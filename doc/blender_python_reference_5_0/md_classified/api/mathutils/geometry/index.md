...
:   Computes the Constrained Delaunay Triangulation of a set of vertices,
    ...
    Parameters:
    :   * **vert\_coords** (Sequence[[`mathutils.Vector`](../index.md#mathutils.Vector "mathutils.Vector")]) – Vertex coordinates (2d)
        ...
        * **need\_ids** (*bool*) – are the orig output arrays needed?

    Returns:
    :   Output tuple, (vert\_coords, edges, faces, orig\_verts, orig\_edges, orig\_faces)

    Return type:
    :   tuple[list[[`mathutils.Vector`](../index.md#mathutils.Vector "mathutils.Vector")], list[tuple[int, int]], list[list[int]], list[list[int]], list[list[int]], list[list[int]]]
...
:   Interpolate a bezier spline segment.
    ...
    Return type:
    :   list[[`mathutils.Vector`](../index.md#mathutils.Vector "mathutils.Vector")]
...
:   Returns a tuple with the points on each line respectively closest to the other.
    ...
    Return type:
    :   tuple[[`mathutils.Vector`](../index.md#mathutils.Vector "mathutils.Vector"), [`mathutils.Vector`](../index.md#mathutils.Vector "mathutils.Vector")] | None
...
:   Takes 2 segments (defined by 4 vectors) and returns a vector for their point of intersection or None.
    ...
    Return type:
    :   [`mathutils.Vector`](../index.md#mathutils.Vector "mathutils.Vector") | None
...
:   Takes a line (as 2 points) and a sphere (as a point and a radius) and
    ...
    Return type:
    :   tuple[[`mathutils.Vector`](../index.md#mathutils.Vector "mathutils.Vector") | None, [`mathutils.Vector`](../index.md#mathutils.Vector "mathutils.Vector") | None]
...
:   Return the intersection between two planes
    ...
    Return type:
    :   tuple[[`mathutils.Vector`](../index.md#mathutils.Vector "mathutils.Vector"), [`mathutils.Vector`](../index.md#mathutils.Vector "mathutils.Vector")] | tuple[None, None]
...
:   Takes a point and a line and returns the closest point on the line and its distance from the first point of the line as a percentage of the length of the line.
    ...
    :   * **pt** ([`mathutils.Vector`](../index.md#mathutils.Vector "mathutils.Vector")) – Point
        ...
        * **line\_p2** ([`mathutils.Vector`](../index.md#mathutils.Vector "mathutils.Vector")) – Second point of the line

    Return type:
    :   tuple[[`mathutils.Vector`](../index.md#mathutils.Vector "mathutils.Vector"), float]

mathutils.geometry.intersect\_point\_line\_segment(*pt*, *seg\_p1*, *seg\_p2*, */*)[¶](#mathutils.geometry.intersect_point_line_segment "Link to this definition")
:   Takes a point and a segment and returns the closest point on the segment and the distance to the segment.

    Parameters:
    :   * **pt** ([`mathutils.Vector`](../index.md#mathutils.Vector "mathutils.Vector")) – Point
        * **seg\_p1** ([`mathutils.Vector`](../index.md#mathutils.Vector "mathutils.Vector")) – First point of the segment
        * **seg\_p2** ([`mathutils.Vector`](../index.md#mathutils.Vector "mathutils.Vector")) – Second point of the segment
...
:   Returns a list of points inside all planes given and a list of index values for the planes used.
    ...
    Parameters:
    :   * **planes** (list[[`mathutils.Vector`](../index.md#mathutils.Vector "mathutils.Vector")]) – List of planes (4D vectors).
    ...
    Return type:
    :   tuple[list[[`mathutils.Vector`](../index.md#mathutils.Vector "mathutils.Vector")], list[int]]

mathutils.geometry.tessellate\_polygon(*polylines*, */*)[¶](#mathutils.geometry.tessellate_polygon "Link to this definition")
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60mathutils.geometry.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fmathutils.geometry.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)
