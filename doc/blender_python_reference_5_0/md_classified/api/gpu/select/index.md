...
# GPU Select Utilities (gpu.select)[¶](#module-gpu.select "Link to this heading")

This module provides access to selection.

gpu.select.load\_id(*id*)[¶](#gpu.select.load_id "Link to this definition")
:   Set the selection ID.

    Parameters:
    :   **id** – Number (32-bit uint).
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60gpu.select.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fgpu.select.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GPU Select Utilities (gpu.select)
  + [`load_id()`](#gpu.select.load_id)