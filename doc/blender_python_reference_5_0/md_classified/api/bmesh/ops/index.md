...
:   Vertex Smooth Laplacian.
    ...
    :   * **bm** (`bmesh.types.BMesh`) – The bmesh to operate on.
        * **verts** (list of (`bmesh.types.BMVert`)) – Input vertices.
        * **lambda\_factor** (*float*) – Lambda parameter.
...
bmesh.ops.find\_doubles(*bm*, *verts=[]*, *keep\_verts=[]*, *use\_connected=False*, *dist=0*)[¶](#bmesh.ops.find_doubles "Link to this definition")
:   Find Doubles.
    ...
    :   * **bm** (`bmesh.types.BMesh`) – The bmesh to operate on.
        * **verts** (list of (`bmesh.types.BMVert`)) – Input vertices.
        * **keep\_verts** (list of (`bmesh.types.BMVert`)) – List of verts to keep.
        * **use\_connected** (*bool*) – Limit the search for doubles by connected geometry.
...
bmesh.ops.remove\_doubles(*bm*, *verts=[]*, *use\_connected=False*, *dist=0*)[¶](#bmesh.ops.remove_doubles "Link to this definition")
:   Remove Doubles.
...
:   Face-Data Point Merge.
    ...
    :   * **bm** (`bmesh.types.BMesh`) – The bmesh to operate on.
        * **verts** (list of (`bmesh.types.BMVert`)) – Input vertices.
        * **vert\_snap** (`bmesh.types.BMVert`) – Snap vertex.
...
bmesh.ops.weld\_verts(*bm*, *targetmap={}*, *use\_centroid=False*)[¶](#bmesh.ops.weld_verts "Link to this definition")
:   Weld Verts.
    ...
    :   * **bm** (`bmesh.types.BMesh`) – The bmesh to operate on.
        ...
        * **use\_centroid** (*bool*) – Merged vertices to their centroid position,
...
bmesh.ops.join\_triangles(*bm*, *faces=[]*, *cmp\_seam=False*, *cmp\_sharp=False*, *cmp\_uvs=False*, *cmp\_vcols=False*, *cmp\_materials=False*, *angle\_face\_threshold=0*, *angle\_shape\_threshold=0*, *topology\_influence=0*, *deselect\_joined=False*, *merge\_limit=0*, *neighbor\_debug=0*)[¶](#bmesh.ops.join_triangles "Link to this definition")
:   Join Triangles.
...
bmesh.ops.extrude\_face\_region(*bm*, *geom=[]*, *edges\_exclude=set()*, *use\_keep\_orig=False*, *use\_normal\_flip=False*, *use\_normal\_from\_adjacent=False*, *use\_dissolve\_ortho\_edges=False*, *use\_select\_history=False*, *skip\_input\_flip=False*)[¶](#bmesh.ops.extrude_face_region "Link to this definition")
:   Extrude Faces.
    ...
    :   * **bm** (`bmesh.types.BMesh`) – The bmesh to operate on.
        ...
        * **use\_select\_history** (*bool*) – Pass to duplicate.
        * **skip\_input\_flip** (*bool*) – Skip flipping of input faces to preserve original orientation.
...
bmesh.ops.dissolve\_edges(*bm*, *edges=[]*, *use\_verts=False*, *use\_face\_split=False*, *angle\_threshold=0*)[¶](#bmesh.ops.dissolve_edges "Link to this definition")
:   Dissolve Edges.
    ...
    :   * **bm** (`bmesh.types.BMesh`) – The bmesh to operate on.
        ...
        * **use\_face\_split** (*bool*) – Split off face corners to maintain surrounding geometry.
        * **angle\_threshold** (*float*) – Do not dissolve verts between 2 edges when their angle exceeds this threshold.
          Disabled by default.
