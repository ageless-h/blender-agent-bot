...
# Additional Math Functions (bl\_math)[¶](#module-bl_math "Link to this heading")

Miscellaneous math utilities module.

bl\_math.clamp(*value*, *min=0*, *max=1*)[¶](#bl_math.clamp "Link to this definition")
...
bl\_math.lerp(*from\_value*, *to\_value*, *factor*)[¶](#bl_math.lerp "Link to this definition")
:   Linearly interpolate between two float values based on factor.

    Parameters:
    :   * **from\_value** (*float*) – The value to return when factor is 0.
        * **to\_value** (*float*) – The value to return when factor is 1.
...
bl\_math.smoothstep(*from\_value*, *to\_value*, *value*)[¶](#bl_math.smoothstep "Link to this definition")
:   Performs smooth interpolation between 0 and 1 as value changes between from and to values.
    ...
    Parameters:
    :   * **from\_value** (*float*) – The edge value where the result is 0.
        * **to\_value** (*float*) – The edge value where the result is 1.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bl_math.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbl_math.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)
