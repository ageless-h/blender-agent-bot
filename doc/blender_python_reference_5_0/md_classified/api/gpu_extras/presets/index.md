...
* [GPU Utilities (gpu\_extras)](../../../meta/index.md)[x]

  Toggle navigation of GPU Utilities (gpu\_extras)

  + [gpu\_extras submodule (gpu\_extras.batch)](../batch/index.md)
  + gpu\_extras submodule (gpu\_extras.presets)
...
# gpu\_extras submodule (gpu\_extras.presets)[¶](#module-gpu_extras.presets "Link to this heading")

gpu\_extras.presets.draw\_circle\_2d(*position*, *color*, *radius*, *\**, *segments=None*)[¶](#gpu_extras.presets.draw_circle_2d "Link to this definition")
:   Draw a circle.

    Parameters:
    :   * **position** (*Sequence**[**float**]*) – 2D position where the circle will be drawn.
        * **color** (*Sequence**[**float**]*) – Color of the circle (RGBA).
          To use transparency blend must be set to `ALPHA`, see: [`gpu.state.blend_set()`](../../gpu/state/index.md#gpu.state.blend_set "gpu.state.blend_set").
...
gpu\_extras.presets.draw\_texture\_2d(*texture*, *position*, *width*, *height*, *is\_scene\_linear\_with\_rec709\_srgb\_target=False*)[¶](#gpu_extras.presets.draw_texture_2d "Link to this definition")
:   Draw a 2d texture.

    Parameters:
    :   * **texture** ([`gpu.types.GPUTexture`](../../gpu/types/index.md#gpu.types.GPUTexture "gpu.types.GPUTexture")) – GPUTexture to draw (e.g. gpu.texture.from\_image(image) for [`bpy.types.Image`](../../bpy/types/Image.md#bpy.types.Image "bpy.types.Image")).
        ...
        * **is\_scene\_linear\_with\_rec709\_srgb\_target** (*bool*) – True if the texture is stored in scene linear color space and
          the destination framebuffer uses the Rec.709 sRGB color space
          (which is true when drawing textures acquired from [`bpy.types.Image`](../../bpy/types/Image.md#bpy.types.Image "bpy.types.Image") inside a
          ‘PRE\_VIEW’, ‘POST\_VIEW’ or ‘POST\_PIXEL’ draw handler).
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60gpu_extras.presets.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fgpu_extras.presets.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* gpu\_extras submodule (gpu\_extras.presets)
  + [`draw_circle_2d()`](#gpu_extras.presets.draw_circle_2d)
  + [`draw_texture_2d()`](#gpu_extras.presets.draw_texture_2d)