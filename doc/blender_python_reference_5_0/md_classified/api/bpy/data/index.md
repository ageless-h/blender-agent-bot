...
# Data Access (bpy.data)[¶](#module-bpy.data "Link to this heading")

This module is used for all Blender/Python access.

bpy.data.data[¶](#bpy.data.data "Link to this definition")
:   Access to Blender’s internal data

    Type:
    :   [`bpy.types.BlendData`](../types/BlendData.md#bpy.types.BlendData "bpy.types.BlendData")
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.data.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.data.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)
