...
# ObjectLightLinking(bpy\_struct)[¶](#objectlightlinking-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.ObjectLightLinking(*bpy\_struct*)[¶](#bpy.types.ObjectLightLinking "Link to this definition")
:   blocker\_collection[¶](#bpy.types.ObjectLightLinking.blocker_collection "Link to this definition")
    ...
    receiver\_collection[¶](#bpy.types.ObjectLightLinking.receiver_collection "Link to this definition")
    :   Collection which defines light linking relation of this emitter

        Type:
        :   [`Collection`](Collection.md#bpy.types.Collection "bpy.types.Collection")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ObjectLightLinking.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ObjectLightLinking.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Object.light_linking`](Object.md#bpy.types.Object.light_linking "bpy.types.Object.light_linking") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ObjectLightLinking.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ObjectLightLinking.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ObjectLightLinking(bpy\_struct)
  + [`ObjectLightLinking`](#bpy.types.ObjectLightLinking)
    - [`ObjectLightLinking.blocker_collection`](#bpy.types.ObjectLightLinking.blocker_collection)
    - [`ObjectLightLinking.receiver_collection`](#bpy.types.ObjectLightLinking.receiver_collection)
    - [`ObjectLightLinking.bl_rna_get_subclass()`](#bpy.types.ObjectLightLinking.bl_rna_get_subclass)
    - [`ObjectLightLinking.bl_rna_get_subclass_py()`](#bpy.types.ObjectLightLinking.bl_rna_get_subclass_py)
