...
# BlendDataBrushes(bpy\_struct)[¶](#blenddatabrushes-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.BlendDataBrushes(*bpy\_struct*)[¶](#bpy.types.BlendDataBrushes "Link to this definition")
:   Collection of brushes

    new(*name*, *\**, *mode='TEXTURE\_PAINT'*)[¶](#bpy.types.BlendDataBrushes.new "Link to this definition")
    :   Add a new brush to the main database

        Parameters:
        :   * **name** (*string**,* *(**never None**)*) – New name for the data-block
            * **mode** (enum in [Object Mode Items](../../../appendix/bpy_types_enum_items/object_mode_items.md#rna-enum-object-mode-items), (optional)) – Paint Mode for the new brush
    ...
    remove(*brush*, *\**, *do\_unlink=True*, *do\_id\_user=True*, *do\_ui\_user=True*)[¶](#bpy.types.BlendDataBrushes.remove "Link to this definition")
    :   Remove a brush from the current blendfile

        Parameters:
        :   * **brush** ([`Brush`](Brush.md#bpy.types.Brush "bpy.types.Brush"), (never None)) – Brush to remove
            * **do\_unlink** (*boolean**,* *(**optional**)*) – Unlink all usages of this brush before deleting it
            * **do\_id\_user** (*boolean**,* *(**optional**)*) – Decrement user counter of all data-blocks used by this brush
            * **do\_ui\_user** (*boolean**,* *(**optional**)*) – Make sure interface does not reference this brush

    tag(*value*)[¶](#bpy.types.BlendDataBrushes.tag "Link to this definition")
    :   tag

        Parameters:
        :   **value** (*boolean*) – Value

    create\_gpencil\_data(*brush*)[¶](#bpy.types.BlendDataBrushes.create_gpencil_data "Link to this definition")
    :   Add Grease Pencil brush settings

        Parameters:
        :   **brush** ([`Brush`](Brush.md#bpy.types.Brush "bpy.types.Brush"), (never None)) – Brush

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.BlendDataBrushes.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.BlendDataBrushes.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`BlendData.brushes`](BlendData.md#bpy.types.BlendData.brushes "bpy.types.BlendData.brushes") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.BlendDataBrushes.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.BlendDataBrushes.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* BlendDataBrushes(bpy\_struct)
  + [`BlendDataBrushes`](#bpy.types.BlendDataBrushes)
    - [`BlendDataBrushes.new()`](#bpy.types.BlendDataBrushes.new)
    - [`BlendDataBrushes.remove()`](#bpy.types.BlendDataBrushes.remove)
    - [`BlendDataBrushes.tag()`](#bpy.types.BlendDataBrushes.tag)
    - [`BlendDataBrushes.create_gpencil_data()`](#bpy.types.BlendDataBrushes.create_gpencil_data)
    - [`BlendDataBrushes.bl_rna_get_subclass()`](#bpy.types.BlendDataBrushes.bl_rna_get_subclass)
    - [`BlendDataBrushes.bl_rna_get_subclass_py()`](#bpy.types.BlendDataBrushes.bl_rna_get_subclass_py)
