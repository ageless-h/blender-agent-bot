...
# AnimDataDrivers(bpy\_struct)[¶](#animdatadrivers-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.AnimDataDrivers(*bpy\_struct*)[¶](#bpy.types.AnimDataDrivers "Link to this definition")
:   Collection of Driver F-Curves

    new(*data\_path*, *\**, *index=0*)[¶](#bpy.types.AnimDataDrivers.new "Link to this definition")
    :   new
    ...
    remove(*driver*)[¶](#bpy.types.AnimDataDrivers.remove "Link to this definition")
    :   remove

    from\_existing(*\**, *src\_driver=None*)[¶](#bpy.types.AnimDataDrivers.from_existing "Link to this definition")
    :   Add a new driver given an existing one

        Parameters:
        :   **src\_driver** ([`FCurve`](FCurve.md#bpy.types.FCurve "bpy.types.FCurve"), (optional)) – Existing Driver F-Curve to use as template for a new one
    ...
    find(*data\_path*, *\**, *index=0*)[¶](#bpy.types.AnimDataDrivers.find "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.AnimDataDrivers.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.AnimDataDrivers.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`AnimData.drivers`](AnimData.md#bpy.types.AnimData.drivers "bpy.types.AnimData.drivers") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.AnimDataDrivers.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.AnimDataDrivers.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* AnimDataDrivers(bpy\_struct)
  + [`AnimDataDrivers`](#bpy.types.AnimDataDrivers)
    - [`AnimDataDrivers.new()`](#bpy.types.AnimDataDrivers.new)
    - [`AnimDataDrivers.remove()`](#bpy.types.AnimDataDrivers.remove)
    - [`AnimDataDrivers.from_existing()`](#bpy.types.AnimDataDrivers.from_existing)
    - [`AnimDataDrivers.find()`](#bpy.types.AnimDataDrivers.find)
    - [`AnimDataDrivers.bl_rna_get_subclass()`](#bpy.types.AnimDataDrivers.bl_rna_get_subclass)
    - [`AnimDataDrivers.bl_rna_get_subclass_py()`](#bpy.types.AnimDataDrivers.bl_rna_get_subclass_py)
