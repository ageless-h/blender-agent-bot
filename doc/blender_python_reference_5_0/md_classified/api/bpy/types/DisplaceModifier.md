...
# DisplaceModifier(Modifier)[¶](#displacemodifier-modifier "Link to this heading")
...
*class* bpy.types.DisplaceModifier(*Modifier*)[¶](#bpy.types.DisplaceModifier "Link to this definition")
:   Displacement modifier

    direction[¶](#bpy.types.DisplaceModifier.direction "Link to this definition")
    :   * `X`
    ...
    invert\_vertex\_group[¶](#bpy.types.DisplaceModifier.invert_vertex_group "Link to this definition")
    :   Invert vertex group influence

        Type:
        :   boolean, default False

    mid\_level[¶](#bpy.types.DisplaceModifier.mid_level "Link to this definition")
    :   Material value that gives no displacement

        Type:
        :   float in [-inf, inf], default 0.5

    space[¶](#bpy.types.DisplaceModifier.space "Link to this definition")
    :   * `LOCAL`
    ...
    strength[¶](#bpy.types.DisplaceModifier.strength "Link to this definition")
    :   Amount to displace geometry

        Type:
        :   float in [-inf, inf], default 1.0

    texture[¶](#bpy.types.DisplaceModifier.texture "Link to this definition")
    :   Type:
        :   [`Texture`](Texture.md#bpy.types.Texture "bpy.types.Texture")

    texture\_coords[¶](#bpy.types.DisplaceModifier.texture_coords "Link to this definition")
    :   * `LOCAL`
    ...
    texture\_coords\_bone[¶](#bpy.types.DisplaceModifier.texture_coords_bone "Link to this definition")
    :   Bone to set the texture coordinates

        Type:
        :   string, default “”, (never None)

    texture\_coords\_object[¶](#bpy.types.DisplaceModifier.texture_coords_object "Link to this definition")
    :   Object to set the texture coordinates

        Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object")

    uv\_layer[¶](#bpy.types.DisplaceModifier.uv_layer "Link to this definition")
    :   UV map name

        Type:
        :   string, default “”, (never None)

    vertex\_group[¶](#bpy.types.DisplaceModifier.vertex_group "Link to this definition")
    :   Name of Vertex Group which determines influence of modifier per point

        Type:
        :   string, default “”, (never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.DisplaceModifier.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.DisplaceModifier.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.DisplaceModifier.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.DisplaceModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* DisplaceModifier(Modifier)
  + [`DisplaceModifier`](#bpy.types.DisplaceModifier)
    - [`DisplaceModifier.direction`](#bpy.types.DisplaceModifier.direction)
    - [`DisplaceModifier.invert_vertex_group`](#bpy.types.DisplaceModifier.invert_vertex_group)
    - [`DisplaceModifier.mid_level`](#bpy.types.DisplaceModifier.mid_level)
    - [`DisplaceModifier.space`](#bpy.types.DisplaceModifier.space)
    - [`DisplaceModifier.strength`](#bpy.types.DisplaceModifier.strength)
    - [`DisplaceModifier.texture`](#bpy.types.DisplaceModifier.texture)
    - [`DisplaceModifier.texture_coords`](#bpy.types.DisplaceModifier.texture_coords)
    - [`DisplaceModifier.texture_coords_bone`](#bpy.types.DisplaceModifier.texture_coords_bone)
    - [`DisplaceModifier.texture_coords_object`](#bpy.types.DisplaceModifier.texture_coords_object)
    - [`DisplaceModifier.uv_layer`](#bpy.types.DisplaceModifier.uv_layer)
    - [`DisplaceModifier.vertex_group`](#bpy.types.DisplaceModifier.vertex_group)
    - [`DisplaceModifier.bl_rna_get_subclass()`](#bpy.types.DisplaceModifier.bl_rna_get_subclass)
    - [`DisplaceModifier.bl_rna_get_subclass_py()`](#bpy.types.DisplaceModifier.bl_rna_get_subclass_py)
