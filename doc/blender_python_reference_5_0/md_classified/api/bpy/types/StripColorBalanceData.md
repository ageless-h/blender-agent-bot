...
# StripColorBalanceData(bpy\_struct)[¶](#stripcolorbalancedata-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

subclasses —
[`StripColorBalance`](StripColorBalance.md#bpy.types.StripColorBalance "bpy.types.StripColorBalance")

*class* bpy.types.StripColorBalanceData(*bpy\_struct*)[¶](#bpy.types.StripColorBalanceData "Link to this definition")
:   Color balance parameters for a sequence strip and its modifiers

    correction\_method[¶](#bpy.types.StripColorBalanceData.correction_method "Link to this definition")
    :   * `LIFT_GAMMA_GAIN`
          Lift/Gamma/Gain.
        * `OFFSET_POWER_SLOPE`
    ...
    gain[¶](#bpy.types.StripColorBalanceData.gain "Link to this definition")
    ...
    gamma[¶](#bpy.types.StripColorBalanceData.gamma "Link to this definition")
    :   Color balance gamma (midtones)

        Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, inf], default (1.0, 1.0, 1.0)

    invert\_gain[¶](#bpy.types.StripColorBalanceData.invert_gain "Link to this definition")
    :   Invert the gain color

        Type:
        :   boolean, default False

    invert\_gamma[¶](#bpy.types.StripColorBalanceData.invert_gamma "Link to this definition")
    :   Invert the gamma color

        Type:
        :   boolean, default False

    invert\_lift[¶](#bpy.types.StripColorBalanceData.invert_lift "Link to this definition")
    :   Invert the lift color

        Type:
        :   boolean, default False

    invert\_offset[¶](#bpy.types.StripColorBalanceData.invert_offset "Link to this definition")
    :   Invert the offset color

        Type:
        :   boolean, default False

    invert\_power[¶](#bpy.types.StripColorBalanceData.invert_power "Link to this definition")
    :   Invert the power color

        Type:
        :   boolean, default False

    invert\_slope[¶](#bpy.types.StripColorBalanceData.invert_slope "Link to this definition")
    :   Invert the slope color

        Type:
        :   boolean, default False

    lift[¶](#bpy.types.StripColorBalanceData.lift "Link to this definition")
    :   Color balance lift (shadows)

        Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, inf], default (1.0, 1.0, 1.0)

    offset[¶](#bpy.types.StripColorBalanceData.offset "Link to this definition")
    :   Correction for entire tonal range

        Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, inf], default (1.0, 1.0, 1.0)

    power[¶](#bpy.types.StripColorBalanceData.power "Link to this definition")
    :   Correction for midtones

        Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, inf], default (1.0, 1.0, 1.0)

    slope[¶](#bpy.types.StripColorBalanceData.slope "Link to this definition")
    :   Correction for highlights

        Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, inf], default (1.0, 1.0, 1.0)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.StripColorBalanceData.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.StripColorBalanceData.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`ColorBalanceModifier.color_balance`](ColorBalanceModifier.md#bpy.types.ColorBalanceModifier.color_balance "bpy.types.ColorBalanceModifier.color_balance") |  |

[Next

StripCrop(bpy\_struct)](StripCrop.md)
[Previous
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.StripColorBalanceData.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.StripColorBalanceData.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* StripColorBalanceData(bpy\_struct)
  + [`StripColorBalanceData`](#bpy.types.StripColorBalanceData)
    - [`StripColorBalanceData.correction_method`](#bpy.types.StripColorBalanceData.correction_method)
    - [`StripColorBalanceData.gain`](#bpy.types.StripColorBalanceData.gain)
    - [`StripColorBalanceData.gamma`](#bpy.types.StripColorBalanceData.gamma)
    - [`StripColorBalanceData.invert_gain`](#bpy.types.StripColorBalanceData.invert_gain)
    - [`StripColorBalanceData.invert_gamma`](#bpy.types.StripColorBalanceData.invert_gamma)
    - [`StripColorBalanceData.invert_lift`](#bpy.types.StripColorBalanceData.invert_lift)
    - [`StripColorBalanceData.invert_offset`](#bpy.types.StripColorBalanceData.invert_offset)
    - [`StripColorBalanceData.invert_power`](#bpy.types.StripColorBalanceData.invert_power)
    - [`StripColorBalanceData.invert_slope`](#bpy.types.StripColorBalanceData.invert_slope)
    - [`StripColorBalanceData.lift`](#bpy.types.StripColorBalanceData.lift)
    - [`StripColorBalanceData.offset`](#bpy.types.StripColorBalanceData.offset)
    - [`StripColorBalanceData.power`](#bpy.types.StripColorBalanceData.power)
    - [`StripColorBalanceData.slope`](#bpy.types.StripColorBalanceData.slope)
    - [`StripColorBalanceData.bl_rna_get_subclass()`](#bpy.types.StripColorBalanceData.bl_rna_get_subclass)
    - [`StripColorBalanceData.bl_rna_get_subclass_py()`](#bpy.types.StripColorBalanceData.bl_rna_get_subclass_py)
