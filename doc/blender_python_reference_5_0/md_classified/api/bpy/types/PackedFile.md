...
# PackedFile(bpy\_struct)[¶](#packedfile-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.PackedFile(*bpy\_struct*)[¶](#bpy.types.PackedFile "Link to this definition")
:   External file packed into the .blend file

    data[¶](#bpy.types.PackedFile.data "Link to this definition")
    :   Raw data (bytes, exact content of the embedded file)

        Type:
        :   byte string, default “”, (readonly, never None)

    size[¶](#bpy.types.PackedFile.size "Link to this definition")
    :   Size of packed file in bytes

        Type:
        :   int in [-inf, inf], default 0, (readonly)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.PackedFile.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.PackedFile.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Image.packed_file`](Image.md#bpy.types.Image.packed_file "bpy.types.Image.packed_file") * [`ImagePackedFile.packed_file`](ImagePackedFile.md#bpy.types.ImagePackedFile.packed_file "bpy.types.ImagePackedFile.packed_file") * [`Library.packed_file`](Library.md#bpy.types.Library.packed_file "bpy.types.Library.packed_file") | * [`Sound.packed_file`](Sound.md#bpy.types.Sound.packed_file "bpy.types.Sound.packed_file") * [`VectorFont.packed_file`](VectorFont.md#bpy.types.VectorFont.packed_file "bpy.types.VectorFont.packed_file") * [`Volume.packed_file`](Volume.md#bpy.types.Volume.packed_file "bpy.types.Volume.packed_file") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.PackedFile.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.PackedFile.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* PackedFile(bpy\_struct)
  + [`PackedFile`](#bpy.types.PackedFile)
    - [`PackedFile.data`](#bpy.types.PackedFile.data)
    - [`PackedFile.size`](#bpy.types.PackedFile.size)
    - [`PackedFile.bl_rna_get_subclass()`](#bpy.types.PackedFile.bl_rna_get_subclass)
    - [`PackedFile.bl_rna_get_subclass_py()`](#bpy.types.PackedFile.bl_rna_get_subclass_py)
