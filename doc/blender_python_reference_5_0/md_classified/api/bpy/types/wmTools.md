...
# wmTools(bpy\_struct)[¶](#wmtools-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.wmTools(*bpy\_struct*)[¶](#bpy.types.wmTools "Link to this definition")
:   from\_space\_view3d\_mode(*mode*, *\**, *create=False*)[¶](#bpy.types.wmTools.from_space_view3d_mode "Link to this definition")
    :   Parameters:
        :   **create** (*boolean**,* *(**optional**)*) – Create

        Return type:
        :   [`WorkSpaceTool`](WorkSpaceTool.md#bpy.types.WorkSpaceTool "bpy.types.WorkSpaceTool")

    from\_space\_image\_mode(*mode*, *\**, *create=False*)[¶](#bpy.types.wmTools.from_space_image_mode "Link to this definition")
    :   Parameters:
        :   **create** (*boolean**,* *(**optional**)*) – Create
    ...
    from\_space\_node(*\**, *create=False*)[¶](#bpy.types.wmTools.from_space_node "Link to this definition")
    :   Parameters:
        :   **create** (*boolean**,* *(**optional**)*) – Create
    ...
    from\_space\_sequencer(*mode*, *\**, *create=False*)[¶](#bpy.types.wmTools.from_space_sequencer "Link to this definition")
    :   Parameters:
        :   **create** (*boolean**,* *(**optional**)*) – Create
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.wmTools.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.wmTools.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`WorkSpace.tools`](WorkSpace.md#bpy.types.WorkSpace.tools "bpy.types.WorkSpace.tools") |  |

[Next

Shared Enum Items](../../../appendix/bpy_types_enum_items/index.md)
[Previous
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.wmTools.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.wmTools.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* wmTools(bpy\_struct)
  + [`wmTools`](#bpy.types.wmTools)
    - [`wmTools.from_space_view3d_mode()`](#bpy.types.wmTools.from_space_view3d_mode)
    - [`wmTools.from_space_image_mode()`](#bpy.types.wmTools.from_space_image_mode)
    - [`wmTools.from_space_node()`](#bpy.types.wmTools.from_space_node)
    - [`wmTools.from_space_sequencer()`](#bpy.types.wmTools.from_space_sequencer)
    - [`wmTools.bl_rna_get_subclass()`](#bpy.types.wmTools.bl_rna_get_subclass)
    - [`wmTools.bl_rna_get_subclass_py()`](#bpy.types.wmTools.bl_rna_get_subclass_py)
