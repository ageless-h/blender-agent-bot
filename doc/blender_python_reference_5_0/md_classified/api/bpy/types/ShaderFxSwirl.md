...
# ShaderFxSwirl(ShaderFx)[¶](#shaderfxswirl-shaderfx "Link to this heading")
...
*class* bpy.types.ShaderFxSwirl(*ShaderFx*)[¶](#bpy.types.ShaderFxSwirl "Link to this definition")
:   Swirl effect

    angle[¶](#bpy.types.ShaderFxSwirl.angle "Link to this definition")
    :   Angle of rotation

        Type:
        :   float in [-31.4159, 31.4159], default 0.0

    object[¶](#bpy.types.ShaderFxSwirl.object "Link to this definition")
    :   Object to determine center location

        Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object")

    radius[¶](#bpy.types.ShaderFxSwirl.radius "Link to this definition")
    :   Radius to apply

        Type:
        :   int in [0, 32767], default 0

    use\_transparent[¶](#bpy.types.ShaderFxSwirl.use_transparent "Link to this definition")
    :   Make image transparent outside of radius

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ShaderFxSwirl.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ShaderFxSwirl.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ShaderFxSwirl.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ShaderFxSwirl.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ShaderFxSwirl(ShaderFx)
  + [`ShaderFxSwirl`](#bpy.types.ShaderFxSwirl)
    - [`ShaderFxSwirl.angle`](#bpy.types.ShaderFxSwirl.angle)
    - [`ShaderFxSwirl.object`](#bpy.types.ShaderFxSwirl.object)
    - [`ShaderFxSwirl.radius`](#bpy.types.ShaderFxSwirl.radius)
    - [`ShaderFxSwirl.use_transparent`](#bpy.types.ShaderFxSwirl.use_transparent)
    - [`ShaderFxSwirl.bl_rna_get_subclass()`](#bpy.types.ShaderFxSwirl.bl_rna_get_subclass)
    - [`ShaderFxSwirl.bl_rna_get_subclass_py()`](#bpy.types.ShaderFxSwirl.bl_rna_get_subclass_py)
