...
# MovieTrackingPlaneTrack(bpy\_struct)[¶](#movietrackingplanetrack-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.MovieTrackingPlaneTrack(*bpy\_struct*)[¶](#bpy.types.MovieTrackingPlaneTrack "Link to this definition")
:   Match-moving plane track data for tracking

    image[¶](#bpy.types.MovieTrackingPlaneTrack.image "Link to this definition")
    :   Image displayed in the track during editing in clip editor

        Type:
        :   [`Image`](Image.md#bpy.types.Image "bpy.types.Image")

    image\_opacity[¶](#bpy.types.MovieTrackingPlaneTrack.image_opacity "Link to this definition")
    :   Opacity of the image

        Type:
        :   float in [0, 1], default 0.0

    markers[¶](#bpy.types.MovieTrackingPlaneTrack.markers "Link to this definition")
    :   Collection of markers in track

        Type:
        :   [`MovieTrackingPlaneMarkers`](MovieTrackingPlaneMarkers.md#bpy.types.MovieTrackingPlaneMarkers "bpy.types.MovieTrackingPlaneMarkers") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`MovieTrackingPlaneMarker`](MovieTrackingPlaneMarker.md#bpy.types.MovieTrackingPlaneMarker "bpy.types.MovieTrackingPlaneMarker"), (readonly)

    name[¶](#bpy.types.MovieTrackingPlaneTrack.name "Link to this definition")
    :   Unique name of track

        Type:
        :   string, default “”, (never None)

    select[¶](#bpy.types.MovieTrackingPlaneTrack.select "Link to this definition")
    :   Plane track is selected

        Type:
        :   boolean, default False

    use\_auto\_keying[¶](#bpy.types.MovieTrackingPlaneTrack.use_auto_keying "Link to this definition")
    :   Automatic keyframe insertion when moving plane corners

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.MovieTrackingPlaneTrack.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.MovieTrackingPlaneTrack.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`MovieTracking.plane_tracks`](MovieTracking.md#bpy.types.MovieTracking.plane_tracks "bpy.types.MovieTracking.plane_tracks") * [`MovieTrackingObject.plane_tracks`](MovieTrackingObject.md#bpy.types.MovieTrackingObject.plane_tracks "bpy.types.MovieTrackingObject.plane_tracks") | * [`MovieTrackingPlaneTracks.active`](MovieTrackingPlaneTracks.md#bpy.types.MovieTrackingPlaneTracks.active "bpy.types.MovieTrackingPlaneTracks.active") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.MovieTrackingPlaneTrack.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.MovieTrackingPlaneTrack.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* MovieTrackingPlaneTrack(bpy\_struct)
  + [`MovieTrackingPlaneTrack`](#bpy.types.MovieTrackingPlaneTrack)
    - [`MovieTrackingPlaneTrack.image`](#bpy.types.MovieTrackingPlaneTrack.image)
    - [`MovieTrackingPlaneTrack.image_opacity`](#bpy.types.MovieTrackingPlaneTrack.image_opacity)
    - [`MovieTrackingPlaneTrack.markers`](#bpy.types.MovieTrackingPlaneTrack.markers)
    - [`MovieTrackingPlaneTrack.name`](#bpy.types.MovieTrackingPlaneTrack.name)
    - [`MovieTrackingPlaneTrack.select`](#bpy.types.MovieTrackingPlaneTrack.select)
    - [`MovieTrackingPlaneTrack.use_auto_keying`](#bpy.types.MovieTrackingPlaneTrack.use_auto_keying)
    - [`MovieTrackingPlaneTrack.bl_rna_get_subclass()`](#bpy.types.MovieTrackingPlaneTrack.bl_rna_get_subclass)
    - [`MovieTrackingPlaneTrack.bl_rna_get_subclass_py()`](#bpy.types.MovieTrackingPlaneTrack.bl_rna_get_subclass_py)
