...
# CollectionLightLinking(bpy\_struct)[¶](#collectionlightlinking-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.CollectionLightLinking(*bpy\_struct*)[¶](#bpy.types.CollectionLightLinking "Link to this definition")
:   Light linking settings of objects and children collections of a collection

    link\_state[¶](#bpy.types.CollectionLightLinking.link_state "Link to this definition")
    :   Light or shadow receiving state of the object or collection

        Type:
        :   enum in [`'INCLUDE'`, `'EXCLUDE'`], default `'INCLUDE'`

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.CollectionLightLinking.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.CollectionLightLinking.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`CollectionChild.light_linking`](CollectionChild.md#bpy.types.CollectionChild.light_linking "bpy.types.CollectionChild.light_linking") | * [`CollectionObject.light_linking`](CollectionObject.md#bpy.types.CollectionObject.light_linking "bpy.types.CollectionObject.light_linking") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CollectionLightLinking.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.CollectionLightLinking.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CollectionLightLinking(bpy\_struct)
  + [`CollectionLightLinking`](#bpy.types.CollectionLightLinking)
    - [`CollectionLightLinking.link_state`](#bpy.types.CollectionLightLinking.link_state)
    - [`CollectionLightLinking.bl_rna_get_subclass()`](#bpy.types.CollectionLightLinking.bl_rna_get_subclass)
    - [`CollectionLightLinking.bl_rna_get_subclass_py()`](#bpy.types.CollectionLightLinking.bl_rna_get_subclass_py)
