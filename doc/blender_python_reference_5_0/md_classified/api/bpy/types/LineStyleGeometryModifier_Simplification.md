...
# LineStyleGeometryModifier\_Simplification(LineStyleGeometryModifier)[¶](#linestylegeometrymodifier-simplification-linestylegeometrymodifier "Link to this heading")
...
*class* bpy.types.LineStyleGeometryModifier\_Simplification(*LineStyleGeometryModifier*)[¶](#bpy.types.LineStyleGeometryModifier_Simplification "Link to this definition")
:   Simplify the stroke set

    expanded[¶](#bpy.types.LineStyleGeometryModifier_Simplification.expanded "Link to this definition")
    :   True if the modifier tab is expanded

        Type:
        :   boolean, default False

    tolerance[¶](#bpy.types.LineStyleGeometryModifier_Simplification.tolerance "Link to this definition")
    :   Distance below which segments will be merged

        Type:
        :   float in [-inf, inf], default 0.0

    type[¶](#bpy.types.LineStyleGeometryModifier_Simplification.type "Link to this definition")
    ...
    use[¶](#bpy.types.LineStyleGeometryModifier_Simplification.use "Link to this definition")
    :   Enable or disable this modifier during stroke rendering

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.LineStyleGeometryModifier_Simplification.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.LineStyleGeometryModifier_Simplification.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
        ...
        Return type:
        :   [type](#bpy.types.LineStyleGeometryModifier_Simplification.type "bpy.types.LineStyleGeometryModifier_Simplification.type")
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.LineStyleGeometryModifier_Simplification.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.LineStyleGeometryModifier_Simplification.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* LineStyleGeometryModifier\_Simplification(LineStyleGeometryModifier)
  + [`LineStyleGeometryModifier_Simplification`](#bpy.types.LineStyleGeometryModifier_Simplification)
    - [`LineStyleGeometryModifier_Simplification.expanded`](#bpy.types.LineStyleGeometryModifier_Simplification.expanded)
    - [`LineStyleGeometryModifier_Simplification.tolerance`](#bpy.types.LineStyleGeometryModifier_Simplification.tolerance)
    - [`LineStyleGeometryModifier_Simplification.type`](#bpy.types.LineStyleGeometryModifier_Simplification.type)
    - [`LineStyleGeometryModifier_Simplification.use`](#bpy.types.LineStyleGeometryModifier_Simplification.use)
    - [`LineStyleGeometryModifier_Simplification.bl_rna_get_subclass()`](#bpy.types.LineStyleGeometryModifier_Simplification.bl_rna_get_subclass)
    - [`LineStyleGeometryModifier_Simplification.bl_rna_get_subclass_py()`](#bpy.types.LineStyleGeometryModifier_Simplification.bl_rna_get_subclass_py)
