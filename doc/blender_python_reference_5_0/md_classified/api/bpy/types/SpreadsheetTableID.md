...
# SpreadsheetTableID(bpy\_struct)[¶](#spreadsheettableid-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

subclasses —
[`SpreadsheetTableIDGeometry`](SpreadsheetTableIDGeometry.md#bpy.types.SpreadsheetTableIDGeometry "bpy.types.SpreadsheetTableIDGeometry")

*class* bpy.types.SpreadsheetTableID(*bpy\_struct*)[¶](#bpy.types.SpreadsheetTableID "Link to this definition")
:   Data used to identify a spreadsheet table

    type[¶](#bpy.types.SpreadsheetTableID.type "Link to this definition")
    :   The type of the table identifier
        ...
        * `GEOMETRY`
        ...
        Type:
        :   enum in [`'GEOMETRY'`], default `'GEOMETRY'`, (readonly)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.SpreadsheetTableID.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.SpreadsheetTableID.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
        ...
        Return type:
        :   [type](#bpy.types.SpreadsheetTableID.type "bpy.types.SpreadsheetTableID.type")
...
|  |  |
| --- | --- |
| * [`SpreadsheetTable.id`](SpreadsheetTable.md#bpy.types.SpreadsheetTable.id "bpy.types.SpreadsheetTable.id") |  |

[Next

SpreadsheetTableIDGeometry(SpreadsheetTableID)](SpreadsheetTableIDGeometry.md)
[Previous
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.SpreadsheetTableID.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.SpreadsheetTableID.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* SpreadsheetTableID(bpy\_struct)
  + [`SpreadsheetTableID`](#bpy.types.SpreadsheetTableID)
    - [`SpreadsheetTableID.type`](#bpy.types.SpreadsheetTableID.type)
    - [`SpreadsheetTableID.bl_rna_get_subclass()`](#bpy.types.SpreadsheetTableID.bl_rna_get_subclass)
    - [`SpreadsheetTableID.bl_rna_get_subclass_py()`](#bpy.types.SpreadsheetTableID.bl_rna_get_subclass_py)
