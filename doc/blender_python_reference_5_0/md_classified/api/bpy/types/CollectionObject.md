...
# CollectionObject(bpy\_struct)[¶](#collectionobject-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.CollectionObject(*bpy\_struct*)[¶](#bpy.types.CollectionObject "Link to this definition")
:   Object of a collection with its collection related settings

    light\_linking[¶](#bpy.types.CollectionObject.light_linking "Link to this definition")
    :   Light linking settings of the collection

        Type:
        :   [`CollectionLightLinking`](CollectionLightLinking.md#bpy.types.CollectionLightLinking "bpy.types.CollectionLightLinking"), (readonly, never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.CollectionObject.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.CollectionObject.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Collection.collection_objects`](Collection.md#bpy.types.Collection.collection_objects "bpy.types.Collection.collection_objects") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CollectionObject.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.CollectionObject.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CollectionObject(bpy\_struct)
  + [`CollectionObject`](#bpy.types.CollectionObject)
    - [`CollectionObject.light_linking`](#bpy.types.CollectionObject.light_linking)
    - [`CollectionObject.bl_rna_get_subclass()`](#bpy.types.CollectionObject.bl_rna_get_subclass)
    - [`CollectionObject.bl_rna_get_subclass_py()`](#bpy.types.CollectionObject.bl_rna_get_subclass_py)
