...
# ThemeFileBrowser(bpy\_struct)[¶](#themefilebrowser-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.ThemeFileBrowser(*bpy\_struct*)[¶](#bpy.types.ThemeFileBrowser "Link to this definition")
:   Theme settings for the File Browser

    row\_alternate[¶](#bpy.types.ThemeFileBrowser.row_alternate "Link to this definition")
    :   Overlay color on every other row

        Type:
        :   float array of 4 items in [0, 1], default (0.0, 0.0, 0.0, 0.0)

    selected\_file[¶](#bpy.types.ThemeFileBrowser.selected_file "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    space[¶](#bpy.types.ThemeFileBrowser.space "Link to this definition")
    :   Settings for space

        Type:
        :   [`ThemeSpaceGeneric`](ThemeSpaceGeneric.md#bpy.types.ThemeSpaceGeneric "bpy.types.ThemeSpaceGeneric"), (readonly, never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ThemeFileBrowser.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ThemeFileBrowser.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Theme.file_browser`](Theme.md#bpy.types.Theme.file_browser "bpy.types.Theme.file_browser") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ThemeFileBrowser.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ThemeFileBrowser.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ThemeFileBrowser(bpy\_struct)
  + [`ThemeFileBrowser`](#bpy.types.ThemeFileBrowser)
    - [`ThemeFileBrowser.row_alternate`](#bpy.types.ThemeFileBrowser.row_alternate)
    - [`ThemeFileBrowser.selected_file`](#bpy.types.ThemeFileBrowser.selected_file)
    - [`ThemeFileBrowser.space`](#bpy.types.ThemeFileBrowser.space)
    - [`ThemeFileBrowser.bl_rna_get_subclass()`](#bpy.types.ThemeFileBrowser.bl_rna_get_subclass)
    - [`ThemeFileBrowser.bl_rna_get_subclass_py()`](#bpy.types.ThemeFileBrowser.bl_rna_get_subclass_py)
