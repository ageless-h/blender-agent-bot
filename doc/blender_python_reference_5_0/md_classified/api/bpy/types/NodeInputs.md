...
# NodeInputs(bpy\_struct)[¶](#nodeinputs-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.NodeInputs(*bpy\_struct*)[¶](#bpy.types.NodeInputs "Link to this definition")
:   Collection of Node Sockets

    new(*type*, *name*, *\**, *identifier=''*, *use\_multi\_input=False*)[¶](#bpy.types.NodeInputs.new "Link to this definition")
    ...
    remove(*socket*)[¶](#bpy.types.NodeInputs.remove "Link to this definition")
    ...
    clear()[¶](#bpy.types.NodeInputs.clear "Link to this definition")
    :   Remove all sockets from this node

    move(*from\_index*, *to\_index*)[¶](#bpy.types.NodeInputs.move "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.NodeInputs.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.NodeInputs.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Node.inputs`](Node.md#bpy.types.Node.inputs "bpy.types.Node.inputs") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.NodeInputs.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.NodeInputs.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* NodeInputs(bpy\_struct)
  + [`NodeInputs`](#bpy.types.NodeInputs)
    - [`NodeInputs.new()`](#bpy.types.NodeInputs.new)
    - [`NodeInputs.remove()`](#bpy.types.NodeInputs.remove)
    - [`NodeInputs.clear()`](#bpy.types.NodeInputs.clear)
    - [`NodeInputs.move()`](#bpy.types.NodeInputs.move)
    - [`NodeInputs.bl_rna_get_subclass()`](#bpy.types.NodeInputs.bl_rna_get_subclass)
    - [`NodeInputs.bl_rna_get_subclass_py()`](#bpy.types.NodeInputs.bl_rna_get_subclass_py)
