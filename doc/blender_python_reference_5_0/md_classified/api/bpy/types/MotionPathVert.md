...
# MotionPathVert(bpy\_struct)[¶](#motionpathvert-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.MotionPathVert(*bpy\_struct*)[¶](#bpy.types.MotionPathVert "Link to this definition")
:   Cached location on path

    co[¶](#bpy.types.MotionPathVert.co "Link to this definition")
    :   Type:
        :   [`mathutils.Vector`](../../mathutils/index.md#mathutils.Vector "mathutils.Vector") of 3 items in [-inf, inf], default (0.0, 0.0, 0.0)

    select[¶](#bpy.types.MotionPathVert.select "Link to this definition")
    :   Path point is selected for editing

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.MotionPathVert.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.MotionPathVert.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`MotionPath.points`](MotionPath.md#bpy.types.MotionPath.points "bpy.types.MotionPath.points") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.MotionPathVert.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.MotionPathVert.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* MotionPathVert(bpy\_struct)
  + [`MotionPathVert`](#bpy.types.MotionPathVert)
    - [`MotionPathVert.co`](#bpy.types.MotionPathVert.co)
    - [`MotionPathVert.select`](#bpy.types.MotionPathVert.select)
    - [`MotionPathVert.bl_rna_get_subclass()`](#bpy.types.MotionPathVert.bl_rna_get_subclass)
    - [`MotionPathVert.bl_rna_get_subclass_py()`](#bpy.types.MotionPathVert.bl_rna_get_subclass_py)
