...
# MirrorModifier(Modifier)[¶](#mirrormodifier-modifier "Link to this heading")
...
*class* bpy.types.MirrorModifier(*Modifier*)[¶](#bpy.types.MirrorModifier "Link to this definition")
:   Mirroring modifier

    bisect\_threshold[¶](#bpy.types.MirrorModifier.bisect_threshold "Link to this definition")
    :   Distance from the bisect plane within which vertices are removed

        Type:
        :   float in [0, inf], default 0.001

    merge\_threshold[¶](#bpy.types.MirrorModifier.merge_threshold "Link to this definition")
    :   Distance within which mirrored vertices are merged

        Type:
        :   float in [0, inf], default 0.001

    mirror\_object[¶](#bpy.types.MirrorModifier.mirror_object "Link to this definition")
    :   Object to use as mirror

        Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object")

    mirror\_offset\_u[¶](#bpy.types.MirrorModifier.mirror_offset_u "Link to this definition")
    :   Amount to offset mirrored UVs flipping point from the 0.5 on the U axis

        Type:
        :   float in [-1, 1], default 0.0

    mirror\_offset\_v[¶](#bpy.types.MirrorModifier.mirror_offset_v "Link to this definition")
    :   Amount to offset mirrored UVs flipping point from the 0.5 point on the V axis

        Type:
        :   float in [-1, 1], default 0.0

    offset\_u[¶](#bpy.types.MirrorModifier.offset_u "Link to this definition")
    :   Mirrored UV offset on the U axis

        Type:
        :   float in [-10000, 10000], default 0.0

    offset\_v[¶](#bpy.types.MirrorModifier.offset_v "Link to this definition")
    :   Mirrored UV offset on the V axis

        Type:
        :   float in [-10000, 10000], default 0.0

    use\_axis[¶](#bpy.types.MirrorModifier.use_axis "Link to this definition")
    :   Enable axis mirror

        Type:
        :   boolean array of 3 items, default (False, False, False)

    use\_bisect\_axis[¶](#bpy.types.MirrorModifier.use_bisect_axis "Link to this definition")
    :   Cuts the mesh across the mirror plane

        Type:
        :   boolean array of 3 items, default (False, False, False)

    use\_bisect\_flip\_axis[¶](#bpy.types.MirrorModifier.use_bisect_flip_axis "Link to this definition")
    :   Flips the direction of the slice

        Type:
        :   boolean array of 3 items, default (False, False, False)

    use\_clip[¶](#bpy.types.MirrorModifier.use_clip "Link to this definition")
    :   Prevent vertices from going through the mirror during transform

        Type:
        :   boolean, default False

    use\_mirror\_merge[¶](#bpy.types.MirrorModifier.use_mirror_merge "Link to this definition")
    :   Merge vertices within the merge threshold

        Type:
        :   boolean, default True

    use\_mirror\_u[¶](#bpy.types.MirrorModifier.use_mirror_u "Link to this definition")
    :   Mirror the U texture coordinate around the flip offset point

        Type:
        :   boolean, default False

    use\_mirror\_udim[¶](#bpy.types.MirrorModifier.use_mirror_udim "Link to this definition")
    :   Mirror the texture coordinate around each tile center

        Type:
        :   boolean, default False

    use\_mirror\_v[¶](#bpy.types.MirrorModifier.use_mirror_v "Link to this definition")
    :   Mirror the V texture coordinate around the flip offset point

        Type:
        :   boolean, default False

    use\_mirror\_vertex\_groups[¶](#bpy.types.MirrorModifier.use_mirror_vertex_groups "Link to this definition")
    :   Mirror vertex groups (e.g. .R->.L)

        Type:
        :   boolean, default True

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.MirrorModifier.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.MirrorModifier.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.MirrorModifier.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.MirrorModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* MirrorModifier(Modifier)
  + [`MirrorModifier`](#bpy.types.MirrorModifier)
    - [`MirrorModifier.bisect_threshold`](#bpy.types.MirrorModifier.bisect_threshold)
    - [`MirrorModifier.merge_threshold`](#bpy.types.MirrorModifier.merge_threshold)
    - [`MirrorModifier.mirror_object`](#bpy.types.MirrorModifier.mirror_object)
    - [`MirrorModifier.mirror_offset_u`](#bpy.types.MirrorModifier.mirror_offset_u)
    - [`MirrorModifier.mirror_offset_v`](#bpy.types.MirrorModifier.mirror_offset_v)
    - [`MirrorModifier.offset_u`](#bpy.types.MirrorModifier.offset_u)
    - [`MirrorModifier.offset_v`](#bpy.types.MirrorModifier.offset_v)
    - [`MirrorModifier.use_axis`](#bpy.types.MirrorModifier.use_axis)
    - [`MirrorModifier.use_bisect_axis`](#bpy.types.MirrorModifier.use_bisect_axis)
    - [`MirrorModifier.use_bisect_flip_axis`](#bpy.types.MirrorModifier.use_bisect_flip_axis)
    - [`MirrorModifier.use_clip`](#bpy.types.MirrorModifier.use_clip)
    - [`MirrorModifier.use_mirror_merge`](#bpy.types.MirrorModifier.use_mirror_merge)
    - [`MirrorModifier.use_mirror_u`](#bpy.types.MirrorModifier.use_mirror_u)
    - [`MirrorModifier.use_mirror_udim`](#bpy.types.MirrorModifier.use_mirror_udim)
    - [`MirrorModifier.use_mirror_v`](#bpy.types.MirrorModifier.use_mirror_v)
    - [`MirrorModifier.use_mirror_vertex_groups`](#bpy.types.MirrorModifier.use_mirror_vertex_groups)
    - [`MirrorModifier.bl_rna_get_subclass()`](#bpy.types.MirrorModifier.bl_rna_get_subclass)
    - [`MirrorModifier.bl_rna_get_subclass_py()`](#bpy.types.MirrorModifier.bl_rna_get_subclass_py)
