...
# AddonPreferences(bpy\_struct)[¶](#addonpreferences-bpy-struct "Link to this heading")
...
*class* bpy.types.AddonPreferences(*bpy\_struct*)[¶](#bpy.types.AddonPreferences "Link to this definition")
:   bl\_idname[¶](#bpy.types.AddonPreferences.bl_idname "Link to this definition")
    :   Type:
        :   string, default “”, (never None)

    bl\_system\_properties\_get(*\**, *do\_create=False*)[¶](#bpy.types.AddonPreferences.bl_system_properties_get "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.AddonPreferences.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.AddonPreferences.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Addon.preferences`](Addon.md#bpy.types.Addon.preferences "bpy.types.Addon.preferences") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.AddonPreferences.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.AddonPreferences.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* AddonPreferences(bpy\_struct)
  + [`AddonPreferences`](#bpy.types.AddonPreferences)
    - [`AddonPreferences.bl_idname`](#bpy.types.AddonPreferences.bl_idname)
    - [`AddonPreferences.bl_system_properties_get()`](#bpy.types.AddonPreferences.bl_system_properties_get)
    - [`AddonPreferences.bl_rna_get_subclass()`](#bpy.types.AddonPreferences.bl_rna_get_subclass)
    - [`AddonPreferences.bl_rna_get_subclass_py()`](#bpy.types.AddonPreferences.bl_rna_get_subclass_py)
