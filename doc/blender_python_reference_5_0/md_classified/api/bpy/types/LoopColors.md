...
# LoopColors(bpy\_struct)[¶](#loopcolors-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.LoopColors(*bpy\_struct*)[¶](#bpy.types.LoopColors "Link to this definition")
:   Collection of vertex colors

    active[¶](#bpy.types.LoopColors.active "Link to this definition")
    :   Active vertex color layer

        Type:
        :   [`MeshLoopColorLayer`](MeshLoopColorLayer.md#bpy.types.MeshLoopColorLayer "bpy.types.MeshLoopColorLayer")

    active\_index[¶](#bpy.types.LoopColors.active_index "Link to this definition")
    :   Active vertex color index

        Type:
        :   int in [0, inf], default 0

    new(*\**, *name='Col'*, *do\_init=True*)[¶](#bpy.types.LoopColors.new "Link to this definition")
    :   Add a vertex color layer to Mesh

        Parameters:
        :   * **name** (*string**,* *(**optional**,* *never None**)*) – Vertex color name
            * **do\_init** (*boolean**,* *(**optional**)*) – Whether new layer’s data should be initialized by copying current active one
    ...
    remove(*layer*)[¶](#bpy.types.LoopColors.remove "Link to this definition")
    :   Remove a vertex color layer

        Parameters:
        :   **layer** ([`MeshLoopColorLayer`](MeshLoopColorLayer.md#bpy.types.MeshLoopColorLayer "bpy.types.MeshLoopColorLayer"), (never None)) – The layer to remove

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.LoopColors.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.LoopColors.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Mesh.vertex_colors`](Mesh.md#bpy.types.Mesh.vertex_colors "bpy.types.Mesh.vertex_colors") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.LoopColors.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.LoopColors.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* LoopColors(bpy\_struct)
  + [`LoopColors`](#bpy.types.LoopColors)
    - [`LoopColors.active`](#bpy.types.LoopColors.active)
    - [`LoopColors.active_index`](#bpy.types.LoopColors.active_index)
    - [`LoopColors.new()`](#bpy.types.LoopColors.new)
    - [`LoopColors.remove()`](#bpy.types.LoopColors.remove)
    - [`LoopColors.bl_rna_get_subclass()`](#bpy.types.LoopColors.bl_rna_get_subclass)
    - [`LoopColors.bl_rna_get_subclass_py()`](#bpy.types.LoopColors.bl_rna_get_subclass_py)
