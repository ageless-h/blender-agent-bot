...
# XrUserPath(bpy\_struct)[¶](#xruserpath-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.XrUserPath(*bpy\_struct*)[¶](#bpy.types.XrUserPath "Link to this definition")
:   path[¶](#bpy.types.XrUserPath.path "Link to this definition")
    :   OpenXR user path

        Type:
        :   string, default “”, (never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.XrUserPath.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.XrUserPath.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`XrActionMapItem.user_paths`](XrActionMapItem.md#bpy.types.XrActionMapItem.user_paths "bpy.types.XrActionMapItem.user_paths") * [`XrUserPaths.find`](XrUserPaths.md#bpy.types.XrUserPaths.find "bpy.types.XrUserPaths.find") | * [`XrUserPaths.new`](XrUserPaths.md#bpy.types.XrUserPaths.new "bpy.types.XrUserPaths.new") * [`XrUserPaths.remove`](XrUserPaths.md#bpy.types.XrUserPaths.remove "bpy.types.XrUserPaths.remove") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.XrUserPath.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.XrUserPath.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* XrUserPath(bpy\_struct)
  + [`XrUserPath`](#bpy.types.XrUserPath)
    - [`XrUserPath.path`](#bpy.types.XrUserPath.path)
    - [`XrUserPath.bl_rna_get_subclass()`](#bpy.types.XrUserPath.bl_rna_get_subclass)
    - [`XrUserPath.bl_rna_get_subclass_py()`](#bpy.types.XrUserPath.bl_rna_get_subclass_py)
