...
:   Collection of Strips
    ...
    :   Add a new image strip
        ...
        :   * **name** (*string**,* *(**never None**)*) – Name for the new strip
            ...
            * **channel** (*int in* *[**1**,* *128**]*) – Channel, The channel for the new strip
            * **frame\_start** (*int in* *[**-1048574**,* *1048574**]*) – The start frame for the new strip
            * **fit\_method** (enum in [Strip Scale Method Items](../../../appendix/bpy_types_enum_items/strip_scale_method_items.md#rna-enum-strip-scale-method-items), (optional)) – Image Fit Method
    ...
    new\_effect(*name*, *type*, *channel*, *frame\_start*, *\**, *length=0*, *input1=None*, *input2=None*)[¶](#bpy.types.StripsTopLevel.new_effect "Link to this definition")
...
|  |  |
| --- | --- |
| * [`SequenceEditor.strips`](SequenceEditor.md#bpy.types.SequenceEditor.strips "bpy.types.SequenceEditor.strips") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.StripsTopLevel.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.StripsTopLevel.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)
