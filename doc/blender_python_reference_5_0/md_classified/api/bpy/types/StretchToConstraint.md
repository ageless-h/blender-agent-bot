...
# StretchToConstraint(Constraint)[¶](#stretchtoconstraint-constraint "Link to this heading")
...
*class* bpy.types.StretchToConstraint(*Constraint*)[¶](#bpy.types.StretchToConstraint "Link to this definition")
:   Stretch to meet the target object

    bulge[¶](#bpy.types.StretchToConstraint.bulge "Link to this definition")
    :   Factor between volume variation and stretching

        Type:
        :   float in [0, 100], default 0.0

    bulge\_max[¶](#bpy.types.StretchToConstraint.bulge_max "Link to this definition")
    :   Maximum volume stretching factor

        Type:
        :   float in [1, 100], default 0.0

    bulge\_min[¶](#bpy.types.StretchToConstraint.bulge_min "Link to this definition")
    :   Minimum volume stretching factor

        Type:
        :   float in [0, 1], default 0.0

    bulge\_smooth[¶](#bpy.types.StretchToConstraint.bulge_smooth "Link to this definition")
    :   Strength of volume stretching clamping

        Type:
        :   float in [0, 1], default 0.0

    head\_tail[¶](#bpy.types.StretchToConstraint.head_tail "Link to this definition")
    :   Target along length of bone: Head is 0, Tail is 1

        Type:
        :   float in [0, 1], default 0.0

    keep\_axis[¶](#bpy.types.StretchToConstraint.keep_axis "Link to this definition")
    ...
    rest\_length[¶](#bpy.types.StretchToConstraint.rest_length "Link to this definition")
    :   Length at rest position

        Type:
        :   float in [0, 1000], default 0.0

    subtarget[¶](#bpy.types.StretchToConstraint.subtarget "Link to this definition")
    :   Armature bone, mesh or lattice vertex group, …

        Type:
        :   string, default “”, (never None)

    target[¶](#bpy.types.StretchToConstraint.target "Link to this definition")
    :   Target object

        Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object")

    use\_bbone\_shape[¶](#bpy.types.StretchToConstraint.use_bbone_shape "Link to this definition")
    :   Follow shape of B-Bone segments when calculating Head/Tail position

        Type:
        :   boolean, default False

    use\_bulge\_max[¶](#bpy.types.StretchToConstraint.use_bulge_max "Link to this definition")
    :   Use upper limit for volume variation

        Type:
        :   boolean, default False

    use\_bulge\_min[¶](#bpy.types.StretchToConstraint.use_bulge_min "Link to this definition")
    :   Use lower limit for volume variation

        Type:
        :   boolean, default False

    volume[¶](#bpy.types.StretchToConstraint.volume "Link to this definition")
    :   Maintain the object’s volume as it stretches

        Type:
        :   enum in [`'VOLUME_XZX'`, `'VOLUME_X'`, `'VOLUME_Z'`, `'NO_VOLUME'`], default `'VOLUME_XZX'`

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.StretchToConstraint.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.StretchToConstraint.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.StretchToConstraint.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.StretchToConstraint.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* StretchToConstraint(Constraint)
  + [`StretchToConstraint`](#bpy.types.StretchToConstraint)
    - [`StretchToConstraint.bulge`](#bpy.types.StretchToConstraint.bulge)
    - [`StretchToConstraint.bulge_max`](#bpy.types.StretchToConstraint.bulge_max)
    - [`StretchToConstraint.bulge_min`](#bpy.types.StretchToConstraint.bulge_min)
    - [`StretchToConstraint.bulge_smooth`](#bpy.types.StretchToConstraint.bulge_smooth)
    - [`StretchToConstraint.head_tail`](#bpy.types.StretchToConstraint.head_tail)
    - [`StretchToConstraint.keep_axis`](#bpy.types.StretchToConstraint.keep_axis)
    - [`StretchToConstraint.rest_length`](#bpy.types.StretchToConstraint.rest_length)
    - [`StretchToConstraint.subtarget`](#bpy.types.StretchToConstraint.subtarget)
    - [`StretchToConstraint.target`](#bpy.types.StretchToConstraint.target)
    - [`StretchToConstraint.use_bbone_shape`](#bpy.types.StretchToConstraint.use_bbone_shape)
    - [`StretchToConstraint.use_bulge_max`](#bpy.types.StretchToConstraint.use_bulge_max)
    - [`StretchToConstraint.use_bulge_min`](#bpy.types.StretchToConstraint.use_bulge_min)
    - [`StretchToConstraint.volume`](#bpy.types.StretchToConstraint.volume)
    - [`StretchToConstraint.bl_rna_get_subclass()`](#bpy.types.StretchToConstraint.bl_rna_get_subclass)
    - [`StretchToConstraint.bl_rna_get_subclass_py()`](#bpy.types.StretchToConstraint.bl_rna_get_subclass_py)
