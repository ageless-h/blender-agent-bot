...
# MaskLayers(bpy\_struct)[¶](#masklayers-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.MaskLayers(*bpy\_struct*)[¶](#bpy.types.MaskLayers "Link to this definition")
:   Collection of layers used by mask

    active[¶](#bpy.types.MaskLayers.active "Link to this definition")
    :   Active layer in this mask

        Type:
        :   [`MaskLayer`](MaskLayer.md#bpy.types.MaskLayer "bpy.types.MaskLayer")

    new(*\**, *name=''*)[¶](#bpy.types.MaskLayers.new "Link to this definition")
    :   Add layer to this mask

        Parameters:
        :   **name** (*string**,* *(**optional**,* *never None**)*) – Name, Name of new layer
    ...
    remove(*layer*)[¶](#bpy.types.MaskLayers.remove "Link to this definition")
    :   Remove layer from this mask

        Parameters:
        :   **layer** ([`MaskLayer`](MaskLayer.md#bpy.types.MaskLayer "bpy.types.MaskLayer"), (never None)) – Shape to be removed

    clear()[¶](#bpy.types.MaskLayers.clear "Link to this definition")
    :   Remove all mask layers

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.MaskLayers.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.MaskLayers.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Mask.layers`](Mask.md#bpy.types.Mask.layers "bpy.types.Mask.layers") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.MaskLayers.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.MaskLayers.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* MaskLayers(bpy\_struct)
  + [`MaskLayers`](#bpy.types.MaskLayers)
    - [`MaskLayers.active`](#bpy.types.MaskLayers.active)
    - [`MaskLayers.new()`](#bpy.types.MaskLayers.new)
    - [`MaskLayers.remove()`](#bpy.types.MaskLayers.remove)
    - [`MaskLayers.clear()`](#bpy.types.MaskLayers.clear)
    - [`MaskLayers.bl_rna_get_subclass()`](#bpy.types.MaskLayers.bl_rna_get_subclass)
    - [`MaskLayers.bl_rna_get_subclass_py()`](#bpy.types.MaskLayers.bl_rna_get_subclass_py)
