...
# WoodTexture(Texture)[¶](#woodtexture-texture "Link to this heading")
...
*class* bpy.types.WoodTexture(*Texture*)[¶](#bpy.types.WoodTexture "Link to this definition")
:   Procedural noise texture

    nabla[¶](#bpy.types.WoodTexture.nabla "Link to this definition")
    :   Size of derivative offset used for calculating normal

        Type:
        :   float in [0.001, 0.1], default 0.025

    noise\_basis[¶](#bpy.types.WoodTexture.noise_basis "Link to this definition")
    ...
    noise\_basis\_2[¶](#bpy.types.WoodTexture.noise_basis_2 "Link to this definition")
    :   * `SIN`
    ...
    noise\_scale[¶](#bpy.types.WoodTexture.noise_scale "Link to this definition")
    :   Scaling for noise input

        Type:
        :   float in [0.0001, inf], default 0.25

    noise\_type[¶](#bpy.types.WoodTexture.noise_type "Link to this definition")
    :   * `SOFT_NOISE`
    ...
    turbulence[¶](#bpy.types.WoodTexture.turbulence "Link to this definition")
    :   Turbulence of the bandnoise and ringnoise types

        Type:
        :   float in [0.0001, inf], default 5.0

    wood\_type[¶](#bpy.types.WoodTexture.wood_type "Link to this definition")
    :   * `BANDS`
    ...
    users\_material[¶](#bpy.types.WoodTexture.users_material "Link to this definition")
    ...
    users\_object\_modifier[¶](#bpy.types.WoodTexture.users_object_modifier "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.WoodTexture.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.WoodTexture.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.WoodTexture.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.WoodTexture.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* WoodTexture(Texture)
  + [`WoodTexture`](#bpy.types.WoodTexture)
    - [`WoodTexture.nabla`](#bpy.types.WoodTexture.nabla)
    - [`WoodTexture.noise_basis`](#bpy.types.WoodTexture.noise_basis)
    - [`WoodTexture.noise_basis_2`](#bpy.types.WoodTexture.noise_basis_2)
    - [`WoodTexture.noise_scale`](#bpy.types.WoodTexture.noise_scale)
    - [`WoodTexture.noise_type`](#bpy.types.WoodTexture.noise_type)
    - [`WoodTexture.turbulence`](#bpy.types.WoodTexture.turbulence)
    - [`WoodTexture.wood_type`](#bpy.types.WoodTexture.wood_type)
    - [`WoodTexture.users_material`](#bpy.types.WoodTexture.users_material)
    - [`WoodTexture.users_object_modifier`](#bpy.types.WoodTexture.users_object_modifier)
    - [`WoodTexture.bl_rna_get_subclass()`](#bpy.types.WoodTexture.bl_rna_get_subclass)
    - [`WoodTexture.bl_rna_get_subclass_py()`](#bpy.types.WoodTexture.bl_rna_get_subclass_py)
