...
# ImageUser(bpy\_struct)[¶](#imageuser-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.ImageUser(*bpy\_struct*)[¶](#bpy.types.ImageUser "Link to this definition")
:   Parameters defining how an Image data-block is used by another data-block

    frame\_current[¶](#bpy.types.ImageUser.frame_current "Link to this definition")
    :   Current frame number in image sequence or movie

        Type:
        :   int in [-1048574, 1048574], default 0

    frame\_duration[¶](#bpy.types.ImageUser.frame_duration "Link to this definition")
    :   Number of images of a movie to use

        Type:
        :   int in [0, 1048574], default 0

    frame\_offset[¶](#bpy.types.ImageUser.frame_offset "Link to this definition")
    :   Offset the number of the frame to use in the animation

        Type:
        :   int in [-inf, inf], default 0

    frame\_start[¶](#bpy.types.ImageUser.frame_start "Link to this definition")
    :   Global starting frame of the movie/sequence, assuming first picture has a #1

        Type:
        :   int in [-1048574, 1048574], default 0

    multilayer\_layer[¶](#bpy.types.ImageUser.multilayer_layer "Link to this definition")
    :   Layer in multilayer image

        Type:
        :   int in [0, 32767], default 0, (readonly)

    multilayer\_pass[¶](#bpy.types.ImageUser.multilayer_pass "Link to this definition")
    :   Pass in multilayer image

        Type:
        :   int in [0, 32767], default 0, (readonly)

    multilayer\_view[¶](#bpy.types.ImageUser.multilayer_view "Link to this definition")
    :   View in multilayer image

        Type:
        :   int in [0, 32767], default 0, (readonly)

    tile[¶](#bpy.types.ImageUser.tile "Link to this definition")
    :   Tile in tiled image

        Type:
        :   int in [0, inf], default 0

    use\_auto\_refresh[¶](#bpy.types.ImageUser.use_auto_refresh "Link to this definition")
    :   Always refresh image on frame changes

        Type:
        :   boolean, default False

    use\_cyclic[¶](#bpy.types.ImageUser.use_cyclic "Link to this definition")
    :   Cycle the images in the movie

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ImageUser.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ImageUser.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`CameraBackgroundImage.image_user`](CameraBackgroundImage.md#bpy.types.CameraBackgroundImage.image_user "bpy.types.CameraBackgroundImage.image_user") * [`Image.filepath_from_user`](Image.md#bpy.types.Image.filepath_from_user "bpy.types.Image.filepath_from_user") * [`ImageTexture.image_user`](ImageTexture.md#bpy.types.ImageTexture.image_user "bpy.types.ImageTexture.image_user") * [`Object.image_user`](Object.md#bpy.types.Object.image_user "bpy.types.Object.image_user") * [`RenderSlot.clear`](RenderSlot.md#bpy.types.RenderSlot.clear "bpy.types.RenderSlot.clear") * [`ShaderNodeTexEnvironment.image_user`](ShaderNodeTexEnvironment.md#bpy.types.ShaderNodeTexEnvironment.image_user "bpy.types.ShaderNodeTexEnvironment.image_user") | * [`ShaderNodeTexImage.image_user`](ShaderNodeTexImage.md#bpy.types.ShaderNodeTexImage.image_user "bpy.types.ShaderNodeTexImage.image_user") * [`SpaceImageEditor.image_user`](SpaceImageEditor.md#bpy.types.SpaceImageEditor.image_user "bpy.types.SpaceImageEditor.image_user") * [`TextureNodeImage.image_user`](TextureNodeImage.md#bpy.types.TextureNodeImage.image_user "bpy.types.TextureNodeImage.image_user") * [`UILayout.template_image`](UILayout.md#bpy.types.UILayout.template_image "bpy.types.UILayout.template_image") * [`UILayout.template_image_layers`](UILayout.md#bpy.types.UILayout.template_image_layers "bpy.types.UILayout.template_image_layers") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ImageUser.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ImageUser.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ImageUser(bpy\_struct)
  + [`ImageUser`](#bpy.types.ImageUser)
    - [`ImageUser.frame_current`](#bpy.types.ImageUser.frame_current)
    - [`ImageUser.frame_duration`](#bpy.types.ImageUser.frame_duration)
    - [`ImageUser.frame_offset`](#bpy.types.ImageUser.frame_offset)
    - [`ImageUser.frame_start`](#bpy.types.ImageUser.frame_start)
    - [`ImageUser.multilayer_layer`](#bpy.types.ImageUser.multilayer_layer)
    - [`ImageUser.multilayer_pass`](#bpy.types.ImageUser.multilayer_pass)
    - [`ImageUser.multilayer_view`](#bpy.types.ImageUser.multilayer_view)
    - [`ImageUser.tile`](#bpy.types.ImageUser.tile)
    - [`ImageUser.use_auto_refresh`](#bpy.types.ImageUser.use_auto_refresh)
    - [`ImageUser.use_cyclic`](#bpy.types.ImageUser.use_cyclic)
    - [`ImageUser.bl_rna_get_subclass()`](#bpy.types.ImageUser.bl_rna_get_subclass)
    - [`ImageUser.bl_rna_get_subclass_py()`](#bpy.types.ImageUser.bl_rna_get_subclass_py)
