...
# AnnotationLayers(bpy\_struct)[¶](#annotationlayers-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.AnnotationLayers(*bpy\_struct*)[¶](#bpy.types.AnnotationLayers "Link to this definition")
:   Collection of annotation layers

    active\_index[¶](#bpy.types.AnnotationLayers.active_index "Link to this definition")
    :   Index of active annotation layer

        Type:
        :   int in [0, inf], default 0

    active\_note[¶](#bpy.types.AnnotationLayers.active_note "Link to this definition")
    :   Note/Layer to add annotation strokes to

        Type:
        :   enum in [`'DEFAULT'`], default `'DEFAULT'`

    new(*name*, *\**, *set\_active=True*)[¶](#bpy.types.AnnotationLayers.new "Link to this definition")
    :   Add a new annotation layer
        ...
        Return type:
        :   [`AnnotationLayer`](AnnotationLayer.md#bpy.types.AnnotationLayer "bpy.types.AnnotationLayer")

    remove(*layer*)[¶](#bpy.types.AnnotationLayers.remove "Link to this definition")
    :   Remove a annotation layer

        Parameters:
        :   **layer** ([`AnnotationLayer`](AnnotationLayer.md#bpy.types.AnnotationLayer "bpy.types.AnnotationLayer"), (never None)) – The layer to remove

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.AnnotationLayers.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.AnnotationLayers.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Annotation.layers`](Annotation.md#bpy.types.Annotation.layers "bpy.types.Annotation.layers") |  |

[Next

AnnotationStroke(bpy\_struct)](AnnotationStroke.md)
[Previous

AnnotationLayer(bpy\_struct)](AnnotationLayer.md)
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.AnnotationLayers.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.AnnotationLayers.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* AnnotationLayers(bpy\_struct)
  + [`AnnotationLayers`](#bpy.types.AnnotationLayers)
    - [`AnnotationLayers.active_index`](#bpy.types.AnnotationLayers.active_index)
    - [`AnnotationLayers.active_note`](#bpy.types.AnnotationLayers.active_note)
    - [`AnnotationLayers.new()`](#bpy.types.AnnotationLayers.new)
    - [`AnnotationLayers.remove()`](#bpy.types.AnnotationLayers.remove)
    - [`AnnotationLayers.bl_rna_get_subclass()`](#bpy.types.AnnotationLayers.bl_rna_get_subclass)
    - [`AnnotationLayers.bl_rna_get_subclass_py()`](#bpy.types.AnnotationLayers.bl_rna_get_subclass_py)
