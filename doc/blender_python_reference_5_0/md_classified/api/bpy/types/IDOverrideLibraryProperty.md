...
# IDOverrideLibraryProperty(bpy\_struct)[¶](#idoverridelibraryproperty-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.IDOverrideLibraryProperty(*bpy\_struct*)[¶](#bpy.types.IDOverrideLibraryProperty "Link to this definition")
:   Description of an overridden property

    operations[¶](#bpy.types.IDOverrideLibraryProperty.operations "Link to this definition")
    :   List of overriding operations for a property

        Type:
        :   [`IDOverrideLibraryPropertyOperations`](IDOverrideLibraryPropertyOperations.md#bpy.types.IDOverrideLibraryPropertyOperations "bpy.types.IDOverrideLibraryPropertyOperations") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`IDOverrideLibraryPropertyOperation`](IDOverrideLibraryPropertyOperation.md#bpy.types.IDOverrideLibraryPropertyOperation "bpy.types.IDOverrideLibraryPropertyOperation"), (readonly)

    rna\_path[¶](#bpy.types.IDOverrideLibraryProperty.rna_path "Link to this definition")
    :   RNA path leading to that property, from owning ID

        Type:
        :   string, default “”, (readonly, never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.IDOverrideLibraryProperty.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.IDOverrideLibraryProperty.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`IDOverrideLibrary.properties`](IDOverrideLibrary.md#bpy.types.IDOverrideLibrary.properties "bpy.types.IDOverrideLibrary.properties") * [`IDOverrideLibraryProperties.add`](IDOverrideLibraryProperties.md#bpy.types.IDOverrideLibraryProperties.add "bpy.types.IDOverrideLibraryProperties.add") | * [`IDOverrideLibraryProperties.remove`](IDOverrideLibraryProperties.md#bpy.types.IDOverrideLibraryProperties.remove "bpy.types.IDOverrideLibraryProperties.remove") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.IDOverrideLibraryProperty.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.IDOverrideLibraryProperty.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* IDOverrideLibraryProperty(bpy\_struct)
  + [`IDOverrideLibraryProperty`](#bpy.types.IDOverrideLibraryProperty)
    - [`IDOverrideLibraryProperty.operations`](#bpy.types.IDOverrideLibraryProperty.operations)
    - [`IDOverrideLibraryProperty.rna_path`](#bpy.types.IDOverrideLibraryProperty.rna_path)
    - [`IDOverrideLibraryProperty.bl_rna_get_subclass()`](#bpy.types.IDOverrideLibraryProperty.bl_rna_get_subclass)
    - [`IDOverrideLibraryProperty.bl_rna_get_subclass_py()`](#bpy.types.IDOverrideLibraryProperty.bl_rna_get_subclass_py)
