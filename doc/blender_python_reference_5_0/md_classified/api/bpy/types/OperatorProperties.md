...
# OperatorProperties(bpy\_struct)[¶](#operatorproperties-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.OperatorProperties(*bpy\_struct*)[¶](#bpy.types.OperatorProperties "Link to this definition")
:   Input properties of an operator

    bl\_system\_properties\_get(*\**, *do\_create=False*)[¶](#bpy.types.OperatorProperties.bl_system_properties_get "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.OperatorProperties.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.OperatorProperties.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Gizmo.target_set_operator`](Gizmo.md#bpy.types.Gizmo.target_set_operator "bpy.types.Gizmo.target_set_operator") * [`KeyConfigurations.find_item_from_operator`](KeyConfigurations.md#bpy.types.KeyConfigurations.find_item_from_operator "bpy.types.KeyConfigurations.find_item_from_operator") * [`KeyMapItem.properties`](KeyMapItem.md#bpy.types.KeyMapItem.properties "bpy.types.KeyMapItem.properties") * [`KeyMapItems.find_from_operator`](KeyMapItems.md#bpy.types.KeyMapItems.find_from_operator "bpy.types.KeyMapItems.find_from_operator") * [`Macro.properties`](Macro.md#bpy.types.Macro.properties "bpy.types.Macro.properties") * [`Operator.description`](Operator.md#bpy.types.Operator.description "bpy.types.Operator.description") * [`Operator.properties`](Operator.md#bpy.types.Operator.properties "bpy.types.Operator.properties") * [`OperatorMacro.properties`](OperatorMacro.md#bpy.types.OperatorMacro.properties "bpy.types.OperatorMacro.properties") | * [`UILayout.operator`](UILayout.md#bpy.types.UILayout.operator "bpy.types.UILayout.operator") * [`UILayout.operator_menu_enum`](UILayout.md#bpy.types.UILayout.operator_menu_enum "bpy.types.UILayout.operator_menu_enum") * [`UILayout.operator_menu_hold`](UILayout.md#bpy.types.UILayout.operator_menu_hold "bpy.types.UILayout.operator_menu_hold") * [`UILayout.template_popup_confirm`](UILayout.md#bpy.types.UILayout.template_popup_confirm "bpy.types.UILayout.template_popup_confirm") * [`WindowManager.operator_properties_last`](WindowManager.md#bpy.types.WindowManager.operator_properties_last "bpy.types.WindowManager.operator_properties_last") * [`WorkSpaceTool.operator_properties`](WorkSpaceTool.md#bpy.types.WorkSpaceTool.operator_properties "bpy.types.WorkSpaceTool.operator_properties") * [`XrActionMapItem.op_properties`](XrActionMapItem.md#bpy.types.XrActionMapItem.op_properties "bpy.types.XrActionMapItem.op_properties") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.OperatorProperties.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.OperatorProperties.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* OperatorProperties(bpy\_struct)
  + [`OperatorProperties`](#bpy.types.OperatorProperties)
    - [`OperatorProperties.bl_system_properties_get()`](#bpy.types.OperatorProperties.bl_system_properties_get)
    - [`OperatorProperties.bl_rna_get_subclass()`](#bpy.types.OperatorProperties.bl_rna_get_subclass)
    - [`OperatorProperties.bl_rna_get_subclass_py()`](#bpy.types.OperatorProperties.bl_rna_get_subclass_py)
