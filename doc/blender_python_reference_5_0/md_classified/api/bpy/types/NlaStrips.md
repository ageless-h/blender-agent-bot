...
# NlaStrips(bpy\_struct)[¶](#nlastrips-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.NlaStrips(*bpy\_struct*)[¶](#bpy.types.NlaStrips "Link to this definition")
:   Collection of NLA Strips

    new(*name*, *start*, *action*)[¶](#bpy.types.NlaStrips.new "Link to this definition")
    :   Add a new Action-Clip strip to the track

        Parameters:
        :   * **name** (*string**,* *(**never None**)*) – Name for the NLA Strip
            * **start** (*int in* *[**-inf**,* *inf**]*) – Start Frame, Start frame for this strip
            * **action** ([`Action`](Action.md#bpy.types.Action "bpy.types.Action"), (never None)) – Action to assign to this strip

        Returns:
        :   New NLA Strip

        Return type:
        :   [`NlaStrip`](NlaStrip.md#bpy.types.NlaStrip "bpy.types.NlaStrip")

    remove(*strip*)[¶](#bpy.types.NlaStrips.remove "Link to this definition")
    :   Remove a NLA Strip

        Parameters:
        :   **strip** ([`NlaStrip`](NlaStrip.md#bpy.types.NlaStrip "bpy.types.NlaStrip"), (never None)) – NLA Strip to remove

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.NlaStrips.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.NlaStrips.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.NlaStrips.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.NlaStrips.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* NlaStrips(bpy\_struct)
  + [`NlaStrips`](#bpy.types.NlaStrips)
    - [`NlaStrips.new()`](#bpy.types.NlaStrips.new)
    - [`NlaStrips.remove()`](#bpy.types.NlaStrips.remove)
    - [`NlaStrips.bl_rna_get_subclass()`](#bpy.types.NlaStrips.bl_rna_get_subclass)
    - [`NlaStrips.bl_rna_get_subclass_py()`](#bpy.types.NlaStrips.bl_rna_get_subclass_py)
