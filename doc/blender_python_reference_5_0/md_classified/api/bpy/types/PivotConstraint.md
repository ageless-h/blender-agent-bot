...
# PivotConstraint(Constraint)[¶](#pivotconstraint-constraint "Link to this heading")
...
*class* bpy.types.PivotConstraint(*Constraint*)[¶](#bpy.types.PivotConstraint "Link to this definition")
:   Rotate around a different point

    head\_tail[¶](#bpy.types.PivotConstraint.head_tail "Link to this definition")
    :   Target along length of bone: Head is 0, Tail is 1

        Type:
        :   float in [0, 1], default 0.0

    offset[¶](#bpy.types.PivotConstraint.offset "Link to this definition")
    ...
    rotation\_range[¶](#bpy.types.PivotConstraint.rotation_range "Link to this definition")
    ...
    subtarget[¶](#bpy.types.PivotConstraint.subtarget "Link to this definition")
    :   Type:
        :   string, default “”, (never None)

    target[¶](#bpy.types.PivotConstraint.target "Link to this definition")
    :   Target Object, defining the position of the pivot when defined

        Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object")

    use\_bbone\_shape[¶](#bpy.types.PivotConstraint.use_bbone_shape "Link to this definition")
    :   Follow shape of B-Bone segments when calculating Head/Tail position

        Type:
        :   boolean, default False

    use\_relative\_location[¶](#bpy.types.PivotConstraint.use_relative_location "Link to this definition")
    :   Offset will be an absolute point in space instead of relative to the target

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.PivotConstraint.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.PivotConstraint.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.PivotConstraint.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.PivotConstraint.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* PivotConstraint(Constraint)
  + [`PivotConstraint`](#bpy.types.PivotConstraint)
    - [`PivotConstraint.head_tail`](#bpy.types.PivotConstraint.head_tail)
    - [`PivotConstraint.offset`](#bpy.types.PivotConstraint.offset)
    - [`PivotConstraint.rotation_range`](#bpy.types.PivotConstraint.rotation_range)
    - [`PivotConstraint.subtarget`](#bpy.types.PivotConstraint.subtarget)
    - [`PivotConstraint.target`](#bpy.types.PivotConstraint.target)
    - [`PivotConstraint.use_bbone_shape`](#bpy.types.PivotConstraint.use_bbone_shape)
    - [`PivotConstraint.use_relative_location`](#bpy.types.PivotConstraint.use_relative_location)
    - [`PivotConstraint.bl_rna_get_subclass()`](#bpy.types.PivotConstraint.bl_rna_get_subclass)
    - [`PivotConstraint.bl_rna_get_subclass_py()`](#bpy.types.PivotConstraint.bl_rna_get_subclass_py)
