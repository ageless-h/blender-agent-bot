...
# NodeEnableOutput(NodeInternal)[¶](#nodeenableoutput-nodeinternal "Link to this heading")
...
*class* bpy.types.NodeEnableOutput(*NodeInternal*)[¶](#bpy.types.NodeEnableOutput "Link to this definition")
:   Either pass through the input value or output the fallback value

    data\_type[¶](#bpy.types.NodeEnableOutput.data_type "Link to this definition")
    :   Type:
    ...
    *classmethod* is\_registered\_node\_type()[¶](#bpy.types.NodeEnableOutput.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[¶](#bpy.types.NodeEnableOutput.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[¶](#bpy.types.NodeEnableOutput.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.NodeEnableOutput.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.NodeEnableOutput.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.NodeEnableOutput.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.NodeEnableOutput.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* NodeEnableOutput(NodeInternal)
  + [`NodeEnableOutput`](#bpy.types.NodeEnableOutput)
    - [`NodeEnableOutput.data_type`](#bpy.types.NodeEnableOutput.data_type)
    - [`NodeEnableOutput.is_registered_node_type()`](#bpy.types.NodeEnableOutput.is_registered_node_type)
    - [`NodeEnableOutput.input_template()`](#bpy.types.NodeEnableOutput.input_template)
    - [`NodeEnableOutput.output_template()`](#bpy.types.NodeEnableOutput.output_template)
    - [`NodeEnableOutput.bl_rna_get_subclass()`](#bpy.types.NodeEnableOutput.bl_rna_get_subclass)
    - [`NodeEnableOutput.bl_rna_get_subclass_py()`](#bpy.types.NodeEnableOutput.bl_rna_get_subclass_py)
