...
# ThemeCommonCurves(bpy\_struct)[¶](#themecommoncurves-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.ThemeCommonCurves(*bpy\_struct*)[¶](#bpy.types.ThemeCommonCurves "Link to this definition")
:   Shared curve theme properties

    handle\_align[¶](#bpy.types.ThemeCommonCurves.handle_align "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    handle\_auto[¶](#bpy.types.ThemeCommonCurves.handle_auto "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    handle\_auto\_clamped[¶](#bpy.types.ThemeCommonCurves.handle_auto_clamped "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    handle\_free[¶](#bpy.types.ThemeCommonCurves.handle_free "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    handle\_sel\_align[¶](#bpy.types.ThemeCommonCurves.handle_sel_align "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    handle\_sel\_auto[¶](#bpy.types.ThemeCommonCurves.handle_sel_auto "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    handle\_sel\_auto\_clamped[¶](#bpy.types.ThemeCommonCurves.handle_sel_auto_clamped "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    handle\_sel\_free[¶](#bpy.types.ThemeCommonCurves.handle_sel_free "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    handle\_sel\_vect[¶](#bpy.types.ThemeCommonCurves.handle_sel_vect "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    handle\_vect[¶](#bpy.types.ThemeCommonCurves.handle_vect "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    handle\_vertex[¶](#bpy.types.ThemeCommonCurves.handle_vertex "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    handle\_vertex\_select[¶](#bpy.types.ThemeCommonCurves.handle_vertex_select "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    handle\_vertex\_size[¶](#bpy.types.ThemeCommonCurves.handle_vertex_size "Link to this definition")
    :   Type:
        :   int in [1, 100], default 0

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ThemeCommonCurves.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ThemeCommonCurves.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`ThemeCommon.curves`](ThemeCommon.md#bpy.types.ThemeCommon.curves "bpy.types.ThemeCommon.curves") |  |
...
ThemeCommonAnim(bpy\_struct)](ThemeCommonAnim.md)
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ThemeCommonCurves.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ThemeCommonCurves.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ThemeCommonCurves(bpy\_struct)
  + [`ThemeCommonCurves`](#bpy.types.ThemeCommonCurves)
    - [`ThemeCommonCurves.handle_align`](#bpy.types.ThemeCommonCurves.handle_align)
    - [`ThemeCommonCurves.handle_auto`](#bpy.types.ThemeCommonCurves.handle_auto)
    - [`ThemeCommonCurves.handle_auto_clamped`](#bpy.types.ThemeCommonCurves.handle_auto_clamped)
    - [`ThemeCommonCurves.handle_free`](#bpy.types.ThemeCommonCurves.handle_free)
    - [`ThemeCommonCurves.handle_sel_align`](#bpy.types.ThemeCommonCurves.handle_sel_align)
    - [`ThemeCommonCurves.handle_sel_auto`](#bpy.types.ThemeCommonCurves.handle_sel_auto)
    - [`ThemeCommonCurves.handle_sel_auto_clamped`](#bpy.types.ThemeCommonCurves.handle_sel_auto_clamped)
    - [`ThemeCommonCurves.handle_sel_free`](#bpy.types.ThemeCommonCurves.handle_sel_free)
    - [`ThemeCommonCurves.handle_sel_vect`](#bpy.types.ThemeCommonCurves.handle_sel_vect)
    - [`ThemeCommonCurves.handle_vect`](#bpy.types.ThemeCommonCurves.handle_vect)
    - [`ThemeCommonCurves.handle_vertex`](#bpy.types.ThemeCommonCurves.handle_vertex)
    - [`ThemeCommonCurves.handle_vertex_select`](#bpy.types.ThemeCommonCurves.handle_vertex_select)
    - [`ThemeCommonCurves.handle_vertex_size`](#bpy.types.ThemeCommonCurves.handle_vertex_size)
    - [`ThemeCommonCurves.bl_rna_get_subclass()`](#bpy.types.ThemeCommonCurves.bl_rna_get_subclass)
    - [`ThemeCommonCurves.bl_rna_get_subclass_py()`](#bpy.types.ThemeCommonCurves.bl_rna_get_subclass_py)
