...
# CurveProfilePoints(bpy\_struct)[¶](#curveprofilepoints-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.CurveProfilePoints(*bpy\_struct*)[¶](#bpy.types.CurveProfilePoints "Link to this definition")
:   Collection of Profile Points

    add(*x*, *y*)[¶](#bpy.types.CurveProfilePoints.add "Link to this definition")
    :   Add point to the profile
        ...
        Return type:
        :   [`CurveProfilePoint`](CurveProfilePoint.md#bpy.types.CurveProfilePoint "bpy.types.CurveProfilePoint")

    remove(*point*)[¶](#bpy.types.CurveProfilePoints.remove "Link to this definition")
    :   Delete point from the profile

        Parameters:
        :   **point** ([`CurveProfilePoint`](CurveProfilePoint.md#bpy.types.CurveProfilePoint "bpy.types.CurveProfilePoint"), (never None)) – Point to remove

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.CurveProfilePoints.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.CurveProfilePoints.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`CurveProfile.points`](CurveProfile.md#bpy.types.CurveProfile.points "bpy.types.CurveProfile.points") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CurveProfilePoints.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.CurveProfilePoints.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CurveProfilePoints(bpy\_struct)
  + [`CurveProfilePoints`](#bpy.types.CurveProfilePoints)
    - [`CurveProfilePoints.add()`](#bpy.types.CurveProfilePoints.add)
    - [`CurveProfilePoints.remove()`](#bpy.types.CurveProfilePoints.remove)
    - [`CurveProfilePoints.bl_rna_get_subclass()`](#bpy.types.CurveProfilePoints.bl_rna_get_subclass)
    - [`CurveProfilePoints.bl_rna_get_subclass_py()`](#bpy.types.CurveProfilePoints.bl_rna_get_subclass_py)
