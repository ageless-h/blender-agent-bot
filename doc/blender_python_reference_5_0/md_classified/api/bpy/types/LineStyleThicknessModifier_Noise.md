...
# LineStyleThicknessModifier\_Noise(LineStyleThicknessModifier)[¶](#linestylethicknessmodifier-noise-linestylethicknessmodifier "Link to this heading")
...
*class* bpy.types.LineStyleThicknessModifier\_Noise(*LineStyleThicknessModifier*)[¶](#bpy.types.LineStyleThicknessModifier_Noise "Link to this definition")
:   Line thickness based on random noise

    amplitude[¶](#bpy.types.LineStyleThicknessModifier_Noise.amplitude "Link to this definition")
    :   Amplitude of the noise

        Type:
        :   float in [-inf, inf], default 0.0

    blend[¶](#bpy.types.LineStyleThicknessModifier_Noise.blend "Link to this definition")
    :   Specify how the modifier value is blended into the base value

        Type:
        :   enum in [`'MIX'`, `'ADD'`, `'SUBTRACT'`, `'MULTIPLY'`, `'DIVIDE'`, `'DIFFERENCE'`, `'MINIMUM'`, `'MAXIMUM'`], default `'MIX'`

    expanded[¶](#bpy.types.LineStyleThicknessModifier_Noise.expanded "Link to this definition")
    :   True if the modifier tab is expanded

        Type:
        :   boolean, default False

    influence[¶](#bpy.types.LineStyleThicknessModifier_Noise.influence "Link to this definition")
    :   Influence factor by which the modifier changes the property

        Type:
        :   float in [0, 1], default 0.0

    period[¶](#bpy.types.LineStyleThicknessModifier_Noise.period "Link to this definition")
    :   Period of the noise

        Type:
        :   float in [-inf, inf], default 0.0

    seed[¶](#bpy.types.LineStyleThicknessModifier_Noise.seed "Link to this definition")
    :   Seed for the noise generation

        Type:
        :   int in [1, 32767], default 0

    type[¶](#bpy.types.LineStyleThicknessModifier_Noise.type "Link to this definition")
    ...
    use[¶](#bpy.types.LineStyleThicknessModifier_Noise.use "Link to this definition")
    :   Enable or disable this modifier during stroke rendering

        Type:
        :   boolean, default False

    use\_asymmetric[¶](#bpy.types.LineStyleThicknessModifier_Noise.use_asymmetric "Link to this definition")
    :   Allow thickness to be assigned asymmetrically

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.LineStyleThicknessModifier_Noise.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.LineStyleThicknessModifier_Noise.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
        ...
        Return type:
        :   [type](#bpy.types.LineStyleThicknessModifier_Noise.type "bpy.types.LineStyleThicknessModifier_Noise.type")
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.LineStyleThicknessModifier_Noise.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.LineStyleThicknessModifier_Noise.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* LineStyleThicknessModifier\_Noise(LineStyleThicknessModifier)
  + [`LineStyleThicknessModifier_Noise`](#bpy.types.LineStyleThicknessModifier_Noise)
    - [`LineStyleThicknessModifier_Noise.amplitude`](#bpy.types.LineStyleThicknessModifier_Noise.amplitude)
    - [`LineStyleThicknessModifier_Noise.blend`](#bpy.types.LineStyleThicknessModifier_Noise.blend)
    - [`LineStyleThicknessModifier_Noise.expanded`](#bpy.types.LineStyleThicknessModifier_Noise.expanded)
    - [`LineStyleThicknessModifier_Noise.influence`](#bpy.types.LineStyleThicknessModifier_Noise.influence)
    - [`LineStyleThicknessModifier_Noise.period`](#bpy.types.LineStyleThicknessModifier_Noise.period)
    - [`LineStyleThicknessModifier_Noise.seed`](#bpy.types.LineStyleThicknessModifier_Noise.seed)
    - [`LineStyleThicknessModifier_Noise.type`](#bpy.types.LineStyleThicknessModifier_Noise.type)
    - [`LineStyleThicknessModifier_Noise.use`](#bpy.types.LineStyleThicknessModifier_Noise.use)
    - [`LineStyleThicknessModifier_Noise.use_asymmetric`](#bpy.types.LineStyleThicknessModifier_Noise.use_asymmetric)
    - [`LineStyleThicknessModifier_Noise.bl_rna_get_subclass()`](#bpy.types.LineStyleThicknessModifier_Noise.bl_rna_get_subclass)
    - [`LineStyleThicknessModifier_Noise.bl_rna_get_subclass_py()`](#bpy.types.LineStyleThicknessModifier_Noise.bl_rna_get_subclass_py)
