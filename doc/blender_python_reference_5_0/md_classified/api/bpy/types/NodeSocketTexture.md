...
# NodeSocketTexture(NodeSocketStandard)[¶](#nodesockettexture-nodesocketstandard "Link to this heading")
...
*class* bpy.types.NodeSocketTexture(*NodeSocketStandard*)[¶](#bpy.types.NodeSocketTexture "Link to this definition")
:   Texture socket of a node

    default\_value[¶](#bpy.types.NodeSocketTexture.default_value "Link to this definition")
    :   Input value used for unconnected socket

        Type:
        :   [`Texture`](Texture.md#bpy.types.Texture "bpy.types.Texture")

    links[¶](#bpy.types.NodeSocketTexture.links "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.NodeSocketTexture.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.NodeSocketTexture.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
NodeSocketStringFilePath(NodeSocketStandard)](NodeSocketStringFilePath.md)
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.NodeSocketTexture.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.NodeSocketTexture.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* NodeSocketTexture(NodeSocketStandard)
  + [`NodeSocketTexture`](#bpy.types.NodeSocketTexture)
    - [`NodeSocketTexture.default_value`](#bpy.types.NodeSocketTexture.default_value)
    - [`NodeSocketTexture.links`](#bpy.types.NodeSocketTexture.links)
    - [`NodeSocketTexture.bl_rna_get_subclass()`](#bpy.types.NodeSocketTexture.bl_rna_get_subclass)
    - [`NodeSocketTexture.bl_rna_get_subclass_py()`](#bpy.types.NodeSocketTexture.bl_rna_get_subclass_py)
