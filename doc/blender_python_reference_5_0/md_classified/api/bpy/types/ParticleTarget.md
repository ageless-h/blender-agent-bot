...
# ParticleTarget(bpy\_struct)[¶](#particletarget-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.ParticleTarget(*bpy\_struct*)[¶](#bpy.types.ParticleTarget "Link to this definition")
:   Target particle system

    alliance[¶](#bpy.types.ParticleTarget.alliance "Link to this definition")
    :   Type:
        :   enum in [`'FRIEND'`, `'NEUTRAL'`, `'ENEMY'`], default `'NEUTRAL'`

    duration[¶](#bpy.types.ParticleTarget.duration "Link to this definition")
    :   Type:
        :   float in [0, 1.04857e+06], default 0.0

    is\_valid[¶](#bpy.types.ParticleTarget.is_valid "Link to this definition")
    :   Keyed particles target is valid

        Type:
        :   boolean, default False

    name[¶](#bpy.types.ParticleTarget.name "Link to this definition")
    :   Particle target name

        Type:
        :   string, default “”, (readonly, never None)

    object[¶](#bpy.types.ParticleTarget.object "Link to this definition")
    :   The object that has the target particle system (empty if same object)

        Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object")

    system[¶](#bpy.types.ParticleTarget.system "Link to this definition")
    :   The index of particle system on the target object

        Type:
        :   int in [1, inf], default 0

    time[¶](#bpy.types.ParticleTarget.time "Link to this definition")
    :   Type:
        :   float in [0, 1.04857e+06], default 0.0

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ParticleTarget.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ParticleTarget.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`ParticleSystem.active_particle_target`](ParticleSystem.md#bpy.types.ParticleSystem.active_particle_target "bpy.types.ParticleSystem.active_particle_target") | * [`ParticleSystem.targets`](ParticleSystem.md#bpy.types.ParticleSystem.targets "bpy.types.ParticleSystem.targets") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ParticleTarget.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ParticleTarget.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ParticleTarget(bpy\_struct)
  + [`ParticleTarget`](#bpy.types.ParticleTarget)
    - [`ParticleTarget.alliance`](#bpy.types.ParticleTarget.alliance)
    - [`ParticleTarget.duration`](#bpy.types.ParticleTarget.duration)
    - [`ParticleTarget.is_valid`](#bpy.types.ParticleTarget.is_valid)
    - [`ParticleTarget.name`](#bpy.types.ParticleTarget.name)
    - [`ParticleTarget.object`](#bpy.types.ParticleTarget.object)
    - [`ParticleTarget.system`](#bpy.types.ParticleTarget.system)
    - [`ParticleTarget.time`](#bpy.types.ParticleTarget.time)
    - [`ParticleTarget.bl_rna_get_subclass()`](#bpy.types.ParticleTarget.bl_rna_get_subclass)
    - [`ParticleTarget.bl_rna_get_subclass_py()`](#bpy.types.ParticleTarget.bl_rna_get_subclass_py)
