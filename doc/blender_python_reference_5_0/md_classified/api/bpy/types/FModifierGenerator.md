...
# FModifierGenerator(FModifier)[¶](#fmodifiergenerator-fmodifier "Link to this heading")
...
*class* bpy.types.FModifierGenerator(*FModifier*)[¶](#bpy.types.FModifierGenerator "Link to this definition")
:   Deterministically generate values for the modified F-Curve

    coefficients[¶](#bpy.types.FModifierGenerator.coefficients "Link to this definition")
    ...
    mode[¶](#bpy.types.FModifierGenerator.mode "Link to this definition")
    :   Type of generator to use

        Type:
        :   enum in [`'POLYNOMIAL'`, `'POLYNOMIAL_FACTORISED'`], default `'POLYNOMIAL'`

    poly\_order[¶](#bpy.types.FModifierGenerator.poly_order "Link to this definition")
    :   The highest power of ‘x’ for this polynomial (number of coefficients - 1)

        Type:
        :   int in [1, 100], default 0

    use\_additive[¶](#bpy.types.FModifierGenerator.use_additive "Link to this definition")
    :   Values generated by this modifier are applied on top of the existing values instead of overwriting them

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.FModifierGenerator.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.FModifierGenerator.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.FModifierGenerator.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.FModifierGenerator.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* FModifierGenerator(FModifier)
  + [`FModifierGenerator`](#bpy.types.FModifierGenerator)
    - [`FModifierGenerator.coefficients`](#bpy.types.FModifierGenerator.coefficients)
    - [`FModifierGenerator.mode`](#bpy.types.FModifierGenerator.mode)
    - [`FModifierGenerator.poly_order`](#bpy.types.FModifierGenerator.poly_order)
    - [`FModifierGenerator.use_additive`](#bpy.types.FModifierGenerator.use_additive)
    - [`FModifierGenerator.bl_rna_get_subclass()`](#bpy.types.FModifierGenerator.bl_rna_get_subclass)
    - [`FModifierGenerator.bl_rna_get_subclass_py()`](#bpy.types.FModifierGenerator.bl_rna_get_subclass_py)
