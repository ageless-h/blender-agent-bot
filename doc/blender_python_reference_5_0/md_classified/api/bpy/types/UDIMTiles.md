...
# UDIMTiles(bpy\_struct)[¶](#udimtiles-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.UDIMTiles(*bpy\_struct*)[¶](#bpy.types.UDIMTiles "Link to this definition")
:   Collection of UDIM tiles

    active[¶](#bpy.types.UDIMTiles.active "Link to this definition")
    :   Active Image Tile

        Type:
        :   [`UDIMTile`](UDIMTile.md#bpy.types.UDIMTile "bpy.types.UDIMTile"), (never None)

    active\_index[¶](#bpy.types.UDIMTiles.active_index "Link to this definition")
    :   Active index in tiles array

        Type:
        :   int in [0, inf], default 0

    new(*tile\_number*, *\**, *label=''*)[¶](#bpy.types.UDIMTiles.new "Link to this definition")
    :   Add a tile to the image

        Parameters:
        :   * **tile\_number** (*int in* *[**1**,* *inf**]*) – Number of the newly created tile
        ...
        Return type:
        :   [`UDIMTile`](UDIMTile.md#bpy.types.UDIMTile "bpy.types.UDIMTile")

    get(*tile\_number*)[¶](#bpy.types.UDIMTiles.get "Link to this definition")
    :   Get a tile based on its tile number

        Parameters:
        :   **tile\_number** (*int in* *[**0**,* *inf**]*) – Number of the tile
    ...
    remove(*tile*)[¶](#bpy.types.UDIMTiles.remove "Link to this definition")
    :   Remove an image tile

        Parameters:
        :   **tile** ([`UDIMTile`](UDIMTile.md#bpy.types.UDIMTile "bpy.types.UDIMTile"), (never None)) – Image tile to remove

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.UDIMTiles.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.UDIMTiles.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Image.tiles`](Image.md#bpy.types.Image.tiles "bpy.types.Image.tiles") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.UDIMTiles.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.UDIMTiles.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* UDIMTiles(bpy\_struct)
  + [`UDIMTiles`](#bpy.types.UDIMTiles)
    - [`UDIMTiles.active`](#bpy.types.UDIMTiles.active)
    - [`UDIMTiles.active_index`](#bpy.types.UDIMTiles.active_index)
    - [`UDIMTiles.new()`](#bpy.types.UDIMTiles.new)
    - [`UDIMTiles.get()`](#bpy.types.UDIMTiles.get)
    - [`UDIMTiles.remove()`](#bpy.types.UDIMTiles.remove)
    - [`UDIMTiles.bl_rna_get_subclass()`](#bpy.types.UDIMTiles.bl_rna_get_subclass)
    - [`UDIMTiles.bl_rna_get_subclass_py()`](#bpy.types.UDIMTiles.bl_rna_get_subclass_py)
