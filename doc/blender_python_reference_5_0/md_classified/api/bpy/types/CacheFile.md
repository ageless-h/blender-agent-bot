...
# CacheFile(ID)[¶](#cachefile-id "Link to this heading")

base classes — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct"), [`ID`](ID.md#bpy.types.ID "bpy.types.ID")

*class* bpy.types.CacheFile(*ID*)[¶](#bpy.types.CacheFile "Link to this definition")
:   active\_index[¶](#bpy.types.CacheFile.active_index "Link to this definition")
    :   Type:
        :   int in [0, inf], default 0

    animation\_data[¶](#bpy.types.CacheFile.animation_data "Link to this definition")
    :   Animation data for this data-block

        Type:
        :   [`AnimData`](AnimData.md#bpy.types.AnimData "bpy.types.AnimData"), (readonly)

    filepath[¶](#bpy.types.CacheFile.filepath "Link to this definition")
    :   Path to external displacements file

        Type:
        :   string, default “”, (never None, blend relative `//` prefix supported)

    forward\_axis[¶](#bpy.types.CacheFile.forward_axis "Link to this definition")
    :   Type:
        :   enum in [Object Axis Items](../../../appendix/bpy_types_enum_items/object_axis_items.md#rna-enum-object-axis-items), default `'POS_X'`

    frame[¶](#bpy.types.CacheFile.frame "Link to this definition")
    ...
    frame\_offset[¶](#bpy.types.CacheFile.frame_offset "Link to this definition")
    ...
    is\_sequence[¶](#bpy.types.CacheFile.is_sequence "Link to this definition")
    :   Whether the cache is separated in a series of files

        Type:
        :   boolean, default False

    layers[¶](#bpy.types.CacheFile.layers "Link to this definition")
    :   Layers of the cache

        Type:
        :   [`CacheFileLayers`](CacheFileLayers.md#bpy.types.CacheFileLayers "bpy.types.CacheFileLayers") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`CacheFileLayer`](CacheFileLayer.md#bpy.types.CacheFileLayer "bpy.types.CacheFileLayer"), (readonly)

    object\_paths[¶](#bpy.types.CacheFile.object_paths "Link to this definition")
    :   Paths of the objects inside the Alembic archive

        Type:
        :   [`CacheObjectPaths`](CacheObjectPaths.md#bpy.types.CacheObjectPaths "bpy.types.CacheObjectPaths") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`CacheObjectPath`](CacheObjectPath.md#bpy.types.CacheObjectPath "bpy.types.CacheObjectPath"), (readonly)

    override\_frame[¶](#bpy.types.CacheFile.override_frame "Link to this definition")
    :   Whether to use a custom frame for looking up data in the cache file, instead of using the current scene frame

        Type:
        :   boolean, default False

    scale[¶](#bpy.types.CacheFile.scale "Link to this definition")
    ...
    up\_axis[¶](#bpy.types.CacheFile.up_axis "Link to this definition")
    :   Type:
        :   enum in [Object Axis Items](../../../appendix/bpy_types_enum_items/object_axis_items.md#rna-enum-object-axis-items), default `'POS_X'`

    velocity\_name[¶](#bpy.types.CacheFile.velocity_name "Link to this definition")
    :   Name of the Alembic attribute used for generating motion blur data

        Type:
        :   string, default “”, (never None)

    velocity\_unit[¶](#bpy.types.CacheFile.velocity_unit "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.CacheFile.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.CacheFile.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`BlendData.cache_files`](BlendData.md#bpy.types.BlendData.cache_files "bpy.types.BlendData.cache_files") * [`MeshSequenceCacheModifier.cache_file`](MeshSequenceCacheModifier.md#bpy.types.MeshSequenceCacheModifier.cache_file "bpy.types.MeshSequenceCacheModifier.cache_file") | * [`TransformCacheConstraint.cache_file`](TransformCacheConstraint.md#bpy.types.TransformCacheConstraint.cache_file "bpy.types.TransformCacheConstraint.cache_file") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CacheFile.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.CacheFile.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CacheFile(ID)
  + [`CacheFile`](#bpy.types.CacheFile)
    - [`CacheFile.active_index`](#bpy.types.CacheFile.active_index)
    - [`CacheFile.animation_data`](#bpy.types.CacheFile.animation_data)
    - [`CacheFile.filepath`](#bpy.types.CacheFile.filepath)
    - [`CacheFile.forward_axis`](#bpy.types.CacheFile.forward_axis)
    - [`CacheFile.frame`](#bpy.types.CacheFile.frame)
    - [`CacheFile.frame_offset`](#bpy.types.CacheFile.frame_offset)
    - [`CacheFile.is_sequence`](#bpy.types.CacheFile.is_sequence)
    - [`CacheFile.layers`](#bpy.types.CacheFile.layers)
    - [`CacheFile.object_paths`](#bpy.types.CacheFile.object_paths)
    - [`CacheFile.override_frame`](#bpy.types.CacheFile.override_frame)
    - [`CacheFile.scale`](#bpy.types.CacheFile.scale)
    - [`CacheFile.up_axis`](#bpy.types.CacheFile.up_axis)
    - [`CacheFile.velocity_name`](#bpy.types.CacheFile.velocity_name)
    - [`CacheFile.velocity_unit`](#bpy.types.CacheFile.velocity_unit)
    - [`CacheFile.bl_rna_get_subclass()`](#bpy.types.CacheFile.bl_rna_get_subclass)
    - [`CacheFile.bl_rna_get_subclass_py()`](#bpy.types.CacheFile.bl_rna_get_subclass_py)
