...
# BlendDataLibraries(bpy\_struct)[¶](#blenddatalibraries-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.BlendDataLibraries(*bpy\_struct*)[¶](#bpy.types.BlendDataLibraries "Link to this definition")
:   Collection of libraries

    tag(*value*)[¶](#bpy.types.BlendDataLibraries.tag "Link to this definition")
    :   tag

        Parameters:
        :   **value** (*boolean*) – Value

    remove(*library*, *\**, *do\_unlink=True*, *do\_id\_user=True*, *do\_ui\_user=True*)[¶](#bpy.types.BlendDataLibraries.remove "Link to this definition")
    :   Remove a library from the current blendfile

        Parameters:
        :   * **library** ([`Library`](Library.md#bpy.types.Library "bpy.types.Library"), (never None)) – Library to remove
            * **do\_unlink** (*boolean**,* *(**optional**)*) – Unlink all usages of this library before deleting it
            * **do\_id\_user** (*boolean**,* *(**optional**)*) – Decrement user counter of all data-blocks used by this library
            * **do\_ui\_user** (*boolean**,* *(**optional**)*) – Make sure interface does not reference this library

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.BlendDataLibraries.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.BlendDataLibraries.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
    ...
    load(*filepath*, *\**, *link=False*, *relative=False*, *set\_fake=False*, *recursive=False*, *reuse\_local\_id=False*, *assets\_only=False*, *clear\_asset\_data=False*, *create\_liboverrides=False*, *reuse\_liboverrides=False*, *create\_liboverrides\_runtime=False*)[¶](#bpy.types.BlendDataLibraries.load "Link to this definition")
    :   Returns a context manager which exposes 2 library objects on entering.
        ...
        :   * **filepath** (*str* *|* *bytes*) – The path to a blend file.
            ...
            * **set\_fake** (*bool*) – If True, set fake user on appended IDs.
            * **recursive** (*bool*) – If True, also make indirect dependencies of appended libraries local.
            * **reuse\_local\_id** (*bool*) – If True,try to re-use previously appended matching ID on new append.
            * **assets\_only** (*bool*) – If True, only list data-blocks marked as assets.
            * **clear\_asset\_data** (*bool*) – If True, clear the asset data on append (it is always kept for linked data).
            * **create\_liboverrides** (*bool*) – If True and `link` is True, liboverrides will
              be created for linked data.
            * **reuse\_liboverrides** (*bool*) – If True and `create_liboverride` is True,
              search for existing liboverride first.
            * **create\_liboverrides\_runtime** (*bool*) – If True and `create_liboverride` is True,
    ...
    write(*filepath*, *datablocks*, *\**, *path\_remap=False*, *fake\_user=False*, *compress=False*)[¶](#bpy.types.BlendDataLibraries.write "Link to this definition")
    :   Write data-blocks into a blend file.
        ...
        :   * **filepath** (*str* *|* *bytes*) – The path to write the blend-file.
            * **datablocks** (set[[`bpy.types.ID`](ID.md#bpy.types.ID "bpy.types.ID")]) – set of data-blocks.
            * **path\_remap** (*str*) –
            ...
            * **fake\_user** (*bool*) – When True, data-blocks will be written with fake-user flag enabled.
...
|  |  |
| --- | --- |
| * [`BlendData.libraries`](BlendData.md#bpy.types.BlendData.libraries "bpy.types.BlendData.libraries") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.BlendDataLibraries.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.BlendDataLibraries.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* BlendDataLibraries(bpy\_struct)
  + [`BlendDataLibraries`](#bpy.types.BlendDataLibraries)
    - [`BlendDataLibraries.tag()`](#bpy.types.BlendDataLibraries.tag)
    - [`BlendDataLibraries.remove()`](#bpy.types.BlendDataLibraries.remove)
    - [`BlendDataLibraries.bl_rna_get_subclass()`](#bpy.types.BlendDataLibraries.bl_rna_get_subclass)
    - [`BlendDataLibraries.bl_rna_get_subclass_py()`](#bpy.types.BlendDataLibraries.bl_rna_get_subclass_py)
    - [`BlendDataLibraries.load()`](#bpy.types.BlendDataLibraries.load)
    - [`BlendDataLibraries.write()`](#bpy.types.BlendDataLibraries.write)
