...
# LineStyleGeometryModifiers(bpy\_struct)[¶](#linestylegeometrymodifiers-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.LineStyleGeometryModifiers(*bpy\_struct*)[¶](#bpy.types.LineStyleGeometryModifiers "Link to this definition")
:   Geometry modifiers for changing line geometries

    new(*name*, *type*)[¶](#bpy.types.LineStyleGeometryModifiers.new "Link to this definition")
    :   Add a geometry modifier to line style

        Parameters:
        :   * **name** (*string**,* *(**never None**)*) – New name for the geometry modifier (not unique)
            * **type** (enum in [Linestyle Geometry Modifier Type Items](../../../appendix/bpy_types_enum_items/linestyle_geometry_modifier_type_items.md#rna-enum-linestyle-geometry-modifier-type-items)) – Geometry modifier type to add

        Returns:
        :   Newly added geometry modifier

        Return type:
        :   [`LineStyleGeometryModifier`](LineStyleGeometryModifier.md#bpy.types.LineStyleGeometryModifier "bpy.types.LineStyleGeometryModifier")

    remove(*modifier*)[¶](#bpy.types.LineStyleGeometryModifiers.remove "Link to this definition")
    :   Remove a geometry modifier from line style

        Parameters:
        :   **modifier** ([`LineStyleGeometryModifier`](LineStyleGeometryModifier.md#bpy.types.LineStyleGeometryModifier "bpy.types.LineStyleGeometryModifier"), (never None)) – Geometry modifier to remove

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.LineStyleGeometryModifiers.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.LineStyleGeometryModifiers.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`FreestyleLineStyle.geometry_modifiers`](FreestyleLineStyle.md#bpy.types.FreestyleLineStyle.geometry_modifiers "bpy.types.FreestyleLineStyle.geometry_modifiers") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.LineStyleGeometryModifiers.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.LineStyleGeometryModifiers.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* LineStyleGeometryModifiers(bpy\_struct)
  + [`LineStyleGeometryModifiers`](#bpy.types.LineStyleGeometryModifiers)
    - [`LineStyleGeometryModifiers.new()`](#bpy.types.LineStyleGeometryModifiers.new)
    - [`LineStyleGeometryModifiers.remove()`](#bpy.types.LineStyleGeometryModifiers.remove)
    - [`LineStyleGeometryModifiers.bl_rna_get_subclass()`](#bpy.types.LineStyleGeometryModifiers.bl_rna_get_subclass)
    - [`LineStyleGeometryModifiers.bl_rna_get_subclass_py()`](#bpy.types.LineStyleGeometryModifiers.bl_rna_get_subclass_py)
