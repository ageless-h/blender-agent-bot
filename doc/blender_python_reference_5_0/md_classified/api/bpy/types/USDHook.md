...
### Callback Function API[¶](#callback-function-api "Link to this heading")

One may optionally define any or all of the following callback functions
in the `USDHook` subclass.

#### on\_export[¶](#on-export "Link to this heading")
...
* `export_context` ([USDSceneExportContext](#usdsceneexportcontext)): Provides access to the stage and dependency graph

Returns:

* `True` on success or `False` if the operation was bypassed or otherwise failed to complete

#### on\_material\_export[¶](#on-material-export "Link to this heading")
...
* `export_context` ([USDMaterialExportContext](#usdmaterialexportcontext)): Provides access to the stage and a texture export utility function
...
#### on\_import[¶](#on-import "Link to this heading")

Called after the USD import finalizes.

Args:

* `import_context` ([USDSceneImportContext](#usdsceneimportcontext)):
...
#### material\_import\_poll[¶](#material-import-poll "Link to this heading")

Called to determine if the `USDHook` implementation can convert a given USD material.

Args:

* `import_context` ([USDMaterialImportContext](#usdmaterialimportcontext)): Provides access to the stage and a texture import utility function
...
or `MaterialX` import and invoke the hook’s [on\_material\_import](#on-material-import) method to convert the material instead.

#### on\_material\_import[¶](#on-material-import "Link to this heading")
...
### Context Classes[¶](#context-classes "Link to this heading")

Instances of the following built-in classes are provided as arguments to the callbacks.

#### USDSceneExportContext[¶](#usdsceneexportcontext "Link to this heading")

Argument for [on\_export](#on-export).
...
#### USDMaterialExportContext[¶](#usdmaterialexportcontext "Link to this heading")

Argument for [on\_material\_export](#on-material-export).
...
#### USDSceneImportContext[¶](#usdsceneimportcontext "Link to this heading")

Argument for [on\_import](#on-import).
...
#### USDMaterialImportContext[¶](#usdmaterialimportcontext "Link to this heading")

Argument for [material\_import\_poll](#material-import-poll) and [on\_material\_import](#on-material-import).
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.USDHook.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.USDHook.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* USDHook(bpy\_struct)
  + [USD Hook Example](#usd-hook-example)
    - [Callback Function API](#callback-function-api)
      * [on\_export](#on-export)
      * [on\_material\_export](#on-material-export)
      * [on\_import](#on-import)
      * [material\_import\_poll](#material-import-poll)
      * [on\_material\_import](#on-material-import)
    - [Context Classes](#context-classes)
      * [USDSceneExportContext](#usdsceneexportcontext)
      * [USDMaterialExportContext](#usdmaterialexportcontext)
      * [USDSceneImportContext](#usdsceneimportcontext)
      * [USDMaterialImportContext](#usdmaterialimportcontext)
    - [Errors](#errors)
