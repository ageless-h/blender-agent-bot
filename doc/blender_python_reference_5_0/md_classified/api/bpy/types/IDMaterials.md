...
# IDMaterials(bpy\_struct)[¶](#idmaterials-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.IDMaterials(*bpy\_struct*)[¶](#bpy.types.IDMaterials "Link to this definition")
:   Collection of materials

    append(*material*)[¶](#bpy.types.IDMaterials.append "Link to this definition")
    :   Add a new material to the data-block

        Parameters:
        :   **material** ([`Material`](Material.md#bpy.types.Material "bpy.types.Material")) – Material to add

    pop(*\**, *index=-1*)[¶](#bpy.types.IDMaterials.pop "Link to this definition")
    :   Remove a material from the data-block

        Parameters:
        :   **index** (*int in* *[**-32766**,* *32766**]**,* *(**optional**)*) – Index of material to remove
    ...
    clear()[¶](#bpy.types.IDMaterials.clear "Link to this definition")
    :   Remove all materials from the data-block

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.IDMaterials.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.IDMaterials.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Curve.materials`](Curve.md#bpy.types.Curve.materials "bpy.types.Curve.materials") * [`Curves.materials`](Curves.md#bpy.types.Curves.materials "bpy.types.Curves.materials") * [`GreasePencil.materials`](GreasePencil.md#bpy.types.GreasePencil.materials "bpy.types.GreasePencil.materials") * [`Mesh.materials`](Mesh.md#bpy.types.Mesh.materials "bpy.types.Mesh.materials") | * [`MetaBall.materials`](MetaBall.md#bpy.types.MetaBall.materials "bpy.types.MetaBall.materials") * [`PointCloud.materials`](PointCloud.md#bpy.types.PointCloud.materials "bpy.types.PointCloud.materials") * [`Volume.materials`](Volume.md#bpy.types.Volume.materials "bpy.types.Volume.materials") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.IDMaterials.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.IDMaterials.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* IDMaterials(bpy\_struct)
  + [`IDMaterials`](#bpy.types.IDMaterials)
    - [`IDMaterials.append()`](#bpy.types.IDMaterials.append)
    - [`IDMaterials.pop()`](#bpy.types.IDMaterials.pop)
    - [`IDMaterials.clear()`](#bpy.types.IDMaterials.clear)
    - [`IDMaterials.bl_rna_get_subclass()`](#bpy.types.IDMaterials.bl_rna_get_subclass)
    - [`IDMaterials.bl_rna_get_subclass_py()`](#bpy.types.IDMaterials.bl_rna_get_subclass_py)
