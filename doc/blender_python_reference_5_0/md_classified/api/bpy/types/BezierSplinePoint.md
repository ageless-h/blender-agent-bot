...
# BezierSplinePoint(bpy\_struct)[¶](#beziersplinepoint-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.BezierSplinePoint(*bpy\_struct*)[¶](#bpy.types.BezierSplinePoint "Link to this definition")
:   Bézier curve point with two handles

    co[¶](#bpy.types.BezierSplinePoint.co "Link to this definition")
    :   Coordinates of the control point

        Type:
        :   [`mathutils.Vector`](../../mathutils/index.md#mathutils.Vector "mathutils.Vector") of 3 items in [-inf, inf], default (0.0, 0.0, 0.0)

    handle\_left[¶](#bpy.types.BezierSplinePoint.handle_left "Link to this definition")
    :   Coordinates of the first handle

        Type:
        :   [`mathutils.Vector`](../../mathutils/index.md#mathutils.Vector "mathutils.Vector") of 3 items in [-inf, inf], default (0.0, 0.0, 0.0)

    handle\_left\_type[¶](#bpy.types.BezierSplinePoint.handle_left_type "Link to this definition")
    :   Handle types

        Type:
        :   enum in [`'FREE'`, `'VECTOR'`, `'ALIGNED'`, `'AUTO'`], default `'FREE'`

    handle\_right[¶](#bpy.types.BezierSplinePoint.handle_right "Link to this definition")
    :   Coordinates of the second handle

        Type:
        :   [`mathutils.Vector`](../../mathutils/index.md#mathutils.Vector "mathutils.Vector") of 3 items in [-inf, inf], default (0.0, 0.0, 0.0)

    handle\_right\_type[¶](#bpy.types.BezierSplinePoint.handle_right_type "Link to this definition")
    :   Handle types

        Type:
        :   enum in [`'FREE'`, `'VECTOR'`, `'ALIGNED'`, `'AUTO'`], default `'FREE'`

    hide[¶](#bpy.types.BezierSplinePoint.hide "Link to this definition")
    :   Visibility status

        Type:
        :   boolean, default False

    radius[¶](#bpy.types.BezierSplinePoint.radius "Link to this definition")
    :   Radius for beveling

        Type:
        :   float in [0, inf], default 0.0

    select\_control\_point[¶](#bpy.types.BezierSplinePoint.select_control_point "Link to this definition")
    :   Control point selection status

        Type:
        :   boolean, default False

    select\_left\_handle[¶](#bpy.types.BezierSplinePoint.select_left_handle "Link to this definition")
    :   Handle 1 selection status

        Type:
        :   boolean, default False

    select\_right\_handle[¶](#bpy.types.BezierSplinePoint.select_right_handle "Link to this definition")
    :   Handle 2 selection status

        Type:
        :   boolean, default False

    tilt[¶](#bpy.types.BezierSplinePoint.tilt "Link to this definition")
    :   Tilt in 3D View

        Type:
        :   float in [-376.991, 376.991], default 0.0

    weight\_softbody[¶](#bpy.types.BezierSplinePoint.weight_softbody "Link to this definition")
    :   Softbody goal weight

        Type:
        :   float in [0.01, 100], default 0.0

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.BezierSplinePoint.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.BezierSplinePoint.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Spline.bezier_points`](Spline.md#bpy.types.Spline.bezier_points "bpy.types.Spline.bezier_points") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.BezierSplinePoint.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.BezierSplinePoint.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* BezierSplinePoint(bpy\_struct)
  + [`BezierSplinePoint`](#bpy.types.BezierSplinePoint)
    - [`BezierSplinePoint.co`](#bpy.types.BezierSplinePoint.co)
    - [`BezierSplinePoint.handle_left`](#bpy.types.BezierSplinePoint.handle_left)
    - [`BezierSplinePoint.handle_left_type`](#bpy.types.BezierSplinePoint.handle_left_type)
    - [`BezierSplinePoint.handle_right`](#bpy.types.BezierSplinePoint.handle_right)
    - [`BezierSplinePoint.handle_right_type`](#bpy.types.BezierSplinePoint.handle_right_type)
    - [`BezierSplinePoint.hide`](#bpy.types.BezierSplinePoint.hide)
    - [`BezierSplinePoint.radius`](#bpy.types.BezierSplinePoint.radius)
    - [`BezierSplinePoint.select_control_point`](#bpy.types.BezierSplinePoint.select_control_point)
    - [`BezierSplinePoint.select_left_handle`](#bpy.types.BezierSplinePoint.select_left_handle)
    - [`BezierSplinePoint.select_right_handle`](#bpy.types.BezierSplinePoint.select_right_handle)
    - [`BezierSplinePoint.tilt`](#bpy.types.BezierSplinePoint.tilt)
    - [`BezierSplinePoint.weight_softbody`](#bpy.types.BezierSplinePoint.weight_softbody)
    - [`BezierSplinePoint.bl_rna_get_subclass()`](#bpy.types.BezierSplinePoint.bl_rna_get_subclass)
    - [`BezierSplinePoint.bl_rna_get_subclass_py()`](#bpy.types.BezierSplinePoint.bl_rna_get_subclass_py)
