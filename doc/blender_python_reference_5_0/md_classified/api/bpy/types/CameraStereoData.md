...
# CameraStereoData(bpy\_struct)[¶](#camerastereodata-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.CameraStereoData(*bpy\_struct*)[¶](#bpy.types.CameraStereoData "Link to this definition")
:   Stereoscopy settings for a Camera data-block

    convergence\_distance[¶](#bpy.types.CameraStereoData.convergence_distance "Link to this definition")
    ...
    convergence\_mode[¶](#bpy.types.CameraStereoData.convergence_mode "Link to this definition")
    :   * `OFFAXIS`
    ...
    interocular\_distance[¶](#bpy.types.CameraStereoData.interocular_distance "Link to this definition")
    :   Set the distance between the eyes - the stereo plane distance / 30 should be fine

        Type:
        :   float in [0, inf], default 0.065

    pivot[¶](#bpy.types.CameraStereoData.pivot "Link to this definition")
    :   Type:
        :   enum in [`'LEFT'`, `'RIGHT'`, `'CENTER'`], default `'LEFT'`

    pole\_merge\_angle\_from[¶](#bpy.types.CameraStereoData.pole_merge_angle_from "Link to this definition")
    :   Angle at which interocular distance starts to fade to 0

        Type:
        :   float in [0, 1.5708], default 1.0472

    pole\_merge\_angle\_to[¶](#bpy.types.CameraStereoData.pole_merge_angle_to "Link to this definition")
    :   Angle at which interocular distance is 0

        Type:
        :   float in [0, 1.5708], default 1.309

    use\_pole\_merge[¶](#bpy.types.CameraStereoData.use_pole_merge "Link to this definition")
    :   Fade interocular distance to 0 after the given cutoff angle

        Type:
        :   boolean, default False

    use\_spherical\_stereo[¶](#bpy.types.CameraStereoData.use_spherical_stereo "Link to this definition")
    :   Render every pixel rotating the camera around the middle of the interocular distance

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.CameraStereoData.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.CameraStereoData.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Camera.stereo`](Camera.md#bpy.types.Camera.stereo "bpy.types.Camera.stereo") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CameraStereoData.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.CameraStereoData.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CameraStereoData(bpy\_struct)
  + [`CameraStereoData`](#bpy.types.CameraStereoData)
    - [`CameraStereoData.convergence_distance`](#bpy.types.CameraStereoData.convergence_distance)
    - [`CameraStereoData.convergence_mode`](#bpy.types.CameraStereoData.convergence_mode)
    - [`CameraStereoData.interocular_distance`](#bpy.types.CameraStereoData.interocular_distance)
    - [`CameraStereoData.pivot`](#bpy.types.CameraStereoData.pivot)
    - [`CameraStereoData.pole_merge_angle_from`](#bpy.types.CameraStereoData.pole_merge_angle_from)
    - [`CameraStereoData.pole_merge_angle_to`](#bpy.types.CameraStereoData.pole_merge_angle_to)
    - [`CameraStereoData.use_pole_merge`](#bpy.types.CameraStereoData.use_pole_merge)
    - [`CameraStereoData.use_spherical_stereo`](#bpy.types.CameraStereoData.use_spherical_stereo)
    - [`CameraStereoData.bl_rna_get_subclass()`](#bpy.types.CameraStereoData.bl_rna_get_subclass)
    - [`CameraStereoData.bl_rna_get_subclass_py()`](#bpy.types.CameraStereoData.bl_rna_get_subclass_py)
