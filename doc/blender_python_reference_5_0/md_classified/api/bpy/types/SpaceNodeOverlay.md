...
# SpaceNodeOverlay(bpy\_struct)[¶](#spacenodeoverlay-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.SpaceNodeOverlay(*bpy\_struct*)[¶](#bpy.types.SpaceNodeOverlay "Link to this definition")
:   Settings for display of overlays in the Node Editor

    preview\_shape[¶](#bpy.types.SpaceNodeOverlay.preview_shape "Link to this definition")
    ...
    show\_context\_path[¶](#bpy.types.SpaceNodeOverlay.show_context_path "Link to this definition")
    :   Display breadcrumbs for the editor’s context

        Type:
        :   boolean, default True

    show\_named\_attributes[¶](#bpy.types.SpaceNodeOverlay.show_named_attributes "Link to this definition")
    :   Show when nodes are using named attributes

        Type:
        :   boolean, default True

    show\_overlays[¶](#bpy.types.SpaceNodeOverlay.show_overlays "Link to this definition")
    :   Display overlays like colored or dashed wires

        Type:
        :   boolean, default True

    show\_previews[¶](#bpy.types.SpaceNodeOverlay.show_previews "Link to this definition")
    :   Display each node’s preview if node is toggled

        Type:
        :   boolean, default False

    show\_reroute\_auto\_labels[¶](#bpy.types.SpaceNodeOverlay.show_reroute_auto_labels "Link to this definition")
    :   Label reroute nodes based on the label of connected reroute nodes

        Type:
        :   boolean, default False

    show\_timing[¶](#bpy.types.SpaceNodeOverlay.show_timing "Link to this definition")
    :   Display each node’s last execution time

        Type:
        :   boolean, default False

    show\_wire\_color[¶](#bpy.types.SpaceNodeOverlay.show_wire_color "Link to this definition")
    :   Color node links based on their connected sockets

        Type:
        :   boolean, default True

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.SpaceNodeOverlay.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.SpaceNodeOverlay.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`SpaceNodeEditor.overlay`](SpaceNodeEditor.md#bpy.types.SpaceNodeEditor.overlay "bpy.types.SpaceNodeEditor.overlay") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.SpaceNodeOverlay.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.SpaceNodeOverlay.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* SpaceNodeOverlay(bpy\_struct)
  + [`SpaceNodeOverlay`](#bpy.types.SpaceNodeOverlay)
    - [`SpaceNodeOverlay.preview_shape`](#bpy.types.SpaceNodeOverlay.preview_shape)
    - [`SpaceNodeOverlay.show_context_path`](#bpy.types.SpaceNodeOverlay.show_context_path)
    - [`SpaceNodeOverlay.show_named_attributes`](#bpy.types.SpaceNodeOverlay.show_named_attributes)
    - [`SpaceNodeOverlay.show_overlays`](#bpy.types.SpaceNodeOverlay.show_overlays)
    - [`SpaceNodeOverlay.show_previews`](#bpy.types.SpaceNodeOverlay.show_previews)
    - [`SpaceNodeOverlay.show_reroute_auto_labels`](#bpy.types.SpaceNodeOverlay.show_reroute_auto_labels)
    - [`SpaceNodeOverlay.show_timing`](#bpy.types.SpaceNodeOverlay.show_timing)
    - [`SpaceNodeOverlay.show_wire_color`](#bpy.types.SpaceNodeOverlay.show_wire_color)
    - [`SpaceNodeOverlay.bl_rna_get_subclass()`](#bpy.types.SpaceNodeOverlay.bl_rna_get_subclass)
    - [`SpaceNodeOverlay.bl_rna_get_subclass_py()`](#bpy.types.SpaceNodeOverlay.bl_rna_get_subclass_py)
