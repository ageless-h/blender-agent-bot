...
# VolumeRender(bpy\_struct)[¶](#volumerender-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.VolumeRender(*bpy\_struct*)[¶](#bpy.types.VolumeRender "Link to this definition")
:   Volume object render settings

    clipping[¶](#bpy.types.VolumeRender.clipping "Link to this definition")
    :   Value under which voxels are considered empty space to optimize rendering

        Type:
        :   float in [0, 1], default 0.0

    precision[¶](#bpy.types.VolumeRender.precision "Link to this definition")
    ...
    space[¶](#bpy.types.VolumeRender.space "Link to this definition")
    ...
    step\_size[¶](#bpy.types.VolumeRender.step_size "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.VolumeRender.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.VolumeRender.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Volume.render`](Volume.md#bpy.types.Volume.render "bpy.types.Volume.render") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.VolumeRender.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.VolumeRender.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* VolumeRender(bpy\_struct)
  + [`VolumeRender`](#bpy.types.VolumeRender)
    - [`VolumeRender.clipping`](#bpy.types.VolumeRender.clipping)
    - [`VolumeRender.precision`](#bpy.types.VolumeRender.precision)
    - [`VolumeRender.space`](#bpy.types.VolumeRender.space)
    - [`VolumeRender.step_size`](#bpy.types.VolumeRender.step_size)
    - [`VolumeRender.bl_rna_get_subclass()`](#bpy.types.VolumeRender.bl_rna_get_subclass)
    - [`VolumeRender.bl_rna_get_subclass_py()`](#bpy.types.VolumeRender.bl_rna_get_subclass_py)
