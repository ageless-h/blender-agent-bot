...
# BrushTextureSlot(TextureSlot)[¶](#brushtextureslot-textureslot "Link to this heading")
...
*class* bpy.types.BrushTextureSlot(*TextureSlot*)[¶](#bpy.types.BrushTextureSlot "Link to this definition")
:   Texture slot for textures in a Brush data-block

    angle[¶](#bpy.types.BrushTextureSlot.angle "Link to this definition")
    :   Brush texture rotation

        Type:
        :   float in [0, 6.28319], default 0.0

    has\_random\_texture\_angle[¶](#bpy.types.BrushTextureSlot.has_random_texture_angle "Link to this definition")
    :   Type:
        :   boolean, default False, (readonly)

    has\_texture\_angle[¶](#bpy.types.BrushTextureSlot.has_texture_angle "Link to this definition")
    :   Type:
        :   boolean, default False, (readonly)

    has\_texture\_angle\_source[¶](#bpy.types.BrushTextureSlot.has_texture_angle_source "Link to this definition")
    :   Type:
        :   boolean, default False, (readonly)

    map\_mode[¶](#bpy.types.BrushTextureSlot.map_mode "Link to this definition")
    :   Type:
        :   enum in [`'VIEW_PLANE'`, `'AREA_PLANE'`, `'TILED'`, `'3D'`, `'RANDOM'`, `'STENCIL'`], default `'VIEW_PLANE'`

    mask\_map\_mode[¶](#bpy.types.BrushTextureSlot.mask_map_mode "Link to this definition")
    :   Type:
        :   enum in [`'VIEW_PLANE'`, `'TILED'`, `'RANDOM'`, `'STENCIL'`], default `'VIEW_PLANE'`

    random\_angle[¶](#bpy.types.BrushTextureSlot.random_angle "Link to this definition")
    :   Brush texture random angle

        Type:
        :   float in [0, 6.28319], default 6.28319

    use\_rake[¶](#bpy.types.BrushTextureSlot.use_rake "Link to this definition")
    :   Type:
        :   boolean, default False

    use\_random[¶](#bpy.types.BrushTextureSlot.use_random "Link to this definition")
    :   Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.BrushTextureSlot.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.BrushTextureSlot.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Brush.mask_texture_slot`](Brush.md#bpy.types.Brush.mask_texture_slot "bpy.types.Brush.mask_texture_slot") | * [`Brush.texture_slot`](Brush.md#bpy.types.Brush.texture_slot "bpy.types.Brush.texture_slot") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.BrushTextureSlot.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.BrushTextureSlot.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* BrushTextureSlot(TextureSlot)
  + [`BrushTextureSlot`](#bpy.types.BrushTextureSlot)
    - [`BrushTextureSlot.angle`](#bpy.types.BrushTextureSlot.angle)
    - [`BrushTextureSlot.has_random_texture_angle`](#bpy.types.BrushTextureSlot.has_random_texture_angle)
    - [`BrushTextureSlot.has_texture_angle`](#bpy.types.BrushTextureSlot.has_texture_angle)
    - [`BrushTextureSlot.has_texture_angle_source`](#bpy.types.BrushTextureSlot.has_texture_angle_source)
    - [`BrushTextureSlot.map_mode`](#bpy.types.BrushTextureSlot.map_mode)
    - [`BrushTextureSlot.mask_map_mode`](#bpy.types.BrushTextureSlot.mask_map_mode)
    - [`BrushTextureSlot.random_angle`](#bpy.types.BrushTextureSlot.random_angle)
    - [`BrushTextureSlot.use_rake`](#bpy.types.BrushTextureSlot.use_rake)
    - [`BrushTextureSlot.use_random`](#bpy.types.BrushTextureSlot.use_random)
    - [`BrushTextureSlot.bl_rna_get_subclass()`](#bpy.types.BrushTextureSlot.bl_rna_get_subclass)
    - [`BrushTextureSlot.bl_rna_get_subclass_py()`](#bpy.types.BrushTextureSlot.bl_rna_get_subclass_py)
