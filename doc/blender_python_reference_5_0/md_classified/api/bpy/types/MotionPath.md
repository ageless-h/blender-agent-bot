...
# MotionPath(bpy\_struct)[¶](#motionpath-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.MotionPath(*bpy\_struct*)[¶](#bpy.types.MotionPath "Link to this definition")
:   Cache of the world-space positions of an element over a frame range

    color[¶](#bpy.types.MotionPath.color "Link to this definition")
    ...
    color\_post[¶](#bpy.types.MotionPath.color_post "Link to this definition")
    :   Custom color for motion path after the current frame

        Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, inf], default (0.0, 0.0, 0.0)

    frame\_end[¶](#bpy.types.MotionPath.frame_end "Link to this definition")
    :   End frame of the stored range

        Type:
        :   int in [-inf, inf], default 0, (readonly)

    frame\_start[¶](#bpy.types.MotionPath.frame_start "Link to this definition")
    :   Starting frame of the stored range

        Type:
        :   int in [-inf, inf], default 0, (readonly)

    is\_modified[¶](#bpy.types.MotionPath.is_modified "Link to this definition")
    :   Path is being edited

        Type:
        :   boolean, default False

    length[¶](#bpy.types.MotionPath.length "Link to this definition")
    :   Number of frames cached

        Type:
        :   int in [-inf, inf], default 0, (readonly)

    line\_thickness[¶](#bpy.types.MotionPath.line_thickness "Link to this definition")
    :   Line thickness for motion path

        Type:
        :   int in [1, 6], default 0

    lines[¶](#bpy.types.MotionPath.lines "Link to this definition")
    :   Use straight lines between keyframe points

        Type:
        :   boolean, default False

    points[¶](#bpy.types.MotionPath.points "Link to this definition")
    :   Cached positions per frame

        Type:
        :   [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`MotionPathVert`](MotionPathVert.md#bpy.types.MotionPathVert "bpy.types.MotionPathVert"), (readonly)

    use\_bone\_head[¶](#bpy.types.MotionPath.use_bone_head "Link to this definition")
    :   For PoseBone paths, use the bone head location when calculating this path

        Type:
        :   boolean, default False, (readonly)

    use\_custom\_color[¶](#bpy.types.MotionPath.use_custom_color "Link to this definition")
    :   Use custom color for this motion path

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.MotionPath.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.MotionPath.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Object.motion_path`](Object.md#bpy.types.Object.motion_path "bpy.types.Object.motion_path") | * [`PoseBone.motion_path`](PoseBone.md#bpy.types.PoseBone.motion_path "bpy.types.PoseBone.motion_path") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.MotionPath.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.MotionPath.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* MotionPath(bpy\_struct)
  + [`MotionPath`](#bpy.types.MotionPath)
    - [`MotionPath.color`](#bpy.types.MotionPath.color)
    - [`MotionPath.color_post`](#bpy.types.MotionPath.color_post)
    - [`MotionPath.frame_end`](#bpy.types.MotionPath.frame_end)
    - [`MotionPath.frame_start`](#bpy.types.MotionPath.frame_start)
    - [`MotionPath.is_modified`](#bpy.types.MotionPath.is_modified)
    - [`MotionPath.length`](#bpy.types.MotionPath.length)
    - [`MotionPath.line_thickness`](#bpy.types.MotionPath.line_thickness)
    - [`MotionPath.lines`](#bpy.types.MotionPath.lines)
    - [`MotionPath.points`](#bpy.types.MotionPath.points)
    - [`MotionPath.use_bone_head`](#bpy.types.MotionPath.use_bone_head)
    - [`MotionPath.use_custom_color`](#bpy.types.MotionPath.use_custom_color)
    - [`MotionPath.bl_rna_get_subclass()`](#bpy.types.MotionPath.bl_rna_get_subclass)
    - [`MotionPath.bl_rna_get_subclass_py()`](#bpy.types.MotionPath.bl_rna_get_subclass_py)
