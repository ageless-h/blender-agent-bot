...
# ObjectBase(bpy\_struct)[¶](#objectbase-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.ObjectBase(*bpy\_struct*)[¶](#bpy.types.ObjectBase "Link to this definition")
:   An object instance in a View Layer (currently never exposed in Python API)

    hide\_viewport[¶](#bpy.types.ObjectBase.hide_viewport "Link to this definition")
    :   Temporarily hide in viewport

        Type:
        :   boolean, default False

    object[¶](#bpy.types.ObjectBase.object "Link to this definition")
    :   Object this base links to

        Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object"), (readonly)

    select[¶](#bpy.types.ObjectBase.select "Link to this definition")
    :   Object base selection state

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ObjectBase.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ObjectBase.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ObjectBase.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ObjectBase.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ObjectBase(bpy\_struct)
  + [`ObjectBase`](#bpy.types.ObjectBase)
    - [`ObjectBase.hide_viewport`](#bpy.types.ObjectBase.hide_viewport)
    - [`ObjectBase.object`](#bpy.types.ObjectBase.object)
    - [`ObjectBase.select`](#bpy.types.ObjectBase.select)
    - [`ObjectBase.bl_rna_get_subclass()`](#bpy.types.ObjectBase.bl_rna_get_subclass)
    - [`ObjectBase.bl_rna_get_subclass_py()`](#bpy.types.ObjectBase.bl_rna_get_subclass_py)
