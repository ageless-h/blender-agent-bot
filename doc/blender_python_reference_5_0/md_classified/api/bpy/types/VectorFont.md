...
# VectorFont(ID)[¶](#vectorfont-id "Link to this heading")

base classes — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct"), [`ID`](ID.md#bpy.types.ID "bpy.types.ID")

*class* bpy.types.VectorFont(*ID*)[¶](#bpy.types.VectorFont "Link to this definition")
:   Vector font for Text objects

    filepath[¶](#bpy.types.VectorFont.filepath "Link to this definition")
    :   Type:
        :   string, default “”, (never None, blend relative `//` prefix supported)

    packed\_file[¶](#bpy.types.VectorFont.packed_file "Link to this definition")
    :   Type:
        :   [`PackedFile`](PackedFile.md#bpy.types.PackedFile "bpy.types.PackedFile"), (readonly)

    pack()[¶](#bpy.types.VectorFont.pack "Link to this definition")
    :   Pack the font into the current blend file

    unpack(*\**, *method='USE\_LOCAL'*)[¶](#bpy.types.VectorFont.unpack "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.VectorFont.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.VectorFont.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`BlendData.fonts`](BlendData.md#bpy.types.BlendData.fonts "bpy.types.BlendData.fonts") * [`BlendDataFonts.load`](BlendDataFonts.md#bpy.types.BlendDataFonts.load "bpy.types.BlendDataFonts.load") * [`BlendDataFonts.remove`](BlendDataFonts.md#bpy.types.BlendDataFonts.remove "bpy.types.BlendDataFonts.remove") * [`GeometryNodeStringToCurves.font`](GeometryNodeStringToCurves.md#bpy.types.GeometryNodeStringToCurves.font "bpy.types.GeometryNodeStringToCurves.font") * [`TextCurve.font`](TextCurve.md#bpy.types.TextCurve.font "bpy.types.TextCurve.font") | * [`TextCurve.font_bold`](TextCurve.md#bpy.types.TextCurve.font_bold "bpy.types.TextCurve.font_bold") * [`TextCurve.font_bold_italic`](TextCurve.md#bpy.types.TextCurve.font_bold_italic "bpy.types.TextCurve.font_bold_italic") * [`TextCurve.font_italic`](TextCurve.md#bpy.types.TextCurve.font_italic "bpy.types.TextCurve.font_italic") * [`TextStrip.font`](TextStrip.md#bpy.types.TextStrip.font "bpy.types.TextStrip.font") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.VectorFont.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.VectorFont.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* VectorFont(ID)
  + [`VectorFont`](#bpy.types.VectorFont)
    - [`VectorFont.filepath`](#bpy.types.VectorFont.filepath)
    - [`VectorFont.packed_file`](#bpy.types.VectorFont.packed_file)
    - [`VectorFont.pack()`](#bpy.types.VectorFont.pack)
    - [`VectorFont.unpack()`](#bpy.types.VectorFont.unpack)
    - [`VectorFont.bl_rna_get_subclass()`](#bpy.types.VectorFont.bl_rna_get_subclass)
    - [`VectorFont.bl_rna_get_subclass_py()`](#bpy.types.VectorFont.bl_rna_get_subclass_py)
