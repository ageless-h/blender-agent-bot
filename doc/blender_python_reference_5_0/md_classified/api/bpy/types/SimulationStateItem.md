...
# SimulationStateItem(bpy\_struct)[¶](#simulationstateitem-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.SimulationStateItem(*bpy\_struct*)[¶](#bpy.types.SimulationStateItem "Link to this definition")
:   attribute\_domain[¶](#bpy.types.SimulationStateItem.attribute_domain "Link to this definition")
    ...
    color[¶](#bpy.types.SimulationStateItem.color "Link to this definition")
    ...
    name[¶](#bpy.types.SimulationStateItem.name "Link to this definition")
    :   Type:
        :   string, default “”, (never None)

    socket\_type[¶](#bpy.types.SimulationStateItem.socket_type "Link to this definition")
    :   Type:
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.SimulationStateItem.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.SimulationStateItem.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`GeometryNodeSimulationOutput.active_item`](GeometryNodeSimulationOutput.md#bpy.types.GeometryNodeSimulationOutput.active_item "bpy.types.GeometryNodeSimulationOutput.active_item") * [`GeometryNodeSimulationOutput.state_items`](GeometryNodeSimulationOutput.md#bpy.types.GeometryNodeSimulationOutput.state_items "bpy.types.GeometryNodeSimulationOutput.state_items") | * [`NodeGeometrySimulationOutputItems.new`](NodeGeometrySimulationOutputItems.md#bpy.types.NodeGeometrySimulationOutputItems.new "bpy.types.NodeGeometrySimulationOutputItems.new") * [`NodeGeometrySimulationOutputItems.remove`](NodeGeometrySimulationOutputItems.md#bpy.types.NodeGeometrySimulationOutputItems.remove "bpy.types.NodeGeometrySimulationOutputItems.remove") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.SimulationStateItem.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.SimulationStateItem.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* SimulationStateItem(bpy\_struct)
  + [`SimulationStateItem`](#bpy.types.SimulationStateItem)
    - [`SimulationStateItem.attribute_domain`](#bpy.types.SimulationStateItem.attribute_domain)
    - [`SimulationStateItem.color`](#bpy.types.SimulationStateItem.color)
    - [`SimulationStateItem.name`](#bpy.types.SimulationStateItem.name)
    - [`SimulationStateItem.socket_type`](#bpy.types.SimulationStateItem.socket_type)
    - [`SimulationStateItem.bl_rna_get_subclass()`](#bpy.types.SimulationStateItem.bl_rna_get_subclass)
    - [`SimulationStateItem.bl_rna_get_subclass_py()`](#bpy.types.SimulationStateItem.bl_rna_get_subclass_py)
