...
# LineStyleGeometryModifier\_SpatialNoise(LineStyleGeometryModifier)[¶](#linestylegeometrymodifier-spatialnoise-linestylegeometrymodifier "Link to this heading")
...
*class* bpy.types.LineStyleGeometryModifier\_SpatialNoise(*LineStyleGeometryModifier*)[¶](#bpy.types.LineStyleGeometryModifier_SpatialNoise "Link to this definition")
:   Add spatial noise to stroke backbone geometry

    amplitude[¶](#bpy.types.LineStyleGeometryModifier_SpatialNoise.amplitude "Link to this definition")
    :   Amplitude of the spatial noise

        Type:
        :   float in [-inf, inf], default 0.0

    expanded[¶](#bpy.types.LineStyleGeometryModifier_SpatialNoise.expanded "Link to this definition")
    :   True if the modifier tab is expanded

        Type:
        :   boolean, default False

    octaves[¶](#bpy.types.LineStyleGeometryModifier_SpatialNoise.octaves "Link to this definition")
    :   Number of octaves (i.e., the amount of detail of the spatial noise)

        Type:
        :   int in [0, inf], default 0

    scale[¶](#bpy.types.LineStyleGeometryModifier_SpatialNoise.scale "Link to this definition")
    :   Scale of the spatial noise

        Type:
        :   float in [-inf, inf], default 0.0

    smooth[¶](#bpy.types.LineStyleGeometryModifier_SpatialNoise.smooth "Link to this definition")
    :   If true, the spatial noise is smooth

        Type:
        :   boolean, default False

    type[¶](#bpy.types.LineStyleGeometryModifier_SpatialNoise.type "Link to this definition")
    ...
    use[¶](#bpy.types.LineStyleGeometryModifier_SpatialNoise.use "Link to this definition")
    :   Enable or disable this modifier during stroke rendering

        Type:
        :   boolean, default False

    use\_pure\_random[¶](#bpy.types.LineStyleGeometryModifier_SpatialNoise.use_pure_random "Link to this definition")
    :   If true, the spatial noise does not show any coherence

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.LineStyleGeometryModifier_SpatialNoise.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.LineStyleGeometryModifier_SpatialNoise.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
        ...
        Return type:
        :   [type](#bpy.types.LineStyleGeometryModifier_SpatialNoise.type "bpy.types.LineStyleGeometryModifier_SpatialNoise.type")
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.LineStyleGeometryModifier_SpatialNoise.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.LineStyleGeometryModifier_SpatialNoise.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* LineStyleGeometryModifier\_SpatialNoise(LineStyleGeometryModifier)
  + [`LineStyleGeometryModifier_SpatialNoise`](#bpy.types.LineStyleGeometryModifier_SpatialNoise)
    - [`LineStyleGeometryModifier_SpatialNoise.amplitude`](#bpy.types.LineStyleGeometryModifier_SpatialNoise.amplitude)
    - [`LineStyleGeometryModifier_SpatialNoise.expanded`](#bpy.types.LineStyleGeometryModifier_SpatialNoise.expanded)
    - [`LineStyleGeometryModifier_SpatialNoise.octaves`](#bpy.types.LineStyleGeometryModifier_SpatialNoise.octaves)
    - [`LineStyleGeometryModifier_SpatialNoise.scale`](#bpy.types.LineStyleGeometryModifier_SpatialNoise.scale)
    - [`LineStyleGeometryModifier_SpatialNoise.smooth`](#bpy.types.LineStyleGeometryModifier_SpatialNoise.smooth)
    - [`LineStyleGeometryModifier_SpatialNoise.type`](#bpy.types.LineStyleGeometryModifier_SpatialNoise.type)
    - [`LineStyleGeometryModifier_SpatialNoise.use`](#bpy.types.LineStyleGeometryModifier_SpatialNoise.use)
    - [`LineStyleGeometryModifier_SpatialNoise.use_pure_random`](#bpy.types.LineStyleGeometryModifier_SpatialNoise.use_pure_random)
    - [`LineStyleGeometryModifier_SpatialNoise.bl_rna_get_subclass()`](#bpy.types.LineStyleGeometryModifier_SpatialNoise.bl_rna_get_subclass)
    - [`LineStyleGeometryModifier_SpatialNoise.bl_rna_get_subclass_py()`](#bpy.types.LineStyleGeometryModifier_SpatialNoise.bl_rna_get_subclass_py)
