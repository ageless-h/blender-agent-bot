...
# PaintCurve(ID)[¶](#paintcurve-id "Link to this heading")

base classes — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct"), [`ID`](ID.md#bpy.types.ID "bpy.types.ID")

*class* bpy.types.PaintCurve(*ID*)[¶](#bpy.types.PaintCurve "Link to this definition")
:   *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.PaintCurve.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.PaintCurve.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`BlendData.paint_curves`](BlendData.md#bpy.types.BlendData.paint_curves "bpy.types.BlendData.paint_curves") | * [`Brush.paint_curve`](Brush.md#bpy.types.Brush.paint_curve "bpy.types.Brush.paint_curve") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.PaintCurve.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.PaintCurve.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* PaintCurve(ID)
  + [`PaintCurve`](#bpy.types.PaintCurve)
    - [`PaintCurve.bl_rna_get_subclass()`](#bpy.types.PaintCurve.bl_rna_get_subclass)
    - [`PaintCurve.bl_rna_get_subclass_py()`](#bpy.types.PaintCurve.bl_rna_get_subclass_py)
