...
# NodeClosureInputItem(bpy\_struct)[¶](#nodeclosureinputitem-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.NodeClosureInputItem(*bpy\_struct*)[¶](#bpy.types.NodeClosureInputItem "Link to this definition")
:   color[¶](#bpy.types.NodeClosureInputItem.color "Link to this definition")
    ...
    name[¶](#bpy.types.NodeClosureInputItem.name "Link to this definition")
    :   Type:
        :   string, default “”, (never None)

    socket\_type[¶](#bpy.types.NodeClosureInputItem.socket_type "Link to this definition")
    :   Type:
    ...
    structure\_type[¶](#bpy.types.NodeClosureInputItem.structure_type "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.NodeClosureInputItem.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.NodeClosureInputItem.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`NodeClosureInputItems.new`](NodeClosureInputItems.md#bpy.types.NodeClosureInputItems.new "bpy.types.NodeClosureInputItems.new") * [`NodeClosureInputItems.remove`](NodeClosureInputItems.md#bpy.types.NodeClosureInputItems.remove "bpy.types.NodeClosureInputItems.remove") | * [`NodeClosureOutput.input_items`](NodeClosureOutput.md#bpy.types.NodeClosureOutput.input_items "bpy.types.NodeClosureOutput.input_items") |

[Next

NodeClosureInputItems(bpy\_struct)](NodeClosureInputItems.md)
[Previous

NodeClosureInput(NodeInternal)](NodeClosureInput.md)
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.NodeClosureInputItem.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.NodeClosureInputItem.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* NodeClosureInputItem(bpy\_struct)
  + [`NodeClosureInputItem`](#bpy.types.NodeClosureInputItem)
    - [`NodeClosureInputItem.color`](#bpy.types.NodeClosureInputItem.color)
    - [`NodeClosureInputItem.name`](#bpy.types.NodeClosureInputItem.name)
    - [`NodeClosureInputItem.socket_type`](#bpy.types.NodeClosureInputItem.socket_type)
    - [`NodeClosureInputItem.structure_type`](#bpy.types.NodeClosureInputItem.structure_type)
    - [`NodeClosureInputItem.bl_rna_get_subclass()`](#bpy.types.NodeClosureInputItem.bl_rna_get_subclass)
    - [`NodeClosureInputItem.bl_rna_get_subclass_py()`](#bpy.types.NodeClosureInputItem.bl_rna_get_subclass_py)
