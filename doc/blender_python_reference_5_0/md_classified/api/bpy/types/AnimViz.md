...
# AnimViz(bpy\_struct)[¶](#animviz-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.AnimViz(*bpy\_struct*)[¶](#bpy.types.AnimViz "Link to this definition")
:   Settings for the visualization of motion

    motion\_path[¶](#bpy.types.AnimViz.motion_path "Link to this definition")
    :   Motion Path settings for visualization

        Type:
        :   [`AnimVizMotionPaths`](AnimVizMotionPaths.md#bpy.types.AnimVizMotionPaths "bpy.types.AnimVizMotionPaths"), (readonly, never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.AnimViz.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.AnimViz.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Object.animation_visualization`](Object.md#bpy.types.Object.animation_visualization "bpy.types.Object.animation_visualization") | * [`Pose.animation_visualization`](Pose.md#bpy.types.Pose.animation_visualization "bpy.types.Pose.animation_visualization") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.AnimViz.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.AnimViz.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* AnimViz(bpy\_struct)
  + [`AnimViz`](#bpy.types.AnimViz)
    - [`AnimViz.motion_path`](#bpy.types.AnimViz.motion_path)
    - [`AnimViz.bl_rna_get_subclass()`](#bpy.types.AnimViz.bl_rna_get_subclass)
    - [`AnimViz.bl_rna_get_subclass_py()`](#bpy.types.AnimViz.bl_rna_get_subclass_py)
