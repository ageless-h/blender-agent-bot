...
# SplineIKConstraint(Constraint)[¶](#splineikconstraint-constraint "Link to this heading")
...
*class* bpy.types.SplineIKConstraint(*Constraint*)[¶](#bpy.types.SplineIKConstraint "Link to this definition")
:   Align ‘n’ bones along a curve

    bulge[¶](#bpy.types.SplineIKConstraint.bulge "Link to this definition")
    :   Factor between volume variation and stretching

        Type:
        :   float in [0, 100], default 0.0

    bulge\_max[¶](#bpy.types.SplineIKConstraint.bulge_max "Link to this definition")
    :   Maximum volume stretching factor

        Type:
        :   float in [1, 100], default 0.0

    bulge\_min[¶](#bpy.types.SplineIKConstraint.bulge_min "Link to this definition")
    :   Minimum volume stretching factor

        Type:
        :   float in [0, 1], default 0.0

    bulge\_smooth[¶](#bpy.types.SplineIKConstraint.bulge_smooth "Link to this definition")
    :   Strength of volume stretching clamping

        Type:
        :   float in [0, 1], default 0.0

    chain\_count[¶](#bpy.types.SplineIKConstraint.chain_count "Link to this definition")
    :   How many bones are included in the chain

        Type:
        :   int in [1, 255], default 0

    joint\_bindings[¶](#bpy.types.SplineIKConstraint.joint_bindings "Link to this definition")
    ...
    target[¶](#bpy.types.SplineIKConstraint.target "Link to this definition")
    :   Curve that controls this relationship

        Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object")

    use\_bulge\_max[¶](#bpy.types.SplineIKConstraint.use_bulge_max "Link to this definition")
    :   Use upper limit for volume variation

        Type:
        :   boolean, default False

    use\_bulge\_min[¶](#bpy.types.SplineIKConstraint.use_bulge_min "Link to this definition")
    :   Use lower limit for volume variation

        Type:
        :   boolean, default False

    use\_chain\_offset[¶](#bpy.types.SplineIKConstraint.use_chain_offset "Link to this definition")
    :   Offset the entire chain relative to the root joint

        Type:
        :   boolean, default False

    use\_curve\_radius[¶](#bpy.types.SplineIKConstraint.use_curve_radius "Link to this definition")
    :   Average radius of the endpoints is used to tweak the X and Z Scaling of the bones, on top of XZ Scale mode

        Type:
        :   boolean, default False

    use\_even\_divisions[¶](#bpy.types.SplineIKConstraint.use_even_divisions "Link to this definition")
    :   Ignore the relative lengths of the bones when fitting to the curve

        Type:
        :   boolean, default False

    use\_original\_scale[¶](#bpy.types.SplineIKConstraint.use_original_scale "Link to this definition")
    :   Apply volume preservation over the original scaling

        Type:
        :   boolean, default False

    xz\_scale\_mode[¶](#bpy.types.SplineIKConstraint.xz_scale_mode "Link to this definition")
    ...
    y\_scale\_mode[¶](#bpy.types.SplineIKConstraint.y_scale_mode "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.SplineIKConstraint.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.SplineIKConstraint.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.SplineIKConstraint.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.SplineIKConstraint.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* SplineIKConstraint(Constraint)
  + [`SplineIKConstraint`](#bpy.types.SplineIKConstraint)
    - [`SplineIKConstraint.bulge`](#bpy.types.SplineIKConstraint.bulge)
    - [`SplineIKConstraint.bulge_max`](#bpy.types.SplineIKConstraint.bulge_max)
    - [`SplineIKConstraint.bulge_min`](#bpy.types.SplineIKConstraint.bulge_min)
    - [`SplineIKConstraint.bulge_smooth`](#bpy.types.SplineIKConstraint.bulge_smooth)
    - [`SplineIKConstraint.chain_count`](#bpy.types.SplineIKConstraint.chain_count)
    - [`SplineIKConstraint.joint_bindings`](#bpy.types.SplineIKConstraint.joint_bindings)
    - [`SplineIKConstraint.target`](#bpy.types.SplineIKConstraint.target)
    - [`SplineIKConstraint.use_bulge_max`](#bpy.types.SplineIKConstraint.use_bulge_max)
    - [`SplineIKConstraint.use_bulge_min`](#bpy.types.SplineIKConstraint.use_bulge_min)
    - [`SplineIKConstraint.use_chain_offset`](#bpy.types.SplineIKConstraint.use_chain_offset)
    - [`SplineIKConstraint.use_curve_radius`](#bpy.types.SplineIKConstraint.use_curve_radius)
    - [`SplineIKConstraint.use_even_divisions`](#bpy.types.SplineIKConstraint.use_even_divisions)
    - [`SplineIKConstraint.use_original_scale`](#bpy.types.SplineIKConstraint.use_original_scale)
    - [`SplineIKConstraint.xz_scale_mode`](#bpy.types.SplineIKConstraint.xz_scale_mode)
    - [`SplineIKConstraint.y_scale_mode`](#bpy.types.SplineIKConstraint.y_scale_mode)
    - [`SplineIKConstraint.bl_rna_get_subclass()`](#bpy.types.SplineIKConstraint.bl_rna_get_subclass)
    - [`SplineIKConstraint.bl_rna_get_subclass_py()`](#bpy.types.SplineIKConstraint.bl_rna_get_subclass_py)
