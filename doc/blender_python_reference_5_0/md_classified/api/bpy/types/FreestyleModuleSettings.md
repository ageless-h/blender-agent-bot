...
# FreestyleModuleSettings(bpy\_struct)[¶](#freestylemodulesettings-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.FreestyleModuleSettings(*bpy\_struct*)[¶](#bpy.types.FreestyleModuleSettings "Link to this definition")
:   Style module configuration for specifying a style module

    script[¶](#bpy.types.FreestyleModuleSettings.script "Link to this definition")
    :   Python script to define a style module

        Type:
        :   [`Text`](Text.md#bpy.types.Text "bpy.types.Text")

    use[¶](#bpy.types.FreestyleModuleSettings.use "Link to this definition")
    :   Enable or disable this style module during stroke rendering

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.FreestyleModuleSettings.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.FreestyleModuleSettings.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`FreestyleModules.new`](FreestyleModules.md#bpy.types.FreestyleModules.new "bpy.types.FreestyleModules.new") * [`FreestyleModules.remove`](FreestyleModules.md#bpy.types.FreestyleModules.remove "bpy.types.FreestyleModules.remove") | * [`FreestyleSettings.modules`](FreestyleSettings.md#bpy.types.FreestyleSettings.modules "bpy.types.FreestyleSettings.modules") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.FreestyleModuleSettings.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.FreestyleModuleSettings.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* FreestyleModuleSettings(bpy\_struct)
  + [`FreestyleModuleSettings`](#bpy.types.FreestyleModuleSettings)
    - [`FreestyleModuleSettings.script`](#bpy.types.FreestyleModuleSettings.script)
    - [`FreestyleModuleSettings.use`](#bpy.types.FreestyleModuleSettings.use)
    - [`FreestyleModuleSettings.bl_rna_get_subclass()`](#bpy.types.FreestyleModuleSettings.bl_rna_get_subclass)
    - [`FreestyleModuleSettings.bl_rna_get_subclass_py()`](#bpy.types.FreestyleModuleSettings.bl_rna_get_subclass_py)
