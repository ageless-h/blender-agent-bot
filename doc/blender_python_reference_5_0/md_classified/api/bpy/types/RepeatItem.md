...
# RepeatItem(bpy\_struct)[¶](#repeatitem-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.RepeatItem(*bpy\_struct*)[¶](#bpy.types.RepeatItem "Link to this definition")
:   color[¶](#bpy.types.RepeatItem.color "Link to this definition")
    ...
    name[¶](#bpy.types.RepeatItem.name "Link to this definition")
    :   Type:
        :   string, default “”, (never None)

    socket\_type[¶](#bpy.types.RepeatItem.socket_type "Link to this definition")
    :   Type:
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.RepeatItem.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.RepeatItem.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`GeometryNodeBake.active_item`](GeometryNodeBake.md#bpy.types.GeometryNodeBake.active_item "bpy.types.GeometryNodeBake.active_item") * [`GeometryNodeCaptureAttribute.active_item`](GeometryNodeCaptureAttribute.md#bpy.types.GeometryNodeCaptureAttribute.active_item "bpy.types.GeometryNodeCaptureAttribute.active_item") * [`GeometryNodeFieldToGrid.active_item`](GeometryNodeFieldToGrid.md#bpy.types.GeometryNodeFieldToGrid.active_item "bpy.types.GeometryNodeFieldToGrid.active_item") * [`GeometryNodeRepeatOutput.active_item`](GeometryNodeRepeatOutput.md#bpy.types.GeometryNodeRepeatOutput.active_item "bpy.types.GeometryNodeRepeatOutput.active_item") | * [`GeometryNodeRepeatOutput.repeat_items`](GeometryNodeRepeatOutput.md#bpy.types.GeometryNodeRepeatOutput.repeat_items "bpy.types.GeometryNodeRepeatOutput.repeat_items") * [`NodeGeometryRepeatOutputItems.new`](NodeGeometryRepeatOutputItems.md#bpy.types.NodeGeometryRepeatOutputItems.new "bpy.types.NodeGeometryRepeatOutputItems.new") * [`NodeGeometryRepeatOutputItems.remove`](NodeGeometryRepeatOutputItems.md#bpy.types.NodeGeometryRepeatOutputItems.remove "bpy.types.NodeGeometryRepeatOutputItems.remove") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.RepeatItem.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.RepeatItem.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* RepeatItem(bpy\_struct)
  + [`RepeatItem`](#bpy.types.RepeatItem)
    - [`RepeatItem.color`](#bpy.types.RepeatItem.color)
    - [`RepeatItem.name`](#bpy.types.RepeatItem.name)
    - [`RepeatItem.socket_type`](#bpy.types.RepeatItem.socket_type)
    - [`RepeatItem.bl_rna_get_subclass()`](#bpy.types.RepeatItem.bl_rna_get_subclass)
    - [`RepeatItem.bl_rna_get_subclass_py()`](#bpy.types.RepeatItem.bl_rna_get_subclass_py)
