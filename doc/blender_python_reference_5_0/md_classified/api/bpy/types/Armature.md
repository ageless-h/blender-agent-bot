...
# Armature(ID)[¶](#armature-id "Link to this heading")

base classes — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct"), [`ID`](ID.md#bpy.types.ID "bpy.types.ID")

*class* bpy.types.Armature(*ID*)[¶](#bpy.types.Armature "Link to this definition")
:   Armature data-block containing a hierarchy of bones, usually used for rigging characters

    animation\_data[¶](#bpy.types.Armature.animation_data "Link to this definition")
    :   Animation data for this data-block

        Type:
        :   [`AnimData`](AnimData.md#bpy.types.AnimData "bpy.types.AnimData"), (readonly)

    axes\_position[¶](#bpy.types.Armature.axes_position "Link to this definition")
    ...
    bones[¶](#bpy.types.Armature.bones "Link to this definition")
    :   Type:
        :   [`ArmatureBones`](ArmatureBones.md#bpy.types.ArmatureBones "bpy.types.ArmatureBones") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`Bone`](Bone.md#bpy.types.Bone "bpy.types.Bone"), (readonly)

    collections[¶](#bpy.types.Armature.collections "Link to this definition")
    :   Type:
        :   [`BoneCollections`](BoneCollections.md#bpy.types.BoneCollections "bpy.types.BoneCollections") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`BoneCollection`](BoneCollection.md#bpy.types.BoneCollection "bpy.types.BoneCollection")

    collections\_all[¶](#bpy.types.Armature.collections_all "Link to this definition")
    ...
    display\_type[¶](#bpy.types.Armature.display_type "Link to this definition")
    :   * `OCTAHEDRAL`
    ...
    edit\_bones[¶](#bpy.types.Armature.edit_bones "Link to this definition")
    :   Type:
        :   [`ArmatureEditBones`](ArmatureEditBones.md#bpy.types.ArmatureEditBones "bpy.types.ArmatureEditBones") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`EditBone`](EditBone.md#bpy.types.EditBone "bpy.types.EditBone"), (readonly)

    is\_editmode[¶](#bpy.types.Armature.is_editmode "Link to this definition")
    :   True when used in editmode

        Type:
        :   boolean, default False, (readonly)

    pose\_position[¶](#bpy.types.Armature.pose_position "Link to this definition")
    ...
    relation\_line\_position[¶](#bpy.types.Armature.relation_line_position "Link to this definition")
    ...
    show\_axes[¶](#bpy.types.Armature.show_axes "Link to this definition")
    :   Display bone axes

        Type:
        :   boolean, default False

    show\_bone\_colors[¶](#bpy.types.Armature.show_bone_colors "Link to this definition")
    :   Display bone colors

        Type:
        :   boolean, default True

    show\_bone\_custom\_shapes[¶](#bpy.types.Armature.show_bone_custom_shapes "Link to this definition")
    :   Display bones with their custom shapes

        Type:
        :   boolean, default True

    show\_names[¶](#bpy.types.Armature.show_names "Link to this definition")
    :   Display bone names

        Type:
        :   boolean, default False

    use\_mirror\_x[¶](#bpy.types.Armature.use_mirror_x "Link to this definition")
    :   Apply changes to matching bone on opposite side of X-Axis

        Type:
        :   boolean, default False

    transform(*matrix*)[¶](#bpy.types.Armature.transform "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.Armature.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.Armature.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`bpy.context.armature`](../context/index.md#bpy.context.armature "bpy.context.armature") * [`BlendData.armatures`](BlendData.md#bpy.types.BlendData.armatures "bpy.types.BlendData.armatures") | * [`BlendDataArmatures.new`](BlendDataArmatures.md#bpy.types.BlendDataArmatures.new "bpy.types.BlendDataArmatures.new") * [`BlendDataArmatures.remove`](BlendDataArmatures.md#bpy.types.BlendDataArmatures.remove "bpy.types.BlendDataArmatures.remove") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.Armature.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.Armature.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* Armature(ID)
  + [`Armature`](#bpy.types.Armature)
    - [`Armature.animation_data`](#bpy.types.Armature.animation_data)
    - [`Armature.axes_position`](#bpy.types.Armature.axes_position)
    - [`Armature.bones`](#bpy.types.Armature.bones)
    - [`Armature.collections`](#bpy.types.Armature.collections)
    - [`Armature.collections_all`](#bpy.types.Armature.collections_all)
    - [`Armature.display_type`](#bpy.types.Armature.display_type)
    - [`Armature.edit_bones`](#bpy.types.Armature.edit_bones)
    - [`Armature.is_editmode`](#bpy.types.Armature.is_editmode)
    - [`Armature.pose_position`](#bpy.types.Armature.pose_position)
    - [`Armature.relation_line_position`](#bpy.types.Armature.relation_line_position)
    - [`Armature.show_axes`](#bpy.types.Armature.show_axes)
    - [`Armature.show_bone_colors`](#bpy.types.Armature.show_bone_colors)
    - [`Armature.show_bone_custom_shapes`](#bpy.types.Armature.show_bone_custom_shapes)
    - [`Armature.show_names`](#bpy.types.Armature.show_names)
    - [`Armature.use_mirror_x`](#bpy.types.Armature.use_mirror_x)
    - [`Armature.transform()`](#bpy.types.Armature.transform)
    - [`Armature.bl_rna_get_subclass()`](#bpy.types.Armature.bl_rna_get_subclass)
    - [`Armature.bl_rna_get_subclass_py()`](#bpy.types.Armature.bl_rna_get_subclass_py)
