...
# SequencerTonemapModifierData(StripModifier)[¶](#sequencertonemapmodifierdata-stripmodifier "Link to this heading")

base classes — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct"), [`StripModifier`](StripModifier.md#bpy.types.StripModifier "bpy.types.StripModifier")

*class* bpy.types.SequencerTonemapModifierData(*StripModifier*)[¶](#bpy.types.SequencerTonemapModifierData "Link to this definition")
:   Tone mapping modifier

    adaptation[¶](#bpy.types.SequencerTonemapModifierData.adaptation "Link to this definition")
    :   If 0, global; if 1, based on pixel intensity

        Type:
        :   float in [0, 1], default 0.0

    contrast[¶](#bpy.types.SequencerTonemapModifierData.contrast "Link to this definition")
    :   Set to 0 to use estimate from input image

        Type:
        :   float in [0, 1], default 0.0

    correction[¶](#bpy.types.SequencerTonemapModifierData.correction "Link to this definition")
    :   If 0, same for all channels; if 1, each independent

        Type:
        :   float in [0, 1], default 0.0

    gamma[¶](#bpy.types.SequencerTonemapModifierData.gamma "Link to this definition")
    :   If not used, set to 1

        Type:
        :   float in [0.001, 3], default 0.0

    intensity[¶](#bpy.types.SequencerTonemapModifierData.intensity "Link to this definition")
    :   If less than zero, darkens image; otherwise, makes it brighter

        Type:
        :   float in [-8, 8], default 0.0

    key[¶](#bpy.types.SequencerTonemapModifierData.key "Link to this definition")
    :   The value the average luminance is mapped to

        Type:
        :   float in [0, 1], default 0.0

    offset[¶](#bpy.types.SequencerTonemapModifierData.offset "Link to this definition")
    :   Normally always 1, but can be used as an extra control to alter the brightness curve

        Type:
        :   float in [0.001, 10], default 0.0

    open\_mask\_input\_panel[¶](#bpy.types.SequencerTonemapModifierData.open_mask_input_panel "Link to this definition")
    :   Type:
        :   boolean, default False

    tonemap\_type[¶](#bpy.types.SequencerTonemapModifierData.tonemap_type "Link to this definition")
    :   Tone mapping algorithm

        Type:
        :   enum in [`'RD_PHOTORECEPTOR'`, `'RH_SIMPLE'`], default `'RH_SIMPLE'`

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.SequencerTonemapModifierData.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.SequencerTonemapModifierData.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`bpy_struct.id_data`](bpy_struct.md#bpy.types.bpy_struct.id_data "bpy.types.bpy_struct.id_data") * [`StripModifier.name`](StripModifier.md#bpy.types.StripModifier.name "bpy.types.StripModifier.name") * [`StripModifier.type`](StripModifier.md#bpy.types.StripModifier.type "bpy.types.StripModifier.type") * [`StripModifier.mute`](StripModifier.md#bpy.types.StripModifier.mute "bpy.types.StripModifier.mute") * [`StripModifier.enable`](StripModifier.md#bpy.types.StripModifier.enable "bpy.types.StripModifier.enable") * [`StripModifier.show_expanded`](StripModifier.md#bpy.types.StripModifier.show_expanded "bpy.types.StripModifier.show_expanded") | * [`StripModifier.input_mask_type`](StripModifier.md#bpy.types.StripModifier.input_mask_type "bpy.types.StripModifier.input_mask_type") * [`StripModifier.mask_time`](StripModifier.md#bpy.types.StripModifier.mask_time "bpy.types.StripModifier.mask_time") * [`StripModifier.input_mask_strip`](StripModifier.md#bpy.types.StripModifier.input_mask_strip "bpy.types.StripModifier.input_mask_strip") * [`StripModifier.input_mask_id`](StripModifier.md#bpy.types.StripModifier.input_mask_id "bpy.types.StripModifier.input_mask_id") * [`StripModifier.is_active`](StripModifier.md#bpy.types.StripModifier.is_active "bpy.types.StripModifier.is_active") |

## Inherited Functions[¶](#inherited-functions "Link to this heading")

|  |  |
| --- | --- |
| * [`bpy_struct.as_pointer`](bpy_struct.md#bpy.types.bpy_struct.as_pointer "bpy.types.bpy_struct.as_pointer") * [`bpy_struct.driver_add`](bpy_struct.md#bpy.types.bpy_struct.driver_add "bpy.types.bpy_struct.driver_add") * [`bpy_struct.driver_remove`](bpy_struct.md#bpy.types.bpy_struct.driver_remove "bpy.types.bpy_struct.driver_remove") * [`bpy_struct.get`](bpy_struct.md#bpy.types.bpy_struct.get "bpy.types.bpy_struct.get") * [`bpy_struct.id_properties_clear`](bpy_struct.md#bpy.types.bpy_struct.id_properties_clear "bpy.types.bpy_struct.id_properties_clear") * [`bpy_struct.id_properties_ensure`](bpy_struct.md#bpy.types.bpy_struct.id_properties_ensure "bpy.types.bpy_struct.id_properties_ensure") * [`bpy_struct.id_properties_ui`](bpy_struct.md#bpy.types.bpy_struct.id_properties_ui "bpy.types.bpy_struct.id_properties_ui") * [`bpy_struct.is_property_hidden`](bpy_struct.md#bpy.types.bpy_struct.is_property_hidden "bpy.types.bpy_struct.is_property_hidden") * [`bpy_struct.is_property_overridable_library`](bpy_struct.md#bpy.types.bpy_struct.is_property_overridable_library "bpy.types.bpy_struct.is_property_overridable_library") * [`bpy_struct.is_property_readonly`](bpy_struct.md#bpy.types.bpy_struct.is_property_readonly "bpy.types.bpy_struct.is_property_readonly") * [`bpy_struct.is_property_set`](bpy_struct.md#bpy.types.bpy_struct.is_property_set "bpy.types.bpy_struct.is_property_set") * [`bpy_struct.items`](bpy_struct.md#bpy.types.bpy_struct.items "bpy.types.bpy_struct.items") * [`bpy_struct.keyframe_delete`](bpy_struct.md#bpy.types.bpy_struct.keyframe_delete "bpy.types.bpy_struct.keyframe_delete") | * [`bpy_struct.keyframe_insert`](bpy_struct.md#bpy.types.bpy_struct.keyframe_insert "bpy.types.bpy_struct.keyframe_insert") * [`bpy_struct.keys`](bpy_struct.md#bpy.types.bpy_struct.keys "bpy.types.bpy_struct.keys") * [`bpy_struct.path_from_id`](bpy_struct.md#bpy.types.bpy_struct.path_from_id "bpy.types.bpy_struct.path_from_id") * [`bpy_struct.path_from_module`](bpy_struct.md#bpy.types.bpy_struct.path_from_module "bpy.types.bpy_struct.path_from_module") * [`bpy_struct.path_resolve`](bpy_struct.md#bpy.types.bpy_struct.path_resolve "bpy.types.bpy_struct.path_resolve") * [`bpy_struct.pop`](bpy_struct.md#bpy.types.bpy_struct.pop "bpy.types.bpy_struct.pop") * [`bpy_struct.property_overridable_library_set`](bpy_struct.md#bpy.types.bpy_struct.property_overridable_library_set "bpy.types.bpy_struct.property_overridable_library_set") * [`bpy_struct.property_unset`](bpy_struct.md#bpy.types.bpy_struct.property_unset "bpy.types.bpy_struct.property_unset") * [`bpy_struct.rna_ancestors`](bpy_struct.md#bpy.types.bpy_struct.rna_ancestors "bpy.types.bpy_struct.rna_ancestors") * [`bpy_struct.type_recast`](bpy_struct.md#bpy.types.bpy_struct.type_recast "bpy.types.bpy_struct.type_recast") * [`bpy_struct.values`](bpy_struct.md#bpy.types.bpy_struct.values "bpy.types.bpy_struct.values") * [`StripModifier.bl_rna_get_subclass`](StripModifier.md#bpy.types.StripModifier.bl_rna_get_subclass "bpy.types.StripModifier.bl_rna_get_subclass") * [`StripModifier.bl_rna_get_subclass_py`](StripModifier.md#bpy.types.StripModifier.bl_rna_get_subclass_py "bpy.types.StripModifier.bl_rna_get_subclass_py") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.SequencerTonemapModifierData.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.SequencerTonemapModifierData.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* SequencerTonemapModifierData(StripModifier)
  + [`SequencerTonemapModifierData`](#bpy.types.SequencerTonemapModifierData)
    - [`SequencerTonemapModifierData.adaptation`](#bpy.types.SequencerTonemapModifierData.adaptation)
    - [`SequencerTonemapModifierData.contrast`](#bpy.types.SequencerTonemapModifierData.contrast)
    - [`SequencerTonemapModifierData.correction`](#bpy.types.SequencerTonemapModifierData.correction)
    - [`SequencerTonemapModifierData.gamma`](#bpy.types.SequencerTonemapModifierData.gamma)
    - [`SequencerTonemapModifierData.intensity`](#bpy.types.SequencerTonemapModifierData.intensity)
    - [`SequencerTonemapModifierData.key`](#bpy.types.SequencerTonemapModifierData.key)
    - [`SequencerTonemapModifierData.offset`](#bpy.types.SequencerTonemapModifierData.offset)
    - [`SequencerTonemapModifierData.open_mask_input_panel`](#bpy.types.SequencerTonemapModifierData.open_mask_input_panel)
    - [`SequencerTonemapModifierData.tonemap_type`](#bpy.types.SequencerTonemapModifierData.tonemap_type)
    - [`SequencerTonemapModifierData.bl_rna_get_subclass()`](#bpy.types.SequencerTonemapModifierData.bl_rna_get_subclass)
    - [`SequencerTonemapModifierData.bl_rna_get_subclass_py()`](#bpy.types.SequencerTonemapModifierData.bl_rna_get_subclass_py)
