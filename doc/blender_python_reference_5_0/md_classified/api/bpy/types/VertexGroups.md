...
# VertexGroups(bpy\_struct)[¶](#vertexgroups-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.VertexGroups(*bpy\_struct*)[¶](#bpy.types.VertexGroups "Link to this definition")
:   Collection of vertex groups

    active[¶](#bpy.types.VertexGroups.active "Link to this definition")
    :   Vertex groups of the object

        Type:
        :   [`VertexGroup`](VertexGroup.md#bpy.types.VertexGroup "bpy.types.VertexGroup")

    active\_index[¶](#bpy.types.VertexGroups.active_index "Link to this definition")
    :   Active index in vertex group array

        Type:
        :   int in [0, inf], default 0

    new(*\**, *name='Group'*)[¶](#bpy.types.VertexGroups.new "Link to this definition")
    ...
    remove(*group*)[¶](#bpy.types.VertexGroups.remove "Link to this definition")
    :   Delete vertex group from object

        Parameters:
        :   **group** ([`VertexGroup`](VertexGroup.md#bpy.types.VertexGroup "bpy.types.VertexGroup"), (never None)) – Vertex group to remove

    clear()[¶](#bpy.types.VertexGroups.clear "Link to this definition")
    :   Delete all vertex groups from object

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.VertexGroups.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.VertexGroups.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Object.vertex_groups`](Object.md#bpy.types.Object.vertex_groups "bpy.types.Object.vertex_groups") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.VertexGroups.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.VertexGroups.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* VertexGroups(bpy\_struct)
  + [`VertexGroups`](#bpy.types.VertexGroups)
    - [`VertexGroups.active`](#bpy.types.VertexGroups.active)
    - [`VertexGroups.active_index`](#bpy.types.VertexGroups.active_index)
    - [`VertexGroups.new()`](#bpy.types.VertexGroups.new)
    - [`VertexGroups.remove()`](#bpy.types.VertexGroups.remove)
    - [`VertexGroups.clear()`](#bpy.types.VertexGroups.clear)
    - [`VertexGroups.bl_rna_get_subclass()`](#bpy.types.VertexGroups.bl_rna_get_subclass)
    - [`VertexGroups.bl_rna_get_subclass_py()`](#bpy.types.VertexGroups.bl_rna_get_subclass_py)
