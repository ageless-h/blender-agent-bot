...
# DepsgraphUpdate(bpy\_struct)[¶](#depsgraphupdate-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.DepsgraphUpdate(*bpy\_struct*)[¶](#bpy.types.DepsgraphUpdate "Link to this definition")
:   Information about ID that was updated

    id[¶](#bpy.types.DepsgraphUpdate.id "Link to this definition")
    :   Updated data-block

        Type:
        :   [`ID`](ID.md#bpy.types.ID "bpy.types.ID"), (readonly)

    is\_updated\_geometry[¶](#bpy.types.DepsgraphUpdate.is_updated_geometry "Link to this definition")
    :   Object geometry is updated

        Type:
        :   boolean, default False, (readonly)

    is\_updated\_shading[¶](#bpy.types.DepsgraphUpdate.is_updated_shading "Link to this definition")
    :   Object shading is updated

        Type:
        :   boolean, default False, (readonly)

    is\_updated\_transform[¶](#bpy.types.DepsgraphUpdate.is_updated_transform "Link to this definition")
    :   Object transformation is updated

        Type:
        :   boolean, default False, (readonly)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.DepsgraphUpdate.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.DepsgraphUpdate.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Depsgraph.updates`](Depsgraph.md#bpy.types.Depsgraph.updates "bpy.types.Depsgraph.updates") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.DepsgraphUpdate.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.DepsgraphUpdate.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* DepsgraphUpdate(bpy\_struct)
  + [`DepsgraphUpdate`](#bpy.types.DepsgraphUpdate)
    - [`DepsgraphUpdate.id`](#bpy.types.DepsgraphUpdate.id)
    - [`DepsgraphUpdate.is_updated_geometry`](#bpy.types.DepsgraphUpdate.is_updated_geometry)
    - [`DepsgraphUpdate.is_updated_shading`](#bpy.types.DepsgraphUpdate.is_updated_shading)
    - [`DepsgraphUpdate.is_updated_transform`](#bpy.types.DepsgraphUpdate.is_updated_transform)
    - [`DepsgraphUpdate.bl_rna_get_subclass()`](#bpy.types.DepsgraphUpdate.bl_rna_get_subclass)
    - [`DepsgraphUpdate.bl_rna_get_subclass_py()`](#bpy.types.DepsgraphUpdate.bl_rna_get_subclass_py)
