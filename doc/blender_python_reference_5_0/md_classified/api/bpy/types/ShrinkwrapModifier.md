...
# ShrinkwrapModifier(Modifier)[¶](#shrinkwrapmodifier-modifier "Link to this heading")
...
*class* bpy.types.ShrinkwrapModifier(*Modifier*)[¶](#bpy.types.ShrinkwrapModifier "Link to this definition")
:   Shrink wrapping modifier to shrink wrap and object to a target

    auxiliary\_target[¶](#bpy.types.ShrinkwrapModifier.auxiliary_target "Link to this definition")
    :   Additional mesh target to shrink to

        Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object")

    cull\_face[¶](#bpy.types.ShrinkwrapModifier.cull_face "Link to this definition")
    ...
    invert\_vertex\_group[¶](#bpy.types.ShrinkwrapModifier.invert_vertex_group "Link to this definition")
    :   Invert vertex group influence

        Type:
        :   boolean, default False

    offset[¶](#bpy.types.ShrinkwrapModifier.offset "Link to this definition")
    :   Distance to keep from the target

        Type:
        :   float in [-inf, inf], default 0.0

    project\_limit[¶](#bpy.types.ShrinkwrapModifier.project_limit "Link to this definition")
    :   Limit the distance used for projection (zero disables)

        Type:
        :   float in [0, inf], default 0.0

    subsurf\_levels[¶](#bpy.types.ShrinkwrapModifier.subsurf_levels "Link to this definition")
    :   Number of subdivisions that must be performed before extracting vertices’ positions and normals

        Type:
        :   int in [0, 6], default 0

    target[¶](#bpy.types.ShrinkwrapModifier.target "Link to this definition")
    :   Mesh target to shrink to

        Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object")

    use\_invert\_cull[¶](#bpy.types.ShrinkwrapModifier.use_invert_cull "Link to this definition")
    :   When projecting in the negative direction invert the face cull mode

        Type:
        :   boolean, default False

    use\_negative\_direction[¶](#bpy.types.ShrinkwrapModifier.use_negative_direction "Link to this definition")
    :   Allow vertices to move in the negative direction of axis

        Type:
        :   boolean, default False

    use\_positive\_direction[¶](#bpy.types.ShrinkwrapModifier.use_positive_direction "Link to this definition")
    :   Allow vertices to move in the positive direction of axis

        Type:
        :   boolean, default True

    use\_project\_x[¶](#bpy.types.ShrinkwrapModifier.use_project_x "Link to this definition")
    :   Type:
        :   boolean, default False

    use\_project\_y[¶](#bpy.types.ShrinkwrapModifier.use_project_y "Link to this definition")
    :   Type:
        :   boolean, default False

    use\_project\_z[¶](#bpy.types.ShrinkwrapModifier.use_project_z "Link to this definition")
    :   Type:
        :   boolean, default False

    vertex\_group[¶](#bpy.types.ShrinkwrapModifier.vertex_group "Link to this definition")
    :   Vertex group name

        Type:
        :   string, default “”, (never None)

    wrap\_method[¶](#bpy.types.ShrinkwrapModifier.wrap_method "Link to this definition")
    :   Type:
    ...
    wrap\_mode[¶](#bpy.types.ShrinkwrapModifier.wrap_mode "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ShrinkwrapModifier.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ShrinkwrapModifier.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ShrinkwrapModifier.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ShrinkwrapModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ShrinkwrapModifier(Modifier)
  + [`ShrinkwrapModifier`](#bpy.types.ShrinkwrapModifier)
    - [`ShrinkwrapModifier.auxiliary_target`](#bpy.types.ShrinkwrapModifier.auxiliary_target)
    - [`ShrinkwrapModifier.cull_face`](#bpy.types.ShrinkwrapModifier.cull_face)
    - [`ShrinkwrapModifier.invert_vertex_group`](#bpy.types.ShrinkwrapModifier.invert_vertex_group)
    - [`ShrinkwrapModifier.offset`](#bpy.types.ShrinkwrapModifier.offset)
    - [`ShrinkwrapModifier.project_limit`](#bpy.types.ShrinkwrapModifier.project_limit)
    - [`ShrinkwrapModifier.subsurf_levels`](#bpy.types.ShrinkwrapModifier.subsurf_levels)
    - [`ShrinkwrapModifier.target`](#bpy.types.ShrinkwrapModifier.target)
    - [`ShrinkwrapModifier.use_invert_cull`](#bpy.types.ShrinkwrapModifier.use_invert_cull)
    - [`ShrinkwrapModifier.use_negative_direction`](#bpy.types.ShrinkwrapModifier.use_negative_direction)
    - [`ShrinkwrapModifier.use_positive_direction`](#bpy.types.ShrinkwrapModifier.use_positive_direction)
    - [`ShrinkwrapModifier.use_project_x`](#bpy.types.ShrinkwrapModifier.use_project_x)
    - [`ShrinkwrapModifier.use_project_y`](#bpy.types.ShrinkwrapModifier.use_project_y)
    - [`ShrinkwrapModifier.use_project_z`](#bpy.types.ShrinkwrapModifier.use_project_z)
    - [`ShrinkwrapModifier.vertex_group`](#bpy.types.ShrinkwrapModifier.vertex_group)
    - [`ShrinkwrapModifier.wrap_method`](#bpy.types.ShrinkwrapModifier.wrap_method)
    - [`ShrinkwrapModifier.wrap_mode`](#bpy.types.ShrinkwrapModifier.wrap_mode)
    - [`ShrinkwrapModifier.bl_rna_get_subclass()`](#bpy.types.ShrinkwrapModifier.bl_rna_get_subclass)
    - [`ShrinkwrapModifier.bl_rna_get_subclass_py()`](#bpy.types.ShrinkwrapModifier.bl_rna_get_subclass_py)
