...
# ThemeRegionsChannels(bpy\_struct)[¶](#themeregionschannels-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.ThemeRegionsChannels(*bpy\_struct*)[¶](#bpy.types.ThemeRegionsChannels "Link to this definition")
:   back[¶](#bpy.types.ThemeRegionsChannels.back "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    text[¶](#bpy.types.ThemeRegionsChannels.text "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    text\_selected[¶](#bpy.types.ThemeRegionsChannels.text_selected "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ThemeRegionsChannels.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ThemeRegionsChannels.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`ThemeRegions.channels`](ThemeRegions.md#bpy.types.ThemeRegions.channels "bpy.types.ThemeRegions.channels") |  |

[Next

ThemeRegionsScrubbing(bpy\_struct)](ThemeRegionsScrubbing.md)
[Previous
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ThemeRegionsChannels.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ThemeRegionsChannels.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ThemeRegionsChannels(bpy\_struct)
  + [`ThemeRegionsChannels`](#bpy.types.ThemeRegionsChannels)
    - [`ThemeRegionsChannels.back`](#bpy.types.ThemeRegionsChannels.back)
    - [`ThemeRegionsChannels.text`](#bpy.types.ThemeRegionsChannels.text)
    - [`ThemeRegionsChannels.text_selected`](#bpy.types.ThemeRegionsChannels.text_selected)
    - [`ThemeRegionsChannels.bl_rna_get_subclass()`](#bpy.types.ThemeRegionsChannels.bl_rna_get_subclass)
    - [`ThemeRegionsChannels.bl_rna_get_subclass_py()`](#bpy.types.ThemeRegionsChannels.bl_rna_get_subclass_py)
