...
# MeshCacheModifier(Modifier)[¶](#meshcachemodifier-modifier "Link to this heading")
...
*class* bpy.types.MeshCacheModifier(*Modifier*)[¶](#bpy.types.MeshCacheModifier "Link to this definition")
:   Cache Mesh

    cache\_format[¶](#bpy.types.MeshCacheModifier.cache_format "Link to this definition")
    :   Type:
        :   enum in [`'MDD'`, `'PC2'`], default `'MDD'`

    deform\_mode[¶](#bpy.types.MeshCacheModifier.deform_mode "Link to this definition")
    :   * `OVERWRITE`
    ...
    eval\_factor[¶](#bpy.types.MeshCacheModifier.eval_factor "Link to this definition")
    :   Evaluation time in seconds

        Type:
        :   float in [0, 1], default 0.0

    eval\_frame[¶](#bpy.types.MeshCacheModifier.eval_frame "Link to this definition")
    :   The frame to evaluate (starting at 0)

        Type:
        :   float in [0, 1.04857e+06], default 0.0

    eval\_time[¶](#bpy.types.MeshCacheModifier.eval_time "Link to this definition")
    :   Evaluation time in seconds

        Type:
        :   float in [0, inf], default 0.0

    factor[¶](#bpy.types.MeshCacheModifier.factor "Link to this definition")
    :   Influence of the deformation

        Type:
        :   float in [0, 1], default 1.0

    filepath[¶](#bpy.types.MeshCacheModifier.filepath "Link to this definition")
    :   Path to external displacements file

        Type:
        :   string, default “”, (never None, blend relative `//` prefix supported)

    flip\_axis[¶](#bpy.types.MeshCacheModifier.flip_axis "Link to this definition")
    :   Type:
        :   boolean array of 3 items, default (False, False, False)

    forward\_axis[¶](#bpy.types.MeshCacheModifier.forward_axis "Link to this definition")
    :   Type:
        :   enum in [Object Axis Items](../../../appendix/bpy_types_enum_items/object_axis_items.md#rna-enum-object-axis-items), default `'POS_Y'`

    frame\_scale[¶](#bpy.types.MeshCacheModifier.frame_scale "Link to this definition")
    :   Evaluation time in seconds

        Type:
        :   float in [0, 100], default 1.0

    frame\_start[¶](#bpy.types.MeshCacheModifier.frame_start "Link to this definition")
    :   Add this to the start frame

        Type:
        :   float in [-1.04857e+06, 1.04857e+06], default 0.0

    interpolation[¶](#bpy.types.MeshCacheModifier.interpolation "Link to this definition")
    :   Type:
        :   enum in [`'NONE'`, `'LINEAR'`], default `'LINEAR'`

    invert\_vertex\_group[¶](#bpy.types.MeshCacheModifier.invert_vertex_group "Link to this definition")
    :   Invert vertex group influence

        Type:
        :   boolean, default False

    play\_mode[¶](#bpy.types.MeshCacheModifier.play_mode "Link to this definition")
    :   * `SCENE`
    ...
    time\_mode[¶](#bpy.types.MeshCacheModifier.time_mode "Link to this definition")
    ...
    up\_axis[¶](#bpy.types.MeshCacheModifier.up_axis "Link to this definition")
    :   Type:
        :   enum in [Object Axis Items](../../../appendix/bpy_types_enum_items/object_axis_items.md#rna-enum-object-axis-items), default `'POS_Z'`

    vertex\_group[¶](#bpy.types.MeshCacheModifier.vertex_group "Link to this definition")
    :   Name of the Vertex Group which determines the influence of the modifier per point

        Type:
        :   string, default “”, (never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.MeshCacheModifier.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.MeshCacheModifier.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.MeshCacheModifier.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.MeshCacheModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* MeshCacheModifier(Modifier)
  + [`MeshCacheModifier`](#bpy.types.MeshCacheModifier)
    - [`MeshCacheModifier.cache_format`](#bpy.types.MeshCacheModifier.cache_format)
    - [`MeshCacheModifier.deform_mode`](#bpy.types.MeshCacheModifier.deform_mode)
    - [`MeshCacheModifier.eval_factor`](#bpy.types.MeshCacheModifier.eval_factor)
    - [`MeshCacheModifier.eval_frame`](#bpy.types.MeshCacheModifier.eval_frame)
    - [`MeshCacheModifier.eval_time`](#bpy.types.MeshCacheModifier.eval_time)
    - [`MeshCacheModifier.factor`](#bpy.types.MeshCacheModifier.factor)
    - [`MeshCacheModifier.filepath`](#bpy.types.MeshCacheModifier.filepath)
    - [`MeshCacheModifier.flip_axis`](#bpy.types.MeshCacheModifier.flip_axis)
    - [`MeshCacheModifier.forward_axis`](#bpy.types.MeshCacheModifier.forward_axis)
    - [`MeshCacheModifier.frame_scale`](#bpy.types.MeshCacheModifier.frame_scale)
    - [`MeshCacheModifier.frame_start`](#bpy.types.MeshCacheModifier.frame_start)
    - [`MeshCacheModifier.interpolation`](#bpy.types.MeshCacheModifier.interpolation)
    - [`MeshCacheModifier.invert_vertex_group`](#bpy.types.MeshCacheModifier.invert_vertex_group)
    - [`MeshCacheModifier.play_mode`](#bpy.types.MeshCacheModifier.play_mode)
    - [`MeshCacheModifier.time_mode`](#bpy.types.MeshCacheModifier.time_mode)
    - [`MeshCacheModifier.up_axis`](#bpy.types.MeshCacheModifier.up_axis)
    - [`MeshCacheModifier.vertex_group`](#bpy.types.MeshCacheModifier.vertex_group)
    - [`MeshCacheModifier.bl_rna_get_subclass()`](#bpy.types.MeshCacheModifier.bl_rna_get_subclass)
    - [`MeshCacheModifier.bl_rna_get_subclass_py()`](#bpy.types.MeshCacheModifier.bl_rna_get_subclass_py)
