...
# MovieTracking(bpy\_struct)[¶](#movietracking-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.MovieTracking(*bpy\_struct*)[¶](#bpy.types.MovieTracking "Link to this definition")
:   Match-moving data for tracking

    active\_object\_index[¶](#bpy.types.MovieTracking.active_object_index "Link to this definition")
    :   Index of active object

        Type:
        :   int in [-inf, inf], default 0

    camera[¶](#bpy.types.MovieTracking.camera "Link to this definition")
    :   Type:
        :   [`MovieTrackingCamera`](MovieTrackingCamera.md#bpy.types.MovieTrackingCamera "bpy.types.MovieTrackingCamera"), (readonly)

    dopesheet[¶](#bpy.types.MovieTracking.dopesheet "Link to this definition")
    :   Type:
        :   [`MovieTrackingDopesheet`](MovieTrackingDopesheet.md#bpy.types.MovieTrackingDopesheet "bpy.types.MovieTrackingDopesheet"), (readonly)

    objects[¶](#bpy.types.MovieTracking.objects "Link to this definition")
    :   Collection of objects in this tracking data object

        Type:
        :   [`MovieTrackingObjects`](MovieTrackingObjects.md#bpy.types.MovieTrackingObjects "bpy.types.MovieTrackingObjects") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`MovieTrackingObject`](MovieTrackingObject.md#bpy.types.MovieTrackingObject "bpy.types.MovieTrackingObject"), (readonly)

    plane\_tracks[¶](#bpy.types.MovieTracking.plane_tracks "Link to this definition")
    :   Collection of plane tracks in this tracking data object. Deprecated, use objects[name].plane\_tracks

        Type:
        :   [`MovieTrackingPlaneTracks`](MovieTrackingPlaneTracks.md#bpy.types.MovieTrackingPlaneTracks "bpy.types.MovieTrackingPlaneTracks") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`MovieTrackingPlaneTrack`](MovieTrackingPlaneTrack.md#bpy.types.MovieTrackingPlaneTrack "bpy.types.MovieTrackingPlaneTrack"), (readonly)

    reconstruction[¶](#bpy.types.MovieTracking.reconstruction "Link to this definition")
    :   Type:
        :   [`MovieTrackingReconstruction`](MovieTrackingReconstruction.md#bpy.types.MovieTrackingReconstruction "bpy.types.MovieTrackingReconstruction"), (readonly)

    settings[¶](#bpy.types.MovieTracking.settings "Link to this definition")
    :   Type:
        :   [`MovieTrackingSettings`](MovieTrackingSettings.md#bpy.types.MovieTrackingSettings "bpy.types.MovieTrackingSettings"), (readonly)

    stabilization[¶](#bpy.types.MovieTracking.stabilization "Link to this definition")
    :   Type:
        :   [`MovieTrackingStabilization`](MovieTrackingStabilization.md#bpy.types.MovieTrackingStabilization "bpy.types.MovieTrackingStabilization"), (readonly)

    tracks[¶](#bpy.types.MovieTracking.tracks "Link to this definition")
    :   Collection of tracks in this tracking data object. Deprecated, use objects[name].tracks

        Type:
        :   [`MovieTrackingTracks`](MovieTrackingTracks.md#bpy.types.MovieTrackingTracks "bpy.types.MovieTrackingTracks") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`MovieTrackingTrack`](MovieTrackingTrack.md#bpy.types.MovieTrackingTrack "bpy.types.MovieTrackingTrack"), (readonly)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.MovieTracking.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.MovieTracking.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`MovieClip.tracking`](MovieClip.md#bpy.types.MovieClip.tracking "bpy.types.MovieClip.tracking") |  |
...
MovieStrip(Strip)](MovieStrip.md)
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.MovieTracking.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.MovieTracking.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* MovieTracking(bpy\_struct)
  + [`MovieTracking`](#bpy.types.MovieTracking)
    - [`MovieTracking.active_object_index`](#bpy.types.MovieTracking.active_object_index)
    - [`MovieTracking.camera`](#bpy.types.MovieTracking.camera)
    - [`MovieTracking.dopesheet`](#bpy.types.MovieTracking.dopesheet)
    - [`MovieTracking.objects`](#bpy.types.MovieTracking.objects)
    - [`MovieTracking.plane_tracks`](#bpy.types.MovieTracking.plane_tracks)
    - [`MovieTracking.reconstruction`](#bpy.types.MovieTracking.reconstruction)
    - [`MovieTracking.settings`](#bpy.types.MovieTracking.settings)
    - [`MovieTracking.stabilization`](#bpy.types.MovieTracking.stabilization)
    - [`MovieTracking.tracks`](#bpy.types.MovieTracking.tracks)
    - [`MovieTracking.bl_rna_get_subclass()`](#bpy.types.MovieTracking.bl_rna_get_subclass)
    - [`MovieTracking.bl_rna_get_subclass_py()`](#bpy.types.MovieTracking.bl_rna_get_subclass_py)
