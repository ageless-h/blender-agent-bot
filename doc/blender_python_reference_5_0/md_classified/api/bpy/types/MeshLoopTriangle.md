...
# MeshLoopTriangle(bpy\_struct)[¶](#meshlooptriangle-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.MeshLoopTriangle(*bpy\_struct*)[¶](#bpy.types.MeshLoopTriangle "Link to this definition")
:   Tessellated triangle in a Mesh data-block

    area[¶](#bpy.types.MeshLoopTriangle.area "Link to this definition")
    :   Area of this triangle

        Type:
        :   float in [0, inf], default 0.0, (readonly)

    index[¶](#bpy.types.MeshLoopTriangle.index "Link to this definition")
    :   Index of this loop triangle

        Type:
        :   int in [0, inf], default 0, (readonly)

    loops[¶](#bpy.types.MeshLoopTriangle.loops "Link to this definition")
    :   Indices of mesh loops that make up the triangle

        Type:
        :   int array of 3 items in [0, inf], default (0, 0, 0), (readonly)

    material\_index[¶](#bpy.types.MeshLoopTriangle.material_index "Link to this definition")
    :   Material slot index of this triangle

        Type:
        :   int in [0, inf], default 0, (readonly)

    normal[¶](#bpy.types.MeshLoopTriangle.normal "Link to this definition")
    ...
    polygon\_index[¶](#bpy.types.MeshLoopTriangle.polygon_index "Link to this definition")
    :   Index of mesh face that the triangle is a part of

        Type:
        :   int in [0, inf], default 0, (readonly)

    split\_normals[¶](#bpy.types.MeshLoopTriangle.split_normals "Link to this definition")
    ...
    use\_smooth[¶](#bpy.types.MeshLoopTriangle.use_smooth "Link to this definition")
    :   Type:
        :   boolean, default False, (readonly)

    vertices[¶](#bpy.types.MeshLoopTriangle.vertices "Link to this definition")
    :   Indices of triangle vertices

        Type:
        :   int array of 3 items in [0, inf], default (0, 0, 0), (readonly)

    center[¶](#bpy.types.MeshLoopTriangle.center "Link to this definition")
    :   The midpoint of the face.

        (readonly)

    edge\_keys[¶](#bpy.types.MeshLoopTriangle.edge_keys "Link to this definition")
    :   (readonly)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.MeshLoopTriangle.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.MeshLoopTriangle.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Mesh.loop_triangles`](Mesh.md#bpy.types.Mesh.loop_triangles "bpy.types.Mesh.loop_triangles") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.MeshLoopTriangle.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.MeshLoopTriangle.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* MeshLoopTriangle(bpy\_struct)
  + [`MeshLoopTriangle`](#bpy.types.MeshLoopTriangle)
    - [`MeshLoopTriangle.area`](#bpy.types.MeshLoopTriangle.area)
    - [`MeshLoopTriangle.index`](#bpy.types.MeshLoopTriangle.index)
    - [`MeshLoopTriangle.loops`](#bpy.types.MeshLoopTriangle.loops)
    - [`MeshLoopTriangle.material_index`](#bpy.types.MeshLoopTriangle.material_index)
    - [`MeshLoopTriangle.normal`](#bpy.types.MeshLoopTriangle.normal)
    - [`MeshLoopTriangle.polygon_index`](#bpy.types.MeshLoopTriangle.polygon_index)
    - [`MeshLoopTriangle.split_normals`](#bpy.types.MeshLoopTriangle.split_normals)
    - [`MeshLoopTriangle.use_smooth`](#bpy.types.MeshLoopTriangle.use_smooth)
    - [`MeshLoopTriangle.vertices`](#bpy.types.MeshLoopTriangle.vertices)
    - [`MeshLoopTriangle.center`](#bpy.types.MeshLoopTriangle.center)
    - [`MeshLoopTriangle.edge_keys`](#bpy.types.MeshLoopTriangle.edge_keys)
    - [`MeshLoopTriangle.bl_rna_get_subclass()`](#bpy.types.MeshLoopTriangle.bl_rna_get_subclass)
    - [`MeshLoopTriangle.bl_rna_get_subclass_py()`](#bpy.types.MeshLoopTriangle.bl_rna_get_subclass_py)
