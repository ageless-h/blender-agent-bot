...
# BrushCapabilities(bpy\_struct)[¶](#brushcapabilities-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.BrushCapabilities(*bpy\_struct*)[¶](#bpy.types.BrushCapabilities "Link to this definition")
:   Read-only indications of supported operations

    has\_overlay[¶](#bpy.types.BrushCapabilities.has_overlay "Link to this definition")
    :   Type:
        :   boolean, default False, (readonly)

    has\_random\_texture\_angle[¶](#bpy.types.BrushCapabilities.has_random_texture_angle "Link to this definition")
    :   Type:
        :   boolean, default False, (readonly)

    has\_smooth\_stroke[¶](#bpy.types.BrushCapabilities.has_smooth_stroke "Link to this definition")
    :   Type:
        :   boolean, default False, (readonly)

    has\_spacing[¶](#bpy.types.BrushCapabilities.has_spacing "Link to this definition")
    :   Type:
        :   boolean, default False, (readonly)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.BrushCapabilities.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.BrushCapabilities.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Brush.brush_capabilities`](Brush.md#bpy.types.Brush.brush_capabilities "bpy.types.Brush.brush_capabilities") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.BrushCapabilities.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.BrushCapabilities.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* BrushCapabilities(bpy\_struct)
  + [`BrushCapabilities`](#bpy.types.BrushCapabilities)
    - [`BrushCapabilities.has_overlay`](#bpy.types.BrushCapabilities.has_overlay)
    - [`BrushCapabilities.has_random_texture_angle`](#bpy.types.BrushCapabilities.has_random_texture_angle)
    - [`BrushCapabilities.has_smooth_stroke`](#bpy.types.BrushCapabilities.has_smooth_stroke)
    - [`BrushCapabilities.has_spacing`](#bpy.types.BrushCapabilities.has_spacing)
    - [`BrushCapabilities.bl_rna_get_subclass()`](#bpy.types.BrushCapabilities.bl_rna_get_subclass)
    - [`BrushCapabilities.bl_rna_get_subclass_py()`](#bpy.types.BrushCapabilities.bl_rna_get_subclass_py)
