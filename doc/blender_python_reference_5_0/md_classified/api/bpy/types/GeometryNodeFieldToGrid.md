...
# GeometryNodeFieldToGrid(GeometryNode)[¶](#geometrynodefieldtogrid-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeFieldToGrid(*GeometryNode*)[¶](#bpy.types.GeometryNodeFieldToGrid "Link to this definition")
:   Create new grids by evaluating new values on an existing volume grid topology

    active\_index[¶](#bpy.types.GeometryNodeFieldToGrid.active_index "Link to this definition")
    :   Index of the active item

        Type:
        :   int in [0, inf], default 0

    active\_item[¶](#bpy.types.GeometryNodeFieldToGrid.active_item "Link to this definition")
    :   Index of the active item

        Type:
        :   [`RepeatItem`](RepeatItem.md#bpy.types.RepeatItem "bpy.types.RepeatItem")

    data\_type[¶](#bpy.types.GeometryNodeFieldToGrid.data_type "Link to this definition")
    ...
    grid\_items[¶](#bpy.types.GeometryNodeFieldToGrid.grid_items "Link to this definition")
    :   Type:
        :   [`GeometryNodeFieldToGridItems`](GeometryNodeFieldToGridItems.md#bpy.types.GeometryNodeFieldToGridItems "bpy.types.GeometryNodeFieldToGridItems") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`GeometryNodeFieldToGridItem`](GeometryNodeFieldToGridItem.md#bpy.types.GeometryNodeFieldToGridItem "bpy.types.GeometryNodeFieldToGridItem"), (readonly)

    *classmethod* is\_registered\_node\_type()[¶](#bpy.types.GeometryNodeFieldToGrid.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[¶](#bpy.types.GeometryNodeFieldToGrid.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[¶](#bpy.types.GeometryNodeFieldToGrid.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.GeometryNodeFieldToGrid.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.GeometryNodeFieldToGrid.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
GeometryNodeFieldToGridItem(bpy\_struct)](GeometryNodeFieldToGridItem.md)
[Previous
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeFieldToGrid.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.GeometryNodeFieldToGrid.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeFieldToGrid(GeometryNode)
  + [`GeometryNodeFieldToGrid`](#bpy.types.GeometryNodeFieldToGrid)
    - [`GeometryNodeFieldToGrid.active_index`](#bpy.types.GeometryNodeFieldToGrid.active_index)
    - [`GeometryNodeFieldToGrid.active_item`](#bpy.types.GeometryNodeFieldToGrid.active_item)
    - [`GeometryNodeFieldToGrid.data_type`](#bpy.types.GeometryNodeFieldToGrid.data_type)
    - [`GeometryNodeFieldToGrid.grid_items`](#bpy.types.GeometryNodeFieldToGrid.grid_items)
    - [`GeometryNodeFieldToGrid.is_registered_node_type()`](#bpy.types.GeometryNodeFieldToGrid.is_registered_node_type)
    - [`GeometryNodeFieldToGrid.input_template()`](#bpy.types.GeometryNodeFieldToGrid.input_template)
    - [`GeometryNodeFieldToGrid.output_template()`](#bpy.types.GeometryNodeFieldToGrid.output_template)
    - [`GeometryNodeFieldToGrid.bl_rna_get_subclass()`](#bpy.types.GeometryNodeFieldToGrid.bl_rna_get_subclass)
    - [`GeometryNodeFieldToGrid.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeFieldToGrid.bl_rna_get_subclass_py)
