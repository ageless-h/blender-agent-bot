...
# ThemeGradientColors(bpy\_struct)[¶](#themegradientcolors-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.ThemeGradientColors(*bpy\_struct*)[¶](#bpy.types.ThemeGradientColors "Link to this definition")
:   Theme settings for background colors and gradient

    background\_type[¶](#bpy.types.ThemeGradientColors.background_type "Link to this definition")
    ...
    gradient[¶](#bpy.types.ThemeGradientColors.gradient "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    high\_gradient[¶](#bpy.types.ThemeGradientColors.high_gradient "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ThemeGradientColors.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ThemeGradientColors.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`ThemeSpaceGradient.gradients`](ThemeSpaceGradient.md#bpy.types.ThemeSpaceGradient.gradients "bpy.types.ThemeSpaceGradient.gradients") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ThemeGradientColors.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ThemeGradientColors.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ThemeGradientColors(bpy\_struct)
  + [`ThemeGradientColors`](#bpy.types.ThemeGradientColors)
    - [`ThemeGradientColors.background_type`](#bpy.types.ThemeGradientColors.background_type)
    - [`ThemeGradientColors.gradient`](#bpy.types.ThemeGradientColors.gradient)
    - [`ThemeGradientColors.high_gradient`](#bpy.types.ThemeGradientColors.high_gradient)
    - [`ThemeGradientColors.bl_rna_get_subclass()`](#bpy.types.ThemeGradientColors.bl_rna_get_subclass)
    - [`ThemeGradientColors.bl_rna_get_subclass_py()`](#bpy.types.ThemeGradientColors.bl_rna_get_subclass_py)
