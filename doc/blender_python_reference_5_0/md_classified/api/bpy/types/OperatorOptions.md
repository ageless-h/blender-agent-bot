...
# OperatorOptions(bpy\_struct)[¶](#operatoroptions-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.OperatorOptions(*bpy\_struct*)[¶](#bpy.types.OperatorOptions "Link to this definition")
:   Runtime options

    is\_grab\_cursor[¶](#bpy.types.OperatorOptions.is_grab_cursor "Link to this definition")
    :   True when the cursor is grabbed

        Type:
        :   boolean, default False, (readonly)

    is\_invoke[¶](#bpy.types.OperatorOptions.is_invoke "Link to this definition")
    :   True when invoked (even if only the execute callbacks available)

        Type:
        :   boolean, default False, (readonly)

    is\_repeat[¶](#bpy.types.OperatorOptions.is_repeat "Link to this definition")
    :   True when run from the ‘Adjust Last Operation’ panel

        Type:
        :   boolean, default False, (readonly)

    is\_repeat\_last[¶](#bpy.types.OperatorOptions.is_repeat_last "Link to this definition")
    :   True when run from the operator ‘Repeat Last’

        Type:
        :   boolean, default False, (readonly)

    use\_cursor\_region[¶](#bpy.types.OperatorOptions.use_cursor_region "Link to this definition")
    :   Enable to use the region under the cursor for modal execution

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.OperatorOptions.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.OperatorOptions.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Operator.options`](Operator.md#bpy.types.Operator.options "bpy.types.Operator.options") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.OperatorOptions.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.OperatorOptions.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* OperatorOptions(bpy\_struct)
  + [`OperatorOptions`](#bpy.types.OperatorOptions)
    - [`OperatorOptions.is_grab_cursor`](#bpy.types.OperatorOptions.is_grab_cursor)
    - [`OperatorOptions.is_invoke`](#bpy.types.OperatorOptions.is_invoke)
    - [`OperatorOptions.is_repeat`](#bpy.types.OperatorOptions.is_repeat)
    - [`OperatorOptions.is_repeat_last`](#bpy.types.OperatorOptions.is_repeat_last)
    - [`OperatorOptions.use_cursor_region`](#bpy.types.OperatorOptions.use_cursor_region)
    - [`OperatorOptions.bl_rna_get_subclass()`](#bpy.types.OperatorOptions.bl_rna_get_subclass)
    - [`OperatorOptions.bl_rna_get_subclass_py()`](#bpy.types.OperatorOptions.bl_rna_get_subclass_py)
