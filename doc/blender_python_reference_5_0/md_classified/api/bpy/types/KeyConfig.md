...
# KeyConfig(bpy\_struct)[¶](#keyconfig-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.KeyConfig(*bpy\_struct*)[¶](#bpy.types.KeyConfig "Link to this definition")
:   Input configuration, including keymaps

    is\_user\_defined[¶](#bpy.types.KeyConfig.is_user_defined "Link to this definition")
    :   Indicates that a keyconfig was defined by the user

        Type:
        :   boolean, default False, (readonly)

    keymaps[¶](#bpy.types.KeyConfig.keymaps "Link to this definition")
    :   Key maps configured as part of this configuration

        Type:
        :   [`KeyMaps`](KeyMaps.md#bpy.types.KeyMaps "bpy.types.KeyMaps") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`KeyMap`](KeyMap.md#bpy.types.KeyMap "bpy.types.KeyMap"), (readonly)

    name[¶](#bpy.types.KeyConfig.name "Link to this definition")
    :   Name of the key configuration

        Type:
        :   string, default “”, (never None)

    preferences[¶](#bpy.types.KeyConfig.preferences "Link to this definition")
    :   Type:
        :   [`KeyConfigPreferences`](KeyConfigPreferences.md#bpy.types.KeyConfigPreferences "bpy.types.KeyConfigPreferences"), (readonly)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.KeyConfig.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.KeyConfig.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`GizmoGroup.setup_keymap`](GizmoGroup.md#bpy.types.GizmoGroup.setup_keymap "bpy.types.GizmoGroup.setup_keymap") * [`KeyConfigurations.active`](KeyConfigurations.md#bpy.types.KeyConfigurations.active "bpy.types.KeyConfigurations.active") * [`KeyConfigurations.addon`](KeyConfigurations.md#bpy.types.KeyConfigurations.addon "bpy.types.KeyConfigurations.addon") * [`KeyConfigurations.default`](KeyConfigurations.md#bpy.types.KeyConfigurations.default "bpy.types.KeyConfigurations.default") | * [`KeyConfigurations.new`](KeyConfigurations.md#bpy.types.KeyConfigurations.new "bpy.types.KeyConfigurations.new") * [`KeyConfigurations.remove`](KeyConfigurations.md#bpy.types.KeyConfigurations.remove "bpy.types.KeyConfigurations.remove") * [`KeyConfigurations.user`](KeyConfigurations.md#bpy.types.KeyConfigurations.user "bpy.types.KeyConfigurations.user") * [`WindowManager.keyconfigs`](WindowManager.md#bpy.types.WindowManager.keyconfigs "bpy.types.WindowManager.keyconfigs") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.KeyConfig.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.KeyConfig.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* KeyConfig(bpy\_struct)
  + [`KeyConfig`](#bpy.types.KeyConfig)
    - [`KeyConfig.is_user_defined`](#bpy.types.KeyConfig.is_user_defined)
    - [`KeyConfig.keymaps`](#bpy.types.KeyConfig.keymaps)
    - [`KeyConfig.name`](#bpy.types.KeyConfig.name)
    - [`KeyConfig.preferences`](#bpy.types.KeyConfig.preferences)
    - [`KeyConfig.bl_rna_get_subclass()`](#bpy.types.KeyConfig.bl_rna_get_subclass)
    - [`KeyConfig.bl_rna_get_subclass_py()`](#bpy.types.KeyConfig.bl_rna_get_subclass_py)
