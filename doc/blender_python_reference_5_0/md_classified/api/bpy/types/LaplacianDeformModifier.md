...
# LaplacianDeformModifier(Modifier)[¶](#laplaciandeformmodifier-modifier "Link to this heading")
...
*class* bpy.types.LaplacianDeformModifier(*Modifier*)[¶](#bpy.types.LaplacianDeformModifier "Link to this definition")
:   Mesh deform modifier

    invert\_vertex\_group[¶](#bpy.types.LaplacianDeformModifier.invert_vertex_group "Link to this definition")
    :   Invert vertex group influence

        Type:
        :   boolean, default False

    is\_bind[¶](#bpy.types.LaplacianDeformModifier.is_bind "Link to this definition")
    :   Whether geometry has been bound to anchors

        Type:
        :   boolean, default False, (readonly)

    iterations[¶](#bpy.types.LaplacianDeformModifier.iterations "Link to this definition")
    :   Type:
        :   int in [0, inf], default 1

    vertex\_group[¶](#bpy.types.LaplacianDeformModifier.vertex_group "Link to this definition")
    :   Name of Vertex Group which determines Anchors

        Type:
        :   string, default “”, (never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.LaplacianDeformModifier.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.LaplacianDeformModifier.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.LaplacianDeformModifier.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.LaplacianDeformModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* LaplacianDeformModifier(Modifier)
  + [`LaplacianDeformModifier`](#bpy.types.LaplacianDeformModifier)
    - [`LaplacianDeformModifier.invert_vertex_group`](#bpy.types.LaplacianDeformModifier.invert_vertex_group)
    - [`LaplacianDeformModifier.is_bind`](#bpy.types.LaplacianDeformModifier.is_bind)
    - [`LaplacianDeformModifier.iterations`](#bpy.types.LaplacianDeformModifier.iterations)
    - [`LaplacianDeformModifier.vertex_group`](#bpy.types.LaplacianDeformModifier.vertex_group)
    - [`LaplacianDeformModifier.bl_rna_get_subclass()`](#bpy.types.LaplacianDeformModifier.bl_rna_get_subclass)
    - [`LaplacianDeformModifier.bl_rna_get_subclass_py()`](#bpy.types.LaplacianDeformModifier.bl_rna_get_subclass_py)
