...
# NodeGeometryCaptureAttributeItems(bpy\_struct)[¶](#nodegeometrycaptureattributeitems-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.NodeGeometryCaptureAttributeItems(*bpy\_struct*)[¶](#bpy.types.NodeGeometryCaptureAttributeItems "Link to this definition")
:   Collection of capture attribute items

    new(*socket\_type*, *name*)[¶](#bpy.types.NodeGeometryCaptureAttributeItems.new "Link to this definition")
    :   Add an item at the end
        ...
        Return type:
        :   [`NodeGeometryCaptureAttributeItem`](NodeGeometryCaptureAttributeItem.md#bpy.types.NodeGeometryCaptureAttributeItem "bpy.types.NodeGeometryCaptureAttributeItem")

    remove(*item*)[¶](#bpy.types.NodeGeometryCaptureAttributeItems.remove "Link to this definition")
    :   Remove an item

        Parameters:
        :   **item** ([`NodeGeometryCaptureAttributeItem`](NodeGeometryCaptureAttributeItem.md#bpy.types.NodeGeometryCaptureAttributeItem "bpy.types.NodeGeometryCaptureAttributeItem"), (never None)) – Item, The item to remove

    clear()[¶](#bpy.types.NodeGeometryCaptureAttributeItems.clear "Link to this definition")
    :   Remove all items

    move(*from\_index*, *to\_index*)[¶](#bpy.types.NodeGeometryCaptureAttributeItems.move "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.NodeGeometryCaptureAttributeItems.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.NodeGeometryCaptureAttributeItems.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`GeometryNodeCaptureAttribute.capture_items`](GeometryNodeCaptureAttribute.md#bpy.types.GeometryNodeCaptureAttribute.capture_items "bpy.types.GeometryNodeCaptureAttribute.capture_items") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.NodeGeometryCaptureAttributeItems.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.NodeGeometryCaptureAttributeItems.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* NodeGeometryCaptureAttributeItems(bpy\_struct)
  + [`NodeGeometryCaptureAttributeItems`](#bpy.types.NodeGeometryCaptureAttributeItems)
    - [`NodeGeometryCaptureAttributeItems.new()`](#bpy.types.NodeGeometryCaptureAttributeItems.new)
    - [`NodeGeometryCaptureAttributeItems.remove()`](#bpy.types.NodeGeometryCaptureAttributeItems.remove)
    - [`NodeGeometryCaptureAttributeItems.clear()`](#bpy.types.NodeGeometryCaptureAttributeItems.clear)
    - [`NodeGeometryCaptureAttributeItems.move()`](#bpy.types.NodeGeometryCaptureAttributeItems.move)
    - [`NodeGeometryCaptureAttributeItems.bl_rna_get_subclass()`](#bpy.types.NodeGeometryCaptureAttributeItems.bl_rna_get_subclass)
    - [`NodeGeometryCaptureAttributeItems.bl_rna_get_subclass_py()`](#bpy.types.NodeGeometryCaptureAttributeItems.bl_rna_get_subclass_py)
