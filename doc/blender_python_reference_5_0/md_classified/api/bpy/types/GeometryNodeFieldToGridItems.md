...
# GeometryNodeFieldToGridItems(bpy\_struct)[¶](#geometrynodefieldtogriditems-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.GeometryNodeFieldToGridItems(*bpy\_struct*)[¶](#bpy.types.GeometryNodeFieldToGridItems "Link to this definition")
:   Collection of field to grid items

    new(*socket\_type*, *name*)[¶](#bpy.types.GeometryNodeFieldToGridItems.new "Link to this definition")
    :   Add an item at the end
        ...
        Return type:
        :   [`GeometryNodeFieldToGridItem`](GeometryNodeFieldToGridItem.md#bpy.types.GeometryNodeFieldToGridItem "bpy.types.GeometryNodeFieldToGridItem")

    remove(*item*)[¶](#bpy.types.GeometryNodeFieldToGridItems.remove "Link to this definition")
    :   Remove an item

        Parameters:
        :   **item** ([`GeometryNodeFieldToGridItem`](GeometryNodeFieldToGridItem.md#bpy.types.GeometryNodeFieldToGridItem "bpy.types.GeometryNodeFieldToGridItem"), (never None)) – Item, The item to remove

    clear()[¶](#bpy.types.GeometryNodeFieldToGridItems.clear "Link to this definition")
    :   Remove all items

    move(*from\_index*, *to\_index*)[¶](#bpy.types.GeometryNodeFieldToGridItems.move "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.GeometryNodeFieldToGridItems.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.GeometryNodeFieldToGridItems.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`GeometryNodeFieldToGrid.grid_items`](GeometryNodeFieldToGrid.md#bpy.types.GeometryNodeFieldToGrid.grid_items "bpy.types.GeometryNodeFieldToGrid.grid_items") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeFieldToGridItems.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.GeometryNodeFieldToGridItems.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeFieldToGridItems(bpy\_struct)
  + [`GeometryNodeFieldToGridItems`](#bpy.types.GeometryNodeFieldToGridItems)
    - [`GeometryNodeFieldToGridItems.new()`](#bpy.types.GeometryNodeFieldToGridItems.new)
    - [`GeometryNodeFieldToGridItems.remove()`](#bpy.types.GeometryNodeFieldToGridItems.remove)
    - [`GeometryNodeFieldToGridItems.clear()`](#bpy.types.GeometryNodeFieldToGridItems.clear)
    - [`GeometryNodeFieldToGridItems.move()`](#bpy.types.GeometryNodeFieldToGridItems.move)
    - [`GeometryNodeFieldToGridItems.bl_rna_get_subclass()`](#bpy.types.GeometryNodeFieldToGridItems.bl_rna_get_subclass)
    - [`GeometryNodeFieldToGridItems.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeFieldToGridItems.bl_rna_get_subclass_py)
