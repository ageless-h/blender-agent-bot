...
# StripModifiers(bpy\_struct)[¶](#stripmodifiers-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.StripModifiers(*bpy\_struct*)[¶](#bpy.types.StripModifiers "Link to this definition")
:   Collection of strip modifiers

    active[¶](#bpy.types.StripModifiers.active "Link to this definition")
    :   The active strip modifier in the list

        Type:
        :   [`StripModifier`](StripModifier.md#bpy.types.StripModifier "bpy.types.StripModifier")

    new(*name*, *type*)[¶](#bpy.types.StripModifiers.new "Link to this definition")
    :   Add a new modifier

        Parameters:
        :   * **name** (*string**,* *(**never None**)*) – New name for the modifier
            * **type** (enum in [Strip Modifier Type Items](../../../appendix/bpy_types_enum_items/strip_modifier_type_items.md#rna-enum-strip-modifier-type-items)) – Modifier type to add
    ...
    remove(*modifier*)[¶](#bpy.types.StripModifiers.remove "Link to this definition")
    :   Remove an existing modifier from the strip

        Parameters:
        :   **modifier** ([`StripModifier`](StripModifier.md#bpy.types.StripModifier "bpy.types.StripModifier"), (never None)) – Modifier to remove

    clear()[¶](#bpy.types.StripModifiers.clear "Link to this definition")
    :   Remove all modifiers from the strip

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.StripModifiers.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.StripModifiers.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Strip.modifiers`](Strip.md#bpy.types.Strip.modifiers "bpy.types.Strip.modifiers") |  |
...
StripModifier(bpy\_struct)](StripModifier.md)
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.StripModifiers.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.StripModifiers.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* StripModifiers(bpy\_struct)
  + [`StripModifiers`](#bpy.types.StripModifiers)
    - [`StripModifiers.active`](#bpy.types.StripModifiers.active)
    - [`StripModifiers.new()`](#bpy.types.StripModifiers.new)
    - [`StripModifiers.remove()`](#bpy.types.StripModifiers.remove)
    - [`StripModifiers.clear()`](#bpy.types.StripModifiers.clear)
    - [`StripModifiers.bl_rna_get_subclass()`](#bpy.types.StripModifiers.bl_rna_get_subclass)
    - [`StripModifiers.bl_rna_get_subclass_py()`](#bpy.types.StripModifiers.bl_rna_get_subclass_py)
