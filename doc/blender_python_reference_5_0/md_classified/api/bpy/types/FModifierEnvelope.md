...
# FModifierEnvelope(FModifier)[¶](#fmodifierenvelope-fmodifier "Link to this heading")
...
*class* bpy.types.FModifierEnvelope(*FModifier*)[¶](#bpy.types.FModifierEnvelope "Link to this definition")
:   Scale the values of the modified F-Curve

    control\_points[¶](#bpy.types.FModifierEnvelope.control_points "Link to this definition")
    :   Control points defining the shape of the envelope

        Type:
        :   [`FModifierEnvelopeControlPoints`](FModifierEnvelopeControlPoints.md#bpy.types.FModifierEnvelopeControlPoints "bpy.types.FModifierEnvelopeControlPoints") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`FModifierEnvelopeControlPoint`](FModifierEnvelopeControlPoint.md#bpy.types.FModifierEnvelopeControlPoint "bpy.types.FModifierEnvelopeControlPoint"), (readonly)

    default\_max[¶](#bpy.types.FModifierEnvelope.default_max "Link to this definition")
    :   Upper distance from Reference Value for 1:1 default influence

        Type:
        :   float in [-inf, inf], default 1.0

    default\_min[¶](#bpy.types.FModifierEnvelope.default_min "Link to this definition")
    :   Lower distance from Reference Value for 1:1 default influence

        Type:
        :   float in [-inf, inf], default -1.0

    reference\_value[¶](#bpy.types.FModifierEnvelope.reference_value "Link to this definition")
    :   Value that envelope’s influence is centered around / based on

        Type:
        :   float in [-inf, inf], default 0.0

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.FModifierEnvelope.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.FModifierEnvelope.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.FModifierEnvelope.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.FModifierEnvelope.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* FModifierEnvelope(FModifier)
  + [`FModifierEnvelope`](#bpy.types.FModifierEnvelope)
    - [`FModifierEnvelope.control_points`](#bpy.types.FModifierEnvelope.control_points)
    - [`FModifierEnvelope.default_max`](#bpy.types.FModifierEnvelope.default_max)
    - [`FModifierEnvelope.default_min`](#bpy.types.FModifierEnvelope.default_min)
    - [`FModifierEnvelope.reference_value`](#bpy.types.FModifierEnvelope.reference_value)
    - [`FModifierEnvelope.bl_rna_get_subclass()`](#bpy.types.FModifierEnvelope.bl_rna_get_subclass)
    - [`FModifierEnvelope.bl_rna_get_subclass_py()`](#bpy.types.FModifierEnvelope.bl_rna_get_subclass_py)
