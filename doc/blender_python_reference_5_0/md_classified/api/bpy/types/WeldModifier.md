...
# WeldModifier(Modifier)[¶](#weldmodifier-modifier "Link to this heading")
...
*class* bpy.types.WeldModifier(*Modifier*)[¶](#bpy.types.WeldModifier "Link to this definition")
:   Weld modifier

    invert\_vertex\_group[¶](#bpy.types.WeldModifier.invert_vertex_group "Link to this definition")
    :   Invert vertex group influence

        Type:
        :   boolean, default False

    loose\_edges[¶](#bpy.types.WeldModifier.loose_edges "Link to this definition")
    :   Collapse edges without faces, cloth sewing edges

        Type:
        :   boolean, default False

    merge\_threshold[¶](#bpy.types.WeldModifier.merge_threshold "Link to this definition")
    :   Limit below which to merge vertices

        Type:
        :   float in [0, inf], default 0.001

    mode[¶](#bpy.types.WeldModifier.mode "Link to this definition")
    ...
    vertex\_group[¶](#bpy.types.WeldModifier.vertex_group "Link to this definition")
    :   Vertex group name for selecting the affected areas

        Type:
        :   string, default “”, (never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.WeldModifier.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.WeldModifier.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.WeldModifier.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.WeldModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* WeldModifier(Modifier)
  + [`WeldModifier`](#bpy.types.WeldModifier)
    - [`WeldModifier.invert_vertex_group`](#bpy.types.WeldModifier.invert_vertex_group)
    - [`WeldModifier.loose_edges`](#bpy.types.WeldModifier.loose_edges)
    - [`WeldModifier.merge_threshold`](#bpy.types.WeldModifier.merge_threshold)
    - [`WeldModifier.mode`](#bpy.types.WeldModifier.mode)
    - [`WeldModifier.vertex_group`](#bpy.types.WeldModifier.vertex_group)
    - [`WeldModifier.bl_rna_get_subclass()`](#bpy.types.WeldModifier.bl_rna_get_subclass)
    - [`WeldModifier.bl_rna_get_subclass_py()`](#bpy.types.WeldModifier.bl_rna_get_subclass_py)
