...
# SkinModifier(Modifier)[¶](#skinmodifier-modifier "Link to this heading")
...
*class* bpy.types.SkinModifier(*Modifier*)[¶](#bpy.types.SkinModifier "Link to this definition")
:   Generate Skin

    branch\_smoothing[¶](#bpy.types.SkinModifier.branch_smoothing "Link to this definition")
    :   Smooth complex geometry around branches

        Type:
        :   float in [0, 1], default 0.0

    use\_smooth\_shade[¶](#bpy.types.SkinModifier.use_smooth_shade "Link to this definition")
    :   Output faces with smooth shading rather than flat shaded

        Type:
        :   boolean, default False

    use\_x\_symmetry[¶](#bpy.types.SkinModifier.use_x_symmetry "Link to this definition")
    :   Avoid making unsymmetrical quads across the X axis

        Type:
        :   boolean, default True

    use\_y\_symmetry[¶](#bpy.types.SkinModifier.use_y_symmetry "Link to this definition")
    :   Avoid making unsymmetrical quads across the Y axis

        Type:
        :   boolean, default False

    use\_z\_symmetry[¶](#bpy.types.SkinModifier.use_z_symmetry "Link to this definition")
    :   Avoid making unsymmetrical quads across the Z axis

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.SkinModifier.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.SkinModifier.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.SkinModifier.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.SkinModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* SkinModifier(Modifier)
  + [`SkinModifier`](#bpy.types.SkinModifier)
    - [`SkinModifier.branch_smoothing`](#bpy.types.SkinModifier.branch_smoothing)
    - [`SkinModifier.use_smooth_shade`](#bpy.types.SkinModifier.use_smooth_shade)
    - [`SkinModifier.use_x_symmetry`](#bpy.types.SkinModifier.use_x_symmetry)
    - [`SkinModifier.use_y_symmetry`](#bpy.types.SkinModifier.use_y_symmetry)
    - [`SkinModifier.use_z_symmetry`](#bpy.types.SkinModifier.use_z_symmetry)
    - [`SkinModifier.bl_rna_get_subclass()`](#bpy.types.SkinModifier.bl_rna_get_subclass)
    - [`SkinModifier.bl_rna_get_subclass_py()`](#bpy.types.SkinModifier.bl_rna_get_subclass_py)
