...
# FILEBROWSER\_UL\_dir(UIList)[¶](#filebrowser-ul-dir-uilist "Link to this heading")
...
*class* bpy.types.FILEBROWSER\_UL\_dir(*UIList*)[¶](#bpy.types.FILEBROWSER_UL_dir "Link to this definition")
:   draw\_item(*\_context*, *layout*, *\_data*, *item*, *icon*, *\_active\_data*, *\_active\_propname*, *\_index*)[¶](#bpy.types.FILEBROWSER_UL_dir.draw_item "Link to this definition")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.FILEBROWSER_UL_dir.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.FILEBROWSER_UL_dir.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.FILEBROWSER_UL_dir.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.FILEBROWSER_UL_dir.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* FILEBROWSER\_UL\_dir(UIList)
  + [`FILEBROWSER_UL_dir`](#bpy.types.FILEBROWSER_UL_dir)
    - [`FILEBROWSER_UL_dir.draw_item()`](#bpy.types.FILEBROWSER_UL_dir.draw_item)
    - [`FILEBROWSER_UL_dir.bl_rna_get_subclass()`](#bpy.types.FILEBROWSER_UL_dir.bl_rna_get_subclass)
    - [`FILEBROWSER_UL_dir.bl_rna_get_subclass_py()`](#bpy.types.FILEBROWSER_UL_dir.bl_rna_get_subclass_py)
