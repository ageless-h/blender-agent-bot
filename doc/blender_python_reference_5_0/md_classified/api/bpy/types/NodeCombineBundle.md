...
# NodeCombineBundle(NodeInternal)[¶](#nodecombinebundle-nodeinternal "Link to this heading")
...
*class* bpy.types.NodeCombineBundle(*NodeInternal*)[¶](#bpy.types.NodeCombineBundle "Link to this definition")
:   Combine multiple socket values into one.

    active\_index[¶](#bpy.types.NodeCombineBundle.active_index "Link to this definition")
    :   Index of the active item

        Type:
        :   int in [0, inf], default 0

    bundle\_items[¶](#bpy.types.NodeCombineBundle.bundle_items "Link to this definition")
    :   Type:
        :   [`NodeCombineBundleItems`](NodeCombineBundleItems.md#bpy.types.NodeCombineBundleItems "bpy.types.NodeCombineBundleItems") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`NodeCombineBundleItem`](NodeCombineBundleItem.md#bpy.types.NodeCombineBundleItem "bpy.types.NodeCombineBundleItem"), (readonly)

    define\_signature[¶](#bpy.types.NodeCombineBundle.define_signature "Link to this definition")
    :   This node defines a bundle signature that should be used by other nodes

        Type:
        :   boolean, default False

    *classmethod* is\_registered\_node\_type()[¶](#bpy.types.NodeCombineBundle.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[¶](#bpy.types.NodeCombineBundle.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[¶](#bpy.types.NodeCombineBundle.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.NodeCombineBundle.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.NodeCombineBundle.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.NodeCombineBundle.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.NodeCombineBundle.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* NodeCombineBundle(NodeInternal)
  + [`NodeCombineBundle`](#bpy.types.NodeCombineBundle)
    - [`NodeCombineBundle.active_index`](#bpy.types.NodeCombineBundle.active_index)
    - [`NodeCombineBundle.bundle_items`](#bpy.types.NodeCombineBundle.bundle_items)
    - [`NodeCombineBundle.define_signature`](#bpy.types.NodeCombineBundle.define_signature)
    - [`NodeCombineBundle.is_registered_node_type()`](#bpy.types.NodeCombineBundle.is_registered_node_type)
    - [`NodeCombineBundle.input_template()`](#bpy.types.NodeCombineBundle.input_template)
    - [`NodeCombineBundle.output_template()`](#bpy.types.NodeCombineBundle.output_template)
    - [`NodeCombineBundle.bl_rna_get_subclass()`](#bpy.types.NodeCombineBundle.bl_rna_get_subclass)
    - [`NodeCombineBundle.bl_rna_get_subclass_py()`](#bpy.types.NodeCombineBundle.bl_rna_get_subclass_py)
