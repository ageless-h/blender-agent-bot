...
# BlendDataMasks(bpy\_struct)[¶](#blenddatamasks-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.BlendDataMasks(*bpy\_struct*)[¶](#bpy.types.BlendDataMasks "Link to this definition")
:   Collection of masks

    tag(*value*)[¶](#bpy.types.BlendDataMasks.tag "Link to this definition")
    :   tag

        Parameters:
        :   **value** (*boolean*) – Value

    new(*name*)[¶](#bpy.types.BlendDataMasks.new "Link to this definition")
    ...
    remove(*mask*, *\**, *do\_unlink=True*, *do\_id\_user=True*, *do\_ui\_user=True*)[¶](#bpy.types.BlendDataMasks.remove "Link to this definition")
    :   Remove a mask from the current blendfile

        Parameters:
        :   * **mask** ([`Mask`](Mask.md#bpy.types.Mask "bpy.types.Mask"), (never None)) – Mask to remove
            * **do\_unlink** (*boolean**,* *(**optional**)*) – Unlink all usages of this mask before deleting it
            * **do\_id\_user** (*boolean**,* *(**optional**)*) – Decrement user counter of all data-blocks used by this mask
            * **do\_ui\_user** (*boolean**,* *(**optional**)*) – Make sure interface does not reference this mask

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.BlendDataMasks.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.BlendDataMasks.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`BlendData.masks`](BlendData.md#bpy.types.BlendData.masks "bpy.types.BlendData.masks") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.BlendDataMasks.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.BlendDataMasks.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* BlendDataMasks(bpy\_struct)
  + [`BlendDataMasks`](#bpy.types.BlendDataMasks)
    - [`BlendDataMasks.tag()`](#bpy.types.BlendDataMasks.tag)
    - [`BlendDataMasks.new()`](#bpy.types.BlendDataMasks.new)
    - [`BlendDataMasks.remove()`](#bpy.types.BlendDataMasks.remove)
    - [`BlendDataMasks.bl_rna_get_subclass()`](#bpy.types.BlendDataMasks.bl_rna_get_subclass)
    - [`BlendDataMasks.bl_rna_get_subclass_py()`](#bpy.types.BlendDataMasks.bl_rna_get_subclass_py)
