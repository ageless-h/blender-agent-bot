...
# GreasePencilLayerMask(bpy\_struct)[¶](#greasepencillayermask-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.GreasePencilLayerMask(*bpy\_struct*)[¶](#bpy.types.GreasePencilLayerMask "Link to this definition")
:   List of Mask Layers

    hide[¶](#bpy.types.GreasePencilLayerMask.hide "Link to this definition")
    :   Set mask Visibility

        Type:
        :   boolean, default False

    invert[¶](#bpy.types.GreasePencilLayerMask.invert "Link to this definition")
    :   Invert mask

        Type:
        :   boolean, default False

    name[¶](#bpy.types.GreasePencilLayerMask.name "Link to this definition")
    :   Mask layer name

        Type:
        :   string, default “”, (never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.GreasePencilLayerMask.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.GreasePencilLayerMask.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`GreasePencilLayer.mask_layers`](GreasePencilLayer.md#bpy.types.GreasePencilLayer.mask_layers "bpy.types.GreasePencilLayer.mask_layers") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GreasePencilLayerMask.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.GreasePencilLayerMask.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GreasePencilLayerMask(bpy\_struct)
  + [`GreasePencilLayerMask`](#bpy.types.GreasePencilLayerMask)
    - [`GreasePencilLayerMask.hide`](#bpy.types.GreasePencilLayerMask.hide)
    - [`GreasePencilLayerMask.invert`](#bpy.types.GreasePencilLayerMask.invert)
    - [`GreasePencilLayerMask.name`](#bpy.types.GreasePencilLayerMask.name)
    - [`GreasePencilLayerMask.bl_rna_get_subclass()`](#bpy.types.GreasePencilLayerMask.bl_rna_get_subclass)
    - [`GreasePencilLayerMask.bl_rna_get_subclass_py()`](#bpy.types.GreasePencilLayerMask.bl_rna_get_subclass_py)
