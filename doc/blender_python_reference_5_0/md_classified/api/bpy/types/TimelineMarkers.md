...
# TimelineMarkers(bpy\_struct)[¶](#timelinemarkers-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.TimelineMarkers(*bpy\_struct*)[¶](#bpy.types.TimelineMarkers "Link to this definition")
:   Collection of timeline markers

    new(*name*, *\**, *frame=1*)[¶](#bpy.types.TimelineMarkers.new "Link to this definition")
    ...
    remove(*marker*)[¶](#bpy.types.TimelineMarkers.remove "Link to this definition")
    ...
    clear()[¶](#bpy.types.TimelineMarkers.clear "Link to this definition")
    :   Remove all timeline markers

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.TimelineMarkers.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.TimelineMarkers.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Scene.timeline_markers`](Scene.md#bpy.types.Scene.timeline_markers "bpy.types.Scene.timeline_markers") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.TimelineMarkers.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.TimelineMarkers.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* TimelineMarkers(bpy\_struct)
  + [`TimelineMarkers`](#bpy.types.TimelineMarkers)
    - [`TimelineMarkers.new()`](#bpy.types.TimelineMarkers.new)
    - [`TimelineMarkers.remove()`](#bpy.types.TimelineMarkers.remove)
    - [`TimelineMarkers.clear()`](#bpy.types.TimelineMarkers.clear)
    - [`TimelineMarkers.bl_rna_get_subclass()`](#bpy.types.TimelineMarkers.bl_rna_get_subclass)
    - [`TimelineMarkers.bl_rna_get_subclass_py()`](#bpy.types.TimelineMarkers.bl_rna_get_subclass_py)
