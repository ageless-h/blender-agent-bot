...
# LineStyleGeometryModifier\_PerlinNoise2D(LineStyleGeometryModifier)[¶](#linestylegeometrymodifier-perlinnoise2d-linestylegeometrymodifier "Link to this heading")
...
*class* bpy.types.LineStyleGeometryModifier\_PerlinNoise2D(*LineStyleGeometryModifier*)[¶](#bpy.types.LineStyleGeometryModifier_PerlinNoise2D "Link to this definition")
:   Add two-dimensional Perlin noise to stroke backbone geometry

    amplitude[¶](#bpy.types.LineStyleGeometryModifier_PerlinNoise2D.amplitude "Link to this definition")
    :   Amplitude of the Perlin noise

        Type:
        :   float in [-inf, inf], default 0.0

    angle[¶](#bpy.types.LineStyleGeometryModifier_PerlinNoise2D.angle "Link to this definition")
    :   Displacement direction

        Type:
        :   float in [-inf, inf], default 0.0

    expanded[¶](#bpy.types.LineStyleGeometryModifier_PerlinNoise2D.expanded "Link to this definition")
    :   True if the modifier tab is expanded

        Type:
        :   boolean, default False

    frequency[¶](#bpy.types.LineStyleGeometryModifier_PerlinNoise2D.frequency "Link to this definition")
    :   Frequency of the Perlin noise

        Type:
        :   float in [-inf, inf], default 0.0

    octaves[¶](#bpy.types.LineStyleGeometryModifier_PerlinNoise2D.octaves "Link to this definition")
    :   Number of octaves (i.e., the amount of detail of the Perlin noise)

        Type:
        :   int in [0, inf], default 0

    seed[¶](#bpy.types.LineStyleGeometryModifier_PerlinNoise2D.seed "Link to this definition")
    :   Seed for random number generation (if negative, time is used as a seed instead)

        Type:
        :   int in [-inf, inf], default 0

    type[¶](#bpy.types.LineStyleGeometryModifier_PerlinNoise2D.type "Link to this definition")
    ...
    use[¶](#bpy.types.LineStyleGeometryModifier_PerlinNoise2D.use "Link to this definition")
    :   Enable or disable this modifier during stroke rendering

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.LineStyleGeometryModifier_PerlinNoise2D.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.LineStyleGeometryModifier_PerlinNoise2D.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
        ...
        Return type:
        :   [type](#bpy.types.LineStyleGeometryModifier_PerlinNoise2D.type "bpy.types.LineStyleGeometryModifier_PerlinNoise2D.type")
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.LineStyleGeometryModifier_PerlinNoise2D.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.LineStyleGeometryModifier_PerlinNoise2D.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* LineStyleGeometryModifier\_PerlinNoise2D(LineStyleGeometryModifier)
  + [`LineStyleGeometryModifier_PerlinNoise2D`](#bpy.types.LineStyleGeometryModifier_PerlinNoise2D)
    - [`LineStyleGeometryModifier_PerlinNoise2D.amplitude`](#bpy.types.LineStyleGeometryModifier_PerlinNoise2D.amplitude)
    - [`LineStyleGeometryModifier_PerlinNoise2D.angle`](#bpy.types.LineStyleGeometryModifier_PerlinNoise2D.angle)
    - [`LineStyleGeometryModifier_PerlinNoise2D.expanded`](#bpy.types.LineStyleGeometryModifier_PerlinNoise2D.expanded)
    - [`LineStyleGeometryModifier_PerlinNoise2D.frequency`](#bpy.types.LineStyleGeometryModifier_PerlinNoise2D.frequency)
    - [`LineStyleGeometryModifier_PerlinNoise2D.octaves`](#bpy.types.LineStyleGeometryModifier_PerlinNoise2D.octaves)
    - [`LineStyleGeometryModifier_PerlinNoise2D.seed`](#bpy.types.LineStyleGeometryModifier_PerlinNoise2D.seed)
    - [`LineStyleGeometryModifier_PerlinNoise2D.type`](#bpy.types.LineStyleGeometryModifier_PerlinNoise2D.type)
    - [`LineStyleGeometryModifier_PerlinNoise2D.use`](#bpy.types.LineStyleGeometryModifier_PerlinNoise2D.use)
    - [`LineStyleGeometryModifier_PerlinNoise2D.bl_rna_get_subclass()`](#bpy.types.LineStyleGeometryModifier_PerlinNoise2D.bl_rna_get_subclass)
    - [`LineStyleGeometryModifier_PerlinNoise2D.bl_rna_get_subclass_py()`](#bpy.types.LineStyleGeometryModifier_PerlinNoise2D.bl_rna_get_subclass_py)
