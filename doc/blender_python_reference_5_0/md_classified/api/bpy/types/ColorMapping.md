...
# ColorMapping(bpy\_struct)[¶](#colormapping-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.ColorMapping(*bpy\_struct*)[¶](#bpy.types.ColorMapping "Link to this definition")
:   Color mapping settings

    blend\_color[¶](#bpy.types.ColorMapping.blend_color "Link to this definition")
    ...
    blend\_factor[¶](#bpy.types.ColorMapping.blend_factor "Link to this definition")
    :   Type:
        :   float in [-inf, inf], default 0.0

    blend\_type[¶](#bpy.types.ColorMapping.blend_type "Link to this definition")
    ...
    brightness[¶](#bpy.types.ColorMapping.brightness "Link to this definition")
    :   Adjust the brightness of the texture

        Type:
        :   float in [0, 2], default 0.0

    color\_ramp[¶](#bpy.types.ColorMapping.color_ramp "Link to this definition")
    :   Type:
        :   [`ColorRamp`](ColorRamp.md#bpy.types.ColorRamp "bpy.types.ColorRamp"), (readonly)

    contrast[¶](#bpy.types.ColorMapping.contrast "Link to this definition")
    :   Adjust the contrast of the texture

        Type:
        :   float in [0, 5], default 0.0

    saturation[¶](#bpy.types.ColorMapping.saturation "Link to this definition")
    :   Adjust the saturation of colors in the texture

        Type:
        :   float in [0, 2], default 0.0

    use\_color\_ramp[¶](#bpy.types.ColorMapping.use_color_ramp "Link to this definition")
    :   Toggle color ramp operations

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ColorMapping.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ColorMapping.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`ShaderNodeTexBrick.color_mapping`](ShaderNodeTexBrick.md#bpy.types.ShaderNodeTexBrick.color_mapping "bpy.types.ShaderNodeTexBrick.color_mapping") * [`ShaderNodeTexChecker.color_mapping`](ShaderNodeTexChecker.md#bpy.types.ShaderNodeTexChecker.color_mapping "bpy.types.ShaderNodeTexChecker.color_mapping") * [`ShaderNodeTexEnvironment.color_mapping`](ShaderNodeTexEnvironment.md#bpy.types.ShaderNodeTexEnvironment.color_mapping "bpy.types.ShaderNodeTexEnvironment.color_mapping") * [`ShaderNodeTexGabor.color_mapping`](ShaderNodeTexGabor.md#bpy.types.ShaderNodeTexGabor.color_mapping "bpy.types.ShaderNodeTexGabor.color_mapping") * [`ShaderNodeTexGradient.color_mapping`](ShaderNodeTexGradient.md#bpy.types.ShaderNodeTexGradient.color_mapping "bpy.types.ShaderNodeTexGradient.color_mapping") * [`ShaderNodeTexImage.color_mapping`](ShaderNodeTexImage.md#bpy.types.ShaderNodeTexImage.color_mapping "bpy.types.ShaderNodeTexImage.color_mapping") | * [`ShaderNodeTexMagic.color_mapping`](ShaderNodeTexMagic.md#bpy.types.ShaderNodeTexMagic.color_mapping "bpy.types.ShaderNodeTexMagic.color_mapping") * [`ShaderNodeTexNoise.color_mapping`](ShaderNodeTexNoise.md#bpy.types.ShaderNodeTexNoise.color_mapping "bpy.types.ShaderNodeTexNoise.color_mapping") * [`ShaderNodeTexSky.color_mapping`](ShaderNodeTexSky.md#bpy.types.ShaderNodeTexSky.color_mapping "bpy.types.ShaderNodeTexSky.color_mapping") * [`ShaderNodeTexVoronoi.color_mapping`](ShaderNodeTexVoronoi.md#bpy.types.ShaderNodeTexVoronoi.color_mapping "bpy.types.ShaderNodeTexVoronoi.color_mapping") * [`ShaderNodeTexWave.color_mapping`](ShaderNodeTexWave.md#bpy.types.ShaderNodeTexWave.color_mapping "bpy.types.ShaderNodeTexWave.color_mapping") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ColorMapping.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ColorMapping.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ColorMapping(bpy\_struct)
  + [`ColorMapping`](#bpy.types.ColorMapping)
    - [`ColorMapping.blend_color`](#bpy.types.ColorMapping.blend_color)
    - [`ColorMapping.blend_factor`](#bpy.types.ColorMapping.blend_factor)
    - [`ColorMapping.blend_type`](#bpy.types.ColorMapping.blend_type)
    - [`ColorMapping.brightness`](#bpy.types.ColorMapping.brightness)
    - [`ColorMapping.color_ramp`](#bpy.types.ColorMapping.color_ramp)
    - [`ColorMapping.contrast`](#bpy.types.ColorMapping.contrast)
    - [`ColorMapping.saturation`](#bpy.types.ColorMapping.saturation)
    - [`ColorMapping.use_color_ramp`](#bpy.types.ColorMapping.use_color_ramp)
    - [`ColorMapping.bl_rna_get_subclass()`](#bpy.types.ColorMapping.bl_rna_get_subclass)
    - [`ColorMapping.bl_rna_get_subclass_py()`](#bpy.types.ColorMapping.bl_rna_get_subclass_py)
