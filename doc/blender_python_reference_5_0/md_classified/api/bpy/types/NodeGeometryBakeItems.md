...
# NodeGeometryBakeItems(bpy\_struct)[¶](#nodegeometrybakeitems-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.NodeGeometryBakeItems(*bpy\_struct*)[¶](#bpy.types.NodeGeometryBakeItems "Link to this definition")
:   Collection of bake items

    new(*socket\_type*, *name*)[¶](#bpy.types.NodeGeometryBakeItems.new "Link to this definition")
    :   Add an item at the end
        ...
        Return type:
        :   [`NodeGeometryBakeItem`](NodeGeometryBakeItem.md#bpy.types.NodeGeometryBakeItem "bpy.types.NodeGeometryBakeItem")

    remove(*item*)[¶](#bpy.types.NodeGeometryBakeItems.remove "Link to this definition")
    :   Remove an item

        Parameters:
        :   **item** ([`NodeGeometryBakeItem`](NodeGeometryBakeItem.md#bpy.types.NodeGeometryBakeItem "bpy.types.NodeGeometryBakeItem"), (never None)) – Item, The item to remove

    clear()[¶](#bpy.types.NodeGeometryBakeItems.clear "Link to this definition")
    :   Remove all items

    move(*from\_index*, *to\_index*)[¶](#bpy.types.NodeGeometryBakeItems.move "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.NodeGeometryBakeItems.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.NodeGeometryBakeItems.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`GeometryNodeBake.bake_items`](GeometryNodeBake.md#bpy.types.GeometryNodeBake.bake_items "bpy.types.GeometryNodeBake.bake_items") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.NodeGeometryBakeItems.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.NodeGeometryBakeItems.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* NodeGeometryBakeItems(bpy\_struct)
  + [`NodeGeometryBakeItems`](#bpy.types.NodeGeometryBakeItems)
    - [`NodeGeometryBakeItems.new()`](#bpy.types.NodeGeometryBakeItems.new)
    - [`NodeGeometryBakeItems.remove()`](#bpy.types.NodeGeometryBakeItems.remove)
    - [`NodeGeometryBakeItems.clear()`](#bpy.types.NodeGeometryBakeItems.clear)
    - [`NodeGeometryBakeItems.move()`](#bpy.types.NodeGeometryBakeItems.move)
    - [`NodeGeometryBakeItems.bl_rna_get_subclass()`](#bpy.types.NodeGeometryBakeItems.bl_rna_get_subclass)
    - [`NodeGeometryBakeItems.bl_rna_get_subclass_py()`](#bpy.types.NodeGeometryBakeItems.bl_rna_get_subclass_py)
