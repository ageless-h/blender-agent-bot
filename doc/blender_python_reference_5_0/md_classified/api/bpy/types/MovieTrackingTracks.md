...
# MovieTrackingTracks(bpy\_struct)[¶](#movietrackingtracks-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.MovieTrackingTracks(*bpy\_struct*)[¶](#bpy.types.MovieTrackingTracks "Link to this definition")
:   Collection of movie tracking tracks

    active[¶](#bpy.types.MovieTrackingTracks.active "Link to this definition")
    ...
    new(*\**, *name=''*, *frame=1*)[¶](#bpy.types.MovieTrackingTracks.new "Link to this definition")
    :   Create new motion track in this movie clip

        Parameters:
        :   * **name** (*string**,* *(**optional**,* *never None**)*) – Name of new track
            * **frame** (*int in* *[**0**,* *1048574**]**,* *(**optional**)*) – Frame, Frame number to add track on
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.MovieTrackingTracks.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.MovieTrackingTracks.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`MovieTracking.tracks`](MovieTracking.md#bpy.types.MovieTracking.tracks "bpy.types.MovieTracking.tracks") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.MovieTrackingTracks.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.MovieTrackingTracks.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* MovieTrackingTracks(bpy\_struct)
  + [`MovieTrackingTracks`](#bpy.types.MovieTrackingTracks)
    - [`MovieTrackingTracks.active`](#bpy.types.MovieTrackingTracks.active)
    - [`MovieTrackingTracks.new()`](#bpy.types.MovieTrackingTracks.new)
    - [`MovieTrackingTracks.bl_rna_get_subclass()`](#bpy.types.MovieTrackingTracks.bl_rna_get_subclass)
    - [`MovieTrackingTracks.bl_rna_get_subclass_py()`](#bpy.types.MovieTrackingTracks.bl_rna_get_subclass_py)
