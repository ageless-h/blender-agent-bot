...
# SpaceGraphEditor(Space)[¶](#spacegrapheditor-space "Link to this heading")
...
*class* bpy.types.SpaceGraphEditor(*Space*)[¶](#bpy.types.SpaceGraphEditor "Link to this definition")
:   Graph Editor space data

    cursor\_position\_x[¶](#bpy.types.SpaceGraphEditor.cursor_position_x "Link to this definition")
    :   Graph Editor 2D-Value cursor - X-Value component

        Type:
        :   float in [-inf, inf], default 0.0

    cursor\_position\_y[¶](#bpy.types.SpaceGraphEditor.cursor_position_y "Link to this definition")
    :   Graph Editor 2D-Value cursor - Y-Value component

        Type:
        :   float in [-inf, inf], default 0.0

    dopesheet[¶](#bpy.types.SpaceGraphEditor.dopesheet "Link to this definition")
    :   Settings for filtering animation data

        Type:
        :   [`DopeSheet`](DopeSheet.md#bpy.types.DopeSheet "bpy.types.DopeSheet"), (readonly)

    has\_ghost\_curves[¶](#bpy.types.SpaceGraphEditor.has_ghost_curves "Link to this definition")
    :   Graph Editor instance has some ghost curves stored

        Type:
        :   boolean, default False, (readonly)

    mode[¶](#bpy.types.SpaceGraphEditor.mode "Link to this definition")
    :   Editing context being displayed

        Type:
        :   enum in [Space Graph Mode Items](../../../appendix/bpy_types_enum_items/space_graph_mode_items.md#rna-enum-space-graph-mode-items), default `'FCURVES'`

    pivot\_point[¶](#bpy.types.SpaceGraphEditor.pivot_point "Link to this definition")
    :   Pivot center for rotation/scaling

        Type:
        :   enum in [`'BOUNDING_BOX_CENTER'`, `'CURSOR'`, `'INDIVIDUAL_ORIGINS'`], default `'BOUNDING_BOX_CENTER'`

    show\_cursor[¶](#bpy.types.SpaceGraphEditor.show_cursor "Link to this definition")
    :   Show 2D cursor

        Type:
        :   boolean, default False

    show\_extrapolation[¶](#bpy.types.SpaceGraphEditor.show_extrapolation "Link to this definition")
    :   Type:
        :   boolean, default False

    show\_handles[¶](#bpy.types.SpaceGraphEditor.show_handles "Link to this definition")
    :   Show handles of Bézier control points

        Type:
        :   boolean, default False

    show\_markers[¶](#bpy.types.SpaceGraphEditor.show_markers "Link to this definition")
    :   If any exists, show markers in a separate row at the bottom of the editor

        Type:
        :   boolean, default False

    show\_region\_channels[¶](#bpy.types.SpaceGraphEditor.show_region_channels "Link to this definition")
    :   Type:
        :   boolean, default False

    show\_region\_footer[¶](#bpy.types.SpaceGraphEditor.show_region_footer "Link to this definition")
    :   Type:
        :   boolean, default False

    show\_region\_hud[¶](#bpy.types.SpaceGraphEditor.show_region_hud "Link to this definition")
    :   Type:
        :   boolean, default False

    show\_region\_ui[¶](#bpy.types.SpaceGraphEditor.show_region_ui "Link to this definition")
    :   Type:
        :   boolean, default False

    show\_seconds[¶](#bpy.types.SpaceGraphEditor.show_seconds "Link to this definition")
    :   Show timing as a timecode instead of frames

        Type:
        :   boolean, default False

    show\_sliders[¶](#bpy.types.SpaceGraphEditor.show_sliders "Link to this definition")
    :   Show sliders beside F-Curve channels

        Type:
        :   boolean, default False

    use\_auto\_lock\_translation\_axis[¶](#bpy.types.SpaceGraphEditor.use_auto_lock_translation_axis "Link to this definition")
    :   Automatically locks the movement of keyframes to the dominant axis

        Type:
        :   boolean, default False

    use\_auto\_merge\_keyframes[¶](#bpy.types.SpaceGraphEditor.use_auto_merge_keyframes "Link to this definition")
    :   Automatically merge nearby keyframes

        Type:
        :   boolean, default False

    use\_auto\_normalization[¶](#bpy.types.SpaceGraphEditor.use_auto_normalization "Link to this definition")
    :   Automatically recalculate curve normalization on every curve edit

        Type:
        :   boolean, default False

    use\_normalization[¶](#bpy.types.SpaceGraphEditor.use_normalization "Link to this definition")
    :   Display curves in normalized range from -1 to 1, for easier editing of multiple curves with different ranges

        Type:
        :   boolean, default False

    use\_only\_selected\_keyframe\_handles[¶](#bpy.types.SpaceGraphEditor.use_only_selected_keyframe_handles "Link to this definition")
    :   Only show and edit handles of selected keyframes

        Type:
        :   boolean, default False

    use\_realtime\_update[¶](#bpy.types.SpaceGraphEditor.use_realtime_update "Link to this definition")
    :   When transforming keyframes, changes to the animation data are flushed to other views

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.SpaceGraphEditor.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.SpaceGraphEditor.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
    ...
    *classmethod* draw\_handler\_add(*callback*, *args*, *region\_type*, *draw\_type*)[¶](#bpy.types.SpaceGraphEditor.draw_handler_add "Link to this definition")
    ...
    *classmethod* draw\_handler\_remove(*handler*, *region\_type*)[¶](#bpy.types.SpaceGraphEditor.draw_handler_remove "Link to this definition")
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.SpaceGraphEditor.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.SpaceGraphEditor.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* SpaceGraphEditor(Space)
  + [`SpaceGraphEditor`](#bpy.types.SpaceGraphEditor)
    - [`SpaceGraphEditor.cursor_position_x`](#bpy.types.SpaceGraphEditor.cursor_position_x)
    - [`SpaceGraphEditor.cursor_position_y`](#bpy.types.SpaceGraphEditor.cursor_position_y)
    - [`SpaceGraphEditor.dopesheet`](#bpy.types.SpaceGraphEditor.dopesheet)
    - [`SpaceGraphEditor.has_ghost_curves`](#bpy.types.SpaceGraphEditor.has_ghost_curves)
    - [`SpaceGraphEditor.mode`](#bpy.types.SpaceGraphEditor.mode)
    - [`SpaceGraphEditor.pivot_point`](#bpy.types.SpaceGraphEditor.pivot_point)
    - [`SpaceGraphEditor.show_cursor`](#bpy.types.SpaceGraphEditor.show_cursor)
    - [`SpaceGraphEditor.show_extrapolation`](#bpy.types.SpaceGraphEditor.show_extrapolation)
    - [`SpaceGraphEditor.show_handles`](#bpy.types.SpaceGraphEditor.show_handles)
    - [`SpaceGraphEditor.show_markers`](#bpy.types.SpaceGraphEditor.show_markers)
    - [`SpaceGraphEditor.show_region_channels`](#bpy.types.SpaceGraphEditor.show_region_channels)
    - [`SpaceGraphEditor.show_region_footer`](#bpy.types.SpaceGraphEditor.show_region_footer)
    - [`SpaceGraphEditor.show_region_hud`](#bpy.types.SpaceGraphEditor.show_region_hud)
    - [`SpaceGraphEditor.show_region_ui`](#bpy.types.SpaceGraphEditor.show_region_ui)
    - [`SpaceGraphEditor.show_seconds`](#bpy.types.SpaceGraphEditor.show_seconds)
    - [`SpaceGraphEditor.show_sliders`](#bpy.types.SpaceGraphEditor.show_sliders)
    - [`SpaceGraphEditor.use_auto_lock_translation_axis`](#bpy.types.SpaceGraphEditor.use_auto_lock_translation_axis)
    - [`SpaceGraphEditor.use_auto_merge_keyframes`](#bpy.types.SpaceGraphEditor.use_auto_merge_keyframes)
    - [`SpaceGraphEditor.use_auto_normalization`](#bpy.types.SpaceGraphEditor.use_auto_normalization)
    - [`SpaceGraphEditor.use_normalization`](#bpy.types.SpaceGraphEditor.use_normalization)
    - [`SpaceGraphEditor.use_only_selected_keyframe_handles`](#bpy.types.SpaceGraphEditor.use_only_selected_keyframe_handles)
    - [`SpaceGraphEditor.use_realtime_update`](#bpy.types.SpaceGraphEditor.use_realtime_update)
    - [`SpaceGraphEditor.bl_rna_get_subclass()`](#bpy.types.SpaceGraphEditor.bl_rna_get_subclass)
    - [`SpaceGraphEditor.bl_rna_get_subclass_py()`](#bpy.types.SpaceGraphEditor.bl_rna_get_subclass_py)
    - [`SpaceGraphEditor.draw_handler_add()`](#bpy.types.SpaceGraphEditor.draw_handler_add)
    - [`SpaceGraphEditor.draw_handler_remove()`](#bpy.types.SpaceGraphEditor.draw_handler_remove)
