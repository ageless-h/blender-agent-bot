...
# MeshLoopColorLayer(bpy\_struct)[¶](#meshloopcolorlayer-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.MeshLoopColorLayer(*bpy\_struct*)[¶](#bpy.types.MeshLoopColorLayer "Link to this definition")
:   Layer of vertex colors in a Mesh data-block

    active[¶](#bpy.types.MeshLoopColorLayer.active "Link to this definition")
    :   Sets the layer as active for display and editing

        Type:
        :   boolean, default False

    active\_render[¶](#bpy.types.MeshLoopColorLayer.active_render "Link to this definition")
    :   Sets the layer as active for rendering

        Type:
        :   boolean, default False

    data[¶](#bpy.types.MeshLoopColorLayer.data "Link to this definition")
    :   Type:
        :   [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`MeshLoopColor`](MeshLoopColor.md#bpy.types.MeshLoopColor "bpy.types.MeshLoopColor"), (readonly)

    name[¶](#bpy.types.MeshLoopColorLayer.name "Link to this definition")
    :   Name of Vertex color layer

        Type:
        :   string, default “”, (never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.MeshLoopColorLayer.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.MeshLoopColorLayer.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`LoopColors.active`](LoopColors.md#bpy.types.LoopColors.active "bpy.types.LoopColors.active") * [`LoopColors.new`](LoopColors.md#bpy.types.LoopColors.new "bpy.types.LoopColors.new") | * [`LoopColors.remove`](LoopColors.md#bpy.types.LoopColors.remove "bpy.types.LoopColors.remove") * [`Mesh.vertex_colors`](Mesh.md#bpy.types.Mesh.vertex_colors "bpy.types.Mesh.vertex_colors") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.MeshLoopColorLayer.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.MeshLoopColorLayer.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* MeshLoopColorLayer(bpy\_struct)
  + [`MeshLoopColorLayer`](#bpy.types.MeshLoopColorLayer)
    - [`MeshLoopColorLayer.active`](#bpy.types.MeshLoopColorLayer.active)
    - [`MeshLoopColorLayer.active_render`](#bpy.types.MeshLoopColorLayer.active_render)
    - [`MeshLoopColorLayer.data`](#bpy.types.MeshLoopColorLayer.data)
    - [`MeshLoopColorLayer.name`](#bpy.types.MeshLoopColorLayer.name)
    - [`MeshLoopColorLayer.bl_rna_get_subclass()`](#bpy.types.MeshLoopColorLayer.bl_rna_get_subclass)
    - [`MeshLoopColorLayer.bl_rna_get_subclass_py()`](#bpy.types.MeshLoopColorLayer.bl_rna_get_subclass_py)
