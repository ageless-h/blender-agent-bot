...
# SpreadsheetRowFilter(bpy\_struct)[¶](#spreadsheetrowfilter-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.SpreadsheetRowFilter(*bpy\_struct*)[¶](#bpy.types.SpreadsheetRowFilter "Link to this definition")
:   column\_name[¶](#bpy.types.SpreadsheetRowFilter.column_name "Link to this definition")
    :   Type:
        :   string, default “”, (never None)

    enabled[¶](#bpy.types.SpreadsheetRowFilter.enabled "Link to this definition")
    :   Type:
        :   boolean, default False

    operation[¶](#bpy.types.SpreadsheetRowFilter.operation "Link to this definition")
    :   Type:
        :   enum in [`'EQUAL'`, `'GREATER'`, `'LESS'`], default `'EQUAL'`

    show\_expanded[¶](#bpy.types.SpreadsheetRowFilter.show_expanded "Link to this definition")
    :   Type:
        :   boolean, default False

    threshold[¶](#bpy.types.SpreadsheetRowFilter.threshold "Link to this definition")
    :   How close float values need to be to be equal

        Type:
        :   float in [0, inf], default 0.0

    value\_boolean[¶](#bpy.types.SpreadsheetRowFilter.value_boolean "Link to this definition")
    :   Type:
        :   boolean, default False

    value\_color[¶](#bpy.types.SpreadsheetRowFilter.value_color "Link to this definition")
    :   Type:
        :   float array of 4 items in [-inf, inf], default (0.0, 0.0, 0.0, 0.0)

    value\_float[¶](#bpy.types.SpreadsheetRowFilter.value_float "Link to this definition")
    :   Type:
        :   float in [-inf, inf], default 0.0

    value\_float2[¶](#bpy.types.SpreadsheetRowFilter.value_float2 "Link to this definition")
    :   Type:
        :   float array of 2 items in [-inf, inf], default (0.0, 0.0)

    value\_float3[¶](#bpy.types.SpreadsheetRowFilter.value_float3 "Link to this definition")
    :   Type:
        :   float array of 3 items in [-inf, inf], default (0.0, 0.0, 0.0)

    value\_int[¶](#bpy.types.SpreadsheetRowFilter.value_int "Link to this definition")
    :   Type:
        :   int in [-inf, inf], default 0

    value\_int2[¶](#bpy.types.SpreadsheetRowFilter.value_int2 "Link to this definition")
    :   Type:
        :   int array of 2 items in [-inf, inf], default (0, 0)

    value\_int3[¶](#bpy.types.SpreadsheetRowFilter.value_int3 "Link to this definition")
    :   Type:
        :   int array of 3 items in [-inf, inf], default (0, 0, 0)

    value\_int8[¶](#bpy.types.SpreadsheetRowFilter.value_int8 "Link to this definition")
    :   Type:
        :   int in [-128, 127], default 0

    value\_string[¶](#bpy.types.SpreadsheetRowFilter.value_string "Link to this definition")
    :   Type:
        :   string, default “”, (never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.SpreadsheetRowFilter.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.SpreadsheetRowFilter.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`SpaceSpreadsheet.row_filters`](SpaceSpreadsheet.md#bpy.types.SpaceSpreadsheet.row_filters "bpy.types.SpaceSpreadsheet.row_filters") |  |

[Next

SpreadsheetTable(bpy\_struct)](SpreadsheetTable.md)
[Previous
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.SpreadsheetRowFilter.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.SpreadsheetRowFilter.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* SpreadsheetRowFilter(bpy\_struct)
  + [`SpreadsheetRowFilter`](#bpy.types.SpreadsheetRowFilter)
    - [`SpreadsheetRowFilter.column_name`](#bpy.types.SpreadsheetRowFilter.column_name)
    - [`SpreadsheetRowFilter.enabled`](#bpy.types.SpreadsheetRowFilter.enabled)
    - [`SpreadsheetRowFilter.operation`](#bpy.types.SpreadsheetRowFilter.operation)
    - [`SpreadsheetRowFilter.show_expanded`](#bpy.types.SpreadsheetRowFilter.show_expanded)
    - [`SpreadsheetRowFilter.threshold`](#bpy.types.SpreadsheetRowFilter.threshold)
    - [`SpreadsheetRowFilter.value_boolean`](#bpy.types.SpreadsheetRowFilter.value_boolean)
    - [`SpreadsheetRowFilter.value_color`](#bpy.types.SpreadsheetRowFilter.value_color)
    - [`SpreadsheetRowFilter.value_float`](#bpy.types.SpreadsheetRowFilter.value_float)
    - [`SpreadsheetRowFilter.value_float2`](#bpy.types.SpreadsheetRowFilter.value_float2)
    - [`SpreadsheetRowFilter.value_float3`](#bpy.types.SpreadsheetRowFilter.value_float3)
    - [`SpreadsheetRowFilter.value_int`](#bpy.types.SpreadsheetRowFilter.value_int)
    - [`SpreadsheetRowFilter.value_int2`](#bpy.types.SpreadsheetRowFilter.value_int2)
    - [`SpreadsheetRowFilter.value_int3`](#bpy.types.SpreadsheetRowFilter.value_int3)
    - [`SpreadsheetRowFilter.value_int8`](#bpy.types.SpreadsheetRowFilter.value_int8)
    - [`SpreadsheetRowFilter.value_string`](#bpy.types.SpreadsheetRowFilter.value_string)
    - [`SpreadsheetRowFilter.bl_rna_get_subclass()`](#bpy.types.SpreadsheetRowFilter.bl_rna_get_subclass)
    - [`SpreadsheetRowFilter.bl_rna_get_subclass_py()`](#bpy.types.SpreadsheetRowFilter.bl_rna_get_subclass_py)
