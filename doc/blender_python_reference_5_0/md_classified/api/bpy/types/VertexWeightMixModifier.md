...
# VertexWeightMixModifier(Modifier)[¶](#vertexweightmixmodifier-modifier "Link to this heading")
...
*class* bpy.types.VertexWeightMixModifier(*Modifier*)[¶](#bpy.types.VertexWeightMixModifier "Link to this definition")
:   Mix the weights of two vertex groups

    default\_weight\_a[¶](#bpy.types.VertexWeightMixModifier.default_weight_a "Link to this definition")
    :   Default weight a vertex will have if it is not in the first A vgroup

        Type:
        :   float in [0, 1], default 0.0

    default\_weight\_b[¶](#bpy.types.VertexWeightMixModifier.default_weight_b "Link to this definition")
    :   Default weight a vertex will have if it is not in the second B vgroup

        Type:
        :   float in [0, 1], default 0.0

    invert\_mask\_vertex\_group[¶](#bpy.types.VertexWeightMixModifier.invert_mask_vertex_group "Link to this definition")
    :   Invert vertex group mask influence

        Type:
        :   boolean, default False

    invert\_vertex\_group\_a[¶](#bpy.types.VertexWeightMixModifier.invert_vertex_group_a "Link to this definition")
    :   Invert the influence of vertex group A

        Type:
        :   boolean, default False

    invert\_vertex\_group\_b[¶](#bpy.types.VertexWeightMixModifier.invert_vertex_group_b "Link to this definition")
    :   Invert the influence of vertex group B

        Type:
        :   boolean, default False

    mask\_constant[¶](#bpy.types.VertexWeightMixModifier.mask_constant "Link to this definition")
    :   Global influence of current modifications on vgroup

        Type:
        :   float in [-inf, inf], default 1.0

    mask\_tex\_map\_bone[¶](#bpy.types.VertexWeightMixModifier.mask_tex_map_bone "Link to this definition")
    :   Which bone to take texture coordinates from

        Type:
        :   string, default “”, (never None)

    mask\_tex\_map\_object[¶](#bpy.types.VertexWeightMixModifier.mask_tex_map_object "Link to this definition")
    :   Which object to take texture coordinates from

        Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object")

    mask\_tex\_mapping[¶](#bpy.types.VertexWeightMixModifier.mask_tex_mapping "Link to this definition")
    ...
    mask\_tex\_use\_channel[¶](#bpy.types.VertexWeightMixModifier.mask_tex_use_channel "Link to this definition")
    :   Which texture channel to use for masking

        Type:
        :   enum in [`'INT'`, `'RED'`, `'GREEN'`, `'BLUE'`, `'HUE'`, `'SAT'`, `'VAL'`, `'ALPHA'`], default `'INT'`

    mask\_tex\_uv\_layer[¶](#bpy.types.VertexWeightMixModifier.mask_tex_uv_layer "Link to this definition")
    :   UV map name

        Type:
        :   string, default “”, (never None)

    mask\_texture[¶](#bpy.types.VertexWeightMixModifier.mask_texture "Link to this definition")
    :   Masking texture

        Type:
        :   [`Texture`](Texture.md#bpy.types.Texture "bpy.types.Texture")

    mask\_vertex\_group[¶](#bpy.types.VertexWeightMixModifier.mask_vertex_group "Link to this definition")
    :   Masking vertex group name

        Type:
        :   string, default “”, (never None)

    mix\_mode[¶](#bpy.types.VertexWeightMixModifier.mix_mode "Link to this definition")
    ...
    mix\_set[¶](#bpy.types.VertexWeightMixModifier.mix_set "Link to this definition")
    ...
    normalize[¶](#bpy.types.VertexWeightMixModifier.normalize "Link to this definition")
    :   Normalize the resulting weights (otherwise they are only clamped within 0.0 to 1.0 range)

        Type:
        :   boolean, default False

    vertex\_group\_a[¶](#bpy.types.VertexWeightMixModifier.vertex_group_a "Link to this definition")
    :   First vertex group name

        Type:
        :   string, default “”, (never None)

    vertex\_group\_b[¶](#bpy.types.VertexWeightMixModifier.vertex_group_b "Link to this definition")
    :   Second vertex group name

        Type:
        :   string, default “”, (never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.VertexWeightMixModifier.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.VertexWeightMixModifier.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.VertexWeightMixModifier.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.VertexWeightMixModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* VertexWeightMixModifier(Modifier)
  + [`VertexWeightMixModifier`](#bpy.types.VertexWeightMixModifier)
    - [`VertexWeightMixModifier.default_weight_a`](#bpy.types.VertexWeightMixModifier.default_weight_a)
    - [`VertexWeightMixModifier.default_weight_b`](#bpy.types.VertexWeightMixModifier.default_weight_b)
    - [`VertexWeightMixModifier.invert_mask_vertex_group`](#bpy.types.VertexWeightMixModifier.invert_mask_vertex_group)
    - [`VertexWeightMixModifier.invert_vertex_group_a`](#bpy.types.VertexWeightMixModifier.invert_vertex_group_a)
    - [`VertexWeightMixModifier.invert_vertex_group_b`](#bpy.types.VertexWeightMixModifier.invert_vertex_group_b)
    - [`VertexWeightMixModifier.mask_constant`](#bpy.types.VertexWeightMixModifier.mask_constant)
    - [`VertexWeightMixModifier.mask_tex_map_bone`](#bpy.types.VertexWeightMixModifier.mask_tex_map_bone)
    - [`VertexWeightMixModifier.mask_tex_map_object`](#bpy.types.VertexWeightMixModifier.mask_tex_map_object)
    - [`VertexWeightMixModifier.mask_tex_mapping`](#bpy.types.VertexWeightMixModifier.mask_tex_mapping)
    - [`VertexWeightMixModifier.mask_tex_use_channel`](#bpy.types.VertexWeightMixModifier.mask_tex_use_channel)
    - [`VertexWeightMixModifier.mask_tex_uv_layer`](#bpy.types.VertexWeightMixModifier.mask_tex_uv_layer)
    - [`VertexWeightMixModifier.mask_texture`](#bpy.types.VertexWeightMixModifier.mask_texture)
    - [`VertexWeightMixModifier.mask_vertex_group`](#bpy.types.VertexWeightMixModifier.mask_vertex_group)
    - [`VertexWeightMixModifier.mix_mode`](#bpy.types.VertexWeightMixModifier.mix_mode)
    - [`VertexWeightMixModifier.mix_set`](#bpy.types.VertexWeightMixModifier.mix_set)
    - [`VertexWeightMixModifier.normalize`](#bpy.types.VertexWeightMixModifier.normalize)
    - [`VertexWeightMixModifier.vertex_group_a`](#bpy.types.VertexWeightMixModifier.vertex_group_a)
    - [`VertexWeightMixModifier.vertex_group_b`](#bpy.types.VertexWeightMixModifier.vertex_group_b)
    - [`VertexWeightMixModifier.bl_rna_get_subclass()`](#bpy.types.VertexWeightMixModifier.bl_rna_get_subclass)
    - [`VertexWeightMixModifier.bl_rna_get_subclass_py()`](#bpy.types.VertexWeightMixModifier.bl_rna_get_subclass_py)
