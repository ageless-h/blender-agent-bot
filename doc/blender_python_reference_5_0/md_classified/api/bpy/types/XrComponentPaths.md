...
# XrComponentPaths(bpy\_struct)[¶](#xrcomponentpaths-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.XrComponentPaths(*bpy\_struct*)[¶](#bpy.types.XrComponentPaths "Link to this definition")
:   Collection of OpenXR component paths

    new(*path*)[¶](#bpy.types.XrComponentPaths.new "Link to this definition")
    :   new

        Parameters:
        :   **path** (*string**,* *(**never None**)*) – Path, OpenXR component path

        Returns:
        :   Component Path, Added component path

        Return type:
        :   [`XrComponentPath`](XrComponentPath.md#bpy.types.XrComponentPath "bpy.types.XrComponentPath")

    remove(*component\_path*)[¶](#bpy.types.XrComponentPaths.remove "Link to this definition")
    :   remove

        Parameters:
        :   **component\_path** ([`XrComponentPath`](XrComponentPath.md#bpy.types.XrComponentPath "bpy.types.XrComponentPath"), (never None)) – Component Path

    find(*path*)[¶](#bpy.types.XrComponentPaths.find "Link to this definition")
    :   find
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.XrComponentPaths.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.XrComponentPaths.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`XrActionMapBinding.component_paths`](XrActionMapBinding.md#bpy.types.XrActionMapBinding.component_paths "bpy.types.XrActionMapBinding.component_paths") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.XrComponentPaths.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.XrComponentPaths.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* XrComponentPaths(bpy\_struct)
  + [`XrComponentPaths`](#bpy.types.XrComponentPaths)
    - [`XrComponentPaths.new()`](#bpy.types.XrComponentPaths.new)
    - [`XrComponentPaths.remove()`](#bpy.types.XrComponentPaths.remove)
    - [`XrComponentPaths.find()`](#bpy.types.XrComponentPaths.find)
    - [`XrComponentPaths.bl_rna_get_subclass()`](#bpy.types.XrComponentPaths.bl_rna_get_subclass)
    - [`XrComponentPaths.bl_rna_get_subclass_py()`](#bpy.types.XrComponentPaths.bl_rna_get_subclass_py)
