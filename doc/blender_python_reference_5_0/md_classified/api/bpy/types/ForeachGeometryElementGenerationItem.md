...
# ForeachGeometryElementGenerationItem(bpy\_struct)[¶](#foreachgeometryelementgenerationitem-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.ForeachGeometryElementGenerationItem(*bpy\_struct*)[¶](#bpy.types.ForeachGeometryElementGenerationItem "Link to this definition")
:   color[¶](#bpy.types.ForeachGeometryElementGenerationItem.color "Link to this definition")
    ...
    domain[¶](#bpy.types.ForeachGeometryElementGenerationItem.domain "Link to this definition")
    ...
    name[¶](#bpy.types.ForeachGeometryElementGenerationItem.name "Link to this definition")
    :   Type:
        :   string, default “”, (never None)

    socket\_type[¶](#bpy.types.ForeachGeometryElementGenerationItem.socket_type "Link to this definition")
    :   Type:
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ForeachGeometryElementGenerationItem.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ForeachGeometryElementGenerationItem.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`GeometryNodeForeachGeometryElementOutput.generation_items`](GeometryNodeForeachGeometryElementOutput.md#bpy.types.GeometryNodeForeachGeometryElementOutput.generation_items "bpy.types.GeometryNodeForeachGeometryElementOutput.generation_items") * [`NodeGeometryForeachGeometryElementGenerationItems.new`](NodeGeometryForeachGeometryElementGenerationItems.md#bpy.types.NodeGeometryForeachGeometryElementGenerationItems.new "bpy.types.NodeGeometryForeachGeometryElementGenerationItems.new") | * [`NodeGeometryForeachGeometryElementGenerationItems.remove`](NodeGeometryForeachGeometryElementGenerationItems.md#bpy.types.NodeGeometryForeachGeometryElementGenerationItems.remove "bpy.types.NodeGeometryForeachGeometryElementGenerationItems.remove") |

[Next

ForeachGeometryElementInputItem(bpy\_struct)](ForeachGeometryElementInputItem.md)
[Previous
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ForeachGeometryElementGenerationItem.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ForeachGeometryElementGenerationItem.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ForeachGeometryElementGenerationItem(bpy\_struct)
  + [`ForeachGeometryElementGenerationItem`](#bpy.types.ForeachGeometryElementGenerationItem)
    - [`ForeachGeometryElementGenerationItem.color`](#bpy.types.ForeachGeometryElementGenerationItem.color)
    - [`ForeachGeometryElementGenerationItem.domain`](#bpy.types.ForeachGeometryElementGenerationItem.domain)
    - [`ForeachGeometryElementGenerationItem.name`](#bpy.types.ForeachGeometryElementGenerationItem.name)
    - [`ForeachGeometryElementGenerationItem.socket_type`](#bpy.types.ForeachGeometryElementGenerationItem.socket_type)
    - [`ForeachGeometryElementGenerationItem.bl_rna_get_subclass()`](#bpy.types.ForeachGeometryElementGenerationItem.bl_rna_get_subclass)
    - [`ForeachGeometryElementGenerationItem.bl_rna_get_subclass_py()`](#bpy.types.ForeachGeometryElementGenerationItem.bl_rna_get_subclass_py)
