...
# BlendDataMovieClips(bpy\_struct)[¶](#blenddatamovieclips-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.BlendDataMovieClips(*bpy\_struct*)[¶](#bpy.types.BlendDataMovieClips "Link to this definition")
:   Collection of movie clips

    tag(*value*)[¶](#bpy.types.BlendDataMovieClips.tag "Link to this definition")
    :   tag

        Parameters:
        :   **value** (*boolean*) – Value

    remove(*clip*, *\**, *do\_unlink=True*, *do\_id\_user=True*, *do\_ui\_user=True*)[¶](#bpy.types.BlendDataMovieClips.remove "Link to this definition")
    :   Remove a movie clip from the current blendfile.

        Parameters:
        :   * **clip** ([`MovieClip`](MovieClip.md#bpy.types.MovieClip "bpy.types.MovieClip"), (never None)) – Movie clip to remove
            * **do\_unlink** (*boolean**,* *(**optional**)*) – Unlink all usages of this movie clip before deleting it
            * **do\_id\_user** (*boolean**,* *(**optional**)*) – Decrement user counter of all data-blocks used by this movie clip
            * **do\_ui\_user** (*boolean**,* *(**optional**)*) – Make sure interface does not reference this movie clip

    load(*filepath*, *\**, *check\_existing=False*)[¶](#bpy.types.BlendDataMovieClips.load "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.BlendDataMovieClips.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.BlendDataMovieClips.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`BlendData.movieclips`](BlendData.md#bpy.types.BlendData.movieclips "bpy.types.BlendData.movieclips") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.BlendDataMovieClips.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.BlendDataMovieClips.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* BlendDataMovieClips(bpy\_struct)
  + [`BlendDataMovieClips`](#bpy.types.BlendDataMovieClips)
    - [`BlendDataMovieClips.tag()`](#bpy.types.BlendDataMovieClips.tag)
    - [`BlendDataMovieClips.remove()`](#bpy.types.BlendDataMovieClips.remove)
    - [`BlendDataMovieClips.load()`](#bpy.types.BlendDataMovieClips.load)
    - [`BlendDataMovieClips.bl_rna_get_subclass()`](#bpy.types.BlendDataMovieClips.bl_rna_get_subclass)
    - [`BlendDataMovieClips.bl_rna_get_subclass_py()`](#bpy.types.BlendDataMovieClips.bl_rna_get_subclass_py)
