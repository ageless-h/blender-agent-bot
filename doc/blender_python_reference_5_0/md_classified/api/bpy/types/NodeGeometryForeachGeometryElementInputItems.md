...
# NodeGeometryForeachGeometryElementInputItems(bpy\_struct)[¶](#nodegeometryforeachgeometryelementinputitems-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.NodeGeometryForeachGeometryElementInputItems(*bpy\_struct*)[¶](#bpy.types.NodeGeometryForeachGeometryElementInputItems "Link to this definition")
:   Collection of input items

    new(*socket\_type*, *name*)[¶](#bpy.types.NodeGeometryForeachGeometryElementInputItems.new "Link to this definition")
    :   Add an item at the end
        ...
        Return type:
        :   [`ForeachGeometryElementInputItem`](ForeachGeometryElementInputItem.md#bpy.types.ForeachGeometryElementInputItem "bpy.types.ForeachGeometryElementInputItem")

    remove(*item*)[¶](#bpy.types.NodeGeometryForeachGeometryElementInputItems.remove "Link to this definition")
    :   Remove an item

        Parameters:
        :   **item** ([`ForeachGeometryElementInputItem`](ForeachGeometryElementInputItem.md#bpy.types.ForeachGeometryElementInputItem "bpy.types.ForeachGeometryElementInputItem"), (never None)) – Item, The item to remove

    clear()[¶](#bpy.types.NodeGeometryForeachGeometryElementInputItems.clear "Link to this definition")
    :   Remove all items

    move(*from\_index*, *to\_index*)[¶](#bpy.types.NodeGeometryForeachGeometryElementInputItems.move "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.NodeGeometryForeachGeometryElementInputItems.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.NodeGeometryForeachGeometryElementInputItems.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`GeometryNodeForeachGeometryElementOutput.input_items`](GeometryNodeForeachGeometryElementOutput.md#bpy.types.GeometryNodeForeachGeometryElementOutput.input_items "bpy.types.GeometryNodeForeachGeometryElementOutput.input_items") |  |

[Next

NodeGeometryForeachGeometryElementMainItems(bpy\_struct)](NodeGeometryForeachGeometryElementMainItems.md)
[Previous

NodeGeometryForeachGeometryElementGenerationItems(bpy\_struct)](NodeGeometryForeachGeometryElementGenerationItems.md)
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.NodeGeometryForeachGeometryElementInputItems.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.NodeGeometryForeachGeometryElementInputItems.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* NodeGeometryForeachGeometryElementInputItems(bpy\_struct)
  + [`NodeGeometryForeachGeometryElementInputItems`](#bpy.types.NodeGeometryForeachGeometryElementInputItems)
    - [`NodeGeometryForeachGeometryElementInputItems.new()`](#bpy.types.NodeGeometryForeachGeometryElementInputItems.new)
    - [`NodeGeometryForeachGeometryElementInputItems.remove()`](#bpy.types.NodeGeometryForeachGeometryElementInputItems.remove)
    - [`NodeGeometryForeachGeometryElementInputItems.clear()`](#bpy.types.NodeGeometryForeachGeometryElementInputItems.clear)
    - [`NodeGeometryForeachGeometryElementInputItems.move()`](#bpy.types.NodeGeometryForeachGeometryElementInputItems.move)
    - [`NodeGeometryForeachGeometryElementInputItems.bl_rna_get_subclass()`](#bpy.types.NodeGeometryForeachGeometryElementInputItems.bl_rna_get_subclass)
    - [`NodeGeometryForeachGeometryElementInputItems.bl_rna_get_subclass_py()`](#bpy.types.NodeGeometryForeachGeometryElementInputItems.bl_rna_get_subclass_py)
