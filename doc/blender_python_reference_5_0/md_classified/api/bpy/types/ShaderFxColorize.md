...
# ShaderFxColorize(ShaderFx)[¶](#shaderfxcolorize-shaderfx "Link to this heading")
...
*class* bpy.types.ShaderFxColorize(*ShaderFx*)[¶](#bpy.types.ShaderFxColorize "Link to this definition")
:   Colorize effect

    factor[¶](#bpy.types.ShaderFxColorize.factor "Link to this definition")
    :   Mix factor

        Type:
        :   float in [0, 1], default 0.0

    high\_color[¶](#bpy.types.ShaderFxColorize.high_color "Link to this definition")
    :   Second color used for effect

        Type:
        :   float array of 4 items in [0, 1], default (0.0, 0.0, 0.0, 0.0)

    low\_color[¶](#bpy.types.ShaderFxColorize.low_color "Link to this definition")
    :   First color used for effect

        Type:
        :   float array of 4 items in [0, 1], default (0.0, 0.0, 0.0, 0.0)

    mode[¶](#bpy.types.ShaderFxColorize.mode "Link to this definition")
    :   Effect mode

        Type:
        :   enum in [`'GRAYSCALE'`, `'SEPIA'`, `'DUOTONE'`, `'TRANSPARENT'`, `'CUSTOM'`], default `'GRAYSCALE'`

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ShaderFxColorize.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ShaderFxColorize.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ShaderFxColorize.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ShaderFxColorize.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ShaderFxColorize(ShaderFx)
  + [`ShaderFxColorize`](#bpy.types.ShaderFxColorize)
    - [`ShaderFxColorize.factor`](#bpy.types.ShaderFxColorize.factor)
    - [`ShaderFxColorize.high_color`](#bpy.types.ShaderFxColorize.high_color)
    - [`ShaderFxColorize.low_color`](#bpy.types.ShaderFxColorize.low_color)
    - [`ShaderFxColorize.mode`](#bpy.types.ShaderFxColorize.mode)
    - [`ShaderFxColorize.bl_rna_get_subclass()`](#bpy.types.ShaderFxColorize.bl_rna_get_subclass)
    - [`ShaderFxColorize.bl_rna_get_subclass_py()`](#bpy.types.ShaderFxColorize.bl_rna_get_subclass_py)
