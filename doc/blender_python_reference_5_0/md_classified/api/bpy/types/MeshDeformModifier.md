...
# MeshDeformModifier(Modifier)[¶](#meshdeformmodifier-modifier "Link to this heading")
...
*class* bpy.types.MeshDeformModifier(*Modifier*)[¶](#bpy.types.MeshDeformModifier "Link to this definition")
:   Mesh deformation modifier to deform with other meshes

    invert\_vertex\_group[¶](#bpy.types.MeshDeformModifier.invert_vertex_group "Link to this definition")
    :   Invert vertex group influence

        Type:
        :   boolean, default False

    is\_bound[¶](#bpy.types.MeshDeformModifier.is_bound "Link to this definition")
    :   Whether geometry has been bound to control cage

        Type:
        :   boolean, default False, (readonly)

    object[¶](#bpy.types.MeshDeformModifier.object "Link to this definition")
    :   Mesh object to deform with

        Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object")

    precision[¶](#bpy.types.MeshDeformModifier.precision "Link to this definition")
    :   The grid size for binding

        Type:
        :   int in [2, 10], default 5

    use\_dynamic\_bind[¶](#bpy.types.MeshDeformModifier.use_dynamic_bind "Link to this definition")
    :   Recompute binding dynamically on top of other deformers (slower and more memory consuming)

        Type:
        :   boolean, default False

    vertex\_group[¶](#bpy.types.MeshDeformModifier.vertex_group "Link to this definition")
    :   Vertex group name

        Type:
        :   string, default “”, (never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.MeshDeformModifier.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.MeshDeformModifier.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.MeshDeformModifier.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.MeshDeformModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* MeshDeformModifier(Modifier)
  + [`MeshDeformModifier`](#bpy.types.MeshDeformModifier)
    - [`MeshDeformModifier.invert_vertex_group`](#bpy.types.MeshDeformModifier.invert_vertex_group)
    - [`MeshDeformModifier.is_bound`](#bpy.types.MeshDeformModifier.is_bound)
    - [`MeshDeformModifier.object`](#bpy.types.MeshDeformModifier.object)
    - [`MeshDeformModifier.precision`](#bpy.types.MeshDeformModifier.precision)
    - [`MeshDeformModifier.use_dynamic_bind`](#bpy.types.MeshDeformModifier.use_dynamic_bind)
    - [`MeshDeformModifier.vertex_group`](#bpy.types.MeshDeformModifier.vertex_group)
    - [`MeshDeformModifier.bl_rna_get_subclass()`](#bpy.types.MeshDeformModifier.bl_rna_get_subclass)
    - [`MeshDeformModifier.bl_rna_get_subclass_py()`](#bpy.types.MeshDeformModifier.bl_rna_get_subclass_py)
