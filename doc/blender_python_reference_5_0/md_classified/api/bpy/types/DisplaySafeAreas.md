...
# DisplaySafeAreas(bpy\_struct)[¶](#displaysafeareas-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.DisplaySafeAreas(*bpy\_struct*)[¶](#bpy.types.DisplaySafeAreas "Link to this definition")
:   Safe areas used in 3D view and the sequencer

    action[¶](#bpy.types.DisplaySafeAreas.action "Link to this definition")
    :   Safe area for general elements

        Type:
        :   [`mathutils.Vector`](../../mathutils/index.md#mathutils.Vector "mathutils.Vector") of 2 items in [0, 1], default (0.035, 0.035)

    action\_center[¶](#bpy.types.DisplaySafeAreas.action_center "Link to this definition")
    :   Safe area for general elements in a different aspect ratio

        Type:
        :   [`mathutils.Vector`](../../mathutils/index.md#mathutils.Vector "mathutils.Vector") of 2 items in [0, 1], default (0.15, 0.05)

    title[¶](#bpy.types.DisplaySafeAreas.title "Link to this definition")
    :   Safe area for text and graphics

        Type:
        :   [`mathutils.Vector`](../../mathutils/index.md#mathutils.Vector "mathutils.Vector") of 2 items in [0, 1], default (0.1, 0.05)

    title\_center[¶](#bpy.types.DisplaySafeAreas.title_center "Link to this definition")
    :   Safe area for text and graphics in a different aspect ratio

        Type:
        :   [`mathutils.Vector`](../../mathutils/index.md#mathutils.Vector "mathutils.Vector") of 2 items in [0, 1], default (0.175, 0.05)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.DisplaySafeAreas.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.DisplaySafeAreas.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Scene.safe_areas`](Scene.md#bpy.types.Scene.safe_areas "bpy.types.Scene.safe_areas") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.DisplaySafeAreas.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.DisplaySafeAreas.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* DisplaySafeAreas(bpy\_struct)
  + [`DisplaySafeAreas`](#bpy.types.DisplaySafeAreas)
    - [`DisplaySafeAreas.action`](#bpy.types.DisplaySafeAreas.action)
    - [`DisplaySafeAreas.action_center`](#bpy.types.DisplaySafeAreas.action_center)
    - [`DisplaySafeAreas.title`](#bpy.types.DisplaySafeAreas.title)
    - [`DisplaySafeAreas.title_center`](#bpy.types.DisplaySafeAreas.title_center)
    - [`DisplaySafeAreas.bl_rna_get_subclass()`](#bpy.types.DisplaySafeAreas.bl_rna_get_subclass)
    - [`DisplaySafeAreas.bl_rna_get_subclass_py()`](#bpy.types.DisplaySafeAreas.bl_rna_get_subclass_py)
