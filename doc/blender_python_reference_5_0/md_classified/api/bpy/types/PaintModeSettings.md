...
# PaintModeSettings(bpy\_struct)[¶](#paintmodesettings-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.PaintModeSettings(*bpy\_struct*)[¶](#bpy.types.PaintModeSettings "Link to this definition")
:   Properties of paint mode

    canvas\_image[¶](#bpy.types.PaintModeSettings.canvas_image "Link to this definition")
    :   Image used as painting target

        Type:
        :   [`Image`](Image.md#bpy.types.Image "bpy.types.Image")

    canvas\_source[¶](#bpy.types.PaintModeSettings.canvas_source "Link to this definition")
    :   Source to select canvas from

        Type:
        :   enum in [`'COLOR_ATTRIBUTE'`, `'MATERIAL'`, `'IMAGE'`], default `'MATERIAL'`

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.PaintModeSettings.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.PaintModeSettings.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`ToolSettings.paint_mode`](ToolSettings.md#bpy.types.ToolSettings.paint_mode "bpy.types.ToolSettings.paint_mode") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.PaintModeSettings.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.PaintModeSettings.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* PaintModeSettings(bpy\_struct)
  + [`PaintModeSettings`](#bpy.types.PaintModeSettings)
    - [`PaintModeSettings.canvas_image`](#bpy.types.PaintModeSettings.canvas_image)
    - [`PaintModeSettings.canvas_source`](#bpy.types.PaintModeSettings.canvas_source)
    - [`PaintModeSettings.bl_rna_get_subclass()`](#bpy.types.PaintModeSettings.bl_rna_get_subclass)
    - [`PaintModeSettings.bl_rna_get_subclass_py()`](#bpy.types.PaintModeSettings.bl_rna_get_subclass_py)
