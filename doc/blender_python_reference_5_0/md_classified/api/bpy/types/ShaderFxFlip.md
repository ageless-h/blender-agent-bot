...
# ShaderFxFlip(ShaderFx)[¶](#shaderfxflip-shaderfx "Link to this heading")
...
*class* bpy.types.ShaderFxFlip(*ShaderFx*)[¶](#bpy.types.ShaderFxFlip "Link to this definition")
:   Flip effect

    use\_flip\_x[¶](#bpy.types.ShaderFxFlip.use_flip_x "Link to this definition")
    :   Flip image horizontally

        Type:
        :   boolean, default False

    use\_flip\_y[¶](#bpy.types.ShaderFxFlip.use_flip_y "Link to this definition")
    :   Flip image vertically

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ShaderFxFlip.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ShaderFxFlip.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ShaderFxFlip.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ShaderFxFlip.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ShaderFxFlip(ShaderFx)
  + [`ShaderFxFlip`](#bpy.types.ShaderFxFlip)
    - [`ShaderFxFlip.use_flip_x`](#bpy.types.ShaderFxFlip.use_flip_x)
    - [`ShaderFxFlip.use_flip_y`](#bpy.types.ShaderFxFlip.use_flip_y)
    - [`ShaderFxFlip.bl_rna_get_subclass()`](#bpy.types.ShaderFxFlip.bl_rna_get_subclass)
    - [`ShaderFxFlip.bl_rna_get_subclass_py()`](#bpy.types.ShaderFxFlip.bl_rna_get_subclass_py)
