...
# ThemeTopBar(bpy\_struct)[¶](#themetopbar-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.ThemeTopBar(*bpy\_struct*)[¶](#bpy.types.ThemeTopBar "Link to this definition")
:   Theme settings for the Top Bar

    space[¶](#bpy.types.ThemeTopBar.space "Link to this definition")
    :   Settings for space

        Type:
        :   [`ThemeSpaceGeneric`](ThemeSpaceGeneric.md#bpy.types.ThemeSpaceGeneric "bpy.types.ThemeSpaceGeneric"), (readonly, never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ThemeTopBar.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ThemeTopBar.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Theme.topbar`](Theme.md#bpy.types.Theme.topbar "bpy.types.Theme.topbar") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ThemeTopBar.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ThemeTopBar.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ThemeTopBar(bpy\_struct)
  + [`ThemeTopBar`](#bpy.types.ThemeTopBar)
    - [`ThemeTopBar.space`](#bpy.types.ThemeTopBar.space)
    - [`ThemeTopBar.bl_rna_get_subclass()`](#bpy.types.ThemeTopBar.bl_rna_get_subclass)
    - [`ThemeTopBar.bl_rna_get_subclass_py()`](#bpy.types.ThemeTopBar.bl_rna_get_subclass_py)
