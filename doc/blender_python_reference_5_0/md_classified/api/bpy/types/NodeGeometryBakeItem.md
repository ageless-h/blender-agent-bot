...
# NodeGeometryBakeItem(bpy\_struct)[¶](#nodegeometrybakeitem-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.NodeGeometryBakeItem(*bpy\_struct*)[¶](#bpy.types.NodeGeometryBakeItem "Link to this definition")
:   attribute\_domain[¶](#bpy.types.NodeGeometryBakeItem.attribute_domain "Link to this definition")
    ...
    color[¶](#bpy.types.NodeGeometryBakeItem.color "Link to this definition")
    ...
    is\_attribute[¶](#bpy.types.NodeGeometryBakeItem.is_attribute "Link to this definition")
    :   Bake item is an attribute stored on a geometry

        Type:
        :   boolean, default False

    name[¶](#bpy.types.NodeGeometryBakeItem.name "Link to this definition")
    :   Type:
        :   string, default “”, (never None)

    socket\_type[¶](#bpy.types.NodeGeometryBakeItem.socket_type "Link to this definition")
    :   Type:
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.NodeGeometryBakeItem.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.NodeGeometryBakeItem.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`GeometryNodeBake.bake_items`](GeometryNodeBake.md#bpy.types.GeometryNodeBake.bake_items "bpy.types.GeometryNodeBake.bake_items") * [`NodeGeometryBakeItems.new`](NodeGeometryBakeItems.md#bpy.types.NodeGeometryBakeItems.new "bpy.types.NodeGeometryBakeItems.new") | * [`NodeGeometryBakeItems.remove`](NodeGeometryBakeItems.md#bpy.types.NodeGeometryBakeItems.remove "bpy.types.NodeGeometryBakeItems.remove") |
...
NodeFunctionFormatStringItems(bpy\_struct)](NodeFunctionFormatStringItems.md)
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.NodeGeometryBakeItem.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.NodeGeometryBakeItem.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* NodeGeometryBakeItem(bpy\_struct)
  + [`NodeGeometryBakeItem`](#bpy.types.NodeGeometryBakeItem)
    - [`NodeGeometryBakeItem.attribute_domain`](#bpy.types.NodeGeometryBakeItem.attribute_domain)
    - [`NodeGeometryBakeItem.color`](#bpy.types.NodeGeometryBakeItem.color)
    - [`NodeGeometryBakeItem.is_attribute`](#bpy.types.NodeGeometryBakeItem.is_attribute)
    - [`NodeGeometryBakeItem.name`](#bpy.types.NodeGeometryBakeItem.name)
    - [`NodeGeometryBakeItem.socket_type`](#bpy.types.NodeGeometryBakeItem.socket_type)
    - [`NodeGeometryBakeItem.bl_rna_get_subclass()`](#bpy.types.NodeGeometryBakeItem.bl_rna_get_subclass)
    - [`NodeGeometryBakeItem.bl_rna_get_subclass_py()`](#bpy.types.NodeGeometryBakeItem.bl_rna_get_subclass_py)
