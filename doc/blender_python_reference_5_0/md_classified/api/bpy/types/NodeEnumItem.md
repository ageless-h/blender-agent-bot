...
# NodeEnumItem(bpy\_struct)[¶](#nodeenumitem-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.NodeEnumItem(*bpy\_struct*)[¶](#bpy.types.NodeEnumItem "Link to this definition")
:   description[¶](#bpy.types.NodeEnumItem.description "Link to this definition")
    :   Type:
        :   string, default “”, (never None)

    name[¶](#bpy.types.NodeEnumItem.name "Link to this definition")
    :   Type:
        :   string, default “”, (never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.NodeEnumItem.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.NodeEnumItem.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`GeometryNodeMenuSwitch.active_item`](GeometryNodeMenuSwitch.md#bpy.types.GeometryNodeMenuSwitch.active_item "bpy.types.GeometryNodeMenuSwitch.active_item") * [`GeometryNodeMenuSwitch.enum_items`](GeometryNodeMenuSwitch.md#bpy.types.GeometryNodeMenuSwitch.enum_items "bpy.types.GeometryNodeMenuSwitch.enum_items") | * [`NodeMenuSwitchItems.new`](NodeMenuSwitchItems.md#bpy.types.NodeMenuSwitchItems.new "bpy.types.NodeMenuSwitchItems.new") * [`NodeMenuSwitchItems.remove`](NodeMenuSwitchItems.md#bpy.types.NodeMenuSwitchItems.remove "bpy.types.NodeMenuSwitchItems.remove") |
...
NodeEnableOutput(NodeInternal)](NodeEnableOutput.md)
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.NodeEnumItem.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.NodeEnumItem.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* NodeEnumItem(bpy\_struct)
  + [`NodeEnumItem`](#bpy.types.NodeEnumItem)
    - [`NodeEnumItem.description`](#bpy.types.NodeEnumItem.description)
    - [`NodeEnumItem.name`](#bpy.types.NodeEnumItem.name)
    - [`NodeEnumItem.bl_rna_get_subclass()`](#bpy.types.NodeEnumItem.bl_rna_get_subclass)
    - [`NodeEnumItem.bl_rna_get_subclass_py()`](#bpy.types.NodeEnumItem.bl_rna_get_subclass_py)
