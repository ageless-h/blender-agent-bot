...
# CurveProfile(bpy\_struct)[¶](#curveprofile-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.CurveProfile(*bpy\_struct*)[¶](#bpy.types.CurveProfile "Link to this definition")
:   Profile Path editor used to build a profile path

    points[¶](#bpy.types.CurveProfile.points "Link to this definition")
    :   Profile control points

        Type:
        :   [`CurveProfilePoints`](CurveProfilePoints.md#bpy.types.CurveProfilePoints "bpy.types.CurveProfilePoints") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`CurveProfilePoint`](CurveProfilePoint.md#bpy.types.CurveProfilePoint "bpy.types.CurveProfilePoint"), (readonly)

    preset[¶](#bpy.types.CurveProfile.preset "Link to this definition")
    :   * `LINE`
          Line – Default.
        * `SUPPORTS`
    ...
    segments[¶](#bpy.types.CurveProfile.segments "Link to this definition")
    :   Segments sampled from control points

        Type:
        :   [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`CurveProfilePoint`](CurveProfilePoint.md#bpy.types.CurveProfilePoint "bpy.types.CurveProfilePoint"), (readonly)

    use\_clip[¶](#bpy.types.CurveProfile.use_clip "Link to this definition")
    :   Force the path view to fit a defined boundary

        Type:
        :   boolean, default False

    use\_sample\_even\_lengths[¶](#bpy.types.CurveProfile.use_sample_even_lengths "Link to this definition")
    :   Sample edges with even lengths

        Type:
        :   boolean, default False

    use\_sample\_straight\_edges[¶](#bpy.types.CurveProfile.use_sample_straight_edges "Link to this definition")
    :   Sample edges with vector handles

        Type:
        :   boolean, default False

    update()[¶](#bpy.types.CurveProfile.update "Link to this definition")
    :   Refresh internal data, remove doubles and clip points

    reset\_view()[¶](#bpy.types.CurveProfile.reset_view "Link to this definition")
    :   Reset the curve profile grid to its clipping size

    initialize(*totsegments*)[¶](#bpy.types.CurveProfile.initialize "Link to this definition")
    ...
    evaluate(*length\_portion*)[¶](#bpy.types.CurveProfile.evaluate "Link to this definition")
    :   Evaluate the at the given portion of the path length

        Parameters:
        :   **length\_portion** (*float in* *[**0**,* *1**]*) – Length Portion, Portion of the path length to travel before evaluation

        Returns:
        :   Location, The location at the given portion of the profile

        Return type:
        :   [`mathutils.Vector`](../../mathutils/index.md#mathutils.Vector "mathutils.Vector") of 2 items in [-100, 100]

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.CurveProfile.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.CurveProfile.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`BevelModifier.custom_profile`](BevelModifier.md#bpy.types.BevelModifier.custom_profile "bpy.types.BevelModifier.custom_profile") * [`Curve.bevel_profile`](Curve.md#bpy.types.Curve.bevel_profile "bpy.types.Curve.bevel_profile") | * [`ToolSettings.custom_bevel_profile_preset`](ToolSettings.md#bpy.types.ToolSettings.custom_bevel_profile_preset "bpy.types.ToolSettings.custom_bevel_profile_preset") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CurveProfile.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.CurveProfile.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CurveProfile(bpy\_struct)
  + [`CurveProfile`](#bpy.types.CurveProfile)
    - [`CurveProfile.points`](#bpy.types.CurveProfile.points)
    - [`CurveProfile.preset`](#bpy.types.CurveProfile.preset)
    - [`CurveProfile.segments`](#bpy.types.CurveProfile.segments)
    - [`CurveProfile.use_clip`](#bpy.types.CurveProfile.use_clip)
    - [`CurveProfile.use_sample_even_lengths`](#bpy.types.CurveProfile.use_sample_even_lengths)
    - [`CurveProfile.use_sample_straight_edges`](#bpy.types.CurveProfile.use_sample_straight_edges)
    - [`CurveProfile.update()`](#bpy.types.CurveProfile.update)
    - [`CurveProfile.reset_view()`](#bpy.types.CurveProfile.reset_view)
    - [`CurveProfile.initialize()`](#bpy.types.CurveProfile.initialize)
    - [`CurveProfile.evaluate()`](#bpy.types.CurveProfile.evaluate)
    - [`CurveProfile.bl_rna_get_subclass()`](#bpy.types.CurveProfile.bl_rna_get_subclass)
    - [`CurveProfile.bl_rna_get_subclass_py()`](#bpy.types.CurveProfile.bl_rna_get_subclass_py)
