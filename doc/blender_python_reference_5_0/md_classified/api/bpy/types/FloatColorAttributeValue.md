...
# FloatColorAttributeValue(bpy\_struct)[¶](#floatcolorattributevalue-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.FloatColorAttributeValue(*bpy\_struct*)[¶](#bpy.types.FloatColorAttributeValue "Link to this definition")
:   Color value in geometry attribute

    color[¶](#bpy.types.FloatColorAttributeValue.color "Link to this definition")
    :   RGBA color in scene linear color space

        Type:
        :   float array of 4 items in [0, inf], default (0.0, 0.0, 0.0, 0.0)

    color\_srgb[¶](#bpy.types.FloatColorAttributeValue.color_srgb "Link to this definition")
    :   RGBA color in sRGB color space

        Type:
        :   float array of 4 items in [0, inf], default (0.0, 0.0, 0.0, 0.0)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.FloatColorAttributeValue.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.FloatColorAttributeValue.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`FloatColorAttribute.data`](FloatColorAttribute.md#bpy.types.FloatColorAttribute.data "bpy.types.FloatColorAttribute.data") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.FloatColorAttributeValue.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.FloatColorAttributeValue.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* FloatColorAttributeValue(bpy\_struct)
  + [`FloatColorAttributeValue`](#bpy.types.FloatColorAttributeValue)
    - [`FloatColorAttributeValue.color`](#bpy.types.FloatColorAttributeValue.color)
    - [`FloatColorAttributeValue.color_srgb`](#bpy.types.FloatColorAttributeValue.color_srgb)
    - [`FloatColorAttributeValue.bl_rna_get_subclass()`](#bpy.types.FloatColorAttributeValue.bl_rna_get_subclass)
    - [`FloatColorAttributeValue.bl_rna_get_subclass_py()`](#bpy.types.FloatColorAttributeValue.bl_rna_get_subclass_py)
