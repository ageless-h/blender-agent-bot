...
:   Collection of action slots
    ...
    remove(*action\_slot*)[¶](#bpy.types.ActionSlots.remove "Link to this definition")
    :   Remove the slot from the Action, including all animation that is associated with that slot

        Parameters:
        :   **action\_slot** ([`ActionSlot`](ActionSlot.md#bpy.types.ActionSlot "bpy.types.ActionSlot")) – Action Slot, The slot to remove

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ActionSlots.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ActionSlots.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Action.slots`](Action.md#bpy.types.Action.slots "bpy.types.Action.slots") |  |

[Next

ActionStrip(bpy\_struct)](ActionStrip.md)
[Previous
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ActionSlots.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ActionSlots.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ActionSlots(bpy\_struct)
  + [`ActionSlots`](#bpy.types.ActionSlots)
    - [`ActionSlots.active`](#bpy.types.ActionSlots.active)
    - [`ActionSlots.new()`](#bpy.types.ActionSlots.new)
    - [`ActionSlots.remove()`](#bpy.types.ActionSlots.remove)
    - [`ActionSlots.bl_rna_get_subclass()`](#bpy.types.ActionSlots.bl_rna_get_subclass)
    - [`ActionSlots.bl_rna_get_subclass_py()`](#bpy.types.ActionSlots.bl_rna_get_subclass_py)
