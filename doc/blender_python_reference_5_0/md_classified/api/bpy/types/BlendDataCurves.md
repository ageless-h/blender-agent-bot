...
# BlendDataCurves(bpy\_struct)[¶](#blenddatacurves-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.BlendDataCurves(*bpy\_struct*)[¶](#bpy.types.BlendDataCurves "Link to this definition")
:   Collection of curves

    new(*name*, *type*)[¶](#bpy.types.BlendDataCurves.new "Link to this definition")
    :   Add a new curve to the main database

        Parameters:
        :   * **name** (*string**,* *(**never None**)*) – New name for the data-block
            * **type** (enum in [Object Type Curve Items](../../../appendix/bpy_types_enum_items/object_type_curve_items.md#rna-enum-object-type-curve-items)) – Type, The type of curve to add
    ...
    remove(*curve*, *\**, *do\_unlink=True*, *do\_id\_user=True*, *do\_ui\_user=True*)[¶](#bpy.types.BlendDataCurves.remove "Link to this definition")
    :   Remove a curve from the current blendfile

        Parameters:
        :   * **curve** ([`Curve`](Curve.md#bpy.types.Curve "bpy.types.Curve"), (never None)) – Curve to remove
            * **do\_unlink** (*boolean**,* *(**optional**)*) – Unlink all usages of this curve before deleting it (WARNING: will also delete objects instancing that curve data)
            * **do\_id\_user** (*boolean**,* *(**optional**)*) – Decrement user counter of all data-blocks used by this curve data
            * **do\_ui\_user** (*boolean**,* *(**optional**)*) – Make sure interface does not reference this curve data

    tag(*value*)[¶](#bpy.types.BlendDataCurves.tag "Link to this definition")
    :   tag

        Parameters:
        :   **value** (*boolean*) – Value

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.BlendDataCurves.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.BlendDataCurves.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`BlendData.curves`](BlendData.md#bpy.types.BlendData.curves "bpy.types.BlendData.curves") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.BlendDataCurves.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.BlendDataCurves.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* BlendDataCurves(bpy\_struct)
  + [`BlendDataCurves`](#bpy.types.BlendDataCurves)
    - [`BlendDataCurves.new()`](#bpy.types.BlendDataCurves.new)
    - [`BlendDataCurves.remove()`](#bpy.types.BlendDataCurves.remove)
    - [`BlendDataCurves.tag()`](#bpy.types.BlendDataCurves.tag)
    - [`BlendDataCurves.bl_rna_get_subclass()`](#bpy.types.BlendDataCurves.bl_rna_get_subclass)
    - [`BlendDataCurves.bl_rna_get_subclass_py()`](#bpy.types.BlendDataCurves.bl_rna_get_subclass_py)
