...
# IndexSwitchItem(bpy\_struct)[¶](#indexswitchitem-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.IndexSwitchItem(*bpy\_struct*)[¶](#bpy.types.IndexSwitchItem "Link to this definition")
:   identifier[¶](#bpy.types.IndexSwitchItem.identifier "Link to this definition")
    :   Consistent identifier used for the item

        Type:
        :   int in [-inf, inf], default 0, (readonly)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.IndexSwitchItem.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.IndexSwitchItem.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`GeometryNodeIndexSwitch.index_switch_items`](GeometryNodeIndexSwitch.md#bpy.types.GeometryNodeIndexSwitch.index_switch_items "bpy.types.GeometryNodeIndexSwitch.index_switch_items") * [`NodeIndexSwitchItems.new`](NodeIndexSwitchItems.md#bpy.types.NodeIndexSwitchItems.new "bpy.types.NodeIndexSwitchItems.new") | * [`NodeIndexSwitchItems.remove`](NodeIndexSwitchItems.md#bpy.types.NodeIndexSwitchItems.remove "bpy.types.NodeIndexSwitchItems.remove") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.IndexSwitchItem.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.IndexSwitchItem.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* IndexSwitchItem(bpy\_struct)
  + [`IndexSwitchItem`](#bpy.types.IndexSwitchItem)
    - [`IndexSwitchItem.identifier`](#bpy.types.IndexSwitchItem.identifier)
    - [`IndexSwitchItem.bl_rna_get_subclass()`](#bpy.types.IndexSwitchItem.bl_rna_get_subclass)
    - [`IndexSwitchItem.bl_rna_get_subclass_py()`](#bpy.types.IndexSwitchItem.bl_rna_get_subclass_py)
