...
# KeyConfigurations(bpy\_struct)[¶](#keyconfigurations-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.KeyConfigurations(*bpy\_struct*)[¶](#bpy.types.KeyConfigurations "Link to this definition")
:   Collection of KeyConfigs

    active[¶](#bpy.types.KeyConfigurations.active "Link to this definition")
    :   Active key configuration (preset)

        Type:
        :   [`KeyConfig`](KeyConfig.md#bpy.types.KeyConfig "bpy.types.KeyConfig")

    addon[¶](#bpy.types.KeyConfigurations.addon "Link to this definition")
    :   Key configuration that can be extended by add-ons, and is added to the active configuration when handling events

        Type:
        :   [`KeyConfig`](KeyConfig.md#bpy.types.KeyConfig "bpy.types.KeyConfig"), (readonly)

    default[¶](#bpy.types.KeyConfigurations.default "Link to this definition")
    :   Default builtin key configuration

        Type:
        :   [`KeyConfig`](KeyConfig.md#bpy.types.KeyConfig "bpy.types.KeyConfig"), (readonly)

    user[¶](#bpy.types.KeyConfigurations.user "Link to this definition")
    :   Final key configuration that combines keymaps from the active and add-on configurations, and can be edited by the user

        Type:
        :   [`KeyConfig`](KeyConfig.md#bpy.types.KeyConfig "bpy.types.KeyConfig"), (readonly)

    new(*name*)[¶](#bpy.types.KeyConfigurations.new "Link to this definition")
    :   new
    ...
    remove(*keyconfig*)[¶](#bpy.types.KeyConfigurations.remove "Link to this definition")
    :   remove

        Parameters:
        :   **keyconfig** ([`KeyConfig`](KeyConfig.md#bpy.types.KeyConfig "bpy.types.KeyConfig"), (never None)) – Key Configuration, Removed key configuration

    find\_item\_from\_operator(*idname*, *\**, *context='INVOKE\_DEFAULT'*, *properties=None*, *include={'ACTIONZONE', 'KEYBOARD', 'MOUSE', 'NDOF'}*, *exclude={}*)[¶](#bpy.types.KeyConfigurations.find_item_from_operator "Link to this definition")
    :   find\_item\_from\_operator

        Parameters:
        :   * **idname** (*string**,* *(**never None**)*) – Operator Identifier
            * **context** (enum in [Operator Context Items](../../../appendix/bpy_types_enum_items/operator_context_items.md#rna-enum-operator-context-items), (optional)) – context
        ...
        Returns:
        :   `keymap`, [`KeyMap`](KeyMap.md#bpy.types.KeyMap "bpy.types.KeyMap")

            `item`, [`KeyMapItem`](KeyMapItem.md#bpy.types.KeyMapItem "bpy.types.KeyMapItem")

        Return type:
        :   ([`KeyMap`](KeyMap.md#bpy.types.KeyMap "bpy.types.KeyMap"), [`KeyMapItem`](KeyMapItem.md#bpy.types.KeyMapItem "bpy.types.KeyMapItem"))

    update(*\**, *keep\_properties=False*)[¶](#bpy.types.KeyConfigurations.update "Link to this definition")
    :   update

        Parameters:
        :   **keep\_properties** (*boolean**,* *(**optional**)*) – Keep Properties, Operator properties are kept to allow the operators to be registered again in the future

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.KeyConfigurations.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.KeyConfigurations.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`WindowManager.keyconfigs`](WindowManager.md#bpy.types.WindowManager.keyconfigs "bpy.types.WindowManager.keyconfigs") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.KeyConfigurations.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.KeyConfigurations.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* KeyConfigurations(bpy\_struct)
  + [`KeyConfigurations`](#bpy.types.KeyConfigurations)
    - [`KeyConfigurations.active`](#bpy.types.KeyConfigurations.active)
    - [`KeyConfigurations.addon`](#bpy.types.KeyConfigurations.addon)
    - [`KeyConfigurations.default`](#bpy.types.KeyConfigurations.default)
    - [`KeyConfigurations.user`](#bpy.types.KeyConfigurations.user)
    - [`KeyConfigurations.new()`](#bpy.types.KeyConfigurations.new)
    - [`KeyConfigurations.remove()`](#bpy.types.KeyConfigurations.remove)
    - [`KeyConfigurations.find_item_from_operator()`](#bpy.types.KeyConfigurations.find_item_from_operator)
    - [`KeyConfigurations.update()`](#bpy.types.KeyConfigurations.update)
    - [`KeyConfigurations.bl_rna_get_subclass()`](#bpy.types.KeyConfigurations.bl_rna_get_subclass)
    - [`KeyConfigurations.bl_rna_get_subclass_py()`](#bpy.types.KeyConfigurations.bl_rna_get_subclass_py)
