...
# BoolProperty(Property)[¶](#boolproperty-property "Link to this heading")
...
*class* bpy.types.BoolProperty(*Property*)[¶](#bpy.types.BoolProperty "Link to this definition")
:   RNA boolean property definition

    array\_dimensions[¶](#bpy.types.BoolProperty.array_dimensions "Link to this definition")
    :   Length of each dimension of the array

        Type:
        :   int array of 3 items in [0, inf], [default](#bpy.types.BoolProperty.default "bpy.types.BoolProperty.default") (0, 0, 0), (readonly)

    array\_length[¶](#bpy.types.BoolProperty.array_length "Link to this definition")
    :   Maximum length of the array, 0 means unlimited

        Type:
        :   int in [0, inf], default 0, (readonly)

    default[¶](#bpy.types.BoolProperty.default "Link to this definition")
    :   Default value for this number

        Type:
        :   boolean, default False, (readonly)

    default\_array[¶](#bpy.types.BoolProperty.default_array "Link to this definition")
    :   Default value for this array

        Type:
        :   boolean array of 3 items, [default](#bpy.types.BoolProperty.default "bpy.types.BoolProperty.default") (False, False, False), (readonly)

    is\_array[¶](#bpy.types.BoolProperty.is_array "Link to this definition")
    :   Type:
        :   boolean, default False, (readonly)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.BoolProperty.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.BoolProperty.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.BoolProperty.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.BoolProperty.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* BoolProperty(Property)
  + [`BoolProperty`](#bpy.types.BoolProperty)
    - [`BoolProperty.array_dimensions`](#bpy.types.BoolProperty.array_dimensions)
    - [`BoolProperty.array_length`](#bpy.types.BoolProperty.array_length)
    - [`BoolProperty.default`](#bpy.types.BoolProperty.default)
    - [`BoolProperty.default_array`](#bpy.types.BoolProperty.default_array)
    - [`BoolProperty.is_array`](#bpy.types.BoolProperty.is_array)
    - [`BoolProperty.bl_rna_get_subclass()`](#bpy.types.BoolProperty.bl_rna_get_subclass)
    - [`BoolProperty.bl_rna_get_subclass_py()`](#bpy.types.BoolProperty.bl_rna_get_subclass_py)
