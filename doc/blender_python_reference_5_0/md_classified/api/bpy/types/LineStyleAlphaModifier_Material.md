...
# LineStyleAlphaModifier\_Material(LineStyleAlphaModifier)[¶](#linestylealphamodifier-material-linestylealphamodifier "Link to this heading")
...
*class* bpy.types.LineStyleAlphaModifier\_Material(*LineStyleAlphaModifier*)[¶](#bpy.types.LineStyleAlphaModifier_Material "Link to this definition")
:   Change alpha transparency based on a material attribute

    blend[¶](#bpy.types.LineStyleAlphaModifier_Material.blend "Link to this definition")
    :   Specify how the modifier value is blended into the base value

        Type:
        :   enum in [`'MIX'`, `'ADD'`, `'SUBTRACT'`, `'MULTIPLY'`, `'DIVIDE'`, `'DIFFERENCE'`, `'MINIMUM'`, `'MAXIMUM'`], default `'MIX'`

    curve[¶](#bpy.types.LineStyleAlphaModifier_Material.curve "Link to this definition")
    :   Curve used for the curve mapping

        Type:
        :   [`CurveMapping`](CurveMapping.md#bpy.types.CurveMapping "bpy.types.CurveMapping"), (readonly)

    expanded[¶](#bpy.types.LineStyleAlphaModifier_Material.expanded "Link to this definition")
    :   True if the modifier tab is expanded

        Type:
        :   boolean, default False

    influence[¶](#bpy.types.LineStyleAlphaModifier_Material.influence "Link to this definition")
    :   Influence factor by which the modifier changes the property

        Type:
        :   float in [0, 1], default 0.0

    invert[¶](#bpy.types.LineStyleAlphaModifier_Material.invert "Link to this definition")
    :   Invert the fade-out direction of the linear mapping

        Type:
        :   boolean, default False

    mapping[¶](#bpy.types.LineStyleAlphaModifier_Material.mapping "Link to this definition")
    ...
    material\_attribute[¶](#bpy.types.LineStyleAlphaModifier_Material.material_attribute "Link to this definition")
    ...
    type[¶](#bpy.types.LineStyleAlphaModifier_Material.type "Link to this definition")
    ...
    use[¶](#bpy.types.LineStyleAlphaModifier_Material.use "Link to this definition")
    :   Enable or disable this modifier during stroke rendering

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.LineStyleAlphaModifier_Material.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.LineStyleAlphaModifier_Material.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.LineStyleAlphaModifier_Material.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.LineStyleAlphaModifier_Material.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* LineStyleAlphaModifier\_Material(LineStyleAlphaModifier)
  + [`LineStyleAlphaModifier_Material`](#bpy.types.LineStyleAlphaModifier_Material)
    - [`LineStyleAlphaModifier_Material.blend`](#bpy.types.LineStyleAlphaModifier_Material.blend)
    - [`LineStyleAlphaModifier_Material.curve`](#bpy.types.LineStyleAlphaModifier_Material.curve)
    - [`LineStyleAlphaModifier_Material.expanded`](#bpy.types.LineStyleAlphaModifier_Material.expanded)
    - [`LineStyleAlphaModifier_Material.influence`](#bpy.types.LineStyleAlphaModifier_Material.influence)
    - [`LineStyleAlphaModifier_Material.invert`](#bpy.types.LineStyleAlphaModifier_Material.invert)
    - [`LineStyleAlphaModifier_Material.mapping`](#bpy.types.LineStyleAlphaModifier_Material.mapping)
    - [`LineStyleAlphaModifier_Material.material_attribute`](#bpy.types.LineStyleAlphaModifier_Material.material_attribute)
    - [`LineStyleAlphaModifier_Material.type`](#bpy.types.LineStyleAlphaModifier_Material.type)
    - [`LineStyleAlphaModifier_Material.use`](#bpy.types.LineStyleAlphaModifier_Material.use)
    - [`LineStyleAlphaModifier_Material.bl_rna_get_subclass()`](#bpy.types.LineStyleAlphaModifier_Material.bl_rna_get_subclass)
    - [`LineStyleAlphaModifier_Material.bl_rna_get_subclass_py()`](#bpy.types.LineStyleAlphaModifier_Material.bl_rna_get_subclass_py)
