...
# NodeGeometryCaptureAttributeItem(bpy\_struct)[¶](#nodegeometrycaptureattributeitem-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.NodeGeometryCaptureAttributeItem(*bpy\_struct*)[¶](#bpy.types.NodeGeometryCaptureAttributeItem "Link to this definition")
:   color[¶](#bpy.types.NodeGeometryCaptureAttributeItem.color "Link to this definition")
    ...
    data\_type[¶](#bpy.types.NodeGeometryCaptureAttributeItem.data_type "Link to this definition")
    :   Type:
    ...
    name[¶](#bpy.types.NodeGeometryCaptureAttributeItem.name "Link to this definition")
    :   Type:
        :   string, default “”, (never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.NodeGeometryCaptureAttributeItem.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.NodeGeometryCaptureAttributeItem.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`GeometryNodeCaptureAttribute.capture_items`](GeometryNodeCaptureAttribute.md#bpy.types.GeometryNodeCaptureAttribute.capture_items "bpy.types.GeometryNodeCaptureAttribute.capture_items") * [`NodeGeometryCaptureAttributeItems.new`](NodeGeometryCaptureAttributeItems.md#bpy.types.NodeGeometryCaptureAttributeItems.new "bpy.types.NodeGeometryCaptureAttributeItems.new") | * [`NodeGeometryCaptureAttributeItems.remove`](NodeGeometryCaptureAttributeItems.md#bpy.types.NodeGeometryCaptureAttributeItems.remove "bpy.types.NodeGeometryCaptureAttributeItems.remove") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.NodeGeometryCaptureAttributeItem.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.NodeGeometryCaptureAttributeItem.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* NodeGeometryCaptureAttributeItem(bpy\_struct)
  + [`NodeGeometryCaptureAttributeItem`](#bpy.types.NodeGeometryCaptureAttributeItem)
    - [`NodeGeometryCaptureAttributeItem.color`](#bpy.types.NodeGeometryCaptureAttributeItem.color)
    - [`NodeGeometryCaptureAttributeItem.data_type`](#bpy.types.NodeGeometryCaptureAttributeItem.data_type)
    - [`NodeGeometryCaptureAttributeItem.name`](#bpy.types.NodeGeometryCaptureAttributeItem.name)
    - [`NodeGeometryCaptureAttributeItem.bl_rna_get_subclass()`](#bpy.types.NodeGeometryCaptureAttributeItem.bl_rna_get_subclass)
    - [`NodeGeometryCaptureAttributeItem.bl_rna_get_subclass_py()`](#bpy.types.NodeGeometryCaptureAttributeItem.bl_rna_get_subclass_py)
