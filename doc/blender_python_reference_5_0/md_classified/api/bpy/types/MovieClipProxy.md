...
# MovieClipProxy(bpy\_struct)[¶](#movieclipproxy-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.MovieClipProxy(*bpy\_struct*)[¶](#bpy.types.MovieClipProxy "Link to this definition")
:   Proxy parameters for a movie clip

    build\_100[¶](#bpy.types.MovieClipProxy.build_100 "Link to this definition")
    :   Build proxy resolution 100% of the original footage dimension

        Type:
        :   boolean, default False

    build\_25[¶](#bpy.types.MovieClipProxy.build_25 "Link to this definition")
    :   Build proxy resolution 25% of the original footage dimension

        Type:
        :   boolean, default False

    build\_50[¶](#bpy.types.MovieClipProxy.build_50 "Link to this definition")
    :   Build proxy resolution 50% of the original footage dimension

        Type:
        :   boolean, default False

    build\_75[¶](#bpy.types.MovieClipProxy.build_75 "Link to this definition")
    :   Build proxy resolution 75% of the original footage dimension

        Type:
        :   boolean, default False

    build\_record\_run[¶](#bpy.types.MovieClipProxy.build_record_run "Link to this definition")
    :   Build record run time code index

        Type:
        :   boolean, default False

    build\_undistorted\_100[¶](#bpy.types.MovieClipProxy.build_undistorted_100 "Link to this definition")
    :   Build proxy resolution 100% of the original undistorted footage dimension

        Type:
        :   boolean, default False

    build\_undistorted\_25[¶](#bpy.types.MovieClipProxy.build_undistorted_25 "Link to this definition")
    :   Build proxy resolution 25% of the original undistorted footage dimension

        Type:
        :   boolean, default False

    build\_undistorted\_50[¶](#bpy.types.MovieClipProxy.build_undistorted_50 "Link to this definition")
    :   Build proxy resolution 50% of the original undistorted footage dimension

        Type:
        :   boolean, default False

    build\_undistorted\_75[¶](#bpy.types.MovieClipProxy.build_undistorted_75 "Link to this definition")
    :   Build proxy resolution 75% of the original undistorted footage dimension

        Type:
        :   boolean, default False

    directory[¶](#bpy.types.MovieClipProxy.directory "Link to this definition")
    :   Location to store the proxy files

        Type:
        :   string, default “”, (never None, blend relative `//` prefix supported)

    quality[¶](#bpy.types.MovieClipProxy.quality "Link to this definition")
    :   JPEG quality of proxy images

        Type:
        :   int in [0, 32767], default 0

    timecode[¶](#bpy.types.MovieClipProxy.timecode "Link to this definition")
    :   * `NONE`
        ...
        * `FREE_RUN_NO_GAPS`
        ...
        Type:
        :   enum in [`'NONE'`, `'RECORD_RUN'`, `'FREE_RUN_NO_GAPS'`], default `'NONE'`

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.MovieClipProxy.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.MovieClipProxy.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`MovieClip.proxy`](MovieClip.md#bpy.types.MovieClip.proxy "bpy.types.MovieClip.proxy") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.MovieClipProxy.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.MovieClipProxy.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* MovieClipProxy(bpy\_struct)
  + [`MovieClipProxy`](#bpy.types.MovieClipProxy)
    - [`MovieClipProxy.build_100`](#bpy.types.MovieClipProxy.build_100)
    - [`MovieClipProxy.build_25`](#bpy.types.MovieClipProxy.build_25)
    - [`MovieClipProxy.build_50`](#bpy.types.MovieClipProxy.build_50)
    - [`MovieClipProxy.build_75`](#bpy.types.MovieClipProxy.build_75)
    - [`MovieClipProxy.build_record_run`](#bpy.types.MovieClipProxy.build_record_run)
    - [`MovieClipProxy.build_undistorted_100`](#bpy.types.MovieClipProxy.build_undistorted_100)
    - [`MovieClipProxy.build_undistorted_25`](#bpy.types.MovieClipProxy.build_undistorted_25)
    - [`MovieClipProxy.build_undistorted_50`](#bpy.types.MovieClipProxy.build_undistorted_50)
    - [`MovieClipProxy.build_undistorted_75`](#bpy.types.MovieClipProxy.build_undistorted_75)
    - [`MovieClipProxy.directory`](#bpy.types.MovieClipProxy.directory)
    - [`MovieClipProxy.quality`](#bpy.types.MovieClipProxy.quality)
    - [`MovieClipProxy.timecode`](#bpy.types.MovieClipProxy.timecode)
    - [`MovieClipProxy.bl_rna_get_subclass()`](#bpy.types.MovieClipProxy.bl_rna_get_subclass)
    - [`MovieClipProxy.bl_rna_get_subclass_py()`](#bpy.types.MovieClipProxy.bl_rna_get_subclass_py)
