...
# LimitScaleConstraint(Constraint)[¶](#limitscaleconstraint-constraint "Link to this heading")
...
*class* bpy.types.LimitScaleConstraint(*Constraint*)[¶](#bpy.types.LimitScaleConstraint "Link to this definition")
:   Limit the scaling of the constrained object

    max\_x[¶](#bpy.types.LimitScaleConstraint.max_x "Link to this definition")
    :   Highest X value to allow

        Type:
        :   float in [-1000, 1000], default 0.0

    max\_y[¶](#bpy.types.LimitScaleConstraint.max_y "Link to this definition")
    :   Highest Y value to allow

        Type:
        :   float in [-1000, 1000], default 0.0

    max\_z[¶](#bpy.types.LimitScaleConstraint.max_z "Link to this definition")
    :   Highest Z value to allow

        Type:
        :   float in [-1000, 1000], default 0.0

    min\_x[¶](#bpy.types.LimitScaleConstraint.min_x "Link to this definition")
    :   Lowest X value to allow

        Type:
        :   float in [-1000, 1000], default 0.0

    min\_y[¶](#bpy.types.LimitScaleConstraint.min_y "Link to this definition")
    :   Lowest Y value to allow

        Type:
        :   float in [-1000, 1000], default 0.0

    min\_z[¶](#bpy.types.LimitScaleConstraint.min_z "Link to this definition")
    :   Lowest Z value to allow

        Type:
        :   float in [-1000, 1000], default 0.0

    use\_max\_x[¶](#bpy.types.LimitScaleConstraint.use_max_x "Link to this definition")
    :   Use the maximum X value

        Type:
        :   boolean, default False

    use\_max\_y[¶](#bpy.types.LimitScaleConstraint.use_max_y "Link to this definition")
    :   Use the maximum Y value

        Type:
        :   boolean, default False

    use\_max\_z[¶](#bpy.types.LimitScaleConstraint.use_max_z "Link to this definition")
    :   Use the maximum Z value

        Type:
        :   boolean, default False

    use\_min\_x[¶](#bpy.types.LimitScaleConstraint.use_min_x "Link to this definition")
    :   Use the minimum X value

        Type:
        :   boolean, default False

    use\_min\_y[¶](#bpy.types.LimitScaleConstraint.use_min_y "Link to this definition")
    :   Use the minimum Y value

        Type:
        :   boolean, default False

    use\_min\_z[¶](#bpy.types.LimitScaleConstraint.use_min_z "Link to this definition")
    :   Use the minimum Z value

        Type:
        :   boolean, default False

    use\_transform\_limit[¶](#bpy.types.LimitScaleConstraint.use_transform_limit "Link to this definition")
    :   Transform tools are affected by this constraint as well

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.LimitScaleConstraint.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.LimitScaleConstraint.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.LimitScaleConstraint.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.LimitScaleConstraint.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* LimitScaleConstraint(Constraint)
  + [`LimitScaleConstraint`](#bpy.types.LimitScaleConstraint)
    - [`LimitScaleConstraint.max_x`](#bpy.types.LimitScaleConstraint.max_x)
    - [`LimitScaleConstraint.max_y`](#bpy.types.LimitScaleConstraint.max_y)
    - [`LimitScaleConstraint.max_z`](#bpy.types.LimitScaleConstraint.max_z)
    - [`LimitScaleConstraint.min_x`](#bpy.types.LimitScaleConstraint.min_x)
    - [`LimitScaleConstraint.min_y`](#bpy.types.LimitScaleConstraint.min_y)
    - [`LimitScaleConstraint.min_z`](#bpy.types.LimitScaleConstraint.min_z)
    - [`LimitScaleConstraint.use_max_x`](#bpy.types.LimitScaleConstraint.use_max_x)
    - [`LimitScaleConstraint.use_max_y`](#bpy.types.LimitScaleConstraint.use_max_y)
    - [`LimitScaleConstraint.use_max_z`](#bpy.types.LimitScaleConstraint.use_max_z)
    - [`LimitScaleConstraint.use_min_x`](#bpy.types.LimitScaleConstraint.use_min_x)
    - [`LimitScaleConstraint.use_min_y`](#bpy.types.LimitScaleConstraint.use_min_y)
    - [`LimitScaleConstraint.use_min_z`](#bpy.types.LimitScaleConstraint.use_min_z)
    - [`LimitScaleConstraint.use_transform_limit`](#bpy.types.LimitScaleConstraint.use_transform_limit)
    - [`LimitScaleConstraint.bl_rna_get_subclass()`](#bpy.types.LimitScaleConstraint.bl_rna_get_subclass)
    - [`LimitScaleConstraint.bl_rna_get_subclass_py()`](#bpy.types.LimitScaleConstraint.bl_rna_get_subclass_py)
