...
# NodeClosureOutputItem(bpy\_struct)[¶](#nodeclosureoutputitem-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.NodeClosureOutputItem(*bpy\_struct*)[¶](#bpy.types.NodeClosureOutputItem "Link to this definition")
:   color[¶](#bpy.types.NodeClosureOutputItem.color "Link to this definition")
    ...
    name[¶](#bpy.types.NodeClosureOutputItem.name "Link to this definition")
    :   Type:
        :   string, default “”, (never None)

    socket\_type[¶](#bpy.types.NodeClosureOutputItem.socket_type "Link to this definition")
    :   Type:
    ...
    structure\_type[¶](#bpy.types.NodeClosureOutputItem.structure_type "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.NodeClosureOutputItem.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.NodeClosureOutputItem.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`NodeClosureOutput.output_items`](NodeClosureOutput.md#bpy.types.NodeClosureOutput.output_items "bpy.types.NodeClosureOutput.output_items") * [`NodeClosureOutputItems.new`](NodeClosureOutputItems.md#bpy.types.NodeClosureOutputItems.new "bpy.types.NodeClosureOutputItems.new") | * [`NodeClosureOutputItems.remove`](NodeClosureOutputItems.md#bpy.types.NodeClosureOutputItems.remove "bpy.types.NodeClosureOutputItems.remove") |

[Next

NodeClosureOutputItems(bpy\_struct)](NodeClosureOutputItems.md)
[Previous

NodeClosureOutput(NodeInternal)](NodeClosureOutput.md)
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.NodeClosureOutputItem.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.NodeClosureOutputItem.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* NodeClosureOutputItem(bpy\_struct)
  + [`NodeClosureOutputItem`](#bpy.types.NodeClosureOutputItem)
    - [`NodeClosureOutputItem.color`](#bpy.types.NodeClosureOutputItem.color)
    - [`NodeClosureOutputItem.name`](#bpy.types.NodeClosureOutputItem.name)
    - [`NodeClosureOutputItem.socket_type`](#bpy.types.NodeClosureOutputItem.socket_type)
    - [`NodeClosureOutputItem.structure_type`](#bpy.types.NodeClosureOutputItem.structure_type)
    - [`NodeClosureOutputItem.bl_rna_get_subclass()`](#bpy.types.NodeClosureOutputItem.bl_rna_get_subclass)
    - [`NodeClosureOutputItem.bl_rna_get_subclass_py()`](#bpy.types.NodeClosureOutputItem.bl_rna_get_subclass_py)
