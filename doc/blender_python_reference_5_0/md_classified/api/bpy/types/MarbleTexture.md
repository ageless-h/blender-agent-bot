...
# MarbleTexture(Texture)[¶](#marbletexture-texture "Link to this heading")
...
*class* bpy.types.MarbleTexture(*Texture*)[¶](#bpy.types.MarbleTexture "Link to this definition")
:   Procedural noise texture

    marble\_type[¶](#bpy.types.MarbleTexture.marble_type "Link to this definition")
    :   * `SOFT`
    ...
    nabla[¶](#bpy.types.MarbleTexture.nabla "Link to this definition")
    :   Size of derivative offset used for calculating normal

        Type:
        :   float in [0.001, 0.1], default 0.025

    noise\_basis[¶](#bpy.types.MarbleTexture.noise_basis "Link to this definition")
    ...
    noise\_basis\_2[¶](#bpy.types.MarbleTexture.noise_basis_2 "Link to this definition")
    :   * `SIN`
    ...
    noise\_depth[¶](#bpy.types.MarbleTexture.noise_depth "Link to this definition")
    :   Depth of the cloud calculation

        Type:
        :   int in [0, 30], default 2

    noise\_scale[¶](#bpy.types.MarbleTexture.noise_scale "Link to this definition")
    :   Scaling for noise input

        Type:
        :   float in [0.0001, inf], default 0.25

    noise\_type[¶](#bpy.types.MarbleTexture.noise_type "Link to this definition")
    :   * `SOFT_NOISE`
    ...
    turbulence[¶](#bpy.types.MarbleTexture.turbulence "Link to this definition")
    :   Turbulence of the bandnoise and ringnoise types

        Type:
        :   float in [0.0001, inf], default 5.0

    users\_material[¶](#bpy.types.MarbleTexture.users_material "Link to this definition")
    ...
    users\_object\_modifier[¶](#bpy.types.MarbleTexture.users_object_modifier "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.MarbleTexture.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.MarbleTexture.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.MarbleTexture.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.MarbleTexture.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* MarbleTexture(Texture)
  + [`MarbleTexture`](#bpy.types.MarbleTexture)
    - [`MarbleTexture.marble_type`](#bpy.types.MarbleTexture.marble_type)
    - [`MarbleTexture.nabla`](#bpy.types.MarbleTexture.nabla)
    - [`MarbleTexture.noise_basis`](#bpy.types.MarbleTexture.noise_basis)
    - [`MarbleTexture.noise_basis_2`](#bpy.types.MarbleTexture.noise_basis_2)
    - [`MarbleTexture.noise_depth`](#bpy.types.MarbleTexture.noise_depth)
    - [`MarbleTexture.noise_scale`](#bpy.types.MarbleTexture.noise_scale)
    - [`MarbleTexture.noise_type`](#bpy.types.MarbleTexture.noise_type)
    - [`MarbleTexture.turbulence`](#bpy.types.MarbleTexture.turbulence)
    - [`MarbleTexture.users_material`](#bpy.types.MarbleTexture.users_material)
    - [`MarbleTexture.users_object_modifier`](#bpy.types.MarbleTexture.users_object_modifier)
    - [`MarbleTexture.bl_rna_get_subclass()`](#bpy.types.MarbleTexture.bl_rna_get_subclass)
    - [`MarbleTexture.bl_rna_get_subclass_py()`](#bpy.types.MarbleTexture.bl_rna_get_subclass_py)
