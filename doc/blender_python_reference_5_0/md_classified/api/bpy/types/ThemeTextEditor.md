...
# ThemeTextEditor(bpy\_struct)[¶](#themetexteditor-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.ThemeTextEditor(*bpy\_struct*)[¶](#bpy.types.ThemeTextEditor "Link to this definition")
:   Theme settings for the Text Editor

    cursor[¶](#bpy.types.ThemeTextEditor.cursor "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    line\_numbers[¶](#bpy.types.ThemeTextEditor.line_numbers "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    line\_numbers\_background[¶](#bpy.types.ThemeTextEditor.line_numbers_background "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    selected\_text[¶](#bpy.types.ThemeTextEditor.selected_text "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    space[¶](#bpy.types.ThemeTextEditor.space "Link to this definition")
    :   Settings for space

        Type:
        :   [`ThemeSpaceGeneric`](ThemeSpaceGeneric.md#bpy.types.ThemeSpaceGeneric "bpy.types.ThemeSpaceGeneric"), (readonly, never None)

    syntax\_builtin[¶](#bpy.types.ThemeTextEditor.syntax_builtin "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    syntax\_comment[¶](#bpy.types.ThemeTextEditor.syntax_comment "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    syntax\_numbers[¶](#bpy.types.ThemeTextEditor.syntax_numbers "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    syntax\_preprocessor[¶](#bpy.types.ThemeTextEditor.syntax_preprocessor "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    syntax\_reserved[¶](#bpy.types.ThemeTextEditor.syntax_reserved "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    syntax\_special[¶](#bpy.types.ThemeTextEditor.syntax_special "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    syntax\_string[¶](#bpy.types.ThemeTextEditor.syntax_string "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    syntax\_symbols[¶](#bpy.types.ThemeTextEditor.syntax_symbols "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ThemeTextEditor.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ThemeTextEditor.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Theme.text_editor`](Theme.md#bpy.types.Theme.text_editor "bpy.types.Theme.text_editor") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ThemeTextEditor.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ThemeTextEditor.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ThemeTextEditor(bpy\_struct)
  + [`ThemeTextEditor`](#bpy.types.ThemeTextEditor)
    - [`ThemeTextEditor.cursor`](#bpy.types.ThemeTextEditor.cursor)
    - [`ThemeTextEditor.line_numbers`](#bpy.types.ThemeTextEditor.line_numbers)
    - [`ThemeTextEditor.line_numbers_background`](#bpy.types.ThemeTextEditor.line_numbers_background)
    - [`ThemeTextEditor.selected_text`](#bpy.types.ThemeTextEditor.selected_text)
    - [`ThemeTextEditor.space`](#bpy.types.ThemeTextEditor.space)
    - [`ThemeTextEditor.syntax_builtin`](#bpy.types.ThemeTextEditor.syntax_builtin)
    - [`ThemeTextEditor.syntax_comment`](#bpy.types.ThemeTextEditor.syntax_comment)
    - [`ThemeTextEditor.syntax_numbers`](#bpy.types.ThemeTextEditor.syntax_numbers)
    - [`ThemeTextEditor.syntax_preprocessor`](#bpy.types.ThemeTextEditor.syntax_preprocessor)
    - [`ThemeTextEditor.syntax_reserved`](#bpy.types.ThemeTextEditor.syntax_reserved)
    - [`ThemeTextEditor.syntax_special`](#bpy.types.ThemeTextEditor.syntax_special)
    - [`ThemeTextEditor.syntax_string`](#bpy.types.ThemeTextEditor.syntax_string)
    - [`ThemeTextEditor.syntax_symbols`](#bpy.types.ThemeTextEditor.syntax_symbols)
    - [`ThemeTextEditor.bl_rna_get_subclass()`](#bpy.types.ThemeTextEditor.bl_rna_get_subclass)
    - [`ThemeTextEditor.bl_rna_get_subclass_py()`](#bpy.types.ThemeTextEditor.bl_rna_get_subclass_py)
