...
# BlendDataNodeTrees(bpy\_struct)[¶](#blenddatanodetrees-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.BlendDataNodeTrees(*bpy\_struct*)[¶](#bpy.types.BlendDataNodeTrees "Link to this definition")
:   Collection of node trees

    new(*name*, *type*)[¶](#bpy.types.BlendDataNodeTrees.new "Link to this definition")
    :   Add a new node tree to the main database
        ...
        :   * **name** (*string**,* *(**never None**)*) – New name for the data-block
            * **type** (enum in [`'GeometryNodeTree'`, `'CompositorNodeTree'`, `'ShaderNodeTree'`, `'TextureNodeTree'`]) –
              ...
              Type, The type of node\_group to add
    ...
    remove(*tree*, *\**, *do\_unlink=True*, *do\_id\_user=True*, *do\_ui\_user=True*)[¶](#bpy.types.BlendDataNodeTrees.remove "Link to this definition")
    :   Remove a node tree from the current blendfile

        Parameters:
        :   * **tree** ([`NodeTree`](NodeTree.md#bpy.types.NodeTree "bpy.types.NodeTree"), (never None)) – Node tree to remove
            * **do\_unlink** (*boolean**,* *(**optional**)*) – Unlink all usages of this node tree before deleting it
            * **do\_id\_user** (*boolean**,* *(**optional**)*) – Decrement user counter of all data-blocks used by this node tree
            * **do\_ui\_user** (*boolean**,* *(**optional**)*) – Make sure interface does not reference this node tree

    tag(*value*)[¶](#bpy.types.BlendDataNodeTrees.tag "Link to this definition")
    :   tag

        Parameters:
        :   **value** (*boolean*) – Value

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.BlendDataNodeTrees.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.BlendDataNodeTrees.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`BlendData.node_groups`](BlendData.md#bpy.types.BlendData.node_groups "bpy.types.BlendData.node_groups") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.BlendDataNodeTrees.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.BlendDataNodeTrees.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* BlendDataNodeTrees(bpy\_struct)
  + [`BlendDataNodeTrees`](#bpy.types.BlendDataNodeTrees)
    - [`BlendDataNodeTrees.new()`](#bpy.types.BlendDataNodeTrees.new)
    - [`BlendDataNodeTrees.remove()`](#bpy.types.BlendDataNodeTrees.remove)
    - [`BlendDataNodeTrees.tag()`](#bpy.types.BlendDataNodeTrees.tag)
    - [`BlendDataNodeTrees.bl_rna_get_subclass()`](#bpy.types.BlendDataNodeTrees.bl_rna_get_subclass)
    - [`BlendDataNodeTrees.bl_rna_get_subclass_py()`](#bpy.types.BlendDataNodeTrees.bl_rna_get_subclass_py)
