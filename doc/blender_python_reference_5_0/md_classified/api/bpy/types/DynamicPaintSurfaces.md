...
# DynamicPaintSurfaces(bpy\_struct)[¶](#dynamicpaintsurfaces-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.DynamicPaintSurfaces(*bpy\_struct*)[¶](#bpy.types.DynamicPaintSurfaces "Link to this definition")
:   Collection of Dynamic Paint Canvas surfaces

    active[¶](#bpy.types.DynamicPaintSurfaces.active "Link to this definition")
    :   Active Dynamic Paint surface being displayed

        Type:
        :   [`DynamicPaintSurface`](DynamicPaintSurface.md#bpy.types.DynamicPaintSurface "bpy.types.DynamicPaintSurface"), (readonly)

    active\_index[¶](#bpy.types.DynamicPaintSurfaces.active_index "Link to this definition")
    :   Type:
        :   int in [0, inf], default 0

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.DynamicPaintSurfaces.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.DynamicPaintSurfaces.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`DynamicPaintCanvasSettings.canvas_surfaces`](DynamicPaintCanvasSettings.md#bpy.types.DynamicPaintCanvasSettings.canvas_surfaces "bpy.types.DynamicPaintCanvasSettings.canvas_surfaces") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.DynamicPaintSurfaces.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.DynamicPaintSurfaces.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* DynamicPaintSurfaces(bpy\_struct)
  + [`DynamicPaintSurfaces`](#bpy.types.DynamicPaintSurfaces)
    - [`DynamicPaintSurfaces.active`](#bpy.types.DynamicPaintSurfaces.active)
    - [`DynamicPaintSurfaces.active_index`](#bpy.types.DynamicPaintSurfaces.active_index)
    - [`DynamicPaintSurfaces.bl_rna_get_subclass()`](#bpy.types.DynamicPaintSurfaces.bl_rna_get_subclass)
    - [`DynamicPaintSurfaces.bl_rna_get_subclass_py()`](#bpy.types.DynamicPaintSurfaces.bl_rna_get_subclass_py)
