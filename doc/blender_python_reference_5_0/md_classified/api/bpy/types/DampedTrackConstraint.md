...
# DampedTrackConstraint(Constraint)[¶](#dampedtrackconstraint-constraint "Link to this heading")
...
*class* bpy.types.DampedTrackConstraint(*Constraint*)[¶](#bpy.types.DampedTrackConstraint "Link to this definition")
:   Point toward target by taking the shortest rotation path

    head\_tail[¶](#bpy.types.DampedTrackConstraint.head_tail "Link to this definition")
    :   Target along length of bone: Head is 0, Tail is 1

        Type:
        :   float in [0, 1], default 0.0

    subtarget[¶](#bpy.types.DampedTrackConstraint.subtarget "Link to this definition")
    :   Armature bone, mesh or lattice vertex group, …

        Type:
        :   string, default “”, (never None)

    target[¶](#bpy.types.DampedTrackConstraint.target "Link to this definition")
    :   Target object

        Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object")

    track\_axis[¶](#bpy.types.DampedTrackConstraint.track_axis "Link to this definition")
    ...
    use\_bbone\_shape[¶](#bpy.types.DampedTrackConstraint.use_bbone_shape "Link to this definition")
    :   Follow shape of B-Bone segments when calculating Head/Tail position

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.DampedTrackConstraint.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.DampedTrackConstraint.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.DampedTrackConstraint.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.DampedTrackConstraint.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* DampedTrackConstraint(Constraint)
  + [`DampedTrackConstraint`](#bpy.types.DampedTrackConstraint)
    - [`DampedTrackConstraint.head_tail`](#bpy.types.DampedTrackConstraint.head_tail)
    - [`DampedTrackConstraint.subtarget`](#bpy.types.DampedTrackConstraint.subtarget)
    - [`DampedTrackConstraint.target`](#bpy.types.DampedTrackConstraint.target)
    - [`DampedTrackConstraint.track_axis`](#bpy.types.DampedTrackConstraint.track_axis)
    - [`DampedTrackConstraint.use_bbone_shape`](#bpy.types.DampedTrackConstraint.use_bbone_shape)
    - [`DampedTrackConstraint.bl_rna_get_subclass()`](#bpy.types.DampedTrackConstraint.bl_rna_get_subclass)
    - [`DampedTrackConstraint.bl_rna_get_subclass_py()`](#bpy.types.DampedTrackConstraint.bl_rna_get_subclass_py)
