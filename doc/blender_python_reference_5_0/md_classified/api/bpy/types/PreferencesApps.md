...
# PreferencesApps(bpy\_struct)[¶](#preferencesapps-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.PreferencesApps(*bpy\_struct*)[¶](#bpy.types.PreferencesApps "Link to this definition")
:   Preferences that work only for apps

    show\_corner\_split[¶](#bpy.types.PreferencesApps.show_corner_split "Link to this definition")
    :   Split and join editors by dragging from corners

        Type:
        :   boolean, default True

    show\_edge\_resize[¶](#bpy.types.PreferencesApps.show_edge_resize "Link to this definition")
    :   Resize editors by dragging from the edges

        Type:
        :   boolean, default True

    show\_regions\_visibility\_toggle[¶](#bpy.types.PreferencesApps.show_regions_visibility_toggle "Link to this definition")
    :   Header and side bars visibility toggles

        Type:
        :   boolean, default True

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.PreferencesApps.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.PreferencesApps.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Preferences.apps`](Preferences.md#bpy.types.Preferences.apps "bpy.types.Preferences.apps") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.PreferencesApps.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.PreferencesApps.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* PreferencesApps(bpy\_struct)
  + [`PreferencesApps`](#bpy.types.PreferencesApps)
    - [`PreferencesApps.show_corner_split`](#bpy.types.PreferencesApps.show_corner_split)
    - [`PreferencesApps.show_edge_resize`](#bpy.types.PreferencesApps.show_edge_resize)
    - [`PreferencesApps.show_regions_visibility_toggle`](#bpy.types.PreferencesApps.show_regions_visibility_toggle)
    - [`PreferencesApps.bl_rna_get_subclass()`](#bpy.types.PreferencesApps.bl_rna_get_subclass)
    - [`PreferencesApps.bl_rna_get_subclass_py()`](#bpy.types.PreferencesApps.bl_rna_get_subclass_py)
