...
# Stereo3dFormat(bpy\_struct)[¶](#stereo3dformat-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.Stereo3dFormat(*bpy\_struct*)[¶](#bpy.types.Stereo3dFormat "Link to this definition")
:   Settings for stereo output

    anaglyph\_type[¶](#bpy.types.Stereo3dFormat.anaglyph_type "Link to this definition")
    :   Type:
        :   enum in [Stereo3D Anaglyph Type Items](../../../appendix/bpy_types_enum_items/stereo3d_anaglyph_type_items.md#rna-enum-stereo3d-anaglyph-type-items), default `'RED_CYAN'`

    display\_mode[¶](#bpy.types.Stereo3dFormat.display_mode "Link to this definition")
    :   * `ANAGLYPH`
    ...
    interlace\_type[¶](#bpy.types.Stereo3dFormat.interlace_type "Link to this definition")
    :   Type:
        :   enum in [Stereo3D Interlace Type Items](../../../appendix/bpy_types_enum_items/stereo3d_interlace_type_items.md#rna-enum-stereo3d-interlace-type-items), default `'ROW_INTERLEAVED'`

    use\_interlace\_swap[¶](#bpy.types.Stereo3dFormat.use_interlace_swap "Link to this definition")
    :   Swap left and right stereo channels

        Type:
        :   boolean, default False

    use\_sidebyside\_crosseyed[¶](#bpy.types.Stereo3dFormat.use_sidebyside_crosseyed "Link to this definition")
    :   Right eye should see left image and vice versa

        Type:
        :   boolean, default False

    use\_squeezed\_frame[¶](#bpy.types.Stereo3dFormat.use_squeezed_frame "Link to this definition")
    :   Combine both views in a squeezed image

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.Stereo3dFormat.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.Stereo3dFormat.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Image.stereo_3d_format`](Image.md#bpy.types.Image.stereo_3d_format "bpy.types.Image.stereo_3d_format") * [`ImageStrip.stereo_3d_format`](ImageStrip.md#bpy.types.ImageStrip.stereo_3d_format "bpy.types.ImageStrip.stereo_3d_format") * [`MovieStrip.stereo_3d_format`](MovieStrip.md#bpy.types.MovieStrip.stereo_3d_format "bpy.types.MovieStrip.stereo_3d_format") | * [`ImageFormatSettings.stereo_3d_format`](ImageFormatSettings.md#bpy.types.ImageFormatSettings.stereo_3d_format "bpy.types.ImageFormatSettings.stereo_3d_format") * [`UILayout.template_image_stereo_3d`](UILayout.md#bpy.types.UILayout.template_image_stereo_3d "bpy.types.UILayout.template_image_stereo_3d") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.Stereo3dFormat.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.Stereo3dFormat.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* Stereo3dFormat(bpy\_struct)
  + [`Stereo3dFormat`](#bpy.types.Stereo3dFormat)
    - [`Stereo3dFormat.anaglyph_type`](#bpy.types.Stereo3dFormat.anaglyph_type)
    - [`Stereo3dFormat.display_mode`](#bpy.types.Stereo3dFormat.display_mode)
    - [`Stereo3dFormat.interlace_type`](#bpy.types.Stereo3dFormat.interlace_type)
    - [`Stereo3dFormat.use_interlace_swap`](#bpy.types.Stereo3dFormat.use_interlace_swap)
    - [`Stereo3dFormat.use_sidebyside_crosseyed`](#bpy.types.Stereo3dFormat.use_sidebyside_crosseyed)
    - [`Stereo3dFormat.use_squeezed_frame`](#bpy.types.Stereo3dFormat.use_squeezed_frame)
    - [`Stereo3dFormat.bl_rna_get_subclass()`](#bpy.types.Stereo3dFormat.bl_rna_get_subclass)
    - [`Stereo3dFormat.bl_rna_get_subclass_py()`](#bpy.types.Stereo3dFormat.bl_rna_get_subclass_py)
