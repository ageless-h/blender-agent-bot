...
# TrackToConstraint(Constraint)[¶](#tracktoconstraint-constraint "Link to this heading")
...
*class* bpy.types.TrackToConstraint(*Constraint*)[¶](#bpy.types.TrackToConstraint "Link to this definition")
:   Aim the constrained object toward the target

    head\_tail[¶](#bpy.types.TrackToConstraint.head_tail "Link to this definition")
    :   Target along length of bone: Head is 0, Tail is 1

        Type:
        :   float in [0, 1], default 0.0

    subtarget[¶](#bpy.types.TrackToConstraint.subtarget "Link to this definition")
    :   Armature bone, mesh or lattice vertex group, …

        Type:
        :   string, default “”, (never None)

    target[¶](#bpy.types.TrackToConstraint.target "Link to this definition")
    :   Target object

        Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object")

    track\_axis[¶](#bpy.types.TrackToConstraint.track_axis "Link to this definition")
    ...
    up\_axis[¶](#bpy.types.TrackToConstraint.up_axis "Link to this definition")
    :   Axis that points upward

        Type:
        :   enum in [`'UP_X'`, `'UP_Y'`, `'UP_Z'`], default `'UP_X'`

    use\_bbone\_shape[¶](#bpy.types.TrackToConstraint.use_bbone_shape "Link to this definition")
    :   Follow shape of B-Bone segments when calculating Head/Tail position

        Type:
        :   boolean, default False

    use\_target\_z[¶](#bpy.types.TrackToConstraint.use_target_z "Link to this definition")
    :   Target’s Z axis, not World Z axis, will constrain the Up direction

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.TrackToConstraint.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.TrackToConstraint.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.TrackToConstraint.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.TrackToConstraint.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* TrackToConstraint(Constraint)
  + [`TrackToConstraint`](#bpy.types.TrackToConstraint)
    - [`TrackToConstraint.head_tail`](#bpy.types.TrackToConstraint.head_tail)
    - [`TrackToConstraint.subtarget`](#bpy.types.TrackToConstraint.subtarget)
    - [`TrackToConstraint.target`](#bpy.types.TrackToConstraint.target)
    - [`TrackToConstraint.track_axis`](#bpy.types.TrackToConstraint.track_axis)
    - [`TrackToConstraint.up_axis`](#bpy.types.TrackToConstraint.up_axis)
    - [`TrackToConstraint.use_bbone_shape`](#bpy.types.TrackToConstraint.use_bbone_shape)
    - [`TrackToConstraint.use_target_z`](#bpy.types.TrackToConstraint.use_target_z)
    - [`TrackToConstraint.bl_rna_get_subclass()`](#bpy.types.TrackToConstraint.bl_rna_get_subclass)
    - [`TrackToConstraint.bl_rna_get_subclass_py()`](#bpy.types.TrackToConstraint.bl_rna_get_subclass_py)
