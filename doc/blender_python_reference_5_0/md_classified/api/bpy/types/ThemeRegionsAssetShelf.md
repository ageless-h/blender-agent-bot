...
# ThemeRegionsAssetShelf(bpy\_struct)[¶](#themeregionsassetshelf-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.ThemeRegionsAssetShelf(*bpy\_struct*)[¶](#bpy.types.ThemeRegionsAssetShelf "Link to this definition")
:   Theme settings for asset shelves

    back[¶](#bpy.types.ThemeRegionsAssetShelf.back "Link to this definition")
    :   Type:
        :   float array of 4 items in [0, 1], default (0.0, 0.0, 0.0, 0.0)

    header\_back[¶](#bpy.types.ThemeRegionsAssetShelf.header_back "Link to this definition")
    :   Type:
        :   float array of 4 items in [0, 1], default (0.0, 0.0, 0.0, 0.0)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ThemeRegionsAssetShelf.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ThemeRegionsAssetShelf.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`ThemeRegions.asset_shelf`](ThemeRegions.md#bpy.types.ThemeRegions.asset_shelf "bpy.types.ThemeRegions.asset_shelf") |  |
...
ThemeRegions(bpy\_struct)](ThemeRegions.md)
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ThemeRegionsAssetShelf.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ThemeRegionsAssetShelf.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ThemeRegionsAssetShelf(bpy\_struct)
  + [`ThemeRegionsAssetShelf`](#bpy.types.ThemeRegionsAssetShelf)
    - [`ThemeRegionsAssetShelf.back`](#bpy.types.ThemeRegionsAssetShelf.back)
    - [`ThemeRegionsAssetShelf.header_back`](#bpy.types.ThemeRegionsAssetShelf.header_back)
    - [`ThemeRegionsAssetShelf.bl_rna_get_subclass()`](#bpy.types.ThemeRegionsAssetShelf.bl_rna_get_subclass)
    - [`ThemeRegionsAssetShelf.bl_rna_get_subclass_py()`](#bpy.types.ThemeRegionsAssetShelf.bl_rna_get_subclass_py)
