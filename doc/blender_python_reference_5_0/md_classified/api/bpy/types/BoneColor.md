...
# BoneColor(bpy\_struct)[¶](#bonecolor-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.BoneColor(*bpy\_struct*)[¶](#bpy.types.BoneColor "Link to this definition")
:   Theme color or custom color of a bone

    custom[¶](#bpy.types.BoneColor.custom "Link to this definition")
    ...
    is\_custom[¶](#bpy.types.BoneColor.is_custom "Link to this definition")
    :   A color palette is user-defined, instead of using a theme-defined one

        Type:
        :   boolean, default False, (readonly)

    palette[¶](#bpy.types.BoneColor.palette "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.BoneColor.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.BoneColor.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Bone.color`](Bone.md#bpy.types.Bone.color "bpy.types.Bone.color") * [`EditBone.color`](EditBone.md#bpy.types.EditBone.color "bpy.types.EditBone.color") | * [`PoseBone.color`](PoseBone.md#bpy.types.PoseBone.color "bpy.types.PoseBone.color") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.BoneColor.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.BoneColor.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* BoneColor(bpy\_struct)
  + [`BoneColor`](#bpy.types.BoneColor)
    - [`BoneColor.custom`](#bpy.types.BoneColor.custom)
    - [`BoneColor.is_custom`](#bpy.types.BoneColor.is_custom)
    - [`BoneColor.palette`](#bpy.types.BoneColor.palette)
    - [`BoneColor.bl_rna_get_subclass()`](#bpy.types.BoneColor.bl_rna_get_subclass)
    - [`BoneColor.bl_rna_get_subclass_py()`](#bpy.types.BoneColor.bl_rna_get_subclass_py)
