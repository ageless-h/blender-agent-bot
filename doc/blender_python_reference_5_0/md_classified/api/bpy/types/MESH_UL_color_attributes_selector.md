...
# MESH\_UL\_color\_attributes\_selector(UIList)[¶](#mesh-ul-color-attributes-selector-uilist "Link to this heading")

base classes — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct"), [`UIList`](UIList.md#bpy.types.UIList "bpy.types.UIList")

*class* bpy.types.MESH\_UL\_color\_attributes\_selector(*UIList*)[¶](#bpy.types.MESH_UL_color_attributes_selector "Link to this definition")
:   draw\_item(*\_context*, *layout*, *\_data*, *attribute*, *\_icon*, *\_active\_data*, *\_active\_propname*, *\_index*)[¶](#bpy.types.MESH_UL_color_attributes_selector.draw_item "Link to this definition")

    filter\_items(*\_context*, *data*, *property*)[¶](#bpy.types.MESH_UL_color_attributes_selector.filter_items "Link to this definition")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.MESH_UL_color_attributes_selector.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.MESH_UL_color_attributes_selector.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`bpy_struct.id_data`](bpy_struct.md#bpy.types.bpy_struct.id_data "bpy.types.bpy_struct.id_data") * [`UIList.bl_idname`](UIList.md#bpy.types.UIList.bl_idname "bpy.types.UIList.bl_idname") * [`UIList.list_id`](UIList.md#bpy.types.UIList.list_id "bpy.types.UIList.list_id") * [`UIList.layout_type`](UIList.md#bpy.types.UIList.layout_type "bpy.types.UIList.layout_type") * [`UIList.use_filter_show`](UIList.md#bpy.types.UIList.use_filter_show "bpy.types.UIList.use_filter_show") * [`UIList.filter_name`](UIList.md#bpy.types.UIList.filter_name "bpy.types.UIList.filter_name") | * [`UIList.use_filter_invert`](UIList.md#bpy.types.UIList.use_filter_invert "bpy.types.UIList.use_filter_invert") * [`UIList.use_filter_sort_alpha`](UIList.md#bpy.types.UIList.use_filter_sort_alpha "bpy.types.UIList.use_filter_sort_alpha") * [`UIList.use_filter_sort_reverse`](UIList.md#bpy.types.UIList.use_filter_sort_reverse "bpy.types.UIList.use_filter_sort_reverse") * [`UIList.use_filter_sort_lock`](UIList.md#bpy.types.UIList.use_filter_sort_lock "bpy.types.UIList.use_filter_sort_lock") * [`UIList.bitflag_filter_item`](UIList.md#bpy.types.UIList.bitflag_filter_item "bpy.types.UIList.bitflag_filter_item") * [`UIList.bitflag_item_never_show`](UIList.md#bpy.types.UIList.bitflag_item_never_show "bpy.types.UIList.bitflag_item_never_show") |

## Inherited Functions[¶](#inherited-functions "Link to this heading")

|  |  |
| --- | --- |
| * [`bpy_struct.as_pointer`](bpy_struct.md#bpy.types.bpy_struct.as_pointer "bpy.types.bpy_struct.as_pointer") * [`bpy_struct.driver_add`](bpy_struct.md#bpy.types.bpy_struct.driver_add "bpy.types.bpy_struct.driver_add") * [`bpy_struct.driver_remove`](bpy_struct.md#bpy.types.bpy_struct.driver_remove "bpy.types.bpy_struct.driver_remove") * [`bpy_struct.get`](bpy_struct.md#bpy.types.bpy_struct.get "bpy.types.bpy_struct.get") * [`bpy_struct.id_properties_clear`](bpy_struct.md#bpy.types.bpy_struct.id_properties_clear "bpy.types.bpy_struct.id_properties_clear") * [`bpy_struct.id_properties_ensure`](bpy_struct.md#bpy.types.bpy_struct.id_properties_ensure "bpy.types.bpy_struct.id_properties_ensure") * [`bpy_struct.id_properties_ui`](bpy_struct.md#bpy.types.bpy_struct.id_properties_ui "bpy.types.bpy_struct.id_properties_ui") * [`bpy_struct.is_property_hidden`](bpy_struct.md#bpy.types.bpy_struct.is_property_hidden "bpy.types.bpy_struct.is_property_hidden") * [`bpy_struct.is_property_overridable_library`](bpy_struct.md#bpy.types.bpy_struct.is_property_overridable_library "bpy.types.bpy_struct.is_property_overridable_library") * [`bpy_struct.is_property_readonly`](bpy_struct.md#bpy.types.bpy_struct.is_property_readonly "bpy.types.bpy_struct.is_property_readonly") * [`bpy_struct.is_property_set`](bpy_struct.md#bpy.types.bpy_struct.is_property_set "bpy.types.bpy_struct.is_property_set") * [`bpy_struct.items`](bpy_struct.md#bpy.types.bpy_struct.items "bpy.types.bpy_struct.items") * [`bpy_struct.keyframe_delete`](bpy_struct.md#bpy.types.bpy_struct.keyframe_delete "bpy.types.bpy_struct.keyframe_delete") * [`bpy_struct.keyframe_insert`](bpy_struct.md#bpy.types.bpy_struct.keyframe_insert "bpy.types.bpy_struct.keyframe_insert") * [`bpy_struct.keys`](bpy_struct.md#bpy.types.bpy_struct.keys "bpy.types.bpy_struct.keys") * [`bpy_struct.path_from_id`](bpy_struct.md#bpy.types.bpy_struct.path_from_id "bpy.types.bpy_struct.path_from_id") * [`bpy_struct.path_from_module`](bpy_struct.md#bpy.types.bpy_struct.path_from_module "bpy.types.bpy_struct.path_from_module") | * [`bpy_struct.path_resolve`](bpy_struct.md#bpy.types.bpy_struct.path_resolve "bpy.types.bpy_struct.path_resolve") * [`bpy_struct.pop`](bpy_struct.md#bpy.types.bpy_struct.pop "bpy.types.bpy_struct.pop") * [`bpy_struct.property_overridable_library_set`](bpy_struct.md#bpy.types.bpy_struct.property_overridable_library_set "bpy.types.bpy_struct.property_overridable_library_set") * [`bpy_struct.property_unset`](bpy_struct.md#bpy.types.bpy_struct.property_unset "bpy.types.bpy_struct.property_unset") * [`bpy_struct.rna_ancestors`](bpy_struct.md#bpy.types.bpy_struct.rna_ancestors "bpy.types.bpy_struct.rna_ancestors") * [`bpy_struct.type_recast`](bpy_struct.md#bpy.types.bpy_struct.type_recast "bpy.types.bpy_struct.type_recast") * [`bpy_struct.values`](bpy_struct.md#bpy.types.bpy_struct.values "bpy.types.bpy_struct.values") * [`UIList.bl_system_properties_get`](UIList.md#bpy.types.UIList.bl_system_properties_get "bpy.types.UIList.bl_system_properties_get") * [`UIList.draw_item`](UIList.md#bpy.types.UIList.draw_item "bpy.types.UIList.draw_item") * [`UIList.draw_filter`](UIList.md#bpy.types.UIList.draw_filter "bpy.types.UIList.draw_filter") * [`UIList.filter_items`](UIList.md#bpy.types.UIList.filter_items "bpy.types.UIList.filter_items") * [`UIList.append`](UIList.md#bpy.types.UIList.append "bpy.types.UIList.append") * [`UIList.is_extended`](UIList.md#bpy.types.UIList.is_extended "bpy.types.UIList.is_extended") * [`UIList.prepend`](UIList.md#bpy.types.UIList.prepend "bpy.types.UIList.prepend") * [`UIList.remove`](UIList.md#bpy.types.UIList.remove "bpy.types.UIList.remove") * [`UIList.bl_rna_get_subclass`](UIList.md#bpy.types.UIList.bl_rna_get_subclass "bpy.types.UIList.bl_rna_get_subclass") * [`UIList.bl_rna_get_subclass_py`](UIList.md#bpy.types.UIList.bl_rna_get_subclass_py "bpy.types.UIList.bl_rna_get_subclass_py") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.MESH_UL_color_attributes_selector.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.MESH_UL_color_attributes_selector.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* MESH\_UL\_color\_attributes\_selector(UIList)
  + [`MESH_UL_color_attributes_selector`](#bpy.types.MESH_UL_color_attributes_selector)
    - [`MESH_UL_color_attributes_selector.draw_item()`](#bpy.types.MESH_UL_color_attributes_selector.draw_item)
    - [`MESH_UL_color_attributes_selector.filter_items()`](#bpy.types.MESH_UL_color_attributes_selector.filter_items)
    - [`MESH_UL_color_attributes_selector.bl_rna_get_subclass()`](#bpy.types.MESH_UL_color_attributes_selector.bl_rna_get_subclass)
    - [`MESH_UL_color_attributes_selector.bl_rna_get_subclass_py()`](#bpy.types.MESH_UL_color_attributes_selector.bl_rna_get_subclass_py)
