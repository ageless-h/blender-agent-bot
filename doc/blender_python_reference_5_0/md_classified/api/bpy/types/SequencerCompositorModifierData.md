...
# SequencerCompositorModifierData(StripModifier)[¶](#sequencercompositormodifierdata-stripmodifier "Link to this heading")
...
*class* bpy.types.SequencerCompositorModifierData(*StripModifier*)[¶](#bpy.types.SequencerCompositorModifierData "Link to this definition")
:   Compositor Modifier

    node\_group[¶](#bpy.types.SequencerCompositorModifierData.node_group "Link to this definition")
    :   Node group that controls what this modifier does

        Type:
        :   [`NodeTree`](NodeTree.md#bpy.types.NodeTree "bpy.types.NodeTree")

    open\_mask\_input\_panel[¶](#bpy.types.SequencerCompositorModifierData.open_mask_input_panel "Link to this definition")
    :   Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.SequencerCompositorModifierData.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.SequencerCompositorModifierData.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.SequencerCompositorModifierData.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.SequencerCompositorModifierData.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* SequencerCompositorModifierData(StripModifier)
  + [`SequencerCompositorModifierData`](#bpy.types.SequencerCompositorModifierData)
    - [`SequencerCompositorModifierData.node_group`](#bpy.types.SequencerCompositorModifierData.node_group)
    - [`SequencerCompositorModifierData.open_mask_input_panel`](#bpy.types.SequencerCompositorModifierData.open_mask_input_panel)
    - [`SequencerCompositorModifierData.bl_rna_get_subclass()`](#bpy.types.SequencerCompositorModifierData.bl_rna_get_subclass)
    - [`SequencerCompositorModifierData.bl_rna_get_subclass_py()`](#bpy.types.SequencerCompositorModifierData.bl_rna_get_subclass_py)
