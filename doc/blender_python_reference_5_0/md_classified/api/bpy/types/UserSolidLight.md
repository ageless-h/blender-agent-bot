...
# UserSolidLight(bpy\_struct)[¶](#usersolidlight-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.UserSolidLight(*bpy\_struct*)[¶](#bpy.types.UserSolidLight "Link to this definition")
:   Light used for Studio lighting in solid shading mode

    diffuse\_color[¶](#bpy.types.UserSolidLight.diffuse_color "Link to this definition")
    :   Color of the light’s diffuse highlight

        Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, inf], default (0.8, 0.8, 0.8)

    direction[¶](#bpy.types.UserSolidLight.direction "Link to this definition")
    ...
    smooth[¶](#bpy.types.UserSolidLight.smooth "Link to this definition")
    :   Smooth the lighting from this light

        Type:
        :   float in [0, 1], default 0.5

    specular\_color[¶](#bpy.types.UserSolidLight.specular_color "Link to this definition")
    :   Color of the light’s specular highlight

        Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, inf], default (0.8, 0.8, 0.8)

    use[¶](#bpy.types.UserSolidLight.use "Link to this definition")
    :   Enable this light in solid shading mode

        Type:
        :   boolean, default True

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.UserSolidLight.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.UserSolidLight.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`PreferencesSystem.solid_lights`](PreferencesSystem.md#bpy.types.PreferencesSystem.solid_lights "bpy.types.PreferencesSystem.solid_lights") | * [`StudioLight.solid_lights`](StudioLight.md#bpy.types.StudioLight.solid_lights "bpy.types.StudioLight.solid_lights") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.UserSolidLight.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.UserSolidLight.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* UserSolidLight(bpy\_struct)
  + [`UserSolidLight`](#bpy.types.UserSolidLight)
    - [`UserSolidLight.diffuse_color`](#bpy.types.UserSolidLight.diffuse_color)
    - [`UserSolidLight.direction`](#bpy.types.UserSolidLight.direction)
    - [`UserSolidLight.smooth`](#bpy.types.UserSolidLight.smooth)
    - [`UserSolidLight.specular_color`](#bpy.types.UserSolidLight.specular_color)
    - [`UserSolidLight.use`](#bpy.types.UserSolidLight.use)
    - [`UserSolidLight.bl_rna_get_subclass()`](#bpy.types.UserSolidLight.bl_rna_get_subclass)
    - [`UserSolidLight.bl_rna_get_subclass_py()`](#bpy.types.UserSolidLight.bl_rna_get_subclass_py)
