...
# GeometryNodeGridCurl(GeometryNode)[¶](#geometrynodegridcurl-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeGridCurl(*GeometryNode*)[¶](#bpy.types.GeometryNodeGridCurl "Link to this definition")
:   Calculate the magnitude and direction of circulation of a directional vector grid

    *classmethod* is\_registered\_node\_type()[¶](#bpy.types.GeometryNodeGridCurl.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[¶](#bpy.types.GeometryNodeGridCurl.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[¶](#bpy.types.GeometryNodeGridCurl.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.GeometryNodeGridCurl.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.GeometryNodeGridCurl.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeGridCurl.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.GeometryNodeGridCurl.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeGridCurl(GeometryNode)
  + [`GeometryNodeGridCurl`](#bpy.types.GeometryNodeGridCurl)
    - [`GeometryNodeGridCurl.is_registered_node_type()`](#bpy.types.GeometryNodeGridCurl.is_registered_node_type)
    - [`GeometryNodeGridCurl.input_template()`](#bpy.types.GeometryNodeGridCurl.input_template)
    - [`GeometryNodeGridCurl.output_template()`](#bpy.types.GeometryNodeGridCurl.output_template)
    - [`GeometryNodeGridCurl.bl_rna_get_subclass()`](#bpy.types.GeometryNodeGridCurl.bl_rna_get_subclass)
    - [`GeometryNodeGridCurl.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeGridCurl.bl_rna_get_subclass_py)
