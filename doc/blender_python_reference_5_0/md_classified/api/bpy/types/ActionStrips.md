...
# ActionStrips(bpy\_struct)[¶](#actionstrips-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.ActionStrips(*bpy\_struct*)[¶](#bpy.types.ActionStrips "Link to this definition")
:   Collection of animation strips

    new(*\**, *type='KEYFRAME'*)[¶](#bpy.types.ActionStrips.new "Link to this definition")
    :   Add a new strip to the layer. Currently a layer can only have one strip, with infinite boundaries.
        ...
        Return type:
        :   [`ActionStrip`](ActionStrip.md#bpy.types.ActionStrip "bpy.types.ActionStrip")

    remove(*anim\_strip*)[¶](#bpy.types.ActionStrips.remove "Link to this definition")
    :   Remove the strip from the animation layer

        Parameters:
        :   **anim\_strip** ([`ActionStrip`](ActionStrip.md#bpy.types.ActionStrip "bpy.types.ActionStrip")) – Animation Strip, The strip to remove

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ActionStrips.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ActionStrips.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`ActionLayer.strips`](ActionLayer.md#bpy.types.ActionLayer.strips "bpy.types.ActionLayer.strips") |  |

[Next

AddStrip(EffectStrip)](AddStrip.md)
[Previous
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ActionStrips.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ActionStrips.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ActionStrips(bpy\_struct)
  + [`ActionStrips`](#bpy.types.ActionStrips)
    - [`ActionStrips.new()`](#bpy.types.ActionStrips.new)
    - [`ActionStrips.remove()`](#bpy.types.ActionStrips.remove)
    - [`ActionStrips.bl_rna_get_subclass()`](#bpy.types.ActionStrips.bl_rna_get_subclass)
    - [`ActionStrips.bl_rna_get_subclass_py()`](#bpy.types.ActionStrips.bl_rna_get_subclass_py)
