...
# NodeSocketBool(NodeSocketStandard)[¶](#nodesocketbool-nodesocketstandard "Link to this heading")
...
*class* bpy.types.NodeSocketBool(*NodeSocketStandard*)[¶](#bpy.types.NodeSocketBool "Link to this definition")
:   Boolean value socket of a node

    default\_value[¶](#bpy.types.NodeSocketBool.default_value "Link to this definition")
    :   Input value used for unconnected socket

        Type:
        :   boolean, default False

    links[¶](#bpy.types.NodeSocketBool.links "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.NodeSocketBool.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.NodeSocketBool.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
NodeSocketBundle(NodeSocketStandard)](NodeSocketBundle.md)
[Previous
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.NodeSocketBool.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.NodeSocketBool.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* NodeSocketBool(NodeSocketStandard)
  + [`NodeSocketBool`](#bpy.types.NodeSocketBool)
    - [`NodeSocketBool.default_value`](#bpy.types.NodeSocketBool.default_value)
    - [`NodeSocketBool.links`](#bpy.types.NodeSocketBool.links)
    - [`NodeSocketBool.bl_rna_get_subclass()`](#bpy.types.NodeSocketBool.bl_rna_get_subclass)
    - [`NodeSocketBool.bl_rna_get_subclass_py()`](#bpy.types.NodeSocketBool.bl_rna_get_subclass_py)
