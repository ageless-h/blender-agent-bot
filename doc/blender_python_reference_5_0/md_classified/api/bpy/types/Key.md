...
# Key(ID)[¶](#key-id "Link to this heading")

base classes — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct"), [`ID`](ID.md#bpy.types.ID "bpy.types.ID")

*class* bpy.types.Key(*ID*)[¶](#bpy.types.Key "Link to this definition")
:   Shape keys data-block containing different shapes of geometric data-blocks

    animation\_data[¶](#bpy.types.Key.animation_data "Link to this definition")
    :   Animation data for this data-block

        Type:
        :   [`AnimData`](AnimData.md#bpy.types.AnimData "bpy.types.AnimData"), (readonly)

    eval\_time[¶](#bpy.types.Key.eval_time "Link to this definition")
    :   Evaluation time for absolute shape keys

        Type:
        :   float in [0, 1.04857e+06], default 0.0

    key\_blocks[¶](#bpy.types.Key.key_blocks "Link to this definition")
    :   Shape keys

        Type:
        :   [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`ShapeKey`](ShapeKey.md#bpy.types.ShapeKey "bpy.types.ShapeKey"), (readonly)

    reference\_key[¶](#bpy.types.Key.reference_key "Link to this definition")
    :   Type:
        :   [`ShapeKey`](ShapeKey.md#bpy.types.ShapeKey "bpy.types.ShapeKey"), (readonly, never None)

    use\_relative[¶](#bpy.types.Key.use_relative "Link to this definition")
    :   Make shape keys relative, otherwise play through shapes as a sequence using the evaluation time

        Type:
        :   boolean, default False

    user[¶](#bpy.types.Key.user "Link to this definition")
    :   Data-block using these shape keys

        Type:
        :   [`ID`](ID.md#bpy.types.ID "bpy.types.ID"), (readonly, never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.Key.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.Key.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`BlendData.shape_keys`](BlendData.md#bpy.types.BlendData.shape_keys "bpy.types.BlendData.shape_keys") * [`Curve.shape_keys`](Curve.md#bpy.types.Curve.shape_keys "bpy.types.Curve.shape_keys") | * [`Lattice.shape_keys`](Lattice.md#bpy.types.Lattice.shape_keys "bpy.types.Lattice.shape_keys") * [`Mesh.shape_keys`](Mesh.md#bpy.types.Mesh.shape_keys "bpy.types.Mesh.shape_keys") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.Key.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.Key.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* Key(ID)
  + [`Key`](#bpy.types.Key)
    - [`Key.animation_data`](#bpy.types.Key.animation_data)
    - [`Key.eval_time`](#bpy.types.Key.eval_time)
    - [`Key.key_blocks`](#bpy.types.Key.key_blocks)
    - [`Key.reference_key`](#bpy.types.Key.reference_key)
    - [`Key.use_relative`](#bpy.types.Key.use_relative)
    - [`Key.user`](#bpy.types.Key.user)
    - [`Key.bl_rna_get_subclass()`](#bpy.types.Key.bl_rna_get_subclass)
    - [`Key.bl_rna_get_subclass_py()`](#bpy.types.Key.bl_rna_get_subclass_py)
