...
# GreasePencilArmatureModifier(Modifier)[¶](#greasepencilarmaturemodifier-modifier "Link to this heading")
...
*class* bpy.types.GreasePencilArmatureModifier(*Modifier*)[¶](#bpy.types.GreasePencilArmatureModifier "Link to this definition")
:   Deform stroke points using armature object

    invert\_vertex\_group[¶](#bpy.types.GreasePencilArmatureModifier.invert_vertex_group "Link to this definition")
    :   Invert vertex group weights

        Type:
        :   boolean, default False

    object[¶](#bpy.types.GreasePencilArmatureModifier.object "Link to this definition")
    :   Armature object to deform with

        Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object")

    open\_influence\_panel[¶](#bpy.types.GreasePencilArmatureModifier.open_influence_panel "Link to this definition")
    :   Type:
        :   boolean, default False

    use\_bone\_envelopes[¶](#bpy.types.GreasePencilArmatureModifier.use_bone_envelopes "Link to this definition")
    :   Bind Bone envelopes to armature modifier

        Type:
        :   boolean, default False

    use\_deform\_preserve\_volume[¶](#bpy.types.GreasePencilArmatureModifier.use_deform_preserve_volume "Link to this definition")
    :   Deform rotation interpolation with quaternions

        Type:
        :   boolean, default False

    use\_vertex\_groups[¶](#bpy.types.GreasePencilArmatureModifier.use_vertex_groups "Link to this definition")
    :   Bind vertex groups to armature modifier

        Type:
        :   boolean, default True

    vertex\_group\_name[¶](#bpy.types.GreasePencilArmatureModifier.vertex_group_name "Link to this definition")
    :   Vertex group name for modulating the deform

        Type:
        :   string, default “”, (never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.GreasePencilArmatureModifier.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.GreasePencilArmatureModifier.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GreasePencilArmatureModifier.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.GreasePencilArmatureModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GreasePencilArmatureModifier(Modifier)
  + [`GreasePencilArmatureModifier`](#bpy.types.GreasePencilArmatureModifier)
    - [`GreasePencilArmatureModifier.invert_vertex_group`](#bpy.types.GreasePencilArmatureModifier.invert_vertex_group)
    - [`GreasePencilArmatureModifier.object`](#bpy.types.GreasePencilArmatureModifier.object)
    - [`GreasePencilArmatureModifier.open_influence_panel`](#bpy.types.GreasePencilArmatureModifier.open_influence_panel)
    - [`GreasePencilArmatureModifier.use_bone_envelopes`](#bpy.types.GreasePencilArmatureModifier.use_bone_envelopes)
    - [`GreasePencilArmatureModifier.use_deform_preserve_volume`](#bpy.types.GreasePencilArmatureModifier.use_deform_preserve_volume)
    - [`GreasePencilArmatureModifier.use_vertex_groups`](#bpy.types.GreasePencilArmatureModifier.use_vertex_groups)
    - [`GreasePencilArmatureModifier.vertex_group_name`](#bpy.types.GreasePencilArmatureModifier.vertex_group_name)
    - [`GreasePencilArmatureModifier.bl_rna_get_subclass()`](#bpy.types.GreasePencilArmatureModifier.bl_rna_get_subclass)
    - [`GreasePencilArmatureModifier.bl_rna_get_subclass_py()`](#bpy.types.GreasePencilArmatureModifier.bl_rna_get_subclass_py)
