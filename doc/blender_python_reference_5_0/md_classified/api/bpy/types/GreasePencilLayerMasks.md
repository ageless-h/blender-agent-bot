...
# GreasePencilLayerMasks(bpy\_struct)[¶](#greasepencillayermasks-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.GreasePencilLayerMasks(*bpy\_struct*)[¶](#bpy.types.GreasePencilLayerMasks "Link to this definition")
:   Collection of Grease Pencil masking layers

    active\_mask\_index[¶](#bpy.types.GreasePencilLayerMasks.active_mask_index "Link to this definition")
    :   Active index in layer mask array

        Type:
        :   int in [0, inf], default 0

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.GreasePencilLayerMasks.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.GreasePencilLayerMasks.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GreasePencilLayerMasks.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.GreasePencilLayerMasks.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GreasePencilLayerMasks(bpy\_struct)
  + [`GreasePencilLayerMasks`](#bpy.types.GreasePencilLayerMasks)
    - [`GreasePencilLayerMasks.active_mask_index`](#bpy.types.GreasePencilLayerMasks.active_mask_index)
    - [`GreasePencilLayerMasks.bl_rna_get_subclass()`](#bpy.types.GreasePencilLayerMasks.bl_rna_get_subclass)
    - [`GreasePencilLayerMasks.bl_rna_get_subclass_py()`](#bpy.types.GreasePencilLayerMasks.bl_rna_get_subclass_py)
