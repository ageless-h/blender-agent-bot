...
# CastModifier(Modifier)[¶](#castmodifier-modifier "Link to this heading")
...
*class* bpy.types.CastModifier(*Modifier*)[¶](#bpy.types.CastModifier "Link to this definition")
:   Modifier to cast to other shapes

    cast\_type[¶](#bpy.types.CastModifier.cast_type "Link to this definition")
    :   Target object shape

        Type:
        :   enum in [`'SPHERE'`, `'CYLINDER'`, `'CUBOID'`], default `'SPHERE'`

    factor[¶](#bpy.types.CastModifier.factor "Link to this definition")
    :   Type:
        :   float in [-inf, inf], default 0.5

    invert\_vertex\_group[¶](#bpy.types.CastModifier.invert_vertex_group "Link to this definition")
    :   Invert vertex group influence

        Type:
        :   boolean, default False

    object[¶](#bpy.types.CastModifier.object "Link to this definition")
    :   Control object: if available, its location determines the center of the effect

        Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object")

    radius[¶](#bpy.types.CastModifier.radius "Link to this definition")
    :   Only deform vertices within this distance from the center of the effect (leave as 0 for infinite.)

        Type:
        :   float in [0, inf], default 0.0

    size[¶](#bpy.types.CastModifier.size "Link to this definition")
    :   Size of projection shape (leave as 0 for auto)

        Type:
        :   float in [0, inf], default 0.0

    use\_radius\_as\_size[¶](#bpy.types.CastModifier.use_radius_as_size "Link to this definition")
    :   Use radius as size of projection shape (0 = auto)

        Type:
        :   boolean, default True

    use\_transform[¶](#bpy.types.CastModifier.use_transform "Link to this definition")
    :   Use object transform to control projection shape

        Type:
        :   boolean, default False

    use\_x[¶](#bpy.types.CastModifier.use_x "Link to this definition")
    :   Type:
        :   boolean, default True

    use\_y[¶](#bpy.types.CastModifier.use_y "Link to this definition")
    :   Type:
        :   boolean, default True

    use\_z[¶](#bpy.types.CastModifier.use_z "Link to this definition")
    :   Type:
        :   boolean, default True

    vertex\_group[¶](#bpy.types.CastModifier.vertex_group "Link to this definition")
    :   Vertex group name

        Type:
        :   string, default “”, (never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.CastModifier.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.CastModifier.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CastModifier.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.CastModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CastModifier(Modifier)
  + [`CastModifier`](#bpy.types.CastModifier)
    - [`CastModifier.cast_type`](#bpy.types.CastModifier.cast_type)
    - [`CastModifier.factor`](#bpy.types.CastModifier.factor)
    - [`CastModifier.invert_vertex_group`](#bpy.types.CastModifier.invert_vertex_group)
    - [`CastModifier.object`](#bpy.types.CastModifier.object)
    - [`CastModifier.radius`](#bpy.types.CastModifier.radius)
    - [`CastModifier.size`](#bpy.types.CastModifier.size)
    - [`CastModifier.use_radius_as_size`](#bpy.types.CastModifier.use_radius_as_size)
    - [`CastModifier.use_transform`](#bpy.types.CastModifier.use_transform)
    - [`CastModifier.use_x`](#bpy.types.CastModifier.use_x)
    - [`CastModifier.use_y`](#bpy.types.CastModifier.use_y)
    - [`CastModifier.use_z`](#bpy.types.CastModifier.use_z)
    - [`CastModifier.vertex_group`](#bpy.types.CastModifier.vertex_group)
    - [`CastModifier.bl_rna_get_subclass()`](#bpy.types.CastModifier.bl_rna_get_subclass)
    - [`CastModifier.bl_rna_get_subclass_py()`](#bpy.types.CastModifier.bl_rna_get_subclass_py)
