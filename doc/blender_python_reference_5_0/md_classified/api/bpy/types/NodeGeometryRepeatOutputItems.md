...
# NodeGeometryRepeatOutputItems(bpy\_struct)[¶](#nodegeometryrepeatoutputitems-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.NodeGeometryRepeatOutputItems(*bpy\_struct*)[¶](#bpy.types.NodeGeometryRepeatOutputItems "Link to this definition")
:   Collection of repeat items

    new(*socket\_type*, *name*)[¶](#bpy.types.NodeGeometryRepeatOutputItems.new "Link to this definition")
    ...
    remove(*item*)[¶](#bpy.types.NodeGeometryRepeatOutputItems.remove "Link to this definition")
    :   Remove an item

        Parameters:
        :   **item** ([`RepeatItem`](RepeatItem.md#bpy.types.RepeatItem "bpy.types.RepeatItem"), (never None)) – Item, The item to remove

    clear()[¶](#bpy.types.NodeGeometryRepeatOutputItems.clear "Link to this definition")
    :   Remove all items

    move(*from\_index*, *to\_index*)[¶](#bpy.types.NodeGeometryRepeatOutputItems.move "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.NodeGeometryRepeatOutputItems.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.NodeGeometryRepeatOutputItems.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`GeometryNodeRepeatOutput.repeat_items`](GeometryNodeRepeatOutput.md#bpy.types.GeometryNodeRepeatOutput.repeat_items "bpy.types.GeometryNodeRepeatOutput.repeat_items") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.NodeGeometryRepeatOutputItems.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.NodeGeometryRepeatOutputItems.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* NodeGeometryRepeatOutputItems(bpy\_struct)
  + [`NodeGeometryRepeatOutputItems`](#bpy.types.NodeGeometryRepeatOutputItems)
    - [`NodeGeometryRepeatOutputItems.new()`](#bpy.types.NodeGeometryRepeatOutputItems.new)
    - [`NodeGeometryRepeatOutputItems.remove()`](#bpy.types.NodeGeometryRepeatOutputItems.remove)
    - [`NodeGeometryRepeatOutputItems.clear()`](#bpy.types.NodeGeometryRepeatOutputItems.clear)
    - [`NodeGeometryRepeatOutputItems.move()`](#bpy.types.NodeGeometryRepeatOutputItems.move)
    - [`NodeGeometryRepeatOutputItems.bl_rna_get_subclass()`](#bpy.types.NodeGeometryRepeatOutputItems.bl_rna_get_subclass)
    - [`NodeGeometryRepeatOutputItems.bl_rna_get_subclass_py()`](#bpy.types.NodeGeometryRepeatOutputItems.bl_rna_get_subclass_py)
