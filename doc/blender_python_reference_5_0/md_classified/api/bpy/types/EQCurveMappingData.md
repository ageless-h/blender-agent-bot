...
# EQCurveMappingData(bpy\_struct)[¶](#eqcurvemappingdata-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.EQCurveMappingData(*bpy\_struct*)[¶](#bpy.types.EQCurveMappingData "Link to this definition")
:   EQCurveMappingData

    curve\_mapping[¶](#bpy.types.EQCurveMappingData.curve_mapping "Link to this definition")
    :   Type:
        :   [`CurveMapping`](CurveMapping.md#bpy.types.CurveMapping "bpy.types.CurveMapping"), (readonly)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.EQCurveMappingData.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.EQCurveMappingData.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`SoundEqualizerModifier.graphics`](SoundEqualizerModifier.md#bpy.types.SoundEqualizerModifier.graphics "bpy.types.SoundEqualizerModifier.graphics") | * [`SoundEqualizerModifier.new_graphic`](SoundEqualizerModifier.md#bpy.types.SoundEqualizerModifier.new_graphic "bpy.types.SoundEqualizerModifier.new_graphic") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.EQCurveMappingData.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.EQCurveMappingData.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* EQCurveMappingData(bpy\_struct)
  + [`EQCurveMappingData`](#bpy.types.EQCurveMappingData)
    - [`EQCurveMappingData.curve_mapping`](#bpy.types.EQCurveMappingData.curve_mapping)
    - [`EQCurveMappingData.bl_rna_get_subclass()`](#bpy.types.EQCurveMappingData.bl_rna_get_subclass)
    - [`EQCurveMappingData.bl_rna_get_subclass_py()`](#bpy.types.EQCurveMappingData.bl_rna_get_subclass_py)
