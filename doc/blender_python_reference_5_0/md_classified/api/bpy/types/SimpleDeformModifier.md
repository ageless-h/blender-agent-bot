...
# SimpleDeformModifier(Modifier)[¶](#simpledeformmodifier-modifier "Link to this heading")
...
*class* bpy.types.SimpleDeformModifier(*Modifier*)[¶](#bpy.types.SimpleDeformModifier "Link to this definition")
:   Simple deformation modifier to apply effects such as twisting and bending

    angle[¶](#bpy.types.SimpleDeformModifier.angle "Link to this definition")
    :   Angle of deformation

        Type:
        :   float in [-inf, inf], default 0.785398

    deform\_axis[¶](#bpy.types.SimpleDeformModifier.deform_axis "Link to this definition")
    ...
    deform\_method[¶](#bpy.types.SimpleDeformModifier.deform_method "Link to this definition")
    :   * `TWIST`
    ...
    factor[¶](#bpy.types.SimpleDeformModifier.factor "Link to this definition")
    :   Amount to deform object

        Type:
        :   float in [-inf, inf], default 0.785398

    invert\_vertex\_group[¶](#bpy.types.SimpleDeformModifier.invert_vertex_group "Link to this definition")
    :   Invert vertex group influence

        Type:
        :   boolean, default False

    limits[¶](#bpy.types.SimpleDeformModifier.limits "Link to this definition")
    :   Lower/Upper limits for deform

        Type:
        :   float array of 2 items in [0, 1], default (0.0, 1.0)

    lock\_x[¶](#bpy.types.SimpleDeformModifier.lock_x "Link to this definition")
    :   Do not allow deformation along the X axis

        Type:
        :   boolean, default False

    lock\_y[¶](#bpy.types.SimpleDeformModifier.lock_y "Link to this definition")
    :   Do not allow deformation along the Y axis

        Type:
        :   boolean, default False

    lock\_z[¶](#bpy.types.SimpleDeformModifier.lock_z "Link to this definition")
    :   Do not allow deformation along the Z axis

        Type:
        :   boolean, default False

    origin[¶](#bpy.types.SimpleDeformModifier.origin "Link to this definition")
    :   Offset the origin and orientation of the deformation

        Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object")

    vertex\_group[¶](#bpy.types.SimpleDeformModifier.vertex_group "Link to this definition")
    :   Vertex group name

        Type:
        :   string, default “”, (never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.SimpleDeformModifier.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.SimpleDeformModifier.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.SimpleDeformModifier.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.SimpleDeformModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* SimpleDeformModifier(Modifier)
  + [`SimpleDeformModifier`](#bpy.types.SimpleDeformModifier)
    - [`SimpleDeformModifier.angle`](#bpy.types.SimpleDeformModifier.angle)
    - [`SimpleDeformModifier.deform_axis`](#bpy.types.SimpleDeformModifier.deform_axis)
    - [`SimpleDeformModifier.deform_method`](#bpy.types.SimpleDeformModifier.deform_method)
    - [`SimpleDeformModifier.factor`](#bpy.types.SimpleDeformModifier.factor)
    - [`SimpleDeformModifier.invert_vertex_group`](#bpy.types.SimpleDeformModifier.invert_vertex_group)
    - [`SimpleDeformModifier.limits`](#bpy.types.SimpleDeformModifier.limits)
    - [`SimpleDeformModifier.lock_x`](#bpy.types.SimpleDeformModifier.lock_x)
    - [`SimpleDeformModifier.lock_y`](#bpy.types.SimpleDeformModifier.lock_y)
    - [`SimpleDeformModifier.lock_z`](#bpy.types.SimpleDeformModifier.lock_z)
    - [`SimpleDeformModifier.origin`](#bpy.types.SimpleDeformModifier.origin)
    - [`SimpleDeformModifier.vertex_group`](#bpy.types.SimpleDeformModifier.vertex_group)
    - [`SimpleDeformModifier.bl_rna_get_subclass()`](#bpy.types.SimpleDeformModifier.bl_rna_get_subclass)
    - [`SimpleDeformModifier.bl_rna_get_subclass_py()`](#bpy.types.SimpleDeformModifier.bl_rna_get_subclass_py)
