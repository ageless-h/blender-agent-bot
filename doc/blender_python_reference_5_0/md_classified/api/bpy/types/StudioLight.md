...
# StudioLight(bpy\_struct)[¶](#studiolight-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.StudioLight(*bpy\_struct*)[¶](#bpy.types.StudioLight "Link to this definition")
:   Studio light

    has\_specular\_highlight\_pass[¶](#bpy.types.StudioLight.has_specular_highlight_pass "Link to this definition")
    :   Studio light image file has separate “diffuse” and “specular” passes

        Type:
        :   boolean, default False, (readonly)

    index[¶](#bpy.types.StudioLight.index "Link to this definition")
    :   Type:
        :   int in [-inf, inf], default 0, (readonly)

    is\_user\_defined[¶](#bpy.types.StudioLight.is_user_defined "Link to this definition")
    :   Type:
        :   boolean, default False, (readonly)

    light\_ambient[¶](#bpy.types.StudioLight.light_ambient "Link to this definition")
    ...
    name[¶](#bpy.types.StudioLight.name "Link to this definition")
    :   Type:
        :   string, default “”, (readonly, never None)

    path[¶](#bpy.types.StudioLight.path "Link to this definition")
    :   Type:
        :   string, default “”, (readonly, never None)

    solid\_lights[¶](#bpy.types.StudioLight.solid_lights "Link to this definition")
    ...
    type[¶](#bpy.types.StudioLight.type "Link to this definition")
    :   Type:
        :   enum in [`'STUDIO'`, `'WORLD'`, `'MATCAP'`], default `'STUDIO'`, (readonly)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.StudioLight.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.StudioLight.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Preferences.studio_lights`](Preferences.md#bpy.types.Preferences.studio_lights "bpy.types.Preferences.studio_lights") * [`StudioLights.load`](StudioLights.md#bpy.types.StudioLights.load "bpy.types.StudioLights.load") * [`StudioLights.new`](StudioLights.md#bpy.types.StudioLights.new "bpy.types.StudioLights.new") | * [`StudioLights.remove`](StudioLights.md#bpy.types.StudioLights.remove "bpy.types.StudioLights.remove") * [`View3DShading.selected_studio_light`](View3DShading.md#bpy.types.View3DShading.selected_studio_light "bpy.types.View3DShading.selected_studio_light") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.StudioLight.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.StudioLight.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* StudioLight(bpy\_struct)
  + [`StudioLight`](#bpy.types.StudioLight)
    - [`StudioLight.has_specular_highlight_pass`](#bpy.types.StudioLight.has_specular_highlight_pass)
    - [`StudioLight.index`](#bpy.types.StudioLight.index)
    - [`StudioLight.is_user_defined`](#bpy.types.StudioLight.is_user_defined)
    - [`StudioLight.light_ambient`](#bpy.types.StudioLight.light_ambient)
    - [`StudioLight.name`](#bpy.types.StudioLight.name)
    - [`StudioLight.path`](#bpy.types.StudioLight.path)
    - [`StudioLight.solid_lights`](#bpy.types.StudioLight.solid_lights)
    - [`StudioLight.type`](#bpy.types.StudioLight.type)
    - [`StudioLight.bl_rna_get_subclass()`](#bpy.types.StudioLight.bl_rna_get_subclass)
    - [`StudioLight.bl_rna_get_subclass_py()`](#bpy.types.StudioLight.bl_rna_get_subclass_py)
