...
# LineStyleThicknessModifiers(bpy\_struct)[¶](#linestylethicknessmodifiers-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.LineStyleThicknessModifiers(*bpy\_struct*)[¶](#bpy.types.LineStyleThicknessModifiers "Link to this definition")
:   Thickness modifiers for changing line thickness

    new(*name*, *type*)[¶](#bpy.types.LineStyleThicknessModifiers.new "Link to this definition")
    :   Add a thickness modifier to line style

        Parameters:
        :   * **name** (*string**,* *(**never None**)*) – New name for the thickness modifier (not unique)
            * **type** (enum in [Linestyle Thickness Modifier Type Items](../../../appendix/bpy_types_enum_items/linestyle_thickness_modifier_type_items.md#rna-enum-linestyle-thickness-modifier-type-items)) – Thickness modifier type to add

        Returns:
        :   Newly added thickness modifier

        Return type:
        :   [`LineStyleThicknessModifier`](LineStyleThicknessModifier.md#bpy.types.LineStyleThicknessModifier "bpy.types.LineStyleThicknessModifier")

    remove(*modifier*)[¶](#bpy.types.LineStyleThicknessModifiers.remove "Link to this definition")
    :   Remove a thickness modifier from line style

        Parameters:
        :   **modifier** ([`LineStyleThicknessModifier`](LineStyleThicknessModifier.md#bpy.types.LineStyleThicknessModifier "bpy.types.LineStyleThicknessModifier"), (never None)) – Thickness modifier to remove

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.LineStyleThicknessModifiers.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.LineStyleThicknessModifiers.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`FreestyleLineStyle.thickness_modifiers`](FreestyleLineStyle.md#bpy.types.FreestyleLineStyle.thickness_modifiers "bpy.types.FreestyleLineStyle.thickness_modifiers") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.LineStyleThicknessModifiers.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.LineStyleThicknessModifiers.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* LineStyleThicknessModifiers(bpy\_struct)
  + [`LineStyleThicknessModifiers`](#bpy.types.LineStyleThicknessModifiers)
    - [`LineStyleThicknessModifiers.new()`](#bpy.types.LineStyleThicknessModifiers.new)
    - [`LineStyleThicknessModifiers.remove()`](#bpy.types.LineStyleThicknessModifiers.remove)
    - [`LineStyleThicknessModifiers.bl_rna_get_subclass()`](#bpy.types.LineStyleThicknessModifiers.bl_rna_get_subclass)
    - [`LineStyleThicknessModifiers.bl_rna_get_subclass_py()`](#bpy.types.LineStyleThicknessModifiers.bl_rna_get_subclass_py)
