...
# Annotation(ID)[¶](#annotation-id "Link to this heading")

base classes — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct"), [`ID`](ID.md#bpy.types.ID "bpy.types.ID")

*class* bpy.types.Annotation(*ID*)[¶](#bpy.types.Annotation "Link to this definition")
:   Freehand annotation sketchbook

    animation\_data[¶](#bpy.types.Annotation.animation_data "Link to this definition")
    :   Animation data for this data-block

        Type:
        :   [`AnimData`](AnimData.md#bpy.types.AnimData "bpy.types.AnimData"), (readonly)

    layers[¶](#bpy.types.Annotation.layers "Link to this definition")
    :   Type:
        :   [`AnnotationLayers`](AnnotationLayers.md#bpy.types.AnnotationLayers "bpy.types.AnnotationLayers") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`AnnotationLayer`](AnnotationLayer.md#bpy.types.AnnotationLayer "bpy.types.AnnotationLayer"), (readonly)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.Annotation.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.Annotation.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`BlendData.annotations`](BlendData.md#bpy.types.BlendData.annotations "bpy.types.BlendData.annotations") * [`BlendDataAnnotations.new`](BlendDataAnnotations.md#bpy.types.BlendDataAnnotations.new "bpy.types.BlendDataAnnotations.new") * [`BlendDataAnnotations.remove`](BlendDataAnnotations.md#bpy.types.BlendDataAnnotations.remove "bpy.types.BlendDataAnnotations.remove") * [`MovieClip.annotation`](MovieClip.md#bpy.types.MovieClip.annotation "bpy.types.MovieClip.annotation") * [`MovieTrackingTrack.annotation`](MovieTrackingTrack.md#bpy.types.MovieTrackingTrack.annotation "bpy.types.MovieTrackingTrack.annotation") | * [`NodeTree.annotation`](NodeTree.md#bpy.types.NodeTree.annotation "bpy.types.NodeTree.annotation") * [`Scene.annotation`](Scene.md#bpy.types.Scene.annotation "bpy.types.Scene.annotation") * [`SpaceImageEditor.annotation`](SpaceImageEditor.md#bpy.types.SpaceImageEditor.annotation "bpy.types.SpaceImageEditor.annotation") * [`SpaceSequenceEditor.annotation`](SpaceSequenceEditor.md#bpy.types.SpaceSequenceEditor.annotation "bpy.types.SpaceSequenceEditor.annotation") |

[Next

AnnotationFrame(bpy\_struct)](AnnotationFrame.md)
[Previous
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.Annotation.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.Annotation.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* Annotation(ID)
  + [`Annotation`](#bpy.types.Annotation)
    - [`Annotation.animation_data`](#bpy.types.Annotation.animation_data)
    - [`Annotation.layers`](#bpy.types.Annotation.layers)
    - [`Annotation.bl_rna_get_subclass()`](#bpy.types.Annotation.bl_rna_get_subclass)
    - [`Annotation.bl_rna_get_subclass_py()`](#bpy.types.Annotation.bl_rna_get_subclass_py)
