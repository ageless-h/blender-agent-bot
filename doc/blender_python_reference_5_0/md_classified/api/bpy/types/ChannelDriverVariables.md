...
# ChannelDriverVariables(bpy\_struct)[¶](#channeldrivervariables-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.ChannelDriverVariables(*bpy\_struct*)[¶](#bpy.types.ChannelDriverVariables "Link to this definition")
:   Collection of channel driver Variables

    new()[¶](#bpy.types.ChannelDriverVariables.new "Link to this definition")
    :   Add a new variable for the driver
        ...
        Return type:
        :   [`DriverVariable`](DriverVariable.md#bpy.types.DriverVariable "bpy.types.DriverVariable")

    remove(*variable*)[¶](#bpy.types.ChannelDriverVariables.remove "Link to this definition")
    :   Remove an existing variable from the driver

        Parameters:
        :   **variable** ([`DriverVariable`](DriverVariable.md#bpy.types.DriverVariable "bpy.types.DriverVariable"), (never None)) – Variable to remove from the driver

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ChannelDriverVariables.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ChannelDriverVariables.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Driver.variables`](Driver.md#bpy.types.Driver.variables "bpy.types.Driver.variables") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ChannelDriverVariables.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ChannelDriverVariables.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ChannelDriverVariables(bpy\_struct)
  + [`ChannelDriverVariables`](#bpy.types.ChannelDriverVariables)
    - [`ChannelDriverVariables.new()`](#bpy.types.ChannelDriverVariables.new)
    - [`ChannelDriverVariables.remove()`](#bpy.types.ChannelDriverVariables.remove)
    - [`ChannelDriverVariables.bl_rna_get_subclass()`](#bpy.types.ChannelDriverVariables.bl_rna_get_subclass)
    - [`ChannelDriverVariables.bl_rna_get_subclass_py()`](#bpy.types.ChannelDriverVariables.bl_rna_get_subclass_py)
