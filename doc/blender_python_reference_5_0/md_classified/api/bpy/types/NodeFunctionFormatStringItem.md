...
# NodeFunctionFormatStringItem(bpy\_struct)[¶](#nodefunctionformatstringitem-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.NodeFunctionFormatStringItem(*bpy\_struct*)[¶](#bpy.types.NodeFunctionFormatStringItem "Link to this definition")
:   color[¶](#bpy.types.NodeFunctionFormatStringItem.color "Link to this definition")
    ...
    name[¶](#bpy.types.NodeFunctionFormatStringItem.name "Link to this definition")
    :   Type:
        :   string, default “”, (never None)

    socket\_type[¶](#bpy.types.NodeFunctionFormatStringItem.socket_type "Link to this definition")
    :   Type:
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.NodeFunctionFormatStringItem.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.NodeFunctionFormatStringItem.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`FunctionNodeFormatString.format_items`](FunctionNodeFormatString.md#bpy.types.FunctionNodeFormatString.format_items "bpy.types.FunctionNodeFormatString.format_items") * [`NodeFunctionFormatStringItems.new`](NodeFunctionFormatStringItems.md#bpy.types.NodeFunctionFormatStringItems.new "bpy.types.NodeFunctionFormatStringItems.new") | * [`NodeFunctionFormatStringItems.remove`](NodeFunctionFormatStringItems.md#bpy.types.NodeFunctionFormatStringItems.remove "bpy.types.NodeFunctionFormatStringItems.remove") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.NodeFunctionFormatStringItem.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.NodeFunctionFormatStringItem.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* NodeFunctionFormatStringItem(bpy\_struct)
  + [`NodeFunctionFormatStringItem`](#bpy.types.NodeFunctionFormatStringItem)
    - [`NodeFunctionFormatStringItem.color`](#bpy.types.NodeFunctionFormatStringItem.color)
    - [`NodeFunctionFormatStringItem.name`](#bpy.types.NodeFunctionFormatStringItem.name)
    - [`NodeFunctionFormatStringItem.socket_type`](#bpy.types.NodeFunctionFormatStringItem.socket_type)
    - [`NodeFunctionFormatStringItem.bl_rna_get_subclass()`](#bpy.types.NodeFunctionFormatStringItem.bl_rna_get_subclass)
    - [`NodeFunctionFormatStringItem.bl_rna_get_subclass_py()`](#bpy.types.NodeFunctionFormatStringItem.bl_rna_get_subclass_py)
