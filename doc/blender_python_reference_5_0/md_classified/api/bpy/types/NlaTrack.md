...
# NlaTrack(bpy\_struct)[¶](#nlatrack-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.NlaTrack(*bpy\_struct*)[¶](#bpy.types.NlaTrack "Link to this definition")
:   An animation layer containing Actions referenced as NLA strips

    active[¶](#bpy.types.NlaTrack.active "Link to this definition")
    :   NLA Track is active

        Type:
        :   boolean, default False, (readonly)

    is\_override\_data[¶](#bpy.types.NlaTrack.is_override_data "Link to this definition")
    :   In a local override data, whether this NLA track comes from the linked reference data, or is local to the override

        Type:
        :   boolean, default False, (readonly)

    is\_solo[¶](#bpy.types.NlaTrack.is_solo "Link to this definition")
    :   NLA Track is evaluated itself (i.e. active Action and all other NLA Tracks in the same AnimData block are disabled)

        Type:
        :   boolean, default False

    lock[¶](#bpy.types.NlaTrack.lock "Link to this definition")
    :   NLA Track is locked

        Type:
        :   boolean, default False

    mute[¶](#bpy.types.NlaTrack.mute "Link to this definition")
    :   Disable NLA Track evaluation

        Type:
        :   boolean, default False

    name[¶](#bpy.types.NlaTrack.name "Link to this definition")
    :   Type:
        :   string, default “”, (never None)

    select[¶](#bpy.types.NlaTrack.select "Link to this definition")
    :   NLA Track is selected

        Type:
        :   boolean, default False

    strips[¶](#bpy.types.NlaTrack.strips "Link to this definition")
    :   NLA Strips on this NLA-track

        Type:
        :   [`NlaStrips`](NlaStrips.md#bpy.types.NlaStrips "bpy.types.NlaStrips") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`NlaStrip`](NlaStrip.md#bpy.types.NlaStrip "bpy.types.NlaStrip"), (readonly)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.NlaTrack.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.NlaTrack.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`bpy.context.active_nla_track`](../context/index.md#bpy.context.active_nla_track "bpy.context.active_nla_track") * [`AnimData.nla_tracks`](AnimData.md#bpy.types.AnimData.nla_tracks "bpy.types.AnimData.nla_tracks") * [`NlaTracks.active`](NlaTracks.md#bpy.types.NlaTracks.active "bpy.types.NlaTracks.active") | * [`NlaTracks.new`](NlaTracks.md#bpy.types.NlaTracks.new "bpy.types.NlaTracks.new") * [`NlaTracks.new`](NlaTracks.md#bpy.types.NlaTracks.new "bpy.types.NlaTracks.new") * [`NlaTracks.remove`](NlaTracks.md#bpy.types.NlaTracks.remove "bpy.types.NlaTracks.remove") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.NlaTrack.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.NlaTrack.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* NlaTrack(bpy\_struct)
  + [`NlaTrack`](#bpy.types.NlaTrack)
    - [`NlaTrack.active`](#bpy.types.NlaTrack.active)
    - [`NlaTrack.is_override_data`](#bpy.types.NlaTrack.is_override_data)
    - [`NlaTrack.is_solo`](#bpy.types.NlaTrack.is_solo)
    - [`NlaTrack.lock`](#bpy.types.NlaTrack.lock)
    - [`NlaTrack.mute`](#bpy.types.NlaTrack.mute)
    - [`NlaTrack.name`](#bpy.types.NlaTrack.name)
    - [`NlaTrack.select`](#bpy.types.NlaTrack.select)
    - [`NlaTrack.strips`](#bpy.types.NlaTrack.strips)
    - [`NlaTrack.bl_rna_get_subclass()`](#bpy.types.NlaTrack.bl_rna_get_subclass)
    - [`NlaTrack.bl_rna_get_subclass_py()`](#bpy.types.NlaTrack.bl_rna_get_subclass_py)
