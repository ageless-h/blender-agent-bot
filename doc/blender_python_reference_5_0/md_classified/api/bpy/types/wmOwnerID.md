...
# wmOwnerID(bpy\_struct)[¶](#wmownerid-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.wmOwnerID(*bpy\_struct*)[¶](#bpy.types.wmOwnerID "Link to this definition")
:   name[¶](#bpy.types.wmOwnerID.name "Link to this definition")
    :   Type:
        :   string, default “”, (never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.wmOwnerID.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.wmOwnerID.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`WorkSpace.owner_ids`](WorkSpace.md#bpy.types.WorkSpace.owner_ids "bpy.types.WorkSpace.owner_ids") * [`wmOwnerIDs.new`](wmOwnerIDs.md#bpy.types.wmOwnerIDs.new "bpy.types.wmOwnerIDs.new") | * [`wmOwnerIDs.remove`](wmOwnerIDs.md#bpy.types.wmOwnerIDs.remove "bpy.types.wmOwnerIDs.remove") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.wmOwnerID.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.wmOwnerID.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* wmOwnerID(bpy\_struct)
  + [`wmOwnerID`](#bpy.types.wmOwnerID)
    - [`wmOwnerID.name`](#bpy.types.wmOwnerID.name)
    - [`wmOwnerID.bl_rna_get_subclass()`](#bpy.types.wmOwnerID.bl_rna_get_subclass)
    - [`wmOwnerID.bl_rna_get_subclass_py()`](#bpy.types.wmOwnerID.bl_rna_get_subclass_py)
