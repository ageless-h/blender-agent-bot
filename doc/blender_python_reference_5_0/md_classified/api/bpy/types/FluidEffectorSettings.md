...
# FluidEffectorSettings(bpy\_struct)[¶](#fluideffectorsettings-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.FluidEffectorSettings(*bpy\_struct*)[¶](#bpy.types.FluidEffectorSettings "Link to this definition")
:   Smoke collision settings

    effector\_type[¶](#bpy.types.FluidEffectorSettings.effector_type "Link to this definition")
    ...
    guide\_mode[¶](#bpy.types.FluidEffectorSettings.guide_mode "Link to this definition")
    ...
    subframes[¶](#bpy.types.FluidEffectorSettings.subframes "Link to this definition")
    ...
    surface\_distance[¶](#bpy.types.FluidEffectorSettings.surface_distance "Link to this definition")
    :   Additional distance around mesh surface to consider as effector

        Type:
        :   float in [0, 10], default 0.0

    use\_effector[¶](#bpy.types.FluidEffectorSettings.use_effector "Link to this definition")
    :   Control when to apply the effector

        Type:
        :   boolean, default True

    use\_plane\_init[¶](#bpy.types.FluidEffectorSettings.use_plane_init "Link to this definition")
    :   Treat this object as a planar, unclosed mesh

        Type:
        :   boolean, default False

    velocity\_factor[¶](#bpy.types.FluidEffectorSettings.velocity_factor "Link to this definition")
    :   Multiplier of obstacle velocity

        Type:
        :   float in [-100, 100], default 1.0

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.FluidEffectorSettings.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.FluidEffectorSettings.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`FluidModifier.effector_settings`](FluidModifier.md#bpy.types.FluidModifier.effector_settings "bpy.types.FluidModifier.effector_settings") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.FluidEffectorSettings.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.FluidEffectorSettings.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* FluidEffectorSettings(bpy\_struct)
  + [`FluidEffectorSettings`](#bpy.types.FluidEffectorSettings)
    - [`FluidEffectorSettings.effector_type`](#bpy.types.FluidEffectorSettings.effector_type)
    - [`FluidEffectorSettings.guide_mode`](#bpy.types.FluidEffectorSettings.guide_mode)
    - [`FluidEffectorSettings.subframes`](#bpy.types.FluidEffectorSettings.subframes)
    - [`FluidEffectorSettings.surface_distance`](#bpy.types.FluidEffectorSettings.surface_distance)
    - [`FluidEffectorSettings.use_effector`](#bpy.types.FluidEffectorSettings.use_effector)
    - [`FluidEffectorSettings.use_plane_init`](#bpy.types.FluidEffectorSettings.use_plane_init)
    - [`FluidEffectorSettings.velocity_factor`](#bpy.types.FluidEffectorSettings.velocity_factor)
    - [`FluidEffectorSettings.bl_rna_get_subclass()`](#bpy.types.FluidEffectorSettings.bl_rna_get_subclass)
    - [`FluidEffectorSettings.bl_rna_get_subclass_py()`](#bpy.types.FluidEffectorSettings.bl_rna_get_subclass_py)
