...
# BlendDataSpeakers(bpy\_struct)[¶](#blenddataspeakers-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.BlendDataSpeakers(*bpy\_struct*)[¶](#bpy.types.BlendDataSpeakers "Link to this definition")
:   Collection of speakers

    new(*name*)[¶](#bpy.types.BlendDataSpeakers.new "Link to this definition")
    :   Add a new speaker to the main database
        ...
        Return type:
        :   [`Speaker`](Speaker.md#bpy.types.Speaker "bpy.types.Speaker")

    remove(*speaker*, *\**, *do\_unlink=True*, *do\_id\_user=True*, *do\_ui\_user=True*)[¶](#bpy.types.BlendDataSpeakers.remove "Link to this definition")
    :   Remove a speaker from the current blendfile

        Parameters:
        :   * **speaker** ([`Speaker`](Speaker.md#bpy.types.Speaker "bpy.types.Speaker"), (never None)) – Speaker to remove
            * **do\_unlink** (*boolean**,* *(**optional**)*) – Unlink all usages of this speaker before deleting it (WARNING: will also delete objects instancing that speaker data)
            * **do\_id\_user** (*boolean**,* *(**optional**)*) – Decrement user counter of all data-blocks used by this speaker data
            * **do\_ui\_user** (*boolean**,* *(**optional**)*) – Make sure interface does not reference this speaker data

    tag(*value*)[¶](#bpy.types.BlendDataSpeakers.tag "Link to this definition")
    :   tag

        Parameters:
        :   **value** (*boolean*) – Value

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.BlendDataSpeakers.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.BlendDataSpeakers.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`BlendData.speakers`](BlendData.md#bpy.types.BlendData.speakers "bpy.types.BlendData.speakers") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.BlendDataSpeakers.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.BlendDataSpeakers.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* BlendDataSpeakers(bpy\_struct)
  + [`BlendDataSpeakers`](#bpy.types.BlendDataSpeakers)
    - [`BlendDataSpeakers.new()`](#bpy.types.BlendDataSpeakers.new)
    - [`BlendDataSpeakers.remove()`](#bpy.types.BlendDataSpeakers.remove)
    - [`BlendDataSpeakers.tag()`](#bpy.types.BlendDataSpeakers.tag)
    - [`BlendDataSpeakers.bl_rna_get_subclass()`](#bpy.types.BlendDataSpeakers.bl_rna_get_subclass)
    - [`BlendDataSpeakers.bl_rna_get_subclass_py()`](#bpy.types.BlendDataSpeakers.bl_rna_get_subclass_py)
