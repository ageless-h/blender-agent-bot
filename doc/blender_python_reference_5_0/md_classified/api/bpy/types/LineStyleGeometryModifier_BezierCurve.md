...
# LineStyleGeometryModifier\_BezierCurve(LineStyleGeometryModifier)[¶](#linestylegeometrymodifier-beziercurve-linestylegeometrymodifier "Link to this heading")
...
*class* bpy.types.LineStyleGeometryModifier\_BezierCurve(*LineStyleGeometryModifier*)[¶](#bpy.types.LineStyleGeometryModifier_BezierCurve "Link to this definition")
:   Replace stroke backbone geometry by a Bézier curve approximation of the original backbone geometry

    error[¶](#bpy.types.LineStyleGeometryModifier_BezierCurve.error "Link to this definition")
    :   Maximum distance allowed between the new Bézier curve and the original backbone geometry

        Type:
        :   float in [-inf, inf], default 0.0

    expanded[¶](#bpy.types.LineStyleGeometryModifier_BezierCurve.expanded "Link to this definition")
    :   True if the modifier tab is expanded

        Type:
        :   boolean, default False

    type[¶](#bpy.types.LineStyleGeometryModifier_BezierCurve.type "Link to this definition")
    ...
    use[¶](#bpy.types.LineStyleGeometryModifier_BezierCurve.use "Link to this definition")
    :   Enable or disable this modifier during stroke rendering

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.LineStyleGeometryModifier_BezierCurve.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.LineStyleGeometryModifier_BezierCurve.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
        ...
        Return type:
        :   [type](#bpy.types.LineStyleGeometryModifier_BezierCurve.type "bpy.types.LineStyleGeometryModifier_BezierCurve.type")
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.LineStyleGeometryModifier_BezierCurve.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.LineStyleGeometryModifier_BezierCurve.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* LineStyleGeometryModifier\_BezierCurve(LineStyleGeometryModifier)
  + [`LineStyleGeometryModifier_BezierCurve`](#bpy.types.LineStyleGeometryModifier_BezierCurve)
    - [`LineStyleGeometryModifier_BezierCurve.error`](#bpy.types.LineStyleGeometryModifier_BezierCurve.error)
    - [`LineStyleGeometryModifier_BezierCurve.expanded`](#bpy.types.LineStyleGeometryModifier_BezierCurve.expanded)
    - [`LineStyleGeometryModifier_BezierCurve.type`](#bpy.types.LineStyleGeometryModifier_BezierCurve.type)
    - [`LineStyleGeometryModifier_BezierCurve.use`](#bpy.types.LineStyleGeometryModifier_BezierCurve.use)
    - [`LineStyleGeometryModifier_BezierCurve.bl_rna_get_subclass()`](#bpy.types.LineStyleGeometryModifier_BezierCurve.bl_rna_get_subclass)
    - [`LineStyleGeometryModifier_BezierCurve.bl_rna_get_subclass_py()`](#bpy.types.LineStyleGeometryModifier_BezierCurve.bl_rna_get_subclass_py)
