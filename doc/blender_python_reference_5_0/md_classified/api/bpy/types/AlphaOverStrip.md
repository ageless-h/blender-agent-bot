...
# AlphaOverStrip(EffectStrip)[¶](#alphaoverstrip-effectstrip "Link to this heading")
...
*class* bpy.types.AlphaOverStrip(*EffectStrip*)[¶](#bpy.types.AlphaOverStrip "Link to this definition")
:   Alpha Over Strip

    input\_1[¶](#bpy.types.AlphaOverStrip.input_1 "Link to this definition")
    :   First input for the effect strip

        Type:
        :   [`Strip`](Strip.md#bpy.types.Strip "bpy.types.Strip"), (never None)

    input\_2[¶](#bpy.types.AlphaOverStrip.input_2 "Link to this definition")
    :   Second input for the effect strip

        Type:
        :   [`Strip`](Strip.md#bpy.types.Strip "bpy.types.Strip"), (never None)

    input\_count[¶](#bpy.types.AlphaOverStrip.input_count "Link to this definition")
    :   Type:
        :   int in [0, inf], default 0, (readonly)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.AlphaOverStrip.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.AlphaOverStrip.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
AdjustmentStrip(EffectStrip)](AdjustmentStrip.md)
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.AlphaOverStrip.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.AlphaOverStrip.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* AlphaOverStrip(EffectStrip)
  + [`AlphaOverStrip`](#bpy.types.AlphaOverStrip)
    - [`AlphaOverStrip.input_1`](#bpy.types.AlphaOverStrip.input_1)
    - [`AlphaOverStrip.input_2`](#bpy.types.AlphaOverStrip.input_2)
    - [`AlphaOverStrip.input_count`](#bpy.types.AlphaOverStrip.input_count)
    - [`AlphaOverStrip.bl_rna_get_subclass()`](#bpy.types.AlphaOverStrip.bl_rna_get_subclass)
    - [`AlphaOverStrip.bl_rna_get_subclass_py()`](#bpy.types.AlphaOverStrip.bl_rna_get_subclass_py)
