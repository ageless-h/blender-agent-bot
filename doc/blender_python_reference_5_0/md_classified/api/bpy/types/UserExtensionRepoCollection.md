...
# UserExtensionRepoCollection(bpy\_struct)[¶](#userextensionrepocollection-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.UserExtensionRepoCollection(*bpy\_struct*)[¶](#bpy.types.UserExtensionRepoCollection "Link to this definition")
:   Collection of user extension repositories

    *classmethod* new(*\**, *name=''*, *module=''*, *custom\_directory=''*, *remote\_url=''*, *source='USER'*)[¶](#bpy.types.UserExtensionRepoCollection.new "Link to this definition")
    :   Add a new repository

        Parameters:
        :   * **name** (*string**,* *(**optional**,* *never None**)*) – Name
            * **module** (*string**,* *(**optional**,* *never None**)*) – Module
            * **custom\_directory** (*string**,* *(**optional**,* *never None**)*) – Custom Directory
            * **remote\_url** (*string**,* *(**optional**,* *never None**)*) – Remote URL
        ...
        Return type:
        :   [`UserExtensionRepo`](UserExtensionRepo.md#bpy.types.UserExtensionRepo "bpy.types.UserExtensionRepo")

    *classmethod* remove(*repo*)[¶](#bpy.types.UserExtensionRepoCollection.remove "Link to this definition")
    :   Remove repos

        Parameters:
        :   **repo** ([`UserExtensionRepo`](UserExtensionRepo.md#bpy.types.UserExtensionRepo "bpy.types.UserExtensionRepo"), (never None)) – Repository to remove

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.UserExtensionRepoCollection.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.UserExtensionRepoCollection.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`PreferencesExtensions.repos`](PreferencesExtensions.md#bpy.types.PreferencesExtensions.repos "bpy.types.PreferencesExtensions.repos") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.UserExtensionRepoCollection.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.UserExtensionRepoCollection.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* UserExtensionRepoCollection(bpy\_struct)
  + [`UserExtensionRepoCollection`](#bpy.types.UserExtensionRepoCollection)
    - [`UserExtensionRepoCollection.new()`](#bpy.types.UserExtensionRepoCollection.new)
    - [`UserExtensionRepoCollection.remove()`](#bpy.types.UserExtensionRepoCollection.remove)
    - [`UserExtensionRepoCollection.bl_rna_get_subclass()`](#bpy.types.UserExtensionRepoCollection.bl_rna_get_subclass)
    - [`UserExtensionRepoCollection.bl_rna_get_subclass_py()`](#bpy.types.UserExtensionRepoCollection.bl_rna_get_subclass_py)
