...
# PathCompareCollection(bpy\_struct)[¶](#pathcomparecollection-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.PathCompareCollection(*bpy\_struct*)[¶](#bpy.types.PathCompareCollection "Link to this definition")
:   Collection of paths

    *classmethod* new()[¶](#bpy.types.PathCompareCollection.new "Link to this definition")
    :   Add a new path

        Return type:
        :   [`PathCompare`](PathCompare.md#bpy.types.PathCompare "bpy.types.PathCompare")

    *classmethod* remove(*pathcmp*)[¶](#bpy.types.PathCompareCollection.remove "Link to this definition")
    :   Remove path

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.PathCompareCollection.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.PathCompareCollection.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Preferences.autoexec_paths`](Preferences.md#bpy.types.Preferences.autoexec_paths "bpy.types.Preferences.autoexec_paths") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.PathCompareCollection.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.PathCompareCollection.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* PathCompareCollection(bpy\_struct)
  + [`PathCompareCollection`](#bpy.types.PathCompareCollection)
    - [`PathCompareCollection.new()`](#bpy.types.PathCompareCollection.new)
    - [`PathCompareCollection.remove()`](#bpy.types.PathCompareCollection.remove)
    - [`PathCompareCollection.bl_rna_get_subclass()`](#bpy.types.PathCompareCollection.bl_rna_get_subclass)
    - [`PathCompareCollection.bl_rna_get_subclass_py()`](#bpy.types.PathCompareCollection.bl_rna_get_subclass_py)
