...
# MusgraveTexture(Texture)[¶](#musgravetexture-texture "Link to this heading")
...
*class* bpy.types.MusgraveTexture(*Texture*)[¶](#bpy.types.MusgraveTexture "Link to this definition")
:   Procedural musgrave texture

    dimension\_max[¶](#bpy.types.MusgraveTexture.dimension_max "Link to this definition")
    :   Highest fractal dimension

        Type:
        :   float in [0.0001, 2], default 1.0

    gain[¶](#bpy.types.MusgraveTexture.gain "Link to this definition")
    :   The gain multiplier

        Type:
        :   float in [0, 6], default 1.0

    lacunarity[¶](#bpy.types.MusgraveTexture.lacunarity "Link to this definition")
    :   Gap between successive frequencies

        Type:
        :   float in [0, 6], default 2.0

    musgrave\_type[¶](#bpy.types.MusgraveTexture.musgrave_type "Link to this definition")
    ...
    nabla[¶](#bpy.types.MusgraveTexture.nabla "Link to this definition")
    :   Size of derivative offset used for calculating normal

        Type:
        :   float in [0.001, 0.1], default 0.025

    noise\_basis[¶](#bpy.types.MusgraveTexture.noise_basis "Link to this definition")
    ...
    noise\_intensity[¶](#bpy.types.MusgraveTexture.noise_intensity "Link to this definition")
    :   Intensity of the noise

        Type:
        :   float in [0, 10], default 1.0

    noise\_scale[¶](#bpy.types.MusgraveTexture.noise_scale "Link to this definition")
    :   Scaling for noise input

        Type:
        :   float in [0.0001, inf], default 0.25

    octaves[¶](#bpy.types.MusgraveTexture.octaves "Link to this definition")
    :   Number of frequencies used

        Type:
        :   float in [0, 8], default 2.0

    offset[¶](#bpy.types.MusgraveTexture.offset "Link to this definition")
    :   The fractal offset

        Type:
        :   float in [0, 6], default 1.0

    users\_material[¶](#bpy.types.MusgraveTexture.users_material "Link to this definition")
    ...
    users\_object\_modifier[¶](#bpy.types.MusgraveTexture.users_object_modifier "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.MusgraveTexture.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.MusgraveTexture.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
NDOFMotionEventData(bpy\_struct)](NDOFMotionEventData.md)
[Previous
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.MusgraveTexture.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.MusgraveTexture.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* MusgraveTexture(Texture)
  + [`MusgraveTexture`](#bpy.types.MusgraveTexture)
    - [`MusgraveTexture.dimension_max`](#bpy.types.MusgraveTexture.dimension_max)
    - [`MusgraveTexture.gain`](#bpy.types.MusgraveTexture.gain)
    - [`MusgraveTexture.lacunarity`](#bpy.types.MusgraveTexture.lacunarity)
    - [`MusgraveTexture.musgrave_type`](#bpy.types.MusgraveTexture.musgrave_type)
    - [`MusgraveTexture.nabla`](#bpy.types.MusgraveTexture.nabla)
    - [`MusgraveTexture.noise_basis`](#bpy.types.MusgraveTexture.noise_basis)
    - [`MusgraveTexture.noise_intensity`](#bpy.types.MusgraveTexture.noise_intensity)
    - [`MusgraveTexture.noise_scale`](#bpy.types.MusgraveTexture.noise_scale)
    - [`MusgraveTexture.octaves`](#bpy.types.MusgraveTexture.octaves)
    - [`MusgraveTexture.offset`](#bpy.types.MusgraveTexture.offset)
    - [`MusgraveTexture.users_material`](#bpy.types.MusgraveTexture.users_material)
    - [`MusgraveTexture.users_object_modifier`](#bpy.types.MusgraveTexture.users_object_modifier)
    - [`MusgraveTexture.bl_rna_get_subclass()`](#bpy.types.MusgraveTexture.bl_rna_get_subclass)
    - [`MusgraveTexture.bl_rna_get_subclass_py()`](#bpy.types.MusgraveTexture.bl_rna_get_subclass_py)
