...
# MaskSplines(bpy\_struct)[¶](#masksplines-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.MaskSplines(*bpy\_struct*)[¶](#bpy.types.MaskSplines "Link to this definition")
:   Collection of masking splines

    active[¶](#bpy.types.MaskSplines.active "Link to this definition")
    :   Active spline of masking layer

        Type:
        :   [`MaskSpline`](MaskSpline.md#bpy.types.MaskSpline "bpy.types.MaskSpline")

    active\_point[¶](#bpy.types.MaskSplines.active_point "Link to this definition")
    :   Active point of masking layer

        Type:
        :   [`MaskSplinePoint`](MaskSplinePoint.md#bpy.types.MaskSplinePoint "bpy.types.MaskSplinePoint")

    new()[¶](#bpy.types.MaskSplines.new "Link to this definition")
    ...
    remove(*spline*)[¶](#bpy.types.MaskSplines.remove "Link to this definition")
    :   Remove a spline from a layer

        Parameters:
        :   **spline** ([`MaskSpline`](MaskSpline.md#bpy.types.MaskSpline "bpy.types.MaskSpline"), (never None)) – The spline to remove

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.MaskSplines.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.MaskSplines.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`MaskLayer.splines`](MaskLayer.md#bpy.types.MaskLayer.splines "bpy.types.MaskLayer.splines") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.MaskSplines.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.MaskSplines.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* MaskSplines(bpy\_struct)
  + [`MaskSplines`](#bpy.types.MaskSplines)
    - [`MaskSplines.active`](#bpy.types.MaskSplines.active)
    - [`MaskSplines.active_point`](#bpy.types.MaskSplines.active_point)
    - [`MaskSplines.new()`](#bpy.types.MaskSplines.new)
    - [`MaskSplines.remove()`](#bpy.types.MaskSplines.remove)
    - [`MaskSplines.bl_rna_get_subclass()`](#bpy.types.MaskSplines.bl_rna_get_subclass)
    - [`MaskSplines.bl_rna_get_subclass_py()`](#bpy.types.MaskSplines.bl_rna_get_subclass_py)
