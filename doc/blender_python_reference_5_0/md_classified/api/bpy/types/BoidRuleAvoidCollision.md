...
# BoidRuleAvoidCollision(BoidRule)[¶](#boidruleavoidcollision-boidrule "Link to this heading")
...
*class* bpy.types.BoidRuleAvoidCollision(*BoidRule*)[¶](#bpy.types.BoidRuleAvoidCollision "Link to this definition")
:   look\_ahead[¶](#bpy.types.BoidRuleAvoidCollision.look_ahead "Link to this definition")
    :   Time to look ahead in seconds

        Type:
        :   float in [0, 100], default 0.0

    use\_avoid[¶](#bpy.types.BoidRuleAvoidCollision.use_avoid "Link to this definition")
    :   Avoid collision with other boids

        Type:
        :   boolean, default False

    use\_avoid\_collision[¶](#bpy.types.BoidRuleAvoidCollision.use_avoid_collision "Link to this definition")
    :   Avoid collision with deflector objects

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.BoidRuleAvoidCollision.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.BoidRuleAvoidCollision.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.BoidRuleAvoidCollision.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.BoidRuleAvoidCollision.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* BoidRuleAvoidCollision(BoidRule)
  + [`BoidRuleAvoidCollision`](#bpy.types.BoidRuleAvoidCollision)
    - [`BoidRuleAvoidCollision.look_ahead`](#bpy.types.BoidRuleAvoidCollision.look_ahead)
    - [`BoidRuleAvoidCollision.use_avoid`](#bpy.types.BoidRuleAvoidCollision.use_avoid)
    - [`BoidRuleAvoidCollision.use_avoid_collision`](#bpy.types.BoidRuleAvoidCollision.use_avoid_collision)
    - [`BoidRuleAvoidCollision.bl_rna_get_subclass()`](#bpy.types.BoidRuleAvoidCollision.bl_rna_get_subclass)
    - [`BoidRuleAvoidCollision.bl_rna_get_subclass_py()`](#bpy.types.BoidRuleAvoidCollision.bl_rna_get_subclass_py)
