...
# NodeCompositorFileOutputItem(bpy\_struct)[¶](#nodecompositorfileoutputitem-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.NodeCompositorFileOutputItem(*bpy\_struct*)[¶](#bpy.types.NodeCompositorFileOutputItem "Link to this definition")
:   color[¶](#bpy.types.NodeCompositorFileOutputItem.color "Link to this definition")
    ...
    format[¶](#bpy.types.NodeCompositorFileOutputItem.format "Link to this definition")
    :   Type:
        :   [`ImageFormatSettings`](ImageFormatSettings.md#bpy.types.ImageFormatSettings "bpy.types.ImageFormatSettings"), (readonly)

    name[¶](#bpy.types.NodeCompositorFileOutputItem.name "Link to this definition")
    :   Type:
        :   string, default “”, (never None)

    override\_node\_format[¶](#bpy.types.NodeCompositorFileOutputItem.override_node_format "Link to this definition")
    :   Use a different format instead of the node format for this file

        Type:
        :   boolean, default False

    save\_as\_render[¶](#bpy.types.NodeCompositorFileOutputItem.save_as_render "Link to this definition")
    :   Apply render part of display transform when saving byte image

        Type:
        :   boolean, default False

    socket\_type[¶](#bpy.types.NodeCompositorFileOutputItem.socket_type "Link to this definition")
    :   Type:
    ...
    vector\_socket\_dimensions[¶](#bpy.types.NodeCompositorFileOutputItem.vector_socket_dimensions "Link to this definition")
    :   Dimensions of the vector socket

        Type:
        :   int in [2, 4], default 0

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.NodeCompositorFileOutputItem.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.NodeCompositorFileOutputItem.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`CompositorNodeOutputFile.file_output_items`](CompositorNodeOutputFile.md#bpy.types.CompositorNodeOutputFile.file_output_items "bpy.types.CompositorNodeOutputFile.file_output_items") * [`NodeCompositorFileOutputItems.new`](NodeCompositorFileOutputItems.md#bpy.types.NodeCompositorFileOutputItems.new "bpy.types.NodeCompositorFileOutputItems.new") | * [`NodeCompositorFileOutputItems.remove`](NodeCompositorFileOutputItems.md#bpy.types.NodeCompositorFileOutputItems.remove "bpy.types.NodeCompositorFileOutputItems.remove") |

[Next

NodeCompositorFileOutputItems(bpy\_struct)](NodeCompositorFileOutputItems.md)
[Previous

NodeCombineBundleItems(bpy\_struct)](NodeCombineBundleItems.md)
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.NodeCompositorFileOutputItem.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.NodeCompositorFileOutputItem.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* NodeCompositorFileOutputItem(bpy\_struct)
  + [`NodeCompositorFileOutputItem`](#bpy.types.NodeCompositorFileOutputItem)
    - [`NodeCompositorFileOutputItem.color`](#bpy.types.NodeCompositorFileOutputItem.color)
    - [`NodeCompositorFileOutputItem.format`](#bpy.types.NodeCompositorFileOutputItem.format)
    - [`NodeCompositorFileOutputItem.name`](#bpy.types.NodeCompositorFileOutputItem.name)
    - [`NodeCompositorFileOutputItem.override_node_format`](#bpy.types.NodeCompositorFileOutputItem.override_node_format)
    - [`NodeCompositorFileOutputItem.save_as_render`](#bpy.types.NodeCompositorFileOutputItem.save_as_render)
    - [`NodeCompositorFileOutputItem.socket_type`](#bpy.types.NodeCompositorFileOutputItem.socket_type)
    - [`NodeCompositorFileOutputItem.vector_socket_dimensions`](#bpy.types.NodeCompositorFileOutputItem.vector_socket_dimensions)
    - [`NodeCompositorFileOutputItem.bl_rna_get_subclass()`](#bpy.types.NodeCompositorFileOutputItem.bl_rna_get_subclass)
    - [`NodeCompositorFileOutputItem.bl_rna_get_subclass_py()`](#bpy.types.NodeCompositorFileOutputItem.bl_rna_get_subclass_py)
