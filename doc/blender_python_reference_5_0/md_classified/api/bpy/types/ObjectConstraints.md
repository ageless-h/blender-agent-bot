...
# ObjectConstraints(bpy\_struct)[¶](#objectconstraints-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.ObjectConstraints(*bpy\_struct*)[¶](#bpy.types.ObjectConstraints "Link to this definition")
:   Collection of object constraints

    active[¶](#bpy.types.ObjectConstraints.active "Link to this definition")
    :   Active Object constraint

        Type:
        :   [`Constraint`](Constraint.md#bpy.types.Constraint "bpy.types.Constraint")

    new(*type*)[¶](#bpy.types.ObjectConstraints.new "Link to this definition")
    :   Add a new constraint to this object

        Parameters:
        :   **type** (enum in [Constraint Type Items](../../../appendix/bpy_types_enum_items/constraint_type_items.md#rna-enum-constraint-type-items)) – Constraint type to add
    ...
    remove(*constraint*)[¶](#bpy.types.ObjectConstraints.remove "Link to this definition")
    :   Remove a constraint from this object

        Parameters:
        :   **constraint** ([`Constraint`](Constraint.md#bpy.types.Constraint "bpy.types.Constraint"), (never None)) – Removed constraint

    clear()[¶](#bpy.types.ObjectConstraints.clear "Link to this definition")
    :   Remove all constraint from this object

    move(*from\_index*, *to\_index*)[¶](#bpy.types.ObjectConstraints.move "Link to this definition")
    ...
    copy(*constraint*)[¶](#bpy.types.ObjectConstraints.copy "Link to this definition")
    :   Add a new constraint that is a copy of the given one

        Parameters:
        :   **constraint** ([`Constraint`](Constraint.md#bpy.types.Constraint "bpy.types.Constraint"), (never None)) – Constraint to copy - may belong to a different object
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ObjectConstraints.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ObjectConstraints.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Object.constraints`](Object.md#bpy.types.Object.constraints "bpy.types.Object.constraints") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ObjectConstraints.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ObjectConstraints.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ObjectConstraints(bpy\_struct)
  + [`ObjectConstraints`](#bpy.types.ObjectConstraints)
    - [`ObjectConstraints.active`](#bpy.types.ObjectConstraints.active)
    - [`ObjectConstraints.new()`](#bpy.types.ObjectConstraints.new)
    - [`ObjectConstraints.remove()`](#bpy.types.ObjectConstraints.remove)
    - [`ObjectConstraints.clear()`](#bpy.types.ObjectConstraints.clear)
    - [`ObjectConstraints.move()`](#bpy.types.ObjectConstraints.move)
    - [`ObjectConstraints.copy()`](#bpy.types.ObjectConstraints.copy)
    - [`ObjectConstraints.bl_rna_get_subclass()`](#bpy.types.ObjectConstraints.bl_rna_get_subclass)
    - [`ObjectConstraints.bl_rna_get_subclass_py()`](#bpy.types.ObjectConstraints.bl_rna_get_subclass_py)
