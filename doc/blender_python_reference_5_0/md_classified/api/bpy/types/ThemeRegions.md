...
# ThemeRegions(bpy\_struct)[¶](#themeregions-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.ThemeRegions(*bpy\_struct*)[¶](#bpy.types.ThemeRegions "Link to this definition")
:   Theme settings for regions that are common among editors

    asset\_shelf[¶](#bpy.types.ThemeRegions.asset_shelf "Link to this definition")
    :   Type:
        :   [`ThemeRegionsAssetShelf`](ThemeRegionsAssetShelf.md#bpy.types.ThemeRegionsAssetShelf "bpy.types.ThemeRegionsAssetShelf"), (readonly, never None)

    channels[¶](#bpy.types.ThemeRegions.channels "Link to this definition")
    :   Type:
        :   [`ThemeRegionsChannels`](ThemeRegionsChannels.md#bpy.types.ThemeRegionsChannels "bpy.types.ThemeRegionsChannels"), (readonly, never None)

    scrubbing[¶](#bpy.types.ThemeRegions.scrubbing "Link to this definition")
    :   Type:
        :   [`ThemeRegionsScrubbing`](ThemeRegionsScrubbing.md#bpy.types.ThemeRegionsScrubbing "bpy.types.ThemeRegionsScrubbing"), (readonly, never None)

    sidebars[¶](#bpy.types.ThemeRegions.sidebars "Link to this definition")
    :   Type:
        :   [`ThemeRegionsSidebars`](ThemeRegionsSidebars.md#bpy.types.ThemeRegionsSidebars "bpy.types.ThemeRegionsSidebars"), (readonly, never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ThemeRegions.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ThemeRegions.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Theme.regions`](Theme.md#bpy.types.Theme.regions "bpy.types.Theme.regions") |  |

[Next

ThemeRegionsAssetShelf(bpy\_struct)](ThemeRegionsAssetShelf.md)
[Previous
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ThemeRegions.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ThemeRegions.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ThemeRegions(bpy\_struct)
  + [`ThemeRegions`](#bpy.types.ThemeRegions)
    - [`ThemeRegions.asset_shelf`](#bpy.types.ThemeRegions.asset_shelf)
    - [`ThemeRegions.channels`](#bpy.types.ThemeRegions.channels)
    - [`ThemeRegions.scrubbing`](#bpy.types.ThemeRegions.scrubbing)
    - [`ThemeRegions.sidebars`](#bpy.types.ThemeRegions.sidebars)
    - [`ThemeRegions.bl_rna_get_subclass()`](#bpy.types.ThemeRegions.bl_rna_get_subclass)
    - [`ThemeRegions.bl_rna_get_subclass_py()`](#bpy.types.ThemeRegions.bl_rna_get_subclass_py)
