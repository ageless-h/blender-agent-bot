...
# ThemeRegionsScrubbing(bpy\_struct)[¶](#themeregionsscrubbing-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.ThemeRegionsScrubbing(*bpy\_struct*)[¶](#bpy.types.ThemeRegionsScrubbing "Link to this definition")
:   back[¶](#bpy.types.ThemeRegionsScrubbing.back "Link to this definition")
    :   Type:
        :   float array of 4 items in [0, 1], default (0.0, 0.0, 0.0, 0.0)

    text[¶](#bpy.types.ThemeRegionsScrubbing.text "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    time\_marker[¶](#bpy.types.ThemeRegionsScrubbing.time_marker "Link to this definition")
    :   Type:
        :   float array of 4 items in [0, 1], default (0.0, 0.0, 0.0, 0.0)

    time\_marker\_selected[¶](#bpy.types.ThemeRegionsScrubbing.time_marker_selected "Link to this definition")
    :   Type:
        :   float array of 4 items in [0, 1], default (0.0, 0.0, 0.0, 0.0)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ThemeRegionsScrubbing.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ThemeRegionsScrubbing.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`ThemeRegions.scrubbing`](ThemeRegions.md#bpy.types.ThemeRegions.scrubbing "bpy.types.ThemeRegions.scrubbing") |  |
...
ThemeRegionsChannels(bpy\_struct)](ThemeRegionsChannels.md)
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ThemeRegionsScrubbing.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ThemeRegionsScrubbing.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ThemeRegionsScrubbing(bpy\_struct)
  + [`ThemeRegionsScrubbing`](#bpy.types.ThemeRegionsScrubbing)
    - [`ThemeRegionsScrubbing.back`](#bpy.types.ThemeRegionsScrubbing.back)
    - [`ThemeRegionsScrubbing.text`](#bpy.types.ThemeRegionsScrubbing.text)
    - [`ThemeRegionsScrubbing.time_marker`](#bpy.types.ThemeRegionsScrubbing.time_marker)
    - [`ThemeRegionsScrubbing.time_marker_selected`](#bpy.types.ThemeRegionsScrubbing.time_marker_selected)
    - [`ThemeRegionsScrubbing.bl_rna_get_subclass()`](#bpy.types.ThemeRegionsScrubbing.bl_rna_get_subclass)
    - [`ThemeRegionsScrubbing.bl_rna_get_subclass_py()`](#bpy.types.ThemeRegionsScrubbing.bl_rna_get_subclass_py)
