...
# ConstraintTargetBone(bpy\_struct)[¶](#constrainttargetbone-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.ConstraintTargetBone(*bpy\_struct*)[¶](#bpy.types.ConstraintTargetBone "Link to this definition")
:   Target bone for multi-target constraints

    subtarget[¶](#bpy.types.ConstraintTargetBone.subtarget "Link to this definition")
    :   Target armature bone

        Type:
        :   string, default “”, (never None)

    target[¶](#bpy.types.ConstraintTargetBone.target "Link to this definition")
    :   Target armature

        Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object")

    weight[¶](#bpy.types.ConstraintTargetBone.weight "Link to this definition")
    :   Blending weight of this bone

        Type:
        :   float in [0, 1], default 0.0

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ConstraintTargetBone.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ConstraintTargetBone.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`ArmatureConstraint.targets`](ArmatureConstraint.md#bpy.types.ArmatureConstraint.targets "bpy.types.ArmatureConstraint.targets") * [`ArmatureConstraintTargets.new`](ArmatureConstraintTargets.md#bpy.types.ArmatureConstraintTargets.new "bpy.types.ArmatureConstraintTargets.new") | * [`ArmatureConstraintTargets.remove`](ArmatureConstraintTargets.md#bpy.types.ArmatureConstraintTargets.remove "bpy.types.ArmatureConstraintTargets.remove") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ConstraintTargetBone.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ConstraintTargetBone.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ConstraintTargetBone(bpy\_struct)
  + [`ConstraintTargetBone`](#bpy.types.ConstraintTargetBone)
    - [`ConstraintTargetBone.subtarget`](#bpy.types.ConstraintTargetBone.subtarget)
    - [`ConstraintTargetBone.target`](#bpy.types.ConstraintTargetBone.target)
    - [`ConstraintTargetBone.weight`](#bpy.types.ConstraintTargetBone.weight)
    - [`ConstraintTargetBone.bl_rna_get_subclass()`](#bpy.types.ConstraintTargetBone.bl_rna_get_subclass)
    - [`ConstraintTargetBone.bl_rna_get_subclass_py()`](#bpy.types.ConstraintTargetBone.bl_rna_get_subclass_py)
