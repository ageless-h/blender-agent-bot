...
# GPencilSculptSettings(bpy\_struct)[¶](#gpencilsculptsettings-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.GPencilSculptSettings(*bpy\_struct*)[¶](#bpy.types.GPencilSculptSettings "Link to this definition")
:   General properties for Grease Pencil stroke sculpting tools

    guide[¶](#bpy.types.GPencilSculptSettings.guide "Link to this definition")
    :   Type:
        :   [`GPencilSculptGuide`](GPencilSculptGuide.md#bpy.types.GPencilSculptGuide "bpy.types.GPencilSculptGuide"), (readonly)

    intersection\_threshold[¶](#bpy.types.GPencilSculptSettings.intersection_threshold "Link to this definition")
    :   Threshold for stroke intersections

        Type:
        :   float in [0, 10], default 0.1

    lock\_axis[¶](#bpy.types.GPencilSculptSettings.lock_axis "Link to this definition")
    :   * `VIEW`
    ...
    multiframe\_falloff\_curve[¶](#bpy.types.GPencilSculptSettings.multiframe_falloff_curve "Link to this definition")
    ...
    thickness\_primitive\_curve[¶](#bpy.types.GPencilSculptSettings.thickness_primitive_curve "Link to this definition")
    :   Custom curve to control primitive thickness

        Type:
        :   [`CurveMapping`](CurveMapping.md#bpy.types.CurveMapping "bpy.types.CurveMapping"), (readonly)

    use\_automasking\_layer\_active[¶](#bpy.types.GPencilSculptSettings.use_automasking_layer_active "Link to this definition")
    :   Affect only the Active Layer

        Type:
        :   boolean, default False

    use\_automasking\_layer\_stroke[¶](#bpy.types.GPencilSculptSettings.use_automasking_layer_stroke "Link to this definition")
    :   Affect only strokes below the cursor

        Type:
        :   boolean, default False

    use\_automasking\_material\_active[¶](#bpy.types.GPencilSculptSettings.use_automasking_material_active "Link to this definition")
    :   Affect only the Active Material

        Type:
        :   boolean, default False

    use\_automasking\_material\_stroke[¶](#bpy.types.GPencilSculptSettings.use_automasking_material_stroke "Link to this definition")
    :   Affect only strokes below the cursor

        Type:
        :   boolean, default False

    use\_automasking\_stroke[¶](#bpy.types.GPencilSculptSettings.use_automasking_stroke "Link to this definition")
    :   Affect only strokes below the cursor

        Type:
        :   boolean, default False

    use\_multiframe\_falloff[¶](#bpy.types.GPencilSculptSettings.use_multiframe_falloff "Link to this definition")
    :   Use falloff effect when edit in multiframe mode to compute brush effect by frame

        Type:
        :   boolean, default False

    use\_scale\_thickness[¶](#bpy.types.GPencilSculptSettings.use_scale_thickness "Link to this definition")
    :   Scale the stroke thickness when transforming strokes

        Type:
        :   boolean, default False

    use\_thickness\_curve[¶](#bpy.types.GPencilSculptSettings.use_thickness_curve "Link to this definition")
    :   Use curve to define primitive stroke thickness

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.GPencilSculptSettings.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.GPencilSculptSettings.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`ToolSettings.gpencil_sculpt`](ToolSettings.md#bpy.types.ToolSettings.gpencil_sculpt "bpy.types.ToolSettings.gpencil_sculpt") |  |

[Next

GREASE\_PENCIL\_UL\_attributes(UIList)](GREASE_PENCIL_UL_attributes.md)
[Previous
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GPencilSculptSettings.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.GPencilSculptSettings.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GPencilSculptSettings(bpy\_struct)
  + [`GPencilSculptSettings`](#bpy.types.GPencilSculptSettings)
    - [`GPencilSculptSettings.guide`](#bpy.types.GPencilSculptSettings.guide)
    - [`GPencilSculptSettings.intersection_threshold`](#bpy.types.GPencilSculptSettings.intersection_threshold)
    - [`GPencilSculptSettings.lock_axis`](#bpy.types.GPencilSculptSettings.lock_axis)
    - [`GPencilSculptSettings.multiframe_falloff_curve`](#bpy.types.GPencilSculptSettings.multiframe_falloff_curve)
    - [`GPencilSculptSettings.thickness_primitive_curve`](#bpy.types.GPencilSculptSettings.thickness_primitive_curve)
    - [`GPencilSculptSettings.use_automasking_layer_active`](#bpy.types.GPencilSculptSettings.use_automasking_layer_active)
    - [`GPencilSculptSettings.use_automasking_layer_stroke`](#bpy.types.GPencilSculptSettings.use_automasking_layer_stroke)
    - [`GPencilSculptSettings.use_automasking_material_active`](#bpy.types.GPencilSculptSettings.use_automasking_material_active)
    - [`GPencilSculptSettings.use_automasking_material_stroke`](#bpy.types.GPencilSculptSettings.use_automasking_material_stroke)
    - [`GPencilSculptSettings.use_automasking_stroke`](#bpy.types.GPencilSculptSettings.use_automasking_stroke)
    - [`GPencilSculptSettings.use_multiframe_falloff`](#bpy.types.GPencilSculptSettings.use_multiframe_falloff)
    - [`GPencilSculptSettings.use_scale_thickness`](#bpy.types.GPencilSculptSettings.use_scale_thickness)
    - [`GPencilSculptSettings.use_thickness_curve`](#bpy.types.GPencilSculptSettings.use_thickness_curve)
    - [`GPencilSculptSettings.bl_rna_get_subclass()`](#bpy.types.GPencilSculptSettings.bl_rna_get_subclass)
    - [`GPencilSculptSettings.bl_rna_get_subclass_py()`](#bpy.types.GPencilSculptSettings.bl_rna_get_subclass_py)
