...
# CollisionSettings(bpy\_struct)[¶](#collisionsettings-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.CollisionSettings(*bpy\_struct*)[¶](#bpy.types.CollisionSettings "Link to this definition")
:   Collision settings for object in physics simulation

    absorption[¶](#bpy.types.CollisionSettings.absorption "Link to this definition")
    :   How much of effector force gets lost during collision with this object (in percent)

        Type:
        :   float in [0, 1], default 0.0

    cloth\_friction[¶](#bpy.types.CollisionSettings.cloth_friction "Link to this definition")
    :   Friction for cloth collisions

        Type:
        :   float in [0, 80], default 0.0

    damping[¶](#bpy.types.CollisionSettings.damping "Link to this definition")
    :   Amount of damping during collision

        Type:
        :   float in [0, 1], default 0.0

    damping\_factor[¶](#bpy.types.CollisionSettings.damping_factor "Link to this definition")
    :   Amount of damping during particle collision

        Type:
        :   float in [0, 1], default 0.0

    damping\_random[¶](#bpy.types.CollisionSettings.damping_random "Link to this definition")
    :   Random variation of damping

        Type:
        :   float in [0, 1], default 0.0

    friction\_factor[¶](#bpy.types.CollisionSettings.friction_factor "Link to this definition")
    :   Amount of friction during particle collision

        Type:
        :   float in [0, 1], default 0.0

    friction\_random[¶](#bpy.types.CollisionSettings.friction_random "Link to this definition")
    :   Random variation of friction

        Type:
        :   float in [0, 1], default 0.0

    permeability[¶](#bpy.types.CollisionSettings.permeability "Link to this definition")
    :   Chance that the particle will pass through the mesh

        Type:
        :   float in [0, 1], default 0.0

    stickiness[¶](#bpy.types.CollisionSettings.stickiness "Link to this definition")
    :   Amount of stickiness to surface collision

        Type:
        :   float in [0, 10], default 0.0

    thickness\_inner[¶](#bpy.types.CollisionSettings.thickness_inner "Link to this definition")
    :   Inner face thickness (only used by softbodies)

        Type:
        :   float in [0.001, 1], default 0.0

    thickness\_outer[¶](#bpy.types.CollisionSettings.thickness_outer "Link to this definition")
    :   Outer face thickness

        Type:
        :   float in [0.001, 1], default 0.0

    use[¶](#bpy.types.CollisionSettings.use "Link to this definition")
    :   Enable this object as a collider for physics systems

        Type:
        :   boolean, default False

    use\_culling[¶](#bpy.types.CollisionSettings.use_culling "Link to this definition")
    :   Cloth collision acts with respect to the collider normals (improves penetration recovery)

        Type:
        :   boolean, default False

    use\_normal[¶](#bpy.types.CollisionSettings.use_normal "Link to this definition")
    :   Cloth collision impulses act in the direction of the collider normals (more reliable in some cases)

        Type:
        :   boolean, default False

    use\_particle\_kill[¶](#bpy.types.CollisionSettings.use_particle_kill "Link to this definition")
    :   Kill collided particles

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.CollisionSettings.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.CollisionSettings.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`CollisionModifier.settings`](CollisionModifier.md#bpy.types.CollisionModifier.settings "bpy.types.CollisionModifier.settings") | * [`Object.collision`](Object.md#bpy.types.Object.collision "bpy.types.Object.collision") |

[Next

ColorBalanceModifier(StripModifier)](ColorBalanceModifier.md)
[Previous
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CollisionSettings.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.CollisionSettings.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CollisionSettings(bpy\_struct)
  + [`CollisionSettings`](#bpy.types.CollisionSettings)
    - [`CollisionSettings.absorption`](#bpy.types.CollisionSettings.absorption)
    - [`CollisionSettings.cloth_friction`](#bpy.types.CollisionSettings.cloth_friction)
    - [`CollisionSettings.damping`](#bpy.types.CollisionSettings.damping)
    - [`CollisionSettings.damping_factor`](#bpy.types.CollisionSettings.damping_factor)
    - [`CollisionSettings.damping_random`](#bpy.types.CollisionSettings.damping_random)
    - [`CollisionSettings.friction_factor`](#bpy.types.CollisionSettings.friction_factor)
    - [`CollisionSettings.friction_random`](#bpy.types.CollisionSettings.friction_random)
    - [`CollisionSettings.permeability`](#bpy.types.CollisionSettings.permeability)
    - [`CollisionSettings.stickiness`](#bpy.types.CollisionSettings.stickiness)
    - [`CollisionSettings.thickness_inner`](#bpy.types.CollisionSettings.thickness_inner)
    - [`CollisionSettings.thickness_outer`](#bpy.types.CollisionSettings.thickness_outer)
    - [`CollisionSettings.use`](#bpy.types.CollisionSettings.use)
    - [`CollisionSettings.use_culling`](#bpy.types.CollisionSettings.use_culling)
    - [`CollisionSettings.use_normal`](#bpy.types.CollisionSettings.use_normal)
    - [`CollisionSettings.use_particle_kill`](#bpy.types.CollisionSettings.use_particle_kill)
    - [`CollisionSettings.bl_rna_get_subclass()`](#bpy.types.CollisionSettings.bl_rna_get_subclass)
    - [`CollisionSettings.bl_rna_get_subclass_py()`](#bpy.types.CollisionSettings.bl_rna_get_subclass_py)
