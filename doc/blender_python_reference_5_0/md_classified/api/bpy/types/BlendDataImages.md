...
# BlendDataImages(bpy\_struct)[¶](#blenddataimages-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.BlendDataImages(*bpy\_struct*)[¶](#bpy.types.BlendDataImages "Link to this definition")
:   Collection of images

    new(*name*, *width*, *height*, *\**, *alpha=False*, *float\_buffer=False*, *stereo3d=False*, *is\_data=False*, *tiled=False*)[¶](#bpy.types.BlendDataImages.new "Link to this definition")
    :   Add a new image to the main database
        ...
        :   * **name** (*string**,* *(**never None**)*) – New name for the data-block
            ...
            * **float\_buffer** (*boolean**,* *(**optional**)*) – Float Buffer, Create an image with floating-point color
            * **stereo3d** (*boolean**,* *(**optional**)*) – Stereo 3D, Create left and right views
            * **is\_data** (*boolean**,* *(**optional**)*) – Is Data, Create image with non-color data color space
    ...
    load(*filepath*, *\**, *check\_existing=False*)[¶](#bpy.types.BlendDataImages.load "Link to this definition")
    :   Load a new image into the main database

        Parameters:
        :   * **filepath** (string, (never None, blend relative `//` prefix supported)) – Path of the file to load
            * **check\_existing** (*boolean**,* *(**optional**)*) – Using existing data-block if this file is already loaded
    ...
    remove(*image*, *\**, *do\_unlink=True*, *do\_id\_user=True*, *do\_ui\_user=True*)[¶](#bpy.types.BlendDataImages.remove "Link to this definition")
    :   Remove an image from the current blendfile

        Parameters:
        :   * **image** ([`Image`](Image.md#bpy.types.Image "bpy.types.Image"), (never None)) – Image to remove
            * **do\_unlink** (*boolean**,* *(**optional**)*) – Unlink all usages of this image before deleting it
            * **do\_id\_user** (*boolean**,* *(**optional**)*) – Decrement user counter of all data-blocks used by this image
            * **do\_ui\_user** (*boolean**,* *(**optional**)*) – Make sure interface does not reference this image

    tag(*value*)[¶](#bpy.types.BlendDataImages.tag "Link to this definition")
    :   tag

        Parameters:
        :   **value** (*boolean*) – Value

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.BlendDataImages.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.BlendDataImages.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`BlendData.images`](BlendData.md#bpy.types.BlendData.images "bpy.types.BlendData.images") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.BlendDataImages.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.BlendDataImages.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* BlendDataImages(bpy\_struct)
  + [`BlendDataImages`](#bpy.types.BlendDataImages)
    - [`BlendDataImages.new()`](#bpy.types.BlendDataImages.new)
    - [`BlendDataImages.load()`](#bpy.types.BlendDataImages.load)
    - [`BlendDataImages.remove()`](#bpy.types.BlendDataImages.remove)
    - [`BlendDataImages.tag()`](#bpy.types.BlendDataImages.tag)
    - [`BlendDataImages.bl_rna_get_subclass()`](#bpy.types.BlendDataImages.bl_rna_get_subclass)
    - [`BlendDataImages.bl_rna_get_subclass_py()`](#bpy.types.BlendDataImages.bl_rna_get_subclass_py)
