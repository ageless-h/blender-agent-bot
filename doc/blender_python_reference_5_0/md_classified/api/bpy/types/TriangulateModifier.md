...
# TriangulateModifier(Modifier)[¶](#triangulatemodifier-modifier "Link to this heading")
...
*class* bpy.types.TriangulateModifier(*Modifier*)[¶](#bpy.types.TriangulateModifier "Link to this definition")
:   Triangulate Mesh

    keep\_custom\_normals[¶](#bpy.types.TriangulateModifier.keep_custom_normals "Link to this definition")
    ...
    min\_vertices[¶](#bpy.types.TriangulateModifier.min_vertices "Link to this definition")
    :   Triangulate only polygons with vertex count greater than or equal to this number

        Type:
        :   int in [4, inf], default 4

    ngon\_method[¶](#bpy.types.TriangulateModifier.ngon_method "Link to this definition")
    :   Method for splitting the n-gons into triangles

        Type:
        :   enum in [Modifier Triangulate Ngon Method Items](../../../appendix/bpy_types_enum_items/modifier_triangulate_ngon_method_items.md#rna-enum-modifier-triangulate-ngon-method-items), default `'BEAUTY'`

    quad\_method[¶](#bpy.types.TriangulateModifier.quad_method "Link to this definition")
    :   Method for splitting the quads into triangles

        Type:
        :   enum in [Modifier Triangulate Quad Method Items](../../../appendix/bpy_types_enum_items/modifier_triangulate_quad_method_items.md#rna-enum-modifier-triangulate-quad-method-items), default `'SHORTEST_DIAGONAL'`

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.TriangulateModifier.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.TriangulateModifier.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.TriangulateModifier.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.TriangulateModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* TriangulateModifier(Modifier)
  + [`TriangulateModifier`](#bpy.types.TriangulateModifier)
    - [`TriangulateModifier.keep_custom_normals`](#bpy.types.TriangulateModifier.keep_custom_normals)
    - [`TriangulateModifier.min_vertices`](#bpy.types.TriangulateModifier.min_vertices)
    - [`TriangulateModifier.ngon_method`](#bpy.types.TriangulateModifier.ngon_method)
    - [`TriangulateModifier.quad_method`](#bpy.types.TriangulateModifier.quad_method)
    - [`TriangulateModifier.bl_rna_get_subclass()`](#bpy.types.TriangulateModifier.bl_rna_get_subclass)
    - [`TriangulateModifier.bl_rna_get_subclass_py()`](#bpy.types.TriangulateModifier.bl_rna_get_subclass_py)
