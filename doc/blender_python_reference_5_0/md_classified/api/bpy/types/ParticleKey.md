...
# ParticleKey(bpy\_struct)[¶](#particlekey-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.ParticleKey(*bpy\_struct*)[¶](#bpy.types.ParticleKey "Link to this definition")
:   Key location for a particle over time

    angular\_velocity[¶](#bpy.types.ParticleKey.angular_velocity "Link to this definition")
    ...
    location[¶](#bpy.types.ParticleKey.location "Link to this definition")
    :   Key location

        Type:
        :   [`mathutils.Vector`](../../mathutils/index.md#mathutils.Vector "mathutils.Vector") of 3 items in [-inf, inf], default (0.0, 0.0, 0.0)

    rotation[¶](#bpy.types.ParticleKey.rotation "Link to this definition")
    ...
    time[¶](#bpy.types.ParticleKey.time "Link to this definition")
    :   Time of key over the simulation

        Type:
        :   float in [0, inf], default 0.0

    velocity[¶](#bpy.types.ParticleKey.velocity "Link to this definition")
    :   Key velocity

        Type:
        :   [`mathutils.Vector`](../../mathutils/index.md#mathutils.Vector "mathutils.Vector") of 3 items in [-inf, inf], default (0.0, 0.0, 0.0)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ParticleKey.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ParticleKey.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Particle.particle_keys`](Particle.md#bpy.types.Particle.particle_keys "bpy.types.Particle.particle_keys") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ParticleKey.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ParticleKey.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ParticleKey(bpy\_struct)
  + [`ParticleKey`](#bpy.types.ParticleKey)
    - [`ParticleKey.angular_velocity`](#bpy.types.ParticleKey.angular_velocity)
    - [`ParticleKey.location`](#bpy.types.ParticleKey.location)
    - [`ParticleKey.rotation`](#bpy.types.ParticleKey.rotation)
    - [`ParticleKey.time`](#bpy.types.ParticleKey.time)
    - [`ParticleKey.velocity`](#bpy.types.ParticleKey.velocity)
    - [`ParticleKey.bl_rna_get_subclass()`](#bpy.types.ParticleKey.bl_rna_get_subclass)
    - [`ParticleKey.bl_rna_get_subclass_py()`](#bpy.types.ParticleKey.bl_rna_get_subclass_py)
