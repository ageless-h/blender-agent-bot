...
# ObjectLineArt(bpy\_struct)[¶](#objectlineart-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.ObjectLineArt(*bpy\_struct*)[¶](#bpy.types.ObjectLineArt "Link to this definition")
:   Object Line Art settings

    crease\_threshold[¶](#bpy.types.ObjectLineArt.crease_threshold "Link to this definition")
    :   Angles smaller than this will be treated as creases

        Type:
        :   float in [0, 3.14159], default 0.0

    intersection\_priority[¶](#bpy.types.ObjectLineArt.intersection_priority "Link to this definition")
    :   The intersection line will be included into the object with the higher intersection priority value

        Type:
        :   int in [0, 255], default 0

    usage[¶](#bpy.types.ObjectLineArt.usage "Link to this definition")
    ...
    use\_crease\_override[¶](#bpy.types.ObjectLineArt.use_crease_override "Link to this definition")
    :   Use this object’s crease setting to overwrite scene global

        Type:
        :   boolean, default False

    use\_intersection\_priority\_override[¶](#bpy.types.ObjectLineArt.use_intersection_priority_override "Link to this definition")
    :   Use this object’s intersection priority to override collection setting

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ObjectLineArt.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ObjectLineArt.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Object.lineart`](Object.md#bpy.types.Object.lineart "bpy.types.Object.lineart") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ObjectLineArt.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ObjectLineArt.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ObjectLineArt(bpy\_struct)
  + [`ObjectLineArt`](#bpy.types.ObjectLineArt)
    - [`ObjectLineArt.crease_threshold`](#bpy.types.ObjectLineArt.crease_threshold)
    - [`ObjectLineArt.intersection_priority`](#bpy.types.ObjectLineArt.intersection_priority)
    - [`ObjectLineArt.usage`](#bpy.types.ObjectLineArt.usage)
    - [`ObjectLineArt.use_crease_override`](#bpy.types.ObjectLineArt.use_crease_override)
    - [`ObjectLineArt.use_intersection_priority_override`](#bpy.types.ObjectLineArt.use_intersection_priority_override)
    - [`ObjectLineArt.bl_rna_get_subclass()`](#bpy.types.ObjectLineArt.bl_rna_get_subclass)
    - [`ObjectLineArt.bl_rna_get_subclass_py()`](#bpy.types.ObjectLineArt.bl_rna_get_subclass_py)
