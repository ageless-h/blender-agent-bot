...
# SequencerPreviewOverlay(bpy\_struct)[¶](#sequencerpreviewoverlay-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.SequencerPreviewOverlay(*bpy\_struct*)[¶](#bpy.types.SequencerPreviewOverlay "Link to this definition")
:   show\_annotation[¶](#bpy.types.SequencerPreviewOverlay.show_annotation "Link to this definition")
    :   Show annotations for this view

        Type:
        :   boolean, default False

    show\_cursor[¶](#bpy.types.SequencerPreviewOverlay.show_cursor "Link to this definition")
    :   Type:
        :   boolean, default False

    show\_image\_outline[¶](#bpy.types.SequencerPreviewOverlay.show_image_outline "Link to this definition")
    :   Type:
        :   boolean, default False

    show\_metadata[¶](#bpy.types.SequencerPreviewOverlay.show_metadata "Link to this definition")
    :   Show metadata of first visible strip

        Type:
        :   boolean, default False

    show\_safe\_areas[¶](#bpy.types.SequencerPreviewOverlay.show_safe_areas "Link to this definition")
    :   Show TV title safe and action safe areas in preview

        Type:
        :   boolean, default False

    show\_safe\_center[¶](#bpy.types.SequencerPreviewOverlay.show_safe_center "Link to this definition")
    :   Show safe areas to fit content in a different aspect ratio

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.SequencerPreviewOverlay.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.SequencerPreviewOverlay.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`SpaceSequenceEditor.preview_overlay`](SpaceSequenceEditor.md#bpy.types.SpaceSequenceEditor.preview_overlay "bpy.types.SpaceSequenceEditor.preview_overlay") |  |
...
SequencerCompositorModifierData(StripModifier)](SequencerCompositorModifierData.md)
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.SequencerPreviewOverlay.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.SequencerPreviewOverlay.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* SequencerPreviewOverlay(bpy\_struct)
  + [`SequencerPreviewOverlay`](#bpy.types.SequencerPreviewOverlay)
    - [`SequencerPreviewOverlay.show_annotation`](#bpy.types.SequencerPreviewOverlay.show_annotation)
    - [`SequencerPreviewOverlay.show_cursor`](#bpy.types.SequencerPreviewOverlay.show_cursor)
    - [`SequencerPreviewOverlay.show_image_outline`](#bpy.types.SequencerPreviewOverlay.show_image_outline)
    - [`SequencerPreviewOverlay.show_metadata`](#bpy.types.SequencerPreviewOverlay.show_metadata)
    - [`SequencerPreviewOverlay.show_safe_areas`](#bpy.types.SequencerPreviewOverlay.show_safe_areas)
    - [`SequencerPreviewOverlay.show_safe_center`](#bpy.types.SequencerPreviewOverlay.show_safe_center)
    - [`SequencerPreviewOverlay.bl_rna_get_subclass()`](#bpy.types.SequencerPreviewOverlay.bl_rna_get_subclass)
    - [`SequencerPreviewOverlay.bl_rna_get_subclass_py()`](#bpy.types.SequencerPreviewOverlay.bl_rna_get_subclass_py)
