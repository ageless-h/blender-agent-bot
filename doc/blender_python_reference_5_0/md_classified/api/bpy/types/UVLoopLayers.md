...
# UVLoopLayers(bpy\_struct)[¶](#uvlooplayers-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.UVLoopLayers(*bpy\_struct*)[¶](#bpy.types.UVLoopLayers "Link to this definition")
:   Collection of UV map layers

    active[¶](#bpy.types.UVLoopLayers.active "Link to this definition")
    :   Active UV Map layer

        Type:
        :   [`MeshUVLoopLayer`](MeshUVLoopLayer.md#bpy.types.MeshUVLoopLayer "bpy.types.MeshUVLoopLayer")

    active\_index[¶](#bpy.types.UVLoopLayers.active_index "Link to this definition")
    :   Active UV map index

        Type:
        :   int in [0, inf], default 0

    new(*\**, *name='UVMap'*, *do\_init=True*)[¶](#bpy.types.UVLoopLayers.new "Link to this definition")
    :   Add a UV map layer to Mesh

        Parameters:
        :   * **name** (*string**,* *(**optional**,* *never None**)*) – UV map name
            * **do\_init** (*boolean**,* *(**optional**)*) – Whether new layer’s data should be initialized by copying current active one, or if none is active, with a default UVmap
    ...
    remove(*layer*)[¶](#bpy.types.UVLoopLayers.remove "Link to this definition")
    :   Remove a UV map layer

        Parameters:
        :   **layer** ([`MeshUVLoopLayer`](MeshUVLoopLayer.md#bpy.types.MeshUVLoopLayer "bpy.types.MeshUVLoopLayer"), (never None)) – The layer to remove

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.UVLoopLayers.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.UVLoopLayers.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Mesh.uv_layers`](Mesh.md#bpy.types.Mesh.uv_layers "bpy.types.Mesh.uv_layers") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.UVLoopLayers.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.UVLoopLayers.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* UVLoopLayers(bpy\_struct)
  + [`UVLoopLayers`](#bpy.types.UVLoopLayers)
    - [`UVLoopLayers.active`](#bpy.types.UVLoopLayers.active)
    - [`UVLoopLayers.active_index`](#bpy.types.UVLoopLayers.active_index)
    - [`UVLoopLayers.new()`](#bpy.types.UVLoopLayers.new)
    - [`UVLoopLayers.remove()`](#bpy.types.UVLoopLayers.remove)
    - [`UVLoopLayers.bl_rna_get_subclass()`](#bpy.types.UVLoopLayers.bl_rna_get_subclass)
    - [`UVLoopLayers.bl_rna_get_subclass_py()`](#bpy.types.UVLoopLayers.bl_rna_get_subclass_py)
