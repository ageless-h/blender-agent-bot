...
# CurveMap(bpy\_struct)[¶](#curvemap-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.CurveMap(*bpy\_struct*)[¶](#bpy.types.CurveMap "Link to this definition")
:   Curve in a curve mapping

    points[¶](#bpy.types.CurveMap.points "Link to this definition")
    :   Type:
        :   [`CurveMapPoints`](CurveMapPoints.md#bpy.types.CurveMapPoints "bpy.types.CurveMapPoints") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`CurveMapPoint`](CurveMapPoint.md#bpy.types.CurveMapPoint "bpy.types.CurveMapPoint"), (readonly)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.CurveMap.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.CurveMap.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`CurveMapping.curves`](CurveMapping.md#bpy.types.CurveMapping.curves "bpy.types.CurveMapping.curves") | * [`CurveMapping.evaluate`](CurveMapping.md#bpy.types.CurveMapping.evaluate "bpy.types.CurveMapping.evaluate") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CurveMap.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.CurveMap.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CurveMap(bpy\_struct)
  + [`CurveMap`](#bpy.types.CurveMap)
    - [`CurveMap.points`](#bpy.types.CurveMap.points)
    - [`CurveMap.bl_rna_get_subclass()`](#bpy.types.CurveMap.bl_rna_get_subclass)
    - [`CurveMap.bl_rna_get_subclass_py()`](#bpy.types.CurveMap.bl_rna_get_subclass_py)
