...
# UserExtensionRepo(bpy\_struct)[¶](#userextensionrepo-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.UserExtensionRepo(*bpy\_struct*)[¶](#bpy.types.UserExtensionRepo "Link to this definition")
:   Settings to define an extension repository

    access\_token[¶](#bpy.types.UserExtensionRepo.access_token "Link to this definition")
    :   Personal access token, may be required by some repositories

        Type:
        :   string, default “”, (never None)

    custom\_directory[¶](#bpy.types.UserExtensionRepo.custom_directory "Link to this definition")
    :   The local directory containing extensions

        Type:
        :   string, default “”, (never None)

    directory[¶](#bpy.types.UserExtensionRepo.directory "Link to this definition")
    :   The local directory containing extensions

        Type:
        :   string, default “”, (readonly, never None)

    enabled[¶](#bpy.types.UserExtensionRepo.enabled "Link to this definition")
    :   Enable the repository

        Type:
        :   boolean, default False

    module[¶](#bpy.types.UserExtensionRepo.module "Link to this definition")
    :   Unique module identifier

        Type:
        :   string, default “”, (never None)

    name[¶](#bpy.types.UserExtensionRepo.name "Link to this definition")
    :   Unique repository name

        Type:
        :   string, default “”, (never None)

    remote\_url[¶](#bpy.types.UserExtensionRepo.remote_url "Link to this definition")
    :   Remote URL to the extension repository, the file-system may be referenced using the file URI scheme: “<file://>”

        Type:
        :   string, default “”, (never None)

    source[¶](#bpy.types.UserExtensionRepo.source "Link to this definition")
    ...
    use\_access\_token[¶](#bpy.types.UserExtensionRepo.use_access_token "Link to this definition")
    :   Repository requires an access token

        Type:
        :   boolean, default False

    use\_cache[¶](#bpy.types.UserExtensionRepo.use_cache "Link to this definition")
    :   Downloaded package files are deleted after installation

        Type:
        :   boolean, default False

    use\_custom\_directory[¶](#bpy.types.UserExtensionRepo.use_custom_directory "Link to this definition")
    :   Manually set the path for extensions to be stored. When disabled a user’s extensions directory is created.

        Type:
        :   boolean, default False

    use\_remote\_url[¶](#bpy.types.UserExtensionRepo.use_remote_url "Link to this definition")
    :   Synchronize the repository with a remote URL

        Type:
        :   boolean, default False

    use\_sync\_on\_startup[¶](#bpy.types.UserExtensionRepo.use_sync_on_startup "Link to this definition")
    :   Allow Blender to check for updates upon launch

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.UserExtensionRepo.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.UserExtensionRepo.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`PreferencesExtensions.repos`](PreferencesExtensions.md#bpy.types.PreferencesExtensions.repos "bpy.types.PreferencesExtensions.repos") * [`UserExtensionRepoCollection.new`](UserExtensionRepoCollection.md#bpy.types.UserExtensionRepoCollection.new "bpy.types.UserExtensionRepoCollection.new") | * [`UserExtensionRepoCollection.remove`](UserExtensionRepoCollection.md#bpy.types.UserExtensionRepoCollection.remove "bpy.types.UserExtensionRepoCollection.remove") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.UserExtensionRepo.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.UserExtensionRepo.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* UserExtensionRepo(bpy\_struct)
  + [`UserExtensionRepo`](#bpy.types.UserExtensionRepo)
    - [`UserExtensionRepo.access_token`](#bpy.types.UserExtensionRepo.access_token)
    - [`UserExtensionRepo.custom_directory`](#bpy.types.UserExtensionRepo.custom_directory)
    - [`UserExtensionRepo.directory`](#bpy.types.UserExtensionRepo.directory)
    - [`UserExtensionRepo.enabled`](#bpy.types.UserExtensionRepo.enabled)
    - [`UserExtensionRepo.module`](#bpy.types.UserExtensionRepo.module)
    - [`UserExtensionRepo.name`](#bpy.types.UserExtensionRepo.name)
    - [`UserExtensionRepo.remote_url`](#bpy.types.UserExtensionRepo.remote_url)
    - [`UserExtensionRepo.source`](#bpy.types.UserExtensionRepo.source)
    - [`UserExtensionRepo.use_access_token`](#bpy.types.UserExtensionRepo.use_access_token)
    - [`UserExtensionRepo.use_cache`](#bpy.types.UserExtensionRepo.use_cache)
    - [`UserExtensionRepo.use_custom_directory`](#bpy.types.UserExtensionRepo.use_custom_directory)
    - [`UserExtensionRepo.use_remote_url`](#bpy.types.UserExtensionRepo.use_remote_url)
    - [`UserExtensionRepo.use_sync_on_startup`](#bpy.types.UserExtensionRepo.use_sync_on_startup)
    - [`UserExtensionRepo.bl_rna_get_subclass()`](#bpy.types.UserExtensionRepo.bl_rna_get_subclass)
    - [`UserExtensionRepo.bl_rna_get_subclass_py()`](#bpy.types.UserExtensionRepo.bl_rna_get_subclass_py)
