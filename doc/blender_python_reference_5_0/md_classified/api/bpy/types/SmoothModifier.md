...
# SmoothModifier(Modifier)[¶](#smoothmodifier-modifier "Link to this heading")
...
*class* bpy.types.SmoothModifier(*Modifier*)[¶](#bpy.types.SmoothModifier "Link to this definition")
:   Smoothing effect modifier

    factor[¶](#bpy.types.SmoothModifier.factor "Link to this definition")
    :   Strength of modifier effect

        Type:
        :   float in [-inf, inf], default 0.5

    invert\_vertex\_group[¶](#bpy.types.SmoothModifier.invert_vertex_group "Link to this definition")
    :   Invert vertex group influence

        Type:
        :   boolean, default False

    iterations[¶](#bpy.types.SmoothModifier.iterations "Link to this definition")
    :   Type:
        :   int in [0, 32767], default 1

    use\_x[¶](#bpy.types.SmoothModifier.use_x "Link to this definition")
    :   Smooth object along X axis

        Type:
        :   boolean, default True

    use\_y[¶](#bpy.types.SmoothModifier.use_y "Link to this definition")
    :   Smooth object along Y axis

        Type:
        :   boolean, default True

    use\_z[¶](#bpy.types.SmoothModifier.use_z "Link to this definition")
    :   Smooth object along Z axis

        Type:
        :   boolean, default True

    vertex\_group[¶](#bpy.types.SmoothModifier.vertex_group "Link to this definition")
    :   Name of Vertex Group which determines influence of modifier per point

        Type:
        :   string, default “”, (never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.SmoothModifier.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.SmoothModifier.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.SmoothModifier.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.SmoothModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* SmoothModifier(Modifier)
  + [`SmoothModifier`](#bpy.types.SmoothModifier)
    - [`SmoothModifier.factor`](#bpy.types.SmoothModifier.factor)
    - [`SmoothModifier.invert_vertex_group`](#bpy.types.SmoothModifier.invert_vertex_group)
    - [`SmoothModifier.iterations`](#bpy.types.SmoothModifier.iterations)
    - [`SmoothModifier.use_x`](#bpy.types.SmoothModifier.use_x)
    - [`SmoothModifier.use_y`](#bpy.types.SmoothModifier.use_y)
    - [`SmoothModifier.use_z`](#bpy.types.SmoothModifier.use_z)
    - [`SmoothModifier.vertex_group`](#bpy.types.SmoothModifier.vertex_group)
    - [`SmoothModifier.bl_rna_get_subclass()`](#bpy.types.SmoothModifier.bl_rna_get_subclass)
    - [`SmoothModifier.bl_rna_get_subclass_py()`](#bpy.types.SmoothModifier.bl_rna_get_subclass_py)
