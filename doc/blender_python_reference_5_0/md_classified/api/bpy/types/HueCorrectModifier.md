...
# HueCorrectModifier(StripModifier)[¶](#huecorrectmodifier-stripmodifier "Link to this heading")
...
*class* bpy.types.HueCorrectModifier(*StripModifier*)[¶](#bpy.types.HueCorrectModifier "Link to this definition")
:   Hue correction modifier for sequence strip

    curve\_mapping[¶](#bpy.types.HueCorrectModifier.curve_mapping "Link to this definition")
    :   Type:
        :   [`CurveMapping`](CurveMapping.md#bpy.types.CurveMapping "bpy.types.CurveMapping"), (readonly)

    open\_mask\_input\_panel[¶](#bpy.types.HueCorrectModifier.open_mask_input_panel "Link to this definition")
    :   Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.HueCorrectModifier.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.HueCorrectModifier.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.HueCorrectModifier.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.HueCorrectModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* HueCorrectModifier(StripModifier)
  + [`HueCorrectModifier`](#bpy.types.HueCorrectModifier)
    - [`HueCorrectModifier.curve_mapping`](#bpy.types.HueCorrectModifier.curve_mapping)
    - [`HueCorrectModifier.open_mask_input_panel`](#bpy.types.HueCorrectModifier.open_mask_input_panel)
    - [`HueCorrectModifier.bl_rna_get_subclass()`](#bpy.types.HueCorrectModifier.bl_rna_get_subclass)
    - [`HueCorrectModifier.bl_rna_get_subclass_py()`](#bpy.types.HueCorrectModifier.bl_rna_get_subclass_py)
