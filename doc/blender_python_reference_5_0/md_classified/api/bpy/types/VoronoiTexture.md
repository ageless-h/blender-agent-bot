...
# VoronoiTexture(Texture)[¶](#voronoitexture-texture "Link to this heading")
...
*class* bpy.types.VoronoiTexture(*Texture*)[¶](#bpy.types.VoronoiTexture "Link to this definition")
:   Procedural voronoi texture

    color\_mode[¶](#bpy.types.VoronoiTexture.color_mode "Link to this definition")
    :   * `INTENSITY`
    ...
    distance\_metric[¶](#bpy.types.VoronoiTexture.distance_metric "Link to this definition")
    ...
    minkovsky\_exponent[¶](#bpy.types.VoronoiTexture.minkovsky_exponent "Link to this definition")
    :   Minkowski exponent

        Type:
        :   float in [0.01, 10], default 2.5

    nabla[¶](#bpy.types.VoronoiTexture.nabla "Link to this definition")
    :   Size of derivative offset used for calculating normal

        Type:
        :   float in [0.001, 0.1], default 0.025

    noise\_intensity[¶](#bpy.types.VoronoiTexture.noise_intensity "Link to this definition")
    :   Scales the intensity of the noise

        Type:
        :   float in [0.01, 10], default 1.0

    noise\_scale[¶](#bpy.types.VoronoiTexture.noise_scale "Link to this definition")
    :   Scaling for noise input

        Type:
        :   float in [0.0001, inf], default 0.25

    weight\_1[¶](#bpy.types.VoronoiTexture.weight_1 "Link to this definition")
    :   Voronoi feature weight 1

        Type:
        :   float in [-2, 2], default 1.0

    weight\_2[¶](#bpy.types.VoronoiTexture.weight_2 "Link to this definition")
    :   Voronoi feature weight 2

        Type:
        :   float in [-2, 2], default 0.0

    weight\_3[¶](#bpy.types.VoronoiTexture.weight_3 "Link to this definition")
    :   Voronoi feature weight 3

        Type:
        :   float in [-2, 2], default 0.0

    weight\_4[¶](#bpy.types.VoronoiTexture.weight_4 "Link to this definition")
    :   Voronoi feature weight 4

        Type:
        :   float in [-2, 2], default 0.0

    users\_material[¶](#bpy.types.VoronoiTexture.users_material "Link to this definition")
    ...
    users\_object\_modifier[¶](#bpy.types.VoronoiTexture.users_object_modifier "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.VoronoiTexture.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.VoronoiTexture.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.VoronoiTexture.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.VoronoiTexture.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* VoronoiTexture(Texture)
  + [`VoronoiTexture`](#bpy.types.VoronoiTexture)
    - [`VoronoiTexture.color_mode`](#bpy.types.VoronoiTexture.color_mode)
    - [`VoronoiTexture.distance_metric`](#bpy.types.VoronoiTexture.distance_metric)
    - [`VoronoiTexture.minkovsky_exponent`](#bpy.types.VoronoiTexture.minkovsky_exponent)
    - [`VoronoiTexture.nabla`](#bpy.types.VoronoiTexture.nabla)
    - [`VoronoiTexture.noise_intensity`](#bpy.types.VoronoiTexture.noise_intensity)
    - [`VoronoiTexture.noise_scale`](#bpy.types.VoronoiTexture.noise_scale)
    - [`VoronoiTexture.weight_1`](#bpy.types.VoronoiTexture.weight_1)
    - [`VoronoiTexture.weight_2`](#bpy.types.VoronoiTexture.weight_2)
    - [`VoronoiTexture.weight_3`](#bpy.types.VoronoiTexture.weight_3)
    - [`VoronoiTexture.weight_4`](#bpy.types.VoronoiTexture.weight_4)
    - [`VoronoiTexture.users_material`](#bpy.types.VoronoiTexture.users_material)
    - [`VoronoiTexture.users_object_modifier`](#bpy.types.VoronoiTexture.users_object_modifier)
    - [`VoronoiTexture.bl_rna_get_subclass()`](#bpy.types.VoronoiTexture.bl_rna_get_subclass)
    - [`VoronoiTexture.bl_rna_get_subclass_py()`](#bpy.types.VoronoiTexture.bl_rna_get_subclass_py)
