...
:   Generate a procedural sky texture
    ...
    aerosol\_density[¶](#bpy.types.ShaderNodeTexSky.aerosol_density "Link to this definition")
    ...
    :   Height from sea level
        ...
        Type:
        :   float in [0, 100000], default 100.0
    ...
    :   Which sky model should be used
        ...
        * `HOSEK_WILKIE`
        ...
        Type:
        :   enum in [`'SINGLE_SCATTERING'`, `'MULTIPLE_SCATTERING'`, `'PREETHAM'`, `'HOSEK_WILKIE'`], default `'PREETHAM'`
    ...
    :   Sun angle from horizon
        ...
        Type:
        :   float in [-inf, inf], default 0.261799
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ShaderNodeTexSky.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ShaderNodeTexSky.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ShaderNodeTexSky(ShaderNode)
  + [`ShaderNodeTexSky`](#bpy.types.ShaderNodeTexSky)
    - [`ShaderNodeTexSky.aerosol_density`](#bpy.types.ShaderNodeTexSky.aerosol_density)
