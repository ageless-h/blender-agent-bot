...
# IntAttributeValue(bpy\_struct)[¶](#intattributevalue-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.IntAttributeValue(*bpy\_struct*)[¶](#bpy.types.IntAttributeValue "Link to this definition")
:   Integer value in geometry attribute

    value[¶](#bpy.types.IntAttributeValue.value "Link to this definition")
    :   Type:
        :   int in [-inf, inf], default 0

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.IntAttributeValue.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.IntAttributeValue.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Curves.curve_offset_data`](Curves.md#bpy.types.Curves.curve_offset_data "bpy.types.Curves.curve_offset_data") * [`GreasePencilDrawing.curve_offsets`](GreasePencilDrawing.md#bpy.types.GreasePencilDrawing.curve_offsets "bpy.types.GreasePencilDrawing.curve_offsets") | * [`IntAttribute.data`](IntAttribute.md#bpy.types.IntAttribute.data "bpy.types.IntAttribute.data") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.IntAttributeValue.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.IntAttributeValue.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* IntAttributeValue(bpy\_struct)
  + [`IntAttributeValue`](#bpy.types.IntAttributeValue)
    - [`IntAttributeValue.value`](#bpy.types.IntAttributeValue.value)
    - [`IntAttributeValue.bl_rna_get_subclass()`](#bpy.types.IntAttributeValue.bl_rna_get_subclass)
    - [`IntAttributeValue.bl_rna_get_subclass_py()`](#bpy.types.IntAttributeValue.bl_rna_get_subclass_py)
