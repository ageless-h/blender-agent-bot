...
# GreasePencilTreeNode(bpy\_struct)[¶](#greasepenciltreenode-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

subclasses —
[`GreasePencilLayer`](GreasePencilLayer.md#bpy.types.GreasePencilLayer "bpy.types.GreasePencilLayer"), [`GreasePencilLayerGroup`](GreasePencilLayerGroup.md#bpy.types.GreasePencilLayerGroup "bpy.types.GreasePencilLayerGroup")

*class* bpy.types.GreasePencilTreeNode(*bpy\_struct*)[¶](#bpy.types.GreasePencilTreeNode "Link to this definition")
:   Grease Pencil node in the layer tree. Either a layer or a group

    channel\_color[¶](#bpy.types.GreasePencilTreeNode.channel_color "Link to this definition")
    ...
    hide[¶](#bpy.types.GreasePencilTreeNode.hide "Link to this definition")
    :   Set tree node visibility

        Type:
        :   boolean, default False

    lock[¶](#bpy.types.GreasePencilTreeNode.lock "Link to this definition")
    :   Protect tree node from editing

        Type:
        :   boolean, default False

    name[¶](#bpy.types.GreasePencilTreeNode.name "Link to this definition")
    :   The name of the tree node

        Type:
        :   string, default “”, (never None)

    next\_node[¶](#bpy.types.GreasePencilTreeNode.next_node "Link to this definition")
    :   The layer tree node after (i.e. above) this one

        Type:
        :   [`GreasePencilTreeNode`](#bpy.types.GreasePencilTreeNode "bpy.types.GreasePencilTreeNode"), (readonly)

    parent\_group[¶](#bpy.types.GreasePencilTreeNode.parent_group "Link to this definition")
    :   The parent group of this layer tree node

        Type:
        :   [`GreasePencilLayerGroup`](GreasePencilLayerGroup.md#bpy.types.GreasePencilLayerGroup "bpy.types.GreasePencilLayerGroup"), (readonly)

    prev\_node[¶](#bpy.types.GreasePencilTreeNode.prev_node "Link to this definition")
    :   The layer tree node before (i.e. below) this one

        Type:
        :   [`GreasePencilTreeNode`](#bpy.types.GreasePencilTreeNode "bpy.types.GreasePencilTreeNode"), (readonly)

    select[¶](#bpy.types.GreasePencilTreeNode.select "Link to this definition")
    :   Tree node is selected

        Type:
        :   boolean, default False

    use\_masks[¶](#bpy.types.GreasePencilTreeNode.use_masks "Link to this definition")
    :   The visibility of drawings in this tree node is affected by the layers in the masks list

        Type:
        :   boolean, default False

    use\_onion\_skinning[¶](#bpy.types.GreasePencilTreeNode.use_onion_skinning "Link to this definition")
    :   Display onion skins before and after the current frame

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.GreasePencilTreeNode.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.GreasePencilTreeNode.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`GreasePencilTreeNode.next_node`](#bpy.types.GreasePencilTreeNode.next_node "bpy.types.GreasePencilTreeNode.next_node") | * [`GreasePencilTreeNode.prev_node`](#bpy.types.GreasePencilTreeNode.prev_node "bpy.types.GreasePencilTreeNode.prev_node") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GreasePencilTreeNode.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.GreasePencilTreeNode.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GreasePencilTreeNode(bpy\_struct)
  + [`GreasePencilTreeNode`](#bpy.types.GreasePencilTreeNode)
    - [`GreasePencilTreeNode.channel_color`](#bpy.types.GreasePencilTreeNode.channel_color)
    - [`GreasePencilTreeNode.hide`](#bpy.types.GreasePencilTreeNode.hide)
    - [`GreasePencilTreeNode.lock`](#bpy.types.GreasePencilTreeNode.lock)
    - [`GreasePencilTreeNode.name`](#bpy.types.GreasePencilTreeNode.name)
    - [`GreasePencilTreeNode.next_node`](#bpy.types.GreasePencilTreeNode.next_node)
    - [`GreasePencilTreeNode.parent_group`](#bpy.types.GreasePencilTreeNode.parent_group)
    - [`GreasePencilTreeNode.prev_node`](#bpy.types.GreasePencilTreeNode.prev_node)
    - [`GreasePencilTreeNode.select`](#bpy.types.GreasePencilTreeNode.select)
    - [`GreasePencilTreeNode.use_masks`](#bpy.types.GreasePencilTreeNode.use_masks)
    - [`GreasePencilTreeNode.use_onion_skinning`](#bpy.types.GreasePencilTreeNode.use_onion_skinning)
    - [`GreasePencilTreeNode.bl_rna_get_subclass()`](#bpy.types.GreasePencilTreeNode.bl_rna_get_subclass)
    - [`GreasePencilTreeNode.bl_rna_get_subclass_py()`](#bpy.types.GreasePencilTreeNode.bl_rna_get_subclass_py)
