...
# BlendDataWorlds(bpy\_struct)[¶](#blenddataworlds-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.BlendDataWorlds(*bpy\_struct*)[¶](#bpy.types.BlendDataWorlds "Link to this definition")
:   Collection of worlds

    new(*name*)[¶](#bpy.types.BlendDataWorlds.new "Link to this definition")
    ...
    remove(*world*, *\**, *do\_unlink=True*, *do\_id\_user=True*, *do\_ui\_user=True*)[¶](#bpy.types.BlendDataWorlds.remove "Link to this definition")
    :   Remove a world from the current blendfile

        Parameters:
        :   * **world** ([`World`](World.md#bpy.types.World "bpy.types.World"), (never None)) – World to remove
            * **do\_unlink** (*boolean**,* *(**optional**)*) – Unlink all usages of this world before deleting it
            * **do\_id\_user** (*boolean**,* *(**optional**)*) – Decrement user counter of all data-blocks used by this world
            * **do\_ui\_user** (*boolean**,* *(**optional**)*) – Make sure interface does not reference this world

    tag(*value*)[¶](#bpy.types.BlendDataWorlds.tag "Link to this definition")
    :   tag

        Parameters:
        :   **value** (*boolean*) – Value

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.BlendDataWorlds.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.BlendDataWorlds.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`BlendData.worlds`](BlendData.md#bpy.types.BlendData.worlds "bpy.types.BlendData.worlds") |  |

[Next

BlendFileColorspace(bpy\_struct)](BlendFileColorspace.md)
[Previous
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.BlendDataWorlds.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.BlendDataWorlds.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* BlendDataWorlds(bpy\_struct)
  + [`BlendDataWorlds`](#bpy.types.BlendDataWorlds)
    - [`BlendDataWorlds.new()`](#bpy.types.BlendDataWorlds.new)
    - [`BlendDataWorlds.remove()`](#bpy.types.BlendDataWorlds.remove)
    - [`BlendDataWorlds.tag()`](#bpy.types.BlendDataWorlds.tag)
    - [`BlendDataWorlds.bl_rna_get_subclass()`](#bpy.types.BlendDataWorlds.bl_rna_get_subclass)
    - [`BlendDataWorlds.bl_rna_get_subclass_py()`](#bpy.types.BlendDataWorlds.bl_rna_get_subclass_py)
