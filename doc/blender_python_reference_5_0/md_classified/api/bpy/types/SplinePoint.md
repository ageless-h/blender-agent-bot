...
# SplinePoint(bpy\_struct)[¶](#splinepoint-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.SplinePoint(*bpy\_struct*)[¶](#bpy.types.SplinePoint "Link to this definition")
:   Spline point without handles

    co[¶](#bpy.types.SplinePoint.co "Link to this definition")
    :   Point coordinates

        Type:
        :   [`mathutils.Vector`](../../mathutils/index.md#mathutils.Vector "mathutils.Vector") of 4 items in [-inf, inf], default (0.0, 0.0, 0.0, 0.0)

    hide[¶](#bpy.types.SplinePoint.hide "Link to this definition")
    :   Visibility status

        Type:
        :   boolean, default False

    radius[¶](#bpy.types.SplinePoint.radius "Link to this definition")
    :   Radius for beveling

        Type:
        :   float in [0, inf], default 0.0

    select[¶](#bpy.types.SplinePoint.select "Link to this definition")
    :   Selection status

        Type:
        :   boolean, default False

    tilt[¶](#bpy.types.SplinePoint.tilt "Link to this definition")
    :   Tilt in 3D View

        Type:
        :   float in [-376.991, 376.991], default 0.0

    weight[¶](#bpy.types.SplinePoint.weight "Link to this definition")
    :   NURBS weight

        Type:
        :   float in [-inf, inf], default 0.0

    weight\_softbody[¶](#bpy.types.SplinePoint.weight_softbody "Link to this definition")
    :   Softbody goal weight

        Type:
        :   float in [0.01, 100], default 0.0

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.SplinePoint.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.SplinePoint.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Spline.points`](Spline.md#bpy.types.Spline.points "bpy.types.Spline.points") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.SplinePoint.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.SplinePoint.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* SplinePoint(bpy\_struct)
  + [`SplinePoint`](#bpy.types.SplinePoint)
    - [`SplinePoint.co`](#bpy.types.SplinePoint.co)
    - [`SplinePoint.hide`](#bpy.types.SplinePoint.hide)
    - [`SplinePoint.radius`](#bpy.types.SplinePoint.radius)
    - [`SplinePoint.select`](#bpy.types.SplinePoint.select)
    - [`SplinePoint.tilt`](#bpy.types.SplinePoint.tilt)
    - [`SplinePoint.weight`](#bpy.types.SplinePoint.weight)
    - [`SplinePoint.weight_softbody`](#bpy.types.SplinePoint.weight_softbody)
    - [`SplinePoint.bl_rna_get_subclass()`](#bpy.types.SplinePoint.bl_rna_get_subclass)
    - [`SplinePoint.bl_rna_get_subclass_py()`](#bpy.types.SplinePoint.bl_rna_get_subclass_py)
