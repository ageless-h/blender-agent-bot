...
# NodeGeometryForeachGeometryElementMainItems(bpy\_struct)[¶](#nodegeometryforeachgeometryelementmainitems-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.NodeGeometryForeachGeometryElementMainItems(*bpy\_struct*)[¶](#bpy.types.NodeGeometryForeachGeometryElementMainItems "Link to this definition")
:   Collection of main items

    new(*socket\_type*, *name*)[¶](#bpy.types.NodeGeometryForeachGeometryElementMainItems.new "Link to this definition")
    :   Add an item at the end
        ...
        Return type:
        :   [`ForeachGeometryElementMainItem`](ForeachGeometryElementMainItem.md#bpy.types.ForeachGeometryElementMainItem "bpy.types.ForeachGeometryElementMainItem")

    remove(*item*)[¶](#bpy.types.NodeGeometryForeachGeometryElementMainItems.remove "Link to this definition")
    :   Remove an item

        Parameters:
        :   **item** ([`ForeachGeometryElementMainItem`](ForeachGeometryElementMainItem.md#bpy.types.ForeachGeometryElementMainItem "bpy.types.ForeachGeometryElementMainItem"), (never None)) – Item, The item to remove

    clear()[¶](#bpy.types.NodeGeometryForeachGeometryElementMainItems.clear "Link to this definition")
    :   Remove all items

    move(*from\_index*, *to\_index*)[¶](#bpy.types.NodeGeometryForeachGeometryElementMainItems.move "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.NodeGeometryForeachGeometryElementMainItems.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.NodeGeometryForeachGeometryElementMainItems.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`GeometryNodeForeachGeometryElementOutput.main_items`](GeometryNodeForeachGeometryElementOutput.md#bpy.types.GeometryNodeForeachGeometryElementOutput.main_items "bpy.types.GeometryNodeForeachGeometryElementOutput.main_items") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.NodeGeometryForeachGeometryElementMainItems.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.NodeGeometryForeachGeometryElementMainItems.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* NodeGeometryForeachGeometryElementMainItems(bpy\_struct)
  + [`NodeGeometryForeachGeometryElementMainItems`](#bpy.types.NodeGeometryForeachGeometryElementMainItems)
    - [`NodeGeometryForeachGeometryElementMainItems.new()`](#bpy.types.NodeGeometryForeachGeometryElementMainItems.new)
    - [`NodeGeometryForeachGeometryElementMainItems.remove()`](#bpy.types.NodeGeometryForeachGeometryElementMainItems.remove)
    - [`NodeGeometryForeachGeometryElementMainItems.clear()`](#bpy.types.NodeGeometryForeachGeometryElementMainItems.clear)
    - [`NodeGeometryForeachGeometryElementMainItems.move()`](#bpy.types.NodeGeometryForeachGeometryElementMainItems.move)
    - [`NodeGeometryForeachGeometryElementMainItems.bl_rna_get_subclass()`](#bpy.types.NodeGeometryForeachGeometryElementMainItems.bl_rna_get_subclass)
    - [`NodeGeometryForeachGeometryElementMainItems.bl_rna_get_subclass_py()`](#bpy.types.NodeGeometryForeachGeometryElementMainItems.bl_rna_get_subclass_py)
