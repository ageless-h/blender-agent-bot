...
# QuaternionAttributeValue(bpy\_struct)[¶](#quaternionattributevalue-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.QuaternionAttributeValue(*bpy\_struct*)[¶](#bpy.types.QuaternionAttributeValue "Link to this definition")
:   Rotation value in geometry attribute

    value[¶](#bpy.types.QuaternionAttributeValue.value "Link to this definition")
    :   Quaternion

        Type:
        :   float array of 4 items in [-inf, inf], default (0.0, 0.0, 0.0, 0.0)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.QuaternionAttributeValue.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.QuaternionAttributeValue.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`QuaternionAttribute.data`](QuaternionAttribute.md#bpy.types.QuaternionAttribute.data "bpy.types.QuaternionAttribute.data") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.QuaternionAttributeValue.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.QuaternionAttributeValue.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* QuaternionAttributeValue(bpy\_struct)
  + [`QuaternionAttributeValue`](#bpy.types.QuaternionAttributeValue)
    - [`QuaternionAttributeValue.value`](#bpy.types.QuaternionAttributeValue.value)
    - [`QuaternionAttributeValue.bl_rna_get_subclass()`](#bpy.types.QuaternionAttributeValue.bl_rna_get_subclass)
    - [`QuaternionAttributeValue.bl_rna_get_subclass_py()`](#bpy.types.QuaternionAttributeValue.bl_rna_get_subclass_py)
