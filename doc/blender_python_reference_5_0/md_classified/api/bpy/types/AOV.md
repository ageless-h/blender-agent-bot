...
# AOV(bpy\_struct)[¶](#aov-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.AOV(*bpy\_struct*)[¶](#bpy.types.AOV "Link to this definition")
:   is\_valid[¶](#bpy.types.AOV.is_valid "Link to this definition")
    :   Is the name of the AOV conflicting

        Type:
        :   boolean, default False

    name[¶](#bpy.types.AOV.name "Link to this definition")
    :   Name of the AOV

        Type:
        :   string, default “”, (never None)

    type[¶](#bpy.types.AOV.type "Link to this definition")
    :   Data type of the AOV

        Type:
        :   enum in [`'COLOR'`, `'VALUE'`], default `'COLOR'`

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.AOV.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.AOV.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`AOVs.add`](AOVs.md#bpy.types.AOVs.add "bpy.types.AOVs.add") * [`AOVs.remove`](AOVs.md#bpy.types.AOVs.remove "bpy.types.AOVs.remove") | * [`ViewLayer.active_aov`](ViewLayer.md#bpy.types.ViewLayer.active_aov "bpy.types.ViewLayer.active_aov") * [`ViewLayer.aovs`](ViewLayer.md#bpy.types.ViewLayer.aovs "bpy.types.ViewLayer.aovs") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.AOV.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.AOV.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* AOV(bpy\_struct)
  + [`AOV`](#bpy.types.AOV)
    - [`AOV.is_valid`](#bpy.types.AOV.is_valid)
    - [`AOV.name`](#bpy.types.AOV.name)
    - [`AOV.type`](#bpy.types.AOV.type)
    - [`AOV.bl_rna_get_subclass()`](#bpy.types.AOV.bl_rna_get_subclass)
    - [`AOV.bl_rna_get_subclass_py()`](#bpy.types.AOV.bl_rna_get_subclass_py)
