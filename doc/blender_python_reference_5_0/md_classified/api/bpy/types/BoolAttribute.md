...
# BoolAttribute(Attribute)[¶](#boolattribute-attribute "Link to this heading")
...
*class* bpy.types.BoolAttribute(*Attribute*)[¶](#bpy.types.BoolAttribute "Link to this definition")
:   Geometry attribute that stores booleans

    data[¶](#bpy.types.BoolAttribute.data "Link to this definition")
    :   Type:
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.BoolAttribute.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.BoolAttribute.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`MeshUVLoopLayer.pin_ensure`](MeshUVLoopLayer.md#bpy.types.MeshUVLoopLayer.pin_ensure "bpy.types.MeshUVLoopLayer.pin_ensure") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.BoolAttribute.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.BoolAttribute.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* BoolAttribute(Attribute)
  + [`BoolAttribute`](#bpy.types.BoolAttribute)
    - [`BoolAttribute.data`](#bpy.types.BoolAttribute.data)
    - [`BoolAttribute.bl_rna_get_subclass()`](#bpy.types.BoolAttribute.bl_rna_get_subclass)
    - [`BoolAttribute.bl_rna_get_subclass_py()`](#bpy.types.BoolAttribute.bl_rna_get_subclass_py)
