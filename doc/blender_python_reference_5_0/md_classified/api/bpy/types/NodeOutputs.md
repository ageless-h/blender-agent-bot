...
# NodeOutputs(bpy\_struct)[¶](#nodeoutputs-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.NodeOutputs(*bpy\_struct*)[¶](#bpy.types.NodeOutputs "Link to this definition")
:   Collection of Node Sockets

    new(*type*, *name*, *\**, *identifier=''*, *use\_multi\_input=False*)[¶](#bpy.types.NodeOutputs.new "Link to this definition")
    :   Add a socket to this node
        ...
        :   * **type** (*string**,* *(**never None**)*) – Type, Data type
            ...
            * **use\_multi\_input** (*boolean**,* *(**optional**)*) – Make the socket multi-input (valid for inputs only)
    ...
    remove(*socket*)[¶](#bpy.types.NodeOutputs.remove "Link to this definition")
    ...
    clear()[¶](#bpy.types.NodeOutputs.clear "Link to this definition")
    :   Remove all sockets from this node

    move(*from\_index*, *to\_index*)[¶](#bpy.types.NodeOutputs.move "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.NodeOutputs.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.NodeOutputs.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Node.outputs`](Node.md#bpy.types.Node.outputs "bpy.types.Node.outputs") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.NodeOutputs.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.NodeOutputs.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* NodeOutputs(bpy\_struct)
  + [`NodeOutputs`](#bpy.types.NodeOutputs)
    - [`NodeOutputs.new()`](#bpy.types.NodeOutputs.new)
    - [`NodeOutputs.remove()`](#bpy.types.NodeOutputs.remove)
    - [`NodeOutputs.clear()`](#bpy.types.NodeOutputs.clear)
    - [`NodeOutputs.move()`](#bpy.types.NodeOutputs.move)
    - [`NodeOutputs.bl_rna_get_subclass()`](#bpy.types.NodeOutputs.bl_rna_get_subclass)
    - [`NodeOutputs.bl_rna_get_subclass_py()`](#bpy.types.NodeOutputs.bl_rna_get_subclass_py)
