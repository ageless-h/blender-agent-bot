...
# UvSculpt(bpy\_struct)[¶](#uvsculpt-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.UvSculpt(*bpy\_struct*)[¶](#bpy.types.UvSculpt "Link to this definition")
:   curve\_distance\_falloff[¶](#bpy.types.UvSculpt.curve_distance_falloff "Link to this definition")
    :   Type:
        :   [`CurveMapping`](CurveMapping.md#bpy.types.CurveMapping "bpy.types.CurveMapping"), (readonly)

    curve\_distance\_falloff\_preset[¶](#bpy.types.UvSculpt.curve_distance_falloff_preset "Link to this definition")
    :   Type:
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.UvSculpt.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.UvSculpt.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* UvSculpt(bpy\_struct)
  + [`UvSculpt`](#bpy.types.UvSculpt)
    - [`UvSculpt.curve_distance_falloff`](#bpy.types.UvSculpt.curve_distance_falloff)
    - [`UvSculpt.curve_distance_falloff_preset`](#bpy.types.UvSculpt.curve_distance_falloff_preset)
