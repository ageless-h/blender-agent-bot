...
# SpreadsheetTable(bpy\_struct)[¶](#spreadsheettable-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.SpreadsheetTable(*bpy\_struct*)[¶](#bpy.types.SpreadsheetTable "Link to this definition")
:   Persistent data associated with a table

    columns[¶](#bpy.types.SpreadsheetTable.columns "Link to this definition")
    ...
    id[¶](#bpy.types.SpreadsheetTable.id "Link to this definition")
    :   Data used to identify the table

        Type:
        :   [`SpreadsheetTableID`](SpreadsheetTableID.md#bpy.types.SpreadsheetTableID "bpy.types.SpreadsheetTableID"), (readonly)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.SpreadsheetTable.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.SpreadsheetTable.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`SpaceSpreadsheet.tables`](SpaceSpreadsheet.md#bpy.types.SpaceSpreadsheet.tables "bpy.types.SpaceSpreadsheet.tables") | * [`SpreadsheetTables.active`](SpreadsheetTables.md#bpy.types.SpreadsheetTables.active "bpy.types.SpreadsheetTables.active") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.SpreadsheetTable.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.SpreadsheetTable.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* SpreadsheetTable(bpy\_struct)
  + [`SpreadsheetTable`](#bpy.types.SpreadsheetTable)
    - [`SpreadsheetTable.columns`](#bpy.types.SpreadsheetTable.columns)
    - [`SpreadsheetTable.id`](#bpy.types.SpreadsheetTable.id)
    - [`SpreadsheetTable.bl_rna_get_subclass()`](#bpy.types.SpreadsheetTable.bl_rna_get_subclass)
    - [`SpreadsheetTable.bl_rna_get_subclass_py()`](#bpy.types.SpreadsheetTable.bl_rna_get_subclass_py)
