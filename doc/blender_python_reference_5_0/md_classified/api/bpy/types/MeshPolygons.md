...
# MeshPolygons(bpy\_struct)[¶](#meshpolygons-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.MeshPolygons(*bpy\_struct*)[¶](#bpy.types.MeshPolygons "Link to this definition")
:   Collection of mesh polygons

    active[¶](#bpy.types.MeshPolygons.active "Link to this definition")
    :   The active face for this mesh

        Type:
        :   int in [-inf, inf], default 0

    add(*count*)[¶](#bpy.types.MeshPolygons.add "Link to this definition")
    :   add

        Parameters:
        :   **count** (*int in* *[**0**,* *inf**]*) – Count, Number of polygons to add

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.MeshPolygons.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.MeshPolygons.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.MeshPolygons.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.MeshPolygons.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* MeshPolygons(bpy\_struct)
  + [`MeshPolygons`](#bpy.types.MeshPolygons)
    - [`MeshPolygons.active`](#bpy.types.MeshPolygons.active)
    - [`MeshPolygons.add()`](#bpy.types.MeshPolygons.add)
    - [`MeshPolygons.bl_rna_get_subclass()`](#bpy.types.MeshPolygons.bl_rna_get_subclass)
    - [`MeshPolygons.bl_rna_get_subclass_py()`](#bpy.types.MeshPolygons.bl_rna_get_subclass_py)
