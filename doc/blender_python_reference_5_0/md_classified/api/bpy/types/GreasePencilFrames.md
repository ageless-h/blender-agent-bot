...
# GreasePencilFrames(bpy\_struct)[¶](#greasepencilframes-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.GreasePencilFrames(*bpy\_struct*)[¶](#bpy.types.GreasePencilFrames "Link to this definition")
:   Collection of Grease Pencil frames

    new(*frame\_number*)[¶](#bpy.types.GreasePencilFrames.new "Link to this definition")
    :   Add a new Grease Pencil frame

        Parameters:
        :   **frame\_number** (*int in* *[**-1048574**,* *1048574**]*) – Frame Number, The frame on which the drawing appears
    ...
    remove(*frame\_number*)[¶](#bpy.types.GreasePencilFrames.remove "Link to this definition")
    :   Remove a Grease Pencil frame

        Parameters:
        :   **frame\_number** (*int in* *[**-1048574**,* *1048574**]*) – Frame Number, The frame number of the frame to remove

    copy(*from\_frame\_number*, *to\_frame\_number*, *\**, *instance\_drawing=False*)[¶](#bpy.types.GreasePencilFrames.copy "Link to this definition")
    :   Copy a Grease Pencil frame

        Parameters:
        :   * **from\_frame\_number** (*int in* *[**-1048574**,* *1048574**]*) – Source Frame Number, The frame number of the source frame
            * **to\_frame\_number** (*int in* *[**-1048574**,* *1048574**]*) – Frame Number of Copy, The frame number to copy the frame to
            * **instance\_drawing** (*boolean**,* *(**optional**)*) – Instance Drawing, Let the copied frame use the same drawing as the source
    ...
    move(*from\_frame\_number*, *to\_frame\_number*)[¶](#bpy.types.GreasePencilFrames.move "Link to this definition")
    :   Move a Grease Pencil frame

        Parameters:
        :   * **from\_frame\_number** (*int in* *[**-1048574**,* *1048574**]*) – Source Frame Number, The frame number of the source frame
            * **to\_frame\_number** (*int in* *[**-1048574**,* *1048574**]*) – Target Frame Number, The frame number to move the frame to
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.GreasePencilFrames.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.GreasePencilFrames.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`GreasePencilLayer.frames`](GreasePencilLayer.md#bpy.types.GreasePencilLayer.frames "bpy.types.GreasePencilLayer.frames") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GreasePencilFrames.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.GreasePencilFrames.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GreasePencilFrames(bpy\_struct)
  + [`GreasePencilFrames`](#bpy.types.GreasePencilFrames)
    - [`GreasePencilFrames.new()`](#bpy.types.GreasePencilFrames.new)
    - [`GreasePencilFrames.remove()`](#bpy.types.GreasePencilFrames.remove)
    - [`GreasePencilFrames.copy()`](#bpy.types.GreasePencilFrames.copy)
    - [`GreasePencilFrames.move()`](#bpy.types.GreasePencilFrames.move)
    - [`GreasePencilFrames.bl_rna_get_subclass()`](#bpy.types.GreasePencilFrames.bl_rna_get_subclass)
    - [`GreasePencilFrames.bl_rna_get_subclass_py()`](#bpy.types.GreasePencilFrames.bl_rna_get_subclass_py)
