...
# GeometryNodeGridPrune(GeometryNode)[¶](#geometrynodegridprune-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeGridPrune(*GeometryNode*)[¶](#bpy.types.GeometryNodeGridPrune "Link to this definition")
:   Make the storage of a volume grid more efficient by collapsing data into tiles or inner nodes

    data\_type[¶](#bpy.types.GeometryNodeGridPrune.data_type "Link to this definition")
    ...
    *classmethod* is\_registered\_node\_type()[¶](#bpy.types.GeometryNodeGridPrune.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[¶](#bpy.types.GeometryNodeGridPrune.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[¶](#bpy.types.GeometryNodeGridPrune.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.GeometryNodeGridPrune.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.GeometryNodeGridPrune.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
GeometryNodeGridLaplacian(GeometryNode)](GeometryNodeGridLaplacian.md)
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeGridPrune.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.GeometryNodeGridPrune.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeGridPrune(GeometryNode)
  + [`GeometryNodeGridPrune`](#bpy.types.GeometryNodeGridPrune)
    - [`GeometryNodeGridPrune.data_type`](#bpy.types.GeometryNodeGridPrune.data_type)
    - [`GeometryNodeGridPrune.is_registered_node_type()`](#bpy.types.GeometryNodeGridPrune.is_registered_node_type)
    - [`GeometryNodeGridPrune.input_template()`](#bpy.types.GeometryNodeGridPrune.input_template)
    - [`GeometryNodeGridPrune.output_template()`](#bpy.types.GeometryNodeGridPrune.output_template)
    - [`GeometryNodeGridPrune.bl_rna_get_subclass()`](#bpy.types.GeometryNodeGridPrune.bl_rna_get_subclass)
    - [`GeometryNodeGridPrune.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeGridPrune.bl_rna_get_subclass_py)
