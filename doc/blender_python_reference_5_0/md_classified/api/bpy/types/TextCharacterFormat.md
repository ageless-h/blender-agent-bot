...
# TextCharacterFormat(bpy\_struct)[¶](#textcharacterformat-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.TextCharacterFormat(*bpy\_struct*)[¶](#bpy.types.TextCharacterFormat "Link to this definition")
:   Text character formatting settings

    kerning[¶](#bpy.types.TextCharacterFormat.kerning "Link to this definition")
    :   Spacing between characters

        Type:
        :   float in [-inf, inf], default 0.0

    material\_index[¶](#bpy.types.TextCharacterFormat.material_index "Link to this definition")
    :   Material slot index of this character

        Type:
        :   int in [0, inf], default 0

    use\_bold[¶](#bpy.types.TextCharacterFormat.use_bold "Link to this definition")
    :   Type:
        :   boolean, default False

    use\_italic[¶](#bpy.types.TextCharacterFormat.use_italic "Link to this definition")
    :   Type:
        :   boolean, default False

    use\_small\_caps[¶](#bpy.types.TextCharacterFormat.use_small_caps "Link to this definition")
    :   Type:
        :   boolean, default False

    use\_underline[¶](#bpy.types.TextCharacterFormat.use_underline "Link to this definition")
    :   Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.TextCharacterFormat.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.TextCharacterFormat.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`TextCurve.body_format`](TextCurve.md#bpy.types.TextCurve.body_format "bpy.types.TextCurve.body_format") | * [`TextCurve.edit_format`](TextCurve.md#bpy.types.TextCurve.edit_format "bpy.types.TextCurve.edit_format") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.TextCharacterFormat.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.TextCharacterFormat.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* TextCharacterFormat(bpy\_struct)
  + [`TextCharacterFormat`](#bpy.types.TextCharacterFormat)
    - [`TextCharacterFormat.kerning`](#bpy.types.TextCharacterFormat.kerning)
    - [`TextCharacterFormat.material_index`](#bpy.types.TextCharacterFormat.material_index)
    - [`TextCharacterFormat.use_bold`](#bpy.types.TextCharacterFormat.use_bold)
    - [`TextCharacterFormat.use_italic`](#bpy.types.TextCharacterFormat.use_italic)
    - [`TextCharacterFormat.use_small_caps`](#bpy.types.TextCharacterFormat.use_small_caps)
    - [`TextCharacterFormat.use_underline`](#bpy.types.TextCharacterFormat.use_underline)
    - [`TextCharacterFormat.bl_rna_get_subclass()`](#bpy.types.TextCharacterFormat.bl_rna_get_subclass)
    - [`TextCharacterFormat.bl_rna_get_subclass_py()`](#bpy.types.TextCharacterFormat.bl_rna_get_subclass_py)
