...
# LineStyleThicknessModifier\_AlongStroke(LineStyleThicknessModifier)[¶](#linestylethicknessmodifier-alongstroke-linestylethicknessmodifier "Link to this heading")
...
*class* bpy.types.LineStyleThicknessModifier\_AlongStroke(*LineStyleThicknessModifier*)[¶](#bpy.types.LineStyleThicknessModifier_AlongStroke "Link to this definition")
:   Change line thickness along stroke

    blend[¶](#bpy.types.LineStyleThicknessModifier_AlongStroke.blend "Link to this definition")
    :   Specify how the modifier value is blended into the base value

        Type:
        :   enum in [`'MIX'`, `'ADD'`, `'SUBTRACT'`, `'MULTIPLY'`, `'DIVIDE'`, `'DIFFERENCE'`, `'MINIMUM'`, `'MAXIMUM'`], default `'MIX'`

    curve[¶](#bpy.types.LineStyleThicknessModifier_AlongStroke.curve "Link to this definition")
    :   Curve used for the curve mapping

        Type:
        :   [`CurveMapping`](CurveMapping.md#bpy.types.CurveMapping "bpy.types.CurveMapping"), (readonly)

    expanded[¶](#bpy.types.LineStyleThicknessModifier_AlongStroke.expanded "Link to this definition")
    :   True if the modifier tab is expanded

        Type:
        :   boolean, default False

    influence[¶](#bpy.types.LineStyleThicknessModifier_AlongStroke.influence "Link to this definition")
    :   Influence factor by which the modifier changes the property

        Type:
        :   float in [0, 1], default 0.0

    invert[¶](#bpy.types.LineStyleThicknessModifier_AlongStroke.invert "Link to this definition")
    :   Invert the fade-out direction of the linear mapping

        Type:
        :   boolean, default False

    mapping[¶](#bpy.types.LineStyleThicknessModifier_AlongStroke.mapping "Link to this definition")
    ...
    type[¶](#bpy.types.LineStyleThicknessModifier_AlongStroke.type "Link to this definition")
    ...
    use[¶](#bpy.types.LineStyleThicknessModifier_AlongStroke.use "Link to this definition")
    :   Enable or disable this modifier during stroke rendering

        Type:
        :   boolean, default False

    value\_max[¶](#bpy.types.LineStyleThicknessModifier_AlongStroke.value_max "Link to this definition")
    :   Maximum output value of the mapping

        Type:
        :   float in [-inf, inf], default 0.0

    value\_min[¶](#bpy.types.LineStyleThicknessModifier_AlongStroke.value_min "Link to this definition")
    :   Minimum output value of the mapping

        Type:
        :   float in [-inf, inf], default 0.0

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.LineStyleThicknessModifier_AlongStroke.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.LineStyleThicknessModifier_AlongStroke.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.LineStyleThicknessModifier_AlongStroke.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.LineStyleThicknessModifier_AlongStroke.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* LineStyleThicknessModifier\_AlongStroke(LineStyleThicknessModifier)
  + [`LineStyleThicknessModifier_AlongStroke`](#bpy.types.LineStyleThicknessModifier_AlongStroke)
    - [`LineStyleThicknessModifier_AlongStroke.blend`](#bpy.types.LineStyleThicknessModifier_AlongStroke.blend)
    - [`LineStyleThicknessModifier_AlongStroke.curve`](#bpy.types.LineStyleThicknessModifier_AlongStroke.curve)
    - [`LineStyleThicknessModifier_AlongStroke.expanded`](#bpy.types.LineStyleThicknessModifier_AlongStroke.expanded)
    - [`LineStyleThicknessModifier_AlongStroke.influence`](#bpy.types.LineStyleThicknessModifier_AlongStroke.influence)
    - [`LineStyleThicknessModifier_AlongStroke.invert`](#bpy.types.LineStyleThicknessModifier_AlongStroke.invert)
    - [`LineStyleThicknessModifier_AlongStroke.mapping`](#bpy.types.LineStyleThicknessModifier_AlongStroke.mapping)
    - [`LineStyleThicknessModifier_AlongStroke.type`](#bpy.types.LineStyleThicknessModifier_AlongStroke.type)
    - [`LineStyleThicknessModifier_AlongStroke.use`](#bpy.types.LineStyleThicknessModifier_AlongStroke.use)
    - [`LineStyleThicknessModifier_AlongStroke.value_max`](#bpy.types.LineStyleThicknessModifier_AlongStroke.value_max)
    - [`LineStyleThicknessModifier_AlongStroke.value_min`](#bpy.types.LineStyleThicknessModifier_AlongStroke.value_min)
    - [`LineStyleThicknessModifier_AlongStroke.bl_rna_get_subclass()`](#bpy.types.LineStyleThicknessModifier_AlongStroke.bl_rna_get_subclass)
    - [`LineStyleThicknessModifier_AlongStroke.bl_rna_get_subclass_py()`](#bpy.types.LineStyleThicknessModifier_AlongStroke.bl_rna_get_subclass_py)
