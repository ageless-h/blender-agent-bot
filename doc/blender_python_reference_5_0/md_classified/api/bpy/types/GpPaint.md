...
# GpPaint(Paint)[¶](#gppaint-paint "Link to this heading")
...
*class* bpy.types.GpPaint(*Paint*)[¶](#bpy.types.GpPaint "Link to this definition")
:   color\_mode[¶](#bpy.types.GpPaint.color_mode "Link to this definition")
    :   Paint Mode
        ...
        * `VERTEXCOLOR`
        ...
        Type:
        :   enum in [`'MATERIAL'`, `'VERTEXCOLOR'`], default `'MATERIAL'`

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.GpPaint.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.GpPaint.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`ToolSettings.gpencil_paint`](ToolSettings.md#bpy.types.ToolSettings.gpencil_paint "bpy.types.ToolSettings.gpencil_paint") |  |
...
GlowStrip(EffectStrip)](GlowStrip.md)
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GpPaint.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.GpPaint.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GpPaint(Paint)
  + [`GpPaint`](#bpy.types.GpPaint)
    - [`GpPaint.color_mode`](#bpy.types.GpPaint.color_mode)
    - [`GpPaint.bl_rna_get_subclass()`](#bpy.types.GpPaint.bl_rna_get_subclass)
    - [`GpPaint.bl_rna_get_subclass_py()`](#bpy.types.GpPaint.bl_rna_get_subclass_py)
