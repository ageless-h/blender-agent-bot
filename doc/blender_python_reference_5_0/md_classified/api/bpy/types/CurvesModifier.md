...
# CurvesModifier(StripModifier)[¶](#curvesmodifier-stripmodifier "Link to this heading")
...
*class* bpy.types.CurvesModifier(*StripModifier*)[¶](#bpy.types.CurvesModifier "Link to this definition")
:   RGB curves modifier for sequence strip

    curve\_mapping[¶](#bpy.types.CurvesModifier.curve_mapping "Link to this definition")
    :   Type:
        :   [`CurveMapping`](CurveMapping.md#bpy.types.CurveMapping "bpy.types.CurveMapping"), (readonly)

    open\_mask\_input\_panel[¶](#bpy.types.CurvesModifier.open_mask_input_panel "Link to this definition")
    :   Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.CurvesModifier.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.CurvesModifier.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CurvesModifier.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.CurvesModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CurvesModifier(StripModifier)
  + [`CurvesModifier`](#bpy.types.CurvesModifier)
    - [`CurvesModifier.curve_mapping`](#bpy.types.CurvesModifier.curve_mapping)
    - [`CurvesModifier.open_mask_input_panel`](#bpy.types.CurvesModifier.open_mask_input_panel)
    - [`CurvesModifier.bl_rna_get_subclass()`](#bpy.types.CurvesModifier.bl_rna_get_subclass)
    - [`CurvesModifier.bl_rna_get_subclass_py()`](#bpy.types.CurvesModifier.bl_rna_get_subclass_py)
