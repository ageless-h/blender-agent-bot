...
# ShaderFxBlur(ShaderFx)[¶](#shaderfxblur-shaderfx "Link to this heading")
...
*class* bpy.types.ShaderFxBlur(*ShaderFx*)[¶](#bpy.types.ShaderFxBlur "Link to this definition")
:   Gaussian Blur effect

    rotation[¶](#bpy.types.ShaderFxBlur.rotation "Link to this definition")
    :   Rotation of the effect

        Type:
        :   float in [-inf, inf], default 0.0

    samples[¶](#bpy.types.ShaderFxBlur.samples "Link to this definition")
    :   Number of Blur Samples (zero, disable blur)

        Type:
        :   int in [0, 32], default 4

    size[¶](#bpy.types.ShaderFxBlur.size "Link to this definition")
    :   Factor of Blur

        Type:
        :   [`mathutils.Vector`](../../mathutils/index.md#mathutils.Vector "mathutils.Vector") of 2 items in [0, inf], default (0.0, 0.0)

    use\_dof\_mode[¶](#bpy.types.ShaderFxBlur.use_dof_mode "Link to this definition")
    :   Blur using camera depth of field

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ShaderFxBlur.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ShaderFxBlur.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ShaderFxBlur.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ShaderFxBlur.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ShaderFxBlur(ShaderFx)
  + [`ShaderFxBlur`](#bpy.types.ShaderFxBlur)
    - [`ShaderFxBlur.rotation`](#bpy.types.ShaderFxBlur.rotation)
    - [`ShaderFxBlur.samples`](#bpy.types.ShaderFxBlur.samples)
    - [`ShaderFxBlur.size`](#bpy.types.ShaderFxBlur.size)
    - [`ShaderFxBlur.use_dof_mode`](#bpy.types.ShaderFxBlur.use_dof_mode)
    - [`ShaderFxBlur.bl_rna_get_subclass()`](#bpy.types.ShaderFxBlur.bl_rna_get_subclass)
    - [`ShaderFxBlur.bl_rna_get_subclass_py()`](#bpy.types.ShaderFxBlur.bl_rna_get_subclass_py)
