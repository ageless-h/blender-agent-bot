...
# LineStyleGeometryModifier\_SinusDisplacement(LineStyleGeometryModifier)[¶](#linestylegeometrymodifier-sinusdisplacement-linestylegeometrymodifier "Link to this heading")
...
*class* bpy.types.LineStyleGeometryModifier\_SinusDisplacement(*LineStyleGeometryModifier*)[¶](#bpy.types.LineStyleGeometryModifier_SinusDisplacement "Link to this definition")
:   Add sinus displacement to stroke backbone geometry

    amplitude[¶](#bpy.types.LineStyleGeometryModifier_SinusDisplacement.amplitude "Link to this definition")
    :   Amplitude of the sinus displacement

        Type:
        :   float in [-inf, inf], default 0.0

    expanded[¶](#bpy.types.LineStyleGeometryModifier_SinusDisplacement.expanded "Link to this definition")
    :   True if the modifier tab is expanded

        Type:
        :   boolean, default False

    phase[¶](#bpy.types.LineStyleGeometryModifier_SinusDisplacement.phase "Link to this definition")
    :   Phase of the sinus displacement

        Type:
        :   float in [-inf, inf], default 0.0

    type[¶](#bpy.types.LineStyleGeometryModifier_SinusDisplacement.type "Link to this definition")
    ...
    use[¶](#bpy.types.LineStyleGeometryModifier_SinusDisplacement.use "Link to this definition")
    :   Enable or disable this modifier during stroke rendering

        Type:
        :   boolean, default False

    wavelength[¶](#bpy.types.LineStyleGeometryModifier_SinusDisplacement.wavelength "Link to this definition")
    :   Wavelength of the sinus displacement

        Type:
        :   float in [0.0001, inf], default 0.0

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.LineStyleGeometryModifier_SinusDisplacement.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.LineStyleGeometryModifier_SinusDisplacement.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
        ...
        Return type:
        :   [type](#bpy.types.LineStyleGeometryModifier_SinusDisplacement.type "bpy.types.LineStyleGeometryModifier_SinusDisplacement.type")
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.LineStyleGeometryModifier_SinusDisplacement.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.LineStyleGeometryModifier_SinusDisplacement.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* LineStyleGeometryModifier\_SinusDisplacement(LineStyleGeometryModifier)
  + [`LineStyleGeometryModifier_SinusDisplacement`](#bpy.types.LineStyleGeometryModifier_SinusDisplacement)
    - [`LineStyleGeometryModifier_SinusDisplacement.amplitude`](#bpy.types.LineStyleGeometryModifier_SinusDisplacement.amplitude)
    - [`LineStyleGeometryModifier_SinusDisplacement.expanded`](#bpy.types.LineStyleGeometryModifier_SinusDisplacement.expanded)
    - [`LineStyleGeometryModifier_SinusDisplacement.phase`](#bpy.types.LineStyleGeometryModifier_SinusDisplacement.phase)
    - [`LineStyleGeometryModifier_SinusDisplacement.type`](#bpy.types.LineStyleGeometryModifier_SinusDisplacement.type)
    - [`LineStyleGeometryModifier_SinusDisplacement.use`](#bpy.types.LineStyleGeometryModifier_SinusDisplacement.use)
    - [`LineStyleGeometryModifier_SinusDisplacement.wavelength`](#bpy.types.LineStyleGeometryModifier_SinusDisplacement.wavelength)
    - [`LineStyleGeometryModifier_SinusDisplacement.bl_rna_get_subclass()`](#bpy.types.LineStyleGeometryModifier_SinusDisplacement.bl_rna_get_subclass)
    - [`LineStyleGeometryModifier_SinusDisplacement.bl_rna_get_subclass_py()`](#bpy.types.LineStyleGeometryModifier_SinusDisplacement.bl_rna_get_subclass_py)
