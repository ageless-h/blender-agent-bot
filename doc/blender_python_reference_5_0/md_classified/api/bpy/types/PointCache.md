...
# PointCache(bpy\_struct)[¶](#pointcache-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.PointCache(*bpy\_struct*)[¶](#bpy.types.PointCache "Link to this definition")
:   Active point cache for physics simulations

    filepath[¶](#bpy.types.PointCache.filepath "Link to this definition")
    :   Cache file path

        Type:
        :   string, default “”, (never None, blend relative `//` prefix supported)

    frame\_end[¶](#bpy.types.PointCache.frame_end "Link to this definition")
    :   Frame on which the simulation stops

        Type:
        :   int in [1, 1048574], default 0

    frame\_start[¶](#bpy.types.PointCache.frame_start "Link to this definition")
    :   Frame on which the simulation starts

        Type:
        :   int in [-1048574, 1048574], default 0

    frame\_step[¶](#bpy.types.PointCache.frame_step "Link to this definition")
    :   Number of frames between cached frames

        Type:
        :   int in [1, 20], default 0

    index[¶](#bpy.types.PointCache.index "Link to this definition")
    :   Index number of cache files

        Type:
        :   int in [-1, 100], default 0

    info[¶](#bpy.types.PointCache.info "Link to this definition")
    :   Info on current cache status

        Type:
        :   string, default “”, (readonly, never None)

    is\_baked[¶](#bpy.types.PointCache.is_baked "Link to this definition")
    :   The cache is baked

        Type:
        :   boolean, default False, (readonly)

    is\_baking[¶](#bpy.types.PointCache.is_baking "Link to this definition")
    :   The cache is being baked

        Type:
        :   boolean, default False, (readonly)

    is\_frame\_skip[¶](#bpy.types.PointCache.is_frame_skip "Link to this definition")
    :   Some frames were skipped while baking/saving that cache

        Type:
        :   boolean, default False, (readonly)

    is\_outdated[¶](#bpy.types.PointCache.is_outdated "Link to this definition")
    :   Type:
        :   boolean, default False, (readonly)

    name[¶](#bpy.types.PointCache.name "Link to this definition")
    :   Cache name

        Type:
        :   string, default “”, (never None)

    point\_caches[¶](#bpy.types.PointCache.point_caches "Link to this definition")
    :   Type:
        :   [`PointCaches`](PointCaches.md#bpy.types.PointCaches "bpy.types.PointCaches") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`PointCacheItem`](PointCacheItem.md#bpy.types.PointCacheItem "bpy.types.PointCacheItem"), (readonly)

    use\_disk\_cache[¶](#bpy.types.PointCache.use_disk_cache "Link to this definition")
    :   Save cache files to disk (.blend file must be saved first)

        Type:
        :   boolean, default False

    use\_external[¶](#bpy.types.PointCache.use_external "Link to this definition")
    :   Read cache from an external location

        Type:
        :   boolean, default False

    use\_library\_path[¶](#bpy.types.PointCache.use_library_path "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.PointCache.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.PointCache.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`ClothModifier.point_cache`](ClothModifier.md#bpy.types.ClothModifier.point_cache "bpy.types.ClothModifier.point_cache") * [`DynamicPaintSurface.point_cache`](DynamicPaintSurface.md#bpy.types.DynamicPaintSurface.point_cache "bpy.types.DynamicPaintSurface.point_cache") * [`ParticleSystem.point_cache`](ParticleSystem.md#bpy.types.ParticleSystem.point_cache "bpy.types.ParticleSystem.point_cache") | * [`RigidBodyWorld.point_cache`](RigidBodyWorld.md#bpy.types.RigidBodyWorld.point_cache "bpy.types.RigidBodyWorld.point_cache") * [`SoftBodyModifier.point_cache`](SoftBodyModifier.md#bpy.types.SoftBodyModifier.point_cache "bpy.types.SoftBodyModifier.point_cache") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.PointCache.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.PointCache.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* PointCache(bpy\_struct)
  + [`PointCache`](#bpy.types.PointCache)
    - [`PointCache.filepath`](#bpy.types.PointCache.filepath)
    - [`PointCache.frame_end`](#bpy.types.PointCache.frame_end)
    - [`PointCache.frame_start`](#bpy.types.PointCache.frame_start)
    - [`PointCache.frame_step`](#bpy.types.PointCache.frame_step)
    - [`PointCache.index`](#bpy.types.PointCache.index)
    - [`PointCache.info`](#bpy.types.PointCache.info)
    - [`PointCache.is_baked`](#bpy.types.PointCache.is_baked)
    - [`PointCache.is_baking`](#bpy.types.PointCache.is_baking)
    - [`PointCache.is_frame_skip`](#bpy.types.PointCache.is_frame_skip)
    - [`PointCache.is_outdated`](#bpy.types.PointCache.is_outdated)
    - [`PointCache.name`](#bpy.types.PointCache.name)
    - [`PointCache.point_caches`](#bpy.types.PointCache.point_caches)
    - [`PointCache.use_disk_cache`](#bpy.types.PointCache.use_disk_cache)
    - [`PointCache.use_external`](#bpy.types.PointCache.use_external)
    - [`PointCache.use_library_path`](#bpy.types.PointCache.use_library_path)
    - [`PointCache.bl_rna_get_subclass()`](#bpy.types.PointCache.bl_rna_get_subclass)
    - [`PointCache.bl_rna_get_subclass_py()`](#bpy.types.PointCache.bl_rna_get_subclass_py)
