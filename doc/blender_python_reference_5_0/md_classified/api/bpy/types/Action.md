...
# Action(ID)[¶](#action-id "Link to this heading")

base classes — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct"), [`ID`](ID.md#bpy.types.ID "bpy.types.ID")

*class* bpy.types.Action(*ID*)[¶](#bpy.types.Action "Link to this definition")
:   A collection of F-Curves for animation

    curve\_frame\_range[¶](#bpy.types.Action.curve_frame_range "Link to this definition")
    ...
    frame\_end[¶](#bpy.types.Action.frame_end "Link to this definition")
    :   The end frame of the manually set intended playback range

        Type:
        :   float in [-1.04857e+06, 1.04857e+06], default 0.0

    frame\_range[¶](#bpy.types.Action.frame_range "Link to this definition")
    ...
    frame\_start[¶](#bpy.types.Action.frame_start "Link to this definition")
    :   The start frame of the manually set intended playback range

        Type:
        :   float in [-1.04857e+06, 1.04857e+06], default 0.0

    is\_action\_layered[¶](#bpy.types.Action.is_action_layered "Link to this definition")
    :   Return whether this is a layered Action. An empty Action is considered as both a ‘legacy’ and a ‘layered’ Action.

        Type:
        :   boolean, default False, (readonly)

    is\_action\_legacy[¶](#bpy.types.Action.is_action_legacy "Link to this definition")
    ...
    is\_empty[¶](#bpy.types.Action.is_empty "Link to this definition")
    :   False when there is any Layer, Slot, or legacy F-Curve

        Type:
        :   boolean, default False, (readonly)

    layers[¶](#bpy.types.Action.layers "Link to this definition")
    :   The list of layers that make up this Action

        Type:
        :   [`ActionLayers`](ActionLayers.md#bpy.types.ActionLayers "bpy.types.ActionLayers") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`ActionLayer`](ActionLayer.md#bpy.types.ActionLayer "bpy.types.ActionLayer"), (readonly)

    pose\_markers[¶](#bpy.types.Action.pose_markers "Link to this definition")
    :   Markers specific to this action, for labeling poses

        Type:
        :   [`ActionPoseMarkers`](ActionPoseMarkers.md#bpy.types.ActionPoseMarkers "bpy.types.ActionPoseMarkers") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`TimelineMarker`](TimelineMarker.md#bpy.types.TimelineMarker "bpy.types.TimelineMarker"), (readonly)

    slots[¶](#bpy.types.Action.slots "Link to this definition")
    :   The list of slots in this Action

        Type:
        :   [`ActionSlots`](ActionSlots.md#bpy.types.ActionSlots "bpy.types.ActionSlots") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`ActionSlot`](ActionSlot.md#bpy.types.ActionSlot "bpy.types.ActionSlot"), (readonly)

    use\_cyclic[¶](#bpy.types.Action.use_cyclic "Link to this definition")
    ...
    use\_frame\_range[¶](#bpy.types.Action.use_frame_range "Link to this definition")
    ...
    deselect\_keys()[¶](#bpy.types.Action.deselect_keys "Link to this definition")
    :   Deselects all keys of the Action. The selection status of F-Curves is unchanged.

    fcurve\_ensure\_for\_datablock(*datablock*, *data\_path*, *\**, *index=0*, *group\_name=''*)[¶](#bpy.types.Action.fcurve_ensure_for_datablock "Link to this definition")
    :   Ensure that an F-Curve exists, with the given data path and array index, for the given data-block. This action must already be assigned to the data-block. This function will also create the layer, keyframe strip, and action slot if necessary, and take care of assigning the action slot too
        ...
        Parameters:
        :   * **datablock** ([`ID`](ID.md#bpy.types.ID "bpy.types.ID"), (never None)) – The data-block animated by this action, for which to ensure the F-Curve exists. This action must already be assigned to the data-block
        ...
        Return type:
        :   [`FCurve`](FCurve.md#bpy.types.FCurve "bpy.types.FCurve")

    flip\_with\_pose(*object*)[¶](#bpy.types.Action.flip_with_pose "Link to this definition")
    :   Flip the action around the X axis using a pose

        Parameters:
        :   **object** ([`Object`](Object.md#bpy.types.Object "bpy.types.Object"), (never None)) – The reference armature object to use when flipping

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.Action.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.Action.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`bpy.context.active_action`](../context/index.md#bpy.context.active_action "bpy.context.active_action") * [`bpy.context.selected_editable_actions`](../context/index.md#bpy.context.selected_editable_actions "bpy.context.selected_editable_actions") * [`bpy.context.selected_visible_actions`](../context/index.md#bpy.context.selected_visible_actions "bpy.context.selected_visible_actions") * [`ActionConstraint.action`](ActionConstraint.md#bpy.types.ActionConstraint.action "bpy.types.ActionConstraint.action") * [`AnimData.action`](AnimData.md#bpy.types.AnimData.action "bpy.types.AnimData.action") * [`AnimData.action_tweak_storage`](AnimData.md#bpy.types.AnimData.action_tweak_storage "bpy.types.AnimData.action_tweak_storage") * [`BlendData.actions`](BlendData.md#bpy.types.BlendData.actions "bpy.types.BlendData.actions") * [`BlendDataActions.new`](BlendDataActions.md#bpy.types.BlendDataActions.new "bpy.types.BlendDataActions.new") | * [`BlendDataActions.remove`](BlendDataActions.md#bpy.types.BlendDataActions.remove "bpy.types.BlendDataActions.remove") * `GLTF2_filter_action.action` * [`NlaStrip.action`](NlaStrip.md#bpy.types.NlaStrip.action "bpy.types.NlaStrip.action") * [`NlaStrips.new`](NlaStrips.md#bpy.types.NlaStrips.new "bpy.types.NlaStrips.new") * [`Pose.apply_pose_from_action`](Pose.md#bpy.types.Pose.apply_pose_from_action "bpy.types.Pose.apply_pose_from_action") * [`Pose.backup_create`](Pose.md#bpy.types.Pose.backup_create "bpy.types.Pose.backup_create") * [`Pose.blend_pose_from_action`](Pose.md#bpy.types.Pose.blend_pose_from_action "bpy.types.Pose.blend_pose_from_action") * [`WindowManager.poselib_previous_action`](WindowManager.md#bpy.types.WindowManager.poselib_previous_action "bpy.types.WindowManager.poselib_previous_action") |

[Next

ActionChannelbag(bpy\_struct)](ActionChannelbag.md)
[Previous
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.Action.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.Action.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* Action(ID)
  + [`Action`](#bpy.types.Action)
    - [`Action.curve_frame_range`](#bpy.types.Action.curve_frame_range)
    - [`Action.frame_end`](#bpy.types.Action.frame_end)
    - [`Action.frame_range`](#bpy.types.Action.frame_range)
    - [`Action.frame_start`](#bpy.types.Action.frame_start)
    - [`Action.is_action_layered`](#bpy.types.Action.is_action_layered)
    - [`Action.is_action_legacy`](#bpy.types.Action.is_action_legacy)
    - [`Action.is_empty`](#bpy.types.Action.is_empty)
    - [`Action.layers`](#bpy.types.Action.layers)
    - [`Action.pose_markers`](#bpy.types.Action.pose_markers)
    - [`Action.slots`](#bpy.types.Action.slots)
    - [`Action.use_cyclic`](#bpy.types.Action.use_cyclic)
    - [`Action.use_frame_range`](#bpy.types.Action.use_frame_range)
    - [`Action.deselect_keys()`](#bpy.types.Action.deselect_keys)
    - [`Action.fcurve_ensure_for_datablock()`](#bpy.types.Action.fcurve_ensure_for_datablock)
    - [`Action.flip_with_pose()`](#bpy.types.Action.flip_with_pose)
    - [`Action.bl_rna_get_subclass()`](#bpy.types.Action.bl_rna_get_subclass)
    - [`Action.bl_rna_get_subclass_py()`](#bpy.types.Action.bl_rna_get_subclass_py)
