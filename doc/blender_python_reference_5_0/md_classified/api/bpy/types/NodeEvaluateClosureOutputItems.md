...
# NodeEvaluateClosureOutputItems(bpy\_struct)[¶](#nodeevaluateclosureoutputitems-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.NodeEvaluateClosureOutputItems(*bpy\_struct*)[¶](#bpy.types.NodeEvaluateClosureOutputItems "Link to this definition")
:   new(*socket\_type*, *name*)[¶](#bpy.types.NodeEvaluateClosureOutputItems.new "Link to this definition")
    :   Add an item at the end
        ...
        Return type:
        :   [`NodeEvaluateClosureOutputItem`](NodeEvaluateClosureOutputItem.md#bpy.types.NodeEvaluateClosureOutputItem "bpy.types.NodeEvaluateClosureOutputItem")

    remove(*item*)[¶](#bpy.types.NodeEvaluateClosureOutputItems.remove "Link to this definition")
    :   Remove an item

        Parameters:
        :   **item** ([`NodeEvaluateClosureOutputItem`](NodeEvaluateClosureOutputItem.md#bpy.types.NodeEvaluateClosureOutputItem "bpy.types.NodeEvaluateClosureOutputItem"), (never None)) – Item, The item to remove

    clear()[¶](#bpy.types.NodeEvaluateClosureOutputItems.clear "Link to this definition")
    :   Remove all items

    move(*from\_index*, *to\_index*)[¶](#bpy.types.NodeEvaluateClosureOutputItems.move "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.NodeEvaluateClosureOutputItems.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.NodeEvaluateClosureOutputItems.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`NodeEvaluateClosure.output_items`](NodeEvaluateClosure.md#bpy.types.NodeEvaluateClosure.output_items "bpy.types.NodeEvaluateClosure.output_items") |  |
...
NodeEvaluateClosureOutputItem(bpy\_struct)](NodeEvaluateClosureOutputItem.md)
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.NodeEvaluateClosureOutputItems.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.NodeEvaluateClosureOutputItems.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* NodeEvaluateClosureOutputItems(bpy\_struct)
  + [`NodeEvaluateClosureOutputItems`](#bpy.types.NodeEvaluateClosureOutputItems)
    - [`NodeEvaluateClosureOutputItems.new()`](#bpy.types.NodeEvaluateClosureOutputItems.new)
    - [`NodeEvaluateClosureOutputItems.remove()`](#bpy.types.NodeEvaluateClosureOutputItems.remove)
    - [`NodeEvaluateClosureOutputItems.clear()`](#bpy.types.NodeEvaluateClosureOutputItems.clear)
    - [`NodeEvaluateClosureOutputItems.move()`](#bpy.types.NodeEvaluateClosureOutputItems.move)
    - [`NodeEvaluateClosureOutputItems.bl_rna_get_subclass()`](#bpy.types.NodeEvaluateClosureOutputItems.bl_rna_get_subclass)
    - [`NodeEvaluateClosureOutputItems.bl_rna_get_subclass_py()`](#bpy.types.NodeEvaluateClosureOutputItems.bl_rna_get_subclass_py)
