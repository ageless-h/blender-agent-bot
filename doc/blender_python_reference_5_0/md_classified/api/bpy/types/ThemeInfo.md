...
# ThemeInfo(bpy\_struct)[¶](#themeinfo-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.ThemeInfo(*bpy\_struct*)[¶](#bpy.types.ThemeInfo "Link to this definition")
:   Theme settings for Info

    info\_debug[¶](#bpy.types.ThemeInfo.info_debug "Link to this definition")
    :   Background color of Debug icon

        Type:
        :   float array of 4 items in [0, 1], default (0.0, 0.0, 0.0, 0.0)

    info\_debug\_text[¶](#bpy.types.ThemeInfo.info_debug_text "Link to this definition")
    ...
    info\_error\_text[¶](#bpy.types.ThemeInfo.info_error_text "Link to this definition")
    :   Foreground color of Error icon

        Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    info\_info\_text[¶](#bpy.types.ThemeInfo.info_info_text "Link to this definition")
    :   Foreground color of Info icon

        Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    info\_operator[¶](#bpy.types.ThemeInfo.info_operator "Link to this definition")
    :   Background color of Operator icon

        Type:
        :   float array of 4 items in [0, 1], default (0.0, 0.0, 0.0, 0.0)

    info\_operator\_text[¶](#bpy.types.ThemeInfo.info_operator_text "Link to this definition")
    :   Foreground color of Operator icon

        Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    info\_property[¶](#bpy.types.ThemeInfo.info_property "Link to this definition")
    :   Background color of Property icon

        Type:
        :   float array of 4 items in [0, 1], default (0.0, 0.0, 0.0, 0.0)

    info\_property\_text[¶](#bpy.types.ThemeInfo.info_property_text "Link to this definition")
    :   Foreground color of Property icon

        Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    info\_selected[¶](#bpy.types.ThemeInfo.info_selected "Link to this definition")
    :   Background color of selected line

        Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    info\_selected\_text[¶](#bpy.types.ThemeInfo.info_selected_text "Link to this definition")
    :   Text color of selected line

        Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    info\_warning\_text[¶](#bpy.types.ThemeInfo.info_warning_text "Link to this definition")
    :   Foreground color of Warning icon

        Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    space[¶](#bpy.types.ThemeInfo.space "Link to this definition")
    :   Settings for space

        Type:
        :   [`ThemeSpaceGeneric`](ThemeSpaceGeneric.md#bpy.types.ThemeSpaceGeneric "bpy.types.ThemeSpaceGeneric"), (readonly, never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ThemeInfo.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ThemeInfo.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Theme.info`](Theme.md#bpy.types.Theme.info "bpy.types.Theme.info") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ThemeInfo.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ThemeInfo.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ThemeInfo(bpy\_struct)
  + [`ThemeInfo`](#bpy.types.ThemeInfo)
    - [`ThemeInfo.info_debug`](#bpy.types.ThemeInfo.info_debug)
    - [`ThemeInfo.info_debug_text`](#bpy.types.ThemeInfo.info_debug_text)
    - [`ThemeInfo.info_error_text`](#bpy.types.ThemeInfo.info_error_text)
    - [`ThemeInfo.info_info_text`](#bpy.types.ThemeInfo.info_info_text)
    - [`ThemeInfo.info_operator`](#bpy.types.ThemeInfo.info_operator)
    - [`ThemeInfo.info_operator_text`](#bpy.types.ThemeInfo.info_operator_text)
    - [`ThemeInfo.info_property`](#bpy.types.ThemeInfo.info_property)
    - [`ThemeInfo.info_property_text`](#bpy.types.ThemeInfo.info_property_text)
    - [`ThemeInfo.info_selected`](#bpy.types.ThemeInfo.info_selected)
    - [`ThemeInfo.info_selected_text`](#bpy.types.ThemeInfo.info_selected_text)
    - [`ThemeInfo.info_warning_text`](#bpy.types.ThemeInfo.info_warning_text)
    - [`ThemeInfo.space`](#bpy.types.ThemeInfo.space)
    - [`ThemeInfo.bl_rna_get_subclass()`](#bpy.types.ThemeInfo.bl_rna_get_subclass)
    - [`ThemeInfo.bl_rna_get_subclass_py()`](#bpy.types.ThemeInfo.bl_rna_get_subclass_py)
