...
# RaytraceEEVEE(bpy\_struct)[¶](#raytraceeevee-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.RaytraceEEVEE(*bpy\_struct*)[¶](#bpy.types.RaytraceEEVEE "Link to this definition")
:   Quality options for the raytracing pipeline

    denoise\_bilateral[¶](#bpy.types.RaytraceEEVEE.denoise_bilateral "Link to this definition")
    :   Blur the resolved radiance using a bilateral filter

        Type:
        :   boolean, default True

    denoise\_spatial[¶](#bpy.types.RaytraceEEVEE.denoise_spatial "Link to this definition")
    :   Reuse neighbor pixels’ rays

        Type:
        :   boolean, default True

    denoise\_temporal[¶](#bpy.types.RaytraceEEVEE.denoise_temporal "Link to this definition")
    :   Accumulate samples by reprojecting last tracing results

        Type:
        :   boolean, default True

    resolution\_scale[¶](#bpy.types.RaytraceEEVEE.resolution_scale "Link to this definition")
    ...
    screen\_trace\_quality[¶](#bpy.types.RaytraceEEVEE.screen_trace_quality "Link to this definition")
    :   Precision of the screen space ray-tracing

        Type:
        :   float in [0, 1], default 0.25

    screen\_trace\_thickness[¶](#bpy.types.RaytraceEEVEE.screen_trace_thickness "Link to this definition")
    :   Surface thickness used to detect intersection when using screen-tracing

        Type:
        :   float in [1e-06, inf], default 0.2

    trace\_max\_roughness[¶](#bpy.types.RaytraceEEVEE.trace_max_roughness "Link to this definition")
    ...
    use\_denoise[¶](#bpy.types.RaytraceEEVEE.use_denoise "Link to this definition")
    :   Enable noise reduction techniques for raytraced effects

        Type:
        :   boolean, default True

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.RaytraceEEVEE.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.RaytraceEEVEE.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`SceneEEVEE.ray_tracing_options`](SceneEEVEE.md#bpy.types.SceneEEVEE.ray_tracing_options "bpy.types.SceneEEVEE.ray_tracing_options") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.RaytraceEEVEE.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.RaytraceEEVEE.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* RaytraceEEVEE(bpy\_struct)
  + [`RaytraceEEVEE`](#bpy.types.RaytraceEEVEE)
    - [`RaytraceEEVEE.denoise_bilateral`](#bpy.types.RaytraceEEVEE.denoise_bilateral)
    - [`RaytraceEEVEE.denoise_spatial`](#bpy.types.RaytraceEEVEE.denoise_spatial)
    - [`RaytraceEEVEE.denoise_temporal`](#bpy.types.RaytraceEEVEE.denoise_temporal)
    - [`RaytraceEEVEE.resolution_scale`](#bpy.types.RaytraceEEVEE.resolution_scale)
    - [`RaytraceEEVEE.screen_trace_quality`](#bpy.types.RaytraceEEVEE.screen_trace_quality)
    - [`RaytraceEEVEE.screen_trace_thickness`](#bpy.types.RaytraceEEVEE.screen_trace_thickness)
    - [`RaytraceEEVEE.trace_max_roughness`](#bpy.types.RaytraceEEVEE.trace_max_roughness)
    - [`RaytraceEEVEE.use_denoise`](#bpy.types.RaytraceEEVEE.use_denoise)
    - [`RaytraceEEVEE.bl_rna_get_subclass()`](#bpy.types.RaytraceEEVEE.bl_rna_get_subclass)
    - [`RaytraceEEVEE.bl_rna_get_subclass_py()`](#bpy.types.RaytraceEEVEE.bl_rna_get_subclass_py)
