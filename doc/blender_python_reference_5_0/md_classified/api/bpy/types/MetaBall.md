...
# MetaBall(ID)[¶](#metaball-id "Link to this heading")

base classes — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct"), [`ID`](ID.md#bpy.types.ID "bpy.types.ID")

*class* bpy.types.MetaBall(*ID*)[¶](#bpy.types.MetaBall "Link to this definition")
:   Metaball data-block to define blobby surfaces

    animation\_data[¶](#bpy.types.MetaBall.animation_data "Link to this definition")
    :   Animation data for this data-block

        Type:
        :   [`AnimData`](AnimData.md#bpy.types.AnimData "bpy.types.AnimData"), (readonly)

    cycles[¶](#bpy.types.MetaBall.cycles "Link to this definition")
    :   Cycles mesh settings

        Type:
        :   `CyclesMeshSettings`, (readonly)

    elements[¶](#bpy.types.MetaBall.elements "Link to this definition")
    :   Metaball elements

        Type:
        :   [`MetaBallElements`](MetaBallElements.md#bpy.types.MetaBallElements "bpy.types.MetaBallElements") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`MetaElement`](MetaElement.md#bpy.types.MetaElement "bpy.types.MetaElement"), (readonly)

    is\_editmode[¶](#bpy.types.MetaBall.is_editmode "Link to this definition")
    :   True when used in editmode

        Type:
        :   boolean, default False, (readonly)

    materials[¶](#bpy.types.MetaBall.materials "Link to this definition")
    :   Type:
    ...
    render\_resolution[¶](#bpy.types.MetaBall.render_resolution "Link to this definition")
    :   Polygonization resolution in rendering

        Type:
        :   float in [0.005, 10000], default 0.2

    resolution[¶](#bpy.types.MetaBall.resolution "Link to this definition")
    :   Polygonization resolution in the 3D viewport

        Type:
        :   float in [0.005, 10000], default 0.4

    texspace\_location[¶](#bpy.types.MetaBall.texspace_location "Link to this definition")
    :   Texture space location

        Type:
        :   [`mathutils.Vector`](../../mathutils/index.md#mathutils.Vector "mathutils.Vector") of 3 items in [-inf, inf], default (0.0, 0.0, 0.0)

    texspace\_size[¶](#bpy.types.MetaBall.texspace_size "Link to this definition")
    :   Texture space size

        Type:
        :   [`mathutils.Vector`](../../mathutils/index.md#mathutils.Vector "mathutils.Vector") of 3 items in [-inf, inf], default (1.0, 1.0, 1.0)

    threshold[¶](#bpy.types.MetaBall.threshold "Link to this definition")
    :   Influence of metaball elements

        Type:
        :   float in [0, 5], default 0.6

    update\_method[¶](#bpy.types.MetaBall.update_method "Link to this definition")
    ...
    use\_auto\_texspace[¶](#bpy.types.MetaBall.use_auto_texspace "Link to this definition")
    :   Adjust active object’s texture space automatically when transforming object

        Type:
        :   boolean, default True

    transform(*matrix*)[¶](#bpy.types.MetaBall.transform "Link to this definition")
    ...
    update\_gpu\_tag()[¶](#bpy.types.MetaBall.update_gpu_tag "Link to this definition")
    :   update\_gpu\_tag

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.MetaBall.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.MetaBall.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`bpy.context.meta_ball`](../context/index.md#bpy.context.meta_ball "bpy.context.meta_ball") * [`BlendData.metaballs`](BlendData.md#bpy.types.BlendData.metaballs "bpy.types.BlendData.metaballs") | * [`BlendDataMetaBalls.new`](BlendDataMetaBalls.md#bpy.types.BlendDataMetaBalls.new "bpy.types.BlendDataMetaBalls.new") * [`BlendDataMetaBalls.remove`](BlendDataMetaBalls.md#bpy.types.BlendDataMetaBalls.remove "bpy.types.BlendDataMetaBalls.remove") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.MetaBall.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.MetaBall.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* MetaBall(ID)
  + [`MetaBall`](#bpy.types.MetaBall)
    - [`MetaBall.animation_data`](#bpy.types.MetaBall.animation_data)
    - [`MetaBall.cycles`](#bpy.types.MetaBall.cycles)
    - [`MetaBall.elements`](#bpy.types.MetaBall.elements)
    - [`MetaBall.is_editmode`](#bpy.types.MetaBall.is_editmode)
    - [`MetaBall.materials`](#bpy.types.MetaBall.materials)
    - [`MetaBall.render_resolution`](#bpy.types.MetaBall.render_resolution)
    - [`MetaBall.resolution`](#bpy.types.MetaBall.resolution)
    - [`MetaBall.texspace_location`](#bpy.types.MetaBall.texspace_location)
    - [`MetaBall.texspace_size`](#bpy.types.MetaBall.texspace_size)
    - [`MetaBall.threshold`](#bpy.types.MetaBall.threshold)
    - [`MetaBall.update_method`](#bpy.types.MetaBall.update_method)
    - [`MetaBall.use_auto_texspace`](#bpy.types.MetaBall.use_auto_texspace)
    - [`MetaBall.transform()`](#bpy.types.MetaBall.transform)
    - [`MetaBall.update_gpu_tag()`](#bpy.types.MetaBall.update_gpu_tag)
    - [`MetaBall.bl_rna_get_subclass()`](#bpy.types.MetaBall.bl_rna_get_subclass)
    - [`MetaBall.bl_rna_get_subclass_py()`](#bpy.types.MetaBall.bl_rna_get_subclass_py)
