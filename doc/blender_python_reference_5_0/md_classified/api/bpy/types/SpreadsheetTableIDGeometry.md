...
# SpreadsheetTableIDGeometry(SpreadsheetTableID)[¶](#spreadsheettableidgeometry-spreadsheettableid "Link to this heading")

base classes — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct"), [`SpreadsheetTableID`](SpreadsheetTableID.md#bpy.types.SpreadsheetTableID "bpy.types.SpreadsheetTableID")

*class* bpy.types.SpreadsheetTableIDGeometry(*SpreadsheetTableID*)[¶](#bpy.types.SpreadsheetTableIDGeometry "Link to this definition")
:   attribute\_domain[¶](#bpy.types.SpreadsheetTableIDGeometry.attribute_domain "Link to this definition")
    ...
    geometry\_component\_type[¶](#bpy.types.SpreadsheetTableIDGeometry.geometry_component_type "Link to this definition")
    :   Part of the geometry to display data from

        Type:
        :   enum in [Geometry Component Type Items](../../../appendix/bpy_types_enum_items/geometry_component_type_items.md#rna-enum-geometry-component-type-items), default `'MESH'`, (readonly)

    layer\_index[¶](#bpy.types.SpreadsheetTableIDGeometry.layer_index "Link to this definition")
    :   Index of the Grease Pencil layer

        Type:
        :   int in [-inf, inf], default 0, (readonly)

    object\_eval\_state[¶](#bpy.types.SpreadsheetTableIDGeometry.object_eval_state "Link to this definition")
    :   * `EVALUATED`
    ...
    viewer\_path[¶](#bpy.types.SpreadsheetTableIDGeometry.viewer_path "Link to this definition")
    :   Path to the data that is displayed

        Type:
        :   [`ViewerPath`](ViewerPath.md#bpy.types.ViewerPath "bpy.types.ViewerPath"), (readonly)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.SpreadsheetTableIDGeometry.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.SpreadsheetTableIDGeometry.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.SpreadsheetTableIDGeometry.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.SpreadsheetTableIDGeometry.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* SpreadsheetTableIDGeometry(SpreadsheetTableID)
  + [`SpreadsheetTableIDGeometry`](#bpy.types.SpreadsheetTableIDGeometry)
    - [`SpreadsheetTableIDGeometry.attribute_domain`](#bpy.types.SpreadsheetTableIDGeometry.attribute_domain)
    - [`SpreadsheetTableIDGeometry.geometry_component_type`](#bpy.types.SpreadsheetTableIDGeometry.geometry_component_type)
    - [`SpreadsheetTableIDGeometry.layer_index`](#bpy.types.SpreadsheetTableIDGeometry.layer_index)
    - [`SpreadsheetTableIDGeometry.object_eval_state`](#bpy.types.SpreadsheetTableIDGeometry.object_eval_state)
    - [`SpreadsheetTableIDGeometry.viewer_path`](#bpy.types.SpreadsheetTableIDGeometry.viewer_path)
    - [`SpreadsheetTableIDGeometry.bl_rna_get_subclass()`](#bpy.types.SpreadsheetTableIDGeometry.bl_rna_get_subclass)
    - [`SpreadsheetTableIDGeometry.bl_rna_get_subclass_py()`](#bpy.types.SpreadsheetTableIDGeometry.bl_rna_get_subclass_py)
