...
# ThemeRegionsSidebars(bpy\_struct)[¶](#themeregionssidebars-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.ThemeRegionsSidebars(*bpy\_struct*)[¶](#bpy.types.ThemeRegionsSidebars "Link to this definition")
:   back[¶](#bpy.types.ThemeRegionsSidebars.back "Link to this definition")
    :   Type:
        :   float array of 4 items in [0, 1], default (0.0, 0.0, 0.0, 0.0)

    tab\_back[¶](#bpy.types.ThemeRegionsSidebars.tab_back "Link to this definition")
    :   Type:
        :   float array of 4 items in [0, 1], default (0.0, 0.0, 0.0, 0.0)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ThemeRegionsSidebars.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ThemeRegionsSidebars.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`ThemeRegions.sidebars`](ThemeRegions.md#bpy.types.ThemeRegions.sidebars "bpy.types.ThemeRegions.sidebars") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ThemeRegionsSidebars.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ThemeRegionsSidebars.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ThemeRegionsSidebars(bpy\_struct)
  + [`ThemeRegionsSidebars`](#bpy.types.ThemeRegionsSidebars)
    - [`ThemeRegionsSidebars.back`](#bpy.types.ThemeRegionsSidebars.back)
    - [`ThemeRegionsSidebars.tab_back`](#bpy.types.ThemeRegionsSidebars.tab_back)
    - [`ThemeRegionsSidebars.bl_rna_get_subclass()`](#bpy.types.ThemeRegionsSidebars.bl_rna_get_subclass)
    - [`ThemeRegionsSidebars.bl_rna_get_subclass_py()`](#bpy.types.ThemeRegionsSidebars.bl_rna_get_subclass_py)
