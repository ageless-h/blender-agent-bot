...
# RenderViews(bpy\_struct)[¶](#renderviews-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.RenderViews(*bpy\_struct*)[¶](#bpy.types.RenderViews "Link to this definition")
:   Collection of render views

    active[¶](#bpy.types.RenderViews.active "Link to this definition")
    :   Active Render View

        Type:
        :   [`SceneRenderView`](SceneRenderView.md#bpy.types.SceneRenderView "bpy.types.SceneRenderView"), (never None)

    active\_index[¶](#bpy.types.RenderViews.active_index "Link to this definition")
    :   Active index in render view array

        Type:
        :   int in [0, 32767], default 0

    new(*name*)[¶](#bpy.types.RenderViews.new "Link to this definition")
    :   Add a render view to scene
        ...
        Return type:
        :   [`SceneRenderView`](SceneRenderView.md#bpy.types.SceneRenderView "bpy.types.SceneRenderView")

    remove(*view*)[¶](#bpy.types.RenderViews.remove "Link to this definition")
    :   Remove a render view

        Parameters:
        :   **view** ([`SceneRenderView`](SceneRenderView.md#bpy.types.SceneRenderView "bpy.types.SceneRenderView"), (never None)) – Render view to remove

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.RenderViews.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.RenderViews.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`RenderSettings.views`](RenderSettings.md#bpy.types.RenderSettings.views "bpy.types.RenderSettings.views") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.RenderViews.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.RenderViews.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* RenderViews(bpy\_struct)
  + [`RenderViews`](#bpy.types.RenderViews)
    - [`RenderViews.active`](#bpy.types.RenderViews.active)
    - [`RenderViews.active_index`](#bpy.types.RenderViews.active_index)
    - [`RenderViews.new()`](#bpy.types.RenderViews.new)
    - [`RenderViews.remove()`](#bpy.types.RenderViews.remove)
    - [`RenderViews.bl_rna_get_subclass()`](#bpy.types.RenderViews.bl_rna_get_subclass)
    - [`RenderViews.bl_rna_get_subclass_py()`](#bpy.types.RenderViews.bl_rna_get_subclass_py)
