...
# CollectionChildren(bpy\_struct)[¶](#collectionchildren-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.CollectionChildren(*bpy\_struct*)[¶](#bpy.types.CollectionChildren "Link to this definition")
:   Collection of child collections

    link(*child*)[¶](#bpy.types.CollectionChildren.link "Link to this definition")
    :   Add this collection as child of this collection

        Parameters:
        :   **child** ([`Collection`](Collection.md#bpy.types.Collection "bpy.types.Collection"), (never None)) – Collection to add

    unlink(*child*)[¶](#bpy.types.CollectionChildren.unlink "Link to this definition")
    :   Remove this child collection from a collection

        Parameters:
        :   **child** ([`Collection`](Collection.md#bpy.types.Collection "bpy.types.Collection")) – Collection to remove

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.CollectionChildren.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.CollectionChildren.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Collection.children`](Collection.md#bpy.types.Collection.children "bpy.types.Collection.children") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CollectionChildren.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.CollectionChildren.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CollectionChildren(bpy\_struct)
  + [`CollectionChildren`](#bpy.types.CollectionChildren)
    - [`CollectionChildren.link()`](#bpy.types.CollectionChildren.link)
    - [`CollectionChildren.unlink()`](#bpy.types.CollectionChildren.unlink)
    - [`CollectionChildren.bl_rna_get_subclass()`](#bpy.types.CollectionChildren.bl_rna_get_subclass)
    - [`CollectionChildren.bl_rna_get_subclass_py()`](#bpy.types.CollectionChildren.bl_rna_get_subclass_py)
