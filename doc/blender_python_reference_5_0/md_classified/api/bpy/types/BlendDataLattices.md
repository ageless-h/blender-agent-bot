...
# BlendDataLattices(bpy\_struct)[¶](#blenddatalattices-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.BlendDataLattices(*bpy\_struct*)[¶](#bpy.types.BlendDataLattices "Link to this definition")
:   Collection of lattices

    new(*name*)[¶](#bpy.types.BlendDataLattices.new "Link to this definition")
    :   Add a new lattice to the main database
        ...
        Return type:
        :   [`Lattice`](Lattice.md#bpy.types.Lattice "bpy.types.Lattice")

    remove(*lattice*, *\**, *do\_unlink=True*, *do\_id\_user=True*, *do\_ui\_user=True*)[¶](#bpy.types.BlendDataLattices.remove "Link to this definition")
    :   Remove a lattice from the current blendfile

        Parameters:
        :   * **lattice** ([`Lattice`](Lattice.md#bpy.types.Lattice "bpy.types.Lattice"), (never None)) – Lattice to remove
            * **do\_unlink** (*boolean**,* *(**optional**)*) – Unlink all usages of this lattice before deleting it (WARNING: will also delete objects instancing that lattice data)
            * **do\_id\_user** (*boolean**,* *(**optional**)*) – Decrement user counter of all data-blocks used by this lattice data
            * **do\_ui\_user** (*boolean**,* *(**optional**)*) – Make sure interface does not reference this lattice data

    tag(*value*)[¶](#bpy.types.BlendDataLattices.tag "Link to this definition")
    :   tag

        Parameters:
        :   **value** (*boolean*) – Value

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.BlendDataLattices.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.BlendDataLattices.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`BlendData.lattices`](BlendData.md#bpy.types.BlendData.lattices "bpy.types.BlendData.lattices") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.BlendDataLattices.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.BlendDataLattices.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* BlendDataLattices(bpy\_struct)
  + [`BlendDataLattices`](#bpy.types.BlendDataLattices)
    - [`BlendDataLattices.new()`](#bpy.types.BlendDataLattices.new)
    - [`BlendDataLattices.remove()`](#bpy.types.BlendDataLattices.remove)
    - [`BlendDataLattices.tag()`](#bpy.types.BlendDataLattices.tag)
    - [`BlendDataLattices.bl_rna_get_subclass()`](#bpy.types.BlendDataLattices.bl_rna_get_subclass)
    - [`BlendDataLattices.bl_rna_get_subclass_py()`](#bpy.types.BlendDataLattices.bl_rna_get_subclass_py)
