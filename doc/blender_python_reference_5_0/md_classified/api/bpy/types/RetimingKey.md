...
# RetimingKey(bpy\_struct)[¶](#retimingkey-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.RetimingKey(*bpy\_struct*)[¶](#bpy.types.RetimingKey "Link to this definition")
:   Key mapped to particular frame that can be moved to change playback speed

    timeline\_frame[¶](#bpy.types.RetimingKey.timeline_frame "Link to this definition")
    :   Position of retiming key in timeline

        Type:
        :   int in [-inf, inf], default 0

    remove()[¶](#bpy.types.RetimingKey.remove "Link to this definition")
    :   Remove retiming key

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.RetimingKey.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.RetimingKey.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`ImageStrip.retiming_keys`](ImageStrip.md#bpy.types.ImageStrip.retiming_keys "bpy.types.ImageStrip.retiming_keys") * [`MovieStrip.retiming_keys`](MovieStrip.md#bpy.types.MovieStrip.retiming_keys "bpy.types.MovieStrip.retiming_keys") * [`RetimingKeys.add`](RetimingKeys.md#bpy.types.RetimingKeys.add "bpy.types.RetimingKeys.add") | * [`SceneStrip.retiming_keys`](SceneStrip.md#bpy.types.SceneStrip.retiming_keys "bpy.types.SceneStrip.retiming_keys") * [`SoundStrip.retiming_keys`](SoundStrip.md#bpy.types.SoundStrip.retiming_keys "bpy.types.SoundStrip.retiming_keys") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.RetimingKey.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.RetimingKey.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* RetimingKey(bpy\_struct)
  + [`RetimingKey`](#bpy.types.RetimingKey)
    - [`RetimingKey.timeline_frame`](#bpy.types.RetimingKey.timeline_frame)
    - [`RetimingKey.remove()`](#bpy.types.RetimingKey.remove)
    - [`RetimingKey.bl_rna_get_subclass()`](#bpy.types.RetimingKey.bl_rna_get_subclass)
    - [`RetimingKey.bl_rna_get_subclass_py()`](#bpy.types.RetimingKey.bl_rna_get_subclass_py)
