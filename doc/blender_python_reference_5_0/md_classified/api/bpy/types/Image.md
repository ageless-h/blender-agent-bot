...
:   Image data-block referencing an external or packed image
    ...
    :   Format used for re-saving this file
        ...
        Type:
        :   enum in [Image Type All Items](../../../appendix/bpy_types_enum_items/image_type_all_items.md#rna-enum-image-type-all-items), default `'TARGA'`
    ...
    :   Generated image type
        ...
        Type:
        :   enum in [Image Generated Type Items](../../../appendix/bpy_types_enum_items/image_generated_type_items.md#rna-enum-image-generated-type-items), default `'UV_GRID'`
    ...
    save(*\**, *filepath=''*, *quality=0*, *save\_copy=False*)[¶](#bpy.types.Image.save "Link to this definition")
    :   Save image
...
IO\_FH\_svg\_as\_curves(FileHandler)](IO_FH_svg_as_curves.md)
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.Image.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.Image.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)
