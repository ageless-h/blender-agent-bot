...
# SequenceTimelineChannel(bpy\_struct)[¶](#sequencetimelinechannel-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.SequenceTimelineChannel(*bpy\_struct*)[¶](#bpy.types.SequenceTimelineChannel "Link to this definition")
:   lock[¶](#bpy.types.SequenceTimelineChannel.lock "Link to this definition")
    :   Type:
        :   boolean, default False

    mute[¶](#bpy.types.SequenceTimelineChannel.mute "Link to this definition")
    :   Type:
        :   boolean, default False

    name[¶](#bpy.types.SequenceTimelineChannel.name "Link to this definition")
    :   Type:
        :   string, default “”, (never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.SequenceTimelineChannel.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.SequenceTimelineChannel.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`MetaStrip.channels`](MetaStrip.md#bpy.types.MetaStrip.channels "bpy.types.MetaStrip.channels") | * [`SequenceEditor.channels`](SequenceEditor.md#bpy.types.SequenceEditor.channels "bpy.types.SequenceEditor.channels") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.SequenceTimelineChannel.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.SequenceTimelineChannel.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* SequenceTimelineChannel(bpy\_struct)
  + [`SequenceTimelineChannel`](#bpy.types.SequenceTimelineChannel)
    - [`SequenceTimelineChannel.lock`](#bpy.types.SequenceTimelineChannel.lock)
    - [`SequenceTimelineChannel.mute`](#bpy.types.SequenceTimelineChannel.mute)
    - [`SequenceTimelineChannel.name`](#bpy.types.SequenceTimelineChannel.name)
    - [`SequenceTimelineChannel.bl_rna_get_subclass()`](#bpy.types.SequenceTimelineChannel.bl_rna_get_subclass)
    - [`SequenceTimelineChannel.bl_rna_get_subclass_py()`](#bpy.types.SequenceTimelineChannel.bl_rna_get_subclass_py)
