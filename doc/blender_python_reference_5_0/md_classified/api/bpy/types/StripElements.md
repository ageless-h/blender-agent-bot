...
# StripElements(bpy\_struct)[¶](#stripelements-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.StripElements(*bpy\_struct*)[¶](#bpy.types.StripElements "Link to this definition")
:   Collection of StripElement

    append(*filename*)[¶](#bpy.types.StripElements.append "Link to this definition")
    :   Push an image from ImageStrip.directory

        Parameters:
        :   **filename** (*string**,* *(**never None**)*) – Filepath to image
    ...
    pop(*index*)[¶](#bpy.types.StripElements.pop "Link to this definition")
    :   Pop an image off the collection

        Parameters:
        :   **index** (*int in* *[**-inf**,* *inf**]*) – Index of image to remove

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.StripElements.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.StripElements.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`ImageStrip.elements`](ImageStrip.md#bpy.types.ImageStrip.elements "bpy.types.ImageStrip.elements") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.StripElements.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.StripElements.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* StripElements(bpy\_struct)
  + [`StripElements`](#bpy.types.StripElements)
    - [`StripElements.append()`](#bpy.types.StripElements.append)
    - [`StripElements.pop()`](#bpy.types.StripElements.pop)
    - [`StripElements.bl_rna_get_subclass()`](#bpy.types.StripElements.bl_rna_get_subclass)
    - [`StripElements.bl_rna_get_subclass_py()`](#bpy.types.StripElements.bl_rna_get_subclass_py)
