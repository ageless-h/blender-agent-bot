...
# EnumPropertyItem(bpy\_struct)[¶](#enumpropertyitem-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.EnumPropertyItem(*bpy\_struct*)[¶](#bpy.types.EnumPropertyItem "Link to this definition")
:   Definition of a choice in an RNA enum property

    description[¶](#bpy.types.EnumPropertyItem.description "Link to this definition")
    :   Description of the item’s purpose

        Type:
        :   string, default “”, (readonly, never None)

    icon[¶](#bpy.types.EnumPropertyItem.icon "Link to this definition")
    :   Icon of the item

        Type:
        :   enum in [Icon Items](../../../appendix/bpy_types_enum_items/icon_items.md#rna-enum-icon-items), default `'NONE'`, (readonly)

    identifier[¶](#bpy.types.EnumPropertyItem.identifier "Link to this definition")
    :   Unique name used in the code and scripting

        Type:
        :   string, default “”, (readonly, never None)

    name[¶](#bpy.types.EnumPropertyItem.name "Link to this definition")
    :   Human readable name

        Type:
        :   string, default “”, (readonly, never None)

    value[¶](#bpy.types.EnumPropertyItem.value "Link to this definition")
    :   Value of the item

        Type:
        :   int in [0, inf], default 0, (readonly)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.EnumPropertyItem.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.EnumPropertyItem.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`EnumProperty.enum_items`](EnumProperty.md#bpy.types.EnumProperty.enum_items "bpy.types.EnumProperty.enum_items") * [`EnumProperty.enum_items_static`](EnumProperty.md#bpy.types.EnumProperty.enum_items_static "bpy.types.EnumProperty.enum_items_static") * [`EnumProperty.enum_items_static_ui`](EnumProperty.md#bpy.types.EnumProperty.enum_items_static_ui "bpy.types.EnumProperty.enum_items_static_ui") | * [`KeyMap.modal_event_values`](KeyMap.md#bpy.types.KeyMap.modal_event_values "bpy.types.KeyMap.modal_event_values") * [`Struct.property_tags`](Struct.md#bpy.types.Struct.property_tags "bpy.types.Struct.property_tags") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.EnumPropertyItem.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.EnumPropertyItem.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* EnumPropertyItem(bpy\_struct)
  + [`EnumPropertyItem`](#bpy.types.EnumPropertyItem)
    - [`EnumPropertyItem.description`](#bpy.types.EnumPropertyItem.description)
    - [`EnumPropertyItem.icon`](#bpy.types.EnumPropertyItem.icon)
    - [`EnumPropertyItem.identifier`](#bpy.types.EnumPropertyItem.identifier)
    - [`EnumPropertyItem.name`](#bpy.types.EnumPropertyItem.name)
    - [`EnumPropertyItem.value`](#bpy.types.EnumPropertyItem.value)
    - [`EnumPropertyItem.bl_rna_get_subclass()`](#bpy.types.EnumPropertyItem.bl_rna_get_subclass)
    - [`EnumPropertyItem.bl_rna_get_subclass_py()`](#bpy.types.EnumPropertyItem.bl_rna_get_subclass_py)
