...
# NodeEvaluateClosureInputItems(bpy\_struct)[¶](#nodeevaluateclosureinputitems-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.NodeEvaluateClosureInputItems(*bpy\_struct*)[¶](#bpy.types.NodeEvaluateClosureInputItems "Link to this definition")
:   new(*socket\_type*, *name*)[¶](#bpy.types.NodeEvaluateClosureInputItems.new "Link to this definition")
    :   Add an item at the end
        ...
        Return type:
        :   [`NodeEvaluateClosureInputItem`](NodeEvaluateClosureInputItem.md#bpy.types.NodeEvaluateClosureInputItem "bpy.types.NodeEvaluateClosureInputItem")

    remove(*item*)[¶](#bpy.types.NodeEvaluateClosureInputItems.remove "Link to this definition")
    :   Remove an item

        Parameters:
        :   **item** ([`NodeEvaluateClosureInputItem`](NodeEvaluateClosureInputItem.md#bpy.types.NodeEvaluateClosureInputItem "bpy.types.NodeEvaluateClosureInputItem"), (never None)) – Item, The item to remove

    clear()[¶](#bpy.types.NodeEvaluateClosureInputItems.clear "Link to this definition")
    :   Remove all items

    move(*from\_index*, *to\_index*)[¶](#bpy.types.NodeEvaluateClosureInputItems.move "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.NodeEvaluateClosureInputItems.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.NodeEvaluateClosureInputItems.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`NodeEvaluateClosure.input_items`](NodeEvaluateClosure.md#bpy.types.NodeEvaluateClosure.input_items "bpy.types.NodeEvaluateClosure.input_items") |  |
...
NodeEvaluateClosureInputItem(bpy\_struct)](NodeEvaluateClosureInputItem.md)
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.NodeEvaluateClosureInputItems.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.NodeEvaluateClosureInputItems.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* NodeEvaluateClosureInputItems(bpy\_struct)
  + [`NodeEvaluateClosureInputItems`](#bpy.types.NodeEvaluateClosureInputItems)
    - [`NodeEvaluateClosureInputItems.new()`](#bpy.types.NodeEvaluateClosureInputItems.new)
    - [`NodeEvaluateClosureInputItems.remove()`](#bpy.types.NodeEvaluateClosureInputItems.remove)
    - [`NodeEvaluateClosureInputItems.clear()`](#bpy.types.NodeEvaluateClosureInputItems.clear)
    - [`NodeEvaluateClosureInputItems.move()`](#bpy.types.NodeEvaluateClosureInputItems.move)
    - [`NodeEvaluateClosureInputItems.bl_rna_get_subclass()`](#bpy.types.NodeEvaluateClosureInputItems.bl_rna_get_subclass)
    - [`NodeEvaluateClosureInputItems.bl_rna_get_subclass_py()`](#bpy.types.NodeEvaluateClosureInputItems.bl_rna_get_subclass_py)
