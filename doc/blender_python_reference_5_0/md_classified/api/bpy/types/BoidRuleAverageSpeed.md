...
# BoidRuleAverageSpeed(BoidRule)[¶](#boidruleaveragespeed-boidrule "Link to this heading")
...
*class* bpy.types.BoidRuleAverageSpeed(*BoidRule*)[¶](#bpy.types.BoidRuleAverageSpeed "Link to this definition")
:   level[¶](#bpy.types.BoidRuleAverageSpeed.level "Link to this definition")
    :   How much velocity’s z-component is kept constant

        Type:
        :   float in [0, 1], default 0.0

    speed[¶](#bpy.types.BoidRuleAverageSpeed.speed "Link to this definition")
    :   Percentage of maximum speed

        Type:
        :   float in [0, 1], default 0.0

    wander[¶](#bpy.types.BoidRuleAverageSpeed.wander "Link to this definition")
    :   How fast velocity’s direction is randomized

        Type:
        :   float in [0, 1], default 0.0

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.BoidRuleAverageSpeed.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.BoidRuleAverageSpeed.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.BoidRuleAverageSpeed.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.BoidRuleAverageSpeed.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* BoidRuleAverageSpeed(BoidRule)
  + [`BoidRuleAverageSpeed`](#bpy.types.BoidRuleAverageSpeed)
    - [`BoidRuleAverageSpeed.level`](#bpy.types.BoidRuleAverageSpeed.level)
    - [`BoidRuleAverageSpeed.speed`](#bpy.types.BoidRuleAverageSpeed.speed)
    - [`BoidRuleAverageSpeed.wander`](#bpy.types.BoidRuleAverageSpeed.wander)
    - [`BoidRuleAverageSpeed.bl_rna_get_subclass()`](#bpy.types.BoidRuleAverageSpeed.bl_rna_get_subclass)
    - [`BoidRuleAverageSpeed.bl_rna_get_subclass_py()`](#bpy.types.BoidRuleAverageSpeed.bl_rna_get_subclass_py)
