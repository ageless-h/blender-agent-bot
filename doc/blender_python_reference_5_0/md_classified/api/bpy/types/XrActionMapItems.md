...
# XrActionMapItems(bpy\_struct)[¶](#xractionmapitems-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.XrActionMapItems(*bpy\_struct*)[¶](#bpy.types.XrActionMapItems "Link to this definition")
:   Collection of XR action map items

    new(*name*, *replace\_existing*)[¶](#bpy.types.XrActionMapItems.new "Link to this definition")
    :   new

        Parameters:
        :   * **name** (*string**,* *(**never None**)*) – Name of the action map item
            * **replace\_existing** (*boolean*) – Replace Existing, Replace any existing item with the same name

        Returns:
        :   Item, Added action map item

        Return type:
        :   [`XrActionMapItem`](XrActionMapItem.md#bpy.types.XrActionMapItem "bpy.types.XrActionMapItem")

    new\_from\_item(*item*)[¶](#bpy.types.XrActionMapItems.new_from_item "Link to this definition")
    :   new\_from\_item

        Parameters:
        :   **item** ([`XrActionMapItem`](XrActionMapItem.md#bpy.types.XrActionMapItem "bpy.types.XrActionMapItem"), (never None)) – Item, Item to use as a reference
    ...
    remove(*item*)[¶](#bpy.types.XrActionMapItems.remove "Link to this definition")
    :   remove

        Parameters:
        :   **item** ([`XrActionMapItem`](XrActionMapItem.md#bpy.types.XrActionMapItem "bpy.types.XrActionMapItem"), (never None)) – Item

    find(*name*)[¶](#bpy.types.XrActionMapItems.find "Link to this definition")
    :   find
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.XrActionMapItems.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.XrActionMapItems.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`XrActionMap.actionmap_items`](XrActionMap.md#bpy.types.XrActionMap.actionmap_items "bpy.types.XrActionMap.actionmap_items") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.XrActionMapItems.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.XrActionMapItems.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* XrActionMapItems(bpy\_struct)
  + [`XrActionMapItems`](#bpy.types.XrActionMapItems)
    - [`XrActionMapItems.new()`](#bpy.types.XrActionMapItems.new)
    - [`XrActionMapItems.new_from_item()`](#bpy.types.XrActionMapItems.new_from_item)
    - [`XrActionMapItems.remove()`](#bpy.types.XrActionMapItems.remove)
    - [`XrActionMapItems.find()`](#bpy.types.XrActionMapItems.find)
    - [`XrActionMapItems.bl_rna_get_subclass()`](#bpy.types.XrActionMapItems.bl_rna_get_subclass)
    - [`XrActionMapItems.bl_rna_get_subclass_py()`](#bpy.types.XrActionMapItems.bl_rna_get_subclass_py)
