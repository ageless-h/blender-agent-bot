...
# StripCrop(bpy\_struct)[¶](#stripcrop-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.StripCrop(*bpy\_struct*)[¶](#bpy.types.StripCrop "Link to this definition")
:   Cropping parameters for a sequence strip

    max\_x[¶](#bpy.types.StripCrop.max_x "Link to this definition")
    :   Number of pixels to crop from the right side

        Type:
        :   int in [-inf, inf], default 0

    max\_y[¶](#bpy.types.StripCrop.max_y "Link to this definition")
    :   Number of pixels to crop from the top

        Type:
        :   int in [-inf, inf], default 0

    min\_x[¶](#bpy.types.StripCrop.min_x "Link to this definition")
    :   Number of pixels to crop from the left side

        Type:
        :   int in [-inf, inf], default 0

    min\_y[¶](#bpy.types.StripCrop.min_y "Link to this definition")
    :   Number of pixels to crop from the bottom

        Type:
        :   int in [-inf, inf], default 0

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.StripCrop.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.StripCrop.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`EffectStrip.crop`](EffectStrip.md#bpy.types.EffectStrip.crop "bpy.types.EffectStrip.crop") * [`ImageStrip.crop`](ImageStrip.md#bpy.types.ImageStrip.crop "bpy.types.ImageStrip.crop") * [`MaskStrip.crop`](MaskStrip.md#bpy.types.MaskStrip.crop "bpy.types.MaskStrip.crop") * [`MetaStrip.crop`](MetaStrip.md#bpy.types.MetaStrip.crop "bpy.types.MetaStrip.crop") | * [`MovieClipStrip.crop`](MovieClipStrip.md#bpy.types.MovieClipStrip.crop "bpy.types.MovieClipStrip.crop") * [`MovieStrip.crop`](MovieStrip.md#bpy.types.MovieStrip.crop "bpy.types.MovieStrip.crop") * [`SceneStrip.crop`](SceneStrip.md#bpy.types.SceneStrip.crop "bpy.types.SceneStrip.crop") |

[Next

StripElement(bpy\_struct)](StripElement.md)
[Previous
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.StripCrop.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.StripCrop.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* StripCrop(bpy\_struct)
  + [`StripCrop`](#bpy.types.StripCrop)
    - [`StripCrop.max_x`](#bpy.types.StripCrop.max_x)
    - [`StripCrop.max_y`](#bpy.types.StripCrop.max_y)
    - [`StripCrop.min_x`](#bpy.types.StripCrop.min_x)
    - [`StripCrop.min_y`](#bpy.types.StripCrop.min_y)
    - [`StripCrop.bl_rna_get_subclass()`](#bpy.types.StripCrop.bl_rna_get_subclass)
    - [`StripCrop.bl_rna_get_subclass_py()`](#bpy.types.StripCrop.bl_rna_get_subclass_py)
