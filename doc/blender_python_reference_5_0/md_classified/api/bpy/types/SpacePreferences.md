...
# SpacePreferences(Space)[¶](#spacepreferences-space "Link to this heading")
...
*class* bpy.types.SpacePreferences(*Space*)[¶](#bpy.types.SpacePreferences "Link to this definition")
:   Blender preferences space data

    filter\_text[¶](#bpy.types.SpacePreferences.filter_text "Link to this definition")
    :   Search term for filtering in the UI

        Type:
        :   string, default “”, (never None)

    filter\_type[¶](#bpy.types.SpacePreferences.filter_type "Link to this definition")
    :   Filter method
        ...
        * `KEY`
        ...
        Type:
        :   enum in [`'NAME'`, `'KEY'`], default `'NAME'`

    show\_region\_ui[¶](#bpy.types.SpacePreferences.show_region_ui "Link to this definition")
    :   Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.SpacePreferences.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.SpacePreferences.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
    ...
    *classmethod* draw\_handler\_add(*callback*, *args*, *region\_type*, *draw\_type*)[¶](#bpy.types.SpacePreferences.draw_handler_add "Link to this definition")
    ...
    *classmethod* draw\_handler\_remove(*handler*, *region\_type*)[¶](#bpy.types.SpacePreferences.draw_handler_remove "Link to this definition")
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.SpacePreferences.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.SpacePreferences.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* SpacePreferences(Space)
  + [`SpacePreferences`](#bpy.types.SpacePreferences)
    - [`SpacePreferences.filter_text`](#bpy.types.SpacePreferences.filter_text)
    - [`SpacePreferences.filter_type`](#bpy.types.SpacePreferences.filter_type)
    - [`SpacePreferences.show_region_ui`](#bpy.types.SpacePreferences.show_region_ui)
    - [`SpacePreferences.bl_rna_get_subclass()`](#bpy.types.SpacePreferences.bl_rna_get_subclass)
    - [`SpacePreferences.bl_rna_get_subclass_py()`](#bpy.types.SpacePreferences.bl_rna_get_subclass_py)
    - [`SpacePreferences.draw_handler_add()`](#bpy.types.SpacePreferences.draw_handler_add)
    - [`SpacePreferences.draw_handler_remove()`](#bpy.types.SpacePreferences.draw_handler_remove)
