...
# TextLine(bpy\_struct)[¶](#textline-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.TextLine(*bpy\_struct*)[¶](#bpy.types.TextLine "Link to this definition")
:   Line of text in a Text data-block

    body[¶](#bpy.types.TextLine.body "Link to this definition")
    :   Text in the line

        Type:
        :   string, default “”, (never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.TextLine.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.TextLine.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Text.current_line`](Text.md#bpy.types.Text.current_line "bpy.types.Text.current_line") * [`Text.lines`](Text.md#bpy.types.Text.lines "bpy.types.Text.lines") | * [`Text.select_end_line`](Text.md#bpy.types.Text.select_end_line "bpy.types.Text.select_end_line") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.TextLine.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.TextLine.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* TextLine(bpy\_struct)
  + [`TextLine`](#bpy.types.TextLine)
    - [`TextLine.body`](#bpy.types.TextLine.body)
    - [`TextLine.bl_rna_get_subclass()`](#bpy.types.TextLine.bl_rna_get_subclass)
    - [`TextLine.bl_rna_get_subclass_py()`](#bpy.types.TextLine.bl_rna_get_subclass_py)
