...
# MovieTrackingMarker(bpy\_struct)[¶](#movietrackingmarker-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.MovieTrackingMarker(*bpy\_struct*)[¶](#bpy.types.MovieTrackingMarker "Link to this definition")
:   Match-moving marker data for tracking

    co[¶](#bpy.types.MovieTrackingMarker.co "Link to this definition")
    ...
    frame[¶](#bpy.types.MovieTrackingMarker.frame "Link to this definition")
    :   Frame number marker is keyframed on

        Type:
        :   int in [-inf, inf], default 0

    is\_keyed[¶](#bpy.types.MovieTrackingMarker.is_keyed "Link to this definition")
    :   Whether the position of the marker is keyframed or tracked

        Type:
        :   boolean, default True

    mute[¶](#bpy.types.MovieTrackingMarker.mute "Link to this definition")
    :   Is marker muted for current frame

        Type:
        :   boolean, default False

    pattern\_bound\_box[¶](#bpy.types.MovieTrackingMarker.pattern_bound_box "Link to this definition")
    ...
    pattern\_corners[¶](#bpy.types.MovieTrackingMarker.pattern_corners "Link to this definition")
    ...
    search\_max[¶](#bpy.types.MovieTrackingMarker.search_max "Link to this definition")
    :   Right-bottom corner of search area in normalized coordinates relative to marker position

        Type:
        :   [`mathutils.Vector`](../../mathutils/index.md#mathutils.Vector "mathutils.Vector") of 2 items in [-inf, inf], default (0.0, 0.0)

    search\_min[¶](#bpy.types.MovieTrackingMarker.search_min "Link to this definition")
    :   Left-bottom corner of search area in normalized coordinates relative to marker position

        Type:
        :   [`mathutils.Vector`](../../mathutils/index.md#mathutils.Vector "mathutils.Vector") of 2 items in [-inf, inf], default (0.0, 0.0)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.MovieTrackingMarker.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.MovieTrackingMarker.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`MovieTrackingMarkers.find_frame`](MovieTrackingMarkers.md#bpy.types.MovieTrackingMarkers.find_frame "bpy.types.MovieTrackingMarkers.find_frame") * [`MovieTrackingMarkers.insert_frame`](MovieTrackingMarkers.md#bpy.types.MovieTrackingMarkers.insert_frame "bpy.types.MovieTrackingMarkers.insert_frame") | * [`MovieTrackingTrack.markers`](MovieTrackingTrack.md#bpy.types.MovieTrackingTrack.markers "bpy.types.MovieTrackingTrack.markers") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.MovieTrackingMarker.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.MovieTrackingMarker.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* MovieTrackingMarker(bpy\_struct)
  + [`MovieTrackingMarker`](#bpy.types.MovieTrackingMarker)
    - [`MovieTrackingMarker.co`](#bpy.types.MovieTrackingMarker.co)
    - [`MovieTrackingMarker.frame`](#bpy.types.MovieTrackingMarker.frame)
    - [`MovieTrackingMarker.is_keyed`](#bpy.types.MovieTrackingMarker.is_keyed)
    - [`MovieTrackingMarker.mute`](#bpy.types.MovieTrackingMarker.mute)
    - [`MovieTrackingMarker.pattern_bound_box`](#bpy.types.MovieTrackingMarker.pattern_bound_box)
    - [`MovieTrackingMarker.pattern_corners`](#bpy.types.MovieTrackingMarker.pattern_corners)
    - [`MovieTrackingMarker.search_max`](#bpy.types.MovieTrackingMarker.search_max)
    - [`MovieTrackingMarker.search_min`](#bpy.types.MovieTrackingMarker.search_min)
    - [`MovieTrackingMarker.bl_rna_get_subclass()`](#bpy.types.MovieTrackingMarker.bl_rna_get_subclass)
    - [`MovieTrackingMarker.bl_rna_get_subclass_py()`](#bpy.types.MovieTrackingMarker.bl_rna_get_subclass_py)
