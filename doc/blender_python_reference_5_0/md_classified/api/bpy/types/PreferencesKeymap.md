...
# PreferencesKeymap(bpy\_struct)[¶](#preferenceskeymap-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.PreferencesKeymap(*bpy\_struct*)[¶](#bpy.types.PreferencesKeymap "Link to this definition")
:   Shortcut setup for keyboards and other input devices

    active\_keyconfig[¶](#bpy.types.PreferencesKeymap.active_keyconfig "Link to this definition")
    :   The name of the active key configuration

        Type:
        :   string, default “”, (never None)

    show\_ui\_keyconfig[¶](#bpy.types.PreferencesKeymap.show_ui_keyconfig "Link to this definition")
    :   Type:
        :   boolean, default True

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.PreferencesKeymap.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.PreferencesKeymap.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Preferences.keymap`](Preferences.md#bpy.types.Preferences.keymap "bpy.types.Preferences.keymap") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.PreferencesKeymap.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.PreferencesKeymap.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* PreferencesKeymap(bpy\_struct)
  + [`PreferencesKeymap`](#bpy.types.PreferencesKeymap)
    - [`PreferencesKeymap.active_keyconfig`](#bpy.types.PreferencesKeymap.active_keyconfig)
    - [`PreferencesKeymap.show_ui_keyconfig`](#bpy.types.PreferencesKeymap.show_ui_keyconfig)
    - [`PreferencesKeymap.bl_rna_get_subclass()`](#bpy.types.PreferencesKeymap.bl_rna_get_subclass)
    - [`PreferencesKeymap.bl_rna_get_subclass_py()`](#bpy.types.PreferencesKeymap.bl_rna_get_subclass_py)
