...
# ParticleSettingsTextureSlots(bpy\_struct)[¶](#particlesettingstextureslots-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.ParticleSettingsTextureSlots(*bpy\_struct*)[¶](#bpy.types.ParticleSettingsTextureSlots "Link to this definition")
:   Collection of texture slots

    *classmethod* add()[¶](#bpy.types.ParticleSettingsTextureSlots.add "Link to this definition")
    :   add
        ...
        Return type:
        :   [`ParticleSettingsTextureSlot`](ParticleSettingsTextureSlot.md#bpy.types.ParticleSettingsTextureSlot "bpy.types.ParticleSettingsTextureSlot")

    *classmethod* create(*index*)[¶](#bpy.types.ParticleSettingsTextureSlots.create "Link to this definition")
    :   create
    ...
    *classmethod* clear(*index*)[¶](#bpy.types.ParticleSettingsTextureSlots.clear "Link to this definition")
    :   clear

        Parameters:
        :   **index** (*int in* *[**0**,* *inf**]*) – Index, Slot index to clear

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ParticleSettingsTextureSlots.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ParticleSettingsTextureSlots.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`ParticleSettings.texture_slots`](ParticleSettings.md#bpy.types.ParticleSettings.texture_slots "bpy.types.ParticleSettings.texture_slots") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ParticleSettingsTextureSlots.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ParticleSettingsTextureSlots.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ParticleSettingsTextureSlots(bpy\_struct)
  + [`ParticleSettingsTextureSlots`](#bpy.types.ParticleSettingsTextureSlots)
    - [`ParticleSettingsTextureSlots.add()`](#bpy.types.ParticleSettingsTextureSlots.add)
    - [`ParticleSettingsTextureSlots.create()`](#bpy.types.ParticleSettingsTextureSlots.create)
    - [`ParticleSettingsTextureSlots.clear()`](#bpy.types.ParticleSettingsTextureSlots.clear)
    - [`ParticleSettingsTextureSlots.bl_rna_get_subclass()`](#bpy.types.ParticleSettingsTextureSlots.bl_rna_get_subclass)
    - [`ParticleSettingsTextureSlots.bl_rna_get_subclass_py()`](#bpy.types.ParticleSettingsTextureSlots.bl_rna_get_subclass_py)
