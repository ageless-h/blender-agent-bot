...
# DriverTarget(bpy\_struct)[¶](#drivertarget-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.DriverTarget(*bpy\_struct*)[¶](#bpy.types.DriverTarget "Link to this definition")
:   Source of input values for driver variables

    bone\_target[¶](#bpy.types.DriverTarget.bone_target "Link to this definition")
    :   Name of PoseBone to use as target

        Type:
        :   string, default “”, (never None)

    context\_property[¶](#bpy.types.DriverTarget.context_property "Link to this definition")
    ...
    data\_path[¶](#bpy.types.DriverTarget.data_path "Link to this definition")
    :   RNA Path (from ID-block) to property used

        Type:
        :   string, default “”, (never None)

    fallback\_value[¶](#bpy.types.DriverTarget.fallback_value "Link to this definition")
    :   The value to use if the data path cannot be resolved

        Type:
        :   float in [-inf, inf], default 0.0

    id[¶](#bpy.types.DriverTarget.id "Link to this definition")
    :   ID-block that the specific property used can be found from (id\_type property must be set first)

        Type:
        :   [`ID`](ID.md#bpy.types.ID "bpy.types.ID")

    id\_type[¶](#bpy.types.DriverTarget.id_type "Link to this definition")
    :   Type of ID-block that can be used

        Type:
        :   enum in [Id Type Items](../../../appendix/bpy_types_enum_items/id_type_items.md#rna-enum-id-type-items), default `'OBJECT'`

    is\_fallback\_used[¶](#bpy.types.DriverTarget.is_fallback_used "Link to this definition")
    :   Indicates that the most recent variable evaluation used the fallback value

        Type:
        :   boolean, default False, (readonly)

    rotation\_mode[¶](#bpy.types.DriverTarget.rotation_mode "Link to this definition")
    ...
    transform\_space[¶](#bpy.types.DriverTarget.transform_space "Link to this definition")
    ...
    transform\_type[¶](#bpy.types.DriverTarget.transform_type "Link to this definition")
    :   Driver variable type

        Type:
        :   enum in [`'LOC_X'`, `'LOC_Y'`, `'LOC_Z'`, `'ROT_X'`, `'ROT_Y'`, `'ROT_Z'`, `'ROT_W'`, `'SCALE_X'`, `'SCALE_Y'`, `'SCALE_Z'`, `'SCALE_AVG'`], default `'LOC_X'`

    use\_fallback\_value[¶](#bpy.types.DriverTarget.use_fallback_value "Link to this definition")
    :   Use the fallback value if the data path cannot be resolved, instead of failing to evaluate the driver

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.DriverTarget.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.DriverTarget.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`DriverVariable.targets`](DriverVariable.md#bpy.types.DriverVariable.targets "bpy.types.DriverVariable.targets") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.DriverTarget.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.DriverTarget.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* DriverTarget(bpy\_struct)
  + [`DriverTarget`](#bpy.types.DriverTarget)
    - [`DriverTarget.bone_target`](#bpy.types.DriverTarget.bone_target)
    - [`DriverTarget.context_property`](#bpy.types.DriverTarget.context_property)
    - [`DriverTarget.data_path`](#bpy.types.DriverTarget.data_path)
    - [`DriverTarget.fallback_value`](#bpy.types.DriverTarget.fallback_value)
    - [`DriverTarget.id`](#bpy.types.DriverTarget.id)
    - [`DriverTarget.id_type`](#bpy.types.DriverTarget.id_type)
    - [`DriverTarget.is_fallback_used`](#bpy.types.DriverTarget.is_fallback_used)
    - [`DriverTarget.rotation_mode`](#bpy.types.DriverTarget.rotation_mode)
    - [`DriverTarget.transform_space`](#bpy.types.DriverTarget.transform_space)
    - [`DriverTarget.transform_type`](#bpy.types.DriverTarget.transform_type)
    - [`DriverTarget.use_fallback_value`](#bpy.types.DriverTarget.use_fallback_value)
    - [`DriverTarget.bl_rna_get_subclass()`](#bpy.types.DriverTarget.bl_rna_get_subclass)
    - [`DriverTarget.bl_rna_get_subclass_py()`](#bpy.types.DriverTarget.bl_rna_get_subclass_py)
