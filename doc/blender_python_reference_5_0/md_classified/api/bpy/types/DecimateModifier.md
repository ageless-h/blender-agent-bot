...
# DecimateModifier(Modifier)[¶](#decimatemodifier-modifier "Link to this heading")
...
*class* bpy.types.DecimateModifier(*Modifier*)[¶](#bpy.types.DecimateModifier "Link to this definition")
:   Decimation modifier

    angle\_limit[¶](#bpy.types.DecimateModifier.angle_limit "Link to this definition")
    :   Only dissolve angles below this (planar only)

        Type:
        :   float in [0, 3.14159], default 0.0872665

    decimate\_type[¶](#bpy.types.DecimateModifier.decimate_type "Link to this definition")
    :   * `COLLAPSE`
    ...
    delimit[¶](#bpy.types.DecimateModifier.delimit "Link to this definition")
    :   Limit merging geometry

        Type:
        :   enum set in [Mesh Delimit Mode Items](../../../appendix/bpy_types_enum_items/mesh_delimit_mode_items.md#rna-enum-mesh-delimit-mode-items), default set()

    face\_count[¶](#bpy.types.DecimateModifier.face_count "Link to this definition")
    :   The current number of faces in the decimated mesh

        Type:
        :   int in [-inf, inf], default 0, (readonly)

    invert\_vertex\_group[¶](#bpy.types.DecimateModifier.invert_vertex_group "Link to this definition")
    :   Invert vertex group influence (collapse only)

        Type:
        :   boolean, default False

    iterations[¶](#bpy.types.DecimateModifier.iterations "Link to this definition")
    :   Number of times reduce the geometry (unsubdivide only)

        Type:
        :   int in [0, 32767], default 0

    ratio[¶](#bpy.types.DecimateModifier.ratio "Link to this definition")
    :   Ratio of triangles to reduce to (collapse only)

        Type:
        :   float in [0, 1], default 1.0

    symmetry\_axis[¶](#bpy.types.DecimateModifier.symmetry_axis "Link to this definition")
    :   Axis of symmetry

        Type:
        :   enum in [Axis Xyz Items](../../../appendix/bpy_types_enum_items/axis_xyz_items.md#rna-enum-axis-xyz-items), default `'X'`

    use\_collapse\_triangulate[¶](#bpy.types.DecimateModifier.use_collapse_triangulate "Link to this definition")
    :   Keep triangulated faces resulting from decimation (collapse only)

        Type:
        :   boolean, default False

    use\_dissolve\_boundaries[¶](#bpy.types.DecimateModifier.use_dissolve_boundaries "Link to this definition")
    :   Dissolve all vertices in between face boundaries (planar only)

        Type:
        :   boolean, default False

    use\_symmetry[¶](#bpy.types.DecimateModifier.use_symmetry "Link to this definition")
    :   Maintain symmetry on an axis

        Type:
        :   boolean, default False

    vertex\_group[¶](#bpy.types.DecimateModifier.vertex_group "Link to this definition")
    :   Vertex group name (collapse only)

        Type:
        :   string, default “”, (never None)

    vertex\_group\_factor[¶](#bpy.types.DecimateModifier.vertex_group_factor "Link to this definition")
    :   Vertex group strength

        Type:
        :   float in [0, 1000], default 1.0

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.DecimateModifier.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.DecimateModifier.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.DecimateModifier.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.DecimateModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* DecimateModifier(Modifier)
  + [`DecimateModifier`](#bpy.types.DecimateModifier)
    - [`DecimateModifier.angle_limit`](#bpy.types.DecimateModifier.angle_limit)
    - [`DecimateModifier.decimate_type`](#bpy.types.DecimateModifier.decimate_type)
    - [`DecimateModifier.delimit`](#bpy.types.DecimateModifier.delimit)
    - [`DecimateModifier.face_count`](#bpy.types.DecimateModifier.face_count)
    - [`DecimateModifier.invert_vertex_group`](#bpy.types.DecimateModifier.invert_vertex_group)
    - [`DecimateModifier.iterations`](#bpy.types.DecimateModifier.iterations)
    - [`DecimateModifier.ratio`](#bpy.types.DecimateModifier.ratio)
    - [`DecimateModifier.symmetry_axis`](#bpy.types.DecimateModifier.symmetry_axis)
    - [`DecimateModifier.use_collapse_triangulate`](#bpy.types.DecimateModifier.use_collapse_triangulate)
    - [`DecimateModifier.use_dissolve_boundaries`](#bpy.types.DecimateModifier.use_dissolve_boundaries)
    - [`DecimateModifier.use_symmetry`](#bpy.types.DecimateModifier.use_symmetry)
    - [`DecimateModifier.vertex_group`](#bpy.types.DecimateModifier.vertex_group)
    - [`DecimateModifier.vertex_group_factor`](#bpy.types.DecimateModifier.vertex_group_factor)
    - [`DecimateModifier.bl_rna_get_subclass()`](#bpy.types.DecimateModifier.bl_rna_get_subclass)
    - [`DecimateModifier.bl_rna_get_subclass_py()`](#bpy.types.DecimateModifier.bl_rna_get_subclass_py)
