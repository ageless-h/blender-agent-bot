...
# NodeLink(bpy\_struct)[¶](#nodelink-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.NodeLink(*bpy\_struct*)[¶](#bpy.types.NodeLink "Link to this definition")
:   Link between nodes in a node tree

    from\_node[¶](#bpy.types.NodeLink.from_node "Link to this definition")
    :   Type:
        :   [`Node`](Node.md#bpy.types.Node "bpy.types.Node"), (readonly)

    from\_socket[¶](#bpy.types.NodeLink.from_socket "Link to this definition")
    :   Type:
        :   [`NodeSocket`](NodeSocket.md#bpy.types.NodeSocket "bpy.types.NodeSocket"), (readonly)

    is\_hidden[¶](#bpy.types.NodeLink.is_hidden "Link to this definition")
    :   Link is hidden due to invisible sockets

        Type:
        :   boolean, default False, (readonly)

    is\_muted[¶](#bpy.types.NodeLink.is_muted "Link to this definition")
    :   Link is muted and can be ignored

        Type:
        :   boolean, default False

    is\_valid[¶](#bpy.types.NodeLink.is_valid "Link to this definition")
    :   Link is valid

        Type:
        :   boolean, default False

    multi\_input\_sort\_id[¶](#bpy.types.NodeLink.multi_input_sort_id "Link to this definition")
    :   Used to sort multiple links coming into the same input. The highest ID is at the top.

        Type:
        :   int in [0, inf], default 0, (readonly)

    to\_node[¶](#bpy.types.NodeLink.to_node "Link to this definition")
    :   Type:
        :   [`Node`](Node.md#bpy.types.Node "bpy.types.Node"), (readonly)

    to\_socket[¶](#bpy.types.NodeLink.to_socket "Link to this definition")
    :   Type:
        :   [`NodeSocket`](NodeSocket.md#bpy.types.NodeSocket "bpy.types.NodeSocket"), (readonly)

    swap\_multi\_input\_sort\_id(*other*)[¶](#bpy.types.NodeLink.swap_multi_input_sort_id "Link to this definition")
    :   Swap the order of two links connected to the same multi-input socket

        Parameters:
        :   **other** ([`NodeLink`](#bpy.types.NodeLink "bpy.types.NodeLink"), (never None)) – Other, The other link. Must link to the same multi-input socket.

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.NodeLink.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.NodeLink.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Node.insert_link`](Node.md#bpy.types.Node.insert_link "bpy.types.Node.insert_link") * [`Node.internal_links`](Node.md#bpy.types.Node.internal_links "bpy.types.Node.internal_links") * [`NodeLink.swap_multi_input_sort_id`](#bpy.types.NodeLink.swap_multi_input_sort_id "bpy.types.NodeLink.swap_multi_input_sort_id") | * [`NodeLinks.new`](NodeLinks.md#bpy.types.NodeLinks.new "bpy.types.NodeLinks.new") * [`NodeLinks.remove`](NodeLinks.md#bpy.types.NodeLinks.remove "bpy.types.NodeLinks.remove") * [`NodeTree.links`](NodeTree.md#bpy.types.NodeTree.links "bpy.types.NodeTree.links") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.NodeLink.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.NodeLink.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* NodeLink(bpy\_struct)
  + [`NodeLink`](#bpy.types.NodeLink)
    - [`NodeLink.from_node`](#bpy.types.NodeLink.from_node)
    - [`NodeLink.from_socket`](#bpy.types.NodeLink.from_socket)
    - [`NodeLink.is_hidden`](#bpy.types.NodeLink.is_hidden)
    - [`NodeLink.is_muted`](#bpy.types.NodeLink.is_muted)
    - [`NodeLink.is_valid`](#bpy.types.NodeLink.is_valid)
    - [`NodeLink.multi_input_sort_id`](#bpy.types.NodeLink.multi_input_sort_id)
    - [`NodeLink.to_node`](#bpy.types.NodeLink.to_node)
    - [`NodeLink.to_socket`](#bpy.types.NodeLink.to_socket)
    - [`NodeLink.swap_multi_input_sort_id()`](#bpy.types.NodeLink.swap_multi_input_sort_id)
    - [`NodeLink.bl_rna_get_subclass()`](#bpy.types.NodeLink.bl_rna_get_subclass)
    - [`NodeLink.bl_rna_get_subclass_py()`](#bpy.types.NodeLink.bl_rna_get_subclass_py)
