...
# Lightgroups(bpy\_struct)[¶](#lightgroups-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.Lightgroups(*bpy\_struct*)[¶](#bpy.types.Lightgroups "Link to this definition")
:   Collection of Lightgroups

    add(*\**, *name=''*)[¶](#bpy.types.Lightgroups.add "Link to this definition")
    :   add
        ...
        Return type:
        :   [`Lightgroup`](Lightgroup.md#bpy.types.Lightgroup "bpy.types.Lightgroup")

    remove(*lightgroup*)[¶](#bpy.types.Lightgroups.remove "Link to this definition")
    :   Remove given light group

        Parameters:
        :   **lightgroup** ([`Lightgroup`](Lightgroup.md#bpy.types.Lightgroup "bpy.types.Lightgroup"), (never None)) – Lightgroup to remove

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.Lightgroups.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.Lightgroups.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`ViewLayer.lightgroups`](ViewLayer.md#bpy.types.ViewLayer.lightgroups "bpy.types.ViewLayer.lightgroups") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.Lightgroups.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.Lightgroups.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* Lightgroups(bpy\_struct)
  + [`Lightgroups`](#bpy.types.Lightgroups)
    - [`Lightgroups.add()`](#bpy.types.Lightgroups.add)
    - [`Lightgroups.remove()`](#bpy.types.Lightgroups.remove)
    - [`Lightgroups.bl_rna_get_subclass()`](#bpy.types.Lightgroups.bl_rna_get_subclass)
    - [`Lightgroups.bl_rna_get_subclass_py()`](#bpy.types.Lightgroups.bl_rna_get_subclass_py)
