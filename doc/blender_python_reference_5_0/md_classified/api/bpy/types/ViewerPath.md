...
# ViewerPath(bpy\_struct)[¶](#viewerpath-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.ViewerPath(*bpy\_struct*)[¶](#bpy.types.ViewerPath "Link to this definition")
:   Path to data that is viewed

    path[¶](#bpy.types.ViewerPath.path "Link to this definition")
    :   Type:
        :   [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`ViewerPathElem`](ViewerPathElem.md#bpy.types.ViewerPathElem "bpy.types.ViewerPathElem"), (readonly)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ViewerPath.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ViewerPath.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`SpaceSpreadsheet.viewer_path`](SpaceSpreadsheet.md#bpy.types.SpaceSpreadsheet.viewer_path "bpy.types.SpaceSpreadsheet.viewer_path") | * [`SpreadsheetTableIDGeometry.viewer_path`](SpreadsheetTableIDGeometry.md#bpy.types.SpreadsheetTableIDGeometry.viewer_path "bpy.types.SpreadsheetTableIDGeometry.viewer_path") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ViewerPath.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ViewerPath.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ViewerPath(bpy\_struct)
  + [`ViewerPath`](#bpy.types.ViewerPath)
    - [`ViewerPath.path`](#bpy.types.ViewerPath.path)
    - [`ViewerPath.bl_rna_get_subclass()`](#bpy.types.ViewerPath.bl_rna_get_subclass)
    - [`ViewerPath.bl_rna_get_subclass_py()`](#bpy.types.ViewerPath.bl_rna_get_subclass_py)
