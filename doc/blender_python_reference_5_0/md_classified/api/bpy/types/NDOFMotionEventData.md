...
# NDOFMotionEventData(bpy\_struct)[¶](#ndofmotioneventdata-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.NDOFMotionEventData(*bpy\_struct*)[¶](#bpy.types.NDOFMotionEventData "Link to this definition")
:   NDOF motion data for window manager events

    progress[¶](#bpy.types.NDOFMotionEventData.progress "Link to this definition")
    :   Indicates the gesture phase

        Type:
        :   enum in [`'STARTING'`, `'IN_PROGRESS'`, `'FINISHING'`], default `'STARTING'`, (readonly)

    rotation[¶](#bpy.types.NDOFMotionEventData.rotation "Link to this definition")
    ...
    time\_delta[¶](#bpy.types.NDOFMotionEventData.time_delta "Link to this definition")
    :   Time since previous motion event (in seconds)

        Type:
        :   float in [-inf, inf], default 0.0, (readonly)

    translation[¶](#bpy.types.NDOFMotionEventData.translation "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.NDOFMotionEventData.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.NDOFMotionEventData.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Event.ndof_motion`](Event.md#bpy.types.Event.ndof_motion "bpy.types.Event.ndof_motion") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.NDOFMotionEventData.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.NDOFMotionEventData.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* NDOFMotionEventData(bpy\_struct)
  + [`NDOFMotionEventData`](#bpy.types.NDOFMotionEventData)
    - [`NDOFMotionEventData.progress`](#bpy.types.NDOFMotionEventData.progress)
    - [`NDOFMotionEventData.rotation`](#bpy.types.NDOFMotionEventData.rotation)
    - [`NDOFMotionEventData.time_delta`](#bpy.types.NDOFMotionEventData.time_delta)
    - [`NDOFMotionEventData.translation`](#bpy.types.NDOFMotionEventData.translation)
    - [`NDOFMotionEventData.bl_rna_get_subclass()`](#bpy.types.NDOFMotionEventData.bl_rna_get_subclass)
    - [`NDOFMotionEventData.bl_rna_get_subclass_py()`](#bpy.types.NDOFMotionEventData.bl_rna_get_subclass_py)
