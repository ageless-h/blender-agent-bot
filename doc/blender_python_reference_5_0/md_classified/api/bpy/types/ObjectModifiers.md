...
# ObjectModifiers(bpy\_struct)[¶](#objectmodifiers-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.ObjectModifiers(*bpy\_struct*)[¶](#bpy.types.ObjectModifiers "Link to this definition")
:   Collection of object modifiers

    active[¶](#bpy.types.ObjectModifiers.active "Link to this definition")
    :   The active modifier in the list

        Type:
        :   [`Modifier`](Modifier.md#bpy.types.Modifier "bpy.types.Modifier")

    new(*name*, *type*)[¶](#bpy.types.ObjectModifiers.new "Link to this definition")
    :   Add a new modifier

        Parameters:
        :   * **name** (*string**,* *(**never None**)*) – New name for the modifier
            * **type** (enum in [Object Modifier Type Items](../../../appendix/bpy_types_enum_items/object_modifier_type_items.md#rna-enum-object-modifier-type-items)) – Modifier type to add
    ...
    remove(*modifier*)[¶](#bpy.types.ObjectModifiers.remove "Link to this definition")
    :   Remove an existing modifier from the object

        Parameters:
        :   **modifier** ([`Modifier`](Modifier.md#bpy.types.Modifier "bpy.types.Modifier"), (never None)) – Modifier to remove

    clear()[¶](#bpy.types.ObjectModifiers.clear "Link to this definition")
    :   Remove all modifiers from the object

    move(*from\_index*, *to\_index*)[¶](#bpy.types.ObjectModifiers.move "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ObjectModifiers.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ObjectModifiers.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Object.modifiers`](Object.md#bpy.types.Object.modifiers "bpy.types.Object.modifiers") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ObjectModifiers.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ObjectModifiers.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ObjectModifiers(bpy\_struct)
  + [`ObjectModifiers`](#bpy.types.ObjectModifiers)
    - [`ObjectModifiers.active`](#bpy.types.ObjectModifiers.active)
    - [`ObjectModifiers.new()`](#bpy.types.ObjectModifiers.new)
    - [`ObjectModifiers.remove()`](#bpy.types.ObjectModifiers.remove)
    - [`ObjectModifiers.clear()`](#bpy.types.ObjectModifiers.clear)
    - [`ObjectModifiers.move()`](#bpy.types.ObjectModifiers.move)
    - [`ObjectModifiers.bl_rna_get_subclass()`](#bpy.types.ObjectModifiers.bl_rna_get_subclass)
    - [`ObjectModifiers.bl_rna_get_subclass_py()`](#bpy.types.ObjectModifiers.bl_rna_get_subclass_py)
