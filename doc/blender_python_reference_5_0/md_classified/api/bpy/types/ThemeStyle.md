...
# ThemeStyle(bpy\_struct)[¶](#themestyle-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.ThemeStyle(*bpy\_struct*)[¶](#bpy.types.ThemeStyle "Link to this definition")
:   Theme settings for style sets

    panel\_title[¶](#bpy.types.ThemeStyle.panel_title "Link to this definition")
    :   Type:
        :   [`ThemeFontStyle`](ThemeFontStyle.md#bpy.types.ThemeFontStyle "bpy.types.ThemeFontStyle"), (readonly, never None)

    tooltip[¶](#bpy.types.ThemeStyle.tooltip "Link to this definition")
    :   Type:
        :   [`ThemeFontStyle`](ThemeFontStyle.md#bpy.types.ThemeFontStyle "bpy.types.ThemeFontStyle"), (readonly, never None)

    widget[¶](#bpy.types.ThemeStyle.widget "Link to this definition")
    :   Type:
        :   [`ThemeFontStyle`](ThemeFontStyle.md#bpy.types.ThemeFontStyle "bpy.types.ThemeFontStyle"), (readonly, never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ThemeStyle.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ThemeStyle.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Preferences.ui_styles`](Preferences.md#bpy.types.Preferences.ui_styles "bpy.types.Preferences.ui_styles") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ThemeStyle.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ThemeStyle.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ThemeStyle(bpy\_struct)
  + [`ThemeStyle`](#bpy.types.ThemeStyle)
    - [`ThemeStyle.panel_title`](#bpy.types.ThemeStyle.panel_title)
    - [`ThemeStyle.tooltip`](#bpy.types.ThemeStyle.tooltip)
    - [`ThemeStyle.widget`](#bpy.types.ThemeStyle.widget)
    - [`ThemeStyle.bl_rna_get_subclass()`](#bpy.types.ThemeStyle.bl_rna_get_subclass)
    - [`ThemeStyle.bl_rna_get_subclass_py()`](#bpy.types.ThemeStyle.bl_rna_get_subclass_py)
