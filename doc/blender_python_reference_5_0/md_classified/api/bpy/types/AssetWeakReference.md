...
# AssetWeakReference(bpy\_struct)[¶](#assetweakreference-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.AssetWeakReference(*bpy\_struct*)[¶](#bpy.types.AssetWeakReference "Link to this definition")
:   Weak reference to some asset

    asset\_library\_identifier[¶](#bpy.types.AssetWeakReference.asset_library_identifier "Link to this definition")
    :   Type:
        :   string, default “”, (readonly, never None)

    asset\_library\_type[¶](#bpy.types.AssetWeakReference.asset_library_type "Link to this definition")
    :   * `ALL`
    ...
    relative\_asset\_identifier[¶](#bpy.types.AssetWeakReference.relative_asset_identifier "Link to this definition")
    :   Type:
        :   string, default “”, (readonly, never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.AssetWeakReference.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.AssetWeakReference.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`AssetShelf.get_active_asset`](AssetShelf.md#bpy.types.AssetShelf.get_active_asset "bpy.types.AssetShelf.get_active_asset") * [`Paint.brush_asset_reference`](Paint.md#bpy.types.Paint.brush_asset_reference "bpy.types.Paint.brush_asset_reference") | * [`Paint.eraser_brush_asset_reference`](Paint.md#bpy.types.Paint.eraser_brush_asset_reference "bpy.types.Paint.eraser_brush_asset_reference") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.AssetWeakReference.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.AssetWeakReference.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* AssetWeakReference(bpy\_struct)
  + [`AssetWeakReference`](#bpy.types.AssetWeakReference)
    - [`AssetWeakReference.asset_library_identifier`](#bpy.types.AssetWeakReference.asset_library_identifier)
    - [`AssetWeakReference.asset_library_type`](#bpy.types.AssetWeakReference.asset_library_type)
    - [`AssetWeakReference.relative_asset_identifier`](#bpy.types.AssetWeakReference.relative_asset_identifier)
    - [`AssetWeakReference.bl_rna_get_subclass()`](#bpy.types.AssetWeakReference.bl_rna_get_subclass)
    - [`AssetWeakReference.bl_rna_get_subclass_py()`](#bpy.types.AssetWeakReference.bl_rna_get_subclass_py)
