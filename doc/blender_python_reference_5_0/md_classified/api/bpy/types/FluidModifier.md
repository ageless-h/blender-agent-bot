...
# FluidModifier(Modifier)[¶](#fluidmodifier-modifier "Link to this heading")
...
*class* bpy.types.FluidModifier(*Modifier*)[¶](#bpy.types.FluidModifier "Link to this definition")
:   Fluid simulation modifier

    domain\_settings[¶](#bpy.types.FluidModifier.domain_settings "Link to this definition")
    :   Type:
        :   [`FluidDomainSettings`](FluidDomainSettings.md#bpy.types.FluidDomainSettings "bpy.types.FluidDomainSettings"), (readonly)

    effector\_settings[¶](#bpy.types.FluidModifier.effector_settings "Link to this definition")
    :   Type:
        :   [`FluidEffectorSettings`](FluidEffectorSettings.md#bpy.types.FluidEffectorSettings "bpy.types.FluidEffectorSettings"), (readonly)

    flow\_settings[¶](#bpy.types.FluidModifier.flow_settings "Link to this definition")
    :   Type:
        :   [`FluidFlowSettings`](FluidFlowSettings.md#bpy.types.FluidFlowSettings "bpy.types.FluidFlowSettings"), (readonly)

    fluid\_type[¶](#bpy.types.FluidModifier.fluid_type "Link to this definition")
    :   * `NONE`
          None.
        * `DOMAIN`
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.FluidModifier.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.FluidModifier.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.FluidModifier.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.FluidModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* FluidModifier(Modifier)
  + [`FluidModifier`](#bpy.types.FluidModifier)
    - [`FluidModifier.domain_settings`](#bpy.types.FluidModifier.domain_settings)
    - [`FluidModifier.effector_settings`](#bpy.types.FluidModifier.effector_settings)
    - [`FluidModifier.flow_settings`](#bpy.types.FluidModifier.flow_settings)
    - [`FluidModifier.fluid_type`](#bpy.types.FluidModifier.fluid_type)
    - [`FluidModifier.bl_rna_get_subclass()`](#bpy.types.FluidModifier.bl_rna_get_subclass)
    - [`FluidModifier.bl_rna_get_subclass_py()`](#bpy.types.FluidModifier.bl_rna_get_subclass_py)
