...
# AnnotationStroke(bpy\_struct)[¶](#annotationstroke-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.AnnotationStroke(*bpy\_struct*)[¶](#bpy.types.AnnotationStroke "Link to this definition")
:   Freehand curve defining part of a sketch

    points[¶](#bpy.types.AnnotationStroke.points "Link to this definition")
    :   Stroke data points

        Type:
        :   [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`AnnotationStrokePoint`](AnnotationStrokePoint.md#bpy.types.AnnotationStrokePoint "bpy.types.AnnotationStrokePoint"), (readonly)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.AnnotationStroke.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.AnnotationStroke.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`AnnotationFrame.strokes`](AnnotationFrame.md#bpy.types.AnnotationFrame.strokes "bpy.types.AnnotationFrame.strokes") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.AnnotationStroke.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.AnnotationStroke.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* AnnotationStroke(bpy\_struct)
  + [`AnnotationStroke`](#bpy.types.AnnotationStroke)
    - [`AnnotationStroke.points`](#bpy.types.AnnotationStroke.points)
    - [`AnnotationStroke.bl_rna_get_subclass()`](#bpy.types.AnnotationStroke.bl_rna_get_subclass)
    - [`AnnotationStroke.bl_rna_get_subclass_py()`](#bpy.types.AnnotationStroke.bl_rna_get_subclass_py)
