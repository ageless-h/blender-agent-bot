...
# MovieTrackingReconstruction(bpy\_struct)[¶](#movietrackingreconstruction-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.MovieTrackingReconstruction(*bpy\_struct*)[¶](#bpy.types.MovieTrackingReconstruction "Link to this definition")
:   Match-moving reconstruction data from tracker

    average\_error[¶](#bpy.types.MovieTrackingReconstruction.average_error "Link to this definition")
    :   Average error of reconstruction

        Type:
        :   float in [-inf, inf], default 0.0, (readonly)

    cameras[¶](#bpy.types.MovieTrackingReconstruction.cameras "Link to this definition")
    :   Collection of solved cameras

        Type:
        :   [`MovieTrackingReconstructedCameras`](MovieTrackingReconstructedCameras.md#bpy.types.MovieTrackingReconstructedCameras "bpy.types.MovieTrackingReconstructedCameras") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`MovieReconstructedCamera`](MovieReconstructedCamera.md#bpy.types.MovieReconstructedCamera "bpy.types.MovieReconstructedCamera"), (readonly)

    is\_valid[¶](#bpy.types.MovieTrackingReconstruction.is_valid "Link to this definition")
    :   Whether the tracking data contains valid reconstruction information

        Type:
        :   boolean, default False, (readonly)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.MovieTrackingReconstruction.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.MovieTrackingReconstruction.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`MovieTracking.reconstruction`](MovieTracking.md#bpy.types.MovieTracking.reconstruction "bpy.types.MovieTracking.reconstruction") | * [`MovieTrackingObject.reconstruction`](MovieTrackingObject.md#bpy.types.MovieTrackingObject.reconstruction "bpy.types.MovieTrackingObject.reconstruction") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.MovieTrackingReconstruction.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.MovieTrackingReconstruction.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* MovieTrackingReconstruction(bpy\_struct)
  + [`MovieTrackingReconstruction`](#bpy.types.MovieTrackingReconstruction)
    - [`MovieTrackingReconstruction.average_error`](#bpy.types.MovieTrackingReconstruction.average_error)
    - [`MovieTrackingReconstruction.cameras`](#bpy.types.MovieTrackingReconstruction.cameras)
    - [`MovieTrackingReconstruction.is_valid`](#bpy.types.MovieTrackingReconstruction.is_valid)
    - [`MovieTrackingReconstruction.bl_rna_get_subclass()`](#bpy.types.MovieTrackingReconstruction.bl_rna_get_subclass)
    - [`MovieTrackingReconstruction.bl_rna_get_subclass_py()`](#bpy.types.MovieTrackingReconstruction.bl_rna_get_subclass_py)
