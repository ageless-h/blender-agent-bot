...
# BoneCollections(bpy\_struct)[¶](#bonecollections-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.BoneCollections(*bpy\_struct*)[¶](#bpy.types.BoneCollections "Link to this definition")
:   The Bone Collections of this Armature

    active[¶](#bpy.types.BoneCollections.active "Link to this definition")
    :   Armature’s active bone collection

        Type:
        :   [`BoneCollection`](BoneCollection.md#bpy.types.BoneCollection "bpy.types.BoneCollection")

    active\_index[¶](#bpy.types.BoneCollections.active_index "Link to this definition")
    ...
    active\_name[¶](#bpy.types.BoneCollections.active_name "Link to this definition")
    :   The name of the Armature’s active bone collection; empty when there is no active collection

        Type:
        :   string, default “”, (never None)

    is\_solo\_active[¶](#bpy.types.BoneCollections.is_solo_active "Link to this definition")
    :   Read-only flag that indicates there is at least one bone collection marked as ‘solo’

        Type:
        :   boolean, default False, (readonly)

    new(*name*, *\**, *parent=None*)[¶](#bpy.types.BoneCollections.new "Link to this definition")
    :   Add a new empty bone collection to the armature
        ...
        :   * **name** (*string**,* *(**never None**)*) – Name, Name of the new collection. Blender will ensure it is unique within the collections of the Armature.
            * **parent** ([`BoneCollection`](BoneCollection.md#bpy.types.BoneCollection "bpy.types.BoneCollection"), (optional)) – Parent Collection, If not None, the new bone collection becomes a child of this collection
    ...
    remove(*bone\_collection*)[¶](#bpy.types.BoneCollections.remove "Link to this definition")
    :   Remove the bone collection from the armature. If this bone collection has any children, they will be reassigned to their grandparent; in other words, the children will take the place of the removed bone collection.
        ...
        Parameters:
        :   **bone\_collection** ([`BoneCollection`](BoneCollection.md#bpy.types.BoneCollection "bpy.types.BoneCollection")) – Bone Collection, The bone collection to remove

    move(*from\_index*, *to\_index*)[¶](#bpy.types.BoneCollections.move "Link to this definition")
    :   Move a bone collection to a different position in the collection list. This can only be used to reorder siblings, and not to change parent-child relationships.
        ...
        Parameters:
        :   * **from\_index** (*int in* *[**-inf**,* *inf**]*) – From Index, Index to move
            * **to\_index** (*int in* *[**-inf**,* *inf**]*) – To Index, Target index

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.BoneCollections.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.BoneCollections.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Armature.collections`](Armature.md#bpy.types.Armature.collections "bpy.types.Armature.collections") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.BoneCollections.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.BoneCollections.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* BoneCollections(bpy\_struct)
  + [`BoneCollections`](#bpy.types.BoneCollections)
    - [`BoneCollections.active`](#bpy.types.BoneCollections.active)
    - [`BoneCollections.active_index`](#bpy.types.BoneCollections.active_index)
    - [`BoneCollections.active_name`](#bpy.types.BoneCollections.active_name)
    - [`BoneCollections.is_solo_active`](#bpy.types.BoneCollections.is_solo_active)
    - [`BoneCollections.new()`](#bpy.types.BoneCollections.new)
    - [`BoneCollections.remove()`](#bpy.types.BoneCollections.remove)
    - [`BoneCollections.move()`](#bpy.types.BoneCollections.move)
    - [`BoneCollections.bl_rna_get_subclass()`](#bpy.types.BoneCollections.bl_rna_get_subclass)
    - [`BoneCollections.bl_rna_get_subclass_py()`](#bpy.types.BoneCollections.bl_rna_get_subclass_py)
