...
# MaskModifier(Modifier)[¶](#maskmodifier-modifier "Link to this heading")
...
*class* bpy.types.MaskModifier(*Modifier*)[¶](#bpy.types.MaskModifier "Link to this definition")
:   Mask modifier to hide parts of the mesh

    armature[¶](#bpy.types.MaskModifier.armature "Link to this definition")
    :   Armature to use as source of bones to mask

        Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object")

    invert\_vertex\_group[¶](#bpy.types.MaskModifier.invert_vertex_group "Link to this definition")
    :   Use vertices that are not part of region defined

        Type:
        :   boolean, default False

    mode[¶](#bpy.types.MaskModifier.mode "Link to this definition")
    :   Type:
        :   enum in [`'VERTEX_GROUP'`, `'ARMATURE'`], default `'VERTEX_GROUP'`

    threshold[¶](#bpy.types.MaskModifier.threshold "Link to this definition")
    :   Weights over this threshold remain

        Type:
        :   float in [0, 1], default 0.0

    use\_smooth[¶](#bpy.types.MaskModifier.use_smooth "Link to this definition")
    :   Use vertex group weights to cut faces at the weight contour

        Type:
        :   boolean, default False

    vertex\_group[¶](#bpy.types.MaskModifier.vertex_group "Link to this definition")
    :   Vertex group name

        Type:
        :   string, default “”, (never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.MaskModifier.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.MaskModifier.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.MaskModifier.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.MaskModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* MaskModifier(Modifier)
  + [`MaskModifier`](#bpy.types.MaskModifier)
    - [`MaskModifier.armature`](#bpy.types.MaskModifier.armature)
    - [`MaskModifier.invert_vertex_group`](#bpy.types.MaskModifier.invert_vertex_group)
    - [`MaskModifier.mode`](#bpy.types.MaskModifier.mode)
    - [`MaskModifier.threshold`](#bpy.types.MaskModifier.threshold)
    - [`MaskModifier.use_smooth`](#bpy.types.MaskModifier.use_smooth)
    - [`MaskModifier.vertex_group`](#bpy.types.MaskModifier.vertex_group)
    - [`MaskModifier.bl_rna_get_subclass()`](#bpy.types.MaskModifier.bl_rna_get_subclass)
    - [`MaskModifier.bl_rna_get_subclass_py()`](#bpy.types.MaskModifier.bl_rna_get_subclass_py)
