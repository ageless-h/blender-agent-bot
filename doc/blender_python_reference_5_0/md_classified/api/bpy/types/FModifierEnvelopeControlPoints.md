...
# FModifierEnvelopeControlPoints(bpy\_struct)[¶](#fmodifierenvelopecontrolpoints-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.FModifierEnvelopeControlPoints(*bpy\_struct*)[¶](#bpy.types.FModifierEnvelopeControlPoints "Link to this definition")
:   Control points defining the shape of the envelope

    add(*frame*)[¶](#bpy.types.FModifierEnvelopeControlPoints.add "Link to this definition")
    :   Add a control point to a FModifierEnvelope
        ...
        Return type:
        :   [`FModifierEnvelopeControlPoint`](FModifierEnvelopeControlPoint.md#bpy.types.FModifierEnvelopeControlPoint "bpy.types.FModifierEnvelopeControlPoint")

    remove(*point*)[¶](#bpy.types.FModifierEnvelopeControlPoints.remove "Link to this definition")
    :   Remove a control-point from an FModifierEnvelope

        Parameters:
        :   **point** ([`FModifierEnvelopeControlPoint`](FModifierEnvelopeControlPoint.md#bpy.types.FModifierEnvelopeControlPoint "bpy.types.FModifierEnvelopeControlPoint"), (never None)) – Control-point to remove

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.FModifierEnvelopeControlPoints.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.FModifierEnvelopeControlPoints.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`FModifierEnvelope.control_points`](FModifierEnvelope.md#bpy.types.FModifierEnvelope.control_points "bpy.types.FModifierEnvelope.control_points") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.FModifierEnvelopeControlPoints.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.FModifierEnvelopeControlPoints.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* FModifierEnvelopeControlPoints(bpy\_struct)
  + [`FModifierEnvelopeControlPoints`](#bpy.types.FModifierEnvelopeControlPoints)
    - [`FModifierEnvelopeControlPoints.add()`](#bpy.types.FModifierEnvelopeControlPoints.add)
    - [`FModifierEnvelopeControlPoints.remove()`](#bpy.types.FModifierEnvelopeControlPoints.remove)
    - [`FModifierEnvelopeControlPoints.bl_rna_get_subclass()`](#bpy.types.FModifierEnvelopeControlPoints.bl_rna_get_subclass)
    - [`FModifierEnvelopeControlPoints.bl_rna_get_subclass_py()`](#bpy.types.FModifierEnvelopeControlPoints.bl_rna_get_subclass_py)
