...
# ConstraintTarget(bpy\_struct)[¶](#constrainttarget-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.ConstraintTarget(*bpy\_struct*)[¶](#bpy.types.ConstraintTarget "Link to this definition")
:   Target object for multi-target constraints

    subtarget[¶](#bpy.types.ConstraintTarget.subtarget "Link to this definition")
    :   Armature bone, mesh or lattice vertex group, …

        Type:
        :   string, default “”, (never None)

    target[¶](#bpy.types.ConstraintTarget.target "Link to this definition")
    :   Target object

        Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ConstraintTarget.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ConstraintTarget.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ConstraintTarget.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ConstraintTarget.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ConstraintTarget(bpy\_struct)
  + [`ConstraintTarget`](#bpy.types.ConstraintTarget)
    - [`ConstraintTarget.subtarget`](#bpy.types.ConstraintTarget.subtarget)
    - [`ConstraintTarget.target`](#bpy.types.ConstraintTarget.target)
    - [`ConstraintTarget.bl_rna_get_subclass()`](#bpy.types.ConstraintTarget.bl_rna_get_subclass)
    - [`ConstraintTarget.bl_rna_get_subclass_py()`](#bpy.types.ConstraintTarget.bl_rna_get_subclass_py)
