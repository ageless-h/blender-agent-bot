...
# LightProbe(ID)[¶](#lightprobe-id "Link to this heading")

base classes — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct"), [`ID`](ID.md#bpy.types.ID "bpy.types.ID")

subclasses —
[`LightProbePlane`](LightProbePlane.md#bpy.types.LightProbePlane "bpy.types.LightProbePlane"), [`LightProbeSphere`](LightProbeSphere.md#bpy.types.LightProbeSphere "bpy.types.LightProbeSphere"), [`LightProbeVolume`](LightProbeVolume.md#bpy.types.LightProbeVolume "bpy.types.LightProbeVolume")

*class* bpy.types.LightProbe(*ID*)[¶](#bpy.types.LightProbe "Link to this definition")
:   Light Probe data-block for lighting capture objects

    animation\_data[¶](#bpy.types.LightProbe.animation_data "Link to this definition")
    :   Animation data for this data-block

        Type:
        :   [`AnimData`](AnimData.md#bpy.types.AnimData "bpy.types.AnimData"), (readonly)

    clip\_start[¶](#bpy.types.LightProbe.clip_start "Link to this definition")
    :   Probe clip start, below which objects will not appear in reflections

        Type:
        :   float in [1e-06, inf], default 0.8

    data\_display\_size[¶](#bpy.types.LightProbe.data_display_size "Link to this definition")
    :   Viewport display size of the sampled data

        Type:
        :   float in [0, inf], default 0.1

    influence\_distance[¶](#bpy.types.LightProbe.influence_distance "Link to this definition")
    :   Influence distance of the probe

        Type:
        :   float in [0, inf], default 2.5

    invert\_visibility\_collection[¶](#bpy.types.LightProbe.invert_visibility_collection "Link to this definition")
    :   Invert visibility collection (Deprecated)

        Type:
        :   boolean, default False

    show\_clip[¶](#bpy.types.LightProbe.show_clip "Link to this definition")
    :   Show the clipping distances in the 3D view

        Type:
        :   boolean, default False

    show\_data[¶](#bpy.types.LightProbe.show_data "Link to this definition")
    :   Deprecated, use use\_data\_display instead

        Type:
        :   boolean, default False

    show\_influence[¶](#bpy.types.LightProbe.show_influence "Link to this definition")
    :   Show the influence volume in the 3D view

        Type:
        :   boolean, default True

    type[¶](#bpy.types.LightProbe.type "Link to this definition")
    :   Type of light probe
    ...
    use\_data\_display[¶](#bpy.types.LightProbe.use_data_display "Link to this definition")
    :   Display sampled data in the viewport to debug captured light

        Type:
        :   boolean, default False

    visibility\_bleed\_bias[¶](#bpy.types.LightProbe.visibility_bleed_bias "Link to this definition")
    :   Bias for reducing light-bleed on variance shadow maps (Deprecated)

        Type:
        :   float in [0, 1], default 0.0

    visibility\_blur[¶](#bpy.types.LightProbe.visibility_blur "Link to this definition")
    :   Filter size of the visibility blur (Deprecated)

        Type:
        :   float in [0, 1], default 0.2

    visibility\_buffer\_bias[¶](#bpy.types.LightProbe.visibility_buffer_bias "Link to this definition")
    :   Bias for reducing self shadowing (Deprecated)

        Type:
        :   float in [0.001, 9999], default 1.0

    visibility\_collection[¶](#bpy.types.LightProbe.visibility_collection "Link to this definition")
    :   Restrict objects visible for this probe (Deprecated)

        Type:
        :   [`Collection`](Collection.md#bpy.types.Collection "bpy.types.Collection")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.LightProbe.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.LightProbe.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`bpy.context.lightprobe`](../context/index.md#bpy.context.lightprobe "bpy.context.lightprobe") * [`BlendData.lightprobes`](BlendData.md#bpy.types.BlendData.lightprobes "bpy.types.BlendData.lightprobes") | * [`BlendDataProbes.new`](BlendDataProbes.md#bpy.types.BlendDataProbes.new "bpy.types.BlendDataProbes.new") * [`BlendDataProbes.remove`](BlendDataProbes.md#bpy.types.BlendDataProbes.remove "bpy.types.BlendDataProbes.remove") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.LightProbe.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.LightProbe.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* LightProbe(ID)
  + [`LightProbe`](#bpy.types.LightProbe)
    - [`LightProbe.animation_data`](#bpy.types.LightProbe.animation_data)
    - [`LightProbe.clip_start`](#bpy.types.LightProbe.clip_start)
    - [`LightProbe.data_display_size`](#bpy.types.LightProbe.data_display_size)
    - [`LightProbe.influence_distance`](#bpy.types.LightProbe.influence_distance)
    - [`LightProbe.invert_visibility_collection`](#bpy.types.LightProbe.invert_visibility_collection)
    - [`LightProbe.show_clip`](#bpy.types.LightProbe.show_clip)
    - [`LightProbe.show_data`](#bpy.types.LightProbe.show_data)
    - [`LightProbe.show_influence`](#bpy.types.LightProbe.show_influence)
    - [`LightProbe.type`](#bpy.types.LightProbe.type)
    - [`LightProbe.use_data_display`](#bpy.types.LightProbe.use_data_display)
    - [`LightProbe.visibility_bleed_bias`](#bpy.types.LightProbe.visibility_bleed_bias)
    - [`LightProbe.visibility_blur`](#bpy.types.LightProbe.visibility_blur)
    - [`LightProbe.visibility_buffer_bias`](#bpy.types.LightProbe.visibility_buffer_bias)
    - [`LightProbe.visibility_collection`](#bpy.types.LightProbe.visibility_collection)
    - [`LightProbe.bl_rna_get_subclass()`](#bpy.types.LightProbe.bl_rna_get_subclass)
    - [`LightProbe.bl_rna_get_subclass_py()`](#bpy.types.LightProbe.bl_rna_get_subclass_py)
