...
# NodeClosureInput(NodeInternal)[¶](#nodeclosureinput-nodeinternal "Link to this heading")
...
*class* bpy.types.NodeClosureInput(*NodeInternal*)[¶](#bpy.types.NodeClosureInput "Link to this definition")
:   paired\_output[¶](#bpy.types.NodeClosureInput.paired_output "Link to this definition")
    :   Zone output node that this input node is paired with

        Type:
        :   [`Node`](Node.md#bpy.types.Node "bpy.types.Node"), (readonly)

    *classmethod* is\_registered\_node\_type()[¶](#bpy.types.NodeClosureInput.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[¶](#bpy.types.NodeClosureInput.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[¶](#bpy.types.NodeClosureInput.output_template "Link to this definition")
    ...
    pair\_with\_output(*output\_node*)[¶](#bpy.types.NodeClosureInput.pair_with_output "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.NodeClosureInput.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.NodeClosureInput.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.NodeClosureInput.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.NodeClosureInput.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* NodeClosureInput(NodeInternal)
  + [`NodeClosureInput`](#bpy.types.NodeClosureInput)
    - [`NodeClosureInput.paired_output`](#bpy.types.NodeClosureInput.paired_output)
    - [`NodeClosureInput.is_registered_node_type()`](#bpy.types.NodeClosureInput.is_registered_node_type)
    - [`NodeClosureInput.input_template()`](#bpy.types.NodeClosureInput.input_template)
    - [`NodeClosureInput.output_template()`](#bpy.types.NodeClosureInput.output_template)
    - [`NodeClosureInput.pair_with_output()`](#bpy.types.NodeClosureInput.pair_with_output)
    - [`NodeClosureInput.bl_rna_get_subclass()`](#bpy.types.NodeClosureInput.bl_rna_get_subclass)
    - [`NodeClosureInput.bl_rna_get_subclass_py()`](#bpy.types.NodeClosureInput.bl_rna_get_subclass_py)
