...
# CollectionExport(bpy\_struct)[¶](#collectionexport-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.CollectionExport(*bpy\_struct*)[¶](#bpy.types.CollectionExport "Link to this definition")
:   export\_properties[¶](#bpy.types.CollectionExport.export_properties "Link to this definition")
    ...
    filepath[¶](#bpy.types.CollectionExport.filepath "Link to this definition")
    :   The file path used for exporting

        Type:
        :   string, default “”, (never None, blend relative `//` prefix supported)

    is\_open[¶](#bpy.types.CollectionExport.is_open "Link to this definition")
    :   Whether the panel is expanded or closed

        Type:
        :   boolean, default False

    name[¶](#bpy.types.CollectionExport.name "Link to this definition")
    :   Type:
        :   string, default “”, (never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.CollectionExport.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.CollectionExport.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Collection.exporters`](Collection.md#bpy.types.Collection.exporters "bpy.types.Collection.exporters") * [`CollectionExports.new`](CollectionExports.md#bpy.types.CollectionExports.new "bpy.types.CollectionExports.new") | * [`CollectionExports.remove`](CollectionExports.md#bpy.types.CollectionExports.remove "bpy.types.CollectionExports.remove") |

[Next

CollectionExports(bpy\_struct)](CollectionExports.md)
[Previous
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CollectionExport.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.CollectionExport.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CollectionExport(bpy\_struct)
  + [`CollectionExport`](#bpy.types.CollectionExport)
    - [`CollectionExport.export_properties`](#bpy.types.CollectionExport.export_properties)
    - [`CollectionExport.filepath`](#bpy.types.CollectionExport.filepath)
    - [`CollectionExport.is_open`](#bpy.types.CollectionExport.is_open)
    - [`CollectionExport.name`](#bpy.types.CollectionExport.name)
    - [`CollectionExport.bl_rna_get_subclass()`](#bpy.types.CollectionExport.bl_rna_get_subclass)
    - [`CollectionExport.bl_rna_get_subclass_py()`](#bpy.types.CollectionExport.bl_rna_get_subclass_py)
