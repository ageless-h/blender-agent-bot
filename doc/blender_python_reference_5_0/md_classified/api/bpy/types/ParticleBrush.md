...
# ParticleBrush(bpy\_struct)[¶](#particlebrush-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.ParticleBrush(*bpy\_struct*)[¶](#bpy.types.ParticleBrush "Link to this definition")
:   Particle editing brush

    count[¶](#bpy.types.ParticleBrush.count "Link to this definition")
    :   Particle count

        Type:
        :   int in [1, 1000], default 10

    curve[¶](#bpy.types.ParticleBrush.curve "Link to this definition")
    :   Type:
        :   [`CurveMapping`](CurveMapping.md#bpy.types.CurveMapping "bpy.types.CurveMapping"), (readonly)

    length\_mode[¶](#bpy.types.ParticleBrush.length_mode "Link to this definition")
    :   * `GROW`
    ...
    puff\_mode[¶](#bpy.types.ParticleBrush.puff_mode "Link to this definition")
    :   * `ADD`
    ...
    size[¶](#bpy.types.ParticleBrush.size "Link to this definition")
    :   Radius of the brush in pixels

        Type:
        :   int in [1, 32767], default 50

    steps[¶](#bpy.types.ParticleBrush.steps "Link to this definition")
    :   Brush steps

        Type:
        :   int in [1, 32767], default 10

    strength[¶](#bpy.types.ParticleBrush.strength "Link to this definition")
    :   Brush strength

        Type:
        :   float in [0.001, 1], default 0.5

    use\_puff\_volume[¶](#bpy.types.ParticleBrush.use_puff_volume "Link to this definition")
    :   Apply puff to unselected end-points (helps maintain hair volume when puffing root)

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ParticleBrush.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ParticleBrush.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`ParticleEdit.brush`](ParticleEdit.md#bpy.types.ParticleEdit.brush "bpy.types.ParticleEdit.brush") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ParticleBrush.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ParticleBrush.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ParticleBrush(bpy\_struct)
  + [`ParticleBrush`](#bpy.types.ParticleBrush)
    - [`ParticleBrush.count`](#bpy.types.ParticleBrush.count)
    - [`ParticleBrush.curve`](#bpy.types.ParticleBrush.curve)
    - [`ParticleBrush.length_mode`](#bpy.types.ParticleBrush.length_mode)
    - [`ParticleBrush.puff_mode`](#bpy.types.ParticleBrush.puff_mode)
    - [`ParticleBrush.size`](#bpy.types.ParticleBrush.size)
    - [`ParticleBrush.steps`](#bpy.types.ParticleBrush.steps)
    - [`ParticleBrush.strength`](#bpy.types.ParticleBrush.strength)
    - [`ParticleBrush.use_puff_volume`](#bpy.types.ParticleBrush.use_puff_volume)
    - [`ParticleBrush.bl_rna_get_subclass()`](#bpy.types.ParticleBrush.bl_rna_get_subclass)
    - [`ParticleBrush.bl_rna_get_subclass_py()`](#bpy.types.ParticleBrush.bl_rna_get_subclass_py)
