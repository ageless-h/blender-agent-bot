...
# RenderResult(bpy\_struct)[¶](#renderresult-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.RenderResult(*bpy\_struct*)[¶](#bpy.types.RenderResult "Link to this definition")
:   Result of rendering, including all layers and passes

    layers[¶](#bpy.types.RenderResult.layers "Link to this definition")
    :   Type:
        :   [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`RenderLayer`](RenderLayer.md#bpy.types.RenderLayer "bpy.types.RenderLayer"), (readonly)

    resolution\_x[¶](#bpy.types.RenderResult.resolution_x "Link to this definition")
    :   Type:
        :   int in [-inf, inf], default 0, (readonly)

    resolution\_y[¶](#bpy.types.RenderResult.resolution_y "Link to this definition")
    :   Type:
        :   int in [-inf, inf], default 0, (readonly)

    views[¶](#bpy.types.RenderResult.views "Link to this definition")
    :   Type:
        :   [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`RenderView`](RenderView.md#bpy.types.RenderView "bpy.types.RenderView"), (readonly)

    load\_from\_file(*filepath*)[¶](#bpy.types.RenderResult.load_from_file "Link to this definition")
    ...
    stamp\_data\_add\_field(*field*, *value*)[¶](#bpy.types.RenderResult.stamp_data_add_field "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.RenderResult.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.RenderResult.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`RenderEngine.begin_result`](RenderEngine.md#bpy.types.RenderEngine.begin_result "bpy.types.RenderEngine.begin_result") * [`RenderEngine.end_result`](RenderEngine.md#bpy.types.RenderEngine.end_result "bpy.types.RenderEngine.end_result") | * [`RenderEngine.get_result`](RenderEngine.md#bpy.types.RenderEngine.get_result "bpy.types.RenderEngine.get_result") * [`RenderEngine.update_result`](RenderEngine.md#bpy.types.RenderEngine.update_result "bpy.types.RenderEngine.update_result") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.RenderResult.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.RenderResult.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* RenderResult(bpy\_struct)
  + [`RenderResult`](#bpy.types.RenderResult)
    - [`RenderResult.layers`](#bpy.types.RenderResult.layers)
    - [`RenderResult.resolution_x`](#bpy.types.RenderResult.resolution_x)
    - [`RenderResult.resolution_y`](#bpy.types.RenderResult.resolution_y)
    - [`RenderResult.views`](#bpy.types.RenderResult.views)
    - [`RenderResult.load_from_file()`](#bpy.types.RenderResult.load_from_file)
    - [`RenderResult.stamp_data_add_field()`](#bpy.types.RenderResult.stamp_data_add_field)
    - [`RenderResult.bl_rna_get_subclass()`](#bpy.types.RenderResult.bl_rna_get_subclass)
    - [`RenderResult.bl_rna_get_subclass_py()`](#bpy.types.RenderResult.bl_rna_get_subclass_py)
