...
# CurveMapPoints(bpy\_struct)[¶](#curvemappoints-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.CurveMapPoints(*bpy\_struct*)[¶](#bpy.types.CurveMapPoints "Link to this definition")
:   Collection of Curve Map Points

    new(*position*, *value*)[¶](#bpy.types.CurveMapPoints.new "Link to this definition")
    :   Add point to CurveMap
        ...
        Return type:
        :   [`CurveMapPoint`](CurveMapPoint.md#bpy.types.CurveMapPoint "bpy.types.CurveMapPoint")

    remove(*point*)[¶](#bpy.types.CurveMapPoints.remove "Link to this definition")
    :   Delete point from CurveMap

        Parameters:
        :   **point** ([`CurveMapPoint`](CurveMapPoint.md#bpy.types.CurveMapPoint "bpy.types.CurveMapPoint"), (never None)) – PointElement to remove

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.CurveMapPoints.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.CurveMapPoints.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`CurveMap.points`](CurveMap.md#bpy.types.CurveMap.points "bpy.types.CurveMap.points") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CurveMapPoints.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.CurveMapPoints.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CurveMapPoints(bpy\_struct)
  + [`CurveMapPoints`](#bpy.types.CurveMapPoints)
    - [`CurveMapPoints.new()`](#bpy.types.CurveMapPoints.new)
    - [`CurveMapPoints.remove()`](#bpy.types.CurveMapPoints.remove)
    - [`CurveMapPoints.bl_rna_get_subclass()`](#bpy.types.CurveMapPoints.bl_rna_get_subclass)
    - [`CurveMapPoints.bl_rna_get_subclass_py()`](#bpy.types.CurveMapPoints.bl_rna_get_subclass_py)
