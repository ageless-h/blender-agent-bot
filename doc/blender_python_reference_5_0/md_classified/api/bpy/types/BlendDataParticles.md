...
# BlendDataParticles(bpy\_struct)[¶](#blenddataparticles-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.BlendDataParticles(*bpy\_struct*)[¶](#bpy.types.BlendDataParticles "Link to this definition")
:   Collection of particle settings

    new(*name*)[¶](#bpy.types.BlendDataParticles.new "Link to this definition")
    :   Add a new particle settings instance to the main database
        ...
        Return type:
        :   [`ParticleSettings`](ParticleSettings.md#bpy.types.ParticleSettings "bpy.types.ParticleSettings")

    remove(*particle*, *\**, *do\_unlink=True*, *do\_id\_user=True*, *do\_ui\_user=True*)[¶](#bpy.types.BlendDataParticles.remove "Link to this definition")
    :   Remove a particle settings instance from the current blendfile

        Parameters:
        :   * **particle** ([`ParticleSettings`](ParticleSettings.md#bpy.types.ParticleSettings "bpy.types.ParticleSettings"), (never None)) – Particle Settings to remove
            * **do\_unlink** (*boolean**,* *(**optional**)*) – Unlink all usages of those particle settings before deleting them
            * **do\_id\_user** (*boolean**,* *(**optional**)*) – Decrement user counter of all data-blocks used by this particle settings
            * **do\_ui\_user** (*boolean**,* *(**optional**)*) – Make sure interface does not reference this particle settings

    tag(*value*)[¶](#bpy.types.BlendDataParticles.tag "Link to this definition")
    :   tag

        Parameters:
        :   **value** (*boolean*) – Value

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.BlendDataParticles.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.BlendDataParticles.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`BlendData.particles`](BlendData.md#bpy.types.BlendData.particles "bpy.types.BlendData.particles") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.BlendDataParticles.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.BlendDataParticles.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* BlendDataParticles(bpy\_struct)
  + [`BlendDataParticles`](#bpy.types.BlendDataParticles)
    - [`BlendDataParticles.new()`](#bpy.types.BlendDataParticles.new)
    - [`BlendDataParticles.remove()`](#bpy.types.BlendDataParticles.remove)
    - [`BlendDataParticles.tag()`](#bpy.types.BlendDataParticles.tag)
    - [`BlendDataParticles.bl_rna_get_subclass()`](#bpy.types.BlendDataParticles.bl_rna_get_subclass)
    - [`BlendDataParticles.bl_rna_get_subclass_py()`](#bpy.types.BlendDataParticles.bl_rna_get_subclass_py)
