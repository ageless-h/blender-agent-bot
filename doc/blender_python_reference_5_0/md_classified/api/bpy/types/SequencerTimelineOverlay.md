...
# SequencerTimelineOverlay(bpy\_struct)[¶](#sequencertimelineoverlay-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.SequencerTimelineOverlay(*bpy\_struct*)[¶](#bpy.types.SequencerTimelineOverlay "Link to this definition")
:   show\_fcurves[¶](#bpy.types.SequencerTimelineOverlay.show_fcurves "Link to this definition")
    :   Display strip opacity/volume curve

        Type:
        :   boolean, default False

    show\_grid[¶](#bpy.types.SequencerTimelineOverlay.show_grid "Link to this definition")
    :   Show vertical grid lines

        Type:
        :   boolean, default False

    show\_strip\_duration[¶](#bpy.types.SequencerTimelineOverlay.show_strip_duration "Link to this definition")
    :   Type:
        :   boolean, default False

    show\_strip\_name[¶](#bpy.types.SequencerTimelineOverlay.show_strip_name "Link to this definition")
    :   Type:
        :   boolean, default False

    show\_strip\_offset[¶](#bpy.types.SequencerTimelineOverlay.show_strip_offset "Link to this definition")
    :   Display strip in/out offsets

        Type:
        :   boolean, default False

    show\_strip\_retiming[¶](#bpy.types.SequencerTimelineOverlay.show_strip_retiming "Link to this definition")
    :   Display retiming keys on top of strips

        Type:
        :   boolean, default False

    show\_strip\_source[¶](#bpy.types.SequencerTimelineOverlay.show_strip_source "Link to this definition")
    :   Display path to source file, or name of source data-block

        Type:
        :   boolean, default False

    show\_strip\_tag\_color[¶](#bpy.types.SequencerTimelineOverlay.show_strip_tag_color "Link to this definition")
    :   Display the strip color tags in the sequencer

        Type:
        :   boolean, default False

    show\_thumbnails[¶](#bpy.types.SequencerTimelineOverlay.show_thumbnails "Link to this definition")
    :   Show strip thumbnails

        Type:
        :   boolean, default False

    waveform\_display\_style[¶](#bpy.types.SequencerTimelineOverlay.waveform_display_style "Link to this definition")
    ...
    waveform\_display\_type[¶](#bpy.types.SequencerTimelineOverlay.waveform_display_type "Link to this definition")
    :   How Waveforms are displayed
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.SequencerTimelineOverlay.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.SequencerTimelineOverlay.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`SpaceSequenceEditor.timeline_overlay`](SpaceSequenceEditor.md#bpy.types.SpaceSequenceEditor.timeline_overlay "bpy.types.SpaceSequenceEditor.timeline_overlay") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.SequencerTimelineOverlay.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.SequencerTimelineOverlay.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* SequencerTimelineOverlay(bpy\_struct)
  + [`SequencerTimelineOverlay`](#bpy.types.SequencerTimelineOverlay)
    - [`SequencerTimelineOverlay.show_fcurves`](#bpy.types.SequencerTimelineOverlay.show_fcurves)
    - [`SequencerTimelineOverlay.show_grid`](#bpy.types.SequencerTimelineOverlay.show_grid)
    - [`SequencerTimelineOverlay.show_strip_duration`](#bpy.types.SequencerTimelineOverlay.show_strip_duration)
    - [`SequencerTimelineOverlay.show_strip_name`](#bpy.types.SequencerTimelineOverlay.show_strip_name)
    - [`SequencerTimelineOverlay.show_strip_offset`](#bpy.types.SequencerTimelineOverlay.show_strip_offset)
    - [`SequencerTimelineOverlay.show_strip_retiming`](#bpy.types.SequencerTimelineOverlay.show_strip_retiming)
    - [`SequencerTimelineOverlay.show_strip_source`](#bpy.types.SequencerTimelineOverlay.show_strip_source)
    - [`SequencerTimelineOverlay.show_strip_tag_color`](#bpy.types.SequencerTimelineOverlay.show_strip_tag_color)
    - [`SequencerTimelineOverlay.show_thumbnails`](#bpy.types.SequencerTimelineOverlay.show_thumbnails)
    - [`SequencerTimelineOverlay.waveform_display_style`](#bpy.types.SequencerTimelineOverlay.waveform_display_style)
    - [`SequencerTimelineOverlay.waveform_display_type`](#bpy.types.SequencerTimelineOverlay.waveform_display_type)
    - [`SequencerTimelineOverlay.bl_rna_get_subclass()`](#bpy.types.SequencerTimelineOverlay.bl_rna_get_subclass)
    - [`SequencerTimelineOverlay.bl_rna_get_subclass_py()`](#bpy.types.SequencerTimelineOverlay.bl_rna_get_subclass_py)
