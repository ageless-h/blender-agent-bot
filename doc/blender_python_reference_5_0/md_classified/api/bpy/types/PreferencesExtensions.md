...
# PreferencesExtensions(bpy\_struct)[¶](#preferencesextensions-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.PreferencesExtensions(*bpy\_struct*)[¶](#bpy.types.PreferencesExtensions "Link to this definition")
:   Settings for extensions

    active\_repo[¶](#bpy.types.PreferencesExtensions.active_repo "Link to this definition")
    :   Index of the extensions repository being edited in the Preferences UI

        Type:
        :   int in [-32768, 32767], default 0

    repos[¶](#bpy.types.PreferencesExtensions.repos "Link to this definition")
    :   Type:
        :   [`UserExtensionRepoCollection`](UserExtensionRepoCollection.md#bpy.types.UserExtensionRepoCollection "bpy.types.UserExtensionRepoCollection") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`UserExtensionRepo`](UserExtensionRepo.md#bpy.types.UserExtensionRepo "bpy.types.UserExtensionRepo"), (readonly)

    use\_online\_access\_handled[¶](#bpy.types.PreferencesExtensions.use_online_access_handled "Link to this definition")
    :   The user has been shown the “Online Access” prompt and made a choice

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.PreferencesExtensions.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.PreferencesExtensions.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Preferences.extensions`](Preferences.md#bpy.types.Preferences.extensions "bpy.types.Preferences.extensions") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.PreferencesExtensions.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.PreferencesExtensions.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* PreferencesExtensions(bpy\_struct)
  + [`PreferencesExtensions`](#bpy.types.PreferencesExtensions)
    - [`PreferencesExtensions.active_repo`](#bpy.types.PreferencesExtensions.active_repo)
    - [`PreferencesExtensions.repos`](#bpy.types.PreferencesExtensions.repos)
    - [`PreferencesExtensions.use_online_access_handled`](#bpy.types.PreferencesExtensions.use_online_access_handled)
    - [`PreferencesExtensions.bl_rna_get_subclass()`](#bpy.types.PreferencesExtensions.bl_rna_get_subclass)
    - [`PreferencesExtensions.bl_rna_get_subclass_py()`](#bpy.types.PreferencesExtensions.bl_rna_get_subclass_py)
