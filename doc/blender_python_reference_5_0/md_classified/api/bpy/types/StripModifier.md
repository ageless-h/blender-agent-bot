...
# StripModifier(bpy\_struct)[¶](#stripmodifier-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

subclasses —
[`BrightContrastModifier`](BrightContrastModifier.md#bpy.types.BrightContrastModifier "bpy.types.BrightContrastModifier"), [`ColorBalanceModifier`](ColorBalanceModifier.md#bpy.types.ColorBalanceModifier "bpy.types.ColorBalanceModifier"), [`CurvesModifier`](CurvesModifier.md#bpy.types.CurvesModifier "bpy.types.CurvesModifier"), [`HueCorrectModifier`](HueCorrectModifier.md#bpy.types.HueCorrectModifier "bpy.types.HueCorrectModifier"), [`MaskStripModifier`](MaskStripModifier.md#bpy.types.MaskStripModifier "bpy.types.MaskStripModifier"), [`SequencerCompositorModifierData`](SequencerCompositorModifierData.md#bpy.types.SequencerCompositorModifierData "bpy.types.SequencerCompositorModifierData"), [`SequencerTonemapModifierData`](SequencerTonemapModifierData.md#bpy.types.SequencerTonemapModifierData "bpy.types.SequencerTonemapModifierData"), [`SoundEqualizerModifier`](SoundEqualizerModifier.md#bpy.types.SoundEqualizerModifier "bpy.types.SoundEqualizerModifier"), [`WhiteBalanceModifier`](WhiteBalanceModifier.md#bpy.types.WhiteBalanceModifier "bpy.types.WhiteBalanceModifier")

*class* bpy.types.StripModifier(*bpy\_struct*)[¶](#bpy.types.StripModifier "Link to this definition")
:   Modifier for sequence strip

    enable[¶](#bpy.types.StripModifier.enable "Link to this definition")
    :   Enable this modifier

        Type:
        :   boolean, default False

    input\_mask\_id[¶](#bpy.types.StripModifier.input_mask_id "Link to this definition")
    :   Mask ID used as mask input for the modifier

        Type:
        :   [`Mask`](Mask.md#bpy.types.Mask "bpy.types.Mask")

    input\_mask\_strip[¶](#bpy.types.StripModifier.input_mask_strip "Link to this definition")
    :   Strip used as mask input for the modifier

        Type:
        :   [`Strip`](Strip.md#bpy.types.Strip "bpy.types.Strip")

    input\_mask\_type[¶](#bpy.types.StripModifier.input_mask_type "Link to this definition")
    ...
    is\_active[¶](#bpy.types.StripModifier.is_active "Link to this definition")
    :   This modifier is active

        Type:
        :   boolean, default False

    mask\_time[¶](#bpy.types.StripModifier.mask_time "Link to this definition")
    ...
    mute[¶](#bpy.types.StripModifier.mute "Link to this definition")
    :   Mute this modifier

        Type:
        :   boolean, default False

    name[¶](#bpy.types.StripModifier.name "Link to this definition")
    :   Type:
        :   string, default “”, (never None)

    show\_expanded[¶](#bpy.types.StripModifier.show_expanded "Link to this definition")
    :   Mute expanded settings for the modifier

        Type:
        :   boolean, default False

    type[¶](#bpy.types.StripModifier.type "Link to this definition")
    :   Type:
        :   enum in [Strip Modifier Type Items](../../../appendix/bpy_types_enum_items/strip_modifier_type_items.md#rna-enum-strip-modifier-type-items), default `'BRIGHT_CONTRAST'`, (readonly)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.StripModifier.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.StripModifier.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`bpy.context.strip_modifier`](../context/index.md#bpy.context.strip_modifier "bpy.context.strip_modifier") * [`Strip.modifiers`](Strip.md#bpy.types.Strip.modifiers "bpy.types.Strip.modifiers") * [`StripModifiers.active`](StripModifiers.md#bpy.types.StripModifiers.active "bpy.types.StripModifiers.active") | * [`StripModifiers.new`](StripModifiers.md#bpy.types.StripModifiers.new "bpy.types.StripModifiers.new") * [`StripModifiers.remove`](StripModifiers.md#bpy.types.StripModifiers.remove "bpy.types.StripModifiers.remove") |

[Next

StripModifiers(bpy\_struct)](StripModifiers.md)
[Previous

StripElements(bpy\_struct)](StripElements.md)
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.StripModifier.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.StripModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* StripModifier(bpy\_struct)
  + [`StripModifier`](#bpy.types.StripModifier)
    - [`StripModifier.enable`](#bpy.types.StripModifier.enable)
    - [`StripModifier.input_mask_id`](#bpy.types.StripModifier.input_mask_id)
    - [`StripModifier.input_mask_strip`](#bpy.types.StripModifier.input_mask_strip)
    - [`StripModifier.input_mask_type`](#bpy.types.StripModifier.input_mask_type)
    - [`StripModifier.is_active`](#bpy.types.StripModifier.is_active)
    - [`StripModifier.mask_time`](#bpy.types.StripModifier.mask_time)
    - [`StripModifier.mute`](#bpy.types.StripModifier.mute)
    - [`StripModifier.name`](#bpy.types.StripModifier.name)
    - [`StripModifier.show_expanded`](#bpy.types.StripModifier.show_expanded)
    - [`StripModifier.type`](#bpy.types.StripModifier.type)
    - [`StripModifier.bl_rna_get_subclass()`](#bpy.types.StripModifier.bl_rna_get_subclass)
    - [`StripModifier.bl_rna_get_subclass_py()`](#bpy.types.StripModifier.bl_rna_get_subclass_py)
