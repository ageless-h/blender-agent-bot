...
# FloatVectorAttributeValue(bpy\_struct)[¶](#floatvectorattributevalue-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.FloatVectorAttributeValue(*bpy\_struct*)[¶](#bpy.types.FloatVectorAttributeValue "Link to this definition")
:   Vector value in geometry attribute

    vector[¶](#bpy.types.FloatVectorAttributeValue.vector "Link to this definition")
    :   3D vector

        Type:
        :   [`mathutils.Vector`](../../mathutils/index.md#mathutils.Vector "mathutils.Vector") of 3 items in [-inf, inf], default (0.0, 0.0, 0.0)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.FloatVectorAttributeValue.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.FloatVectorAttributeValue.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Curves.position_data`](Curves.md#bpy.types.Curves.position_data "bpy.types.Curves.position_data") | * [`FloatVectorAttribute.data`](FloatVectorAttribute.md#bpy.types.FloatVectorAttribute.data "bpy.types.FloatVectorAttribute.data") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.FloatVectorAttributeValue.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.FloatVectorAttributeValue.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* FloatVectorAttributeValue(bpy\_struct)
  + [`FloatVectorAttributeValue`](#bpy.types.FloatVectorAttributeValue)
    - [`FloatVectorAttributeValue.vector`](#bpy.types.FloatVectorAttributeValue.vector)
    - [`FloatVectorAttributeValue.bl_rna_get_subclass()`](#bpy.types.FloatVectorAttributeValue.bl_rna_get_subclass)
    - [`FloatVectorAttributeValue.bl_rna_get_subclass_py()`](#bpy.types.FloatVectorAttributeValue.bl_rna_get_subclass_py)
