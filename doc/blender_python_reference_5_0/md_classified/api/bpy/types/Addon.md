...
# Addon(bpy\_struct)[¶](#addon-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.Addon(*bpy\_struct*)[¶](#bpy.types.Addon "Link to this definition")
:   Python add-ons to be loaded automatically

    module[¶](#bpy.types.Addon.module "Link to this definition")
    :   Module name

        Type:
        :   string, default “”, (never None)

    preferences[¶](#bpy.types.Addon.preferences "Link to this definition")
    :   Type:
        :   [`AddonPreferences`](AddonPreferences.md#bpy.types.AddonPreferences "bpy.types.AddonPreferences"), (readonly)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.Addon.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.Addon.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Addons.new`](Addons.md#bpy.types.Addons.new "bpy.types.Addons.new") * [`Addons.remove`](Addons.md#bpy.types.Addons.remove "bpy.types.Addons.remove") | * [`Preferences.addons`](Preferences.md#bpy.types.Preferences.addons "bpy.types.Preferences.addons") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.Addon.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.Addon.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* Addon(bpy\_struct)
  + [`Addon`](#bpy.types.Addon)
    - [`Addon.module`](#bpy.types.Addon.module)
    - [`Addon.preferences`](#bpy.types.Addon.preferences)
    - [`Addon.bl_rna_get_subclass()`](#bpy.types.Addon.bl_rna_get_subclass)
    - [`Addon.bl_rna_get_subclass_py()`](#bpy.types.Addon.bl_rna_get_subclass_py)
