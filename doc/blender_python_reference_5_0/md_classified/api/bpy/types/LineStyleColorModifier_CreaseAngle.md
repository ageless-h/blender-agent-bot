...
# LineStyleColorModifier\_CreaseAngle(LineStyleColorModifier)[¶](#linestylecolormodifier-creaseangle-linestylecolormodifier "Link to this heading")
...
*class* bpy.types.LineStyleColorModifier\_CreaseAngle(*LineStyleColorModifier*)[¶](#bpy.types.LineStyleColorModifier_CreaseAngle "Link to this definition")
:   Change line color based on the underlying crease angle

    angle\_max[¶](#bpy.types.LineStyleColorModifier_CreaseAngle.angle_max "Link to this definition")
    :   Maximum angle to modify thickness

        Type:
        :   float in [-inf, inf], default 0.0

    angle\_min[¶](#bpy.types.LineStyleColorModifier_CreaseAngle.angle_min "Link to this definition")
    :   Minimum angle to modify thickness

        Type:
        :   float in [-inf, inf], default 0.0

    blend[¶](#bpy.types.LineStyleColorModifier_CreaseAngle.blend "Link to this definition")
    ...
    color\_ramp[¶](#bpy.types.LineStyleColorModifier_CreaseAngle.color_ramp "Link to this definition")
    :   Color ramp used to change line color

        Type:
        :   [`ColorRamp`](ColorRamp.md#bpy.types.ColorRamp "bpy.types.ColorRamp"), (readonly)

    expanded[¶](#bpy.types.LineStyleColorModifier_CreaseAngle.expanded "Link to this definition")
    :   True if the modifier tab is expanded

        Type:
        :   boolean, default False

    influence[¶](#bpy.types.LineStyleColorModifier_CreaseAngle.influence "Link to this definition")
    :   Influence factor by which the modifier changes the property

        Type:
        :   float in [0, 1], default 0.0

    type[¶](#bpy.types.LineStyleColorModifier_CreaseAngle.type "Link to this definition")
    ...
    use[¶](#bpy.types.LineStyleColorModifier_CreaseAngle.use "Link to this definition")
    :   Enable or disable this modifier during stroke rendering

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.LineStyleColorModifier_CreaseAngle.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.LineStyleColorModifier_CreaseAngle.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.LineStyleColorModifier_CreaseAngle.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.LineStyleColorModifier_CreaseAngle.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* LineStyleColorModifier\_CreaseAngle(LineStyleColorModifier)
  + [`LineStyleColorModifier_CreaseAngle`](#bpy.types.LineStyleColorModifier_CreaseAngle)
    - [`LineStyleColorModifier_CreaseAngle.angle_max`](#bpy.types.LineStyleColorModifier_CreaseAngle.angle_max)
    - [`LineStyleColorModifier_CreaseAngle.angle_min`](#bpy.types.LineStyleColorModifier_CreaseAngle.angle_min)
    - [`LineStyleColorModifier_CreaseAngle.blend`](#bpy.types.LineStyleColorModifier_CreaseAngle.blend)
    - [`LineStyleColorModifier_CreaseAngle.color_ramp`](#bpy.types.LineStyleColorModifier_CreaseAngle.color_ramp)
    - [`LineStyleColorModifier_CreaseAngle.expanded`](#bpy.types.LineStyleColorModifier_CreaseAngle.expanded)
    - [`LineStyleColorModifier_CreaseAngle.influence`](#bpy.types.LineStyleColorModifier_CreaseAngle.influence)
    - [`LineStyleColorModifier_CreaseAngle.type`](#bpy.types.LineStyleColorModifier_CreaseAngle.type)
    - [`LineStyleColorModifier_CreaseAngle.use`](#bpy.types.LineStyleColorModifier_CreaseAngle.use)
    - [`LineStyleColorModifier_CreaseAngle.bl_rna_get_subclass()`](#bpy.types.LineStyleColorModifier_CreaseAngle.bl_rna_get_subclass)
    - [`LineStyleColorModifier_CreaseAngle.bl_rna_get_subclass_py()`](#bpy.types.LineStyleColorModifier_CreaseAngle.bl_rna_get_subclass_py)
