...
# BlendDataPointClouds(bpy\_struct)[¶](#blenddatapointclouds-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.BlendDataPointClouds(*bpy\_struct*)[¶](#bpy.types.BlendDataPointClouds "Link to this definition")
:   Collection of point clouds

    new(*name*)[¶](#bpy.types.BlendDataPointClouds.new "Link to this definition")
    :   Add a new point cloud to the main database
        ...
        Return type:
        :   [`PointCloud`](PointCloud.md#bpy.types.PointCloud "bpy.types.PointCloud")

    remove(*pointcloud*, *\**, *do\_unlink=True*, *do\_id\_user=True*, *do\_ui\_user=True*)[¶](#bpy.types.BlendDataPointClouds.remove "Link to this definition")
    :   Remove a point cloud from the current blendfile

        Parameters:
        :   * **pointcloud** ([`PointCloud`](PointCloud.md#bpy.types.PointCloud "bpy.types.PointCloud"), (never None)) – Point cloud to remove
            * **do\_unlink** (*boolean**,* *(**optional**)*) – Unlink all usages of this point cloud before deleting it (WARNING: will also delete objects instancing that point cloud data)
            * **do\_id\_user** (*boolean**,* *(**optional**)*) – Decrement user counter of all data-blocks used by this point cloud data
            * **do\_ui\_user** (*boolean**,* *(**optional**)*) – Make sure interface does not reference this point cloud data

    tag(*value*)[¶](#bpy.types.BlendDataPointClouds.tag "Link to this definition")
    :   tag

        Parameters:
        :   **value** (*boolean*) – Value

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.BlendDataPointClouds.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.BlendDataPointClouds.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`BlendData.pointclouds`](BlendData.md#bpy.types.BlendData.pointclouds "bpy.types.BlendData.pointclouds") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.BlendDataPointClouds.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.BlendDataPointClouds.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* BlendDataPointClouds(bpy\_struct)
  + [`BlendDataPointClouds`](#bpy.types.BlendDataPointClouds)
    - [`BlendDataPointClouds.new()`](#bpy.types.BlendDataPointClouds.new)
    - [`BlendDataPointClouds.remove()`](#bpy.types.BlendDataPointClouds.remove)
    - [`BlendDataPointClouds.tag()`](#bpy.types.BlendDataPointClouds.tag)
    - [`BlendDataPointClouds.bl_rna_get_subclass()`](#bpy.types.BlendDataPointClouds.bl_rna_get_subclass)
    - [`BlendDataPointClouds.bl_rna_get_subclass_py()`](#bpy.types.BlendDataPointClouds.bl_rna_get_subclass_py)
