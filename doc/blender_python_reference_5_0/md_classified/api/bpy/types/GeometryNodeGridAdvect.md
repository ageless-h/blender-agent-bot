...
# GeometryNodeGridAdvect(GeometryNode)[¶](#geometrynodegridadvect-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeGridAdvect(*GeometryNode*)[¶](#bpy.types.GeometryNodeGridAdvect "Link to this definition")
:   Move grid values through a velocity field using numerical integration. Supports multiple integration schemes for different accuracy and performance trade-offs
    ...
    data\_type[¶](#bpy.types.GeometryNodeGridAdvect.data_type "Link to this definition")
    ...
    *classmethod* is\_registered\_node\_type()[¶](#bpy.types.GeometryNodeGridAdvect.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[¶](#bpy.types.GeometryNodeGridAdvect.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[¶](#bpy.types.GeometryNodeGridAdvect.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.GeometryNodeGridAdvect.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.GeometryNodeGridAdvect.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
GeometryNodeGridCurl(GeometryNode)](GeometryNodeGridCurl.md)
[Previous
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeGridAdvect.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.GeometryNodeGridAdvect.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeGridAdvect(GeometryNode)
  + [`GeometryNodeGridAdvect`](#bpy.types.GeometryNodeGridAdvect)
    - [`GeometryNodeGridAdvect.data_type`](#bpy.types.GeometryNodeGridAdvect.data_type)
    - [`GeometryNodeGridAdvect.is_registered_node_type()`](#bpy.types.GeometryNodeGridAdvect.is_registered_node_type)
    - [`GeometryNodeGridAdvect.input_template()`](#bpy.types.GeometryNodeGridAdvect.input_template)
    - [`GeometryNodeGridAdvect.output_template()`](#bpy.types.GeometryNodeGridAdvect.output_template)
    - [`GeometryNodeGridAdvect.bl_rna_get_subclass()`](#bpy.types.GeometryNodeGridAdvect.bl_rna_get_subclass)
    - [`GeometryNodeGridAdvect.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeGridAdvect.bl_rna_get_subclass_py)
