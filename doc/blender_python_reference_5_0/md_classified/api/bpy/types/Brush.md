...
:   Brush data-block for storing brush settings for painting and sculpting
    ...
    curve\_distance\_falloff[¶](#bpy.types.Brush.curve_distance_falloff "Link to this definition")
    :   Editable falloff curve

        Type:
        :   [`CurveMapping`](CurveMapping.md#bpy.types.CurveMapping "bpy.types.CurveMapping"), (readonly, never None)

    curve\_distance\_falloff\_preset[¶](#bpy.types.Brush.curve_distance_falloff_preset "Link to this definition")
    :   Type:
    ...
    curve\_jitter[¶](#bpy.types.Brush.curve_jitter "Link to this definition")
    :   Curve used to map pressure to brush jitter

        Type:
        :   [`CurveMapping`](CurveMapping.md#bpy.types.CurveMapping "bpy.types.CurveMapping"), (readonly)

    curve\_random\_hue[¶](#bpy.types.Brush.curve_random_hue "Link to this definition")
    :   Curve used for modulating effect

        Type:
        :   [`CurveMapping`](CurveMapping.md#bpy.types.CurveMapping "bpy.types.CurveMapping"), (readonly)

    curve\_random\_saturation[¶](#bpy.types.Brush.curve_random_saturation "Link to this definition")
    :   Curve used for modulating effect

        Type:
        :   [`CurveMapping`](CurveMapping.md#bpy.types.CurveMapping "bpy.types.CurveMapping"), (readonly)

    curve\_random\_value[¶](#bpy.types.Brush.curve_random_value "Link to this definition")
    :   Curve used for modulating effect

        Type:
        :   [`CurveMapping`](CurveMapping.md#bpy.types.CurveMapping "bpy.types.CurveMapping"), (readonly)

    curve\_size[¶](#bpy.types.Brush.curve_size "Link to this definition")
    :   Curve used to map pressure to brush size

        Type:
        :   [`CurveMapping`](CurveMapping.md#bpy.types.CurveMapping "bpy.types.CurveMapping"), (readonly)

    curve\_strength[¶](#bpy.types.Brush.curve_strength "Link to this definition")
    :   Curve used to map pressure to brush strength

        Type:
        :   [`CurveMapping`](CurveMapping.md#bpy.types.CurveMapping "bpy.types.CurveMapping"), (readonly)

    curves\_sculpt\_brush\_type[¶](#bpy.types.Brush.curves_sculpt_brush_type "Link to this definition")
    :   Type:
        :   enum in [Brush Curves Sculpt Brush Type Items](../../../appendix/bpy_types_enum_items/brush_curves_sculpt_brush_type_items.md#rna-enum-brush-curves-sculpt-brush-type-items), default `'COMB'`
    ...
    gpencil\_brush\_type[¶](#bpy.types.Brush.gpencil_brush_type "Link to this definition")
    :   Type:
    ...
    gpencil\_sculpt\_brush\_type[¶](#bpy.types.Brush.gpencil_sculpt_brush_type "Link to this definition")
    :   Type:
    ...
    gpencil\_vertex\_brush\_type[¶](#bpy.types.Brush.gpencil_vertex_brush_type "Link to this definition")
    :   Type:
    ...
    gpencil\_weight\_brush\_type[¶](#bpy.types.Brush.gpencil_weight_brush_type "Link to this definition")
    :   Type:
    ...
    has\_unsaved\_changes[¶](#bpy.types.Brush.has_unsaved_changes "Link to this definition")
    ...
    hue\_jitter[¶](#bpy.types.Brush.hue_jitter "Link to this definition")
    :   Color jitter effect on hue

        Type:
        :   float in [0, 1], default 0.0

    image\_brush\_type[¶](#bpy.types.Brush.image_brush_type "Link to this definition")
    :   Type:
        :   enum in [Brush Image Brush Type Items](../../../appendix/bpy_types_enum_items/brush_image_brush_type_items.md#rna-enum-brush-image-brush-type-items), default `'DRAW'`
    ...
    plane\_depth[¶](#bpy.types.Brush.plane_depth "Link to this definition")
    :   The maximum distance below the plane for affected vertices. Increasing the depth affects vertices farther below the plane.

        Type:
        :   float in [0, 1], default 0.0

    plane\_height[¶](#bpy.types.Brush.plane_height "Link to this definition")
    ...
    plane\_inversion\_mode[¶](#bpy.types.Brush.plane_inversion_mode "Link to this definition")
    :   Inversion Mode
    ...
    saturation\_jitter[¶](#bpy.types.Brush.saturation_jitter "Link to this definition")
    :   Color jitter effect on saturation

        Type:
        :   float in [0, 1], default 0.0

    sculpt\_brush\_type[¶](#bpy.types.Brush.sculpt_brush_type "Link to this definition")
    :   Type:
        :   enum in [Brush Sculpt Brush Type Items](../../../appendix/bpy_types_enum_items/brush_sculpt_brush_type_items.md#rna-enum-brush-sculpt-brush-type-items), default `'DRAW'`
    ...
    stabilize\_normal[¶](#bpy.types.Brush.stabilize_normal "Link to this definition")
    :   Stabilize the orientation of the brush plane.

        Type:
        :   float in [0, 1], default 0.0

    stabilize\_plane[¶](#bpy.types.Brush.stabilize_plane "Link to this definition")
    ...
    unprojected\_size[¶](#bpy.types.Brush.unprojected_size "Link to this definition")
    ...
    use\_color\_jitter[¶](#bpy.types.Brush.use_color_jitter "Link to this definition")
    :   Jitter brush color
    ...
    use\_random\_press\_hue[¶](#bpy.types.Brush.use_random_press_hue "Link to this definition")
    :   Use pressure to modulate randomness

        Type:
        :   boolean, default False

    use\_random\_press\_sat[¶](#bpy.types.Brush.use_random_press_sat "Link to this definition")
    :   Use pressure to modulate randomness

        Type:
        :   boolean, default False

    use\_random\_press\_val[¶](#bpy.types.Brush.use_random_press_val "Link to this definition")
    :   Use pressure to modulate randomness
    ...
    use\_stroke\_random\_hue[¶](#bpy.types.Brush.use_stroke_random_hue "Link to this definition")
    :   Use randomness at stroke level

        Type:
        :   boolean, default False

    use\_stroke\_random\_sat[¶](#bpy.types.Brush.use_stroke_random_sat "Link to this definition")
    :   Use randomness at stroke level

        Type:
        :   boolean, default False

    use\_stroke\_random\_val[¶](#bpy.types.Brush.use_stroke_random_val "Link to this definition")
    :   Use randomness at stroke level
    ...
    value\_jitter[¶](#bpy.types.Brush.value_jitter "Link to this definition")
    :   Color jitter effect on value

        Type:
        :   float in [0, 1], default 0.0

    vertex\_brush\_type[¶](#bpy.types.Brush.vertex_brush_type "Link to this definition")
    :   Type:
        :   enum in [Brush Vertex Brush Type Items](../../../appendix/bpy_types_enum_items/brush_vertex_brush_type_items.md#rna-enum-brush-vertex-brush-type-items), default `'DRAW'`
    ...
    weight\_brush\_type[¶](#bpy.types.Brush.weight_brush_type "Link to this definition")
    :   Type:
        :   enum in [Brush Weight Brush Type Items](../../../appendix/bpy_types_enum_items/brush_weight_brush_type_items.md#rna-enum-brush-weight-brush-type-items), default `'DRAW'`
...
BrightContrastModifier(StripModifier)](BrightContrastModifier.md)
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.Brush.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.Brush.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)
...
* Brush(ID)
  + [`Brush`](#bpy.types.Brush)
    ...
    - [`Brush.curve_distance_falloff`](#bpy.types.Brush.curve_distance_falloff)
    - [`Brush.curve_distance_falloff_preset`](#bpy.types.Brush.curve_distance_falloff_preset)
    - [`Brush.curve_jitter`](#bpy.types.Brush.curve_jitter)
    - [`Brush.curve_random_hue`](#bpy.types.Brush.curve_random_hue)
    - [`Brush.curve_random_saturation`](#bpy.types.Brush.curve_random_saturation)
    - [`Brush.curve_random_value`](#bpy.types.Brush.curve_random_value)
    - [`Brush.curve_size`](#bpy.types.Brush.curve_size)
    - [`Brush.curve_strength`](#bpy.types.Brush.curve_strength)
    - [`Brush.curves_sculpt_brush_type`](#bpy.types.Brush.curves_sculpt_brush_type)
    ...
    - [`Brush.gpencil_brush_type`](#bpy.types.Brush.gpencil_brush_type)
    - [`Brush.gpencil_sculpt_brush_type`](#bpy.types.Brush.gpencil_sculpt_brush_type)
    - [`Brush.gpencil_settings`](#bpy.types.Brush.gpencil_settings)
    - [`Brush.gpencil_vertex_brush_type`](#bpy.types.Brush.gpencil_vertex_brush_type)
    - [`Brush.gpencil_weight_brush_type`](#bpy.types.Brush.gpencil_weight_brush_type)
    ...
    - [`Brush.has_unsaved_changes`](#bpy.types.Brush.has_unsaved_changes)
    - [`Brush.height`](#bpy.types.Brush.height)
    - [`Brush.hue_jitter`](#bpy.types.Brush.hue_jitter)
    - [`Brush.image_brush_type`](#bpy.types.Brush.image_brush_type)
    ...
    - [`Brush.plane_depth`](#bpy.types.Brush.plane_depth)
    - [`Brush.plane_height`](#bpy.types.Brush.plane_height)
    - [`Brush.plane_inversion_mode`](#bpy.types.Brush.plane_inversion_mode)
    ...
    - [`Brush.saturation_jitter`](#bpy.types.Brush.saturation_jitter)
    - [`Brush.sculpt_brush_type`](#bpy.types.Brush.sculpt_brush_type)
    ...
    - [`Brush.stabilize_normal`](#bpy.types.Brush.stabilize_normal)
    - [`Brush.stabilize_plane`](#bpy.types.Brush.stabilize_plane)
    ...
    - [`Brush.unprojected_size`](#bpy.types.Brush.unprojected_size)
    ...
    - [`Brush.use_color_jitter`](#bpy.types.Brush.use_color_jitter)
    ...
    - [`Brush.use_random_press_hue`](#bpy.types.Brush.use_random_press_hue)
    - [`Brush.use_random_press_sat`](#bpy.types.Brush.use_random_press_sat)
    - [`Brush.use_random_press_val`](#bpy.types.Brush.use_random_press_val)
    ...
    - [`Brush.use_stroke_random_hue`](#bpy.types.Brush.use_stroke_random_hue)
    - [`Brush.use_stroke_random_sat`](#bpy.types.Brush.use_stroke_random_sat)
    - [`Brush.use_stroke_random_val`](#bpy.types.Brush.use_stroke_random_val)
    ...
    - [`Brush.value_jitter`](#bpy.types.Brush.value_jitter)
    - [`Brush.vertex_brush_type`](#bpy.types.Brush.vertex_brush_type)
    - [`Brush.vertex_paint_capabilities`](#bpy.types.Brush.vertex_paint_capabilities)
    - [`Brush.weight`](#bpy.types.Brush.weight)
    - [`Brush.weight_brush_type`](#bpy.types.Brush.weight_brush_type)
