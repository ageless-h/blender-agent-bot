...
# UI\_UL\_list(UIList)[¶](#ui-ul-list-uilist "Link to this heading")
...
*class* bpy.types.UI\_UL\_list(*UIList*)[¶](#bpy.types.UI_UL_list "Link to this definition")
:   *static* filter\_items\_by\_name(*pattern*, *bitflag*, *items*, *propname='name'*, *flags=None*, *reverse=False*)[¶](#bpy.types.UI_UL_list.filter_items_by_name "Link to this definition")
    :   Set FILTER\_ITEM for items which name matches filter\_name one (case-insensitive).
    ...
    *classmethod* sort\_items\_by\_name(*items*, *propname='name'*)[¶](#bpy.types.UI_UL_list.sort_items_by_name "Link to this definition")
    :   Re-order items using their names (case-insensitive).
        propname is the name of the string property to use for sorting.
        return a list mapping org\_idx -> new\_idx,
        or an empty list if no sorting has been done.

    *static* sort\_items\_helper(*sort\_data*, *key*, *reverse=False*)[¶](#bpy.types.UI_UL_list.sort_items_helper "Link to this definition")
    :   Common sorting utility. Returns a neworder list mapping org\_idx -> new\_idx.
        sort\_data must be an (unordered) list of tuples [(org\_idx, …), (org\_idx, …), …].
        key must be the same kind of callable you would use for sorted() builtin function.
        reverse will reverse the sorting!

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.UI_UL_list.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.UI_UL_list.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.UI_UL_list.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.UI_UL_list.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* UI\_UL\_list(UIList)
  + [`UI_UL_list`](#bpy.types.UI_UL_list)
    - [`UI_UL_list.filter_items_by_name()`](#bpy.types.UI_UL_list.filter_items_by_name)
    - [`UI_UL_list.sort_items_by_name()`](#bpy.types.UI_UL_list.sort_items_by_name)
    - [`UI_UL_list.sort_items_helper()`](#bpy.types.UI_UL_list.sort_items_helper)
    - [`UI_UL_list.bl_rna_get_subclass()`](#bpy.types.UI_UL_list.bl_rna_get_subclass)
    - [`UI_UL_list.bl_rna_get_subclass_py()`](#bpy.types.UI_UL_list.bl_rna_get_subclass_py)
