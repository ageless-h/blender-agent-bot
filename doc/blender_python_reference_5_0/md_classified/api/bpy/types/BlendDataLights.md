...
# BlendDataLights(bpy\_struct)[¶](#blenddatalights-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.BlendDataLights(*bpy\_struct*)[¶](#bpy.types.BlendDataLights "Link to this definition")
:   Collection of lights

    new(*name*, *type*)[¶](#bpy.types.BlendDataLights.new "Link to this definition")
    :   Add a new light to the main database

        Parameters:
        :   * **name** (*string**,* *(**never None**)*) – New name for the data-block
            * **type** (enum in [Light Type Items](../../../appendix/bpy_types_enum_items/light_type_items.md#rna-enum-light-type-items)) – Type, The type of light to add

        Returns:
        :   New light data-block

        Return type:
        :   [`Light`](Light.md#bpy.types.Light "bpy.types.Light")

    remove(*light*, *\**, *do\_unlink=True*, *do\_id\_user=True*, *do\_ui\_user=True*)[¶](#bpy.types.BlendDataLights.remove "Link to this definition")
    :   Remove a light from the current blendfile

        Parameters:
        :   * **light** ([`Light`](Light.md#bpy.types.Light "bpy.types.Light"), (never None)) – Light to remove
            * **do\_unlink** (*boolean**,* *(**optional**)*) – Unlink all usages of this light before deleting it (WARNING: will also delete objects instancing that light data)
            * **do\_id\_user** (*boolean**,* *(**optional**)*) – Decrement user counter of all data-blocks used by this light data
            * **do\_ui\_user** (*boolean**,* *(**optional**)*) – Make sure interface does not reference this light data

    tag(*value*)[¶](#bpy.types.BlendDataLights.tag "Link to this definition")
    :   tag

        Parameters:
        :   **value** (*boolean*) – Value

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.BlendDataLights.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.BlendDataLights.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`BlendData.lights`](BlendData.md#bpy.types.BlendData.lights "bpy.types.BlendData.lights") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.BlendDataLights.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.BlendDataLights.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* BlendDataLights(bpy\_struct)
  + [`BlendDataLights`](#bpy.types.BlendDataLights)
    - [`BlendDataLights.new()`](#bpy.types.BlendDataLights.new)
    - [`BlendDataLights.remove()`](#bpy.types.BlendDataLights.remove)
    - [`BlendDataLights.tag()`](#bpy.types.BlendDataLights.tag)
    - [`BlendDataLights.bl_rna_get_subclass()`](#bpy.types.BlendDataLights.bl_rna_get_subclass)
    - [`BlendDataLights.bl_rna_get_subclass_py()`](#bpy.types.BlendDataLights.bl_rna_get_subclass_py)
