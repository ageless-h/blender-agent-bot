...
:   Write image file to disk
    ...
    active\_item\_index[¶](#bpy.types.CompositorNodeOutputFile.active_item_index "Link to this definition")
    :   Index of the active item

        Type:
        :   int in [0, inf], default 0

    directory[¶](#bpy.types.CompositorNodeOutputFile.directory "Link to this definition")
    ...
    file\_name[¶](#bpy.types.CompositorNodeOutputFile.file_name "Link to this definition")
    :   The base name of the file. Other information might be included in the final file name depending on the node options

        Type:
        :   string, default “”, (never None, Supports [template expressions](https://docs.blender.org/manual/en/5.0/files/file_paths.html#path-templates))

    file\_output\_items[¶](#bpy.types.CompositorNodeOutputFile.file_output_items "Link to this definition")
    :   Type:
        :   [`NodeCompositorFileOutputItems`](NodeCompositorFileOutputItems.md#bpy.types.NodeCompositorFileOutputItems "bpy.types.NodeCompositorFileOutputItems") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`NodeCompositorFileOutputItem`](NodeCompositorFileOutputItem.md#bpy.types.NodeCompositorFileOutputItem "bpy.types.NodeCompositorFileOutputItem"), (readonly)
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CompositorNodeOutputFile.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.CompositorNodeOutputFile.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CompositorNodeOutputFile(CompositorNode)
  + [`CompositorNodeOutputFile`](#bpy.types.CompositorNodeOutputFile)
    - [`CompositorNodeOutputFile.active_item_index`](#bpy.types.CompositorNodeOutputFile.active_item_index)
    - [`CompositorNodeOutputFile.directory`](#bpy.types.CompositorNodeOutputFile.directory)
    - [`CompositorNodeOutputFile.file_name`](#bpy.types.CompositorNodeOutputFile.file_name)
    - [`CompositorNodeOutputFile.file_output_items`](#bpy.types.CompositorNodeOutputFile.file_output_items)
