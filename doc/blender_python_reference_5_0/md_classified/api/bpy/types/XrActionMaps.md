...
# XrActionMaps(bpy\_struct)[¶](#xractionmaps-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.XrActionMaps(*bpy\_struct*)[¶](#bpy.types.XrActionMaps "Link to this definition")
:   Collection of XR action maps

    *classmethod* new(*xr\_session\_state*, *name*, *replace\_existing*)[¶](#bpy.types.XrActionMaps.new "Link to this definition")
    :   new

        Parameters:
        :   * **xr\_session\_state** ([`XrSessionState`](XrSessionState.md#bpy.types.XrSessionState "bpy.types.XrSessionState"), (never None)) – XR Session State
            * **name** (*string**,* *(**never None**)*) – Name
            * **replace\_existing** (*boolean*) – Replace Existing, Replace any existing actionmap with the same name

        Returns:
        :   Action Map, Added action map

        Return type:
        :   [`XrActionMap`](XrActionMap.md#bpy.types.XrActionMap "bpy.types.XrActionMap")

    *classmethod* new\_from\_actionmap(*xr\_session\_state*, *actionmap*)[¶](#bpy.types.XrActionMaps.new_from_actionmap "Link to this definition")
    :   new\_from\_actionmap

        Parameters:
        :   * **xr\_session\_state** ([`XrSessionState`](XrSessionState.md#bpy.types.XrSessionState "bpy.types.XrSessionState"), (never None)) – XR Session State
            * **actionmap** ([`XrActionMap`](XrActionMap.md#bpy.types.XrActionMap "bpy.types.XrActionMap"), (never None)) – Action Map, Action map to use as a reference
    ...
    *classmethod* remove(*xr\_session\_state*, *actionmap*)[¶](#bpy.types.XrActionMaps.remove "Link to this definition")
    :   remove

        Parameters:
        :   * **xr\_session\_state** ([`XrSessionState`](XrSessionState.md#bpy.types.XrSessionState "bpy.types.XrSessionState"), (never None)) – XR Session State
            * **actionmap** ([`XrActionMap`](XrActionMap.md#bpy.types.XrActionMap "bpy.types.XrActionMap"), (never None)) – Action Map, Removed action map

    *classmethod* find(*xr\_session\_state*, *name*)[¶](#bpy.types.XrActionMaps.find "Link to this definition")
    :   find
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.XrActionMaps.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.XrActionMaps.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`XrSessionState.actionmaps`](XrSessionState.md#bpy.types.XrSessionState.actionmaps "bpy.types.XrSessionState.actionmaps") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.XrActionMaps.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.XrActionMaps.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* XrActionMaps(bpy\_struct)
  + [`XrActionMaps`](#bpy.types.XrActionMaps)
    - [`XrActionMaps.new()`](#bpy.types.XrActionMaps.new)
    - [`XrActionMaps.new_from_actionmap()`](#bpy.types.XrActionMaps.new_from_actionmap)
    - [`XrActionMaps.remove()`](#bpy.types.XrActionMaps.remove)
    - [`XrActionMaps.find()`](#bpy.types.XrActionMaps.find)
    - [`XrActionMaps.bl_rna_get_subclass()`](#bpy.types.XrActionMaps.bl_rna_get_subclass)
    - [`XrActionMaps.bl_rna_get_subclass_py()`](#bpy.types.XrActionMaps.bl_rna_get_subclass_py)
