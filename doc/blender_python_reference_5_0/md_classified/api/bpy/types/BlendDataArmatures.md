...
# BlendDataArmatures(bpy\_struct)[¶](#blenddataarmatures-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.BlendDataArmatures(*bpy\_struct*)[¶](#bpy.types.BlendDataArmatures "Link to this definition")
:   Collection of armatures

    new(*name*)[¶](#bpy.types.BlendDataArmatures.new "Link to this definition")
    :   Add a new armature to the main database
        ...
        Return type:
        :   [`Armature`](Armature.md#bpy.types.Armature "bpy.types.Armature")

    remove(*armature*, *\**, *do\_unlink=True*, *do\_id\_user=True*, *do\_ui\_user=True*)[¶](#bpy.types.BlendDataArmatures.remove "Link to this definition")
    :   Remove an armature from the current blendfile

        Parameters:
        :   * **armature** ([`Armature`](Armature.md#bpy.types.Armature "bpy.types.Armature"), (never None)) – Armature to remove
            * **do\_unlink** (*boolean**,* *(**optional**)*) – Unlink all usages of this armature before deleting it (WARNING: will also delete objects instancing that armature data)
            * **do\_id\_user** (*boolean**,* *(**optional**)*) – Decrement user counter of all data-blocks used by this armature data
            * **do\_ui\_user** (*boolean**,* *(**optional**)*) – Make sure interface does not reference this armature data

    tag(*value*)[¶](#bpy.types.BlendDataArmatures.tag "Link to this definition")
    :   tag

        Parameters:
        :   **value** (*boolean*) – Value

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.BlendDataArmatures.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.BlendDataArmatures.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`BlendData.armatures`](BlendData.md#bpy.types.BlendData.armatures "bpy.types.BlendData.armatures") |  |
...
BlendDataAnnotations(bpy\_struct)](BlendDataAnnotations.md)
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.BlendDataArmatures.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.BlendDataArmatures.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* BlendDataArmatures(bpy\_struct)
  + [`BlendDataArmatures`](#bpy.types.BlendDataArmatures)
    - [`BlendDataArmatures.new()`](#bpy.types.BlendDataArmatures.new)
    - [`BlendDataArmatures.remove()`](#bpy.types.BlendDataArmatures.remove)
    - [`BlendDataArmatures.tag()`](#bpy.types.BlendDataArmatures.tag)
    - [`BlendDataArmatures.bl_rna_get_subclass()`](#bpy.types.BlendDataArmatures.bl_rna_get_subclass)
    - [`BlendDataArmatures.bl_rna_get_subclass_py()`](#bpy.types.BlendDataArmatures.bl_rna_get_subclass_py)
