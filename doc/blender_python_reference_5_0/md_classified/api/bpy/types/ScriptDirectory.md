...
# ScriptDirectory(bpy\_struct)[¶](#scriptdirectory-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.ScriptDirectory(*bpy\_struct*)[¶](#bpy.types.ScriptDirectory "Link to this definition")
:   directory[¶](#bpy.types.ScriptDirectory.directory "Link to this definition")
    ...
    name[¶](#bpy.types.ScriptDirectory.name "Link to this definition")
    :   Identifier for the Python scripts directory

        Type:
        :   string, default “”, (never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ScriptDirectory.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ScriptDirectory.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`PreferencesFilePaths.script_directories`](PreferencesFilePaths.md#bpy.types.PreferencesFilePaths.script_directories "bpy.types.PreferencesFilePaths.script_directories") * [`ScriptDirectoryCollection.new`](ScriptDirectoryCollection.md#bpy.types.ScriptDirectoryCollection.new "bpy.types.ScriptDirectoryCollection.new") | * [`ScriptDirectoryCollection.remove`](ScriptDirectoryCollection.md#bpy.types.ScriptDirectoryCollection.remove "bpy.types.ScriptDirectoryCollection.remove") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ScriptDirectory.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ScriptDirectory.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ScriptDirectory(bpy\_struct)
  + [`ScriptDirectory`](#bpy.types.ScriptDirectory)
    - [`ScriptDirectory.directory`](#bpy.types.ScriptDirectory.directory)
    - [`ScriptDirectory.name`](#bpy.types.ScriptDirectory.name)
    - [`ScriptDirectory.bl_rna_get_subclass()`](#bpy.types.ScriptDirectory.bl_rna_get_subclass)
    - [`ScriptDirectory.bl_rna_get_subclass_py()`](#bpy.types.ScriptDirectory.bl_rna_get_subclass_py)
