...
# NodeCombineBundleItem(bpy\_struct)[¶](#nodecombinebundleitem-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.NodeCombineBundleItem(*bpy\_struct*)[¶](#bpy.types.NodeCombineBundleItem "Link to this definition")
:   color[¶](#bpy.types.NodeCombineBundleItem.color "Link to this definition")
    ...
    name[¶](#bpy.types.NodeCombineBundleItem.name "Link to this definition")
    :   Type:
        :   string, default “”, (never None)

    socket\_type[¶](#bpy.types.NodeCombineBundleItem.socket_type "Link to this definition")
    :   Type:
    ...
    structure\_type[¶](#bpy.types.NodeCombineBundleItem.structure_type "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.NodeCombineBundleItem.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.NodeCombineBundleItem.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`NodeCombineBundle.bundle_items`](NodeCombineBundle.md#bpy.types.NodeCombineBundle.bundle_items "bpy.types.NodeCombineBundle.bundle_items") * [`NodeCombineBundleItems.new`](NodeCombineBundleItems.md#bpy.types.NodeCombineBundleItems.new "bpy.types.NodeCombineBundleItems.new") | * [`NodeCombineBundleItems.remove`](NodeCombineBundleItems.md#bpy.types.NodeCombineBundleItems.remove "bpy.types.NodeCombineBundleItems.remove") |
...
NodeCombineBundle(NodeInternal)](NodeCombineBundle.md)
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.NodeCombineBundleItem.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.NodeCombineBundleItem.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* NodeCombineBundleItem(bpy\_struct)
  + [`NodeCombineBundleItem`](#bpy.types.NodeCombineBundleItem)
    - [`NodeCombineBundleItem.color`](#bpy.types.NodeCombineBundleItem.color)
    - [`NodeCombineBundleItem.name`](#bpy.types.NodeCombineBundleItem.name)
    - [`NodeCombineBundleItem.socket_type`](#bpy.types.NodeCombineBundleItem.socket_type)
    - [`NodeCombineBundleItem.structure_type`](#bpy.types.NodeCombineBundleItem.structure_type)
    - [`NodeCombineBundleItem.bl_rna_get_subclass()`](#bpy.types.NodeCombineBundleItem.bl_rna_get_subclass)
    - [`NodeCombineBundleItem.bl_rna_get_subclass_py()`](#bpy.types.NodeCombineBundleItem.bl_rna_get_subclass_py)
