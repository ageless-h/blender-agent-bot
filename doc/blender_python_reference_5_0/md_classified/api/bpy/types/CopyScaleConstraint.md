...
# CopyScaleConstraint(Constraint)[¶](#copyscaleconstraint-constraint "Link to this heading")
...
*class* bpy.types.CopyScaleConstraint(*Constraint*)[¶](#bpy.types.CopyScaleConstraint "Link to this definition")
:   Copy the scale of the target

    power[¶](#bpy.types.CopyScaleConstraint.power "Link to this definition")
    :   Raise the target’s scale to the specified power

        Type:
        :   float in [-inf, inf], default 1.0

    subtarget[¶](#bpy.types.CopyScaleConstraint.subtarget "Link to this definition")
    :   Armature bone, mesh or lattice vertex group, …

        Type:
        :   string, default “”, (never None)

    target[¶](#bpy.types.CopyScaleConstraint.target "Link to this definition")
    :   Target object

        Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object")

    use\_add[¶](#bpy.types.CopyScaleConstraint.use_add "Link to this definition")
    :   Use addition instead of multiplication to combine scale (2.7 compatibility)

        Type:
        :   boolean, default False

    use\_make\_uniform[¶](#bpy.types.CopyScaleConstraint.use_make_uniform "Link to this definition")
    :   Redistribute the copied change in volume equally between the three axes of the owner

        Type:
        :   boolean, default False

    use\_offset[¶](#bpy.types.CopyScaleConstraint.use_offset "Link to this definition")
    :   Combine original scale with copied scale

        Type:
        :   boolean, default False

    use\_x[¶](#bpy.types.CopyScaleConstraint.use_x "Link to this definition")
    :   Copy the target’s X scale

        Type:
        :   boolean, default False

    use\_y[¶](#bpy.types.CopyScaleConstraint.use_y "Link to this definition")
    :   Copy the target’s Y scale

        Type:
        :   boolean, default False

    use\_z[¶](#bpy.types.CopyScaleConstraint.use_z "Link to this definition")
    :   Copy the target’s Z scale

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.CopyScaleConstraint.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.CopyScaleConstraint.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CopyScaleConstraint.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.CopyScaleConstraint.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CopyScaleConstraint(Constraint)
  + [`CopyScaleConstraint`](#bpy.types.CopyScaleConstraint)
    - [`CopyScaleConstraint.power`](#bpy.types.CopyScaleConstraint.power)
    - [`CopyScaleConstraint.subtarget`](#bpy.types.CopyScaleConstraint.subtarget)
    - [`CopyScaleConstraint.target`](#bpy.types.CopyScaleConstraint.target)
    - [`CopyScaleConstraint.use_add`](#bpy.types.CopyScaleConstraint.use_add)
    - [`CopyScaleConstraint.use_make_uniform`](#bpy.types.CopyScaleConstraint.use_make_uniform)
    - [`CopyScaleConstraint.use_offset`](#bpy.types.CopyScaleConstraint.use_offset)
    - [`CopyScaleConstraint.use_x`](#bpy.types.CopyScaleConstraint.use_x)
    - [`CopyScaleConstraint.use_y`](#bpy.types.CopyScaleConstraint.use_y)
    - [`CopyScaleConstraint.use_z`](#bpy.types.CopyScaleConstraint.use_z)
    - [`CopyScaleConstraint.bl_rna_get_subclass()`](#bpy.types.CopyScaleConstraint.bl_rna_get_subclass)
    - [`CopyScaleConstraint.bl_rna_get_subclass_py()`](#bpy.types.CopyScaleConstraint.bl_rna_get_subclass_py)
