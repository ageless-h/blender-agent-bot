...
# ArmatureConstraintTargets(bpy\_struct)[¶](#armatureconstrainttargets-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.ArmatureConstraintTargets(*bpy\_struct*)[¶](#bpy.types.ArmatureConstraintTargets "Link to this definition")
:   Collection of target bones and weights

    new()[¶](#bpy.types.ArmatureConstraintTargets.new "Link to this definition")
    :   Add a new target to the constraint
        ...
        Return type:
        :   [`ConstraintTargetBone`](ConstraintTargetBone.md#bpy.types.ConstraintTargetBone "bpy.types.ConstraintTargetBone")

    remove(*target*)[¶](#bpy.types.ArmatureConstraintTargets.remove "Link to this definition")
    :   Delete target from the constraint

        Parameters:
        :   **target** ([`ConstraintTargetBone`](ConstraintTargetBone.md#bpy.types.ConstraintTargetBone "bpy.types.ConstraintTargetBone"), (never None)) – Target to remove

    clear()[¶](#bpy.types.ArmatureConstraintTargets.clear "Link to this definition")
    :   Delete all targets from object

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ArmatureConstraintTargets.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ArmatureConstraintTargets.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`ArmatureConstraint.targets`](ArmatureConstraint.md#bpy.types.ArmatureConstraint.targets "bpy.types.ArmatureConstraint.targets") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ArmatureConstraintTargets.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ArmatureConstraintTargets.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ArmatureConstraintTargets(bpy\_struct)
  + [`ArmatureConstraintTargets`](#bpy.types.ArmatureConstraintTargets)
    - [`ArmatureConstraintTargets.new()`](#bpy.types.ArmatureConstraintTargets.new)
    - [`ArmatureConstraintTargets.remove()`](#bpy.types.ArmatureConstraintTargets.remove)
    - [`ArmatureConstraintTargets.clear()`](#bpy.types.ArmatureConstraintTargets.clear)
    - [`ArmatureConstraintTargets.bl_rna_get_subclass()`](#bpy.types.ArmatureConstraintTargets.bl_rna_get_subclass)
    - [`ArmatureConstraintTargets.bl_rna_get_subclass_py()`](#bpy.types.ArmatureConstraintTargets.bl_rna_get_subclass_py)
