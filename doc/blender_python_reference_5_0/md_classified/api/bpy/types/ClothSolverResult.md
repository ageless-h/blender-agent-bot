...
# ClothSolverResult(bpy\_struct)[¶](#clothsolverresult-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.ClothSolverResult(*bpy\_struct*)[¶](#bpy.types.ClothSolverResult "Link to this definition")
:   Result of cloth solver iteration

    avg\_error[¶](#bpy.types.ClothSolverResult.avg_error "Link to this definition")
    :   Average error during substeps

        Type:
        :   float in [-inf, inf], default 0.0, (readonly)

    avg\_iterations[¶](#bpy.types.ClothSolverResult.avg_iterations "Link to this definition")
    :   Average iterations during substeps

        Type:
        :   float in [-inf, inf], default 0.0, (readonly)

    max\_error[¶](#bpy.types.ClothSolverResult.max_error "Link to this definition")
    :   Maximum error during substeps

        Type:
        :   float in [-inf, inf], default 0.0, (readonly)

    max\_iterations[¶](#bpy.types.ClothSolverResult.max_iterations "Link to this definition")
    :   Maximum iterations during substeps

        Type:
        :   int in [-inf, inf], default 0, (readonly)

    min\_error[¶](#bpy.types.ClothSolverResult.min_error "Link to this definition")
    :   Minimum error during substeps

        Type:
        :   float in [-inf, inf], default 0.0, (readonly)

    min\_iterations[¶](#bpy.types.ClothSolverResult.min_iterations "Link to this definition")
    :   Minimum iterations during substeps

        Type:
        :   int in [-inf, inf], default 0, (readonly)

    status[¶](#bpy.types.ClothSolverResult.status "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ClothSolverResult.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ClothSolverResult.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`ClothModifier.solver_result`](ClothModifier.md#bpy.types.ClothModifier.solver_result "bpy.types.ClothModifier.solver_result") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ClothSolverResult.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ClothSolverResult.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ClothSolverResult(bpy\_struct)
  + [`ClothSolverResult`](#bpy.types.ClothSolverResult)
    - [`ClothSolverResult.avg_error`](#bpy.types.ClothSolverResult.avg_error)
    - [`ClothSolverResult.avg_iterations`](#bpy.types.ClothSolverResult.avg_iterations)
    - [`ClothSolverResult.max_error`](#bpy.types.ClothSolverResult.max_error)
    - [`ClothSolverResult.max_iterations`](#bpy.types.ClothSolverResult.max_iterations)
    - [`ClothSolverResult.min_error`](#bpy.types.ClothSolverResult.min_error)
    - [`ClothSolverResult.min_iterations`](#bpy.types.ClothSolverResult.min_iterations)
    - [`ClothSolverResult.status`](#bpy.types.ClothSolverResult.status)
    - [`ClothSolverResult.bl_rna_get_subclass()`](#bpy.types.ClothSolverResult.bl_rna_get_subclass)
    - [`ClothSolverResult.bl_rna_get_subclass_py()`](#bpy.types.ClothSolverResult.bl_rna_get_subclass_py)
