...
# LineStyleColorModifier\_DistanceFromCamera(LineStyleColorModifier)[¶](#linestylecolormodifier-distancefromcamera-linestylecolormodifier "Link to this heading")
...
*class* bpy.types.LineStyleColorModifier\_DistanceFromCamera(*LineStyleColorModifier*)[¶](#bpy.types.LineStyleColorModifier_DistanceFromCamera "Link to this definition")
:   Change line color based on the distance from the camera

    blend[¶](#bpy.types.LineStyleColorModifier_DistanceFromCamera.blend "Link to this definition")
    ...
    color\_ramp[¶](#bpy.types.LineStyleColorModifier_DistanceFromCamera.color_ramp "Link to this definition")
    :   Color ramp used to change line color

        Type:
        :   [`ColorRamp`](ColorRamp.md#bpy.types.ColorRamp "bpy.types.ColorRamp"), (readonly)

    expanded[¶](#bpy.types.LineStyleColorModifier_DistanceFromCamera.expanded "Link to this definition")
    :   True if the modifier tab is expanded

        Type:
        :   boolean, default False

    influence[¶](#bpy.types.LineStyleColorModifier_DistanceFromCamera.influence "Link to this definition")
    :   Influence factor by which the modifier changes the property

        Type:
        :   float in [0, 1], default 0.0

    range\_max[¶](#bpy.types.LineStyleColorModifier_DistanceFromCamera.range_max "Link to this definition")
    :   Upper bound of the input range the mapping is applied

        Type:
        :   float in [-inf, inf], default 0.0

    range\_min[¶](#bpy.types.LineStyleColorModifier_DistanceFromCamera.range_min "Link to this definition")
    :   Lower bound of the input range the mapping is applied

        Type:
        :   float in [-inf, inf], default 0.0

    type[¶](#bpy.types.LineStyleColorModifier_DistanceFromCamera.type "Link to this definition")
    ...
    use[¶](#bpy.types.LineStyleColorModifier_DistanceFromCamera.use "Link to this definition")
    :   Enable or disable this modifier during stroke rendering

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.LineStyleColorModifier_DistanceFromCamera.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.LineStyleColorModifier_DistanceFromCamera.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.LineStyleColorModifier_DistanceFromCamera.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.LineStyleColorModifier_DistanceFromCamera.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* LineStyleColorModifier\_DistanceFromCamera(LineStyleColorModifier)
  + [`LineStyleColorModifier_DistanceFromCamera`](#bpy.types.LineStyleColorModifier_DistanceFromCamera)
    - [`LineStyleColorModifier_DistanceFromCamera.blend`](#bpy.types.LineStyleColorModifier_DistanceFromCamera.blend)
    - [`LineStyleColorModifier_DistanceFromCamera.color_ramp`](#bpy.types.LineStyleColorModifier_DistanceFromCamera.color_ramp)
    - [`LineStyleColorModifier_DistanceFromCamera.expanded`](#bpy.types.LineStyleColorModifier_DistanceFromCamera.expanded)
    - [`LineStyleColorModifier_DistanceFromCamera.influence`](#bpy.types.LineStyleColorModifier_DistanceFromCamera.influence)
    - [`LineStyleColorModifier_DistanceFromCamera.range_max`](#bpy.types.LineStyleColorModifier_DistanceFromCamera.range_max)
    - [`LineStyleColorModifier_DistanceFromCamera.range_min`](#bpy.types.LineStyleColorModifier_DistanceFromCamera.range_min)
    - [`LineStyleColorModifier_DistanceFromCamera.type`](#bpy.types.LineStyleColorModifier_DistanceFromCamera.type)
    - [`LineStyleColorModifier_DistanceFromCamera.use`](#bpy.types.LineStyleColorModifier_DistanceFromCamera.use)
    - [`LineStyleColorModifier_DistanceFromCamera.bl_rna_get_subclass()`](#bpy.types.LineStyleColorModifier_DistanceFromCamera.bl_rna_get_subclass)
    - [`LineStyleColorModifier_DistanceFromCamera.bl_rna_get_subclass_py()`](#bpy.types.LineStyleColorModifier_DistanceFromCamera.bl_rna_get_subclass_py)
