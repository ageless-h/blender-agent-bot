...
# FCurveSample(bpy\_struct)[¶](#fcurvesample-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.FCurveSample(*bpy\_struct*)[¶](#bpy.types.FCurveSample "Link to this definition")
:   Sample point for F-Curve

    co[¶](#bpy.types.FCurveSample.co "Link to this definition")
    :   Point coordinates

        Type:
        :   [`mathutils.Vector`](../../mathutils/index.md#mathutils.Vector "mathutils.Vector") of 2 items in [-inf, inf], default (0.0, 0.0)

    select[¶](#bpy.types.FCurveSample.select "Link to this definition")
    :   Selection status

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.FCurveSample.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.FCurveSample.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`FCurve.sampled_points`](FCurve.md#bpy.types.FCurve.sampled_points "bpy.types.FCurve.sampled_points") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.FCurveSample.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.FCurveSample.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* FCurveSample(bpy\_struct)
  + [`FCurveSample`](#bpy.types.FCurveSample)
    - [`FCurveSample.co`](#bpy.types.FCurveSample.co)
    - [`FCurveSample.select`](#bpy.types.FCurveSample.select)
    - [`FCurveSample.bl_rna_get_subclass()`](#bpy.types.FCurveSample.bl_rna_get_subclass)
    - [`FCurveSample.bl_rna_get_subclass_py()`](#bpy.types.FCurveSample.bl_rna_get_subclass_py)
