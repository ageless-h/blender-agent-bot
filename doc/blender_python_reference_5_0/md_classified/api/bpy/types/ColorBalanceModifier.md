...
# ColorBalanceModifier(StripModifier)[¶](#colorbalancemodifier-stripmodifier "Link to this heading")
...
*class* bpy.types.ColorBalanceModifier(*StripModifier*)[¶](#bpy.types.ColorBalanceModifier "Link to this definition")
:   Color balance modifier for sequence strip

    color\_balance[¶](#bpy.types.ColorBalanceModifier.color_balance "Link to this definition")
    :   Type:
        :   [`StripColorBalanceData`](StripColorBalanceData.md#bpy.types.StripColorBalanceData "bpy.types.StripColorBalanceData"), (readonly)

    color\_multiply[¶](#bpy.types.ColorBalanceModifier.color_multiply "Link to this definition")
    :   Multiply the intensity of each pixel

        Type:
        :   float in [0, 20], default 1.0

    open\_mask\_input\_panel[¶](#bpy.types.ColorBalanceModifier.open_mask_input_panel "Link to this definition")
    :   Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ColorBalanceModifier.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ColorBalanceModifier.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ColorBalanceModifier.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ColorBalanceModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ColorBalanceModifier(StripModifier)
  + [`ColorBalanceModifier`](#bpy.types.ColorBalanceModifier)
    - [`ColorBalanceModifier.color_balance`](#bpy.types.ColorBalanceModifier.color_balance)
    - [`ColorBalanceModifier.color_multiply`](#bpy.types.ColorBalanceModifier.color_multiply)
    - [`ColorBalanceModifier.open_mask_input_panel`](#bpy.types.ColorBalanceModifier.open_mask_input_panel)
    - [`ColorBalanceModifier.bl_rna_get_subclass()`](#bpy.types.ColorBalanceModifier.bl_rna_get_subclass)
    - [`ColorBalanceModifier.bl_rna_get_subclass_py()`](#bpy.types.ColorBalanceModifier.bl_rna_get_subclass_py)
