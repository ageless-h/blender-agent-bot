...
# AnimVizMotionPaths(bpy\_struct)[¶](#animvizmotionpaths-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.AnimVizMotionPaths(*bpy\_struct*)[¶](#bpy.types.AnimVizMotionPaths "Link to this definition")
:   Motion Path settings for animation visualization

    bake\_location[¶](#bpy.types.AnimVizMotionPaths.bake_location "Link to this definition")
    :   When calculating Bone Paths, use Head or Tips

        Type:
        :   enum in [Motionpath Bake Location Items](../../../appendix/bpy_types_enum_items/motionpath_bake_location_items.md#rna-enum-motionpath-bake-location-items), default `'TAILS'`

    frame\_after[¶](#bpy.types.AnimVizMotionPaths.frame_after "Link to this definition")
    :   Number of frames to show after the current frame (only for ‘Around Frame’ Onion-skinning method)

        Type:
        :   int in [1, 524287], default 0

    frame\_before[¶](#bpy.types.AnimVizMotionPaths.frame_before "Link to this definition")
    :   Number of frames to show before the current frame (only for ‘Around Frame’ Onion-skinning method)

        Type:
        :   int in [1, 524287], default 0

    frame\_end[¶](#bpy.types.AnimVizMotionPaths.frame_end "Link to this definition")
    :   End frame of range of paths to display/calculate (not for ‘Around Frame’ Onion-skinning method)

        Type:
        :   int in [-inf, inf], default 0

    frame\_start[¶](#bpy.types.AnimVizMotionPaths.frame_start "Link to this definition")
    :   Starting frame of range of paths to display/calculate (not for ‘Around Frame’ Onion-skinning method)

        Type:
        :   int in [-inf, inf], default 0

    frame\_step[¶](#bpy.types.AnimVizMotionPaths.frame_step "Link to this definition")
    :   Number of frames between paths shown (not for ‘On Keyframes’ Onion-skinning method)

        Type:
        :   int in [1, 100], default 0

    has\_motion\_paths[¶](#bpy.types.AnimVizMotionPaths.has_motion_paths "Link to this definition")
    :   Are there any bone paths that will need updating (read-only)

        Type:
        :   boolean, default False, (readonly)

    range[¶](#bpy.types.AnimVizMotionPaths.range "Link to this definition")
    :   Type of range to calculate for Motion Paths

        Type:
        :   enum in [Motionpath Range Items](../../../appendix/bpy_types_enum_items/motionpath_range_items.md#rna-enum-motionpath-range-items), default `'SCENE'`

    show\_frame\_numbers[¶](#bpy.types.AnimVizMotionPaths.show_frame_numbers "Link to this definition")
    :   Show frame numbers on Motion Paths

        Type:
        :   boolean, default False

    show\_keyframe\_action\_all[¶](#bpy.types.AnimVizMotionPaths.show_keyframe_action_all "Link to this definition")
    :   For bone motion paths, search whole Action for keyframes instead of in group with matching name only (is slower)

        Type:
        :   boolean, default False

    show\_keyframe\_highlight[¶](#bpy.types.AnimVizMotionPaths.show_keyframe_highlight "Link to this definition")
    :   Emphasize position of keyframes on Motion Paths

        Type:
        :   boolean, default False

    show\_keyframe\_numbers[¶](#bpy.types.AnimVizMotionPaths.show_keyframe_numbers "Link to this definition")
    :   Show frame numbers of Keyframes on Motion Paths

        Type:
        :   boolean, default False

    type[¶](#bpy.types.AnimVizMotionPaths.type "Link to this definition")
    :   Type of range to show for Motion Paths

        Type:
        :   enum in [Motionpath Display Type Items](../../../appendix/bpy_types_enum_items/motionpath_display_type_items.md#rna-enum-motionpath-display-type-items), default `'RANGE'`

    use\_camera\_space\_bake[¶](#bpy.types.AnimVizMotionPaths.use_camera_space_bake "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.AnimVizMotionPaths.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.AnimVizMotionPaths.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`AnimViz.motion_path`](AnimViz.md#bpy.types.AnimViz.motion_path "bpy.types.AnimViz.motion_path") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.AnimVizMotionPaths.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.AnimVizMotionPaths.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* AnimVizMotionPaths(bpy\_struct)
  + [`AnimVizMotionPaths`](#bpy.types.AnimVizMotionPaths)
    - [`AnimVizMotionPaths.bake_location`](#bpy.types.AnimVizMotionPaths.bake_location)
    - [`AnimVizMotionPaths.frame_after`](#bpy.types.AnimVizMotionPaths.frame_after)
    - [`AnimVizMotionPaths.frame_before`](#bpy.types.AnimVizMotionPaths.frame_before)
    - [`AnimVizMotionPaths.frame_end`](#bpy.types.AnimVizMotionPaths.frame_end)
    - [`AnimVizMotionPaths.frame_start`](#bpy.types.AnimVizMotionPaths.frame_start)
    - [`AnimVizMotionPaths.frame_step`](#bpy.types.AnimVizMotionPaths.frame_step)
    - [`AnimVizMotionPaths.has_motion_paths`](#bpy.types.AnimVizMotionPaths.has_motion_paths)
    - [`AnimVizMotionPaths.range`](#bpy.types.AnimVizMotionPaths.range)
    - [`AnimVizMotionPaths.show_frame_numbers`](#bpy.types.AnimVizMotionPaths.show_frame_numbers)
    - [`AnimVizMotionPaths.show_keyframe_action_all`](#bpy.types.AnimVizMotionPaths.show_keyframe_action_all)
    - [`AnimVizMotionPaths.show_keyframe_highlight`](#bpy.types.AnimVizMotionPaths.show_keyframe_highlight)
    - [`AnimVizMotionPaths.show_keyframe_numbers`](#bpy.types.AnimVizMotionPaths.show_keyframe_numbers)
    - [`AnimVizMotionPaths.type`](#bpy.types.AnimVizMotionPaths.type)
    - [`AnimVizMotionPaths.use_camera_space_bake`](#bpy.types.AnimVizMotionPaths.use_camera_space_bake)
    - [`AnimVizMotionPaths.bl_rna_get_subclass()`](#bpy.types.AnimVizMotionPaths.bl_rna_get_subclass)
    - [`AnimVizMotionPaths.bl_rna_get_subclass_py()`](#bpy.types.AnimVizMotionPaths.bl_rna_get_subclass_py)
