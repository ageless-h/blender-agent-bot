...
# CacheFileLayer(bpy\_struct)[¶](#cachefilelayer-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.CacheFileLayer(*bpy\_struct*)[¶](#bpy.types.CacheFileLayer "Link to this definition")
:   Layer of the cache, used to load or override data from the first the first layer

    filepath[¶](#bpy.types.CacheFileLayer.filepath "Link to this definition")
    :   Path to the archive

        Type:
        :   string, default “”, (never None, blend relative `//` prefix supported)

    hide\_layer[¶](#bpy.types.CacheFileLayer.hide_layer "Link to this definition")
    :   Do not load data from this layer

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.CacheFileLayer.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.CacheFileLayer.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`CacheFile.layers`](CacheFile.md#bpy.types.CacheFile.layers "bpy.types.CacheFile.layers") * [`CacheFileLayers.active`](CacheFileLayers.md#bpy.types.CacheFileLayers.active "bpy.types.CacheFileLayers.active") | * [`CacheFileLayers.new`](CacheFileLayers.md#bpy.types.CacheFileLayers.new "bpy.types.CacheFileLayers.new") * [`CacheFileLayers.remove`](CacheFileLayers.md#bpy.types.CacheFileLayers.remove "bpy.types.CacheFileLayers.remove") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CacheFileLayer.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.CacheFileLayer.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CacheFileLayer(bpy\_struct)
  + [`CacheFileLayer`](#bpy.types.CacheFileLayer)
    - [`CacheFileLayer.filepath`](#bpy.types.CacheFileLayer.filepath)
    - [`CacheFileLayer.hide_layer`](#bpy.types.CacheFileLayer.hide_layer)
    - [`CacheFileLayer.bl_rna_get_subclass()`](#bpy.types.CacheFileLayer.bl_rna_get_subclass)
    - [`CacheFileLayer.bl_rna_get_subclass_py()`](#bpy.types.CacheFileLayer.bl_rna_get_subclass_py)
