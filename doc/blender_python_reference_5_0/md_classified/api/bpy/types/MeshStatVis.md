...
# MeshStatVis(bpy\_struct)[¶](#meshstatvis-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.MeshStatVis(*bpy\_struct*)[¶](#bpy.types.MeshStatVis "Link to this definition")
:   distort\_max[¶](#bpy.types.MeshStatVis.distort_max "Link to this definition")
    :   Maximum angle to display

        Type:
        :   float in [0, 3.14159], default 0.785398

    distort\_min[¶](#bpy.types.MeshStatVis.distort_min "Link to this definition")
    :   Minimum angle to display

        Type:
        :   float in [0, 3.14159], default 0.0872665

    overhang\_axis[¶](#bpy.types.MeshStatVis.overhang_axis "Link to this definition")
    :   Type:
        :   enum in [Object Axis Items](../../../appendix/bpy_types_enum_items/object_axis_items.md#rna-enum-object-axis-items), default `'NEG_Z'`

    overhang\_max[¶](#bpy.types.MeshStatVis.overhang_max "Link to this definition")
    :   Maximum angle to display

        Type:
        :   float in [0, 3.14159], default 0.785398

    overhang\_min[¶](#bpy.types.MeshStatVis.overhang_min "Link to this definition")
    :   Minimum angle to display

        Type:
        :   float in [0, 3.14159], default 0.0

    sharp\_max[¶](#bpy.types.MeshStatVis.sharp_max "Link to this definition")
    :   Maximum angle to display

        Type:
        :   float in [-3.14159, 3.14159], default 3.14159

    sharp\_min[¶](#bpy.types.MeshStatVis.sharp_min "Link to this definition")
    :   Minimum angle to display

        Type:
        :   float in [-3.14159, 3.14159], default 1.5708

    thickness\_max[¶](#bpy.types.MeshStatVis.thickness_max "Link to this definition")
    :   Maximum for measuring thickness

        Type:
        :   float in [0, 1000], default 0.1

    thickness\_min[¶](#bpy.types.MeshStatVis.thickness_min "Link to this definition")
    :   Minimum for measuring thickness

        Type:
        :   float in [0, 1000], default 0.0

    thickness\_samples[¶](#bpy.types.MeshStatVis.thickness_samples "Link to this definition")
    :   Number of samples to test per face

        Type:
        :   int in [1, 32], default 1

    type[¶](#bpy.types.MeshStatVis.type "Link to this definition")
    :   Type of data to visualize/check

        Type:
        :   enum in [`'OVERHANG'`, `'THICKNESS'`, `'INTERSECT'`, `'DISTORT'`, `'SHARP'`], default `'OVERHANG'`

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.MeshStatVis.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.MeshStatVis.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`ToolSettings.statvis`](ToolSettings.md#bpy.types.ToolSettings.statvis "bpy.types.ToolSettings.statvis") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.MeshStatVis.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.MeshStatVis.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* MeshStatVis(bpy\_struct)
  + [`MeshStatVis`](#bpy.types.MeshStatVis)
    - [`MeshStatVis.distort_max`](#bpy.types.MeshStatVis.distort_max)
    - [`MeshStatVis.distort_min`](#bpy.types.MeshStatVis.distort_min)
    - [`MeshStatVis.overhang_axis`](#bpy.types.MeshStatVis.overhang_axis)
    - [`MeshStatVis.overhang_max`](#bpy.types.MeshStatVis.overhang_max)
    - [`MeshStatVis.overhang_min`](#bpy.types.MeshStatVis.overhang_min)
    - [`MeshStatVis.sharp_max`](#bpy.types.MeshStatVis.sharp_max)
    - [`MeshStatVis.sharp_min`](#bpy.types.MeshStatVis.sharp_min)
    - [`MeshStatVis.thickness_max`](#bpy.types.MeshStatVis.thickness_max)
    - [`MeshStatVis.thickness_min`](#bpy.types.MeshStatVis.thickness_min)
    - [`MeshStatVis.thickness_samples`](#bpy.types.MeshStatVis.thickness_samples)
    - [`MeshStatVis.type`](#bpy.types.MeshStatVis.type)
    - [`MeshStatVis.bl_rna_get_subclass()`](#bpy.types.MeshStatVis.bl_rna_get_subclass)
    - [`MeshStatVis.bl_rna_get_subclass_py()`](#bpy.types.MeshStatVis.bl_rna_get_subclass_py)
