...
# Mask(ID)[¶](#mask-id "Link to this heading")

base classes — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct"), [`ID`](ID.md#bpy.types.ID "bpy.types.ID")

*class* bpy.types.Mask(*ID*)[¶](#bpy.types.Mask "Link to this definition")
:   Mask data-block defining mask for compositing

    active\_layer\_index[¶](#bpy.types.Mask.active_layer_index "Link to this definition")
    :   Index of active layer in list of all mask’s layers

        Type:
        :   int in [-inf, inf], default 0

    animation\_data[¶](#bpy.types.Mask.animation_data "Link to this definition")
    :   Animation data for this data-block

        Type:
        :   [`AnimData`](AnimData.md#bpy.types.AnimData "bpy.types.AnimData"), (readonly)

    frame\_end[¶](#bpy.types.Mask.frame_end "Link to this definition")
    :   Final frame of the mask (used for sequencer)

        Type:
        :   int in [0, 1048574], default 0

    frame\_start[¶](#bpy.types.Mask.frame_start "Link to this definition")
    :   First frame of the mask (used for sequencer)

        Type:
        :   int in [0, 1048574], default 0

    layers[¶](#bpy.types.Mask.layers "Link to this definition")
    :   Collection of layers which defines this mask

        Type:
        :   [`MaskLayers`](MaskLayers.md#bpy.types.MaskLayers "bpy.types.MaskLayers") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`MaskLayer`](MaskLayer.md#bpy.types.MaskLayer "bpy.types.MaskLayer"), (readonly)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.Mask.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.Mask.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`bpy.context.edit_mask`](../context/index.md#bpy.context.edit_mask "bpy.context.edit_mask") * [`BlendData.masks`](BlendData.md#bpy.types.BlendData.masks "bpy.types.BlendData.masks") * [`BlendDataMasks.new`](BlendDataMasks.md#bpy.types.BlendDataMasks.new "bpy.types.BlendDataMasks.new") * [`BlendDataMasks.remove`](BlendDataMasks.md#bpy.types.BlendDataMasks.remove "bpy.types.BlendDataMasks.remove") * [`CompositorNodeMask.mask`](CompositorNodeMask.md#bpy.types.CompositorNodeMask.mask "bpy.types.CompositorNodeMask.mask") * [`MaskStrip.mask`](MaskStrip.md#bpy.types.MaskStrip.mask "bpy.types.MaskStrip.mask") | * [`SpaceClipEditor.mask`](SpaceClipEditor.md#bpy.types.SpaceClipEditor.mask "bpy.types.SpaceClipEditor.mask") * [`SpaceImageEditor.mask`](SpaceImageEditor.md#bpy.types.SpaceImageEditor.mask "bpy.types.SpaceImageEditor.mask") * [`StripModifier.input_mask_id`](StripModifier.md#bpy.types.StripModifier.input_mask_id "bpy.types.StripModifier.input_mask_id") * [`StripsMeta.new_mask`](StripsMeta.md#bpy.types.StripsMeta.new_mask "bpy.types.StripsMeta.new_mask") * [`StripsTopLevel.new_mask`](StripsTopLevel.md#bpy.types.StripsTopLevel.new_mask "bpy.types.StripsTopLevel.new_mask") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.Mask.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.Mask.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* Mask(ID)
  + [`Mask`](#bpy.types.Mask)
    - [`Mask.active_layer_index`](#bpy.types.Mask.active_layer_index)
    - [`Mask.animation_data`](#bpy.types.Mask.animation_data)
    - [`Mask.frame_end`](#bpy.types.Mask.frame_end)
    - [`Mask.frame_start`](#bpy.types.Mask.frame_start)
    - [`Mask.layers`](#bpy.types.Mask.layers)
    - [`Mask.bl_rna_get_subclass()`](#bpy.types.Mask.bl_rna_get_subclass)
    - [`Mask.bl_rna_get_subclass_py()`](#bpy.types.Mask.bl_rna_get_subclass_py)
