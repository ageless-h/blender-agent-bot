...
# BlendDataHairCurves(bpy\_struct)[¶](#blenddatahaircurves-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.BlendDataHairCurves(*bpy\_struct*)[¶](#bpy.types.BlendDataHairCurves "Link to this definition")
:   Collection of hair curves

    new(*name*)[¶](#bpy.types.BlendDataHairCurves.new "Link to this definition")
    :   Add a new hair to the main database
        ...
        Return type:
        :   [`Curves`](Curves.md#bpy.types.Curves "bpy.types.Curves")

    remove(*curves*, *\**, *do\_unlink=True*, *do\_id\_user=True*, *do\_ui\_user=True*)[¶](#bpy.types.BlendDataHairCurves.remove "Link to this definition")
    :   Remove a curves data-block from the current blendfile

        Parameters:
        :   * **curves** ([`Curves`](Curves.md#bpy.types.Curves "bpy.types.Curves"), (never None)) – Curves data-block to remove
            * **do\_unlink** (*boolean**,* *(**optional**)*) – Unlink all usages of this curves before deleting it (WARNING: will also delete objects instancing that curves data)
            * **do\_id\_user** (*boolean**,* *(**optional**)*) – Decrement user counter of all data-blocks used by this curves data
            * **do\_ui\_user** (*boolean**,* *(**optional**)*) – Make sure interface does not reference this curves data

    tag(*value*)[¶](#bpy.types.BlendDataHairCurves.tag "Link to this definition")
    :   tag

        Parameters:
        :   **value** (*boolean*) – Value

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.BlendDataHairCurves.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.BlendDataHairCurves.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`BlendData.hair_curves`](BlendData.md#bpy.types.BlendData.hair_curves "bpy.types.BlendData.hair_curves") |  |
...
BlendDataGreasePencilsV3(bpy\_struct)](BlendDataGreasePencilsV3.md)
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.BlendDataHairCurves.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.BlendDataHairCurves.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* BlendDataHairCurves(bpy\_struct)
  + [`BlendDataHairCurves`](#bpy.types.BlendDataHairCurves)
    - [`BlendDataHairCurves.new()`](#bpy.types.BlendDataHairCurves.new)
    - [`BlendDataHairCurves.remove()`](#bpy.types.BlendDataHairCurves.remove)
    - [`BlendDataHairCurves.tag()`](#bpy.types.BlendDataHairCurves.tag)
    - [`BlendDataHairCurves.bl_rna_get_subclass()`](#bpy.types.BlendDataHairCurves.bl_rna_get_subclass)
    - [`BlendDataHairCurves.bl_rna_get_subclass_py()`](#bpy.types.BlendDataHairCurves.bl_rna_get_subclass_py)
