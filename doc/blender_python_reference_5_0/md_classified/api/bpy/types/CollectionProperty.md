...
# CollectionProperty(Property)[¶](#collectionproperty-property "Link to this heading")
...
*class* bpy.types.CollectionProperty(*Property*)[¶](#bpy.types.CollectionProperty "Link to this definition")
:   RNA collection property to define lists, arrays and mappings

    fixed\_type[¶](#bpy.types.CollectionProperty.fixed_type "Link to this definition")
    :   Fixed pointer type, empty if variable type

        Type:
        :   [`Struct`](Struct.md#bpy.types.Struct "bpy.types.Struct"), (readonly)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.CollectionProperty.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.CollectionProperty.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CollectionProperty.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.CollectionProperty.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CollectionProperty(Property)
  + [`CollectionProperty`](#bpy.types.CollectionProperty)
    - [`CollectionProperty.fixed_type`](#bpy.types.CollectionProperty.fixed_type)
    - [`CollectionProperty.bl_rna_get_subclass()`](#bpy.types.CollectionProperty.bl_rna_get_subclass)
    - [`CollectionProperty.bl_rna_get_subclass_py()`](#bpy.types.CollectionProperty.bl_rna_get_subclass_py)
