...
# AreaLight(Light)[¶](#arealight-light "Link to this heading")
...
*class* bpy.types.AreaLight(*Light*)[¶](#bpy.types.AreaLight "Link to this definition")
:   Directional area Light

    energy[¶](#bpy.types.AreaLight.energy "Link to this definition")
    ...
    shadow\_buffer\_clip\_start[¶](#bpy.types.AreaLight.shadow_buffer_clip_start "Link to this definition")
    :   Shadow map clip start, below which objects will not generate shadows

        Type:
        :   float in [1e-06, inf], default 0.05

    shadow\_filter\_radius[¶](#bpy.types.AreaLight.shadow_filter_radius "Link to this definition")
    :   Blur shadow aliasing using Percentage Closer Filtering

        Type:
        :   float in [0, inf], default 1.0

    shadow\_jitter\_overblur[¶](#bpy.types.AreaLight.shadow_jitter_overblur "Link to this definition")
    :   Apply shadow tracing to each jittered sample to reduce under-sampling artifacts

        Type:
        :   float in [0, 100], default 10.0

    shadow\_maximum\_resolution[¶](#bpy.types.AreaLight.shadow_maximum_resolution "Link to this definition")
    ...
    shadow\_soft\_size[¶](#bpy.types.AreaLight.shadow_soft_size "Link to this definition")
    :   Light size for ray shadow sampling (Raytraced shadows)

        Type:
        :   float in [0, inf], default 0.0

    shape[¶](#bpy.types.AreaLight.shape "Link to this definition")
    :   Shape of the area Light

        Type:
        :   enum in [`'SQUARE'`, `'RECTANGLE'`, `'DISK'`, `'ELLIPSE'`], default `'SQUARE'`

    size[¶](#bpy.types.AreaLight.size "Link to this definition")
    :   Size of the area of the area light, X direction size for rectangle shapes

        Type:
        :   float in [0, inf], default 0.25

    size\_y[¶](#bpy.types.AreaLight.size_y "Link to this definition")
    :   Size of the area of the area light in the Y direction for rectangle shapes

        Type:
        :   float in [0, inf], default 0.25

    spread[¶](#bpy.types.AreaLight.spread "Link to this definition")
    :   How widely the emitted light fans out, as in the case of a gridded softbox

        Type:
        :   float in [0, 3.14159], default 3.14159

    use\_absolute\_resolution[¶](#bpy.types.AreaLight.use_absolute_resolution "Link to this definition")
    :   Limit the resolution at 1 unit from the light origin instead of relative to the shadowed pixel

        Type:
        :   boolean, default False

    use\_shadow\_jitter[¶](#bpy.types.AreaLight.use_shadow_jitter "Link to this definition")
    ...
    inline\_shader\_nodes()[¶](#bpy.types.AreaLight.inline_shader_nodes "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.AreaLight.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.AreaLight.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.AreaLight.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.AreaLight.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* AreaLight(Light)
  + [`AreaLight`](#bpy.types.AreaLight)
    - [`AreaLight.energy`](#bpy.types.AreaLight.energy)
    - [`AreaLight.shadow_buffer_clip_start`](#bpy.types.AreaLight.shadow_buffer_clip_start)
    - [`AreaLight.shadow_filter_radius`](#bpy.types.AreaLight.shadow_filter_radius)
    - [`AreaLight.shadow_jitter_overblur`](#bpy.types.AreaLight.shadow_jitter_overblur)
    - [`AreaLight.shadow_maximum_resolution`](#bpy.types.AreaLight.shadow_maximum_resolution)
    - [`AreaLight.shadow_soft_size`](#bpy.types.AreaLight.shadow_soft_size)
    - [`AreaLight.shape`](#bpy.types.AreaLight.shape)
    - [`AreaLight.size`](#bpy.types.AreaLight.size)
    - [`AreaLight.size_y`](#bpy.types.AreaLight.size_y)
    - [`AreaLight.spread`](#bpy.types.AreaLight.spread)
    - [`AreaLight.use_absolute_resolution`](#bpy.types.AreaLight.use_absolute_resolution)
    - [`AreaLight.use_shadow_jitter`](#bpy.types.AreaLight.use_shadow_jitter)
    - [`AreaLight.inline_shader_nodes()`](#bpy.types.AreaLight.inline_shader_nodes)
    - [`AreaLight.bl_rna_get_subclass()`](#bpy.types.AreaLight.bl_rna_get_subclass)
    - [`AreaLight.bl_rna_get_subclass_py()`](#bpy.types.AreaLight.bl_rna_get_subclass_py)
