...
# ImagePackedFile(bpy\_struct)[¶](#imagepackedfile-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.ImagePackedFile(*bpy\_struct*)[¶](#bpy.types.ImagePackedFile "Link to this definition")
:   filepath[¶](#bpy.types.ImagePackedFile.filepath "Link to this definition")
    :   Type:
        :   string, default “”, (never None, blend relative `//` prefix supported)

    packed\_file[¶](#bpy.types.ImagePackedFile.packed_file "Link to this definition")
    :   Type:
        :   [`PackedFile`](PackedFile.md#bpy.types.PackedFile "bpy.types.PackedFile"), (readonly)

    tile\_number[¶](#bpy.types.ImagePackedFile.tile_number "Link to this definition")
    :   Type:
        :   int in [-inf, inf], default 0, (readonly)

    view[¶](#bpy.types.ImagePackedFile.view "Link to this definition")
    :   Type:
        :   int in [-inf, inf], default 0, (readonly)

    save()[¶](#bpy.types.ImagePackedFile.save "Link to this definition")
    :   Save the packed file to its filepath

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ImagePackedFile.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ImagePackedFile.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Image.packed_files`](Image.md#bpy.types.Image.packed_files "bpy.types.Image.packed_files") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ImagePackedFile.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ImagePackedFile.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ImagePackedFile(bpy\_struct)
  + [`ImagePackedFile`](#bpy.types.ImagePackedFile)
    - [`ImagePackedFile.filepath`](#bpy.types.ImagePackedFile.filepath)
    - [`ImagePackedFile.packed_file`](#bpy.types.ImagePackedFile.packed_file)
    - [`ImagePackedFile.tile_number`](#bpy.types.ImagePackedFile.tile_number)
    - [`ImagePackedFile.view`](#bpy.types.ImagePackedFile.view)
    - [`ImagePackedFile.save()`](#bpy.types.ImagePackedFile.save)
    - [`ImagePackedFile.bl_rna_get_subclass()`](#bpy.types.ImagePackedFile.bl_rna_get_subclass)
    - [`ImagePackedFile.bl_rna_get_subclass_py()`](#bpy.types.ImagePackedFile.bl_rna_get_subclass_py)
