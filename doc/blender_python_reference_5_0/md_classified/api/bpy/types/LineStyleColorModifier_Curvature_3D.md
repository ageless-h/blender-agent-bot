...
# LineStyleColorModifier\_Curvature\_3D(LineStyleColorModifier)[¶](#linestylecolormodifier-curvature-3d-linestylecolormodifier "Link to this heading")
...
*class* bpy.types.LineStyleColorModifier\_Curvature\_3D(*LineStyleColorModifier*)[¶](#bpy.types.LineStyleColorModifier_Curvature_3D "Link to this definition")
:   Change line color based on the radial curvature of 3D mesh surfaces

    blend[¶](#bpy.types.LineStyleColorModifier_Curvature_3D.blend "Link to this definition")
    ...
    color\_ramp[¶](#bpy.types.LineStyleColorModifier_Curvature_3D.color_ramp "Link to this definition")
    :   Color ramp used to change line color

        Type:
        :   [`ColorRamp`](ColorRamp.md#bpy.types.ColorRamp "bpy.types.ColorRamp"), (readonly)

    curvature\_max[¶](#bpy.types.LineStyleColorModifier_Curvature_3D.curvature_max "Link to this definition")
    :   Maximum Curvature

        Type:
        :   float in [-inf, inf], default 0.0

    curvature\_min[¶](#bpy.types.LineStyleColorModifier_Curvature_3D.curvature_min "Link to this definition")
    :   Minimum Curvature

        Type:
        :   float in [-inf, inf], default 0.0

    expanded[¶](#bpy.types.LineStyleColorModifier_Curvature_3D.expanded "Link to this definition")
    :   True if the modifier tab is expanded

        Type:
        :   boolean, default False

    influence[¶](#bpy.types.LineStyleColorModifier_Curvature_3D.influence "Link to this definition")
    :   Influence factor by which the modifier changes the property

        Type:
        :   float in [0, 1], default 0.0

    type[¶](#bpy.types.LineStyleColorModifier_Curvature_3D.type "Link to this definition")
    ...
    use[¶](#bpy.types.LineStyleColorModifier_Curvature_3D.use "Link to this definition")
    :   Enable or disable this modifier during stroke rendering

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.LineStyleColorModifier_Curvature_3D.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.LineStyleColorModifier_Curvature_3D.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.LineStyleColorModifier_Curvature_3D.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.LineStyleColorModifier_Curvature_3D.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* LineStyleColorModifier\_Curvature\_3D(LineStyleColorModifier)
  + [`LineStyleColorModifier_Curvature_3D`](#bpy.types.LineStyleColorModifier_Curvature_3D)
    - [`LineStyleColorModifier_Curvature_3D.blend`](#bpy.types.LineStyleColorModifier_Curvature_3D.blend)
    - [`LineStyleColorModifier_Curvature_3D.color_ramp`](#bpy.types.LineStyleColorModifier_Curvature_3D.color_ramp)
    - [`LineStyleColorModifier_Curvature_3D.curvature_max`](#bpy.types.LineStyleColorModifier_Curvature_3D.curvature_max)
    - [`LineStyleColorModifier_Curvature_3D.curvature_min`](#bpy.types.LineStyleColorModifier_Curvature_3D.curvature_min)
    - [`LineStyleColorModifier_Curvature_3D.expanded`](#bpy.types.LineStyleColorModifier_Curvature_3D.expanded)
    - [`LineStyleColorModifier_Curvature_3D.influence`](#bpy.types.LineStyleColorModifier_Curvature_3D.influence)
    - [`LineStyleColorModifier_Curvature_3D.type`](#bpy.types.LineStyleColorModifier_Curvature_3D.type)
    - [`LineStyleColorModifier_Curvature_3D.use`](#bpy.types.LineStyleColorModifier_Curvature_3D.use)
    - [`LineStyleColorModifier_Curvature_3D.bl_rna_get_subclass()`](#bpy.types.LineStyleColorModifier_Curvature_3D.bl_rna_get_subclass)
    - [`LineStyleColorModifier_Curvature_3D.bl_rna_get_subclass_py()`](#bpy.types.LineStyleColorModifier_Curvature_3D.bl_rna_get_subclass_py)
