...
# MESH\_UL\_color\_attributes(UIList)[¶](#mesh-ul-color-attributes-uilist "Link to this heading")
...
*class* bpy.types.MESH\_UL\_color\_attributes(*UIList*)[¶](#bpy.types.MESH_UL_color_attributes "Link to this definition")
:   draw\_item(*\_context*, *layout*, *data*, *attribute*, *\_icon*, *\_active\_data*, *\_active\_propname*, *\_index*)[¶](#bpy.types.MESH_UL_color_attributes.draw_item "Link to this definition")

    filter\_items(*\_context*, *data*, *property*)[¶](#bpy.types.MESH_UL_color_attributes.filter_items "Link to this definition")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.MESH_UL_color_attributes.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.MESH_UL_color_attributes.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.MESH_UL_color_attributes.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.MESH_UL_color_attributes.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* MESH\_UL\_color\_attributes(UIList)
  + [`MESH_UL_color_attributes`](#bpy.types.MESH_UL_color_attributes)
    - [`MESH_UL_color_attributes.draw_item()`](#bpy.types.MESH_UL_color_attributes.draw_item)
    - [`MESH_UL_color_attributes.filter_items()`](#bpy.types.MESH_UL_color_attributes.filter_items)
    - [`MESH_UL_color_attributes.bl_rna_get_subclass()`](#bpy.types.MESH_UL_color_attributes.bl_rna_get_subclass)
    - [`MESH_UL_color_attributes.bl_rna_get_subclass_py()`](#bpy.types.MESH_UL_color_attributes.bl_rna_get_subclass_py)
