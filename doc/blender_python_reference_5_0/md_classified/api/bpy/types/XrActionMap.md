...
# XrActionMap(bpy\_struct)[¶](#xractionmap-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.XrActionMap(*bpy\_struct*)[¶](#bpy.types.XrActionMap "Link to this definition")
:   actionmap\_items[¶](#bpy.types.XrActionMap.actionmap_items "Link to this definition")
    :   Items in the action map, mapping an XR event to an operator, pose, or haptic output

        Type:
        :   [`XrActionMapItems`](XrActionMapItems.md#bpy.types.XrActionMapItems "bpy.types.XrActionMapItems") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`XrActionMapItem`](XrActionMapItem.md#bpy.types.XrActionMapItem "bpy.types.XrActionMapItem"), (readonly)

    name[¶](#bpy.types.XrActionMap.name "Link to this definition")
    :   Name of the action map

        Type:
        :   string, default “”, (never None)

    selected\_item[¶](#bpy.types.XrActionMap.selected_item "Link to this definition")
    :   Type:
        :   int in [-32768, 32767], default 0

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.XrActionMap.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.XrActionMap.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`XrActionMaps.find`](XrActionMaps.md#bpy.types.XrActionMaps.find "bpy.types.XrActionMaps.find") * [`XrActionMaps.new`](XrActionMaps.md#bpy.types.XrActionMaps.new "bpy.types.XrActionMaps.new") * [`XrActionMaps.new_from_actionmap`](XrActionMaps.md#bpy.types.XrActionMaps.new_from_actionmap "bpy.types.XrActionMaps.new_from_actionmap") * [`XrActionMaps.new_from_actionmap`](XrActionMaps.md#bpy.types.XrActionMaps.new_from_actionmap "bpy.types.XrActionMaps.new_from_actionmap") * [`XrActionMaps.remove`](XrActionMaps.md#bpy.types.XrActionMaps.remove "bpy.types.XrActionMaps.remove") | * [`XrSessionState.action_binding_create`](XrSessionState.md#bpy.types.XrSessionState.action_binding_create "bpy.types.XrSessionState.action_binding_create") * [`XrSessionState.action_create`](XrSessionState.md#bpy.types.XrSessionState.action_create "bpy.types.XrSessionState.action_create") * [`XrSessionState.action_set_create`](XrSessionState.md#bpy.types.XrSessionState.action_set_create "bpy.types.XrSessionState.action_set_create") * [`XrSessionState.actionmaps`](XrSessionState.md#bpy.types.XrSessionState.actionmaps "bpy.types.XrSessionState.actionmaps") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.XrActionMap.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.XrActionMap.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* XrActionMap(bpy\_struct)
  + [`XrActionMap`](#bpy.types.XrActionMap)
    - [`XrActionMap.actionmap_items`](#bpy.types.XrActionMap.actionmap_items)
    - [`XrActionMap.name`](#bpy.types.XrActionMap.name)
    - [`XrActionMap.selected_item`](#bpy.types.XrActionMap.selected_item)
    - [`XrActionMap.bl_rna_get_subclass()`](#bpy.types.XrActionMap.bl_rna_get_subclass)
    - [`XrActionMap.bl_rna_get_subclass_py()`](#bpy.types.XrActionMap.bl_rna_get_subclass_py)
