...
# View3DCursor(bpy\_struct)[¶](#view3dcursor-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.View3DCursor(*bpy\_struct*)[¶](#bpy.types.View3DCursor "Link to this definition")
:   location[¶](#bpy.types.View3DCursor.location "Link to this definition")
    :   Type:
        :   [`mathutils.Vector`](../../mathutils/index.md#mathutils.Vector "mathutils.Vector") of 3 items in [-inf, inf], default (0.0, 0.0, 0.0)

    matrix[¶](#bpy.types.View3DCursor.matrix "Link to this definition")
    ...
    rotation\_axis\_angle[¶](#bpy.types.View3DCursor.rotation_axis_angle "Link to this definition")
    :   Angle of Rotation for Axis-Angle rotation representation

        Type:
        :   float array of 4 items in [-inf, inf], default (0.0, 0.0, 1.0, 0.0)

    rotation\_euler[¶](#bpy.types.View3DCursor.rotation_euler "Link to this definition")
    :   3D rotation

        Type:
        :   [`mathutils.Euler`](../../mathutils/index.md#mathutils.Euler "mathutils.Euler") rotation of 3 items in [-inf, inf], default (0.0, 0.0, 0.0)

    rotation\_mode[¶](#bpy.types.View3DCursor.rotation_mode "Link to this definition")
    ...
    rotation\_quaternion[¶](#bpy.types.View3DCursor.rotation_quaternion "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.View3DCursor.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.View3DCursor.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Scene.cursor`](Scene.md#bpy.types.Scene.cursor "bpy.types.Scene.cursor") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.View3DCursor.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.View3DCursor.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* View3DCursor(bpy\_struct)
  + [`View3DCursor`](#bpy.types.View3DCursor)
    - [`View3DCursor.location`](#bpy.types.View3DCursor.location)
    - [`View3DCursor.matrix`](#bpy.types.View3DCursor.matrix)
    - [`View3DCursor.rotation_axis_angle`](#bpy.types.View3DCursor.rotation_axis_angle)
    - [`View3DCursor.rotation_euler`](#bpy.types.View3DCursor.rotation_euler)
    - [`View3DCursor.rotation_mode`](#bpy.types.View3DCursor.rotation_mode)
    - [`View3DCursor.rotation_quaternion`](#bpy.types.View3DCursor.rotation_quaternion)
    - [`View3DCursor.bl_rna_get_subclass()`](#bpy.types.View3DCursor.bl_rna_get_subclass)
    - [`View3DCursor.bl_rna_get_subclass_py()`](#bpy.types.View3DCursor.bl_rna_get_subclass_py)
