...
# Stereo3dDisplay(bpy\_struct)[¶](#stereo3ddisplay-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.Stereo3dDisplay(*bpy\_struct*)[¶](#bpy.types.Stereo3dDisplay "Link to this definition")
:   Settings for stereo 3D display

    anaglyph\_type[¶](#bpy.types.Stereo3dDisplay.anaglyph_type "Link to this definition")
    :   Type:
    ...
    display\_mode[¶](#bpy.types.Stereo3dDisplay.display_mode "Link to this definition")
    :   Type:
        :   enum in [Stereo3D Display Items](../../../appendix/bpy_types_enum_items/stereo3d_display_items.md#rna-enum-stereo3d-display-items), default `'ANAGLYPH'`

    interlace\_type[¶](#bpy.types.Stereo3dDisplay.interlace_type "Link to this definition")
    :   Type:
    ...
    use\_interlace\_swap[¶](#bpy.types.Stereo3dDisplay.use_interlace_swap "Link to this definition")
    :   Swap left and right stereo channels

        Type:
        :   boolean, default False

    use\_sidebyside\_crosseyed[¶](#bpy.types.Stereo3dDisplay.use_sidebyside_crosseyed "Link to this definition")
    :   Right eye should see left image and vice versa

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.Stereo3dDisplay.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.Stereo3dDisplay.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Window.stereo_3d_display`](Window.md#bpy.types.Window.stereo_3d_display "bpy.types.Window.stereo_3d_display") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.Stereo3dDisplay.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.Stereo3dDisplay.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* Stereo3dDisplay(bpy\_struct)
  + [`Stereo3dDisplay`](#bpy.types.Stereo3dDisplay)
    - [`Stereo3dDisplay.anaglyph_type`](#bpy.types.Stereo3dDisplay.anaglyph_type)
    - [`Stereo3dDisplay.display_mode`](#bpy.types.Stereo3dDisplay.display_mode)
    - [`Stereo3dDisplay.interlace_type`](#bpy.types.Stereo3dDisplay.interlace_type)
    - [`Stereo3dDisplay.use_interlace_swap`](#bpy.types.Stereo3dDisplay.use_interlace_swap)
    - [`Stereo3dDisplay.use_sidebyside_crosseyed`](#bpy.types.Stereo3dDisplay.use_sidebyside_crosseyed)
    - [`Stereo3dDisplay.bl_rna_get_subclass()`](#bpy.types.Stereo3dDisplay.bl_rna_get_subclass)
    - [`Stereo3dDisplay.bl_rna_get_subclass_py()`](#bpy.types.Stereo3dDisplay.bl_rna_get_subclass_py)
