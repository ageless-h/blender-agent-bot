...
# PoseBoneConstraints(bpy\_struct)[¶](#poseboneconstraints-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.PoseBoneConstraints(*bpy\_struct*)[¶](#bpy.types.PoseBoneConstraints "Link to this definition")
:   Collection of pose bone constraints

    active[¶](#bpy.types.PoseBoneConstraints.active "Link to this definition")
    :   Active PoseChannel constraint

        Type:
        :   [`Constraint`](Constraint.md#bpy.types.Constraint "bpy.types.Constraint")

    new(*type*)[¶](#bpy.types.PoseBoneConstraints.new "Link to this definition")
    ...
    remove(*constraint*)[¶](#bpy.types.PoseBoneConstraints.remove "Link to this definition")
    ...
    move(*from\_index*, *to\_index*)[¶](#bpy.types.PoseBoneConstraints.move "Link to this definition")
    ...
    copy(*constraint*)[¶](#bpy.types.PoseBoneConstraints.copy "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.PoseBoneConstraints.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.PoseBoneConstraints.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`PoseBone.constraints`](PoseBone.md#bpy.types.PoseBone.constraints "bpy.types.PoseBone.constraints") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.PoseBoneConstraints.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.PoseBoneConstraints.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* PoseBoneConstraints(bpy\_struct)
  + [`PoseBoneConstraints`](#bpy.types.PoseBoneConstraints)
    - [`PoseBoneConstraints.active`](#bpy.types.PoseBoneConstraints.active)
    - [`PoseBoneConstraints.new()`](#bpy.types.PoseBoneConstraints.new)
    - [`PoseBoneConstraints.remove()`](#bpy.types.PoseBoneConstraints.remove)
    - [`PoseBoneConstraints.move()`](#bpy.types.PoseBoneConstraints.move)
    - [`PoseBoneConstraints.copy()`](#bpy.types.PoseBoneConstraints.copy)
    - [`PoseBoneConstraints.bl_rna_get_subclass()`](#bpy.types.PoseBoneConstraints.bl_rna_get_subclass)
    - [`PoseBoneConstraints.bl_rna_get_subclass_py()`](#bpy.types.PoseBoneConstraints.bl_rna_get_subclass_py)
