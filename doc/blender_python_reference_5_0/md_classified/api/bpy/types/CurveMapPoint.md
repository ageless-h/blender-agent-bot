...
# CurveMapPoint(bpy\_struct)[¶](#curvemappoint-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.CurveMapPoint(*bpy\_struct*)[¶](#bpy.types.CurveMapPoint "Link to this definition")
:   Point of a curve used for a curve mapping

    handle\_type[¶](#bpy.types.CurveMapPoint.handle_type "Link to this definition")
    :   Curve interpolation at this point: Bézier or vector

        Type:
        :   enum in [`'AUTO'`, `'AUTO_CLAMPED'`, `'VECTOR'`], default `'AUTO'`

    location[¶](#bpy.types.CurveMapPoint.location "Link to this definition")
    ...
    select[¶](#bpy.types.CurveMapPoint.select "Link to this definition")
    :   Selection state of the curve point

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.CurveMapPoint.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.CurveMapPoint.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`CurveMap.points`](CurveMap.md#bpy.types.CurveMap.points "bpy.types.CurveMap.points") * [`CurveMapPoints.new`](CurveMapPoints.md#bpy.types.CurveMapPoints.new "bpy.types.CurveMapPoints.new") | * [`CurveMapPoints.remove`](CurveMapPoints.md#bpy.types.CurveMapPoints.remove "bpy.types.CurveMapPoints.remove") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CurveMapPoint.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.CurveMapPoint.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CurveMapPoint(bpy\_struct)
  + [`CurveMapPoint`](#bpy.types.CurveMapPoint)
    - [`CurveMapPoint.handle_type`](#bpy.types.CurveMapPoint.handle_type)
    - [`CurveMapPoint.location`](#bpy.types.CurveMapPoint.location)
    - [`CurveMapPoint.select`](#bpy.types.CurveMapPoint.select)
    - [`CurveMapPoint.bl_rna_get_subclass()`](#bpy.types.CurveMapPoint.bl_rna_get_subclass)
    - [`CurveMapPoint.bl_rna_get_subclass_py()`](#bpy.types.CurveMapPoint.bl_rna_get_subclass_py)
