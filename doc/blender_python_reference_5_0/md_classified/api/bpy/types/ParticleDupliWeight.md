...
# ParticleDupliWeight(bpy\_struct)[¶](#particledupliweight-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.ParticleDupliWeight(*bpy\_struct*)[¶](#bpy.types.ParticleDupliWeight "Link to this definition")
:   Weight of a particle instance object in a collection

    count[¶](#bpy.types.ParticleDupliWeight.count "Link to this definition")
    :   The number of times this object is repeated with respect to other objects

        Type:
        :   int in [0, 32767], default 0

    name[¶](#bpy.types.ParticleDupliWeight.name "Link to this definition")
    :   Particle instance object name

        Type:
        :   string, default “”, (readonly, never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ParticleDupliWeight.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ParticleDupliWeight.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`ParticleSettings.active_instanceweight`](ParticleSettings.md#bpy.types.ParticleSettings.active_instanceweight "bpy.types.ParticleSettings.active_instanceweight") | * [`ParticleSettings.instance_weights`](ParticleSettings.md#bpy.types.ParticleSettings.instance_weights "bpy.types.ParticleSettings.instance_weights") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ParticleDupliWeight.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ParticleDupliWeight.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ParticleDupliWeight(bpy\_struct)
  + [`ParticleDupliWeight`](#bpy.types.ParticleDupliWeight)
    - [`ParticleDupliWeight.count`](#bpy.types.ParticleDupliWeight.count)
    - [`ParticleDupliWeight.name`](#bpy.types.ParticleDupliWeight.name)
    - [`ParticleDupliWeight.bl_rna_get_subclass()`](#bpy.types.ParticleDupliWeight.bl_rna_get_subclass)
    - [`ParticleDupliWeight.bl_rna_get_subclass_py()`](#bpy.types.ParticleDupliWeight.bl_rna_get_subclass_py)
