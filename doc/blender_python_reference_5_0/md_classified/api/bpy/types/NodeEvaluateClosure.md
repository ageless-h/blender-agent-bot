...
# NodeEvaluateClosure(NodeInternal)[¶](#nodeevaluateclosure-nodeinternal "Link to this heading")
...
*class* bpy.types.NodeEvaluateClosure(*NodeInternal*)[¶](#bpy.types.NodeEvaluateClosure "Link to this definition")
:   Execute a given closure

    active\_input\_index[¶](#bpy.types.NodeEvaluateClosure.active_input_index "Link to this definition")
    :   Index of the active item

        Type:
        :   int in [0, inf], default 0

    active\_output\_index[¶](#bpy.types.NodeEvaluateClosure.active_output_index "Link to this definition")
    :   Index of the active item

        Type:
        :   int in [0, inf], default 0

    define\_signature[¶](#bpy.types.NodeEvaluateClosure.define_signature "Link to this definition")
    :   This node defines a closure signature that should be used by other nodes

        Type:
        :   boolean, default False

    input\_items[¶](#bpy.types.NodeEvaluateClosure.input_items "Link to this definition")
    :   Type:
        :   [`NodeEvaluateClosureInputItems`](NodeEvaluateClosureInputItems.md#bpy.types.NodeEvaluateClosureInputItems "bpy.types.NodeEvaluateClosureInputItems") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`NodeEvaluateClosureInputItem`](NodeEvaluateClosureInputItem.md#bpy.types.NodeEvaluateClosureInputItem "bpy.types.NodeEvaluateClosureInputItem"), (readonly)

    output\_items[¶](#bpy.types.NodeEvaluateClosure.output_items "Link to this definition")
    :   Type:
        :   [`NodeEvaluateClosureOutputItems`](NodeEvaluateClosureOutputItems.md#bpy.types.NodeEvaluateClosureOutputItems "bpy.types.NodeEvaluateClosureOutputItems") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`NodeEvaluateClosureOutputItem`](NodeEvaluateClosureOutputItem.md#bpy.types.NodeEvaluateClosureOutputItem "bpy.types.NodeEvaluateClosureOutputItem"), (readonly)

    *classmethod* is\_registered\_node\_type()[¶](#bpy.types.NodeEvaluateClosure.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[¶](#bpy.types.NodeEvaluateClosure.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[¶](#bpy.types.NodeEvaluateClosure.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.NodeEvaluateClosure.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.NodeEvaluateClosure.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.NodeEvaluateClosure.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.NodeEvaluateClosure.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* NodeEvaluateClosure(NodeInternal)
  + [`NodeEvaluateClosure`](#bpy.types.NodeEvaluateClosure)
    - [`NodeEvaluateClosure.active_input_index`](#bpy.types.NodeEvaluateClosure.active_input_index)
    - [`NodeEvaluateClosure.active_output_index`](#bpy.types.NodeEvaluateClosure.active_output_index)
    - [`NodeEvaluateClosure.define_signature`](#bpy.types.NodeEvaluateClosure.define_signature)
    - [`NodeEvaluateClosure.input_items`](#bpy.types.NodeEvaluateClosure.input_items)
    - [`NodeEvaluateClosure.output_items`](#bpy.types.NodeEvaluateClosure.output_items)
    - [`NodeEvaluateClosure.is_registered_node_type()`](#bpy.types.NodeEvaluateClosure.is_registered_node_type)
    - [`NodeEvaluateClosure.input_template()`](#bpy.types.NodeEvaluateClosure.input_template)
    - [`NodeEvaluateClosure.output_template()`](#bpy.types.NodeEvaluateClosure.output_template)
    - [`NodeEvaluateClosure.bl_rna_get_subclass()`](#bpy.types.NodeEvaluateClosure.bl_rna_get_subclass)
    - [`NodeEvaluateClosure.bl_rna_get_subclass_py()`](#bpy.types.NodeEvaluateClosure.bl_rna_get_subclass_py)
