...
# DistortedNoiseTexture(Texture)[¶](#distortednoisetexture-texture "Link to this heading")
...
*class* bpy.types.DistortedNoiseTexture(*Texture*)[¶](#bpy.types.DistortedNoiseTexture "Link to this definition")
:   Procedural distorted noise texture

    distortion[¶](#bpy.types.DistortedNoiseTexture.distortion "Link to this definition")
    :   Amount of distortion

        Type:
        :   float in [0, 10], default 1.0

    nabla[¶](#bpy.types.DistortedNoiseTexture.nabla "Link to this definition")
    :   Size of derivative offset used for calculating normal

        Type:
        :   float in [0.001, 0.1], default 0.025

    noise\_basis[¶](#bpy.types.DistortedNoiseTexture.noise_basis "Link to this definition")
    ...
    noise\_distortion[¶](#bpy.types.DistortedNoiseTexture.noise_distortion "Link to this definition")
    ...
    noise\_scale[¶](#bpy.types.DistortedNoiseTexture.noise_scale "Link to this definition")
    :   Scaling for noise input

        Type:
        :   float in [0.0001, inf], default 0.25

    users\_material[¶](#bpy.types.DistortedNoiseTexture.users_material "Link to this definition")
    ...
    users\_object\_modifier[¶](#bpy.types.DistortedNoiseTexture.users_object_modifier "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.DistortedNoiseTexture.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.DistortedNoiseTexture.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.DistortedNoiseTexture.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.DistortedNoiseTexture.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* DistortedNoiseTexture(Texture)
  + [`DistortedNoiseTexture`](#bpy.types.DistortedNoiseTexture)
    - [`DistortedNoiseTexture.distortion`](#bpy.types.DistortedNoiseTexture.distortion)
    - [`DistortedNoiseTexture.nabla`](#bpy.types.DistortedNoiseTexture.nabla)
    - [`DistortedNoiseTexture.noise_basis`](#bpy.types.DistortedNoiseTexture.noise_basis)
    - [`DistortedNoiseTexture.noise_distortion`](#bpy.types.DistortedNoiseTexture.noise_distortion)
    - [`DistortedNoiseTexture.noise_scale`](#bpy.types.DistortedNoiseTexture.noise_scale)
    - [`DistortedNoiseTexture.users_material`](#bpy.types.DistortedNoiseTexture.users_material)
    - [`DistortedNoiseTexture.users_object_modifier`](#bpy.types.DistortedNoiseTexture.users_object_modifier)
    - [`DistortedNoiseTexture.bl_rna_get_subclass()`](#bpy.types.DistortedNoiseTexture.bl_rna_get_subclass)
    - [`DistortedNoiseTexture.bl_rna_get_subclass_py()`](#bpy.types.DistortedNoiseTexture.bl_rna_get_subclass_py)
