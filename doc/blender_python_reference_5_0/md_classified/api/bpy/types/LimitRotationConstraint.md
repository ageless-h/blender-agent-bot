...
# LimitRotationConstraint(Constraint)[¶](#limitrotationconstraint-constraint "Link to this heading")
...
*class* bpy.types.LimitRotationConstraint(*Constraint*)[¶](#bpy.types.LimitRotationConstraint "Link to this definition")
:   Limit the rotation of the constrained object

    euler\_order[¶](#bpy.types.LimitRotationConstraint.euler_order "Link to this definition")
    ...
    max\_x[¶](#bpy.types.LimitRotationConstraint.max_x "Link to this definition")
    :   Upper X angle bound

        Type:
        :   float in [-1000, 1000], default 0.0

    max\_y[¶](#bpy.types.LimitRotationConstraint.max_y "Link to this definition")
    :   Upper Y angle bound

        Type:
        :   float in [-1000, 1000], default 0.0

    max\_z[¶](#bpy.types.LimitRotationConstraint.max_z "Link to this definition")
    :   Upper Z angle bound

        Type:
        :   float in [-1000, 1000], default 0.0

    min\_x[¶](#bpy.types.LimitRotationConstraint.min_x "Link to this definition")
    :   Lower X angle bound

        Type:
        :   float in [-1000, 1000], default 0.0

    min\_y[¶](#bpy.types.LimitRotationConstraint.min_y "Link to this definition")
    :   Lower Y angle bound

        Type:
        :   float in [-1000, 1000], default 0.0

    min\_z[¶](#bpy.types.LimitRotationConstraint.min_z "Link to this definition")
    :   Lower Z angle bound

        Type:
        :   float in [-1000, 1000], default 0.0

    use\_legacy\_behavior[¶](#bpy.types.LimitRotationConstraint.use_legacy_behavior "Link to this definition")
    :   Use the old semi-broken behavior that does not understand that rotations loop around

        Type:
        :   boolean, default False

    use\_limit\_x[¶](#bpy.types.LimitRotationConstraint.use_limit_x "Link to this definition")
    :   Use the minimum X value

        Type:
        :   boolean, default False

    use\_limit\_y[¶](#bpy.types.LimitRotationConstraint.use_limit_y "Link to this definition")
    :   Use the minimum Y value

        Type:
        :   boolean, default False

    use\_limit\_z[¶](#bpy.types.LimitRotationConstraint.use_limit_z "Link to this definition")
    :   Use the minimum Z value

        Type:
        :   boolean, default False

    use\_transform\_limit[¶](#bpy.types.LimitRotationConstraint.use_transform_limit "Link to this definition")
    :   Transform tools are affected by this constraint as well

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.LimitRotationConstraint.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.LimitRotationConstraint.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.LimitRotationConstraint.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.LimitRotationConstraint.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* LimitRotationConstraint(Constraint)
  + [`LimitRotationConstraint`](#bpy.types.LimitRotationConstraint)
    - [`LimitRotationConstraint.euler_order`](#bpy.types.LimitRotationConstraint.euler_order)
    - [`LimitRotationConstraint.max_x`](#bpy.types.LimitRotationConstraint.max_x)
    - [`LimitRotationConstraint.max_y`](#bpy.types.LimitRotationConstraint.max_y)
    - [`LimitRotationConstraint.max_z`](#bpy.types.LimitRotationConstraint.max_z)
    - [`LimitRotationConstraint.min_x`](#bpy.types.LimitRotationConstraint.min_x)
    - [`LimitRotationConstraint.min_y`](#bpy.types.LimitRotationConstraint.min_y)
    - [`LimitRotationConstraint.min_z`](#bpy.types.LimitRotationConstraint.min_z)
    - [`LimitRotationConstraint.use_legacy_behavior`](#bpy.types.LimitRotationConstraint.use_legacy_behavior)
    - [`LimitRotationConstraint.use_limit_x`](#bpy.types.LimitRotationConstraint.use_limit_x)
    - [`LimitRotationConstraint.use_limit_y`](#bpy.types.LimitRotationConstraint.use_limit_y)
    - [`LimitRotationConstraint.use_limit_z`](#bpy.types.LimitRotationConstraint.use_limit_z)
    - [`LimitRotationConstraint.use_transform_limit`](#bpy.types.LimitRotationConstraint.use_transform_limit)
    - [`LimitRotationConstraint.bl_rna_get_subclass()`](#bpy.types.LimitRotationConstraint.bl_rna_get_subclass)
    - [`LimitRotationConstraint.bl_rna_get_subclass_py()`](#bpy.types.LimitRotationConstraint.bl_rna_get_subclass_py)
