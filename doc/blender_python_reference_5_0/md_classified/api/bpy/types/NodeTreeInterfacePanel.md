...
# NodeTreeInterfacePanel(NodeTreeInterfaceItem)[¶](#nodetreeinterfacepanel-nodetreeinterfaceitem "Link to this heading")
...
*class* bpy.types.NodeTreeInterfacePanel(*NodeTreeInterfaceItem*)[¶](#bpy.types.NodeTreeInterfacePanel "Link to this definition")
:   Declaration of a node panel

    default\_closed[¶](#bpy.types.NodeTreeInterfacePanel.default_closed "Link to this definition")
    :   Panel is closed by default on new nodes

        Type:
        :   boolean, default False

    description[¶](#bpy.types.NodeTreeInterfacePanel.description "Link to this definition")
    :   Panel description

        Type:
        :   string, default “”, (never None)

    interface\_items[¶](#bpy.types.NodeTreeInterfacePanel.interface_items "Link to this definition")
    ...
    name[¶](#bpy.types.NodeTreeInterfacePanel.name "Link to this definition")
    :   Panel name

        Type:
        :   string, default “”, (never None)

    persistent\_uid[¶](#bpy.types.NodeTreeInterfacePanel.persistent_uid "Link to this definition")
    :   Unique identifier for this panel within this node tree

        Type:
        :   int in [-inf, inf], default 0, (readonly)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.NodeTreeInterfacePanel.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.NodeTreeInterfacePanel.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`NodeTreeInterface.move_to_parent`](NodeTreeInterface.md#bpy.types.NodeTreeInterface.move_to_parent "bpy.types.NodeTreeInterface.move_to_parent") * [`NodeTreeInterface.new_panel`](NodeTreeInterface.md#bpy.types.NodeTreeInterface.new_panel "bpy.types.NodeTreeInterface.new_panel") | * [`NodeTreeInterface.new_socket`](NodeTreeInterface.md#bpy.types.NodeTreeInterface.new_socket "bpy.types.NodeTreeInterface.new_socket") * [`NodeTreeInterfaceItem.parent`](NodeTreeInterfaceItem.md#bpy.types.NodeTreeInterfaceItem.parent "bpy.types.NodeTreeInterfaceItem.parent") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.NodeTreeInterfacePanel.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.NodeTreeInterfacePanel.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* NodeTreeInterfacePanel(NodeTreeInterfaceItem)
  + [`NodeTreeInterfacePanel`](#bpy.types.NodeTreeInterfacePanel)
    - [`NodeTreeInterfacePanel.default_closed`](#bpy.types.NodeTreeInterfacePanel.default_closed)
    - [`NodeTreeInterfacePanel.description`](#bpy.types.NodeTreeInterfacePanel.description)
    - [`NodeTreeInterfacePanel.interface_items`](#bpy.types.NodeTreeInterfacePanel.interface_items)
    - [`NodeTreeInterfacePanel.name`](#bpy.types.NodeTreeInterfacePanel.name)
    - [`NodeTreeInterfacePanel.persistent_uid`](#bpy.types.NodeTreeInterfacePanel.persistent_uid)
    - [`NodeTreeInterfacePanel.bl_rna_get_subclass()`](#bpy.types.NodeTreeInterfacePanel.bl_rna_get_subclass)
    - [`NodeTreeInterfacePanel.bl_rna_get_subclass_py()`](#bpy.types.NodeTreeInterfacePanel.bl_rna_get_subclass_py)
