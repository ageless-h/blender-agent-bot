...
# BlendDataTextures(bpy\_struct)[¶](#blenddatatextures-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.BlendDataTextures(*bpy\_struct*)[¶](#bpy.types.BlendDataTextures "Link to this definition")
:   Collection of textures

    new(*name*, *type*)[¶](#bpy.types.BlendDataTextures.new "Link to this definition")
    :   Add a new texture to the main database

        Parameters:
        :   * **name** (*string**,* *(**never None**)*) – New name for the data-block
            * **type** (enum in [Texture Type Items](../../../appendix/bpy_types_enum_items/texture_type_items.md#rna-enum-texture-type-items)) – Type, The type of texture to add
    ...
    remove(*texture*, *\**, *do\_unlink=True*, *do\_id\_user=True*, *do\_ui\_user=True*)[¶](#bpy.types.BlendDataTextures.remove "Link to this definition")
    :   Remove a texture from the current blendfile

        Parameters:
        :   * **texture** ([`Texture`](Texture.md#bpy.types.Texture "bpy.types.Texture"), (never None)) – Texture to remove
            * **do\_unlink** (*boolean**,* *(**optional**)*) – Unlink all usages of this texture before deleting it
            * **do\_id\_user** (*boolean**,* *(**optional**)*) – Decrement user counter of all data-blocks used by this texture
            * **do\_ui\_user** (*boolean**,* *(**optional**)*) – Make sure interface does not reference this texture

    tag(*value*)[¶](#bpy.types.BlendDataTextures.tag "Link to this definition")
    :   tag

        Parameters:
        :   **value** (*boolean*) – Value

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.BlendDataTextures.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.BlendDataTextures.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`BlendData.textures`](BlendData.md#bpy.types.BlendData.textures "bpy.types.BlendData.textures") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.BlendDataTextures.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.BlendDataTextures.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* BlendDataTextures(bpy\_struct)
  + [`BlendDataTextures`](#bpy.types.BlendDataTextures)
    - [`BlendDataTextures.new()`](#bpy.types.BlendDataTextures.new)
    - [`BlendDataTextures.remove()`](#bpy.types.BlendDataTextures.remove)
    - [`BlendDataTextures.tag()`](#bpy.types.BlendDataTextures.tag)
    - [`BlendDataTextures.bl_rna_get_subclass()`](#bpy.types.BlendDataTextures.bl_rna_get_subclass)
    - [`BlendDataTextures.bl_rna_get_subclass_py()`](#bpy.types.BlendDataTextures.bl_rna_get_subclass_py)
