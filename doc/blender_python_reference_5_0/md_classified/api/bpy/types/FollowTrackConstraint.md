...
# FollowTrackConstraint(Constraint)[¶](#followtrackconstraint-constraint "Link to this heading")
...
*class* bpy.types.FollowTrackConstraint(*Constraint*)[¶](#bpy.types.FollowTrackConstraint "Link to this definition")
:   Lock motion to the target motion track

    camera[¶](#bpy.types.FollowTrackConstraint.camera "Link to this definition")
    :   Camera to which motion is parented (if empty active scene camera is used)

        Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object")

    clip[¶](#bpy.types.FollowTrackConstraint.clip "Link to this definition")
    :   Movie Clip to get tracking data from

        Type:
        :   [`MovieClip`](MovieClip.md#bpy.types.MovieClip "bpy.types.MovieClip")

    depth\_object[¶](#bpy.types.FollowTrackConstraint.depth_object "Link to this definition")
    :   Object used to define depth in camera space by projecting onto surface of this object

        Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object")

    frame\_method[¶](#bpy.types.FollowTrackConstraint.frame_method "Link to this definition")
    :   How the footage fits in the camera frame

        Type:
        :   enum in [`'STRETCH'`, `'FIT'`, `'CROP'`], default `'STRETCH'`

    object[¶](#bpy.types.FollowTrackConstraint.object "Link to this definition")
    :   Movie tracking object to follow (if empty, camera object is used)

        Type:
        :   string, default “”, (never None)

    track[¶](#bpy.types.FollowTrackConstraint.track "Link to this definition")
    :   Movie tracking track to follow

        Type:
        :   string, default “”, (never None)

    use\_3d\_position[¶](#bpy.types.FollowTrackConstraint.use_3d_position "Link to this definition")
    :   Use 3D position of track to parent to

        Type:
        :   boolean, default False

    use\_active\_clip[¶](#bpy.types.FollowTrackConstraint.use_active_clip "Link to this definition")
    :   Use active clip defined in scene

        Type:
        :   boolean, default False

    use\_undistorted\_position[¶](#bpy.types.FollowTrackConstraint.use_undistorted_position "Link to this definition")
    :   Parent to undistorted position of 2D track

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.FollowTrackConstraint.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.FollowTrackConstraint.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
ForeachGeometryElementGenerationItem(bpy\_struct)](ForeachGeometryElementGenerationItem.md)
[Previous
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.FollowTrackConstraint.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.FollowTrackConstraint.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* FollowTrackConstraint(Constraint)
  + [`FollowTrackConstraint`](#bpy.types.FollowTrackConstraint)
    - [`FollowTrackConstraint.camera`](#bpy.types.FollowTrackConstraint.camera)
    - [`FollowTrackConstraint.clip`](#bpy.types.FollowTrackConstraint.clip)
    - [`FollowTrackConstraint.depth_object`](#bpy.types.FollowTrackConstraint.depth_object)
    - [`FollowTrackConstraint.frame_method`](#bpy.types.FollowTrackConstraint.frame_method)
    - [`FollowTrackConstraint.object`](#bpy.types.FollowTrackConstraint.object)
    - [`FollowTrackConstraint.track`](#bpy.types.FollowTrackConstraint.track)
    - [`FollowTrackConstraint.use_3d_position`](#bpy.types.FollowTrackConstraint.use_3d_position)
    - [`FollowTrackConstraint.use_active_clip`](#bpy.types.FollowTrackConstraint.use_active_clip)
    - [`FollowTrackConstraint.use_undistorted_position`](#bpy.types.FollowTrackConstraint.use_undistorted_position)
    - [`FollowTrackConstraint.bl_rna_get_subclass()`](#bpy.types.FollowTrackConstraint.bl_rna_get_subclass)
    - [`FollowTrackConstraint.bl_rna_get_subclass_py()`](#bpy.types.FollowTrackConstraint.bl_rna_get_subclass_py)
