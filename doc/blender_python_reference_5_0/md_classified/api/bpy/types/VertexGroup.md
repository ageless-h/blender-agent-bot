...
# VertexGroup(bpy\_struct)[¶](#vertexgroup-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.VertexGroup(*bpy\_struct*)[¶](#bpy.types.VertexGroup "Link to this definition")
:   Group of vertices, used for armature deform and other purposes

    index[¶](#bpy.types.VertexGroup.index "Link to this definition")
    :   Index number of the vertex group

        Type:
        :   int in [0, inf], default 0, (readonly)

    lock\_weight[¶](#bpy.types.VertexGroup.lock_weight "Link to this definition")
    :   Maintain the relative weights for the group

        Type:
        :   boolean, default False

    name[¶](#bpy.types.VertexGroup.name "Link to this definition")
    :   Vertex group name

        Type:
        :   string, default “”, (never None)

    add(*index*, *weight*, *type*)[¶](#bpy.types.VertexGroup.add "Link to this definition")
    ...
    remove(*index*)[¶](#bpy.types.VertexGroup.remove "Link to this definition")
    :   Remove vertices from the group

        Parameters:
        :   **index** (*int array* *of* *1 items in* *[**-inf**,* *inf**]*) – List of indices

    weight(*index*)[¶](#bpy.types.VertexGroup.weight "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.VertexGroup.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.VertexGroup.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Object.vertex_groups`](Object.md#bpy.types.Object.vertex_groups "bpy.types.Object.vertex_groups") * [`VertexGroups.active`](VertexGroups.md#bpy.types.VertexGroups.active "bpy.types.VertexGroups.active") | * [`VertexGroups.new`](VertexGroups.md#bpy.types.VertexGroups.new "bpy.types.VertexGroups.new") * [`VertexGroups.remove`](VertexGroups.md#bpy.types.VertexGroups.remove "bpy.types.VertexGroups.remove") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.VertexGroup.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.VertexGroup.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* VertexGroup(bpy\_struct)
  + [`VertexGroup`](#bpy.types.VertexGroup)
    - [`VertexGroup.index`](#bpy.types.VertexGroup.index)
    - [`VertexGroup.lock_weight`](#bpy.types.VertexGroup.lock_weight)
    - [`VertexGroup.name`](#bpy.types.VertexGroup.name)
    - [`VertexGroup.add()`](#bpy.types.VertexGroup.add)
    - [`VertexGroup.remove()`](#bpy.types.VertexGroup.remove)
    - [`VertexGroup.weight()`](#bpy.types.VertexGroup.weight)
    - [`VertexGroup.bl_rna_get_subclass()`](#bpy.types.VertexGroup.bl_rna_get_subclass)
    - [`VertexGroup.bl_rna_get_subclass_py()`](#bpy.types.VertexGroup.bl_rna_get_subclass_py)
