...
# TransformOrientation(bpy\_struct)[¶](#transformorientation-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.TransformOrientation(*bpy\_struct*)[¶](#bpy.types.TransformOrientation "Link to this definition")
:   matrix[¶](#bpy.types.TransformOrientation.matrix "Link to this definition")
    :   Type:
    ...
    name[¶](#bpy.types.TransformOrientation.name "Link to this definition")
    :   Name of the custom transform orientation

        Type:
        :   string, default “”, (never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.TransformOrientation.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.TransformOrientation.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`TransformOrientationSlot.custom_orientation`](TransformOrientationSlot.md#bpy.types.TransformOrientationSlot.custom_orientation "bpy.types.TransformOrientationSlot.custom_orientation") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.TransformOrientation.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.TransformOrientation.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* TransformOrientation(bpy\_struct)
  + [`TransformOrientation`](#bpy.types.TransformOrientation)
    - [`TransformOrientation.matrix`](#bpy.types.TransformOrientation.matrix)
    - [`TransformOrientation.name`](#bpy.types.TransformOrientation.name)
    - [`TransformOrientation.bl_rna_get_subclass()`](#bpy.types.TransformOrientation.bl_rna_get_subclass)
    - [`TransformOrientation.bl_rna_get_subclass_py()`](#bpy.types.TransformOrientation.bl_rna_get_subclass_py)
