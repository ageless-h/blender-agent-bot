...
# MovieTrackingPlaneMarker(bpy\_struct)[¶](#movietrackingplanemarker-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.MovieTrackingPlaneMarker(*bpy\_struct*)[¶](#bpy.types.MovieTrackingPlaneMarker "Link to this definition")
:   Match-moving plane marker data for tracking

    corners[¶](#bpy.types.MovieTrackingPlaneMarker.corners "Link to this definition")
    ...
    frame[¶](#bpy.types.MovieTrackingPlaneMarker.frame "Link to this definition")
    :   Frame number marker is keyframed on

        Type:
        :   int in [-inf, inf], default 0

    mute[¶](#bpy.types.MovieTrackingPlaneMarker.mute "Link to this definition")
    :   Is marker muted for current frame

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.MovieTrackingPlaneMarker.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.MovieTrackingPlaneMarker.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`MovieTrackingPlaneMarkers.find_frame`](MovieTrackingPlaneMarkers.md#bpy.types.MovieTrackingPlaneMarkers.find_frame "bpy.types.MovieTrackingPlaneMarkers.find_frame") * [`MovieTrackingPlaneMarkers.insert_frame`](MovieTrackingPlaneMarkers.md#bpy.types.MovieTrackingPlaneMarkers.insert_frame "bpy.types.MovieTrackingPlaneMarkers.insert_frame") | * [`MovieTrackingPlaneTrack.markers`](MovieTrackingPlaneTrack.md#bpy.types.MovieTrackingPlaneTrack.markers "bpy.types.MovieTrackingPlaneTrack.markers") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.MovieTrackingPlaneMarker.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.MovieTrackingPlaneMarker.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* MovieTrackingPlaneMarker(bpy\_struct)
  + [`MovieTrackingPlaneMarker`](#bpy.types.MovieTrackingPlaneMarker)
    - [`MovieTrackingPlaneMarker.corners`](#bpy.types.MovieTrackingPlaneMarker.corners)
    - [`MovieTrackingPlaneMarker.frame`](#bpy.types.MovieTrackingPlaneMarker.frame)
    - [`MovieTrackingPlaneMarker.mute`](#bpy.types.MovieTrackingPlaneMarker.mute)
    - [`MovieTrackingPlaneMarker.bl_rna_get_subclass()`](#bpy.types.MovieTrackingPlaneMarker.bl_rna_get_subclass)
    - [`MovieTrackingPlaneMarker.bl_rna_get_subclass_py()`](#bpy.types.MovieTrackingPlaneMarker.bl_rna_get_subclass_py)
