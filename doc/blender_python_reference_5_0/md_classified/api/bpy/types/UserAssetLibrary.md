...
# UserAssetLibrary(bpy\_struct)[¶](#userassetlibrary-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.UserAssetLibrary(*bpy\_struct*)[¶](#bpy.types.UserAssetLibrary "Link to this definition")
:   Settings to define a reusable library for Asset Browsers to use

    import\_method[¶](#bpy.types.UserAssetLibrary.import_method "Link to this definition")
    ...
    name[¶](#bpy.types.UserAssetLibrary.name "Link to this definition")
    :   Identifier (not necessarily unique) for the asset library

        Type:
        :   string, default “”, (never None)

    path[¶](#bpy.types.UserAssetLibrary.path "Link to this definition")
    :   Path to a directory with .blend files to use as an asset library

        Type:
        :   string, default “”, (never None)

    use\_relative\_path[¶](#bpy.types.UserAssetLibrary.use_relative_path "Link to this definition")
    :   Use relative path when linking assets from this asset library

        Type:
        :   boolean, default True

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.UserAssetLibrary.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.UserAssetLibrary.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`AssetLibraryCollection.new`](AssetLibraryCollection.md#bpy.types.AssetLibraryCollection.new "bpy.types.AssetLibraryCollection.new") * [`AssetLibraryCollection.remove`](AssetLibraryCollection.md#bpy.types.AssetLibraryCollection.remove "bpy.types.AssetLibraryCollection.remove") | * [`PreferencesFilePaths.asset_libraries`](PreferencesFilePaths.md#bpy.types.PreferencesFilePaths.asset_libraries "bpy.types.PreferencesFilePaths.asset_libraries") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.UserAssetLibrary.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.UserAssetLibrary.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* UserAssetLibrary(bpy\_struct)
  + [`UserAssetLibrary`](#bpy.types.UserAssetLibrary)
    - [`UserAssetLibrary.import_method`](#bpy.types.UserAssetLibrary.import_method)
    - [`UserAssetLibrary.name`](#bpy.types.UserAssetLibrary.name)
    - [`UserAssetLibrary.path`](#bpy.types.UserAssetLibrary.path)
    - [`UserAssetLibrary.use_relative_path`](#bpy.types.UserAssetLibrary.use_relative_path)
    - [`UserAssetLibrary.bl_rna_get_subclass()`](#bpy.types.UserAssetLibrary.bl_rna_get_subclass)
    - [`UserAssetLibrary.bl_rna_get_subclass_py()`](#bpy.types.UserAssetLibrary.bl_rna_get_subclass_py)
