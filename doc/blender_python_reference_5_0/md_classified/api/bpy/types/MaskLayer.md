...
# MaskLayer(bpy\_struct)[¶](#masklayer-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.MaskLayer(*bpy\_struct*)[¶](#bpy.types.MaskLayer "Link to this definition")
:   Single layer used for masking pixels

    alpha[¶](#bpy.types.MaskLayer.alpha "Link to this definition")
    :   Render Opacity

        Type:
        :   float in [-inf, inf], default 0.0

    blend[¶](#bpy.types.MaskLayer.blend "Link to this definition")
    ...
    falloff[¶](#bpy.types.MaskLayer.falloff "Link to this definition")
    ...
    hide[¶](#bpy.types.MaskLayer.hide "Link to this definition")
    :   Restrict visibility in the viewport

        Type:
        :   boolean, default False

    hide\_render[¶](#bpy.types.MaskLayer.hide_render "Link to this definition")
    :   Restrict renderability

        Type:
        :   boolean, default False

    hide\_select[¶](#bpy.types.MaskLayer.hide_select "Link to this definition")
    :   Restrict selection in the viewport

        Type:
        :   boolean, default False

    invert[¶](#bpy.types.MaskLayer.invert "Link to this definition")
    :   Invert the mask black/white

        Type:
        :   boolean, default False

    name[¶](#bpy.types.MaskLayer.name "Link to this definition")
    :   Unique name of layer

        Type:
        :   string, default “”, (never None)

    select[¶](#bpy.types.MaskLayer.select "Link to this definition")
    :   Layer is selected for editing in the Dope Sheet

        Type:
        :   boolean, default False

    splines[¶](#bpy.types.MaskLayer.splines "Link to this definition")
    :   Collection of splines which defines this layer

        Type:
        :   [`MaskSplines`](MaskSplines.md#bpy.types.MaskSplines "bpy.types.MaskSplines") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`MaskSpline`](MaskSpline.md#bpy.types.MaskSpline "bpy.types.MaskSpline"), (readonly)

    use\_fill\_holes[¶](#bpy.types.MaskLayer.use_fill_holes "Link to this definition")
    :   Calculate holes when filling overlapping curves

        Type:
        :   boolean, default False

    use\_fill\_overlap[¶](#bpy.types.MaskLayer.use_fill_overlap "Link to this definition")
    :   Calculate self intersections and overlap before filling

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.MaskLayer.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.MaskLayer.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Mask.layers`](Mask.md#bpy.types.Mask.layers "bpy.types.Mask.layers") * [`MaskLayers.active`](MaskLayers.md#bpy.types.MaskLayers.active "bpy.types.MaskLayers.active") | * [`MaskLayers.new`](MaskLayers.md#bpy.types.MaskLayers.new "bpy.types.MaskLayers.new") * [`MaskLayers.remove`](MaskLayers.md#bpy.types.MaskLayers.remove "bpy.types.MaskLayers.remove") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.MaskLayer.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.MaskLayer.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* MaskLayer(bpy\_struct)
  + [`MaskLayer`](#bpy.types.MaskLayer)
    - [`MaskLayer.alpha`](#bpy.types.MaskLayer.alpha)
    - [`MaskLayer.blend`](#bpy.types.MaskLayer.blend)
    - [`MaskLayer.falloff`](#bpy.types.MaskLayer.falloff)
    - [`MaskLayer.hide`](#bpy.types.MaskLayer.hide)
    - [`MaskLayer.hide_render`](#bpy.types.MaskLayer.hide_render)
    - [`MaskLayer.hide_select`](#bpy.types.MaskLayer.hide_select)
    - [`MaskLayer.invert`](#bpy.types.MaskLayer.invert)
    - [`MaskLayer.name`](#bpy.types.MaskLayer.name)
    - [`MaskLayer.select`](#bpy.types.MaskLayer.select)
    - [`MaskLayer.splines`](#bpy.types.MaskLayer.splines)
    - [`MaskLayer.use_fill_holes`](#bpy.types.MaskLayer.use_fill_holes)
    - [`MaskLayer.use_fill_overlap`](#bpy.types.MaskLayer.use_fill_overlap)
    - [`MaskLayer.bl_rna_get_subclass()`](#bpy.types.MaskLayer.bl_rna_get_subclass)
    - [`MaskLayer.bl_rna_get_subclass_py()`](#bpy.types.MaskLayer.bl_rna_get_subclass_py)
