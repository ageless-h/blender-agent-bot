...
# ParticleSystemModifier(Modifier)[¶](#particlesystemmodifier-modifier "Link to this heading")
...
*class* bpy.types.ParticleSystemModifier(*Modifier*)[¶](#bpy.types.ParticleSystemModifier "Link to this definition")
:   Particle system simulation modifier

    particle\_system[¶](#bpy.types.ParticleSystemModifier.particle_system "Link to this definition")
    :   Particle System that this modifier controls

        Type:
        :   [`ParticleSystem`](ParticleSystem.md#bpy.types.ParticleSystem "bpy.types.ParticleSystem"), (readonly, never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ParticleSystemModifier.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ParticleSystemModifier.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Particle.uv_on_emitter`](Particle.md#bpy.types.Particle.uv_on_emitter "bpy.types.Particle.uv_on_emitter") * [`ParticleHairKey.co_object`](ParticleHairKey.md#bpy.types.ParticleHairKey.co_object "bpy.types.ParticleHairKey.co_object") * [`ParticleHairKey.co_object_set`](ParticleHairKey.md#bpy.types.ParticleHairKey.co_object_set "bpy.types.ParticleHairKey.co_object_set") | * [`ParticleSystem.mcol_on_emitter`](ParticleSystem.md#bpy.types.ParticleSystem.mcol_on_emitter "bpy.types.ParticleSystem.mcol_on_emitter") * [`ParticleSystem.uv_on_emitter`](ParticleSystem.md#bpy.types.ParticleSystem.uv_on_emitter "bpy.types.ParticleSystem.uv_on_emitter") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ParticleSystemModifier.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ParticleSystemModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ParticleSystemModifier(Modifier)
  + [`ParticleSystemModifier`](#bpy.types.ParticleSystemModifier)
    - [`ParticleSystemModifier.particle_system`](#bpy.types.ParticleSystemModifier.particle_system)
    - [`ParticleSystemModifier.bl_rna_get_subclass()`](#bpy.types.ParticleSystemModifier.bl_rna_get_subclass)
    - [`ParticleSystemModifier.bl_rna_get_subclass_py()`](#bpy.types.ParticleSystemModifier.bl_rna_get_subclass_py)
