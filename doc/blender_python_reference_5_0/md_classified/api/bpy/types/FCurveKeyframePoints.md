...
# FCurveKeyframePoints(bpy\_struct)[¶](#fcurvekeyframepoints-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.FCurveKeyframePoints(*bpy\_struct*)[¶](#bpy.types.FCurveKeyframePoints "Link to this definition")
:   Collection of keyframe points

    insert(*frame*, *value*, *\**, *options={}*, *keyframe\_type='KEYFRAME'*)[¶](#bpy.types.FCurveKeyframePoints.insert "Link to this definition")
    :   Add a keyframe point to a F-Curve
        ...
        :   * **frame** (*float in* *[**-inf**,* *inf**]*) – X Value of this keyframe point
            ...
            * **keyframe\_type** (enum in [Beztriple Keyframe Type Items](../../../appendix/bpy_types_enum_items/beztriple_keyframe_type_items.md#rna-enum-beztriple-keyframe-type-items), (optional)) – Type of keyframe to insert

        Returns:
        :   Newly created keyframe

        Return type:
        :   [`Keyframe`](Keyframe.md#bpy.types.Keyframe "bpy.types.Keyframe")

    add(*count*)[¶](#bpy.types.FCurveKeyframePoints.add "Link to this definition")
    :   Add a keyframe point to a F-Curve

        Parameters:
        :   **count** (*int in* *[**0**,* *inf**]*) – Number, Number of points to add to the spline

    remove(*keyframe*, *\**, *fast=False*)[¶](#bpy.types.FCurveKeyframePoints.remove "Link to this definition")
    :   Remove keyframe from an F-Curve

        Parameters:
        :   * **keyframe** ([`Keyframe`](Keyframe.md#bpy.types.Keyframe "bpy.types.Keyframe"), (never None)) – Keyframe to remove
            * **fast** (*boolean**,* *(**optional**)*) – Fast, Fast keyframe removal to avoid recalculating the curve each time

    clear()[¶](#bpy.types.FCurveKeyframePoints.clear "Link to this definition")
    :   Remove all keyframes from an F-Curve

    sort()[¶](#bpy.types.FCurveKeyframePoints.sort "Link to this definition")
    :   Ensure all keyframe points are chronologically sorted

    deduplicate()[¶](#bpy.types.FCurveKeyframePoints.deduplicate "Link to this definition")
    :   Ensure there are no duplicate keys. Assumes that the points have already been sorted

    handles\_recalc()[¶](#bpy.types.FCurveKeyframePoints.handles_recalc "Link to this definition")
    :   Update handles after modifications to the keyframe points, to update things like auto-clamping

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.FCurveKeyframePoints.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.FCurveKeyframePoints.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`FCurve.keyframe_points`](FCurve.md#bpy.types.FCurve.keyframe_points "bpy.types.FCurve.keyframe_points") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.FCurveKeyframePoints.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.FCurveKeyframePoints.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* FCurveKeyframePoints(bpy\_struct)
  + [`FCurveKeyframePoints`](#bpy.types.FCurveKeyframePoints)
    - [`FCurveKeyframePoints.insert()`](#bpy.types.FCurveKeyframePoints.insert)
    - [`FCurveKeyframePoints.add()`](#bpy.types.FCurveKeyframePoints.add)
    - [`FCurveKeyframePoints.remove()`](#bpy.types.FCurveKeyframePoints.remove)
    - [`FCurveKeyframePoints.clear()`](#bpy.types.FCurveKeyframePoints.clear)
    - [`FCurveKeyframePoints.sort()`](#bpy.types.FCurveKeyframePoints.sort)
    - [`FCurveKeyframePoints.deduplicate()`](#bpy.types.FCurveKeyframePoints.deduplicate)
    - [`FCurveKeyframePoints.handles_recalc()`](#bpy.types.FCurveKeyframePoints.handles_recalc)
    - [`FCurveKeyframePoints.bl_rna_get_subclass()`](#bpy.types.FCurveKeyframePoints.bl_rna_get_subclass)
    - [`FCurveKeyframePoints.bl_rna_get_subclass_py()`](#bpy.types.FCurveKeyframePoints.bl_rna_get_subclass_py)
