...
# PaletteColors(bpy\_struct)[¶](#palettecolors-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.PaletteColors(*bpy\_struct*)[¶](#bpy.types.PaletteColors "Link to this definition")
:   Collection of palette colors

    active[¶](#bpy.types.PaletteColors.active "Link to this definition")
    :   Type:
        :   [`PaletteColor`](PaletteColor.md#bpy.types.PaletteColor "bpy.types.PaletteColor")

    new()[¶](#bpy.types.PaletteColors.new "Link to this definition")
    ...
    remove(*color*)[¶](#bpy.types.PaletteColors.remove "Link to this definition")
    :   Remove a color from the palette

        Parameters:
        :   **color** ([`PaletteColor`](PaletteColor.md#bpy.types.PaletteColor "bpy.types.PaletteColor"), (never None)) – The color to remove

    clear()[¶](#bpy.types.PaletteColors.clear "Link to this definition")
    :   Remove all colors from the palette

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.PaletteColors.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.PaletteColors.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Palette.colors`](Palette.md#bpy.types.Palette.colors "bpy.types.Palette.colors") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.PaletteColors.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.PaletteColors.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* PaletteColors(bpy\_struct)
  + [`PaletteColors`](#bpy.types.PaletteColors)
    - [`PaletteColors.active`](#bpy.types.PaletteColors.active)
    - [`PaletteColors.new()`](#bpy.types.PaletteColors.new)
    - [`PaletteColors.remove()`](#bpy.types.PaletteColors.remove)
    - [`PaletteColors.clear()`](#bpy.types.PaletteColors.clear)
    - [`PaletteColors.bl_rna_get_subclass()`](#bpy.types.PaletteColors.bl_rna_get_subclass)
    - [`PaletteColors.bl_rna_get_subclass_py()`](#bpy.types.PaletteColors.bl_rna_get_subclass_py)
