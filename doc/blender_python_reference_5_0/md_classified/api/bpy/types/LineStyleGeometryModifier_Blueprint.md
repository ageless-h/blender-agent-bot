...
# LineStyleGeometryModifier\_Blueprint(LineStyleGeometryModifier)[¶](#linestylegeometrymodifier-blueprint-linestylegeometrymodifier "Link to this heading")

base classes — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct"), [`LineStyleModifier`](LineStyleModifier.md#bpy.types.LineStyleModifier "bpy.types.LineStyleModifier"), [`LineStyleGeometryModifier`](LineStyleGeometryModifier.md#bpy.types.LineStyleGeometryModifier "bpy.types.LineStyleGeometryModifier")

*class* bpy.types.LineStyleGeometryModifier\_Blueprint(*LineStyleGeometryModifier*)[¶](#bpy.types.LineStyleGeometryModifier_Blueprint "Link to this definition")
:   Produce a blueprint using circular, elliptic, and square contour strokes

    backbone\_length[¶](#bpy.types.LineStyleGeometryModifier_Blueprint.backbone_length "Link to this definition")
    :   Amount of backbone stretching

        Type:
        :   float in [-inf, inf], default 0.0

    expanded[¶](#bpy.types.LineStyleGeometryModifier_Blueprint.expanded "Link to this definition")
    :   True if the modifier tab is expanded

        Type:
        :   boolean, default False

    random\_backbone[¶](#bpy.types.LineStyleGeometryModifier_Blueprint.random_backbone "Link to this definition")
    :   Randomness of the backbone stretching

        Type:
        :   int in [0, inf], default 0

    random\_center[¶](#bpy.types.LineStyleGeometryModifier_Blueprint.random_center "Link to this definition")
    :   Randomness of the center

        Type:
        :   int in [0, inf], default 0

    random\_radius[¶](#bpy.types.LineStyleGeometryModifier_Blueprint.random_radius "Link to this definition")
    :   Randomness of the radius

        Type:
        :   int in [0, inf], default 0

    rounds[¶](#bpy.types.LineStyleGeometryModifier_Blueprint.rounds "Link to this definition")
    :   Number of rounds in contour strokes

        Type:
        :   int in [1, 1000], default 0

    shape[¶](#bpy.types.LineStyleGeometryModifier_Blueprint.shape "Link to this definition")
    :   Select the shape of blueprint contour strokes
        ...
        * `SQUARES`
        ...
        Type:
        :   enum in [`'CIRCLES'`, `'ELLIPSES'`, `'SQUARES'`], default `'CIRCLES'`

    type[¶](#bpy.types.LineStyleGeometryModifier_Blueprint.type "Link to this definition")
    :   Type of the modifier

        Type:
        :   enum in [Linestyle Geometry Modifier Type Items](../../../appendix/bpy_types_enum_items/linestyle_geometry_modifier_type_items.md#rna-enum-linestyle-geometry-modifier-type-items), default `'2D_OFFSET'`, (readonly)

    use[¶](#bpy.types.LineStyleGeometryModifier_Blueprint.use "Link to this definition")
    :   Enable or disable this modifier during stroke rendering

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.LineStyleGeometryModifier_Blueprint.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.LineStyleGeometryModifier_Blueprint.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.LineStyleGeometryModifier_Blueprint.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.LineStyleGeometryModifier_Blueprint.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* LineStyleGeometryModifier\_Blueprint(LineStyleGeometryModifier)
  + [`LineStyleGeometryModifier_Blueprint`](#bpy.types.LineStyleGeometryModifier_Blueprint)
    - [`LineStyleGeometryModifier_Blueprint.backbone_length`](#bpy.types.LineStyleGeometryModifier_Blueprint.backbone_length)
    - [`LineStyleGeometryModifier_Blueprint.expanded`](#bpy.types.LineStyleGeometryModifier_Blueprint.expanded)
    - [`LineStyleGeometryModifier_Blueprint.random_backbone`](#bpy.types.LineStyleGeometryModifier_Blueprint.random_backbone)
    - [`LineStyleGeometryModifier_Blueprint.random_center`](#bpy.types.LineStyleGeometryModifier_Blueprint.random_center)
    - [`LineStyleGeometryModifier_Blueprint.random_radius`](#bpy.types.LineStyleGeometryModifier_Blueprint.random_radius)
    - [`LineStyleGeometryModifier_Blueprint.rounds`](#bpy.types.LineStyleGeometryModifier_Blueprint.rounds)
    - [`LineStyleGeometryModifier_Blueprint.shape`](#bpy.types.LineStyleGeometryModifier_Blueprint.shape)
    - [`LineStyleGeometryModifier_Blueprint.type`](#bpy.types.LineStyleGeometryModifier_Blueprint.type)
    - [`LineStyleGeometryModifier_Blueprint.use`](#bpy.types.LineStyleGeometryModifier_Blueprint.use)
    - [`LineStyleGeometryModifier_Blueprint.bl_rna_get_subclass()`](#bpy.types.LineStyleGeometryModifier_Blueprint.bl_rna_get_subclass)
    - [`LineStyleGeometryModifier_Blueprint.bl_rna_get_subclass_py()`](#bpy.types.LineStyleGeometryModifier_Blueprint.bl_rna_get_subclass_py)
