...
# NodeGeometryForeachGeometryElementGenerationItems(bpy\_struct)[¶](#nodegeometryforeachgeometryelementgenerationitems-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.NodeGeometryForeachGeometryElementGenerationItems(*bpy\_struct*)[¶](#bpy.types.NodeGeometryForeachGeometryElementGenerationItems "Link to this definition")
:   Collection of generation items

    new(*socket\_type*, *name*)[¶](#bpy.types.NodeGeometryForeachGeometryElementGenerationItems.new "Link to this definition")
    :   Add an item at the end

        Parameters:
        :   * **socket\_type** (enum in [Node Socket Data Type Items](../../../appendix/bpy_types_enum_items/node_socket_data_type_items.md#rna-enum-node-socket-data-type-items)) – Socket Type, Socket type of the item
        ...
        Return type:
        :   [`ForeachGeometryElementGenerationItem`](ForeachGeometryElementGenerationItem.md#bpy.types.ForeachGeometryElementGenerationItem "bpy.types.ForeachGeometryElementGenerationItem")

    remove(*item*)[¶](#bpy.types.NodeGeometryForeachGeometryElementGenerationItems.remove "Link to this definition")
    :   Remove an item

        Parameters:
        :   **item** ([`ForeachGeometryElementGenerationItem`](ForeachGeometryElementGenerationItem.md#bpy.types.ForeachGeometryElementGenerationItem "bpy.types.ForeachGeometryElementGenerationItem"), (never None)) – Item, The item to remove

    clear()[¶](#bpy.types.NodeGeometryForeachGeometryElementGenerationItems.clear "Link to this definition")
    :   Remove all items

    move(*from\_index*, *to\_index*)[¶](#bpy.types.NodeGeometryForeachGeometryElementGenerationItems.move "Link to this definition")
    :   Move an item to another position

        Parameters:
        :   * **from\_index** (*int in* *[**0**,* *inf**]*) – From Index, Index of the item to move
            * **to\_index** (*int in* *[**0**,* *inf**]*) – To Index, Target index for the item

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.NodeGeometryForeachGeometryElementGenerationItems.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.NodeGeometryForeachGeometryElementGenerationItems.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`GeometryNodeForeachGeometryElementOutput.generation_items`](GeometryNodeForeachGeometryElementOutput.md#bpy.types.GeometryNodeForeachGeometryElementOutput.generation_items "bpy.types.GeometryNodeForeachGeometryElementOutput.generation_items") |  |

[Next

NodeGeometryForeachGeometryElementInputItems(bpy\_struct)](NodeGeometryForeachGeometryElementInputItems.md)
[Previous
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.NodeGeometryForeachGeometryElementGenerationItems.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.NodeGeometryForeachGeometryElementGenerationItems.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* NodeGeometryForeachGeometryElementGenerationItems(bpy\_struct)
  + [`NodeGeometryForeachGeometryElementGenerationItems`](#bpy.types.NodeGeometryForeachGeometryElementGenerationItems)
    - [`NodeGeometryForeachGeometryElementGenerationItems.new()`](#bpy.types.NodeGeometryForeachGeometryElementGenerationItems.new)
    - [`NodeGeometryForeachGeometryElementGenerationItems.remove()`](#bpy.types.NodeGeometryForeachGeometryElementGenerationItems.remove)
    - [`NodeGeometryForeachGeometryElementGenerationItems.clear()`](#bpy.types.NodeGeometryForeachGeometryElementGenerationItems.clear)
    - [`NodeGeometryForeachGeometryElementGenerationItems.move()`](#bpy.types.NodeGeometryForeachGeometryElementGenerationItems.move)
    - [`NodeGeometryForeachGeometryElementGenerationItems.bl_rna_get_subclass()`](#bpy.types.NodeGeometryForeachGeometryElementGenerationItems.bl_rna_get_subclass)
    - [`NodeGeometryForeachGeometryElementGenerationItems.bl_rna_get_subclass_py()`](#bpy.types.NodeGeometryForeachGeometryElementGenerationItems.bl_rna_get_subclass_py)
