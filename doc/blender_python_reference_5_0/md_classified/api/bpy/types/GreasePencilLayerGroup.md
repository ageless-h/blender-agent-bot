...
# GreasePencilLayerGroup(GreasePencilTreeNode)[¶](#greasepencillayergroup-greasepenciltreenode "Link to this heading")
...
*class* bpy.types.GreasePencilLayerGroup(*GreasePencilTreeNode*)[¶](#bpy.types.GreasePencilLayerGroup "Link to this definition")
:   Group of Grease Pencil layers

    color\_tag[¶](#bpy.types.GreasePencilLayerGroup.color_tag "Link to this definition")
    :   Type:
        :   enum in [`'NONE'`, `'COLOR1'`, `'COLOR2'`, `'COLOR3'`, `'COLOR4'`, `'COLOR5'`, `'COLOR6'`, `'COLOR7'`, `'COLOR8'`], default `'COLOR1'`

    is\_expanded[¶](#bpy.types.GreasePencilLayerGroup.is_expanded "Link to this definition")
    :   The layer group is expanded in the UI

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.GreasePencilLayerGroup.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.GreasePencilLayerGroup.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`GreasePencil.layer_groups`](GreasePencil.md#bpy.types.GreasePencil.layer_groups "bpy.types.GreasePencil.layer_groups") * [`GreasePencilTreeNode.parent_group`](GreasePencilTreeNode.md#bpy.types.GreasePencilTreeNode.parent_group "bpy.types.GreasePencilTreeNode.parent_group") * [`GreasePencilv3LayerGroup.active`](GreasePencilv3LayerGroup.md#bpy.types.GreasePencilv3LayerGroup.active "bpy.types.GreasePencilv3LayerGroup.active") * [`GreasePencilv3LayerGroup.move`](GreasePencilv3LayerGroup.md#bpy.types.GreasePencilv3LayerGroup.move "bpy.types.GreasePencilv3LayerGroup.move") * [`GreasePencilv3LayerGroup.move_bottom`](GreasePencilv3LayerGroup.md#bpy.types.GreasePencilv3LayerGroup.move_bottom "bpy.types.GreasePencilv3LayerGroup.move_bottom") * [`GreasePencilv3LayerGroup.move_to_layer_group`](GreasePencilv3LayerGroup.md#bpy.types.GreasePencilv3LayerGroup.move_to_layer_group "bpy.types.GreasePencilv3LayerGroup.move_to_layer_group") * [`GreasePencilv3LayerGroup.move_to_layer_group`](GreasePencilv3LayerGroup.md#bpy.types.GreasePencilv3LayerGroup.move_to_layer_group "bpy.types.GreasePencilv3LayerGroup.move_to_layer_group") | * [`GreasePencilv3LayerGroup.move_top`](GreasePencilv3LayerGroup.md#bpy.types.GreasePencilv3LayerGroup.move_top "bpy.types.GreasePencilv3LayerGroup.move_top") * [`GreasePencilv3LayerGroup.new`](GreasePencilv3LayerGroup.md#bpy.types.GreasePencilv3LayerGroup.new "bpy.types.GreasePencilv3LayerGroup.new") * [`GreasePencilv3LayerGroup.new`](GreasePencilv3LayerGroup.md#bpy.types.GreasePencilv3LayerGroup.new "bpy.types.GreasePencilv3LayerGroup.new") * [`GreasePencilv3LayerGroup.remove`](GreasePencilv3LayerGroup.md#bpy.types.GreasePencilv3LayerGroup.remove "bpy.types.GreasePencilv3LayerGroup.remove") * [`GreasePencilv3Layers.move_to_layer_group`](GreasePencilv3Layers.md#bpy.types.GreasePencilv3Layers.move_to_layer_group "bpy.types.GreasePencilv3Layers.move_to_layer_group") * [`GreasePencilv3Layers.new`](GreasePencilv3Layers.md#bpy.types.GreasePencilv3Layers.new "bpy.types.GreasePencilv3Layers.new") |

[Next

GreasePencilLayerMask(bpy\_struct)](GreasePencilLayerMask.md)
[Previous
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GreasePencilLayerGroup.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.GreasePencilLayerGroup.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GreasePencilLayerGroup(GreasePencilTreeNode)
  + [`GreasePencilLayerGroup`](#bpy.types.GreasePencilLayerGroup)
    - [`GreasePencilLayerGroup.color_tag`](#bpy.types.GreasePencilLayerGroup.color_tag)
    - [`GreasePencilLayerGroup.is_expanded`](#bpy.types.GreasePencilLayerGroup.is_expanded)
    - [`GreasePencilLayerGroup.bl_rna_get_subclass()`](#bpy.types.GreasePencilLayerGroup.bl_rna_get_subclass)
    - [`GreasePencilLayerGroup.bl_rna_get_subclass_py()`](#bpy.types.GreasePencilLayerGroup.bl_rna_get_subclass_py)
