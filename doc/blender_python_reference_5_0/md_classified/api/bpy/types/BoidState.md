...
# BoidState(bpy\_struct)[¶](#boidstate-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.BoidState(*bpy\_struct*)[¶](#bpy.types.BoidState "Link to this definition")
:   Boid state for boid physics

    active\_boid\_rule[¶](#bpy.types.BoidState.active_boid_rule "Link to this definition")
    :   Type:
        :   [`BoidRule`](BoidRule.md#bpy.types.BoidRule "bpy.types.BoidRule"), (readonly)

    active\_boid\_rule\_index[¶](#bpy.types.BoidState.active_boid_rule_index "Link to this definition")
    :   Type:
        :   int in [0, inf], default 0

    falloff[¶](#bpy.types.BoidState.falloff "Link to this definition")
    :   Type:
        :   float in [0, 10], default 0.0

    name[¶](#bpy.types.BoidState.name "Link to this definition")
    :   Boid state name

        Type:
        :   string, default “”, (never None)

    rule\_fuzzy[¶](#bpy.types.BoidState.rule_fuzzy "Link to this definition")
    :   Type:
        :   float in [0, 1], default 0.0

    rules[¶](#bpy.types.BoidState.rules "Link to this definition")
    :   Type:
        :   [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`BoidRule`](BoidRule.md#bpy.types.BoidRule "bpy.types.BoidRule"), (readonly)

    ruleset\_type[¶](#bpy.types.BoidState.ruleset_type "Link to this definition")
    ...
    volume[¶](#bpy.types.BoidState.volume "Link to this definition")
    :   Type:
        :   float in [0, 100], default 0.0

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.BoidState.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.BoidState.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`BoidSettings.states`](BoidSettings.md#bpy.types.BoidSettings.states "bpy.types.BoidSettings.states") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.BoidState.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.BoidState.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* BoidState(bpy\_struct)
  + [`BoidState`](#bpy.types.BoidState)
    - [`BoidState.active_boid_rule`](#bpy.types.BoidState.active_boid_rule)
    - [`BoidState.active_boid_rule_index`](#bpy.types.BoidState.active_boid_rule_index)
    - [`BoidState.falloff`](#bpy.types.BoidState.falloff)
    - [`BoidState.name`](#bpy.types.BoidState.name)
    - [`BoidState.rule_fuzzy`](#bpy.types.BoidState.rule_fuzzy)
    - [`BoidState.rules`](#bpy.types.BoidState.rules)
    - [`BoidState.ruleset_type`](#bpy.types.BoidState.ruleset_type)
    - [`BoidState.volume`](#bpy.types.BoidState.volume)
    - [`BoidState.bl_rna_get_subclass()`](#bpy.types.BoidState.bl_rna_get_subclass)
    - [`BoidState.bl_rna_get_subclass_py()`](#bpy.types.BoidState.bl_rna_get_subclass_py)
