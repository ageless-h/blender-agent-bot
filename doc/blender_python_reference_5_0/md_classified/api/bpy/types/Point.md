...
# Point(bpy\_struct)[¶](#point-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.Point(*bpy\_struct*)[¶](#bpy.types.Point "Link to this definition")
:   Point in a point cloud

    co[¶](#bpy.types.Point.co "Link to this definition")
    :   Type:
        :   [`mathutils.Vector`](../../mathutils/index.md#mathutils.Vector "mathutils.Vector") of 3 items in [-inf, inf], default (0.0, 0.0, 0.0)

    index[¶](#bpy.types.Point.index "Link to this definition")
    :   Index of this point

        Type:
        :   int in [0, inf], default 0, (readonly)

    radius[¶](#bpy.types.Point.radius "Link to this definition")
    :   Type:
        :   float in [-inf, inf], default 0.0

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.Point.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.Point.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`PointCloud.points`](PointCloud.md#bpy.types.PointCloud.points "bpy.types.PointCloud.points") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.Point.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.Point.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* Point(bpy\_struct)
  + [`Point`](#bpy.types.Point)
    - [`Point.co`](#bpy.types.Point.co)
    - [`Point.index`](#bpy.types.Point.index)
    - [`Point.radius`](#bpy.types.Point.radius)
    - [`Point.bl_rna_get_subclass()`](#bpy.types.Point.bl_rna_get_subclass)
    - [`Point.bl_rna_get_subclass_py()`](#bpy.types.Point.bl_rna_get_subclass_py)
