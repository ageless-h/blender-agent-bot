...
# CacheFileLayers(bpy\_struct)[¶](#cachefilelayers-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.CacheFileLayers(*bpy\_struct*)[¶](#bpy.types.CacheFileLayers "Link to this definition")
:   Collection of cache layers

    active[¶](#bpy.types.CacheFileLayers.active "Link to this definition")
    :   Active layer of the CacheFile

        Type:
        :   [`CacheFileLayer`](CacheFileLayer.md#bpy.types.CacheFileLayer "bpy.types.CacheFileLayer")

    new(*filepath*)[¶](#bpy.types.CacheFileLayers.new "Link to this definition")
    :   Add a new layer
    ...
    remove(*layer*)[¶](#bpy.types.CacheFileLayers.remove "Link to this definition")
    :   Remove an existing layer from the cache file

        Parameters:
        :   **layer** ([`CacheFileLayer`](CacheFileLayer.md#bpy.types.CacheFileLayer "bpy.types.CacheFileLayer"), (never None)) – Layer to remove

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.CacheFileLayers.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.CacheFileLayers.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`CacheFile.layers`](CacheFile.md#bpy.types.CacheFile.layers "bpy.types.CacheFile.layers") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CacheFileLayers.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.CacheFileLayers.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CacheFileLayers(bpy\_struct)
  + [`CacheFileLayers`](#bpy.types.CacheFileLayers)
    - [`CacheFileLayers.active`](#bpy.types.CacheFileLayers.active)
    - [`CacheFileLayers.new()`](#bpy.types.CacheFileLayers.new)
    - [`CacheFileLayers.remove()`](#bpy.types.CacheFileLayers.remove)
    - [`CacheFileLayers.bl_rna_get_subclass()`](#bpy.types.CacheFileLayers.bl_rna_get_subclass)
    - [`CacheFileLayers.bl_rna_get_subclass_py()`](#bpy.types.CacheFileLayers.bl_rna_get_subclass_py)
