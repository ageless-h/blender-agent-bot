...
# NormalEditModifier(Modifier)[¶](#normaleditmodifier-modifier "Link to this heading")
...
*class* bpy.types.NormalEditModifier(*Modifier*)[¶](#bpy.types.NormalEditModifier "Link to this definition")
:   Modifier affecting/generating custom normals

    invert\_vertex\_group[¶](#bpy.types.NormalEditModifier.invert_vertex_group "Link to this definition")
    :   Invert vertex group influence

        Type:
        :   boolean, default False

    mix\_factor[¶](#bpy.types.NormalEditModifier.mix_factor "Link to this definition")
    :   How much of generated normals to mix with existing ones

        Type:
        :   float in [0, 1], default 1.0

    mix\_limit[¶](#bpy.types.NormalEditModifier.mix_limit "Link to this definition")
    :   Maximum angle between old and new normals

        Type:
        :   float in [0, 3.14159], default 3.14159

    mix\_mode[¶](#bpy.types.NormalEditModifier.mix_mode "Link to this definition")
    ...
    mode[¶](#bpy.types.NormalEditModifier.mode "Link to this definition")
    ...
    no\_polynors\_fix[¶](#bpy.types.NormalEditModifier.no_polynors_fix "Link to this definition")
    :   Do not flip polygons when their normals are not consistent with their newly computed custom vertex normals

        Type:
        :   boolean, default False

    offset[¶](#bpy.types.NormalEditModifier.offset "Link to this definition")
    ...
    target[¶](#bpy.types.NormalEditModifier.target "Link to this definition")
    :   Target object used to affect normals

        Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object")

    use\_direction\_parallel[¶](#bpy.types.NormalEditModifier.use_direction_parallel "Link to this definition")
    :   Use same direction for all normals, from origin to target’s center (Directional mode only)

        Type:
        :   boolean, default True

    vertex\_group[¶](#bpy.types.NormalEditModifier.vertex_group "Link to this definition")
    :   Vertex group name for selecting/weighting the affected areas

        Type:
        :   string, default “”, (never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.NormalEditModifier.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.NormalEditModifier.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.NormalEditModifier.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.NormalEditModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* NormalEditModifier(Modifier)
  + [`NormalEditModifier`](#bpy.types.NormalEditModifier)
    - [`NormalEditModifier.invert_vertex_group`](#bpy.types.NormalEditModifier.invert_vertex_group)
    - [`NormalEditModifier.mix_factor`](#bpy.types.NormalEditModifier.mix_factor)
    - [`NormalEditModifier.mix_limit`](#bpy.types.NormalEditModifier.mix_limit)
    - [`NormalEditModifier.mix_mode`](#bpy.types.NormalEditModifier.mix_mode)
    - [`NormalEditModifier.mode`](#bpy.types.NormalEditModifier.mode)
    - [`NormalEditModifier.no_polynors_fix`](#bpy.types.NormalEditModifier.no_polynors_fix)
    - [`NormalEditModifier.offset`](#bpy.types.NormalEditModifier.offset)
    - [`NormalEditModifier.target`](#bpy.types.NormalEditModifier.target)
    - [`NormalEditModifier.use_direction_parallel`](#bpy.types.NormalEditModifier.use_direction_parallel)
    - [`NormalEditModifier.vertex_group`](#bpy.types.NormalEditModifier.vertex_group)
    - [`NormalEditModifier.bl_rna_get_subclass()`](#bpy.types.NormalEditModifier.bl_rna_get_subclass)
    - [`NormalEditModifier.bl_rna_get_subclass_py()`](#bpy.types.NormalEditModifier.bl_rna_get_subclass_py)
