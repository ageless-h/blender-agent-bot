...
# NodesModifierDataBlock(bpy\_struct)[¶](#nodesmodifierdatablock-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.NodesModifierDataBlock(*bpy\_struct*)[¶](#bpy.types.NodesModifierDataBlock "Link to this definition")
:   id[¶](#bpy.types.NodesModifierDataBlock.id "Link to this definition")
    :   Type:
        :   [`ID`](ID.md#bpy.types.ID "bpy.types.ID")

    id\_name[¶](#bpy.types.NodesModifierDataBlock.id_name "Link to this definition")
    :   Name that is mapped to the referenced data-block

        Type:
        :   string, default “”, (readonly, never None)

    id\_type[¶](#bpy.types.NodesModifierDataBlock.id_type "Link to this definition")
    :   Type:
        :   enum in [Id Type Items](../../../appendix/bpy_types_enum_items/id_type_items.md#rna-enum-id-type-items), default `'ACTION'`, (readonly)

    lib\_name[¶](#bpy.types.NodesModifierDataBlock.lib_name "Link to this definition")
    :   Used when the data block is not local to the current .blend file but is linked from some library

        Type:
        :   string, default “”, (readonly, never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.NodesModifierDataBlock.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.NodesModifierDataBlock.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`NodesModifierBake.data_blocks`](NodesModifierBake.md#bpy.types.NodesModifierBake.data_blocks "bpy.types.NodesModifierBake.data_blocks") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.NodesModifierDataBlock.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.NodesModifierDataBlock.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* NodesModifierDataBlock(bpy\_struct)
  + [`NodesModifierDataBlock`](#bpy.types.NodesModifierDataBlock)
    - [`NodesModifierDataBlock.id`](#bpy.types.NodesModifierDataBlock.id)
    - [`NodesModifierDataBlock.id_name`](#bpy.types.NodesModifierDataBlock.id_name)
    - [`NodesModifierDataBlock.id_type`](#bpy.types.NodesModifierDataBlock.id_type)
    - [`NodesModifierDataBlock.lib_name`](#bpy.types.NodesModifierDataBlock.lib_name)
    - [`NodesModifierDataBlock.bl_rna_get_subclass()`](#bpy.types.NodesModifierDataBlock.bl_rna_get_subclass)
    - [`NodesModifierDataBlock.bl_rna_get_subclass_py()`](#bpy.types.NodesModifierDataBlock.bl_rna_get_subclass_py)
