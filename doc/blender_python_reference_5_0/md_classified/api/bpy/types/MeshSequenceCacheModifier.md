...
# MeshSequenceCacheModifier(Modifier)[¶](#meshsequencecachemodifier-modifier "Link to this heading")
...
*class* bpy.types.MeshSequenceCacheModifier(*Modifier*)[¶](#bpy.types.MeshSequenceCacheModifier "Link to this definition")
:   Cache Mesh

    cache\_file[¶](#bpy.types.MeshSequenceCacheModifier.cache_file "Link to this definition")
    :   Type:
        :   [`CacheFile`](CacheFile.md#bpy.types.CacheFile "bpy.types.CacheFile")

    object\_path[¶](#bpy.types.MeshSequenceCacheModifier.object_path "Link to this definition")
    :   Path to the object in the Alembic archive used to lookup geometric data

        Type:
        :   string, default “”, (never None)

    read\_data[¶](#bpy.types.MeshSequenceCacheModifier.read_data "Link to this definition")
    :   Data to read from the cache

        Type:
        :   enum set in {`'VERT'`, `'POLY'`, `'UV'`, `'COLOR'`, `'ATTRIBUTES'`}, default {`'ATTRIBUTES'`, `'COLOR'`, `'POLY'`, `'UV'`, `'VERT'`}

    use\_vertex\_interpolation[¶](#bpy.types.MeshSequenceCacheModifier.use_vertex_interpolation "Link to this definition")
    :   Allow interpolation of vertex positions

        Type:
        :   boolean, default True

    velocity\_scale[¶](#bpy.types.MeshSequenceCacheModifier.velocity_scale "Link to this definition")
    :   Multiplier used to control the magnitude of the velocity vectors for time effects

        Type:
        :   float in [0, inf], default 1.0

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.MeshSequenceCacheModifier.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.MeshSequenceCacheModifier.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.MeshSequenceCacheModifier.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.MeshSequenceCacheModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* MeshSequenceCacheModifier(Modifier)
  + [`MeshSequenceCacheModifier`](#bpy.types.MeshSequenceCacheModifier)
    - [`MeshSequenceCacheModifier.cache_file`](#bpy.types.MeshSequenceCacheModifier.cache_file)
    - [`MeshSequenceCacheModifier.object_path`](#bpy.types.MeshSequenceCacheModifier.object_path)
    - [`MeshSequenceCacheModifier.read_data`](#bpy.types.MeshSequenceCacheModifier.read_data)
    - [`MeshSequenceCacheModifier.use_vertex_interpolation`](#bpy.types.MeshSequenceCacheModifier.use_vertex_interpolation)
    - [`MeshSequenceCacheModifier.velocity_scale`](#bpy.types.MeshSequenceCacheModifier.velocity_scale)
    - [`MeshSequenceCacheModifier.bl_rna_get_subclass()`](#bpy.types.MeshSequenceCacheModifier.bl_rna_get_subclass)
    - [`MeshSequenceCacheModifier.bl_rna_get_subclass_py()`](#bpy.types.MeshSequenceCacheModifier.bl_rna_get_subclass_py)
