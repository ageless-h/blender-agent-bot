...
# ThemeOutliner(bpy\_struct)[¶](#themeoutliner-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.ThemeOutliner(*bpy\_struct*)[¶](#bpy.types.ThemeOutliner "Link to this definition")
:   Theme settings for the Outliner

    active[¶](#bpy.types.ThemeOutliner.active "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    active\_object[¶](#bpy.types.ThemeOutliner.active_object "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    edited\_object[¶](#bpy.types.ThemeOutliner.edited_object "Link to this definition")
    :   Type:
        :   float array of 4 items in [0, 1], default (0.0, 0.0, 0.0, 0.0)

    match[¶](#bpy.types.ThemeOutliner.match "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    row\_alternate[¶](#bpy.types.ThemeOutliner.row_alternate "Link to this definition")
    :   Overlay color on every other row

        Type:
        :   float array of 4 items in [0, 1], default (0.0, 0.0, 0.0, 0.0)

    selected\_highlight[¶](#bpy.types.ThemeOutliner.selected_highlight "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    selected\_object[¶](#bpy.types.ThemeOutliner.selected_object "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    space[¶](#bpy.types.ThemeOutliner.space "Link to this definition")
    :   Settings for space

        Type:
        :   [`ThemeSpaceGeneric`](ThemeSpaceGeneric.md#bpy.types.ThemeSpaceGeneric "bpy.types.ThemeSpaceGeneric"), (readonly, never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ThemeOutliner.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ThemeOutliner.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Theme.outliner`](Theme.md#bpy.types.Theme.outliner "bpy.types.Theme.outliner") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ThemeOutliner.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ThemeOutliner.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ThemeOutliner(bpy\_struct)
  + [`ThemeOutliner`](#bpy.types.ThemeOutliner)
    - [`ThemeOutliner.active`](#bpy.types.ThemeOutliner.active)
    - [`ThemeOutliner.active_object`](#bpy.types.ThemeOutliner.active_object)
    - [`ThemeOutliner.edited_object`](#bpy.types.ThemeOutliner.edited_object)
    - [`ThemeOutliner.match`](#bpy.types.ThemeOutliner.match)
    - [`ThemeOutliner.row_alternate`](#bpy.types.ThemeOutliner.row_alternate)
    - [`ThemeOutliner.selected_highlight`](#bpy.types.ThemeOutliner.selected_highlight)
    - [`ThemeOutliner.selected_object`](#bpy.types.ThemeOutliner.selected_object)
    - [`ThemeOutliner.space`](#bpy.types.ThemeOutliner.space)
    - [`ThemeOutliner.bl_rna_get_subclass()`](#bpy.types.ThemeOutliner.bl_rna_get_subclass)
    - [`ThemeOutliner.bl_rna_get_subclass_py()`](#bpy.types.ThemeOutliner.bl_rna_get_subclass_py)
