...
# UVProjectModifier(Modifier)[¶](#uvprojectmodifier-modifier "Link to this heading")
...
*class* bpy.types.UVProjectModifier(*Modifier*)[¶](#bpy.types.UVProjectModifier "Link to this definition")
:   UV projection modifier to set UVs from a projector

    aspect\_x[¶](#bpy.types.UVProjectModifier.aspect_x "Link to this definition")
    :   Horizontal aspect ratio (only used for camera projectors)

        Type:
        :   float in [1, inf], default 1.0

    aspect\_y[¶](#bpy.types.UVProjectModifier.aspect_y "Link to this definition")
    :   Vertical aspect ratio (only used for camera projectors)

        Type:
        :   float in [1, inf], default 1.0

    projector\_count[¶](#bpy.types.UVProjectModifier.projector_count "Link to this definition")
    :   Number of projectors to use

        Type:
        :   int in [1, 10], default 1

    projectors[¶](#bpy.types.UVProjectModifier.projectors "Link to this definition")
    :   Type:
        :   [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`UVProjector`](UVProjector.md#bpy.types.UVProjector "bpy.types.UVProjector"), (readonly)

    scale\_x[¶](#bpy.types.UVProjectModifier.scale_x "Link to this definition")
    :   Horizontal scale (only used for camera projectors)

        Type:
        :   float in [0, inf], default 1.0

    scale\_y[¶](#bpy.types.UVProjectModifier.scale_y "Link to this definition")
    :   Vertical scale (only used for camera projectors)

        Type:
        :   float in [0, inf], default 1.0

    uv\_layer[¶](#bpy.types.UVProjectModifier.uv_layer "Link to this definition")
    :   UV map name

        Type:
        :   string, default “”, (never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.UVProjectModifier.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.UVProjectModifier.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.UVProjectModifier.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.UVProjectModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* UVProjectModifier(Modifier)
  + [`UVProjectModifier`](#bpy.types.UVProjectModifier)
    - [`UVProjectModifier.aspect_x`](#bpy.types.UVProjectModifier.aspect_x)
    - [`UVProjectModifier.aspect_y`](#bpy.types.UVProjectModifier.aspect_y)
    - [`UVProjectModifier.projector_count`](#bpy.types.UVProjectModifier.projector_count)
    - [`UVProjectModifier.projectors`](#bpy.types.UVProjectModifier.projectors)
    - [`UVProjectModifier.scale_x`](#bpy.types.UVProjectModifier.scale_x)
    - [`UVProjectModifier.scale_y`](#bpy.types.UVProjectModifier.scale_y)
    - [`UVProjectModifier.uv_layer`](#bpy.types.UVProjectModifier.uv_layer)
    - [`UVProjectModifier.bl_rna_get_subclass()`](#bpy.types.UVProjectModifier.bl_rna_get_subclass)
    - [`UVProjectModifier.bl_rna_get_subclass_py()`](#bpy.types.UVProjectModifier.bl_rna_get_subclass_py)
