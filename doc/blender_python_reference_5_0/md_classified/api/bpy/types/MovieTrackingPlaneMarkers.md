...
# MovieTrackingPlaneMarkers(bpy\_struct)[¶](#movietrackingplanemarkers-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.MovieTrackingPlaneMarkers(*bpy\_struct*)[¶](#bpy.types.MovieTrackingPlaneMarkers "Link to this definition")
:   Collection of markers for movie tracking plane track

    find\_frame(*frame*, *\**, *exact=True*)[¶](#bpy.types.MovieTrackingPlaneMarkers.find_frame "Link to this definition")
    :   Get plane marker for specified frame
        ...
        Return type:
        :   [`MovieTrackingPlaneMarker`](MovieTrackingPlaneMarker.md#bpy.types.MovieTrackingPlaneMarker "bpy.types.MovieTrackingPlaneMarker")

    insert\_frame(*frame*)[¶](#bpy.types.MovieTrackingPlaneMarkers.insert_frame "Link to this definition")
    ...
    delete\_frame(*frame*)[¶](#bpy.types.MovieTrackingPlaneMarkers.delete_frame "Link to this definition")
    :   Delete plane marker at specified frame

        Parameters:
        :   **frame** (*int in* *[**0**,* *1048574**]*) – Frame, Frame number to delete plane marker from

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.MovieTrackingPlaneMarkers.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.MovieTrackingPlaneMarkers.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`MovieTrackingPlaneTrack.markers`](MovieTrackingPlaneTrack.md#bpy.types.MovieTrackingPlaneTrack.markers "bpy.types.MovieTrackingPlaneTrack.markers") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.MovieTrackingPlaneMarkers.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.MovieTrackingPlaneMarkers.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* MovieTrackingPlaneMarkers(bpy\_struct)
  + [`MovieTrackingPlaneMarkers`](#bpy.types.MovieTrackingPlaneMarkers)
    - [`MovieTrackingPlaneMarkers.find_frame()`](#bpy.types.MovieTrackingPlaneMarkers.find_frame)
    - [`MovieTrackingPlaneMarkers.insert_frame()`](#bpy.types.MovieTrackingPlaneMarkers.insert_frame)
    - [`MovieTrackingPlaneMarkers.delete_frame()`](#bpy.types.MovieTrackingPlaneMarkers.delete_frame)
    - [`MovieTrackingPlaneMarkers.bl_rna_get_subclass()`](#bpy.types.MovieTrackingPlaneMarkers.bl_rna_get_subclass)
    - [`MovieTrackingPlaneMarkers.bl_rna_get_subclass_py()`](#bpy.types.MovieTrackingPlaneMarkers.bl_rna_get_subclass_py)
