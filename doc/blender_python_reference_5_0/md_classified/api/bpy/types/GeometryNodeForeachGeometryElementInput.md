...
:   paired\_output[¶](#bpy.types.GeometryNodeForeachGeometryElementInput.paired_output "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[¶](#bpy.types.GeometryNodeForeachGeometryElementInput.output_template "Link to this definition")
    ...
    :   Pair a zone input node with an output node.
        ...
        Parameters:
        :   **output\_node** ([`NodeInternal`](NodeInternal.md#bpy.types.NodeInternal "bpy.types.NodeInternal")) – Output Node, Zone output node to pair with
