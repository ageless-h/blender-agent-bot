...
# WorldLighting(bpy\_struct)[¶](#worldlighting-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.WorldLighting(*bpy\_struct*)[¶](#bpy.types.WorldLighting "Link to this definition")
:   Lighting for a World data-block

    ao\_factor[¶](#bpy.types.WorldLighting.ao_factor "Link to this definition")
    :   Factor for ambient occlusion blending

        Type:
        :   float in [0, inf], default 1.0

    distance[¶](#bpy.types.WorldLighting.distance "Link to this definition")
    :   Length of rays, defines how far away other faces give occlusion effect

        Type:
        :   float in [0, inf], default 10.0

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.WorldLighting.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.WorldLighting.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`World.light_settings`](World.md#bpy.types.World.light_settings "bpy.types.World.light_settings") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.WorldLighting.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.WorldLighting.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* WorldLighting(bpy\_struct)
  + [`WorldLighting`](#bpy.types.WorldLighting)
    - [`WorldLighting.ao_factor`](#bpy.types.WorldLighting.ao_factor)
    - [`WorldLighting.distance`](#bpy.types.WorldLighting.distance)
    - [`WorldLighting.bl_rna_get_subclass()`](#bpy.types.WorldLighting.bl_rna_get_subclass)
    - [`WorldLighting.bl_rna_get_subclass_py()`](#bpy.types.WorldLighting.bl_rna_get_subclass_py)
