...
# SubsurfModifier(Modifier)[¶](#subsurfmodifier-modifier "Link to this heading")
...
*class* bpy.types.SubsurfModifier(*Modifier*)[¶](#bpy.types.SubsurfModifier "Link to this definition")
:   Subdivision surface modifier

    adaptive\_object\_edge\_length[¶](#bpy.types.SubsurfModifier.adaptive_object_edge_length "Link to this definition")
    :   Target object space edge length for adaptive subdivision

        Type:
        :   float in [0.0001, 1000], default 0.01

    adaptive\_pixel\_size[¶](#bpy.types.SubsurfModifier.adaptive_pixel_size "Link to this definition")
    :   Target polygon pixel size for adaptive subdivision

        Type:
        :   float in [0.1, 1000], default 1.0

    adaptive\_space[¶](#bpy.types.SubsurfModifier.adaptive_space "Link to this definition")
    ...
    boundary\_smooth[¶](#bpy.types.SubsurfModifier.boundary_smooth "Link to this definition")
    :   Controls how open boundaries are smoothed

        Type:
        :   enum in [Subdivision Boundary Smooth Items](../../../appendix/bpy_types_enum_items/subdivision_boundary_smooth_items.md#rna-enum-subdivision-boundary-smooth-items), default `'ALL'`

    levels[¶](#bpy.types.SubsurfModifier.levels "Link to this definition")
    :   Number of subdivisions to perform in the 3D viewport

        Type:
        :   int in [0, 11], default 1

    open\_adaptive\_subdivision\_panel[¶](#bpy.types.SubsurfModifier.open_adaptive_subdivision_panel "Link to this definition")
    :   Type:
        :   boolean, default False

    open\_advanced\_panel[¶](#bpy.types.SubsurfModifier.open_advanced_panel "Link to this definition")
    :   Type:
        :   boolean, default False

    quality[¶](#bpy.types.SubsurfModifier.quality "Link to this definition")
    :   Accuracy of vertex positions, lower value is faster but less precise

        Type:
        :   int in [1, 10], default 3

    render\_levels[¶](#bpy.types.SubsurfModifier.render_levels "Link to this definition")
    :   Number of subdivisions to perform when rendering

        Type:
        :   int in [0, 11], default 2

    show\_only\_control\_edges[¶](#bpy.types.SubsurfModifier.show_only_control_edges "Link to this definition")
    :   Skip displaying interior subdivided edges

        Type:
        :   boolean, default True

    subdivision\_type[¶](#bpy.types.SubsurfModifier.subdivision_type "Link to this definition")
    ...
    use\_adaptive\_subdivision[¶](#bpy.types.SubsurfModifier.use_adaptive_subdivision "Link to this definition")
    :   Adaptively subdivide mesh based on camera distance

        Type:
        :   boolean, default False

    use\_creases[¶](#bpy.types.SubsurfModifier.use_creases "Link to this definition")
    :   Use mesh crease information to sharpen edges or corners

        Type:
        :   boolean, default True

    use\_custom\_normals[¶](#bpy.types.SubsurfModifier.use_custom_normals "Link to this definition")
    :   Interpolates existing custom normals to resulting mesh

        Type:
        :   boolean, default False

    use\_limit\_surface[¶](#bpy.types.SubsurfModifier.use_limit_surface "Link to this definition")
    :   Place vertices at the surface that would be produced with infinite levels of subdivision (smoothest possible shape)

        Type:
        :   boolean, default True

    uv\_smooth[¶](#bpy.types.SubsurfModifier.uv_smooth "Link to this definition")
    :   Controls how smoothing is applied to UVs

        Type:
        :   enum in [Subdivision Uv Smooth Items](../../../appendix/bpy_types_enum_items/subdivision_uv_smooth_items.md#rna-enum-subdivision-uv-smooth-items), default `'PRESERVE_BOUNDARIES'`

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.SubsurfModifier.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.SubsurfModifier.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.SubsurfModifier.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.SubsurfModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* SubsurfModifier(Modifier)
  + [`SubsurfModifier`](#bpy.types.SubsurfModifier)
    - [`SubsurfModifier.adaptive_object_edge_length`](#bpy.types.SubsurfModifier.adaptive_object_edge_length)
    - [`SubsurfModifier.adaptive_pixel_size`](#bpy.types.SubsurfModifier.adaptive_pixel_size)
    - [`SubsurfModifier.adaptive_space`](#bpy.types.SubsurfModifier.adaptive_space)
    - [`SubsurfModifier.boundary_smooth`](#bpy.types.SubsurfModifier.boundary_smooth)
    - [`SubsurfModifier.levels`](#bpy.types.SubsurfModifier.levels)
    - [`SubsurfModifier.open_adaptive_subdivision_panel`](#bpy.types.SubsurfModifier.open_adaptive_subdivision_panel)
    - [`SubsurfModifier.open_advanced_panel`](#bpy.types.SubsurfModifier.open_advanced_panel)
    - [`SubsurfModifier.quality`](#bpy.types.SubsurfModifier.quality)
    - [`SubsurfModifier.render_levels`](#bpy.types.SubsurfModifier.render_levels)
    - [`SubsurfModifier.show_only_control_edges`](#bpy.types.SubsurfModifier.show_only_control_edges)
    - [`SubsurfModifier.subdivision_type`](#bpy.types.SubsurfModifier.subdivision_type)
    - [`SubsurfModifier.use_adaptive_subdivision`](#bpy.types.SubsurfModifier.use_adaptive_subdivision)
    - [`SubsurfModifier.use_creases`](#bpy.types.SubsurfModifier.use_creases)
    - [`SubsurfModifier.use_custom_normals`](#bpy.types.SubsurfModifier.use_custom_normals)
    - [`SubsurfModifier.use_limit_surface`](#bpy.types.SubsurfModifier.use_limit_surface)
    - [`SubsurfModifier.uv_smooth`](#bpy.types.SubsurfModifier.uv_smooth)
    - [`SubsurfModifier.bl_rna_get_subclass()`](#bpy.types.SubsurfModifier.bl_rna_get_subclass)
    - [`SubsurfModifier.bl_rna_get_subclass_py()`](#bpy.types.SubsurfModifier.bl_rna_get_subclass_py)
