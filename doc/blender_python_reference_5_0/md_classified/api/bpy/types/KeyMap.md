...
# KeyMap(bpy\_struct)[¶](#keymap-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.KeyMap(*bpy\_struct*)[¶](#bpy.types.KeyMap "Link to this definition")
:   Input configuration, including keymaps

    bl\_owner\_id[¶](#bpy.types.KeyMap.bl_owner_id "Link to this definition")
    :   Internal owner

        Type:
        :   string, default “”, (never None)

    is\_modal[¶](#bpy.types.KeyMap.is_modal "Link to this definition")
    :   Indicates that a keymap is used for translate modal events for an operator

        Type:
        :   boolean, default False, (readonly)

    is\_user\_modified[¶](#bpy.types.KeyMap.is_user_modified "Link to this definition")
    :   Keymap is defined by the user

        Type:
        :   boolean, default False

    keymap\_items[¶](#bpy.types.KeyMap.keymap_items "Link to this definition")
    :   Items in the keymap, linking an operator to an input event

        Type:
        :   [`KeyMapItems`](KeyMapItems.md#bpy.types.KeyMapItems "bpy.types.KeyMapItems") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`KeyMapItem`](KeyMapItem.md#bpy.types.KeyMapItem "bpy.types.KeyMapItem"), (readonly)

    modal\_event\_values[¶](#bpy.types.KeyMap.modal_event_values "Link to this definition")
    ...
    name[¶](#bpy.types.KeyMap.name "Link to this definition")
    :   Name of the key map

        Type:
        :   string, default “”, (readonly, never None)

    region\_type[¶](#bpy.types.KeyMap.region_type "Link to this definition")
    :   Optional region type keymap is associated with

        Type:
        :   enum in [Region Type Items](../../../appendix/bpy_types_enum_items/region_type_items.md#rna-enum-region-type-items), default `'WINDOW'`, (readonly)

    show\_expanded\_children[¶](#bpy.types.KeyMap.show_expanded_children "Link to this definition")
    :   Children expanded in the user interface

        Type:
        :   boolean, default False

    show\_expanded\_items[¶](#bpy.types.KeyMap.show_expanded_items "Link to this definition")
    :   Expanded in the user interface

        Type:
        :   boolean, default False

    space\_type[¶](#bpy.types.KeyMap.space_type "Link to this definition")
    ...
    active()[¶](#bpy.types.KeyMap.active "Link to this definition")
    :   active
    ...
    restore\_to\_default()[¶](#bpy.types.KeyMap.restore_to_default "Link to this definition")
    :   restore\_to\_default

    restore\_item\_to\_default(*item*)[¶](#bpy.types.KeyMap.restore_item_to_default "Link to this definition")
    :   restore\_item\_to\_default

        Parameters:
        :   **item** ([`KeyMapItem`](KeyMapItem.md#bpy.types.KeyMapItem "bpy.types.KeyMapItem"), (never None)) – Item

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.KeyMap.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.KeyMap.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`GizmoGroup.setup_keymap`](GizmoGroup.md#bpy.types.GizmoGroup.setup_keymap "bpy.types.GizmoGroup.setup_keymap") * [`KeyConfig.keymaps`](KeyConfig.md#bpy.types.KeyConfig.keymaps "bpy.types.KeyConfig.keymaps") * [`KeyConfigurations.find_item_from_operator`](KeyConfigurations.md#bpy.types.KeyConfigurations.find_item_from_operator "bpy.types.KeyConfigurations.find_item_from_operator") * [`KeyMap.active`](#bpy.types.KeyMap.active "bpy.types.KeyMap.active") * [`KeyMapItems.find_match`](KeyMapItems.md#bpy.types.KeyMapItems.find_match "bpy.types.KeyMapItems.find_match") * [`KeyMaps.find`](KeyMaps.md#bpy.types.KeyMaps.find "bpy.types.KeyMaps.find") | * [`KeyMaps.find_match`](KeyMaps.md#bpy.types.KeyMaps.find_match "bpy.types.KeyMaps.find_match") * [`KeyMaps.find_match`](KeyMaps.md#bpy.types.KeyMaps.find_match "bpy.types.KeyMaps.find_match") * [`KeyMaps.find_modal`](KeyMaps.md#bpy.types.KeyMaps.find_modal "bpy.types.KeyMaps.find_modal") * [`KeyMaps.new`](KeyMaps.md#bpy.types.KeyMaps.new "bpy.types.KeyMaps.new") * [`KeyMaps.remove`](KeyMaps.md#bpy.types.KeyMaps.remove "bpy.types.KeyMaps.remove") * [`WindowManager.popover_end__internal`](WindowManager.md#bpy.types.WindowManager.popover_end__internal "bpy.types.WindowManager.popover_end__internal") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.KeyMap.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.KeyMap.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* KeyMap(bpy\_struct)
  + [`KeyMap`](#bpy.types.KeyMap)
    - [`KeyMap.bl_owner_id`](#bpy.types.KeyMap.bl_owner_id)
    - [`KeyMap.is_modal`](#bpy.types.KeyMap.is_modal)
    - [`KeyMap.is_user_modified`](#bpy.types.KeyMap.is_user_modified)
    - [`KeyMap.keymap_items`](#bpy.types.KeyMap.keymap_items)
    - [`KeyMap.modal_event_values`](#bpy.types.KeyMap.modal_event_values)
    - [`KeyMap.name`](#bpy.types.KeyMap.name)
    - [`KeyMap.region_type`](#bpy.types.KeyMap.region_type)
    - [`KeyMap.show_expanded_children`](#bpy.types.KeyMap.show_expanded_children)
    - [`KeyMap.show_expanded_items`](#bpy.types.KeyMap.show_expanded_items)
    - [`KeyMap.space_type`](#bpy.types.KeyMap.space_type)
    - [`KeyMap.active()`](#bpy.types.KeyMap.active)
    - [`KeyMap.restore_to_default()`](#bpy.types.KeyMap.restore_to_default)
    - [`KeyMap.restore_item_to_default()`](#bpy.types.KeyMap.restore_item_to_default)
    - [`KeyMap.bl_rna_get_subclass()`](#bpy.types.KeyMap.bl_rna_get_subclass)
    - [`KeyMap.bl_rna_get_subclass_py()`](#bpy.types.KeyMap.bl_rna_get_subclass_py)
