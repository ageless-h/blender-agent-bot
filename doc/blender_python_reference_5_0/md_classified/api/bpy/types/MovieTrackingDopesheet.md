...
# MovieTrackingDopesheet(bpy\_struct)[¶](#movietrackingdopesheet-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.MovieTrackingDopesheet(*bpy\_struct*)[¶](#bpy.types.MovieTrackingDopesheet "Link to this definition")
:   Match-moving dopesheet data

    show\_hidden[¶](#bpy.types.MovieTrackingDopesheet.show_hidden "Link to this definition")
    :   Include channels from objects/bone that are not visible

        Type:
        :   boolean, default False

    show\_only\_selected[¶](#bpy.types.MovieTrackingDopesheet.show_only_selected "Link to this definition")
    :   Only include channels relating to selected objects and data

        Type:
        :   boolean, default False

    sort\_method[¶](#bpy.types.MovieTrackingDopesheet.sort_method "Link to this definition")
    ...
    use\_invert\_sort[¶](#bpy.types.MovieTrackingDopesheet.use_invert_sort "Link to this definition")
    :   Invert sort order of dopesheet channels

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.MovieTrackingDopesheet.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.MovieTrackingDopesheet.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`MovieTracking.dopesheet`](MovieTracking.md#bpy.types.MovieTracking.dopesheet "bpy.types.MovieTracking.dopesheet") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.MovieTrackingDopesheet.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.MovieTrackingDopesheet.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* MovieTrackingDopesheet(bpy\_struct)
  + [`MovieTrackingDopesheet`](#bpy.types.MovieTrackingDopesheet)
    - [`MovieTrackingDopesheet.show_hidden`](#bpy.types.MovieTrackingDopesheet.show_hidden)
    - [`MovieTrackingDopesheet.show_only_selected`](#bpy.types.MovieTrackingDopesheet.show_only_selected)
    - [`MovieTrackingDopesheet.sort_method`](#bpy.types.MovieTrackingDopesheet.sort_method)
    - [`MovieTrackingDopesheet.use_invert_sort`](#bpy.types.MovieTrackingDopesheet.use_invert_sort)
    - [`MovieTrackingDopesheet.bl_rna_get_subclass()`](#bpy.types.MovieTrackingDopesheet.bl_rna_get_subclass)
    - [`MovieTrackingDopesheet.bl_rna_get_subclass_py()`](#bpy.types.MovieTrackingDopesheet.bl_rna_get_subclass_py)
