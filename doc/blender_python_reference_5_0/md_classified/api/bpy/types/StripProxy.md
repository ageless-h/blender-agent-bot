...
# StripProxy(bpy\_struct)[¶](#stripproxy-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.StripProxy(*bpy\_struct*)[¶](#bpy.types.StripProxy "Link to this definition")
:   Proxy parameters for a sequence strip

    build\_100[¶](#bpy.types.StripProxy.build_100 "Link to this definition")
    :   Build 100% proxy resolution

        Type:
        :   boolean, default False

    build\_25[¶](#bpy.types.StripProxy.build_25 "Link to this definition")
    :   Build 25% proxy resolution

        Type:
        :   boolean, default False

    build\_50[¶](#bpy.types.StripProxy.build_50 "Link to this definition")
    :   Build 50% proxy resolution

        Type:
        :   boolean, default False

    build\_75[¶](#bpy.types.StripProxy.build_75 "Link to this definition")
    :   Build 75% proxy resolution

        Type:
        :   boolean, default False

    build\_record\_run[¶](#bpy.types.StripProxy.build_record_run "Link to this definition")
    :   Build record run time code index

        Type:
        :   boolean, default False

    directory[¶](#bpy.types.StripProxy.directory "Link to this definition")
    :   Location to store the proxy files

        Type:
        :   string, default “”, (never None, blend relative `//` prefix supported)

    filepath[¶](#bpy.types.StripProxy.filepath "Link to this definition")
    :   Location of custom proxy file

        Type:
        :   string, default “”, (never None, blend relative `//` prefix supported)

    quality[¶](#bpy.types.StripProxy.quality "Link to this definition")
    :   Quality of proxies to build

        Type:
        :   int in [0, 32767], default 0

    timecode[¶](#bpy.types.StripProxy.timecode "Link to this definition")
    ...
    use\_overwrite[¶](#bpy.types.StripProxy.use_overwrite "Link to this definition")
    :   Overwrite existing proxy files when building

        Type:
        :   boolean, default False

    use\_proxy\_custom\_directory[¶](#bpy.types.StripProxy.use_proxy_custom_directory "Link to this definition")
    :   Use a custom directory to store data

        Type:
        :   boolean, default False

    use\_proxy\_custom\_file[¶](#bpy.types.StripProxy.use_proxy_custom_file "Link to this definition")
    :   Use a custom file to read proxy data from

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.StripProxy.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.StripProxy.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`EffectStrip.proxy`](EffectStrip.md#bpy.types.EffectStrip.proxy "bpy.types.EffectStrip.proxy") * [`ImageStrip.proxy`](ImageStrip.md#bpy.types.ImageStrip.proxy "bpy.types.ImageStrip.proxy") * [`MetaStrip.proxy`](MetaStrip.md#bpy.types.MetaStrip.proxy "bpy.types.MetaStrip.proxy") | * [`MovieStrip.proxy`](MovieStrip.md#bpy.types.MovieStrip.proxy "bpy.types.MovieStrip.proxy") * [`SceneStrip.proxy`](SceneStrip.md#bpy.types.SceneStrip.proxy "bpy.types.SceneStrip.proxy") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.StripProxy.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.StripProxy.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* StripProxy(bpy\_struct)
  + [`StripProxy`](#bpy.types.StripProxy)
    - [`StripProxy.build_100`](#bpy.types.StripProxy.build_100)
    - [`StripProxy.build_25`](#bpy.types.StripProxy.build_25)
    - [`StripProxy.build_50`](#bpy.types.StripProxy.build_50)
    - [`StripProxy.build_75`](#bpy.types.StripProxy.build_75)
    - [`StripProxy.build_record_run`](#bpy.types.StripProxy.build_record_run)
    - [`StripProxy.directory`](#bpy.types.StripProxy.directory)
    - [`StripProxy.filepath`](#bpy.types.StripProxy.filepath)
    - [`StripProxy.quality`](#bpy.types.StripProxy.quality)
    - [`StripProxy.timecode`](#bpy.types.StripProxy.timecode)
    - [`StripProxy.use_overwrite`](#bpy.types.StripProxy.use_overwrite)
    - [`StripProxy.use_proxy_custom_directory`](#bpy.types.StripProxy.use_proxy_custom_directory)
    - [`StripProxy.use_proxy_custom_file`](#bpy.types.StripProxy.use_proxy_custom_file)
    - [`StripProxy.bl_rna_get_subclass()`](#bpy.types.StripProxy.bl_rna_get_subclass)
    - [`StripProxy.bl_rna_get_subclass_py()`](#bpy.types.StripProxy.bl_rna_get_subclass_py)
