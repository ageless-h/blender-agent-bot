...
# ShapeKeyCurvePoint(bpy\_struct)[¶](#shapekeycurvepoint-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.ShapeKeyCurvePoint(*bpy\_struct*)[¶](#bpy.types.ShapeKeyCurvePoint "Link to this definition")
:   Point in a shape key for curves

    co[¶](#bpy.types.ShapeKeyCurvePoint.co "Link to this definition")
    :   Type:
        :   [`mathutils.Vector`](../../mathutils/index.md#mathutils.Vector "mathutils.Vector") of 3 items in [-inf, inf], default (0.0, 0.0, 0.0)

    radius[¶](#bpy.types.ShapeKeyCurvePoint.radius "Link to this definition")
    :   Radius for beveling

        Type:
        :   float in [0, inf], default 0.0

    tilt[¶](#bpy.types.ShapeKeyCurvePoint.tilt "Link to this definition")
    :   Tilt in 3D View

        Type:
        :   float in [-376.991, 376.991], default 0.0

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ShapeKeyCurvePoint.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ShapeKeyCurvePoint.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ShapeKeyCurvePoint.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ShapeKeyCurvePoint.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ShapeKeyCurvePoint(bpy\_struct)
  + [`ShapeKeyCurvePoint`](#bpy.types.ShapeKeyCurvePoint)
    - [`ShapeKeyCurvePoint.co`](#bpy.types.ShapeKeyCurvePoint.co)
    - [`ShapeKeyCurvePoint.radius`](#bpy.types.ShapeKeyCurvePoint.radius)
    - [`ShapeKeyCurvePoint.tilt`](#bpy.types.ShapeKeyCurvePoint.tilt)
    - [`ShapeKeyCurvePoint.bl_rna_get_subclass()`](#bpy.types.ShapeKeyCurvePoint.bl_rna_get_subclass)
    - [`ShapeKeyCurvePoint.bl_rna_get_subclass_py()`](#bpy.types.ShapeKeyCurvePoint.bl_rna_get_subclass_py)
