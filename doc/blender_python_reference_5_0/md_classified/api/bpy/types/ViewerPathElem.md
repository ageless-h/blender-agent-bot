...
# ViewerPathElem(bpy\_struct)[¶](#viewerpathelem-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

subclasses —
[`EvaluateClosureNodeViewerPathElem`](EvaluateClosureNodeViewerPathElem.md#bpy.types.EvaluateClosureNodeViewerPathElem "bpy.types.EvaluateClosureNodeViewerPathElem"), [`ForeachGeometryElementZoneViewerPathElem`](ForeachGeometryElementZoneViewerPathElem.md#bpy.types.ForeachGeometryElementZoneViewerPathElem "bpy.types.ForeachGeometryElementZoneViewerPathElem"), [`GroupNodeViewerPathElem`](GroupNodeViewerPathElem.md#bpy.types.GroupNodeViewerPathElem "bpy.types.GroupNodeViewerPathElem"), [`IDViewerPathElem`](IDViewerPathElem.md#bpy.types.IDViewerPathElem "bpy.types.IDViewerPathElem"), [`ModifierViewerPathElem`](ModifierViewerPathElem.md#bpy.types.ModifierViewerPathElem "bpy.types.ModifierViewerPathElem"), [`RepeatZoneViewerPathElem`](RepeatZoneViewerPathElem.md#bpy.types.RepeatZoneViewerPathElem "bpy.types.RepeatZoneViewerPathElem"), [`SimulationZoneViewerPathElem`](SimulationZoneViewerPathElem.md#bpy.types.SimulationZoneViewerPathElem "bpy.types.SimulationZoneViewerPathElem"), [`ViewerNodeViewerPathElem`](ViewerNodeViewerPathElem.md#bpy.types.ViewerNodeViewerPathElem "bpy.types.ViewerNodeViewerPathElem")

*class* bpy.types.ViewerPathElem(*bpy\_struct*)[¶](#bpy.types.ViewerPathElem "Link to this definition")
:   Element of a viewer path

    type[¶](#bpy.types.ViewerPathElem.type "Link to this definition")
    ...
    ui\_name[¶](#bpy.types.ViewerPathElem.ui_name "Link to this definition")
    :   Name that can be displayed in the UI for this element

        Type:
        :   string, default “”, (readonly, never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ViewerPathElem.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ViewerPathElem.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`ViewerPath.path`](ViewerPath.md#bpy.types.ViewerPath.path "bpy.types.ViewerPath.path") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ViewerPathElem.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ViewerPathElem.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ViewerPathElem(bpy\_struct)
  + [`ViewerPathElem`](#bpy.types.ViewerPathElem)
    - [`ViewerPathElem.type`](#bpy.types.ViewerPathElem.type)
    - [`ViewerPathElem.ui_name`](#bpy.types.ViewerPathElem.ui_name)
    - [`ViewerPathElem.bl_rna_get_subclass()`](#bpy.types.ViewerPathElem.bl_rna_get_subclass)
    - [`ViewerPathElem.bl_rna_get_subclass_py()`](#bpy.types.ViewerPathElem.bl_rna_get_subclass_py)
