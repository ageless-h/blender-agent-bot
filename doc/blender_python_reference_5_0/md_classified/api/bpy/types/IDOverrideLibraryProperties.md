...
# IDOverrideLibraryProperties(bpy\_struct)[¶](#idoverridelibraryproperties-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.IDOverrideLibraryProperties(*bpy\_struct*)[¶](#bpy.types.IDOverrideLibraryProperties "Link to this definition")
:   Collection of override properties

    add(*rna\_path*)[¶](#bpy.types.IDOverrideLibraryProperties.add "Link to this definition")
    :   Add a property to the override library when it doesn’t exist yet

        Parameters:
        :   **rna\_path** (*string**,* *(**never None**)*) – RNA Path, RNA-Path of the property to add

        Returns:
        :   New Property, Newly created override property or existing one

        Return type:
        :   [`IDOverrideLibraryProperty`](IDOverrideLibraryProperty.md#bpy.types.IDOverrideLibraryProperty "bpy.types.IDOverrideLibraryProperty")

    remove(*property*)[¶](#bpy.types.IDOverrideLibraryProperties.remove "Link to this definition")
    :   Remove and delete a property

        Parameters:
        :   **property** ([`IDOverrideLibraryProperty`](IDOverrideLibraryProperty.md#bpy.types.IDOverrideLibraryProperty "bpy.types.IDOverrideLibraryProperty")) – Property, Override property to be deleted

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.IDOverrideLibraryProperties.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.IDOverrideLibraryProperties.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`IDOverrideLibrary.properties`](IDOverrideLibrary.md#bpy.types.IDOverrideLibrary.properties "bpy.types.IDOverrideLibrary.properties") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.IDOverrideLibraryProperties.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.IDOverrideLibraryProperties.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* IDOverrideLibraryProperties(bpy\_struct)
  + [`IDOverrideLibraryProperties`](#bpy.types.IDOverrideLibraryProperties)
    - [`IDOverrideLibraryProperties.add()`](#bpy.types.IDOverrideLibraryProperties.add)
    - [`IDOverrideLibraryProperties.remove()`](#bpy.types.IDOverrideLibraryProperties.remove)
    - [`IDOverrideLibraryProperties.bl_rna_get_subclass()`](#bpy.types.IDOverrideLibraryProperties.bl_rna_get_subclass)
    - [`IDOverrideLibraryProperties.bl_rna_get_subclass_py()`](#bpy.types.IDOverrideLibraryProperties.bl_rna_get_subclass_py)
