...
# LayerCollection(bpy\_struct)[¶](#layercollection-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.LayerCollection(*bpy\_struct*)[¶](#bpy.types.LayerCollection "Link to this definition")
:   Layer collection

    children[¶](#bpy.types.LayerCollection.children "Link to this definition")
    :   Layer collection children

        Type:
        :   [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`LayerCollection`](#bpy.types.LayerCollection "bpy.types.LayerCollection"), (readonly)

    collection[¶](#bpy.types.LayerCollection.collection "Link to this definition")
    ...
    exclude[¶](#bpy.types.LayerCollection.exclude "Link to this definition")
    :   Exclude from view layer

        Type:
        :   boolean, default False

    hide\_viewport[¶](#bpy.types.LayerCollection.hide_viewport "Link to this definition")
    :   Temporarily hide in viewport

        Type:
        :   boolean, default False

    holdout[¶](#bpy.types.LayerCollection.holdout "Link to this definition")
    :   Mask out objects in collection from view layer

        Type:
        :   boolean, default False

    indirect\_only[¶](#bpy.types.LayerCollection.indirect_only "Link to this definition")
    :   Objects in collection only contribute indirectly (through shadows and reflections) in the view layer

        Type:
        :   boolean, default False

    is\_visible[¶](#bpy.types.LayerCollection.is_visible "Link to this definition")
    :   Whether this collection is visible for the view layer, take into account the collection parent

        Type:
        :   boolean, default False, (readonly)

    name[¶](#bpy.types.LayerCollection.name "Link to this definition")
    :   Name of this layer collection (same as its collection one)

        Type:
        :   string, default “”, (readonly, never None)

    visible\_get()[¶](#bpy.types.LayerCollection.visible_get "Link to this definition")
    :   Whether this collection is visible, take into account the collection parent and the viewport

        Return type:
        :   boolean

    has\_objects()[¶](#bpy.types.LayerCollection.has_objects "Link to this definition")
    :   Return type:
        :   boolean

    has\_selected\_objects(*view\_layer*)[¶](#bpy.types.LayerCollection.has_selected_objects "Link to this definition")
    :   Parameters:
        :   **view\_layer** ([`ViewLayer`](ViewLayer.md#bpy.types.ViewLayer "bpy.types.ViewLayer")) – View layer the layer collection belongs to

        Return type:
        :   boolean

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.LayerCollection.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.LayerCollection.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`bpy.context.collection`](../context/index.md#bpy.context.collection "bpy.context.collection") * [`Context.layer_collection`](Context.md#bpy.types.Context.layer_collection "bpy.types.Context.layer_collection") * [`LayerCollection.children`](#bpy.types.LayerCollection.children "bpy.types.LayerCollection.children") | * [`ViewLayer.active_layer_collection`](ViewLayer.md#bpy.types.ViewLayer.active_layer_collection "bpy.types.ViewLayer.active_layer_collection") * [`ViewLayer.layer_collection`](ViewLayer.md#bpy.types.ViewLayer.layer_collection "bpy.types.ViewLayer.layer_collection") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.LayerCollection.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.LayerCollection.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* LayerCollection(bpy\_struct)
  + [`LayerCollection`](#bpy.types.LayerCollection)
    - [`LayerCollection.children`](#bpy.types.LayerCollection.children)
    - [`LayerCollection.collection`](#bpy.types.LayerCollection.collection)
    - [`LayerCollection.exclude`](#bpy.types.LayerCollection.exclude)
    - [`LayerCollection.hide_viewport`](#bpy.types.LayerCollection.hide_viewport)
    - [`LayerCollection.holdout`](#bpy.types.LayerCollection.holdout)
    - [`LayerCollection.indirect_only`](#bpy.types.LayerCollection.indirect_only)
    - [`LayerCollection.is_visible`](#bpy.types.LayerCollection.is_visible)
    - [`LayerCollection.name`](#bpy.types.LayerCollection.name)
    - [`LayerCollection.visible_get()`](#bpy.types.LayerCollection.visible_get)
    - [`LayerCollection.has_objects()`](#bpy.types.LayerCollection.has_objects)
    - [`LayerCollection.has_selected_objects()`](#bpy.types.LayerCollection.has_selected_objects)
    - [`LayerCollection.bl_rna_get_subclass()`](#bpy.types.LayerCollection.bl_rna_get_subclass)
    - [`LayerCollection.bl_rna_get_subclass_py()`](#bpy.types.LayerCollection.bl_rna_get_subclass_py)
