...
# CopyRotationConstraint(Constraint)[¶](#copyrotationconstraint-constraint "Link to this heading")
...
*class* bpy.types.CopyRotationConstraint(*Constraint*)[¶](#bpy.types.CopyRotationConstraint "Link to this definition")
:   Copy the rotation of the target

    euler\_order[¶](#bpy.types.CopyRotationConstraint.euler_order "Link to this definition")
    ...
    invert\_x[¶](#bpy.types.CopyRotationConstraint.invert_x "Link to this definition")
    :   Invert the X rotation

        Type:
        :   boolean, default False

    invert\_y[¶](#bpy.types.CopyRotationConstraint.invert_y "Link to this definition")
    :   Invert the Y rotation

        Type:
        :   boolean, default False

    invert\_z[¶](#bpy.types.CopyRotationConstraint.invert_z "Link to this definition")
    :   Invert the Z rotation

        Type:
        :   boolean, default False

    mix\_mode[¶](#bpy.types.CopyRotationConstraint.mix_mode "Link to this definition")
    ...
    subtarget[¶](#bpy.types.CopyRotationConstraint.subtarget "Link to this definition")
    :   Armature bone, mesh or lattice vertex group, …

        Type:
        :   string, default “”, (never None)

    target[¶](#bpy.types.CopyRotationConstraint.target "Link to this definition")
    :   Target object

        Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object")

    use\_offset[¶](#bpy.types.CopyRotationConstraint.use_offset "Link to this definition")
    :   DEPRECATED: Add original rotation into copied rotation

        Type:
        :   boolean, default False

    use\_x[¶](#bpy.types.CopyRotationConstraint.use_x "Link to this definition")
    :   Copy the target’s X rotation

        Type:
        :   boolean, default False

    use\_y[¶](#bpy.types.CopyRotationConstraint.use_y "Link to this definition")
    :   Copy the target’s Y rotation

        Type:
        :   boolean, default False

    use\_z[¶](#bpy.types.CopyRotationConstraint.use_z "Link to this definition")
    :   Copy the target’s Z rotation

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.CopyRotationConstraint.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.CopyRotationConstraint.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CopyRotationConstraint.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.CopyRotationConstraint.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CopyRotationConstraint(Constraint)
  + [`CopyRotationConstraint`](#bpy.types.CopyRotationConstraint)
    - [`CopyRotationConstraint.euler_order`](#bpy.types.CopyRotationConstraint.euler_order)
    - [`CopyRotationConstraint.invert_x`](#bpy.types.CopyRotationConstraint.invert_x)
    - [`CopyRotationConstraint.invert_y`](#bpy.types.CopyRotationConstraint.invert_y)
    - [`CopyRotationConstraint.invert_z`](#bpy.types.CopyRotationConstraint.invert_z)
    - [`CopyRotationConstraint.mix_mode`](#bpy.types.CopyRotationConstraint.mix_mode)
    - [`CopyRotationConstraint.subtarget`](#bpy.types.CopyRotationConstraint.subtarget)
    - [`CopyRotationConstraint.target`](#bpy.types.CopyRotationConstraint.target)
    - [`CopyRotationConstraint.use_offset`](#bpy.types.CopyRotationConstraint.use_offset)
    - [`CopyRotationConstraint.use_x`](#bpy.types.CopyRotationConstraint.use_x)
    - [`CopyRotationConstraint.use_y`](#bpy.types.CopyRotationConstraint.use_y)
    - [`CopyRotationConstraint.use_z`](#bpy.types.CopyRotationConstraint.use_z)
    - [`CopyRotationConstraint.bl_rna_get_subclass()`](#bpy.types.CopyRotationConstraint.bl_rna_get_subclass)
    - [`CopyRotationConstraint.bl_rna_get_subclass_py()`](#bpy.types.CopyRotationConstraint.bl_rna_get_subclass_py)
