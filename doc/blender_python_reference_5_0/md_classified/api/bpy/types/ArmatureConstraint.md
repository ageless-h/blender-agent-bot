...
# ArmatureConstraint(Constraint)[¶](#armatureconstraint-constraint "Link to this heading")
...
*class* bpy.types.ArmatureConstraint(*Constraint*)[¶](#bpy.types.ArmatureConstraint "Link to this definition")
:   Applies transformations done by the Armature modifier

    targets[¶](#bpy.types.ArmatureConstraint.targets "Link to this definition")
    :   Target Bones

        Type:
        :   [`ArmatureConstraintTargets`](ArmatureConstraintTargets.md#bpy.types.ArmatureConstraintTargets "bpy.types.ArmatureConstraintTargets") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`ConstraintTargetBone`](ConstraintTargetBone.md#bpy.types.ConstraintTargetBone "bpy.types.ConstraintTargetBone"), (readonly)

    use\_bone\_envelopes[¶](#bpy.types.ArmatureConstraint.use_bone_envelopes "Link to this definition")
    ...
    use\_current\_location[¶](#bpy.types.ArmatureConstraint.use_current_location "Link to this definition")
    :   Use the current bone location for envelopes and choosing B-Bone segments instead of rest position

        Type:
        :   boolean, default False

    use\_deform\_preserve\_volume[¶](#bpy.types.ArmatureConstraint.use_deform_preserve_volume "Link to this definition")
    :   Deform rotation interpolation with quaternions

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ArmatureConstraint.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ArmatureConstraint.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ArmatureConstraint.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ArmatureConstraint.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ArmatureConstraint(Constraint)
  + [`ArmatureConstraint`](#bpy.types.ArmatureConstraint)
    - [`ArmatureConstraint.targets`](#bpy.types.ArmatureConstraint.targets)
    - [`ArmatureConstraint.use_bone_envelopes`](#bpy.types.ArmatureConstraint.use_bone_envelopes)
    - [`ArmatureConstraint.use_current_location`](#bpy.types.ArmatureConstraint.use_current_location)
    - [`ArmatureConstraint.use_deform_preserve_volume`](#bpy.types.ArmatureConstraint.use_deform_preserve_volume)
    - [`ArmatureConstraint.bl_rna_get_subclass()`](#bpy.types.ArmatureConstraint.bl_rna_get_subclass)
    - [`ArmatureConstraint.bl_rna_get_subclass_py()`](#bpy.types.ArmatureConstraint.bl_rna_get_subclass_py)
