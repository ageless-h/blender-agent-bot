...
# UVProjector(bpy\_struct)[¶](#uvprojector-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.UVProjector(*bpy\_struct*)[¶](#bpy.types.UVProjector "Link to this definition")
:   UV projector used by the UV project modifier

    object[¶](#bpy.types.UVProjector.object "Link to this definition")
    :   Object to use as projector transform

        Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.UVProjector.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.UVProjector.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`UVProjectModifier.projectors`](UVProjectModifier.md#bpy.types.UVProjectModifier.projectors "bpy.types.UVProjectModifier.projectors") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.UVProjector.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.UVProjector.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* UVProjector(bpy\_struct)
  + [`UVProjector`](#bpy.types.UVProjector)
    - [`UVProjector.object`](#bpy.types.UVProjector.object)
    - [`UVProjector.bl_rna_get_subclass()`](#bpy.types.UVProjector.bl_rna_get_subclass)
    - [`UVProjector.bl_rna_get_subclass_py()`](#bpy.types.UVProjector.bl_rna_get_subclass_py)
