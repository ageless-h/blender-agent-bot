...
# NodeTreePath(bpy\_struct)[¶](#nodetreepath-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.NodeTreePath(*bpy\_struct*)[¶](#bpy.types.NodeTreePath "Link to this definition")
:   Element of the node space tree path

    node\_tree[¶](#bpy.types.NodeTreePath.node_tree "Link to this definition")
    :   Base node tree from context

        Type:
        :   [`NodeTree`](NodeTree.md#bpy.types.NodeTree "bpy.types.NodeTree"), (readonly)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.NodeTreePath.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.NodeTreePath.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.NodeTreePath.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.NodeTreePath.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* NodeTreePath(bpy\_struct)
  + [`NodeTreePath`](#bpy.types.NodeTreePath)
    - [`NodeTreePath.node_tree`](#bpy.types.NodeTreePath.node_tree)
    - [`NodeTreePath.bl_rna_get_subclass()`](#bpy.types.NodeTreePath.bl_rna_get_subclass)
    - [`NodeTreePath.bl_rna_get_subclass_py()`](#bpy.types.NodeTreePath.bl_rna_get_subclass_py)
