...
# CloudsTexture(Texture)[¶](#cloudstexture-texture "Link to this heading")
...
*class* bpy.types.CloudsTexture(*Texture*)[¶](#bpy.types.CloudsTexture "Link to this definition")
:   Procedural noise texture

    cloud\_type[¶](#bpy.types.CloudsTexture.cloud_type "Link to this definition")
    :   Determine whether Noise returns grayscale or RGB values

        Type:
        :   enum in [`'GRAYSCALE'`, `'COLOR'`], default `'GRAYSCALE'`

    nabla[¶](#bpy.types.CloudsTexture.nabla "Link to this definition")
    :   Size of derivative offset used for calculating normal

        Type:
        :   float in [0.001, 0.1], default 0.025

    noise\_basis[¶](#bpy.types.CloudsTexture.noise_basis "Link to this definition")
    ...
    noise\_depth[¶](#bpy.types.CloudsTexture.noise_depth "Link to this definition")
    :   Depth of the cloud calculation

        Type:
        :   int in [0, 30], default 2

    noise\_scale[¶](#bpy.types.CloudsTexture.noise_scale "Link to this definition")
    :   Scaling for noise input

        Type:
        :   float in [0.0001, inf], default 0.25

    noise\_type[¶](#bpy.types.CloudsTexture.noise_type "Link to this definition")
    :   * `SOFT_NOISE`
    ...
    users\_material[¶](#bpy.types.CloudsTexture.users_material "Link to this definition")
    ...
    users\_object\_modifier[¶](#bpy.types.CloudsTexture.users_object_modifier "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.CloudsTexture.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.CloudsTexture.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CloudsTexture.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.CloudsTexture.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CloudsTexture(Texture)
  + [`CloudsTexture`](#bpy.types.CloudsTexture)
    - [`CloudsTexture.cloud_type`](#bpy.types.CloudsTexture.cloud_type)
    - [`CloudsTexture.nabla`](#bpy.types.CloudsTexture.nabla)
    - [`CloudsTexture.noise_basis`](#bpy.types.CloudsTexture.noise_basis)
    - [`CloudsTexture.noise_depth`](#bpy.types.CloudsTexture.noise_depth)
    - [`CloudsTexture.noise_scale`](#bpy.types.CloudsTexture.noise_scale)
    - [`CloudsTexture.noise_type`](#bpy.types.CloudsTexture.noise_type)
    - [`CloudsTexture.users_material`](#bpy.types.CloudsTexture.users_material)
    - [`CloudsTexture.users_object_modifier`](#bpy.types.CloudsTexture.users_object_modifier)
    - [`CloudsTexture.bl_rna_get_subclass()`](#bpy.types.CloudsTexture.bl_rna_get_subclass)
    - [`CloudsTexture.bl_rna_get_subclass_py()`](#bpy.types.CloudsTexture.bl_rna_get_subclass_py)
