...
# KeyingSetPaths(bpy\_struct)[¶](#keyingsetpaths-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.KeyingSetPaths(*bpy\_struct*)[¶](#bpy.types.KeyingSetPaths "Link to this definition")
:   Collection of keying set paths

    active[¶](#bpy.types.KeyingSetPaths.active "Link to this definition")
    :   Active Keying Set used to insert/delete keyframes

        Type:
        :   [`KeyingSetPath`](KeyingSetPath.md#bpy.types.KeyingSetPath "bpy.types.KeyingSetPath")

    active\_index[¶](#bpy.types.KeyingSetPaths.active_index "Link to this definition")
    :   Current Keying Set index

        Type:
        :   int in [-inf, inf], default 0

    add(*target\_id*, *data\_path*, *\**, *index=-1*, *group\_method='KEYINGSET'*, *group\_name=''*)[¶](#bpy.types.KeyingSetPaths.add "Link to this definition")
    :   Add a new path for the Keying Set

        Parameters:
        :   * **target\_id** ([`ID`](ID.md#bpy.types.ID "bpy.types.ID")) – Target ID, ID data-block for the destination
            * **data\_path** (*string**,* *(**never None**)*) – Data-Path, RNA-Path to destination property
            ...
            * **group\_method** (enum in [Keyingset Path Grouping Items](../../../appendix/bpy_types_enum_items/keyingset_path_grouping_items.md#rna-enum-keyingset-path-grouping-items), (optional)) – Grouping Method, Method used to define which Group-name to use
            * **group\_name** (*string**,* *(**optional**,* *never None**)*) – Group Name, Name of Action Group to assign destination to (only if grouping mode is to use this name)
    ...
    remove(*path*)[¶](#bpy.types.KeyingSetPaths.remove "Link to this definition")
    :   Remove the given path from the Keying Set

        Parameters:
        :   **path** ([`KeyingSetPath`](KeyingSetPath.md#bpy.types.KeyingSetPath "bpy.types.KeyingSetPath"), (never None)) – Path

    clear()[¶](#bpy.types.KeyingSetPaths.clear "Link to this definition")
    :   Remove all the paths from the Keying Set

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.KeyingSetPaths.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.KeyingSetPaths.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`KeyingSet.paths`](KeyingSet.md#bpy.types.KeyingSet.paths "bpy.types.KeyingSet.paths") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.KeyingSetPaths.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.KeyingSetPaths.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* KeyingSetPaths(bpy\_struct)
  + [`KeyingSetPaths`](#bpy.types.KeyingSetPaths)
    - [`KeyingSetPaths.active`](#bpy.types.KeyingSetPaths.active)
    - [`KeyingSetPaths.active_index`](#bpy.types.KeyingSetPaths.active_index)
    - [`KeyingSetPaths.add()`](#bpy.types.KeyingSetPaths.add)
    - [`KeyingSetPaths.remove()`](#bpy.types.KeyingSetPaths.remove)
    - [`KeyingSetPaths.clear()`](#bpy.types.KeyingSetPaths.clear)
    - [`KeyingSetPaths.bl_rna_get_subclass()`](#bpy.types.KeyingSetPaths.bl_rna_get_subclass)
    - [`KeyingSetPaths.bl_rna_get_subclass_py()`](#bpy.types.KeyingSetPaths.bl_rna_get_subclass_py)
