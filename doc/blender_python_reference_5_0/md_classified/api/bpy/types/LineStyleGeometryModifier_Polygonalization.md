...
# LineStyleGeometryModifier\_Polygonalization(LineStyleGeometryModifier)[¶](#linestylegeometrymodifier-polygonalization-linestylegeometrymodifier "Link to this heading")
...
*class* bpy.types.LineStyleGeometryModifier\_Polygonalization(*LineStyleGeometryModifier*)[¶](#bpy.types.LineStyleGeometryModifier_Polygonalization "Link to this definition")
:   Modify the stroke geometry so that it looks more ‘polygonal’

    error[¶](#bpy.types.LineStyleGeometryModifier_Polygonalization.error "Link to this definition")
    :   Maximum distance between the original stroke and its polygonal approximation

        Type:
        :   float in [-inf, inf], default 0.0

    expanded[¶](#bpy.types.LineStyleGeometryModifier_Polygonalization.expanded "Link to this definition")
    :   True if the modifier tab is expanded

        Type:
        :   boolean, default False

    type[¶](#bpy.types.LineStyleGeometryModifier_Polygonalization.type "Link to this definition")
    ...
    use[¶](#bpy.types.LineStyleGeometryModifier_Polygonalization.use "Link to this definition")
    :   Enable or disable this modifier during stroke rendering

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.LineStyleGeometryModifier_Polygonalization.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.LineStyleGeometryModifier_Polygonalization.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
        ...
        Return type:
        :   [type](#bpy.types.LineStyleGeometryModifier_Polygonalization.type "bpy.types.LineStyleGeometryModifier_Polygonalization.type")
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.LineStyleGeometryModifier_Polygonalization.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.LineStyleGeometryModifier_Polygonalization.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* LineStyleGeometryModifier\_Polygonalization(LineStyleGeometryModifier)
  + [`LineStyleGeometryModifier_Polygonalization`](#bpy.types.LineStyleGeometryModifier_Polygonalization)
    - [`LineStyleGeometryModifier_Polygonalization.error`](#bpy.types.LineStyleGeometryModifier_Polygonalization.error)
    - [`LineStyleGeometryModifier_Polygonalization.expanded`](#bpy.types.LineStyleGeometryModifier_Polygonalization.expanded)
    - [`LineStyleGeometryModifier_Polygonalization.type`](#bpy.types.LineStyleGeometryModifier_Polygonalization.type)
    - [`LineStyleGeometryModifier_Polygonalization.use`](#bpy.types.LineStyleGeometryModifier_Polygonalization.use)
    - [`LineStyleGeometryModifier_Polygonalization.bl_rna_get_subclass()`](#bpy.types.LineStyleGeometryModifier_Polygonalization.bl_rna_get_subclass)
    - [`LineStyleGeometryModifier_Polygonalization.bl_rna_get_subclass_py()`](#bpy.types.LineStyleGeometryModifier_Polygonalization.bl_rna_get_subclass_py)
