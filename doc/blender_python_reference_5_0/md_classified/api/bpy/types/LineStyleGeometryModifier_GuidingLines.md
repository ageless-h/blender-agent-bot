...
# LineStyleGeometryModifier\_GuidingLines(LineStyleGeometryModifier)[¶](#linestylegeometrymodifier-guidinglines-linestylegeometrymodifier "Link to this heading")
...
*class* bpy.types.LineStyleGeometryModifier\_GuidingLines(*LineStyleGeometryModifier*)[¶](#bpy.types.LineStyleGeometryModifier_GuidingLines "Link to this definition")
:   Modify the stroke geometry so that it corresponds to its main direction line

    expanded[¶](#bpy.types.LineStyleGeometryModifier_GuidingLines.expanded "Link to this definition")
    :   True if the modifier tab is expanded

        Type:
        :   boolean, default False

    offset[¶](#bpy.types.LineStyleGeometryModifier_GuidingLines.offset "Link to this definition")
    :   Displacement that is applied to the main direction line along its normal

        Type:
        :   float in [-inf, inf], default 0.0

    type[¶](#bpy.types.LineStyleGeometryModifier_GuidingLines.type "Link to this definition")
    ...
    use[¶](#bpy.types.LineStyleGeometryModifier_GuidingLines.use "Link to this definition")
    :   Enable or disable this modifier during stroke rendering

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.LineStyleGeometryModifier_GuidingLines.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.LineStyleGeometryModifier_GuidingLines.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.LineStyleGeometryModifier_GuidingLines.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.LineStyleGeometryModifier_GuidingLines.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* LineStyleGeometryModifier\_GuidingLines(LineStyleGeometryModifier)
  + [`LineStyleGeometryModifier_GuidingLines`](#bpy.types.LineStyleGeometryModifier_GuidingLines)
    - [`LineStyleGeometryModifier_GuidingLines.expanded`](#bpy.types.LineStyleGeometryModifier_GuidingLines.expanded)
    - [`LineStyleGeometryModifier_GuidingLines.offset`](#bpy.types.LineStyleGeometryModifier_GuidingLines.offset)
    - [`LineStyleGeometryModifier_GuidingLines.type`](#bpy.types.LineStyleGeometryModifier_GuidingLines.type)
    - [`LineStyleGeometryModifier_GuidingLines.use`](#bpy.types.LineStyleGeometryModifier_GuidingLines.use)
    - [`LineStyleGeometryModifier_GuidingLines.bl_rna_get_subclass()`](#bpy.types.LineStyleGeometryModifier_GuidingLines.bl_rna_get_subclass)
    - [`LineStyleGeometryModifier_GuidingLines.bl_rna_get_subclass_py()`](#bpy.types.LineStyleGeometryModifier_GuidingLines.bl_rna_get_subclass_py)
