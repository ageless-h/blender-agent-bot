...
# CurvePoint(bpy\_struct)[¶](#curvepoint-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.CurvePoint(*bpy\_struct*)[¶](#bpy.types.CurvePoint "Link to this definition")
:   Curve control point

    index[¶](#bpy.types.CurvePoint.index "Link to this definition")
    :   Index of this point

        Type:
        :   int in [0, inf], default 0, (readonly)

    position[¶](#bpy.types.CurvePoint.position "Link to this definition")
    :   Type:
        :   [`mathutils.Vector`](../../mathutils/index.md#mathutils.Vector "mathutils.Vector") of 3 items in [-inf, inf], default (0.0, 0.0, 0.0)

    radius[¶](#bpy.types.CurvePoint.radius "Link to this definition")
    :   Type:
        :   float in [-inf, inf], default 0.0

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.CurvePoint.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.CurvePoint.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`CurveSlice.points`](CurveSlice.md#bpy.types.CurveSlice.points "bpy.types.CurveSlice.points") | * [`Curves.points`](Curves.md#bpy.types.Curves.points "bpy.types.Curves.points") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CurvePoint.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.CurvePoint.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CurvePoint(bpy\_struct)
  + [`CurvePoint`](#bpy.types.CurvePoint)
    - [`CurvePoint.index`](#bpy.types.CurvePoint.index)
    - [`CurvePoint.position`](#bpy.types.CurvePoint.position)
    - [`CurvePoint.radius`](#bpy.types.CurvePoint.radius)
    - [`CurvePoint.bl_rna_get_subclass()`](#bpy.types.CurvePoint.bl_rna_get_subclass)
    - [`CurvePoint.bl_rna_get_subclass_py()`](#bpy.types.CurvePoint.bl_rna_get_subclass_py)
