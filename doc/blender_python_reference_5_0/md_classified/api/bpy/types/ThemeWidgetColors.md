...
# ThemeWidgetColors(bpy\_struct)[¶](#themewidgetcolors-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.ThemeWidgetColors(*bpy\_struct*)[¶](#bpy.types.ThemeWidgetColors "Link to this definition")
:   Theme settings for widget color sets

    inner[¶](#bpy.types.ThemeWidgetColors.inner "Link to this definition")
    :   Type:
        :   float array of 4 items in [0, 1], default (0.0, 0.0, 0.0, 0.0)

    inner\_sel[¶](#bpy.types.ThemeWidgetColors.inner_sel "Link to this definition")
    :   Type:
        :   float array of 4 items in [0, 1], default (0.0, 0.0, 0.0, 0.0)

    item[¶](#bpy.types.ThemeWidgetColors.item "Link to this definition")
    :   Type:
        :   float array of 4 items in [0, 1], default (0.0, 0.0, 0.0, 0.0)

    outline[¶](#bpy.types.ThemeWidgetColors.outline "Link to this definition")
    :   Type:
        :   float array of 4 items in [0, 1], default (0.0, 0.0, 0.0, 0.0)

    outline\_sel[¶](#bpy.types.ThemeWidgetColors.outline_sel "Link to this definition")
    :   Type:
        :   float array of 4 items in [0, 1], default (0.0, 0.0, 0.0, 0.0)

    roundness[¶](#bpy.types.ThemeWidgetColors.roundness "Link to this definition")
    :   Amount of edge rounding

        Type:
        :   float in [0, 1], default 0.0

    shadedown[¶](#bpy.types.ThemeWidgetColors.shadedown "Link to this definition")
    :   Type:
        :   int in [-100, 100], default 0

    shadetop[¶](#bpy.types.ThemeWidgetColors.shadetop "Link to this definition")
    :   Type:
        :   int in [-100, 100], default 0

    show\_shaded[¶](#bpy.types.ThemeWidgetColors.show_shaded "Link to this definition")
    :   Type:
        :   boolean, default False

    text[¶](#bpy.types.ThemeWidgetColors.text "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    text\_sel[¶](#bpy.types.ThemeWidgetColors.text_sel "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ThemeWidgetColors.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ThemeWidgetColors.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`ThemeUserInterface.wcol_box`](ThemeUserInterface.md#bpy.types.ThemeUserInterface.wcol_box "bpy.types.ThemeUserInterface.wcol_box") * [`ThemeUserInterface.wcol_curve`](ThemeUserInterface.md#bpy.types.ThemeUserInterface.wcol_curve "bpy.types.ThemeUserInterface.wcol_curve") * [`ThemeUserInterface.wcol_list_item`](ThemeUserInterface.md#bpy.types.ThemeUserInterface.wcol_list_item "bpy.types.ThemeUserInterface.wcol_list_item") * [`ThemeUserInterface.wcol_menu`](ThemeUserInterface.md#bpy.types.ThemeUserInterface.wcol_menu "bpy.types.ThemeUserInterface.wcol_menu") * [`ThemeUserInterface.wcol_menu_back`](ThemeUserInterface.md#bpy.types.ThemeUserInterface.wcol_menu_back "bpy.types.ThemeUserInterface.wcol_menu_back") * [`ThemeUserInterface.wcol_menu_item`](ThemeUserInterface.md#bpy.types.ThemeUserInterface.wcol_menu_item "bpy.types.ThemeUserInterface.wcol_menu_item") * [`ThemeUserInterface.wcol_num`](ThemeUserInterface.md#bpy.types.ThemeUserInterface.wcol_num "bpy.types.ThemeUserInterface.wcol_num") * [`ThemeUserInterface.wcol_numslider`](ThemeUserInterface.md#bpy.types.ThemeUserInterface.wcol_numslider "bpy.types.ThemeUserInterface.wcol_numslider") * [`ThemeUserInterface.wcol_option`](ThemeUserInterface.md#bpy.types.ThemeUserInterface.wcol_option "bpy.types.ThemeUserInterface.wcol_option") * [`ThemeUserInterface.wcol_pie_menu`](ThemeUserInterface.md#bpy.types.ThemeUserInterface.wcol_pie_menu "bpy.types.ThemeUserInterface.wcol_pie_menu") * [`ThemeUserInterface.wcol_progress`](ThemeUserInterface.md#bpy.types.ThemeUserInterface.wcol_progress "bpy.types.ThemeUserInterface.wcol_progress") | * [`ThemeUserInterface.wcol_pulldown`](ThemeUserInterface.md#bpy.types.ThemeUserInterface.wcol_pulldown "bpy.types.ThemeUserInterface.wcol_pulldown") * [`ThemeUserInterface.wcol_radio`](ThemeUserInterface.md#bpy.types.ThemeUserInterface.wcol_radio "bpy.types.ThemeUserInterface.wcol_radio") * [`ThemeUserInterface.wcol_regular`](ThemeUserInterface.md#bpy.types.ThemeUserInterface.wcol_regular "bpy.types.ThemeUserInterface.wcol_regular") * [`ThemeUserInterface.wcol_scroll`](ThemeUserInterface.md#bpy.types.ThemeUserInterface.wcol_scroll "bpy.types.ThemeUserInterface.wcol_scroll") * [`ThemeUserInterface.wcol_tab`](ThemeUserInterface.md#bpy.types.ThemeUserInterface.wcol_tab "bpy.types.ThemeUserInterface.wcol_tab") * [`ThemeUserInterface.wcol_text`](ThemeUserInterface.md#bpy.types.ThemeUserInterface.wcol_text "bpy.types.ThemeUserInterface.wcol_text") * [`ThemeUserInterface.wcol_toggle`](ThemeUserInterface.md#bpy.types.ThemeUserInterface.wcol_toggle "bpy.types.ThemeUserInterface.wcol_toggle") * [`ThemeUserInterface.wcol_tool`](ThemeUserInterface.md#bpy.types.ThemeUserInterface.wcol_tool "bpy.types.ThemeUserInterface.wcol_tool") * [`ThemeUserInterface.wcol_toolbar_item`](ThemeUserInterface.md#bpy.types.ThemeUserInterface.wcol_toolbar_item "bpy.types.ThemeUserInterface.wcol_toolbar_item") * [`ThemeUserInterface.wcol_tooltip`](ThemeUserInterface.md#bpy.types.ThemeUserInterface.wcol_tooltip "bpy.types.ThemeUserInterface.wcol_tooltip") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ThemeWidgetColors.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ThemeWidgetColors.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ThemeWidgetColors(bpy\_struct)
  + [`ThemeWidgetColors`](#bpy.types.ThemeWidgetColors)
    - [`ThemeWidgetColors.inner`](#bpy.types.ThemeWidgetColors.inner)
    - [`ThemeWidgetColors.inner_sel`](#bpy.types.ThemeWidgetColors.inner_sel)
    - [`ThemeWidgetColors.item`](#bpy.types.ThemeWidgetColors.item)
    - [`ThemeWidgetColors.outline`](#bpy.types.ThemeWidgetColors.outline)
    - [`ThemeWidgetColors.outline_sel`](#bpy.types.ThemeWidgetColors.outline_sel)
    - [`ThemeWidgetColors.roundness`](#bpy.types.ThemeWidgetColors.roundness)
    - [`ThemeWidgetColors.shadedown`](#bpy.types.ThemeWidgetColors.shadedown)
    - [`ThemeWidgetColors.shadetop`](#bpy.types.ThemeWidgetColors.shadetop)
    - [`ThemeWidgetColors.show_shaded`](#bpy.types.ThemeWidgetColors.show_shaded)
    - [`ThemeWidgetColors.text`](#bpy.types.ThemeWidgetColors.text)
    - [`ThemeWidgetColors.text_sel`](#bpy.types.ThemeWidgetColors.text_sel)
    - [`ThemeWidgetColors.bl_rna_get_subclass()`](#bpy.types.ThemeWidgetColors.bl_rna_get_subclass)
    - [`ThemeWidgetColors.bl_rna_get_subclass_py()`](#bpy.types.ThemeWidgetColors.bl_rna_get_subclass_py)
