...
# ColorRampElement(bpy\_struct)[¶](#colorrampelement-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.ColorRampElement(*bpy\_struct*)[¶](#bpy.types.ColorRampElement "Link to this definition")
:   Element defining a color at a position in the color ramp

    alpha[¶](#bpy.types.ColorRampElement.alpha "Link to this definition")
    :   Set alpha of selected color stop

        Type:
        :   float in [0, inf], default 0.0

    color[¶](#bpy.types.ColorRampElement.color "Link to this definition")
    :   Set color of selected color stop

        Type:
        :   float array of 4 items in [0, inf], default (0.0, 0.0, 0.0, 0.0)

    position[¶](#bpy.types.ColorRampElement.position "Link to this definition")
    :   Set position of selected color stop

        Type:
        :   float in [0, 1], default 0.0

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ColorRampElement.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ColorRampElement.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`ColorRamp.elements`](ColorRamp.md#bpy.types.ColorRamp.elements "bpy.types.ColorRamp.elements") * [`ColorRampElements.new`](ColorRampElements.md#bpy.types.ColorRampElements.new "bpy.types.ColorRampElements.new") | * [`ColorRampElements.remove`](ColorRampElements.md#bpy.types.ColorRampElements.remove "bpy.types.ColorRampElements.remove") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ColorRampElement.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ColorRampElement.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ColorRampElement(bpy\_struct)
  + [`ColorRampElement`](#bpy.types.ColorRampElement)
    - [`ColorRampElement.alpha`](#bpy.types.ColorRampElement.alpha)
    - [`ColorRampElement.color`](#bpy.types.ColorRampElement.color)
    - [`ColorRampElement.position`](#bpy.types.ColorRampElement.position)
    - [`ColorRampElement.bl_rna_get_subclass()`](#bpy.types.ColorRampElement.bl_rna_get_subclass)
    - [`ColorRampElement.bl_rna_get_subclass_py()`](#bpy.types.ColorRampElement.bl_rna_get_subclass_py)
