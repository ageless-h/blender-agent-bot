...
# IKParam(bpy\_struct)[¶](#ikparam-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

subclasses —
[`Itasc`](Itasc.md#bpy.types.Itasc "bpy.types.Itasc")

*class* bpy.types.IKParam(*bpy\_struct*)[¶](#bpy.types.IKParam "Link to this definition")
:   Base type for IK solver parameters

    ik\_solver[¶](#bpy.types.IKParam.ik_solver "Link to this definition")
    :   IK solver for which these parameters are defined
        ...
        * `ITASC`
        ...
        Type:
        :   enum in [`'LEGACY'`, `'ITASC'`], default `'LEGACY'`, (readonly)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.IKParam.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.IKParam.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Pose.ik_param`](Pose.md#bpy.types.Pose.ik_param "bpy.types.Pose.ik_param") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.IKParam.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.IKParam.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* IKParam(bpy\_struct)
  + [`IKParam`](#bpy.types.IKParam)
    - [`IKParam.ik_solver`](#bpy.types.IKParam.ik_solver)
    - [`IKParam.bl_rna_get_subclass()`](#bpy.types.IKParam.bl_rna_get_subclass)
    - [`IKParam.bl_rna_get_subclass_py()`](#bpy.types.IKParam.bl_rna_get_subclass_py)
