...
# BlendDataWindowManagers(bpy\_struct)[¶](#blenddatawindowmanagers-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.BlendDataWindowManagers(*bpy\_struct*)[¶](#bpy.types.BlendDataWindowManagers "Link to this definition")
:   Collection of window managers

    tag(*value*)[¶](#bpy.types.BlendDataWindowManagers.tag "Link to this definition")
    :   tag

        Parameters:
        :   **value** (*boolean*) – Value

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.BlendDataWindowManagers.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.BlendDataWindowManagers.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`BlendData.window_managers`](BlendData.md#bpy.types.BlendData.window_managers "bpy.types.BlendData.window_managers") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.BlendDataWindowManagers.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.BlendDataWindowManagers.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* BlendDataWindowManagers(bpy\_struct)
  + [`BlendDataWindowManagers`](#bpy.types.BlendDataWindowManagers)
    - [`BlendDataWindowManagers.tag()`](#bpy.types.BlendDataWindowManagers.tag)
    - [`BlendDataWindowManagers.bl_rna_get_subclass()`](#bpy.types.BlendDataWindowManagers.bl_rna_get_subclass)
    - [`BlendDataWindowManagers.bl_rna_get_subclass_py()`](#bpy.types.BlendDataWindowManagers.bl_rna_get_subclass_py)
