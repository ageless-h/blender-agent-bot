...
# DynamicPaintCanvasSettings(bpy\_struct)[¶](#dynamicpaintcanvassettings-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.DynamicPaintCanvasSettings(*bpy\_struct*)[¶](#bpy.types.DynamicPaintCanvasSettings "Link to this definition")
:   Dynamic Paint canvas settings

    canvas\_surfaces[¶](#bpy.types.DynamicPaintCanvasSettings.canvas_surfaces "Link to this definition")
    :   Paint surface list

        Type:
        :   [`DynamicPaintSurfaces`](DynamicPaintSurfaces.md#bpy.types.DynamicPaintSurfaces "bpy.types.DynamicPaintSurfaces") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`DynamicPaintSurface`](DynamicPaintSurface.md#bpy.types.DynamicPaintSurface "bpy.types.DynamicPaintSurface"), (readonly)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.DynamicPaintCanvasSettings.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.DynamicPaintCanvasSettings.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`DynamicPaintModifier.canvas_settings`](DynamicPaintModifier.md#bpy.types.DynamicPaintModifier.canvas_settings "bpy.types.DynamicPaintModifier.canvas_settings") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.DynamicPaintCanvasSettings.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.DynamicPaintCanvasSettings.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* DynamicPaintCanvasSettings(bpy\_struct)
  + [`DynamicPaintCanvasSettings`](#bpy.types.DynamicPaintCanvasSettings)
    - [`DynamicPaintCanvasSettings.canvas_surfaces`](#bpy.types.DynamicPaintCanvasSettings.canvas_surfaces)
    - [`DynamicPaintCanvasSettings.bl_rna_get_subclass()`](#bpy.types.DynamicPaintCanvasSettings.bl_rna_get_subclass)
    - [`DynamicPaintCanvasSettings.bl_rna_get_subclass_py()`](#bpy.types.DynamicPaintCanvasSettings.bl_rna_get_subclass_py)
