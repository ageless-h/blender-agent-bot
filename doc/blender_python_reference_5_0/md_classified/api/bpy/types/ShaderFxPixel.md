...
# ShaderFxPixel(ShaderFx)[¶](#shaderfxpixel-shaderfx "Link to this heading")
...
*class* bpy.types.ShaderFxPixel(*ShaderFx*)[¶](#bpy.types.ShaderFxPixel "Link to this definition")
:   Pixelate effect

    size[¶](#bpy.types.ShaderFxPixel.size "Link to this definition")
    :   Pixel size

        Type:
        :   int array of 2 items in [1, 32767], default (0, 0)

    use\_antialiasing[¶](#bpy.types.ShaderFxPixel.use_antialiasing "Link to this definition")
    :   Antialias pixels

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ShaderFxPixel.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ShaderFxPixel.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ShaderFxPixel.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ShaderFxPixel.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ShaderFxPixel(ShaderFx)
  + [`ShaderFxPixel`](#bpy.types.ShaderFxPixel)
    - [`ShaderFxPixel.size`](#bpy.types.ShaderFxPixel.size)
    - [`ShaderFxPixel.use_antialiasing`](#bpy.types.ShaderFxPixel.use_antialiasing)
    - [`ShaderFxPixel.bl_rna_get_subclass()`](#bpy.types.ShaderFxPixel.bl_rna_get_subclass)
    - [`ShaderFxPixel.bl_rna_get_subclass_py()`](#bpy.types.ShaderFxPixel.bl_rna_get_subclass_py)
