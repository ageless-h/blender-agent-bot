...
# MaterialSlot(bpy\_struct)[¶](#materialslot-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.MaterialSlot(*bpy\_struct*)[¶](#bpy.types.MaterialSlot "Link to this definition")
:   Material slot in an object

    link[¶](#bpy.types.MaterialSlot.link "Link to this definition")
    :   Link material to object or the object’s data

        Type:
        :   enum in [`'OBJECT'`, `'DATA'`], default `'DATA'`

    material[¶](#bpy.types.MaterialSlot.material "Link to this definition")
    :   Material data-block used by this material slot

        Type:
        :   [`Material`](Material.md#bpy.types.Material "bpy.types.Material")

    name[¶](#bpy.types.MaterialSlot.name "Link to this definition")
    :   Material slot name

        Type:
        :   string, default “”, (readonly, never None)

    slot\_index[¶](#bpy.types.MaterialSlot.slot_index "Link to this definition")
    :   Type:
        :   int in [-inf, inf], default 0, (readonly)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.MaterialSlot.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.MaterialSlot.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`bpy.context.material_slot`](../context/index.md#bpy.context.material_slot "bpy.context.material_slot") | * [`Object.material_slots`](Object.md#bpy.types.Object.material_slots "bpy.types.Object.material_slots") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.MaterialSlot.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.MaterialSlot.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* MaterialSlot(bpy\_struct)
  + [`MaterialSlot`](#bpy.types.MaterialSlot)
    - [`MaterialSlot.link`](#bpy.types.MaterialSlot.link)
    - [`MaterialSlot.material`](#bpy.types.MaterialSlot.material)
    - [`MaterialSlot.name`](#bpy.types.MaterialSlot.name)
    - [`MaterialSlot.slot_index`](#bpy.types.MaterialSlot.slot_index)
    - [`MaterialSlot.bl_rna_get_subclass()`](#bpy.types.MaterialSlot.bl_rna_get_subclass)
    - [`MaterialSlot.bl_rna_get_subclass_py()`](#bpy.types.MaterialSlot.bl_rna_get_subclass_py)
