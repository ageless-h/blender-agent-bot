...
# ActionStrip(bpy\_struct)[¶](#actionstrip-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

subclasses —
[`ActionKeyframeStrip`](ActionKeyframeStrip.md#bpy.types.ActionKeyframeStrip "bpy.types.ActionKeyframeStrip")

*class* bpy.types.ActionStrip(*bpy\_struct*)[¶](#bpy.types.ActionStrip "Link to this definition")
:   type[¶](#bpy.types.ActionStrip.type "Link to this definition")
    :   * `KEYFRAME`
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ActionStrip.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ActionStrip.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
        ...
        Return type:
        :   [type](#bpy.types.ActionStrip.type "bpy.types.ActionStrip.type")
...
|  |  |
| --- | --- |
| * [`ActionLayer.strips`](ActionLayer.md#bpy.types.ActionLayer.strips "bpy.types.ActionLayer.strips") * [`ActionStrips.new`](ActionStrips.md#bpy.types.ActionStrips.new "bpy.types.ActionStrips.new") | * [`ActionStrips.remove`](ActionStrips.md#bpy.types.ActionStrips.remove "bpy.types.ActionStrips.remove") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ActionStrip.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ActionStrip.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ActionStrip(bpy\_struct)
  + [`ActionStrip`](#bpy.types.ActionStrip)
    - [`ActionStrip.type`](#bpy.types.ActionStrip.type)
    - [`ActionStrip.bl_rna_get_subclass()`](#bpy.types.ActionStrip.bl_rna_get_subclass)
    - [`ActionStrip.bl_rna_get_subclass_py()`](#bpy.types.ActionStrip.bl_rna_get_subclass_py)
