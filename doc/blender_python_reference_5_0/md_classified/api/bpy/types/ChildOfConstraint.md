...
# ChildOfConstraint(Constraint)[¶](#childofconstraint-constraint "Link to this heading")
...
*class* bpy.types.ChildOfConstraint(*Constraint*)[¶](#bpy.types.ChildOfConstraint "Link to this definition")
:   Create constraint-based parent-child relationship

    inverse\_matrix[¶](#bpy.types.ChildOfConstraint.inverse_matrix "Link to this definition")
    ...
    set\_inverse\_pending[¶](#bpy.types.ChildOfConstraint.set_inverse_pending "Link to this definition")
    :   Set to true to request recalculation of the inverse matrix

        Type:
        :   boolean, default False

    subtarget[¶](#bpy.types.ChildOfConstraint.subtarget "Link to this definition")
    :   Armature bone, mesh or lattice vertex group, …

        Type:
        :   string, default “”, (never None)

    target[¶](#bpy.types.ChildOfConstraint.target "Link to this definition")
    :   Target object

        Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object")

    use\_location\_x[¶](#bpy.types.ChildOfConstraint.use_location_x "Link to this definition")
    :   Use X Location of Parent

        Type:
        :   boolean, default False

    use\_location\_y[¶](#bpy.types.ChildOfConstraint.use_location_y "Link to this definition")
    :   Use Y Location of Parent

        Type:
        :   boolean, default False

    use\_location\_z[¶](#bpy.types.ChildOfConstraint.use_location_z "Link to this definition")
    :   Use Z Location of Parent

        Type:
        :   boolean, default False

    use\_rotation\_x[¶](#bpy.types.ChildOfConstraint.use_rotation_x "Link to this definition")
    :   Use X Rotation of Parent

        Type:
        :   boolean, default False

    use\_rotation\_y[¶](#bpy.types.ChildOfConstraint.use_rotation_y "Link to this definition")
    :   Use Y Rotation of Parent

        Type:
        :   boolean, default False

    use\_rotation\_z[¶](#bpy.types.ChildOfConstraint.use_rotation_z "Link to this definition")
    :   Use Z Rotation of Parent

        Type:
        :   boolean, default False

    use\_scale\_x[¶](#bpy.types.ChildOfConstraint.use_scale_x "Link to this definition")
    :   Use X Scale of Parent

        Type:
        :   boolean, default False

    use\_scale\_y[¶](#bpy.types.ChildOfConstraint.use_scale_y "Link to this definition")
    :   Use Y Scale of Parent

        Type:
        :   boolean, default False

    use\_scale\_z[¶](#bpy.types.ChildOfConstraint.use_scale_z "Link to this definition")
    :   Use Z Scale of Parent

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ChildOfConstraint.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ChildOfConstraint.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ChildOfConstraint.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ChildOfConstraint.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ChildOfConstraint(Constraint)
  + [`ChildOfConstraint`](#bpy.types.ChildOfConstraint)
    - [`ChildOfConstraint.inverse_matrix`](#bpy.types.ChildOfConstraint.inverse_matrix)
    - [`ChildOfConstraint.set_inverse_pending`](#bpy.types.ChildOfConstraint.set_inverse_pending)
    - [`ChildOfConstraint.subtarget`](#bpy.types.ChildOfConstraint.subtarget)
    - [`ChildOfConstraint.target`](#bpy.types.ChildOfConstraint.target)
    - [`ChildOfConstraint.use_location_x`](#bpy.types.ChildOfConstraint.use_location_x)
    - [`ChildOfConstraint.use_location_y`](#bpy.types.ChildOfConstraint.use_location_y)
    - [`ChildOfConstraint.use_location_z`](#bpy.types.ChildOfConstraint.use_location_z)
    - [`ChildOfConstraint.use_rotation_x`](#bpy.types.ChildOfConstraint.use_rotation_x)
    - [`ChildOfConstraint.use_rotation_y`](#bpy.types.ChildOfConstraint.use_rotation_y)
    - [`ChildOfConstraint.use_rotation_z`](#bpy.types.ChildOfConstraint.use_rotation_z)
    - [`ChildOfConstraint.use_scale_x`](#bpy.types.ChildOfConstraint.use_scale_x)
    - [`ChildOfConstraint.use_scale_y`](#bpy.types.ChildOfConstraint.use_scale_y)
    - [`ChildOfConstraint.use_scale_z`](#bpy.types.ChildOfConstraint.use_scale_z)
    - [`ChildOfConstraint.bl_rna_get_subclass()`](#bpy.types.ChildOfConstraint.bl_rna_get_subclass)
    - [`ChildOfConstraint.bl_rna_get_subclass_py()`](#bpy.types.ChildOfConstraint.bl_rna_get_subclass_py)
