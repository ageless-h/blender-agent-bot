...
subclasses —
[`CompositorNode`](CompositorNode.md#bpy.types.CompositorNode "bpy.types.CompositorNode"), [`FunctionNode`](FunctionNode.md#bpy.types.FunctionNode "bpy.types.FunctionNode"), [`GeometryNode`](GeometryNode.md#bpy.types.GeometryNode "bpy.types.GeometryNode"), [`NodeClosureInput`](NodeClosureInput.md#bpy.types.NodeClosureInput "bpy.types.NodeClosureInput"), [`NodeClosureOutput`](NodeClosureOutput.md#bpy.types.NodeClosureOutput "bpy.types.NodeClosureOutput"), [`NodeCombineBundle`](NodeCombineBundle.md#bpy.types.NodeCombineBundle "bpy.types.NodeCombineBundle"), [`NodeEnableOutput`](NodeEnableOutput.md#bpy.types.NodeEnableOutput "bpy.types.NodeEnableOutput"), [`NodeEvaluateClosure`](NodeEvaluateClosure.md#bpy.types.NodeEvaluateClosure "bpy.types.NodeEvaluateClosure"), [`NodeFrame`](NodeFrame.md#bpy.types.NodeFrame "bpy.types.NodeFrame"), [`NodeGroup`](NodeGroup.md#bpy.types.NodeGroup "bpy.types.NodeGroup"), [`NodeGroupInput`](NodeGroupInput.md#bpy.types.NodeGroupInput "bpy.types.NodeGroupInput"), [`NodeGroupOutput`](NodeGroupOutput.md#bpy.types.NodeGroupOutput "bpy.types.NodeGroupOutput"), [`NodeJoinBundle`](NodeJoinBundle.md#bpy.types.NodeJoinBundle "bpy.types.NodeJoinBundle"), [`NodeReroute`](NodeReroute.md#bpy.types.NodeReroute "bpy.types.NodeReroute"), [`NodeSeparateBundle`](NodeSeparateBundle.md#bpy.types.NodeSeparateBundle "bpy.types.NodeSeparateBundle"), [`ShaderNode`](ShaderNode.md#bpy.types.ShaderNode "bpy.types.ShaderNode"), [`TextureNode`](TextureNode.md#bpy.types.TextureNode "bpy.types.TextureNode")
...
|  |  |
| --- | --- |
| * [`GeometryNodeForeachGeometryElementInput.pair_with_output`](GeometryNodeForeachGeometryElementInput.md#bpy.types.GeometryNodeForeachGeometryElementInput.pair_with_output "bpy.types.GeometryNodeForeachGeometryElementInput.pair_with_output") * [`GeometryNodeRepeatInput.pair_with_output`](GeometryNodeRepeatInput.md#bpy.types.GeometryNodeRepeatInput.pair_with_output "bpy.types.GeometryNodeRepeatInput.pair_with_output") | * [`GeometryNodeSimulationInput.pair_with_output`](GeometryNodeSimulationInput.md#bpy.types.GeometryNodeSimulationInput.pair_with_output "bpy.types.GeometryNodeSimulationInput.pair_with_output") * [`NodeClosureInput.pair_with_output`](NodeClosureInput.md#bpy.types.NodeClosureInput.pair_with_output "bpy.types.NodeClosureInput.pair_with_output") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.NodeInternal.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.NodeInternal.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)
