...
# BlendFileColorspace(bpy\_struct)[¶](#blendfilecolorspace-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.BlendFileColorspace(*bpy\_struct*)[¶](#bpy.types.BlendFileColorspace "Link to this definition")
:   Information about the color space used for data-blocks in a blend file

    is\_missing\_opencolorio\_config[¶](#bpy.types.BlendFileColorspace.is_missing_opencolorio_config "Link to this definition")
    ...
    working\_space[¶](#bpy.types.BlendFileColorspace.working_space "Link to this definition")
    ...
    working\_space\_interop\_id[¶](#bpy.types.BlendFileColorspace.working_space_interop_id "Link to this definition")
    :   Unique identifier for common color spaces, as defined by the Color Interop Forum. May be empty if there is no interop ID for the working space. Common values are lin\_rec709\_scene, lin\_rec2020\_scene and lin\_ap1\_scene (for ACEScg)

        Type:
        :   string, default “”, (readonly, never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.BlendFileColorspace.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.BlendFileColorspace.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`BlendData.colorspace`](BlendData.md#bpy.types.BlendData.colorspace "bpy.types.BlendData.colorspace") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.BlendFileColorspace.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.BlendFileColorspace.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* BlendFileColorspace(bpy\_struct)
  + [`BlendFileColorspace`](#bpy.types.BlendFileColorspace)
    - [`BlendFileColorspace.is_missing_opencolorio_config`](#bpy.types.BlendFileColorspace.is_missing_opencolorio_config)
    - [`BlendFileColorspace.working_space`](#bpy.types.BlendFileColorspace.working_space)
    - [`BlendFileColorspace.working_space_interop_id`](#bpy.types.BlendFileColorspace.working_space_interop_id)
    - [`BlendFileColorspace.bl_rna_get_subclass()`](#bpy.types.BlendFileColorspace.bl_rna_get_subclass)
    - [`BlendFileColorspace.bl_rna_get_subclass_py()`](#bpy.types.BlendFileColorspace.bl_rna_get_subclass_py)
