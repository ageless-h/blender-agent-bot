...
# MaterialLineArt(bpy\_struct)[¶](#materiallineart-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.MaterialLineArt(*bpy\_struct*)[¶](#bpy.types.MaterialLineArt "Link to this definition")
:   intersection\_priority[¶](#bpy.types.MaterialLineArt.intersection_priority "Link to this definition")
    :   The intersection line will be included into the object with the higher intersection priority value

        Type:
        :   int in [0, 255], default 0

    mat\_occlusion[¶](#bpy.types.MaterialLineArt.mat_occlusion "Link to this definition")
    :   Faces with this material will behave as if it has set number of layers in occlusion

        Type:
        :   int in [0, 255], default 1

    use\_intersection\_priority\_override[¶](#bpy.types.MaterialLineArt.use_intersection_priority_override "Link to this definition")
    :   Override object and collection intersection priority value

        Type:
        :   boolean, default False

    use\_material\_mask[¶](#bpy.types.MaterialLineArt.use_material_mask "Link to this definition")
    :   Use material masks to filter out occluded strokes

        Type:
        :   boolean, default False

    use\_material\_mask\_bits[¶](#bpy.types.MaterialLineArt.use_material_mask_bits "Link to this definition")
    :   Type:
        :   boolean array of 8 items, default (False, False, False, False, False, False, False, False)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.MaterialLineArt.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.MaterialLineArt.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Material.lineart`](Material.md#bpy.types.Material.lineart "bpy.types.Material.lineart") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.MaterialLineArt.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.MaterialLineArt.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* MaterialLineArt(bpy\_struct)
  + [`MaterialLineArt`](#bpy.types.MaterialLineArt)
    - [`MaterialLineArt.intersection_priority`](#bpy.types.MaterialLineArt.intersection_priority)
    - [`MaterialLineArt.mat_occlusion`](#bpy.types.MaterialLineArt.mat_occlusion)
    - [`MaterialLineArt.use_intersection_priority_override`](#bpy.types.MaterialLineArt.use_intersection_priority_override)
    - [`MaterialLineArt.use_material_mask`](#bpy.types.MaterialLineArt.use_material_mask)
    - [`MaterialLineArt.use_material_mask_bits`](#bpy.types.MaterialLineArt.use_material_mask_bits)
    - [`MaterialLineArt.bl_rna_get_subclass()`](#bpy.types.MaterialLineArt.bl_rna_get_subclass)
    - [`MaterialLineArt.bl_rna_get_subclass_py()`](#bpy.types.MaterialLineArt.bl_rna_get_subclass_py)
