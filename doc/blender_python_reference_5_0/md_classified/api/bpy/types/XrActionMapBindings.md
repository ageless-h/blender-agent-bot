...
# XrActionMapBindings(bpy\_struct)[¶](#xractionmapbindings-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.XrActionMapBindings(*bpy\_struct*)[¶](#bpy.types.XrActionMapBindings "Link to this definition")
:   Collection of XR action map bindings

    new(*name*, *replace\_existing*)[¶](#bpy.types.XrActionMapBindings.new "Link to this definition")
    :   new

        Parameters:
        :   * **name** (*string**,* *(**never None**)*) – Name of the action map binding
            * **replace\_existing** (*boolean*) – Replace Existing, Replace any existing binding with the same name

        Returns:
        :   Binding, Added action map binding

        Return type:
        :   [`XrActionMapBinding`](XrActionMapBinding.md#bpy.types.XrActionMapBinding "bpy.types.XrActionMapBinding")

    new\_from\_binding(*binding*)[¶](#bpy.types.XrActionMapBindings.new_from_binding "Link to this definition")
    :   new\_from\_binding

        Parameters:
        :   **binding** ([`XrActionMapBinding`](XrActionMapBinding.md#bpy.types.XrActionMapBinding "bpy.types.XrActionMapBinding"), (never None)) – Binding, Binding to use as a reference
    ...
    remove(*binding*)[¶](#bpy.types.XrActionMapBindings.remove "Link to this definition")
    :   remove

        Parameters:
        :   **binding** ([`XrActionMapBinding`](XrActionMapBinding.md#bpy.types.XrActionMapBinding "bpy.types.XrActionMapBinding"), (never None)) – Binding

    find(*name*)[¶](#bpy.types.XrActionMapBindings.find "Link to this definition")
    :   find
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.XrActionMapBindings.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.XrActionMapBindings.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`XrActionMapItem.bindings`](XrActionMapItem.md#bpy.types.XrActionMapItem.bindings "bpy.types.XrActionMapItem.bindings") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.XrActionMapBindings.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.XrActionMapBindings.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* XrActionMapBindings(bpy\_struct)
  + [`XrActionMapBindings`](#bpy.types.XrActionMapBindings)
    - [`XrActionMapBindings.new()`](#bpy.types.XrActionMapBindings.new)
    - [`XrActionMapBindings.new_from_binding()`](#bpy.types.XrActionMapBindings.new_from_binding)
    - [`XrActionMapBindings.remove()`](#bpy.types.XrActionMapBindings.remove)
    - [`XrActionMapBindings.find()`](#bpy.types.XrActionMapBindings.find)
    - [`XrActionMapBindings.bl_rna_get_subclass()`](#bpy.types.XrActionMapBindings.bl_rna_get_subclass)
    - [`XrActionMapBindings.bl_rna_get_subclass_py()`](#bpy.types.XrActionMapBindings.bl_rna_get_subclass_py)
