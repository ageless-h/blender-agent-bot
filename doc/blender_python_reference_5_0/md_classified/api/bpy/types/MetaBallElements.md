...
# MetaBallElements(bpy\_struct)[¶](#metaballelements-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.MetaBallElements(*bpy\_struct*)[¶](#bpy.types.MetaBallElements "Link to this definition")
:   Collection of metaball elements

    active[¶](#bpy.types.MetaBallElements.active "Link to this definition")
    :   Last selected element

        Type:
        :   [`MetaElement`](MetaElement.md#bpy.types.MetaElement "bpy.types.MetaElement"), (readonly)

    new(*\**, *type='BALL'*)[¶](#bpy.types.MetaBallElements.new "Link to this definition")
    :   Add a new element to the metaball

        Parameters:
        :   **type** (enum in [Metaelem Type Items](../../../appendix/bpy_types_enum_items/metaelem_type_items.md#rna-enum-metaelem-type-items), (optional)) – Type for the new metaball element

        Returns:
        :   The newly created metaball element

        Return type:
        :   [`MetaElement`](MetaElement.md#bpy.types.MetaElement "bpy.types.MetaElement")

    remove(*element*)[¶](#bpy.types.MetaBallElements.remove "Link to this definition")
    :   Remove an element from the metaball

        Parameters:
        :   **element** ([`MetaElement`](MetaElement.md#bpy.types.MetaElement "bpy.types.MetaElement"), (never None)) – The element to remove

    clear()[¶](#bpy.types.MetaBallElements.clear "Link to this definition")
    :   Remove all elements from the metaball

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.MetaBallElements.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.MetaBallElements.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`MetaBall.elements`](MetaBall.md#bpy.types.MetaBall.elements "bpy.types.MetaBall.elements") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.MetaBallElements.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.MetaBallElements.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* MetaBallElements(bpy\_struct)
  + [`MetaBallElements`](#bpy.types.MetaBallElements)
    - [`MetaBallElements.active`](#bpy.types.MetaBallElements.active)
    - [`MetaBallElements.new()`](#bpy.types.MetaBallElements.new)
    - [`MetaBallElements.remove()`](#bpy.types.MetaBallElements.remove)
    - [`MetaBallElements.clear()`](#bpy.types.MetaBallElements.clear)
    - [`MetaBallElements.bl_rna_get_subclass()`](#bpy.types.MetaBallElements.bl_rna_get_subclass)
    - [`MetaBallElements.bl_rna_get_subclass_py()`](#bpy.types.MetaBallElements.bl_rna_get_subclass_py)
