...
# NodeClosureOutput(NodeInternal)[¶](#nodeclosureoutput-nodeinternal "Link to this heading")
...
*class* bpy.types.NodeClosureOutput(*NodeInternal*)[¶](#bpy.types.NodeClosureOutput "Link to this definition")
:   active\_input\_index[¶](#bpy.types.NodeClosureOutput.active_input_index "Link to this definition")
    :   Index of the active item

        Type:
        :   int in [0, inf], default 0

    active\_output\_index[¶](#bpy.types.NodeClosureOutput.active_output_index "Link to this definition")
    :   Index of the active item

        Type:
        :   int in [0, inf], default 0

    define\_signature[¶](#bpy.types.NodeClosureOutput.define_signature "Link to this definition")
    :   This zone defines a closure signature that should be used by other nodes

        Type:
        :   boolean, default False

    input\_items[¶](#bpy.types.NodeClosureOutput.input_items "Link to this definition")
    :   Type:
        :   [`NodeClosureInputItems`](NodeClosureInputItems.md#bpy.types.NodeClosureInputItems "bpy.types.NodeClosureInputItems") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`NodeClosureInputItem`](NodeClosureInputItem.md#bpy.types.NodeClosureInputItem "bpy.types.NodeClosureInputItem"), (readonly)

    output\_items[¶](#bpy.types.NodeClosureOutput.output_items "Link to this definition")
    :   Type:
        :   [`NodeClosureOutputItems`](NodeClosureOutputItems.md#bpy.types.NodeClosureOutputItems "bpy.types.NodeClosureOutputItems") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`NodeClosureOutputItem`](NodeClosureOutputItem.md#bpy.types.NodeClosureOutputItem "bpy.types.NodeClosureOutputItem"), (readonly)

    *classmethod* is\_registered\_node\_type()[¶](#bpy.types.NodeClosureOutput.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[¶](#bpy.types.NodeClosureOutput.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[¶](#bpy.types.NodeClosureOutput.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.NodeClosureOutput.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.NodeClosureOutput.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
NodeClosureOutputItem(bpy\_struct)](NodeClosureOutputItem.md)
[Previous
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.NodeClosureOutput.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.NodeClosureOutput.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* NodeClosureOutput(NodeInternal)
  + [`NodeClosureOutput`](#bpy.types.NodeClosureOutput)
    - [`NodeClosureOutput.active_input_index`](#bpy.types.NodeClosureOutput.active_input_index)
    - [`NodeClosureOutput.active_output_index`](#bpy.types.NodeClosureOutput.active_output_index)
    - [`NodeClosureOutput.define_signature`](#bpy.types.NodeClosureOutput.define_signature)
    - [`NodeClosureOutput.input_items`](#bpy.types.NodeClosureOutput.input_items)
    - [`NodeClosureOutput.output_items`](#bpy.types.NodeClosureOutput.output_items)
    - [`NodeClosureOutput.is_registered_node_type()`](#bpy.types.NodeClosureOutput.is_registered_node_type)
    - [`NodeClosureOutput.input_template()`](#bpy.types.NodeClosureOutput.input_template)
    - [`NodeClosureOutput.output_template()`](#bpy.types.NodeClosureOutput.output_template)
    - [`NodeClosureOutput.bl_rna_get_subclass()`](#bpy.types.NodeClosureOutput.bl_rna_get_subclass)
    - [`NodeClosureOutput.bl_rna_get_subclass_py()`](#bpy.types.NodeClosureOutput.bl_rna_get_subclass_py)
