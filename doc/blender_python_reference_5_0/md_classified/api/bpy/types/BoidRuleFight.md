...
# BoidRuleFight(BoidRule)[¶](#boidrulefight-boidrule "Link to this heading")
...
*class* bpy.types.BoidRuleFight(*BoidRule*)[¶](#bpy.types.BoidRuleFight "Link to this definition")
:   distance[¶](#bpy.types.BoidRuleFight.distance "Link to this definition")
    :   Attack boids at max this distance

        Type:
        :   float in [0, 100], default 0.0

    flee\_distance[¶](#bpy.types.BoidRuleFight.flee_distance "Link to this definition")
    :   Flee to this distance

        Type:
        :   float in [0, 100], default 0.0

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.BoidRuleFight.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.BoidRuleFight.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.BoidRuleFight.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.BoidRuleFight.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* BoidRuleFight(BoidRule)
  + [`BoidRuleFight`](#bpy.types.BoidRuleFight)
    - [`BoidRuleFight.distance`](#bpy.types.BoidRuleFight.distance)
    - [`BoidRuleFight.flee_distance`](#bpy.types.BoidRuleFight.flee_distance)
    - [`BoidRuleFight.bl_rna_get_subclass()`](#bpy.types.BoidRuleFight.bl_rna_get_subclass)
    - [`BoidRuleFight.bl_rna_get_subclass_py()`](#bpy.types.BoidRuleFight.bl_rna_get_subclass_py)
