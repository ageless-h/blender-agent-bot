...
# CurveModifier(Modifier)[¶](#curvemodifier-modifier "Link to this heading")
...
*class* bpy.types.CurveModifier(*Modifier*)[¶](#bpy.types.CurveModifier "Link to this definition")
:   Curve deformation modifier

    deform\_axis[¶](#bpy.types.CurveModifier.deform_axis "Link to this definition")
    :   The axis that the curve deforms along

        Type:
        :   enum in [`'POS_X'`, `'POS_Y'`, `'POS_Z'`, `'NEG_X'`, `'NEG_Y'`, `'NEG_Z'`], default `'POS_X'`

    invert\_vertex\_group[¶](#bpy.types.CurveModifier.invert_vertex_group "Link to this definition")
    :   Invert vertex group influence

        Type:
        :   boolean, default False

    object[¶](#bpy.types.CurveModifier.object "Link to this definition")
    :   Curve object to deform with

        Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object")

    vertex\_group[¶](#bpy.types.CurveModifier.vertex_group "Link to this definition")
    :   Name of Vertex Group which determines influence of modifier per point

        Type:
        :   string, default “”, (never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.CurveModifier.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.CurveModifier.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CurveModifier.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.CurveModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CurveModifier(Modifier)
  + [`CurveModifier`](#bpy.types.CurveModifier)
    - [`CurveModifier.deform_axis`](#bpy.types.CurveModifier.deform_axis)
    - [`CurveModifier.invert_vertex_group`](#bpy.types.CurveModifier.invert_vertex_group)
    - [`CurveModifier.object`](#bpy.types.CurveModifier.object)
    - [`CurveModifier.vertex_group`](#bpy.types.CurveModifier.vertex_group)
    - [`CurveModifier.bl_rna_get_subclass()`](#bpy.types.CurveModifier.bl_rna_get_subclass)
    - [`CurveModifier.bl_rna_get_subclass_py()`](#bpy.types.CurveModifier.bl_rna_get_subclass_py)
