...
# BlendTexture(Texture)[¶](#blendtexture-texture "Link to this heading")
...
*class* bpy.types.BlendTexture(*Texture*)[¶](#bpy.types.BlendTexture "Link to this definition")
:   Procedural color blending texture

    progression[¶](#bpy.types.BlendTexture.progression "Link to this definition")
    ...
    use\_flip\_axis[¶](#bpy.types.BlendTexture.use_flip_axis "Link to this definition")
    ...
    users\_material[¶](#bpy.types.BlendTexture.users_material "Link to this definition")
    ...
    users\_object\_modifier[¶](#bpy.types.BlendTexture.users_object_modifier "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.BlendTexture.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.BlendTexture.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
BlendImportContextLibrary(bpy\_struct)](BlendImportContextLibrary.md)
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.BlendTexture.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.BlendTexture.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* BlendTexture(Texture)
  + [`BlendTexture`](#bpy.types.BlendTexture)
    - [`BlendTexture.progression`](#bpy.types.BlendTexture.progression)
    - [`BlendTexture.use_flip_axis`](#bpy.types.BlendTexture.use_flip_axis)
    - [`BlendTexture.users_material`](#bpy.types.BlendTexture.users_material)
    - [`BlendTexture.users_object_modifier`](#bpy.types.BlendTexture.users_object_modifier)
    - [`BlendTexture.bl_rna_get_subclass()`](#bpy.types.BlendTexture.bl_rna_get_subclass)
    - [`BlendTexture.bl_rna_get_subclass_py()`](#bpy.types.BlendTexture.bl_rna_get_subclass_py)
