...
# SceneHydra(bpy\_struct)[¶](#scenehydra-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.SceneHydra(*bpy\_struct*)[¶](#bpy.types.SceneHydra "Link to this definition")
:   Scene Hydra render engine settings

    export\_method[¶](#bpy.types.SceneHydra.export_method "Link to this definition")
    :   How to export the Blender scene to the Hydra render engine
        ...
        * `USD`
        ...
        Type:
        :   enum in [`'HYDRA'`, `'USD'`], default `'HYDRA'`

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.SceneHydra.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.SceneHydra.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Scene.hydra`](Scene.md#bpy.types.Scene.hydra "bpy.types.Scene.hydra") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.SceneHydra.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.SceneHydra.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* SceneHydra(bpy\_struct)
  + [`SceneHydra`](#bpy.types.SceneHydra)
    - [`SceneHydra.export_method`](#bpy.types.SceneHydra.export_method)
    - [`SceneHydra.bl_rna_get_subclass()`](#bpy.types.SceneHydra.bl_rna_get_subclass)
    - [`SceneHydra.bl_rna_get_subclass_py()`](#bpy.types.SceneHydra.bl_rna_get_subclass_py)
