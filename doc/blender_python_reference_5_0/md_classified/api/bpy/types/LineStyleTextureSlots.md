...
# LineStyleTextureSlots(bpy\_struct)[¶](#linestyletextureslots-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.LineStyleTextureSlots(*bpy\_struct*)[¶](#bpy.types.LineStyleTextureSlots "Link to this definition")
:   Collection of texture slots

    *classmethod* add()[¶](#bpy.types.LineStyleTextureSlots.add "Link to this definition")
    :   add
        ...
        Return type:
        :   [`LineStyleTextureSlot`](LineStyleTextureSlot.md#bpy.types.LineStyleTextureSlot "bpy.types.LineStyleTextureSlot")

    *classmethod* create(*index*)[¶](#bpy.types.LineStyleTextureSlots.create "Link to this definition")
    :   create
    ...
    *classmethod* clear(*index*)[¶](#bpy.types.LineStyleTextureSlots.clear "Link to this definition")
    :   clear

        Parameters:
        :   **index** (*int in* *[**0**,* *inf**]*) – Index, Slot index to clear

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.LineStyleTextureSlots.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.LineStyleTextureSlots.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`FreestyleLineStyle.texture_slots`](FreestyleLineStyle.md#bpy.types.FreestyleLineStyle.texture_slots "bpy.types.FreestyleLineStyle.texture_slots") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.LineStyleTextureSlots.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.LineStyleTextureSlots.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* LineStyleTextureSlots(bpy\_struct)
  + [`LineStyleTextureSlots`](#bpy.types.LineStyleTextureSlots)
    - [`LineStyleTextureSlots.add()`](#bpy.types.LineStyleTextureSlots.add)
    - [`LineStyleTextureSlots.create()`](#bpy.types.LineStyleTextureSlots.create)
    - [`LineStyleTextureSlots.clear()`](#bpy.types.LineStyleTextureSlots.clear)
    - [`LineStyleTextureSlots.bl_rna_get_subclass()`](#bpy.types.LineStyleTextureSlots.bl_rna_get_subclass)
    - [`LineStyleTextureSlots.bl_rna_get_subclass_py()`](#bpy.types.LineStyleTextureSlots.bl_rna_get_subclass_py)
