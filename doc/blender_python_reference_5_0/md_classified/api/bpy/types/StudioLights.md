...
# StudioLights(bpy\_struct)[¶](#studiolights-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.StudioLights(*bpy\_struct*)[¶](#bpy.types.StudioLights "Link to this definition")
:   Collection of studio lights

    load(*path*, *type*)[¶](#bpy.types.StudioLights.load "Link to this definition")
    :   Load studiolight from file
        ...
        Return type:
        :   [`StudioLight`](StudioLight.md#bpy.types.StudioLight "bpy.types.StudioLight")

    new(*path*)[¶](#bpy.types.StudioLights.new "Link to this definition")
    :   Create studiolight from default lighting

        Parameters:
        :   **path** (*string**,* *(**never None**)*) – Path, Path to the file that will contain the lighting info (without extension)
    ...
    remove(*studio\_light*)[¶](#bpy.types.StudioLights.remove "Link to this definition")
    :   Remove a studio light

        Parameters:
        :   **studio\_light** ([`StudioLight`](StudioLight.md#bpy.types.StudioLight "bpy.types.StudioLight"), (never None)) – The studio light to remove

    refresh()[¶](#bpy.types.StudioLights.refresh "Link to this definition")
    :   Refresh Studio Lights from disk

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.StudioLights.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.StudioLights.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Preferences.studio_lights`](Preferences.md#bpy.types.Preferences.studio_lights "bpy.types.Preferences.studio_lights") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.StudioLights.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.StudioLights.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* StudioLights(bpy\_struct)
  + [`StudioLights`](#bpy.types.StudioLights)
    - [`StudioLights.load()`](#bpy.types.StudioLights.load)
    - [`StudioLights.new()`](#bpy.types.StudioLights.new)
    - [`StudioLights.remove()`](#bpy.types.StudioLights.remove)
    - [`StudioLights.refresh()`](#bpy.types.StudioLights.refresh)
    - [`StudioLights.bl_rna_get_subclass()`](#bpy.types.StudioLights.bl_rna_get_subclass)
    - [`StudioLights.bl_rna_get_subclass_py()`](#bpy.types.StudioLights.bl_rna_get_subclass_py)
