...
# ForeachGeometryElementInputItem(bpy\_struct)[¶](#foreachgeometryelementinputitem-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.ForeachGeometryElementInputItem(*bpy\_struct*)[¶](#bpy.types.ForeachGeometryElementInputItem "Link to this definition")
:   color[¶](#bpy.types.ForeachGeometryElementInputItem.color "Link to this definition")
    ...
    name[¶](#bpy.types.ForeachGeometryElementInputItem.name "Link to this definition")
    :   Type:
        :   string, default “”, (never None)

    socket\_type[¶](#bpy.types.ForeachGeometryElementInputItem.socket_type "Link to this definition")
    :   Type:
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ForeachGeometryElementInputItem.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ForeachGeometryElementInputItem.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`GeometryNodeForeachGeometryElementOutput.input_items`](GeometryNodeForeachGeometryElementOutput.md#bpy.types.GeometryNodeForeachGeometryElementOutput.input_items "bpy.types.GeometryNodeForeachGeometryElementOutput.input_items") * [`NodeGeometryForeachGeometryElementInputItems.new`](NodeGeometryForeachGeometryElementInputItems.md#bpy.types.NodeGeometryForeachGeometryElementInputItems.new "bpy.types.NodeGeometryForeachGeometryElementInputItems.new") | * [`NodeGeometryForeachGeometryElementInputItems.remove`](NodeGeometryForeachGeometryElementInputItems.md#bpy.types.NodeGeometryForeachGeometryElementInputItems.remove "bpy.types.NodeGeometryForeachGeometryElementInputItems.remove") |

[Next

ForeachGeometryElementMainItem(bpy\_struct)](ForeachGeometryElementMainItem.md)
[Previous
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ForeachGeometryElementInputItem.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ForeachGeometryElementInputItem.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ForeachGeometryElementInputItem(bpy\_struct)
  + [`ForeachGeometryElementInputItem`](#bpy.types.ForeachGeometryElementInputItem)
    - [`ForeachGeometryElementInputItem.color`](#bpy.types.ForeachGeometryElementInputItem.color)
    - [`ForeachGeometryElementInputItem.name`](#bpy.types.ForeachGeometryElementInputItem.name)
    - [`ForeachGeometryElementInputItem.socket_type`](#bpy.types.ForeachGeometryElementInputItem.socket_type)
    - [`ForeachGeometryElementInputItem.bl_rna_get_subclass()`](#bpy.types.ForeachGeometryElementInputItem.bl_rna_get_subclass)
    - [`ForeachGeometryElementInputItem.bl_rna_get_subclass_py()`](#bpy.types.ForeachGeometryElementInputItem.bl_rna_get_subclass_py)
