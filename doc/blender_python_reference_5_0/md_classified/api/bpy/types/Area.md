...
# Area(bpy\_struct)[¶](#area-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.Area(*bpy\_struct*)[¶](#bpy.types.Area "Link to this definition")
:   Area in a subdivided screen, containing an editor

    height[¶](#bpy.types.Area.height "Link to this definition")
    :   Area height

        Type:
        :   int in [0, 32767], default 0, (readonly)

    regions[¶](#bpy.types.Area.regions "Link to this definition")
    :   Regions this area is subdivided in

        Type:
        :   [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`Region`](Region.md#bpy.types.Region "bpy.types.Region"), (readonly)

    show\_menus[¶](#bpy.types.Area.show_menus "Link to this definition")
    :   Show menus in the header

        Type:
        :   boolean, default False

    spaces[¶](#bpy.types.Area.spaces "Link to this definition")
    :   Spaces contained in this area, the first being the active space (NOTE: Useful for example to restore a previously used 3D view space in a certain area to get the old view orientation)
        ...
        Type:
        :   [`AreaSpaces`](AreaSpaces.md#bpy.types.AreaSpaces "bpy.types.AreaSpaces") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`Space`](Space.md#bpy.types.Space "bpy.types.Space"), (readonly)

    type[¶](#bpy.types.Area.type "Link to this definition")
    :   Current editor type for this area

        Type:
        :   enum in [Space Type Items](../../../appendix/bpy_types_enum_items/space_type_items.md#rna-enum-space-type-items), default `'VIEW_3D'`

    ui\_type[¶](#bpy.types.Area.ui_type "Link to this definition")
    :   Current editor type for this area

        Type:
        :   enum in []

    width[¶](#bpy.types.Area.width "Link to this definition")
    :   Area width

        Type:
        :   int in [0, 32767], default 0, (readonly)

    x[¶](#bpy.types.Area.x "Link to this definition")
    :   The window relative vertical location of the area

        Type:
        :   int in [-inf, inf], default 0, (readonly)

    y[¶](#bpy.types.Area.y "Link to this definition")
    :   The window relative horizontal location of the area

        Type:
        :   int in [-inf, inf], default 0, (readonly)

    tag\_redraw()[¶](#bpy.types.Area.tag_redraw "Link to this definition")
    :   tag\_redraw

    header\_text\_set(*text*)[¶](#bpy.types.Area.header_text_set "Link to this definition")
    :   Set the header status text

        Parameters:
        :   **text** (*string*) – Text, New string for the header, None clears the text

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.Area.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.Area.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Context.area`](Context.md#bpy.types.Context.area "bpy.types.Context.area") | * [`Screen.areas`](Screen.md#bpy.types.Screen.areas "bpy.types.Screen.areas") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.Area.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.Area.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* Area(bpy\_struct)
  + [`Area`](#bpy.types.Area)
    - [`Area.height`](#bpy.types.Area.height)
    - [`Area.regions`](#bpy.types.Area.regions)
    - [`Area.show_menus`](#bpy.types.Area.show_menus)
    - [`Area.spaces`](#bpy.types.Area.spaces)
    - [`Area.type`](#bpy.types.Area.type)
    - [`Area.ui_type`](#bpy.types.Area.ui_type)
    - [`Area.width`](#bpy.types.Area.width)
    - [`Area.x`](#bpy.types.Area.x)
    - [`Area.y`](#bpy.types.Area.y)
    - [`Area.tag_redraw()`](#bpy.types.Area.tag_redraw)
    - [`Area.header_text_set()`](#bpy.types.Area.header_text_set)
    - [`Area.bl_rna_get_subclass()`](#bpy.types.Area.bl_rna_get_subclass)
    - [`Area.bl_rna_get_subclass_py()`](#bpy.types.Area.bl_rna_get_subclass_py)
