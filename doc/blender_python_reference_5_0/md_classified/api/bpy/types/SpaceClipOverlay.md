...
# SpaceClipOverlay(bpy\_struct)[¶](#spaceclipoverlay-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.SpaceClipOverlay(*bpy\_struct*)[¶](#bpy.types.SpaceClipOverlay "Link to this definition")
:   Settings for display of overlays in the Movie Clip editor

    show\_cursor[¶](#bpy.types.SpaceClipOverlay.show_cursor "Link to this definition")
    :   Display 2D cursor

        Type:
        :   boolean, default True

    show\_overlays[¶](#bpy.types.SpaceClipOverlay.show_overlays "Link to this definition")
    :   Display overlays like cursor and annotations

        Type:
        :   boolean, default True

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.SpaceClipOverlay.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.SpaceClipOverlay.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`SpaceClipEditor.overlay`](SpaceClipEditor.md#bpy.types.SpaceClipEditor.overlay "bpy.types.SpaceClipEditor.overlay") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.SpaceClipOverlay.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.SpaceClipOverlay.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* SpaceClipOverlay(bpy\_struct)
  + [`SpaceClipOverlay`](#bpy.types.SpaceClipOverlay)
    - [`SpaceClipOverlay.show_cursor`](#bpy.types.SpaceClipOverlay.show_cursor)
    - [`SpaceClipOverlay.show_overlays`](#bpy.types.SpaceClipOverlay.show_overlays)
    - [`SpaceClipOverlay.bl_rna_get_subclass()`](#bpy.types.SpaceClipOverlay.bl_rna_get_subclass)
    - [`SpaceClipOverlay.bl_rna_get_subclass_py()`](#bpy.types.SpaceClipOverlay.bl_rna_get_subclass_py)
