...
# LineStyleGeometryModifier\_2DTransform(LineStyleGeometryModifier)[¶](#linestylegeometrymodifier-2dtransform-linestylegeometrymodifier "Link to this heading")
...
*class* bpy.types.LineStyleGeometryModifier\_2DTransform(*LineStyleGeometryModifier*)[¶](#bpy.types.LineStyleGeometryModifier_2DTransform "Link to this definition")
:   Apply two-dimensional scaling and rotation to stroke backbone geometry

    angle[¶](#bpy.types.LineStyleGeometryModifier_2DTransform.angle "Link to this definition")
    :   Rotation angle

        Type:
        :   float in [-inf, inf], default 0.0

    expanded[¶](#bpy.types.LineStyleGeometryModifier_2DTransform.expanded "Link to this definition")
    :   True if the modifier tab is expanded

        Type:
        :   boolean, default False

    pivot[¶](#bpy.types.LineStyleGeometryModifier_2DTransform.pivot "Link to this definition")
    :   Pivot of scaling and rotation operations

        Type:
        :   enum in [`'CENTER'`, `'START'`, `'END'`, `'PARAM'`, `'ABSOLUTE'`], default `'CENTER'`

    pivot\_u[¶](#bpy.types.LineStyleGeometryModifier_2DTransform.pivot_u "Link to this definition")
    :   Pivot in terms of the stroke point parameter u (0 <= u <= 1)

        Type:
        :   float in [0, 1], default 0.0

    pivot\_x[¶](#bpy.types.LineStyleGeometryModifier_2DTransform.pivot_x "Link to this definition")
    :   2D X coordinate of the absolute pivot

        Type:
        :   float in [-inf, inf], default 0.0

    pivot\_y[¶](#bpy.types.LineStyleGeometryModifier_2DTransform.pivot_y "Link to this definition")
    :   2D Y coordinate of the absolute pivot

        Type:
        :   float in [-inf, inf], default 0.0

    scale\_x[¶](#bpy.types.LineStyleGeometryModifier_2DTransform.scale_x "Link to this definition")
    :   Scaling factor that is applied along the X axis

        Type:
        :   float in [-inf, inf], default 0.0

    scale\_y[¶](#bpy.types.LineStyleGeometryModifier_2DTransform.scale_y "Link to this definition")
    :   Scaling factor that is applied along the Y axis

        Type:
        :   float in [-inf, inf], default 0.0

    type[¶](#bpy.types.LineStyleGeometryModifier_2DTransform.type "Link to this definition")
    ...
    use[¶](#bpy.types.LineStyleGeometryModifier_2DTransform.use "Link to this definition")
    :   Enable or disable this modifier during stroke rendering

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.LineStyleGeometryModifier_2DTransform.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.LineStyleGeometryModifier_2DTransform.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.LineStyleGeometryModifier_2DTransform.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.LineStyleGeometryModifier_2DTransform.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* LineStyleGeometryModifier\_2DTransform(LineStyleGeometryModifier)
  + [`LineStyleGeometryModifier_2DTransform`](#bpy.types.LineStyleGeometryModifier_2DTransform)
    - [`LineStyleGeometryModifier_2DTransform.angle`](#bpy.types.LineStyleGeometryModifier_2DTransform.angle)
    - [`LineStyleGeometryModifier_2DTransform.expanded`](#bpy.types.LineStyleGeometryModifier_2DTransform.expanded)
    - [`LineStyleGeometryModifier_2DTransform.pivot`](#bpy.types.LineStyleGeometryModifier_2DTransform.pivot)
    - [`LineStyleGeometryModifier_2DTransform.pivot_u`](#bpy.types.LineStyleGeometryModifier_2DTransform.pivot_u)
    - [`LineStyleGeometryModifier_2DTransform.pivot_x`](#bpy.types.LineStyleGeometryModifier_2DTransform.pivot_x)
    - [`LineStyleGeometryModifier_2DTransform.pivot_y`](#bpy.types.LineStyleGeometryModifier_2DTransform.pivot_y)
    - [`LineStyleGeometryModifier_2DTransform.scale_x`](#bpy.types.LineStyleGeometryModifier_2DTransform.scale_x)
    - [`LineStyleGeometryModifier_2DTransform.scale_y`](#bpy.types.LineStyleGeometryModifier_2DTransform.scale_y)
    - [`LineStyleGeometryModifier_2DTransform.type`](#bpy.types.LineStyleGeometryModifier_2DTransform.type)
    - [`LineStyleGeometryModifier_2DTransform.use`](#bpy.types.LineStyleGeometryModifier_2DTransform.use)
    - [`LineStyleGeometryModifier_2DTransform.bl_rna_get_subclass()`](#bpy.types.LineStyleGeometryModifier_2DTransform.bl_rna_get_subclass)
    - [`LineStyleGeometryModifier_2DTransform.bl_rna_get_subclass_py()`](#bpy.types.LineStyleGeometryModifier_2DTransform.bl_rna_get_subclass_py)
