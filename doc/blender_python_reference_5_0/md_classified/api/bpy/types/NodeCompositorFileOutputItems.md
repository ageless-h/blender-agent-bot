...
# NodeCompositorFileOutputItems(bpy\_struct)[¶](#nodecompositorfileoutputitems-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.NodeCompositorFileOutputItems(*bpy\_struct*)[¶](#bpy.types.NodeCompositorFileOutputItems "Link to this definition")
:   Collection of file output items

    new(*socket\_type*, *name*)[¶](#bpy.types.NodeCompositorFileOutputItems.new "Link to this definition")
    :   Add an item at the end
        ...
        Return type:
        :   [`NodeCompositorFileOutputItem`](NodeCompositorFileOutputItem.md#bpy.types.NodeCompositorFileOutputItem "bpy.types.NodeCompositorFileOutputItem")

    remove(*item*)[¶](#bpy.types.NodeCompositorFileOutputItems.remove "Link to this definition")
    :   Remove an item

        Parameters:
        :   **item** ([`NodeCompositorFileOutputItem`](NodeCompositorFileOutputItem.md#bpy.types.NodeCompositorFileOutputItem "bpy.types.NodeCompositorFileOutputItem"), (never None)) – Item, The item to remove

    clear()[¶](#bpy.types.NodeCompositorFileOutputItems.clear "Link to this definition")
    :   Remove all items

    move(*from\_index*, *to\_index*)[¶](#bpy.types.NodeCompositorFileOutputItems.move "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.NodeCompositorFileOutputItems.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.NodeCompositorFileOutputItems.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`CompositorNodeOutputFile.file_output_items`](CompositorNodeOutputFile.md#bpy.types.CompositorNodeOutputFile.file_output_items "bpy.types.CompositorNodeOutputFile.file_output_items") |  |
...
NodeCompositorFileOutputItem(bpy\_struct)](NodeCompositorFileOutputItem.md)
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.NodeCompositorFileOutputItems.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.NodeCompositorFileOutputItems.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* NodeCompositorFileOutputItems(bpy\_struct)
  + [`NodeCompositorFileOutputItems`](#bpy.types.NodeCompositorFileOutputItems)
    - [`NodeCompositorFileOutputItems.new()`](#bpy.types.NodeCompositorFileOutputItems.new)
    - [`NodeCompositorFileOutputItems.remove()`](#bpy.types.NodeCompositorFileOutputItems.remove)
    - [`NodeCompositorFileOutputItems.clear()`](#bpy.types.NodeCompositorFileOutputItems.clear)
    - [`NodeCompositorFileOutputItems.move()`](#bpy.types.NodeCompositorFileOutputItems.move)
    - [`NodeCompositorFileOutputItems.bl_rna_get_subclass()`](#bpy.types.NodeCompositorFileOutputItems.bl_rna_get_subclass)
    - [`NodeCompositorFileOutputItems.bl_rna_get_subclass_py()`](#bpy.types.NodeCompositorFileOutputItems.bl_rna_get_subclass_py)
