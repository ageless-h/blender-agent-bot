...
# VolumeDisplaceModifier(Modifier)[¶](#volumedisplacemodifier-modifier "Link to this heading")
...
*class* bpy.types.VolumeDisplaceModifier(*Modifier*)[¶](#bpy.types.VolumeDisplaceModifier "Link to this definition")
:   strength[¶](#bpy.types.VolumeDisplaceModifier.strength "Link to this definition")
    :   Strength of the displacement

        Type:
        :   float in [-inf, inf], default 0.0

    texture[¶](#bpy.types.VolumeDisplaceModifier.texture "Link to this definition")
    :   Type:
        :   [`Texture`](Texture.md#bpy.types.Texture "bpy.types.Texture")

    texture\_map\_mode[¶](#bpy.types.VolumeDisplaceModifier.texture_map_mode "Link to this definition")
    :   * `LOCAL`
    ...
    texture\_map\_object[¶](#bpy.types.VolumeDisplaceModifier.texture_map_object "Link to this definition")
    :   Object to use for texture mapping

        Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object")

    texture\_mid\_level[¶](#bpy.types.VolumeDisplaceModifier.texture_mid_level "Link to this definition")
    ...
    texture\_sample\_radius[¶](#bpy.types.VolumeDisplaceModifier.texture_sample_radius "Link to this definition")
    :   Smaller values result in better performance but might cut off the volume

        Type:
        :   float in [0, inf], default 0.0

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.VolumeDisplaceModifier.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.VolumeDisplaceModifier.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.VolumeDisplaceModifier.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.VolumeDisplaceModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* VolumeDisplaceModifier(Modifier)
  + [`VolumeDisplaceModifier`](#bpy.types.VolumeDisplaceModifier)
    - [`VolumeDisplaceModifier.strength`](#bpy.types.VolumeDisplaceModifier.strength)
    - [`VolumeDisplaceModifier.texture`](#bpy.types.VolumeDisplaceModifier.texture)
    - [`VolumeDisplaceModifier.texture_map_mode`](#bpy.types.VolumeDisplaceModifier.texture_map_mode)
    - [`VolumeDisplaceModifier.texture_map_object`](#bpy.types.VolumeDisplaceModifier.texture_map_object)
    - [`VolumeDisplaceModifier.texture_mid_level`](#bpy.types.VolumeDisplaceModifier.texture_mid_level)
    - [`VolumeDisplaceModifier.texture_sample_radius`](#bpy.types.VolumeDisplaceModifier.texture_sample_radius)
    - [`VolumeDisplaceModifier.bl_rna_get_subclass()`](#bpy.types.VolumeDisplaceModifier.bl_rna_get_subclass)
    - [`VolumeDisplaceModifier.bl_rna_get_subclass_py()`](#bpy.types.VolumeDisplaceModifier.bl_rna_get_subclass_py)
