...
# ThemeFontStyle(bpy\_struct)[¶](#themefontstyle-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.ThemeFontStyle(*bpy\_struct*)[¶](#bpy.types.ThemeFontStyle "Link to this definition")
:   Theme settings for Font

    character\_weight[¶](#bpy.types.ThemeFontStyle.character_weight "Link to this definition")
    :   Weight of the characters. 100-900, 400 is normal.

        Type:
        :   int in [100, 900], default 400

    points[¶](#bpy.types.ThemeFontStyle.points "Link to this definition")
    :   Font size in points

        Type:
        :   float in [6, 32], default 0.0

    shadow[¶](#bpy.types.ThemeFontStyle.shadow "Link to this definition")
    :   Shadow type (0 none, 3, 5 blur, 6 outline)

        Type:
        :   int in [0, 6], default 0

    shadow\_alpha[¶](#bpy.types.ThemeFontStyle.shadow_alpha "Link to this definition")
    :   Type:
        :   float in [0, 1], default 0.0

    shadow\_offset\_x[¶](#bpy.types.ThemeFontStyle.shadow_offset_x "Link to this definition")
    :   Shadow offset in pixels

        Type:
        :   int in [-10, 10], default 0

    shadow\_offset\_y[¶](#bpy.types.ThemeFontStyle.shadow_offset_y "Link to this definition")
    :   Shadow offset in pixels

        Type:
        :   int in [-10, 10], default 0

    shadow\_value[¶](#bpy.types.ThemeFontStyle.shadow_value "Link to this definition")
    :   Shadow color in gray value

        Type:
        :   float in [0, 1], default 0.0

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ThemeFontStyle.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ThemeFontStyle.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`ThemeStyle.panel_title`](ThemeStyle.md#bpy.types.ThemeStyle.panel_title "bpy.types.ThemeStyle.panel_title") * [`ThemeStyle.tooltip`](ThemeStyle.md#bpy.types.ThemeStyle.tooltip "bpy.types.ThemeStyle.tooltip") | * [`ThemeStyle.widget`](ThemeStyle.md#bpy.types.ThemeStyle.widget "bpy.types.ThemeStyle.widget") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ThemeFontStyle.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ThemeFontStyle.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ThemeFontStyle(bpy\_struct)
  + [`ThemeFontStyle`](#bpy.types.ThemeFontStyle)
    - [`ThemeFontStyle.character_weight`](#bpy.types.ThemeFontStyle.character_weight)
    - [`ThemeFontStyle.points`](#bpy.types.ThemeFontStyle.points)
    - [`ThemeFontStyle.shadow`](#bpy.types.ThemeFontStyle.shadow)
    - [`ThemeFontStyle.shadow_alpha`](#bpy.types.ThemeFontStyle.shadow_alpha)
    - [`ThemeFontStyle.shadow_offset_x`](#bpy.types.ThemeFontStyle.shadow_offset_x)
    - [`ThemeFontStyle.shadow_offset_y`](#bpy.types.ThemeFontStyle.shadow_offset_y)
    - [`ThemeFontStyle.shadow_value`](#bpy.types.ThemeFontStyle.shadow_value)
    - [`ThemeFontStyle.bl_rna_get_subclass()`](#bpy.types.ThemeFontStyle.bl_rna_get_subclass)
    - [`ThemeFontStyle.bl_rna_get_subclass_py()`](#bpy.types.ThemeFontStyle.bl_rna_get_subclass_py)
