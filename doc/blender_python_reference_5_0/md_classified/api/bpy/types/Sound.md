...
:   Sound data-block referencing an external or packed sound file
    ...
    filepath[¶](#bpy.types.Sound.filepath "Link to this definition")
    :   Sound sample file used by this Sound data-block

        Type:
        :   string, default “”, (never None, blend relative `//` prefix supported)

    packed\_file[¶](#bpy.types.Sound.packed_file "Link to this definition")
    :   Type:
        :   [`PackedFile`](PackedFile.md#bpy.types.PackedFile "bpy.types.PackedFile"), (readonly)

    samplerate[¶](#bpy.types.Sound.samplerate "Link to this definition")
    :   Sample rate of the audio in Hz

        Type:
        :   int in [-inf, inf], default 0, (readonly)

    use\_memory\_cache[¶](#bpy.types.Sound.use_memory_cache "Link to this definition")
    :   The sound file is decoded and loaded into RAM

        Type:
        :   boolean, default False

    use\_mono[¶](#bpy.types.Sound.use_mono "Link to this definition")
    :   If the file contains multiple audio channels they are rendered to a single one

        Type:
        :   boolean, default False

    factory[¶](#bpy.types.Sound.factory "Link to this definition")
    :   The aud.Factory object of the sound.

        (readonly)

    pack()[¶](#bpy.types.Sound.pack "Link to this definition")
    :   Pack the sound into the current blend file

    unpack(*\**, *method='USE\_LOCAL'*)[¶](#bpy.types.Sound.unpack "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.Sound.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.Sound.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`BlendData.sounds`](BlendData.md#bpy.types.BlendData.sounds "bpy.types.BlendData.sounds") * [`BlendDataSounds.load`](BlendDataSounds.md#bpy.types.BlendDataSounds.load "bpy.types.BlendDataSounds.load") * [`BlendDataSounds.remove`](BlendDataSounds.md#bpy.types.BlendDataSounds.remove "bpy.types.BlendDataSounds.remove") | * [`SoundStrip.sound`](SoundStrip.md#bpy.types.SoundStrip.sound "bpy.types.SoundStrip.sound") * [`Speaker.sound`](Speaker.md#bpy.types.Speaker.sound "bpy.types.Speaker.sound") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.Sound.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.Sound.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* Sound(ID)
  + [`Sound`](#bpy.types.Sound)
    - [`Sound.channels`](#bpy.types.Sound.channels)
    - [`Sound.filepath`](#bpy.types.Sound.filepath)
    - [`Sound.packed_file`](#bpy.types.Sound.packed_file)
    - [`Sound.samplerate`](#bpy.types.Sound.samplerate)
    - [`Sound.use_memory_cache`](#bpy.types.Sound.use_memory_cache)
    - [`Sound.use_mono`](#bpy.types.Sound.use_mono)
    - [`Sound.factory`](#bpy.types.Sound.factory)
    - [`Sound.pack()`](#bpy.types.Sound.pack)
    - [`Sound.unpack()`](#bpy.types.Sound.unpack)
    - [`Sound.bl_rna_get_subclass()`](#bpy.types.Sound.bl_rna_get_subclass)
    - [`Sound.bl_rna_get_subclass_py()`](#bpy.types.Sound.bl_rna_get_subclass_py)
