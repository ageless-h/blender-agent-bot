...
# SoftBodyModifier(Modifier)[¶](#softbodymodifier-modifier "Link to this heading")
...
*class* bpy.types.SoftBodyModifier(*Modifier*)[¶](#bpy.types.SoftBodyModifier "Link to this definition")
:   Soft body simulation modifier

    point\_cache[¶](#bpy.types.SoftBodyModifier.point_cache "Link to this definition")
    :   Type:
        :   [`PointCache`](PointCache.md#bpy.types.PointCache "bpy.types.PointCache"), (readonly, never None)

    settings[¶](#bpy.types.SoftBodyModifier.settings "Link to this definition")
    :   Type:
        :   [`SoftBodySettings`](SoftBodySettings.md#bpy.types.SoftBodySettings "bpy.types.SoftBodySettings"), (readonly, never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.SoftBodyModifier.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.SoftBodyModifier.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.SoftBodyModifier.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.SoftBodyModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* SoftBodyModifier(Modifier)
  + [`SoftBodyModifier`](#bpy.types.SoftBodyModifier)
    - [`SoftBodyModifier.point_cache`](#bpy.types.SoftBodyModifier.point_cache)
    - [`SoftBodyModifier.settings`](#bpy.types.SoftBodyModifier.settings)
    - [`SoftBodyModifier.bl_rna_get_subclass()`](#bpy.types.SoftBodyModifier.bl_rna_get_subclass)
    - [`SoftBodyModifier.bl_rna_get_subclass_py()`](#bpy.types.SoftBodyModifier.bl_rna_get_subclass_py)
