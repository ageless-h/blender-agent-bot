...
# ShaderFxRim(ShaderFx)[¶](#shaderfxrim-shaderfx "Link to this heading")
...
*class* bpy.types.ShaderFxRim(*ShaderFx*)[¶](#bpy.types.ShaderFxRim "Link to this definition")
:   Rim effect

    blur[¶](#bpy.types.ShaderFxRim.blur "Link to this definition")
    :   Number of pixels for blurring rim (set to 0 to disable)

        Type:
        :   int array of 2 items in [0, 32767], default (0, 0)

    mask\_color[¶](#bpy.types.ShaderFxRim.mask_color "Link to this definition")
    ...
    mode[¶](#bpy.types.ShaderFxRim.mode "Link to this definition")
    :   Blend mode

        Type:
        :   enum in [`'NORMAL'`, `'OVERLAY'`, `'ADD'`, `'SUBTRACT'`, `'MULTIPLY'`, `'DIVIDE'`], default `'NORMAL'`

    offset[¶](#bpy.types.ShaderFxRim.offset "Link to this definition")
    :   Offset of the rim

        Type:
        :   int array of 2 items in [-32768, 32767], default (0, 0)

    rim\_color[¶](#bpy.types.ShaderFxRim.rim_color "Link to this definition")
    :   Color used for Rim

        Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    samples[¶](#bpy.types.ShaderFxRim.samples "Link to this definition")
    :   Number of Blur Samples (zero, disable blur)

        Type:
        :   int in [0, 32], default 4

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ShaderFxRim.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ShaderFxRim.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ShaderFxRim.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ShaderFxRim.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ShaderFxRim(ShaderFx)
  + [`ShaderFxRim`](#bpy.types.ShaderFxRim)
    - [`ShaderFxRim.blur`](#bpy.types.ShaderFxRim.blur)
    - [`ShaderFxRim.mask_color`](#bpy.types.ShaderFxRim.mask_color)
    - [`ShaderFxRim.mode`](#bpy.types.ShaderFxRim.mode)
    - [`ShaderFxRim.offset`](#bpy.types.ShaderFxRim.offset)
    - [`ShaderFxRim.rim_color`](#bpy.types.ShaderFxRim.rim_color)
    - [`ShaderFxRim.samples`](#bpy.types.ShaderFxRim.samples)
    - [`ShaderFxRim.bl_rna_get_subclass()`](#bpy.types.ShaderFxRim.bl_rna_get_subclass)
    - [`ShaderFxRim.bl_rna_get_subclass_py()`](#bpy.types.ShaderFxRim.bl_rna_get_subclass_py)
