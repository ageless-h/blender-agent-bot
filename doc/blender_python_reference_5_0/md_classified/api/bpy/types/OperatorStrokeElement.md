...
# OperatorStrokeElement(PropertyGroup)[¶](#operatorstrokeelement-propertygroup "Link to this heading")

base classes — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct"), [`PropertyGroup`](PropertyGroup.md#bpy.types.PropertyGroup "bpy.types.PropertyGroup")

*class* bpy.types.OperatorStrokeElement(*PropertyGroup*)[¶](#bpy.types.OperatorStrokeElement "Link to this definition")
:   is\_start[¶](#bpy.types.OperatorStrokeElement.is_start "Link to this definition")
    :   Type:
        :   boolean, default False

    location[¶](#bpy.types.OperatorStrokeElement.location "Link to this definition")
    :   Type:
        :   [`mathutils.Vector`](../../mathutils/index.md#mathutils.Vector "mathutils.Vector") of 3 items in [-inf, inf], default (0.0, 0.0, 0.0)

    mouse[¶](#bpy.types.OperatorStrokeElement.mouse "Link to this definition")
    :   Type:
        :   [`mathutils.Vector`](../../mathutils/index.md#mathutils.Vector "mathutils.Vector") of 2 items in [-inf, inf], default (0.0, 0.0)

    mouse\_event[¶](#bpy.types.OperatorStrokeElement.mouse_event "Link to this definition")
    :   Type:
        :   [`mathutils.Vector`](../../mathutils/index.md#mathutils.Vector "mathutils.Vector") of 2 items in [-inf, inf], default (0.0, 0.0)

    pressure[¶](#bpy.types.OperatorStrokeElement.pressure "Link to this definition")
    :   Tablet pressure

        Type:
        :   float in [0, 1], default 0.0

    size[¶](#bpy.types.OperatorStrokeElement.size "Link to this definition")
    :   Brush size in screen space

        Type:
        :   float in [0, inf], default 0.0

    time[¶](#bpy.types.OperatorStrokeElement.time "Link to this definition")
    :   Type:
        :   float in [0, inf], default 0.0

    x\_tilt[¶](#bpy.types.OperatorStrokeElement.x_tilt "Link to this definition")
    :   Pen tilt from left (-1.0) to right (+1.0)

        Type:
        :   float in [-1, 1], default 0.0

    y\_tilt[¶](#bpy.types.OperatorStrokeElement.y_tilt "Link to this definition")
    :   Pen tilt from backward (-1.0) to forward (+1.0)

        Type:
        :   float in [-1, 1], default 0.0

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.OperatorStrokeElement.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.OperatorStrokeElement.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.OperatorStrokeElement.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.OperatorStrokeElement.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* OperatorStrokeElement(PropertyGroup)
  + [`OperatorStrokeElement`](#bpy.types.OperatorStrokeElement)
    - [`OperatorStrokeElement.is_start`](#bpy.types.OperatorStrokeElement.is_start)
    - [`OperatorStrokeElement.location`](#bpy.types.OperatorStrokeElement.location)
    - [`OperatorStrokeElement.mouse`](#bpy.types.OperatorStrokeElement.mouse)
    - [`OperatorStrokeElement.mouse_event`](#bpy.types.OperatorStrokeElement.mouse_event)
    - [`OperatorStrokeElement.pressure`](#bpy.types.OperatorStrokeElement.pressure)
    - [`OperatorStrokeElement.size`](#bpy.types.OperatorStrokeElement.size)
    - [`OperatorStrokeElement.time`](#bpy.types.OperatorStrokeElement.time)
    - [`OperatorStrokeElement.x_tilt`](#bpy.types.OperatorStrokeElement.x_tilt)
    - [`OperatorStrokeElement.y_tilt`](#bpy.types.OperatorStrokeElement.y_tilt)
    - [`OperatorStrokeElement.bl_rna_get_subclass()`](#bpy.types.OperatorStrokeElement.bl_rna_get_subclass)
    - [`OperatorStrokeElement.bl_rna_get_subclass_py()`](#bpy.types.OperatorStrokeElement.bl_rna_get_subclass_py)
