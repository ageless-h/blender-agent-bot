...
# Histogram(bpy\_struct)[¶](#histogram-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.Histogram(*bpy\_struct*)[¶](#bpy.types.Histogram "Link to this definition")
:   Statistical view of the levels of color in an image

    mode[¶](#bpy.types.Histogram.mode "Link to this definition")
    :   Channels to display in the histogram
        ...
        * `A`
        ...
        Type:
        :   enum in [`'LUMA'`, `'RGB'`, `'R'`, `'G'`, `'B'`, `'A'`], default `'LUMA'`

    show\_line[¶](#bpy.types.Histogram.show_line "Link to this definition")
    :   Display lines rather than filled shapes

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.Histogram.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.Histogram.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Scopes.histogram`](Scopes.md#bpy.types.Scopes.histogram "bpy.types.Scopes.histogram") | * [`SpaceImageEditor.sample_histogram`](SpaceImageEditor.md#bpy.types.SpaceImageEditor.sample_histogram "bpy.types.SpaceImageEditor.sample_histogram") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.Histogram.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.Histogram.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* Histogram(bpy\_struct)
  + [`Histogram`](#bpy.types.Histogram)
    - [`Histogram.mode`](#bpy.types.Histogram.mode)
    - [`Histogram.show_line`](#bpy.types.Histogram.show_line)
    - [`Histogram.bl_rna_get_subclass()`](#bpy.types.Histogram.bl_rna_get_subclass)
    - [`Histogram.bl_rna_get_subclass_py()`](#bpy.types.Histogram.bl_rna_get_subclass_py)
