...
# ForeachGeometryElementMainItem(bpy\_struct)[¶](#foreachgeometryelementmainitem-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.ForeachGeometryElementMainItem(*bpy\_struct*)[¶](#bpy.types.ForeachGeometryElementMainItem "Link to this definition")
:   color[¶](#bpy.types.ForeachGeometryElementMainItem.color "Link to this definition")
    ...
    name[¶](#bpy.types.ForeachGeometryElementMainItem.name "Link to this definition")
    :   Type:
        :   string, default “”, (never None)

    socket\_type[¶](#bpy.types.ForeachGeometryElementMainItem.socket_type "Link to this definition")
    :   Type:
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ForeachGeometryElementMainItem.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ForeachGeometryElementMainItem.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`GeometryNodeForeachGeometryElementOutput.main_items`](GeometryNodeForeachGeometryElementOutput.md#bpy.types.GeometryNodeForeachGeometryElementOutput.main_items "bpy.types.GeometryNodeForeachGeometryElementOutput.main_items") * [`NodeGeometryForeachGeometryElementMainItems.new`](NodeGeometryForeachGeometryElementMainItems.md#bpy.types.NodeGeometryForeachGeometryElementMainItems.new "bpy.types.NodeGeometryForeachGeometryElementMainItems.new") | * [`NodeGeometryForeachGeometryElementMainItems.remove`](NodeGeometryForeachGeometryElementMainItems.md#bpy.types.NodeGeometryForeachGeometryElementMainItems.remove "bpy.types.NodeGeometryForeachGeometryElementMainItems.remove") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ForeachGeometryElementMainItem.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ForeachGeometryElementMainItem.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ForeachGeometryElementMainItem(bpy\_struct)
  + [`ForeachGeometryElementMainItem`](#bpy.types.ForeachGeometryElementMainItem)
    - [`ForeachGeometryElementMainItem.color`](#bpy.types.ForeachGeometryElementMainItem.color)
    - [`ForeachGeometryElementMainItem.name`](#bpy.types.ForeachGeometryElementMainItem.name)
    - [`ForeachGeometryElementMainItem.socket_type`](#bpy.types.ForeachGeometryElementMainItem.socket_type)
    - [`ForeachGeometryElementMainItem.bl_rna_get_subclass()`](#bpy.types.ForeachGeometryElementMainItem.bl_rna_get_subclass)
    - [`ForeachGeometryElementMainItem.bl_rna_get_subclass_py()`](#bpy.types.ForeachGeometryElementMainItem.bl_rna_get_subclass_py)
