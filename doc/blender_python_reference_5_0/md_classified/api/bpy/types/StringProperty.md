...
# StringProperty(Property)[¶](#stringproperty-property "Link to this heading")
...
*class* bpy.types.StringProperty(*Property*)[¶](#bpy.types.StringProperty "Link to this definition")
:   RNA text string property definition

    default[¶](#bpy.types.StringProperty.default "Link to this definition")
    :   String default value

        Type:
        :   string, default “”, (readonly, never None)

    length\_max[¶](#bpy.types.StringProperty.length_max "Link to this definition")
    :   Maximum length of the string, 0 means unlimited

        Type:
        :   int in [0, inf], default 0, (readonly)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.StringProperty.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.StringProperty.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Struct.name_property`](Struct.md#bpy.types.Struct.name_property "bpy.types.Struct.name_property") |  |

[Next

Strip(bpy\_struct)](Strip.md)
[Previous
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.StringProperty.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.StringProperty.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* StringProperty(Property)
  + [`StringProperty`](#bpy.types.StringProperty)
    - [`StringProperty.default`](#bpy.types.StringProperty.default)
    - [`StringProperty.length_max`](#bpy.types.StringProperty.length_max)
    - [`StringProperty.bl_rna_get_subclass()`](#bpy.types.StringProperty.bl_rna_get_subclass)
    - [`StringProperty.bl_rna_get_subclass_py()`](#bpy.types.StringProperty.bl_rna_get_subclass_py)
