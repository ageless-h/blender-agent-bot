...
# ShaderFxGlow(ShaderFx)[¶](#shaderfxglow-shaderfx "Link to this heading")
...
*class* bpy.types.ShaderFxGlow(*ShaderFx*)[¶](#bpy.types.ShaderFxGlow "Link to this definition")
:   Glow effect

    blend\_mode[¶](#bpy.types.ShaderFxGlow.blend_mode "Link to this definition")
    :   Blend mode

        Type:
        :   enum in [`'REGULAR'`, `'ADD'`, `'SUBTRACT'`, `'MULTIPLY'`, `'DIVIDE'`], default `'REGULAR'`

    glow\_color[¶](#bpy.types.ShaderFxGlow.glow_color "Link to this definition")
    ...
    mode[¶](#bpy.types.ShaderFxGlow.mode "Link to this definition")
    :   Glow mode

        Type:
        :   enum in [`'LUMINANCE'`, `'COLOR'`], default `'LUMINANCE'`

    opacity[¶](#bpy.types.ShaderFxGlow.opacity "Link to this definition")
    :   Effect Opacity

        Type:
        :   float in [0, 1], default 0.0

    rotation[¶](#bpy.types.ShaderFxGlow.rotation "Link to this definition")
    :   Rotation of the effect

        Type:
        :   float in [-inf, inf], default 0.0

    samples[¶](#bpy.types.ShaderFxGlow.samples "Link to this definition")
    :   Number of Blur Samples

        Type:
        :   int in [1, 32], default 4

    select\_color[¶](#bpy.types.ShaderFxGlow.select_color "Link to this definition")
    :   Color selected to apply glow

        Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    size[¶](#bpy.types.ShaderFxGlow.size "Link to this definition")
    :   Size of the effect

        Type:
        :   [`mathutils.Vector`](../../mathutils/index.md#mathutils.Vector "mathutils.Vector") of 2 items in [0, inf], default (0.0, 0.0)

    threshold[¶](#bpy.types.ShaderFxGlow.threshold "Link to this definition")
    :   Limit to select color for glow effect

        Type:
        :   float in [0, 1], default 0.0

    use\_glow\_under[¶](#bpy.types.ShaderFxGlow.use_glow_under "Link to this definition")
    :   Glow only areas with alpha (not supported with Regular blend mode)

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ShaderFxGlow.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ShaderFxGlow.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ShaderFxGlow.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ShaderFxGlow.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ShaderFxGlow(ShaderFx)
  + [`ShaderFxGlow`](#bpy.types.ShaderFxGlow)
    - [`ShaderFxGlow.blend_mode`](#bpy.types.ShaderFxGlow.blend_mode)
    - [`ShaderFxGlow.glow_color`](#bpy.types.ShaderFxGlow.glow_color)
    - [`ShaderFxGlow.mode`](#bpy.types.ShaderFxGlow.mode)
    - [`ShaderFxGlow.opacity`](#bpy.types.ShaderFxGlow.opacity)
    - [`ShaderFxGlow.rotation`](#bpy.types.ShaderFxGlow.rotation)
    - [`ShaderFxGlow.samples`](#bpy.types.ShaderFxGlow.samples)
    - [`ShaderFxGlow.select_color`](#bpy.types.ShaderFxGlow.select_color)
    - [`ShaderFxGlow.size`](#bpy.types.ShaderFxGlow.size)
    - [`ShaderFxGlow.threshold`](#bpy.types.ShaderFxGlow.threshold)
    - [`ShaderFxGlow.use_glow_under`](#bpy.types.ShaderFxGlow.use_glow_under)
    - [`ShaderFxGlow.bl_rna_get_subclass()`](#bpy.types.ShaderFxGlow.bl_rna_get_subclass)
    - [`ShaderFxGlow.bl_rna_get_subclass_py()`](#bpy.types.ShaderFxGlow.bl_rna_get_subclass_py)
