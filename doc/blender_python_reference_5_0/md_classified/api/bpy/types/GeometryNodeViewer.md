...
:   Display the input data in the Spreadsheet Editor
    ...
    active\_index[¶](#bpy.types.GeometryNodeViewer.active_index "Link to this definition")
    :   Index of the active item

        Type:
        :   int in [0, inf], default 0

    active\_item[¶](#bpy.types.GeometryNodeViewer.active_item "Link to this definition")
    :   Type:
        :   [`NodeGeometryViewerItem`](NodeGeometryViewerItem.md#bpy.types.NodeGeometryViewerItem "bpy.types.NodeGeometryViewerItem")
    ...
    viewer\_items[¶](#bpy.types.GeometryNodeViewer.viewer_items "Link to this definition")
    :   Type:
        :   [`NodeGeometryViewerItems`](NodeGeometryViewerItems.md#bpy.types.NodeGeometryViewerItems "bpy.types.NodeGeometryViewerItems") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`NodeGeometryViewerItem`](NodeGeometryViewerItem.md#bpy.types.NodeGeometryViewerItem "bpy.types.NodeGeometryViewerItem"), (readonly)
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeViewer.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.GeometryNodeViewer.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeViewer(GeometryNode)
  + [`GeometryNodeViewer`](#bpy.types.GeometryNodeViewer)
    - [`GeometryNodeViewer.active_index`](#bpy.types.GeometryNodeViewer.active_index)
    - [`GeometryNodeViewer.active_item`](#bpy.types.GeometryNodeViewer.active_item)
    ...
    - [`GeometryNodeViewer.viewer_items`](#bpy.types.GeometryNodeViewer.viewer_items)
