...
# NodeFunctionFormatStringItems(bpy\_struct)[¶](#nodefunctionformatstringitems-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.NodeFunctionFormatStringItems(*bpy\_struct*)[¶](#bpy.types.NodeFunctionFormatStringItems "Link to this definition")
:   Collection of format string items

    new(*socket\_type*, *name*)[¶](#bpy.types.NodeFunctionFormatStringItems.new "Link to this definition")
    :   Add an item at the end
        ...
        Return type:
        :   [`NodeFunctionFormatStringItem`](NodeFunctionFormatStringItem.md#bpy.types.NodeFunctionFormatStringItem "bpy.types.NodeFunctionFormatStringItem")

    remove(*item*)[¶](#bpy.types.NodeFunctionFormatStringItems.remove "Link to this definition")
    :   Remove an item

        Parameters:
        :   **item** ([`NodeFunctionFormatStringItem`](NodeFunctionFormatStringItem.md#bpy.types.NodeFunctionFormatStringItem "bpy.types.NodeFunctionFormatStringItem"), (never None)) – Item, The item to remove

    clear()[¶](#bpy.types.NodeFunctionFormatStringItems.clear "Link to this definition")
    :   Remove all items

    move(*from\_index*, *to\_index*)[¶](#bpy.types.NodeFunctionFormatStringItems.move "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.NodeFunctionFormatStringItems.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.NodeFunctionFormatStringItems.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`FunctionNodeFormatString.format_items`](FunctionNodeFormatString.md#bpy.types.FunctionNodeFormatString.format_items "bpy.types.FunctionNodeFormatString.format_items") |  |
...
NodeFunctionFormatStringItem(bpy\_struct)](NodeFunctionFormatStringItem.md)
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.NodeFunctionFormatStringItems.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.NodeFunctionFormatStringItems.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* NodeFunctionFormatStringItems(bpy\_struct)
  + [`NodeFunctionFormatStringItems`](#bpy.types.NodeFunctionFormatStringItems)
    - [`NodeFunctionFormatStringItems.new()`](#bpy.types.NodeFunctionFormatStringItems.new)
    - [`NodeFunctionFormatStringItems.remove()`](#bpy.types.NodeFunctionFormatStringItems.remove)
    - [`NodeFunctionFormatStringItems.clear()`](#bpy.types.NodeFunctionFormatStringItems.clear)
    - [`NodeFunctionFormatStringItems.move()`](#bpy.types.NodeFunctionFormatStringItems.move)
    - [`NodeFunctionFormatStringItems.bl_rna_get_subclass()`](#bpy.types.NodeFunctionFormatStringItems.bl_rna_get_subclass)
    - [`NodeFunctionFormatStringItems.bl_rna_get_subclass_py()`](#bpy.types.NodeFunctionFormatStringItems.bl_rna_get_subclass_py)
