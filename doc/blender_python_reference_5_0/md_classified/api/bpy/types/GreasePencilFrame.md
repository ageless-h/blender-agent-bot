...
# GreasePencilFrame(bpy\_struct)[¶](#greasepencilframe-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.GreasePencilFrame(*bpy\_struct*)[¶](#bpy.types.GreasePencilFrame "Link to this definition")
:   A Grease Pencil keyframe

    drawing[¶](#bpy.types.GreasePencilFrame.drawing "Link to this definition")
    :   A Grease Pencil drawing

        Type:
        :   [`GreasePencilDrawing`](GreasePencilDrawing.md#bpy.types.GreasePencilDrawing "bpy.types.GreasePencilDrawing")

    frame\_number[¶](#bpy.types.GreasePencilFrame.frame_number "Link to this definition")
    :   The frame number in the scene

        Type:
        :   int in [-1048574, 1048574], default 0, (readonly)

    keyframe\_type[¶](#bpy.types.GreasePencilFrame.keyframe_type "Link to this definition")
    :   Type of keyframe
    ...
    select[¶](#bpy.types.GreasePencilFrame.select "Link to this definition")
    :   Frame Selection in the Dope Sheet

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.GreasePencilFrame.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.GreasePencilFrame.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`GreasePencilFrames.copy`](GreasePencilFrames.md#bpy.types.GreasePencilFrames.copy "bpy.types.GreasePencilFrames.copy") * [`GreasePencilFrames.move`](GreasePencilFrames.md#bpy.types.GreasePencilFrames.move "bpy.types.GreasePencilFrames.move") * [`GreasePencilFrames.new`](GreasePencilFrames.md#bpy.types.GreasePencilFrames.new "bpy.types.GreasePencilFrames.new") | * [`GreasePencilLayer.current_frame`](GreasePencilLayer.md#bpy.types.GreasePencilLayer.current_frame "bpy.types.GreasePencilLayer.current_frame") * [`GreasePencilLayer.frames`](GreasePencilLayer.md#bpy.types.GreasePencilLayer.frames "bpy.types.GreasePencilLayer.frames") * [`GreasePencilLayer.get_frame_at`](GreasePencilLayer.md#bpy.types.GreasePencilLayer.get_frame_at "bpy.types.GreasePencilLayer.get_frame_at") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GreasePencilFrame.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.GreasePencilFrame.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GreasePencilFrame(bpy\_struct)
  + [`GreasePencilFrame`](#bpy.types.GreasePencilFrame)
    - [`GreasePencilFrame.drawing`](#bpy.types.GreasePencilFrame.drawing)
    - [`GreasePencilFrame.frame_number`](#bpy.types.GreasePencilFrame.frame_number)
    - [`GreasePencilFrame.keyframe_type`](#bpy.types.GreasePencilFrame.keyframe_type)
    - [`GreasePencilFrame.select`](#bpy.types.GreasePencilFrame.select)
    - [`GreasePencilFrame.bl_rna_get_subclass()`](#bpy.types.GreasePencilFrame.bl_rna_get_subclass)
    - [`GreasePencilFrame.bl_rna_get_subclass_py()`](#bpy.types.GreasePencilFrame.bl_rna_get_subclass_py)
