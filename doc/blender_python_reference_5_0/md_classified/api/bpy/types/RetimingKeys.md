...
# RetimingKeys(bpy\_struct)[¶](#retimingkeys-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.RetimingKeys(*bpy\_struct*)[¶](#bpy.types.RetimingKeys "Link to this definition")
:   Collection of RetimingKey

    add(*\**, *timeline\_frame=0*)[¶](#bpy.types.RetimingKeys.add "Link to this definition")
    :   Add retiming key

        Parameters:
        :   **timeline\_frame** (*int in* *[**-1048574**,* *1048574**]**,* *(**optional**)*) – Timeline Frame

        Returns:
        :   New RetimingKey

        Return type:
        :   [`RetimingKey`](RetimingKey.md#bpy.types.RetimingKey "bpy.types.RetimingKey")

    reset()[¶](#bpy.types.RetimingKeys.reset "Link to this definition")
    :   Remove all retiming keys

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.RetimingKeys.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.RetimingKeys.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`ImageStrip.retiming_keys`](ImageStrip.md#bpy.types.ImageStrip.retiming_keys "bpy.types.ImageStrip.retiming_keys") * [`MovieStrip.retiming_keys`](MovieStrip.md#bpy.types.MovieStrip.retiming_keys "bpy.types.MovieStrip.retiming_keys") | * [`SceneStrip.retiming_keys`](SceneStrip.md#bpy.types.SceneStrip.retiming_keys "bpy.types.SceneStrip.retiming_keys") * [`SoundStrip.retiming_keys`](SoundStrip.md#bpy.types.SoundStrip.retiming_keys "bpy.types.SoundStrip.retiming_keys") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.RetimingKeys.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.RetimingKeys.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* RetimingKeys(bpy\_struct)
  + [`RetimingKeys`](#bpy.types.RetimingKeys)
    - [`RetimingKeys.add()`](#bpy.types.RetimingKeys.add)
    - [`RetimingKeys.reset()`](#bpy.types.RetimingKeys.reset)
    - [`RetimingKeys.bl_rna_get_subclass()`](#bpy.types.RetimingKeys.bl_rna_get_subclass)
    - [`RetimingKeys.bl_rna_get_subclass_py()`](#bpy.types.RetimingKeys.bl_rna_get_subclass_py)
