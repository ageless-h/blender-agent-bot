...
# LineStyleGeometryModifier\_Sampling(LineStyleGeometryModifier)[¶](#linestylegeometrymodifier-sampling-linestylegeometrymodifier "Link to this heading")
...
*class* bpy.types.LineStyleGeometryModifier\_Sampling(*LineStyleGeometryModifier*)[¶](#bpy.types.LineStyleGeometryModifier_Sampling "Link to this definition")
:   Specify a new sampling value that determines the resolution of stroke polylines

    expanded[¶](#bpy.types.LineStyleGeometryModifier_Sampling.expanded "Link to this definition")
    :   True if the modifier tab is expanded

        Type:
        :   boolean, default False

    sampling[¶](#bpy.types.LineStyleGeometryModifier_Sampling.sampling "Link to this definition")
    :   New sampling value to be used for subsequent modifiers

        Type:
        :   float in [0, 10000], default 0.0

    type[¶](#bpy.types.LineStyleGeometryModifier_Sampling.type "Link to this definition")
    ...
    use[¶](#bpy.types.LineStyleGeometryModifier_Sampling.use "Link to this definition")
    :   Enable or disable this modifier during stroke rendering

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.LineStyleGeometryModifier_Sampling.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.LineStyleGeometryModifier_Sampling.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
        ...
        Return type:
        :   [type](#bpy.types.LineStyleGeometryModifier_Sampling.type "bpy.types.LineStyleGeometryModifier_Sampling.type")
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.LineStyleGeometryModifier_Sampling.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.LineStyleGeometryModifier_Sampling.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* LineStyleGeometryModifier\_Sampling(LineStyleGeometryModifier)
  + [`LineStyleGeometryModifier_Sampling`](#bpy.types.LineStyleGeometryModifier_Sampling)
    - [`LineStyleGeometryModifier_Sampling.expanded`](#bpy.types.LineStyleGeometryModifier_Sampling.expanded)
    - [`LineStyleGeometryModifier_Sampling.sampling`](#bpy.types.LineStyleGeometryModifier_Sampling.sampling)
    - [`LineStyleGeometryModifier_Sampling.type`](#bpy.types.LineStyleGeometryModifier_Sampling.type)
    - [`LineStyleGeometryModifier_Sampling.use`](#bpy.types.LineStyleGeometryModifier_Sampling.use)
    - [`LineStyleGeometryModifier_Sampling.bl_rna_get_subclass()`](#bpy.types.LineStyleGeometryModifier_Sampling.bl_rna_get_subclass)
    - [`LineStyleGeometryModifier_Sampling.bl_rna_get_subclass_py()`](#bpy.types.LineStyleGeometryModifier_Sampling.bl_rna_get_subclass_py)
