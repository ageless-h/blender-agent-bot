...
# ConsoleLine(bpy\_struct)[¶](#consoleline-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.ConsoleLine(*bpy\_struct*)[¶](#bpy.types.ConsoleLine "Link to this definition")
:   Input line for the interactive console

    body[¶](#bpy.types.ConsoleLine.body "Link to this definition")
    :   Text in the line

        Type:
        :   string, default “”, (never None)

    current\_character[¶](#bpy.types.ConsoleLine.current_character "Link to this definition")
    :   Type:
        :   int in [-inf, inf], default 0

    type[¶](#bpy.types.ConsoleLine.type "Link to this definition")
    :   Console line type when used in scrollback

        Type:
        :   enum in [`'OUTPUT'`, `'INPUT'`, `'INFO'`, `'ERROR'`], default `'OUTPUT'`

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ConsoleLine.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ConsoleLine.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`SpaceConsole.history`](SpaceConsole.md#bpy.types.SpaceConsole.history "bpy.types.SpaceConsole.history") | * [`SpaceConsole.scrollback`](SpaceConsole.md#bpy.types.SpaceConsole.scrollback "bpy.types.SpaceConsole.scrollback") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ConsoleLine.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ConsoleLine.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ConsoleLine(bpy\_struct)
  + [`ConsoleLine`](#bpy.types.ConsoleLine)
    - [`ConsoleLine.body`](#bpy.types.ConsoleLine.body)
    - [`ConsoleLine.current_character`](#bpy.types.ConsoleLine.current_character)
    - [`ConsoleLine.type`](#bpy.types.ConsoleLine.type)
    - [`ConsoleLine.bl_rna_get_subclass()`](#bpy.types.ConsoleLine.bl_rna_get_subclass)
    - [`ConsoleLine.bl_rna_get_subclass_py()`](#bpy.types.ConsoleLine.bl_rna_get_subclass_py)
