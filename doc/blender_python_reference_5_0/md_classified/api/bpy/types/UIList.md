...
:   UI list containing the elements of a collection
    ...
    bitflag\_item\_never\_show[¶](#bpy.types.UIList.bitflag_item_never_show "Link to this definition")
    ...
    bl\_system\_properties\_get(*\**, *do\_create=False*)[¶](#bpy.types.UIList.bl_system_properties_get "Link to this definition")
    ...
    draw\_item(*context*, *layout*, *data*, *item*, *icon*, *active\_data*, *active\_property*, *index*, *flt\_flag*)[¶](#bpy.types.UIList.draw_item "Link to this definition")
    :   Draw an item in the list (NOTE: when you define your own draw\_item function, you may want to check given ‘item’ is of the right type…)
        ...
        :   * **layout** ([`UILayout`](UILayout.md#bpy.types.UILayout "bpy.types.UILayout"), (never None)) – Layout to draw the item
            ...
            * **active\_property** (*string**,* *(**optional for registration**,* *never None**)*) – Identifier of property in active\_data, for the active element
            * **index** (*int in* *[**0**,* *inf**]*) – Index of the item in the collection
            * **flt\_flag** (*int in* *[**0**,* *inf**]*) – The filter-flag result for this item
    ...
    :   Filter and/or re-order items of the collection (output filter results in filter\_flags, and reorder results in filter\_neworder arrays)
        ...
        Returns:
        :   `filter_flags`, An array of filter flags, one for each item in the collection (NOTE: The upper 16 bits, including FILTER\_ITEM, are reserved, only use the lower 16 bits for custom usages), int array of 1 items in [0, inf]
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.UIList.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.UIList.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)
...
* UIList(bpy\_struct)
  ...
  + [Advanced UIList Example - Filtering and Reordering](#advanced-uilist-example-filtering-and-reordering)
    - [`UIList`](#bpy.types.UIList)
      ...
      * [`UIList.bitflag_item_never_show`](#bpy.types.UIList.bitflag_item_never_show)
      ...
      * [`UIList.bl_system_properties_get()`](#bpy.types.UIList.bl_system_properties_get)
