...
# MaskSpline(bpy\_struct)[¶](#maskspline-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.MaskSpline(*bpy\_struct*)[¶](#bpy.types.MaskSpline "Link to this definition")
:   Single spline used for defining mask shape

    offset\_mode[¶](#bpy.types.MaskSpline.offset_mode "Link to this definition")
    ...
    points[¶](#bpy.types.MaskSpline.points "Link to this definition")
    :   Collection of points

        Type:
        :   [`MaskSplinePoints`](MaskSplinePoints.md#bpy.types.MaskSplinePoints "bpy.types.MaskSplinePoints") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`MaskSplinePoint`](MaskSplinePoint.md#bpy.types.MaskSplinePoint "bpy.types.MaskSplinePoint"), (readonly)

    use\_cyclic[¶](#bpy.types.MaskSpline.use_cyclic "Link to this definition")
    :   Make this spline a closed loop

        Type:
        :   boolean, default False

    use\_fill[¶](#bpy.types.MaskSpline.use_fill "Link to this definition")
    :   Make this spline filled

        Type:
        :   boolean, default False

    use\_self\_intersection\_check[¶](#bpy.types.MaskSpline.use_self_intersection_check "Link to this definition")
    :   Prevent feather from self-intersections

        Type:
        :   boolean, default False

    weight\_interpolation[¶](#bpy.types.MaskSpline.weight_interpolation "Link to this definition")
    :   The type of weight interpolation for spline

        Type:
        :   enum in [`'LINEAR'`, `'EASE'`], default `'LINEAR'`

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.MaskSpline.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.MaskSpline.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`MaskLayer.splines`](MaskLayer.md#bpy.types.MaskLayer.splines "bpy.types.MaskLayer.splines") * [`MaskSplines.active`](MaskSplines.md#bpy.types.MaskSplines.active "bpy.types.MaskSplines.active") | * [`MaskSplines.new`](MaskSplines.md#bpy.types.MaskSplines.new "bpy.types.MaskSplines.new") * [`MaskSplines.remove`](MaskSplines.md#bpy.types.MaskSplines.remove "bpy.types.MaskSplines.remove") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.MaskSpline.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.MaskSpline.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* MaskSpline(bpy\_struct)
  + [`MaskSpline`](#bpy.types.MaskSpline)
    - [`MaskSpline.offset_mode`](#bpy.types.MaskSpline.offset_mode)
    - [`MaskSpline.points`](#bpy.types.MaskSpline.points)
    - [`MaskSpline.use_cyclic`](#bpy.types.MaskSpline.use_cyclic)
    - [`MaskSpline.use_fill`](#bpy.types.MaskSpline.use_fill)
    - [`MaskSpline.use_self_intersection_check`](#bpy.types.MaskSpline.use_self_intersection_check)
    - [`MaskSpline.weight_interpolation`](#bpy.types.MaskSpline.weight_interpolation)
    - [`MaskSpline.bl_rna_get_subclass()`](#bpy.types.MaskSpline.bl_rna_get_subclass)
    - [`MaskSpline.bl_rna_get_subclass_py()`](#bpy.types.MaskSpline.bl_rna_get_subclass_py)
