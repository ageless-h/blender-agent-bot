...
# BlendDataVolumes(bpy\_struct)[¶](#blenddatavolumes-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.BlendDataVolumes(*bpy\_struct*)[¶](#bpy.types.BlendDataVolumes "Link to this definition")
:   Collection of volumes

    new(*name*)[¶](#bpy.types.BlendDataVolumes.new "Link to this definition")
    :   Add a new volume to the main database
        ...
        Return type:
        :   [`Volume`](Volume.md#bpy.types.Volume "bpy.types.Volume")

    remove(*volume*, *\**, *do\_unlink=True*, *do\_id\_user=True*, *do\_ui\_user=True*)[¶](#bpy.types.BlendDataVolumes.remove "Link to this definition")
    :   Remove a volume from the current blendfile

        Parameters:
        :   * **volume** ([`Volume`](Volume.md#bpy.types.Volume "bpy.types.Volume"), (never None)) – Volume to remove
            * **do\_unlink** (*boolean**,* *(**optional**)*) – Unlink all usages of this volume before deleting it (WARNING: will also delete objects instancing that volume data)
            * **do\_id\_user** (*boolean**,* *(**optional**)*) – Decrement user counter of all data-blocks used by this volume data
            * **do\_ui\_user** (*boolean**,* *(**optional**)*) – Make sure interface does not reference this volume data

    tag(*value*)[¶](#bpy.types.BlendDataVolumes.tag "Link to this definition")
    :   tag

        Parameters:
        :   **value** (*boolean*) – Value

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.BlendDataVolumes.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.BlendDataVolumes.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`BlendData.volumes`](BlendData.md#bpy.types.BlendData.volumes "bpy.types.BlendData.volumes") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.BlendDataVolumes.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.BlendDataVolumes.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* BlendDataVolumes(bpy\_struct)
  + [`BlendDataVolumes`](#bpy.types.BlendDataVolumes)
    - [`BlendDataVolumes.new()`](#bpy.types.BlendDataVolumes.new)
    - [`BlendDataVolumes.remove()`](#bpy.types.BlendDataVolumes.remove)
    - [`BlendDataVolumes.tag()`](#bpy.types.BlendDataVolumes.tag)
    - [`BlendDataVolumes.bl_rna_get_subclass()`](#bpy.types.BlendDataVolumes.bl_rna_get_subclass)
    - [`BlendDataVolumes.bl_rna_get_subclass_py()`](#bpy.types.BlendDataVolumes.bl_rna_get_subclass_py)
