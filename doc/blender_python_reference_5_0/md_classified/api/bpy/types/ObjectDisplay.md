...
# ObjectDisplay(bpy\_struct)[¶](#objectdisplay-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.ObjectDisplay(*bpy\_struct*)[¶](#bpy.types.ObjectDisplay "Link to this definition")
:   Object display settings for 3D viewport

    show\_shadows[¶](#bpy.types.ObjectDisplay.show_shadows "Link to this definition")
    :   Object cast shadows in the 3D viewport

        Type:
        :   boolean, default True

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ObjectDisplay.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ObjectDisplay.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Object.display`](Object.md#bpy.types.Object.display "bpy.types.Object.display") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ObjectDisplay.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ObjectDisplay.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ObjectDisplay(bpy\_struct)
  + [`ObjectDisplay`](#bpy.types.ObjectDisplay)
    - [`ObjectDisplay.show_shadows`](#bpy.types.ObjectDisplay.show_shadows)
    - [`ObjectDisplay.bl_rna_get_subclass()`](#bpy.types.ObjectDisplay.bl_rna_get_subclass)
    - [`ObjectDisplay.bl_rna_get_subclass_py()`](#bpy.types.ObjectDisplay.bl_rna_get_subclass_py)
