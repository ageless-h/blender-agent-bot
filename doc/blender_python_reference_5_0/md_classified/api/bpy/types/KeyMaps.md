...
# KeyMaps(bpy\_struct)[¶](#keymaps-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.KeyMaps(*bpy\_struct*)[¶](#bpy.types.KeyMaps "Link to this definition")
:   Collection of keymaps

    new(*name*, *\**, *space\_type='EMPTY'*, *region\_type='WINDOW'*, *modal=False*, *tool=False*)[¶](#bpy.types.KeyMaps.new "Link to this definition")
    :   Ensure the keymap exists. This will return the one with the given name/space type/region type, or create a new one if it does not exist yet.
        ...
        :   * **name** (*string**,* *(**never None**)*) – Name
            * **space\_type** (enum in [Space Type Items](../../../appendix/bpy_types_enum_items/space_type_items.md#rna-enum-space-type-items), (optional)) – Space Type
            * **region\_type** (enum in [Region Type Items](../../../appendix/bpy_types_enum_items/region_type_items.md#rna-enum-region-type-items), (optional)) – Region Type
        ...
        Return type:
        :   [`KeyMap`](KeyMap.md#bpy.types.KeyMap "bpy.types.KeyMap")

    remove(*keymap*)[¶](#bpy.types.KeyMaps.remove "Link to this definition")
    :   remove

        Parameters:
        :   **keymap** ([`KeyMap`](KeyMap.md#bpy.types.KeyMap "bpy.types.KeyMap"), (never None)) – Key Map, Removed key map

    clear()[¶](#bpy.types.KeyMaps.clear "Link to this definition")
    :   Remove all keymaps.

    find(*name*, *\**, *space\_type='EMPTY'*, *region\_type='WINDOW'*)[¶](#bpy.types.KeyMaps.find "Link to this definition")
    :   find
    ...
    find\_match(*keymap*)[¶](#bpy.types.KeyMaps.find_match "Link to this definition")
    :   find\_match

        Parameters:
        :   **keymap** ([`KeyMap`](KeyMap.md#bpy.types.KeyMap "bpy.types.KeyMap")) – Key Map, The key map for comparison
    ...
    find\_modal(*name*)[¶](#bpy.types.KeyMaps.find_modal "Link to this definition")
    :   find\_modal
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.KeyMaps.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.KeyMaps.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`KeyConfig.keymaps`](KeyConfig.md#bpy.types.KeyConfig.keymaps "bpy.types.KeyConfig.keymaps") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.KeyMaps.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.KeyMaps.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* KeyMaps(bpy\_struct)
  + [`KeyMaps`](#bpy.types.KeyMaps)
    - [`KeyMaps.new()`](#bpy.types.KeyMaps.new)
    - [`KeyMaps.remove()`](#bpy.types.KeyMaps.remove)
    - [`KeyMaps.clear()`](#bpy.types.KeyMaps.clear)
    - [`KeyMaps.find()`](#bpy.types.KeyMaps.find)
    - [`KeyMaps.find_match()`](#bpy.types.KeyMaps.find_match)
    - [`KeyMaps.find_modal()`](#bpy.types.KeyMaps.find_modal)
    - [`KeyMaps.bl_rna_get_subclass()`](#bpy.types.KeyMaps.bl_rna_get_subclass)
    - [`KeyMaps.bl_rna_get_subclass_py()`](#bpy.types.KeyMaps.bl_rna_get_subclass_py)
