...
# VertexWeightProximityModifier(Modifier)[¶](#vertexweightproximitymodifier-modifier "Link to this heading")
...
*class* bpy.types.VertexWeightProximityModifier(*Modifier*)[¶](#bpy.types.VertexWeightProximityModifier "Link to this definition")
:   Set the weights of vertices in a group from a target object’s distance

    falloff\_type[¶](#bpy.types.VertexWeightProximityModifier.falloff_type "Link to this definition")
    ...
    invert\_falloff[¶](#bpy.types.VertexWeightProximityModifier.invert_falloff "Link to this definition")
    :   Invert the resulting falloff weight

        Type:
        :   boolean, default False

    invert\_mask\_vertex\_group[¶](#bpy.types.VertexWeightProximityModifier.invert_mask_vertex_group "Link to this definition")
    :   Invert vertex group mask influence

        Type:
        :   boolean, default False

    map\_curve[¶](#bpy.types.VertexWeightProximityModifier.map_curve "Link to this definition")
    :   Custom mapping curve

        Type:
        :   [`CurveMapping`](CurveMapping.md#bpy.types.CurveMapping "bpy.types.CurveMapping"), (readonly)

    mask\_constant[¶](#bpy.types.VertexWeightProximityModifier.mask_constant "Link to this definition")
    :   Global influence of current modifications on vgroup

        Type:
        :   float in [-inf, inf], default 1.0

    mask\_tex\_map\_bone[¶](#bpy.types.VertexWeightProximityModifier.mask_tex_map_bone "Link to this definition")
    :   Which bone to take texture coordinates from

        Type:
        :   string, default “”, (never None)

    mask\_tex\_map\_object[¶](#bpy.types.VertexWeightProximityModifier.mask_tex_map_object "Link to this definition")
    :   Which object to take texture coordinates from

        Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object")

    mask\_tex\_mapping[¶](#bpy.types.VertexWeightProximityModifier.mask_tex_mapping "Link to this definition")
    ...
    mask\_tex\_use\_channel[¶](#bpy.types.VertexWeightProximityModifier.mask_tex_use_channel "Link to this definition")
    :   Which texture channel to use for masking

        Type:
        :   enum in [`'INT'`, `'RED'`, `'GREEN'`, `'BLUE'`, `'HUE'`, `'SAT'`, `'VAL'`, `'ALPHA'`], default `'INT'`

    mask\_tex\_uv\_layer[¶](#bpy.types.VertexWeightProximityModifier.mask_tex_uv_layer "Link to this definition")
    :   UV map name

        Type:
        :   string, default “”, (never None)

    mask\_texture[¶](#bpy.types.VertexWeightProximityModifier.mask_texture "Link to this definition")
    :   Masking texture

        Type:
        :   [`Texture`](Texture.md#bpy.types.Texture "bpy.types.Texture")

    mask\_vertex\_group[¶](#bpy.types.VertexWeightProximityModifier.mask_vertex_group "Link to this definition")
    :   Masking vertex group name

        Type:
        :   string, default “”, (never None)

    max\_dist[¶](#bpy.types.VertexWeightProximityModifier.max_dist "Link to this definition")
    :   Distance mapping to weight 1.0

        Type:
        :   float in [0, inf], default 1.0

    min\_dist[¶](#bpy.types.VertexWeightProximityModifier.min_dist "Link to this definition")
    :   Distance mapping to weight 0.0

        Type:
        :   float in [0, inf], default 0.0

    normalize[¶](#bpy.types.VertexWeightProximityModifier.normalize "Link to this definition")
    :   Normalize the resulting weights (otherwise they are only clamped within 0.0 to 1.0 range)

        Type:
        :   boolean, default False

    proximity\_geometry[¶](#bpy.types.VertexWeightProximityModifier.proximity_geometry "Link to this definition")
    ...
    proximity\_mode[¶](#bpy.types.VertexWeightProximityModifier.proximity_mode "Link to this definition")
    ...
    target[¶](#bpy.types.VertexWeightProximityModifier.target "Link to this definition")
    :   Object to calculate vertices distances from

        Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object")

    vertex\_group[¶](#bpy.types.VertexWeightProximityModifier.vertex_group "Link to this definition")
    :   Vertex group name

        Type:
        :   string, default “”, (never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.VertexWeightProximityModifier.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.VertexWeightProximityModifier.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.VertexWeightProximityModifier.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.VertexWeightProximityModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* VertexWeightProximityModifier(Modifier)
  + [`VertexWeightProximityModifier`](#bpy.types.VertexWeightProximityModifier)
    - [`VertexWeightProximityModifier.falloff_type`](#bpy.types.VertexWeightProximityModifier.falloff_type)
    - [`VertexWeightProximityModifier.invert_falloff`](#bpy.types.VertexWeightProximityModifier.invert_falloff)
    - [`VertexWeightProximityModifier.invert_mask_vertex_group`](#bpy.types.VertexWeightProximityModifier.invert_mask_vertex_group)
    - [`VertexWeightProximityModifier.map_curve`](#bpy.types.VertexWeightProximityModifier.map_curve)
    - [`VertexWeightProximityModifier.mask_constant`](#bpy.types.VertexWeightProximityModifier.mask_constant)
    - [`VertexWeightProximityModifier.mask_tex_map_bone`](#bpy.types.VertexWeightProximityModifier.mask_tex_map_bone)
    - [`VertexWeightProximityModifier.mask_tex_map_object`](#bpy.types.VertexWeightProximityModifier.mask_tex_map_object)
    - [`VertexWeightProximityModifier.mask_tex_mapping`](#bpy.types.VertexWeightProximityModifier.mask_tex_mapping)
    - [`VertexWeightProximityModifier.mask_tex_use_channel`](#bpy.types.VertexWeightProximityModifier.mask_tex_use_channel)
    - [`VertexWeightProximityModifier.mask_tex_uv_layer`](#bpy.types.VertexWeightProximityModifier.mask_tex_uv_layer)
    - [`VertexWeightProximityModifier.mask_texture`](#bpy.types.VertexWeightProximityModifier.mask_texture)
    - [`VertexWeightProximityModifier.mask_vertex_group`](#bpy.types.VertexWeightProximityModifier.mask_vertex_group)
    - [`VertexWeightProximityModifier.max_dist`](#bpy.types.VertexWeightProximityModifier.max_dist)
    - [`VertexWeightProximityModifier.min_dist`](#bpy.types.VertexWeightProximityModifier.min_dist)
    - [`VertexWeightProximityModifier.normalize`](#bpy.types.VertexWeightProximityModifier.normalize)
    - [`VertexWeightProximityModifier.proximity_geometry`](#bpy.types.VertexWeightProximityModifier.proximity_geometry)
    - [`VertexWeightProximityModifier.proximity_mode`](#bpy.types.VertexWeightProximityModifier.proximity_mode)
    - [`VertexWeightProximityModifier.target`](#bpy.types.VertexWeightProximityModifier.target)
    - [`VertexWeightProximityModifier.vertex_group`](#bpy.types.VertexWeightProximityModifier.vertex_group)
    - [`VertexWeightProximityModifier.bl_rna_get_subclass()`](#bpy.types.VertexWeightProximityModifier.bl_rna_get_subclass)
    - [`VertexWeightProximityModifier.bl_rna_get_subclass_py()`](#bpy.types.VertexWeightProximityModifier.bl_rna_get_subclass_py)
