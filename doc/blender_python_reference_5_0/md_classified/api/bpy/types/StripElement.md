...
# StripElement(bpy\_struct)[¶](#stripelement-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.StripElement(*bpy\_struct*)[¶](#bpy.types.StripElement "Link to this definition")
:   Sequence strip data for a single frame

    filename[¶](#bpy.types.StripElement.filename "Link to this definition")
    :   Name of the source file

        Type:
        :   string, default “”, (never None)

    orig\_fps[¶](#bpy.types.StripElement.orig_fps "Link to this definition")
    :   Original frames per second

        Type:
        :   float in [-inf, inf], default 0.0, (readonly)

    orig\_height[¶](#bpy.types.StripElement.orig_height "Link to this definition")
    :   Original image height

        Type:
        :   int in [-inf, inf], default 0, (readonly)

    orig\_width[¶](#bpy.types.StripElement.orig_width "Link to this definition")
    :   Original image width

        Type:
        :   int in [-inf, inf], default 0, (readonly)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.StripElement.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.StripElement.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`ImageStrip.elements`](ImageStrip.md#bpy.types.ImageStrip.elements "bpy.types.ImageStrip.elements") * [`MovieStrip.elements`](MovieStrip.md#bpy.types.MovieStrip.elements "bpy.types.MovieStrip.elements") | * [`Strip.strip_elem_from_frame`](Strip.md#bpy.types.Strip.strip_elem_from_frame "bpy.types.Strip.strip_elem_from_frame") * [`StripElements.append`](StripElements.md#bpy.types.StripElements.append "bpy.types.StripElements.append") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.StripElement.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.StripElement.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* StripElement(bpy\_struct)
  + [`StripElement`](#bpy.types.StripElement)
    - [`StripElement.filename`](#bpy.types.StripElement.filename)
    - [`StripElement.orig_fps`](#bpy.types.StripElement.orig_fps)
    - [`StripElement.orig_height`](#bpy.types.StripElement.orig_height)
    - [`StripElement.orig_width`](#bpy.types.StripElement.orig_width)
    - [`StripElement.bl_rna_get_subclass()`](#bpy.types.StripElement.bl_rna_get_subclass)
    - [`StripElement.bl_rna_get_subclass_py()`](#bpy.types.StripElement.bl_rna_get_subclass_py)
