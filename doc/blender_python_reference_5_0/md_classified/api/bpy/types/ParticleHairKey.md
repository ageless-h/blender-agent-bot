...
# ParticleHairKey(bpy\_struct)[¶](#particlehairkey-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.ParticleHairKey(*bpy\_struct*)[¶](#bpy.types.ParticleHairKey "Link to this definition")
:   Particle key for hair particle system

    co[¶](#bpy.types.ParticleHairKey.co "Link to this definition")
    ...
    co\_local[¶](#bpy.types.ParticleHairKey.co_local "Link to this definition")
    :   Location of the hair key in its local coordinate system, relative to the emitting face

        Type:
        :   [`mathutils.Vector`](../../mathutils/index.md#mathutils.Vector "mathutils.Vector") of 3 items in [-inf, inf], default (0.0, 0.0, 0.0)

    time[¶](#bpy.types.ParticleHairKey.time "Link to this definition")
    :   Relative time of key over hair length

        Type:
        :   float in [0, inf], default 0.0

    weight[¶](#bpy.types.ParticleHairKey.weight "Link to this definition")
    :   Weight for cloth simulation

        Type:
        :   float in [0, 1], default 0.0

    co\_object(*object*, *modifier*, *particle*)[¶](#bpy.types.ParticleHairKey.co_object "Link to this definition")
    :   Obtain hairkey location with particle and modifier data
        ...
        :   * **object** ([`Object`](Object.md#bpy.types.Object "bpy.types.Object"), (never None)) – Object
            ...
            * **particle** ([`Particle`](Particle.md#bpy.types.Particle "bpy.types.Particle"), (never None)) – hair particle
    ...
    co\_object\_set(*object*, *modifier*, *particle*, *co*)[¶](#bpy.types.ParticleHairKey.co_object_set "Link to this definition")
    :   Set hairkey location with particle and modifier data
        ...
        :   * **object** ([`Object`](Object.md#bpy.types.Object "bpy.types.Object"), (never None)) – Object
            * **modifier** ([`ParticleSystemModifier`](ParticleSystemModifier.md#bpy.types.ParticleSystemModifier "bpy.types.ParticleSystemModifier"), (never None)) – Particle modifier
            * **particle** ([`Particle`](Particle.md#bpy.types.Particle "bpy.types.Particle"), (never None)) – hair particle
            * **co** ([`mathutils.Vector`](../../mathutils/index.md#mathutils.Vector "mathutils.Vector") of 3 items in [-inf, inf]) – Co, Specified hairkey location

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ParticleHairKey.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ParticleHairKey.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Particle.hair_keys`](Particle.md#bpy.types.Particle.hair_keys "bpy.types.Particle.hair_keys") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ParticleHairKey.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ParticleHairKey.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ParticleHairKey(bpy\_struct)
  + [`ParticleHairKey`](#bpy.types.ParticleHairKey)
    - [`ParticleHairKey.co`](#bpy.types.ParticleHairKey.co)
    - [`ParticleHairKey.co_local`](#bpy.types.ParticleHairKey.co_local)
    - [`ParticleHairKey.time`](#bpy.types.ParticleHairKey.time)
    - [`ParticleHairKey.weight`](#bpy.types.ParticleHairKey.weight)
    - [`ParticleHairKey.co_object()`](#bpy.types.ParticleHairKey.co_object)
    - [`ParticleHairKey.co_object_set()`](#bpy.types.ParticleHairKey.co_object_set)
    - [`ParticleHairKey.bl_rna_get_subclass()`](#bpy.types.ParticleHairKey.bl_rna_get_subclass)
    - [`ParticleHairKey.bl_rna_get_subclass_py()`](#bpy.types.ParticleHairKey.bl_rna_get_subclass_py)
