...
# EnumProperty(Property)[¶](#enumproperty-property "Link to this heading")
...
*class* bpy.types.EnumProperty(*Property*)[¶](#bpy.types.EnumProperty "Link to this definition")
:   RNA enumeration property definition, to choose from a number of predefined options

    default[¶](#bpy.types.EnumProperty.default "Link to this definition")
    :   Default value for this enum

        Type:
        :   enum in [`'DEFAULT'`], default `'DEFAULT'`, (readonly)

    default\_flag[¶](#bpy.types.EnumProperty.default_flag "Link to this definition")
    :   Default value for this enum

        Type:
        :   enum set in {`'DEFAULT'`}, default set(), (readonly)

    enum\_items[¶](#bpy.types.EnumProperty.enum_items "Link to this definition")
    :   Possible values for the property

        Type:
        :   [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`EnumPropertyItem`](EnumPropertyItem.md#bpy.types.EnumPropertyItem "bpy.types.EnumPropertyItem"), (readonly)

    enum\_items\_static[¶](#bpy.types.EnumProperty.enum_items_static "Link to this definition")
    :   Possible values for the property (never calls optional dynamic generation of those)

        Type:
        :   [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`EnumPropertyItem`](EnumPropertyItem.md#bpy.types.EnumPropertyItem "bpy.types.EnumPropertyItem"), (readonly)

    enum\_items\_static\_ui[¶](#bpy.types.EnumProperty.enum_items_static_ui "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.EnumProperty.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.EnumProperty.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.EnumProperty.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.EnumProperty.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* EnumProperty(Property)
  + [`EnumProperty`](#bpy.types.EnumProperty)
    - [`EnumProperty.default`](#bpy.types.EnumProperty.default)
    - [`EnumProperty.default_flag`](#bpy.types.EnumProperty.default_flag)
    - [`EnumProperty.enum_items`](#bpy.types.EnumProperty.enum_items)
    - [`EnumProperty.enum_items_static`](#bpy.types.EnumProperty.enum_items_static)
    - [`EnumProperty.enum_items_static_ui`](#bpy.types.EnumProperty.enum_items_static_ui)
    - [`EnumProperty.bl_rna_get_subclass()`](#bpy.types.EnumProperty.bl_rna_get_subclass)
    - [`EnumProperty.bl_rna_get_subclass_py()`](#bpy.types.EnumProperty.bl_rna_get_subclass_py)
