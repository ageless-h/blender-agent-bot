...
# CollectionObjects(bpy\_struct)[¶](#collectionobjects-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.CollectionObjects(*bpy\_struct*)[¶](#bpy.types.CollectionObjects "Link to this definition")
:   Collection of collection objects

    link(*object*)[¶](#bpy.types.CollectionObjects.link "Link to this definition")
    :   Add this object to a collection

        Parameters:
        :   **object** ([`Object`](Object.md#bpy.types.Object "bpy.types.Object"), (never None)) – Object to add

    unlink(*object*)[¶](#bpy.types.CollectionObjects.unlink "Link to this definition")
    :   Remove this object from a collection

        Parameters:
        :   **object** ([`Object`](Object.md#bpy.types.Object "bpy.types.Object")) – Object to remove

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.CollectionObjects.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.CollectionObjects.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Collection.objects`](Collection.md#bpy.types.Collection.objects "bpy.types.Collection.objects") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CollectionObjects.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.CollectionObjects.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CollectionObjects(bpy\_struct)
  + [`CollectionObjects`](#bpy.types.CollectionObjects)
    - [`CollectionObjects.link()`](#bpy.types.CollectionObjects.link)
    - [`CollectionObjects.unlink()`](#bpy.types.CollectionObjects.unlink)
    - [`CollectionObjects.bl_rna_get_subclass()`](#bpy.types.CollectionObjects.bl_rna_get_subclass)
    - [`CollectionObjects.bl_rna_get_subclass_py()`](#bpy.types.CollectionObjects.bl_rna_get_subclass_py)
