...
# GeometryNodeSDFGridOffset(GeometryNode)[¶](#geometrynodesdfgridoffset-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeSDFGridOffset(*GeometryNode*)[¶](#bpy.types.GeometryNodeSDFGridOffset "Link to this definition")
:   Offset a signed distance field surface by a world-space distance. Dilates (positive) or erodes (negative) while maintaining the signed distance property
    ...
    *classmethod* is\_registered\_node\_type()[¶](#bpy.types.GeometryNodeSDFGridOffset.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[¶](#bpy.types.GeometryNodeSDFGridOffset.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[¶](#bpy.types.GeometryNodeSDFGridOffset.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.GeometryNodeSDFGridOffset.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.GeometryNodeSDFGridOffset.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeSDFGridOffset.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.GeometryNodeSDFGridOffset.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeSDFGridOffset(GeometryNode)
  + [`GeometryNodeSDFGridOffset`](#bpy.types.GeometryNodeSDFGridOffset)
    - [`GeometryNodeSDFGridOffset.is_registered_node_type()`](#bpy.types.GeometryNodeSDFGridOffset.is_registered_node_type)
    - [`GeometryNodeSDFGridOffset.input_template()`](#bpy.types.GeometryNodeSDFGridOffset.input_template)
    - [`GeometryNodeSDFGridOffset.output_template()`](#bpy.types.GeometryNodeSDFGridOffset.output_template)
    - [`GeometryNodeSDFGridOffset.bl_rna_get_subclass()`](#bpy.types.GeometryNodeSDFGridOffset.bl_rna_get_subclass)
    - [`GeometryNodeSDFGridOffset.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeSDFGridOffset.bl_rna_get_subclass_py)
