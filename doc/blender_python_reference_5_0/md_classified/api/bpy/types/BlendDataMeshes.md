...
# BlendDataMeshes(bpy\_struct)[¶](#blenddatameshes-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.BlendDataMeshes(*bpy\_struct*)[¶](#bpy.types.BlendDataMeshes "Link to this definition")
:   Collection of meshes

    new(*name*)[¶](#bpy.types.BlendDataMeshes.new "Link to this definition")
    ...
    new\_from\_object(*object*, *\**, *preserve\_all\_data\_layers=False*, *depsgraph=None*)[¶](#bpy.types.BlendDataMeshes.new_from_object "Link to this definition")
    :   Add a new mesh created from given object (undeformed geometry if object is original, and final evaluated geometry, with all modifiers etc., if object is evaluated)
        ...
        Parameters:
        :   * **object** ([`Object`](Object.md#bpy.types.Object "bpy.types.Object"), (never None)) – Object to create mesh from
    ...
    remove(*mesh*, *\**, *do\_unlink=True*, *do\_id\_user=True*, *do\_ui\_user=True*)[¶](#bpy.types.BlendDataMeshes.remove "Link to this definition")
    :   Remove a mesh from the current blendfile

        Parameters:
        :   * **mesh** ([`Mesh`](Mesh.md#bpy.types.Mesh "bpy.types.Mesh"), (never None)) – Mesh to remove
            * **do\_unlink** (*boolean**,* *(**optional**)*) – Unlink all usages of this mesh before deleting it (WARNING: will also delete objects instancing that mesh data)
            * **do\_id\_user** (*boolean**,* *(**optional**)*) – Decrement user counter of all data-blocks used by this mesh data
            * **do\_ui\_user** (*boolean**,* *(**optional**)*) – Make sure interface does not reference this mesh data

    tag(*value*)[¶](#bpy.types.BlendDataMeshes.tag "Link to this definition")
    :   tag

        Parameters:
        :   **value** (*boolean*) – Value

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.BlendDataMeshes.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.BlendDataMeshes.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`BlendData.meshes`](BlendData.md#bpy.types.BlendData.meshes "bpy.types.BlendData.meshes") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.BlendDataMeshes.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.BlendDataMeshes.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* BlendDataMeshes(bpy\_struct)
  + [`BlendDataMeshes`](#bpy.types.BlendDataMeshes)
    - [`BlendDataMeshes.new()`](#bpy.types.BlendDataMeshes.new)
    - [`BlendDataMeshes.new_from_object()`](#bpy.types.BlendDataMeshes.new_from_object)
    - [`BlendDataMeshes.remove()`](#bpy.types.BlendDataMeshes.remove)
    - [`BlendDataMeshes.tag()`](#bpy.types.BlendDataMeshes.tag)
    - [`BlendDataMeshes.bl_rna_get_subclass()`](#bpy.types.BlendDataMeshes.bl_rna_get_subclass)
    - [`BlendDataMeshes.bl_rna_get_subclass_py()`](#bpy.types.BlendDataMeshes.bl_rna_get_subclass_py)
