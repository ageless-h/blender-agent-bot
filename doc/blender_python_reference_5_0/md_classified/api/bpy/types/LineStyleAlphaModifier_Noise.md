...
# LineStyleAlphaModifier\_Noise(LineStyleAlphaModifier)[¶](#linestylealphamodifier-noise-linestylealphamodifier "Link to this heading")
...
*class* bpy.types.LineStyleAlphaModifier\_Noise(*LineStyleAlphaModifier*)[¶](#bpy.types.LineStyleAlphaModifier_Noise "Link to this definition")
:   Alpha transparency based on random noise

    amplitude[¶](#bpy.types.LineStyleAlphaModifier_Noise.amplitude "Link to this definition")
    :   Amplitude of the noise

        Type:
        :   float in [-inf, inf], default 0.0

    blend[¶](#bpy.types.LineStyleAlphaModifier_Noise.blend "Link to this definition")
    :   Specify how the modifier value is blended into the base value

        Type:
        :   enum in [`'MIX'`, `'ADD'`, `'SUBTRACT'`, `'MULTIPLY'`, `'DIVIDE'`, `'DIFFERENCE'`, `'MINIMUM'`, `'MAXIMUM'`], default `'MIX'`

    curve[¶](#bpy.types.LineStyleAlphaModifier_Noise.curve "Link to this definition")
    :   Curve used for the curve mapping

        Type:
        :   [`CurveMapping`](CurveMapping.md#bpy.types.CurveMapping "bpy.types.CurveMapping"), (readonly)

    expanded[¶](#bpy.types.LineStyleAlphaModifier_Noise.expanded "Link to this definition")
    :   True if the modifier tab is expanded

        Type:
        :   boolean, default False

    influence[¶](#bpy.types.LineStyleAlphaModifier_Noise.influence "Link to this definition")
    :   Influence factor by which the modifier changes the property

        Type:
        :   float in [0, 1], default 0.0

    invert[¶](#bpy.types.LineStyleAlphaModifier_Noise.invert "Link to this definition")
    :   Invert the fade-out direction of the linear mapping

        Type:
        :   boolean, default False

    mapping[¶](#bpy.types.LineStyleAlphaModifier_Noise.mapping "Link to this definition")
    ...
    period[¶](#bpy.types.LineStyleAlphaModifier_Noise.period "Link to this definition")
    :   Period of the noise

        Type:
        :   float in [-inf, inf], default 0.0

    seed[¶](#bpy.types.LineStyleAlphaModifier_Noise.seed "Link to this definition")
    :   Seed for the noise generation

        Type:
        :   int in [1, 32767], default 0

    type[¶](#bpy.types.LineStyleAlphaModifier_Noise.type "Link to this definition")
    ...
    use[¶](#bpy.types.LineStyleAlphaModifier_Noise.use "Link to this definition")
    :   Enable or disable this modifier during stroke rendering

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.LineStyleAlphaModifier_Noise.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.LineStyleAlphaModifier_Noise.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
        ...
        Return type:
        :   [type](#bpy.types.LineStyleAlphaModifier_Noise.type "bpy.types.LineStyleAlphaModifier_Noise.type")
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.LineStyleAlphaModifier_Noise.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.LineStyleAlphaModifier_Noise.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* LineStyleAlphaModifier\_Noise(LineStyleAlphaModifier)
  + [`LineStyleAlphaModifier_Noise`](#bpy.types.LineStyleAlphaModifier_Noise)
    - [`LineStyleAlphaModifier_Noise.amplitude`](#bpy.types.LineStyleAlphaModifier_Noise.amplitude)
    - [`LineStyleAlphaModifier_Noise.blend`](#bpy.types.LineStyleAlphaModifier_Noise.blend)
    - [`LineStyleAlphaModifier_Noise.curve`](#bpy.types.LineStyleAlphaModifier_Noise.curve)
    - [`LineStyleAlphaModifier_Noise.expanded`](#bpy.types.LineStyleAlphaModifier_Noise.expanded)
    - [`LineStyleAlphaModifier_Noise.influence`](#bpy.types.LineStyleAlphaModifier_Noise.influence)
    - [`LineStyleAlphaModifier_Noise.invert`](#bpy.types.LineStyleAlphaModifier_Noise.invert)
    - [`LineStyleAlphaModifier_Noise.mapping`](#bpy.types.LineStyleAlphaModifier_Noise.mapping)
    - [`LineStyleAlphaModifier_Noise.period`](#bpy.types.LineStyleAlphaModifier_Noise.period)
    - [`LineStyleAlphaModifier_Noise.seed`](#bpy.types.LineStyleAlphaModifier_Noise.seed)
    - [`LineStyleAlphaModifier_Noise.type`](#bpy.types.LineStyleAlphaModifier_Noise.type)
    - [`LineStyleAlphaModifier_Noise.use`](#bpy.types.LineStyleAlphaModifier_Noise.use)
    - [`LineStyleAlphaModifier_Noise.bl_rna_get_subclass()`](#bpy.types.LineStyleAlphaModifier_Noise.bl_rna_get_subclass)
    - [`LineStyleAlphaModifier_Noise.bl_rna_get_subclass_py()`](#bpy.types.LineStyleAlphaModifier_Noise.bl_rna_get_subclass_py)
