...
# SplinePoints(bpy\_struct)[¶](#splinepoints-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.SplinePoints(*bpy\_struct*)[¶](#bpy.types.SplinePoints "Link to this definition")
:   Collection of spline points

    add(*count*)[¶](#bpy.types.SplinePoints.add "Link to this definition")
    :   Add a number of points to this spline

        Parameters:
        :   **count** (*int in* *[**0**,* *inf**]*) – Number, Number of points to add to the spline

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.SplinePoints.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.SplinePoints.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.SplinePoints.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.SplinePoints.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* SplinePoints(bpy\_struct)
  + [`SplinePoints`](#bpy.types.SplinePoints)
    - [`SplinePoints.add()`](#bpy.types.SplinePoints.add)
    - [`SplinePoints.bl_rna_get_subclass()`](#bpy.types.SplinePoints.bl_rna_get_subclass)
    - [`SplinePoints.bl_rna_get_subclass_py()`](#bpy.types.SplinePoints.bl_rna_get_subclass_py)
