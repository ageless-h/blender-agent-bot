...
# LineStyleColorModifier\_Material(LineStyleColorModifier)[¶](#linestylecolormodifier-material-linestylecolormodifier "Link to this heading")
...
*class* bpy.types.LineStyleColorModifier\_Material(*LineStyleColorModifier*)[¶](#bpy.types.LineStyleColorModifier_Material "Link to this definition")
:   Change line color based on a material attribute

    blend[¶](#bpy.types.LineStyleColorModifier_Material.blend "Link to this definition")
    ...
    color\_ramp[¶](#bpy.types.LineStyleColorModifier_Material.color_ramp "Link to this definition")
    :   Color ramp used to change line color

        Type:
        :   [`ColorRamp`](ColorRamp.md#bpy.types.ColorRamp "bpy.types.ColorRamp"), (readonly)

    expanded[¶](#bpy.types.LineStyleColorModifier_Material.expanded "Link to this definition")
    :   True if the modifier tab is expanded

        Type:
        :   boolean, default False

    influence[¶](#bpy.types.LineStyleColorModifier_Material.influence "Link to this definition")
    :   Influence factor by which the modifier changes the property

        Type:
        :   float in [0, 1], default 0.0

    material\_attribute[¶](#bpy.types.LineStyleColorModifier_Material.material_attribute "Link to this definition")
    ...
    type[¶](#bpy.types.LineStyleColorModifier_Material.type "Link to this definition")
    ...
    use[¶](#bpy.types.LineStyleColorModifier_Material.use "Link to this definition")
    :   Enable or disable this modifier during stroke rendering

        Type:
        :   boolean, default False

    use\_ramp[¶](#bpy.types.LineStyleColorModifier_Material.use_ramp "Link to this definition")
    :   Use color ramp to map the BW average into an RGB color

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.LineStyleColorModifier_Material.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.LineStyleColorModifier_Material.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.LineStyleColorModifier_Material.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.LineStyleColorModifier_Material.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* LineStyleColorModifier\_Material(LineStyleColorModifier)
  + [`LineStyleColorModifier_Material`](#bpy.types.LineStyleColorModifier_Material)
    - [`LineStyleColorModifier_Material.blend`](#bpy.types.LineStyleColorModifier_Material.blend)
    - [`LineStyleColorModifier_Material.color_ramp`](#bpy.types.LineStyleColorModifier_Material.color_ramp)
    - [`LineStyleColorModifier_Material.expanded`](#bpy.types.LineStyleColorModifier_Material.expanded)
    - [`LineStyleColorModifier_Material.influence`](#bpy.types.LineStyleColorModifier_Material.influence)
    - [`LineStyleColorModifier_Material.material_attribute`](#bpy.types.LineStyleColorModifier_Material.material_attribute)
    - [`LineStyleColorModifier_Material.type`](#bpy.types.LineStyleColorModifier_Material.type)
    - [`LineStyleColorModifier_Material.use`](#bpy.types.LineStyleColorModifier_Material.use)
    - [`LineStyleColorModifier_Material.use_ramp`](#bpy.types.LineStyleColorModifier_Material.use_ramp)
    - [`LineStyleColorModifier_Material.bl_rna_get_subclass()`](#bpy.types.LineStyleColorModifier_Material.bl_rna_get_subclass)
    - [`LineStyleColorModifier_Material.bl_rna_get_subclass_py()`](#bpy.types.LineStyleColorModifier_Material.bl_rna_get_subclass_py)
