...
:   Experimental features
    ...
    no\_data\_block\_packing[¶](#bpy.types.PreferencesExperimental.no_data_block_packing "Link to this definition")
    ...
    use\_geometry\_nodes\_lists[¶](#bpy.types.PreferencesExperimental.use_geometry_nodes_lists "Link to this definition")
    ...
    write\_legacy\_blend\_file\_format[¶](#bpy.types.PreferencesExperimental.write_legacy_blend_file_format "Link to this definition")
...
* PreferencesExperimental(bpy\_struct)
  + [`PreferencesExperimental`](#bpy.types.PreferencesExperimental)
    ...
    - [`PreferencesExperimental.use_geometry_nodes_lists`](#bpy.types.PreferencesExperimental.use_geometry_nodes_lists)
    ...
    - [`PreferencesExperimental.write_legacy_blend_file_format`](#bpy.types.PreferencesExperimental.write_legacy_blend_file_format)
