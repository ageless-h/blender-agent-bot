...
# Function(bpy\_struct)[¶](#function-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.Function(*bpy\_struct*)[¶](#bpy.types.Function "Link to this definition")
:   RNA function definition

    description[¶](#bpy.types.Function.description "Link to this definition")
    :   Description of the Function’s purpose

        Type:
        :   string, default “”, (readonly, never None)

    identifier[¶](#bpy.types.Function.identifier "Link to this definition")
    :   Unique name used in the code and scripting

        Type:
        :   string, default “”, (readonly, never None)

    is\_registered[¶](#bpy.types.Function.is_registered "Link to this definition")
    :   Function is registered as callback as part of type registration

        Type:
        :   boolean, default False, (readonly)

    is\_registered\_optional[¶](#bpy.types.Function.is_registered_optional "Link to this definition")
    :   Function is optionally registered as callback part of type registration

        Type:
        :   boolean, default False, (readonly)

    parameters[¶](#bpy.types.Function.parameters "Link to this definition")
    ...
    use\_self[¶](#bpy.types.Function.use_self "Link to this definition")
    :   Function does not pass itself as an argument (becomes a static method in Python)

        Type:
        :   boolean, default False, (readonly)

    use\_self\_type[¶](#bpy.types.Function.use_self_type "Link to this definition")
    :   Function passes itself type as an argument (becomes a class method in Python if use\_self is false)

        Type:
        :   boolean, default False, (readonly)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.Function.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.Function.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Struct.functions`](Struct.md#bpy.types.Struct.functions "bpy.types.Struct.functions") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.Function.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.Function.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* Function(bpy\_struct)
  + [`Function`](#bpy.types.Function)
    - [`Function.description`](#bpy.types.Function.description)
    - [`Function.identifier`](#bpy.types.Function.identifier)
    - [`Function.is_registered`](#bpy.types.Function.is_registered)
    - [`Function.is_registered_optional`](#bpy.types.Function.is_registered_optional)
    - [`Function.parameters`](#bpy.types.Function.parameters)
    - [`Function.use_self`](#bpy.types.Function.use_self)
    - [`Function.use_self_type`](#bpy.types.Function.use_self_type)
    - [`Function.bl_rna_get_subclass()`](#bpy.types.Function.bl_rna_get_subclass)
    - [`Function.bl_rna_get_subclass_py()`](#bpy.types.Function.bl_rna_get_subclass_py)
