...
# SpreadsheetColumnID(bpy\_struct)[¶](#spreadsheetcolumnid-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.SpreadsheetColumnID(*bpy\_struct*)[¶](#bpy.types.SpreadsheetColumnID "Link to this definition")
:   Data used to identify a spreadsheet column

    name[¶](#bpy.types.SpreadsheetColumnID.name "Link to this definition")
    :   Type:
        :   string, default “”, (never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.SpreadsheetColumnID.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.SpreadsheetColumnID.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`SpreadsheetColumn.id`](SpreadsheetColumn.md#bpy.types.SpreadsheetColumn.id "bpy.types.SpreadsheetColumn.id") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.SpreadsheetColumnID.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.SpreadsheetColumnID.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* SpreadsheetColumnID(bpy\_struct)
  + [`SpreadsheetColumnID`](#bpy.types.SpreadsheetColumnID)
    - [`SpreadsheetColumnID.name`](#bpy.types.SpreadsheetColumnID.name)
    - [`SpreadsheetColumnID.bl_rna_get_subclass()`](#bpy.types.SpreadsheetColumnID.bl_rna_get_subclass)
    - [`SpreadsheetColumnID.bl_rna_get_subclass_py()`](#bpy.types.SpreadsheetColumnID.bl_rna_get_subclass_py)
