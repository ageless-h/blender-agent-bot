...
# TexPaintSlot(bpy\_struct)[¶](#texpaintslot-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.TexPaintSlot(*bpy\_struct*)[¶](#bpy.types.TexPaintSlot "Link to this definition")
:   Slot that contains information about texture painting

    icon\_value[¶](#bpy.types.TexPaintSlot.icon_value "Link to this definition")
    :   Paint slot icon

        Type:
        :   int in [-inf, inf], default 0, (readonly)

    is\_valid[¶](#bpy.types.TexPaintSlot.is_valid "Link to this definition")
    :   Slot has a valid image and UV map

        Type:
        :   boolean, default False, (readonly)

    name[¶](#bpy.types.TexPaintSlot.name "Link to this definition")
    :   Name of the slot

        Type:
        :   string, default “”, (readonly, never None)

    uv\_layer[¶](#bpy.types.TexPaintSlot.uv_layer "Link to this definition")
    :   Name of UV map

        Type:
        :   string, default “”, (never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.TexPaintSlot.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.TexPaintSlot.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Material.texture_paint_slots`](Material.md#bpy.types.Material.texture_paint_slots "bpy.types.Material.texture_paint_slots") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.TexPaintSlot.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.TexPaintSlot.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* TexPaintSlot(bpy\_struct)
  + [`TexPaintSlot`](#bpy.types.TexPaintSlot)
    - [`TexPaintSlot.icon_value`](#bpy.types.TexPaintSlot.icon_value)
    - [`TexPaintSlot.is_valid`](#bpy.types.TexPaintSlot.is_valid)
    - [`TexPaintSlot.name`](#bpy.types.TexPaintSlot.name)
    - [`TexPaintSlot.uv_layer`](#bpy.types.TexPaintSlot.uv_layer)
    - [`TexPaintSlot.bl_rna_get_subclass()`](#bpy.types.TexPaintSlot.bl_rna_get_subclass)
    - [`TexPaintSlot.bl_rna_get_subclass_py()`](#bpy.types.TexPaintSlot.bl_rna_get_subclass_py)
