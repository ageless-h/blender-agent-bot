...
# Timer(bpy\_struct)[¶](#timer-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.Timer(*bpy\_struct*)[¶](#bpy.types.Timer "Link to this definition")
:   Window event timer

    time\_delta[¶](#bpy.types.Timer.time_delta "Link to this definition")
    :   Time since last step in seconds

        Type:
        :   float in [-inf, inf], default 0.0, (readonly)

    time\_duration[¶](#bpy.types.Timer.time_duration "Link to this definition")
    :   Time since the timer started seconds

        Type:
        :   float in [-inf, inf], default 0.0, (readonly)

    time\_step[¶](#bpy.types.Timer.time_step "Link to this definition")
    :   Type:
        :   float in [-inf, inf], default 0.0, (readonly)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.Timer.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.Timer.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`WindowManager.event_timer_add`](WindowManager.md#bpy.types.WindowManager.event_timer_add "bpy.types.WindowManager.event_timer_add") | * [`WindowManager.event_timer_remove`](WindowManager.md#bpy.types.WindowManager.event_timer_remove "bpy.types.WindowManager.event_timer_remove") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.Timer.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.Timer.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* Timer(bpy\_struct)
  + [`Timer`](#bpy.types.Timer)
    - [`Timer.time_delta`](#bpy.types.Timer.time_delta)
    - [`Timer.time_duration`](#bpy.types.Timer.time_duration)
    - [`Timer.time_step`](#bpy.types.Timer.time_step)
    - [`Timer.bl_rna_get_subclass()`](#bpy.types.Timer.bl_rna_get_subclass)
    - [`Timer.bl_rna_get_subclass_py()`](#bpy.types.Timer.bl_rna_get_subclass_py)
