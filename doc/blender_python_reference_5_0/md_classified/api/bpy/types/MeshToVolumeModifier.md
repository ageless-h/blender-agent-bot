...
# MeshToVolumeModifier(Modifier)[¶](#meshtovolumemodifier-modifier "Link to this heading")
...
*class* bpy.types.MeshToVolumeModifier(*Modifier*)[¶](#bpy.types.MeshToVolumeModifier "Link to this definition")
:   density[¶](#bpy.types.MeshToVolumeModifier.density "Link to this definition")
    :   Density of the new volume

        Type:
        :   float in [0, inf], default 0.0

    interior\_band\_width[¶](#bpy.types.MeshToVolumeModifier.interior_band_width "Link to this definition")
    :   Width of the gradient inside of the mesh

        Type:
        :   float in [0, inf], default 0.0

    object[¶](#bpy.types.MeshToVolumeModifier.object "Link to this definition")
    :   Object

        Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object")

    resolution\_mode[¶](#bpy.types.MeshToVolumeModifier.resolution_mode "Link to this definition")
    ...
    voxel\_amount[¶](#bpy.types.MeshToVolumeModifier.voxel_amount "Link to this definition")
    :   Approximate number of voxels along one axis

        Type:
        :   int in [0, inf], default 0

    voxel\_size[¶](#bpy.types.MeshToVolumeModifier.voxel_size "Link to this definition")
    :   Smaller values result in a higher resolution output

        Type:
        :   float in [0, inf], default 0.0

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.MeshToVolumeModifier.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.MeshToVolumeModifier.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.MeshToVolumeModifier.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.MeshToVolumeModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* MeshToVolumeModifier(Modifier)
  + [`MeshToVolumeModifier`](#bpy.types.MeshToVolumeModifier)
    - [`MeshToVolumeModifier.density`](#bpy.types.MeshToVolumeModifier.density)
    - [`MeshToVolumeModifier.interior_band_width`](#bpy.types.MeshToVolumeModifier.interior_band_width)
    - [`MeshToVolumeModifier.object`](#bpy.types.MeshToVolumeModifier.object)
    - [`MeshToVolumeModifier.resolution_mode`](#bpy.types.MeshToVolumeModifier.resolution_mode)
    - [`MeshToVolumeModifier.voxel_amount`](#bpy.types.MeshToVolumeModifier.voxel_amount)
    - [`MeshToVolumeModifier.voxel_size`](#bpy.types.MeshToVolumeModifier.voxel_size)
    - [`MeshToVolumeModifier.bl_rna_get_subclass()`](#bpy.types.MeshToVolumeModifier.bl_rna_get_subclass)
    - [`MeshToVolumeModifier.bl_rna_get_subclass_py()`](#bpy.types.MeshToVolumeModifier.bl_rna_get_subclass_py)
