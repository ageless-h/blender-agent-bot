...
# WorldMistSettings(bpy\_struct)[¶](#worldmistsettings-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.WorldMistSettings(*bpy\_struct*)[¶](#bpy.types.WorldMistSettings "Link to this definition")
:   Mist settings for a World data-block

    depth[¶](#bpy.types.WorldMistSettings.depth "Link to this definition")
    :   Distance over which the mist effect fades in

        Type:
        :   float in [0, inf], default 25.0

    falloff[¶](#bpy.types.WorldMistSettings.falloff "Link to this definition")
    ...
    height[¶](#bpy.types.WorldMistSettings.height "Link to this definition")
    :   Control how much mist density decreases with height

        Type:
        :   float in [0, 100], default 0.0

    intensity[¶](#bpy.types.WorldMistSettings.intensity "Link to this definition")
    :   Overall minimum intensity of the mist effect

        Type:
        :   float in [0, 1], default 0.0

    start[¶](#bpy.types.WorldMistSettings.start "Link to this definition")
    :   Starting distance of the mist, measured from the camera

        Type:
        :   float in [0, inf], default 5.0

    use\_mist[¶](#bpy.types.WorldMistSettings.use_mist "Link to this definition")
    :   Occlude objects with the environment color as they are further away

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.WorldMistSettings.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.WorldMistSettings.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`World.mist_settings`](World.md#bpy.types.World.mist_settings "bpy.types.World.mist_settings") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.WorldMistSettings.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.WorldMistSettings.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* WorldMistSettings(bpy\_struct)
  + [`WorldMistSettings`](#bpy.types.WorldMistSettings)
    - [`WorldMistSettings.depth`](#bpy.types.WorldMistSettings.depth)
    - [`WorldMistSettings.falloff`](#bpy.types.WorldMistSettings.falloff)
    - [`WorldMistSettings.height`](#bpy.types.WorldMistSettings.height)
    - [`WorldMistSettings.intensity`](#bpy.types.WorldMistSettings.intensity)
    - [`WorldMistSettings.start`](#bpy.types.WorldMistSettings.start)
    - [`WorldMistSettings.use_mist`](#bpy.types.WorldMistSettings.use_mist)
    - [`WorldMistSettings.bl_rna_get_subclass()`](#bpy.types.WorldMistSettings.bl_rna_get_subclass)
    - [`WorldMistSettings.bl_rna_get_subclass_py()`](#bpy.types.WorldMistSettings.bl_rna_get_subclass_py)
