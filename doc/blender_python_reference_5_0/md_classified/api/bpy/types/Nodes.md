...
# Nodes(bpy\_struct)[¶](#nodes-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.Nodes(*bpy\_struct*)[¶](#bpy.types.Nodes "Link to this definition")
:   Collection of Nodes

    active[¶](#bpy.types.Nodes.active "Link to this definition")
    :   Active node in this tree

        Type:
        :   [`Node`](Node.md#bpy.types.Node "bpy.types.Node")

    new(*type*)[¶](#bpy.types.Nodes.new "Link to this definition")
    :   Add a node to this node tree

        Parameters:
        :   **type** (*string**,* *(**never None**)*) – Type, Type of node to add (Warning: should be same as node.bl\_idname, not node.type!)
    ...
    remove(*node*)[¶](#bpy.types.Nodes.remove "Link to this definition")
    :   Remove a node from this node tree

        Parameters:
        :   **node** ([`Node`](Node.md#bpy.types.Node "bpy.types.Node"), (never None)) – The node to remove

    clear()[¶](#bpy.types.Nodes.clear "Link to this definition")
    :   Remove all nodes from this node tree

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.Nodes.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.Nodes.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`NodeTree.nodes`](NodeTree.md#bpy.types.NodeTree.nodes "bpy.types.NodeTree.nodes") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.Nodes.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.Nodes.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* Nodes(bpy\_struct)
  + [`Nodes`](#bpy.types.Nodes)
    - [`Nodes.active`](#bpy.types.Nodes.active)
    - [`Nodes.new()`](#bpy.types.Nodes.new)
    - [`Nodes.remove()`](#bpy.types.Nodes.remove)
    - [`Nodes.clear()`](#bpy.types.Nodes.clear)
    - [`Nodes.bl_rna_get_subclass()`](#bpy.types.Nodes.bl_rna_get_subclass)
    - [`Nodes.bl_rna_get_subclass_py()`](#bpy.types.Nodes.bl_rna_get_subclass_py)
