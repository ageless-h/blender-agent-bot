...
# GreasePencilv3LayerGroup(bpy\_struct)[¶](#greasepencilv3layergroup-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.GreasePencilv3LayerGroup(*bpy\_struct*)[¶](#bpy.types.GreasePencilv3LayerGroup "Link to this definition")
:   Collection of Grease Pencil layers

    active[¶](#bpy.types.GreasePencilv3LayerGroup.active "Link to this definition")
    :   Active Grease Pencil layer group

        Type:
        :   [`GreasePencilLayerGroup`](GreasePencilLayerGroup.md#bpy.types.GreasePencilLayerGroup "bpy.types.GreasePencilLayerGroup")

    new(*name*, *\**, *parent\_group=None*)[¶](#bpy.types.GreasePencilv3LayerGroup.new "Link to this definition")
    :   Add a new Grease Pencil layer group

        Parameters:
        :   * **name** (*string**,* *(**never None**)*) – Name, Name of the layer group
            * **parent\_group** ([`GreasePencilLayerGroup`](GreasePencilLayerGroup.md#bpy.types.GreasePencilLayerGroup "bpy.types.GreasePencilLayerGroup"), (optional)) – The parent layer group the new group will be created in (use None for the main stack)
    ...
    remove(*layer\_group*, *\**, *keep\_children=False*)[¶](#bpy.types.GreasePencilv3LayerGroup.remove "Link to this definition")
    :   Remove a new Grease Pencil layer group

        Parameters:
        :   * **layer\_group** ([`GreasePencilLayerGroup`](GreasePencilLayerGroup.md#bpy.types.GreasePencilLayerGroup "bpy.types.GreasePencilLayerGroup"), (never None)) – The layer group to remove
            * **keep\_children** (*boolean**,* *(**optional**)*) – Keep the children nodes of the group and only delete the group itself

    move(*layer\_group*, *type*)[¶](#bpy.types.GreasePencilv3LayerGroup.move "Link to this definition")
    :   Move a layer group in the parent layer group or main stack

        Parameters:
        :   * **layer\_group** ([`GreasePencilLayerGroup`](GreasePencilLayerGroup.md#bpy.types.GreasePencilLayerGroup "bpy.types.GreasePencilLayerGroup"), (never None)) – The layer group to move
            * **type** (enum in [`'DOWN'`, `'UP'`]) – Direction of movement

    move\_top(*layer\_group*)[¶](#bpy.types.GreasePencilv3LayerGroup.move_top "Link to this definition")
    :   Move a layer group to the top of the parent layer group or main stack

        Parameters:
        :   **layer\_group** ([`GreasePencilLayerGroup`](GreasePencilLayerGroup.md#bpy.types.GreasePencilLayerGroup "bpy.types.GreasePencilLayerGroup"), (never None)) – The layer group to move

    move\_bottom(*layer\_group*)[¶](#bpy.types.GreasePencilv3LayerGroup.move_bottom "Link to this definition")
    :   Move a layer group to the bottom of the parent layer group or main stack

        Parameters:
        :   **layer\_group** ([`GreasePencilLayerGroup`](GreasePencilLayerGroup.md#bpy.types.GreasePencilLayerGroup "bpy.types.GreasePencilLayerGroup"), (never None)) – The layer group to move

    move\_to\_layer\_group(*layer\_group*, *parent\_group*)[¶](#bpy.types.GreasePencilv3LayerGroup.move_to_layer_group "Link to this definition")
    :   Move a layer group into a parent layer group

        Parameters:
        :   * **layer\_group** ([`GreasePencilLayerGroup`](GreasePencilLayerGroup.md#bpy.types.GreasePencilLayerGroup "bpy.types.GreasePencilLayerGroup"), (never None)) – The layer group to move
            * **parent\_group** ([`GreasePencilLayerGroup`](GreasePencilLayerGroup.md#bpy.types.GreasePencilLayerGroup "bpy.types.GreasePencilLayerGroup")) – The parent layer group the layer group will be moved into (use None for the main stack)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.GreasePencilv3LayerGroup.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.GreasePencilv3LayerGroup.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`GreasePencil.layer_groups`](GreasePencil.md#bpy.types.GreasePencil.layer_groups "bpy.types.GreasePencil.layer_groups") |  |

[Next

GreasePencilv3Layers(bpy\_struct)](GreasePencilv3Layers.md)
[Previous
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GreasePencilv3LayerGroup.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.GreasePencilv3LayerGroup.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GreasePencilv3LayerGroup(bpy\_struct)
  + [`GreasePencilv3LayerGroup`](#bpy.types.GreasePencilv3LayerGroup)
    - [`GreasePencilv3LayerGroup.active`](#bpy.types.GreasePencilv3LayerGroup.active)
    - [`GreasePencilv3LayerGroup.new()`](#bpy.types.GreasePencilv3LayerGroup.new)
    - [`GreasePencilv3LayerGroup.remove()`](#bpy.types.GreasePencilv3LayerGroup.remove)
    - [`GreasePencilv3LayerGroup.move()`](#bpy.types.GreasePencilv3LayerGroup.move)
    - [`GreasePencilv3LayerGroup.move_top()`](#bpy.types.GreasePencilv3LayerGroup.move_top)
    - [`GreasePencilv3LayerGroup.move_bottom()`](#bpy.types.GreasePencilv3LayerGroup.move_bottom)
    - [`GreasePencilv3LayerGroup.move_to_layer_group()`](#bpy.types.GreasePencilv3LayerGroup.move_to_layer_group)
    - [`GreasePencilv3LayerGroup.bl_rna_get_subclass()`](#bpy.types.GreasePencilv3LayerGroup.bl_rna_get_subclass)
    - [`GreasePencilv3LayerGroup.bl_rna_get_subclass_py()`](#bpy.types.GreasePencilv3LayerGroup.bl_rna_get_subclass_py)
