...
# ActionChannelbags(bpy\_struct)[¶](#actionchannelbags-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.ActionChannelbags(*bpy\_struct*)[¶](#bpy.types.ActionChannelbags "Link to this definition")
:   For each action slot, a list of animation channels that are meant for that slot

    new(*slot*)[¶](#bpy.types.ActionChannelbags.new "Link to this definition")
    :   Add a new channelbag to the strip, to contain animation channels for a specific slot

        Parameters:
        :   **slot** ([`ActionSlot`](ActionSlot.md#bpy.types.ActionSlot "bpy.types.ActionSlot")) – Action Slot, The slot that should be animated by this channelbag
    ...
    remove(*channelbag*)[¶](#bpy.types.ActionChannelbags.remove "Link to this definition")
    :   Remove the channelbag from the strip

        Parameters:
        :   **channelbag** ([`ActionChannelbag`](ActionChannelbag.md#bpy.types.ActionChannelbag "bpy.types.ActionChannelbag")) – The channelbag to remove

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ActionChannelbags.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ActionChannelbags.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`ActionKeyframeStrip.channelbags`](ActionKeyframeStrip.md#bpy.types.ActionKeyframeStrip.channelbags "bpy.types.ActionKeyframeStrip.channelbags") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ActionChannelbags.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ActionChannelbags.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ActionChannelbags(bpy\_struct)
  + [`ActionChannelbags`](#bpy.types.ActionChannelbags)
    - [`ActionChannelbags.new()`](#bpy.types.ActionChannelbags.new)
    - [`ActionChannelbags.remove()`](#bpy.types.ActionChannelbags.remove)
    - [`ActionChannelbags.bl_rna_get_subclass()`](#bpy.types.ActionChannelbags.bl_rna_get_subclass)
    - [`ActionChannelbags.bl_rna_get_subclass_py()`](#bpy.types.ActionChannelbags.bl_rna_get_subclass_py)
