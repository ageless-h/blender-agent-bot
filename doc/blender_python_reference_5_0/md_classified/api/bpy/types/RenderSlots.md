...
# RenderSlots(bpy\_struct)[¶](#renderslots-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.RenderSlots(*bpy\_struct*)[¶](#bpy.types.RenderSlots "Link to this definition")
:   Collection of render layers

    active[¶](#bpy.types.RenderSlots.active "Link to this definition")
    :   Active render slot of the image

        Type:
        :   [`RenderSlot`](RenderSlot.md#bpy.types.RenderSlot "bpy.types.RenderSlot")

    active\_index[¶](#bpy.types.RenderSlots.active_index "Link to this definition")
    :   Active render slot of the image

        Type:
        :   int in [0, 32767], default 0

    new(*\**, *name=''*)[¶](#bpy.types.RenderSlots.new "Link to this definition")
    :   Add a render slot to the image

        Parameters:
        :   **name** (*string**,* *(**optional**,* *never None**)*) – Name, New name for the render slot
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.RenderSlots.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.RenderSlots.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Image.render_slots`](Image.md#bpy.types.Image.render_slots "bpy.types.Image.render_slots") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.RenderSlots.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.RenderSlots.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* RenderSlots(bpy\_struct)
  + [`RenderSlots`](#bpy.types.RenderSlots)
    - [`RenderSlots.active`](#bpy.types.RenderSlots.active)
    - [`RenderSlots.active_index`](#bpy.types.RenderSlots.active_index)
    - [`RenderSlots.new()`](#bpy.types.RenderSlots.new)
    - [`RenderSlots.bl_rna_get_subclass()`](#bpy.types.RenderSlots.bl_rna_get_subclass)
    - [`RenderSlots.bl_rna_get_subclass_py()`](#bpy.types.RenderSlots.bl_rna_get_subclass_py)
