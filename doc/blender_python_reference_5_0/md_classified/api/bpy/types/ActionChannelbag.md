...
# ActionChannelbag(bpy\_struct)[¶](#actionchannelbag-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.ActionChannelbag(*bpy\_struct*)[¶](#bpy.types.ActionChannelbag "Link to this definition")
:   Collection of animation channels, typically associated with an action slot

    fcurves[¶](#bpy.types.ActionChannelbag.fcurves "Link to this definition")
    :   The individual F-Curves that animate the slot

        Type:
        :   [`ActionChannelbagFCurves`](ActionChannelbagFCurves.md#bpy.types.ActionChannelbagFCurves "bpy.types.ActionChannelbagFCurves") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`FCurve`](FCurve.md#bpy.types.FCurve "bpy.types.FCurve"), (readonly)

    groups[¶](#bpy.types.ActionChannelbag.groups "Link to this definition")
    :   Groupings of F-Curves for display purposes, in e.g. the dopesheet and graph editor

        Type:
        :   [`ActionChannelbagGroups`](ActionChannelbagGroups.md#bpy.types.ActionChannelbagGroups "bpy.types.ActionChannelbagGroups") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`ActionGroup`](ActionGroup.md#bpy.types.ActionGroup "bpy.types.ActionGroup"), (readonly)

    slot[¶](#bpy.types.ActionChannelbag.slot "Link to this definition")
    :   The Slot that the Channelbag’s animation data is for

        Type:
        :   [`ActionSlot`](ActionSlot.md#bpy.types.ActionSlot "bpy.types.ActionSlot"), (readonly)

    slot\_handle[¶](#bpy.types.ActionChannelbag.slot_handle "Link to this definition")
    :   Type:
        :   int in [-inf, inf], default 0, (readonly)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ActionChannelbag.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ActionChannelbag.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`ActionChannelbags.new`](ActionChannelbags.md#bpy.types.ActionChannelbags.new "bpy.types.ActionChannelbags.new") * [`ActionChannelbags.remove`](ActionChannelbags.md#bpy.types.ActionChannelbags.remove "bpy.types.ActionChannelbags.remove") | * [`ActionKeyframeStrip.channelbag`](ActionKeyframeStrip.md#bpy.types.ActionKeyframeStrip.channelbag "bpy.types.ActionKeyframeStrip.channelbag") * [`ActionKeyframeStrip.channelbags`](ActionKeyframeStrip.md#bpy.types.ActionKeyframeStrip.channelbags "bpy.types.ActionKeyframeStrip.channelbags") |

[Next

ActionChannelbagFCurves(bpy\_struct)](ActionChannelbagFCurves.md)
[Previous
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ActionChannelbag.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ActionChannelbag.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ActionChannelbag(bpy\_struct)
  + [`ActionChannelbag`](#bpy.types.ActionChannelbag)
    - [`ActionChannelbag.fcurves`](#bpy.types.ActionChannelbag.fcurves)
    - [`ActionChannelbag.groups`](#bpy.types.ActionChannelbag.groups)
    - [`ActionChannelbag.slot`](#bpy.types.ActionChannelbag.slot)
    - [`ActionChannelbag.slot_handle`](#bpy.types.ActionChannelbag.slot_handle)
    - [`ActionChannelbag.bl_rna_get_subclass()`](#bpy.types.ActionChannelbag.bl_rna_get_subclass)
    - [`ActionChannelbag.bl_rna_get_subclass_py()`](#bpy.types.ActionChannelbag.bl_rna_get_subclass_py)
