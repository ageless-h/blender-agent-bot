...
# View2D(bpy\_struct)[¶](#view2d-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.View2D(*bpy\_struct*)[¶](#bpy.types.View2D "Link to this definition")
:   Scroll and zoom for a 2D region

    region\_to\_view(*x*, *y*)[¶](#bpy.types.View2D.region_to_view "Link to this definition")
    ...
    view\_to\_region(*x*, *y*, *\**, *clip=True*)[¶](#bpy.types.View2D.view_to_region "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.View2D.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.View2D.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Region.view2d`](Region.md#bpy.types.Region.view2d "bpy.types.Region.view2d") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.View2D.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.View2D.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* View2D(bpy\_struct)
  + [`View2D`](#bpy.types.View2D)
    - [`View2D.region_to_view()`](#bpy.types.View2D.region_to_view)
    - [`View2D.view_to_region()`](#bpy.types.View2D.view_to_region)
    - [`View2D.bl_rna_get_subclass()`](#bpy.types.View2D.bl_rna_get_subclass)
    - [`View2D.bl_rna_get_subclass_py()`](#bpy.types.View2D.bl_rna_get_subclass_py)
