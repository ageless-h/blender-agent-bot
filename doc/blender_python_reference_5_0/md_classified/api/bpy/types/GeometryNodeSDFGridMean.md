...
# GeometryNodeSDFGridMean(GeometryNode)[¶](#geometrynodesdfgridmean-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeSDFGridMean(*GeometryNode*)[¶](#bpy.types.GeometryNodeSDFGridMean "Link to this definition")
:   Apply mean (box) filter smoothing to a signed distance field. Fast separable averaging filter for general smoothing of the distance field
    ...
    *classmethod* is\_registered\_node\_type()[¶](#bpy.types.GeometryNodeSDFGridMean.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[¶](#bpy.types.GeometryNodeSDFGridMean.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[¶](#bpy.types.GeometryNodeSDFGridMean.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.GeometryNodeSDFGridMean.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.GeometryNodeSDFGridMean.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
GeometryNodeSDFGridLaplacian(GeometryNode)](GeometryNodeSDFGridLaplacian.md)
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeSDFGridMean.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.GeometryNodeSDFGridMean.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeSDFGridMean(GeometryNode)
  + [`GeometryNodeSDFGridMean`](#bpy.types.GeometryNodeSDFGridMean)
    - [`GeometryNodeSDFGridMean.is_registered_node_type()`](#bpy.types.GeometryNodeSDFGridMean.is_registered_node_type)
    - [`GeometryNodeSDFGridMean.input_template()`](#bpy.types.GeometryNodeSDFGridMean.input_template)
    - [`GeometryNodeSDFGridMean.output_template()`](#bpy.types.GeometryNodeSDFGridMean.output_template)
    - [`GeometryNodeSDFGridMean.bl_rna_get_subclass()`](#bpy.types.GeometryNodeSDFGridMean.bl_rna_get_subclass)
    - [`GeometryNodeSDFGridMean.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeSDFGridMean.bl_rna_get_subclass_py)
