...
# VolumeGrid(bpy\_struct)[¶](#volumegrid-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.VolumeGrid(*bpy\_struct*)[¶](#bpy.types.VolumeGrid "Link to this definition")
:   3D volume grid

    channels[¶](#bpy.types.VolumeGrid.channels "Link to this definition")
    :   Number of dimensions of the grid data type

        Type:
        :   int in [0, inf], default 0, (readonly)

    data\_type[¶](#bpy.types.VolumeGrid.data_type "Link to this definition")
    :   Data type of voxel values

        Type:
        :   enum in [Volume Grid Data Type Items](../../../appendix/bpy_types_enum_items/volume_grid_data_type_items.md#rna-enum-volume-grid-data-type-items), default `'UNKNOWN'`, (readonly)

    is\_loaded[¶](#bpy.types.VolumeGrid.is_loaded "Link to this definition")
    :   Grid tree is loaded in memory

        Type:
        :   boolean, default False, (readonly)

    matrix\_object[¶](#bpy.types.VolumeGrid.matrix_object "Link to this definition")
    ...
    name[¶](#bpy.types.VolumeGrid.name "Link to this definition")
    :   Volume grid name

        Type:
        :   string, default “”, (readonly, never None)

    load()[¶](#bpy.types.VolumeGrid.load "Link to this definition")
    ...
    unload()[¶](#bpy.types.VolumeGrid.unload "Link to this definition")
    :   Unload grid tree and voxel data from memory, leaving only metadata

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.VolumeGrid.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.VolumeGrid.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Volume.grids`](Volume.md#bpy.types.Volume.grids "bpy.types.Volume.grids") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.VolumeGrid.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.VolumeGrid.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* VolumeGrid(bpy\_struct)
  + [`VolumeGrid`](#bpy.types.VolumeGrid)
    - [`VolumeGrid.channels`](#bpy.types.VolumeGrid.channels)
    - [`VolumeGrid.data_type`](#bpy.types.VolumeGrid.data_type)
    - [`VolumeGrid.is_loaded`](#bpy.types.VolumeGrid.is_loaded)
    - [`VolumeGrid.matrix_object`](#bpy.types.VolumeGrid.matrix_object)
    - [`VolumeGrid.name`](#bpy.types.VolumeGrid.name)
    - [`VolumeGrid.load()`](#bpy.types.VolumeGrid.load)
    - [`VolumeGrid.unload()`](#bpy.types.VolumeGrid.unload)
    - [`VolumeGrid.bl_rna_get_subclass()`](#bpy.types.VolumeGrid.bl_rna_get_subclass)
    - [`VolumeGrid.bl_rna_get_subclass_py()`](#bpy.types.VolumeGrid.bl_rna_get_subclass_py)
