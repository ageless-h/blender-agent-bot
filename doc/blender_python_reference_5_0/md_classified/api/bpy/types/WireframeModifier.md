...
# WireframeModifier(Modifier)[¶](#wireframemodifier-modifier "Link to this heading")
...
*class* bpy.types.WireframeModifier(*Modifier*)[¶](#bpy.types.WireframeModifier "Link to this definition")
:   Wireframe effect modifier

    crease\_weight[¶](#bpy.types.WireframeModifier.crease_weight "Link to this definition")
    :   Crease weight (if active)

        Type:
        :   float in [-inf, inf], default 1.0

    invert\_vertex\_group[¶](#bpy.types.WireframeModifier.invert_vertex_group "Link to this definition")
    :   Invert vertex group influence

        Type:
        :   boolean, default False

    material\_offset[¶](#bpy.types.WireframeModifier.material_offset "Link to this definition")
    :   Offset material index of generated faces

        Type:
        :   int in [-32768, 32767], default 0

    offset[¶](#bpy.types.WireframeModifier.offset "Link to this definition")
    :   Offset the thickness from the center

        Type:
        :   float in [-inf, inf], default 0.0

    thickness[¶](#bpy.types.WireframeModifier.thickness "Link to this definition")
    :   Thickness factor

        Type:
        :   float in [-inf, inf], default 0.02

    thickness\_vertex\_group[¶](#bpy.types.WireframeModifier.thickness_vertex_group "Link to this definition")
    :   Thickness factor to use for zero vertex group influence

        Type:
        :   float in [0, 1], default 0.0

    use\_boundary[¶](#bpy.types.WireframeModifier.use_boundary "Link to this definition")
    :   Support face boundaries

        Type:
        :   boolean, default False

    use\_crease[¶](#bpy.types.WireframeModifier.use_crease "Link to this definition")
    :   Crease hub edges for improved subdivision surface

        Type:
        :   boolean, default False

    use\_even\_offset[¶](#bpy.types.WireframeModifier.use_even_offset "Link to this definition")
    :   Scale the offset to give more even thickness

        Type:
        :   boolean, default True

    use\_relative\_offset[¶](#bpy.types.WireframeModifier.use_relative_offset "Link to this definition")
    :   Scale the offset by surrounding geometry

        Type:
        :   boolean, default False

    use\_replace[¶](#bpy.types.WireframeModifier.use_replace "Link to this definition")
    :   Remove original geometry

        Type:
        :   boolean, default True

    vertex\_group[¶](#bpy.types.WireframeModifier.vertex_group "Link to this definition")
    :   Vertex group name for selecting the affected areas

        Type:
        :   string, default “”, (never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.WireframeModifier.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.WireframeModifier.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.WireframeModifier.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.WireframeModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* WireframeModifier(Modifier)
  + [`WireframeModifier`](#bpy.types.WireframeModifier)
    - [`WireframeModifier.crease_weight`](#bpy.types.WireframeModifier.crease_weight)
    - [`WireframeModifier.invert_vertex_group`](#bpy.types.WireframeModifier.invert_vertex_group)
    - [`WireframeModifier.material_offset`](#bpy.types.WireframeModifier.material_offset)
    - [`WireframeModifier.offset`](#bpy.types.WireframeModifier.offset)
    - [`WireframeModifier.thickness`](#bpy.types.WireframeModifier.thickness)
    - [`WireframeModifier.thickness_vertex_group`](#bpy.types.WireframeModifier.thickness_vertex_group)
    - [`WireframeModifier.use_boundary`](#bpy.types.WireframeModifier.use_boundary)
    - [`WireframeModifier.use_crease`](#bpy.types.WireframeModifier.use_crease)
    - [`WireframeModifier.use_even_offset`](#bpy.types.WireframeModifier.use_even_offset)
    - [`WireframeModifier.use_relative_offset`](#bpy.types.WireframeModifier.use_relative_offset)
    - [`WireframeModifier.use_replace`](#bpy.types.WireframeModifier.use_replace)
    - [`WireframeModifier.vertex_group`](#bpy.types.WireframeModifier.vertex_group)
    - [`WireframeModifier.bl_rna_get_subclass()`](#bpy.types.WireframeModifier.bl_rna_get_subclass)
    - [`WireframeModifier.bl_rna_get_subclass_py()`](#bpy.types.WireframeModifier.bl_rna_get_subclass_py)
