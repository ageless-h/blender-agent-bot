...
# LineStyleAlphaModifier(LineStyleModifier)[¶](#linestylealphamodifier-linestylemodifier "Link to this heading")
...
subclasses —
[`LineStyleAlphaModifier_AlongStroke`](LineStyleAlphaModifier_AlongStroke.md#bpy.types.LineStyleAlphaModifier_AlongStroke "bpy.types.LineStyleAlphaModifier_AlongStroke"), [`LineStyleAlphaModifier_CreaseAngle`](LineStyleAlphaModifier_CreaseAngle.md#bpy.types.LineStyleAlphaModifier_CreaseAngle "bpy.types.LineStyleAlphaModifier_CreaseAngle"), [`LineStyleAlphaModifier_Curvature_3D`](LineStyleAlphaModifier_Curvature_3D.md#bpy.types.LineStyleAlphaModifier_Curvature_3D "bpy.types.LineStyleAlphaModifier_Curvature_3D"), [`LineStyleAlphaModifier_DistanceFromCamera`](LineStyleAlphaModifier_DistanceFromCamera.md#bpy.types.LineStyleAlphaModifier_DistanceFromCamera "bpy.types.LineStyleAlphaModifier_DistanceFromCamera"), [`LineStyleAlphaModifier_DistanceFromObject`](LineStyleAlphaModifier_DistanceFromObject.md#bpy.types.LineStyleAlphaModifier_DistanceFromObject "bpy.types.LineStyleAlphaModifier_DistanceFromObject"), [`LineStyleAlphaModifier_Material`](LineStyleAlphaModifier_Material.md#bpy.types.LineStyleAlphaModifier_Material "bpy.types.LineStyleAlphaModifier_Material"), [`LineStyleAlphaModifier_Noise`](LineStyleAlphaModifier_Noise.md#bpy.types.LineStyleAlphaModifier_Noise "bpy.types.LineStyleAlphaModifier_Noise"), [`LineStyleAlphaModifier_Tangent`](LineStyleAlphaModifier_Tangent.md#bpy.types.LineStyleAlphaModifier_Tangent "bpy.types.LineStyleAlphaModifier_Tangent")

*class* bpy.types.LineStyleAlphaModifier(*LineStyleModifier*)[¶](#bpy.types.LineStyleAlphaModifier "Link to this definition")
:   Base type to define alpha transparency modifiers

    name[¶](#bpy.types.LineStyleAlphaModifier.name "Link to this definition")
    :   Name of the modifier

        Type:
        :   string, default “”, (never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.LineStyleAlphaModifier.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.LineStyleAlphaModifier.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`FreestyleLineStyle.alpha_modifiers`](FreestyleLineStyle.md#bpy.types.FreestyleLineStyle.alpha_modifiers "bpy.types.FreestyleLineStyle.alpha_modifiers") * [`LineStyleAlphaModifiers.new`](LineStyleAlphaModifiers.md#bpy.types.LineStyleAlphaModifiers.new "bpy.types.LineStyleAlphaModifiers.new") | * [`LineStyleAlphaModifiers.remove`](LineStyleAlphaModifiers.md#bpy.types.LineStyleAlphaModifiers.remove "bpy.types.LineStyleAlphaModifiers.remove") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.LineStyleAlphaModifier.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.LineStyleAlphaModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* LineStyleAlphaModifier(LineStyleModifier)
  + [`LineStyleAlphaModifier`](#bpy.types.LineStyleAlphaModifier)
    - [`LineStyleAlphaModifier.name`](#bpy.types.LineStyleAlphaModifier.name)
    - [`LineStyleAlphaModifier.bl_rna_get_subclass()`](#bpy.types.LineStyleAlphaModifier.bl_rna_get_subclass)
    - [`LineStyleAlphaModifier.bl_rna_get_subclass_py()`](#bpy.types.LineStyleAlphaModifier.bl_rna_get_subclass_py)
