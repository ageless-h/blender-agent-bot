...
# GeometryNodeSetGridTransform(GeometryNode)[¶](#geometrynodesetgridtransform-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeSetGridTransform(*GeometryNode*)[¶](#bpy.types.GeometryNodeSetGridTransform "Link to this definition")
:   Set the transform for the grid from index space into object space.

    data\_type[¶](#bpy.types.GeometryNodeSetGridTransform.data_type "Link to this definition")
    ...
    *classmethod* is\_registered\_node\_type()[¶](#bpy.types.GeometryNodeSetGridTransform.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[¶](#bpy.types.GeometryNodeSetGridTransform.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[¶](#bpy.types.GeometryNodeSetGridTransform.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.GeometryNodeSetGridTransform.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.GeometryNodeSetGridTransform.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
GeometryNodeSetGridBackground(GeometryNode)](GeometryNodeSetGridBackground.md)
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeSetGridTransform.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.GeometryNodeSetGridTransform.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeSetGridTransform(GeometryNode)
  + [`GeometryNodeSetGridTransform`](#bpy.types.GeometryNodeSetGridTransform)
    - [`GeometryNodeSetGridTransform.data_type`](#bpy.types.GeometryNodeSetGridTransform.data_type)
    - [`GeometryNodeSetGridTransform.is_registered_node_type()`](#bpy.types.GeometryNodeSetGridTransform.is_registered_node_type)
    - [`GeometryNodeSetGridTransform.input_template()`](#bpy.types.GeometryNodeSetGridTransform.input_template)
    - [`GeometryNodeSetGridTransform.output_template()`](#bpy.types.GeometryNodeSetGridTransform.output_template)
    - [`GeometryNodeSetGridTransform.bl_rna_get_subclass()`](#bpy.types.GeometryNodeSetGridTransform.bl_rna_get_subclass)
    - [`GeometryNodeSetGridTransform.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeSetGridTransform.bl_rna_get_subclass_py)
