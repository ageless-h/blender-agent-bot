...
# NodeSocketMaterial(NodeSocketStandard)[¶](#nodesocketmaterial-nodesocketstandard "Link to this heading")
...
*class* bpy.types.NodeSocketMaterial(*NodeSocketStandard*)[¶](#bpy.types.NodeSocketMaterial "Link to this definition")
:   Material socket of a node

    default\_value[¶](#bpy.types.NodeSocketMaterial.default_value "Link to this definition")
    :   Input value used for unconnected socket

        Type:
        :   [`Material`](Material.md#bpy.types.Material "bpy.types.Material")

    links[¶](#bpy.types.NodeSocketMaterial.links "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.NodeSocketMaterial.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.NodeSocketMaterial.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.NodeSocketMaterial.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.NodeSocketMaterial.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* NodeSocketMaterial(NodeSocketStandard)
  + [`NodeSocketMaterial`](#bpy.types.NodeSocketMaterial)
    - [`NodeSocketMaterial.default_value`](#bpy.types.NodeSocketMaterial.default_value)
    - [`NodeSocketMaterial.links`](#bpy.types.NodeSocketMaterial.links)
    - [`NodeSocketMaterial.bl_rna_get_subclass()`](#bpy.types.NodeSocketMaterial.bl_rna_get_subclass)
    - [`NodeSocketMaterial.bl_rna_get_subclass_py()`](#bpy.types.NodeSocketMaterial.bl_rna_get_subclass_py)
