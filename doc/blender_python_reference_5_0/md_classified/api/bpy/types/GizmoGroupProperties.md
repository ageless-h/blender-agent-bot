...
# GizmoGroupProperties(bpy\_struct)[¶](#gizmogroupproperties-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.GizmoGroupProperties(*bpy\_struct*)[¶](#bpy.types.GizmoGroupProperties "Link to this definition")
:   Input properties of a Gizmo Group

    bl\_system\_properties\_get(*\**, *do\_create=False*)[¶](#bpy.types.GizmoGroupProperties.bl_system_properties_get "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.GizmoGroupProperties.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.GizmoGroupProperties.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`WorkSpaceTool.gizmo_group_properties`](WorkSpaceTool.md#bpy.types.WorkSpaceTool.gizmo_group_properties "bpy.types.WorkSpaceTool.gizmo_group_properties") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GizmoGroupProperties.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.GizmoGroupProperties.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GizmoGroupProperties(bpy\_struct)
  + [`GizmoGroupProperties`](#bpy.types.GizmoGroupProperties)
    - [`GizmoGroupProperties.bl_system_properties_get()`](#bpy.types.GizmoGroupProperties.bl_system_properties_get)
    - [`GizmoGroupProperties.bl_rna_get_subclass()`](#bpy.types.GizmoGroupProperties.bl_rna_get_subclass)
    - [`GizmoGroupProperties.bl_rna_get_subclass_py()`](#bpy.types.GizmoGroupProperties.bl_rna_get_subclass_py)
