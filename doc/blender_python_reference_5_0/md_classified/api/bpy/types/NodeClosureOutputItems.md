...
# NodeClosureOutputItems(bpy\_struct)[¶](#nodeclosureoutputitems-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.NodeClosureOutputItems(*bpy\_struct*)[¶](#bpy.types.NodeClosureOutputItems "Link to this definition")
:   new(*socket\_type*, *name*)[¶](#bpy.types.NodeClosureOutputItems.new "Link to this definition")
    :   Add an item at the end
        ...
        Return type:
        :   [`NodeClosureOutputItem`](NodeClosureOutputItem.md#bpy.types.NodeClosureOutputItem "bpy.types.NodeClosureOutputItem")

    remove(*item*)[¶](#bpy.types.NodeClosureOutputItems.remove "Link to this definition")
    :   Remove an item

        Parameters:
        :   **item** ([`NodeClosureOutputItem`](NodeClosureOutputItem.md#bpy.types.NodeClosureOutputItem "bpy.types.NodeClosureOutputItem"), (never None)) – Item, The item to remove

    clear()[¶](#bpy.types.NodeClosureOutputItems.clear "Link to this definition")
    :   Remove all items

    move(*from\_index*, *to\_index*)[¶](#bpy.types.NodeClosureOutputItems.move "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.NodeClosureOutputItems.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.NodeClosureOutputItems.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`NodeClosureOutput.output_items`](NodeClosureOutput.md#bpy.types.NodeClosureOutput.output_items "bpy.types.NodeClosureOutput.output_items") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.NodeClosureOutputItems.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.NodeClosureOutputItems.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* NodeClosureOutputItems(bpy\_struct)
  + [`NodeClosureOutputItems`](#bpy.types.NodeClosureOutputItems)
    - [`NodeClosureOutputItems.new()`](#bpy.types.NodeClosureOutputItems.new)
    - [`NodeClosureOutputItems.remove()`](#bpy.types.NodeClosureOutputItems.remove)
    - [`NodeClosureOutputItems.clear()`](#bpy.types.NodeClosureOutputItems.clear)
    - [`NodeClosureOutputItems.move()`](#bpy.types.NodeClosureOutputItems.move)
    - [`NodeClosureOutputItems.bl_rna_get_subclass()`](#bpy.types.NodeClosureOutputItems.bl_rna_get_subclass)
    - [`NodeClosureOutputItems.bl_rna_get_subclass_py()`](#bpy.types.NodeClosureOutputItems.bl_rna_get_subclass_py)
