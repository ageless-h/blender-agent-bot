...
# ArmatureModifier(Modifier)[¶](#armaturemodifier-modifier "Link to this heading")
...
*class* bpy.types.ArmatureModifier(*Modifier*)[¶](#bpy.types.ArmatureModifier "Link to this definition")
:   Armature deformation modifier

    invert\_vertex\_group[¶](#bpy.types.ArmatureModifier.invert_vertex_group "Link to this definition")
    :   Invert vertex group influence

        Type:
        :   boolean, default False

    object[¶](#bpy.types.ArmatureModifier.object "Link to this definition")
    :   Armature object to deform with

        Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object")

    use\_bone\_envelopes[¶](#bpy.types.ArmatureModifier.use_bone_envelopes "Link to this definition")
    :   Bind Bone envelopes to armature modifier

        Type:
        :   boolean, default False

    use\_deform\_preserve\_volume[¶](#bpy.types.ArmatureModifier.use_deform_preserve_volume "Link to this definition")
    :   Deform rotation interpolation with quaternions

        Type:
        :   boolean, default False

    use\_multi\_modifier[¶](#bpy.types.ArmatureModifier.use_multi_modifier "Link to this definition")
    :   Use same input as previous modifier, and mix results using overall vgroup

        Type:
        :   boolean, default False

    use\_vertex\_groups[¶](#bpy.types.ArmatureModifier.use_vertex_groups "Link to this definition")
    :   Bind vertex groups to armature modifier

        Type:
        :   boolean, default True

    vertex\_group[¶](#bpy.types.ArmatureModifier.vertex_group "Link to this definition")
    :   Name of Vertex Group which determines influence of modifier per point

        Type:
        :   string, default “”, (never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ArmatureModifier.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ArmatureModifier.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ArmatureModifier.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ArmatureModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ArmatureModifier(Modifier)
  + [`ArmatureModifier`](#bpy.types.ArmatureModifier)
    - [`ArmatureModifier.invert_vertex_group`](#bpy.types.ArmatureModifier.invert_vertex_group)
    - [`ArmatureModifier.object`](#bpy.types.ArmatureModifier.object)
    - [`ArmatureModifier.use_bone_envelopes`](#bpy.types.ArmatureModifier.use_bone_envelopes)
    - [`ArmatureModifier.use_deform_preserve_volume`](#bpy.types.ArmatureModifier.use_deform_preserve_volume)
    - [`ArmatureModifier.use_multi_modifier`](#bpy.types.ArmatureModifier.use_multi_modifier)
    - [`ArmatureModifier.use_vertex_groups`](#bpy.types.ArmatureModifier.use_vertex_groups)
    - [`ArmatureModifier.vertex_group`](#bpy.types.ArmatureModifier.vertex_group)
    - [`ArmatureModifier.bl_rna_get_subclass()`](#bpy.types.ArmatureModifier.bl_rna_get_subclass)
    - [`ArmatureModifier.bl_rna_get_subclass_py()`](#bpy.types.ArmatureModifier.bl_rna_get_subclass_py)
