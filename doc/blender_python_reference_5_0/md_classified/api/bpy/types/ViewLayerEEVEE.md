...
# ViewLayerEEVEE(bpy\_struct)[¶](#viewlayereevee-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.ViewLayerEEVEE(*bpy\_struct*)[¶](#bpy.types.ViewLayerEEVEE "Link to this definition")
:   View Layer settings for EEVEE

    ambient\_occlusion\_distance[¶](#bpy.types.ViewLayerEEVEE.ambient_occlusion_distance "Link to this definition")
    :   Distance of object that contribute to the ambient occlusion effect

        Type:
        :   float in [0, 100000], default 0.0

    use\_pass\_bloom[¶](#bpy.types.ViewLayerEEVEE.use_pass_bloom "Link to this definition")
    :   Deliver bloom pass (deprecated)

        Type:
        :   boolean, default False

    use\_pass\_transparent[¶](#bpy.types.ViewLayerEEVEE.use_pass_transparent "Link to this definition")
    :   Deliver alpha blended surfaces in a separate pass

        Type:
        :   boolean, default False

    use\_pass\_volume\_direct[¶](#bpy.types.ViewLayerEEVEE.use_pass_volume_direct "Link to this definition")
    :   Deliver volume direct light pass

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ViewLayerEEVEE.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ViewLayerEEVEE.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`ViewLayer.eevee`](ViewLayer.md#bpy.types.ViewLayer.eevee "bpy.types.ViewLayer.eevee") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ViewLayerEEVEE.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ViewLayerEEVEE.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ViewLayerEEVEE(bpy\_struct)
  + [`ViewLayerEEVEE`](#bpy.types.ViewLayerEEVEE)
    - [`ViewLayerEEVEE.ambient_occlusion_distance`](#bpy.types.ViewLayerEEVEE.ambient_occlusion_distance)
    - [`ViewLayerEEVEE.use_pass_bloom`](#bpy.types.ViewLayerEEVEE.use_pass_bloom)
    - [`ViewLayerEEVEE.use_pass_transparent`](#bpy.types.ViewLayerEEVEE.use_pass_transparent)
    - [`ViewLayerEEVEE.use_pass_volume_direct`](#bpy.types.ViewLayerEEVEE.use_pass_volume_direct)
    - [`ViewLayerEEVEE.bl_rna_get_subclass()`](#bpy.types.ViewLayerEEVEE.bl_rna_get_subclass)
    - [`ViewLayerEEVEE.bl_rna_get_subclass_py()`](#bpy.types.ViewLayerEEVEE.bl_rna_get_subclass_py)
