...
# NodesModifierWarning(bpy\_struct)[¶](#nodesmodifierwarning-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.NodesModifierWarning(*bpy\_struct*)[¶](#bpy.types.NodesModifierWarning "Link to this definition")
:   Warning created during evaluation of a geometry nodes modifier

    message[¶](#bpy.types.NodesModifierWarning.message "Link to this definition")
    :   Type:
        :   string, default “”, (readonly, never None)

    type[¶](#bpy.types.NodesModifierWarning.type "Link to this definition")
    :   Type:
        :   enum in [Node Warning Type Items](../../../appendix/bpy_types_enum_items/node_warning_type_items.md#rna-enum-node-warning-type-items), default `'ERROR'`, (readonly)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.NodesModifierWarning.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.NodesModifierWarning.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`NodesModifier.node_warnings`](NodesModifier.md#bpy.types.NodesModifier.node_warnings "bpy.types.NodesModifier.node_warnings") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.NodesModifierWarning.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.NodesModifierWarning.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* NodesModifierWarning(bpy\_struct)
  + [`NodesModifierWarning`](#bpy.types.NodesModifierWarning)
    - [`NodesModifierWarning.message`](#bpy.types.NodesModifierWarning.message)
    - [`NodesModifierWarning.type`](#bpy.types.NodesModifierWarning.type)
    - [`NodesModifierWarning.bl_rna_get_subclass()`](#bpy.types.NodesModifierWarning.bl_rna_get_subclass)
    - [`NodesModifierWarning.bl_rna_get_subclass_py()`](#bpy.types.NodesModifierWarning.bl_rna_get_subclass_py)
