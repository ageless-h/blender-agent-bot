...
# ActionPoseMarkers(bpy\_struct)[¶](#actionposemarkers-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.ActionPoseMarkers(*bpy\_struct*)[¶](#bpy.types.ActionPoseMarkers "Link to this definition")
:   Collection of timeline markers

    active[¶](#bpy.types.ActionPoseMarkers.active "Link to this definition")
    :   Active pose marker for this action

        Type:
        :   [`TimelineMarker`](TimelineMarker.md#bpy.types.TimelineMarker "bpy.types.TimelineMarker")

    active\_index[¶](#bpy.types.ActionPoseMarkers.active_index "Link to this definition")
    :   Index of active pose marker

        Type:
        :   int in [0, inf], default 0

    new(*name*)[¶](#bpy.types.ActionPoseMarkers.new "Link to this definition")
    ...
    remove(*marker*)[¶](#bpy.types.ActionPoseMarkers.remove "Link to this definition")
    :   Remove a timeline marker

        Parameters:
        :   **marker** ([`TimelineMarker`](TimelineMarker.md#bpy.types.TimelineMarker "bpy.types.TimelineMarker"), (never None)) – Timeline marker to remove

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ActionPoseMarkers.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ActionPoseMarkers.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Action.pose_markers`](Action.md#bpy.types.Action.pose_markers "bpy.types.Action.pose_markers") |  |

[Next

ActionSlot(bpy\_struct)](ActionSlot.md)
[Previous

ActionLayers(bpy\_struct)](ActionLayers.md)
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ActionPoseMarkers.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ActionPoseMarkers.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ActionPoseMarkers(bpy\_struct)
  + [`ActionPoseMarkers`](#bpy.types.ActionPoseMarkers)
    - [`ActionPoseMarkers.active`](#bpy.types.ActionPoseMarkers.active)
    - [`ActionPoseMarkers.active_index`](#bpy.types.ActionPoseMarkers.active_index)
    - [`ActionPoseMarkers.new()`](#bpy.types.ActionPoseMarkers.new)
    - [`ActionPoseMarkers.remove()`](#bpy.types.ActionPoseMarkers.remove)
    - [`ActionPoseMarkers.bl_rna_get_subclass()`](#bpy.types.ActionPoseMarkers.bl_rna_get_subclass)
    - [`ActionPoseMarkers.bl_rna_get_subclass_py()`](#bpy.types.ActionPoseMarkers.bl_rna_get_subclass_py)
