...
# NodeIndexSwitchItems(bpy\_struct)[¶](#nodeindexswitchitems-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.NodeIndexSwitchItems(*bpy\_struct*)[¶](#bpy.types.NodeIndexSwitchItems "Link to this definition")
:   Collection of index\_switch items

    new()[¶](#bpy.types.NodeIndexSwitchItems.new "Link to this definition")
    :   Add an item at the end
        ...
        Return type:
        :   [`IndexSwitchItem`](IndexSwitchItem.md#bpy.types.IndexSwitchItem "bpy.types.IndexSwitchItem")

    remove(*item*)[¶](#bpy.types.NodeIndexSwitchItems.remove "Link to this definition")
    :   Remove an item

        Parameters:
        :   **item** ([`IndexSwitchItem`](IndexSwitchItem.md#bpy.types.IndexSwitchItem "bpy.types.IndexSwitchItem"), (never None)) – Item, The item to remove

    clear()[¶](#bpy.types.NodeIndexSwitchItems.clear "Link to this definition")
    :   Remove all items

    move(*from\_index*, *to\_index*)[¶](#bpy.types.NodeIndexSwitchItems.move "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.NodeIndexSwitchItems.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.NodeIndexSwitchItems.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`GeometryNodeIndexSwitch.index_switch_items`](GeometryNodeIndexSwitch.md#bpy.types.GeometryNodeIndexSwitch.index_switch_items "bpy.types.GeometryNodeIndexSwitch.index_switch_items") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.NodeIndexSwitchItems.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.NodeIndexSwitchItems.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* NodeIndexSwitchItems(bpy\_struct)
  + [`NodeIndexSwitchItems`](#bpy.types.NodeIndexSwitchItems)
    - [`NodeIndexSwitchItems.new()`](#bpy.types.NodeIndexSwitchItems.new)
    - [`NodeIndexSwitchItems.remove()`](#bpy.types.NodeIndexSwitchItems.remove)
    - [`NodeIndexSwitchItems.clear()`](#bpy.types.NodeIndexSwitchItems.clear)
    - [`NodeIndexSwitchItems.move()`](#bpy.types.NodeIndexSwitchItems.move)
    - [`NodeIndexSwitchItems.bl_rna_get_subclass()`](#bpy.types.NodeIndexSwitchItems.bl_rna_get_subclass)
    - [`NodeIndexSwitchItems.bl_rna_get_subclass_py()`](#bpy.types.NodeIndexSwitchItems.bl_rna_get_subclass_py)
