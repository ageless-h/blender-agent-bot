...
# DriverVariable(bpy\_struct)[¶](#drivervariable-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.DriverVariable(*bpy\_struct*)[¶](#bpy.types.DriverVariable "Link to this definition")
:   Variable from some source/target for driver relationship

    is\_name\_valid[¶](#bpy.types.DriverVariable.is_name_valid "Link to this definition")
    :   Is this a valid name for a driver variable

        Type:
        :   boolean, default False, (readonly)

    name[¶](#bpy.types.DriverVariable.name "Link to this definition")
    :   Name to use in scripted expressions/functions (no spaces or dots are allowed, and must start with a letter)

        Type:
        :   string, default “”, (never None)

    targets[¶](#bpy.types.DriverVariable.targets "Link to this definition")
    :   Sources of input data for evaluating this variable

        Type:
        :   [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`DriverTarget`](DriverTarget.md#bpy.types.DriverTarget "bpy.types.DriverTarget"), (readonly)

    type[¶](#bpy.types.DriverVariable.type "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.DriverVariable.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.DriverVariable.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`ChannelDriverVariables.new`](ChannelDriverVariables.md#bpy.types.ChannelDriverVariables.new "bpy.types.ChannelDriverVariables.new") * [`ChannelDriverVariables.remove`](ChannelDriverVariables.md#bpy.types.ChannelDriverVariables.remove "bpy.types.ChannelDriverVariables.remove") | * [`Driver.variables`](Driver.md#bpy.types.Driver.variables "bpy.types.Driver.variables") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.DriverVariable.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.DriverVariable.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* DriverVariable(bpy\_struct)
  + [`DriverVariable`](#bpy.types.DriverVariable)
    - [`DriverVariable.is_name_valid`](#bpy.types.DriverVariable.is_name_valid)
    - [`DriverVariable.name`](#bpy.types.DriverVariable.name)
    - [`DriverVariable.targets`](#bpy.types.DriverVariable.targets)
    - [`DriverVariable.type`](#bpy.types.DriverVariable.type)
    - [`DriverVariable.bl_rna_get_subclass()`](#bpy.types.DriverVariable.bl_rna_get_subclass)
    - [`DriverVariable.bl_rna_get_subclass_py()`](#bpy.types.DriverVariable.bl_rna_get_subclass_py)
