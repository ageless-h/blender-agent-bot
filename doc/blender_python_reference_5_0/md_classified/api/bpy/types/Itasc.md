...
# Itasc(IKParam)[¶](#itasc-ikparam "Link to this heading")

base classes — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct"), [`IKParam`](IKParam.md#bpy.types.IKParam "bpy.types.IKParam")

*class* bpy.types.Itasc(*IKParam*)[¶](#bpy.types.Itasc "Link to this definition")
:   Parameters for the iTaSC IK solver

    damping\_epsilon[¶](#bpy.types.Itasc.damping_epsilon "Link to this definition")
    ...
    damping\_max[¶](#bpy.types.Itasc.damping_max "Link to this definition")
    ...
    feedback[¶](#bpy.types.Itasc.feedback "Link to this definition")
    :   Feedback coefficient for error correction, average response time is 1/feedback

        Type:
        :   float in [0, 100], default 0.0

    iterations[¶](#bpy.types.Itasc.iterations "Link to this definition")
    :   Maximum number of iterations for convergence in case of reiteration

        Type:
        :   int in [0, 1000], default 0

    mode[¶](#bpy.types.Itasc.mode "Link to this definition")
    :   * `ANIMATION`
    ...
    precision[¶](#bpy.types.Itasc.precision "Link to this definition")
    :   Precision of convergence in case of reiteration

        Type:
        :   float in [0, 0.1], default 0.0

    reiteration\_method[¶](#bpy.types.Itasc.reiteration_method "Link to this definition")
    ...
    solver[¶](#bpy.types.Itasc.solver "Link to this definition")
    ...
    step\_count[¶](#bpy.types.Itasc.step_count "Link to this definition")
    :   Divide the frame interval into this many steps

        Type:
        :   int in [1, 50], default 0

    step\_max[¶](#bpy.types.Itasc.step_max "Link to this definition")
    :   Higher bound for timestep in second in case of automatic substeps

        Type:
        :   float in [0, 1], default 0.0

    step\_min[¶](#bpy.types.Itasc.step_min "Link to this definition")
    :   Lower bound for timestep in second in case of automatic substeps

        Type:
        :   float in [0, 0.1], default 0.0

    translate\_root\_bones[¶](#bpy.types.Itasc.translate_root_bones "Link to this definition")
    :   Translate root (i.e. parentless) bones to the armature origin

        Type:
        :   boolean, default False

    use\_auto\_step[¶](#bpy.types.Itasc.use_auto_step "Link to this definition")
    :   Automatically determine the optimal number of steps for best performance/accuracy trade off

        Type:
        :   boolean, default False

    velocity\_max[¶](#bpy.types.Itasc.velocity_max "Link to this definition")
    :   Maximum joint velocity in radians/second

        Type:
        :   float in [0, 100], default 0.0

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.Itasc.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.Itasc.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.Itasc.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.Itasc.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* Itasc(IKParam)
  + [`Itasc`](#bpy.types.Itasc)
    - [`Itasc.damping_epsilon`](#bpy.types.Itasc.damping_epsilon)
    - [`Itasc.damping_max`](#bpy.types.Itasc.damping_max)
    - [`Itasc.feedback`](#bpy.types.Itasc.feedback)
    - [`Itasc.iterations`](#bpy.types.Itasc.iterations)
    - [`Itasc.mode`](#bpy.types.Itasc.mode)
    - [`Itasc.precision`](#bpy.types.Itasc.precision)
    - [`Itasc.reiteration_method`](#bpy.types.Itasc.reiteration_method)
    - [`Itasc.solver`](#bpy.types.Itasc.solver)
    - [`Itasc.step_count`](#bpy.types.Itasc.step_count)
    - [`Itasc.step_max`](#bpy.types.Itasc.step_max)
    - [`Itasc.step_min`](#bpy.types.Itasc.step_min)
    - [`Itasc.translate_root_bones`](#bpy.types.Itasc.translate_root_bones)
    - [`Itasc.use_auto_step`](#bpy.types.Itasc.use_auto_step)
    - [`Itasc.velocity_max`](#bpy.types.Itasc.velocity_max)
    - [`Itasc.bl_rna_get_subclass()`](#bpy.types.Itasc.bl_rna_get_subclass)
    - [`Itasc.bl_rna_get_subclass_py()`](#bpy.types.Itasc.bl_rna_get_subclass_py)
