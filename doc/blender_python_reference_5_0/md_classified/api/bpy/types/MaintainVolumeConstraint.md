...
# MaintainVolumeConstraint(Constraint)[¶](#maintainvolumeconstraint-constraint "Link to this heading")
...
*class* bpy.types.MaintainVolumeConstraint(*Constraint*)[¶](#bpy.types.MaintainVolumeConstraint "Link to this definition")
:   Maintain a constant volume along a single scaling axis

    free\_axis[¶](#bpy.types.MaintainVolumeConstraint.free_axis "Link to this definition")
    :   The free scaling axis of the object

        Type:
        :   enum in [`'SAMEVOL_X'`, `'SAMEVOL_Y'`, `'SAMEVOL_Z'`], default `'SAMEVOL_X'`

    mode[¶](#bpy.types.MaintainVolumeConstraint.mode "Link to this definition")
    :   The way the constraint treats original non-free axis scaling
        ...
        * `SINGLE_AXIS`
        ...
        Type:
        :   enum in [`'STRICT'`, `'UNIFORM'`, `'SINGLE_AXIS'`], default `'STRICT'`

    volume[¶](#bpy.types.MaintainVolumeConstraint.volume "Link to this definition")
    :   Volume of the bone at rest

        Type:
        :   float in [0, inf], default 0.0

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.MaintainVolumeConstraint.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.MaintainVolumeConstraint.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.MaintainVolumeConstraint.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.MaintainVolumeConstraint.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* MaintainVolumeConstraint(Constraint)
  + [`MaintainVolumeConstraint`](#bpy.types.MaintainVolumeConstraint)
    - [`MaintainVolumeConstraint.free_axis`](#bpy.types.MaintainVolumeConstraint.free_axis)
    - [`MaintainVolumeConstraint.mode`](#bpy.types.MaintainVolumeConstraint.mode)
    - [`MaintainVolumeConstraint.volume`](#bpy.types.MaintainVolumeConstraint.volume)
    - [`MaintainVolumeConstraint.bl_rna_get_subclass()`](#bpy.types.MaintainVolumeConstraint.bl_rna_get_subclass)
    - [`MaintainVolumeConstraint.bl_rna_get_subclass_py()`](#bpy.types.MaintainVolumeConstraint.bl_rna_get_subclass_py)
