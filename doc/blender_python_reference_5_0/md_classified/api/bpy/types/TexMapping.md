...
# TexMapping(bpy\_struct)[¶](#texmapping-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.TexMapping(*bpy\_struct*)[¶](#bpy.types.TexMapping "Link to this definition")
:   Texture coordinate mapping settings

    mapping[¶](#bpy.types.TexMapping.mapping "Link to this definition")
    :   * `FLAT`
    ...
    mapping\_x[¶](#bpy.types.TexMapping.mapping_x "Link to this definition")
    :   Type:
        :   enum in [`'NONE'`, `'X'`, `'Y'`, `'Z'`], default `'NONE'`

    mapping\_y[¶](#bpy.types.TexMapping.mapping_y "Link to this definition")
    :   Type:
        :   enum in [`'NONE'`, `'X'`, `'Y'`, `'Z'`], default `'NONE'`

    mapping\_z[¶](#bpy.types.TexMapping.mapping_z "Link to this definition")
    :   Type:
        :   enum in [`'NONE'`, `'X'`, `'Y'`, `'Z'`], default `'NONE'`

    max[¶](#bpy.types.TexMapping.max "Link to this definition")
    :   Maximum value for clipping

        Type:
        :   [`mathutils.Vector`](../../mathutils/index.md#mathutils.Vector "mathutils.Vector") of 3 items in [-inf, inf], default (0.0, 0.0, 0.0)

    min[¶](#bpy.types.TexMapping.min "Link to this definition")
    :   Minimum value for clipping

        Type:
        :   [`mathutils.Vector`](../../mathutils/index.md#mathutils.Vector "mathutils.Vector") of 3 items in [-inf, inf], default (0.0, 0.0, 0.0)

    rotation[¶](#bpy.types.TexMapping.rotation "Link to this definition")
    :   Type:
        :   [`mathutils.Euler`](../../mathutils/index.md#mathutils.Euler "mathutils.Euler") rotation of 3 items in [-inf, inf], default (0.0, 0.0, 0.0)

    scale[¶](#bpy.types.TexMapping.scale "Link to this definition")
    :   Type:
        :   [`mathutils.Vector`](../../mathutils/index.md#mathutils.Vector "mathutils.Vector") of 3 items in [-inf, inf], default (0.0, 0.0, 0.0)

    translation[¶](#bpy.types.TexMapping.translation "Link to this definition")
    :   Type:
        :   [`mathutils.Vector`](../../mathutils/index.md#mathutils.Vector "mathutils.Vector") of 3 items in [-inf, inf], default (0.0, 0.0, 0.0)

    use\_max[¶](#bpy.types.TexMapping.use_max "Link to this definition")
    :   Whether to use maximum clipping value

        Type:
        :   boolean, default False

    use\_min[¶](#bpy.types.TexMapping.use_min "Link to this definition")
    :   Whether to use minimum clipping value

        Type:
        :   boolean, default False

    vector\_type[¶](#bpy.types.TexMapping.vector_type "Link to this definition")
    :   Type of vector that the mapping transforms

        Type:
        :   enum in [Mapping Type Items](../../../appendix/bpy_types_enum_items/mapping_type_items.md#rna-enum-mapping-type-items), default `'POINT'`

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.TexMapping.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.TexMapping.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`ShaderNodeTexBrick.texture_mapping`](ShaderNodeTexBrick.md#bpy.types.ShaderNodeTexBrick.texture_mapping "bpy.types.ShaderNodeTexBrick.texture_mapping") * [`ShaderNodeTexChecker.texture_mapping`](ShaderNodeTexChecker.md#bpy.types.ShaderNodeTexChecker.texture_mapping "bpy.types.ShaderNodeTexChecker.texture_mapping") * [`ShaderNodeTexEnvironment.texture_mapping`](ShaderNodeTexEnvironment.md#bpy.types.ShaderNodeTexEnvironment.texture_mapping "bpy.types.ShaderNodeTexEnvironment.texture_mapping") * [`ShaderNodeTexGabor.texture_mapping`](ShaderNodeTexGabor.md#bpy.types.ShaderNodeTexGabor.texture_mapping "bpy.types.ShaderNodeTexGabor.texture_mapping") * [`ShaderNodeTexGradient.texture_mapping`](ShaderNodeTexGradient.md#bpy.types.ShaderNodeTexGradient.texture_mapping "bpy.types.ShaderNodeTexGradient.texture_mapping") * [`ShaderNodeTexImage.texture_mapping`](ShaderNodeTexImage.md#bpy.types.ShaderNodeTexImage.texture_mapping "bpy.types.ShaderNodeTexImage.texture_mapping") | * [`ShaderNodeTexMagic.texture_mapping`](ShaderNodeTexMagic.md#bpy.types.ShaderNodeTexMagic.texture_mapping "bpy.types.ShaderNodeTexMagic.texture_mapping") * [`ShaderNodeTexNoise.texture_mapping`](ShaderNodeTexNoise.md#bpy.types.ShaderNodeTexNoise.texture_mapping "bpy.types.ShaderNodeTexNoise.texture_mapping") * [`ShaderNodeTexSky.texture_mapping`](ShaderNodeTexSky.md#bpy.types.ShaderNodeTexSky.texture_mapping "bpy.types.ShaderNodeTexSky.texture_mapping") * [`ShaderNodeTexVoronoi.texture_mapping`](ShaderNodeTexVoronoi.md#bpy.types.ShaderNodeTexVoronoi.texture_mapping "bpy.types.ShaderNodeTexVoronoi.texture_mapping") * [`ShaderNodeTexWave.texture_mapping`](ShaderNodeTexWave.md#bpy.types.ShaderNodeTexWave.texture_mapping "bpy.types.ShaderNodeTexWave.texture_mapping") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.TexMapping.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.TexMapping.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* TexMapping(bpy\_struct)
  + [`TexMapping`](#bpy.types.TexMapping)
    - [`TexMapping.mapping`](#bpy.types.TexMapping.mapping)
    - [`TexMapping.mapping_x`](#bpy.types.TexMapping.mapping_x)
    - [`TexMapping.mapping_y`](#bpy.types.TexMapping.mapping_y)
    - [`TexMapping.mapping_z`](#bpy.types.TexMapping.mapping_z)
    - [`TexMapping.max`](#bpy.types.TexMapping.max)
    - [`TexMapping.min`](#bpy.types.TexMapping.min)
    - [`TexMapping.rotation`](#bpy.types.TexMapping.rotation)
    - [`TexMapping.scale`](#bpy.types.TexMapping.scale)
    - [`TexMapping.translation`](#bpy.types.TexMapping.translation)
    - [`TexMapping.use_max`](#bpy.types.TexMapping.use_max)
    - [`TexMapping.use_min`](#bpy.types.TexMapping.use_min)
    - [`TexMapping.vector_type`](#bpy.types.TexMapping.vector_type)
    - [`TexMapping.bl_rna_get_subclass()`](#bpy.types.TexMapping.bl_rna_get_subclass)
    - [`TexMapping.bl_rna_get_subclass_py()`](#bpy.types.TexMapping.bl_rna_get_subclass_py)
