...
# ByteIntAttributeValue(bpy\_struct)[¶](#byteintattributevalue-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.ByteIntAttributeValue(*bpy\_struct*)[¶](#bpy.types.ByteIntAttributeValue "Link to this definition")
:   8-bit value in geometry attribute

    value[¶](#bpy.types.ByteIntAttributeValue.value "Link to this definition")
    :   Type:
        :   int in [-128, 127], default 0

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ByteIntAttributeValue.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ByteIntAttributeValue.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`ByteIntAttribute.data`](ByteIntAttribute.md#bpy.types.ByteIntAttribute.data "bpy.types.ByteIntAttribute.data") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ByteIntAttributeValue.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ByteIntAttributeValue.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ByteIntAttributeValue(bpy\_struct)
  + [`ByteIntAttributeValue`](#bpy.types.ByteIntAttributeValue)
    - [`ByteIntAttributeValue.value`](#bpy.types.ByteIntAttributeValue.value)
    - [`ByteIntAttributeValue.bl_rna_get_subclass()`](#bpy.types.ByteIntAttributeValue.bl_rna_get_subclass)
    - [`ByteIntAttributeValue.bl_rna_get_subclass_py()`](#bpy.types.ByteIntAttributeValue.bl_rna_get_subclass_py)
