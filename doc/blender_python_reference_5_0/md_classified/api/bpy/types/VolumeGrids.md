...
# VolumeGrids(bpy\_struct)[¶](#volumegrids-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.VolumeGrids(*bpy\_struct*)[¶](#bpy.types.VolumeGrids "Link to this definition")
:   3D volume grids

    active\_index[¶](#bpy.types.VolumeGrids.active_index "Link to this definition")
    :   Index of active volume grid

        Type:
        :   int in [0, inf], default 0

    error\_message[¶](#bpy.types.VolumeGrids.error_message "Link to this definition")
    :   If loading grids failed, error message with details

        Type:
        :   string, default “”, (readonly, never None)

    frame[¶](#bpy.types.VolumeGrids.frame "Link to this definition")
    :   Frame number that volume grids will be loaded at, based on scene time and volume parameters

        Type:
        :   int in [-inf, inf], default 0, (readonly)

    frame\_filepath[¶](#bpy.types.VolumeGrids.frame_filepath "Link to this definition")
    :   Volume file used for loading the volume at the current frame. Empty if the volume has not be loaded or the frame only exists in memory.
        ...
        Type:
        :   string, default “”, (readonly, never None, blend relative `//` prefix supported)

    is\_loaded[¶](#bpy.types.VolumeGrids.is_loaded "Link to this definition")
    :   List of grids and metadata are loaded in memory

        Type:
        :   boolean, default False, (readonly)

    load()[¶](#bpy.types.VolumeGrids.load "Link to this definition")
    ...
    unload()[¶](#bpy.types.VolumeGrids.unload "Link to this definition")
    :   Unload all grid and voxel data from memory

    save(*filepath*)[¶](#bpy.types.VolumeGrids.save "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.VolumeGrids.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.VolumeGrids.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.VolumeGrids.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.VolumeGrids.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* VolumeGrids(bpy\_struct)
  + [`VolumeGrids`](#bpy.types.VolumeGrids)
    - [`VolumeGrids.active_index`](#bpy.types.VolumeGrids.active_index)
    - [`VolumeGrids.error_message`](#bpy.types.VolumeGrids.error_message)
    - [`VolumeGrids.frame`](#bpy.types.VolumeGrids.frame)
    - [`VolumeGrids.frame_filepath`](#bpy.types.VolumeGrids.frame_filepath)
    - [`VolumeGrids.is_loaded`](#bpy.types.VolumeGrids.is_loaded)
    - [`VolumeGrids.load()`](#bpy.types.VolumeGrids.load)
    - [`VolumeGrids.unload()`](#bpy.types.VolumeGrids.unload)
    - [`VolumeGrids.save()`](#bpy.types.VolumeGrids.save)
    - [`VolumeGrids.bl_rna_get_subclass()`](#bpy.types.VolumeGrids.bl_rna_get_subclass)
    - [`VolumeGrids.bl_rna_get_subclass_py()`](#bpy.types.VolumeGrids.bl_rna_get_subclass_py)
