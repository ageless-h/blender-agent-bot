...
# LatticeModifier(Modifier)[¶](#latticemodifier-modifier "Link to this heading")
...
*class* bpy.types.LatticeModifier(*Modifier*)[¶](#bpy.types.LatticeModifier "Link to this definition")
:   Lattice deformation modifier

    invert\_vertex\_group[¶](#bpy.types.LatticeModifier.invert_vertex_group "Link to this definition")
    :   Invert vertex group influence

        Type:
        :   boolean, default False

    object[¶](#bpy.types.LatticeModifier.object "Link to this definition")
    :   Lattice object to deform with

        Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object")

    strength[¶](#bpy.types.LatticeModifier.strength "Link to this definition")
    :   Strength of modifier effect

        Type:
        :   float in [-inf, inf], default 1.0

    vertex\_group[¶](#bpy.types.LatticeModifier.vertex_group "Link to this definition")
    :   Name of Vertex Group which determines influence of modifier per point

        Type:
        :   string, default “”, (never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.LatticeModifier.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.LatticeModifier.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.LatticeModifier.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.LatticeModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* LatticeModifier(Modifier)
  + [`LatticeModifier`](#bpy.types.LatticeModifier)
    - [`LatticeModifier.invert_vertex_group`](#bpy.types.LatticeModifier.invert_vertex_group)
    - [`LatticeModifier.object`](#bpy.types.LatticeModifier.object)
    - [`LatticeModifier.strength`](#bpy.types.LatticeModifier.strength)
    - [`LatticeModifier.vertex_group`](#bpy.types.LatticeModifier.vertex_group)
    - [`LatticeModifier.bl_rna_get_subclass()`](#bpy.types.LatticeModifier.bl_rna_get_subclass)
    - [`LatticeModifier.bl_rna_get_subclass_py()`](#bpy.types.LatticeModifier.bl_rna_get_subclass_py)
