...
# FModifierLimits(FModifier)[¶](#fmodifierlimits-fmodifier "Link to this heading")
...
*class* bpy.types.FModifierLimits(*FModifier*)[¶](#bpy.types.FModifierLimits "Link to this definition")
:   Limit the time/value ranges of the modified F-Curve

    max\_x[¶](#bpy.types.FModifierLimits.max_x "Link to this definition")
    :   Highest X value to allow

        Type:
        :   float in [-inf, inf], default 0.0

    max\_y[¶](#bpy.types.FModifierLimits.max_y "Link to this definition")
    :   Highest Y value to allow

        Type:
        :   float in [-inf, inf], default 0.0

    min\_x[¶](#bpy.types.FModifierLimits.min_x "Link to this definition")
    :   Lowest X value to allow

        Type:
        :   float in [-inf, inf], default 0.0

    min\_y[¶](#bpy.types.FModifierLimits.min_y "Link to this definition")
    :   Lowest Y value to allow

        Type:
        :   float in [-inf, inf], default 0.0

    use\_max\_x[¶](#bpy.types.FModifierLimits.use_max_x "Link to this definition")
    :   Use the maximum X value

        Type:
        :   boolean, default False

    use\_max\_y[¶](#bpy.types.FModifierLimits.use_max_y "Link to this definition")
    :   Use the maximum Y value

        Type:
        :   boolean, default False

    use\_min\_x[¶](#bpy.types.FModifierLimits.use_min_x "Link to this definition")
    :   Use the minimum X value

        Type:
        :   boolean, default False

    use\_min\_y[¶](#bpy.types.FModifierLimits.use_min_y "Link to this definition")
    :   Use the minimum Y value

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.FModifierLimits.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.FModifierLimits.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.FModifierLimits.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.FModifierLimits.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* FModifierLimits(FModifier)
  + [`FModifierLimits`](#bpy.types.FModifierLimits)
    - [`FModifierLimits.max_x`](#bpy.types.FModifierLimits.max_x)
    - [`FModifierLimits.max_y`](#bpy.types.FModifierLimits.max_y)
    - [`FModifierLimits.min_x`](#bpy.types.FModifierLimits.min_x)
    - [`FModifierLimits.min_y`](#bpy.types.FModifierLimits.min_y)
    - [`FModifierLimits.use_max_x`](#bpy.types.FModifierLimits.use_max_x)
    - [`FModifierLimits.use_max_y`](#bpy.types.FModifierLimits.use_max_y)
    - [`FModifierLimits.use_min_x`](#bpy.types.FModifierLimits.use_min_x)
    - [`FModifierLimits.use_min_y`](#bpy.types.FModifierLimits.use_min_y)
    - [`FModifierLimits.bl_rna_get_subclass()`](#bpy.types.FModifierLimits.bl_rna_get_subclass)
    - [`FModifierLimits.bl_rna_get_subclass_py()`](#bpy.types.FModifierLimits.bl_rna_get_subclass_py)
