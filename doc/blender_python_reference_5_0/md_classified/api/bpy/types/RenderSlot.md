...
# RenderSlot(bpy\_struct)[¶](#renderslot-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.RenderSlot(*bpy\_struct*)[¶](#bpy.types.RenderSlot "Link to this definition")
:   Parameters defining the render slot

    name[¶](#bpy.types.RenderSlot.name "Link to this definition")
    :   Render slot name

        Type:
        :   string, default “”, (never None)

    clear(*iuser*)[¶](#bpy.types.RenderSlot.clear "Link to this definition")
    :   Clear the render slot

        Parameters:
        :   **iuser** ([`ImageUser`](ImageUser.md#bpy.types.ImageUser "bpy.types.ImageUser")) – ImageUser

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.RenderSlot.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.RenderSlot.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Image.render_slots`](Image.md#bpy.types.Image.render_slots "bpy.types.Image.render_slots") * [`RenderSlots.active`](RenderSlots.md#bpy.types.RenderSlots.active "bpy.types.RenderSlots.active") | * [`RenderSlots.new`](RenderSlots.md#bpy.types.RenderSlots.new "bpy.types.RenderSlots.new") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.RenderSlot.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.RenderSlot.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* RenderSlot(bpy\_struct)
  + [`RenderSlot`](#bpy.types.RenderSlot)
    - [`RenderSlot.name`](#bpy.types.RenderSlot.name)
    - [`RenderSlot.clear()`](#bpy.types.RenderSlot.clear)
    - [`RenderSlot.bl_rna_get_subclass()`](#bpy.types.RenderSlot.bl_rna_get_subclass)
    - [`RenderSlot.bl_rna_get_subclass_py()`](#bpy.types.RenderSlot.bl_rna_get_subclass_py)
