...
# NodeSeparateBundleItem(bpy\_struct)[¶](#nodeseparatebundleitem-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.NodeSeparateBundleItem(*bpy\_struct*)[¶](#bpy.types.NodeSeparateBundleItem "Link to this definition")
:   color[¶](#bpy.types.NodeSeparateBundleItem.color "Link to this definition")
    ...
    name[¶](#bpy.types.NodeSeparateBundleItem.name "Link to this definition")
    :   Type:
        :   string, default “”, (never None)

    socket\_type[¶](#bpy.types.NodeSeparateBundleItem.socket_type "Link to this definition")
    :   Type:
    ...
    structure\_type[¶](#bpy.types.NodeSeparateBundleItem.structure_type "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.NodeSeparateBundleItem.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.NodeSeparateBundleItem.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`NodeSeparateBundle.bundle_items`](NodeSeparateBundle.md#bpy.types.NodeSeparateBundle.bundle_items "bpy.types.NodeSeparateBundle.bundle_items") * [`NodeSeparateBundleItems.new`](NodeSeparateBundleItems.md#bpy.types.NodeSeparateBundleItems.new "bpy.types.NodeSeparateBundleItems.new") | * [`NodeSeparateBundleItems.remove`](NodeSeparateBundleItems.md#bpy.types.NodeSeparateBundleItems.remove "bpy.types.NodeSeparateBundleItems.remove") |
...
NodeSeparateBundle(NodeInternal)](NodeSeparateBundle.md)
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.NodeSeparateBundleItem.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.NodeSeparateBundleItem.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* NodeSeparateBundleItem(bpy\_struct)
  + [`NodeSeparateBundleItem`](#bpy.types.NodeSeparateBundleItem)
    - [`NodeSeparateBundleItem.color`](#bpy.types.NodeSeparateBundleItem.color)
    - [`NodeSeparateBundleItem.name`](#bpy.types.NodeSeparateBundleItem.name)
    - [`NodeSeparateBundleItem.socket_type`](#bpy.types.NodeSeparateBundleItem.socket_type)
    - [`NodeSeparateBundleItem.structure_type`](#bpy.types.NodeSeparateBundleItem.structure_type)
    - [`NodeSeparateBundleItem.bl_rna_get_subclass()`](#bpy.types.NodeSeparateBundleItem.bl_rna_get_subclass)
    - [`NodeSeparateBundleItem.bl_rna_get_subclass_py()`](#bpy.types.NodeSeparateBundleItem.bl_rna_get_subclass_py)
