...
# SceneDisplay(bpy\_struct)[¶](#scenedisplay-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.SceneDisplay(*bpy\_struct*)[¶](#bpy.types.SceneDisplay "Link to this definition")
:   Scene display settings for 3D viewport

    light\_direction[¶](#bpy.types.SceneDisplay.light_direction "Link to this definition")
    :   Direction of the light for shadows and highlights

        Type:
        :   [`mathutils.Vector`](../../mathutils/index.md#mathutils.Vector "mathutils.Vector") of 3 items in [-inf, inf], default (0.57735, 0.57735, 0.57735)

    matcap\_ssao\_attenuation[¶](#bpy.types.SceneDisplay.matcap_ssao_attenuation "Link to this definition")
    :   Attenuation constant

        Type:
        :   float in [0, 100000], default 1.0

    matcap\_ssao\_distance[¶](#bpy.types.SceneDisplay.matcap_ssao_distance "Link to this definition")
    :   Distance of object that contribute to the cavity/edge effect

        Type:
        :   float in [0, 100000], default 0.2

    matcap\_ssao\_samples[¶](#bpy.types.SceneDisplay.matcap_ssao_samples "Link to this definition")
    :   Number of samples

        Type:
        :   int in [1, 500], default 16

    render\_aa[¶](#bpy.types.SceneDisplay.render_aa "Link to this definition")
    ...
    shading[¶](#bpy.types.SceneDisplay.shading "Link to this definition")
    :   Shading settings for OpenGL render engine

        Type:
        :   [`View3DShading`](View3DShading.md#bpy.types.View3DShading "bpy.types.View3DShading"), (readonly)

    shadow\_focus[¶](#bpy.types.SceneDisplay.shadow_focus "Link to this definition")
    :   Shadow factor hardness

        Type:
        :   float in [0, 1], default 0.0

    shadow\_shift[¶](#bpy.types.SceneDisplay.shadow_shift "Link to this definition")
    :   Shadow termination angle

        Type:
        :   float in [0, 1], default 0.1

    viewport\_aa[¶](#bpy.types.SceneDisplay.viewport_aa "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.SceneDisplay.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.SceneDisplay.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Scene.display`](Scene.md#bpy.types.Scene.display "bpy.types.Scene.display") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.SceneDisplay.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.SceneDisplay.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* SceneDisplay(bpy\_struct)
  + [`SceneDisplay`](#bpy.types.SceneDisplay)
    - [`SceneDisplay.light_direction`](#bpy.types.SceneDisplay.light_direction)
    - [`SceneDisplay.matcap_ssao_attenuation`](#bpy.types.SceneDisplay.matcap_ssao_attenuation)
    - [`SceneDisplay.matcap_ssao_distance`](#bpy.types.SceneDisplay.matcap_ssao_distance)
    - [`SceneDisplay.matcap_ssao_samples`](#bpy.types.SceneDisplay.matcap_ssao_samples)
    - [`SceneDisplay.render_aa`](#bpy.types.SceneDisplay.render_aa)
    - [`SceneDisplay.shading`](#bpy.types.SceneDisplay.shading)
    - [`SceneDisplay.shadow_focus`](#bpy.types.SceneDisplay.shadow_focus)
    - [`SceneDisplay.shadow_shift`](#bpy.types.SceneDisplay.shadow_shift)
    - [`SceneDisplay.viewport_aa`](#bpy.types.SceneDisplay.viewport_aa)
    - [`SceneDisplay.bl_rna_get_subclass()`](#bpy.types.SceneDisplay.bl_rna_get_subclass)
    - [`SceneDisplay.bl_rna_get_subclass_py()`](#bpy.types.SceneDisplay.bl_rna_get_subclass_py)
