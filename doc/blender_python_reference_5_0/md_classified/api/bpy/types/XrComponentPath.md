...
# XrComponentPath(bpy\_struct)[¶](#xrcomponentpath-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.XrComponentPath(*bpy\_struct*)[¶](#bpy.types.XrComponentPath "Link to this definition")
:   path[¶](#bpy.types.XrComponentPath.path "Link to this definition")
    :   OpenXR component path

        Type:
        :   string, default “”, (never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.XrComponentPath.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.XrComponentPath.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`XrActionMapBinding.component_paths`](XrActionMapBinding.md#bpy.types.XrActionMapBinding.component_paths "bpy.types.XrActionMapBinding.component_paths") * [`XrComponentPaths.find`](XrComponentPaths.md#bpy.types.XrComponentPaths.find "bpy.types.XrComponentPaths.find") | * [`XrComponentPaths.new`](XrComponentPaths.md#bpy.types.XrComponentPaths.new "bpy.types.XrComponentPaths.new") * [`XrComponentPaths.remove`](XrComponentPaths.md#bpy.types.XrComponentPaths.remove "bpy.types.XrComponentPaths.remove") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.XrComponentPath.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.XrComponentPath.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* XrComponentPath(bpy\_struct)
  + [`XrComponentPath`](#bpy.types.XrComponentPath)
    - [`XrComponentPath.path`](#bpy.types.XrComponentPath.path)
    - [`XrComponentPath.bl_rna_get_subclass()`](#bpy.types.XrComponentPath.bl_rna_get_subclass)
    - [`XrComponentPath.bl_rna_get_subclass_py()`](#bpy.types.XrComponentPath.bl_rna_get_subclass_py)
