...
# UDIMTile(bpy\_struct)[¶](#udimtile-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.UDIMTile(*bpy\_struct*)[¶](#bpy.types.UDIMTile "Link to this definition")
:   Properties of the UDIM tile

    channels[¶](#bpy.types.UDIMTile.channels "Link to this definition")
    :   Number of channels in the tile pixels buffer

        Type:
        :   int in [0, inf], default 0, (readonly)

    generated\_color[¶](#bpy.types.UDIMTile.generated_color "Link to this definition")
    :   Fill color for the generated image

        Type:
        :   float array of 4 items in [0, inf], default (0.0, 0.0, 0.0, 0.0)

    generated\_height[¶](#bpy.types.UDIMTile.generated_height "Link to this definition")
    :   Generated image height

        Type:
        :   int in [1, 65536], default 0

    generated\_type[¶](#bpy.types.UDIMTile.generated_type "Link to this definition")
    :   Generated image type

        Type:
        :   enum in [Image Generated Type Items](../../../appendix/bpy_types_enum_items/image_generated_type_items.md#rna-enum-image-generated-type-items), default `'BLANK'`

    generated\_width[¶](#bpy.types.UDIMTile.generated_width "Link to this definition")
    :   Generated image width

        Type:
        :   int in [1, 65536], default 0

    is\_generated\_tile[¶](#bpy.types.UDIMTile.is_generated_tile "Link to this definition")
    :   Is this image tile generated

        Type:
        :   boolean, default False, (readonly)

    label[¶](#bpy.types.UDIMTile.label "Link to this definition")
    :   Tile label

        Type:
        :   string, default “”, (never None)

    number[¶](#bpy.types.UDIMTile.number "Link to this definition")
    :   Number of the position that this tile covers

        Type:
        :   int in [-inf, inf], default 0

    size[¶](#bpy.types.UDIMTile.size "Link to this definition")
    ...
    use\_generated\_float[¶](#bpy.types.UDIMTile.use_generated_float "Link to this definition")
    :   Generate floating-point buffer

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.UDIMTile.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.UDIMTile.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Image.tiles`](Image.md#bpy.types.Image.tiles "bpy.types.Image.tiles") * [`UDIMTiles.active`](UDIMTiles.md#bpy.types.UDIMTiles.active "bpy.types.UDIMTiles.active") * [`UDIMTiles.get`](UDIMTiles.md#bpy.types.UDIMTiles.get "bpy.types.UDIMTiles.get") | * [`UDIMTiles.new`](UDIMTiles.md#bpy.types.UDIMTiles.new "bpy.types.UDIMTiles.new") * [`UDIMTiles.remove`](UDIMTiles.md#bpy.types.UDIMTiles.remove "bpy.types.UDIMTiles.remove") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.UDIMTile.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.UDIMTile.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* UDIMTile(bpy\_struct)
  + [`UDIMTile`](#bpy.types.UDIMTile)
    - [`UDIMTile.channels`](#bpy.types.UDIMTile.channels)
    - [`UDIMTile.generated_color`](#bpy.types.UDIMTile.generated_color)
    - [`UDIMTile.generated_height`](#bpy.types.UDIMTile.generated_height)
    - [`UDIMTile.generated_type`](#bpy.types.UDIMTile.generated_type)
    - [`UDIMTile.generated_width`](#bpy.types.UDIMTile.generated_width)
    - [`UDIMTile.is_generated_tile`](#bpy.types.UDIMTile.is_generated_tile)
    - [`UDIMTile.label`](#bpy.types.UDIMTile.label)
    - [`UDIMTile.number`](#bpy.types.UDIMTile.number)
    - [`UDIMTile.size`](#bpy.types.UDIMTile.size)
    - [`UDIMTile.use_generated_float`](#bpy.types.UDIMTile.use_generated_float)
    - [`UDIMTile.bl_rna_get_subclass()`](#bpy.types.UDIMTile.bl_rna_get_subclass)
    - [`UDIMTile.bl_rna_get_subclass_py()`](#bpy.types.UDIMTile.bl_rna_get_subclass_py)
