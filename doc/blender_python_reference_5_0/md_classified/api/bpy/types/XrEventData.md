...
# XrEventData(bpy\_struct)[¶](#xreventdata-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.XrEventData(*bpy\_struct*)[¶](#bpy.types.XrEventData "Link to this definition")
:   XR Data for Window Manager Event

    action[¶](#bpy.types.XrEventData.action "Link to this definition")
    :   XR action name

        Type:
        :   string, default “”, (readonly, never None)

    action\_set[¶](#bpy.types.XrEventData.action_set "Link to this definition")
    :   XR action set name

        Type:
        :   string, default “”, (readonly, never None)

    bimanual[¶](#bpy.types.XrEventData.bimanual "Link to this definition")
    :   Whether bimanual interaction is occurring

        Type:
        :   boolean, default False, (readonly)

    controller\_location[¶](#bpy.types.XrEventData.controller_location "Link to this definition")
    ...
    controller\_location\_other[¶](#bpy.types.XrEventData.controller_location_other "Link to this definition")
    :   Controller aim location of the other user path for bimanual actions

        Type:
        :   [`mathutils.Vector`](../../mathutils/index.md#mathutils.Vector "mathutils.Vector") of 3 items in [-inf, inf], default (0.0, 0.0, 0.0), (readonly)

    controller\_rotation[¶](#bpy.types.XrEventData.controller_rotation "Link to this definition")
    ...
    controller\_rotation\_other[¶](#bpy.types.XrEventData.controller_rotation_other "Link to this definition")
    :   Controller aim rotation of the other user path for bimanual actions

        Type:
        :   [`mathutils.Quaternion`](../../mathutils/index.md#mathutils.Quaternion "mathutils.Quaternion") rotation of 4 items in [-inf, inf], default (0.0, 0.0, 0.0, 0.0), (readonly)

    float\_threshold[¶](#bpy.types.XrEventData.float_threshold "Link to this definition")
    :   Input threshold for float/2D vector actions

        Type:
        :   float in [-inf, inf], default 0.0, (readonly)

    state[¶](#bpy.types.XrEventData.state "Link to this definition")
    :   XR action values corresponding to type

        Type:
        :   float array of 2 items in [-inf, inf], default (0.0, 0.0), (readonly)

    state\_other[¶](#bpy.types.XrEventData.state_other "Link to this definition")
    :   State of the other user path for bimanual actions

        Type:
        :   float array of 2 items in [-inf, inf], default (0.0, 0.0), (readonly)

    type[¶](#bpy.types.XrEventData.type "Link to this definition")
    :   XR action type
    ...
    user\_path[¶](#bpy.types.XrEventData.user_path "Link to this definition")
    :   User path of the action. E.g. “/user/hand/left”

        Type:
        :   string, default “”, (readonly, never None)

    user\_path\_other[¶](#bpy.types.XrEventData.user_path_other "Link to this definition")
    :   Other user path, for bimanual actions. E.g. “/user/hand/right”

        Type:
        :   string, default “”, (readonly, never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.XrEventData.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.XrEventData.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Event.xr`](Event.md#bpy.types.Event.xr "bpy.types.Event.xr") |  |

[Next

XrNavigation(bpy\_struct)](XrNavigation.md)
[Previous
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.XrEventData.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.XrEventData.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* XrEventData(bpy\_struct)
  + [`XrEventData`](#bpy.types.XrEventData)
    - [`XrEventData.action`](#bpy.types.XrEventData.action)
    - [`XrEventData.action_set`](#bpy.types.XrEventData.action_set)
    - [`XrEventData.bimanual`](#bpy.types.XrEventData.bimanual)
    - [`XrEventData.controller_location`](#bpy.types.XrEventData.controller_location)
    - [`XrEventData.controller_location_other`](#bpy.types.XrEventData.controller_location_other)
    - [`XrEventData.controller_rotation`](#bpy.types.XrEventData.controller_rotation)
    - [`XrEventData.controller_rotation_other`](#bpy.types.XrEventData.controller_rotation_other)
    - [`XrEventData.float_threshold`](#bpy.types.XrEventData.float_threshold)
    - [`XrEventData.state`](#bpy.types.XrEventData.state)
    - [`XrEventData.state_other`](#bpy.types.XrEventData.state_other)
    - [`XrEventData.type`](#bpy.types.XrEventData.type)
    - [`XrEventData.user_path`](#bpy.types.XrEventData.user_path)
    - [`XrEventData.user_path_other`](#bpy.types.XrEventData.user_path_other)
    - [`XrEventData.bl_rna_get_subclass()`](#bpy.types.XrEventData.bl_rna_get_subclass)
    - [`XrEventData.bl_rna_get_subclass_py()`](#bpy.types.XrEventData.bl_rna_get_subclass_py)
