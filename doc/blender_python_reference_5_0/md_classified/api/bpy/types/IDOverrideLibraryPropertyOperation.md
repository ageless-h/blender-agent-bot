...
# IDOverrideLibraryPropertyOperation(bpy\_struct)[¶](#idoverridelibrarypropertyoperation-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.IDOverrideLibraryPropertyOperation(*bpy\_struct*)[¶](#bpy.types.IDOverrideLibraryPropertyOperation "Link to this definition")
:   Description of an override operation over an overridden property

    flag[¶](#bpy.types.IDOverrideLibraryPropertyOperation.flag "Link to this definition")
    :   Status flags
    ...
    operation[¶](#bpy.types.IDOverrideLibraryPropertyOperation.operation "Link to this definition")
    :   What override operation is performed
        ...
        * `INSERT_AFTER`
          Insert After – Insert a new item into collection after the one referenced in subitem\_reference\_name/\_id or \_index.
        * `INSERT_BEFORE`
          Insert Before – Insert a new item into collection before the one referenced in subitem\_reference\_name/\_id or \_index (NOT USED).

        Type:
        :   enum in [`'NOOP'`, `'REPLACE'`, `'DIFF_ADD'`, `'DIFF_SUB'`, `'FACT_MULTIPLY'`, `'INSERT_AFTER'`, `'INSERT_BEFORE'`], default `'REPLACE'`, (readonly)

    subitem\_local\_id[¶](#bpy.types.IDOverrideLibraryPropertyOperation.subitem_local_id "Link to this definition")
    ...
    subitem\_local\_index[¶](#bpy.types.IDOverrideLibraryPropertyOperation.subitem_local_index "Link to this definition")
    :   Used to handle changes into collection

        Type:
        :   int in [-1, inf], default -1, (readonly)

    subitem\_local\_name[¶](#bpy.types.IDOverrideLibraryPropertyOperation.subitem_local_name "Link to this definition")
    :   Used to handle changes into collection

        Type:
        :   string, default “”, (readonly, never None)

    subitem\_reference\_id[¶](#bpy.types.IDOverrideLibraryPropertyOperation.subitem_reference_id "Link to this definition")
    :   Collection of IDs only, used to disambiguate between potential IDs with same name from different libraries

        Type:
        :   [`ID`](ID.md#bpy.types.ID "bpy.types.ID"), (readonly)

    subitem\_reference\_index[¶](#bpy.types.IDOverrideLibraryPropertyOperation.subitem_reference_index "Link to this definition")
    :   Used to handle changes into collection

        Type:
        :   int in [-1, inf], default -1, (readonly)

    subitem\_reference\_name[¶](#bpy.types.IDOverrideLibraryPropertyOperation.subitem_reference_name "Link to this definition")
    :   Used to handle changes into collection

        Type:
        :   string, default “”, (readonly, never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.IDOverrideLibraryPropertyOperation.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.IDOverrideLibraryPropertyOperation.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`IDOverrideLibraryProperty.operations`](IDOverrideLibraryProperty.md#bpy.types.IDOverrideLibraryProperty.operations "bpy.types.IDOverrideLibraryProperty.operations") * [`IDOverrideLibraryPropertyOperations.add`](IDOverrideLibraryPropertyOperations.md#bpy.types.IDOverrideLibraryPropertyOperations.add "bpy.types.IDOverrideLibraryPropertyOperations.add") | * [`IDOverrideLibraryPropertyOperations.remove`](IDOverrideLibraryPropertyOperations.md#bpy.types.IDOverrideLibraryPropertyOperations.remove "bpy.types.IDOverrideLibraryPropertyOperations.remove") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.IDOverrideLibraryPropertyOperation.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.IDOverrideLibraryPropertyOperation.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* IDOverrideLibraryPropertyOperation(bpy\_struct)
  + [`IDOverrideLibraryPropertyOperation`](#bpy.types.IDOverrideLibraryPropertyOperation)
    - [`IDOverrideLibraryPropertyOperation.flag`](#bpy.types.IDOverrideLibraryPropertyOperation.flag)
    - [`IDOverrideLibraryPropertyOperation.operation`](#bpy.types.IDOverrideLibraryPropertyOperation.operation)
    - [`IDOverrideLibraryPropertyOperation.subitem_local_id`](#bpy.types.IDOverrideLibraryPropertyOperation.subitem_local_id)
    - [`IDOverrideLibraryPropertyOperation.subitem_local_index`](#bpy.types.IDOverrideLibraryPropertyOperation.subitem_local_index)
    - [`IDOverrideLibraryPropertyOperation.subitem_local_name`](#bpy.types.IDOverrideLibraryPropertyOperation.subitem_local_name)
    - [`IDOverrideLibraryPropertyOperation.subitem_reference_id`](#bpy.types.IDOverrideLibraryPropertyOperation.subitem_reference_id)
    - [`IDOverrideLibraryPropertyOperation.subitem_reference_index`](#bpy.types.IDOverrideLibraryPropertyOperation.subitem_reference_index)
    - [`IDOverrideLibraryPropertyOperation.subitem_reference_name`](#bpy.types.IDOverrideLibraryPropertyOperation.subitem_reference_name)
    - [`IDOverrideLibraryPropertyOperation.bl_rna_get_subclass()`](#bpy.types.IDOverrideLibraryPropertyOperation.bl_rna_get_subclass)
    - [`IDOverrideLibraryPropertyOperation.bl_rna_get_subclass_py()`](#bpy.types.IDOverrideLibraryPropertyOperation.bl_rna_get_subclass_py)
