...
# AnnotationFrames(bpy\_struct)[¶](#annotationframes-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.AnnotationFrames(*bpy\_struct*)[¶](#bpy.types.AnnotationFrames "Link to this definition")
:   Collection of annotation frames

    new(*frame\_number*, *\**, *active=False*)[¶](#bpy.types.AnnotationFrames.new "Link to this definition")
    :   Add a new annotation frame

        Parameters:
        :   * **frame\_number** (*int in* *[**-1048574**,* *1048574**]*) – Frame Number, The frame on which this sketch appears
        ...
        Return type:
        :   [`AnnotationFrame`](AnnotationFrame.md#bpy.types.AnnotationFrame "bpy.types.AnnotationFrame")

    remove(*frame*)[¶](#bpy.types.AnnotationFrames.remove "Link to this definition")
    :   Remove an annotation frame

        Parameters:
        :   **frame** ([`AnnotationFrame`](AnnotationFrame.md#bpy.types.AnnotationFrame "bpy.types.AnnotationFrame"), (never None)) – Frame, The frame to remove

    copy(*source*)[¶](#bpy.types.AnnotationFrames.copy "Link to this definition")
    :   Copy an annotation frame

        Parameters:
        :   **source** ([`AnnotationFrame`](AnnotationFrame.md#bpy.types.AnnotationFrame "bpy.types.AnnotationFrame"), (never None)) – Source, The source frame
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.AnnotationFrames.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.AnnotationFrames.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`AnnotationLayer.frames`](AnnotationLayer.md#bpy.types.AnnotationLayer.frames "bpy.types.AnnotationLayer.frames") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.AnnotationFrames.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.AnnotationFrames.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* AnnotationFrames(bpy\_struct)
  + [`AnnotationFrames`](#bpy.types.AnnotationFrames)
    - [`AnnotationFrames.new()`](#bpy.types.AnnotationFrames.new)
    - [`AnnotationFrames.remove()`](#bpy.types.AnnotationFrames.remove)
    - [`AnnotationFrames.copy()`](#bpy.types.AnnotationFrames.copy)
    - [`AnnotationFrames.bl_rna_get_subclass()`](#bpy.types.AnnotationFrames.bl_rna_get_subclass)
    - [`AnnotationFrames.bl_rna_get_subclass_py()`](#bpy.types.AnnotationFrames.bl_rna_get_subclass_py)
