...
# Driver(bpy\_struct)[¶](#driver-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.Driver(*bpy\_struct*)[¶](#bpy.types.Driver "Link to this definition")
:   Driver for the value of a setting based on an external value

    expression[¶](#bpy.types.Driver.expression "Link to this definition")
    :   Expression to use for Scripted Expression

        Type:
        :   string, default “”, (never None)

    is\_simple\_expression[¶](#bpy.types.Driver.is_simple_expression "Link to this definition")
    :   The scripted expression can be evaluated without using the full Python interpreter

        Type:
        :   boolean, default False, (readonly)

    is\_valid[¶](#bpy.types.Driver.is_valid "Link to this definition")
    :   Driver could not be evaluated in past, so should be skipped

        Type:
        :   boolean, default False

    type[¶](#bpy.types.Driver.type "Link to this definition")
    :   Driver type

        Type:
        :   enum in [`'AVERAGE'`, `'SUM'`, `'SCRIPTED'`, `'MIN'`, `'MAX'`], default `'AVERAGE'`

    use\_self[¶](#bpy.types.Driver.use_self "Link to this definition")
    :   Include a ‘self’ variable in the name-space, so drivers can easily reference the data being modified (object, bone, etc…)

        Type:
        :   boolean, default False

    variables[¶](#bpy.types.Driver.variables "Link to this definition")
    :   Properties acting as inputs for this driver

        Type:
        :   [`ChannelDriverVariables`](ChannelDriverVariables.md#bpy.types.ChannelDriverVariables "bpy.types.ChannelDriverVariables") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`DriverVariable`](DriverVariable.md#bpy.types.DriverVariable "bpy.types.DriverVariable"), (readonly)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.Driver.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.Driver.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`FCurve.driver`](FCurve.md#bpy.types.FCurve.driver "bpy.types.FCurve.driver") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.Driver.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.Driver.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* Driver(bpy\_struct)
  + [`Driver`](#bpy.types.Driver)
    - [`Driver.expression`](#bpy.types.Driver.expression)
    - [`Driver.is_simple_expression`](#bpy.types.Driver.is_simple_expression)
    - [`Driver.is_valid`](#bpy.types.Driver.is_valid)
    - [`Driver.type`](#bpy.types.Driver.type)
    - [`Driver.use_self`](#bpy.types.Driver.use_self)
    - [`Driver.variables`](#bpy.types.Driver.variables)
    - [`Driver.bl_rna_get_subclass()`](#bpy.types.Driver.bl_rna_get_subclass)
    - [`Driver.bl_rna_get_subclass_py()`](#bpy.types.Driver.bl_rna_get_subclass_py)
