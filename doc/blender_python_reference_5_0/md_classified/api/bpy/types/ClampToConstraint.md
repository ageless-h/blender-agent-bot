...
# ClampToConstraint(Constraint)[¶](#clamptoconstraint-constraint "Link to this heading")
...
*class* bpy.types.ClampToConstraint(*Constraint*)[¶](#bpy.types.ClampToConstraint "Link to this definition")
:   Constrain an object’s location to the nearest point along the target path

    main\_axis[¶](#bpy.types.ClampToConstraint.main_axis "Link to this definition")
    :   Main axis of movement

        Type:
        :   enum in [`'CLAMPTO_AUTO'`, `'CLAMPTO_X'`, `'CLAMPTO_Y'`, `'CLAMPTO_Z'`], default `'CLAMPTO_AUTO'`

    target[¶](#bpy.types.ClampToConstraint.target "Link to this definition")
    :   Target Object (Curves only)

        Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object")

    use\_cyclic[¶](#bpy.types.ClampToConstraint.use_cyclic "Link to this definition")
    :   Treat curve as cyclic curve (no clamping to curve bounding box)

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ClampToConstraint.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ClampToConstraint.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ClampToConstraint.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ClampToConstraint.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ClampToConstraint(Constraint)
  + [`ClampToConstraint`](#bpy.types.ClampToConstraint)
    - [`ClampToConstraint.main_axis`](#bpy.types.ClampToConstraint.main_axis)
    - [`ClampToConstraint.target`](#bpy.types.ClampToConstraint.target)
    - [`ClampToConstraint.use_cyclic`](#bpy.types.ClampToConstraint.use_cyclic)
    - [`ClampToConstraint.bl_rna_get_subclass()`](#bpy.types.ClampToConstraint.bl_rna_get_subclass)
    - [`ClampToConstraint.bl_rna_get_subclass_py()`](#bpy.types.ClampToConstraint.bl_rna_get_subclass_py)
