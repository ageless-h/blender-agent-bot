...
# GeometryNodeListLength(GeometryNode)[¶](#geometrynodelistlength-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeListLength(*GeometryNode*)[¶](#bpy.types.GeometryNodeListLength "Link to this definition")
:   Count how many items are in a given list

    data\_type[¶](#bpy.types.GeometryNodeListLength.data_type "Link to this definition")
    :   Type:
    ...
    *classmethod* is\_registered\_node\_type()[¶](#bpy.types.GeometryNodeListLength.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[¶](#bpy.types.GeometryNodeListLength.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[¶](#bpy.types.GeometryNodeListLength.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.GeometryNodeListLength.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.GeometryNodeListLength.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
GeometryNodeListGetItem(GeometryNode)](GeometryNodeListGetItem.md)
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeListLength.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.GeometryNodeListLength.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeListLength(GeometryNode)
  + [`GeometryNodeListLength`](#bpy.types.GeometryNodeListLength)
    - [`GeometryNodeListLength.data_type`](#bpy.types.GeometryNodeListLength.data_type)
    - [`GeometryNodeListLength.is_registered_node_type()`](#bpy.types.GeometryNodeListLength.is_registered_node_type)
    - [`GeometryNodeListLength.input_template()`](#bpy.types.GeometryNodeListLength.input_template)
    - [`GeometryNodeListLength.output_template()`](#bpy.types.GeometryNodeListLength.output_template)
    - [`GeometryNodeListLength.bl_rna_get_subclass()`](#bpy.types.GeometryNodeListLength.bl_rna_get_subclass)
    - [`GeometryNodeListLength.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeListLength.bl_rna_get_subclass_py)
