...
# FModifier(bpy\_struct)[¶](#fmodifier-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

subclasses —
[`FModifierCycles`](FModifierCycles.md#bpy.types.FModifierCycles "bpy.types.FModifierCycles"), [`FModifierEnvelope`](FModifierEnvelope.md#bpy.types.FModifierEnvelope "bpy.types.FModifierEnvelope"), [`FModifierFunctionGenerator`](FModifierFunctionGenerator.md#bpy.types.FModifierFunctionGenerator "bpy.types.FModifierFunctionGenerator"), [`FModifierGenerator`](FModifierGenerator.md#bpy.types.FModifierGenerator "bpy.types.FModifierGenerator"), [`FModifierLimits`](FModifierLimits.md#bpy.types.FModifierLimits "bpy.types.FModifierLimits"), [`FModifierNoise`](FModifierNoise.md#bpy.types.FModifierNoise "bpy.types.FModifierNoise"), [`FModifierStepped`](FModifierStepped.md#bpy.types.FModifierStepped "bpy.types.FModifierStepped")

*class* bpy.types.FModifier(*bpy\_struct*)[¶](#bpy.types.FModifier "Link to this definition")
:   Modifier for values of F-Curve

    active[¶](#bpy.types.FModifier.active "Link to this definition")
    :   F-Curve modifier will show settings in the editor

        Type:
        :   boolean, default False

    blend\_in[¶](#bpy.types.FModifier.blend_in "Link to this definition")
    :   Number of frames from start frame for influence to take effect

        Type:
        :   float in [-inf, inf], default 0.0

    blend\_out[¶](#bpy.types.FModifier.blend_out "Link to this definition")
    :   Number of frames from end frame for influence to fade out

        Type:
        :   float in [-inf, inf], default 0.0

    frame\_end[¶](#bpy.types.FModifier.frame_end "Link to this definition")
    :   Frame that modifier’s influence ends (if Restrict Frame Range is in use)

        Type:
        :   float in [-inf, inf], default 0.0

    frame\_start[¶](#bpy.types.FModifier.frame_start "Link to this definition")
    :   Frame that modifier’s influence starts (if Restrict Frame Range is in use)

        Type:
        :   float in [-inf, inf], default 0.0

    influence[¶](#bpy.types.FModifier.influence "Link to this definition")
    :   Amount of influence F-Curve Modifier will have when not fading in/out

        Type:
        :   float in [0, 1], default 1.0

    is\_valid[¶](#bpy.types.FModifier.is_valid "Link to this definition")
    :   F-Curve Modifier has invalid settings and will not be evaluated

        Type:
        :   boolean, default False, (readonly)

    mute[¶](#bpy.types.FModifier.mute "Link to this definition")
    :   Enable F-Curve modifier evaluation

        Type:
        :   boolean, default False

    name[¶](#bpy.types.FModifier.name "Link to this definition")
    :   F-Curve Modifier name

        Type:
        :   string, default “”, (never None)

    show\_expanded[¶](#bpy.types.FModifier.show_expanded "Link to this definition")
    :   F-Curve Modifier’s panel is expanded in UI

        Type:
        :   boolean, default False

    type[¶](#bpy.types.FModifier.type "Link to this definition")
    :   F-Curve Modifier Type

        Type:
        :   enum in [Fmodifier Type Items](../../../appendix/bpy_types_enum_items/fmodifier_type_items.md#rna-enum-fmodifier-type-items), default `'NULL'`, (readonly)

    use\_influence[¶](#bpy.types.FModifier.use_influence "Link to this definition")
    :   F-Curve Modifier’s effects will be tempered by a default factor

        Type:
        :   boolean, default False

    use\_restricted\_range[¶](#bpy.types.FModifier.use_restricted_range "Link to this definition")
    :   F-Curve Modifier is only applied for the specified frame range to help mask off effects in order to chain them

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.FModifier.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.FModifier.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`FCurve.modifiers`](FCurve.md#bpy.types.FCurve.modifiers "bpy.types.FCurve.modifiers") * [`FCurveModifiers.active`](FCurveModifiers.md#bpy.types.FCurveModifiers.active "bpy.types.FCurveModifiers.active") * [`FCurveModifiers.new`](FCurveModifiers.md#bpy.types.FCurveModifiers.new "bpy.types.FCurveModifiers.new") | * [`FCurveModifiers.remove`](FCurveModifiers.md#bpy.types.FCurveModifiers.remove "bpy.types.FCurveModifiers.remove") * [`NlaStrip.modifiers`](NlaStrip.md#bpy.types.NlaStrip.modifiers "bpy.types.NlaStrip.modifiers") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.FModifier.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.FModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* FModifier(bpy\_struct)
  + [`FModifier`](#bpy.types.FModifier)
    - [`FModifier.active`](#bpy.types.FModifier.active)
    - [`FModifier.blend_in`](#bpy.types.FModifier.blend_in)
    - [`FModifier.blend_out`](#bpy.types.FModifier.blend_out)
    - [`FModifier.frame_end`](#bpy.types.FModifier.frame_end)
    - [`FModifier.frame_start`](#bpy.types.FModifier.frame_start)
    - [`FModifier.influence`](#bpy.types.FModifier.influence)
    - [`FModifier.is_valid`](#bpy.types.FModifier.is_valid)
    - [`FModifier.mute`](#bpy.types.FModifier.mute)
    - [`FModifier.name`](#bpy.types.FModifier.name)
    - [`FModifier.show_expanded`](#bpy.types.FModifier.show_expanded)
    - [`FModifier.type`](#bpy.types.FModifier.type)
    - [`FModifier.use_influence`](#bpy.types.FModifier.use_influence)
    - [`FModifier.use_restricted_range`](#bpy.types.FModifier.use_restricted_range)
    - [`FModifier.bl_rna_get_subclass()`](#bpy.types.FModifier.bl_rna_get_subclass)
    - [`FModifier.bl_rna_get_subclass_py()`](#bpy.types.FModifier.bl_rna_get_subclass_py)
