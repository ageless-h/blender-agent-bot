...
# BlendDataLineStyles(bpy\_struct)[¶](#blenddatalinestyles-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.BlendDataLineStyles(*bpy\_struct*)[¶](#bpy.types.BlendDataLineStyles "Link to this definition")
:   Collection of line styles

    tag(*value*)[¶](#bpy.types.BlendDataLineStyles.tag "Link to this definition")
    :   tag

        Parameters:
        :   **value** (*boolean*) – Value

    new(*name*)[¶](#bpy.types.BlendDataLineStyles.new "Link to this definition")
    :   Add a new line style instance to the main database
        ...
        Return type:
        :   [`FreestyleLineStyle`](FreestyleLineStyle.md#bpy.types.FreestyleLineStyle "bpy.types.FreestyleLineStyle")

    remove(*linestyle*, *\**, *do\_unlink=True*, *do\_id\_user=True*, *do\_ui\_user=True*)[¶](#bpy.types.BlendDataLineStyles.remove "Link to this definition")
    :   Remove a line style instance from the current blendfile

        Parameters:
        :   * **linestyle** ([`FreestyleLineStyle`](FreestyleLineStyle.md#bpy.types.FreestyleLineStyle "bpy.types.FreestyleLineStyle"), (never None)) – Line style to remove
            * **do\_unlink** (*boolean**,* *(**optional**)*) – Unlink all usages of this line style before deleting it
            * **do\_id\_user** (*boolean**,* *(**optional**)*) – Decrement user counter of all data-blocks used by this line style
            * **do\_ui\_user** (*boolean**,* *(**optional**)*) – Make sure interface does not reference this line style

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.BlendDataLineStyles.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.BlendDataLineStyles.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`BlendData.linestyles`](BlendData.md#bpy.types.BlendData.linestyles "bpy.types.BlendData.linestyles") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.BlendDataLineStyles.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.BlendDataLineStyles.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* BlendDataLineStyles(bpy\_struct)
  + [`BlendDataLineStyles`](#bpy.types.BlendDataLineStyles)
    - [`BlendDataLineStyles.tag()`](#bpy.types.BlendDataLineStyles.tag)
    - [`BlendDataLineStyles.new()`](#bpy.types.BlendDataLineStyles.new)
    - [`BlendDataLineStyles.remove()`](#bpy.types.BlendDataLineStyles.remove)
    - [`BlendDataLineStyles.bl_rna_get_subclass()`](#bpy.types.BlendDataLineStyles.bl_rna_get_subclass)
    - [`BlendDataLineStyles.bl_rna_get_subclass_py()`](#bpy.types.BlendDataLineStyles.bl_rna_get_subclass_py)
