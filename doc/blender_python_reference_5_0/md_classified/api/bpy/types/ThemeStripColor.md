...
# ThemeStripColor(bpy\_struct)[¶](#themestripcolor-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.ThemeStripColor(*bpy\_struct*)[¶](#bpy.types.ThemeStripColor "Link to this definition")
:   Theme settings for strip colors

    color[¶](#bpy.types.ThemeStripColor.color "Link to this definition")
    :   Strip Color

        Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ThemeStripColor.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ThemeStripColor.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Theme.strip_color`](Theme.md#bpy.types.Theme.strip_color "bpy.types.Theme.strip_color") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ThemeStripColor.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ThemeStripColor.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ThemeStripColor(bpy\_struct)
  + [`ThemeStripColor`](#bpy.types.ThemeStripColor)
    - [`ThemeStripColor.color`](#bpy.types.ThemeStripColor.color)
    - [`ThemeStripColor.bl_rna_get_subclass()`](#bpy.types.ThemeStripColor.bl_rna_get_subclass)
    - [`ThemeStripColor.bl_rna_get_subclass_py()`](#bpy.types.ThemeStripColor.bl_rna_get_subclass_py)
