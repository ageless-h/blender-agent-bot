...
# IDOverrideLibrary(bpy\_struct)[¶](#idoverridelibrary-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.IDOverrideLibrary(*bpy\_struct*)[¶](#bpy.types.IDOverrideLibrary "Link to this definition")
:   Struct gathering all data needed by overridden linked IDs

    hierarchy\_root[¶](#bpy.types.IDOverrideLibrary.hierarchy_root "Link to this definition")
    ...
    is\_in\_hierarchy[¶](#bpy.types.IDOverrideLibrary.is_in_hierarchy "Link to this definition")
    ...
    is\_system\_override[¶](#bpy.types.IDOverrideLibrary.is_system_override "Link to this definition")
    :   Whether this library override exists only for the override hierarchy, or if it is actually editable by the user

        Type:
        :   boolean, default False

    properties[¶](#bpy.types.IDOverrideLibrary.properties "Link to this definition")
    :   List of overridden properties

        Type:
        :   [`IDOverrideLibraryProperties`](IDOverrideLibraryProperties.md#bpy.types.IDOverrideLibraryProperties "bpy.types.IDOverrideLibraryProperties") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`IDOverrideLibraryProperty`](IDOverrideLibraryProperty.md#bpy.types.IDOverrideLibraryProperty "bpy.types.IDOverrideLibraryProperty"), (readonly)

    reference[¶](#bpy.types.IDOverrideLibrary.reference "Link to this definition")
    :   Linked ID used as reference by this override

        Type:
        :   [`ID`](ID.md#bpy.types.ID "bpy.types.ID"), (readonly)

    operations\_update()[¶](#bpy.types.IDOverrideLibrary.operations_update "Link to this definition")
    :   Update the library override operations based on the differences between this override ID and its reference

    reset(*\**, *do\_hierarchy=True*, *set\_system\_override=False*)[¶](#bpy.types.IDOverrideLibrary.reset "Link to this definition")
    :   Reset this override to match again its linked reference ID

        Parameters:
        :   * **do\_hierarchy** (*boolean**,* *(**optional**)*) – Also reset all the dependencies of this override to match their reference linked IDs
            * **set\_system\_override** (*boolean**,* *(**optional**)*) – Reset all user-editable overrides as (non-editable) system overrides

    destroy(*\**, *do\_hierarchy=True*)[¶](#bpy.types.IDOverrideLibrary.destroy "Link to this definition")
    :   Delete this override ID and remap its usages to its linked reference ID instead

        Parameters:
        :   **do\_hierarchy** (*boolean**,* *(**optional**)*) – Also delete all the dependencies of this override and remap their usages to their reference linked IDs

    resync(*scene*, *\**, *view\_layer=None*, *residual\_storage=None*, *do\_hierarchy\_enforce=False*, *do\_whole\_hierarchy=False*)[¶](#bpy.types.IDOverrideLibrary.resync "Link to this definition")
    :   Resync the data-block and its sub-hierarchy, or the whole hierarchy if requested

        Parameters:
        :   * **scene** ([`Scene`](Scene.md#bpy.types.Scene "bpy.types.Scene"), (never None)) – The scene to operate in (for contextual things like keeping active object active, ensuring all overridden objects remain instantiated, etc.)
            * **view\_layer** ([`ViewLayer`](ViewLayer.md#bpy.types.ViewLayer "bpy.types.ViewLayer"), (optional)) – The view layer to operate in (same usage as the `scene` data, in case it is not provided the scene’s collection will be used instead)
            * **residual\_storage** ([`Collection`](Collection.md#bpy.types.Collection "bpy.types.Collection"), (optional)) – Collection where to store objects that are instantiated in any other collection anymore (garbage collection, will be created if needed and none is provided)
            * **do\_hierarchy\_enforce** (*boolean**,* *(**optional**)*) – Enforce restoring the dependency hierarchy between data-blocks to match the one from the reference linked hierarchy (WARNING: if some ID pointers have been purposely overridden, these will be reset to their default value)
            * **do\_whole\_hierarchy** (*boolean**,* *(**optional**)*) – Resync the whole hierarchy this data-block belongs to, not only its own sub-hierarchy
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.IDOverrideLibrary.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.IDOverrideLibrary.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`ID.override_library`](ID.md#bpy.types.ID.override_library "bpy.types.ID.override_library") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.IDOverrideLibrary.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.IDOverrideLibrary.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* IDOverrideLibrary(bpy\_struct)
  + [`IDOverrideLibrary`](#bpy.types.IDOverrideLibrary)
    - [`IDOverrideLibrary.hierarchy_root`](#bpy.types.IDOverrideLibrary.hierarchy_root)
    - [`IDOverrideLibrary.is_in_hierarchy`](#bpy.types.IDOverrideLibrary.is_in_hierarchy)
    - [`IDOverrideLibrary.is_system_override`](#bpy.types.IDOverrideLibrary.is_system_override)
    - [`IDOverrideLibrary.properties`](#bpy.types.IDOverrideLibrary.properties)
    - [`IDOverrideLibrary.reference`](#bpy.types.IDOverrideLibrary.reference)
    - [`IDOverrideLibrary.operations_update()`](#bpy.types.IDOverrideLibrary.operations_update)
    - [`IDOverrideLibrary.reset()`](#bpy.types.IDOverrideLibrary.reset)
    - [`IDOverrideLibrary.destroy()`](#bpy.types.IDOverrideLibrary.destroy)
    - [`IDOverrideLibrary.resync()`](#bpy.types.IDOverrideLibrary.resync)
    - [`IDOverrideLibrary.bl_rna_get_subclass()`](#bpy.types.IDOverrideLibrary.bl_rna_get_subclass)
    - [`IDOverrideLibrary.bl_rna_get_subclass_py()`](#bpy.types.IDOverrideLibrary.bl_rna_get_subclass_py)
