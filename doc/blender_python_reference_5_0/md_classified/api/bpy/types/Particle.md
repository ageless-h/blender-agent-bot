...
# Particle(bpy\_struct)[¶](#particle-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.Particle(*bpy\_struct*)[¶](#bpy.types.Particle "Link to this definition")
:   Particle in a particle system

    alive\_state[¶](#bpy.types.Particle.alive_state "Link to this definition")
    :   Type:
        :   enum in [`'DEAD'`, `'UNBORN'`, `'ALIVE'`, `'DYING'`], default `'DEAD'`

    angular\_velocity[¶](#bpy.types.Particle.angular_velocity "Link to this definition")
    :   Type:
        :   [`mathutils.Vector`](../../mathutils/index.md#mathutils.Vector "mathutils.Vector") of 3 items in [-inf, inf], default (0.0, 0.0, 0.0)

    birth\_time[¶](#bpy.types.Particle.birth_time "Link to this definition")
    :   Type:
        :   float in [-inf, inf], default 0.0

    die\_time[¶](#bpy.types.Particle.die_time "Link to this definition")
    :   Type:
        :   float in [-inf, inf], default 0.0

    hair\_keys[¶](#bpy.types.Particle.hair_keys "Link to this definition")
    :   Type:
        :   [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`ParticleHairKey`](ParticleHairKey.md#bpy.types.ParticleHairKey "bpy.types.ParticleHairKey"), (readonly)

    is\_exist[¶](#bpy.types.Particle.is_exist "Link to this definition")
    :   Type:
        :   boolean, default False, (readonly)

    is\_visible[¶](#bpy.types.Particle.is_visible "Link to this definition")
    :   Type:
        :   boolean, default False, (readonly)

    lifetime[¶](#bpy.types.Particle.lifetime "Link to this definition")
    :   Type:
        :   float in [-inf, inf], default 0.0

    location[¶](#bpy.types.Particle.location "Link to this definition")
    :   Type:
        :   [`mathutils.Vector`](../../mathutils/index.md#mathutils.Vector "mathutils.Vector") of 3 items in [-inf, inf], default (0.0, 0.0, 0.0)

    particle\_keys[¶](#bpy.types.Particle.particle_keys "Link to this definition")
    :   Type:
        :   [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`ParticleKey`](ParticleKey.md#bpy.types.ParticleKey "bpy.types.ParticleKey"), (readonly)

    prev\_angular\_velocity[¶](#bpy.types.Particle.prev_angular_velocity "Link to this definition")
    :   Type:
        :   [`mathutils.Vector`](../../mathutils/index.md#mathutils.Vector "mathutils.Vector") of 3 items in [-inf, inf], default (0.0, 0.0, 0.0)

    prev\_location[¶](#bpy.types.Particle.prev_location "Link to this definition")
    :   Type:
        :   [`mathutils.Vector`](../../mathutils/index.md#mathutils.Vector "mathutils.Vector") of 3 items in [-inf, inf], default (0.0, 0.0, 0.0)

    prev\_rotation[¶](#bpy.types.Particle.prev_rotation "Link to this definition")
    :   Type:
    ...
    prev\_velocity[¶](#bpy.types.Particle.prev_velocity "Link to this definition")
    :   Type:
        :   [`mathutils.Vector`](../../mathutils/index.md#mathutils.Vector "mathutils.Vector") of 3 items in [-inf, inf], default (0.0, 0.0, 0.0)

    rotation[¶](#bpy.types.Particle.rotation "Link to this definition")
    :   Type:
        :   [`mathutils.Quaternion`](../../mathutils/index.md#mathutils.Quaternion "mathutils.Quaternion") rotation of 4 items in [-inf, inf], default (0.0, 0.0, 0.0, 0.0)

    size[¶](#bpy.types.Particle.size "Link to this definition")
    :   Type:
        :   float in [-inf, inf], default 0.0

    velocity[¶](#bpy.types.Particle.velocity "Link to this definition")
    :   Type:
        :   [`mathutils.Vector`](../../mathutils/index.md#mathutils.Vector "mathutils.Vector") of 3 items in [-inf, inf], default (0.0, 0.0, 0.0)

    uv\_on\_emitter(*modifier*)[¶](#bpy.types.Particle.uv_on_emitter "Link to this definition")
    :   Obtain UV coordinates for a particle on an evaluated mesh.

        Parameters:
        :   **modifier** ([`ParticleSystemModifier`](ParticleSystemModifier.md#bpy.types.ParticleSystemModifier "bpy.types.ParticleSystemModifier"), (never None)) – Particle modifier from an evaluated object
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.Particle.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.Particle.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`ParticleHairKey.co_object`](ParticleHairKey.md#bpy.types.ParticleHairKey.co_object "bpy.types.ParticleHairKey.co_object") * [`ParticleHairKey.co_object_set`](ParticleHairKey.md#bpy.types.ParticleHairKey.co_object_set "bpy.types.ParticleHairKey.co_object_set") * [`ParticleSystem.mcol_on_emitter`](ParticleSystem.md#bpy.types.ParticleSystem.mcol_on_emitter "bpy.types.ParticleSystem.mcol_on_emitter") | * [`ParticleSystem.particles`](ParticleSystem.md#bpy.types.ParticleSystem.particles "bpy.types.ParticleSystem.particles") * [`ParticleSystem.uv_on_emitter`](ParticleSystem.md#bpy.types.ParticleSystem.uv_on_emitter "bpy.types.ParticleSystem.uv_on_emitter") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.Particle.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.Particle.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* Particle(bpy\_struct)
  + [`Particle`](#bpy.types.Particle)
    - [`Particle.alive_state`](#bpy.types.Particle.alive_state)
    - [`Particle.angular_velocity`](#bpy.types.Particle.angular_velocity)
    - [`Particle.birth_time`](#bpy.types.Particle.birth_time)
    - [`Particle.die_time`](#bpy.types.Particle.die_time)
    - [`Particle.hair_keys`](#bpy.types.Particle.hair_keys)
    - [`Particle.is_exist`](#bpy.types.Particle.is_exist)
    - [`Particle.is_visible`](#bpy.types.Particle.is_visible)
    - [`Particle.lifetime`](#bpy.types.Particle.lifetime)
    - [`Particle.location`](#bpy.types.Particle.location)
    - [`Particle.particle_keys`](#bpy.types.Particle.particle_keys)
    - [`Particle.prev_angular_velocity`](#bpy.types.Particle.prev_angular_velocity)
    - [`Particle.prev_location`](#bpy.types.Particle.prev_location)
    - [`Particle.prev_rotation`](#bpy.types.Particle.prev_rotation)
    - [`Particle.prev_velocity`](#bpy.types.Particle.prev_velocity)
    - [`Particle.rotation`](#bpy.types.Particle.rotation)
    - [`Particle.size`](#bpy.types.Particle.size)
    - [`Particle.velocity`](#bpy.types.Particle.velocity)
    - [`Particle.uv_on_emitter()`](#bpy.types.Particle.uv_on_emitter)
    - [`Particle.bl_rna_get_subclass()`](#bpy.types.Particle.bl_rna_get_subclass)
    - [`Particle.bl_rna_get_subclass_py()`](#bpy.types.Particle.bl_rna_get_subclass_py)
