...
# MagicTexture(Texture)[¶](#magictexture-texture "Link to this heading")
...
*class* bpy.types.MagicTexture(*Texture*)[¶](#bpy.types.MagicTexture "Link to this definition")
:   Procedural noise texture

    noise\_depth[¶](#bpy.types.MagicTexture.noise_depth "Link to this definition")
    :   Depth of the noise

        Type:
        :   int in [0, 30], default 2

    turbulence[¶](#bpy.types.MagicTexture.turbulence "Link to this definition")
    :   Turbulence of the noise

        Type:
        :   float in [0.0001, inf], default 5.0

    users\_material[¶](#bpy.types.MagicTexture.users_material "Link to this definition")
    ...
    users\_object\_modifier[¶](#bpy.types.MagicTexture.users_object_modifier "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.MagicTexture.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.MagicTexture.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.MagicTexture.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.MagicTexture.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* MagicTexture(Texture)
  + [`MagicTexture`](#bpy.types.MagicTexture)
    - [`MagicTexture.noise_depth`](#bpy.types.MagicTexture.noise_depth)
    - [`MagicTexture.turbulence`](#bpy.types.MagicTexture.turbulence)
    - [`MagicTexture.users_material`](#bpy.types.MagicTexture.users_material)
    - [`MagicTexture.users_object_modifier`](#bpy.types.MagicTexture.users_object_modifier)
    - [`MagicTexture.bl_rna_get_subclass()`](#bpy.types.MagicTexture.bl_rna_get_subclass)
    - [`MagicTexture.bl_rna_get_subclass_py()`](#bpy.types.MagicTexture.bl_rna_get_subclass_py)
