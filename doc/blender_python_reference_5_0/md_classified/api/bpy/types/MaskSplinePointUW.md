...
# MaskSplinePointUW(bpy\_struct)[¶](#masksplinepointuw-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.MaskSplinePointUW(*bpy\_struct*)[¶](#bpy.types.MaskSplinePointUW "Link to this definition")
:   Single point in spline segment defining feather

    select[¶](#bpy.types.MaskSplinePointUW.select "Link to this definition")
    :   Selection status

        Type:
        :   boolean, default False

    u[¶](#bpy.types.MaskSplinePointUW.u "Link to this definition")
    :   U coordinate of point along spline segment

        Type:
        :   float in [0, 1], default 0.0

    weight[¶](#bpy.types.MaskSplinePointUW.weight "Link to this definition")
    :   Weight of feather point

        Type:
        :   float in [0, 1], default 0.0

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.MaskSplinePointUW.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.MaskSplinePointUW.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`MaskSplinePoint.feather_points`](MaskSplinePoint.md#bpy.types.MaskSplinePoint.feather_points "bpy.types.MaskSplinePoint.feather_points") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.MaskSplinePointUW.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.MaskSplinePointUW.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* MaskSplinePointUW(bpy\_struct)
  + [`MaskSplinePointUW`](#bpy.types.MaskSplinePointUW)
    - [`MaskSplinePointUW.select`](#bpy.types.MaskSplinePointUW.select)
    - [`MaskSplinePointUW.u`](#bpy.types.MaskSplinePointUW.u)
    - [`MaskSplinePointUW.weight`](#bpy.types.MaskSplinePointUW.weight)
    - [`MaskSplinePointUW.bl_rna_get_subclass()`](#bpy.types.MaskSplinePointUW.bl_rna_get_subclass)
    - [`MaskSplinePointUW.bl_rna_get_subclass_py()`](#bpy.types.MaskSplinePointUW.bl_rna_get_subclass_py)
