...
|  |  |
| --- | --- |
| * [`ActionChannelbag.groups`](ActionChannelbag.md#bpy.types.ActionChannelbag.groups "bpy.types.ActionChannelbag.groups") * [`ActionChannelbagGroups.new`](ActionChannelbagGroups.md#bpy.types.ActionChannelbagGroups.new "bpy.types.ActionChannelbagGroups.new") | * [`ActionChannelbagGroups.remove`](ActionChannelbagGroups.md#bpy.types.ActionChannelbagGroups.remove "bpy.types.ActionChannelbagGroups.remove") * [`FCurve.group`](FCurve.md#bpy.types.FCurve.group "bpy.types.FCurve.group") |

[Next

ActionKeyframeStrip(ActionStrip)](ActionKeyframeStrip.md)
[Previous
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ActionGroup.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ActionGroup.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)
