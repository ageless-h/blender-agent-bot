...
# LineStyleThicknessModifier\_Material(LineStyleThicknessModifier)[¶](#linestylethicknessmodifier-material-linestylethicknessmodifier "Link to this heading")
...
*class* bpy.types.LineStyleThicknessModifier\_Material(*LineStyleThicknessModifier*)[¶](#bpy.types.LineStyleThicknessModifier_Material "Link to this definition")
:   Change line thickness based on a material attribute

    blend[¶](#bpy.types.LineStyleThicknessModifier_Material.blend "Link to this definition")
    :   Specify how the modifier value is blended into the base value

        Type:
        :   enum in [`'MIX'`, `'ADD'`, `'SUBTRACT'`, `'MULTIPLY'`, `'DIVIDE'`, `'DIFFERENCE'`, `'MINIMUM'`, `'MAXIMUM'`], default `'MIX'`

    curve[¶](#bpy.types.LineStyleThicknessModifier_Material.curve "Link to this definition")
    :   Curve used for the curve mapping

        Type:
        :   [`CurveMapping`](CurveMapping.md#bpy.types.CurveMapping "bpy.types.CurveMapping"), (readonly)

    expanded[¶](#bpy.types.LineStyleThicknessModifier_Material.expanded "Link to this definition")
    :   True if the modifier tab is expanded

        Type:
        :   boolean, default False

    influence[¶](#bpy.types.LineStyleThicknessModifier_Material.influence "Link to this definition")
    :   Influence factor by which the modifier changes the property

        Type:
        :   float in [0, 1], default 0.0

    invert[¶](#bpy.types.LineStyleThicknessModifier_Material.invert "Link to this definition")
    :   Invert the fade-out direction of the linear mapping

        Type:
        :   boolean, default False

    mapping[¶](#bpy.types.LineStyleThicknessModifier_Material.mapping "Link to this definition")
    ...
    material\_attribute[¶](#bpy.types.LineStyleThicknessModifier_Material.material_attribute "Link to this definition")
    ...
    type[¶](#bpy.types.LineStyleThicknessModifier_Material.type "Link to this definition")
    ...
    use[¶](#bpy.types.LineStyleThicknessModifier_Material.use "Link to this definition")
    :   Enable or disable this modifier during stroke rendering

        Type:
        :   boolean, default False

    value\_max[¶](#bpy.types.LineStyleThicknessModifier_Material.value_max "Link to this definition")
    :   Maximum output value of the mapping

        Type:
        :   float in [-inf, inf], default 0.0

    value\_min[¶](#bpy.types.LineStyleThicknessModifier_Material.value_min "Link to this definition")
    :   Minimum output value of the mapping

        Type:
        :   float in [-inf, inf], default 0.0

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.LineStyleThicknessModifier_Material.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.LineStyleThicknessModifier_Material.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
        ...
        Return type:
        :   [type](#bpy.types.LineStyleThicknessModifier_Material.type "bpy.types.LineStyleThicknessModifier_Material.type")
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.LineStyleThicknessModifier_Material.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.LineStyleThicknessModifier_Material.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* LineStyleThicknessModifier\_Material(LineStyleThicknessModifier)
  + [`LineStyleThicknessModifier_Material`](#bpy.types.LineStyleThicknessModifier_Material)
    - [`LineStyleThicknessModifier_Material.blend`](#bpy.types.LineStyleThicknessModifier_Material.blend)
    - [`LineStyleThicknessModifier_Material.curve`](#bpy.types.LineStyleThicknessModifier_Material.curve)
    - [`LineStyleThicknessModifier_Material.expanded`](#bpy.types.LineStyleThicknessModifier_Material.expanded)
    - [`LineStyleThicknessModifier_Material.influence`](#bpy.types.LineStyleThicknessModifier_Material.influence)
    - [`LineStyleThicknessModifier_Material.invert`](#bpy.types.LineStyleThicknessModifier_Material.invert)
    - [`LineStyleThicknessModifier_Material.mapping`](#bpy.types.LineStyleThicknessModifier_Material.mapping)
    - [`LineStyleThicknessModifier_Material.material_attribute`](#bpy.types.LineStyleThicknessModifier_Material.material_attribute)
    - [`LineStyleThicknessModifier_Material.type`](#bpy.types.LineStyleThicknessModifier_Material.type)
    - [`LineStyleThicknessModifier_Material.use`](#bpy.types.LineStyleThicknessModifier_Material.use)
    - [`LineStyleThicknessModifier_Material.value_max`](#bpy.types.LineStyleThicknessModifier_Material.value_max)
    - [`LineStyleThicknessModifier_Material.value_min`](#bpy.types.LineStyleThicknessModifier_Material.value_min)
    - [`LineStyleThicknessModifier_Material.bl_rna_get_subclass()`](#bpy.types.LineStyleThicknessModifier_Material.bl_rna_get_subclass)
    - [`LineStyleThicknessModifier_Material.bl_rna_get_subclass_py()`](#bpy.types.LineStyleThicknessModifier_Material.bl_rna_get_subclass_py)
