...
# BlendImportContextLibrary(bpy\_struct)[¶](#blendimportcontextlibrary-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.BlendImportContextLibrary(*bpy\_struct*)[¶](#bpy.types.BlendImportContextLibrary "Link to this definition")
:   Library (blendfile) reference in a BlendImportContext data. Currently only exposed as read-only data for the pre/post blendimport handlers
    ...
    filepath[¶](#bpy.types.BlendImportContextLibrary.filepath "Link to this definition")
    :   Type:
        :   string, default “”, (readonly, never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.BlendImportContextLibrary.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.BlendImportContextLibrary.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`BlendImportContextItem.source_libraries`](BlendImportContextItem.md#bpy.types.BlendImportContextItem.source_libraries "bpy.types.BlendImportContextItem.source_libraries") |  |
...
BlendImportContextLibraries(bpy\_struct)](BlendImportContextLibraries.md)
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.BlendImportContextLibrary.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.BlendImportContextLibrary.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* BlendImportContextLibrary(bpy\_struct)
  + [`BlendImportContextLibrary`](#bpy.types.BlendImportContextLibrary)
    - [`BlendImportContextLibrary.filepath`](#bpy.types.BlendImportContextLibrary.filepath)
    - [`BlendImportContextLibrary.bl_rna_get_subclass()`](#bpy.types.BlendImportContextLibrary.bl_rna_get_subclass)
    - [`BlendImportContextLibrary.bl_rna_get_subclass_py()`](#bpy.types.BlendImportContextLibrary.bl_rna_get_subclass_py)
