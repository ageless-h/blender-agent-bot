...
# FModifierStepped(FModifier)[¶](#fmodifierstepped-fmodifier "Link to this heading")
...
*class* bpy.types.FModifierStepped(*FModifier*)[¶](#bpy.types.FModifierStepped "Link to this definition")
:   Hold each interpolated value from the F-Curve for several frames without changing the timing

    frame\_end[¶](#bpy.types.FModifierStepped.frame_end "Link to this definition")
    :   Frame that modifier’s influence ends (if applicable)

        Type:
        :   float in [-inf, inf], default 0.0

    frame\_offset[¶](#bpy.types.FModifierStepped.frame_offset "Link to this definition")
    :   Reference number of frames before frames get held (use to get hold for ‘1-3’ vs ‘5-7’ holding patterns)

        Type:
        :   float in [-inf, inf], default 0.0

    frame\_start[¶](#bpy.types.FModifierStepped.frame_start "Link to this definition")
    :   Frame that modifier’s influence starts (if applicable)

        Type:
        :   float in [-inf, inf], default 0.0

    frame\_step[¶](#bpy.types.FModifierStepped.frame_step "Link to this definition")
    :   Number of frames to hold each value

        Type:
        :   float in [-inf, inf], default 2.0

    use\_frame\_end[¶](#bpy.types.FModifierStepped.use_frame_end "Link to this definition")
    :   Restrict modifier to only act before its ‘end’ frame

        Type:
        :   boolean, default False

    use\_frame\_start[¶](#bpy.types.FModifierStepped.use_frame_start "Link to this definition")
    :   Restrict modifier to only act after its ‘start’ frame

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.FModifierStepped.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.FModifierStepped.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.FModifierStepped.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.FModifierStepped.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* FModifierStepped(FModifier)
  + [`FModifierStepped`](#bpy.types.FModifierStepped)
    - [`FModifierStepped.frame_end`](#bpy.types.FModifierStepped.frame_end)
    - [`FModifierStepped.frame_offset`](#bpy.types.FModifierStepped.frame_offset)
    - [`FModifierStepped.frame_start`](#bpy.types.FModifierStepped.frame_start)
    - [`FModifierStepped.frame_step`](#bpy.types.FModifierStepped.frame_step)
    - [`FModifierStepped.use_frame_end`](#bpy.types.FModifierStepped.use_frame_end)
    - [`FModifierStepped.use_frame_start`](#bpy.types.FModifierStepped.use_frame_start)
    - [`FModifierStepped.bl_rna_get_subclass()`](#bpy.types.FModifierStepped.bl_rna_get_subclass)
    - [`FModifierStepped.bl_rna_get_subclass_py()`](#bpy.types.FModifierStepped.bl_rna_get_subclass_py)
