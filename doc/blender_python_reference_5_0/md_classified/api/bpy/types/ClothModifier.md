...
# ClothModifier(Modifier)[¶](#clothmodifier-modifier "Link to this heading")
...
*class* bpy.types.ClothModifier(*Modifier*)[¶](#bpy.types.ClothModifier "Link to this definition")
:   Cloth simulation modifier

    collision\_settings[¶](#bpy.types.ClothModifier.collision_settings "Link to this definition")
    :   Type:
        :   [`ClothCollisionSettings`](ClothCollisionSettings.md#bpy.types.ClothCollisionSettings "bpy.types.ClothCollisionSettings"), (readonly, never None)

    hair\_grid\_max[¶](#bpy.types.ClothModifier.hair_grid_max "Link to this definition")
    :   Type:
        :   float array of 3 items in [-inf, inf], default (0.0, 0.0, 0.0), (readonly)

    hair\_grid\_min[¶](#bpy.types.ClothModifier.hair_grid_min "Link to this definition")
    :   Type:
        :   float array of 3 items in [-inf, inf], default (0.0, 0.0, 0.0), (readonly)

    hair\_grid\_resolution[¶](#bpy.types.ClothModifier.hair_grid_resolution "Link to this definition")
    :   Type:
        :   int array of 3 items in [-inf, inf], default (0, 0, 0), (readonly)

    point\_cache[¶](#bpy.types.ClothModifier.point_cache "Link to this definition")
    :   Type:
        :   [`PointCache`](PointCache.md#bpy.types.PointCache "bpy.types.PointCache"), (readonly, never None)

    settings[¶](#bpy.types.ClothModifier.settings "Link to this definition")
    :   Type:
        :   [`ClothSettings`](ClothSettings.md#bpy.types.ClothSettings "bpy.types.ClothSettings"), (readonly, never None)

    solver\_result[¶](#bpy.types.ClothModifier.solver_result "Link to this definition")
    :   Type:
        :   [`ClothSolverResult`](ClothSolverResult.md#bpy.types.ClothSolverResult "bpy.types.ClothSolverResult"), (readonly)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ClothModifier.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ClothModifier.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`bpy.context.cloth`](../context/index.md#bpy.context.cloth "bpy.context.cloth") | * [`ParticleSystem.cloth`](ParticleSystem.md#bpy.types.ParticleSystem.cloth "bpy.types.ParticleSystem.cloth") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ClothModifier.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ClothModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ClothModifier(Modifier)
  + [`ClothModifier`](#bpy.types.ClothModifier)
    - [`ClothModifier.collision_settings`](#bpy.types.ClothModifier.collision_settings)
    - [`ClothModifier.hair_grid_max`](#bpy.types.ClothModifier.hair_grid_max)
    - [`ClothModifier.hair_grid_min`](#bpy.types.ClothModifier.hair_grid_min)
    - [`ClothModifier.hair_grid_resolution`](#bpy.types.ClothModifier.hair_grid_resolution)
    - [`ClothModifier.point_cache`](#bpy.types.ClothModifier.point_cache)
    - [`ClothModifier.settings`](#bpy.types.ClothModifier.settings)
    - [`ClothModifier.solver_result`](#bpy.types.ClothModifier.solver_result)
    - [`ClothModifier.bl_rna_get_subclass()`](#bpy.types.ClothModifier.bl_rna_get_subclass)
    - [`ClothModifier.bl_rna_get_subclass_py()`](#bpy.types.ClothModifier.bl_rna_get_subclass_py)
