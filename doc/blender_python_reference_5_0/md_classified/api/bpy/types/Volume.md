...
# Volume(ID)[¶](#volume-id "Link to this heading")

base classes — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct"), [`ID`](ID.md#bpy.types.ID "bpy.types.ID")

*class* bpy.types.Volume(*ID*)[¶](#bpy.types.Volume "Link to this definition")
:   Volume data-block for 3D volume grids

    animation\_data[¶](#bpy.types.Volume.animation_data "Link to this definition")
    :   Animation data for this data-block

        Type:
        :   [`AnimData`](AnimData.md#bpy.types.AnimData "bpy.types.AnimData"), (readonly)

    display[¶](#bpy.types.Volume.display "Link to this definition")
    :   Volume display settings for 3D viewport

        Type:
        :   [`VolumeDisplay`](VolumeDisplay.md#bpy.types.VolumeDisplay "bpy.types.VolumeDisplay"), (readonly)

    filepath[¶](#bpy.types.Volume.filepath "Link to this definition")
    :   Volume file used by this Volume data-block

        Type:
        :   string, default “”, (never None, blend relative `//` prefix supported)

    frame\_duration[¶](#bpy.types.Volume.frame_duration "Link to this definition")
    :   Number of frames of the sequence to use

        Type:
        :   int in [0, 1048574], default 0

    frame\_offset[¶](#bpy.types.Volume.frame_offset "Link to this definition")
    :   Offset the number of the frame to use in the animation

        Type:
        :   int in [-inf, inf], default 0

    frame\_start[¶](#bpy.types.Volume.frame_start "Link to this definition")
    :   Global starting frame of the sequence, assuming first has a #1

        Type:
        :   int in [-1048574, 1048574], default 1

    grids[¶](#bpy.types.Volume.grids "Link to this definition")
    :   3D volume grids

        Type:
        :   [`VolumeGrids`](VolumeGrids.md#bpy.types.VolumeGrids "bpy.types.VolumeGrids") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`VolumeGrid`](VolumeGrid.md#bpy.types.VolumeGrid "bpy.types.VolumeGrid"), (readonly)

    is\_sequence[¶](#bpy.types.Volume.is_sequence "Link to this definition")
    :   Whether the cache is separated in a series of files

        Type:
        :   boolean, default False

    materials[¶](#bpy.types.Volume.materials "Link to this definition")
    :   Type:
    ...
    packed\_file[¶](#bpy.types.Volume.packed_file "Link to this definition")
    :   Type:
        :   [`PackedFile`](PackedFile.md#bpy.types.PackedFile "bpy.types.PackedFile"), (readonly)

    render[¶](#bpy.types.Volume.render "Link to this definition")
    :   Volume render settings for 3D viewport

        Type:
        :   [`VolumeRender`](VolumeRender.md#bpy.types.VolumeRender "bpy.types.VolumeRender"), (readonly)

    sequence\_mode[¶](#bpy.types.Volume.sequence_mode "Link to this definition")
    ...
    velocity\_grid[¶](#bpy.types.Volume.velocity_grid "Link to this definition")
    :   Name of the velocity field, or the base name if the velocity is split into multiple grids

        Type:
        :   string, default “”, (never None)

    velocity\_scale[¶](#bpy.types.Volume.velocity_scale "Link to this definition")
    :   Factor to control the amount of motion blur

        Type:
        :   float in [0, inf], default 1.0

    velocity\_unit[¶](#bpy.types.Volume.velocity_unit "Link to this definition")
    :   Define how the velocity vectors are interpreted with regard to time, ‘frame’ means the delta time is 1 frame, ‘second’ means the delta time is 1 / FPS
        ...
        Type:
        :   enum in [Velocity Unit Items](../../../appendix/bpy_types_enum_items/velocity_unit_items.md#rna-enum-velocity-unit-items), default `'FRAME'`

    velocity\_x\_grid[¶](#bpy.types.Volume.velocity_x_grid "Link to this definition")
    :   Name of the grid for the X axis component of the velocity field if it was split into multiple grids

        Type:
        :   string, default “”, (readonly, never None)

    velocity\_y\_grid[¶](#bpy.types.Volume.velocity_y_grid "Link to this definition")
    :   Name of the grid for the Y axis component of the velocity field if it was split into multiple grids

        Type:
        :   string, default “”, (readonly, never None)

    velocity\_z\_grid[¶](#bpy.types.Volume.velocity_z_grid "Link to this definition")
    :   Name of the grid for the Z axis component of the velocity field if it was split into multiple grids

        Type:
        :   string, default “”, (readonly, never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.Volume.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.Volume.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`bpy.context.volume`](../context/index.md#bpy.context.volume "bpy.context.volume") * [`BlendData.volumes`](BlendData.md#bpy.types.BlendData.volumes "bpy.types.BlendData.volumes") | * [`BlendDataVolumes.new`](BlendDataVolumes.md#bpy.types.BlendDataVolumes.new "bpy.types.BlendDataVolumes.new") * [`BlendDataVolumes.remove`](BlendDataVolumes.md#bpy.types.BlendDataVolumes.remove "bpy.types.BlendDataVolumes.remove") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.Volume.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.Volume.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* Volume(ID)
  + [`Volume`](#bpy.types.Volume)
    - [`Volume.animation_data`](#bpy.types.Volume.animation_data)
    - [`Volume.display`](#bpy.types.Volume.display)
    - [`Volume.filepath`](#bpy.types.Volume.filepath)
    - [`Volume.frame_duration`](#bpy.types.Volume.frame_duration)
    - [`Volume.frame_offset`](#bpy.types.Volume.frame_offset)
    - [`Volume.frame_start`](#bpy.types.Volume.frame_start)
    - [`Volume.grids`](#bpy.types.Volume.grids)
    - [`Volume.is_sequence`](#bpy.types.Volume.is_sequence)
    - [`Volume.materials`](#bpy.types.Volume.materials)
    - [`Volume.packed_file`](#bpy.types.Volume.packed_file)
    - [`Volume.render`](#bpy.types.Volume.render)
    - [`Volume.sequence_mode`](#bpy.types.Volume.sequence_mode)
    - [`Volume.velocity_grid`](#bpy.types.Volume.velocity_grid)
    - [`Volume.velocity_scale`](#bpy.types.Volume.velocity_scale)
    - [`Volume.velocity_unit`](#bpy.types.Volume.velocity_unit)
    - [`Volume.velocity_x_grid`](#bpy.types.Volume.velocity_x_grid)
    - [`Volume.velocity_y_grid`](#bpy.types.Volume.velocity_y_grid)
    - [`Volume.velocity_z_grid`](#bpy.types.Volume.velocity_z_grid)
    - [`Volume.bl_rna_get_subclass()`](#bpy.types.Volume.bl_rna_get_subclass)
    - [`Volume.bl_rna_get_subclass_py()`](#bpy.types.Volume.bl_rna_get_subclass_py)
