...
# MeshVertex(bpy\_struct)[¶](#meshvertex-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.MeshVertex(*bpy\_struct*)[¶](#bpy.types.MeshVertex "Link to this definition")
:   Vertex in a Mesh data-block

    co[¶](#bpy.types.MeshVertex.co "Link to this definition")
    :   Type:
        :   [`mathutils.Vector`](../../mathutils/index.md#mathutils.Vector "mathutils.Vector") of 3 items in [-inf, inf], default (0.0, 0.0, 0.0)

    groups[¶](#bpy.types.MeshVertex.groups "Link to this definition")
    :   Weights for the vertex groups this vertex is member of

        Type:
        :   [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`VertexGroupElement`](VertexGroupElement.md#bpy.types.VertexGroupElement "bpy.types.VertexGroupElement"), (readonly)

    hide[¶](#bpy.types.MeshVertex.hide "Link to this definition")
    :   Type:
        :   boolean, default False

    index[¶](#bpy.types.MeshVertex.index "Link to this definition")
    :   Index of this vertex

        Type:
        :   int in [0, inf], default 0, (readonly)

    normal[¶](#bpy.types.MeshVertex.normal "Link to this definition")
    :   Vertex Normal

        Type:
        :   [`mathutils.Vector`](../../mathutils/index.md#mathutils.Vector "mathutils.Vector") of 3 items in [-inf, inf], default (0.0, 0.0, 0.0), (readonly)

    select[¶](#bpy.types.MeshVertex.select "Link to this definition")
    :   Type:
        :   boolean, default False

    undeformed\_co[¶](#bpy.types.MeshVertex.undeformed_co "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.MeshVertex.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.MeshVertex.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Mesh.vertices`](Mesh.md#bpy.types.Mesh.vertices "bpy.types.Mesh.vertices") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.MeshVertex.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.MeshVertex.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* MeshVertex(bpy\_struct)
  + [`MeshVertex`](#bpy.types.MeshVertex)
    - [`MeshVertex.co`](#bpy.types.MeshVertex.co)
    - [`MeshVertex.groups`](#bpy.types.MeshVertex.groups)
    - [`MeshVertex.hide`](#bpy.types.MeshVertex.hide)
    - [`MeshVertex.index`](#bpy.types.MeshVertex.index)
    - [`MeshVertex.normal`](#bpy.types.MeshVertex.normal)
    - [`MeshVertex.select`](#bpy.types.MeshVertex.select)
    - [`MeshVertex.undeformed_co`](#bpy.types.MeshVertex.undeformed_co)
    - [`MeshVertex.bl_rna_get_subclass()`](#bpy.types.MeshVertex.bl_rna_get_subclass)
    - [`MeshVertex.bl_rna_get_subclass_py()`](#bpy.types.MeshVertex.bl_rna_get_subclass_py)
