...
# InlineShaderNodes[¶](#inlineshadernodes "Link to this heading")

## Inline Shader Nodes[¶](#inline-shader-nodes "Link to this heading")
...
*class* bpy.types.InlineShaderNodes[¶](#bpy.types.InlineShaderNodes "Link to this definition")
:   An inlined shader node tree.

    node\_tree[¶](#bpy.types.InlineShaderNodes.node_tree "Link to this definition")
    :   The inlined node tree.

        Type:
        :   [`bpy.types.NodeTree`](NodeTree.md#bpy.types.NodeTree "bpy.types.NodeTree")

    *static* from\_light(*light*)[¶](#bpy.types.InlineShaderNodes.from_light "Link to this definition")
    :   Create an inlined shader node tree from a light.

        Parameters:
        :   **light** ([*bpy.types.Light*](Light.md#bpy.types.Light "bpy.types.Light")) – The light to online the node tree of.

    *static* from\_material(*material*)[¶](#bpy.types.InlineShaderNodes.from_material "Link to this definition")
    :   Create an inlined shader node tree from a material.

        Parameters:
        :   **material** ([*bpy.types.Material*](Material.md#bpy.types.Material "bpy.types.Material")) – The material to inline the node tree of.

    *static* from\_world(*world*)[¶](#bpy.types.InlineShaderNodes.from_world "Link to this definition")
    :   Create an inlined shader node tree from a world.

        Parameters:
        :   **world** ([*bpy.types.World*](World.md#bpy.types.World "bpy.types.World")) – The world to inline the node tree of.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.InlineShaderNodes.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.InlineShaderNodes.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* InlineShaderNodes
  + [Inline Shader Nodes](#inline-shader-nodes)
    - [`bpy.types.InlineShaderNodes`](#bpy.types.InlineShaderNodes)
      * [`bpy.types.InlineShaderNodes.node_tree`](#bpy.types.InlineShaderNodes.node_tree)
      * [`bpy.types.InlineShaderNodes.from_light()`](#bpy.types.InlineShaderNodes.from_light)
      * [`bpy.types.InlineShaderNodes.from_material()`](#bpy.types.InlineShaderNodes.from_material)
      * [`bpy.types.InlineShaderNodes.from_world()`](#bpy.types.InlineShaderNodes.from_world)