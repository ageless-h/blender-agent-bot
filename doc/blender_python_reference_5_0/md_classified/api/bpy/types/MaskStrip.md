...
# MaskStrip(Strip)[¶](#maskstrip-strip "Link to this heading")
...
*class* bpy.types.MaskStrip(*Strip*)[¶](#bpy.types.MaskStrip "Link to this definition")
:   Sequence strip to load a video from a mask

    alpha\_mode[¶](#bpy.types.MaskStrip.alpha_mode "Link to this definition")
    ...
    animation\_offset\_end[¶](#bpy.types.MaskStrip.animation_offset_end "Link to this definition")
    :   Animation end offset (trim end)

        Type:
        :   int in [0, inf], default 0

    animation\_offset\_start[¶](#bpy.types.MaskStrip.animation_offset_start "Link to this definition")
    :   Animation start offset (trim start)

        Type:
        :   int in [0, inf], default 0

    color\_multiply[¶](#bpy.types.MaskStrip.color_multiply "Link to this definition")
    :   Type:
        :   float in [0, 20], default 1.0

    color\_saturation[¶](#bpy.types.MaskStrip.color_saturation "Link to this definition")
    :   Adjust the intensity of the input’s color

        Type:
        :   float in [0, 20], default 1.0

    crop[¶](#bpy.types.MaskStrip.crop "Link to this definition")
    :   Type:
        :   [`StripCrop`](StripCrop.md#bpy.types.StripCrop "bpy.types.StripCrop"), (readonly)

    mask[¶](#bpy.types.MaskStrip.mask "Link to this definition")
    :   Mask that this strip uses

        Type:
        :   [`Mask`](Mask.md#bpy.types.Mask "bpy.types.Mask")

    multiply\_alpha[¶](#bpy.types.MaskStrip.multiply_alpha "Link to this definition")
    :   Multiply alpha along with color channels

        Type:
        :   boolean, default False

    strobe[¶](#bpy.types.MaskStrip.strobe "Link to this definition")
    :   Only display every nth frame

        Type:
        :   float in [1, 30], default 0.0

    transform[¶](#bpy.types.MaskStrip.transform "Link to this definition")
    :   Type:
        :   [`StripTransform`](StripTransform.md#bpy.types.StripTransform "bpy.types.StripTransform"), (readonly)

    use\_deinterlace[¶](#bpy.types.MaskStrip.use_deinterlace "Link to this definition")
    :   Remove fields from video movies

        Type:
        :   boolean, default False

    use\_flip\_x[¶](#bpy.types.MaskStrip.use_flip_x "Link to this definition")
    :   Flip on the X axis

        Type:
        :   boolean, default False

    use\_flip\_y[¶](#bpy.types.MaskStrip.use_flip_y "Link to this definition")
    :   Flip on the Y axis

        Type:
        :   boolean, default False

    use\_float[¶](#bpy.types.MaskStrip.use_float "Link to this definition")
    :   Convert input to float data

        Type:
        :   boolean, default False

    use\_reverse\_frames[¶](#bpy.types.MaskStrip.use_reverse_frames "Link to this definition")
    :   Reverse frame order

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.MaskStrip.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.MaskStrip.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
MaskStripModifier(StripModifier)](MaskStripModifier.md)
[Previous
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.MaskStrip.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.MaskStrip.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* MaskStrip(Strip)
  + [`MaskStrip`](#bpy.types.MaskStrip)
    - [`MaskStrip.alpha_mode`](#bpy.types.MaskStrip.alpha_mode)
    - [`MaskStrip.animation_offset_end`](#bpy.types.MaskStrip.animation_offset_end)
    - [`MaskStrip.animation_offset_start`](#bpy.types.MaskStrip.animation_offset_start)
    - [`MaskStrip.color_multiply`](#bpy.types.MaskStrip.color_multiply)
    - [`MaskStrip.color_saturation`](#bpy.types.MaskStrip.color_saturation)
    - [`MaskStrip.crop`](#bpy.types.MaskStrip.crop)
    - [`MaskStrip.mask`](#bpy.types.MaskStrip.mask)
    - [`MaskStrip.multiply_alpha`](#bpy.types.MaskStrip.multiply_alpha)
    - [`MaskStrip.strobe`](#bpy.types.MaskStrip.strobe)
    - [`MaskStrip.transform`](#bpy.types.MaskStrip.transform)
    - [`MaskStrip.use_deinterlace`](#bpy.types.MaskStrip.use_deinterlace)
    - [`MaskStrip.use_flip_x`](#bpy.types.MaskStrip.use_flip_x)
    - [`MaskStrip.use_flip_y`](#bpy.types.MaskStrip.use_flip_y)
    - [`MaskStrip.use_float`](#bpy.types.MaskStrip.use_float)
    - [`MaskStrip.use_reverse_frames`](#bpy.types.MaskStrip.use_reverse_frames)
    - [`MaskStrip.bl_rna_get_subclass()`](#bpy.types.MaskStrip.bl_rna_get_subclass)
    - [`MaskStrip.bl_rna_get_subclass_py()`](#bpy.types.MaskStrip.bl_rna_get_subclass_py)
