...
# WorkSpace(ID)[¶](#workspace-id "Link to this heading")

base classes — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct"), [`ID`](ID.md#bpy.types.ID "bpy.types.ID")

*class* bpy.types.WorkSpace(*ID*)[¶](#bpy.types.WorkSpace "Link to this definition")
:   Workspace data-block, defining the working environment for the user

    active\_addon[¶](#bpy.types.WorkSpace.active_addon "Link to this definition")
    :   Active Add-on in the Workspace Add-ons filter

        Type:
        :   int in [-inf, inf], default 0

    asset\_library\_reference[¶](#bpy.types.WorkSpace.asset_library_reference "Link to this definition")
    ...
    object\_mode[¶](#bpy.types.WorkSpace.object_mode "Link to this definition")
    :   Switch to this object mode when activating the workspace

        Type:
        :   enum in [Workspace Object Mode Items](../../../appendix/bpy_types_enum_items/workspace_object_mode_items.md#rna-enum-workspace-object-mode-items), default `'OBJECT'`

    owner\_ids[¶](#bpy.types.WorkSpace.owner_ids "Link to this definition")
    :   Type:
        :   [`wmOwnerIDs`](wmOwnerIDs.md#bpy.types.wmOwnerIDs "bpy.types.wmOwnerIDs") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`wmOwnerID`](wmOwnerID.md#bpy.types.wmOwnerID "bpy.types.wmOwnerID"), (readonly)

    screens[¶](#bpy.types.WorkSpace.screens "Link to this definition")
    :   Screen layouts of a workspace

        Type:
        :   [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`Screen`](Screen.md#bpy.types.Screen "bpy.types.Screen"), (readonly)

    sequencer\_scene[¶](#bpy.types.WorkSpace.sequencer_scene "Link to this definition")
    :   Type:
        :   [`Scene`](Scene.md#bpy.types.Scene "bpy.types.Scene")

    tools[¶](#bpy.types.WorkSpace.tools "Link to this definition")
    :   Type:
        :   [`wmTools`](wmTools.md#bpy.types.wmTools "bpy.types.wmTools") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`WorkSpaceTool`](WorkSpaceTool.md#bpy.types.WorkSpaceTool "bpy.types.WorkSpaceTool"), (readonly)

    use\_filter\_by\_owner[¶](#bpy.types.WorkSpace.use_filter_by_owner "Link to this definition")
    :   Filter the UI by tags

        Type:
        :   boolean, default False

    use\_pin\_scene[¶](#bpy.types.WorkSpace.use_pin_scene "Link to this definition")
    :   Remember the last used scene for the workspace and switch to it whenever this workspace is activated again

        Type:
        :   boolean, default False

    use\_scene\_time\_sync[¶](#bpy.types.WorkSpace.use_scene_time_sync "Link to this definition")
    :   Set the active scene and time based on the current scene strip

        Type:
        :   boolean, default False

    *classmethod* status\_text\_set\_internal(*text*)[¶](#bpy.types.WorkSpace.status_text_set_internal "Link to this definition")
    ...
    status\_text\_set(*text*)[¶](#bpy.types.WorkSpace.status_text_set "Link to this definition")
    :   Set the status text or None to clear,
        When text is a function, this will be called with the (header, context) arguments.

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.WorkSpace.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.WorkSpace.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`BlendData.workspaces`](BlendData.md#bpy.types.BlendData.workspaces "bpy.types.BlendData.workspaces") * [`Context.workspace`](Context.md#bpy.types.Context.workspace "bpy.types.Context.workspace") | * [`Window.workspace`](Window.md#bpy.types.Window.workspace "bpy.types.Window.workspace") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.WorkSpace.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.WorkSpace.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* WorkSpace(ID)
  + [`WorkSpace`](#bpy.types.WorkSpace)
    - [`WorkSpace.active_addon`](#bpy.types.WorkSpace.active_addon)
    - [`WorkSpace.asset_library_reference`](#bpy.types.WorkSpace.asset_library_reference)
    - [`WorkSpace.object_mode`](#bpy.types.WorkSpace.object_mode)
    - [`WorkSpace.owner_ids`](#bpy.types.WorkSpace.owner_ids)
    - [`WorkSpace.screens`](#bpy.types.WorkSpace.screens)
    - [`WorkSpace.sequencer_scene`](#bpy.types.WorkSpace.sequencer_scene)
    - [`WorkSpace.tools`](#bpy.types.WorkSpace.tools)
    - [`WorkSpace.use_filter_by_owner`](#bpy.types.WorkSpace.use_filter_by_owner)
    - [`WorkSpace.use_pin_scene`](#bpy.types.WorkSpace.use_pin_scene)
    - [`WorkSpace.use_scene_time_sync`](#bpy.types.WorkSpace.use_scene_time_sync)
    - [`WorkSpace.status_text_set_internal()`](#bpy.types.WorkSpace.status_text_set_internal)
    - [`WorkSpace.status_text_set()`](#bpy.types.WorkSpace.status_text_set)
    - [`WorkSpace.bl_rna_get_subclass()`](#bpy.types.WorkSpace.bl_rna_get_subclass)
    - [`WorkSpace.bl_rna_get_subclass_py()`](#bpy.types.WorkSpace.bl_rna_get_subclass_py)
