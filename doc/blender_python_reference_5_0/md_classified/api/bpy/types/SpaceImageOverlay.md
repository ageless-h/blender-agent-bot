...
# SpaceImageOverlay(bpy\_struct)[¶](#spaceimageoverlay-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.SpaceImageOverlay(*bpy\_struct*)[¶](#bpy.types.SpaceImageOverlay "Link to this definition")
:   Settings for display of overlays in the UV/Image editor

    passepartout\_alpha[¶](#bpy.types.SpaceImageOverlay.passepartout_alpha "Link to this definition")
    :   Opacity of the darkened overlay outside the render region

        Type:
        :   float in [0, 1], default 0.5

    show\_grid\_background[¶](#bpy.types.SpaceImageOverlay.show_grid_background "Link to this definition")
    :   Show the grid background and borders

        Type:
        :   boolean, default False

    show\_overlays[¶](#bpy.types.SpaceImageOverlay.show_overlays "Link to this definition")
    :   Display overlays like UV Maps and Metadata

        Type:
        :   boolean, default False

    show\_render\_size[¶](#bpy.types.SpaceImageOverlay.show_render_size "Link to this definition")
    :   Display the region of the final render

        Type:
        :   boolean, default False

    show\_text\_info[¶](#bpy.types.SpaceImageOverlay.show_text_info "Link to this definition")
    :   Display overlay text

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.SpaceImageOverlay.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.SpaceImageOverlay.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`SpaceImageEditor.overlay`](SpaceImageEditor.md#bpy.types.SpaceImageEditor.overlay "bpy.types.SpaceImageEditor.overlay") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.SpaceImageOverlay.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.SpaceImageOverlay.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* SpaceImageOverlay(bpy\_struct)
  + [`SpaceImageOverlay`](#bpy.types.SpaceImageOverlay)
    - [`SpaceImageOverlay.passepartout_alpha`](#bpy.types.SpaceImageOverlay.passepartout_alpha)
    - [`SpaceImageOverlay.show_grid_background`](#bpy.types.SpaceImageOverlay.show_grid_background)
    - [`SpaceImageOverlay.show_overlays`](#bpy.types.SpaceImageOverlay.show_overlays)
    - [`SpaceImageOverlay.show_render_size`](#bpy.types.SpaceImageOverlay.show_render_size)
    - [`SpaceImageOverlay.show_text_info`](#bpy.types.SpaceImageOverlay.show_text_info)
    - [`SpaceImageOverlay.bl_rna_get_subclass()`](#bpy.types.SpaceImageOverlay.bl_rna_get_subclass)
    - [`SpaceImageOverlay.bl_rna_get_subclass_py()`](#bpy.types.SpaceImageOverlay.bl_rna_get_subclass_py)
