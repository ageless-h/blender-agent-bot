...
# FloatProperty(Property)[¶](#floatproperty-property "Link to this heading")

base classes — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct"), [`Property`](Property.md#bpy.types.Property "bpy.types.Property")

*class* bpy.types.FloatProperty(*Property*)[¶](#bpy.types.FloatProperty "Link to this definition")
:   RNA floating-point number (single precision) property definition

    array\_dimensions[¶](#bpy.types.FloatProperty.array_dimensions "Link to this definition")
    :   Length of each dimension of the array

        Type:
        :   int array of 3 items in [0, inf], [default](#bpy.types.FloatProperty.default "bpy.types.FloatProperty.default") (0, 0, 0), (readonly)

    array\_length[¶](#bpy.types.FloatProperty.array_length "Link to this definition")
    :   Maximum length of the array, 0 means unlimited

        Type:
        :   int in [0, inf], default 0, (readonly)

    default[¶](#bpy.types.FloatProperty.default "Link to this definition")
    :   Default value for this number

        Type:
        :   float in [-inf, inf], default 0.0, (readonly)

    default\_array[¶](#bpy.types.FloatProperty.default_array "Link to this definition")
    :   Default value for this array

        Type:
        :   float array of 3 items in [-inf, inf], [default](#bpy.types.FloatProperty.default "bpy.types.FloatProperty.default") (0.0, 0.0, 0.0), (readonly)

    hard\_max[¶](#bpy.types.FloatProperty.hard_max "Link to this definition")
    :   Maximum value used by buttons

        Type:
        :   float in [-inf, inf], default 0.0, (readonly)

    hard\_min[¶](#bpy.types.FloatProperty.hard_min "Link to this definition")
    :   Minimum value used by buttons

        Type:
        :   float in [-inf, inf], default 0.0, (readonly)

    is\_array[¶](#bpy.types.FloatProperty.is_array "Link to this definition")
    :   Type:
        :   boolean, default False, (readonly)

    precision[¶](#bpy.types.FloatProperty.precision "Link to this definition")
    ...
    soft\_max[¶](#bpy.types.FloatProperty.soft_max "Link to this definition")
    :   Maximum value used by buttons

        Type:
        :   float in [-inf, inf], default 0.0, (readonly)

    soft\_min[¶](#bpy.types.FloatProperty.soft_min "Link to this definition")
    :   Minimum value used by buttons

        Type:
        :   float in [-inf, inf], default 0.0, (readonly)

    step[¶](#bpy.types.FloatProperty.step "Link to this definition")
    :   Step size used by number buttons, for floats 1/100th of the step size

        Type:
        :   float in [0, inf], default 0.0, (readonly)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.FloatProperty.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.FloatProperty.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`bpy_struct.id_data`](bpy_struct.md#bpy.types.bpy_struct.id_data "bpy.types.bpy_struct.id_data") * [`Property.name`](Property.md#bpy.types.Property.name "bpy.types.Property.name") * [`Property.identifier`](Property.md#bpy.types.Property.identifier "bpy.types.Property.identifier") * [`Property.description`](Property.md#bpy.types.Property.description "bpy.types.Property.description") * [`Property.translation_context`](Property.md#bpy.types.Property.translation_context "bpy.types.Property.translation_context") * [`Property.type`](Property.md#bpy.types.Property.type "bpy.types.Property.type") * [`Property.subtype`](Property.md#bpy.types.Property.subtype "bpy.types.Property.subtype") * [`Property.srna`](Property.md#bpy.types.Property.srna "bpy.types.Property.srna") * [`Property.unit`](Property.md#bpy.types.Property.unit "bpy.types.Property.unit") * [`Property.icon`](Property.md#bpy.types.Property.icon "bpy.types.Property.icon") * [`Property.is_readonly`](Property.md#bpy.types.Property.is_readonly "bpy.types.Property.is_readonly") * [`Property.is_animatable`](Property.md#bpy.types.Property.is_animatable "bpy.types.Property.is_animatable") * [`Property.is_overridable`](Property.md#bpy.types.Property.is_overridable "bpy.types.Property.is_overridable") * [`Property.is_required`](Property.md#bpy.types.Property.is_required "bpy.types.Property.is_required") * [`Property.is_argument_optional`](Property.md#bpy.types.Property.is_argument_optional "bpy.types.Property.is_argument_optional") * [`Property.is_never_none`](Property.md#bpy.types.Property.is_never_none "bpy.types.Property.is_never_none") * [`Property.is_hidden`](Property.md#bpy.types.Property.is_hidden "bpy.types.Property.is_hidden") | * [`Property.is_skip_save`](Property.md#bpy.types.Property.is_skip_save "bpy.types.Property.is_skip_save") * [`Property.is_skip_preset`](Property.md#bpy.types.Property.is_skip_preset "bpy.types.Property.is_skip_preset") * [`Property.is_output`](Property.md#bpy.types.Property.is_output "bpy.types.Property.is_output") * [`Property.is_registered`](Property.md#bpy.types.Property.is_registered "bpy.types.Property.is_registered") * [`Property.is_registered_optional`](Property.md#bpy.types.Property.is_registered_optional "bpy.types.Property.is_registered_optional") * [`Property.is_runtime`](Property.md#bpy.types.Property.is_runtime "bpy.types.Property.is_runtime") * [`Property.is_enum_flag`](Property.md#bpy.types.Property.is_enum_flag "bpy.types.Property.is_enum_flag") * [`Property.is_library_editable`](Property.md#bpy.types.Property.is_library_editable "bpy.types.Property.is_library_editable") * [`Property.is_path_output`](Property.md#bpy.types.Property.is_path_output "bpy.types.Property.is_path_output") * [`Property.is_path_supports_blend_relative`](Property.md#bpy.types.Property.is_path_supports_blend_relative "bpy.types.Property.is_path_supports_blend_relative") * [`Property.is_path_supports_templates`](Property.md#bpy.types.Property.is_path_supports_templates "bpy.types.Property.is_path_supports_templates") * [`Property.is_deprecated`](Property.md#bpy.types.Property.is_deprecated "bpy.types.Property.is_deprecated") * [`Property.deprecated_note`](Property.md#bpy.types.Property.deprecated_note "bpy.types.Property.deprecated_note") * [`Property.deprecated_version`](Property.md#bpy.types.Property.deprecated_version "bpy.types.Property.deprecated_version") * [`Property.deprecated_removal_version`](Property.md#bpy.types.Property.deprecated_removal_version "bpy.types.Property.deprecated_removal_version") * [`Property.tags`](Property.md#bpy.types.Property.tags "bpy.types.Property.tags") |

## Inherited Functions[¶](#inherited-functions "Link to this heading")

|  |  |
| --- | --- |
| * [`bpy_struct.as_pointer`](bpy_struct.md#bpy.types.bpy_struct.as_pointer "bpy.types.bpy_struct.as_pointer") * [`bpy_struct.driver_add`](bpy_struct.md#bpy.types.bpy_struct.driver_add "bpy.types.bpy_struct.driver_add") * [`bpy_struct.driver_remove`](bpy_struct.md#bpy.types.bpy_struct.driver_remove "bpy.types.bpy_struct.driver_remove") * [`bpy_struct.get`](bpy_struct.md#bpy.types.bpy_struct.get "bpy.types.bpy_struct.get") * [`bpy_struct.id_properties_clear`](bpy_struct.md#bpy.types.bpy_struct.id_properties_clear "bpy.types.bpy_struct.id_properties_clear") * [`bpy_struct.id_properties_ensure`](bpy_struct.md#bpy.types.bpy_struct.id_properties_ensure "bpy.types.bpy_struct.id_properties_ensure") * [`bpy_struct.id_properties_ui`](bpy_struct.md#bpy.types.bpy_struct.id_properties_ui "bpy.types.bpy_struct.id_properties_ui") * [`bpy_struct.is_property_hidden`](bpy_struct.md#bpy.types.bpy_struct.is_property_hidden "bpy.types.bpy_struct.is_property_hidden") * [`bpy_struct.is_property_overridable_library`](bpy_struct.md#bpy.types.bpy_struct.is_property_overridable_library "bpy.types.bpy_struct.is_property_overridable_library") * [`bpy_struct.is_property_readonly`](bpy_struct.md#bpy.types.bpy_struct.is_property_readonly "bpy.types.bpy_struct.is_property_readonly") * [`bpy_struct.is_property_set`](bpy_struct.md#bpy.types.bpy_struct.is_property_set "bpy.types.bpy_struct.is_property_set") * [`bpy_struct.items`](bpy_struct.md#bpy.types.bpy_struct.items "bpy.types.bpy_struct.items") * [`bpy_struct.keyframe_delete`](bpy_struct.md#bpy.types.bpy_struct.keyframe_delete "bpy.types.bpy_struct.keyframe_delete") | * [`bpy_struct.keyframe_insert`](bpy_struct.md#bpy.types.bpy_struct.keyframe_insert "bpy.types.bpy_struct.keyframe_insert") * [`bpy_struct.keys`](bpy_struct.md#bpy.types.bpy_struct.keys "bpy.types.bpy_struct.keys") * [`bpy_struct.path_from_id`](bpy_struct.md#bpy.types.bpy_struct.path_from_id "bpy.types.bpy_struct.path_from_id") * [`bpy_struct.path_from_module`](bpy_struct.md#bpy.types.bpy_struct.path_from_module "bpy.types.bpy_struct.path_from_module") * [`bpy_struct.path_resolve`](bpy_struct.md#bpy.types.bpy_struct.path_resolve "bpy.types.bpy_struct.path_resolve") * [`bpy_struct.pop`](bpy_struct.md#bpy.types.bpy_struct.pop "bpy.types.bpy_struct.pop") * [`bpy_struct.property_overridable_library_set`](bpy_struct.md#bpy.types.bpy_struct.property_overridable_library_set "bpy.types.bpy_struct.property_overridable_library_set") * [`bpy_struct.property_unset`](bpy_struct.md#bpy.types.bpy_struct.property_unset "bpy.types.bpy_struct.property_unset") * [`bpy_struct.rna_ancestors`](bpy_struct.md#bpy.types.bpy_struct.rna_ancestors "bpy.types.bpy_struct.rna_ancestors") * [`bpy_struct.type_recast`](bpy_struct.md#bpy.types.bpy_struct.type_recast "bpy.types.bpy_struct.type_recast") * [`bpy_struct.values`](bpy_struct.md#bpy.types.bpy_struct.values "bpy.types.bpy_struct.values") * [`Property.bl_rna_get_subclass`](Property.md#bpy.types.Property.bl_rna_get_subclass "bpy.types.Property.bl_rna_get_subclass") * [`Property.bl_rna_get_subclass_py`](Property.md#bpy.types.Property.bl_rna_get_subclass_py "bpy.types.Property.bl_rna_get_subclass_py") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.FloatProperty.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.FloatProperty.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* FloatProperty(Property)
  + [`FloatProperty`](#bpy.types.FloatProperty)
    - [`FloatProperty.array_dimensions`](#bpy.types.FloatProperty.array_dimensions)
    - [`FloatProperty.array_length`](#bpy.types.FloatProperty.array_length)
    - [`FloatProperty.default`](#bpy.types.FloatProperty.default)
    - [`FloatProperty.default_array`](#bpy.types.FloatProperty.default_array)
    - [`FloatProperty.hard_max`](#bpy.types.FloatProperty.hard_max)
    - [`FloatProperty.hard_min`](#bpy.types.FloatProperty.hard_min)
    - [`FloatProperty.is_array`](#bpy.types.FloatProperty.is_array)
    - [`FloatProperty.precision`](#bpy.types.FloatProperty.precision)
    - [`FloatProperty.soft_max`](#bpy.types.FloatProperty.soft_max)
    - [`FloatProperty.soft_min`](#bpy.types.FloatProperty.soft_min)
    - [`FloatProperty.step`](#bpy.types.FloatProperty.step)
    - [`FloatProperty.bl_rna_get_subclass()`](#bpy.types.FloatProperty.bl_rna_get_subclass)
    - [`FloatProperty.bl_rna_get_subclass_py()`](#bpy.types.FloatProperty.bl_rna_get_subclass_py)
