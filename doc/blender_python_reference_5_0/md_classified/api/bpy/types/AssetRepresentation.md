...
# AssetRepresentation(bpy\_struct)[¶](#assetrepresentation-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.AssetRepresentation(*bpy\_struct*)[¶](#bpy.types.AssetRepresentation "Link to this definition")
:   Information about an entity that makes it possible for the asset system to deal with the entity as asset

    full\_library\_path[¶](#bpy.types.AssetRepresentation.full_library_path "Link to this definition")
    :   Absolute path to the .blend file containing this asset

        Type:
        :   string, default “”, (readonly, never None)

    full\_path[¶](#bpy.types.AssetRepresentation.full_path "Link to this definition")
    :   Absolute path to the .blend file containing this asset extended with the path of the asset inside the file

        Type:
        :   string, default “”, (readonly, never None)

    id\_type[¶](#bpy.types.AssetRepresentation.id_type "Link to this definition")
    ...
    local\_id[¶](#bpy.types.AssetRepresentation.local_id "Link to this definition")
    ...
    metadata[¶](#bpy.types.AssetRepresentation.metadata "Link to this definition")
    :   Additional information about the asset

        Type:
        :   [`AssetMetaData`](AssetMetaData.md#bpy.types.AssetMetaData "bpy.types.AssetMetaData"), (readonly)

    name[¶](#bpy.types.AssetRepresentation.name "Link to this definition")
    :   Type:
        :   string, default “”, (readonly, never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.AssetRepresentation.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.AssetRepresentation.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`bpy.context.asset`](../context/index.md#bpy.context.asset "bpy.context.asset") * [`bpy.context.selected_assets`](../context/index.md#bpy.context.selected_assets "bpy.context.selected_assets") * [`AssetShelf.asset_poll`](AssetShelf.md#bpy.types.AssetShelf.asset_poll "bpy.types.AssetShelf.asset_poll") | * [`AssetShelf.draw_context_menu`](AssetShelf.md#bpy.types.AssetShelf.draw_context_menu "bpy.types.AssetShelf.draw_context_menu") * [`Context.asset`](Context.md#bpy.types.Context.asset "bpy.types.Context.asset") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.AssetRepresentation.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.AssetRepresentation.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* AssetRepresentation(bpy\_struct)
  + [`AssetRepresentation`](#bpy.types.AssetRepresentation)
    - [`AssetRepresentation.full_library_path`](#bpy.types.AssetRepresentation.full_library_path)
    - [`AssetRepresentation.full_path`](#bpy.types.AssetRepresentation.full_path)
    - [`AssetRepresentation.id_type`](#bpy.types.AssetRepresentation.id_type)
    - [`AssetRepresentation.local_id`](#bpy.types.AssetRepresentation.local_id)
    - [`AssetRepresentation.metadata`](#bpy.types.AssetRepresentation.metadata)
    - [`AssetRepresentation.name`](#bpy.types.AssetRepresentation.name)
    - [`AssetRepresentation.bl_rna_get_subclass()`](#bpy.types.AssetRepresentation.bl_rna_get_subclass)
    - [`AssetRepresentation.bl_rna_get_subclass_py()`](#bpy.types.AssetRepresentation.bl_rna_get_subclass_py)
