...
# CameraDOFSettings(bpy\_struct)[¶](#cameradofsettings-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.CameraDOFSettings(*bpy\_struct*)[¶](#bpy.types.CameraDOFSettings "Link to this definition")
:   Depth of Field settings

    aperture\_blades[¶](#bpy.types.CameraDOFSettings.aperture_blades "Link to this definition")
    :   Number of blades in aperture for polygonal bokeh (at least 3)

        Type:
        :   int in [0, 16], default 0

    aperture\_fstop[¶](#bpy.types.CameraDOFSettings.aperture_fstop "Link to this definition")
    :   F-Stop ratio (lower numbers give more defocus, higher numbers give a sharper image)

        Type:
        :   float in [0, inf], default 2.8

    aperture\_ratio[¶](#bpy.types.CameraDOFSettings.aperture_ratio "Link to this definition")
    :   Distortion to simulate anamorphic lens bokeh

        Type:
        :   float in [0.01, inf], default 1.0

    aperture\_rotation[¶](#bpy.types.CameraDOFSettings.aperture_rotation "Link to this definition")
    :   Rotation of blades in aperture

        Type:
        :   float in [-3.14159, 3.14159], default 0.0

    focus\_distance[¶](#bpy.types.CameraDOFSettings.focus_distance "Link to this definition")
    :   Distance to the focus point for depth of field

        Type:
        :   float in [0, inf], default 10.0

    focus\_object[¶](#bpy.types.CameraDOFSettings.focus_object "Link to this definition")
    :   Use this object to define the depth of field focal point

        Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object")

    focus\_subtarget[¶](#bpy.types.CameraDOFSettings.focus_subtarget "Link to this definition")
    :   Use this armature bone to define the depth of field focal point

        Type:
        :   string, default “”, (never None)

    use\_dof[¶](#bpy.types.CameraDOFSettings.use_dof "Link to this definition")
    :   Use Depth of Field

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.CameraDOFSettings.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.CameraDOFSettings.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Camera.dof`](Camera.md#bpy.types.Camera.dof "bpy.types.Camera.dof") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CameraDOFSettings.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.CameraDOFSettings.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CameraDOFSettings(bpy\_struct)
  + [`CameraDOFSettings`](#bpy.types.CameraDOFSettings)
    - [`CameraDOFSettings.aperture_blades`](#bpy.types.CameraDOFSettings.aperture_blades)
    - [`CameraDOFSettings.aperture_fstop`](#bpy.types.CameraDOFSettings.aperture_fstop)
    - [`CameraDOFSettings.aperture_ratio`](#bpy.types.CameraDOFSettings.aperture_ratio)
    - [`CameraDOFSettings.aperture_rotation`](#bpy.types.CameraDOFSettings.aperture_rotation)
    - [`CameraDOFSettings.focus_distance`](#bpy.types.CameraDOFSettings.focus_distance)
    - [`CameraDOFSettings.focus_object`](#bpy.types.CameraDOFSettings.focus_object)
    - [`CameraDOFSettings.focus_subtarget`](#bpy.types.CameraDOFSettings.focus_subtarget)
    - [`CameraDOFSettings.use_dof`](#bpy.types.CameraDOFSettings.use_dof)
    - [`CameraDOFSettings.bl_rna_get_subclass()`](#bpy.types.CameraDOFSettings.bl_rna_get_subclass)
    - [`CameraDOFSettings.bl_rna_get_subclass_py()`](#bpy.types.CameraDOFSettings.bl_rna_get_subclass_py)
