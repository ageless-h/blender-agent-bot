...
# LineStyleAlphaModifier\_CreaseAngle(LineStyleAlphaModifier)[¶](#linestylealphamodifier-creaseangle-linestylealphamodifier "Link to this heading")
...
*class* bpy.types.LineStyleAlphaModifier\_CreaseAngle(*LineStyleAlphaModifier*)[¶](#bpy.types.LineStyleAlphaModifier_CreaseAngle "Link to this definition")
:   Alpha transparency based on the angle between two adjacent faces

    angle\_max[¶](#bpy.types.LineStyleAlphaModifier_CreaseAngle.angle_max "Link to this definition")
    :   Maximum angle to modify thickness

        Type:
        :   float in [-inf, inf], default 0.0

    angle\_min[¶](#bpy.types.LineStyleAlphaModifier_CreaseAngle.angle_min "Link to this definition")
    :   Minimum angle to modify thickness

        Type:
        :   float in [-inf, inf], default 0.0

    blend[¶](#bpy.types.LineStyleAlphaModifier_CreaseAngle.blend "Link to this definition")
    :   Specify how the modifier value is blended into the base value

        Type:
        :   enum in [`'MIX'`, `'ADD'`, `'SUBTRACT'`, `'MULTIPLY'`, `'DIVIDE'`, `'DIFFERENCE'`, `'MINIMUM'`, `'MAXIMUM'`], default `'MIX'`

    curve[¶](#bpy.types.LineStyleAlphaModifier_CreaseAngle.curve "Link to this definition")
    :   Curve used for the curve mapping

        Type:
        :   [`CurveMapping`](CurveMapping.md#bpy.types.CurveMapping "bpy.types.CurveMapping"), (readonly)

    expanded[¶](#bpy.types.LineStyleAlphaModifier_CreaseAngle.expanded "Link to this definition")
    :   True if the modifier tab is expanded

        Type:
        :   boolean, default False

    influence[¶](#bpy.types.LineStyleAlphaModifier_CreaseAngle.influence "Link to this definition")
    :   Influence factor by which the modifier changes the property

        Type:
        :   float in [0, 1], default 0.0

    invert[¶](#bpy.types.LineStyleAlphaModifier_CreaseAngle.invert "Link to this definition")
    :   Invert the fade-out direction of the linear mapping

        Type:
        :   boolean, default False

    mapping[¶](#bpy.types.LineStyleAlphaModifier_CreaseAngle.mapping "Link to this definition")
    ...
    type[¶](#bpy.types.LineStyleAlphaModifier_CreaseAngle.type "Link to this definition")
    ...
    use[¶](#bpy.types.LineStyleAlphaModifier_CreaseAngle.use "Link to this definition")
    :   Enable or disable this modifier during stroke rendering

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.LineStyleAlphaModifier_CreaseAngle.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.LineStyleAlphaModifier_CreaseAngle.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
        ...
        Return type:
        :   [type](#bpy.types.LineStyleAlphaModifier_CreaseAngle.type "bpy.types.LineStyleAlphaModifier_CreaseAngle.type")
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.LineStyleAlphaModifier_CreaseAngle.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.LineStyleAlphaModifier_CreaseAngle.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* LineStyleAlphaModifier\_CreaseAngle(LineStyleAlphaModifier)
  + [`LineStyleAlphaModifier_CreaseAngle`](#bpy.types.LineStyleAlphaModifier_CreaseAngle)
    - [`LineStyleAlphaModifier_CreaseAngle.angle_max`](#bpy.types.LineStyleAlphaModifier_CreaseAngle.angle_max)
    - [`LineStyleAlphaModifier_CreaseAngle.angle_min`](#bpy.types.LineStyleAlphaModifier_CreaseAngle.angle_min)
    - [`LineStyleAlphaModifier_CreaseAngle.blend`](#bpy.types.LineStyleAlphaModifier_CreaseAngle.blend)
    - [`LineStyleAlphaModifier_CreaseAngle.curve`](#bpy.types.LineStyleAlphaModifier_CreaseAngle.curve)
    - [`LineStyleAlphaModifier_CreaseAngle.expanded`](#bpy.types.LineStyleAlphaModifier_CreaseAngle.expanded)
    - [`LineStyleAlphaModifier_CreaseAngle.influence`](#bpy.types.LineStyleAlphaModifier_CreaseAngle.influence)
    - [`LineStyleAlphaModifier_CreaseAngle.invert`](#bpy.types.LineStyleAlphaModifier_CreaseAngle.invert)
    - [`LineStyleAlphaModifier_CreaseAngle.mapping`](#bpy.types.LineStyleAlphaModifier_CreaseAngle.mapping)
    - [`LineStyleAlphaModifier_CreaseAngle.type`](#bpy.types.LineStyleAlphaModifier_CreaseAngle.type)
    - [`LineStyleAlphaModifier_CreaseAngle.use`](#bpy.types.LineStyleAlphaModifier_CreaseAngle.use)
    - [`LineStyleAlphaModifier_CreaseAngle.bl_rna_get_subclass()`](#bpy.types.LineStyleAlphaModifier_CreaseAngle.bl_rna_get_subclass)
    - [`LineStyleAlphaModifier_CreaseAngle.bl_rna_get_subclass_py()`](#bpy.types.LineStyleAlphaModifier_CreaseAngle.bl_rna_get_subclass_py)
