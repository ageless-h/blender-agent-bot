...
# CameraSolverConstraint(Constraint)[¶](#camerasolverconstraint-constraint "Link to this heading")
...
*class* bpy.types.CameraSolverConstraint(*Constraint*)[¶](#bpy.types.CameraSolverConstraint "Link to this definition")
:   Lock motion to the reconstructed camera movement

    clip[¶](#bpy.types.CameraSolverConstraint.clip "Link to this definition")
    :   Movie Clip to get tracking data from

        Type:
        :   [`MovieClip`](MovieClip.md#bpy.types.MovieClip "bpy.types.MovieClip")

    use\_active\_clip[¶](#bpy.types.CameraSolverConstraint.use_active_clip "Link to this definition")
    :   Use active clip defined in scene

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.CameraSolverConstraint.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.CameraSolverConstraint.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CameraSolverConstraint.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.CameraSolverConstraint.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CameraSolverConstraint(Constraint)
  + [`CameraSolverConstraint`](#bpy.types.CameraSolverConstraint)
    - [`CameraSolverConstraint.clip`](#bpy.types.CameraSolverConstraint.clip)
    - [`CameraSolverConstraint.use_active_clip`](#bpy.types.CameraSolverConstraint.use_active_clip)
    - [`CameraSolverConstraint.bl_rna_get_subclass()`](#bpy.types.CameraSolverConstraint.bl_rna_get_subclass)
    - [`CameraSolverConstraint.bl_rna_get_subclass_py()`](#bpy.types.CameraSolverConstraint.bl_rna_get_subclass_py)
