...
# IDViewerPathElem(ViewerPathElem)[¶](#idviewerpathelem-viewerpathelem "Link to this heading")
...
*class* bpy.types.IDViewerPathElem(*ViewerPathElem*)[¶](#bpy.types.IDViewerPathElem "Link to this definition")
:   id[¶](#bpy.types.IDViewerPathElem.id "Link to this definition")
    :   Type:
        :   [`ID`](ID.md#bpy.types.ID "bpy.types.ID"), (readonly)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.IDViewerPathElem.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.IDViewerPathElem.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.IDViewerPathElem.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.IDViewerPathElem.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* IDViewerPathElem(ViewerPathElem)
  + [`IDViewerPathElem`](#bpy.types.IDViewerPathElem)
    - [`IDViewerPathElem.id`](#bpy.types.IDViewerPathElem.id)
    - [`IDViewerPathElem.bl_rna_get_subclass()`](#bpy.types.IDViewerPathElem.bl_rna_get_subclass)
    - [`IDViewerPathElem.bl_rna_get_subclass_py()`](#bpy.types.IDViewerPathElem.bl_rna_get_subclass_py)
