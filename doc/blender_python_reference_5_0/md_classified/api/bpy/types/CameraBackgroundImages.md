...
# CameraBackgroundImages(bpy\_struct)[¶](#camerabackgroundimages-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.CameraBackgroundImages(*bpy\_struct*)[¶](#bpy.types.CameraBackgroundImages "Link to this definition")
:   Collection of background images

    new()[¶](#bpy.types.CameraBackgroundImages.new "Link to this definition")
    :   Add new background image
        ...
        Return type:
        :   [`CameraBackgroundImage`](CameraBackgroundImage.md#bpy.types.CameraBackgroundImage "bpy.types.CameraBackgroundImage")

    remove(*image*)[¶](#bpy.types.CameraBackgroundImages.remove "Link to this definition")
    :   Remove background image

        Parameters:
        :   **image** ([`CameraBackgroundImage`](CameraBackgroundImage.md#bpy.types.CameraBackgroundImage "bpy.types.CameraBackgroundImage"), (never None)) – Image displayed as viewport background

    clear()[¶](#bpy.types.CameraBackgroundImages.clear "Link to this definition")
    :   Remove all background images

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.CameraBackgroundImages.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.CameraBackgroundImages.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Camera.background_images`](Camera.md#bpy.types.Camera.background_images "bpy.types.Camera.background_images") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CameraBackgroundImages.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.CameraBackgroundImages.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CameraBackgroundImages(bpy\_struct)
  + [`CameraBackgroundImages`](#bpy.types.CameraBackgroundImages)
    - [`CameraBackgroundImages.new()`](#bpy.types.CameraBackgroundImages.new)
    - [`CameraBackgroundImages.remove()`](#bpy.types.CameraBackgroundImages.remove)
    - [`CameraBackgroundImages.clear()`](#bpy.types.CameraBackgroundImages.clear)
    - [`CameraBackgroundImages.bl_rna_get_subclass()`](#bpy.types.CameraBackgroundImages.bl_rna_get_subclass)
    - [`CameraBackgroundImages.bl_rna_get_subclass_py()`](#bpy.types.CameraBackgroundImages.bl_rna_get_subclass_py)
