...
# NodeSeparateBundleItems(bpy\_struct)[¶](#nodeseparatebundleitems-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.NodeSeparateBundleItems(*bpy\_struct*)[¶](#bpy.types.NodeSeparateBundleItems "Link to this definition")
:   Collection of separate bundle items

    new(*socket\_type*, *name*)[¶](#bpy.types.NodeSeparateBundleItems.new "Link to this definition")
    :   Add an item at the end
        ...
        Return type:
        :   [`NodeSeparateBundleItem`](NodeSeparateBundleItem.md#bpy.types.NodeSeparateBundleItem "bpy.types.NodeSeparateBundleItem")

    remove(*item*)[¶](#bpy.types.NodeSeparateBundleItems.remove "Link to this definition")
    :   Remove an item

        Parameters:
        :   **item** ([`NodeSeparateBundleItem`](NodeSeparateBundleItem.md#bpy.types.NodeSeparateBundleItem "bpy.types.NodeSeparateBundleItem"), (never None)) – Item, The item to remove

    clear()[¶](#bpy.types.NodeSeparateBundleItems.clear "Link to this definition")
    :   Remove all items

    move(*from\_index*, *to\_index*)[¶](#bpy.types.NodeSeparateBundleItems.move "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.NodeSeparateBundleItems.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.NodeSeparateBundleItems.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`NodeSeparateBundle.bundle_items`](NodeSeparateBundle.md#bpy.types.NodeSeparateBundle.bundle_items "bpy.types.NodeSeparateBundle.bundle_items") |  |
...
NodeSeparateBundleItem(bpy\_struct)](NodeSeparateBundleItem.md)
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.NodeSeparateBundleItems.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.NodeSeparateBundleItems.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* NodeSeparateBundleItems(bpy\_struct)
  + [`NodeSeparateBundleItems`](#bpy.types.NodeSeparateBundleItems)
    - [`NodeSeparateBundleItems.new()`](#bpy.types.NodeSeparateBundleItems.new)
    - [`NodeSeparateBundleItems.remove()`](#bpy.types.NodeSeparateBundleItems.remove)
    - [`NodeSeparateBundleItems.clear()`](#bpy.types.NodeSeparateBundleItems.clear)
    - [`NodeSeparateBundleItems.move()`](#bpy.types.NodeSeparateBundleItems.move)
    - [`NodeSeparateBundleItems.bl_rna_get_subclass()`](#bpy.types.NodeSeparateBundleItems.bl_rna_get_subclass)
    - [`NodeSeparateBundleItems.bl_rna_get_subclass_py()`](#bpy.types.NodeSeparateBundleItems.bl_rna_get_subclass_py)
