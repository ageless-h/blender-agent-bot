...
# NodeMenuSwitchItems(bpy\_struct)[¶](#nodemenuswitchitems-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.NodeMenuSwitchItems(*bpy\_struct*)[¶](#bpy.types.NodeMenuSwitchItems "Link to this definition")
:   Collection of items that make up an enum

    new(*name*)[¶](#bpy.types.NodeMenuSwitchItems.new "Link to this definition")
    ...
    remove(*item*)[¶](#bpy.types.NodeMenuSwitchItems.remove "Link to this definition")
    :   Remove an item

        Parameters:
        :   **item** ([`NodeEnumItem`](NodeEnumItem.md#bpy.types.NodeEnumItem "bpy.types.NodeEnumItem"), (never None)) – Item, The item to remove

    clear()[¶](#bpy.types.NodeMenuSwitchItems.clear "Link to this definition")
    :   Remove all items

    move(*from\_index*, *to\_index*)[¶](#bpy.types.NodeMenuSwitchItems.move "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.NodeMenuSwitchItems.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.NodeMenuSwitchItems.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`GeometryNodeMenuSwitch.enum_items`](GeometryNodeMenuSwitch.md#bpy.types.GeometryNodeMenuSwitch.enum_items "bpy.types.GeometryNodeMenuSwitch.enum_items") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.NodeMenuSwitchItems.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.NodeMenuSwitchItems.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* NodeMenuSwitchItems(bpy\_struct)
  + [`NodeMenuSwitchItems`](#bpy.types.NodeMenuSwitchItems)
    - [`NodeMenuSwitchItems.new()`](#bpy.types.NodeMenuSwitchItems.new)
    - [`NodeMenuSwitchItems.remove()`](#bpy.types.NodeMenuSwitchItems.remove)
    - [`NodeMenuSwitchItems.clear()`](#bpy.types.NodeMenuSwitchItems.clear)
    - [`NodeMenuSwitchItems.move()`](#bpy.types.NodeMenuSwitchItems.move)
    - [`NodeMenuSwitchItems.bl_rna_get_subclass()`](#bpy.types.NodeMenuSwitchItems.bl_rna_get_subclass)
    - [`NodeMenuSwitchItems.bl_rna_get_subclass_py()`](#bpy.types.NodeMenuSwitchItems.bl_rna_get_subclass_py)
