...
# BlendDataCollections(bpy\_struct)[¶](#blenddatacollections-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.BlendDataCollections(*bpy\_struct*)[¶](#bpy.types.BlendDataCollections "Link to this definition")
:   Collection of collections

    new(*name*)[¶](#bpy.types.BlendDataCollections.new "Link to this definition")
    ...
    remove(*collection*, *\**, *do\_unlink=True*, *do\_id\_user=True*, *do\_ui\_user=True*)[¶](#bpy.types.BlendDataCollections.remove "Link to this definition")
    :   Remove a collection from the current blendfile

        Parameters:
        :   * **collection** ([`Collection`](Collection.md#bpy.types.Collection "bpy.types.Collection"), (never None)) – Collection to remove
            * **do\_unlink** (*boolean**,* *(**optional**)*) – Unlink all usages of this collection before deleting it
            * **do\_id\_user** (*boolean**,* *(**optional**)*) – Decrement user counter of all data-blocks used by this collection
            * **do\_ui\_user** (*boolean**,* *(**optional**)*) – Make sure interface does not reference this collection

    tag(*value*)[¶](#bpy.types.BlendDataCollections.tag "Link to this definition")
    :   tag

        Parameters:
        :   **value** (*boolean*) – Value

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.BlendDataCollections.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.BlendDataCollections.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`BlendData.collections`](BlendData.md#bpy.types.BlendData.collections "bpy.types.BlendData.collections") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.BlendDataCollections.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.BlendDataCollections.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* BlendDataCollections(bpy\_struct)
  + [`BlendDataCollections`](#bpy.types.BlendDataCollections)
    - [`BlendDataCollections.new()`](#bpy.types.BlendDataCollections.new)
    - [`BlendDataCollections.remove()`](#bpy.types.BlendDataCollections.remove)
    - [`BlendDataCollections.tag()`](#bpy.types.BlendDataCollections.tag)
    - [`BlendDataCollections.bl_rna_get_subclass()`](#bpy.types.BlendDataCollections.bl_rna_get_subclass)
    - [`BlendDataCollections.bl_rna_get_subclass_py()`](#bpy.types.BlendDataCollections.bl_rna_get_subclass_py)
