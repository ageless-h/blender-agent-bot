...
# TimelineMarker(bpy\_struct)[¶](#timelinemarker-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.TimelineMarker(*bpy\_struct*)[¶](#bpy.types.TimelineMarker "Link to this definition")
:   Marker for noting points in the timeline

    camera[¶](#bpy.types.TimelineMarker.camera "Link to this definition")
    :   Camera that becomes active on this frame

        Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object")

    frame[¶](#bpy.types.TimelineMarker.frame "Link to this definition")
    :   The frame on which the timeline marker appears

        Type:
        :   int in [-inf, inf], default 0

    name[¶](#bpy.types.TimelineMarker.name "Link to this definition")
    :   Type:
        :   string, default “”, (never None)

    select[¶](#bpy.types.TimelineMarker.select "Link to this definition")
    :   Marker selection state

        Type:
        :   boolean, default False

    bl\_system\_properties\_get(*\**, *do\_create=False*)[¶](#bpy.types.TimelineMarker.bl_system_properties_get "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.TimelineMarker.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.TimelineMarker.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Action.pose_markers`](Action.md#bpy.types.Action.pose_markers "bpy.types.Action.pose_markers") * [`ActionPoseMarkers.active`](ActionPoseMarkers.md#bpy.types.ActionPoseMarkers.active "bpy.types.ActionPoseMarkers.active") * [`ActionPoseMarkers.new`](ActionPoseMarkers.md#bpy.types.ActionPoseMarkers.new "bpy.types.ActionPoseMarkers.new") * [`ActionPoseMarkers.remove`](ActionPoseMarkers.md#bpy.types.ActionPoseMarkers.remove "bpy.types.ActionPoseMarkers.remove") | * [`Scene.timeline_markers`](Scene.md#bpy.types.Scene.timeline_markers "bpy.types.Scene.timeline_markers") * [`TimelineMarkers.new`](TimelineMarkers.md#bpy.types.TimelineMarkers.new "bpy.types.TimelineMarkers.new") * [`TimelineMarkers.remove`](TimelineMarkers.md#bpy.types.TimelineMarkers.remove "bpy.types.TimelineMarkers.remove") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.TimelineMarker.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.TimelineMarker.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* TimelineMarker(bpy\_struct)
  + [`TimelineMarker`](#bpy.types.TimelineMarker)
    - [`TimelineMarker.camera`](#bpy.types.TimelineMarker.camera)
    - [`TimelineMarker.frame`](#bpy.types.TimelineMarker.frame)
    - [`TimelineMarker.name`](#bpy.types.TimelineMarker.name)
    - [`TimelineMarker.select`](#bpy.types.TimelineMarker.select)
    - [`TimelineMarker.bl_system_properties_get()`](#bpy.types.TimelineMarker.bl_system_properties_get)
    - [`TimelineMarker.bl_rna_get_subclass()`](#bpy.types.TimelineMarker.bl_rna_get_subclass)
    - [`TimelineMarker.bl_rna_get_subclass_py()`](#bpy.types.TimelineMarker.bl_rna_get_subclass_py)
