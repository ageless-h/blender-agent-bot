...
# Space(bpy\_struct)[¶](#space-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

subclasses —
[`SpaceClipEditor`](SpaceClipEditor.md#bpy.types.SpaceClipEditor "bpy.types.SpaceClipEditor"), [`SpaceConsole`](SpaceConsole.md#bpy.types.SpaceConsole "bpy.types.SpaceConsole"), [`SpaceDopeSheetEditor`](SpaceDopeSheetEditor.md#bpy.types.SpaceDopeSheetEditor "bpy.types.SpaceDopeSheetEditor"), [`SpaceFileBrowser`](SpaceFileBrowser.md#bpy.types.SpaceFileBrowser "bpy.types.SpaceFileBrowser"), [`SpaceGraphEditor`](SpaceGraphEditor.md#bpy.types.SpaceGraphEditor "bpy.types.SpaceGraphEditor"), [`SpaceImageEditor`](SpaceImageEditor.md#bpy.types.SpaceImageEditor "bpy.types.SpaceImageEditor"), [`SpaceInfo`](SpaceInfo.md#bpy.types.SpaceInfo "bpy.types.SpaceInfo"), [`SpaceNLA`](SpaceNLA.md#bpy.types.SpaceNLA "bpy.types.SpaceNLA"), [`SpaceNodeEditor`](SpaceNodeEditor.md#bpy.types.SpaceNodeEditor "bpy.types.SpaceNodeEditor"), [`SpaceOutliner`](SpaceOutliner.md#bpy.types.SpaceOutliner "bpy.types.SpaceOutliner"), [`SpacePreferences`](SpacePreferences.md#bpy.types.SpacePreferences "bpy.types.SpacePreferences"), [`SpaceProperties`](SpaceProperties.md#bpy.types.SpaceProperties "bpy.types.SpaceProperties"), [`SpaceSequenceEditor`](SpaceSequenceEditor.md#bpy.types.SpaceSequenceEditor "bpy.types.SpaceSequenceEditor"), [`SpaceSpreadsheet`](SpaceSpreadsheet.md#bpy.types.SpaceSpreadsheet "bpy.types.SpaceSpreadsheet"), [`SpaceTextEditor`](SpaceTextEditor.md#bpy.types.SpaceTextEditor "bpy.types.SpaceTextEditor"), [`SpaceView3D`](SpaceView3D.md#bpy.types.SpaceView3D "bpy.types.SpaceView3D")

*class* bpy.types.Space(*bpy\_struct*)[¶](#bpy.types.Space "Link to this definition")
:   Space data for a screen area

    show\_locked\_time[¶](#bpy.types.Space.show_locked_time "Link to this definition")
    :   Synchronize the visible timeline range with other time-based editors

        Type:
        :   boolean, default False

    show\_region\_header[¶](#bpy.types.Space.show_region_header "Link to this definition")
    :   Type:
        :   boolean, default False

    type[¶](#bpy.types.Space.type "Link to this definition")
    :   Space data type
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.Space.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.Space.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
    ...
    *classmethod* draw\_handler\_add(*callback*, *args*, *region\_type*, *draw\_type*)[¶](#bpy.types.Space.draw_handler_add "Link to this definition")
    ...
    *classmethod* draw\_handler\_remove(*handler*, *region\_type*)[¶](#bpy.types.Space.draw_handler_remove "Link to this definition")
...
|  |  |
| --- | --- |
| * [`Area.spaces`](Area.md#bpy.types.Area.spaces "bpy.types.Area.spaces") * [`AreaSpaces.active`](AreaSpaces.md#bpy.types.AreaSpaces.active "bpy.types.AreaSpaces.active") | * [`Context.space_data`](Context.md#bpy.types.Context.space_data "bpy.types.Context.space_data") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.Space.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.Space.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* Space(bpy\_struct)
  + [`Space`](#bpy.types.Space)
    - [`Space.show_locked_time`](#bpy.types.Space.show_locked_time)
    - [`Space.show_region_header`](#bpy.types.Space.show_region_header)
    - [`Space.type`](#bpy.types.Space.type)
    - [`Space.bl_rna_get_subclass()`](#bpy.types.Space.bl_rna_get_subclass)
    - [`Space.bl_rna_get_subclass_py()`](#bpy.types.Space.bl_rna_get_subclass_py)
    - [`Space.draw_handler_add()`](#bpy.types.Space.draw_handler_add)
    - [`Space.draw_handler_remove()`](#bpy.types.Space.draw_handler_remove)
