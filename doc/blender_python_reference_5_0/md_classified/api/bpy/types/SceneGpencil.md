...
# SceneGpencil(bpy\_struct)[¶](#scenegpencil-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.SceneGpencil(*bpy\_struct*)[¶](#bpy.types.SceneGpencil "Link to this definition")
:   Render settings

    aa\_samples[¶](#bpy.types.SceneGpencil.aa_samples "Link to this definition")
    :   Number of supersampling anti-aliasing samples per pixel for final render

        Type:
        :   int in [1, inf], default 8

    antialias\_threshold[¶](#bpy.types.SceneGpencil.antialias_threshold "Link to this definition")
    :   Threshold for edge detection algorithm (higher values might over-blur some part of the image)

        Type:
        :   float in [0, inf], default 1.0

    antialias\_threshold\_render[¶](#bpy.types.SceneGpencil.antialias_threshold_render "Link to this definition")
    ...
    motion\_blur\_steps[¶](#bpy.types.SceneGpencil.motion_blur_steps "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.SceneGpencil.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.SceneGpencil.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Scene.grease_pencil_settings`](Scene.md#bpy.types.Scene.grease_pencil_settings "bpy.types.Scene.grease_pencil_settings") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.SceneGpencil.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.SceneGpencil.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* SceneGpencil(bpy\_struct)
  + [`SceneGpencil`](#bpy.types.SceneGpencil)
    - [`SceneGpencil.aa_samples`](#bpy.types.SceneGpencil.aa_samples)
    - [`SceneGpencil.antialias_threshold`](#bpy.types.SceneGpencil.antialias_threshold)
    - [`SceneGpencil.antialias_threshold_render`](#bpy.types.SceneGpencil.antialias_threshold_render)
    - [`SceneGpencil.motion_blur_steps`](#bpy.types.SceneGpencil.motion_blur_steps)
    - [`SceneGpencil.bl_rna_get_subclass()`](#bpy.types.SceneGpencil.bl_rna_get_subclass)
    - [`SceneGpencil.bl_rna_get_subclass_py()`](#bpy.types.SceneGpencil.bl_rna_get_subclass_py)
