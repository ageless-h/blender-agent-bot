...
# BoidRuleFollowLeader(BoidRule)[¶](#boidrulefollowleader-boidrule "Link to this heading")

base classes — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct"), [`BoidRule`](BoidRule.md#bpy.types.BoidRule "bpy.types.BoidRule")

*class* bpy.types.BoidRuleFollowLeader(*BoidRule*)[¶](#bpy.types.BoidRuleFollowLeader "Link to this definition")
:   distance[¶](#bpy.types.BoidRuleFollowLeader.distance "Link to this definition")
    :   Distance behind leader to follow

        Type:
        :   float in [0, 100], default 0.0

    object[¶](#bpy.types.BoidRuleFollowLeader.object "Link to this definition")
    :   Follow this object instead of a boid

        Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object")

    queue\_count[¶](#bpy.types.BoidRuleFollowLeader.queue_count "Link to this definition")
    :   How many boids in a line

        Type:
        :   int in [0, 100], default 0

    use\_line[¶](#bpy.types.BoidRuleFollowLeader.use_line "Link to this definition")
    :   Follow leader in a line

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.BoidRuleFollowLeader.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.BoidRuleFollowLeader.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.BoidRuleFollowLeader.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.BoidRuleFollowLeader.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* BoidRuleFollowLeader(BoidRule)
  + [`BoidRuleFollowLeader`](#bpy.types.BoidRuleFollowLeader)
    - [`BoidRuleFollowLeader.distance`](#bpy.types.BoidRuleFollowLeader.distance)
    - [`BoidRuleFollowLeader.object`](#bpy.types.BoidRuleFollowLeader.object)
    - [`BoidRuleFollowLeader.queue_count`](#bpy.types.BoidRuleFollowLeader.queue_count)
    - [`BoidRuleFollowLeader.use_line`](#bpy.types.BoidRuleFollowLeader.use_line)
    - [`BoidRuleFollowLeader.bl_rna_get_subclass()`](#bpy.types.BoidRuleFollowLeader.bl_rna_get_subclass)
    - [`BoidRuleFollowLeader.bl_rna_get_subclass_py()`](#bpy.types.BoidRuleFollowLeader.bl_rna_get_subclass_py)
