...
# ThemeCollectionColor(bpy\_struct)[¶](#themecollectioncolor-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.ThemeCollectionColor(*bpy\_struct*)[¶](#bpy.types.ThemeCollectionColor "Link to this definition")
:   Theme settings for collection colors

    color[¶](#bpy.types.ThemeCollectionColor.color "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ThemeCollectionColor.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ThemeCollectionColor.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Theme.collection_color`](Theme.md#bpy.types.Theme.collection_color "bpy.types.Theme.collection_color") |  |

[Next

ThemeCommon(bpy\_struct)](ThemeCommon.md)
[Previous
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ThemeCollectionColor.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ThemeCollectionColor.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ThemeCollectionColor(bpy\_struct)
  + [`ThemeCollectionColor`](#bpy.types.ThemeCollectionColor)
    - [`ThemeCollectionColor.color`](#bpy.types.ThemeCollectionColor.color)
    - [`ThemeCollectionColor.bl_rna_get_subclass()`](#bpy.types.ThemeCollectionColor.bl_rna_get_subclass)
    - [`ThemeCollectionColor.bl_rna_get_subclass_py()`](#bpy.types.ThemeCollectionColor.bl_rna_get_subclass_py)
