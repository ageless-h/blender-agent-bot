...
# ViewLayers(bpy\_struct)[¶](#viewlayers-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.ViewLayers(*bpy\_struct*)[¶](#bpy.types.ViewLayers "Link to this definition")
:   Collection of render layers

    new(*name*)[¶](#bpy.types.ViewLayers.new "Link to this definition")
    :   Add a view layer to scene

        Parameters:
        :   **name** (*string**,* *(**never None**)*) – New name for the view layer (not unique)

        Returns:
        :   Newly created view layer

        Return type:
        :   [`ViewLayer`](ViewLayer.md#bpy.types.ViewLayer "bpy.types.ViewLayer")

    remove(*layer*)[¶](#bpy.types.ViewLayers.remove "Link to this definition")
    :   Remove a view layer

        Parameters:
        :   **layer** ([`ViewLayer`](ViewLayer.md#bpy.types.ViewLayer "bpy.types.ViewLayer"), (never None)) – View layer to remove

    move(*from\_index*, *to\_index*)[¶](#bpy.types.ViewLayers.move "Link to this definition")
    :   Move a view layer
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ViewLayers.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ViewLayers.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Scene.view_layers`](Scene.md#bpy.types.Scene.view_layers "bpy.types.Scene.view_layers") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ViewLayers.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ViewLayers.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ViewLayers(bpy\_struct)
  + [`ViewLayers`](#bpy.types.ViewLayers)
    - [`ViewLayers.new()`](#bpy.types.ViewLayers.new)
    - [`ViewLayers.remove()`](#bpy.types.ViewLayers.remove)
    - [`ViewLayers.move()`](#bpy.types.ViewLayers.move)
    - [`ViewLayers.bl_rna_get_subclass()`](#bpy.types.ViewLayers.bl_rna_get_subclass)
    - [`ViewLayers.bl_rna_get_subclass_py()`](#bpy.types.ViewLayers.bl_rna_get_subclass_py)
