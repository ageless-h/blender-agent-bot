...
# GeometryAttributeConstraint(Constraint)[¶](#geometryattributeconstraint-constraint "Link to this heading")
...
*class* bpy.types.GeometryAttributeConstraint(*Constraint*)[¶](#bpy.types.GeometryAttributeConstraint "Link to this definition")
:   Create a constraint-based relationship with an attribute from geometry

    apply\_target\_transform[¶](#bpy.types.GeometryAttributeConstraint.apply_target_transform "Link to this definition")
    :   Apply the target object’s world transform on top of the attribute’s transform

        Type:
        :   boolean, default False

    attribute\_name[¶](#bpy.types.GeometryAttributeConstraint.attribute_name "Link to this definition")
    :   Name of the attribute to retrieve the transform from

        Type:
        :   string, default “”, (never None)

    data\_type[¶](#bpy.types.GeometryAttributeConstraint.data_type "Link to this definition")
    ...
    domain[¶](#bpy.types.GeometryAttributeConstraint.domain "Link to this definition")
    :   Attribute domain

        Type:
        :   enum in [`'POINT'`, `'EDGE'`, `'FACE'`, `'FACE_CORNER'`, `'CURVE'`, `'INSTANCE'`], default `'POINT'`

    mix\_loc[¶](#bpy.types.GeometryAttributeConstraint.mix_loc "Link to this definition")
    :   Mix Location

        Type:
        :   boolean, default False

    mix\_mode[¶](#bpy.types.GeometryAttributeConstraint.mix_mode "Link to this definition")
    ...
    mix\_rot[¶](#bpy.types.GeometryAttributeConstraint.mix_rot "Link to this definition")
    :   Mix Rotation

        Type:
        :   boolean, default False

    mix\_scl[¶](#bpy.types.GeometryAttributeConstraint.mix_scl "Link to this definition")
    :   Mix Scale

        Type:
        :   boolean, default False

    sample\_index[¶](#bpy.types.GeometryAttributeConstraint.sample_index "Link to this definition")
    :   Sample Index

        Type:
        :   int in [0, inf], default 0

    target[¶](#bpy.types.GeometryAttributeConstraint.target "Link to this definition")
    :   Target geometry object

        Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.GeometryAttributeConstraint.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.GeometryAttributeConstraint.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryAttributeConstraint.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.GeometryAttributeConstraint.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryAttributeConstraint(Constraint)
  + [`GeometryAttributeConstraint`](#bpy.types.GeometryAttributeConstraint)
    - [`GeometryAttributeConstraint.apply_target_transform`](#bpy.types.GeometryAttributeConstraint.apply_target_transform)
    - [`GeometryAttributeConstraint.attribute_name`](#bpy.types.GeometryAttributeConstraint.attribute_name)
    - [`GeometryAttributeConstraint.data_type`](#bpy.types.GeometryAttributeConstraint.data_type)
    - [`GeometryAttributeConstraint.domain`](#bpy.types.GeometryAttributeConstraint.domain)
    - [`GeometryAttributeConstraint.mix_loc`](#bpy.types.GeometryAttributeConstraint.mix_loc)
    - [`GeometryAttributeConstraint.mix_mode`](#bpy.types.GeometryAttributeConstraint.mix_mode)
    - [`GeometryAttributeConstraint.mix_rot`](#bpy.types.GeometryAttributeConstraint.mix_rot)
    - [`GeometryAttributeConstraint.mix_scl`](#bpy.types.GeometryAttributeConstraint.mix_scl)
    - [`GeometryAttributeConstraint.sample_index`](#bpy.types.GeometryAttributeConstraint.sample_index)
    - [`GeometryAttributeConstraint.target`](#bpy.types.GeometryAttributeConstraint.target)
    - [`GeometryAttributeConstraint.bl_rna_get_subclass()`](#bpy.types.GeometryAttributeConstraint.bl_rna_get_subclass)
    - [`GeometryAttributeConstraint.bl_rna_get_subclass_py()`](#bpy.types.GeometryAttributeConstraint.bl_rna_get_subclass_py)
