...
# AttributeGroupPointCloud(bpy\_struct)[¶](#attributegrouppointcloud-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.AttributeGroupPointCloud(*bpy\_struct*)[¶](#bpy.types.AttributeGroupPointCloud "Link to this definition")
:   Group of geometry attributes

    active[¶](#bpy.types.AttributeGroupPointCloud.active "Link to this definition")
    :   Active attribute

        Type:
        :   [`Attribute`](Attribute.md#bpy.types.Attribute "bpy.types.Attribute")

    active\_index[¶](#bpy.types.AttributeGroupPointCloud.active_index "Link to this definition")
    :   Active attribute index or -1 when none are active

        Type:
        :   int in [-1, inf], default 0

    new(*name*, *type*, *domain*)[¶](#bpy.types.AttributeGroupPointCloud.new "Link to this definition")
    ...
    remove(*attribute*)[¶](#bpy.types.AttributeGroupPointCloud.remove "Link to this definition")
    :   Remove attribute from geometry

        Parameters:
        :   **attribute** ([`Attribute`](Attribute.md#bpy.types.Attribute "bpy.types.Attribute"), (never None)) – Geometry Attribute

    domain\_size(*domain*)[¶](#bpy.types.AttributeGroupPointCloud.domain_size "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.AttributeGroupPointCloud.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.AttributeGroupPointCloud.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`PointCloud.attributes`](PointCloud.md#bpy.types.PointCloud.attributes "bpy.types.PointCloud.attributes") | * [`PointCloud.color_attributes`](PointCloud.md#bpy.types.PointCloud.color_attributes "bpy.types.PointCloud.color_attributes") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.AttributeGroupPointCloud.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.AttributeGroupPointCloud.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* AttributeGroupPointCloud(bpy\_struct)
  + [`AttributeGroupPointCloud`](#bpy.types.AttributeGroupPointCloud)
    - [`AttributeGroupPointCloud.active`](#bpy.types.AttributeGroupPointCloud.active)
    - [`AttributeGroupPointCloud.active_index`](#bpy.types.AttributeGroupPointCloud.active_index)
    - [`AttributeGroupPointCloud.new()`](#bpy.types.AttributeGroupPointCloud.new)
    - [`AttributeGroupPointCloud.remove()`](#bpy.types.AttributeGroupPointCloud.remove)
    - [`AttributeGroupPointCloud.domain_size()`](#bpy.types.AttributeGroupPointCloud.domain_size)
    - [`AttributeGroupPointCloud.bl_rna_get_subclass()`](#bpy.types.AttributeGroupPointCloud.bl_rna_get_subclass)
    - [`AttributeGroupPointCloud.bl_rna_get_subclass_py()`](#bpy.types.AttributeGroupPointCloud.bl_rna_get_subclass_py)
