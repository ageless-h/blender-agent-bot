...
# UIPopover(bpy\_struct)[¶](#uipopover-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.UIPopover(*bpy\_struct*)[¶](#bpy.types.UIPopover "Link to this definition")
:   layout[¶](#bpy.types.UIPopover.layout "Link to this definition")
    :   Type:
        :   [`UILayout`](UILayout.md#bpy.types.UILayout "bpy.types.UILayout"), (readonly)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.UIPopover.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.UIPopover.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`WindowManager.popover_begin__internal`](WindowManager.md#bpy.types.WindowManager.popover_begin__internal "bpy.types.WindowManager.popover_begin__internal") | * [`WindowManager.popover_end__internal`](WindowManager.md#bpy.types.WindowManager.popover_end__internal "bpy.types.WindowManager.popover_end__internal") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.UIPopover.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.UIPopover.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* UIPopover(bpy\_struct)
  + [`UIPopover`](#bpy.types.UIPopover)
    - [`UIPopover.layout`](#bpy.types.UIPopover.layout)
    - [`UIPopover.bl_rna_get_subclass()`](#bpy.types.UIPopover.bl_rna_get_subclass)
    - [`UIPopover.bl_rna_get_subclass_py()`](#bpy.types.UIPopover.bl_rna_get_subclass_py)
