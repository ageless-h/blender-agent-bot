...
# ActionLayers(bpy\_struct)[¶](#actionlayers-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.ActionLayers(*bpy\_struct*)[¶](#bpy.types.ActionLayers "Link to this definition")
:   Collection of animation layers

    new(*name*)[¶](#bpy.types.ActionLayers.new "Link to this definition")
    :   Add a layer to the Animation. Currently an Animation can only have at most one layer.
        ...
        Return type:
        :   [`ActionLayer`](ActionLayer.md#bpy.types.ActionLayer "bpy.types.ActionLayer")

    remove(*anim\_layer*)[¶](#bpy.types.ActionLayers.remove "Link to this definition")
    :   Remove the layer from the animation

        Parameters:
        :   **anim\_layer** ([`ActionLayer`](ActionLayer.md#bpy.types.ActionLayer "bpy.types.ActionLayer")) – Animation Layer, The layer to remove

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ActionLayers.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ActionLayers.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Action.layers`](Action.md#bpy.types.Action.layers "bpy.types.Action.layers") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ActionLayers.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ActionLayers.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ActionLayers(bpy\_struct)
  + [`ActionLayers`](#bpy.types.ActionLayers)
    - [`ActionLayers.new()`](#bpy.types.ActionLayers.new)
    - [`ActionLayers.remove()`](#bpy.types.ActionLayers.remove)
    - [`ActionLayers.bl_rna_get_subclass()`](#bpy.types.ActionLayers.bl_rna_get_subclass)
    - [`ActionLayers.bl_rna_get_subclass_py()`](#bpy.types.ActionLayers.bl_rna_get_subclass_py)
