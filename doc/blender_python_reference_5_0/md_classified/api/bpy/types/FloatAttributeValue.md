...
# FloatAttributeValue(bpy\_struct)[¶](#floatattributevalue-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.FloatAttributeValue(*bpy\_struct*)[¶](#bpy.types.FloatAttributeValue "Link to this definition")
:   Floating-point value in geometry attribute

    value[¶](#bpy.types.FloatAttributeValue.value "Link to this definition")
    :   Type:
        :   float in [-inf, inf], default 0.0

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.FloatAttributeValue.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.FloatAttributeValue.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`FloatAttribute.data`](FloatAttribute.md#bpy.types.FloatAttribute.data "bpy.types.FloatAttribute.data") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.FloatAttributeValue.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.FloatAttributeValue.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* FloatAttributeValue(bpy\_struct)
  + [`FloatAttributeValue`](#bpy.types.FloatAttributeValue)
    - [`FloatAttributeValue.value`](#bpy.types.FloatAttributeValue.value)
    - [`FloatAttributeValue.bl_rna_get_subclass()`](#bpy.types.FloatAttributeValue.bl_rna_get_subclass)
    - [`FloatAttributeValue.bl_rna_get_subclass_py()`](#bpy.types.FloatAttributeValue.bl_rna_get_subclass_py)
