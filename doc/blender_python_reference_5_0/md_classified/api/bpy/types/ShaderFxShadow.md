...
# ShaderFxShadow(ShaderFx)[¶](#shaderfxshadow-shaderfx "Link to this heading")

base classes — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct"), [`ShaderFx`](ShaderFx.md#bpy.types.ShaderFx "bpy.types.ShaderFx")

*class* bpy.types.ShaderFxShadow(*ShaderFx*)[¶](#bpy.types.ShaderFxShadow "Link to this definition")
:   Shadow effect

    amplitude[¶](#bpy.types.ShaderFxShadow.amplitude "Link to this definition")
    :   Amplitude of Wave

        Type:
        :   float in [0, inf], default 0.0

    blur[¶](#bpy.types.ShaderFxShadow.blur "Link to this definition")
    :   Number of pixels for blurring shadow (set to 0 to disable)

        Type:
        :   int array of 2 items in [0, 32767], default (0, 0)

    object[¶](#bpy.types.ShaderFxShadow.object "Link to this definition")
    :   Object to determine center of rotation

        Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object")

    offset[¶](#bpy.types.ShaderFxShadow.offset "Link to this definition")
    :   Offset of the shadow

        Type:
        :   int array of 2 items in [-32768, 32767], default (0, 0)

    orientation[¶](#bpy.types.ShaderFxShadow.orientation "Link to this definition")
    :   Direction of the wave

        Type:
        :   enum in [`'HORIZONTAL'`, `'VERTICAL'`], default `'HORIZONTAL'`

    period[¶](#bpy.types.ShaderFxShadow.period "Link to this definition")
    :   Period of Wave

        Type:
        :   float in [0, inf], default 0.0

    phase[¶](#bpy.types.ShaderFxShadow.phase "Link to this definition")
    :   Phase Shift of Wave

        Type:
        :   float in [-inf, inf], default 0.0

    rotation[¶](#bpy.types.ShaderFxShadow.rotation "Link to this definition")
    :   Rotation around center or object

        Type:
        :   float in [-6.28319, 6.28319], default 0.0

    samples[¶](#bpy.types.ShaderFxShadow.samples "Link to this definition")
    :   Number of Blur Samples (zero, disable blur)

        Type:
        :   int in [0, 32], default 4

    scale[¶](#bpy.types.ShaderFxShadow.scale "Link to this definition")
    :   Scale of the shadow

        Type:
        :   [`mathutils.Vector`](../../mathutils/index.md#mathutils.Vector "mathutils.Vector") of 2 items in [-inf, inf], default (0.0, 0.0)

    shadow\_color[¶](#bpy.types.ShaderFxShadow.shadow_color "Link to this definition")
    :   Color used for Shadow

        Type:
        :   float array of 4 items in [0, 1], default (0.0, 0.0, 0.0, 0.0)

    use\_object[¶](#bpy.types.ShaderFxShadow.use_object "Link to this definition")
    :   Use object as center of rotation

        Type:
        :   boolean, default False

    use\_wave[¶](#bpy.types.ShaderFxShadow.use_wave "Link to this definition")
    :   Use wave effect

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ShaderFxShadow.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ShaderFxShadow.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ShaderFxShadow.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ShaderFxShadow.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ShaderFxShadow(ShaderFx)
  + [`ShaderFxShadow`](#bpy.types.ShaderFxShadow)
    - [`ShaderFxShadow.amplitude`](#bpy.types.ShaderFxShadow.amplitude)
    - [`ShaderFxShadow.blur`](#bpy.types.ShaderFxShadow.blur)
    - [`ShaderFxShadow.object`](#bpy.types.ShaderFxShadow.object)
    - [`ShaderFxShadow.offset`](#bpy.types.ShaderFxShadow.offset)
    - [`ShaderFxShadow.orientation`](#bpy.types.ShaderFxShadow.orientation)
    - [`ShaderFxShadow.period`](#bpy.types.ShaderFxShadow.period)
    - [`ShaderFxShadow.phase`](#bpy.types.ShaderFxShadow.phase)
    - [`ShaderFxShadow.rotation`](#bpy.types.ShaderFxShadow.rotation)
    - [`ShaderFxShadow.samples`](#bpy.types.ShaderFxShadow.samples)
    - [`ShaderFxShadow.scale`](#bpy.types.ShaderFxShadow.scale)
    - [`ShaderFxShadow.shadow_color`](#bpy.types.ShaderFxShadow.shadow_color)
    - [`ShaderFxShadow.use_object`](#bpy.types.ShaderFxShadow.use_object)
    - [`ShaderFxShadow.use_wave`](#bpy.types.ShaderFxShadow.use_wave)
    - [`ShaderFxShadow.bl_rna_get_subclass()`](#bpy.types.ShaderFxShadow.bl_rna_get_subclass)
    - [`ShaderFxShadow.bl_rna_get_subclass_py()`](#bpy.types.ShaderFxShadow.bl_rna_get_subclass_py)
