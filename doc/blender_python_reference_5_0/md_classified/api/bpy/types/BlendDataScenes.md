...
# BlendDataScenes(bpy\_struct)[¶](#blenddatascenes-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.BlendDataScenes(*bpy\_struct*)[¶](#bpy.types.BlendDataScenes "Link to this definition")
:   Collection of scenes

    new(*name*)[¶](#bpy.types.BlendDataScenes.new "Link to this definition")
    ...
    remove(*scene*, *\**, *do\_unlink=True*)[¶](#bpy.types.BlendDataScenes.remove "Link to this definition")
    :   Remove a scene from the current blendfile

        Parameters:
        :   * **scene** ([`Scene`](Scene.md#bpy.types.Scene "bpy.types.Scene"), (never None)) – Scene to remove
            * **do\_unlink** (*boolean**,* *(**optional**)*) – Unlink all usages of this scene before deleting it

    tag(*value*)[¶](#bpy.types.BlendDataScenes.tag "Link to this definition")
    :   tag

        Parameters:
        :   **value** (*boolean*) – Value

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.BlendDataScenes.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.BlendDataScenes.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`BlendData.scenes`](BlendData.md#bpy.types.BlendData.scenes "bpy.types.BlendData.scenes") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.BlendDataScenes.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.BlendDataScenes.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* BlendDataScenes(bpy\_struct)
  + [`BlendDataScenes`](#bpy.types.BlendDataScenes)
    - [`BlendDataScenes.new()`](#bpy.types.BlendDataScenes.new)
    - [`BlendDataScenes.remove()`](#bpy.types.BlendDataScenes.remove)
    - [`BlendDataScenes.tag()`](#bpy.types.BlendDataScenes.tag)
    - [`BlendDataScenes.bl_rna_get_subclass()`](#bpy.types.BlendDataScenes.bl_rna_get_subclass)
    - [`BlendDataScenes.bl_rna_get_subclass_py()`](#bpy.types.BlendDataScenes.bl_rna_get_subclass_py)
