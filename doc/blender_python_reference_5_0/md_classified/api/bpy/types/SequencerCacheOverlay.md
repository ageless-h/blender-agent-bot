...
# SequencerCacheOverlay(bpy\_struct)[¶](#sequencercacheoverlay-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.SequencerCacheOverlay(*bpy\_struct*)[¶](#bpy.types.SequencerCacheOverlay "Link to this definition")
:   show\_cache[¶](#bpy.types.SequencerCacheOverlay.show_cache "Link to this definition")
    :   Visualize cached images on the timeline

        Type:
        :   boolean, default False

    show\_cache\_final\_out[¶](#bpy.types.SequencerCacheOverlay.show_cache_final_out "Link to this definition")
    :   Visualize cached complete frames

        Type:
        :   boolean, default False

    show\_cache\_raw[¶](#bpy.types.SequencerCacheOverlay.show_cache_raw "Link to this definition")
    :   Visualize cached raw images

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.SequencerCacheOverlay.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.SequencerCacheOverlay.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`SpaceSequenceEditor.cache_overlay`](SpaceSequenceEditor.md#bpy.types.SpaceSequenceEditor.cache_overlay "bpy.types.SpaceSequenceEditor.cache_overlay") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.SequencerCacheOverlay.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.SequencerCacheOverlay.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* SequencerCacheOverlay(bpy\_struct)
  + [`SequencerCacheOverlay`](#bpy.types.SequencerCacheOverlay)
    - [`SequencerCacheOverlay.show_cache`](#bpy.types.SequencerCacheOverlay.show_cache)
    - [`SequencerCacheOverlay.show_cache_final_out`](#bpy.types.SequencerCacheOverlay.show_cache_final_out)
    - [`SequencerCacheOverlay.show_cache_raw`](#bpy.types.SequencerCacheOverlay.show_cache_raw)
    - [`SequencerCacheOverlay.bl_rna_get_subclass()`](#bpy.types.SequencerCacheOverlay.bl_rna_get_subclass)
    - [`SequencerCacheOverlay.bl_rna_get_subclass_py()`](#bpy.types.SequencerCacheOverlay.bl_rna_get_subclass_py)
