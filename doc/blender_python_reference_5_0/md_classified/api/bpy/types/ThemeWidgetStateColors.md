...
# ThemeWidgetStateColors(bpy\_struct)[¶](#themewidgetstatecolors-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.ThemeWidgetStateColors(*bpy\_struct*)[¶](#bpy.types.ThemeWidgetStateColors "Link to this definition")
:   Theme settings for widget state colors

    blend[¶](#bpy.types.ThemeWidgetStateColors.blend "Link to this definition")
    :   Type:
        :   float in [0, 1], default 0.0

    error[¶](#bpy.types.ThemeWidgetStateColors.error "Link to this definition")
    :   Color for error items

        Type:
        :   float array of 4 items in [0, 1], default (0.0, 0.0, 0.0, 0.0)

    info[¶](#bpy.types.ThemeWidgetStateColors.info "Link to this definition")
    :   Color for informational items

        Type:
        :   float array of 4 items in [0, 1], default (0.0, 0.0, 0.0, 0.0)

    inner\_anim[¶](#bpy.types.ThemeWidgetStateColors.inner_anim "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    inner\_anim\_sel[¶](#bpy.types.ThemeWidgetStateColors.inner_anim_sel "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    inner\_changed[¶](#bpy.types.ThemeWidgetStateColors.inner_changed "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    inner\_changed\_sel[¶](#bpy.types.ThemeWidgetStateColors.inner_changed_sel "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    inner\_driven[¶](#bpy.types.ThemeWidgetStateColors.inner_driven "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    inner\_driven\_sel[¶](#bpy.types.ThemeWidgetStateColors.inner_driven_sel "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    inner\_key[¶](#bpy.types.ThemeWidgetStateColors.inner_key "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    inner\_key\_sel[¶](#bpy.types.ThemeWidgetStateColors.inner_key_sel "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    inner\_overridden[¶](#bpy.types.ThemeWidgetStateColors.inner_overridden "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    inner\_overridden\_sel[¶](#bpy.types.ThemeWidgetStateColors.inner_overridden_sel "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    success[¶](#bpy.types.ThemeWidgetStateColors.success "Link to this definition")
    :   Color for successful items

        Type:
        :   float array of 4 items in [0, 1], default (0.0, 0.0, 0.0, 0.0)

    warning[¶](#bpy.types.ThemeWidgetStateColors.warning "Link to this definition")
    :   Color for warning items

        Type:
        :   float array of 4 items in [0, 1], default (0.0, 0.0, 0.0, 0.0)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ThemeWidgetStateColors.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ThemeWidgetStateColors.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`ThemeUserInterface.wcol_state`](ThemeUserInterface.md#bpy.types.ThemeUserInterface.wcol_state "bpy.types.ThemeUserInterface.wcol_state") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ThemeWidgetStateColors.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ThemeWidgetStateColors.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ThemeWidgetStateColors(bpy\_struct)
  + [`ThemeWidgetStateColors`](#bpy.types.ThemeWidgetStateColors)
    - [`ThemeWidgetStateColors.blend`](#bpy.types.ThemeWidgetStateColors.blend)
    - [`ThemeWidgetStateColors.error`](#bpy.types.ThemeWidgetStateColors.error)
    - [`ThemeWidgetStateColors.info`](#bpy.types.ThemeWidgetStateColors.info)
    - [`ThemeWidgetStateColors.inner_anim`](#bpy.types.ThemeWidgetStateColors.inner_anim)
    - [`ThemeWidgetStateColors.inner_anim_sel`](#bpy.types.ThemeWidgetStateColors.inner_anim_sel)
    - [`ThemeWidgetStateColors.inner_changed`](#bpy.types.ThemeWidgetStateColors.inner_changed)
    - [`ThemeWidgetStateColors.inner_changed_sel`](#bpy.types.ThemeWidgetStateColors.inner_changed_sel)
    - [`ThemeWidgetStateColors.inner_driven`](#bpy.types.ThemeWidgetStateColors.inner_driven)
    - [`ThemeWidgetStateColors.inner_driven_sel`](#bpy.types.ThemeWidgetStateColors.inner_driven_sel)
    - [`ThemeWidgetStateColors.inner_key`](#bpy.types.ThemeWidgetStateColors.inner_key)
    - [`ThemeWidgetStateColors.inner_key_sel`](#bpy.types.ThemeWidgetStateColors.inner_key_sel)
    - [`ThemeWidgetStateColors.inner_overridden`](#bpy.types.ThemeWidgetStateColors.inner_overridden)
    - [`ThemeWidgetStateColors.inner_overridden_sel`](#bpy.types.ThemeWidgetStateColors.inner_overridden_sel)
    - [`ThemeWidgetStateColors.success`](#bpy.types.ThemeWidgetStateColors.success)
    - [`ThemeWidgetStateColors.warning`](#bpy.types.ThemeWidgetStateColors.warning)
    - [`ThemeWidgetStateColors.bl_rna_get_subclass()`](#bpy.types.ThemeWidgetStateColors.bl_rna_get_subclass)
    - [`ThemeWidgetStateColors.bl_rna_get_subclass_py()`](#bpy.types.ThemeWidgetStateColors.bl_rna_get_subclass_py)
