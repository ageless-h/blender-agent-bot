...
# PaletteColor(bpy\_struct)[¶](#palettecolor-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.PaletteColor(*bpy\_struct*)[¶](#bpy.types.PaletteColor "Link to this definition")
:   color[¶](#bpy.types.PaletteColor.color "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    strength[¶](#bpy.types.PaletteColor.strength "Link to this definition")
    :   Type:
        :   float in [0, 1], default 0.0

    weight[¶](#bpy.types.PaletteColor.weight "Link to this definition")
    :   Type:
        :   float in [0, 1], default 0.0

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.PaletteColor.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.PaletteColor.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Palette.colors`](Palette.md#bpy.types.Palette.colors "bpy.types.Palette.colors") * [`PaletteColors.active`](PaletteColors.md#bpy.types.PaletteColors.active "bpy.types.PaletteColors.active") | * [`PaletteColors.new`](PaletteColors.md#bpy.types.PaletteColors.new "bpy.types.PaletteColors.new") * [`PaletteColors.remove`](PaletteColors.md#bpy.types.PaletteColors.remove "bpy.types.PaletteColors.remove") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.PaletteColor.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.PaletteColor.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* PaletteColor(bpy\_struct)
  + [`PaletteColor`](#bpy.types.PaletteColor)
    - [`PaletteColor.color`](#bpy.types.PaletteColor.color)
    - [`PaletteColor.strength`](#bpy.types.PaletteColor.strength)
    - [`PaletteColor.weight`](#bpy.types.PaletteColor.weight)
    - [`PaletteColor.bl_rna_get_subclass()`](#bpy.types.PaletteColor.bl_rna_get_subclass)
    - [`PaletteColor.bl_rna_get_subclass_py()`](#bpy.types.PaletteColor.bl_rna_get_subclass_py)
