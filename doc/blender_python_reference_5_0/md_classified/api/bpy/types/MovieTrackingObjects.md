...
# MovieTrackingObjects(bpy\_struct)[¶](#movietrackingobjects-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.MovieTrackingObjects(*bpy\_struct*)[¶](#bpy.types.MovieTrackingObjects "Link to this definition")
:   Collection of movie tracking objects

    active[¶](#bpy.types.MovieTrackingObjects.active "Link to this definition")
    :   Active object in this tracking data object

        Type:
        :   [`MovieTrackingObject`](MovieTrackingObject.md#bpy.types.MovieTrackingObject "bpy.types.MovieTrackingObject")

    new(*name*)[¶](#bpy.types.MovieTrackingObjects.new "Link to this definition")
    ...
    remove(*object*)[¶](#bpy.types.MovieTrackingObjects.remove "Link to this definition")
    :   Remove tracking object from this movie clip

        Parameters:
        :   **object** ([`MovieTrackingObject`](MovieTrackingObject.md#bpy.types.MovieTrackingObject "bpy.types.MovieTrackingObject"), (never None)) – Motion tracking object to be removed

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.MovieTrackingObjects.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.MovieTrackingObjects.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`MovieTracking.objects`](MovieTracking.md#bpy.types.MovieTracking.objects "bpy.types.MovieTracking.objects") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.MovieTrackingObjects.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.MovieTrackingObjects.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* MovieTrackingObjects(bpy\_struct)
  + [`MovieTrackingObjects`](#bpy.types.MovieTrackingObjects)
    - [`MovieTrackingObjects.active`](#bpy.types.MovieTrackingObjects.active)
    - [`MovieTrackingObjects.new()`](#bpy.types.MovieTrackingObjects.new)
    - [`MovieTrackingObjects.remove()`](#bpy.types.MovieTrackingObjects.remove)
    - [`MovieTrackingObjects.bl_rna_get_subclass()`](#bpy.types.MovieTrackingObjects.bl_rna_get_subclass)
    - [`MovieTrackingObjects.bl_rna_get_subclass_py()`](#bpy.types.MovieTrackingObjects.bl_rna_get_subclass_py)
