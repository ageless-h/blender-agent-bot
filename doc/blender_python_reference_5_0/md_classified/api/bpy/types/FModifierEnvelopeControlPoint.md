...
# FModifierEnvelopeControlPoint(bpy\_struct)[¶](#fmodifierenvelopecontrolpoint-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.FModifierEnvelopeControlPoint(*bpy\_struct*)[¶](#bpy.types.FModifierEnvelopeControlPoint "Link to this definition")
:   Control point for envelope F-Modifier

    frame[¶](#bpy.types.FModifierEnvelopeControlPoint.frame "Link to this definition")
    :   Frame this control-point occurs on

        Type:
        :   float in [-inf, inf], default 0.0

    max[¶](#bpy.types.FModifierEnvelopeControlPoint.max "Link to this definition")
    :   Upper bound of envelope at this control-point

        Type:
        :   float in [-inf, inf], default 0.0

    min[¶](#bpy.types.FModifierEnvelopeControlPoint.min "Link to this definition")
    :   Lower bound of envelope at this control-point

        Type:
        :   float in [-inf, inf], default 0.0

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.FModifierEnvelopeControlPoint.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.FModifierEnvelopeControlPoint.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`FModifierEnvelope.control_points`](FModifierEnvelope.md#bpy.types.FModifierEnvelope.control_points "bpy.types.FModifierEnvelope.control_points") * [`FModifierEnvelopeControlPoints.add`](FModifierEnvelopeControlPoints.md#bpy.types.FModifierEnvelopeControlPoints.add "bpy.types.FModifierEnvelopeControlPoints.add") | * [`FModifierEnvelopeControlPoints.remove`](FModifierEnvelopeControlPoints.md#bpy.types.FModifierEnvelopeControlPoints.remove "bpy.types.FModifierEnvelopeControlPoints.remove") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.FModifierEnvelopeControlPoint.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.FModifierEnvelopeControlPoint.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* FModifierEnvelopeControlPoint(bpy\_struct)
  + [`FModifierEnvelopeControlPoint`](#bpy.types.FModifierEnvelopeControlPoint)
    - [`FModifierEnvelopeControlPoint.frame`](#bpy.types.FModifierEnvelopeControlPoint.frame)
    - [`FModifierEnvelopeControlPoint.max`](#bpy.types.FModifierEnvelopeControlPoint.max)
    - [`FModifierEnvelopeControlPoint.min`](#bpy.types.FModifierEnvelopeControlPoint.min)
    - [`FModifierEnvelopeControlPoint.bl_rna_get_subclass()`](#bpy.types.FModifierEnvelopeControlPoint.bl_rna_get_subclass)
    - [`FModifierEnvelopeControlPoint.bl_rna_get_subclass_py()`](#bpy.types.FModifierEnvelopeControlPoint.bl_rna_get_subclass_py)
