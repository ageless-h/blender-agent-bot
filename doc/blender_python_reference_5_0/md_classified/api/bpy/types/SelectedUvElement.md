...
# SelectedUvElement(PropertyGroup)[¶](#selecteduvelement-propertygroup "Link to this heading")
...
*class* bpy.types.SelectedUvElement(*PropertyGroup*)[¶](#bpy.types.SelectedUvElement "Link to this definition")
:   element\_index[¶](#bpy.types.SelectedUvElement.element_index "Link to this definition")
    :   Type:
        :   int in [0, inf], default 0

    face\_index[¶](#bpy.types.SelectedUvElement.face_index "Link to this definition")
    :   Type:
        :   int in [0, inf], default 0

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.SelectedUvElement.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.SelectedUvElement.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.SelectedUvElement.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.SelectedUvElement.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* SelectedUvElement(PropertyGroup)
  + [`SelectedUvElement`](#bpy.types.SelectedUvElement)
    - [`SelectedUvElement.element_index`](#bpy.types.SelectedUvElement.element_index)
    - [`SelectedUvElement.face_index`](#bpy.types.SelectedUvElement.face_index)
    - [`SelectedUvElement.bl_rna_get_subclass()`](#bpy.types.SelectedUvElement.bl_rna_get_subclass)
    - [`SelectedUvElement.bl_rna_get_subclass_py()`](#bpy.types.SelectedUvElement.bl_rna_get_subclass_py)
