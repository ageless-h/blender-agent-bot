...
# TextureSlot(bpy\_struct)[¶](#textureslot-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

subclasses —
[`BrushTextureSlot`](BrushTextureSlot.md#bpy.types.BrushTextureSlot "bpy.types.BrushTextureSlot"), [`LineStyleTextureSlot`](LineStyleTextureSlot.md#bpy.types.LineStyleTextureSlot "bpy.types.LineStyleTextureSlot"), [`ParticleSettingsTextureSlot`](ParticleSettingsTextureSlot.md#bpy.types.ParticleSettingsTextureSlot "bpy.types.ParticleSettingsTextureSlot")

*class* bpy.types.TextureSlot(*bpy\_struct*)[¶](#bpy.types.TextureSlot "Link to this definition")
:   Texture slot defining the mapping and influence of a texture

    blend\_type[¶](#bpy.types.TextureSlot.blend_type "Link to this definition")
    ...
    color[¶](#bpy.types.TextureSlot.color "Link to this definition")
    ...
    default\_value[¶](#bpy.types.TextureSlot.default_value "Link to this definition")
    :   Value to use for Ref, Spec, Amb, Emit, Alpha, RayMir, TransLu and Hard

        Type:
        :   float in [-inf, inf], default 1.0

    name[¶](#bpy.types.TextureSlot.name "Link to this definition")
    :   Texture slot name

        Type:
        :   string, default “”, (readonly, never None)

    offset[¶](#bpy.types.TextureSlot.offset "Link to this definition")
    ...
    output\_node[¶](#bpy.types.TextureSlot.output_node "Link to this definition")
    :   Which output node to use, for node-based textures

        Type:
        :   enum in [`'DEFAULT'`], default `'DEFAULT'`

    scale[¶](#bpy.types.TextureSlot.scale "Link to this definition")
    ...
    texture[¶](#bpy.types.TextureSlot.texture "Link to this definition")
    :   Texture data-block used by this texture slot

        Type:
        :   [`Texture`](Texture.md#bpy.types.Texture "bpy.types.Texture")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.TextureSlot.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.TextureSlot.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`bpy.context.texture_slot`](../context/index.md#bpy.context.texture_slot "bpy.context.texture_slot") | * [`UILayout.template_preview`](UILayout.md#bpy.types.UILayout.template_preview "bpy.types.UILayout.template_preview") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.TextureSlot.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.TextureSlot.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* TextureSlot(bpy\_struct)
  + [`TextureSlot`](#bpy.types.TextureSlot)
    - [`TextureSlot.blend_type`](#bpy.types.TextureSlot.blend_type)
    - [`TextureSlot.color`](#bpy.types.TextureSlot.color)
    - [`TextureSlot.default_value`](#bpy.types.TextureSlot.default_value)
    - [`TextureSlot.name`](#bpy.types.TextureSlot.name)
    - [`TextureSlot.offset`](#bpy.types.TextureSlot.offset)
    - [`TextureSlot.output_node`](#bpy.types.TextureSlot.output_node)
    - [`TextureSlot.scale`](#bpy.types.TextureSlot.scale)
    - [`TextureSlot.texture`](#bpy.types.TextureSlot.texture)
    - [`TextureSlot.bl_rna_get_subclass()`](#bpy.types.TextureSlot.bl_rna_get_subclass)
    - [`TextureSlot.bl_rna_get_subclass_py()`](#bpy.types.TextureSlot.bl_rna_get_subclass_py)
