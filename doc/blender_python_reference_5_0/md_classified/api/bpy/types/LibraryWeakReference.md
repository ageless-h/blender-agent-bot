...
# LibraryWeakReference(bpy\_struct)[¶](#libraryweakreference-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.LibraryWeakReference(*bpy\_struct*)[¶](#bpy.types.LibraryWeakReference "Link to this definition")
:   Read-only external reference to a linked data-block and its library file

    filepath[¶](#bpy.types.LibraryWeakReference.filepath "Link to this definition")
    :   Path to the library .blend file

        Type:
        :   string, default “”, (never None, blend relative `//` prefix supported)

    id\_name[¶](#bpy.types.LibraryWeakReference.id_name "Link to this definition")
    :   Full ID name in the library .blend file (including the two leading ‘id type’ chars)

        Type:
        :   string, default “”, (never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.LibraryWeakReference.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.LibraryWeakReference.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`ID.library_weak_reference`](ID.md#bpy.types.ID.library_weak_reference "bpy.types.ID.library_weak_reference") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.LibraryWeakReference.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.LibraryWeakReference.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* LibraryWeakReference(bpy\_struct)
  + [`LibraryWeakReference`](#bpy.types.LibraryWeakReference)
    - [`LibraryWeakReference.filepath`](#bpy.types.LibraryWeakReference.filepath)
    - [`LibraryWeakReference.id_name`](#bpy.types.LibraryWeakReference.id_name)
    - [`LibraryWeakReference.bl_rna_get_subclass()`](#bpy.types.LibraryWeakReference.bl_rna_get_subclass)
    - [`LibraryWeakReference.bl_rna_get_subclass_py()`](#bpy.types.LibraryWeakReference.bl_rna_get_subclass_py)
