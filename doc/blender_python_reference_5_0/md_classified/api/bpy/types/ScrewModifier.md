...
# ScrewModifier(Modifier)[¶](#screwmodifier-modifier "Link to this heading")
...
*class* bpy.types.ScrewModifier(*Modifier*)[¶](#bpy.types.ScrewModifier "Link to this definition")
:   Revolve edges

    angle[¶](#bpy.types.ScrewModifier.angle "Link to this definition")
    :   Angle of revolution

        Type:
        :   float in [-inf, inf], default 6.28319

    axis[¶](#bpy.types.ScrewModifier.axis "Link to this definition")
    :   Screw axis

        Type:
        :   enum in [Axis Xyz Items](../../../appendix/bpy_types_enum_items/axis_xyz_items.md#rna-enum-axis-xyz-items), default `'Z'`

    iterations[¶](#bpy.types.ScrewModifier.iterations "Link to this definition")
    :   Number of times to apply the screw operation

        Type:
        :   int in [1, 10000], default 1

    merge\_threshold[¶](#bpy.types.ScrewModifier.merge_threshold "Link to this definition")
    :   Limit below which to merge vertices

        Type:
        :   float in [0, inf], default 0.01

    object[¶](#bpy.types.ScrewModifier.object "Link to this definition")
    :   Object to define the screw axis

        Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object")

    render\_steps[¶](#bpy.types.ScrewModifier.render_steps "Link to this definition")
    :   Number of steps in the revolution

        Type:
        :   int in [1, 10000], default 16

    screw\_offset[¶](#bpy.types.ScrewModifier.screw_offset "Link to this definition")
    :   Offset the revolution along its axis

        Type:
        :   float in [-inf, inf], default 0.0

    steps[¶](#bpy.types.ScrewModifier.steps "Link to this definition")
    :   Number of steps in the revolution

        Type:
        :   int in [1, 10000], default 16

    use\_merge\_vertices[¶](#bpy.types.ScrewModifier.use_merge_vertices "Link to this definition")
    :   Merge adjacent vertices (screw offset must be zero)

        Type:
        :   boolean, default False

    use\_normal\_calculate[¶](#bpy.types.ScrewModifier.use_normal_calculate "Link to this definition")
    :   Calculate the order of edges (needed for meshes, but not curves)

        Type:
        :   boolean, default False

    use\_normal\_flip[¶](#bpy.types.ScrewModifier.use_normal_flip "Link to this definition")
    :   Flip normals of lathed faces

        Type:
        :   boolean, default False

    use\_object\_screw\_offset[¶](#bpy.types.ScrewModifier.use_object_screw_offset "Link to this definition")
    :   Use the distance between the objects to make a screw

        Type:
        :   boolean, default False

    use\_smooth\_shade[¶](#bpy.types.ScrewModifier.use_smooth_shade "Link to this definition")
    :   Output faces with smooth shading rather than flat shaded

        Type:
        :   boolean, default True

    use\_stretch\_u[¶](#bpy.types.ScrewModifier.use_stretch_u "Link to this definition")
    :   Stretch the U coordinates between 0 and 1 when UVs are present

        Type:
        :   boolean, default False

    use\_stretch\_v[¶](#bpy.types.ScrewModifier.use_stretch_v "Link to this definition")
    :   Stretch the V coordinates between 0 and 1 when UVs are present

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ScrewModifier.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ScrewModifier.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ScrewModifier.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ScrewModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ScrewModifier(Modifier)
  + [`ScrewModifier`](#bpy.types.ScrewModifier)
    - [`ScrewModifier.angle`](#bpy.types.ScrewModifier.angle)
    - [`ScrewModifier.axis`](#bpy.types.ScrewModifier.axis)
    - [`ScrewModifier.iterations`](#bpy.types.ScrewModifier.iterations)
    - [`ScrewModifier.merge_threshold`](#bpy.types.ScrewModifier.merge_threshold)
    - [`ScrewModifier.object`](#bpy.types.ScrewModifier.object)
    - [`ScrewModifier.render_steps`](#bpy.types.ScrewModifier.render_steps)
    - [`ScrewModifier.screw_offset`](#bpy.types.ScrewModifier.screw_offset)
    - [`ScrewModifier.steps`](#bpy.types.ScrewModifier.steps)
    - [`ScrewModifier.use_merge_vertices`](#bpy.types.ScrewModifier.use_merge_vertices)
    - [`ScrewModifier.use_normal_calculate`](#bpy.types.ScrewModifier.use_normal_calculate)
    - [`ScrewModifier.use_normal_flip`](#bpy.types.ScrewModifier.use_normal_flip)
    - [`ScrewModifier.use_object_screw_offset`](#bpy.types.ScrewModifier.use_object_screw_offset)
    - [`ScrewModifier.use_smooth_shade`](#bpy.types.ScrewModifier.use_smooth_shade)
    - [`ScrewModifier.use_stretch_u`](#bpy.types.ScrewModifier.use_stretch_u)
    - [`ScrewModifier.use_stretch_v`](#bpy.types.ScrewModifier.use_stretch_v)
    - [`ScrewModifier.bl_rna_get_subclass()`](#bpy.types.ScrewModifier.bl_rna_get_subclass)
    - [`ScrewModifier.bl_rna_get_subclass_py()`](#bpy.types.ScrewModifier.bl_rna_get_subclass_py)
