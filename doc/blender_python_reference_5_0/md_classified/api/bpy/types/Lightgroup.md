...
# Lightgroup(bpy\_struct)[¶](#lightgroup-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.Lightgroup(*bpy\_struct*)[¶](#bpy.types.Lightgroup "Link to this definition")
:   name[¶](#bpy.types.Lightgroup.name "Link to this definition")
    :   Name of the Lightgroup

        Type:
        :   string, default “”, (never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.Lightgroup.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.Lightgroup.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Lightgroups.add`](Lightgroups.md#bpy.types.Lightgroups.add "bpy.types.Lightgroups.add") * [`Lightgroups.remove`](Lightgroups.md#bpy.types.Lightgroups.remove "bpy.types.Lightgroups.remove") | * [`ViewLayer.active_lightgroup`](ViewLayer.md#bpy.types.ViewLayer.active_lightgroup "bpy.types.ViewLayer.active_lightgroup") * [`ViewLayer.lightgroups`](ViewLayer.md#bpy.types.ViewLayer.lightgroups "bpy.types.ViewLayer.lightgroups") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.Lightgroup.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.Lightgroup.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* Lightgroup(bpy\_struct)
  + [`Lightgroup`](#bpy.types.Lightgroup)
    - [`Lightgroup.name`](#bpy.types.Lightgroup.name)
    - [`Lightgroup.bl_rna_get_subclass()`](#bpy.types.Lightgroup.bl_rna_get_subclass)
    - [`Lightgroup.bl_rna_get_subclass_py()`](#bpy.types.Lightgroup.bl_rna_get_subclass_py)
