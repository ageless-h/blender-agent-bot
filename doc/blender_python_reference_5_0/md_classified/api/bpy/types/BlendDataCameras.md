...
# BlendDataCameras(bpy\_struct)[¶](#blenddatacameras-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.BlendDataCameras(*bpy\_struct*)[¶](#bpy.types.BlendDataCameras "Link to this definition")
:   Collection of cameras

    new(*name*)[¶](#bpy.types.BlendDataCameras.new "Link to this definition")
    :   Add a new camera to the main database
        ...
        Return type:
        :   [`Camera`](Camera.md#bpy.types.Camera "bpy.types.Camera")

    remove(*camera*, *\**, *do\_unlink=True*, *do\_id\_user=True*, *do\_ui\_user=True*)[¶](#bpy.types.BlendDataCameras.remove "Link to this definition")
    :   Remove a camera from the current blendfile

        Parameters:
        :   * **camera** ([`Camera`](Camera.md#bpy.types.Camera "bpy.types.Camera"), (never None)) – Camera to remove
            * **do\_unlink** (*boolean**,* *(**optional**)*) – Unlink all usages of this camera before deleting it (WARNING: will also delete objects instancing that camera data)
            * **do\_id\_user** (*boolean**,* *(**optional**)*) – Decrement user counter of all data-blocks used by this camera
            * **do\_ui\_user** (*boolean**,* *(**optional**)*) – Make sure interface does not reference this camera

    tag(*value*)[¶](#bpy.types.BlendDataCameras.tag "Link to this definition")
    :   tag

        Parameters:
        :   **value** (*boolean*) – Value

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.BlendDataCameras.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.BlendDataCameras.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`BlendData.cameras`](BlendData.md#bpy.types.BlendData.cameras "bpy.types.BlendData.cameras") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.BlendDataCameras.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.BlendDataCameras.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* BlendDataCameras(bpy\_struct)
  + [`BlendDataCameras`](#bpy.types.BlendDataCameras)
    - [`BlendDataCameras.new()`](#bpy.types.BlendDataCameras.new)
    - [`BlendDataCameras.remove()`](#bpy.types.BlendDataCameras.remove)
    - [`BlendDataCameras.tag()`](#bpy.types.BlendDataCameras.tag)
    - [`BlendDataCameras.bl_rna_get_subclass()`](#bpy.types.BlendDataCameras.bl_rna_get_subclass)
    - [`BlendDataCameras.bl_rna_get_subclass_py()`](#bpy.types.BlendDataCameras.bl_rna_get_subclass_py)
