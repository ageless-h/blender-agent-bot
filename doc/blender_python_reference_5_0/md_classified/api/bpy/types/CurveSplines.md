...
# CurveSplines(bpy\_struct)[¶](#curvesplines-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.CurveSplines(*bpy\_struct*)[¶](#bpy.types.CurveSplines "Link to this definition")
:   Collection of curve splines

    active[¶](#bpy.types.CurveSplines.active "Link to this definition")
    :   Active curve spline

        Type:
        :   [`Spline`](Spline.md#bpy.types.Spline "bpy.types.Spline")

    new(*type*)[¶](#bpy.types.CurveSplines.new "Link to this definition")
    ...
    remove(*spline*)[¶](#bpy.types.CurveSplines.remove "Link to this definition")
    :   Remove a spline from a curve

        Parameters:
        :   **spline** ([`Spline`](Spline.md#bpy.types.Spline "bpy.types.Spline"), (never None)) – The spline to remove

    clear()[¶](#bpy.types.CurveSplines.clear "Link to this definition")
    :   Remove all splines from a curve

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.CurveSplines.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.CurveSplines.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Curve.splines`](Curve.md#bpy.types.Curve.splines "bpy.types.Curve.splines") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CurveSplines.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.CurveSplines.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CurveSplines(bpy\_struct)
  + [`CurveSplines`](#bpy.types.CurveSplines)
    - [`CurveSplines.active`](#bpy.types.CurveSplines.active)
    - [`CurveSplines.new()`](#bpy.types.CurveSplines.new)
    - [`CurveSplines.remove()`](#bpy.types.CurveSplines.remove)
    - [`CurveSplines.clear()`](#bpy.types.CurveSplines.clear)
    - [`CurveSplines.bl_rna_get_subclass()`](#bpy.types.CurveSplines.bl_rna_get_subclass)
    - [`CurveSplines.bl_rna_get_subclass_py()`](#bpy.types.CurveSplines.bl_rna_get_subclass_py)
