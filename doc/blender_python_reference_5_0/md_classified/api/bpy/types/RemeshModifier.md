...
# RemeshModifier(Modifier)[¶](#remeshmodifier-modifier "Link to this heading")
...
*class* bpy.types.RemeshModifier(*Modifier*)[¶](#bpy.types.RemeshModifier "Link to this definition")
:   Generate a new surface with regular topology that follows the shape of the input mesh

    adaptivity[¶](#bpy.types.RemeshModifier.adaptivity "Link to this definition")
    ...
    mode[¶](#bpy.types.RemeshModifier.mode "Link to this definition")
    :   * `BLOCKS`
    ...
    use\_remove\_disconnected[¶](#bpy.types.RemeshModifier.use_remove_disconnected "Link to this definition")
    :   Type:
        :   boolean, default True

    use\_smooth\_shade[¶](#bpy.types.RemeshModifier.use_smooth_shade "Link to this definition")
    :   Output faces with smooth shading rather than flat shaded

        Type:
        :   boolean, default False

    voxel\_size[¶](#bpy.types.RemeshModifier.voxel_size "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.RemeshModifier.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.RemeshModifier.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.RemeshModifier.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.RemeshModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* RemeshModifier(Modifier)
  + [`RemeshModifier`](#bpy.types.RemeshModifier)
    - [`RemeshModifier.adaptivity`](#bpy.types.RemeshModifier.adaptivity)
    - [`RemeshModifier.mode`](#bpy.types.RemeshModifier.mode)
    - [`RemeshModifier.octree_depth`](#bpy.types.RemeshModifier.octree_depth)
    - [`RemeshModifier.scale`](#bpy.types.RemeshModifier.scale)
    - [`RemeshModifier.sharpness`](#bpy.types.RemeshModifier.sharpness)
    - [`RemeshModifier.threshold`](#bpy.types.RemeshModifier.threshold)
    - [`RemeshModifier.use_remove_disconnected`](#bpy.types.RemeshModifier.use_remove_disconnected)
    - [`RemeshModifier.use_smooth_shade`](#bpy.types.RemeshModifier.use_smooth_shade)
    - [`RemeshModifier.voxel_size`](#bpy.types.RemeshModifier.voxel_size)
    - [`RemeshModifier.bl_rna_get_subclass()`](#bpy.types.RemeshModifier.bl_rna_get_subclass)
    - [`RemeshModifier.bl_rna_get_subclass_py()`](#bpy.types.RemeshModifier.bl_rna_get_subclass_py)
