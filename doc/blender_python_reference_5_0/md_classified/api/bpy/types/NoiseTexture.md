...
# NoiseTexture(Texture)[¶](#noisetexture-texture "Link to this heading")
...
*class* bpy.types.NoiseTexture(*Texture*)[¶](#bpy.types.NoiseTexture "Link to this definition")
:   Procedural noise texture

    users\_material[¶](#bpy.types.NoiseTexture.users_material "Link to this definition")
    ...
    users\_object\_modifier[¶](#bpy.types.NoiseTexture.users_object_modifier "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.NoiseTexture.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.NoiseTexture.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
NodesModifierWarning(bpy\_struct)](NodesModifierWarning.md)
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.NoiseTexture.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.NoiseTexture.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* NoiseTexture(Texture)
  + [`NoiseTexture`](#bpy.types.NoiseTexture)
    - [`NoiseTexture.users_material`](#bpy.types.NoiseTexture.users_material)
    - [`NoiseTexture.users_object_modifier`](#bpy.types.NoiseTexture.users_object_modifier)
    - [`NoiseTexture.bl_rna_get_subclass()`](#bpy.types.NoiseTexture.bl_rna_get_subclass)
    - [`NoiseTexture.bl_rna_get_subclass_py()`](#bpy.types.NoiseTexture.bl_rna_get_subclass_py)
