...
# Float4x4Attribute(Attribute)[¶](#float4x4attribute-attribute "Link to this heading")
...
*class* bpy.types.Float4x4Attribute(*Attribute*)[¶](#bpy.types.Float4x4Attribute "Link to this definition")
:   Geometry attribute that stores a 4 by 4 float matrix

    data[¶](#bpy.types.Float4x4Attribute.data "Link to this definition")
    :   Type:
        :   [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`Float4x4AttributeValue`](Float4x4AttributeValue.md#bpy.types.Float4x4AttributeValue "bpy.types.Float4x4AttributeValue"), (readonly)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.Float4x4Attribute.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.Float4x4Attribute.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.Float4x4Attribute.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.Float4x4Attribute.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* Float4x4Attribute(Attribute)
  + [`Float4x4Attribute`](#bpy.types.Float4x4Attribute)
    - [`Float4x4Attribute.data`](#bpy.types.Float4x4Attribute.data)
    - [`Float4x4Attribute.bl_rna_get_subclass()`](#bpy.types.Float4x4Attribute.bl_rna_get_subclass)
    - [`Float4x4Attribute.bl_rna_get_subclass_py()`](#bpy.types.Float4x4Attribute.bl_rna_get_subclass_py)
