...
# SceneRenderView(bpy\_struct)[¶](#scenerenderview-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.SceneRenderView(*bpy\_struct*)[¶](#bpy.types.SceneRenderView "Link to this definition")
:   Render viewpoint for 3D stereo and multiview rendering

    camera\_suffix[¶](#bpy.types.SceneRenderView.camera_suffix "Link to this definition")
    :   Suffix to identify the cameras to use, and added to the render images for this view

        Type:
        :   string, default “”, (never None)

    file\_suffix[¶](#bpy.types.SceneRenderView.file_suffix "Link to this definition")
    :   Suffix added to the render images for this view

        Type:
        :   string, default “”, (never None)

    name[¶](#bpy.types.SceneRenderView.name "Link to this definition")
    :   Render view name

        Type:
        :   string, default “”, (never None)

    use[¶](#bpy.types.SceneRenderView.use "Link to this definition")
    :   Disable or enable the render view

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.SceneRenderView.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.SceneRenderView.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`RenderViews.active`](RenderViews.md#bpy.types.RenderViews.active "bpy.types.RenderViews.active") * [`RenderViews.new`](RenderViews.md#bpy.types.RenderViews.new "bpy.types.RenderViews.new") * [`RenderViews.remove`](RenderViews.md#bpy.types.RenderViews.remove "bpy.types.RenderViews.remove") | * [`RenderSettings.stereo_views`](RenderSettings.md#bpy.types.RenderSettings.stereo_views "bpy.types.RenderSettings.stereo_views") * [`RenderSettings.views`](RenderSettings.md#bpy.types.RenderSettings.views "bpy.types.RenderSettings.views") |

[Next

SceneStrip(Strip)](SceneStrip.md)
[Previous
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.SceneRenderView.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.SceneRenderView.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* SceneRenderView(bpy\_struct)
  + [`SceneRenderView`](#bpy.types.SceneRenderView)
    - [`SceneRenderView.camera_suffix`](#bpy.types.SceneRenderView.camera_suffix)
    - [`SceneRenderView.file_suffix`](#bpy.types.SceneRenderView.file_suffix)
    - [`SceneRenderView.name`](#bpy.types.SceneRenderView.name)
    - [`SceneRenderView.use`](#bpy.types.SceneRenderView.use)
    - [`SceneRenderView.bl_rna_get_subclass()`](#bpy.types.SceneRenderView.bl_rna_get_subclass)
    - [`SceneRenderView.bl_rna_get_subclass_py()`](#bpy.types.SceneRenderView.bl_rna_get_subclass_py)
