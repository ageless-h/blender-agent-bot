...
# BlendDataObjects(bpy\_struct)[¶](#blenddataobjects-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.BlendDataObjects(*bpy\_struct*)[¶](#bpy.types.BlendDataObjects "Link to this definition")
:   Collection of objects

    new(*name*, *object\_data*)[¶](#bpy.types.BlendDataObjects.new "Link to this definition")
    :   Add a new object to the main database

        Parameters:
        :   * **name** (*string**,* *(**never None**)*) – New name for the data-block
            * **object\_data** ([`ID`](ID.md#bpy.types.ID "bpy.types.ID")) – Object data or None for an empty object
    ...
    remove(*object*, *\**, *do\_unlink=True*, *do\_id\_user=True*, *do\_ui\_user=True*)[¶](#bpy.types.BlendDataObjects.remove "Link to this definition")
    :   Remove an object from the current blendfile

        Parameters:
        :   * **object** ([`Object`](Object.md#bpy.types.Object "bpy.types.Object"), (never None)) – Object to remove
            * **do\_unlink** (*boolean**,* *(**optional**)*) – Unlink all usages of this object before deleting it
            * **do\_id\_user** (*boolean**,* *(**optional**)*) – Decrement user counter of all data-blocks used by this object
            * **do\_ui\_user** (*boolean**,* *(**optional**)*) – Make sure interface does not reference this object

    tag(*value*)[¶](#bpy.types.BlendDataObjects.tag "Link to this definition")
    :   tag

        Parameters:
        :   **value** (*boolean*) – Value

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.BlendDataObjects.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.BlendDataObjects.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`BlendData.objects`](BlendData.md#bpy.types.BlendData.objects "bpy.types.BlendData.objects") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.BlendDataObjects.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.BlendDataObjects.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* BlendDataObjects(bpy\_struct)
  + [`BlendDataObjects`](#bpy.types.BlendDataObjects)
    - [`BlendDataObjects.new()`](#bpy.types.BlendDataObjects.new)
    - [`BlendDataObjects.remove()`](#bpy.types.BlendDataObjects.remove)
    - [`BlendDataObjects.tag()`](#bpy.types.BlendDataObjects.tag)
    - [`BlendDataObjects.bl_rna_get_subclass()`](#bpy.types.BlendDataObjects.bl_rna_get_subclass)
    - [`BlendDataObjects.bl_rna_get_subclass_py()`](#bpy.types.BlendDataObjects.bl_rna_get_subclass_py)
