...
# NodeClosureInputItems(bpy\_struct)[¶](#nodeclosureinputitems-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.NodeClosureInputItems(*bpy\_struct*)[¶](#bpy.types.NodeClosureInputItems "Link to this definition")
:   new(*socket\_type*, *name*)[¶](#bpy.types.NodeClosureInputItems.new "Link to this definition")
    :   Add an item at the end
        ...
        Return type:
        :   [`NodeClosureInputItem`](NodeClosureInputItem.md#bpy.types.NodeClosureInputItem "bpy.types.NodeClosureInputItem")

    remove(*item*)[¶](#bpy.types.NodeClosureInputItems.remove "Link to this definition")
    :   Remove an item

        Parameters:
        :   **item** ([`NodeClosureInputItem`](NodeClosureInputItem.md#bpy.types.NodeClosureInputItem "bpy.types.NodeClosureInputItem"), (never None)) – Item, The item to remove

    clear()[¶](#bpy.types.NodeClosureInputItems.clear "Link to this definition")
    :   Remove all items

    move(*from\_index*, *to\_index*)[¶](#bpy.types.NodeClosureInputItems.move "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.NodeClosureInputItems.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.NodeClosureInputItems.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`NodeClosureOutput.input_items`](NodeClosureOutput.md#bpy.types.NodeClosureOutput.input_items "bpy.types.NodeClosureOutput.input_items") |  |
...
NodeClosureInputItem(bpy\_struct)](NodeClosureInputItem.md)
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.NodeClosureInputItems.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.NodeClosureInputItems.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* NodeClosureInputItems(bpy\_struct)
  + [`NodeClosureInputItems`](#bpy.types.NodeClosureInputItems)
    - [`NodeClosureInputItems.new()`](#bpy.types.NodeClosureInputItems.new)
    - [`NodeClosureInputItems.remove()`](#bpy.types.NodeClosureInputItems.remove)
    - [`NodeClosureInputItems.clear()`](#bpy.types.NodeClosureInputItems.clear)
    - [`NodeClosureInputItems.move()`](#bpy.types.NodeClosureInputItems.move)
    - [`NodeClosureInputItems.bl_rna_get_subclass()`](#bpy.types.NodeClosureInputItems.bl_rna_get_subclass)
    - [`NodeClosureInputItems.bl_rna_get_subclass_py()`](#bpy.types.NodeClosureInputItems.bl_rna_get_subclass_py)
