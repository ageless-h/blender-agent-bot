...
# WeightedNormalModifier(Modifier)[¶](#weightednormalmodifier-modifier "Link to this heading")
...
*class* bpy.types.WeightedNormalModifier(*Modifier*)[¶](#bpy.types.WeightedNormalModifier "Link to this definition")
:   invert\_vertex\_group[¶](#bpy.types.WeightedNormalModifier.invert_vertex_group "Link to this definition")
    :   Invert vertex group influence

        Type:
        :   boolean, default False

    keep\_sharp[¶](#bpy.types.WeightedNormalModifier.keep_sharp "Link to this definition")
    :   Keep sharp edges as computed for default custom normals, instead of setting a single weighted normal for each vertex

        Type:
        :   boolean, default False

    mode[¶](#bpy.types.WeightedNormalModifier.mode "Link to this definition")
    ...
    thresh[¶](#bpy.types.WeightedNormalModifier.thresh "Link to this definition")
    :   Threshold value for different weights to be considered equal

        Type:
        :   float in [0, 10], default 0.01

    use\_face\_influence[¶](#bpy.types.WeightedNormalModifier.use_face_influence "Link to this definition")
    :   Use influence of face for weighting

        Type:
        :   boolean, default False

    vertex\_group[¶](#bpy.types.WeightedNormalModifier.vertex_group "Link to this definition")
    :   Vertex group name for modifying the selected areas

        Type:
        :   string, default “”, (never None)

    weight[¶](#bpy.types.WeightedNormalModifier.weight "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.WeightedNormalModifier.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.WeightedNormalModifier.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.WeightedNormalModifier.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.WeightedNormalModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* WeightedNormalModifier(Modifier)
  + [`WeightedNormalModifier`](#bpy.types.WeightedNormalModifier)
    - [`WeightedNormalModifier.invert_vertex_group`](#bpy.types.WeightedNormalModifier.invert_vertex_group)
    - [`WeightedNormalModifier.keep_sharp`](#bpy.types.WeightedNormalModifier.keep_sharp)
    - [`WeightedNormalModifier.mode`](#bpy.types.WeightedNormalModifier.mode)
    - [`WeightedNormalModifier.thresh`](#bpy.types.WeightedNormalModifier.thresh)
    - [`WeightedNormalModifier.use_face_influence`](#bpy.types.WeightedNormalModifier.use_face_influence)
    - [`WeightedNormalModifier.vertex_group`](#bpy.types.WeightedNormalModifier.vertex_group)
    - [`WeightedNormalModifier.weight`](#bpy.types.WeightedNormalModifier.weight)
    - [`WeightedNormalModifier.bl_rna_get_subclass()`](#bpy.types.WeightedNormalModifier.bl_rna_get_subclass)
    - [`WeightedNormalModifier.bl_rna_get_subclass_py()`](#bpy.types.WeightedNormalModifier.bl_rna_get_subclass_py)
