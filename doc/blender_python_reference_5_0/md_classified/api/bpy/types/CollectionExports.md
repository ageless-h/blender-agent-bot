...
# CollectionExports(bpy\_struct)[¶](#collectionexports-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.CollectionExports(*bpy\_struct*)[¶](#bpy.types.CollectionExports "Link to this definition")
:   Collection of export handlers

    new(*type*, *\**, *name=''*)[¶](#bpy.types.CollectionExports.new "Link to this definition")
    :   Add an export handler to the collection
        ...
        Return type:
        :   [`CollectionExport`](CollectionExport.md#bpy.types.CollectionExport "bpy.types.CollectionExport")

    remove(*exporter*)[¶](#bpy.types.CollectionExports.remove "Link to this definition")
    :   Remove an export handler from the collection

        Parameters:
        :   **exporter** ([`CollectionExport`](CollectionExport.md#bpy.types.CollectionExport "bpy.types.CollectionExport")) – Export Handler to remove

    move(*from\_index*, *to\_index*)[¶](#bpy.types.CollectionExports.move "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.CollectionExports.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.CollectionExports.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Collection.exporters`](Collection.md#bpy.types.Collection.exporters "bpy.types.Collection.exporters") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CollectionExports.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.CollectionExports.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CollectionExports(bpy\_struct)
  + [`CollectionExports`](#bpy.types.CollectionExports)
    - [`CollectionExports.new()`](#bpy.types.CollectionExports.new)
    - [`CollectionExports.remove()`](#bpy.types.CollectionExports.remove)
    - [`CollectionExports.move()`](#bpy.types.CollectionExports.move)
    - [`CollectionExports.bl_rna_get_subclass()`](#bpy.types.CollectionExports.bl_rna_get_subclass)
    - [`CollectionExports.bl_rna_get_subclass_py()`](#bpy.types.CollectionExports.bl_rna_get_subclass_py)
