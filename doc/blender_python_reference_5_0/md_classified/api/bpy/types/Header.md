...
# Header(bpy\_struct)[¶](#header-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.Header(*bpy\_struct*)[¶](#bpy.types.Header "Link to this definition")
:   Editor header containing UI elements

    bl\_idname[¶](#bpy.types.Header.bl_idname "Link to this definition")
    :   If this is set, the header gets a custom ID, otherwise it takes the name of the class used to define the header; for example, if the class name is “OBJECT\_HT\_hello”, and bl\_idname is not set by the script, then bl\_idname = “OBJECT\_HT\_hello”

        Type:
        :   string, default “”, (never None)

    bl\_region\_type[¶](#bpy.types.Header.bl_region_type "Link to this definition")
    :   The region where the header is going to be used in (defaults to header region)

        Type:
        :   enum in [Region Type Items](../../../appendix/bpy_types_enum_items/region_type_items.md#rna-enum-region-type-items), default `'HEADER'`

    bl\_space\_type[¶](#bpy.types.Header.bl_space_type "Link to this definition")
    ...
    layout[¶](#bpy.types.Header.layout "Link to this definition")
    :   Structure of the header in the UI

        Type:
        :   [`UILayout`](UILayout.md#bpy.types.UILayout "bpy.types.UILayout"), (readonly)

    draw(*context*)[¶](#bpy.types.Header.draw "Link to this definition")
    :   Draw UI elements into the header UI layout

    *classmethod* append(*draw\_func*)[¶](#bpy.types.Header.append "Link to this definition")
    :   Append a draw function to this menu,
        takes the same arguments as the menus draw function

    *classmethod* is\_extended()[¶](#bpy.types.Header.is_extended "Link to this definition")

    *classmethod* prepend(*draw\_func*)[¶](#bpy.types.Header.prepend "Link to this definition")
    :   Prepend a draw function to this menu, takes the same arguments as
        the menus draw function

    *classmethod* remove(*draw\_func*)[¶](#bpy.types.Header.remove "Link to this definition")
    :   Remove a draw function that has been added to this menu.

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.Header.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.Header.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.Header.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.Header.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* Header(bpy\_struct)
  + [`Header`](#bpy.types.Header)
    - [`Header.bl_idname`](#bpy.types.Header.bl_idname)
    - [`Header.bl_region_type`](#bpy.types.Header.bl_region_type)
    - [`Header.bl_space_type`](#bpy.types.Header.bl_space_type)
    - [`Header.layout`](#bpy.types.Header.layout)
    - [`Header.draw()`](#bpy.types.Header.draw)
    - [`Header.append()`](#bpy.types.Header.append)
    - [`Header.is_extended()`](#bpy.types.Header.is_extended)
    - [`Header.prepend()`](#bpy.types.Header.prepend)
    - [`Header.remove()`](#bpy.types.Header.remove)
    - [`Header.bl_rna_get_subclass()`](#bpy.types.Header.bl_rna_get_subclass)
    - [`Header.bl_rna_get_subclass_py()`](#bpy.types.Header.bl_rna_get_subclass_py)
