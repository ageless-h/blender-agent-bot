...
# Screen(ID)[¶](#screen-id "Link to this heading")

base classes — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct"), [`ID`](ID.md#bpy.types.ID "bpy.types.ID")

*class* bpy.types.Screen(*ID*)[¶](#bpy.types.Screen "Link to this definition")
:   Screen data-block, defining the layout of areas in a window

    areas[¶](#bpy.types.Screen.areas "Link to this definition")
    :   Areas the screen is subdivided into

        Type:
        :   [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`Area`](Area.md#bpy.types.Area "bpy.types.Area"), (readonly)

    is\_animation\_playing[¶](#bpy.types.Screen.is_animation_playing "Link to this definition")
    :   Animation playback is active

        Type:
        :   boolean, default False, (readonly)

    is\_scrubbing[¶](#bpy.types.Screen.is_scrubbing "Link to this definition")
    :   True when the user is scrubbing through time

        Type:
        :   boolean, default False, (readonly)

    is\_temporary[¶](#bpy.types.Screen.is_temporary "Link to this definition")
    :   Type:
        :   boolean, default False, (readonly)

    show\_fullscreen[¶](#bpy.types.Screen.show_fullscreen "Link to this definition")
    :   An area is maximized, filling this screen

        Type:
        :   boolean, default False, (readonly)

    show\_statusbar[¶](#bpy.types.Screen.show_statusbar "Link to this definition")
    :   Show status bar

        Type:
        :   boolean, default False

    use\_follow[¶](#bpy.types.Screen.use_follow "Link to this definition")
    :   Follow current frame in editors

        Type:
        :   boolean, default False

    use\_play\_3d\_editors[¶](#bpy.types.Screen.use_play_3d_editors "Link to this definition")
    :   Type:
        :   boolean, default False

    use\_play\_animation\_editors[¶](#bpy.types.Screen.use_play_animation_editors "Link to this definition")
    :   Type:
        :   boolean, default False

    use\_play\_clip\_editors[¶](#bpy.types.Screen.use_play_clip_editors "Link to this definition")
    :   Type:
        :   boolean, default False

    use\_play\_image\_editors[¶](#bpy.types.Screen.use_play_image_editors "Link to this definition")
    :   Type:
        :   boolean, default False

    use\_play\_node\_editors[¶](#bpy.types.Screen.use_play_node_editors "Link to this definition")
    :   Type:
        :   boolean, default False

    use\_play\_properties\_editors[¶](#bpy.types.Screen.use_play_properties_editors "Link to this definition")
    :   Type:
        :   boolean, default False

    use\_play\_sequence\_editors[¶](#bpy.types.Screen.use_play_sequence_editors "Link to this definition")
    :   Type:
        :   boolean, default False

    use\_play\_spreadsheet\_editors[¶](#bpy.types.Screen.use_play_spreadsheet_editors "Link to this definition")
    :   Type:
        :   boolean, default False

    use\_play\_top\_left\_3d\_editor[¶](#bpy.types.Screen.use_play_top_left_3d_editor "Link to this definition")
    :   Type:
        :   boolean, default False

    statusbar\_info()[¶](#bpy.types.Screen.statusbar_info "Link to this definition")
    :   statusbar\_info
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.Screen.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.Screen.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`BlendData.screens`](BlendData.md#bpy.types.BlendData.screens "bpy.types.BlendData.screens") * [`Context.screen`](Context.md#bpy.types.Context.screen "bpy.types.Context.screen") | * [`Window.screen`](Window.md#bpy.types.Window.screen "bpy.types.Window.screen") * [`WorkSpace.screens`](WorkSpace.md#bpy.types.WorkSpace.screens "bpy.types.WorkSpace.screens") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.Screen.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.Screen.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* Screen(ID)
  + [`Screen`](#bpy.types.Screen)
    - [`Screen.areas`](#bpy.types.Screen.areas)
    - [`Screen.is_animation_playing`](#bpy.types.Screen.is_animation_playing)
    - [`Screen.is_scrubbing`](#bpy.types.Screen.is_scrubbing)
    - [`Screen.is_temporary`](#bpy.types.Screen.is_temporary)
    - [`Screen.show_fullscreen`](#bpy.types.Screen.show_fullscreen)
    - [`Screen.show_statusbar`](#bpy.types.Screen.show_statusbar)
    - [`Screen.use_follow`](#bpy.types.Screen.use_follow)
    - [`Screen.use_play_3d_editors`](#bpy.types.Screen.use_play_3d_editors)
    - [`Screen.use_play_animation_editors`](#bpy.types.Screen.use_play_animation_editors)
    - [`Screen.use_play_clip_editors`](#bpy.types.Screen.use_play_clip_editors)
    - [`Screen.use_play_image_editors`](#bpy.types.Screen.use_play_image_editors)
    - [`Screen.use_play_node_editors`](#bpy.types.Screen.use_play_node_editors)
    - [`Screen.use_play_properties_editors`](#bpy.types.Screen.use_play_properties_editors)
    - [`Screen.use_play_sequence_editors`](#bpy.types.Screen.use_play_sequence_editors)
    - [`Screen.use_play_spreadsheet_editors`](#bpy.types.Screen.use_play_spreadsheet_editors)
    - [`Screen.use_play_top_left_3d_editor`](#bpy.types.Screen.use_play_top_left_3d_editor)
    - [`Screen.statusbar_info()`](#bpy.types.Screen.statusbar_info)
    - [`Screen.bl_rna_get_subclass()`](#bpy.types.Screen.bl_rna_get_subclass)
    - [`Screen.bl_rna_get_subclass_py()`](#bpy.types.Screen.bl_rna_get_subclass_py)
