...
# BlendDataActions(bpy\_struct)[¶](#blenddataactions-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.BlendDataActions(*bpy\_struct*)[¶](#bpy.types.BlendDataActions "Link to this definition")
:   Collection of actions

    new(*name*)[¶](#bpy.types.BlendDataActions.new "Link to this definition")
    ...
    remove(*action*, *\**, *do\_unlink=True*, *do\_id\_user=True*, *do\_ui\_user=True*)[¶](#bpy.types.BlendDataActions.remove "Link to this definition")
    :   Remove an action from the current blendfile

        Parameters:
        :   * **action** ([`Action`](Action.md#bpy.types.Action "bpy.types.Action"), (never None)) – Action to remove
            * **do\_unlink** (*boolean**,* *(**optional**)*) – Unlink all usages of this action before deleting it
            * **do\_id\_user** (*boolean**,* *(**optional**)*) – Decrement user counter of all data-blocks used by this action
            * **do\_ui\_user** (*boolean**,* *(**optional**)*) – Make sure interface does not reference this action

    tag(*value*)[¶](#bpy.types.BlendDataActions.tag "Link to this definition")
    :   tag

        Parameters:
        :   **value** (*boolean*) – Value

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.BlendDataActions.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.BlendDataActions.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`BlendData.actions`](BlendData.md#bpy.types.BlendData.actions "bpy.types.BlendData.actions") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.BlendDataActions.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.BlendDataActions.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* BlendDataActions(bpy\_struct)
  + [`BlendDataActions`](#bpy.types.BlendDataActions)
    - [`BlendDataActions.new()`](#bpy.types.BlendDataActions.new)
    - [`BlendDataActions.remove()`](#bpy.types.BlendDataActions.remove)
    - [`BlendDataActions.tag()`](#bpy.types.BlendDataActions.tag)
    - [`BlendDataActions.bl_rna_get_subclass()`](#bpy.types.BlendDataActions.bl_rna_get_subclass)
    - [`BlendDataActions.bl_rna_get_subclass_py()`](#bpy.types.BlendDataActions.bl_rna_get_subclass_py)
