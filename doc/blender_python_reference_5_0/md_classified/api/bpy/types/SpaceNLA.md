...
# SpaceNLA(Space)[¶](#spacenla-space "Link to this heading")
...
*class* bpy.types.SpaceNLA(*Space*)[¶](#bpy.types.SpaceNLA "Link to this definition")
:   NLA editor space data

    dopesheet[¶](#bpy.types.SpaceNLA.dopesheet "Link to this definition")
    :   Settings for filtering animation data

        Type:
        :   [`DopeSheet`](DopeSheet.md#bpy.types.DopeSheet "bpy.types.DopeSheet"), (readonly)

    show\_local\_markers[¶](#bpy.types.SpaceNLA.show_local_markers "Link to this definition")
    :   Show action-local markers on the strips, useful when synchronizing timing across strips

        Type:
        :   boolean, default False

    show\_markers[¶](#bpy.types.SpaceNLA.show_markers "Link to this definition")
    :   If any exists, show markers in a separate row at the bottom of the editor

        Type:
        :   boolean, default False

    show\_region\_channels[¶](#bpy.types.SpaceNLA.show_region_channels "Link to this definition")
    :   Type:
        :   boolean, default False

    show\_region\_footer[¶](#bpy.types.SpaceNLA.show_region_footer "Link to this definition")
    :   Type:
        :   boolean, default False

    show\_region\_hud[¶](#bpy.types.SpaceNLA.show_region_hud "Link to this definition")
    :   Type:
        :   boolean, default False

    show\_region\_ui[¶](#bpy.types.SpaceNLA.show_region_ui "Link to this definition")
    :   Type:
        :   boolean, default False

    show\_seconds[¶](#bpy.types.SpaceNLA.show_seconds "Link to this definition")
    :   Show timing as a timecode instead of frames

        Type:
        :   boolean, default False

    show\_strip\_curves[¶](#bpy.types.SpaceNLA.show_strip_curves "Link to this definition")
    :   Show influence F-Curves on strips

        Type:
        :   boolean, default False

    use\_realtime\_update[¶](#bpy.types.SpaceNLA.use_realtime_update "Link to this definition")
    :   When transforming strips, changes to the animation data are flushed to other views

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.SpaceNLA.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.SpaceNLA.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
    ...
    *classmethod* draw\_handler\_add(*callback*, *args*, *region\_type*, *draw\_type*)[¶](#bpy.types.SpaceNLA.draw_handler_add "Link to this definition")
    ...
    *classmethod* draw\_handler\_remove(*handler*, *region\_type*)[¶](#bpy.types.SpaceNLA.draw_handler_remove "Link to this definition")
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.SpaceNLA.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.SpaceNLA.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* SpaceNLA(Space)
  + [`SpaceNLA`](#bpy.types.SpaceNLA)
    - [`SpaceNLA.dopesheet`](#bpy.types.SpaceNLA.dopesheet)
    - [`SpaceNLA.show_local_markers`](#bpy.types.SpaceNLA.show_local_markers)
    - [`SpaceNLA.show_markers`](#bpy.types.SpaceNLA.show_markers)
    - [`SpaceNLA.show_region_channels`](#bpy.types.SpaceNLA.show_region_channels)
    - [`SpaceNLA.show_region_footer`](#bpy.types.SpaceNLA.show_region_footer)
    - [`SpaceNLA.show_region_hud`](#bpy.types.SpaceNLA.show_region_hud)
    - [`SpaceNLA.show_region_ui`](#bpy.types.SpaceNLA.show_region_ui)
    - [`SpaceNLA.show_seconds`](#bpy.types.SpaceNLA.show_seconds)
    - [`SpaceNLA.show_strip_curves`](#bpy.types.SpaceNLA.show_strip_curves)
    - [`SpaceNLA.use_realtime_update`](#bpy.types.SpaceNLA.use_realtime_update)
    - [`SpaceNLA.bl_rna_get_subclass()`](#bpy.types.SpaceNLA.bl_rna_get_subclass)
    - [`SpaceNLA.bl_rna_get_subclass_py()`](#bpy.types.SpaceNLA.bl_rna_get_subclass_py)
    - [`SpaceNLA.draw_handler_add()`](#bpy.types.SpaceNLA.draw_handler_add)
    - [`SpaceNLA.draw_handler_remove()`](#bpy.types.SpaceNLA.draw_handler_remove)
