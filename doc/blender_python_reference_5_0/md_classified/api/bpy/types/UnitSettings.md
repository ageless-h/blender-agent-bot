...
# UnitSettings(bpy\_struct)[¶](#unitsettings-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.UnitSettings(*bpy\_struct*)[¶](#bpy.types.UnitSettings "Link to this definition")
:   length\_unit[¶](#bpy.types.UnitSettings.length_unit "Link to this definition")
    :   Unit that will be used to display length values

        Type:
        :   enum in [`'DEFAULT'`], default `'DEFAULT'`

    mass\_unit[¶](#bpy.types.UnitSettings.mass_unit "Link to this definition")
    :   Unit that will be used to display mass values

        Type:
        :   enum in [`'DEFAULT'`], default `'DEFAULT'`

    scale\_length[¶](#bpy.types.UnitSettings.scale_length "Link to this definition")
    ...
    system[¶](#bpy.types.UnitSettings.system "Link to this definition")
    :   The unit system to use for user interface controls

        Type:
        :   enum in [`'NONE'`, `'METRIC'`, `'IMPERIAL'`], default `'NONE'`

    system\_rotation[¶](#bpy.types.UnitSettings.system_rotation "Link to this definition")
    ...
    temperature\_unit[¶](#bpy.types.UnitSettings.temperature_unit "Link to this definition")
    :   Unit that will be used to display temperature values

        Type:
        :   enum in [`'DEFAULT'`], default `'DEFAULT'`

    time\_unit[¶](#bpy.types.UnitSettings.time_unit "Link to this definition")
    :   Unit that will be used to display time values

        Type:
        :   enum in [`'DEFAULT'`], default `'DEFAULT'`

    use\_separate[¶](#bpy.types.UnitSettings.use_separate "Link to this definition")
    :   Display units in pairs (e.g. 1m 0cm)

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.UnitSettings.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.UnitSettings.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Scene.unit_settings`](Scene.md#bpy.types.Scene.unit_settings "bpy.types.Scene.unit_settings") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.UnitSettings.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.UnitSettings.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* UnitSettings(bpy\_struct)
  + [`UnitSettings`](#bpy.types.UnitSettings)
    - [`UnitSettings.length_unit`](#bpy.types.UnitSettings.length_unit)
    - [`UnitSettings.mass_unit`](#bpy.types.UnitSettings.mass_unit)
    - [`UnitSettings.scale_length`](#bpy.types.UnitSettings.scale_length)
    - [`UnitSettings.system`](#bpy.types.UnitSettings.system)
    - [`UnitSettings.system_rotation`](#bpy.types.UnitSettings.system_rotation)
    - [`UnitSettings.temperature_unit`](#bpy.types.UnitSettings.temperature_unit)
    - [`UnitSettings.time_unit`](#bpy.types.UnitSettings.time_unit)
    - [`UnitSettings.use_separate`](#bpy.types.UnitSettings.use_separate)
    - [`UnitSettings.bl_rna_get_subclass()`](#bpy.types.UnitSettings.bl_rna_get_subclass)
    - [`UnitSettings.bl_rna_get_subclass_py()`](#bpy.types.UnitSettings.bl_rna_get_subclass_py)
