...
# BlendDataMaterials(bpy\_struct)[¶](#blenddatamaterials-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.BlendDataMaterials(*bpy\_struct*)[¶](#bpy.types.BlendDataMaterials "Link to this definition")
:   Collection of materials

    new(*name*)[¶](#bpy.types.BlendDataMaterials.new "Link to this definition")
    ...
    create\_gpencil\_data(*material*)[¶](#bpy.types.BlendDataMaterials.create_gpencil_data "Link to this definition")
    :   Add Grease Pencil material settings

        Parameters:
        :   **material** ([`Material`](Material.md#bpy.types.Material "bpy.types.Material"), (never None)) – Material

    remove\_gpencil\_data(*material*)[¶](#bpy.types.BlendDataMaterials.remove_gpencil_data "Link to this definition")
    :   Remove Grease Pencil material settings

        Parameters:
        :   **material** ([`Material`](Material.md#bpy.types.Material "bpy.types.Material"), (never None)) – Material

    remove(*material*, *\**, *do\_unlink=True*, *do\_id\_user=True*, *do\_ui\_user=True*)[¶](#bpy.types.BlendDataMaterials.remove "Link to this definition")
    :   Remove a material from the current blendfile

        Parameters:
        :   * **material** ([`Material`](Material.md#bpy.types.Material "bpy.types.Material"), (never None)) – Material to remove
            * **do\_unlink** (*boolean**,* *(**optional**)*) – Unlink all usages of this material before deleting it
            * **do\_id\_user** (*boolean**,* *(**optional**)*) – Decrement user counter of all data-blocks used by this material
            * **do\_ui\_user** (*boolean**,* *(**optional**)*) – Make sure interface does not reference this material

    tag(*value*)[¶](#bpy.types.BlendDataMaterials.tag "Link to this definition")
    :   tag

        Parameters:
        :   **value** (*boolean*) – Value

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.BlendDataMaterials.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.BlendDataMaterials.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`BlendData.materials`](BlendData.md#bpy.types.BlendData.materials "bpy.types.BlendData.materials") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.BlendDataMaterials.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.BlendDataMaterials.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* BlendDataMaterials(bpy\_struct)
  + [`BlendDataMaterials`](#bpy.types.BlendDataMaterials)
    - [`BlendDataMaterials.new()`](#bpy.types.BlendDataMaterials.new)
    - [`BlendDataMaterials.create_gpencil_data()`](#bpy.types.BlendDataMaterials.create_gpencil_data)
    - [`BlendDataMaterials.remove_gpencil_data()`](#bpy.types.BlendDataMaterials.remove_gpencil_data)
    - [`BlendDataMaterials.remove()`](#bpy.types.BlendDataMaterials.remove)
    - [`BlendDataMaterials.tag()`](#bpy.types.BlendDataMaterials.tag)
    - [`BlendDataMaterials.bl_rna_get_subclass()`](#bpy.types.BlendDataMaterials.bl_rna_get_subclass)
    - [`BlendDataMaterials.bl_rna_get_subclass_py()`](#bpy.types.BlendDataMaterials.bl_rna_get_subclass_py)
