...
# DynamicPaintModifier(Modifier)[¶](#dynamicpaintmodifier-modifier "Link to this heading")
...
*class* bpy.types.DynamicPaintModifier(*Modifier*)[¶](#bpy.types.DynamicPaintModifier "Link to this definition")
:   Dynamic Paint modifier

    brush\_settings[¶](#bpy.types.DynamicPaintModifier.brush_settings "Link to this definition")
    :   Type:
        :   [`DynamicPaintBrushSettings`](DynamicPaintBrushSettings.md#bpy.types.DynamicPaintBrushSettings "bpy.types.DynamicPaintBrushSettings"), (readonly)

    canvas\_settings[¶](#bpy.types.DynamicPaintModifier.canvas_settings "Link to this definition")
    :   Type:
        :   [`DynamicPaintCanvasSettings`](DynamicPaintCanvasSettings.md#bpy.types.DynamicPaintCanvasSettings "bpy.types.DynamicPaintCanvasSettings"), (readonly)

    ui\_type[¶](#bpy.types.DynamicPaintModifier.ui_type "Link to this definition")
    :   Type:
        :   enum in [Prop Dynamicpaint Type Items](../../../appendix/bpy_types_enum_items/prop_dynamicpaint_type_items.md#rna-enum-prop-dynamicpaint-type-items), default `'CANVAS'`

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.DynamicPaintModifier.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.DynamicPaintModifier.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.DynamicPaintModifier.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.DynamicPaintModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* DynamicPaintModifier(Modifier)
  + [`DynamicPaintModifier`](#bpy.types.DynamicPaintModifier)
    - [`DynamicPaintModifier.brush_settings`](#bpy.types.DynamicPaintModifier.brush_settings)
    - [`DynamicPaintModifier.canvas_settings`](#bpy.types.DynamicPaintModifier.canvas_settings)
    - [`DynamicPaintModifier.ui_type`](#bpy.types.DynamicPaintModifier.ui_type)
    - [`DynamicPaintModifier.bl_rna_get_subclass()`](#bpy.types.DynamicPaintModifier.bl_rna_get_subclass)
    - [`DynamicPaintModifier.bl_rna_get_subclass_py()`](#bpy.types.DynamicPaintModifier.bl_rna_get_subclass_py)
