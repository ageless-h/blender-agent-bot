...
# FileHandler(bpy\_struct)[¶](#filehandler-bpy-struct "Link to this heading")

## Basic FileHandler for importing a single file[¶](#basic-filehandler-for-importing-a-single-file "Link to this heading")

A file handler allows custom drag-and-drop behavior to be associated with a given `Operator`
([`FileHandler.bl_import_operator`](#bpy.types.FileHandler.bl_import_operator "bpy.types.FileHandler.bl_import_operator")) and set of file extensions
([`FileHandler.bl_file_extensions`](#bpy.types.FileHandler.bl_file_extensions "bpy.types.FileHandler.bl_file_extensions")). Control over which area of the UI accepts the
drag-in-drop action is specified using the [`FileHandler.poll_drop`](#bpy.types.FileHandler.poll_drop "bpy.types.FileHandler.poll_drop") method.
...
## FileHandler for Importing multiple files and exposing Operator options[¶](#filehandler-for-importing-multiple-files-and-exposing-operator-options "Link to this heading")
...
[`Operator.draw`](Operator.md#bpy.types.Operator.draw "bpy.types.Operator.draw") method for layout and display.
...
subclasses —
[`IMAGE_FH_drop_handler`](IMAGE_FH_drop_handler.md#bpy.types.IMAGE_FH_drop_handler "bpy.types.IMAGE_FH_drop_handler"), [`IO_FH_gltf2`](IO_FH_gltf2.md#bpy.types.IO_FH_gltf2 "bpy.types.IO_FH_gltf2"), [`IO_FH_svg_as_curves`](IO_FH_svg_as_curves.md#bpy.types.IO_FH_svg_as_curves "bpy.types.IO_FH_svg_as_curves"), [`NODE_FH_image_node`](NODE_FH_image_node.md#bpy.types.NODE_FH_image_node "bpy.types.NODE_FH_image_node"), [`SEQUENCER_FH_image_strip`](SEQUENCER_FH_image_strip.md#bpy.types.SEQUENCER_FH_image_strip "bpy.types.SEQUENCER_FH_image_strip"), [`SEQUENCER_FH_movie_strip`](SEQUENCER_FH_movie_strip.md#bpy.types.SEQUENCER_FH_movie_strip "bpy.types.SEQUENCER_FH_movie_strip"), [`SEQUENCER_FH_sound_strip`](SEQUENCER_FH_sound_strip.md#bpy.types.SEQUENCER_FH_sound_strip "bpy.types.SEQUENCER_FH_sound_strip"), [`VIEW3D_FH_camera_background_image`](VIEW3D_FH_camera_background_image.md#bpy.types.VIEW3D_FH_camera_background_image "bpy.types.VIEW3D_FH_camera_background_image"), [`VIEW3D_FH_empty_image`](VIEW3D_FH_empty_image.md#bpy.types.VIEW3D_FH_empty_image "bpy.types.VIEW3D_FH_empty_image"), [`VIEW3D_FH_vdb_volume`](VIEW3D_FH_vdb_volume.md#bpy.types.VIEW3D_FH_vdb_volume "bpy.types.VIEW3D_FH_vdb_volume")

*class* bpy.types.FileHandler(*bpy\_struct*)[¶](#bpy.types.FileHandler "Link to this definition")
:   Extends functionality to operators that manages files, such as adding drag and drop support

    bl\_export\_operator[¶](#bpy.types.FileHandler.bl_export_operator "Link to this definition")
    :   Operator that can handle export for files with the extensions given in bl\_file\_extensions

        Type:
        :   string, default “”, (never None)

    bl\_file\_extensions[¶](#bpy.types.FileHandler.bl_file_extensions "Link to this definition")
    ...
    bl\_idname[¶](#bpy.types.FileHandler.bl_idname "Link to this definition")
    :   If this is set, the file handler gets a custom ID, otherwise it takes the name of the class used to define the file handler (for example, if the class name is “OBJECT\_FH\_hello”, and bl\_idname is not set by the script, then bl\_idname = “OBJECT\_FH\_hello”)

        Type:
        :   string, default “”, (never None)

    bl\_import\_operator[¶](#bpy.types.FileHandler.bl_import_operator "Link to this definition")
    :   Operator that can handle import for files with the extensions given in bl\_file\_extensions

        Type:
        :   string, default “”, (never None)

    bl\_label[¶](#bpy.types.FileHandler.bl_label "Link to this definition")
    :   The file handler label

        Type:
        :   string, default “”, (never None)

    *classmethod* poll\_drop(*context*)[¶](#bpy.types.FileHandler.poll_drop "Link to this definition")
    :   If this method returns True, can be used to handle the drop of a drag-and-drop action

        Return type:
        :   boolean

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.FileHandler.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.FileHandler.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.FileHandler.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.FileHandler.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* FileHandler(bpy\_struct)
  + [Basic FileHandler for importing a single file](#basic-filehandler-for-importing-a-single-file)
  + [FileHandler for Importing multiple files and exposing Operator options](#filehandler-for-importing-multiple-files-and-exposing-operator-options)
    - [`FileHandler`](#bpy.types.FileHandler)
      * [`FileHandler.bl_export_operator`](#bpy.types.FileHandler.bl_export_operator)
      * [`FileHandler.bl_file_extensions`](#bpy.types.FileHandler.bl_file_extensions)
      * [`FileHandler.bl_idname`](#bpy.types.FileHandler.bl_idname)
      * [`FileHandler.bl_import_operator`](#bpy.types.FileHandler.bl_import_operator)
      * [`FileHandler.bl_label`](#bpy.types.FileHandler.bl_label)
      * [`FileHandler.poll_drop()`](#bpy.types.FileHandler.poll_drop)
      * [`FileHandler.bl_rna_get_subclass()`](#bpy.types.FileHandler.bl_rna_get_subclass)
      * [`FileHandler.bl_rna_get_subclass_py()`](#bpy.types.FileHandler.bl_rna_get_subclass_py)
