...
# CollectionChild(bpy\_struct)[¶](#collectionchild-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.CollectionChild(*bpy\_struct*)[¶](#bpy.types.CollectionChild "Link to this definition")
:   Child collection with its collection related settings

    light\_linking[¶](#bpy.types.CollectionChild.light_linking "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.CollectionChild.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.CollectionChild.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Collection.collection_children`](Collection.md#bpy.types.Collection.collection_children "bpy.types.Collection.collection_children") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CollectionChild.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.CollectionChild.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CollectionChild(bpy\_struct)
  + [`CollectionChild`](#bpy.types.CollectionChild)
    - [`CollectionChild.light_linking`](#bpy.types.CollectionChild.light_linking)
    - [`CollectionChild.bl_rna_get_subclass()`](#bpy.types.CollectionChild.bl_rna_get_subclass)
    - [`CollectionChild.bl_rna_get_subclass_py()`](#bpy.types.CollectionChild.bl_rna_get_subclass_py)
