...
# StucciTexture(Texture)[¶](#stuccitexture-texture "Link to this heading")
...
*class* bpy.types.StucciTexture(*Texture*)[¶](#bpy.types.StucciTexture "Link to this definition")
:   Procedural noise texture

    noise\_basis[¶](#bpy.types.StucciTexture.noise_basis "Link to this definition")
    ...
    noise\_scale[¶](#bpy.types.StucciTexture.noise_scale "Link to this definition")
    :   Scaling for noise input

        Type:
        :   float in [0.0001, inf], default 0.25

    noise\_type[¶](#bpy.types.StucciTexture.noise_type "Link to this definition")
    :   * `SOFT_NOISE`
    ...
    stucci\_type[¶](#bpy.types.StucciTexture.stucci_type "Link to this definition")
    :   * `PLASTIC`
    ...
    turbulence[¶](#bpy.types.StucciTexture.turbulence "Link to this definition")
    :   Turbulence of the noise

        Type:
        :   float in [0.0001, inf], default 5.0

    users\_material[¶](#bpy.types.StucciTexture.users_material "Link to this definition")
    ...
    users\_object\_modifier[¶](#bpy.types.StucciTexture.users_object_modifier "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.StucciTexture.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.StucciTexture.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.StucciTexture.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.StucciTexture.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* StucciTexture(Texture)
  + [`StucciTexture`](#bpy.types.StucciTexture)
    - [`StucciTexture.noise_basis`](#bpy.types.StucciTexture.noise_basis)
    - [`StucciTexture.noise_scale`](#bpy.types.StucciTexture.noise_scale)
    - [`StucciTexture.noise_type`](#bpy.types.StucciTexture.noise_type)
    - [`StucciTexture.stucci_type`](#bpy.types.StucciTexture.stucci_type)
    - [`StucciTexture.turbulence`](#bpy.types.StucciTexture.turbulence)
    - [`StucciTexture.users_material`](#bpy.types.StucciTexture.users_material)
    - [`StucciTexture.users_object_modifier`](#bpy.types.StucciTexture.users_object_modifier)
    - [`StucciTexture.bl_rna_get_subclass()`](#bpy.types.StucciTexture.bl_rna_get_subclass)
    - [`StucciTexture.bl_rna_get_subclass_py()`](#bpy.types.StucciTexture.bl_rna_get_subclass_py)
