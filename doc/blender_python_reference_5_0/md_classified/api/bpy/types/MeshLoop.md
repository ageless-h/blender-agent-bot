...
# MeshLoop(bpy\_struct)[¶](#meshloop-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.MeshLoop(*bpy\_struct*)[¶](#bpy.types.MeshLoop "Link to this definition")
:   Loop in a Mesh data-block

    bitangent[¶](#bpy.types.MeshLoop.bitangent "Link to this definition")
    :   Bitangent vector of this vertex for this face (must be computed beforehand using calc\_tangents, use it only if really needed, slower access than bitangent\_sign)

        Type:
        :   [`mathutils.Vector`](../../mathutils/index.md#mathutils.Vector "mathutils.Vector") of 3 items in [-1, 1], default (0.0, 0.0, 0.0), (readonly)

    bitangent\_sign[¶](#bpy.types.MeshLoop.bitangent_sign "Link to this definition")
    :   Sign of the bitangent vector of this vertex for this face (must be computed beforehand using calc\_tangents, bitangent = bitangent\_sign \* cross(normal, tangent))

        Type:
        :   float in [-1, 1], default 0.0, (readonly)

    edge\_index[¶](#bpy.types.MeshLoop.edge_index "Link to this definition")
    :   Edge index

        Type:
        :   int in [0, inf], default 0

    index[¶](#bpy.types.MeshLoop.index "Link to this definition")
    :   Index of this loop

        Type:
        :   int in [0, inf], default 0, (readonly)

    normal[¶](#bpy.types.MeshLoop.normal "Link to this definition")
    :   The normal direction of the face corner, taking into account sharp faces, sharp edges, and custom normal data

        Type:
        :   [`mathutils.Vector`](../../mathutils/index.md#mathutils.Vector "mathutils.Vector") of 3 items in [-1, 1], default (0.0, 0.0, 0.0), (readonly)

    tangent[¶](#bpy.types.MeshLoop.tangent "Link to this definition")
    :   Local space unit length tangent vector of this vertex for this face (must be computed beforehand using calc\_tangents)

        Type:
        :   [`mathutils.Vector`](../../mathutils/index.md#mathutils.Vector "mathutils.Vector") of 3 items in [-1, 1], default (0.0, 0.0, 0.0), (readonly)

    vertex\_index[¶](#bpy.types.MeshLoop.vertex_index "Link to this definition")
    :   Vertex index

        Type:
        :   int in [0, inf], default 0

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.MeshLoop.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.MeshLoop.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Mesh.loops`](Mesh.md#bpy.types.Mesh.loops "bpy.types.Mesh.loops") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.MeshLoop.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.MeshLoop.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* MeshLoop(bpy\_struct)
  + [`MeshLoop`](#bpy.types.MeshLoop)
    - [`MeshLoop.bitangent`](#bpy.types.MeshLoop.bitangent)
    - [`MeshLoop.bitangent_sign`](#bpy.types.MeshLoop.bitangent_sign)
    - [`MeshLoop.edge_index`](#bpy.types.MeshLoop.edge_index)
    - [`MeshLoop.index`](#bpy.types.MeshLoop.index)
    - [`MeshLoop.normal`](#bpy.types.MeshLoop.normal)
    - [`MeshLoop.tangent`](#bpy.types.MeshLoop.tangent)
    - [`MeshLoop.vertex_index`](#bpy.types.MeshLoop.vertex_index)
    - [`MeshLoop.bl_rna_get_subclass()`](#bpy.types.MeshLoop.bl_rna_get_subclass)
    - [`MeshLoop.bl_rna_get_subclass_py()`](#bpy.types.MeshLoop.bl_rna_get_subclass_py)
