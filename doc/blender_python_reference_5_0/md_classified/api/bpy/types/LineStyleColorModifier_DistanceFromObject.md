...
# LineStyleColorModifier\_DistanceFromObject(LineStyleColorModifier)[¶](#linestylecolormodifier-distancefromobject-linestylecolormodifier "Link to this heading")

base classes — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct"), [`LineStyleModifier`](LineStyleModifier.md#bpy.types.LineStyleModifier "bpy.types.LineStyleModifier"), [`LineStyleColorModifier`](LineStyleColorModifier.md#bpy.types.LineStyleColorModifier "bpy.types.LineStyleColorModifier")

*class* bpy.types.LineStyleColorModifier\_DistanceFromObject(*LineStyleColorModifier*)[¶](#bpy.types.LineStyleColorModifier_DistanceFromObject "Link to this definition")
:   Change line color based on the distance from an object

    blend[¶](#bpy.types.LineStyleColorModifier_DistanceFromObject.blend "Link to this definition")
    :   Specify how the modifier value is blended into the base value

        Type:
        :   enum in [Ramp Blend Items](../../../appendix/bpy_types_enum_items/ramp_blend_items.md#rna-enum-ramp-blend-items), default `'MIX'`

    color\_ramp[¶](#bpy.types.LineStyleColorModifier_DistanceFromObject.color_ramp "Link to this definition")
    :   Color ramp used to change line color

        Type:
        :   [`ColorRamp`](ColorRamp.md#bpy.types.ColorRamp "bpy.types.ColorRamp"), (readonly)

    expanded[¶](#bpy.types.LineStyleColorModifier_DistanceFromObject.expanded "Link to this definition")
    :   True if the modifier tab is expanded

        Type:
        :   boolean, default False

    influence[¶](#bpy.types.LineStyleColorModifier_DistanceFromObject.influence "Link to this definition")
    :   Influence factor by which the modifier changes the property

        Type:
        :   float in [0, 1], default 0.0

    range\_max[¶](#bpy.types.LineStyleColorModifier_DistanceFromObject.range_max "Link to this definition")
    :   Upper bound of the input range the mapping is applied

        Type:
        :   float in [-inf, inf], default 0.0

    range\_min[¶](#bpy.types.LineStyleColorModifier_DistanceFromObject.range_min "Link to this definition")
    :   Lower bound of the input range the mapping is applied

        Type:
        :   float in [-inf, inf], default 0.0

    target[¶](#bpy.types.LineStyleColorModifier_DistanceFromObject.target "Link to this definition")
    :   Target object from which the distance is measured

        Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object")

    type[¶](#bpy.types.LineStyleColorModifier_DistanceFromObject.type "Link to this definition")
    :   Type of the modifier

        Type:
        :   enum in [Linestyle Color Modifier Type Items](../../../appendix/bpy_types_enum_items/linestyle_color_modifier_type_items.md#rna-enum-linestyle-color-modifier-type-items), default `'ALONG_STROKE'`, (readonly)

    use[¶](#bpy.types.LineStyleColorModifier_DistanceFromObject.use "Link to this definition")
    :   Enable or disable this modifier during stroke rendering

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.LineStyleColorModifier_DistanceFromObject.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.LineStyleColorModifier_DistanceFromObject.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.LineStyleColorModifier_DistanceFromObject.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.LineStyleColorModifier_DistanceFromObject.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* LineStyleColorModifier\_DistanceFromObject(LineStyleColorModifier)
  + [`LineStyleColorModifier_DistanceFromObject`](#bpy.types.LineStyleColorModifier_DistanceFromObject)
    - [`LineStyleColorModifier_DistanceFromObject.blend`](#bpy.types.LineStyleColorModifier_DistanceFromObject.blend)
    - [`LineStyleColorModifier_DistanceFromObject.color_ramp`](#bpy.types.LineStyleColorModifier_DistanceFromObject.color_ramp)
    - [`LineStyleColorModifier_DistanceFromObject.expanded`](#bpy.types.LineStyleColorModifier_DistanceFromObject.expanded)
    - [`LineStyleColorModifier_DistanceFromObject.influence`](#bpy.types.LineStyleColorModifier_DistanceFromObject.influence)
    - [`LineStyleColorModifier_DistanceFromObject.range_max`](#bpy.types.LineStyleColorModifier_DistanceFromObject.range_max)
    - [`LineStyleColorModifier_DistanceFromObject.range_min`](#bpy.types.LineStyleColorModifier_DistanceFromObject.range_min)
    - [`LineStyleColorModifier_DistanceFromObject.target`](#bpy.types.LineStyleColorModifier_DistanceFromObject.target)
    - [`LineStyleColorModifier_DistanceFromObject.type`](#bpy.types.LineStyleColorModifier_DistanceFromObject.type)
    - [`LineStyleColorModifier_DistanceFromObject.use`](#bpy.types.LineStyleColorModifier_DistanceFromObject.use)
    - [`LineStyleColorModifier_DistanceFromObject.bl_rna_get_subclass()`](#bpy.types.LineStyleColorModifier_DistanceFromObject.bl_rna_get_subclass)
    - [`LineStyleColorModifier_DistanceFromObject.bl_rna_get_subclass_py()`](#bpy.types.LineStyleColorModifier_DistanceFromObject.bl_rna_get_subclass_py)
