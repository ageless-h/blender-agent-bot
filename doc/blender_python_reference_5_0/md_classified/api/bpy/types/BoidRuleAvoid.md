...
# BoidRuleAvoid(BoidRule)[¶](#boidruleavoid-boidrule "Link to this heading")
...
*class* bpy.types.BoidRuleAvoid(*BoidRule*)[¶](#bpy.types.BoidRuleAvoid "Link to this definition")
:   fear\_factor[¶](#bpy.types.BoidRuleAvoid.fear_factor "Link to this definition")
    :   Avoid object if danger from it is above this threshold

        Type:
        :   float in [0, 100], default 0.0

    object[¶](#bpy.types.BoidRuleAvoid.object "Link to this definition")
    :   Object to avoid

        Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object")

    use\_predict[¶](#bpy.types.BoidRuleAvoid.use_predict "Link to this definition")
    :   Predict target movement

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.BoidRuleAvoid.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.BoidRuleAvoid.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.BoidRuleAvoid.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.BoidRuleAvoid.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* BoidRuleAvoid(BoidRule)
  + [`BoidRuleAvoid`](#bpy.types.BoidRuleAvoid)
    - [`BoidRuleAvoid.fear_factor`](#bpy.types.BoidRuleAvoid.fear_factor)
    - [`BoidRuleAvoid.object`](#bpy.types.BoidRuleAvoid.object)
    - [`BoidRuleAvoid.use_predict`](#bpy.types.BoidRuleAvoid.use_predict)
    - [`BoidRuleAvoid.bl_rna_get_subclass()`](#bpy.types.BoidRuleAvoid.bl_rna_get_subclass)
    - [`BoidRuleAvoid.bl_rna_get_subclass_py()`](#bpy.types.BoidRuleAvoid.bl_rna_get_subclass_py)
