...
# MovieClipStrip(Strip)[¶](#movieclipstrip-strip "Link to this heading")
...
*class* bpy.types.MovieClipStrip(*Strip*)[¶](#bpy.types.MovieClipStrip "Link to this definition")
:   Sequence strip to load a video from the clip editor

    alpha\_mode[¶](#bpy.types.MovieClipStrip.alpha_mode "Link to this definition")
    ...
    animation\_offset\_end[¶](#bpy.types.MovieClipStrip.animation_offset_end "Link to this definition")
    :   Animation end offset (trim end)

        Type:
        :   int in [0, inf], default 0

    animation\_offset\_start[¶](#bpy.types.MovieClipStrip.animation_offset_start "Link to this definition")
    :   Animation start offset (trim start)

        Type:
        :   int in [0, inf], default 0

    clip[¶](#bpy.types.MovieClipStrip.clip "Link to this definition")
    :   Movie clip that this strip uses

        Type:
        :   [`MovieClip`](MovieClip.md#bpy.types.MovieClip "bpy.types.MovieClip")

    color\_multiply[¶](#bpy.types.MovieClipStrip.color_multiply "Link to this definition")
    :   Type:
        :   float in [0, 20], default 1.0

    color\_saturation[¶](#bpy.types.MovieClipStrip.color_saturation "Link to this definition")
    :   Adjust the intensity of the input’s color

        Type:
        :   float in [0, 20], default 1.0

    crop[¶](#bpy.types.MovieClipStrip.crop "Link to this definition")
    :   Type:
        :   [`StripCrop`](StripCrop.md#bpy.types.StripCrop "bpy.types.StripCrop"), (readonly)

    fps[¶](#bpy.types.MovieClipStrip.fps "Link to this definition")
    :   Frames per second

        Type:
        :   float in [-inf, inf], default 0.0, (readonly)

    multiply\_alpha[¶](#bpy.types.MovieClipStrip.multiply_alpha "Link to this definition")
    :   Multiply alpha along with color channels

        Type:
        :   boolean, default False

    stabilize2d[¶](#bpy.types.MovieClipStrip.stabilize2d "Link to this definition")
    :   Use the 2D stabilized version of the clip

        Type:
        :   boolean, default False

    strobe[¶](#bpy.types.MovieClipStrip.strobe "Link to this definition")
    :   Only display every nth frame

        Type:
        :   float in [1, 30], default 0.0

    transform[¶](#bpy.types.MovieClipStrip.transform "Link to this definition")
    :   Type:
        :   [`StripTransform`](StripTransform.md#bpy.types.StripTransform "bpy.types.StripTransform"), (readonly)

    undistort[¶](#bpy.types.MovieClipStrip.undistort "Link to this definition")
    :   Use the undistorted version of the clip

        Type:
        :   boolean, default False

    use\_deinterlace[¶](#bpy.types.MovieClipStrip.use_deinterlace "Link to this definition")
    :   Remove fields from video movies

        Type:
        :   boolean, default False

    use\_flip\_x[¶](#bpy.types.MovieClipStrip.use_flip_x "Link to this definition")
    :   Flip on the X axis

        Type:
        :   boolean, default False

    use\_flip\_y[¶](#bpy.types.MovieClipStrip.use_flip_y "Link to this definition")
    :   Flip on the Y axis

        Type:
        :   boolean, default False

    use\_float[¶](#bpy.types.MovieClipStrip.use_float "Link to this definition")
    :   Convert input to float data

        Type:
        :   boolean, default False

    use\_reverse\_frames[¶](#bpy.types.MovieClipStrip.use_reverse_frames "Link to this definition")
    :   Reverse frame order

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.MovieClipStrip.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.MovieClipStrip.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.MovieClipStrip.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.MovieClipStrip.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* MovieClipStrip(Strip)
  + [`MovieClipStrip`](#bpy.types.MovieClipStrip)
    - [`MovieClipStrip.alpha_mode`](#bpy.types.MovieClipStrip.alpha_mode)
    - [`MovieClipStrip.animation_offset_end`](#bpy.types.MovieClipStrip.animation_offset_end)
    - [`MovieClipStrip.animation_offset_start`](#bpy.types.MovieClipStrip.animation_offset_start)
    - [`MovieClipStrip.clip`](#bpy.types.MovieClipStrip.clip)
    - [`MovieClipStrip.color_multiply`](#bpy.types.MovieClipStrip.color_multiply)
    - [`MovieClipStrip.color_saturation`](#bpy.types.MovieClipStrip.color_saturation)
    - [`MovieClipStrip.crop`](#bpy.types.MovieClipStrip.crop)
    - [`MovieClipStrip.fps`](#bpy.types.MovieClipStrip.fps)
    - [`MovieClipStrip.multiply_alpha`](#bpy.types.MovieClipStrip.multiply_alpha)
    - [`MovieClipStrip.stabilize2d`](#bpy.types.MovieClipStrip.stabilize2d)
    - [`MovieClipStrip.strobe`](#bpy.types.MovieClipStrip.strobe)
    - [`MovieClipStrip.transform`](#bpy.types.MovieClipStrip.transform)
    - [`MovieClipStrip.undistort`](#bpy.types.MovieClipStrip.undistort)
    - [`MovieClipStrip.use_deinterlace`](#bpy.types.MovieClipStrip.use_deinterlace)
    - [`MovieClipStrip.use_flip_x`](#bpy.types.MovieClipStrip.use_flip_x)
    - [`MovieClipStrip.use_flip_y`](#bpy.types.MovieClipStrip.use_flip_y)
    - [`MovieClipStrip.use_float`](#bpy.types.MovieClipStrip.use_float)
    - [`MovieClipStrip.use_reverse_frames`](#bpy.types.MovieClipStrip.use_reverse_frames)
    - [`MovieClipStrip.bl_rna_get_subclass()`](#bpy.types.MovieClipStrip.bl_rna_get_subclass)
    - [`MovieClipStrip.bl_rna_get_subclass_py()`](#bpy.types.MovieClipStrip.bl_rna_get_subclass_py)
