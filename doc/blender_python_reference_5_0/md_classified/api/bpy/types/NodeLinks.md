...
# NodeLinks(bpy\_struct)[¶](#nodelinks-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.NodeLinks(*bpy\_struct*)[¶](#bpy.types.NodeLinks "Link to this definition")
:   Collection of Node Links

    new(*input*, *output*, *\**, *verify\_limits=True*, *handle\_dynamic\_sockets=False*)[¶](#bpy.types.NodeLinks.new "Link to this definition")
    :   Add a node link to this node tree

        Parameters:
        :   * **input** ([`NodeSocket`](NodeSocket.md#bpy.types.NodeSocket "bpy.types.NodeSocket"), (never None)) – The input socket
            * **output** ([`NodeSocket`](NodeSocket.md#bpy.types.NodeSocket "bpy.types.NodeSocket"), (never None)) – The output socket
            * **verify\_limits** (*boolean**,* *(**optional**)*) – Verify Limits, Remove existing links if connection limit is exceeded
            * **handle\_dynamic\_sockets** (*boolean**,* *(**optional**)*) – Handle Dynamic Sockets, Handle node specific features like virtual sockets

        Returns:
        :   New node link

        Return type:
        :   [`NodeLink`](NodeLink.md#bpy.types.NodeLink "bpy.types.NodeLink")

    remove(*link*)[¶](#bpy.types.NodeLinks.remove "Link to this definition")
    :   remove a node link from the node tree

        Parameters:
        :   **link** ([`NodeLink`](NodeLink.md#bpy.types.NodeLink "bpy.types.NodeLink"), (never None)) – The node link to remove

    clear()[¶](#bpy.types.NodeLinks.clear "Link to this definition")
    :   remove all node links from the node tree

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.NodeLinks.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.NodeLinks.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`NodeTree.links`](NodeTree.md#bpy.types.NodeTree.links "bpy.types.NodeTree.links") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.NodeLinks.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.NodeLinks.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* NodeLinks(bpy\_struct)
  + [`NodeLinks`](#bpy.types.NodeLinks)
    - [`NodeLinks.new()`](#bpy.types.NodeLinks.new)
    - [`NodeLinks.remove()`](#bpy.types.NodeLinks.remove)
    - [`NodeLinks.clear()`](#bpy.types.NodeLinks.clear)
    - [`NodeLinks.bl_rna_get_subclass()`](#bpy.types.NodeLinks.bl_rna_get_subclass)
    - [`NodeLinks.bl_rna_get_subclass_py()`](#bpy.types.NodeLinks.bl_rna_get_subclass_py)
