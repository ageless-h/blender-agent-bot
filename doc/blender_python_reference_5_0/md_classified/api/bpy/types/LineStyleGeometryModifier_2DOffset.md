...
# LineStyleGeometryModifier\_2DOffset(LineStyleGeometryModifier)[¶](#linestylegeometrymodifier-2doffset-linestylegeometrymodifier "Link to this heading")
...
*class* bpy.types.LineStyleGeometryModifier\_2DOffset(*LineStyleGeometryModifier*)[¶](#bpy.types.LineStyleGeometryModifier_2DOffset "Link to this definition")
:   Add two-dimensional offsets to stroke backbone geometry

    end[¶](#bpy.types.LineStyleGeometryModifier_2DOffset.end "Link to this definition")
    :   Displacement that is applied from the end of the stroke

        Type:
        :   float in [-inf, inf], default 0.0

    expanded[¶](#bpy.types.LineStyleGeometryModifier_2DOffset.expanded "Link to this definition")
    :   True if the modifier tab is expanded

        Type:
        :   boolean, default False

    start[¶](#bpy.types.LineStyleGeometryModifier_2DOffset.start "Link to this definition")
    :   Displacement that is applied from the beginning of the stroke

        Type:
        :   float in [-inf, inf], default 0.0

    type[¶](#bpy.types.LineStyleGeometryModifier_2DOffset.type "Link to this definition")
    ...
    use[¶](#bpy.types.LineStyleGeometryModifier_2DOffset.use "Link to this definition")
    :   Enable or disable this modifier during stroke rendering

        Type:
        :   boolean, default False

    x[¶](#bpy.types.LineStyleGeometryModifier_2DOffset.x "Link to this definition")
    :   Displacement that is applied to the X coordinates of stroke vertices

        Type:
        :   float in [-inf, inf], default 0.0

    y[¶](#bpy.types.LineStyleGeometryModifier_2DOffset.y "Link to this definition")
    :   Displacement that is applied to the Y coordinates of stroke vertices

        Type:
        :   float in [-inf, inf], default 0.0

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.LineStyleGeometryModifier_2DOffset.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.LineStyleGeometryModifier_2DOffset.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.LineStyleGeometryModifier_2DOffset.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.LineStyleGeometryModifier_2DOffset.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* LineStyleGeometryModifier\_2DOffset(LineStyleGeometryModifier)
  + [`LineStyleGeometryModifier_2DOffset`](#bpy.types.LineStyleGeometryModifier_2DOffset)
    - [`LineStyleGeometryModifier_2DOffset.end`](#bpy.types.LineStyleGeometryModifier_2DOffset.end)
    - [`LineStyleGeometryModifier_2DOffset.expanded`](#bpy.types.LineStyleGeometryModifier_2DOffset.expanded)
    - [`LineStyleGeometryModifier_2DOffset.start`](#bpy.types.LineStyleGeometryModifier_2DOffset.start)
    - [`LineStyleGeometryModifier_2DOffset.type`](#bpy.types.LineStyleGeometryModifier_2DOffset.type)
    - [`LineStyleGeometryModifier_2DOffset.use`](#bpy.types.LineStyleGeometryModifier_2DOffset.use)
    - [`LineStyleGeometryModifier_2DOffset.x`](#bpy.types.LineStyleGeometryModifier_2DOffset.x)
    - [`LineStyleGeometryModifier_2DOffset.y`](#bpy.types.LineStyleGeometryModifier_2DOffset.y)
    - [`LineStyleGeometryModifier_2DOffset.bl_rna_get_subclass()`](#bpy.types.LineStyleGeometryModifier_2DOffset.bl_rna_get_subclass)
    - [`LineStyleGeometryModifier_2DOffset.bl_rna_get_subclass_py()`](#bpy.types.LineStyleGeometryModifier_2DOffset.bl_rna_get_subclass_py)
