...
# GreasePencilTimeModifier(Modifier)[¶](#greasepenciltimemodifier-modifier "Link to this heading")
...
*class* bpy.types.GreasePencilTimeModifier(*Modifier*)[¶](#bpy.types.GreasePencilTimeModifier "Link to this definition")
:   Offset keyframes

    frame\_end[¶](#bpy.types.GreasePencilTimeModifier.frame_end "Link to this definition")
    :   Final frame of the range

        Type:
        :   int in [0, 1048574], default 250

    frame\_scale[¶](#bpy.types.GreasePencilTimeModifier.frame_scale "Link to this definition")
    :   Evaluation time in seconds

        Type:
        :   float in [0.001, 100], default 1.0

    frame\_start[¶](#bpy.types.GreasePencilTimeModifier.frame_start "Link to this definition")
    :   First frame of the range

        Type:
        :   int in [0, 1048574], default 1

    invert\_layer\_filter[¶](#bpy.types.GreasePencilTimeModifier.invert_layer_filter "Link to this definition")
    :   Invert layer filter

        Type:
        :   boolean, default False

    invert\_layer\_pass\_filter[¶](#bpy.types.GreasePencilTimeModifier.invert_layer_pass_filter "Link to this definition")
    :   Invert layer pass filter

        Type:
        :   boolean, default False

    layer\_pass\_filter[¶](#bpy.types.GreasePencilTimeModifier.layer_pass_filter "Link to this definition")
    :   Layer pass filter

        Type:
        :   int in [0, 100], default 0

    mode[¶](#bpy.types.GreasePencilTimeModifier.mode "Link to this definition")
    :   * `NORMAL`
    ...
    offset[¶](#bpy.types.GreasePencilTimeModifier.offset "Link to this definition")
    :   Number of frames to offset original keyframe number or frame to fix

        Type:
        :   int in [-32768, 32767], default 1

    open\_custom\_range\_panel[¶](#bpy.types.GreasePencilTimeModifier.open_custom_range_panel "Link to this definition")
    :   Type:
        :   boolean, default False

    open\_influence\_panel[¶](#bpy.types.GreasePencilTimeModifier.open_influence_panel "Link to this definition")
    :   Type:
        :   boolean, default False

    segment\_active\_index[¶](#bpy.types.GreasePencilTimeModifier.segment_active_index "Link to this definition")
    :   Active index in the segment list

        Type:
        :   int in [0, inf], default 0

    segments[¶](#bpy.types.GreasePencilTimeModifier.segments "Link to this definition")
    :   Type:
        :   [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`GreasePencilTimeModifierSegment`](GreasePencilTimeModifierSegment.md#bpy.types.GreasePencilTimeModifierSegment "bpy.types.GreasePencilTimeModifierSegment"), (readonly)

    tree\_node\_filter[¶](#bpy.types.GreasePencilTimeModifier.tree_node_filter "Link to this definition")
    :   Layer name

        Type:
        :   string, default “”, (never None)

    use\_custom\_frame\_range[¶](#bpy.types.GreasePencilTimeModifier.use_custom_frame_range "Link to this definition")
    :   Define a custom range of frames to use in modifier

        Type:
        :   boolean, default False

    use\_keep\_loop[¶](#bpy.types.GreasePencilTimeModifier.use_keep_loop "Link to this definition")
    :   Retiming end frames and move to start of animation to keep loop

        Type:
        :   boolean, default True

    use\_layer\_group\_filter[¶](#bpy.types.GreasePencilTimeModifier.use_layer_group_filter "Link to this definition")
    :   Filter by layer group name

        Type:
        :   boolean, default False

    use\_layer\_pass\_filter[¶](#bpy.types.GreasePencilTimeModifier.use_layer_pass_filter "Link to this definition")
    :   Use layer pass filter

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.GreasePencilTimeModifier.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.GreasePencilTimeModifier.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GreasePencilTimeModifier.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.GreasePencilTimeModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GreasePencilTimeModifier(Modifier)
  + [`GreasePencilTimeModifier`](#bpy.types.GreasePencilTimeModifier)
    - [`GreasePencilTimeModifier.frame_end`](#bpy.types.GreasePencilTimeModifier.frame_end)
    - [`GreasePencilTimeModifier.frame_scale`](#bpy.types.GreasePencilTimeModifier.frame_scale)
    - [`GreasePencilTimeModifier.frame_start`](#bpy.types.GreasePencilTimeModifier.frame_start)
    - [`GreasePencilTimeModifier.invert_layer_filter`](#bpy.types.GreasePencilTimeModifier.invert_layer_filter)
    - [`GreasePencilTimeModifier.invert_layer_pass_filter`](#bpy.types.GreasePencilTimeModifier.invert_layer_pass_filter)
    - [`GreasePencilTimeModifier.layer_pass_filter`](#bpy.types.GreasePencilTimeModifier.layer_pass_filter)
    - [`GreasePencilTimeModifier.mode`](#bpy.types.GreasePencilTimeModifier.mode)
    - [`GreasePencilTimeModifier.offset`](#bpy.types.GreasePencilTimeModifier.offset)
    - [`GreasePencilTimeModifier.open_custom_range_panel`](#bpy.types.GreasePencilTimeModifier.open_custom_range_panel)
    - [`GreasePencilTimeModifier.open_influence_panel`](#bpy.types.GreasePencilTimeModifier.open_influence_panel)
    - [`GreasePencilTimeModifier.segment_active_index`](#bpy.types.GreasePencilTimeModifier.segment_active_index)
    - [`GreasePencilTimeModifier.segments`](#bpy.types.GreasePencilTimeModifier.segments)
    - [`GreasePencilTimeModifier.tree_node_filter`](#bpy.types.GreasePencilTimeModifier.tree_node_filter)
    - [`GreasePencilTimeModifier.use_custom_frame_range`](#bpy.types.GreasePencilTimeModifier.use_custom_frame_range)
    - [`GreasePencilTimeModifier.use_keep_loop`](#bpy.types.GreasePencilTimeModifier.use_keep_loop)
    - [`GreasePencilTimeModifier.use_layer_group_filter`](#bpy.types.GreasePencilTimeModifier.use_layer_group_filter)
    - [`GreasePencilTimeModifier.use_layer_pass_filter`](#bpy.types.GreasePencilTimeModifier.use_layer_pass_filter)
    - [`GreasePencilTimeModifier.bl_rna_get_subclass()`](#bpy.types.GreasePencilTimeModifier.bl_rna_get_subclass)
    - [`GreasePencilTimeModifier.bl_rna_get_subclass_py()`](#bpy.types.GreasePencilTimeModifier.bl_rna_get_subclass_py)
