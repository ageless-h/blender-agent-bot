...
# BoidRuleGoal(BoidRule)[¶](#boidrulegoal-boidrule "Link to this heading")
...
*class* bpy.types.BoidRuleGoal(*BoidRule*)[¶](#bpy.types.BoidRuleGoal "Link to this definition")
:   object[¶](#bpy.types.BoidRuleGoal.object "Link to this definition")
    :   Goal object

        Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object")

    use\_predict[¶](#bpy.types.BoidRuleGoal.use_predict "Link to this definition")
    :   Predict target movement

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.BoidRuleGoal.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.BoidRuleGoal.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.BoidRuleGoal.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.BoidRuleGoal.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* BoidRuleGoal(BoidRule)
  + [`BoidRuleGoal`](#bpy.types.BoidRuleGoal)
    - [`BoidRuleGoal.object`](#bpy.types.BoidRuleGoal.object)
    - [`BoidRuleGoal.use_predict`](#bpy.types.BoidRuleGoal.use_predict)
    - [`BoidRuleGoal.bl_rna_get_subclass()`](#bpy.types.BoidRuleGoal.bl_rna_get_subclass)
    - [`BoidRuleGoal.bl_rna_get_subclass_py()`](#bpy.types.BoidRuleGoal.bl_rna_get_subclass_py)
