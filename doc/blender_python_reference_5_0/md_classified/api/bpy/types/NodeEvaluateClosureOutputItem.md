...
# NodeEvaluateClosureOutputItem(bpy\_struct)[¶](#nodeevaluateclosureoutputitem-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.NodeEvaluateClosureOutputItem(*bpy\_struct*)[¶](#bpy.types.NodeEvaluateClosureOutputItem "Link to this definition")
:   color[¶](#bpy.types.NodeEvaluateClosureOutputItem.color "Link to this definition")
    ...
    name[¶](#bpy.types.NodeEvaluateClosureOutputItem.name "Link to this definition")
    :   Type:
        :   string, default “”, (never None)

    socket\_type[¶](#bpy.types.NodeEvaluateClosureOutputItem.socket_type "Link to this definition")
    :   Type:
    ...
    structure\_type[¶](#bpy.types.NodeEvaluateClosureOutputItem.structure_type "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.NodeEvaluateClosureOutputItem.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.NodeEvaluateClosureOutputItem.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`NodeEvaluateClosure.output_items`](NodeEvaluateClosure.md#bpy.types.NodeEvaluateClosure.output_items "bpy.types.NodeEvaluateClosure.output_items") * [`NodeEvaluateClosureOutputItems.new`](NodeEvaluateClosureOutputItems.md#bpy.types.NodeEvaluateClosureOutputItems.new "bpy.types.NodeEvaluateClosureOutputItems.new") | * [`NodeEvaluateClosureOutputItems.remove`](NodeEvaluateClosureOutputItems.md#bpy.types.NodeEvaluateClosureOutputItems.remove "bpy.types.NodeEvaluateClosureOutputItems.remove") |

[Next

NodeEvaluateClosureOutputItems(bpy\_struct)](NodeEvaluateClosureOutputItems.md)
[Previous
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.NodeEvaluateClosureOutputItem.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.NodeEvaluateClosureOutputItem.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* NodeEvaluateClosureOutputItem(bpy\_struct)
  + [`NodeEvaluateClosureOutputItem`](#bpy.types.NodeEvaluateClosureOutputItem)
    - [`NodeEvaluateClosureOutputItem.color`](#bpy.types.NodeEvaluateClosureOutputItem.color)
    - [`NodeEvaluateClosureOutputItem.name`](#bpy.types.NodeEvaluateClosureOutputItem.name)
    - [`NodeEvaluateClosureOutputItem.socket_type`](#bpy.types.NodeEvaluateClosureOutputItem.socket_type)
    - [`NodeEvaluateClosureOutputItem.structure_type`](#bpy.types.NodeEvaluateClosureOutputItem.structure_type)
    - [`NodeEvaluateClosureOutputItem.bl_rna_get_subclass()`](#bpy.types.NodeEvaluateClosureOutputItem.bl_rna_get_subclass)
    - [`NodeEvaluateClosureOutputItem.bl_rna_get_subclass_py()`](#bpy.types.NodeEvaluateClosureOutputItem.bl_rna_get_subclass_py)
