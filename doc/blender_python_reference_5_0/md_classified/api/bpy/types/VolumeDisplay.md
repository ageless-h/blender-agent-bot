...
# VolumeDisplay(bpy\_struct)[¶](#volumedisplay-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.VolumeDisplay(*bpy\_struct*)[¶](#bpy.types.VolumeDisplay "Link to this definition")
:   Volume object display settings for 3D viewport

    density[¶](#bpy.types.VolumeDisplay.density "Link to this definition")
    :   Thickness of volume display in the viewport

        Type:
        :   float in [1e-05, inf], default 0.0

    interpolation\_method[¶](#bpy.types.VolumeDisplay.interpolation_method "Link to this definition")
    ...
    slice\_axis[¶](#bpy.types.VolumeDisplay.slice_axis "Link to this definition")
    :   * `AUTO`
    ...
    slice\_depth[¶](#bpy.types.VolumeDisplay.slice_depth "Link to this definition")
    :   Position of the slice

        Type:
        :   float in [0, 1], default 0.0

    use\_slice[¶](#bpy.types.VolumeDisplay.use_slice "Link to this definition")
    :   Perform a single slice of the domain object

        Type:
        :   boolean, default False

    wireframe\_detail[¶](#bpy.types.VolumeDisplay.wireframe_detail "Link to this definition")
    ...
    wireframe\_type[¶](#bpy.types.VolumeDisplay.wireframe_type "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.VolumeDisplay.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.VolumeDisplay.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Volume.display`](Volume.md#bpy.types.Volume.display "bpy.types.Volume.display") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.VolumeDisplay.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.VolumeDisplay.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* VolumeDisplay(bpy\_struct)
  + [`VolumeDisplay`](#bpy.types.VolumeDisplay)
    - [`VolumeDisplay.density`](#bpy.types.VolumeDisplay.density)
    - [`VolumeDisplay.interpolation_method`](#bpy.types.VolumeDisplay.interpolation_method)
    - [`VolumeDisplay.slice_axis`](#bpy.types.VolumeDisplay.slice_axis)
    - [`VolumeDisplay.slice_depth`](#bpy.types.VolumeDisplay.slice_depth)
    - [`VolumeDisplay.use_slice`](#bpy.types.VolumeDisplay.use_slice)
    - [`VolumeDisplay.wireframe_detail`](#bpy.types.VolumeDisplay.wireframe_detail)
    - [`VolumeDisplay.wireframe_type`](#bpy.types.VolumeDisplay.wireframe_type)
    - [`VolumeDisplay.bl_rna_get_subclass()`](#bpy.types.VolumeDisplay.bl_rna_get_subclass)
    - [`VolumeDisplay.bl_rna_get_subclass_py()`](#bpy.types.VolumeDisplay.bl_rna_get_subclass_py)
