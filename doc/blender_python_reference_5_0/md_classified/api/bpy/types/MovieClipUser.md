...
# MovieClipUser(bpy\_struct)[¶](#movieclipuser-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.MovieClipUser(*bpy\_struct*)[¶](#bpy.types.MovieClipUser "Link to this definition")
:   Parameters defining how a MovieClip data-block is used by another data-block

    frame\_current[¶](#bpy.types.MovieClipUser.frame_current "Link to this definition")
    :   Current frame number in movie or image sequence

        Type:
        :   int in [-1048574, 1048574], default 1

    proxy\_render\_size[¶](#bpy.types.MovieClipUser.proxy_render_size "Link to this definition")
    :   Display preview using full resolution or different proxy resolutions

        Type:
        :   enum in [`'PROXY_25'`, `'PROXY_50'`, `'PROXY_75'`, `'PROXY_100'`, `'FULL'`], default `'FULL'`

    use\_render\_undistorted[¶](#bpy.types.MovieClipUser.use_render_undistorted "Link to this definition")
    :   Render preview using undistorted proxy

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.MovieClipUser.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.MovieClipUser.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`CameraBackgroundImage.clip_user`](CameraBackgroundImage.md#bpy.types.CameraBackgroundImage.clip_user "bpy.types.CameraBackgroundImage.clip_user") * [`SpaceClipEditor.clip_user`](SpaceClipEditor.md#bpy.types.SpaceClipEditor.clip_user "bpy.types.SpaceClipEditor.clip_user") | * [`UILayout.template_marker`](UILayout.md#bpy.types.UILayout.template_marker "bpy.types.UILayout.template_marker") * [`UILayout.template_movieclip_information`](UILayout.md#bpy.types.UILayout.template_movieclip_information "bpy.types.UILayout.template_movieclip_information") |
...
MovieClipStrip(Strip)](MovieClipStrip.md)
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.MovieClipUser.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.MovieClipUser.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* MovieClipUser(bpy\_struct)
  + [`MovieClipUser`](#bpy.types.MovieClipUser)
    - [`MovieClipUser.frame_current`](#bpy.types.MovieClipUser.frame_current)
    - [`MovieClipUser.proxy_render_size`](#bpy.types.MovieClipUser.proxy_render_size)
    - [`MovieClipUser.use_render_undistorted`](#bpy.types.MovieClipUser.use_render_undistorted)
    - [`MovieClipUser.bl_rna_get_subclass()`](#bpy.types.MovieClipUser.bl_rna_get_subclass)
    - [`MovieClipUser.bl_rna_get_subclass_py()`](#bpy.types.MovieClipUser.bl_rna_get_subclass_py)
