...
# GroupNodeViewerPathElem(ViewerPathElem)[¶](#groupnodeviewerpathelem-viewerpathelem "Link to this heading")
...
*class* bpy.types.GroupNodeViewerPathElem(*ViewerPathElem*)[¶](#bpy.types.GroupNodeViewerPathElem "Link to this definition")
:   node\_id[¶](#bpy.types.GroupNodeViewerPathElem.node_id "Link to this definition")
    :   Type:
        :   int in [-inf, inf], default 0

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.GroupNodeViewerPathElem.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.GroupNodeViewerPathElem.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GroupNodeViewerPathElem.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.GroupNodeViewerPathElem.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GroupNodeViewerPathElem(ViewerPathElem)
  + [`GroupNodeViewerPathElem`](#bpy.types.GroupNodeViewerPathElem)
    - [`GroupNodeViewerPathElem.node_id`](#bpy.types.GroupNodeViewerPathElem.node_id)
    - [`GroupNodeViewerPathElem.bl_rna_get_subclass()`](#bpy.types.GroupNodeViewerPathElem.bl_rna_get_subclass)
    - [`GroupNodeViewerPathElem.bl_rna_get_subclass_py()`](#bpy.types.GroupNodeViewerPathElem.bl_rna_get_subclass_py)
