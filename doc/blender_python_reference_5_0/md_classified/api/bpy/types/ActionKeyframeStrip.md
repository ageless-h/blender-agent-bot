...
# ActionKeyframeStrip(ActionStrip)[¶](#actionkeyframestrip-actionstrip "Link to this heading")

base classes — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct"), [`ActionStrip`](ActionStrip.md#bpy.types.ActionStrip "bpy.types.ActionStrip")

*class* bpy.types.ActionKeyframeStrip(*ActionStrip*)[¶](#bpy.types.ActionKeyframeStrip "Link to this definition")
:   Strip with a set of F-Curves for each action slot

    channelbags[¶](#bpy.types.ActionKeyframeStrip.channelbags "Link to this definition")
    :   Type:
        :   [`ActionChannelbags`](ActionChannelbags.md#bpy.types.ActionChannelbags "bpy.types.ActionChannelbags") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`ActionChannelbag`](ActionChannelbag.md#bpy.types.ActionChannelbag "bpy.types.ActionChannelbag"), (readonly)

    channelbag(*slot*, *\**, *ensure=False*)[¶](#bpy.types.ActionKeyframeStrip.channelbag "Link to this definition")
    :   Find the ActionChannelbag for a specific Slot

        Parameters:
        :   * **slot** ([`ActionSlot`](ActionSlot.md#bpy.types.ActionSlot "bpy.types.ActionSlot")) – Slot, The slot for which to find the channelbag
        ...
        Return type:
        :   [`ActionChannelbag`](ActionChannelbag.md#bpy.types.ActionChannelbag "bpy.types.ActionChannelbag")

    key\_insert(*slot*, *data\_path*, *array\_index*, *value*, *time*)[¶](#bpy.types.ActionKeyframeStrip.key_insert "Link to this definition")
    :   key\_insert

        Parameters:
        :   * **slot** ([`ActionSlot`](ActionSlot.md#bpy.types.ActionSlot "bpy.types.ActionSlot")) – Slot, The slot that identifies which ‘thing’ should be keyed
            * **data\_path** (*string**,* *(**never None**)*) – Data Path, F-Curve data path
            * **array\_index** (*int in* *[**-inf**,* *inf**]*) – Array Index, Index of the animated array element, or -1 if the property is not an array
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ActionKeyframeStrip.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ActionKeyframeStrip.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ActionKeyframeStrip.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ActionKeyframeStrip.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ActionKeyframeStrip(ActionStrip)
  + [`ActionKeyframeStrip`](#bpy.types.ActionKeyframeStrip)
    - [`ActionKeyframeStrip.channelbags`](#bpy.types.ActionKeyframeStrip.channelbags)
    - [`ActionKeyframeStrip.channelbag()`](#bpy.types.ActionKeyframeStrip.channelbag)
    - [`ActionKeyframeStrip.key_insert()`](#bpy.types.ActionKeyframeStrip.key_insert)
    - [`ActionKeyframeStrip.bl_rna_get_subclass()`](#bpy.types.ActionKeyframeStrip.bl_rna_get_subclass)
    - [`ActionKeyframeStrip.bl_rna_get_subclass_py()`](#bpy.types.ActionKeyframeStrip.bl_rna_get_subclass_py)
