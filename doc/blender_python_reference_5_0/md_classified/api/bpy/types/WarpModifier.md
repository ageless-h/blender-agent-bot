...
# WarpModifier(Modifier)[¶](#warpmodifier-modifier "Link to this heading")
...
*class* bpy.types.WarpModifier(*Modifier*)[¶](#bpy.types.WarpModifier "Link to this definition")
:   Warp modifier

    bone\_from[¶](#bpy.types.WarpModifier.bone_from "Link to this definition")
    :   Bone to transform from

        Type:
        :   string, default “”, (never None)

    bone\_to[¶](#bpy.types.WarpModifier.bone_to "Link to this definition")
    :   Bone defining offset

        Type:
        :   string, default “”, (never None)

    falloff\_curve[¶](#bpy.types.WarpModifier.falloff_curve "Link to this definition")
    :   Custom falloff curve

        Type:
        :   [`CurveMapping`](CurveMapping.md#bpy.types.CurveMapping "bpy.types.CurveMapping"), (readonly)

    falloff\_radius[¶](#bpy.types.WarpModifier.falloff_radius "Link to this definition")
    :   Radius to apply

        Type:
        :   float in [-inf, inf], default 1.0

    falloff\_type[¶](#bpy.types.WarpModifier.falloff_type "Link to this definition")
    :   Type:
        :   enum in [`'NONE'`, `'CURVE'`, `'SMOOTH'`, `'SPHERE'`, `'ROOT'`, `'INVERSE_SQUARE'`, `'SHARP'`, `'LINEAR'`, `'CONSTANT'`], default `'SMOOTH'`

    invert\_vertex\_group[¶](#bpy.types.WarpModifier.invert_vertex_group "Link to this definition")
    :   Invert vertex group influence

        Type:
        :   boolean, default False

    object\_from[¶](#bpy.types.WarpModifier.object_from "Link to this definition")
    :   Object to transform from

        Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object")

    object\_to[¶](#bpy.types.WarpModifier.object_to "Link to this definition")
    :   Object to transform to

        Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object")

    strength[¶](#bpy.types.WarpModifier.strength "Link to this definition")
    :   Type:
        :   float in [-inf, inf], default 1.0

    texture[¶](#bpy.types.WarpModifier.texture "Link to this definition")
    :   Type:
        :   [`Texture`](Texture.md#bpy.types.Texture "bpy.types.Texture")

    texture\_coords[¶](#bpy.types.WarpModifier.texture_coords "Link to this definition")
    :   * `LOCAL`
    ...
    texture\_coords\_bone[¶](#bpy.types.WarpModifier.texture_coords_bone "Link to this definition")
    :   Bone to set the texture coordinates

        Type:
        :   string, default “”, (never None)

    texture\_coords\_object[¶](#bpy.types.WarpModifier.texture_coords_object "Link to this definition")
    :   Object to set the texture coordinates

        Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object")

    use\_volume\_preserve[¶](#bpy.types.WarpModifier.use_volume_preserve "Link to this definition")
    :   Preserve volume when rotations are used

        Type:
        :   boolean, default False

    uv\_layer[¶](#bpy.types.WarpModifier.uv_layer "Link to this definition")
    :   UV map name

        Type:
        :   string, default “”, (never None)

    vertex\_group[¶](#bpy.types.WarpModifier.vertex_group "Link to this definition")
    :   Vertex group name for modulating the deform

        Type:
        :   string, default “”, (never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.WarpModifier.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.WarpModifier.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.WarpModifier.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.WarpModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* WarpModifier(Modifier)
  + [`WarpModifier`](#bpy.types.WarpModifier)
    - [`WarpModifier.bone_from`](#bpy.types.WarpModifier.bone_from)
    - [`WarpModifier.bone_to`](#bpy.types.WarpModifier.bone_to)
    - [`WarpModifier.falloff_curve`](#bpy.types.WarpModifier.falloff_curve)
    - [`WarpModifier.falloff_radius`](#bpy.types.WarpModifier.falloff_radius)
    - [`WarpModifier.falloff_type`](#bpy.types.WarpModifier.falloff_type)
    - [`WarpModifier.invert_vertex_group`](#bpy.types.WarpModifier.invert_vertex_group)
    - [`WarpModifier.object_from`](#bpy.types.WarpModifier.object_from)
    - [`WarpModifier.object_to`](#bpy.types.WarpModifier.object_to)
    - [`WarpModifier.strength`](#bpy.types.WarpModifier.strength)
    - [`WarpModifier.texture`](#bpy.types.WarpModifier.texture)
    - [`WarpModifier.texture_coords`](#bpy.types.WarpModifier.texture_coords)
    - [`WarpModifier.texture_coords_bone`](#bpy.types.WarpModifier.texture_coords_bone)
    - [`WarpModifier.texture_coords_object`](#bpy.types.WarpModifier.texture_coords_object)
    - [`WarpModifier.use_volume_preserve`](#bpy.types.WarpModifier.use_volume_preserve)
    - [`WarpModifier.uv_layer`](#bpy.types.WarpModifier.uv_layer)
    - [`WarpModifier.vertex_group`](#bpy.types.WarpModifier.vertex_group)
    - [`WarpModifier.bl_rna_get_subclass()`](#bpy.types.WarpModifier.bl_rna_get_subclass)
    - [`WarpModifier.bl_rna_get_subclass_py()`](#bpy.types.WarpModifier.bl_rna_get_subclass_py)
