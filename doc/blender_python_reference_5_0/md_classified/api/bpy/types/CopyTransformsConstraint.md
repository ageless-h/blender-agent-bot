...
# CopyTransformsConstraint(Constraint)[¶](#copytransformsconstraint-constraint "Link to this heading")
...
*class* bpy.types.CopyTransformsConstraint(*Constraint*)[¶](#bpy.types.CopyTransformsConstraint "Link to this definition")
:   Copy all the transforms of the target

    head\_tail[¶](#bpy.types.CopyTransformsConstraint.head_tail "Link to this definition")
    :   Target along length of bone: Head is 0, Tail is 1

        Type:
        :   float in [0, 1], default 0.0

    mix\_mode[¶](#bpy.types.CopyTransformsConstraint.mix_mode "Link to this definition")
    ...
    remove\_target\_shear[¶](#bpy.types.CopyTransformsConstraint.remove_target_shear "Link to this definition")
    :   Remove shear from the target transformation before combining

        Type:
        :   boolean, default False

    subtarget[¶](#bpy.types.CopyTransformsConstraint.subtarget "Link to this definition")
    :   Armature bone, mesh or lattice vertex group, …

        Type:
        :   string, default “”, (never None)

    target[¶](#bpy.types.CopyTransformsConstraint.target "Link to this definition")
    :   Target object

        Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object")

    use\_bbone\_shape[¶](#bpy.types.CopyTransformsConstraint.use_bbone_shape "Link to this definition")
    :   Follow shape of B-Bone segments when calculating Head/Tail position

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.CopyTransformsConstraint.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.CopyTransformsConstraint.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CopyTransformsConstraint.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.CopyTransformsConstraint.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CopyTransformsConstraint(Constraint)
  + [`CopyTransformsConstraint`](#bpy.types.CopyTransformsConstraint)
    - [`CopyTransformsConstraint.head_tail`](#bpy.types.CopyTransformsConstraint.head_tail)
    - [`CopyTransformsConstraint.mix_mode`](#bpy.types.CopyTransformsConstraint.mix_mode)
    - [`CopyTransformsConstraint.remove_target_shear`](#bpy.types.CopyTransformsConstraint.remove_target_shear)
    - [`CopyTransformsConstraint.subtarget`](#bpy.types.CopyTransformsConstraint.subtarget)
    - [`CopyTransformsConstraint.target`](#bpy.types.CopyTransformsConstraint.target)
    - [`CopyTransformsConstraint.use_bbone_shape`](#bpy.types.CopyTransformsConstraint.use_bbone_shape)
    - [`CopyTransformsConstraint.bl_rna_get_subclass()`](#bpy.types.CopyTransformsConstraint.bl_rna_get_subclass)
    - [`CopyTransformsConstraint.bl_rna_get_subclass_py()`](#bpy.types.CopyTransformsConstraint.bl_rna_get_subclass_py)
