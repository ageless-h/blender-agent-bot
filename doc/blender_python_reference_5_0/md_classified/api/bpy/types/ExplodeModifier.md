...
# ExplodeModifier(Modifier)[¶](#explodemodifier-modifier "Link to this heading")
...
*class* bpy.types.ExplodeModifier(*Modifier*)[¶](#bpy.types.ExplodeModifier "Link to this definition")
:   Explosion effect modifier based on a particle system

    invert\_vertex\_group[¶](#bpy.types.ExplodeModifier.invert_vertex_group "Link to this definition")
    :   Invert vertex group influence

        Type:
        :   boolean, default False

    particle\_uv[¶](#bpy.types.ExplodeModifier.particle_uv "Link to this definition")
    :   UV map to change with particle age

        Type:
        :   string, default “”, (never None)

    protect[¶](#bpy.types.ExplodeModifier.protect "Link to this definition")
    :   Clean vertex group edges

        Type:
        :   float in [0, 1], default 0.0

    show\_alive[¶](#bpy.types.ExplodeModifier.show_alive "Link to this definition")
    :   Show mesh when particles are alive

        Type:
        :   boolean, default True

    show\_dead[¶](#bpy.types.ExplodeModifier.show_dead "Link to this definition")
    :   Show mesh when particles are dead

        Type:
        :   boolean, default True

    show\_unborn[¶](#bpy.types.ExplodeModifier.show_unborn "Link to this definition")
    :   Show mesh when particles are unborn

        Type:
        :   boolean, default True

    use\_edge\_cut[¶](#bpy.types.ExplodeModifier.use_edge_cut "Link to this definition")
    :   Cut face edges for nicer shrapnel

        Type:
        :   boolean, default False

    use\_size[¶](#bpy.types.ExplodeModifier.use_size "Link to this definition")
    :   Use particle size for the shrapnel

        Type:
        :   boolean, default False

    vertex\_group[¶](#bpy.types.ExplodeModifier.vertex_group "Link to this definition")
    :   Type:
        :   string, default “”, (never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ExplodeModifier.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ExplodeModifier.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ExplodeModifier.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ExplodeModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ExplodeModifier(Modifier)
  + [`ExplodeModifier`](#bpy.types.ExplodeModifier)
    - [`ExplodeModifier.invert_vertex_group`](#bpy.types.ExplodeModifier.invert_vertex_group)
    - [`ExplodeModifier.particle_uv`](#bpy.types.ExplodeModifier.particle_uv)
    - [`ExplodeModifier.protect`](#bpy.types.ExplodeModifier.protect)
    - [`ExplodeModifier.show_alive`](#bpy.types.ExplodeModifier.show_alive)
    - [`ExplodeModifier.show_dead`](#bpy.types.ExplodeModifier.show_dead)
    - [`ExplodeModifier.show_unborn`](#bpy.types.ExplodeModifier.show_unborn)
    - [`ExplodeModifier.use_edge_cut`](#bpy.types.ExplodeModifier.use_edge_cut)
    - [`ExplodeModifier.use_size`](#bpy.types.ExplodeModifier.use_size)
    - [`ExplodeModifier.vertex_group`](#bpy.types.ExplodeModifier.vertex_group)
    - [`ExplodeModifier.bl_rna_get_subclass()`](#bpy.types.ExplodeModifier.bl_rna_get_subclass)
    - [`ExplodeModifier.bl_rna_get_subclass_py()`](#bpy.types.ExplodeModifier.bl_rna_get_subclass_py)
