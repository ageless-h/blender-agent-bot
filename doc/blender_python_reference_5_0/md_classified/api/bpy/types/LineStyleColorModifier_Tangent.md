...
# LineStyleColorModifier\_Tangent(LineStyleColorModifier)[¶](#linestylecolormodifier-tangent-linestylecolormodifier "Link to this heading")
...
*class* bpy.types.LineStyleColorModifier\_Tangent(*LineStyleColorModifier*)[¶](#bpy.types.LineStyleColorModifier_Tangent "Link to this definition")
:   Change line color based on the direction of a stroke

    blend[¶](#bpy.types.LineStyleColorModifier_Tangent.blend "Link to this definition")
    ...
    color\_ramp[¶](#bpy.types.LineStyleColorModifier_Tangent.color_ramp "Link to this definition")
    :   Color ramp used to change line color

        Type:
        :   [`ColorRamp`](ColorRamp.md#bpy.types.ColorRamp "bpy.types.ColorRamp"), (readonly)

    expanded[¶](#bpy.types.LineStyleColorModifier_Tangent.expanded "Link to this definition")
    :   True if the modifier tab is expanded

        Type:
        :   boolean, default False

    influence[¶](#bpy.types.LineStyleColorModifier_Tangent.influence "Link to this definition")
    :   Influence factor by which the modifier changes the property

        Type:
        :   float in [0, 1], default 0.0

    type[¶](#bpy.types.LineStyleColorModifier_Tangent.type "Link to this definition")
    ...
    use[¶](#bpy.types.LineStyleColorModifier_Tangent.use "Link to this definition")
    :   Enable or disable this modifier during stroke rendering

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.LineStyleColorModifier_Tangent.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.LineStyleColorModifier_Tangent.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.LineStyleColorModifier_Tangent.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.LineStyleColorModifier_Tangent.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* LineStyleColorModifier\_Tangent(LineStyleColorModifier)
  + [`LineStyleColorModifier_Tangent`](#bpy.types.LineStyleColorModifier_Tangent)
    - [`LineStyleColorModifier_Tangent.blend`](#bpy.types.LineStyleColorModifier_Tangent.blend)
    - [`LineStyleColorModifier_Tangent.color_ramp`](#bpy.types.LineStyleColorModifier_Tangent.color_ramp)
    - [`LineStyleColorModifier_Tangent.expanded`](#bpy.types.LineStyleColorModifier_Tangent.expanded)
    - [`LineStyleColorModifier_Tangent.influence`](#bpy.types.LineStyleColorModifier_Tangent.influence)
    - [`LineStyleColorModifier_Tangent.type`](#bpy.types.LineStyleColorModifier_Tangent.type)
    - [`LineStyleColorModifier_Tangent.use`](#bpy.types.LineStyleColorModifier_Tangent.use)
    - [`LineStyleColorModifier_Tangent.bl_rna_get_subclass()`](#bpy.types.LineStyleColorModifier_Tangent.bl_rna_get_subclass)
    - [`LineStyleColorModifier_Tangent.bl_rna_get_subclass_py()`](#bpy.types.LineStyleColorModifier_Tangent.bl_rna_get_subclass_py)
