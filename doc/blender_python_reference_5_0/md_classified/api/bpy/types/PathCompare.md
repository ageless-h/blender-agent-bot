...
# PathCompare(bpy\_struct)[¶](#pathcompare-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.PathCompare(*bpy\_struct*)[¶](#bpy.types.PathCompare "Link to this definition")
:   Match paths against this value

    path[¶](#bpy.types.PathCompare.path "Link to this definition")
    :   Type:
        :   string, default “”, (never None)

    use\_glob[¶](#bpy.types.PathCompare.use_glob "Link to this definition")
    :   Enable wildcard globbing

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.PathCompare.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.PathCompare.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`PathCompareCollection.new`](PathCompareCollection.md#bpy.types.PathCompareCollection.new "bpy.types.PathCompareCollection.new") * [`PathCompareCollection.remove`](PathCompareCollection.md#bpy.types.PathCompareCollection.remove "bpy.types.PathCompareCollection.remove") | * [`Preferences.autoexec_paths`](Preferences.md#bpy.types.Preferences.autoexec_paths "bpy.types.Preferences.autoexec_paths") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.PathCompare.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.PathCompare.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* PathCompare(bpy\_struct)
  + [`PathCompare`](#bpy.types.PathCompare)
    - [`PathCompare.path`](#bpy.types.PathCompare.path)
    - [`PathCompare.use_glob`](#bpy.types.PathCompare.use_glob)
    - [`PathCompare.bl_rna_get_subclass()`](#bpy.types.PathCompare.bl_rna_get_subclass)
    - [`PathCompare.bl_rna_get_subclass_py()`](#bpy.types.PathCompare.bl_rna_get_subclass_py)
