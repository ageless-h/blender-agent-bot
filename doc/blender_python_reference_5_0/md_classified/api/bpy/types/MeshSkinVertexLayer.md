...
# MeshSkinVertexLayer(bpy\_struct)[¶](#meshskinvertexlayer-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.MeshSkinVertexLayer(*bpy\_struct*)[¶](#bpy.types.MeshSkinVertexLayer "Link to this definition")
:   Per-vertex skin data for use with the Skin modifier

    data[¶](#bpy.types.MeshSkinVertexLayer.data "Link to this definition")
    :   Type:
        :   [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`MeshSkinVertex`](MeshSkinVertex.md#bpy.types.MeshSkinVertex "bpy.types.MeshSkinVertex"), (readonly)

    name[¶](#bpy.types.MeshSkinVertexLayer.name "Link to this definition")
    :   Name of skin layer

        Type:
        :   string, default “”, (never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.MeshSkinVertexLayer.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.MeshSkinVertexLayer.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Mesh.skin_vertices`](Mesh.md#bpy.types.Mesh.skin_vertices "bpy.types.Mesh.skin_vertices") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.MeshSkinVertexLayer.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.MeshSkinVertexLayer.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* MeshSkinVertexLayer(bpy\_struct)
  + [`MeshSkinVertexLayer`](#bpy.types.MeshSkinVertexLayer)
    - [`MeshSkinVertexLayer.data`](#bpy.types.MeshSkinVertexLayer.data)
    - [`MeshSkinVertexLayer.name`](#bpy.types.MeshSkinVertexLayer.name)
    - [`MeshSkinVertexLayer.bl_rna_get_subclass()`](#bpy.types.MeshSkinVertexLayer.bl_rna_get_subclass)
    - [`MeshSkinVertexLayer.bl_rna_get_subclass_py()`](#bpy.types.MeshSkinVertexLayer.bl_rna_get_subclass_py)
