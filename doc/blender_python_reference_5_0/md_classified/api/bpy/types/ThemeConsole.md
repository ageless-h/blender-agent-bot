...
# ThemeConsole(bpy\_struct)[¶](#themeconsole-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.ThemeConsole(*bpy\_struct*)[¶](#bpy.types.ThemeConsole "Link to this definition")
:   Theme settings for the Console

    cursor[¶](#bpy.types.ThemeConsole.cursor "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    line\_error[¶](#bpy.types.ThemeConsole.line_error "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    line\_info[¶](#bpy.types.ThemeConsole.line_info "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    line\_input[¶](#bpy.types.ThemeConsole.line_input "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    line\_output[¶](#bpy.types.ThemeConsole.line_output "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    select[¶](#bpy.types.ThemeConsole.select "Link to this definition")
    :   Type:
        :   float array of 4 items in [0, 1], default (0.0, 0.0, 0.0, 0.0)

    space[¶](#bpy.types.ThemeConsole.space "Link to this definition")
    :   Settings for space

        Type:
        :   [`ThemeSpaceGeneric`](ThemeSpaceGeneric.md#bpy.types.ThemeSpaceGeneric "bpy.types.ThemeSpaceGeneric"), (readonly, never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ThemeConsole.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ThemeConsole.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Theme.console`](Theme.md#bpy.types.Theme.console "bpy.types.Theme.console") |  |
...
ThemeCommonCurves(bpy\_struct)](ThemeCommonCurves.md)
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ThemeConsole.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ThemeConsole.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ThemeConsole(bpy\_struct)
  + [`ThemeConsole`](#bpy.types.ThemeConsole)
    - [`ThemeConsole.cursor`](#bpy.types.ThemeConsole.cursor)
    - [`ThemeConsole.line_error`](#bpy.types.ThemeConsole.line_error)
    - [`ThemeConsole.line_info`](#bpy.types.ThemeConsole.line_info)
    - [`ThemeConsole.line_input`](#bpy.types.ThemeConsole.line_input)
    - [`ThemeConsole.line_output`](#bpy.types.ThemeConsole.line_output)
    - [`ThemeConsole.select`](#bpy.types.ThemeConsole.select)
    - [`ThemeConsole.space`](#bpy.types.ThemeConsole.space)
    - [`ThemeConsole.bl_rna_get_subclass()`](#bpy.types.ThemeConsole.bl_rna_get_subclass)
    - [`ThemeConsole.bl_rna_get_subclass_py()`](#bpy.types.ThemeConsole.bl_rna_get_subclass_py)
