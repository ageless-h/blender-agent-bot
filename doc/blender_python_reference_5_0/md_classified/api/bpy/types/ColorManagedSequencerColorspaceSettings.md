...
# ColorManagedSequencerColorspaceSettings(bpy\_struct)[¶](#colormanagedsequencercolorspacesettings-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.ColorManagedSequencerColorspaceSettings(*bpy\_struct*)[¶](#bpy.types.ColorManagedSequencerColorspaceSettings "Link to this definition")
:   Input color space settings

    name[¶](#bpy.types.ColorManagedSequencerColorspaceSettings.name "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ColorManagedSequencerColorspaceSettings.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ColorManagedSequencerColorspaceSettings.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Scene.sequencer_colorspace_settings`](Scene.md#bpy.types.Scene.sequencer_colorspace_settings "bpy.types.Scene.sequencer_colorspace_settings") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ColorManagedSequencerColorspaceSettings.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ColorManagedSequencerColorspaceSettings.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ColorManagedSequencerColorspaceSettings(bpy\_struct)
  + [`ColorManagedSequencerColorspaceSettings`](#bpy.types.ColorManagedSequencerColorspaceSettings)
    - [`ColorManagedSequencerColorspaceSettings.name`](#bpy.types.ColorManagedSequencerColorspaceSettings.name)
    - [`ColorManagedSequencerColorspaceSettings.bl_rna_get_subclass()`](#bpy.types.ColorManagedSequencerColorspaceSettings.bl_rna_get_subclass)
    - [`ColorManagedSequencerColorspaceSettings.bl_rna_get_subclass_py()`](#bpy.types.ColorManagedSequencerColorspaceSettings.bl_rna_get_subclass_py)
