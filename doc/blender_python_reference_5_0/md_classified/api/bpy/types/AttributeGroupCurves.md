...
# AttributeGroupCurves(bpy\_struct)[¶](#attributegroupcurves-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.AttributeGroupCurves(*bpy\_struct*)[¶](#bpy.types.AttributeGroupCurves "Link to this definition")
:   Group of geometry attributes

    active[¶](#bpy.types.AttributeGroupCurves.active "Link to this definition")
    :   Active attribute

        Type:
        :   [`Attribute`](Attribute.md#bpy.types.Attribute "bpy.types.Attribute")

    active\_index[¶](#bpy.types.AttributeGroupCurves.active_index "Link to this definition")
    :   Active attribute index or -1 when none are active

        Type:
        :   int in [-1, inf], default 0

    new(*name*, *type*, *domain*)[¶](#bpy.types.AttributeGroupCurves.new "Link to this definition")
    ...
    remove(*attribute*)[¶](#bpy.types.AttributeGroupCurves.remove "Link to this definition")
    :   Remove attribute from geometry

        Parameters:
        :   **attribute** ([`Attribute`](Attribute.md#bpy.types.Attribute "bpy.types.Attribute"), (never None)) – Geometry Attribute

    domain\_size(*domain*)[¶](#bpy.types.AttributeGroupCurves.domain_size "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.AttributeGroupCurves.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.AttributeGroupCurves.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Curves.attributes`](Curves.md#bpy.types.Curves.attributes "bpy.types.Curves.attributes") | * [`Curves.color_attributes`](Curves.md#bpy.types.Curves.color_attributes "bpy.types.Curves.color_attributes") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.AttributeGroupCurves.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.AttributeGroupCurves.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* AttributeGroupCurves(bpy\_struct)
  + [`AttributeGroupCurves`](#bpy.types.AttributeGroupCurves)
    - [`AttributeGroupCurves.active`](#bpy.types.AttributeGroupCurves.active)
    - [`AttributeGroupCurves.active_index`](#bpy.types.AttributeGroupCurves.active_index)
    - [`AttributeGroupCurves.new()`](#bpy.types.AttributeGroupCurves.new)
    - [`AttributeGroupCurves.remove()`](#bpy.types.AttributeGroupCurves.remove)
    - [`AttributeGroupCurves.domain_size()`](#bpy.types.AttributeGroupCurves.domain_size)
    - [`AttributeGroupCurves.bl_rna_get_subclass()`](#bpy.types.AttributeGroupCurves.bl_rna_get_subclass)
    - [`AttributeGroupCurves.bl_rna_get_subclass_py()`](#bpy.types.AttributeGroupCurves.bl_rna_get_subclass_py)
