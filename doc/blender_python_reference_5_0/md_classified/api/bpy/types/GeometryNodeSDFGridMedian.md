...
# GeometryNodeSDFGridMedian(GeometryNode)[¶](#geometrynodesdfgridmedian-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeSDFGridMedian(*GeometryNode*)[¶](#bpy.types.GeometryNodeSDFGridMedian "Link to this definition")
:   Apply median filter to a signed distance field. Reduces noise while preserving sharp features and edges in the distance field
    ...
    *classmethod* is\_registered\_node\_type()[¶](#bpy.types.GeometryNodeSDFGridMedian.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[¶](#bpy.types.GeometryNodeSDFGridMedian.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[¶](#bpy.types.GeometryNodeSDFGridMedian.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.GeometryNodeSDFGridMedian.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.GeometryNodeSDFGridMedian.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
GeometryNodeSDFGridMeanCurvature(GeometryNode)](GeometryNodeSDFGridMeanCurvature.md)
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeSDFGridMedian.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.GeometryNodeSDFGridMedian.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeSDFGridMedian(GeometryNode)
  + [`GeometryNodeSDFGridMedian`](#bpy.types.GeometryNodeSDFGridMedian)
    - [`GeometryNodeSDFGridMedian.is_registered_node_type()`](#bpy.types.GeometryNodeSDFGridMedian.is_registered_node_type)
    - [`GeometryNodeSDFGridMedian.input_template()`](#bpy.types.GeometryNodeSDFGridMedian.input_template)
    - [`GeometryNodeSDFGridMedian.output_template()`](#bpy.types.GeometryNodeSDFGridMedian.output_template)
    - [`GeometryNodeSDFGridMedian.bl_rna_get_subclass()`](#bpy.types.GeometryNodeSDFGridMedian.bl_rna_get_subclass)
    - [`GeometryNodeSDFGridMedian.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeSDFGridMedian.bl_rna_get_subclass_py)
