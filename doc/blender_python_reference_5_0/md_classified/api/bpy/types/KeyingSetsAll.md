...
# KeyingSetsAll(bpy\_struct)[¶](#keyingsetsall-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.KeyingSetsAll(*bpy\_struct*)[¶](#bpy.types.KeyingSetsAll "Link to this definition")
:   All available keying sets

    active[¶](#bpy.types.KeyingSetsAll.active "Link to this definition")
    :   Active Keying Set used to insert/delete keyframes

        Type:
        :   [`KeyingSet`](KeyingSet.md#bpy.types.KeyingSet "bpy.types.KeyingSet")

    active\_index[¶](#bpy.types.KeyingSetsAll.active_index "Link to this definition")
    :   Current Keying Set index (negative for ‘builtin’ and positive for ‘absolute’)

        Type:
        :   int in [-inf, inf], default 0

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.KeyingSetsAll.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.KeyingSetsAll.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Scene.keying_sets_all`](Scene.md#bpy.types.Scene.keying_sets_all "bpy.types.Scene.keying_sets_all") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.KeyingSetsAll.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.KeyingSetsAll.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* KeyingSetsAll(bpy\_struct)
  + [`KeyingSetsAll`](#bpy.types.KeyingSetsAll)
    - [`KeyingSetsAll.active`](#bpy.types.KeyingSetsAll.active)
    - [`KeyingSetsAll.active_index`](#bpy.types.KeyingSetsAll.active_index)
    - [`KeyingSetsAll.bl_rna_get_subclass()`](#bpy.types.KeyingSetsAll.bl_rna_get_subclass)
    - [`KeyingSetsAll.bl_rna_get_subclass_py()`](#bpy.types.KeyingSetsAll.bl_rna_get_subclass_py)
