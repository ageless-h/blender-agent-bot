...
# AssetLibraryCollection(bpy\_struct)[¶](#assetlibrarycollection-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.AssetLibraryCollection(*bpy\_struct*)[¶](#bpy.types.AssetLibraryCollection "Link to this definition")
:   Collection of user asset libraries

    *classmethod* new(*\**, *name=''*, *directory=''*)[¶](#bpy.types.AssetLibraryCollection.new "Link to this definition")
    :   Add a new Asset Library
        ...
        Return type:
        :   [`UserAssetLibrary`](UserAssetLibrary.md#bpy.types.UserAssetLibrary "bpy.types.UserAssetLibrary")

    *classmethod* remove(*library*)[¶](#bpy.types.AssetLibraryCollection.remove "Link to this definition")
    :   Remove an Asset Library

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.AssetLibraryCollection.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.AssetLibraryCollection.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`PreferencesFilePaths.asset_libraries`](PreferencesFilePaths.md#bpy.types.PreferencesFilePaths.asset_libraries "bpy.types.PreferencesFilePaths.asset_libraries") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.AssetLibraryCollection.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.AssetLibraryCollection.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* AssetLibraryCollection(bpy\_struct)
  + [`AssetLibraryCollection`](#bpy.types.AssetLibraryCollection)
    - [`AssetLibraryCollection.new()`](#bpy.types.AssetLibraryCollection.new)
    - [`AssetLibraryCollection.remove()`](#bpy.types.AssetLibraryCollection.remove)
    - [`AssetLibraryCollection.bl_rna_get_subclass()`](#bpy.types.AssetLibraryCollection.bl_rna_get_subclass)
    - [`AssetLibraryCollection.bl_rna_get_subclass_py()`](#bpy.types.AssetLibraryCollection.bl_rna_get_subclass_py)
