...
# SpaceConsole(Space)[¶](#spaceconsole-space "Link to this heading")
...
*class* bpy.types.SpaceConsole(*Space*)[¶](#bpy.types.SpaceConsole "Link to this definition")
:   Interactive Python console

    font\_size[¶](#bpy.types.SpaceConsole.font_size "Link to this definition")
    :   Font size to use for displaying the text

        Type:
        :   int in [1, 256], default 0

    history[¶](#bpy.types.SpaceConsole.history "Link to this definition")
    :   Command history

        Type:
        :   [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`ConsoleLine`](ConsoleLine.md#bpy.types.ConsoleLine "bpy.types.ConsoleLine"), (readonly)

    language[¶](#bpy.types.SpaceConsole.language "Link to this definition")
    :   Command line prompt language

        Type:
        :   string, default “”, (never None)

    prompt[¶](#bpy.types.SpaceConsole.prompt "Link to this definition")
    :   Command line prompt

        Type:
        :   string, default “”, (never None)

    scrollback[¶](#bpy.types.SpaceConsole.scrollback "Link to this definition")
    :   Command output

        Type:
        :   [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`ConsoleLine`](ConsoleLine.md#bpy.types.ConsoleLine "bpy.types.ConsoleLine"), (readonly)

    select\_end[¶](#bpy.types.SpaceConsole.select_end "Link to this definition")
    :   Type:
        :   int in [0, inf], default 0

    select\_start[¶](#bpy.types.SpaceConsole.select_start "Link to this definition")
    :   Type:
        :   int in [0, inf], default 0

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.SpaceConsole.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.SpaceConsole.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
    ...
    *classmethod* draw\_handler\_add(*callback*, *args*, *region\_type*, *draw\_type*)[¶](#bpy.types.SpaceConsole.draw_handler_add "Link to this definition")
    ...
    *classmethod* draw\_handler\_remove(*handler*, *region\_type*)[¶](#bpy.types.SpaceConsole.draw_handler_remove "Link to this definition")
...
SpaceClipOverlay(bpy\_struct)](SpaceClipOverlay.md)
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.SpaceConsole.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.SpaceConsole.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* SpaceConsole(Space)
  + [`SpaceConsole`](#bpy.types.SpaceConsole)
    - [`SpaceConsole.font_size`](#bpy.types.SpaceConsole.font_size)
    - [`SpaceConsole.history`](#bpy.types.SpaceConsole.history)
    - [`SpaceConsole.language`](#bpy.types.SpaceConsole.language)
    - [`SpaceConsole.prompt`](#bpy.types.SpaceConsole.prompt)
    - [`SpaceConsole.scrollback`](#bpy.types.SpaceConsole.scrollback)
    - [`SpaceConsole.select_end`](#bpy.types.SpaceConsole.select_end)
    - [`SpaceConsole.select_start`](#bpy.types.SpaceConsole.select_start)
    - [`SpaceConsole.bl_rna_get_subclass()`](#bpy.types.SpaceConsole.bl_rna_get_subclass)
    - [`SpaceConsole.bl_rna_get_subclass_py()`](#bpy.types.SpaceConsole.bl_rna_get_subclass_py)
    - [`SpaceConsole.draw_handler_add()`](#bpy.types.SpaceConsole.draw_handler_add)
    - [`SpaceConsole.draw_handler_remove()`](#bpy.types.SpaceConsole.draw_handler_remove)
