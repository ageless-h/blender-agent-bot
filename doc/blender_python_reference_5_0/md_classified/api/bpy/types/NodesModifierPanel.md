...
# NodesModifierPanel(bpy\_struct)[¶](#nodesmodifierpanel-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.NodesModifierPanel(*bpy\_struct*)[¶](#bpy.types.NodesModifierPanel "Link to this definition")
:   is\_open[¶](#bpy.types.NodesModifierPanel.is_open "Link to this definition")
    :   Whether the panel is expanded or closed

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.NodesModifierPanel.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.NodesModifierPanel.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`NodesModifier.panels`](NodesModifier.md#bpy.types.NodesModifier.panels "bpy.types.NodesModifier.panels") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.NodesModifierPanel.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.NodesModifierPanel.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* NodesModifierPanel(bpy\_struct)
  + [`NodesModifierPanel`](#bpy.types.NodesModifierPanel)
    - [`NodesModifierPanel.is_open`](#bpy.types.NodesModifierPanel.is_open)
    - [`NodesModifierPanel.bl_rna_get_subclass()`](#bpy.types.NodesModifierPanel.bl_rna_get_subclass)
    - [`NodesModifierPanel.bl_rna_get_subclass_py()`](#bpy.types.NodesModifierPanel.bl_rna_get_subclass_py)
