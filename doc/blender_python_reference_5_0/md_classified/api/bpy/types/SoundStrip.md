...
# SoundStrip(Strip)[¶](#soundstrip-strip "Link to this heading")
...
*class* bpy.types.SoundStrip(*Strip*)[¶](#bpy.types.SoundStrip "Link to this definition")
:   Sequence strip defining a sound to be played over a period of time

    animation\_offset\_end[¶](#bpy.types.SoundStrip.animation_offset_end "Link to this definition")
    :   Animation end offset (trim end)

        Type:
        :   int in [0, inf], default 0

    animation\_offset\_start[¶](#bpy.types.SoundStrip.animation_offset_start "Link to this definition")
    :   Animation start offset (trim start)

        Type:
        :   int in [0, inf], default 0

    pan[¶](#bpy.types.SoundStrip.pan "Link to this definition")
    :   Playback panning of the sound (only for Mono sources)

        Type:
        :   float in [-inf, inf], default 0.0

    pitch\_correction[¶](#bpy.types.SoundStrip.pitch_correction "Link to this definition")
    :   Maintain the original pitch of the audio when changing playback speed

        Type:
        :   boolean, default False

    retiming\_keys[¶](#bpy.types.SoundStrip.retiming_keys "Link to this definition")
    :   Type:
    ...
    show\_waveform[¶](#bpy.types.SoundStrip.show_waveform "Link to this definition")
    :   Display the audio waveform inside the strip

        Type:
        :   boolean, default False

    sound[¶](#bpy.types.SoundStrip.sound "Link to this definition")
    :   Sound data-block used by this strip

        Type:
        :   [`Sound`](Sound.md#bpy.types.Sound "bpy.types.Sound")

    sound\_offset[¶](#bpy.types.SoundStrip.sound_offset "Link to this definition")
    :   Offset of the sound from the beginning of the strip, expressed in seconds

        Type:
        :   float in [-inf, inf], default 0.0

    volume[¶](#bpy.types.SoundStrip.volume "Link to this definition")
    :   Playback volume of the sound

        Type:
        :   float in [0, 100], default 1.0

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.SoundStrip.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.SoundStrip.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
SoundEqualizerModifier(StripModifier)](SoundEqualizerModifier.md)
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.SoundStrip.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.SoundStrip.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* SoundStrip(Strip)
  + [`SoundStrip`](#bpy.types.SoundStrip)
    - [`SoundStrip.animation_offset_end`](#bpy.types.SoundStrip.animation_offset_end)
    - [`SoundStrip.animation_offset_start`](#bpy.types.SoundStrip.animation_offset_start)
    - [`SoundStrip.pan`](#bpy.types.SoundStrip.pan)
    - [`SoundStrip.pitch_correction`](#bpy.types.SoundStrip.pitch_correction)
    - [`SoundStrip.retiming_keys`](#bpy.types.SoundStrip.retiming_keys)
    - [`SoundStrip.show_waveform`](#bpy.types.SoundStrip.show_waveform)
    - [`SoundStrip.sound`](#bpy.types.SoundStrip.sound)
    - [`SoundStrip.sound_offset`](#bpy.types.SoundStrip.sound_offset)
    - [`SoundStrip.volume`](#bpy.types.SoundStrip.volume)
    - [`SoundStrip.bl_rna_get_subclass()`](#bpy.types.SoundStrip.bl_rna_get_subclass)
    - [`SoundStrip.bl_rna_get_subclass_py()`](#bpy.types.SoundStrip.bl_rna_get_subclass_py)
