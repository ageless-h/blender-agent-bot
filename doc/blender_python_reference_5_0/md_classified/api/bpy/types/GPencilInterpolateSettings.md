...
# GPencilInterpolateSettings(bpy\_struct)[¶](#gpencilinterpolatesettings-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.GPencilInterpolateSettings(*bpy\_struct*)[¶](#bpy.types.GPencilInterpolateSettings "Link to this definition")
:   Settings for Grease Pencil interpolation tools

    interpolation\_curve[¶](#bpy.types.GPencilInterpolateSettings.interpolation_curve "Link to this definition")
    :   Custom curve to control ‘sequence’ interpolation between Grease Pencil frames

        Type:
        :   [`CurveMapping`](CurveMapping.md#bpy.types.CurveMapping "bpy.types.CurveMapping"), (readonly)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.GPencilInterpolateSettings.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.GPencilInterpolateSettings.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`ToolSettings.gpencil_interpolate`](ToolSettings.md#bpy.types.ToolSettings.gpencil_interpolate "bpy.types.ToolSettings.gpencil_interpolate") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GPencilInterpolateSettings.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.GPencilInterpolateSettings.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GPencilInterpolateSettings(bpy\_struct)
  + [`GPencilInterpolateSettings`](#bpy.types.GPencilInterpolateSettings)
    - [`GPencilInterpolateSettings.interpolation_curve`](#bpy.types.GPencilInterpolateSettings.interpolation_curve)
    - [`GPencilInterpolateSettings.bl_rna_get_subclass()`](#bpy.types.GPencilInterpolateSettings.bl_rna_get_subclass)
    - [`GPencilInterpolateSettings.bl_rna_get_subclass_py()`](#bpy.types.GPencilInterpolateSettings.bl_rna_get_subclass_py)
