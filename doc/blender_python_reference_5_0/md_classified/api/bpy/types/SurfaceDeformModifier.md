...
# SurfaceDeformModifier(Modifier)[¶](#surfacedeformmodifier-modifier "Link to this heading")
...
*class* bpy.types.SurfaceDeformModifier(*Modifier*)[¶](#bpy.types.SurfaceDeformModifier "Link to this definition")
:   falloff[¶](#bpy.types.SurfaceDeformModifier.falloff "Link to this definition")
    :   Controls how much nearby polygons influence deformation

        Type:
        :   float in [2, 16], default 4.0

    invert\_vertex\_group[¶](#bpy.types.SurfaceDeformModifier.invert_vertex_group "Link to this definition")
    :   Invert vertex group influence

        Type:
        :   boolean, default False

    is\_bound[¶](#bpy.types.SurfaceDeformModifier.is_bound "Link to this definition")
    :   Whether geometry has been bound to target mesh

        Type:
        :   boolean, default False, (readonly)

    strength[¶](#bpy.types.SurfaceDeformModifier.strength "Link to this definition")
    :   Strength of modifier deformations

        Type:
        :   float in [-100, 100], default 1.0

    target[¶](#bpy.types.SurfaceDeformModifier.target "Link to this definition")
    :   Mesh object to deform with

        Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object")

    use\_sparse\_bind[¶](#bpy.types.SurfaceDeformModifier.use_sparse_bind "Link to this definition")
    :   Only record binding data for vertices matching the vertex group at the time of bind

        Type:
        :   boolean, default False

    vertex\_group[¶](#bpy.types.SurfaceDeformModifier.vertex_group "Link to this definition")
    :   Vertex group name for selecting/weighting the affected areas

        Type:
        :   string, default “”, (never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.SurfaceDeformModifier.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.SurfaceDeformModifier.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.SurfaceDeformModifier.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.SurfaceDeformModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* SurfaceDeformModifier(Modifier)
  + [`SurfaceDeformModifier`](#bpy.types.SurfaceDeformModifier)
    - [`SurfaceDeformModifier.falloff`](#bpy.types.SurfaceDeformModifier.falloff)
    - [`SurfaceDeformModifier.invert_vertex_group`](#bpy.types.SurfaceDeformModifier.invert_vertex_group)
    - [`SurfaceDeformModifier.is_bound`](#bpy.types.SurfaceDeformModifier.is_bound)
    - [`SurfaceDeformModifier.strength`](#bpy.types.SurfaceDeformModifier.strength)
    - [`SurfaceDeformModifier.target`](#bpy.types.SurfaceDeformModifier.target)
    - [`SurfaceDeformModifier.use_sparse_bind`](#bpy.types.SurfaceDeformModifier.use_sparse_bind)
    - [`SurfaceDeformModifier.vertex_group`](#bpy.types.SurfaceDeformModifier.vertex_group)
    - [`SurfaceDeformModifier.bl_rna_get_subclass()`](#bpy.types.SurfaceDeformModifier.bl_rna_get_subclass)
    - [`SurfaceDeformModifier.bl_rna_get_subclass_py()`](#bpy.types.SurfaceDeformModifier.bl_rna_get_subclass_py)
