...
# FollowPathConstraint(Constraint)[¶](#followpathconstraint-constraint "Link to this heading")
...
*class* bpy.types.FollowPathConstraint(*Constraint*)[¶](#bpy.types.FollowPathConstraint "Link to this definition")
:   Lock motion to the target path

    forward\_axis[¶](#bpy.types.FollowPathConstraint.forward_axis "Link to this definition")
    ...
    offset[¶](#bpy.types.FollowPathConstraint.offset "Link to this definition")
    :   Offset from the position corresponding to the time frame

        Type:
        :   float in [-1.04857e+06, 1.04857e+06], default 0.0

    offset\_factor[¶](#bpy.types.FollowPathConstraint.offset_factor "Link to this definition")
    :   Percentage value defining target position along length of curve

        Type:
        :   float in [-inf, inf], default 0.0

    target[¶](#bpy.types.FollowPathConstraint.target "Link to this definition")
    :   Target Curve object

        Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object")

    up\_axis[¶](#bpy.types.FollowPathConstraint.up_axis "Link to this definition")
    :   Axis that points upward

        Type:
        :   enum in [`'UP_X'`, `'UP_Y'`, `'UP_Z'`], default `'UP_X'`

    use\_curve\_follow[¶](#bpy.types.FollowPathConstraint.use_curve_follow "Link to this definition")
    :   Object will follow the heading and banking of the curve

        Type:
        :   boolean, default False

    use\_curve\_radius[¶](#bpy.types.FollowPathConstraint.use_curve_radius "Link to this definition")
    :   Object is scaled by the curve radius

        Type:
        :   boolean, default False

    use\_fixed\_location[¶](#bpy.types.FollowPathConstraint.use_fixed_location "Link to this definition")
    :   Object will stay locked to a single point somewhere along the length of the curve regardless of time

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.FollowPathConstraint.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.FollowPathConstraint.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.FollowPathConstraint.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.FollowPathConstraint.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* FollowPathConstraint(Constraint)
  + [`FollowPathConstraint`](#bpy.types.FollowPathConstraint)
    - [`FollowPathConstraint.forward_axis`](#bpy.types.FollowPathConstraint.forward_axis)
    - [`FollowPathConstraint.offset`](#bpy.types.FollowPathConstraint.offset)
    - [`FollowPathConstraint.offset_factor`](#bpy.types.FollowPathConstraint.offset_factor)
    - [`FollowPathConstraint.target`](#bpy.types.FollowPathConstraint.target)
    - [`FollowPathConstraint.up_axis`](#bpy.types.FollowPathConstraint.up_axis)
    - [`FollowPathConstraint.use_curve_follow`](#bpy.types.FollowPathConstraint.use_curve_follow)
    - [`FollowPathConstraint.use_curve_radius`](#bpy.types.FollowPathConstraint.use_curve_radius)
    - [`FollowPathConstraint.use_fixed_location`](#bpy.types.FollowPathConstraint.use_fixed_location)
    - [`FollowPathConstraint.bl_rna_get_subclass()`](#bpy.types.FollowPathConstraint.bl_rna_get_subclass)
    - [`FollowPathConstraint.bl_rna_get_subclass_py()`](#bpy.types.FollowPathConstraint.bl_rna_get_subclass_py)
