...
# ShaderFxWave(ShaderFx)[¶](#shaderfxwave-shaderfx "Link to this heading")
...
*class* bpy.types.ShaderFxWave(*ShaderFx*)[¶](#bpy.types.ShaderFxWave "Link to this definition")
:   Wave Deformation effect

    amplitude[¶](#bpy.types.ShaderFxWave.amplitude "Link to this definition")
    :   Amplitude of Wave

        Type:
        :   float in [0, inf], default 0.0

    orientation[¶](#bpy.types.ShaderFxWave.orientation "Link to this definition")
    :   Direction of the wave

        Type:
        :   enum in [`'HORIZONTAL'`, `'VERTICAL'`], default `'HORIZONTAL'`

    period[¶](#bpy.types.ShaderFxWave.period "Link to this definition")
    :   Period of Wave

        Type:
        :   float in [0, inf], default 0.0

    phase[¶](#bpy.types.ShaderFxWave.phase "Link to this definition")
    :   Phase Shift of Wave

        Type:
        :   float in [-inf, inf], default 0.0

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ShaderFxWave.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ShaderFxWave.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ShaderFxWave.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ShaderFxWave.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ShaderFxWave(ShaderFx)
  + [`ShaderFxWave`](#bpy.types.ShaderFxWave)
    - [`ShaderFxWave.amplitude`](#bpy.types.ShaderFxWave.amplitude)
    - [`ShaderFxWave.orientation`](#bpy.types.ShaderFxWave.orientation)
    - [`ShaderFxWave.period`](#bpy.types.ShaderFxWave.period)
    - [`ShaderFxWave.phase`](#bpy.types.ShaderFxWave.phase)
    - [`ShaderFxWave.bl_rna_get_subclass()`](#bpy.types.ShaderFxWave.bl_rna_get_subclass)
    - [`ShaderFxWave.bl_rna_get_subclass_py()`](#bpy.types.ShaderFxWave.bl_rna_get_subclass_py)
