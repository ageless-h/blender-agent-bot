...
# MultiresModifier(Modifier)[¶](#multiresmodifier-modifier "Link to this heading")
...
*class* bpy.types.MultiresModifier(*Modifier*)[¶](#bpy.types.MultiresModifier "Link to this definition")
:   Multiresolution mesh modifier

    boundary\_smooth[¶](#bpy.types.MultiresModifier.boundary_smooth "Link to this definition")
    ...
    filepath[¶](#bpy.types.MultiresModifier.filepath "Link to this definition")
    :   Path to external displacements file

        Type:
        :   string, default “”, (never None, blend relative `//` prefix supported)

    is\_external[¶](#bpy.types.MultiresModifier.is_external "Link to this definition")
    :   Store multires displacements outside the .blend file, to save memory

        Type:
        :   boolean, default False, (readonly)

    levels[¶](#bpy.types.MultiresModifier.levels "Link to this definition")
    :   Number of subdivisions to use in the viewport

        Type:
        :   int in [0, 255], default 0

    quality[¶](#bpy.types.MultiresModifier.quality "Link to this definition")
    :   Accuracy of vertex positions, lower value is faster but less precise

        Type:
        :   int in [1, 10], default 4

    render\_levels[¶](#bpy.types.MultiresModifier.render_levels "Link to this definition")
    :   The subdivision level visible at render time

        Type:
        :   int in [0, 255], default 0

    sculpt\_levels[¶](#bpy.types.MultiresModifier.sculpt_levels "Link to this definition")
    :   Number of subdivisions to use in sculpt mode

        Type:
        :   int in [0, 255], default 0

    show\_only\_control\_edges[¶](#bpy.types.MultiresModifier.show_only_control_edges "Link to this definition")
    :   Skip drawing/rendering of interior subdivided edges

        Type:
        :   boolean, default True

    total\_levels[¶](#bpy.types.MultiresModifier.total_levels "Link to this definition")
    :   Number of subdivisions for which displacements are stored

        Type:
        :   int in [0, 255], default 0, (readonly)

    use\_creases[¶](#bpy.types.MultiresModifier.use_creases "Link to this definition")
    :   Use mesh crease information to sharpen edges or corners

        Type:
        :   boolean, default True

    use\_custom\_normals[¶](#bpy.types.MultiresModifier.use_custom_normals "Link to this definition")
    :   Interpolates existing custom normals to resulting mesh

        Type:
        :   boolean, default False

    use\_sculpt\_base\_mesh[¶](#bpy.types.MultiresModifier.use_sculpt_base_mesh "Link to this definition")
    :   Make Sculpt Mode tools deform the base mesh while previewing the displacement of higher subdivision levels

        Type:
        :   boolean, default False

    uv\_smooth[¶](#bpy.types.MultiresModifier.uv_smooth "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.MultiresModifier.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.MultiresModifier.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.MultiresModifier.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.MultiresModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* MultiresModifier(Modifier)
  + [`MultiresModifier`](#bpy.types.MultiresModifier)
    - [`MultiresModifier.boundary_smooth`](#bpy.types.MultiresModifier.boundary_smooth)
    - [`MultiresModifier.filepath`](#bpy.types.MultiresModifier.filepath)
    - [`MultiresModifier.is_external`](#bpy.types.MultiresModifier.is_external)
    - [`MultiresModifier.levels`](#bpy.types.MultiresModifier.levels)
    - [`MultiresModifier.quality`](#bpy.types.MultiresModifier.quality)
    - [`MultiresModifier.render_levels`](#bpy.types.MultiresModifier.render_levels)
    - [`MultiresModifier.sculpt_levels`](#bpy.types.MultiresModifier.sculpt_levels)
    - [`MultiresModifier.show_only_control_edges`](#bpy.types.MultiresModifier.show_only_control_edges)
    - [`MultiresModifier.total_levels`](#bpy.types.MultiresModifier.total_levels)
    - [`MultiresModifier.use_creases`](#bpy.types.MultiresModifier.use_creases)
    - [`MultiresModifier.use_custom_normals`](#bpy.types.MultiresModifier.use_custom_normals)
    - [`MultiresModifier.use_sculpt_base_mesh`](#bpy.types.MultiresModifier.use_sculpt_base_mesh)
    - [`MultiresModifier.uv_smooth`](#bpy.types.MultiresModifier.uv_smooth)
    - [`MultiresModifier.bl_rna_get_subclass()`](#bpy.types.MultiresModifier.bl_rna_get_subclass)
    - [`MultiresModifier.bl_rna_get_subclass_py()`](#bpy.types.MultiresModifier.bl_rna_get_subclass_py)
