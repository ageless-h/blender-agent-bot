...
# Float4x4AttributeValue(bpy\_struct)[¶](#float4x4attributevalue-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.Float4x4AttributeValue(*bpy\_struct*)[¶](#bpy.types.Float4x4AttributeValue "Link to this definition")
:   Matrix value in geometry attribute

    value[¶](#bpy.types.Float4x4AttributeValue.value "Link to this definition")
    :   Matrix
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.Float4x4AttributeValue.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.Float4x4AttributeValue.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Float4x4Attribute.data`](Float4x4Attribute.md#bpy.types.Float4x4Attribute.data "bpy.types.Float4x4Attribute.data") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.Float4x4AttributeValue.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.Float4x4AttributeValue.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* Float4x4AttributeValue(bpy\_struct)
  + [`Float4x4AttributeValue`](#bpy.types.Float4x4AttributeValue)
    - [`Float4x4AttributeValue.value`](#bpy.types.Float4x4AttributeValue.value)
    - [`Float4x4AttributeValue.bl_rna_get_subclass()`](#bpy.types.Float4x4AttributeValue.bl_rna_get_subclass)
    - [`Float4x4AttributeValue.bl_rna_get_subclass_py()`](#bpy.types.Float4x4AttributeValue.bl_rna_get_subclass_py)
