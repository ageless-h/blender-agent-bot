...
# MeshUVLoopLayer(bpy\_struct)[¶](#meshuvlooplayer-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.MeshUVLoopLayer(*bpy\_struct*)[¶](#bpy.types.MeshUVLoopLayer "Link to this definition")
:   active[¶](#bpy.types.MeshUVLoopLayer.active "Link to this definition")
    :   Set the map as active for display and editing

        Type:
        :   boolean, default False

    active\_clone[¶](#bpy.types.MeshUVLoopLayer.active_clone "Link to this definition")
    :   Set the map as active for cloning

        Type:
        :   boolean, default False

    active\_render[¶](#bpy.types.MeshUVLoopLayer.active_render "Link to this definition")
    :   Set the UV map as active for rendering

        Type:
        :   boolean, default False

    data[¶](#bpy.types.MeshUVLoopLayer.data "Link to this definition")
    :   Deprecated, use ‘uv’, ‘vertex\_select’, ‘edge\_select’ or ‘pin’ properties instead

        Type:
        :   [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`MeshUVLoop`](MeshUVLoop.md#bpy.types.MeshUVLoop "bpy.types.MeshUVLoop"), (readonly)

    name[¶](#bpy.types.MeshUVLoopLayer.name "Link to this definition")
    :   Name of UV map

        Type:
        :   string, default “”, (never None)

    pin[¶](#bpy.types.MeshUVLoopLayer.pin "Link to this definition")
    :   UV pinned state in the UV editor

        Type:
        :   [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`BoolAttributeValue`](BoolAttributeValue.md#bpy.types.BoolAttributeValue "bpy.types.BoolAttributeValue"), (readonly)

    uv[¶](#bpy.types.MeshUVLoopLayer.uv "Link to this definition")
    :   UV coordinates on face corners

        Type:
        :   [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`Float2AttributeValue`](Float2AttributeValue.md#bpy.types.Float2AttributeValue "bpy.types.Float2AttributeValue"), (readonly)

    pin\_ensure()[¶](#bpy.types.MeshUVLoopLayer.pin_ensure "Link to this definition")
    :   pin\_ensure
        ...
        Return type:
        :   [`BoolAttribute`](BoolAttribute.md#bpy.types.BoolAttribute "bpy.types.BoolAttribute")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.MeshUVLoopLayer.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.MeshUVLoopLayer.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Mesh.uv_layer_clone`](Mesh.md#bpy.types.Mesh.uv_layer_clone "bpy.types.Mesh.uv_layer_clone") * [`Mesh.uv_layer_stencil`](Mesh.md#bpy.types.Mesh.uv_layer_stencil "bpy.types.Mesh.uv_layer_stencil") * [`Mesh.uv_layers`](Mesh.md#bpy.types.Mesh.uv_layers "bpy.types.Mesh.uv_layers") | * [`UVLoopLayers.active`](UVLoopLayers.md#bpy.types.UVLoopLayers.active "bpy.types.UVLoopLayers.active") * [`UVLoopLayers.new`](UVLoopLayers.md#bpy.types.UVLoopLayers.new "bpy.types.UVLoopLayers.new") * [`UVLoopLayers.remove`](UVLoopLayers.md#bpy.types.UVLoopLayers.remove "bpy.types.UVLoopLayers.remove") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.MeshUVLoopLayer.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.MeshUVLoopLayer.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* MeshUVLoopLayer(bpy\_struct)
  + [`MeshUVLoopLayer`](#bpy.types.MeshUVLoopLayer)
    - [`MeshUVLoopLayer.active`](#bpy.types.MeshUVLoopLayer.active)
    - [`MeshUVLoopLayer.active_clone`](#bpy.types.MeshUVLoopLayer.active_clone)
    - [`MeshUVLoopLayer.active_render`](#bpy.types.MeshUVLoopLayer.active_render)
    - [`MeshUVLoopLayer.data`](#bpy.types.MeshUVLoopLayer.data)
    - [`MeshUVLoopLayer.name`](#bpy.types.MeshUVLoopLayer.name)
    - [`MeshUVLoopLayer.pin`](#bpy.types.MeshUVLoopLayer.pin)
    - [`MeshUVLoopLayer.uv`](#bpy.types.MeshUVLoopLayer.uv)
    - [`MeshUVLoopLayer.pin_ensure()`](#bpy.types.MeshUVLoopLayer.pin_ensure)
    - [`MeshUVLoopLayer.bl_rna_get_subclass()`](#bpy.types.MeshUVLoopLayer.bl_rna_get_subclass)
    - [`MeshUVLoopLayer.bl_rna_get_subclass_py()`](#bpy.types.MeshUVLoopLayer.bl_rna_get_subclass_py)
