...
# VolumeToMeshModifier(Modifier)[¶](#volumetomeshmodifier-modifier "Link to this heading")
...
*class* bpy.types.VolumeToMeshModifier(*Modifier*)[¶](#bpy.types.VolumeToMeshModifier "Link to this definition")
:   adaptivity[¶](#bpy.types.VolumeToMeshModifier.adaptivity "Link to this definition")
    :   Reduces the final face count by simplifying geometry where detail is not needed

        Type:
        :   float in [0, 1], default 0.0

    grid\_name[¶](#bpy.types.VolumeToMeshModifier.grid_name "Link to this definition")
    :   Grid in the volume object that is converted to a mesh

        Type:
        :   string, default “”, (never None)

    object[¶](#bpy.types.VolumeToMeshModifier.object "Link to this definition")
    :   Object

        Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object")

    resolution\_mode[¶](#bpy.types.VolumeToMeshModifier.resolution_mode "Link to this definition")
    ...
    threshold[¶](#bpy.types.VolumeToMeshModifier.threshold "Link to this definition")
    :   Voxels with a larger value are inside the generated mesh

        Type:
        :   float in [0, inf], default 0.0

    use\_smooth\_shade[¶](#bpy.types.VolumeToMeshModifier.use_smooth_shade "Link to this definition")
    :   Output faces with smooth shading rather than flat shaded

        Type:
        :   boolean, default False

    voxel\_amount[¶](#bpy.types.VolumeToMeshModifier.voxel_amount "Link to this definition")
    :   Approximate number of voxels along one axis

        Type:
        :   int in [0, inf], default 0

    voxel\_size[¶](#bpy.types.VolumeToMeshModifier.voxel_size "Link to this definition")
    :   Smaller values result in a higher resolution output

        Type:
        :   float in [0, inf], default 0.0

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.VolumeToMeshModifier.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.VolumeToMeshModifier.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.VolumeToMeshModifier.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.VolumeToMeshModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* VolumeToMeshModifier(Modifier)
  + [`VolumeToMeshModifier`](#bpy.types.VolumeToMeshModifier)
    - [`VolumeToMeshModifier.adaptivity`](#bpy.types.VolumeToMeshModifier.adaptivity)
    - [`VolumeToMeshModifier.grid_name`](#bpy.types.VolumeToMeshModifier.grid_name)
    - [`VolumeToMeshModifier.object`](#bpy.types.VolumeToMeshModifier.object)
    - [`VolumeToMeshModifier.resolution_mode`](#bpy.types.VolumeToMeshModifier.resolution_mode)
    - [`VolumeToMeshModifier.threshold`](#bpy.types.VolumeToMeshModifier.threshold)
    - [`VolumeToMeshModifier.use_smooth_shade`](#bpy.types.VolumeToMeshModifier.use_smooth_shade)
    - [`VolumeToMeshModifier.voxel_amount`](#bpy.types.VolumeToMeshModifier.voxel_amount)
    - [`VolumeToMeshModifier.voxel_size`](#bpy.types.VolumeToMeshModifier.voxel_size)
    - [`VolumeToMeshModifier.bl_rna_get_subclass()`](#bpy.types.VolumeToMeshModifier.bl_rna_get_subclass)
    - [`VolumeToMeshModifier.bl_rna_get_subclass_py()`](#bpy.types.VolumeToMeshModifier.bl_rna_get_subclass_py)
