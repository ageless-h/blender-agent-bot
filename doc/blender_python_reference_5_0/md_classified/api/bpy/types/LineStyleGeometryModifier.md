...
# LineStyleGeometryModifier(LineStyleModifier)[¶](#linestylegeometrymodifier-linestylemodifier "Link to this heading")

base classes — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct"), [`LineStyleModifier`](LineStyleModifier.md#bpy.types.LineStyleModifier "bpy.types.LineStyleModifier")

subclasses —
[`LineStyleGeometryModifier_2DOffset`](LineStyleGeometryModifier_2DOffset.md#bpy.types.LineStyleGeometryModifier_2DOffset "bpy.types.LineStyleGeometryModifier_2DOffset"), [`LineStyleGeometryModifier_2DTransform`](LineStyleGeometryModifier_2DTransform.md#bpy.types.LineStyleGeometryModifier_2DTransform "bpy.types.LineStyleGeometryModifier_2DTransform"), [`LineStyleGeometryModifier_BackboneStretcher`](LineStyleGeometryModifier_BackboneStretcher.md#bpy.types.LineStyleGeometryModifier_BackboneStretcher "bpy.types.LineStyleGeometryModifier_BackboneStretcher"), [`LineStyleGeometryModifier_BezierCurve`](LineStyleGeometryModifier_BezierCurve.md#bpy.types.LineStyleGeometryModifier_BezierCurve "bpy.types.LineStyleGeometryModifier_BezierCurve"), [`LineStyleGeometryModifier_Blueprint`](LineStyleGeometryModifier_Blueprint.md#bpy.types.LineStyleGeometryModifier_Blueprint "bpy.types.LineStyleGeometryModifier_Blueprint"), [`LineStyleGeometryModifier_GuidingLines`](LineStyleGeometryModifier_GuidingLines.md#bpy.types.LineStyleGeometryModifier_GuidingLines "bpy.types.LineStyleGeometryModifier_GuidingLines"), [`LineStyleGeometryModifier_PerlinNoise1D`](LineStyleGeometryModifier_PerlinNoise1D.md#bpy.types.LineStyleGeometryModifier_PerlinNoise1D "bpy.types.LineStyleGeometryModifier_PerlinNoise1D"), [`LineStyleGeometryModifier_PerlinNoise2D`](LineStyleGeometryModifier_PerlinNoise2D.md#bpy.types.LineStyleGeometryModifier_PerlinNoise2D "bpy.types.LineStyleGeometryModifier_PerlinNoise2D"), [`LineStyleGeometryModifier_Polygonalization`](LineStyleGeometryModifier_Polygonalization.md#bpy.types.LineStyleGeometryModifier_Polygonalization "bpy.types.LineStyleGeometryModifier_Polygonalization"), [`LineStyleGeometryModifier_Sampling`](LineStyleGeometryModifier_Sampling.md#bpy.types.LineStyleGeometryModifier_Sampling "bpy.types.LineStyleGeometryModifier_Sampling"), [`LineStyleGeometryModifier_Simplification`](LineStyleGeometryModifier_Simplification.md#bpy.types.LineStyleGeometryModifier_Simplification "bpy.types.LineStyleGeometryModifier_Simplification"), [`LineStyleGeometryModifier_SinusDisplacement`](LineStyleGeometryModifier_SinusDisplacement.md#bpy.types.LineStyleGeometryModifier_SinusDisplacement "bpy.types.LineStyleGeometryModifier_SinusDisplacement"), [`LineStyleGeometryModifier_SpatialNoise`](LineStyleGeometryModifier_SpatialNoise.md#bpy.types.LineStyleGeometryModifier_SpatialNoise "bpy.types.LineStyleGeometryModifier_SpatialNoise"), [`LineStyleGeometryModifier_TipRemover`](LineStyleGeometryModifier_TipRemover.md#bpy.types.LineStyleGeometryModifier_TipRemover "bpy.types.LineStyleGeometryModifier_TipRemover")

*class* bpy.types.LineStyleGeometryModifier(*LineStyleModifier*)[¶](#bpy.types.LineStyleGeometryModifier "Link to this definition")
:   Base type to define stroke geometry modifiers

    name[¶](#bpy.types.LineStyleGeometryModifier.name "Link to this definition")
    :   Name of the modifier

        Type:
        :   string, default “”, (never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.LineStyleGeometryModifier.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.LineStyleGeometryModifier.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.LineStyleGeometryModifier.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.LineStyleGeometryModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* LineStyleGeometryModifier(LineStyleModifier)
  + [`LineStyleGeometryModifier`](#bpy.types.LineStyleGeometryModifier)
    - [`LineStyleGeometryModifier.name`](#bpy.types.LineStyleGeometryModifier.name)
    - [`LineStyleGeometryModifier.bl_rna_get_subclass()`](#bpy.types.LineStyleGeometryModifier.bl_rna_get_subclass)
    - [`LineStyleGeometryModifier.bl_rna_get_subclass_py()`](#bpy.types.LineStyleGeometryModifier.bl_rna_get_subclass_py)
