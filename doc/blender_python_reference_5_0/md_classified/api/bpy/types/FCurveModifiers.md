...
# FCurveModifiers(bpy\_struct)[¶](#fcurvemodifiers-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.FCurveModifiers(*bpy\_struct*)[¶](#bpy.types.FCurveModifiers "Link to this definition")
:   Collection of F-Curve Modifiers

    active[¶](#bpy.types.FCurveModifiers.active "Link to this definition")
    :   Active F-Curve Modifier

        Type:
        :   [`FModifier`](FModifier.md#bpy.types.FModifier "bpy.types.FModifier")

    new(*type*)[¶](#bpy.types.FCurveModifiers.new "Link to this definition")
    :   Add a constraint to this object

        Parameters:
        :   **type** (enum in [Fmodifier Type Items](../../../appendix/bpy_types_enum_items/fmodifier_type_items.md#rna-enum-fmodifier-type-items)) – Constraint type to add
    ...
    remove(*modifier*)[¶](#bpy.types.FCurveModifiers.remove "Link to this definition")
    :   Remove a modifier from this F-Curve

        Parameters:
        :   **modifier** ([`FModifier`](FModifier.md#bpy.types.FModifier "bpy.types.FModifier"), (never None)) – Removed modifier

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.FCurveModifiers.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.FCurveModifiers.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`FCurve.modifiers`](FCurve.md#bpy.types.FCurve.modifiers "bpy.types.FCurve.modifiers") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.FCurveModifiers.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.FCurveModifiers.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* FCurveModifiers(bpy\_struct)
  + [`FCurveModifiers`](#bpy.types.FCurveModifiers)
    - [`FCurveModifiers.active`](#bpy.types.FCurveModifiers.active)
    - [`FCurveModifiers.new()`](#bpy.types.FCurveModifiers.new)
    - [`FCurveModifiers.remove()`](#bpy.types.FCurveModifiers.remove)
    - [`FCurveModifiers.bl_rna_get_subclass()`](#bpy.types.FCurveModifiers.bl_rna_get_subclass)
    - [`FCurveModifiers.bl_rna_get_subclass_py()`](#bpy.types.FCurveModifiers.bl_rna_get_subclass_py)
