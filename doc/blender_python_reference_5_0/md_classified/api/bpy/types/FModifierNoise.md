...
# FModifierNoise(FModifier)[¶](#fmodifiernoise-fmodifier "Link to this heading")
...
*class* bpy.types.FModifierNoise(*FModifier*)[¶](#bpy.types.FModifierNoise "Link to this definition")
:   Give randomness to the modified F-Curve

    blend\_type[¶](#bpy.types.FModifierNoise.blend_type "Link to this definition")
    :   Method of modifying the existing F-Curve

        Type:
        :   enum in [`'REPLACE'`, `'ADD'`, `'SUBTRACT'`, `'MULTIPLY'`], default `'REPLACE'`

    depth[¶](#bpy.types.FModifierNoise.depth "Link to this definition")
    :   Amount of fine level detail present in the noise

        Type:
        :   int in [0, 32767], default 0

    lacunarity[¶](#bpy.types.FModifierNoise.lacunarity "Link to this definition")
    ...
    offset[¶](#bpy.types.FModifierNoise.offset "Link to this definition")
    :   Time offset for the noise effect

        Type:
        :   float in [-inf, inf], default 0.0

    phase[¶](#bpy.types.FModifierNoise.phase "Link to this definition")
    :   A random seed for the noise effect

        Type:
        :   float in [-inf, inf], default 1.0

    roughness[¶](#bpy.types.FModifierNoise.roughness "Link to this definition")
    :   Amount of high frequency detail. Depth needs to be greater than 0 for this to have an effect

        Type:
        :   float in [-inf, inf], default 0.5

    scale[¶](#bpy.types.FModifierNoise.scale "Link to this definition")
    :   Scaling (in time) of the noise

        Type:
        :   float in [-inf, inf], default 1.0

    strength[¶](#bpy.types.FModifierNoise.strength "Link to this definition")
    :   Amplitude of the noise - the amount that it modifies the underlying curve

        Type:
        :   float in [-inf, inf], default 1.0

    use\_legacy\_noise[¶](#bpy.types.FModifierNoise.use_legacy_noise "Link to this definition")
    :   Use the legacy way of generating noise. Has the issue that it can produce values outside of -1/1

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.FModifierNoise.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.FModifierNoise.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.FModifierNoise.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.FModifierNoise.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* FModifierNoise(FModifier)
  + [`FModifierNoise`](#bpy.types.FModifierNoise)
    - [`FModifierNoise.blend_type`](#bpy.types.FModifierNoise.blend_type)
    - [`FModifierNoise.depth`](#bpy.types.FModifierNoise.depth)
    - [`FModifierNoise.lacunarity`](#bpy.types.FModifierNoise.lacunarity)
    - [`FModifierNoise.offset`](#bpy.types.FModifierNoise.offset)
    - [`FModifierNoise.phase`](#bpy.types.FModifierNoise.phase)
    - [`FModifierNoise.roughness`](#bpy.types.FModifierNoise.roughness)
    - [`FModifierNoise.scale`](#bpy.types.FModifierNoise.scale)
    - [`FModifierNoise.strength`](#bpy.types.FModifierNoise.strength)
    - [`FModifierNoise.use_legacy_noise`](#bpy.types.FModifierNoise.use_legacy_noise)
    - [`FModifierNoise.bl_rna_get_subclass()`](#bpy.types.FModifierNoise.bl_rna_get_subclass)
    - [`FModifierNoise.bl_rna_get_subclass_py()`](#bpy.types.FModifierNoise.bl_rna_get_subclass_py)
