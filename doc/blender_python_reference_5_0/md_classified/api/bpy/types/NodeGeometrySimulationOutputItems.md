...
# NodeGeometrySimulationOutputItems(bpy\_struct)[¶](#nodegeometrysimulationoutputitems-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.NodeGeometrySimulationOutputItems(*bpy\_struct*)[¶](#bpy.types.NodeGeometrySimulationOutputItems "Link to this definition")
:   Collection of simulation items

    new(*socket\_type*, *name*)[¶](#bpy.types.NodeGeometrySimulationOutputItems.new "Link to this definition")
    ...
    remove(*item*)[¶](#bpy.types.NodeGeometrySimulationOutputItems.remove "Link to this definition")
    :   Remove an item

        Parameters:
        :   **item** ([`SimulationStateItem`](SimulationStateItem.md#bpy.types.SimulationStateItem "bpy.types.SimulationStateItem"), (never None)) – Item, The item to remove

    clear()[¶](#bpy.types.NodeGeometrySimulationOutputItems.clear "Link to this definition")
    :   Remove all items

    move(*from\_index*, *to\_index*)[¶](#bpy.types.NodeGeometrySimulationOutputItems.move "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.NodeGeometrySimulationOutputItems.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.NodeGeometrySimulationOutputItems.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`GeometryNodeSimulationOutput.state_items`](GeometryNodeSimulationOutput.md#bpy.types.GeometryNodeSimulationOutput.state_items "bpy.types.GeometryNodeSimulationOutput.state_items") |  |

[Next

NodeGeometryViewerItem(bpy\_struct)](NodeGeometryViewerItem.md)
[Previous
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.NodeGeometrySimulationOutputItems.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.NodeGeometrySimulationOutputItems.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* NodeGeometrySimulationOutputItems(bpy\_struct)
  + [`NodeGeometrySimulationOutputItems`](#bpy.types.NodeGeometrySimulationOutputItems)
    - [`NodeGeometrySimulationOutputItems.new()`](#bpy.types.NodeGeometrySimulationOutputItems.new)
    - [`NodeGeometrySimulationOutputItems.remove()`](#bpy.types.NodeGeometrySimulationOutputItems.remove)
    - [`NodeGeometrySimulationOutputItems.clear()`](#bpy.types.NodeGeometrySimulationOutputItems.clear)
    - [`NodeGeometrySimulationOutputItems.move()`](#bpy.types.NodeGeometrySimulationOutputItems.move)
    - [`NodeGeometrySimulationOutputItems.bl_rna_get_subclass()`](#bpy.types.NodeGeometrySimulationOutputItems.bl_rna_get_subclass)
    - [`NodeGeometrySimulationOutputItems.bl_rna_get_subclass_py()`](#bpy.types.NodeGeometrySimulationOutputItems.bl_rna_get_subclass_py)
