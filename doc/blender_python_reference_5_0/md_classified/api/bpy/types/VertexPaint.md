...
# VertexPaint(Paint)[¶](#vertexpaint-paint "Link to this heading")
...
*class* bpy.types.VertexPaint(*Paint*)[¶](#bpy.types.VertexPaint "Link to this definition")
:   Properties of vertex and weight paint mode

    use\_group\_restrict[¶](#bpy.types.VertexPaint.use_group_restrict "Link to this definition")
    :   Restrict painting to vertices in the group

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.VertexPaint.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.VertexPaint.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`ToolSettings.vertex_paint`](ToolSettings.md#bpy.types.ToolSettings.vertex_paint "bpy.types.ToolSettings.vertex_paint") | * [`ToolSettings.weight_paint`](ToolSettings.md#bpy.types.ToolSettings.weight_paint "bpy.types.ToolSettings.weight_paint") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.VertexPaint.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.VertexPaint.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* VertexPaint(Paint)
  + [`VertexPaint`](#bpy.types.VertexPaint)
    - [`VertexPaint.use_group_restrict`](#bpy.types.VertexPaint.use_group_restrict)
    - [`VertexPaint.bl_rna_get_subclass()`](#bpy.types.VertexPaint.bl_rna_get_subclass)
    - [`VertexPaint.bl_rna_get_subclass_py()`](#bpy.types.VertexPaint.bl_rna_get_subclass_py)
