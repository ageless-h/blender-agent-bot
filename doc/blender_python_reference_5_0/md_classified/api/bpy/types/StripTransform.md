...
# StripTransform(bpy\_struct)[¶](#striptransform-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.StripTransform(*bpy\_struct*)[¶](#bpy.types.StripTransform "Link to this definition")
:   Transform parameters for a sequence strip

    filter[¶](#bpy.types.StripTransform.filter "Link to this definition")
    ...
    offset\_x[¶](#bpy.types.StripTransform.offset_x "Link to this definition")
    :   Move along X axis

        Type:
        :   float in [-inf, inf], default 0.0

    offset\_y[¶](#bpy.types.StripTransform.offset_y "Link to this definition")
    :   Move along Y axis

        Type:
        :   float in [-inf, inf], default 0.0

    origin[¶](#bpy.types.StripTransform.origin "Link to this definition")
    :   Origin of image for transformation

        Type:
        :   float array of 2 items in [-inf, inf], default (0.0, 0.0)

    rotation[¶](#bpy.types.StripTransform.rotation "Link to this definition")
    :   Rotate around image center

        Type:
        :   float in [-inf, inf], default 0.0

    scale\_x[¶](#bpy.types.StripTransform.scale_x "Link to this definition")
    :   Scale along X axis

        Type:
        :   float in [0, inf], default 1.0

    scale\_y[¶](#bpy.types.StripTransform.scale_y "Link to this definition")
    :   Scale along Y axis

        Type:
        :   float in [0, inf], default 1.0

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.StripTransform.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.StripTransform.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`EffectStrip.transform`](EffectStrip.md#bpy.types.EffectStrip.transform "bpy.types.EffectStrip.transform") * [`ImageStrip.transform`](ImageStrip.md#bpy.types.ImageStrip.transform "bpy.types.ImageStrip.transform") * [`MaskStrip.transform`](MaskStrip.md#bpy.types.MaskStrip.transform "bpy.types.MaskStrip.transform") * [`MetaStrip.transform`](MetaStrip.md#bpy.types.MetaStrip.transform "bpy.types.MetaStrip.transform") | * [`MovieClipStrip.transform`](MovieClipStrip.md#bpy.types.MovieClipStrip.transform "bpy.types.MovieClipStrip.transform") * [`MovieStrip.transform`](MovieStrip.md#bpy.types.MovieStrip.transform "bpy.types.MovieStrip.transform") * [`SceneStrip.transform`](SceneStrip.md#bpy.types.SceneStrip.transform "bpy.types.SceneStrip.transform") |
...
StripProxy(bpy\_struct)](StripProxy.md)
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.StripTransform.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.StripTransform.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* StripTransform(bpy\_struct)
  + [`StripTransform`](#bpy.types.StripTransform)
    - [`StripTransform.filter`](#bpy.types.StripTransform.filter)
    - [`StripTransform.offset_x`](#bpy.types.StripTransform.offset_x)
    - [`StripTransform.offset_y`](#bpy.types.StripTransform.offset_y)
    - [`StripTransform.origin`](#bpy.types.StripTransform.origin)
    - [`StripTransform.rotation`](#bpy.types.StripTransform.rotation)
    - [`StripTransform.scale_x`](#bpy.types.StripTransform.scale_x)
    - [`StripTransform.scale_y`](#bpy.types.StripTransform.scale_y)
    - [`StripTransform.bl_rna_get_subclass()`](#bpy.types.StripTransform.bl_rna_get_subclass)
    - [`StripTransform.bl_rna_get_subclass_py()`](#bpy.types.StripTransform.bl_rna_get_subclass_py)
