...
# OperatorMousePath(PropertyGroup)[¶](#operatormousepath-propertygroup "Link to this heading")
...
*class* bpy.types.OperatorMousePath(*PropertyGroup*)[¶](#bpy.types.OperatorMousePath "Link to this definition")
:   Mouse path values for operators that record such paths

    loc[¶](#bpy.types.OperatorMousePath.loc "Link to this definition")
    :   Mouse location

        Type:
        :   [`mathutils.Vector`](../../mathutils/index.md#mathutils.Vector "mathutils.Vector") of 2 items in [-inf, inf], default (0.0, 0.0)

    time[¶](#bpy.types.OperatorMousePath.time "Link to this definition")
    :   Time of mouse location

        Type:
        :   float in [-inf, inf], default 0.0

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.OperatorMousePath.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.OperatorMousePath.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.OperatorMousePath.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.OperatorMousePath.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* OperatorMousePath(PropertyGroup)
  + [`OperatorMousePath`](#bpy.types.OperatorMousePath)
    - [`OperatorMousePath.loc`](#bpy.types.OperatorMousePath.loc)
    - [`OperatorMousePath.time`](#bpy.types.OperatorMousePath.time)
    - [`OperatorMousePath.bl_rna_get_subclass()`](#bpy.types.OperatorMousePath.bl_rna_get_subclass)
    - [`OperatorMousePath.bl_rna_get_subclass_py()`](#bpy.types.OperatorMousePath.bl_rna_get_subclass_py)
