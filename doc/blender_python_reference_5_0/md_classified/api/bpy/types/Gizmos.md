...
# Gizmos(bpy\_struct)[¶](#gizmos-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.Gizmos(*bpy\_struct*)[¶](#bpy.types.Gizmos "Link to this definition")
:   Collection of gizmos

    new(*type*)[¶](#bpy.types.Gizmos.new "Link to this definition")
    :   Add gizmo

        Parameters:
        :   **type** (*string**,* *(**never None**)*) – Gizmo identifier

        Returns:
        :   New gizmo

        Return type:
        :   [`Gizmo`](Gizmo.md#bpy.types.Gizmo "bpy.types.Gizmo")

    remove(*gizmo*)[¶](#bpy.types.Gizmos.remove "Link to this definition")
    :   Delete gizmo

        Parameters:
        :   **gizmo** ([`Gizmo`](Gizmo.md#bpy.types.Gizmo "bpy.types.Gizmo"), (never None)) – New gizmo

    clear()[¶](#bpy.types.Gizmos.clear "Link to this definition")
    :   Delete all gizmos

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.Gizmos.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.Gizmos.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`GizmoGroup.gizmos`](GizmoGroup.md#bpy.types.GizmoGroup.gizmos "bpy.types.GizmoGroup.gizmos") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.Gizmos.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.Gizmos.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* Gizmos(bpy\_struct)
  + [`Gizmos`](#bpy.types.Gizmos)
    - [`Gizmos.new()`](#bpy.types.Gizmos.new)
    - [`Gizmos.remove()`](#bpy.types.Gizmos.remove)
    - [`Gizmos.clear()`](#bpy.types.Gizmos.clear)
    - [`Gizmos.bl_rna_get_subclass()`](#bpy.types.Gizmos.bl_rna_get_subclass)
    - [`Gizmos.bl_rna_get_subclass_py()`](#bpy.types.Gizmos.bl_rna_get_subclass_py)
