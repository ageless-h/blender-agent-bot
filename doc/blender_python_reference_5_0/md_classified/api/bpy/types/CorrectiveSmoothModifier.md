...
# CorrectiveSmoothModifier(Modifier)[¶](#correctivesmoothmodifier-modifier "Link to this heading")
...
*class* bpy.types.CorrectiveSmoothModifier(*Modifier*)[¶](#bpy.types.CorrectiveSmoothModifier "Link to this definition")
:   Correct distortion caused by deformation

    factor[¶](#bpy.types.CorrectiveSmoothModifier.factor "Link to this definition")
    :   Smooth effect factor

        Type:
        :   float in [-inf, inf], default 0.5

    invert\_vertex\_group[¶](#bpy.types.CorrectiveSmoothModifier.invert_vertex_group "Link to this definition")
    :   Invert vertex group influence

        Type:
        :   boolean, default False

    is\_bind[¶](#bpy.types.CorrectiveSmoothModifier.is_bind "Link to this definition")
    :   Type:
        :   boolean, default False, (readonly)

    iterations[¶](#bpy.types.CorrectiveSmoothModifier.iterations "Link to this definition")
    :   Type:
        :   int in [0, 32767], default 5

    rest\_source[¶](#bpy.types.CorrectiveSmoothModifier.rest_source "Link to this definition")
    ...
    scale[¶](#bpy.types.CorrectiveSmoothModifier.scale "Link to this definition")
    :   Compensate for scale applied by other modifiers

        Type:
        :   float in [-inf, inf], default 1.0

    smooth\_type[¶](#bpy.types.CorrectiveSmoothModifier.smooth_type "Link to this definition")
    ...
    use\_only\_smooth[¶](#bpy.types.CorrectiveSmoothModifier.use_only_smooth "Link to this definition")
    :   Apply smoothing without reconstructing the surface

        Type:
        :   boolean, default False

    use\_pin\_boundary[¶](#bpy.types.CorrectiveSmoothModifier.use_pin_boundary "Link to this definition")
    :   Excludes boundary vertices from being smoothed

        Type:
        :   boolean, default False

    vertex\_group[¶](#bpy.types.CorrectiveSmoothModifier.vertex_group "Link to this definition")
    :   Name of Vertex Group which determines influence of modifier per point

        Type:
        :   string, default “”, (never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.CorrectiveSmoothModifier.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.CorrectiveSmoothModifier.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
CrossStrip(EffectStrip)](CrossStrip.md)
[Previous
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CorrectiveSmoothModifier.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.CorrectiveSmoothModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CorrectiveSmoothModifier(Modifier)
  + [`CorrectiveSmoothModifier`](#bpy.types.CorrectiveSmoothModifier)
    - [`CorrectiveSmoothModifier.factor`](#bpy.types.CorrectiveSmoothModifier.factor)
    - [`CorrectiveSmoothModifier.invert_vertex_group`](#bpy.types.CorrectiveSmoothModifier.invert_vertex_group)
    - [`CorrectiveSmoothModifier.is_bind`](#bpy.types.CorrectiveSmoothModifier.is_bind)
    - [`CorrectiveSmoothModifier.iterations`](#bpy.types.CorrectiveSmoothModifier.iterations)
    - [`CorrectiveSmoothModifier.rest_source`](#bpy.types.CorrectiveSmoothModifier.rest_source)
    - [`CorrectiveSmoothModifier.scale`](#bpy.types.CorrectiveSmoothModifier.scale)
    - [`CorrectiveSmoothModifier.smooth_type`](#bpy.types.CorrectiveSmoothModifier.smooth_type)
    - [`CorrectiveSmoothModifier.use_only_smooth`](#bpy.types.CorrectiveSmoothModifier.use_only_smooth)
    - [`CorrectiveSmoothModifier.use_pin_boundary`](#bpy.types.CorrectiveSmoothModifier.use_pin_boundary)
    - [`CorrectiveSmoothModifier.vertex_group`](#bpy.types.CorrectiveSmoothModifier.vertex_group)
    - [`CorrectiveSmoothModifier.bl_rna_get_subclass()`](#bpy.types.CorrectiveSmoothModifier.bl_rna_get_subclass)
    - [`CorrectiveSmoothModifier.bl_rna_get_subclass_py()`](#bpy.types.CorrectiveSmoothModifier.bl_rna_get_subclass_py)
