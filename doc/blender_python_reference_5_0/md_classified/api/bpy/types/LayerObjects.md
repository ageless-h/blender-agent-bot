...
# LayerObjects(bpy\_struct)[¶](#layerobjects-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.LayerObjects(*bpy\_struct*)[¶](#bpy.types.LayerObjects "Link to this definition")
:   Collections of objects

    active[¶](#bpy.types.LayerObjects.active "Link to this definition")
    :   Active object for this layer

        Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object")

    selected[¶](#bpy.types.LayerObjects.selected "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.LayerObjects.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.LayerObjects.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`ViewLayer.objects`](ViewLayer.md#bpy.types.ViewLayer.objects "bpy.types.ViewLayer.objects") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.LayerObjects.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.LayerObjects.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* LayerObjects(bpy\_struct)
  + [`LayerObjects`](#bpy.types.LayerObjects)
    - [`LayerObjects.active`](#bpy.types.LayerObjects.active)
    - [`LayerObjects.selected`](#bpy.types.LayerObjects.selected)
    - [`LayerObjects.bl_rna_get_subclass()`](#bpy.types.LayerObjects.bl_rna_get_subclass)
    - [`LayerObjects.bl_rna_get_subclass_py()`](#bpy.types.LayerObjects.bl_rna_get_subclass_py)
