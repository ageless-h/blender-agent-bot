...
:   Identifier for a set of channels in this Action, that can be used by a data-block to specify what it gets animated by
    ...
    identifier[¶](#bpy.types.ActionSlot.identifier "Link to this definition")
    ...
    name\_display[¶](#bpy.types.ActionSlot.name_display "Link to this definition")
    ...
    select[¶](#bpy.types.ActionSlot.select "Link to this definition")
    :   Selection state of the slot

        Type:
        :   boolean, default False

    show\_expanded[¶](#bpy.types.ActionSlot.show_expanded "Link to this definition")
    :   Expanded state of the slot

        Type:
        :   boolean, default False

    target\_id\_type[¶](#bpy.types.ActionSlot.target_id_type "Link to this definition")
    ...
    target\_id\_type\_icon[¶](#bpy.types.ActionSlot.target_id_type_icon "Link to this definition")
    :   Type:
        :   int in [-inf, inf], default 0, (readonly)

    users()[¶](#bpy.types.ActionSlot.users "Link to this definition")
    :   Return the data-blocks that are animated by this slot of this action
        ...
        Return type:
        :   [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`ID`](ID.md#bpy.types.ID "bpy.types.ID")

    duplicate()[¶](#bpy.types.ActionSlot.duplicate "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ActionSlot.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ActionSlot.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Action.slots`](Action.md#bpy.types.Action.slots "bpy.types.Action.slots") * [`ActionChannelbag.slot`](ActionChannelbag.md#bpy.types.ActionChannelbag.slot "bpy.types.ActionChannelbag.slot") * [`ActionChannelbags.new`](ActionChannelbags.md#bpy.types.ActionChannelbags.new "bpy.types.ActionChannelbags.new") * [`ActionConstraint.action_slot`](ActionConstraint.md#bpy.types.ActionConstraint.action_slot "bpy.types.ActionConstraint.action_slot") * [`ActionConstraint.action_suitable_slots`](ActionConstraint.md#bpy.types.ActionConstraint.action_suitable_slots "bpy.types.ActionConstraint.action_suitable_slots") * [`ActionKeyframeStrip.channelbag`](ActionKeyframeStrip.md#bpy.types.ActionKeyframeStrip.channelbag "bpy.types.ActionKeyframeStrip.channelbag") * [`ActionKeyframeStrip.key_insert`](ActionKeyframeStrip.md#bpy.types.ActionKeyframeStrip.key_insert "bpy.types.ActionKeyframeStrip.key_insert") * [`ActionSlot.duplicate`](#bpy.types.ActionSlot.duplicate "bpy.types.ActionSlot.duplicate") | * [`ActionSlots.active`](ActionSlots.md#bpy.types.ActionSlots.active "bpy.types.ActionSlots.active") * [`ActionSlots.new`](ActionSlots.md#bpy.types.ActionSlots.new "bpy.types.ActionSlots.new") * [`ActionSlots.remove`](ActionSlots.md#bpy.types.ActionSlots.remove "bpy.types.ActionSlots.remove") * [`AnimData.action_slot`](AnimData.md#bpy.types.AnimData.action_slot "bpy.types.AnimData.action_slot") * [`AnimData.action_suitable_slots`](AnimData.md#bpy.types.AnimData.action_suitable_slots "bpy.types.AnimData.action_suitable_slots") * [`NlaStrip.action_slot`](NlaStrip.md#bpy.types.NlaStrip.action_slot "bpy.types.NlaStrip.action_slot") * [`NlaStrip.action_suitable_slots`](NlaStrip.md#bpy.types.NlaStrip.action_suitable_slots "bpy.types.NlaStrip.action_suitable_slots") |

[Next

ActionSlots(bpy\_struct)](ActionSlots.md)
[Previous
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ActionSlot.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ActionSlot.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ActionSlot(bpy\_struct)
  + [`ActionSlot`](#bpy.types.ActionSlot)
    - [`ActionSlot.active`](#bpy.types.ActionSlot.active)
    - [`ActionSlot.handle`](#bpy.types.ActionSlot.handle)
    - [`ActionSlot.identifier`](#bpy.types.ActionSlot.identifier)
    - [`ActionSlot.name_display`](#bpy.types.ActionSlot.name_display)
    - [`ActionSlot.select`](#bpy.types.ActionSlot.select)
    - [`ActionSlot.show_expanded`](#bpy.types.ActionSlot.show_expanded)
    - [`ActionSlot.target_id_type`](#bpy.types.ActionSlot.target_id_type)
    - [`ActionSlot.target_id_type_icon`](#bpy.types.ActionSlot.target_id_type_icon)
    - [`ActionSlot.users()`](#bpy.types.ActionSlot.users)
    - [`ActionSlot.duplicate()`](#bpy.types.ActionSlot.duplicate)
    - [`ActionSlot.bl_rna_get_subclass()`](#bpy.types.ActionSlot.bl_rna_get_subclass)
    - [`ActionSlot.bl_rna_get_subclass_py()`](#bpy.types.ActionSlot.bl_rna_get_subclass_py)
