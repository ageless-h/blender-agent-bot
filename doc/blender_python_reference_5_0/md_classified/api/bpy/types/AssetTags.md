...
# AssetTags(bpy\_struct)[¶](#assettags-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.AssetTags(*bpy\_struct*)[¶](#bpy.types.AssetTags "Link to this definition")
:   Collection of custom asset tags

    new(*name*, *\**, *skip\_if\_exists=False*)[¶](#bpy.types.AssetTags.new "Link to this definition")
    :   Add a new tag to this asset

        Parameters:
        :   * **name** (*string**,* *(**never None**)*) – Name
            * **skip\_if\_exists** (*boolean**,* *(**optional**)*) – Skip if Exists, Do not add a new tag if one of the same type already exists

        Returns:
        :   New tag

        Return type:
        :   [`AssetTag`](AssetTag.md#bpy.types.AssetTag "bpy.types.AssetTag")

    remove(*tag*)[¶](#bpy.types.AssetTags.remove "Link to this definition")
    :   Remove an existing tag from this asset

        Parameters:
        :   **tag** ([`AssetTag`](AssetTag.md#bpy.types.AssetTag "bpy.types.AssetTag"), (never None)) – Removed tag

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.AssetTags.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.AssetTags.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`AssetMetaData.tags`](AssetMetaData.md#bpy.types.AssetMetaData.tags "bpy.types.AssetMetaData.tags") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.AssetTags.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.AssetTags.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* AssetTags(bpy\_struct)
  + [`AssetTags`](#bpy.types.AssetTags)
    - [`AssetTags.new()`](#bpy.types.AssetTags.new)
    - [`AssetTags.remove()`](#bpy.types.AssetTags.remove)
    - [`AssetTags.bl_rna_get_subclass()`](#bpy.types.AssetTags.bl_rna_get_subclass)
    - [`AssetTags.bl_rna_get_subclass_py()`](#bpy.types.AssetTags.bl_rna_get_subclass_py)
