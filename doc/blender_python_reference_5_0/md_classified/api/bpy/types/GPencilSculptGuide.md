...
# GPencilSculptGuide(bpy\_struct)[¶](#gpencilsculptguide-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.GPencilSculptGuide(*bpy\_struct*)[¶](#bpy.types.GPencilSculptGuide "Link to this definition")
:   Guides for drawing

    angle[¶](#bpy.types.GPencilSculptGuide.angle "Link to this definition")
    :   Direction of lines

        Type:
        :   float in [-6.28319, 6.28319], default 0.0

    angle\_snap[¶](#bpy.types.GPencilSculptGuide.angle_snap "Link to this definition")
    :   Angle snapping

        Type:
        :   float in [-6.28319, 6.28319], default 0.0

    location[¶](#bpy.types.GPencilSculptGuide.location "Link to this definition")
    :   Custom reference point for guides

        Type:
        :   float array of 3 items in [-inf, inf], default (0.0, 0.0, 0.0)

    reference\_object[¶](#bpy.types.GPencilSculptGuide.reference_object "Link to this definition")
    :   Object used for reference point

        Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object")

    reference\_point[¶](#bpy.types.GPencilSculptGuide.reference_point "Link to this definition")
    :   Type of speed guide
    ...
    spacing[¶](#bpy.types.GPencilSculptGuide.spacing "Link to this definition")
    :   Guide spacing

        Type:
        :   float in [0, inf], default 20.0

    type[¶](#bpy.types.GPencilSculptGuide.type "Link to this definition")
    :   Type of speed guide
    ...
    use\_guide[¶](#bpy.types.GPencilSculptGuide.use_guide "Link to this definition")
    :   Enable speed guides

        Type:
        :   boolean, default False

    use\_snapping[¶](#bpy.types.GPencilSculptGuide.use_snapping "Link to this definition")
    :   Enable snapping to guides angle or spacing options

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.GPencilSculptGuide.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.GPencilSculptGuide.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`GPencilSculptSettings.guide`](GPencilSculptSettings.md#bpy.types.GPencilSculptSettings.guide "bpy.types.GPencilSculptSettings.guide") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GPencilSculptGuide.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.GPencilSculptGuide.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GPencilSculptGuide(bpy\_struct)
  + [`GPencilSculptGuide`](#bpy.types.GPencilSculptGuide)
    - [`GPencilSculptGuide.angle`](#bpy.types.GPencilSculptGuide.angle)
    - [`GPencilSculptGuide.angle_snap`](#bpy.types.GPencilSculptGuide.angle_snap)
    - [`GPencilSculptGuide.location`](#bpy.types.GPencilSculptGuide.location)
    - [`GPencilSculptGuide.reference_object`](#bpy.types.GPencilSculptGuide.reference_object)
    - [`GPencilSculptGuide.reference_point`](#bpy.types.GPencilSculptGuide.reference_point)
    - [`GPencilSculptGuide.spacing`](#bpy.types.GPencilSculptGuide.spacing)
    - [`GPencilSculptGuide.type`](#bpy.types.GPencilSculptGuide.type)
    - [`GPencilSculptGuide.use_guide`](#bpy.types.GPencilSculptGuide.use_guide)
    - [`GPencilSculptGuide.use_snapping`](#bpy.types.GPencilSculptGuide.use_snapping)
    - [`GPencilSculptGuide.bl_rna_get_subclass()`](#bpy.types.GPencilSculptGuide.bl_rna_get_subclass)
    - [`GPencilSculptGuide.bl_rna_get_subclass_py()`](#bpy.types.GPencilSculptGuide.bl_rna_get_subclass_py)
