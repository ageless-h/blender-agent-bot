...
# GreasePencilDashModifierSegment(bpy\_struct)[¶](#greasepencildashmodifiersegment-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.GreasePencilDashModifierSegment(*bpy\_struct*)[¶](#bpy.types.GreasePencilDashModifierSegment "Link to this definition")
:   Configuration for a single dash segment

    dash[¶](#bpy.types.GreasePencilDashModifierSegment.dash "Link to this definition")
    :   The number of consecutive points from the original stroke to include in this segment

        Type:
        :   int in [1, 32767], default 2

    gap[¶](#bpy.types.GreasePencilDashModifierSegment.gap "Link to this definition")
    :   The number of points skipped after this segment

        Type:
        :   int in [0, 32767], default 1

    material\_index[¶](#bpy.types.GreasePencilDashModifierSegment.material_index "Link to this definition")
    :   Use this index on generated segment. -1 means using the existing material.

        Type:
        :   int in [-1, 32767], default -1

    name[¶](#bpy.types.GreasePencilDashModifierSegment.name "Link to this definition")
    :   Name of the dash segment

        Type:
        :   string, default “”, (never None)

    opacity[¶](#bpy.types.GreasePencilDashModifierSegment.opacity "Link to this definition")
    :   The factor to apply to the original point’s opacity for the new points

        Type:
        :   float in [0, 1], default 1.0

    radius[¶](#bpy.types.GreasePencilDashModifierSegment.radius "Link to this definition")
    :   The factor to apply to the original point’s radius for the new points

        Type:
        :   float in [0, 1], default 1.0

    use\_cyclic[¶](#bpy.types.GreasePencilDashModifierSegment.use_cyclic "Link to this definition")
    :   Enable cyclic on individual stroke dashes

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.GreasePencilDashModifierSegment.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.GreasePencilDashModifierSegment.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`GreasePencilDashModifierData.segments`](GreasePencilDashModifierData.md#bpy.types.GreasePencilDashModifierData.segments "bpy.types.GreasePencilDashModifierData.segments") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GreasePencilDashModifierSegment.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.GreasePencilDashModifierSegment.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GreasePencilDashModifierSegment(bpy\_struct)
  + [`GreasePencilDashModifierSegment`](#bpy.types.GreasePencilDashModifierSegment)
    - [`GreasePencilDashModifierSegment.dash`](#bpy.types.GreasePencilDashModifierSegment.dash)
    - [`GreasePencilDashModifierSegment.gap`](#bpy.types.GreasePencilDashModifierSegment.gap)
    - [`GreasePencilDashModifierSegment.material_index`](#bpy.types.GreasePencilDashModifierSegment.material_index)
    - [`GreasePencilDashModifierSegment.name`](#bpy.types.GreasePencilDashModifierSegment.name)
    - [`GreasePencilDashModifierSegment.opacity`](#bpy.types.GreasePencilDashModifierSegment.opacity)
    - [`GreasePencilDashModifierSegment.radius`](#bpy.types.GreasePencilDashModifierSegment.radius)
    - [`GreasePencilDashModifierSegment.use_cyclic`](#bpy.types.GreasePencilDashModifierSegment.use_cyclic)
    - [`GreasePencilDashModifierSegment.bl_rna_get_subclass()`](#bpy.types.GreasePencilDashModifierSegment.bl_rna_get_subclass)
    - [`GreasePencilDashModifierSegment.bl_rna_get_subclass_py()`](#bpy.types.GreasePencilDashModifierSegment.bl_rna_get_subclass_py)
