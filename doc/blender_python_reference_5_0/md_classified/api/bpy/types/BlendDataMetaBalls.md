...
# BlendDataMetaBalls(bpy\_struct)[¶](#blenddatametaballs-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.BlendDataMetaBalls(*bpy\_struct*)[¶](#bpy.types.BlendDataMetaBalls "Link to this definition")
:   Collection of metaballs

    new(*name*)[¶](#bpy.types.BlendDataMetaBalls.new "Link to this definition")
    :   Add a new metaball to the main database
        ...
        Return type:
        :   [`MetaBall`](MetaBall.md#bpy.types.MetaBall "bpy.types.MetaBall")

    remove(*metaball*, *\**, *do\_unlink=True*, *do\_id\_user=True*, *do\_ui\_user=True*)[¶](#bpy.types.BlendDataMetaBalls.remove "Link to this definition")
    :   Remove a metaball from the current blendfile

        Parameters:
        :   * **metaball** ([`MetaBall`](MetaBall.md#bpy.types.MetaBall "bpy.types.MetaBall"), (never None)) – Metaball to remove
            * **do\_unlink** (*boolean**,* *(**optional**)*) – Unlink all usages of this metaball before deleting it (WARNING: will also delete objects instancing that metaball data)
            * **do\_id\_user** (*boolean**,* *(**optional**)*) – Decrement user counter of all data-blocks used by this metaball data
            * **do\_ui\_user** (*boolean**,* *(**optional**)*) – Make sure interface does not reference this metaball data

    tag(*value*)[¶](#bpy.types.BlendDataMetaBalls.tag "Link to this definition")
    :   tag

        Parameters:
        :   **value** (*boolean*) – Value

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.BlendDataMetaBalls.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.BlendDataMetaBalls.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`BlendData.metaballs`](BlendData.md#bpy.types.BlendData.metaballs "bpy.types.BlendData.metaballs") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.BlendDataMetaBalls.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.BlendDataMetaBalls.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* BlendDataMetaBalls(bpy\_struct)
  + [`BlendDataMetaBalls`](#bpy.types.BlendDataMetaBalls)
    - [`BlendDataMetaBalls.new()`](#bpy.types.BlendDataMetaBalls.new)
    - [`BlendDataMetaBalls.remove()`](#bpy.types.BlendDataMetaBalls.remove)
    - [`BlendDataMetaBalls.tag()`](#bpy.types.BlendDataMetaBalls.tag)
    - [`BlendDataMetaBalls.bl_rna_get_subclass()`](#bpy.types.BlendDataMetaBalls.bl_rna_get_subclass)
    - [`BlendDataMetaBalls.bl_rna_get_subclass_py()`](#bpy.types.BlendDataMetaBalls.bl_rna_get_subclass_py)
