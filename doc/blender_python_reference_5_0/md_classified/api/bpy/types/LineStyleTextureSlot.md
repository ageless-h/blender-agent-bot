...
# LineStyleTextureSlot(TextureSlot)[¶](#linestyletextureslot-textureslot "Link to this heading")
...
*class* bpy.types.LineStyleTextureSlot(*TextureSlot*)[¶](#bpy.types.LineStyleTextureSlot "Link to this definition")
:   Texture slot for textures in a LineStyle data-block

    alpha\_factor[¶](#bpy.types.LineStyleTextureSlot.alpha_factor "Link to this definition")
    :   Amount texture affects alpha

        Type:
        :   float in [-inf, inf], default 1.0

    diffuse\_color\_factor[¶](#bpy.types.LineStyleTextureSlot.diffuse_color_factor "Link to this definition")
    :   Amount texture affects diffuse color

        Type:
        :   float in [-inf, inf], default 1.0

    mapping[¶](#bpy.types.LineStyleTextureSlot.mapping "Link to this definition")
    :   * `FLAT`
    ...
    mapping\_x[¶](#bpy.types.LineStyleTextureSlot.mapping_x "Link to this definition")
    :   Type:
        :   enum in [`'NONE'`, `'X'`, `'Y'`, `'Z'`], default `'X'`

    mapping\_y[¶](#bpy.types.LineStyleTextureSlot.mapping_y "Link to this definition")
    :   Type:
        :   enum in [`'NONE'`, `'X'`, `'Y'`, `'Z'`], default `'Y'`

    mapping\_z[¶](#bpy.types.LineStyleTextureSlot.mapping_z "Link to this definition")
    :   Type:
        :   enum in [`'NONE'`, `'X'`, `'Y'`, `'Z'`], default `'Z'`

    texture\_coords[¶](#bpy.types.LineStyleTextureSlot.texture_coords "Link to this definition")
    ...
    use\_map\_alpha[¶](#bpy.types.LineStyleTextureSlot.use_map_alpha "Link to this definition")
    :   The texture affects the alpha value

        Type:
        :   boolean, default False

    use\_map\_color\_diffuse[¶](#bpy.types.LineStyleTextureSlot.use_map_color_diffuse "Link to this definition")
    :   The texture affects basic color of the stroke

        Type:
        :   boolean, default True

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.LineStyleTextureSlot.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.LineStyleTextureSlot.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.LineStyleTextureSlot.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.LineStyleTextureSlot.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* LineStyleTextureSlot(TextureSlot)
  + [`LineStyleTextureSlot`](#bpy.types.LineStyleTextureSlot)
    - [`LineStyleTextureSlot.alpha_factor`](#bpy.types.LineStyleTextureSlot.alpha_factor)
    - [`LineStyleTextureSlot.diffuse_color_factor`](#bpy.types.LineStyleTextureSlot.diffuse_color_factor)
    - [`LineStyleTextureSlot.mapping`](#bpy.types.LineStyleTextureSlot.mapping)
    - [`LineStyleTextureSlot.mapping_x`](#bpy.types.LineStyleTextureSlot.mapping_x)
    - [`LineStyleTextureSlot.mapping_y`](#bpy.types.LineStyleTextureSlot.mapping_y)
    - [`LineStyleTextureSlot.mapping_z`](#bpy.types.LineStyleTextureSlot.mapping_z)
    - [`LineStyleTextureSlot.texture_coords`](#bpy.types.LineStyleTextureSlot.texture_coords)
    - [`LineStyleTextureSlot.use_map_alpha`](#bpy.types.LineStyleTextureSlot.use_map_alpha)
    - [`LineStyleTextureSlot.use_map_color_diffuse`](#bpy.types.LineStyleTextureSlot.use_map_color_diffuse)
    - [`LineStyleTextureSlot.bl_rna_get_subclass()`](#bpy.types.LineStyleTextureSlot.bl_rna_get_subclass)
    - [`LineStyleTextureSlot.bl_rna_get_subclass_py()`](#bpy.types.LineStyleTextureSlot.bl_rna_get_subclass_py)
