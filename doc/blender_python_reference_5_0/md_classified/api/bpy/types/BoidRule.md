...
# BoidRule(bpy\_struct)[¶](#boidrule-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

subclasses —
[`BoidRuleAverageSpeed`](BoidRuleAverageSpeed.md#bpy.types.BoidRuleAverageSpeed "bpy.types.BoidRuleAverageSpeed"), [`BoidRuleAvoid`](BoidRuleAvoid.md#bpy.types.BoidRuleAvoid "bpy.types.BoidRuleAvoid"), [`BoidRuleAvoidCollision`](BoidRuleAvoidCollision.md#bpy.types.BoidRuleAvoidCollision "bpy.types.BoidRuleAvoidCollision"), [`BoidRuleFight`](BoidRuleFight.md#bpy.types.BoidRuleFight "bpy.types.BoidRuleFight"), [`BoidRuleFollowLeader`](BoidRuleFollowLeader.md#bpy.types.BoidRuleFollowLeader "bpy.types.BoidRuleFollowLeader"), [`BoidRuleGoal`](BoidRuleGoal.md#bpy.types.BoidRuleGoal "bpy.types.BoidRuleGoal")

*class* bpy.types.BoidRule(*bpy\_struct*)[¶](#bpy.types.BoidRule "Link to this definition")
:   name[¶](#bpy.types.BoidRule.name "Link to this definition")
    :   Boid rule name

        Type:
        :   string, default “”, (never None)

    type[¶](#bpy.types.BoidRule.type "Link to this definition")
    :   Type:
        :   enum in [Boidrule Type Items](../../../appendix/bpy_types_enum_items/boidrule_type_items.md#rna-enum-boidrule-type-items), default `'GOAL'`, (readonly)

    use\_in\_air[¶](#bpy.types.BoidRule.use_in_air "Link to this definition")
    :   Use rule when boid is flying

        Type:
        :   boolean, default False

    use\_on\_land[¶](#bpy.types.BoidRule.use_on_land "Link to this definition")
    :   Use rule when boid is on land

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.BoidRule.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.BoidRule.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`BoidSettings.active_boid_state`](BoidSettings.md#bpy.types.BoidSettings.active_boid_state "bpy.types.BoidSettings.active_boid_state") * [`BoidState.active_boid_rule`](BoidState.md#bpy.types.BoidState.active_boid_rule "bpy.types.BoidState.active_boid_rule") | * [`BoidState.rules`](BoidState.md#bpy.types.BoidState.rules "bpy.types.BoidState.rules") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.BoidRule.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.BoidRule.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* BoidRule(bpy\_struct)
  + [`BoidRule`](#bpy.types.BoidRule)
    - [`BoidRule.name`](#bpy.types.BoidRule.name)
    - [`BoidRule.type`](#bpy.types.BoidRule.type)
    - [`BoidRule.use_in_air`](#bpy.types.BoidRule.use_in_air)
    - [`BoidRule.use_on_land`](#bpy.types.BoidRule.use_on_land)
    - [`BoidRule.bl_rna_get_subclass()`](#bpy.types.BoidRule.bl_rna_get_subclass)
    - [`BoidRule.bl_rna_get_subclass_py()`](#bpy.types.BoidRule.bl_rna_get_subclass_py)
