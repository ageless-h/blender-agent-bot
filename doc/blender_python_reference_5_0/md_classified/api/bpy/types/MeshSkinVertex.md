...
# MeshSkinVertex(bpy\_struct)[¶](#meshskinvertex-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.MeshSkinVertex(*bpy\_struct*)[¶](#bpy.types.MeshSkinVertex "Link to this definition")
:   Per-vertex skin data for use with the Skin modifier

    radius[¶](#bpy.types.MeshSkinVertex.radius "Link to this definition")
    :   Radius of the skin

        Type:
        :   float array of 2 items in [0, inf], default (0.0, 0.0)

    use\_loose[¶](#bpy.types.MeshSkinVertex.use_loose "Link to this definition")
    :   If vertex has multiple adjacent edges, it is hulled to them directly

        Type:
        :   boolean, default False

    use\_root[¶](#bpy.types.MeshSkinVertex.use_root "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.MeshSkinVertex.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.MeshSkinVertex.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`MeshSkinVertexLayer.data`](MeshSkinVertexLayer.md#bpy.types.MeshSkinVertexLayer.data "bpy.types.MeshSkinVertexLayer.data") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.MeshSkinVertex.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.MeshSkinVertex.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* MeshSkinVertex(bpy\_struct)
  + [`MeshSkinVertex`](#bpy.types.MeshSkinVertex)
    - [`MeshSkinVertex.radius`](#bpy.types.MeshSkinVertex.radius)
    - [`MeshSkinVertex.use_loose`](#bpy.types.MeshSkinVertex.use_loose)
    - [`MeshSkinVertex.use_root`](#bpy.types.MeshSkinVertex.use_root)
    - [`MeshSkinVertex.bl_rna_get_subclass()`](#bpy.types.MeshSkinVertex.bl_rna_get_subclass)
    - [`MeshSkinVertex.bl_rna_get_subclass_py()`](#bpy.types.MeshSkinVertex.bl_rna_get_subclass_py)
