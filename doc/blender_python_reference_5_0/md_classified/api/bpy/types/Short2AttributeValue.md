...
# Short2AttributeValue(bpy\_struct)[¶](#short2attributevalue-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.Short2AttributeValue(*bpy\_struct*)[¶](#bpy.types.Short2AttributeValue "Link to this definition")
:   2D value in geometry attribute

    value[¶](#bpy.types.Short2AttributeValue.value "Link to this definition")
    :   2D vector

        Type:
        :   int array of 2 items in [-32768, 32767], default (0, 0)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.Short2AttributeValue.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.Short2AttributeValue.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Short2Attribute.data`](Short2Attribute.md#bpy.types.Short2Attribute.data "bpy.types.Short2Attribute.data") |  |
...
Short2Attribute(Attribute)](Short2Attribute.md)
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.Short2AttributeValue.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.Short2AttributeValue.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* Short2AttributeValue(bpy\_struct)
  + [`Short2AttributeValue`](#bpy.types.Short2AttributeValue)
    - [`Short2AttributeValue.value`](#bpy.types.Short2AttributeValue.value)
    - [`Short2AttributeValue.bl_rna_get_subclass()`](#bpy.types.Short2AttributeValue.bl_rna_get_subclass)
    - [`Short2AttributeValue.bl_rna_get_subclass_py()`](#bpy.types.Short2AttributeValue.bl_rna_get_subclass_py)
