...
# AssetMetaData(bpy\_struct)[¶](#assetmetadata-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.AssetMetaData(*bpy\_struct*)[¶](#bpy.types.AssetMetaData "Link to this definition")
:   Additional data stored for an asset data-block

    active\_tag[¶](#bpy.types.AssetMetaData.active_tag "Link to this definition")
    :   Index of the tag set for editing

        Type:
        :   int in [-32768, 32767], default 0

    author[¶](#bpy.types.AssetMetaData.author "Link to this definition")
    :   Name of the creator of the asset

        Type:
        :   string, default “”, (never None)

    catalog\_id[¶](#bpy.types.AssetMetaData.catalog_id "Link to this definition")
    ...
    catalog\_simple\_name[¶](#bpy.types.AssetMetaData.catalog_simple_name "Link to this definition")
    :   Simple name of the asset’s catalog, for debugging and data recovery purposes

        Type:
        :   string, default “”, (readonly, never None)

    copyright[¶](#bpy.types.AssetMetaData.copyright "Link to this definition")
    ...
    description[¶](#bpy.types.AssetMetaData.description "Link to this definition")
    :   A description of the asset to be displayed for the user

        Type:
        :   string, default “”, (never None)

    license[¶](#bpy.types.AssetMetaData.license "Link to this definition")
    ...
    tags[¶](#bpy.types.AssetMetaData.tags "Link to this definition")
    :   Custom tags (name tokens) for the asset, used for filtering and general asset management

        Type:
        :   [`AssetTags`](AssetTags.md#bpy.types.AssetTags "bpy.types.AssetTags") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`AssetTag`](AssetTag.md#bpy.types.AssetTag "bpy.types.AssetTag"), (readonly)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.AssetMetaData.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.AssetMetaData.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`AssetRepresentation.metadata`](AssetRepresentation.md#bpy.types.AssetRepresentation.metadata "bpy.types.AssetRepresentation.metadata") * [`FileSelectEntry.asset_data`](FileSelectEntry.md#bpy.types.FileSelectEntry.asset_data "bpy.types.FileSelectEntry.asset_data") | * [`ID.asset_data`](ID.md#bpy.types.ID.asset_data "bpy.types.ID.asset_data") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.AssetMetaData.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.AssetMetaData.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* AssetMetaData(bpy\_struct)
  + [`AssetMetaData`](#bpy.types.AssetMetaData)
    - [`AssetMetaData.active_tag`](#bpy.types.AssetMetaData.active_tag)
    - [`AssetMetaData.author`](#bpy.types.AssetMetaData.author)
    - [`AssetMetaData.catalog_id`](#bpy.types.AssetMetaData.catalog_id)
    - [`AssetMetaData.catalog_simple_name`](#bpy.types.AssetMetaData.catalog_simple_name)
    - [`AssetMetaData.copyright`](#bpy.types.AssetMetaData.copyright)
    - [`AssetMetaData.description`](#bpy.types.AssetMetaData.description)
    - [`AssetMetaData.license`](#bpy.types.AssetMetaData.license)
    - [`AssetMetaData.tags`](#bpy.types.AssetMetaData.tags)
    - [`AssetMetaData.bl_rna_get_subclass()`](#bpy.types.AssetMetaData.bl_rna_get_subclass)
    - [`AssetMetaData.bl_rna_get_subclass_py()`](#bpy.types.AssetMetaData.bl_rna_get_subclass_py)
