...
# ActionChannelbagGroups(bpy\_struct)[¶](#actionchannelbaggroups-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.ActionChannelbagGroups(*bpy\_struct*)[¶](#bpy.types.ActionChannelbagGroups "Link to this definition")
:   Collection of f-curve groups

    new(*name*)[¶](#bpy.types.ActionChannelbagGroups.new "Link to this definition")
    ...
    remove(*action\_group*)[¶](#bpy.types.ActionChannelbagGroups.remove "Link to this definition")
    :   Remove action group

        Parameters:
        :   **action\_group** ([`ActionGroup`](ActionGroup.md#bpy.types.ActionGroup "bpy.types.ActionGroup"), (never None)) – Action group to remove

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ActionChannelbagGroups.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ActionChannelbagGroups.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`ActionChannelbag.groups`](ActionChannelbag.md#bpy.types.ActionChannelbag.groups "bpy.types.ActionChannelbag.groups") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ActionChannelbagGroups.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ActionChannelbagGroups.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ActionChannelbagGroups(bpy\_struct)
  + [`ActionChannelbagGroups`](#bpy.types.ActionChannelbagGroups)
    - [`ActionChannelbagGroups.new()`](#bpy.types.ActionChannelbagGroups.new)
    - [`ActionChannelbagGroups.remove()`](#bpy.types.ActionChannelbagGroups.remove)
    - [`ActionChannelbagGroups.bl_rna_get_subclass()`](#bpy.types.ActionChannelbagGroups.bl_rna_get_subclass)
    - [`ActionChannelbagGroups.bl_rna_get_subclass_py()`](#bpy.types.ActionChannelbagGroups.bl_rna_get_subclass_py)
