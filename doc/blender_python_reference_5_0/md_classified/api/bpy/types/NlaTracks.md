...
# NlaTracks(bpy\_struct)[¶](#nlatracks-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.NlaTracks(*bpy\_struct*)[¶](#bpy.types.NlaTracks "Link to this definition")
:   Collection of NLA Tracks

    active[¶](#bpy.types.NlaTracks.active "Link to this definition")
    :   Active NLA Track

        Type:
        :   [`NlaTrack`](NlaTrack.md#bpy.types.NlaTrack "bpy.types.NlaTrack")

    new(*\**, *prev=None*)[¶](#bpy.types.NlaTracks.new "Link to this definition")
    :   Add a new NLA Track

        Parameters:
        :   **prev** ([`NlaTrack`](NlaTrack.md#bpy.types.NlaTrack "bpy.types.NlaTrack"), (optional)) – NLA Track to add the new one after
    ...
    remove(*track*)[¶](#bpy.types.NlaTracks.remove "Link to this definition")
    :   Remove a NLA Track

        Parameters:
        :   **track** ([`NlaTrack`](NlaTrack.md#bpy.types.NlaTrack "bpy.types.NlaTrack"), (never None)) – NLA Track to remove

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.NlaTracks.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.NlaTracks.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`AnimData.nla_tracks`](AnimData.md#bpy.types.AnimData.nla_tracks "bpy.types.AnimData.nla_tracks") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.NlaTracks.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.NlaTracks.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* NlaTracks(bpy\_struct)
  + [`NlaTracks`](#bpy.types.NlaTracks)
    - [`NlaTracks.active`](#bpy.types.NlaTracks.active)
    - [`NlaTracks.new()`](#bpy.types.NlaTracks.new)
    - [`NlaTracks.remove()`](#bpy.types.NlaTracks.remove)
    - [`NlaTracks.bl_rna_get_subclass()`](#bpy.types.NlaTracks.bl_rna_get_subclass)
    - [`NlaTracks.bl_rna_get_subclass_py()`](#bpy.types.NlaTracks.bl_rna_get_subclass_py)
