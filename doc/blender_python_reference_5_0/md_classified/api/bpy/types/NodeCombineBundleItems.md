...
# NodeCombineBundleItems(bpy\_struct)[¶](#nodecombinebundleitems-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.NodeCombineBundleItems(*bpy\_struct*)[¶](#bpy.types.NodeCombineBundleItems "Link to this definition")
:   Collection of combine bundle items

    new(*socket\_type*, *name*)[¶](#bpy.types.NodeCombineBundleItems.new "Link to this definition")
    :   Add an item at the end
        ...
        Return type:
        :   [`NodeCombineBundleItem`](NodeCombineBundleItem.md#bpy.types.NodeCombineBundleItem "bpy.types.NodeCombineBundleItem")

    remove(*item*)[¶](#bpy.types.NodeCombineBundleItems.remove "Link to this definition")
    :   Remove an item

        Parameters:
        :   **item** ([`NodeCombineBundleItem`](NodeCombineBundleItem.md#bpy.types.NodeCombineBundleItem "bpy.types.NodeCombineBundleItem"), (never None)) – Item, The item to remove

    clear()[¶](#bpy.types.NodeCombineBundleItems.clear "Link to this definition")
    :   Remove all items

    move(*from\_index*, *to\_index*)[¶](#bpy.types.NodeCombineBundleItems.move "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.NodeCombineBundleItems.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.NodeCombineBundleItems.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`NodeCombineBundle.bundle_items`](NodeCombineBundle.md#bpy.types.NodeCombineBundle.bundle_items "bpy.types.NodeCombineBundle.bundle_items") |  |
...
NodeCombineBundleItem(bpy\_struct)](NodeCombineBundleItem.md)
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.NodeCombineBundleItems.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.NodeCombineBundleItems.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* NodeCombineBundleItems(bpy\_struct)
  + [`NodeCombineBundleItems`](#bpy.types.NodeCombineBundleItems)
    - [`NodeCombineBundleItems.new()`](#bpy.types.NodeCombineBundleItems.new)
    - [`NodeCombineBundleItems.remove()`](#bpy.types.NodeCombineBundleItems.remove)
    - [`NodeCombineBundleItems.clear()`](#bpy.types.NodeCombineBundleItems.clear)
    - [`NodeCombineBundleItems.move()`](#bpy.types.NodeCombineBundleItems.move)
    - [`NodeCombineBundleItems.bl_rna_get_subclass()`](#bpy.types.NodeCombineBundleItems.bl_rna_get_subclass)
    - [`NodeCombineBundleItems.bl_rna_get_subclass_py()`](#bpy.types.NodeCombineBundleItems.bl_rna_get_subclass_py)
