...
# ActionLayer(bpy\_struct)[¶](#actionlayer-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.ActionLayer(*bpy\_struct*)[¶](#bpy.types.ActionLayer "Link to this definition")
:   name[¶](#bpy.types.ActionLayer.name "Link to this definition")
    :   Type:
        :   string, default “”, (never None)

    strips[¶](#bpy.types.ActionLayer.strips "Link to this definition")
    :   The list of strips that are on this animation layer

        Type:
        :   [`ActionStrips`](ActionStrips.md#bpy.types.ActionStrips "bpy.types.ActionStrips") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`ActionStrip`](ActionStrip.md#bpy.types.ActionStrip "bpy.types.ActionStrip"), (readonly)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ActionLayer.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ActionLayer.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Action.layers`](Action.md#bpy.types.Action.layers "bpy.types.Action.layers") * [`ActionLayers.new`](ActionLayers.md#bpy.types.ActionLayers.new "bpy.types.ActionLayers.new") | * [`ActionLayers.remove`](ActionLayers.md#bpy.types.ActionLayers.remove "bpy.types.ActionLayers.remove") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ActionLayer.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ActionLayer.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ActionLayer(bpy\_struct)
  + [`ActionLayer`](#bpy.types.ActionLayer)
    - [`ActionLayer.name`](#bpy.types.ActionLayer.name)
    - [`ActionLayer.strips`](#bpy.types.ActionLayer.strips)
    - [`ActionLayer.bl_rna_get_subclass()`](#bpy.types.ActionLayer.bl_rna_get_subclass)
    - [`ActionLayer.bl_rna_get_subclass_py()`](#bpy.types.ActionLayer.bl_rna_get_subclass_py)
