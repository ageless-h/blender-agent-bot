...
# KeyingSetInfo(bpy\_struct)[¶](#keyingsetinfo-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.KeyingSetInfo(*bpy\_struct*)[¶](#bpy.types.KeyingSetInfo "Link to this definition")
:   Callback function defines for builtin Keying Sets

    bl\_description[¶](#bpy.types.KeyingSetInfo.bl_description "Link to this definition")
    :   A short description of the keying set

        Type:
        :   string, default “”, (never None)

    bl\_idname[¶](#bpy.types.KeyingSetInfo.bl_idname "Link to this definition")
    ...
    bl\_label[¶](#bpy.types.KeyingSetInfo.bl_label "Link to this definition")
    :   Type:
        :   string, default “”, (never None)

    bl\_options[¶](#bpy.types.KeyingSetInfo.bl_options "Link to this definition")
    :   Keying Set options to use when inserting keyframes

        Type:
        :   enum set in [Keying Flag Items](../../../appendix/bpy_types_enum_items/keying_flag_items.md#rna-enum-keying-flag-items), default set()

    poll(*context*)[¶](#bpy.types.KeyingSetInfo.poll "Link to this definition")
    :   Test if Keying Set can be used or not

        Return type:
        :   boolean

    iterator(*context*, *ks*)[¶](#bpy.types.KeyingSetInfo.iterator "Link to this definition")
    :   Call generate() on the structs which have properties to be keyframed

    generate(*context*, *ks*, *data*)[¶](#bpy.types.KeyingSetInfo.generate "Link to this definition")
    :   Add Paths to the Keying Set to keyframe the properties of the given data

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.KeyingSetInfo.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.KeyingSetInfo.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`KeyingSet.type_info`](KeyingSet.md#bpy.types.KeyingSet.type_info "bpy.types.KeyingSet.type_info") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.KeyingSetInfo.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.KeyingSetInfo.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* KeyingSetInfo(bpy\_struct)
  + [`KeyingSetInfo`](#bpy.types.KeyingSetInfo)
    - [`KeyingSetInfo.bl_description`](#bpy.types.KeyingSetInfo.bl_description)
    - [`KeyingSetInfo.bl_idname`](#bpy.types.KeyingSetInfo.bl_idname)
    - [`KeyingSetInfo.bl_label`](#bpy.types.KeyingSetInfo.bl_label)
    - [`KeyingSetInfo.bl_options`](#bpy.types.KeyingSetInfo.bl_options)
    - [`KeyingSetInfo.poll()`](#bpy.types.KeyingSetInfo.poll)
    - [`KeyingSetInfo.iterator()`](#bpy.types.KeyingSetInfo.iterator)
    - [`KeyingSetInfo.generate()`](#bpy.types.KeyingSetInfo.generate)
    - [`KeyingSetInfo.bl_rna_get_subclass()`](#bpy.types.KeyingSetInfo.bl_rna_get_subclass)
    - [`KeyingSetInfo.bl_rna_get_subclass_py()`](#bpy.types.KeyingSetInfo.bl_rna_get_subclass_py)
