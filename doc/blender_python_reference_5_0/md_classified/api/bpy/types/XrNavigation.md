...
# XrNavigation(bpy\_struct)[¶](#xrnavigation-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.XrNavigation(*bpy\_struct*)[¶](#bpy.types.XrNavigation "Link to this definition")
:   VR navigation settings

    invert\_rotation[¶](#bpy.types.XrNavigation.invert_rotation "Link to this definition")
    :   Reverses the direction of rotation input

        Type:
        :   boolean, default False

    snap\_turn[¶](#bpy.types.XrNavigation.snap_turn "Link to this definition")
    :   Instantly rotates the camera by a fixed angle instead of smoothly turning

        Type:
        :   boolean, default True

    turn\_amount[¶](#bpy.types.XrNavigation.turn_amount "Link to this definition")
    :   Amount in degrees per turn when using snap turn

        Type:
        :   float in [0, 6.28319], default 0.523599

    turn\_speed[¶](#bpy.types.XrNavigation.turn_speed "Link to this definition")
    :   Turn speed in degrees per second

        Type:
        :   float in [0, inf], default 1.0472

    vignette\_intensity[¶](#bpy.types.XrNavigation.vignette_intensity "Link to this definition")
    :   Intensity of vignette that appears when moving

        Type:
        :   float in [0, 100], default 60.0

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.XrNavigation.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.XrNavigation.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`PreferencesInput.xr_navigation`](PreferencesInput.md#bpy.types.PreferencesInput.xr_navigation "bpy.types.PreferencesInput.xr_navigation") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.XrNavigation.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.XrNavigation.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* XrNavigation(bpy\_struct)
  + [`XrNavigation`](#bpy.types.XrNavigation)
    - [`XrNavigation.invert_rotation`](#bpy.types.XrNavigation.invert_rotation)
    - [`XrNavigation.snap_turn`](#bpy.types.XrNavigation.snap_turn)
    - [`XrNavigation.turn_amount`](#bpy.types.XrNavigation.turn_amount)
    - [`XrNavigation.turn_speed`](#bpy.types.XrNavigation.turn_speed)
    - [`XrNavigation.vignette_intensity`](#bpy.types.XrNavigation.vignette_intensity)
    - [`XrNavigation.bl_rna_get_subclass()`](#bpy.types.XrNavigation.bl_rna_get_subclass)
    - [`XrNavigation.bl_rna_get_subclass_py()`](#bpy.types.XrNavigation.bl_rna_get_subclass_py)
