...
# NodeEvaluateClosureInputItem(bpy\_struct)[¶](#nodeevaluateclosureinputitem-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.NodeEvaluateClosureInputItem(*bpy\_struct*)[¶](#bpy.types.NodeEvaluateClosureInputItem "Link to this definition")
:   color[¶](#bpy.types.NodeEvaluateClosureInputItem.color "Link to this definition")
    ...
    name[¶](#bpy.types.NodeEvaluateClosureInputItem.name "Link to this definition")
    :   Type:
        :   string, default “”, (never None)

    socket\_type[¶](#bpy.types.NodeEvaluateClosureInputItem.socket_type "Link to this definition")
    :   Type:
    ...
    structure\_type[¶](#bpy.types.NodeEvaluateClosureInputItem.structure_type "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.NodeEvaluateClosureInputItem.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.NodeEvaluateClosureInputItem.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`NodeEvaluateClosure.input_items`](NodeEvaluateClosure.md#bpy.types.NodeEvaluateClosure.input_items "bpy.types.NodeEvaluateClosure.input_items") * [`NodeEvaluateClosureInputItems.new`](NodeEvaluateClosureInputItems.md#bpy.types.NodeEvaluateClosureInputItems.new "bpy.types.NodeEvaluateClosureInputItems.new") | * [`NodeEvaluateClosureInputItems.remove`](NodeEvaluateClosureInputItems.md#bpy.types.NodeEvaluateClosureInputItems.remove "bpy.types.NodeEvaluateClosureInputItems.remove") |

[Next

NodeEvaluateClosureInputItems(bpy\_struct)](NodeEvaluateClosureInputItems.md)
[Previous

NodeEvaluateClosure(NodeInternal)](NodeEvaluateClosure.md)
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.NodeEvaluateClosureInputItem.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.NodeEvaluateClosureInputItem.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* NodeEvaluateClosureInputItem(bpy\_struct)
  + [`NodeEvaluateClosureInputItem`](#bpy.types.NodeEvaluateClosureInputItem)
    - [`NodeEvaluateClosureInputItem.color`](#bpy.types.NodeEvaluateClosureInputItem.color)
    - [`NodeEvaluateClosureInputItem.name`](#bpy.types.NodeEvaluateClosureInputItem.name)
    - [`NodeEvaluateClosureInputItem.socket_type`](#bpy.types.NodeEvaluateClosureInputItem.socket_type)
    - [`NodeEvaluateClosureInputItem.structure_type`](#bpy.types.NodeEvaluateClosureInputItem.structure_type)
    - [`NodeEvaluateClosureInputItem.bl_rna_get_subclass()`](#bpy.types.NodeEvaluateClosureInputItem.bl_rna_get_subclass)
    - [`NodeEvaluateClosureInputItem.bl_rna_get_subclass_py()`](#bpy.types.NodeEvaluateClosureInputItem.bl_rna_get_subclass_py)
