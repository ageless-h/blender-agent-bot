...
# CopyLocationConstraint(Constraint)[¶](#copylocationconstraint-constraint "Link to this heading")
...
*class* bpy.types.CopyLocationConstraint(*Constraint*)[¶](#bpy.types.CopyLocationConstraint "Link to this definition")
:   Copy the location of the target

    head\_tail[¶](#bpy.types.CopyLocationConstraint.head_tail "Link to this definition")
    :   Target along length of bone: Head is 0, Tail is 1

        Type:
        :   float in [0, 1], default 0.0

    invert\_x[¶](#bpy.types.CopyLocationConstraint.invert_x "Link to this definition")
    :   Invert the X location

        Type:
        :   boolean, default False

    invert\_y[¶](#bpy.types.CopyLocationConstraint.invert_y "Link to this definition")
    :   Invert the Y location

        Type:
        :   boolean, default False

    invert\_z[¶](#bpy.types.CopyLocationConstraint.invert_z "Link to this definition")
    :   Invert the Z location

        Type:
        :   boolean, default False

    subtarget[¶](#bpy.types.CopyLocationConstraint.subtarget "Link to this definition")
    :   Armature bone, mesh or lattice vertex group, …

        Type:
        :   string, default “”, (never None)

    target[¶](#bpy.types.CopyLocationConstraint.target "Link to this definition")
    :   Target object

        Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object")

    use\_bbone\_shape[¶](#bpy.types.CopyLocationConstraint.use_bbone_shape "Link to this definition")
    :   Follow shape of B-Bone segments when calculating Head/Tail position

        Type:
        :   boolean, default False

    use\_offset[¶](#bpy.types.CopyLocationConstraint.use_offset "Link to this definition")
    :   Add original location into copied location

        Type:
        :   boolean, default False

    use\_x[¶](#bpy.types.CopyLocationConstraint.use_x "Link to this definition")
    :   Copy the target’s X location

        Type:
        :   boolean, default False

    use\_y[¶](#bpy.types.CopyLocationConstraint.use_y "Link to this definition")
    :   Copy the target’s Y location

        Type:
        :   boolean, default False

    use\_z[¶](#bpy.types.CopyLocationConstraint.use_z "Link to this definition")
    :   Copy the target’s Z location

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.CopyLocationConstraint.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.CopyLocationConstraint.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CopyLocationConstraint.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.CopyLocationConstraint.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CopyLocationConstraint(Constraint)
  + [`CopyLocationConstraint`](#bpy.types.CopyLocationConstraint)
    - [`CopyLocationConstraint.head_tail`](#bpy.types.CopyLocationConstraint.head_tail)
    - [`CopyLocationConstraint.invert_x`](#bpy.types.CopyLocationConstraint.invert_x)
    - [`CopyLocationConstraint.invert_y`](#bpy.types.CopyLocationConstraint.invert_y)
    - [`CopyLocationConstraint.invert_z`](#bpy.types.CopyLocationConstraint.invert_z)
    - [`CopyLocationConstraint.subtarget`](#bpy.types.CopyLocationConstraint.subtarget)
    - [`CopyLocationConstraint.target`](#bpy.types.CopyLocationConstraint.target)
    - [`CopyLocationConstraint.use_bbone_shape`](#bpy.types.CopyLocationConstraint.use_bbone_shape)
    - [`CopyLocationConstraint.use_offset`](#bpy.types.CopyLocationConstraint.use_offset)
    - [`CopyLocationConstraint.use_x`](#bpy.types.CopyLocationConstraint.use_x)
    - [`CopyLocationConstraint.use_y`](#bpy.types.CopyLocationConstraint.use_y)
    - [`CopyLocationConstraint.use_z`](#bpy.types.CopyLocationConstraint.use_z)
    - [`CopyLocationConstraint.bl_rna_get_subclass()`](#bpy.types.CopyLocationConstraint.bl_rna_get_subclass)
    - [`CopyLocationConstraint.bl_rna_get_subclass_py()`](#bpy.types.CopyLocationConstraint.bl_rna_get_subclass_py)
