...
# CryptomatteEntry(bpy\_struct)[¶](#cryptomatteentry-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.CryptomatteEntry(*bpy\_struct*)[¶](#bpy.types.CryptomatteEntry "Link to this definition")
:   encoded\_hash[¶](#bpy.types.CryptomatteEntry.encoded_hash "Link to this definition")
    :   Type:
        :   float in [-inf, inf], default 0.0, (readonly)

    name[¶](#bpy.types.CryptomatteEntry.name "Link to this definition")
    :   Type:
        :   string, default “”, (readonly, never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.CryptomatteEntry.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.CryptomatteEntry.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`CompositorNodeCryptomatteV2.entries`](CompositorNodeCryptomatteV2.md#bpy.types.CompositorNodeCryptomatteV2.entries "bpy.types.CompositorNodeCryptomatteV2.entries") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CryptomatteEntry.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.CryptomatteEntry.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CryptomatteEntry(bpy\_struct)
  + [`CryptomatteEntry`](#bpy.types.CryptomatteEntry)
    - [`CryptomatteEntry.encoded_hash`](#bpy.types.CryptomatteEntry.encoded_hash)
    - [`CryptomatteEntry.name`](#bpy.types.CryptomatteEntry.name)
    - [`CryptomatteEntry.bl_rna_get_subclass()`](#bpy.types.CryptomatteEntry.bl_rna_get_subclass)
    - [`CryptomatteEntry.bl_rna_get_subclass_py()`](#bpy.types.CryptomatteEntry.bl_rna_get_subclass_py)
