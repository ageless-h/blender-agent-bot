...
# ThemeBoneColorSet(bpy\_struct)[¶](#themebonecolorset-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.ThemeBoneColorSet(*bpy\_struct*)[¶](#bpy.types.ThemeBoneColorSet "Link to this definition")
:   Theme settings for bone color sets

    active[¶](#bpy.types.ThemeBoneColorSet.active "Link to this definition")
    ...
    normal[¶](#bpy.types.ThemeBoneColorSet.normal "Link to this definition")
    :   Color used for the surface of bones

        Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    select[¶](#bpy.types.ThemeBoneColorSet.select "Link to this definition")
    :   Color used for selected bones

        Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    show\_colored\_constraints[¶](#bpy.types.ThemeBoneColorSet.show_colored_constraints "Link to this definition")
    :   Allow the use of colors indicating constraints/keyed status

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ThemeBoneColorSet.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ThemeBoneColorSet.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`ActionGroup.colors`](ActionGroup.md#bpy.types.ActionGroup.colors "bpy.types.ActionGroup.colors") * [`BoneColor.custom`](BoneColor.md#bpy.types.BoneColor.custom "bpy.types.BoneColor.custom") | * [`Theme.bone_color_sets`](Theme.md#bpy.types.Theme.bone_color_sets "bpy.types.Theme.bone_color_sets") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ThemeBoneColorSet.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ThemeBoneColorSet.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ThemeBoneColorSet(bpy\_struct)
  + [`ThemeBoneColorSet`](#bpy.types.ThemeBoneColorSet)
    - [`ThemeBoneColorSet.active`](#bpy.types.ThemeBoneColorSet.active)
    - [`ThemeBoneColorSet.normal`](#bpy.types.ThemeBoneColorSet.normal)
    - [`ThemeBoneColorSet.select`](#bpy.types.ThemeBoneColorSet.select)
    - [`ThemeBoneColorSet.show_colored_constraints`](#bpy.types.ThemeBoneColorSet.show_colored_constraints)
    - [`ThemeBoneColorSet.bl_rna_get_subclass()`](#bpy.types.ThemeBoneColorSet.bl_rna_get_subclass)
    - [`ThemeBoneColorSet.bl_rna_get_subclass_py()`](#bpy.types.ThemeBoneColorSet.bl_rna_get_subclass_py)
