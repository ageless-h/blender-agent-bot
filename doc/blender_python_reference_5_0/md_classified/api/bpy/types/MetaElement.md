...
# MetaElement(bpy\_struct)[¶](#metaelement-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.MetaElement(*bpy\_struct*)[¶](#bpy.types.MetaElement "Link to this definition")
:   Blobby element in a metaball data-block

    co[¶](#bpy.types.MetaElement.co "Link to this definition")
    :   Type:
        :   [`mathutils.Vector`](../../mathutils/index.md#mathutils.Vector "mathutils.Vector") of 3 items in [-inf, inf], default (0.0, 0.0, 0.0)

    hide[¶](#bpy.types.MetaElement.hide "Link to this definition")
    :   Hide element

        Type:
        :   boolean, default False

    radius[¶](#bpy.types.MetaElement.radius "Link to this definition")
    :   Type:
        :   float in [0, inf], default 0.0

    rotation[¶](#bpy.types.MetaElement.rotation "Link to this definition")
    ...
    select[¶](#bpy.types.MetaElement.select "Link to this definition")
    :   Select element

        Type:
        :   boolean, default False

    size\_x[¶](#bpy.types.MetaElement.size_x "Link to this definition")
    :   Size of element, use of components depends on element type

        Type:
        :   float in [0, 20], default 0.0

    size\_y[¶](#bpy.types.MetaElement.size_y "Link to this definition")
    :   Size of element, use of components depends on element type

        Type:
        :   float in [0, 20], default 0.0

    size\_z[¶](#bpy.types.MetaElement.size_z "Link to this definition")
    :   Size of element, use of components depends on element type

        Type:
        :   float in [0, 20], default 0.0

    stiffness[¶](#bpy.types.MetaElement.stiffness "Link to this definition")
    :   Stiffness defines how much of the element to fill

        Type:
        :   float in [0, 10], default 0.0

    type[¶](#bpy.types.MetaElement.type "Link to this definition")
    :   Metaball type

        Type:
        :   enum in [Metaelem Type Items](../../../appendix/bpy_types_enum_items/metaelem_type_items.md#rna-enum-metaelem-type-items), default `'BALL'`

    use\_negative[¶](#bpy.types.MetaElement.use_negative "Link to this definition")
    :   Set metaball as negative one

        Type:
        :   boolean, default False

    use\_scale\_stiffness[¶](#bpy.types.MetaElement.use_scale_stiffness "Link to this definition")
    :   Scale stiffness instead of radius

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.MetaElement.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.MetaElement.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`MetaBall.elements`](MetaBall.md#bpy.types.MetaBall.elements "bpy.types.MetaBall.elements") * [`MetaBallElements.active`](MetaBallElements.md#bpy.types.MetaBallElements.active "bpy.types.MetaBallElements.active") | * [`MetaBallElements.new`](MetaBallElements.md#bpy.types.MetaBallElements.new "bpy.types.MetaBallElements.new") * [`MetaBallElements.remove`](MetaBallElements.md#bpy.types.MetaBallElements.remove "bpy.types.MetaBallElements.remove") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.MetaElement.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.MetaElement.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* MetaElement(bpy\_struct)
  + [`MetaElement`](#bpy.types.MetaElement)
    - [`MetaElement.co`](#bpy.types.MetaElement.co)
    - [`MetaElement.hide`](#bpy.types.MetaElement.hide)
    - [`MetaElement.radius`](#bpy.types.MetaElement.radius)
    - [`MetaElement.rotation`](#bpy.types.MetaElement.rotation)
    - [`MetaElement.select`](#bpy.types.MetaElement.select)
    - [`MetaElement.size_x`](#bpy.types.MetaElement.size_x)
    - [`MetaElement.size_y`](#bpy.types.MetaElement.size_y)
    - [`MetaElement.size_z`](#bpy.types.MetaElement.size_z)
    - [`MetaElement.stiffness`](#bpy.types.MetaElement.stiffness)
    - [`MetaElement.type`](#bpy.types.MetaElement.type)
    - [`MetaElement.use_negative`](#bpy.types.MetaElement.use_negative)
    - [`MetaElement.use_scale_stiffness`](#bpy.types.MetaElement.use_scale_stiffness)
    - [`MetaElement.bl_rna_get_subclass()`](#bpy.types.MetaElement.bl_rna_get_subclass)
    - [`MetaElement.bl_rna_get_subclass_py()`](#bpy.types.MetaElement.bl_rna_get_subclass_py)
