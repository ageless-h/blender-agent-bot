...
# AnnotationFrame(bpy\_struct)[¶](#annotationframe-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.AnnotationFrame(*bpy\_struct*)[¶](#bpy.types.AnnotationFrame "Link to this definition")
:   Collection of related sketches on a particular frame

    frame\_number[¶](#bpy.types.AnnotationFrame.frame_number "Link to this definition")
    :   The frame on which this sketch appears

        Type:
        :   int in [-1048574, 1048574], default 0

    select[¶](#bpy.types.AnnotationFrame.select "Link to this definition")
    :   Frame is selected for editing in the Dope Sheet

        Type:
        :   boolean, default False

    strokes[¶](#bpy.types.AnnotationFrame.strokes "Link to this definition")
    :   Freehand curves defining the sketch on this frame

        Type:
        :   [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`AnnotationStroke`](AnnotationStroke.md#bpy.types.AnnotationStroke "bpy.types.AnnotationStroke"), (readonly)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.AnnotationFrame.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.AnnotationFrame.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`AnnotationFrames.copy`](AnnotationFrames.md#bpy.types.AnnotationFrames.copy "bpy.types.AnnotationFrames.copy") * [`AnnotationFrames.copy`](AnnotationFrames.md#bpy.types.AnnotationFrames.copy "bpy.types.AnnotationFrames.copy") * [`AnnotationFrames.new`](AnnotationFrames.md#bpy.types.AnnotationFrames.new "bpy.types.AnnotationFrames.new") | * [`AnnotationFrames.remove`](AnnotationFrames.md#bpy.types.AnnotationFrames.remove "bpy.types.AnnotationFrames.remove") * [`AnnotationLayer.active_frame`](AnnotationLayer.md#bpy.types.AnnotationLayer.active_frame "bpy.types.AnnotationLayer.active_frame") * [`AnnotationLayer.frames`](AnnotationLayer.md#bpy.types.AnnotationLayer.frames "bpy.types.AnnotationLayer.frames") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.AnnotationFrame.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.AnnotationFrame.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* AnnotationFrame(bpy\_struct)
  + [`AnnotationFrame`](#bpy.types.AnnotationFrame)
    - [`AnnotationFrame.frame_number`](#bpy.types.AnnotationFrame.frame_number)
    - [`AnnotationFrame.select`](#bpy.types.AnnotationFrame.select)
    - [`AnnotationFrame.strokes`](#bpy.types.AnnotationFrame.strokes)
    - [`AnnotationFrame.bl_rna_get_subclass()`](#bpy.types.AnnotationFrame.bl_rna_get_subclass)
    - [`AnnotationFrame.bl_rna_get_subclass_py()`](#bpy.types.AnnotationFrame.bl_rna_get_subclass_py)
