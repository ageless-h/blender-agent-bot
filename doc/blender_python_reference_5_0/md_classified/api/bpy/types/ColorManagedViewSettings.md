...
# ColorManagedViewSettings(bpy\_struct)[¶](#colormanagedviewsettings-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.ColorManagedViewSettings(*bpy\_struct*)[¶](#bpy.types.ColorManagedViewSettings "Link to this definition")
:   Color management settings used for displaying images on the display

    curve\_mapping[¶](#bpy.types.ColorManagedViewSettings.curve_mapping "Link to this definition")
    ...
    exposure[¶](#bpy.types.ColorManagedViewSettings.exposure "Link to this definition")
    :   Exposure (stops) applied before display transform, multiplying by 2^exposure

        Type:
        :   float in [-32, 32], default 0.0

    gamma[¶](#bpy.types.ColorManagedViewSettings.gamma "Link to this definition")
    :   Additional gamma encoding after display transform, for output with custom gamma

        Type:
        :   float in [0, 5], default 1.0

    is\_hdr[¶](#bpy.types.ColorManagedViewSettings.is_hdr "Link to this definition")
    :   The display and view transform supports high dynamic range colors

        Type:
        :   boolean, default False, (readonly)

    look[¶](#bpy.types.ColorManagedViewSettings.look "Link to this definition")
    ...
    support\_emulation[¶](#bpy.types.ColorManagedViewSettings.support_emulation "Link to this definition")
    ...
    use\_curve\_mapping[¶](#bpy.types.ColorManagedViewSettings.use_curve_mapping "Link to this definition")
    :   Use RGB curved for pre-display transformation

        Type:
        :   boolean, default False

    use\_white\_balance[¶](#bpy.types.ColorManagedViewSettings.use_white_balance "Link to this definition")
    :   Perform chromatic adaption from a different white point

        Type:
        :   boolean, default False

    view\_transform[¶](#bpy.types.ColorManagedViewSettings.view_transform "Link to this definition")
    ...
    white\_balance\_temperature[¶](#bpy.types.ColorManagedViewSettings.white_balance_temperature "Link to this definition")
    :   Color temperature of the scene’s white point

        Type:
        :   float in [1800, 100000], default 6500.0

    white\_balance\_tint[¶](#bpy.types.ColorManagedViewSettings.white_balance_tint "Link to this definition")
    :   Color tint of the scene’s white point (the default of 10 matches daylight)

        Type:
        :   float in [-500, 500], default 10.0

    white\_balance\_whitepoint[¶](#bpy.types.ColorManagedViewSettings.white_balance_whitepoint "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ColorManagedViewSettings.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ColorManagedViewSettings.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`CompositorNodeConvertToDisplay.view_settings`](CompositorNodeConvertToDisplay.md#bpy.types.CompositorNodeConvertToDisplay.view_settings "bpy.types.CompositorNodeConvertToDisplay.view_settings") * [`ImageFormatSettings.view_settings`](ImageFormatSettings.md#bpy.types.ImageFormatSettings.view_settings "bpy.types.ImageFormatSettings.view_settings") | * [`Scene.view_settings`](Scene.md#bpy.types.Scene.view_settings "bpy.types.Scene.view_settings") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ColorManagedViewSettings.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ColorManagedViewSettings.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ColorManagedViewSettings(bpy\_struct)
  + [`ColorManagedViewSettings`](#bpy.types.ColorManagedViewSettings)
    - [`ColorManagedViewSettings.curve_mapping`](#bpy.types.ColorManagedViewSettings.curve_mapping)
    - [`ColorManagedViewSettings.exposure`](#bpy.types.ColorManagedViewSettings.exposure)
    - [`ColorManagedViewSettings.gamma`](#bpy.types.ColorManagedViewSettings.gamma)
    - [`ColorManagedViewSettings.is_hdr`](#bpy.types.ColorManagedViewSettings.is_hdr)
    - [`ColorManagedViewSettings.look`](#bpy.types.ColorManagedViewSettings.look)
    - [`ColorManagedViewSettings.support_emulation`](#bpy.types.ColorManagedViewSettings.support_emulation)
    - [`ColorManagedViewSettings.use_curve_mapping`](#bpy.types.ColorManagedViewSettings.use_curve_mapping)
    - [`ColorManagedViewSettings.use_white_balance`](#bpy.types.ColorManagedViewSettings.use_white_balance)
    - [`ColorManagedViewSettings.view_transform`](#bpy.types.ColorManagedViewSettings.view_transform)
    - [`ColorManagedViewSettings.white_balance_temperature`](#bpy.types.ColorManagedViewSettings.white_balance_temperature)
    - [`ColorManagedViewSettings.white_balance_tint`](#bpy.types.ColorManagedViewSettings.white_balance_tint)
    - [`ColorManagedViewSettings.white_balance_whitepoint`](#bpy.types.ColorManagedViewSettings.white_balance_whitepoint)
    - [`ColorManagedViewSettings.bl_rna_get_subclass()`](#bpy.types.ColorManagedViewSettings.bl_rna_get_subclass)
    - [`ColorManagedViewSettings.bl_rna_get_subclass_py()`](#bpy.types.ColorManagedViewSettings.bl_rna_get_subclass_py)
