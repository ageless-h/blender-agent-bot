...
# LineStyleAlphaModifier\_DistanceFromObject(LineStyleAlphaModifier)[¶](#linestylealphamodifier-distancefromobject-linestylealphamodifier "Link to this heading")

base classes — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct"), [`LineStyleModifier`](LineStyleModifier.md#bpy.types.LineStyleModifier "bpy.types.LineStyleModifier"), [`LineStyleAlphaModifier`](LineStyleAlphaModifier.md#bpy.types.LineStyleAlphaModifier "bpy.types.LineStyleAlphaModifier")

*class* bpy.types.LineStyleAlphaModifier\_DistanceFromObject(*LineStyleAlphaModifier*)[¶](#bpy.types.LineStyleAlphaModifier_DistanceFromObject "Link to this definition")
:   Change alpha transparency based on the distance from an object

    blend[¶](#bpy.types.LineStyleAlphaModifier_DistanceFromObject.blend "Link to this definition")
    :   Specify how the modifier value is blended into the base value

        Type:
        :   enum in [`'MIX'`, `'ADD'`, `'SUBTRACT'`, `'MULTIPLY'`, `'DIVIDE'`, `'DIFFERENCE'`, `'MINIMUM'`, `'MAXIMUM'`], default `'MIX'`

    curve[¶](#bpy.types.LineStyleAlphaModifier_DistanceFromObject.curve "Link to this definition")
    :   Curve used for the curve mapping

        Type:
        :   [`CurveMapping`](CurveMapping.md#bpy.types.CurveMapping "bpy.types.CurveMapping"), (readonly)

    expanded[¶](#bpy.types.LineStyleAlphaModifier_DistanceFromObject.expanded "Link to this definition")
    :   True if the modifier tab is expanded

        Type:
        :   boolean, default False

    influence[¶](#bpy.types.LineStyleAlphaModifier_DistanceFromObject.influence "Link to this definition")
    :   Influence factor by which the modifier changes the property

        Type:
        :   float in [0, 1], default 0.0

    invert[¶](#bpy.types.LineStyleAlphaModifier_DistanceFromObject.invert "Link to this definition")
    :   Invert the fade-out direction of the linear mapping

        Type:
        :   boolean, default False

    mapping[¶](#bpy.types.LineStyleAlphaModifier_DistanceFromObject.mapping "Link to this definition")
    ...
    range\_max[¶](#bpy.types.LineStyleAlphaModifier_DistanceFromObject.range_max "Link to this definition")
    :   Upper bound of the input range the mapping is applied

        Type:
        :   float in [-inf, inf], default 0.0

    range\_min[¶](#bpy.types.LineStyleAlphaModifier_DistanceFromObject.range_min "Link to this definition")
    :   Lower bound of the input range the mapping is applied

        Type:
        :   float in [-inf, inf], default 0.0

    target[¶](#bpy.types.LineStyleAlphaModifier_DistanceFromObject.target "Link to this definition")
    :   Target object from which the distance is measured

        Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object")

    type[¶](#bpy.types.LineStyleAlphaModifier_DistanceFromObject.type "Link to this definition")
    :   Type of the modifier

        Type:
        :   enum in [Linestyle Alpha Modifier Type Items](../../../appendix/bpy_types_enum_items/linestyle_alpha_modifier_type_items.md#rna-enum-linestyle-alpha-modifier-type-items), default `'ALONG_STROKE'`, (readonly)

    use[¶](#bpy.types.LineStyleAlphaModifier_DistanceFromObject.use "Link to this definition")
    :   Enable or disable this modifier during stroke rendering

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.LineStyleAlphaModifier_DistanceFromObject.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.LineStyleAlphaModifier_DistanceFromObject.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.LineStyleAlphaModifier_DistanceFromObject.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.LineStyleAlphaModifier_DistanceFromObject.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* LineStyleAlphaModifier\_DistanceFromObject(LineStyleAlphaModifier)
  + [`LineStyleAlphaModifier_DistanceFromObject`](#bpy.types.LineStyleAlphaModifier_DistanceFromObject)
    - [`LineStyleAlphaModifier_DistanceFromObject.blend`](#bpy.types.LineStyleAlphaModifier_DistanceFromObject.blend)
    - [`LineStyleAlphaModifier_DistanceFromObject.curve`](#bpy.types.LineStyleAlphaModifier_DistanceFromObject.curve)
    - [`LineStyleAlphaModifier_DistanceFromObject.expanded`](#bpy.types.LineStyleAlphaModifier_DistanceFromObject.expanded)
    - [`LineStyleAlphaModifier_DistanceFromObject.influence`](#bpy.types.LineStyleAlphaModifier_DistanceFromObject.influence)
    - [`LineStyleAlphaModifier_DistanceFromObject.invert`](#bpy.types.LineStyleAlphaModifier_DistanceFromObject.invert)
    - [`LineStyleAlphaModifier_DistanceFromObject.mapping`](#bpy.types.LineStyleAlphaModifier_DistanceFromObject.mapping)
    - [`LineStyleAlphaModifier_DistanceFromObject.range_max`](#bpy.types.LineStyleAlphaModifier_DistanceFromObject.range_max)
    - [`LineStyleAlphaModifier_DistanceFromObject.range_min`](#bpy.types.LineStyleAlphaModifier_DistanceFromObject.range_min)
    - [`LineStyleAlphaModifier_DistanceFromObject.target`](#bpy.types.LineStyleAlphaModifier_DistanceFromObject.target)
    - [`LineStyleAlphaModifier_DistanceFromObject.type`](#bpy.types.LineStyleAlphaModifier_DistanceFromObject.type)
    - [`LineStyleAlphaModifier_DistanceFromObject.use`](#bpy.types.LineStyleAlphaModifier_DistanceFromObject.use)
    - [`LineStyleAlphaModifier_DistanceFromObject.bl_rna_get_subclass()`](#bpy.types.LineStyleAlphaModifier_DistanceFromObject.bl_rna_get_subclass)
    - [`LineStyleAlphaModifier_DistanceFromObject.bl_rna_get_subclass_py()`](#bpy.types.LineStyleAlphaModifier_DistanceFromObject.bl_rna_get_subclass_py)
