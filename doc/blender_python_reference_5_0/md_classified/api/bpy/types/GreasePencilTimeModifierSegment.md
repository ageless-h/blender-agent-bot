...
# GreasePencilTimeModifierSegment(bpy\_struct)[¶](#greasepenciltimemodifiersegment-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.GreasePencilTimeModifierSegment(*bpy\_struct*)[¶](#bpy.types.GreasePencilTimeModifierSegment "Link to this definition")
:   Configuration for a single dash segment

    name[¶](#bpy.types.GreasePencilTimeModifierSegment.name "Link to this definition")
    :   Name of the dash segment

        Type:
        :   string, default “”, (never None)

    segment\_end[¶](#bpy.types.GreasePencilTimeModifierSegment.segment_end "Link to this definition")
    :   Last frame of the segment

        Type:
        :   int in [0, 32767], default 2

    segment\_mode[¶](#bpy.types.GreasePencilTimeModifierSegment.segment_mode "Link to this definition")
    :   * `NORMAL`
    ...
    segment\_repeat[¶](#bpy.types.GreasePencilTimeModifierSegment.segment_repeat "Link to this definition")
    :   Number of cycle repeats

        Type:
        :   int in [1, 32767], default 1

    segment\_start[¶](#bpy.types.GreasePencilTimeModifierSegment.segment_start "Link to this definition")
    :   First frame of the segment

        Type:
        :   int in [0, 32767], default 1

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.GreasePencilTimeModifierSegment.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.GreasePencilTimeModifierSegment.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`GreasePencilTimeModifier.segments`](GreasePencilTimeModifier.md#bpy.types.GreasePencilTimeModifier.segments "bpy.types.GreasePencilTimeModifier.segments") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GreasePencilTimeModifierSegment.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.GreasePencilTimeModifierSegment.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GreasePencilTimeModifierSegment(bpy\_struct)
  + [`GreasePencilTimeModifierSegment`](#bpy.types.GreasePencilTimeModifierSegment)
    - [`GreasePencilTimeModifierSegment.name`](#bpy.types.GreasePencilTimeModifierSegment.name)
    - [`GreasePencilTimeModifierSegment.segment_end`](#bpy.types.GreasePencilTimeModifierSegment.segment_end)
    - [`GreasePencilTimeModifierSegment.segment_mode`](#bpy.types.GreasePencilTimeModifierSegment.segment_mode)
    - [`GreasePencilTimeModifierSegment.segment_repeat`](#bpy.types.GreasePencilTimeModifierSegment.segment_repeat)
    - [`GreasePencilTimeModifierSegment.segment_start`](#bpy.types.GreasePencilTimeModifierSegment.segment_start)
    - [`GreasePencilTimeModifierSegment.bl_rna_get_subclass()`](#bpy.types.GreasePencilTimeModifierSegment.bl_rna_get_subclass)
    - [`GreasePencilTimeModifierSegment.bl_rna_get_subclass_py()`](#bpy.types.GreasePencilTimeModifierSegment.bl_rna_get_subclass_py)
