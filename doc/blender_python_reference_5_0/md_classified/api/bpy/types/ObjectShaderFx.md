...
# ObjectShaderFx(bpy\_struct)[¶](#objectshaderfx-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.ObjectShaderFx(*bpy\_struct*)[¶](#bpy.types.ObjectShaderFx "Link to this definition")
:   Collection of object effects

    new(*name*, *type*)[¶](#bpy.types.ObjectShaderFx.new "Link to this definition")
    :   Add a new shader fx

        Parameters:
        :   * **name** (*string**,* *(**never None**)*) – New name for the effect
            * **type** (enum in [Object Shaderfx Type Items](../../../appendix/bpy_types_enum_items/object_shaderfx_type_items.md#rna-enum-object-shaderfx-type-items)) – Effect type to add

        Returns:
        :   Newly created effect

        Return type:
        :   [`ShaderFx`](ShaderFx.md#bpy.types.ShaderFx "bpy.types.ShaderFx")

    remove(*shader\_fx*)[¶](#bpy.types.ObjectShaderFx.remove "Link to this definition")
    :   Remove an existing effect from the object

        Parameters:
        :   **shader\_fx** ([`ShaderFx`](ShaderFx.md#bpy.types.ShaderFx "bpy.types.ShaderFx"), (never None)) – Effect to remove

    clear()[¶](#bpy.types.ObjectShaderFx.clear "Link to this definition")
    :   Remove all effects from the object

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ObjectShaderFx.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ObjectShaderFx.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Object.shader_effects`](Object.md#bpy.types.Object.shader_effects "bpy.types.Object.shader_effects") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ObjectShaderFx.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ObjectShaderFx.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ObjectShaderFx(bpy\_struct)
  + [`ObjectShaderFx`](#bpy.types.ObjectShaderFx)
    - [`ObjectShaderFx.new()`](#bpy.types.ObjectShaderFx.new)
    - [`ObjectShaderFx.remove()`](#bpy.types.ObjectShaderFx.remove)
    - [`ObjectShaderFx.clear()`](#bpy.types.ObjectShaderFx.clear)
    - [`ObjectShaderFx.bl_rna_get_subclass()`](#bpy.types.ObjectShaderFx.bl_rna_get_subclass)
    - [`ObjectShaderFx.bl_rna_get_subclass_py()`](#bpy.types.ObjectShaderFx.bl_rna_get_subclass_py)
