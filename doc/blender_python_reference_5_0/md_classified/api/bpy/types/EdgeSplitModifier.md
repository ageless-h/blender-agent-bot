...
# EdgeSplitModifier(Modifier)[¶](#edgesplitmodifier-modifier "Link to this heading")
...
*class* bpy.types.EdgeSplitModifier(*Modifier*)[¶](#bpy.types.EdgeSplitModifier "Link to this definition")
:   Edge splitting modifier to create sharp edges

    split\_angle[¶](#bpy.types.EdgeSplitModifier.split_angle "Link to this definition")
    :   Angle above which to split edges

        Type:
        :   float in [0, 3.14159], default 0.523599

    use\_edge\_angle[¶](#bpy.types.EdgeSplitModifier.use_edge_angle "Link to this definition")
    :   Split edges with high angle between faces

        Type:
        :   boolean, default True

    use\_edge\_sharp[¶](#bpy.types.EdgeSplitModifier.use_edge_sharp "Link to this definition")
    :   Split edges that are marked as sharp

        Type:
        :   boolean, default True

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.EdgeSplitModifier.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.EdgeSplitModifier.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.EdgeSplitModifier.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.EdgeSplitModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* EdgeSplitModifier(Modifier)
  + [`EdgeSplitModifier`](#bpy.types.EdgeSplitModifier)
    - [`EdgeSplitModifier.split_angle`](#bpy.types.EdgeSplitModifier.split_angle)
    - [`EdgeSplitModifier.use_edge_angle`](#bpy.types.EdgeSplitModifier.use_edge_angle)
    - [`EdgeSplitModifier.use_edge_sharp`](#bpy.types.EdgeSplitModifier.use_edge_sharp)
    - [`EdgeSplitModifier.bl_rna_get_subclass()`](#bpy.types.EdgeSplitModifier.bl_rna_get_subclass)
    - [`EdgeSplitModifier.bl_rna_get_subclass_py()`](#bpy.types.EdgeSplitModifier.bl_rna_get_subclass_py)
