...
# BlendDataPalettes(bpy\_struct)[¶](#blenddatapalettes-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.BlendDataPalettes(*bpy\_struct*)[¶](#bpy.types.BlendDataPalettes "Link to this definition")
:   Collection of palettes

    new(*name*)[¶](#bpy.types.BlendDataPalettes.new "Link to this definition")
    ...
    remove(*palette*, *\**, *do\_unlink=True*, *do\_id\_user=True*, *do\_ui\_user=True*)[¶](#bpy.types.BlendDataPalettes.remove "Link to this definition")
    :   Remove a palette from the current blendfile

        Parameters:
        :   * **palette** ([`Palette`](Palette.md#bpy.types.Palette "bpy.types.Palette"), (never None)) – Palette to remove
            * **do\_unlink** (*boolean**,* *(**optional**)*) – Unlink all usages of this palette before deleting it
            * **do\_id\_user** (*boolean**,* *(**optional**)*) – Decrement user counter of all data-blocks used by this palette
            * **do\_ui\_user** (*boolean**,* *(**optional**)*) – Make sure interface does not reference this palette

    tag(*value*)[¶](#bpy.types.BlendDataPalettes.tag "Link to this definition")
    :   tag

        Parameters:
        :   **value** (*boolean*) – Value

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.BlendDataPalettes.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.BlendDataPalettes.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`BlendData.palettes`](BlendData.md#bpy.types.BlendData.palettes "bpy.types.BlendData.palettes") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.BlendDataPalettes.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.BlendDataPalettes.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* BlendDataPalettes(bpy\_struct)
  + [`BlendDataPalettes`](#bpy.types.BlendDataPalettes)
    - [`BlendDataPalettes.new()`](#bpy.types.BlendDataPalettes.new)
    - [`BlendDataPalettes.remove()`](#bpy.types.BlendDataPalettes.remove)
    - [`BlendDataPalettes.tag()`](#bpy.types.BlendDataPalettes.tag)
    - [`BlendDataPalettes.bl_rna_get_subclass()`](#bpy.types.BlendDataPalettes.bl_rna_get_subclass)
    - [`BlendDataPalettes.bl_rna_get_subclass_py()`](#bpy.types.BlendDataPalettes.bl_rna_get_subclass_py)
