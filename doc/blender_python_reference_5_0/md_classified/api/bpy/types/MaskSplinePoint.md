...
# MaskSplinePoint(bpy\_struct)[¶](#masksplinepoint-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.MaskSplinePoint(*bpy\_struct*)[¶](#bpy.types.MaskSplinePoint "Link to this definition")
:   Single point in spline used for defining mask

    co[¶](#bpy.types.MaskSplinePoint.co "Link to this definition")
    :   Coordinates of the control point

        Type:
        :   [`mathutils.Vector`](../../mathutils/index.md#mathutils.Vector "mathutils.Vector") of 2 items in [-inf, inf], default (0.0, 0.0)

    feather\_points[¶](#bpy.types.MaskSplinePoint.feather_points "Link to this definition")
    :   Points defining feather

        Type:
        :   [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`MaskSplinePointUW`](MaskSplinePointUW.md#bpy.types.MaskSplinePointUW "bpy.types.MaskSplinePointUW"), (readonly)

    handle\_left[¶](#bpy.types.MaskSplinePoint.handle_left "Link to this definition")
    :   Coordinates of the first handle

        Type:
        :   [`mathutils.Vector`](../../mathutils/index.md#mathutils.Vector "mathutils.Vector") of 2 items in [-inf, inf], default (0.0, 0.0)

    handle\_left\_type[¶](#bpy.types.MaskSplinePoint.handle_left_type "Link to this definition")
    :   Handle type

        Type:
        :   enum in [`'AUTO'`, `'VECTOR'`, `'ALIGNED'`, `'ALIGNED_DOUBLESIDE'`, `'FREE'`], default `'FREE'`

    handle\_right[¶](#bpy.types.MaskSplinePoint.handle_right "Link to this definition")
    :   Coordinates of the second handle

        Type:
        :   [`mathutils.Vector`](../../mathutils/index.md#mathutils.Vector "mathutils.Vector") of 2 items in [-inf, inf], default (0.0, 0.0)

    handle\_right\_type[¶](#bpy.types.MaskSplinePoint.handle_right_type "Link to this definition")
    :   Handle type

        Type:
        :   enum in [`'AUTO'`, `'VECTOR'`, `'ALIGNED'`, `'ALIGNED_DOUBLESIDE'`, `'FREE'`], default `'FREE'`

    handle\_type[¶](#bpy.types.MaskSplinePoint.handle_type "Link to this definition")
    :   Handle type

        Type:
        :   enum in [`'AUTO'`, `'VECTOR'`, `'ALIGNED'`, `'ALIGNED_DOUBLESIDE'`, `'FREE'`], default `'FREE'`

    parent[¶](#bpy.types.MaskSplinePoint.parent "Link to this definition")
    :   Type:
        :   [`MaskParent`](MaskParent.md#bpy.types.MaskParent "bpy.types.MaskParent"), (readonly)

    select[¶](#bpy.types.MaskSplinePoint.select "Link to this definition")
    :   Selection status of the control point. (Deprecated: use Select Control Point instead)

        Type:
        :   boolean, default False

    select\_control\_point[¶](#bpy.types.MaskSplinePoint.select_control_point "Link to this definition")
    :   Selection status of the control point

        Type:
        :   boolean, default False

    select\_left\_handle[¶](#bpy.types.MaskSplinePoint.select_left_handle "Link to this definition")
    :   Selection status of the left handle

        Type:
        :   boolean, default False

    select\_right\_handle[¶](#bpy.types.MaskSplinePoint.select_right_handle "Link to this definition")
    :   Selection status of the right handle

        Type:
        :   boolean, default False

    select\_single\_handle[¶](#bpy.types.MaskSplinePoint.select_single_handle "Link to this definition")
    :   Selection status of the Aligned Single handle

        Type:
        :   boolean, default False

    weight[¶](#bpy.types.MaskSplinePoint.weight "Link to this definition")
    :   Weight of the point

        Type:
        :   float in [0, 1], default 0.0

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.MaskSplinePoint.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.MaskSplinePoint.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`MaskSpline.points`](MaskSpline.md#bpy.types.MaskSpline.points "bpy.types.MaskSpline.points") * [`MaskSplinePoints.remove`](MaskSplinePoints.md#bpy.types.MaskSplinePoints.remove "bpy.types.MaskSplinePoints.remove") | * [`MaskSplines.active_point`](MaskSplines.md#bpy.types.MaskSplines.active_point "bpy.types.MaskSplines.active_point") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.MaskSplinePoint.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.MaskSplinePoint.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* MaskSplinePoint(bpy\_struct)
  + [`MaskSplinePoint`](#bpy.types.MaskSplinePoint)
    - [`MaskSplinePoint.co`](#bpy.types.MaskSplinePoint.co)
    - [`MaskSplinePoint.feather_points`](#bpy.types.MaskSplinePoint.feather_points)
    - [`MaskSplinePoint.handle_left`](#bpy.types.MaskSplinePoint.handle_left)
    - [`MaskSplinePoint.handle_left_type`](#bpy.types.MaskSplinePoint.handle_left_type)
    - [`MaskSplinePoint.handle_right`](#bpy.types.MaskSplinePoint.handle_right)
    - [`MaskSplinePoint.handle_right_type`](#bpy.types.MaskSplinePoint.handle_right_type)
    - [`MaskSplinePoint.handle_type`](#bpy.types.MaskSplinePoint.handle_type)
    - [`MaskSplinePoint.parent`](#bpy.types.MaskSplinePoint.parent)
    - [`MaskSplinePoint.select`](#bpy.types.MaskSplinePoint.select)
    - [`MaskSplinePoint.select_control_point`](#bpy.types.MaskSplinePoint.select_control_point)
    - [`MaskSplinePoint.select_left_handle`](#bpy.types.MaskSplinePoint.select_left_handle)
    - [`MaskSplinePoint.select_right_handle`](#bpy.types.MaskSplinePoint.select_right_handle)
    - [`MaskSplinePoint.select_single_handle`](#bpy.types.MaskSplinePoint.select_single_handle)
    - [`MaskSplinePoint.weight`](#bpy.types.MaskSplinePoint.weight)
    - [`MaskSplinePoint.bl_rna_get_subclass()`](#bpy.types.MaskSplinePoint.bl_rna_get_subclass)
    - [`MaskSplinePoint.bl_rna_get_subclass_py()`](#bpy.types.MaskSplinePoint.bl_rna_get_subclass_py)
