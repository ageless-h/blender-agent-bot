...
# SpreadsheetColumn(bpy\_struct)[¶](#spreadsheetcolumn-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.SpreadsheetColumn(*bpy\_struct*)[¶](#bpy.types.SpreadsheetColumn "Link to this definition")
:   Persistent data associated with a spreadsheet column

    data\_type[¶](#bpy.types.SpreadsheetColumn.data_type "Link to this definition")
    :   The data type of the corresponding column visible in the spreadsheet

        Type:
        :   enum in [`'INT32'`, `'FLOAT'`, `'BOOLEAN'`, `'INSTANCES'`], default `'BOOLEAN'`, (readonly)

    id[¶](#bpy.types.SpreadsheetColumn.id "Link to this definition")
    :   Data used to identify the corresponding data from the data source

        Type:
        :   [`SpreadsheetColumnID`](SpreadsheetColumnID.md#bpy.types.SpreadsheetColumnID "bpy.types.SpreadsheetColumnID"), (readonly)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.SpreadsheetColumn.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.SpreadsheetColumn.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`SpreadsheetTable.columns`](SpreadsheetTable.md#bpy.types.SpreadsheetTable.columns "bpy.types.SpreadsheetTable.columns") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.SpreadsheetColumn.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.SpreadsheetColumn.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* SpreadsheetColumn(bpy\_struct)
  + [`SpreadsheetColumn`](#bpy.types.SpreadsheetColumn)
    - [`SpreadsheetColumn.data_type`](#bpy.types.SpreadsheetColumn.data_type)
    - [`SpreadsheetColumn.id`](#bpy.types.SpreadsheetColumn.id)
    - [`SpreadsheetColumn.bl_rna_get_subclass()`](#bpy.types.SpreadsheetColumn.bl_rna_get_subclass)
    - [`SpreadsheetColumn.bl_rna_get_subclass_py()`](#bpy.types.SpreadsheetColumn.bl_rna_get_subclass_py)
