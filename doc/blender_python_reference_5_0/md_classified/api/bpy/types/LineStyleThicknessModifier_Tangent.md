...
# LineStyleThicknessModifier\_Tangent(LineStyleThicknessModifier)[¶](#linestylethicknessmodifier-tangent-linestylethicknessmodifier "Link to this heading")
...
*class* bpy.types.LineStyleThicknessModifier\_Tangent(*LineStyleThicknessModifier*)[¶](#bpy.types.LineStyleThicknessModifier_Tangent "Link to this definition")
:   Thickness based on the direction of the stroke

    blend[¶](#bpy.types.LineStyleThicknessModifier_Tangent.blend "Link to this definition")
    :   Specify how the modifier value is blended into the base value

        Type:
        :   enum in [`'MIX'`, `'ADD'`, `'SUBTRACT'`, `'MULTIPLY'`, `'DIVIDE'`, `'DIFFERENCE'`, `'MINIMUM'`, `'MAXIMUM'`], default `'MIX'`

    curve[¶](#bpy.types.LineStyleThicknessModifier_Tangent.curve "Link to this definition")
    :   Curve used for the curve mapping

        Type:
        :   [`CurveMapping`](CurveMapping.md#bpy.types.CurveMapping "bpy.types.CurveMapping"), (readonly)

    expanded[¶](#bpy.types.LineStyleThicknessModifier_Tangent.expanded "Link to this definition")
    :   True if the modifier tab is expanded

        Type:
        :   boolean, default False

    influence[¶](#bpy.types.LineStyleThicknessModifier_Tangent.influence "Link to this definition")
    :   Influence factor by which the modifier changes the property

        Type:
        :   float in [0, 1], default 0.0

    invert[¶](#bpy.types.LineStyleThicknessModifier_Tangent.invert "Link to this definition")
    :   Invert the fade-out direction of the linear mapping

        Type:
        :   boolean, default False

    mapping[¶](#bpy.types.LineStyleThicknessModifier_Tangent.mapping "Link to this definition")
    ...
    thickness\_max[¶](#bpy.types.LineStyleThicknessModifier_Tangent.thickness_max "Link to this definition")
    :   Maximum thickness

        Type:
        :   float in [0, 10000], default 0.0

    thickness\_min[¶](#bpy.types.LineStyleThicknessModifier_Tangent.thickness_min "Link to this definition")
    :   Minimum thickness

        Type:
        :   float in [0, 10000], default 0.0

    type[¶](#bpy.types.LineStyleThicknessModifier_Tangent.type "Link to this definition")
    ...
    use[¶](#bpy.types.LineStyleThicknessModifier_Tangent.use "Link to this definition")
    :   Enable or disable this modifier during stroke rendering

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.LineStyleThicknessModifier_Tangent.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.LineStyleThicknessModifier_Tangent.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
        ...
        Return type:
        :   [type](#bpy.types.LineStyleThicknessModifier_Tangent.type "bpy.types.LineStyleThicknessModifier_Tangent.type")
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.LineStyleThicknessModifier_Tangent.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.LineStyleThicknessModifier_Tangent.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* LineStyleThicknessModifier\_Tangent(LineStyleThicknessModifier)
  + [`LineStyleThicknessModifier_Tangent`](#bpy.types.LineStyleThicknessModifier_Tangent)
    - [`LineStyleThicknessModifier_Tangent.blend`](#bpy.types.LineStyleThicknessModifier_Tangent.blend)
    - [`LineStyleThicknessModifier_Tangent.curve`](#bpy.types.LineStyleThicknessModifier_Tangent.curve)
    - [`LineStyleThicknessModifier_Tangent.expanded`](#bpy.types.LineStyleThicknessModifier_Tangent.expanded)
    - [`LineStyleThicknessModifier_Tangent.influence`](#bpy.types.LineStyleThicknessModifier_Tangent.influence)
    - [`LineStyleThicknessModifier_Tangent.invert`](#bpy.types.LineStyleThicknessModifier_Tangent.invert)
    - [`LineStyleThicknessModifier_Tangent.mapping`](#bpy.types.LineStyleThicknessModifier_Tangent.mapping)
    - [`LineStyleThicknessModifier_Tangent.thickness_max`](#bpy.types.LineStyleThicknessModifier_Tangent.thickness_max)
    - [`LineStyleThicknessModifier_Tangent.thickness_min`](#bpy.types.LineStyleThicknessModifier_Tangent.thickness_min)
    - [`LineStyleThicknessModifier_Tangent.type`](#bpy.types.LineStyleThicknessModifier_Tangent.type)
    - [`LineStyleThicknessModifier_Tangent.use`](#bpy.types.LineStyleThicknessModifier_Tangent.use)
    - [`LineStyleThicknessModifier_Tangent.bl_rna_get_subclass()`](#bpy.types.LineStyleThicknessModifier_Tangent.bl_rna_get_subclass)
    - [`LineStyleThicknessModifier_Tangent.bl_rna_get_subclass_py()`](#bpy.types.LineStyleThicknessModifier_Tangent.bl_rna_get_subclass_py)
