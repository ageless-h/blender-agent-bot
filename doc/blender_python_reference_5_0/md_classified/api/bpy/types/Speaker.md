...
# Speaker(ID)[¶](#speaker-id "Link to this heading")

base classes — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct"), [`ID`](ID.md#bpy.types.ID "bpy.types.ID")

*class* bpy.types.Speaker(*ID*)[¶](#bpy.types.Speaker "Link to this definition")
:   Speaker data-block for 3D audio speaker objects

    animation\_data[¶](#bpy.types.Speaker.animation_data "Link to this definition")
    :   Animation data for this data-block

        Type:
        :   [`AnimData`](AnimData.md#bpy.types.AnimData "bpy.types.AnimData"), (readonly)

    attenuation[¶](#bpy.types.Speaker.attenuation "Link to this definition")
    :   How strong the distance affects volume, depending on distance model

        Type:
        :   float in [0, inf], default 1.0

    cone\_angle\_inner[¶](#bpy.types.Speaker.cone_angle_inner "Link to this definition")
    :   Angle of the inner cone, in degrees, inside the cone the volume is 100%

        Type:
        :   float in [0, 360], default 360.0

    cone\_angle\_outer[¶](#bpy.types.Speaker.cone_angle_outer "Link to this definition")
    ...
    cone\_volume\_outer[¶](#bpy.types.Speaker.cone_volume_outer "Link to this definition")
    :   Volume outside the outer cone

        Type:
        :   float in [0, 1], default 1.0

    distance\_max[¶](#bpy.types.Speaker.distance_max "Link to this definition")
    :   Maximum distance for volume calculation, no matter how far away the object is

        Type:
        :   float in [0, inf], default 3.40282e+38

    distance\_reference[¶](#bpy.types.Speaker.distance_reference "Link to this definition")
    :   Reference distance at which volume is 100%

        Type:
        :   float in [0, inf], default 1.0

    muted[¶](#bpy.types.Speaker.muted "Link to this definition")
    :   Mute the speaker

        Type:
        :   boolean, default False

    pitch[¶](#bpy.types.Speaker.pitch "Link to this definition")
    :   Playback pitch of the sound

        Type:
        :   float in [0.1, 10], default 1.0

    sound[¶](#bpy.types.Speaker.sound "Link to this definition")
    :   Sound data-block used by this speaker

        Type:
        :   [`Sound`](Sound.md#bpy.types.Sound "bpy.types.Sound")

    volume[¶](#bpy.types.Speaker.volume "Link to this definition")
    :   How loud the sound is

        Type:
        :   float in [0, 1], default 1.0

    volume\_max[¶](#bpy.types.Speaker.volume_max "Link to this definition")
    :   Maximum volume, no matter how near the object is

        Type:
        :   float in [0, 1], default 1.0

    volume\_min[¶](#bpy.types.Speaker.volume_min "Link to this definition")
    :   Minimum volume, no matter how far away the object is

        Type:
        :   float in [0, 1], default 0.0

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.Speaker.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.Speaker.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`bpy.context.speaker`](../context/index.md#bpy.context.speaker "bpy.context.speaker") * [`BlendData.speakers`](BlendData.md#bpy.types.BlendData.speakers "bpy.types.BlendData.speakers") | * [`BlendDataSpeakers.new`](BlendDataSpeakers.md#bpy.types.BlendDataSpeakers.new "bpy.types.BlendDataSpeakers.new") * [`BlendDataSpeakers.remove`](BlendDataSpeakers.md#bpy.types.BlendDataSpeakers.remove "bpy.types.BlendDataSpeakers.remove") |

[Next

SpeedControlStrip(EffectStrip)](SpeedControlStrip.md)
[Previous
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.Speaker.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.Speaker.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* Speaker(ID)
  + [`Speaker`](#bpy.types.Speaker)
    - [`Speaker.animation_data`](#bpy.types.Speaker.animation_data)
    - [`Speaker.attenuation`](#bpy.types.Speaker.attenuation)
    - [`Speaker.cone_angle_inner`](#bpy.types.Speaker.cone_angle_inner)
    - [`Speaker.cone_angle_outer`](#bpy.types.Speaker.cone_angle_outer)
    - [`Speaker.cone_volume_outer`](#bpy.types.Speaker.cone_volume_outer)
    - [`Speaker.distance_max`](#bpy.types.Speaker.distance_max)
    - [`Speaker.distance_reference`](#bpy.types.Speaker.distance_reference)
    - [`Speaker.muted`](#bpy.types.Speaker.muted)
    - [`Speaker.pitch`](#bpy.types.Speaker.pitch)
    - [`Speaker.sound`](#bpy.types.Speaker.sound)
    - [`Speaker.volume`](#bpy.types.Speaker.volume)
    - [`Speaker.volume_max`](#bpy.types.Speaker.volume_max)
    - [`Speaker.volume_min`](#bpy.types.Speaker.volume_min)
    - [`Speaker.bl_rna_get_subclass()`](#bpy.types.Speaker.bl_rna_get_subclass)
    - [`Speaker.bl_rna_get_subclass_py()`](#bpy.types.Speaker.bl_rna_get_subclass_py)
