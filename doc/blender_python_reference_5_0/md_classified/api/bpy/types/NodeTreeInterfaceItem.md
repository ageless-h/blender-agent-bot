...
# NodeTreeInterfaceItem(bpy\_struct)[¶](#nodetreeinterfaceitem-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

subclasses —
[`NodeTreeInterfacePanel`](NodeTreeInterfacePanel.md#bpy.types.NodeTreeInterfacePanel "bpy.types.NodeTreeInterfacePanel"), [`NodeTreeInterfaceSocket`](NodeTreeInterfaceSocket.md#bpy.types.NodeTreeInterfaceSocket "bpy.types.NodeTreeInterfaceSocket")

*class* bpy.types.NodeTreeInterfaceItem(*bpy\_struct*)[¶](#bpy.types.NodeTreeInterfaceItem "Link to this definition")
:   Item in a node tree interface

    index[¶](#bpy.types.NodeTreeInterfaceItem.index "Link to this definition")
    :   Global index of the item among all items in the interface

        Type:
        :   int in [-1, inf], default 0, (readonly)

    item\_type[¶](#bpy.types.NodeTreeInterfaceItem.item_type "Link to this definition")
    :   Type of interface item

        Type:
        :   enum in [Node Tree Interface Item Type Items](../../../appendix/bpy_types_enum_items/node_tree_interface_item_type_items.md#rna-enum-node-tree-interface-item-type-items), default `'PANEL'`, (readonly)

    parent[¶](#bpy.types.NodeTreeInterfaceItem.parent "Link to this definition")
    :   Panel that contains the item

        Type:
        :   [`NodeTreeInterfacePanel`](NodeTreeInterfacePanel.md#bpy.types.NodeTreeInterfacePanel "bpy.types.NodeTreeInterfacePanel"), (readonly)

    position[¶](#bpy.types.NodeTreeInterfaceItem.position "Link to this definition")
    :   Position of the item in its parent panel

        Type:
        :   int in [-1, inf], default 0, (readonly)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.NodeTreeInterfaceItem.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.NodeTreeInterfaceItem.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`NodeTreeInterface.active`](NodeTreeInterface.md#bpy.types.NodeTreeInterface.active "bpy.types.NodeTreeInterface.active") * [`NodeTreeInterface.copy`](NodeTreeInterface.md#bpy.types.NodeTreeInterface.copy "bpy.types.NodeTreeInterface.copy") * [`NodeTreeInterface.copy`](NodeTreeInterface.md#bpy.types.NodeTreeInterface.copy "bpy.types.NodeTreeInterface.copy") * [`NodeTreeInterface.items_tree`](NodeTreeInterface.md#bpy.types.NodeTreeInterface.items_tree "bpy.types.NodeTreeInterface.items_tree") | * [`NodeTreeInterface.move`](NodeTreeInterface.md#bpy.types.NodeTreeInterface.move "bpy.types.NodeTreeInterface.move") * [`NodeTreeInterface.move_to_parent`](NodeTreeInterface.md#bpy.types.NodeTreeInterface.move_to_parent "bpy.types.NodeTreeInterface.move_to_parent") * [`NodeTreeInterface.remove`](NodeTreeInterface.md#bpy.types.NodeTreeInterface.remove "bpy.types.NodeTreeInterface.remove") * [`NodeTreeInterfacePanel.interface_items`](NodeTreeInterfacePanel.md#bpy.types.NodeTreeInterfacePanel.interface_items "bpy.types.NodeTreeInterfacePanel.interface_items") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.NodeTreeInterfaceItem.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.NodeTreeInterfaceItem.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* NodeTreeInterfaceItem(bpy\_struct)
  + [`NodeTreeInterfaceItem`](#bpy.types.NodeTreeInterfaceItem)
    - [`NodeTreeInterfaceItem.index`](#bpy.types.NodeTreeInterfaceItem.index)
    - [`NodeTreeInterfaceItem.item_type`](#bpy.types.NodeTreeInterfaceItem.item_type)
    - [`NodeTreeInterfaceItem.parent`](#bpy.types.NodeTreeInterfaceItem.parent)
    - [`NodeTreeInterfaceItem.position`](#bpy.types.NodeTreeInterfaceItem.position)
    - [`NodeTreeInterfaceItem.bl_rna_get_subclass()`](#bpy.types.NodeTreeInterfaceItem.bl_rna_get_subclass)
    - [`NodeTreeInterfaceItem.bl_rna_get_subclass_py()`](#bpy.types.NodeTreeInterfaceItem.bl_rna_get_subclass_py)
