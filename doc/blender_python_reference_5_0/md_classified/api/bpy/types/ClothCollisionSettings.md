...
# ClothCollisionSettings(bpy\_struct)[¶](#clothcollisionsettings-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.ClothCollisionSettings(*bpy\_struct*)[¶](#bpy.types.ClothCollisionSettings "Link to this definition")
:   Cloth simulation settings for self collision and collision with other objects

    collection[¶](#bpy.types.ClothCollisionSettings.collection "Link to this definition")
    :   Limit colliders to this Collection

        Type:
        :   [`Collection`](Collection.md#bpy.types.Collection "bpy.types.Collection")

    collision\_quality[¶](#bpy.types.ClothCollisionSettings.collision_quality "Link to this definition")
    :   How many collision iterations should be done (higher is better quality but slower)

        Type:
        :   int in [1, 32767], default 2

    damping[¶](#bpy.types.ClothCollisionSettings.damping "Link to this definition")
    :   Amount of velocity lost on collision

        Type:
        :   float in [0, 1], default 1.0

    distance\_min[¶](#bpy.types.ClothCollisionSettings.distance_min "Link to this definition")
    :   Minimum distance between collision objects before collision response takes effect

        Type:
        :   float in [0.001, 1], default 0.015

    friction[¶](#bpy.types.ClothCollisionSettings.friction "Link to this definition")
    :   Friction force if a collision happened (higher = less movement)

        Type:
        :   float in [0, 80], default 5.0

    impulse\_clamp[¶](#bpy.types.ClothCollisionSettings.impulse_clamp "Link to this definition")
    :   Clamp collision impulses to avoid instability (0.0 to disable clamping)

        Type:
        :   float in [0, 100], default 0.0

    self\_distance\_min[¶](#bpy.types.ClothCollisionSettings.self_distance_min "Link to this definition")
    :   Minimum distance between cloth faces before collision response takes effect

        Type:
        :   float in [0.001, 0.1], default 0.015

    self\_friction[¶](#bpy.types.ClothCollisionSettings.self_friction "Link to this definition")
    :   Friction with self contact

        Type:
        :   float in [0, 80], default 5.0

    self\_impulse\_clamp[¶](#bpy.types.ClothCollisionSettings.self_impulse_clamp "Link to this definition")
    :   Clamp collision impulses to avoid instability (0.0 to disable clamping)

        Type:
        :   float in [0, 100], default 0.0

    use\_collision[¶](#bpy.types.ClothCollisionSettings.use_collision "Link to this definition")
    :   Enable collisions with other objects

        Type:
        :   boolean, default True

    use\_self\_collision[¶](#bpy.types.ClothCollisionSettings.use_self_collision "Link to this definition")
    :   Enable self collisions

        Type:
        :   boolean, default False

    vertex\_group\_object\_collisions[¶](#bpy.types.ClothCollisionSettings.vertex_group_object_collisions "Link to this definition")
    :   Triangles with all vertices in this group are not used during object collisions

        Type:
        :   string, default “”, (never None)

    vertex\_group\_self\_collisions[¶](#bpy.types.ClothCollisionSettings.vertex_group_self_collisions "Link to this definition")
    :   Triangles with all vertices in this group are not used during self collisions

        Type:
        :   string, default “”, (never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ClothCollisionSettings.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ClothCollisionSettings.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`ClothModifier.collision_settings`](ClothModifier.md#bpy.types.ClothModifier.collision_settings "bpy.types.ClothModifier.collision_settings") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ClothCollisionSettings.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ClothCollisionSettings.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ClothCollisionSettings(bpy\_struct)
  + [`ClothCollisionSettings`](#bpy.types.ClothCollisionSettings)
    - [`ClothCollisionSettings.collection`](#bpy.types.ClothCollisionSettings.collection)
    - [`ClothCollisionSettings.collision_quality`](#bpy.types.ClothCollisionSettings.collision_quality)
    - [`ClothCollisionSettings.damping`](#bpy.types.ClothCollisionSettings.damping)
    - [`ClothCollisionSettings.distance_min`](#bpy.types.ClothCollisionSettings.distance_min)
    - [`ClothCollisionSettings.friction`](#bpy.types.ClothCollisionSettings.friction)
    - [`ClothCollisionSettings.impulse_clamp`](#bpy.types.ClothCollisionSettings.impulse_clamp)
    - [`ClothCollisionSettings.self_distance_min`](#bpy.types.ClothCollisionSettings.self_distance_min)
    - [`ClothCollisionSettings.self_friction`](#bpy.types.ClothCollisionSettings.self_friction)
    - [`ClothCollisionSettings.self_impulse_clamp`](#bpy.types.ClothCollisionSettings.self_impulse_clamp)
    - [`ClothCollisionSettings.use_collision`](#bpy.types.ClothCollisionSettings.use_collision)
    - [`ClothCollisionSettings.use_self_collision`](#bpy.types.ClothCollisionSettings.use_self_collision)
    - [`ClothCollisionSettings.vertex_group_object_collisions`](#bpy.types.ClothCollisionSettings.vertex_group_object_collisions)
    - [`ClothCollisionSettings.vertex_group_self_collisions`](#bpy.types.ClothCollisionSettings.vertex_group_self_collisions)
    - [`ClothCollisionSettings.bl_rna_get_subclass()`](#bpy.types.ClothCollisionSettings.bl_rna_get_subclass)
    - [`ClothCollisionSettings.bl_rna_get_subclass_py()`](#bpy.types.ClothCollisionSettings.bl_rna_get_subclass_py)
