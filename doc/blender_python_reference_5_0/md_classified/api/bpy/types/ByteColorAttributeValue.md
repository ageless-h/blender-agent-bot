...
# ByteColorAttributeValue(bpy\_struct)[¶](#bytecolorattributevalue-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.ByteColorAttributeValue(*bpy\_struct*)[¶](#bpy.types.ByteColorAttributeValue "Link to this definition")
:   Color value in geometry attribute

    color[¶](#bpy.types.ByteColorAttributeValue.color "Link to this definition")
    :   RGBA color in scene linear color space

        Type:
        :   float array of 4 items in [0, 1], default (0.0, 0.0, 0.0, 0.0)

    color\_srgb[¶](#bpy.types.ByteColorAttributeValue.color_srgb "Link to this definition")
    :   RGBA color in sRGB color space

        Type:
        :   float array of 4 items in [0, 1], default (0.0, 0.0, 0.0, 0.0)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ByteColorAttributeValue.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ByteColorAttributeValue.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`ByteColorAttribute.data`](ByteColorAttribute.md#bpy.types.ByteColorAttribute.data "bpy.types.ByteColorAttribute.data") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ByteColorAttributeValue.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ByteColorAttributeValue.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ByteColorAttributeValue(bpy\_struct)
  + [`ByteColorAttributeValue`](#bpy.types.ByteColorAttributeValue)
    - [`ByteColorAttributeValue.color`](#bpy.types.ByteColorAttributeValue.color)
    - [`ByteColorAttributeValue.color_srgb`](#bpy.types.ByteColorAttributeValue.color_srgb)
    - [`ByteColorAttributeValue.bl_rna_get_subclass()`](#bpy.types.ByteColorAttributeValue.bl_rna_get_subclass)
    - [`ByteColorAttributeValue.bl_rna_get_subclass_py()`](#bpy.types.ByteColorAttributeValue.bl_rna_get_subclass_py)
