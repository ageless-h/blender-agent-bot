...
# SoundEqualizerModifier(StripModifier)[¶](#soundequalizermodifier-stripmodifier "Link to this heading")
...
*class* bpy.types.SoundEqualizerModifier(*StripModifier*)[¶](#bpy.types.SoundEqualizerModifier "Link to this definition")
:   Equalize audio

    graphics[¶](#bpy.types.SoundEqualizerModifier.graphics "Link to this definition")
    :   Graphical definition equalization

        Type:
        :   [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`EQCurveMappingData`](EQCurveMappingData.md#bpy.types.EQCurveMappingData "bpy.types.EQCurveMappingData"), (readonly)

    new\_graphic(*min\_freq*, *max\_freq*)[¶](#bpy.types.SoundEqualizerModifier.new_graphic "Link to this definition")
    :   Add a new EQ band

        Parameters:
        :   * **min\_freq** (*float in* *[**0**,* *20000**]*) – Minimum Frequency, Minimum Frequency
            * **max\_freq** (*float in* *[**0**,* *20000**]*) – Maximum Frequency, Maximum Frequency

        Returns:
        :   Newly created graphical Equalizer definition

        Return type:
        :   [`EQCurveMappingData`](EQCurveMappingData.md#bpy.types.EQCurveMappingData "bpy.types.EQCurveMappingData")

    clear\_soundeqs()[¶](#bpy.types.SoundEqualizerModifier.clear_soundeqs "Link to this definition")
    :   Remove all graphical equalizers from the Equalizer modifier

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.SoundEqualizerModifier.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.SoundEqualizerModifier.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
SoundStrip(Strip)](SoundStrip.md)
[Previous
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.SoundEqualizerModifier.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.SoundEqualizerModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* SoundEqualizerModifier(StripModifier)
  + [`SoundEqualizerModifier`](#bpy.types.SoundEqualizerModifier)
    - [`SoundEqualizerModifier.graphics`](#bpy.types.SoundEqualizerModifier.graphics)
    - [`SoundEqualizerModifier.new_graphic()`](#bpy.types.SoundEqualizerModifier.new_graphic)
    - [`SoundEqualizerModifier.clear_soundeqs()`](#bpy.types.SoundEqualizerModifier.clear_soundeqs)
    - [`SoundEqualizerModifier.bl_rna_get_subclass()`](#bpy.types.SoundEqualizerModifier.bl_rna_get_subclass)
    - [`SoundEqualizerModifier.bl_rna_get_subclass_py()`](#bpy.types.SoundEqualizerModifier.bl_rna_get_subclass_py)
