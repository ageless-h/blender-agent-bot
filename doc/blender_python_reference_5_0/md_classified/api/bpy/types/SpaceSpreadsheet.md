...
# SpaceSpreadsheet(Space)[¶](#spacespreadsheet-space "Link to this heading")
...
*class* bpy.types.SpaceSpreadsheet(*Space*)[¶](#bpy.types.SpaceSpreadsheet "Link to this definition")
:   Spreadsheet space data

    attribute\_domain[¶](#bpy.types.SpaceSpreadsheet.attribute_domain "Link to this definition")
    ...
    geometry\_component\_type[¶](#bpy.types.SpaceSpreadsheet.geometry_component_type "Link to this definition")
    :   Part of the geometry to display data from

        Type:
        :   enum in [Geometry Component Type Items](../../../appendix/bpy_types_enum_items/geometry_component_type_items.md#rna-enum-geometry-component-type-items), default `'MESH'`

    is\_pinned[¶](#bpy.types.SpaceSpreadsheet.is_pinned "Link to this definition")
    :   Context path is pinned

        Type:
        :   boolean, default False

    object\_eval\_state[¶](#bpy.types.SpaceSpreadsheet.object_eval_state "Link to this definition")
    :   * `EVALUATED`
    ...
    row\_filters[¶](#bpy.types.SpaceSpreadsheet.row_filters "Link to this definition")
    :   Filters to remove rows from the displayed data

        Type:
        :   [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`SpreadsheetRowFilter`](SpreadsheetRowFilter.md#bpy.types.SpreadsheetRowFilter "bpy.types.SpreadsheetRowFilter"), (readonly)

    show\_internal\_attributes[¶](#bpy.types.SpaceSpreadsheet.show_internal_attributes "Link to this definition")
    :   Display attributes with names starting with a period that are meant for internal use

        Type:
        :   boolean, default False

    show\_only\_selected[¶](#bpy.types.SpaceSpreadsheet.show_only_selected "Link to this definition")
    :   Only include rows that correspond to selected elements

        Type:
        :   boolean, default False

    show\_region\_channels[¶](#bpy.types.SpaceSpreadsheet.show_region_channels "Link to this definition")
    :   Type:
        :   boolean, default False

    show\_region\_footer[¶](#bpy.types.SpaceSpreadsheet.show_region_footer "Link to this definition")
    :   Type:
        :   boolean, default False

    show\_region\_toolbar[¶](#bpy.types.SpaceSpreadsheet.show_region_toolbar "Link to this definition")
    :   Type:
        :   boolean, default False

    show\_region\_ui[¶](#bpy.types.SpaceSpreadsheet.show_region_ui "Link to this definition")
    :   Type:
        :   boolean, default False

    tables[¶](#bpy.types.SpaceSpreadsheet.tables "Link to this definition")
    :   Persistent data for the tables shown in this spreadsheet editor

        Type:
        :   [`SpreadsheetTables`](SpreadsheetTables.md#bpy.types.SpreadsheetTables "bpy.types.SpreadsheetTables") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`SpreadsheetTable`](SpreadsheetTable.md#bpy.types.SpreadsheetTable "bpy.types.SpreadsheetTable"), (readonly)

    use\_filter[¶](#bpy.types.SpaceSpreadsheet.use_filter "Link to this definition")
    :   Type:
        :   boolean, default False

    viewer\_path[¶](#bpy.types.SpaceSpreadsheet.viewer_path "Link to this definition")
    :   Path to the data that is displayed in the spreadsheet

        Type:
        :   [`ViewerPath`](ViewerPath.md#bpy.types.ViewerPath "bpy.types.ViewerPath"), (readonly)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.SpaceSpreadsheet.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.SpaceSpreadsheet.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
    ...
    *classmethod* draw\_handler\_add(*callback*, *args*, *region\_type*, *draw\_type*)[¶](#bpy.types.SpaceSpreadsheet.draw_handler_add "Link to this definition")
    ...
    *classmethod* draw\_handler\_remove(*handler*, *region\_type*)[¶](#bpy.types.SpaceSpreadsheet.draw_handler_remove "Link to this definition")
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.SpaceSpreadsheet.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.SpaceSpreadsheet.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* SpaceSpreadsheet(Space)
  + [`SpaceSpreadsheet`](#bpy.types.SpaceSpreadsheet)
    - [`SpaceSpreadsheet.attribute_domain`](#bpy.types.SpaceSpreadsheet.attribute_domain)
    - [`SpaceSpreadsheet.geometry_component_type`](#bpy.types.SpaceSpreadsheet.geometry_component_type)
    - [`SpaceSpreadsheet.is_pinned`](#bpy.types.SpaceSpreadsheet.is_pinned)
    - [`SpaceSpreadsheet.object_eval_state`](#bpy.types.SpaceSpreadsheet.object_eval_state)
    - [`SpaceSpreadsheet.row_filters`](#bpy.types.SpaceSpreadsheet.row_filters)
    - [`SpaceSpreadsheet.show_internal_attributes`](#bpy.types.SpaceSpreadsheet.show_internal_attributes)
    - [`SpaceSpreadsheet.show_only_selected`](#bpy.types.SpaceSpreadsheet.show_only_selected)
    - [`SpaceSpreadsheet.show_region_channels`](#bpy.types.SpaceSpreadsheet.show_region_channels)
    - [`SpaceSpreadsheet.show_region_footer`](#bpy.types.SpaceSpreadsheet.show_region_footer)
    - [`SpaceSpreadsheet.show_region_toolbar`](#bpy.types.SpaceSpreadsheet.show_region_toolbar)
    - [`SpaceSpreadsheet.show_region_ui`](#bpy.types.SpaceSpreadsheet.show_region_ui)
    - [`SpaceSpreadsheet.tables`](#bpy.types.SpaceSpreadsheet.tables)
    - [`SpaceSpreadsheet.use_filter`](#bpy.types.SpaceSpreadsheet.use_filter)
    - [`SpaceSpreadsheet.viewer_path`](#bpy.types.SpaceSpreadsheet.viewer_path)
    - [`SpaceSpreadsheet.bl_rna_get_subclass()`](#bpy.types.SpaceSpreadsheet.bl_rna_get_subclass)
    - [`SpaceSpreadsheet.bl_rna_get_subclass_py()`](#bpy.types.SpaceSpreadsheet.bl_rna_get_subclass_py)
    - [`SpaceSpreadsheet.draw_handler_add()`](#bpy.types.SpaceSpreadsheet.draw_handler_add)
    - [`SpaceSpreadsheet.draw_handler_remove()`](#bpy.types.SpaceSpreadsheet.draw_handler_remove)
