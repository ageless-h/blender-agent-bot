...
# BrushCurvesSculptSettings(bpy\_struct)[¶](#brushcurvessculptsettings-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.BrushCurvesSculptSettings(*bpy\_struct*)[¶](#bpy.types.BrushCurvesSculptSettings "Link to this definition")
:   add\_amount[¶](#bpy.types.BrushCurvesSculptSettings.add_amount "Link to this definition")
    :   Number of curves added by the Add brush

        Type:
        :   int in [1, inf], default 0

    curve\_length[¶](#bpy.types.BrushCurvesSculptSettings.curve_length "Link to this definition")
    :   Length of newly added curves when it is not interpolated from other curves

        Type:
        :   float in [0, inf], default 0.0

    curve\_parameter\_falloff[¶](#bpy.types.BrushCurvesSculptSettings.curve_parameter_falloff "Link to this definition")
    ...
    curve\_radius[¶](#bpy.types.BrushCurvesSculptSettings.curve_radius "Link to this definition")
    :   Radius of newly added curves when it is not interpolated from other curves

        Type:
        :   float in [0, inf], default 0.01

    density\_add\_attempts[¶](#bpy.types.BrushCurvesSculptSettings.density_add_attempts "Link to this definition")
    :   How many times the Density brush tries to add a new curve

        Type:
        :   int in [0, inf], default 0

    density\_mode[¶](#bpy.types.BrushCurvesSculptSettings.density_mode "Link to this definition")
    ...
    minimum\_distance[¶](#bpy.types.BrushCurvesSculptSettings.minimum_distance "Link to this definition")
    :   Goal distance between curve roots for the Density brush

        Type:
        :   float in [0, inf], default 0.0

    minimum\_length[¶](#bpy.types.BrushCurvesSculptSettings.minimum_length "Link to this definition")
    :   Avoid shrinking curves shorter than this length

        Type:
        :   float in [0, inf], default 0.0

    points\_per\_curve[¶](#bpy.types.BrushCurvesSculptSettings.points_per_curve "Link to this definition")
    :   Number of control points in a newly added curve

        Type:
        :   int in [2, inf], default 0

    use\_length\_interpolate[¶](#bpy.types.BrushCurvesSculptSettings.use_length_interpolate "Link to this definition")
    :   Use length of the curves in close proximity

        Type:
        :   boolean, default False

    use\_point\_count\_interpolate[¶](#bpy.types.BrushCurvesSculptSettings.use_point_count_interpolate "Link to this definition")
    :   Use the number of points from the curves in close proximity

        Type:
        :   boolean, default False

    use\_radius\_interpolate[¶](#bpy.types.BrushCurvesSculptSettings.use_radius_interpolate "Link to this definition")
    :   Use radius of the curves in close proximity

        Type:
        :   boolean, default True

    use\_shape\_interpolate[¶](#bpy.types.BrushCurvesSculptSettings.use_shape_interpolate "Link to this definition")
    :   Use shape of the curves in close proximity

        Type:
        :   boolean, default False

    use\_uniform\_scale[¶](#bpy.types.BrushCurvesSculptSettings.use_uniform_scale "Link to this definition")
    :   Grow or shrink curves by changing their size uniformly instead of using trimming or extrapolation

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.BrushCurvesSculptSettings.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.BrushCurvesSculptSettings.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Brush.curves_sculpt_settings`](Brush.md#bpy.types.Brush.curves_sculpt_settings "bpy.types.Brush.curves_sculpt_settings") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.BrushCurvesSculptSettings.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.BrushCurvesSculptSettings.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* BrushCurvesSculptSettings(bpy\_struct)
  + [`BrushCurvesSculptSettings`](#bpy.types.BrushCurvesSculptSettings)
    - [`BrushCurvesSculptSettings.add_amount`](#bpy.types.BrushCurvesSculptSettings.add_amount)
    - [`BrushCurvesSculptSettings.curve_length`](#bpy.types.BrushCurvesSculptSettings.curve_length)
    - [`BrushCurvesSculptSettings.curve_parameter_falloff`](#bpy.types.BrushCurvesSculptSettings.curve_parameter_falloff)
    - [`BrushCurvesSculptSettings.curve_radius`](#bpy.types.BrushCurvesSculptSettings.curve_radius)
    - [`BrushCurvesSculptSettings.density_add_attempts`](#bpy.types.BrushCurvesSculptSettings.density_add_attempts)
    - [`BrushCurvesSculptSettings.density_mode`](#bpy.types.BrushCurvesSculptSettings.density_mode)
    - [`BrushCurvesSculptSettings.minimum_distance`](#bpy.types.BrushCurvesSculptSettings.minimum_distance)
    - [`BrushCurvesSculptSettings.minimum_length`](#bpy.types.BrushCurvesSculptSettings.minimum_length)
    - [`BrushCurvesSculptSettings.points_per_curve`](#bpy.types.BrushCurvesSculptSettings.points_per_curve)
    - [`BrushCurvesSculptSettings.use_length_interpolate`](#bpy.types.BrushCurvesSculptSettings.use_length_interpolate)
    - [`BrushCurvesSculptSettings.use_point_count_interpolate`](#bpy.types.BrushCurvesSculptSettings.use_point_count_interpolate)
    - [`BrushCurvesSculptSettings.use_radius_interpolate`](#bpy.types.BrushCurvesSculptSettings.use_radius_interpolate)
    - [`BrushCurvesSculptSettings.use_shape_interpolate`](#bpy.types.BrushCurvesSculptSettings.use_shape_interpolate)
    - [`BrushCurvesSculptSettings.use_uniform_scale`](#bpy.types.BrushCurvesSculptSettings.use_uniform_scale)
    - [`BrushCurvesSculptSettings.bl_rna_get_subclass()`](#bpy.types.BrushCurvesSculptSettings.bl_rna_get_subclass)
    - [`BrushCurvesSculptSettings.bl_rna_get_subclass_py()`](#bpy.types.BrushCurvesSculptSettings.bl_rna_get_subclass_py)
