...
# CurveProfilePoint(bpy\_struct)[¶](#curveprofilepoint-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.CurveProfilePoint(*bpy\_struct*)[¶](#bpy.types.CurveProfilePoint "Link to this definition")
:   Point of a path used to define a profile

    handle\_type\_1[¶](#bpy.types.CurveProfilePoint.handle_type_1 "Link to this definition")
    :   Path interpolation at this point

        Type:
        :   enum in [`'AUTO'`, `'VECTOR'`, `'FREE'`, `'ALIGN'`], default `'FREE'`

    handle\_type\_2[¶](#bpy.types.CurveProfilePoint.handle_type_2 "Link to this definition")
    :   Path interpolation at this point

        Type:
        :   enum in [`'AUTO'`, `'VECTOR'`, `'FREE'`, `'ALIGN'`], default `'FREE'`

    location[¶](#bpy.types.CurveProfilePoint.location "Link to this definition")
    ...
    select[¶](#bpy.types.CurveProfilePoint.select "Link to this definition")
    :   Selection state of the path point

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.CurveProfilePoint.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.CurveProfilePoint.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`CurveProfile.points`](CurveProfile.md#bpy.types.CurveProfile.points "bpy.types.CurveProfile.points") * [`CurveProfile.segments`](CurveProfile.md#bpy.types.CurveProfile.segments "bpy.types.CurveProfile.segments") | * [`CurveProfilePoints.add`](CurveProfilePoints.md#bpy.types.CurveProfilePoints.add "bpy.types.CurveProfilePoints.add") * [`CurveProfilePoints.remove`](CurveProfilePoints.md#bpy.types.CurveProfilePoints.remove "bpy.types.CurveProfilePoints.remove") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CurveProfilePoint.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.CurveProfilePoint.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CurveProfilePoint(bpy\_struct)
  + [`CurveProfilePoint`](#bpy.types.CurveProfilePoint)
    - [`CurveProfilePoint.handle_type_1`](#bpy.types.CurveProfilePoint.handle_type_1)
    - [`CurveProfilePoint.handle_type_2`](#bpy.types.CurveProfilePoint.handle_type_2)
    - [`CurveProfilePoint.location`](#bpy.types.CurveProfilePoint.location)
    - [`CurveProfilePoint.select`](#bpy.types.CurveProfilePoint.select)
    - [`CurveProfilePoint.bl_rna_get_subclass()`](#bpy.types.CurveProfilePoint.bl_rna_get_subclass)
    - [`CurveProfilePoint.bl_rna_get_subclass_py()`](#bpy.types.CurveProfilePoint.bl_rna_get_subclass_py)
