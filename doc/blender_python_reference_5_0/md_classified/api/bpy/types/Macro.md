...
# Macro(bpy\_struct)[¶](#macro-bpy-struct "Link to this heading")

## Example Macro[¶](#example-macro "Link to this heading")
...
*class* bpy.types.Macro(*bpy\_struct*)[¶](#bpy.types.Macro "Link to this definition")
:   Storage of a macro operator being executed, or registered after execution

    bl\_cursor\_pending[¶](#bpy.types.Macro.bl_cursor_pending "Link to this definition")
    ...
    bl\_description[¶](#bpy.types.Macro.bl_description "Link to this definition")
    :   Type:
        :   string, default “”, (never None)

    bl\_idname[¶](#bpy.types.Macro.bl_idname "Link to this definition")
    :   Type:
        :   string, default “”, (never None)

    bl\_label[¶](#bpy.types.Macro.bl_label "Link to this definition")
    :   Type:
        :   string, default “”, (never None)

    bl\_options[¶](#bpy.types.Macro.bl_options "Link to this definition")
    :   Options for this operator type

        Type:
        :   enum set in [Operator Type Flag Items](../../../appendix/bpy_types_enum_items/operator_type_flag_items.md#rna-enum-operator-type-flag-items), default set()

    bl\_translation\_context[¶](#bpy.types.Macro.bl_translation_context "Link to this definition")
    :   Type:
        :   string, default “Operator”, (never None)

    bl\_undo\_group[¶](#bpy.types.Macro.bl_undo_group "Link to this definition")
    :   Type:
        :   string, default “”, (never None)

    has\_reports[¶](#bpy.types.Macro.has_reports "Link to this definition")
    :   Operator has a set of reports (warnings and errors) from last execution

        Type:
        :   boolean, default False, (readonly)

    name[¶](#bpy.types.Macro.name "Link to this definition")
    :   Type:
        :   string, default “”, (readonly, never None)

    properties[¶](#bpy.types.Macro.properties "Link to this definition")
    :   Type:
        :   [`OperatorProperties`](OperatorProperties.md#bpy.types.OperatorProperties "bpy.types.OperatorProperties"), (readonly, never None)

    report(*type*, *message*)[¶](#bpy.types.Macro.report "Link to this definition")
    :   report
    ...
    *classmethod* poll(*context*)[¶](#bpy.types.Macro.poll "Link to this definition")
    :   Test if the operator can be called or not

        Return type:
        :   boolean

    draw(*context*)[¶](#bpy.types.Macro.draw "Link to this definition")
    :   Draw function for the operator

    *classmethod* define(*operator*)[¶](#bpy.types.Macro.define "Link to this definition")
    :   Append an operator to a registered macro class.
        ...
        Return type:
        :   [`OperatorMacro`](OperatorMacro.md#bpy.types.OperatorMacro "bpy.types.OperatorMacro")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.Macro.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.Macro.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Operator.macros`](Operator.md#bpy.types.Operator.macros "bpy.types.Operator.macros") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.Macro.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.Macro.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* Macro(bpy\_struct)
  + [Example Macro](#example-macro)
    - [`Macro`](#bpy.types.Macro)
      * [`Macro.bl_cursor_pending`](#bpy.types.Macro.bl_cursor_pending)
      * [`Macro.bl_description`](#bpy.types.Macro.bl_description)
      * [`Macro.bl_idname`](#bpy.types.Macro.bl_idname)
      * [`Macro.bl_label`](#bpy.types.Macro.bl_label)
      * [`Macro.bl_options`](#bpy.types.Macro.bl_options)
      * [`Macro.bl_translation_context`](#bpy.types.Macro.bl_translation_context)
      * [`Macro.bl_undo_group`](#bpy.types.Macro.bl_undo_group)
      * [`Macro.has_reports`](#bpy.types.Macro.has_reports)
      * [`Macro.name`](#bpy.types.Macro.name)
      * [`Macro.properties`](#bpy.types.Macro.properties)
      * [`Macro.report()`](#bpy.types.Macro.report)
      * [`Macro.poll()`](#bpy.types.Macro.poll)
      * [`Macro.draw()`](#bpy.types.Macro.draw)
      * [`Macro.define()`](#bpy.types.Macro.define)
      * [`Macro.bl_rna_get_subclass()`](#bpy.types.Macro.bl_rna_get_subclass)
      * [`Macro.bl_rna_get_subclass_py()`](#bpy.types.Macro.bl_rna_get_subclass_py)
