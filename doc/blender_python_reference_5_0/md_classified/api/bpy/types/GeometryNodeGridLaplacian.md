...
# GeometryNodeGridLaplacian(GeometryNode)[¶](#geometrynodegridlaplacian-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeGridLaplacian(*GeometryNode*)[¶](#bpy.types.GeometryNodeGridLaplacian "Link to this definition")
:   Compute the divergence of the gradient of the input grid

    *classmethod* is\_registered\_node\_type()[¶](#bpy.types.GeometryNodeGridLaplacian.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[¶](#bpy.types.GeometryNodeGridLaplacian.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[¶](#bpy.types.GeometryNodeGridLaplacian.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.GeometryNodeGridLaplacian.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.GeometryNodeGridLaplacian.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
GeometryNodeGridPrune(GeometryNode)](GeometryNodeGridPrune.md)
[Previous
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeGridLaplacian.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.GeometryNodeGridLaplacian.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeGridLaplacian(GeometryNode)
  + [`GeometryNodeGridLaplacian`](#bpy.types.GeometryNodeGridLaplacian)
    - [`GeometryNodeGridLaplacian.is_registered_node_type()`](#bpy.types.GeometryNodeGridLaplacian.is_registered_node_type)
    - [`GeometryNodeGridLaplacian.input_template()`](#bpy.types.GeometryNodeGridLaplacian.input_template)
    - [`GeometryNodeGridLaplacian.output_template()`](#bpy.types.GeometryNodeGridLaplacian.output_template)
    - [`GeometryNodeGridLaplacian.bl_rna_get_subclass()`](#bpy.types.GeometryNodeGridLaplacian.bl_rna_get_subclass)
    - [`GeometryNodeGridLaplacian.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeGridLaplacian.bl_rna_get_subclass_py)
