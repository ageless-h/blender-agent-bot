...
# UVWarpModifier(Modifier)[¶](#uvwarpmodifier-modifier "Link to this heading")
...
*class* bpy.types.UVWarpModifier(*Modifier*)[¶](#bpy.types.UVWarpModifier "Link to this definition")
:   Add target position to UV coordinates

    axis\_u[¶](#bpy.types.UVWarpModifier.axis_u "Link to this definition")
    ...
    axis\_v[¶](#bpy.types.UVWarpModifier.axis_v "Link to this definition")
    :   Pole axis for rotation

        Type:
        :   enum in [Axis Xyz Items](../../../appendix/bpy_types_enum_items/axis_xyz_items.md#rna-enum-axis-xyz-items), default `'Y'`

    bone\_from[¶](#bpy.types.UVWarpModifier.bone_from "Link to this definition")
    :   Bone defining offset

        Type:
        :   string, default “”, (never None)

    bone\_to[¶](#bpy.types.UVWarpModifier.bone_to "Link to this definition")
    :   Bone defining offset

        Type:
        :   string, default “”, (never None)

    center[¶](#bpy.types.UVWarpModifier.center "Link to this definition")
    :   Center point for rotate/scale

        Type:
        :   float array of 2 items in [-inf, inf], default (0.5, 0.5)

    invert\_vertex\_group[¶](#bpy.types.UVWarpModifier.invert_vertex_group "Link to this definition")
    :   Invert vertex group influence

        Type:
        :   boolean, default False

    object\_from[¶](#bpy.types.UVWarpModifier.object_from "Link to this definition")
    :   Object defining offset

        Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object")

    object\_to[¶](#bpy.types.UVWarpModifier.object_to "Link to this definition")
    :   Object defining offset

        Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object")

    offset[¶](#bpy.types.UVWarpModifier.offset "Link to this definition")
    :   2D Offset for the warp

        Type:
        :   float array of 2 items in [-inf, inf], default (0.0, 0.0)

    rotation[¶](#bpy.types.UVWarpModifier.rotation "Link to this definition")
    :   2D Rotation for the warp

        Type:
        :   float in [-inf, inf], default 0.0

    scale[¶](#bpy.types.UVWarpModifier.scale "Link to this definition")
    :   2D Scale for the warp

        Type:
        :   float array of 2 items in [-inf, inf], default (1.0, 1.0)

    uv\_layer[¶](#bpy.types.UVWarpModifier.uv_layer "Link to this definition")
    :   UV map name

        Type:
        :   string, default “”, (never None)

    vertex\_group[¶](#bpy.types.UVWarpModifier.vertex_group "Link to this definition")
    :   Vertex group name

        Type:
        :   string, default “”, (never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.UVWarpModifier.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.UVWarpModifier.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.UVWarpModifier.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.UVWarpModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* UVWarpModifier(Modifier)
  + [`UVWarpModifier`](#bpy.types.UVWarpModifier)
    - [`UVWarpModifier.axis_u`](#bpy.types.UVWarpModifier.axis_u)
    - [`UVWarpModifier.axis_v`](#bpy.types.UVWarpModifier.axis_v)
    - [`UVWarpModifier.bone_from`](#bpy.types.UVWarpModifier.bone_from)
    - [`UVWarpModifier.bone_to`](#bpy.types.UVWarpModifier.bone_to)
    - [`UVWarpModifier.center`](#bpy.types.UVWarpModifier.center)
    - [`UVWarpModifier.invert_vertex_group`](#bpy.types.UVWarpModifier.invert_vertex_group)
    - [`UVWarpModifier.object_from`](#bpy.types.UVWarpModifier.object_from)
    - [`UVWarpModifier.object_to`](#bpy.types.UVWarpModifier.object_to)
    - [`UVWarpModifier.offset`](#bpy.types.UVWarpModifier.offset)
    - [`UVWarpModifier.rotation`](#bpy.types.UVWarpModifier.rotation)
    - [`UVWarpModifier.scale`](#bpy.types.UVWarpModifier.scale)
    - [`UVWarpModifier.uv_layer`](#bpy.types.UVWarpModifier.uv_layer)
    - [`UVWarpModifier.vertex_group`](#bpy.types.UVWarpModifier.vertex_group)
    - [`UVWarpModifier.bl_rna_get_subclass()`](#bpy.types.UVWarpModifier.bl_rna_get_subclass)
    - [`UVWarpModifier.bl_rna_get_subclass_py()`](#bpy.types.UVWarpModifier.bl_rna_get_subclass_py)
