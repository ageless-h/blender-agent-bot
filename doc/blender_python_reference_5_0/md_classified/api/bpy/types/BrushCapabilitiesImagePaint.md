...
# BrushCapabilitiesImagePaint(bpy\_struct)[¶](#brushcapabilitiesimagepaint-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.BrushCapabilitiesImagePaint(*bpy\_struct*)[¶](#bpy.types.BrushCapabilitiesImagePaint "Link to this definition")
:   Read-only indications of supported operations

    has\_accumulate[¶](#bpy.types.BrushCapabilitiesImagePaint.has_accumulate "Link to this definition")
    :   Type:
        :   boolean, default False, (readonly)

    has\_color[¶](#bpy.types.BrushCapabilitiesImagePaint.has_color "Link to this definition")
    :   Type:
        :   boolean, default False, (readonly)

    has\_radius[¶](#bpy.types.BrushCapabilitiesImagePaint.has_radius "Link to this definition")
    :   Type:
        :   boolean, default False, (readonly)

    has\_space\_attenuation[¶](#bpy.types.BrushCapabilitiesImagePaint.has_space_attenuation "Link to this definition")
    :   Type:
        :   boolean, default False, (readonly)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.BrushCapabilitiesImagePaint.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.BrushCapabilitiesImagePaint.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Brush.image_paint_capabilities`](Brush.md#bpy.types.Brush.image_paint_capabilities "bpy.types.Brush.image_paint_capabilities") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.BrushCapabilitiesImagePaint.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.BrushCapabilitiesImagePaint.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* BrushCapabilitiesImagePaint(bpy\_struct)
  + [`BrushCapabilitiesImagePaint`](#bpy.types.BrushCapabilitiesImagePaint)
    - [`BrushCapabilitiesImagePaint.has_accumulate`](#bpy.types.BrushCapabilitiesImagePaint.has_accumulate)
    - [`BrushCapabilitiesImagePaint.has_color`](#bpy.types.BrushCapabilitiesImagePaint.has_color)
    - [`BrushCapabilitiesImagePaint.has_radius`](#bpy.types.BrushCapabilitiesImagePaint.has_radius)
    - [`BrushCapabilitiesImagePaint.has_space_attenuation`](#bpy.types.BrushCapabilitiesImagePaint.has_space_attenuation)
    - [`BrushCapabilitiesImagePaint.bl_rna_get_subclass()`](#bpy.types.BrushCapabilitiesImagePaint.bl_rna_get_subclass)
    - [`BrushCapabilitiesImagePaint.bl_rna_get_subclass_py()`](#bpy.types.BrushCapabilitiesImagePaint.bl_rna_get_subclass_py)
