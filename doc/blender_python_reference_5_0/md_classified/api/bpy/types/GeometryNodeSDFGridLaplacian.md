...
# GeometryNodeSDFGridLaplacian(GeometryNode)[¶](#geometrynodesdfgridlaplacian-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeSDFGridLaplacian(*GeometryNode*)[¶](#bpy.types.GeometryNodeSDFGridLaplacian "Link to this definition")
:   Apply Laplacian flow smoothing to a signed distance field. Computationally efficient alternative to mean curvature flow, ideal when combined with SDF normalization
    ...
    *classmethod* is\_registered\_node\_type()[¶](#bpy.types.GeometryNodeSDFGridLaplacian.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[¶](#bpy.types.GeometryNodeSDFGridLaplacian.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[¶](#bpy.types.GeometryNodeSDFGridLaplacian.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.GeometryNodeSDFGridLaplacian.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.GeometryNodeSDFGridLaplacian.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeSDFGridLaplacian.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.GeometryNodeSDFGridLaplacian.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeSDFGridLaplacian(GeometryNode)
  + [`GeometryNodeSDFGridLaplacian`](#bpy.types.GeometryNodeSDFGridLaplacian)
    - [`GeometryNodeSDFGridLaplacian.is_registered_node_type()`](#bpy.types.GeometryNodeSDFGridLaplacian.is_registered_node_type)
    - [`GeometryNodeSDFGridLaplacian.input_template()`](#bpy.types.GeometryNodeSDFGridLaplacian.input_template)
    - [`GeometryNodeSDFGridLaplacian.output_template()`](#bpy.types.GeometryNodeSDFGridLaplacian.output_template)
    - [`GeometryNodeSDFGridLaplacian.bl_rna_get_subclass()`](#bpy.types.GeometryNodeSDFGridLaplacian.bl_rna_get_subclass)
    - [`GeometryNodeSDFGridLaplacian.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeSDFGridLaplacian.bl_rna_get_subclass_py)
