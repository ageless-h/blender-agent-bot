...
# XrActionMapBinding(bpy\_struct)[¶](#xractionmapbinding-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.XrActionMapBinding(*bpy\_struct*)[¶](#bpy.types.XrActionMapBinding "Link to this definition")
:   Binding in an XR action map item

    axis0\_region[¶](#bpy.types.XrActionMapBinding.axis0_region "Link to this definition")
    ...
    axis1\_region[¶](#bpy.types.XrActionMapBinding.axis1_region "Link to this definition")
    ...
    component\_paths[¶](#bpy.types.XrActionMapBinding.component_paths "Link to this definition")
    :   OpenXR component paths

        Type:
        :   [`XrComponentPaths`](XrComponentPaths.md#bpy.types.XrComponentPaths "bpy.types.XrComponentPaths") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`XrComponentPath`](XrComponentPath.md#bpy.types.XrComponentPath "bpy.types.XrComponentPath"), (readonly)

    name[¶](#bpy.types.XrActionMapBinding.name "Link to this definition")
    :   Name of the action map binding

        Type:
        :   string, default “”, (never None)

    pose\_location[¶](#bpy.types.XrActionMapBinding.pose_location "Link to this definition")
    :   Type:
        :   [`mathutils.Vector`](../../mathutils/index.md#mathutils.Vector "mathutils.Vector") of 3 items in [-inf, inf], default (0.0, 0.0, 0.0)

    pose\_rotation[¶](#bpy.types.XrActionMapBinding.pose_rotation "Link to this definition")
    :   Type:
        :   [`mathutils.Euler`](../../mathutils/index.md#mathutils.Euler "mathutils.Euler") rotation of 3 items in [-inf, inf], default (0.0, 0.0, 0.0)

    profile[¶](#bpy.types.XrActionMapBinding.profile "Link to this definition")
    :   OpenXR interaction profile path

        Type:
        :   string, default “”, (never None)

    threshold[¶](#bpy.types.XrActionMapBinding.threshold "Link to this definition")
    :   Input threshold for button/axis actions

        Type:
        :   float in [0, 1], default 0.0

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.XrActionMapBinding.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.XrActionMapBinding.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`XrActionMapBindings.find`](XrActionMapBindings.md#bpy.types.XrActionMapBindings.find "bpy.types.XrActionMapBindings.find") * [`XrActionMapBindings.new`](XrActionMapBindings.md#bpy.types.XrActionMapBindings.new "bpy.types.XrActionMapBindings.new") * [`XrActionMapBindings.new_from_binding`](XrActionMapBindings.md#bpy.types.XrActionMapBindings.new_from_binding "bpy.types.XrActionMapBindings.new_from_binding") * [`XrActionMapBindings.new_from_binding`](XrActionMapBindings.md#bpy.types.XrActionMapBindings.new_from_binding "bpy.types.XrActionMapBindings.new_from_binding") | * [`XrActionMapBindings.remove`](XrActionMapBindings.md#bpy.types.XrActionMapBindings.remove "bpy.types.XrActionMapBindings.remove") * [`XrActionMapItem.bindings`](XrActionMapItem.md#bpy.types.XrActionMapItem.bindings "bpy.types.XrActionMapItem.bindings") * [`XrSessionState.action_binding_create`](XrSessionState.md#bpy.types.XrSessionState.action_binding_create "bpy.types.XrSessionState.action_binding_create") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.XrActionMapBinding.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.XrActionMapBinding.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* XrActionMapBinding(bpy\_struct)
  + [`XrActionMapBinding`](#bpy.types.XrActionMapBinding)
    - [`XrActionMapBinding.axis0_region`](#bpy.types.XrActionMapBinding.axis0_region)
    - [`XrActionMapBinding.axis1_region`](#bpy.types.XrActionMapBinding.axis1_region)
    - [`XrActionMapBinding.component_paths`](#bpy.types.XrActionMapBinding.component_paths)
    - [`XrActionMapBinding.name`](#bpy.types.XrActionMapBinding.name)
    - [`XrActionMapBinding.pose_location`](#bpy.types.XrActionMapBinding.pose_location)
    - [`XrActionMapBinding.pose_rotation`](#bpy.types.XrActionMapBinding.pose_rotation)
    - [`XrActionMapBinding.profile`](#bpy.types.XrActionMapBinding.profile)
    - [`XrActionMapBinding.threshold`](#bpy.types.XrActionMapBinding.threshold)
    - [`XrActionMapBinding.bl_rna_get_subclass()`](#bpy.types.XrActionMapBinding.bl_rna_get_subclass)
    - [`XrActionMapBinding.bl_rna_get_subclass_py()`](#bpy.types.XrActionMapBinding.bl_rna_get_subclass_py)
