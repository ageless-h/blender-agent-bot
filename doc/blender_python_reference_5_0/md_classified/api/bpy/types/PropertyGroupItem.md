...
# PropertyGroupItem(bpy\_struct)[¶](#propertygroupitem-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.PropertyGroupItem(*bpy\_struct*)[¶](#bpy.types.PropertyGroupItem "Link to this definition")
:   Property that stores arbitrary, user defined properties

    bool[¶](#bpy.types.PropertyGroupItem.bool "Link to this definition")
    :   Type:
        :   boolean, default False

    bool\_array[¶](#bpy.types.PropertyGroupItem.bool_array "Link to this definition")
    :   Type:
        :   boolean array of 1 items, default (False,)

    collection[¶](#bpy.types.PropertyGroupItem.collection "Link to this definition")
    :   Type:
        :   [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`PropertyGroup`](PropertyGroup.md#bpy.types.PropertyGroup "bpy.types.PropertyGroup"), (readonly)

    double[¶](#bpy.types.PropertyGroupItem.double "Link to this definition")
    :   Type:
        :   float in [-inf, inf], default 0.0

    double\_array[¶](#bpy.types.PropertyGroupItem.double_array "Link to this definition")
    :   Type:
        :   float array of 1 items in [-inf, inf], default (0.0)

    enum[¶](#bpy.types.PropertyGroupItem.enum "Link to this definition")
    :   Type:
        :   enum in [`'DEFAULT'`], default `'DEFAULT'`

    float[¶](#bpy.types.PropertyGroupItem.float "Link to this definition")
    :   Type:
        :   float in [-inf, inf], default 0.0

    float\_array[¶](#bpy.types.PropertyGroupItem.float_array "Link to this definition")
    :   Type:
        :   float array of 1 items in [-inf, inf], default (0.0)

    group[¶](#bpy.types.PropertyGroupItem.group "Link to this definition")
    :   Type:
        :   [`PropertyGroup`](PropertyGroup.md#bpy.types.PropertyGroup "bpy.types.PropertyGroup"), (readonly)

    id[¶](#bpy.types.PropertyGroupItem.id "Link to this definition")
    :   Type:
        :   [`ID`](ID.md#bpy.types.ID "bpy.types.ID")

    idp\_array[¶](#bpy.types.PropertyGroupItem.idp_array "Link to this definition")
    :   Type:
        :   [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`PropertyGroup`](PropertyGroup.md#bpy.types.PropertyGroup "bpy.types.PropertyGroup"), (readonly)

    int[¶](#bpy.types.PropertyGroupItem.int "Link to this definition")
    :   Type:
        :   int in [-inf, inf], default 0

    int\_array[¶](#bpy.types.PropertyGroupItem.int_array "Link to this definition")
    :   Type:
        :   int array of 1 items in [-inf, inf], default (0,)

    string[¶](#bpy.types.PropertyGroupItem.string "Link to this definition")
    :   Type:
        :   [string](#bpy.types.PropertyGroupItem.string "bpy.types.PropertyGroupItem.string"), default “”, (never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.PropertyGroupItem.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.PropertyGroupItem.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.PropertyGroupItem.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.PropertyGroupItem.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* PropertyGroupItem(bpy\_struct)
  + [`PropertyGroupItem`](#bpy.types.PropertyGroupItem)
    - [`PropertyGroupItem.bool`](#bpy.types.PropertyGroupItem.bool)
    - [`PropertyGroupItem.bool_array`](#bpy.types.PropertyGroupItem.bool_array)
    - [`PropertyGroupItem.collection`](#bpy.types.PropertyGroupItem.collection)
    - [`PropertyGroupItem.double`](#bpy.types.PropertyGroupItem.double)
    - [`PropertyGroupItem.double_array`](#bpy.types.PropertyGroupItem.double_array)
    - [`PropertyGroupItem.enum`](#bpy.types.PropertyGroupItem.enum)
    - [`PropertyGroupItem.float`](#bpy.types.PropertyGroupItem.float)
    - [`PropertyGroupItem.float_array`](#bpy.types.PropertyGroupItem.float_array)
    - [`PropertyGroupItem.group`](#bpy.types.PropertyGroupItem.group)
    - [`PropertyGroupItem.id`](#bpy.types.PropertyGroupItem.id)
    - [`PropertyGroupItem.idp_array`](#bpy.types.PropertyGroupItem.idp_array)
    - [`PropertyGroupItem.int`](#bpy.types.PropertyGroupItem.int)
    - [`PropertyGroupItem.int_array`](#bpy.types.PropertyGroupItem.int_array)
    - [`PropertyGroupItem.string`](#bpy.types.PropertyGroupItem.string)
    - [`PropertyGroupItem.bl_rna_get_subclass()`](#bpy.types.PropertyGroupItem.bl_rna_get_subclass)
    - [`PropertyGroupItem.bl_rna_get_subclass_py()`](#bpy.types.PropertyGroupItem.bl_rna_get_subclass_py)
