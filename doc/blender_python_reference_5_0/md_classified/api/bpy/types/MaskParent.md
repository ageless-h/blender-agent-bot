...
# MaskParent(bpy\_struct)[¶](#maskparent-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.MaskParent(*bpy\_struct*)[¶](#bpy.types.MaskParent "Link to this definition")
:   Parenting settings for masking element

    id[¶](#bpy.types.MaskParent.id "Link to this definition")
    :   ID-block to which masking element would be parented to or to its property

        Type:
        :   [`ID`](ID.md#bpy.types.ID "bpy.types.ID")

    id\_type[¶](#bpy.types.MaskParent.id_type "Link to this definition")
    :   Type of ID-block that can be used

        Type:
        :   enum in [`'MOVIECLIP'`], default `'MOVIECLIP'`

    parent[¶](#bpy.types.MaskParent.parent "Link to this definition")
    :   Name of parent object in specified data-block to which parenting happens

        Type:
        :   string, default “”, (never None)

    sub\_parent[¶](#bpy.types.MaskParent.sub_parent "Link to this definition")
    :   Name of parent sub-object in specified data-block to which parenting happens

        Type:
        :   string, default “”, (never None)

    type[¶](#bpy.types.MaskParent.type "Link to this definition")
    :   Parent Type

        Type:
        :   enum in [`'POINT_TRACK'`, `'PLANE_TRACK'`], default `'POINT_TRACK'`

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.MaskParent.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.MaskParent.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`MaskSplinePoint.parent`](MaskSplinePoint.md#bpy.types.MaskSplinePoint.parent "bpy.types.MaskSplinePoint.parent") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.MaskParent.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.MaskParent.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* MaskParent(bpy\_struct)
  + [`MaskParent`](#bpy.types.MaskParent)
    - [`MaskParent.id`](#bpy.types.MaskParent.id)
    - [`MaskParent.id_type`](#bpy.types.MaskParent.id_type)
    - [`MaskParent.parent`](#bpy.types.MaskParent.parent)
    - [`MaskParent.sub_parent`](#bpy.types.MaskParent.sub_parent)
    - [`MaskParent.type`](#bpy.types.MaskParent.type)
    - [`MaskParent.bl_rna_get_subclass()`](#bpy.types.MaskParent.bl_rna_get_subclass)
    - [`MaskParent.bl_rna_get_subclass_py()`](#bpy.types.MaskParent.bl_rna_get_subclass_py)
