...
# Addons(bpy\_struct)[¶](#addons-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.Addons(*bpy\_struct*)[¶](#bpy.types.Addons "Link to this definition")
:   Collection of add-ons

    *classmethod* new()[¶](#bpy.types.Addons.new "Link to this definition")
    :   Add a new add-on
        ...
        Return type:
        :   [`Addon`](Addon.md#bpy.types.Addon "bpy.types.Addon")

    *classmethod* remove(*addon*)[¶](#bpy.types.Addons.remove "Link to this definition")
    :   Remove add-on

        Parameters:
        :   **addon** ([`Addon`](Addon.md#bpy.types.Addon "bpy.types.Addon"), (never None)) – Add-on to remove

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.Addons.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.Addons.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Preferences.addons`](Preferences.md#bpy.types.Preferences.addons "bpy.types.Preferences.addons") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.Addons.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.Addons.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* Addons(bpy\_struct)
  + [`Addons`](#bpy.types.Addons)
    - [`Addons.new()`](#bpy.types.Addons.new)
    - [`Addons.remove()`](#bpy.types.Addons.remove)
    - [`Addons.bl_rna_get_subclass()`](#bpy.types.Addons.bl_rna_get_subclass)
    - [`Addons.bl_rna_get_subclass_py()`](#bpy.types.Addons.bl_rna_get_subclass_py)
