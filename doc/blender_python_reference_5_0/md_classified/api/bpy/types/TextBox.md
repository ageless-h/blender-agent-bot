...
# TextBox(bpy\_struct)[¶](#textbox-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.TextBox(*bpy\_struct*)[¶](#bpy.types.TextBox "Link to this definition")
:   Text bounding box for layout

    height[¶](#bpy.types.TextBox.height "Link to this definition")
    :   Type:
        :   float in [0, inf], default 0.0

    width[¶](#bpy.types.TextBox.width "Link to this definition")
    :   Type:
        :   float in [0, inf], default 0.0

    x[¶](#bpy.types.TextBox.x "Link to this definition")
    :   Type:
        :   float in [-inf, inf], default 0.0

    y[¶](#bpy.types.TextBox.y "Link to this definition")
    :   Type:
        :   float in [-inf, inf], default 0.0

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.TextBox.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.TextBox.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`TextCurve.text_boxes`](TextCurve.md#bpy.types.TextCurve.text_boxes "bpy.types.TextCurve.text_boxes") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.TextBox.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.TextBox.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* TextBox(bpy\_struct)
  + [`TextBox`](#bpy.types.TextBox)
    - [`TextBox.height`](#bpy.types.TextBox.height)
    - [`TextBox.width`](#bpy.types.TextBox.width)
    - [`TextBox.x`](#bpy.types.TextBox.x)
    - [`TextBox.y`](#bpy.types.TextBox.y)
    - [`TextBox.bl_rna_get_subclass()`](#bpy.types.TextBox.bl_rna_get_subclass)
    - [`TextBox.bl_rna_get_subclass_py()`](#bpy.types.TextBox.bl_rna_get_subclass_py)
