...
# MovieTrackingMarkers(bpy\_struct)[¶](#movietrackingmarkers-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.MovieTrackingMarkers(*bpy\_struct*)[¶](#bpy.types.MovieTrackingMarkers "Link to this definition")
:   Collection of markers for movie tracking track

    find\_frame(*frame*, *\**, *exact=True*)[¶](#bpy.types.MovieTrackingMarkers.find_frame "Link to this definition")
    :   Get marker for specified frame
        ...
        Return type:
        :   [`MovieTrackingMarker`](MovieTrackingMarker.md#bpy.types.MovieTrackingMarker "bpy.types.MovieTrackingMarker")

    insert\_frame(*frame*, *\**, *co=(0.0, 0.0)*)[¶](#bpy.types.MovieTrackingMarkers.insert_frame "Link to this definition")
    :   Insert a new marker at the specified frame

        Parameters:
        :   * **frame** (*int in* *[**0**,* *1048574**]*) – Frame, Frame number to insert marker to
            * **co** ([`mathutils.Vector`](../../mathutils/index.md#mathutils.Vector "mathutils.Vector") of 2 items in [-1, 1], (optional)) – Coordinate, Place new marker at the given frame using specified in normalized space coordinates
    ...
    delete\_frame(*frame*)[¶](#bpy.types.MovieTrackingMarkers.delete_frame "Link to this definition")
    :   Delete marker at specified frame

        Parameters:
        :   **frame** (*int in* *[**0**,* *1048574**]*) – Frame, Frame number to delete marker from

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.MovieTrackingMarkers.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.MovieTrackingMarkers.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`MovieTrackingTrack.markers`](MovieTrackingTrack.md#bpy.types.MovieTrackingTrack.markers "bpy.types.MovieTrackingTrack.markers") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.MovieTrackingMarkers.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.MovieTrackingMarkers.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* MovieTrackingMarkers(bpy\_struct)
  + [`MovieTrackingMarkers`](#bpy.types.MovieTrackingMarkers)
    - [`MovieTrackingMarkers.find_frame()`](#bpy.types.MovieTrackingMarkers.find_frame)
    - [`MovieTrackingMarkers.insert_frame()`](#bpy.types.MovieTrackingMarkers.insert_frame)
    - [`MovieTrackingMarkers.delete_frame()`](#bpy.types.MovieTrackingMarkers.delete_frame)
    - [`MovieTrackingMarkers.bl_rna_get_subclass()`](#bpy.types.MovieTrackingMarkers.bl_rna_get_subclass)
    - [`MovieTrackingMarkers.bl_rna_get_subclass_py()`](#bpy.types.MovieTrackingMarkers.bl_rna_get_subclass_py)
