...
# BrushCapabilitiesVertexPaint(bpy\_struct)[¶](#brushcapabilitiesvertexpaint-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.BrushCapabilitiesVertexPaint(*bpy\_struct*)[¶](#bpy.types.BrushCapabilitiesVertexPaint "Link to this definition")
:   Read-only indications of supported operations

    has\_color[¶](#bpy.types.BrushCapabilitiesVertexPaint.has_color "Link to this definition")
    :   Type:
        :   boolean, default False, (readonly)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.BrushCapabilitiesVertexPaint.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.BrushCapabilitiesVertexPaint.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Brush.vertex_paint_capabilities`](Brush.md#bpy.types.Brush.vertex_paint_capabilities "bpy.types.Brush.vertex_paint_capabilities") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.BrushCapabilitiesVertexPaint.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.BrushCapabilitiesVertexPaint.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* BrushCapabilitiesVertexPaint(bpy\_struct)
  + [`BrushCapabilitiesVertexPaint`](#bpy.types.BrushCapabilitiesVertexPaint)
    - [`BrushCapabilitiesVertexPaint.has_color`](#bpy.types.BrushCapabilitiesVertexPaint.has_color)
    - [`BrushCapabilitiesVertexPaint.bl_rna_get_subclass()`](#bpy.types.BrushCapabilitiesVertexPaint.bl_rna_get_subclass)
    - [`BrushCapabilitiesVertexPaint.bl_rna_get_subclass_py()`](#bpy.types.BrushCapabilitiesVertexPaint.bl_rna_get_subclass_py)
