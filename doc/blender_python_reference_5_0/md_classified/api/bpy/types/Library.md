...
# Library(ID)[¶](#library-id "Link to this heading")

base classes — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct"), [`ID`](ID.md#bpy.types.ID "bpy.types.ID")

*class* bpy.types.Library(*ID*)[¶](#bpy.types.Library "Link to this definition")
:   External .blend file from which data is linked

    archive\_libraries[¶](#bpy.types.Library.archive_libraries "Link to this definition")
    :   Archive libraries of packed IDs, generated (and owned) by this source library

        Type:
        :   [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`Library`](#bpy.types.Library "bpy.types.Library"), (readonly)

    archive\_parent\_library[¶](#bpy.types.Library.archive_parent_library "Link to this definition")
    :   Source library from which this archive of packed IDs was generated

        Type:
        :   [`Library`](#bpy.types.Library "bpy.types.Library"), (readonly)

    filepath[¶](#bpy.types.Library.filepath "Link to this definition")
    :   Path to the library .blend file

        Type:
        :   string, default “”, (never None, blend relative `//` prefix supported)

    is\_archive[¶](#bpy.types.Library.is_archive "Link to this definition")
    :   This library is an ‘archive’ storage for packed linked IDs originally linked from its ‘archive parent’ library.

        Type:
        :   boolean, default False, (readonly)

    is\_editable[¶](#bpy.types.Library.is_editable "Link to this definition")
    :   Data-blocks in this library are editable despite being linked. Used by brush assets and their dependencies.

        Type:
        :   boolean, default False, (readonly)

    needs\_liboverride\_resync[¶](#bpy.types.Library.needs_liboverride_resync "Link to this definition")
    ...
    packed\_file[¶](#bpy.types.Library.packed_file "Link to this definition")
    :   Type:
        :   [`PackedFile`](PackedFile.md#bpy.types.PackedFile "bpy.types.PackedFile"), (readonly)

    parent[¶](#bpy.types.Library.parent "Link to this definition")
    :   Type:
        :   [`Library`](#bpy.types.Library "bpy.types.Library"), (readonly)

    version[¶](#bpy.types.Library.version "Link to this definition")
    :   Version of Blender the library .blend was saved with

        Type:
        :   int array of 3 items in [0, inf], default (0, 0, 0), (readonly)

    users\_id[¶](#bpy.types.Library.users_id "Link to this definition")
    :   ID data-blocks that use this library

        Type:
        :   tuple of [`bpy.types.ID`](ID.md#bpy.types.ID "bpy.types.ID")
    ...
    reload()[¶](#bpy.types.Library.reload "Link to this definition")
    :   Reload this library and all its linked data-blocks

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.Library.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.Library.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`BlendData.libraries`](BlendData.md#bpy.types.BlendData.libraries "bpy.types.BlendData.libraries") * [`BlendDataLibraries.remove`](BlendDataLibraries.md#bpy.types.BlendDataLibraries.remove "bpy.types.BlendDataLibraries.remove") * [`BlendImportContextItem.source_library`](BlendImportContextItem.md#bpy.types.BlendImportContextItem.source_library "bpy.types.BlendImportContextItem.source_library") * [`ID.library`](ID.md#bpy.types.ID.library "bpy.types.ID.library") | * [`Library.archive_libraries`](#bpy.types.Library.archive_libraries "bpy.types.Library.archive_libraries") * [`Library.archive_parent_library`](#bpy.types.Library.archive_parent_library "bpy.types.Library.archive_parent_library") * [`Library.parent`](#bpy.types.Library.parent "bpy.types.Library.parent") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.Library.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.Library.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* Library(ID)
  + [`Library`](#bpy.types.Library)
    - [`Library.archive_libraries`](#bpy.types.Library.archive_libraries)
    - [`Library.archive_parent_library`](#bpy.types.Library.archive_parent_library)
    - [`Library.filepath`](#bpy.types.Library.filepath)
    - [`Library.is_archive`](#bpy.types.Library.is_archive)
    - [`Library.is_editable`](#bpy.types.Library.is_editable)
    - [`Library.needs_liboverride_resync`](#bpy.types.Library.needs_liboverride_resync)
    - [`Library.packed_file`](#bpy.types.Library.packed_file)
    - [`Library.parent`](#bpy.types.Library.parent)
    - [`Library.version`](#bpy.types.Library.version)
    - [`Library.users_id`](#bpy.types.Library.users_id)
    - [`Library.reload()`](#bpy.types.Library.reload)
    - [`Library.bl_rna_get_subclass()`](#bpy.types.Library.bl_rna_get_subclass)
    - [`Library.bl_rna_get_subclass_py()`](#bpy.types.Library.bl_rna_get_subclass_py)
