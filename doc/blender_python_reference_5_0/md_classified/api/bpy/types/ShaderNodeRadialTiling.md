...
# ShaderNodeRadialTiling(ShaderNode)[¶](#shadernoderadialtiling-shadernode "Link to this heading")
...
*class* bpy.types.ShaderNodeRadialTiling(*ShaderNode*)[¶](#bpy.types.ShaderNodeRadialTiling "Link to this definition")
:   Transform Coordinate System for Radial Tiling

    normalize[¶](#bpy.types.ShaderNodeRadialTiling.normalize "Link to this definition")
    ...
    *classmethod* is\_registered\_node\_type()[¶](#bpy.types.ShaderNodeRadialTiling.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[¶](#bpy.types.ShaderNodeRadialTiling.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[¶](#bpy.types.ShaderNodeRadialTiling.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ShaderNodeRadialTiling.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ShaderNodeRadialTiling.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ShaderNodeRadialTiling.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ShaderNodeRadialTiling.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ShaderNodeRadialTiling(ShaderNode)
  + [`ShaderNodeRadialTiling`](#bpy.types.ShaderNodeRadialTiling)
    - [`ShaderNodeRadialTiling.normalize`](#bpy.types.ShaderNodeRadialTiling.normalize)
    - [`ShaderNodeRadialTiling.is_registered_node_type()`](#bpy.types.ShaderNodeRadialTiling.is_registered_node_type)
    - [`ShaderNodeRadialTiling.input_template()`](#bpy.types.ShaderNodeRadialTiling.input_template)
    - [`ShaderNodeRadialTiling.output_template()`](#bpy.types.ShaderNodeRadialTiling.output_template)
    - [`ShaderNodeRadialTiling.bl_rna_get_subclass()`](#bpy.types.ShaderNodeRadialTiling.bl_rna_get_subclass)
    - [`ShaderNodeRadialTiling.bl_rna_get_subclass_py()`](#bpy.types.ShaderNodeRadialTiling.bl_rna_get_subclass_py)
