...
# ObjectSolverConstraint(Constraint)[¶](#objectsolverconstraint-constraint "Link to this heading")
...
*class* bpy.types.ObjectSolverConstraint(*Constraint*)[¶](#bpy.types.ObjectSolverConstraint "Link to this definition")
:   Lock motion to the reconstructed object movement

    camera[¶](#bpy.types.ObjectSolverConstraint.camera "Link to this definition")
    :   Camera to which motion is parented (if empty active scene camera is used)

        Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object")

    clip[¶](#bpy.types.ObjectSolverConstraint.clip "Link to this definition")
    :   Movie Clip to get tracking data from

        Type:
        :   [`MovieClip`](MovieClip.md#bpy.types.MovieClip "bpy.types.MovieClip")

    object[¶](#bpy.types.ObjectSolverConstraint.object "Link to this definition")
    :   Movie tracking object to follow

        Type:
        :   string, default “”, (never None)

    set\_inverse\_pending[¶](#bpy.types.ObjectSolverConstraint.set_inverse_pending "Link to this definition")
    :   Set to true to request recalculation of the inverse matrix

        Type:
        :   boolean, default False

    use\_active\_clip[¶](#bpy.types.ObjectSolverConstraint.use_active_clip "Link to this definition")
    :   Use active clip defined in scene

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ObjectSolverConstraint.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ObjectSolverConstraint.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ObjectSolverConstraint.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ObjectSolverConstraint.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ObjectSolverConstraint(Constraint)
  + [`ObjectSolverConstraint`](#bpy.types.ObjectSolverConstraint)
    - [`ObjectSolverConstraint.camera`](#bpy.types.ObjectSolverConstraint.camera)
    - [`ObjectSolverConstraint.clip`](#bpy.types.ObjectSolverConstraint.clip)
    - [`ObjectSolverConstraint.object`](#bpy.types.ObjectSolverConstraint.object)
    - [`ObjectSolverConstraint.set_inverse_pending`](#bpy.types.ObjectSolverConstraint.set_inverse_pending)
    - [`ObjectSolverConstraint.use_active_clip`](#bpy.types.ObjectSolverConstraint.use_active_clip)
    - [`ObjectSolverConstraint.bl_rna_get_subclass()`](#bpy.types.ObjectSolverConstraint.bl_rna_get_subclass)
    - [`ObjectSolverConstraint.bl_rna_get_subclass_py()`](#bpy.types.ObjectSolverConstraint.bl_rna_get_subclass_py)
