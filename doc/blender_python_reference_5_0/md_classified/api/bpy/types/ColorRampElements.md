...
# ColorRampElements(bpy\_struct)[¶](#colorrampelements-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.ColorRampElements(*bpy\_struct*)[¶](#bpy.types.ColorRampElements "Link to this definition")
:   Collection of Color Ramp Elements

    new(*position*)[¶](#bpy.types.ColorRampElements.new "Link to this definition")
    :   Add element to Color Ramp
        ...
        Return type:
        :   [`ColorRampElement`](ColorRampElement.md#bpy.types.ColorRampElement "bpy.types.ColorRampElement")

    remove(*element*)[¶](#bpy.types.ColorRampElements.remove "Link to this definition")
    :   Delete element from Color Ramp

        Parameters:
        :   **element** ([`ColorRampElement`](ColorRampElement.md#bpy.types.ColorRampElement "bpy.types.ColorRampElement"), (never None)) – Element to remove

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ColorRampElements.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ColorRampElements.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`ColorRamp.elements`](ColorRamp.md#bpy.types.ColorRamp.elements "bpy.types.ColorRamp.elements") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ColorRampElements.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ColorRampElements.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ColorRampElements(bpy\_struct)
  + [`ColorRampElements`](#bpy.types.ColorRampElements)
    - [`ColorRampElements.new()`](#bpy.types.ColorRampElements.new)
    - [`ColorRampElements.remove()`](#bpy.types.ColorRampElements.remove)
    - [`ColorRampElements.bl_rna_get_subclass()`](#bpy.types.ColorRampElements.bl_rna_get_subclass)
    - [`ColorRampElements.bl_rna_get_subclass_py()`](#bpy.types.ColorRampElements.bl_rna_get_subclass_py)
