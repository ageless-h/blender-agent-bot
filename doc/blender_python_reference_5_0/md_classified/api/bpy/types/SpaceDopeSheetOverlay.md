...
# SpaceDopeSheetOverlay(bpy\_struct)[¶](#spacedopesheetoverlay-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.SpaceDopeSheetOverlay(*bpy\_struct*)[¶](#bpy.types.SpaceDopeSheetOverlay "Link to this definition")
:   show\_overlays[¶](#bpy.types.SpaceDopeSheetOverlay.show_overlays "Link to this definition")
    :   Display overlays

        Type:
        :   boolean, default True

    show\_scene\_strip\_range[¶](#bpy.types.SpaceDopeSheetOverlay.show_scene_strip_range "Link to this definition")
    :   When using scene time synchronization in the sequence editor, display the range of the current scene strip

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.SpaceDopeSheetOverlay.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.SpaceDopeSheetOverlay.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`SpaceDopeSheetEditor.overlays`](SpaceDopeSheetEditor.md#bpy.types.SpaceDopeSheetEditor.overlays "bpy.types.SpaceDopeSheetEditor.overlays") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.SpaceDopeSheetOverlay.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.SpaceDopeSheetOverlay.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* SpaceDopeSheetOverlay(bpy\_struct)
  + [`SpaceDopeSheetOverlay`](#bpy.types.SpaceDopeSheetOverlay)
    - [`SpaceDopeSheetOverlay.show_overlays`](#bpy.types.SpaceDopeSheetOverlay.show_overlays)
    - [`SpaceDopeSheetOverlay.show_scene_strip_range`](#bpy.types.SpaceDopeSheetOverlay.show_scene_strip_range)
    - [`SpaceDopeSheetOverlay.bl_rna_get_subclass()`](#bpy.types.SpaceDopeSheetOverlay.bl_rna_get_subclass)
    - [`SpaceDopeSheetOverlay.bl_rna_get_subclass_py()`](#bpy.types.SpaceDopeSheetOverlay.bl_rna_get_subclass_py)
