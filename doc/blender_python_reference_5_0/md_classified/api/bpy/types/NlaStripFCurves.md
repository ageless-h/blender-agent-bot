...
# NlaStripFCurves(bpy\_struct)[¶](#nlastripfcurves-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.NlaStripFCurves(*bpy\_struct*)[¶](#bpy.types.NlaStripFCurves "Link to this definition")
:   Collection of NLA strip F-Curves

    find(*data\_path*, *\**, *index=0*)[¶](#bpy.types.NlaStripFCurves.find "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.NlaStripFCurves.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.NlaStripFCurves.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`NlaStrip.fcurves`](NlaStrip.md#bpy.types.NlaStrip.fcurves "bpy.types.NlaStrip.fcurves") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.NlaStripFCurves.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.NlaStripFCurves.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* NlaStripFCurves(bpy\_struct)
  + [`NlaStripFCurves`](#bpy.types.NlaStripFCurves)
    - [`NlaStripFCurves.find()`](#bpy.types.NlaStripFCurves.find)
    - [`NlaStripFCurves.bl_rna_get_subclass()`](#bpy.types.NlaStripFCurves.bl_rna_get_subclass)
    - [`NlaStripFCurves.bl_rna_get_subclass_py()`](#bpy.types.NlaStripFCurves.bl_rna_get_subclass_py)
