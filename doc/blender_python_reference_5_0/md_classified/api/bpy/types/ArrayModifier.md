...
# ArrayModifier(Modifier)[¶](#arraymodifier-modifier "Link to this heading")
...
*class* bpy.types.ArrayModifier(*Modifier*)[¶](#bpy.types.ArrayModifier "Link to this definition")
:   Array duplication modifier

    constant\_offset\_displace[¶](#bpy.types.ArrayModifier.constant_offset_displace "Link to this definition")
    ...
    count[¶](#bpy.types.ArrayModifier.count "Link to this definition")
    :   Number of duplicates to make

        Type:
        :   int in [1, inf], default 2

    curve[¶](#bpy.types.ArrayModifier.curve "Link to this definition")
    :   Curve object to fit array length to

        Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object")

    end\_cap[¶](#bpy.types.ArrayModifier.end_cap "Link to this definition")
    :   Mesh object to use as an end cap

        Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object")

    fit\_length[¶](#bpy.types.ArrayModifier.fit_length "Link to this definition")
    :   Length to fit array within

        Type:
        :   float in [0, inf], default 0.0

    fit\_type[¶](#bpy.types.ArrayModifier.fit_type "Link to this definition")
    ...
    merge\_threshold[¶](#bpy.types.ArrayModifier.merge_threshold "Link to this definition")
    :   Limit below which to merge vertices

        Type:
        :   float in [0, inf], default 0.01

    offset\_object[¶](#bpy.types.ArrayModifier.offset_object "Link to this definition")
    :   Use the location and rotation of another object to determine the distance and rotational change between arrayed items

        Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object")

    offset\_u[¶](#bpy.types.ArrayModifier.offset_u "Link to this definition")
    :   Amount to offset array UVs on the U axis

        Type:
        :   float in [-1, 1], default 0.0

    offset\_v[¶](#bpy.types.ArrayModifier.offset_v "Link to this definition")
    :   Amount to offset array UVs on the V axis

        Type:
        :   float in [-1, 1], default 0.0

    relative\_offset\_displace[¶](#bpy.types.ArrayModifier.relative_offset_displace "Link to this definition")
    :   The size of the geometry will determine the distance between arrayed items

        Type:
        :   [`mathutils.Vector`](../../mathutils/index.md#mathutils.Vector "mathutils.Vector") of 3 items in [-inf, inf], default (1.0, 0.0, 0.0)

    start\_cap[¶](#bpy.types.ArrayModifier.start_cap "Link to this definition")
    :   Mesh object to use as a start cap

        Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object")

    use\_constant\_offset[¶](#bpy.types.ArrayModifier.use_constant_offset "Link to this definition")
    :   Add a constant offset

        Type:
        :   boolean, default False

    use\_merge\_vertices[¶](#bpy.types.ArrayModifier.use_merge_vertices "Link to this definition")
    :   Merge vertices in adjacent duplicates

        Type:
        :   boolean, default False

    use\_merge\_vertices\_cap[¶](#bpy.types.ArrayModifier.use_merge_vertices_cap "Link to this definition")
    :   Merge vertices in first and last duplicates

        Type:
        :   boolean, default False

    use\_object\_offset[¶](#bpy.types.ArrayModifier.use_object_offset "Link to this definition")
    :   Add another object’s transformation to the total offset

        Type:
        :   boolean, default False

    use\_relative\_offset[¶](#bpy.types.ArrayModifier.use_relative_offset "Link to this definition")
    :   Add an offset relative to the object’s bounding box

        Type:
        :   boolean, default True

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ArrayModifier.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ArrayModifier.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ArrayModifier.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ArrayModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ArrayModifier(Modifier)
  + [`ArrayModifier`](#bpy.types.ArrayModifier)
    - [`ArrayModifier.constant_offset_displace`](#bpy.types.ArrayModifier.constant_offset_displace)
    - [`ArrayModifier.count`](#bpy.types.ArrayModifier.count)
    - [`ArrayModifier.curve`](#bpy.types.ArrayModifier.curve)
    - [`ArrayModifier.end_cap`](#bpy.types.ArrayModifier.end_cap)
    - [`ArrayModifier.fit_length`](#bpy.types.ArrayModifier.fit_length)
    - [`ArrayModifier.fit_type`](#bpy.types.ArrayModifier.fit_type)
    - [`ArrayModifier.merge_threshold`](#bpy.types.ArrayModifier.merge_threshold)
    - [`ArrayModifier.offset_object`](#bpy.types.ArrayModifier.offset_object)
    - [`ArrayModifier.offset_u`](#bpy.types.ArrayModifier.offset_u)
    - [`ArrayModifier.offset_v`](#bpy.types.ArrayModifier.offset_v)
    - [`ArrayModifier.relative_offset_displace`](#bpy.types.ArrayModifier.relative_offset_displace)
    - [`ArrayModifier.start_cap`](#bpy.types.ArrayModifier.start_cap)
    - [`ArrayModifier.use_constant_offset`](#bpy.types.ArrayModifier.use_constant_offset)
    - [`ArrayModifier.use_merge_vertices`](#bpy.types.ArrayModifier.use_merge_vertices)
    - [`ArrayModifier.use_merge_vertices_cap`](#bpy.types.ArrayModifier.use_merge_vertices_cap)
    - [`ArrayModifier.use_object_offset`](#bpy.types.ArrayModifier.use_object_offset)
    - [`ArrayModifier.use_relative_offset`](#bpy.types.ArrayModifier.use_relative_offset)
    - [`ArrayModifier.bl_rna_get_subclass()`](#bpy.types.ArrayModifier.bl_rna_get_subclass)
    - [`ArrayModifier.bl_rna_get_subclass_py()`](#bpy.types.ArrayModifier.bl_rna_get_subclass_py)
