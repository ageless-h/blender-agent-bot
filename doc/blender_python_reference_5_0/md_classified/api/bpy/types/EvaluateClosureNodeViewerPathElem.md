...
# EvaluateClosureNodeViewerPathElem(ViewerPathElem)[¶](#evaluateclosurenodeviewerpathelem-viewerpathelem "Link to this heading")

base classes — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct"), [`ViewerPathElem`](ViewerPathElem.md#bpy.types.ViewerPathElem "bpy.types.ViewerPathElem")

*class* bpy.types.EvaluateClosureNodeViewerPathElem(*ViewerPathElem*)[¶](#bpy.types.EvaluateClosureNodeViewerPathElem "Link to this definition")
:   evaluate\_node\_id[¶](#bpy.types.EvaluateClosureNodeViewerPathElem.evaluate_node_id "Link to this definition")
    :   Type:
        :   int in [-inf, inf], default 0

    source\_node\_tree[¶](#bpy.types.EvaluateClosureNodeViewerPathElem.source_node_tree "Link to this definition")
    :   Type:
        :   [`NodeTree`](NodeTree.md#bpy.types.NodeTree "bpy.types.NodeTree"), (readonly)

    source\_output\_node\_id[¶](#bpy.types.EvaluateClosureNodeViewerPathElem.source_output_node_id "Link to this definition")
    :   Type:
        :   int in [-inf, inf], default 0

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.EvaluateClosureNodeViewerPathElem.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.EvaluateClosureNodeViewerPathElem.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.EvaluateClosureNodeViewerPathElem.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.EvaluateClosureNodeViewerPathElem.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* EvaluateClosureNodeViewerPathElem(ViewerPathElem)
  + [`EvaluateClosureNodeViewerPathElem`](#bpy.types.EvaluateClosureNodeViewerPathElem)
    - [`EvaluateClosureNodeViewerPathElem.evaluate_node_id`](#bpy.types.EvaluateClosureNodeViewerPathElem.evaluate_node_id)
    - [`EvaluateClosureNodeViewerPathElem.source_node_tree`](#bpy.types.EvaluateClosureNodeViewerPathElem.source_node_tree)
    - [`EvaluateClosureNodeViewerPathElem.source_output_node_id`](#bpy.types.EvaluateClosureNodeViewerPathElem.source_output_node_id)
    - [`EvaluateClosureNodeViewerPathElem.bl_rna_get_subclass()`](#bpy.types.EvaluateClosureNodeViewerPathElem.bl_rna_get_subclass)
    - [`EvaluateClosureNodeViewerPathElem.bl_rna_get_subclass_py()`](#bpy.types.EvaluateClosureNodeViewerPathElem.bl_rna_get_subclass_py)
