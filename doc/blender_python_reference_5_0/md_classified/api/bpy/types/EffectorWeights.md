...
# EffectorWeights(bpy\_struct)[¶](#effectorweights-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.EffectorWeights(*bpy\_struct*)[¶](#bpy.types.EffectorWeights "Link to this definition")
:   Effector weights for physics simulation

    all[¶](#bpy.types.EffectorWeights.all "Link to this definition")
    :   All effector’s weight

        Type:
        :   float in [-200, 200], default 0.0

    apply\_to\_hair\_growing[¶](#bpy.types.EffectorWeights.apply_to_hair_growing "Link to this definition")
    :   Use force fields when growing hair

        Type:
        :   boolean, default False

    boid[¶](#bpy.types.EffectorWeights.boid "Link to this definition")
    :   Boid effector weight

        Type:
        :   float in [-200, 200], default 0.0

    charge[¶](#bpy.types.EffectorWeights.charge "Link to this definition")
    :   Charge effector weight

        Type:
        :   float in [-200, 200], default 0.0

    collection[¶](#bpy.types.EffectorWeights.collection "Link to this definition")
    :   Limit effectors to this collection

        Type:
        :   [`Collection`](Collection.md#bpy.types.Collection "bpy.types.Collection")

    curve\_guide[¶](#bpy.types.EffectorWeights.curve_guide "Link to this definition")
    :   Curve guide effector weight

        Type:
        :   float in [-200, 200], default 0.0

    drag[¶](#bpy.types.EffectorWeights.drag "Link to this definition")
    :   Drag effector weight

        Type:
        :   float in [-200, 200], default 0.0

    force[¶](#bpy.types.EffectorWeights.force "Link to this definition")
    :   Force effector weight

        Type:
        :   float in [-200, 200], default 0.0

    gravity[¶](#bpy.types.EffectorWeights.gravity "Link to this definition")
    :   Global gravity weight

        Type:
        :   float in [-200, 200], default 0.0

    harmonic[¶](#bpy.types.EffectorWeights.harmonic "Link to this definition")
    :   Harmonic effector weight

        Type:
        :   float in [-200, 200], default 0.0

    lennardjones[¶](#bpy.types.EffectorWeights.lennardjones "Link to this definition")
    :   Lennard-Jones effector weight

        Type:
        :   float in [-200, 200], default 0.0

    magnetic[¶](#bpy.types.EffectorWeights.magnetic "Link to this definition")
    :   Magnetic effector weight

        Type:
        :   float in [-200, 200], default 0.0

    smokeflow[¶](#bpy.types.EffectorWeights.smokeflow "Link to this definition")
    :   Fluid Flow effector weight

        Type:
        :   float in [-200, 200], default 0.0

    texture[¶](#bpy.types.EffectorWeights.texture "Link to this definition")
    :   Texture effector weight

        Type:
        :   float in [-200, 200], default 0.0

    turbulence[¶](#bpy.types.EffectorWeights.turbulence "Link to this definition")
    :   Turbulence effector weight

        Type:
        :   float in [-200, 200], default 0.0

    vortex[¶](#bpy.types.EffectorWeights.vortex "Link to this definition")
    :   Vortex effector weight

        Type:
        :   float in [-200, 200], default 0.0

    wind[¶](#bpy.types.EffectorWeights.wind "Link to this definition")
    :   Wind effector weight

        Type:
        :   float in [-200, 200], default 0.0

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.EffectorWeights.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.EffectorWeights.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`ClothSettings.effector_weights`](ClothSettings.md#bpy.types.ClothSettings.effector_weights "bpy.types.ClothSettings.effector_weights") * [`DynamicPaintSurface.effector_weights`](DynamicPaintSurface.md#bpy.types.DynamicPaintSurface.effector_weights "bpy.types.DynamicPaintSurface.effector_weights") * [`FluidDomainSettings.effector_weights`](FluidDomainSettings.md#bpy.types.FluidDomainSettings.effector_weights "bpy.types.FluidDomainSettings.effector_weights") | * [`ParticleSettings.effector_weights`](ParticleSettings.md#bpy.types.ParticleSettings.effector_weights "bpy.types.ParticleSettings.effector_weights") * [`RigidBodyWorld.effector_weights`](RigidBodyWorld.md#bpy.types.RigidBodyWorld.effector_weights "bpy.types.RigidBodyWorld.effector_weights") * [`SoftBodySettings.effector_weights`](SoftBodySettings.md#bpy.types.SoftBodySettings.effector_weights "bpy.types.SoftBodySettings.effector_weights") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.EffectorWeights.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.EffectorWeights.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* EffectorWeights(bpy\_struct)
  + [`EffectorWeights`](#bpy.types.EffectorWeights)
    - [`EffectorWeights.all`](#bpy.types.EffectorWeights.all)
    - [`EffectorWeights.apply_to_hair_growing`](#bpy.types.EffectorWeights.apply_to_hair_growing)
    - [`EffectorWeights.boid`](#bpy.types.EffectorWeights.boid)
    - [`EffectorWeights.charge`](#bpy.types.EffectorWeights.charge)
    - [`EffectorWeights.collection`](#bpy.types.EffectorWeights.collection)
    - [`EffectorWeights.curve_guide`](#bpy.types.EffectorWeights.curve_guide)
    - [`EffectorWeights.drag`](#bpy.types.EffectorWeights.drag)
    - [`EffectorWeights.force`](#bpy.types.EffectorWeights.force)
    - [`EffectorWeights.gravity`](#bpy.types.EffectorWeights.gravity)
    - [`EffectorWeights.harmonic`](#bpy.types.EffectorWeights.harmonic)
    - [`EffectorWeights.lennardjones`](#bpy.types.EffectorWeights.lennardjones)
    - [`EffectorWeights.magnetic`](#bpy.types.EffectorWeights.magnetic)
    - [`EffectorWeights.smokeflow`](#bpy.types.EffectorWeights.smokeflow)
    - [`EffectorWeights.texture`](#bpy.types.EffectorWeights.texture)
    - [`EffectorWeights.turbulence`](#bpy.types.EffectorWeights.turbulence)
    - [`EffectorWeights.vortex`](#bpy.types.EffectorWeights.vortex)
    - [`EffectorWeights.wind`](#bpy.types.EffectorWeights.wind)
    - [`EffectorWeights.bl_rna_get_subclass()`](#bpy.types.EffectorWeights.bl_rna_get_subclass)
    - [`EffectorWeights.bl_rna_get_subclass_py()`](#bpy.types.EffectorWeights.bl_rna_get_subclass_py)
