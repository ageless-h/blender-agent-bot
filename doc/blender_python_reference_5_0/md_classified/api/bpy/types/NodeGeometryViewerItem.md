...
# NodeGeometryViewerItem(bpy\_struct)[¶](#nodegeometryvieweritem-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.NodeGeometryViewerItem(*bpy\_struct*)[¶](#bpy.types.NodeGeometryViewerItem "Link to this definition")
:   auto\_remove[¶](#bpy.types.NodeGeometryViewerItem.auto_remove "Link to this definition")
    :   Remove the item automatically when it is unlinked

        Type:
        :   boolean, default False

    color[¶](#bpy.types.NodeGeometryViewerItem.color "Link to this definition")
    ...
    name[¶](#bpy.types.NodeGeometryViewerItem.name "Link to this definition")
    :   Type:
        :   string, default “”, (never None)

    socket\_type[¶](#bpy.types.NodeGeometryViewerItem.socket_type "Link to this definition")
    :   Type:
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.NodeGeometryViewerItem.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.NodeGeometryViewerItem.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`GeometryNodeViewer.active_item`](GeometryNodeViewer.md#bpy.types.GeometryNodeViewer.active_item "bpy.types.GeometryNodeViewer.active_item") * [`GeometryNodeViewer.viewer_items`](GeometryNodeViewer.md#bpy.types.GeometryNodeViewer.viewer_items "bpy.types.GeometryNodeViewer.viewer_items") | * [`NodeGeometryViewerItems.new`](NodeGeometryViewerItems.md#bpy.types.NodeGeometryViewerItems.new "bpy.types.NodeGeometryViewerItems.new") * [`NodeGeometryViewerItems.remove`](NodeGeometryViewerItems.md#bpy.types.NodeGeometryViewerItems.remove "bpy.types.NodeGeometryViewerItems.remove") |

[Next

NodeGeometryViewerItems(bpy\_struct)](NodeGeometryViewerItems.md)
[Previous
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.NodeGeometryViewerItem.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.NodeGeometryViewerItem.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* NodeGeometryViewerItem(bpy\_struct)
  + [`NodeGeometryViewerItem`](#bpy.types.NodeGeometryViewerItem)
    - [`NodeGeometryViewerItem.auto_remove`](#bpy.types.NodeGeometryViewerItem.auto_remove)
    - [`NodeGeometryViewerItem.color`](#bpy.types.NodeGeometryViewerItem.color)
    - [`NodeGeometryViewerItem.name`](#bpy.types.NodeGeometryViewerItem.name)
    - [`NodeGeometryViewerItem.socket_type`](#bpy.types.NodeGeometryViewerItem.socket_type)
    - [`NodeGeometryViewerItem.bl_rna_get_subclass()`](#bpy.types.NodeGeometryViewerItem.bl_rna_get_subclass)
    - [`NodeGeometryViewerItem.bl_rna_get_subclass_py()`](#bpy.types.NodeGeometryViewerItem.bl_rna_get_subclass_py)
