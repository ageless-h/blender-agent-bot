...
# LatticePoint(bpy\_struct)[¶](#latticepoint-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.LatticePoint(*bpy\_struct*)[¶](#bpy.types.LatticePoint "Link to this definition")
:   Point in the lattice grid

    co[¶](#bpy.types.LatticePoint.co "Link to this definition")
    ...
    co\_deform[¶](#bpy.types.LatticePoint.co_deform "Link to this definition")
    :   Type:
        :   [`mathutils.Vector`](../../mathutils/index.md#mathutils.Vector "mathutils.Vector") of 3 items in [-inf, inf], default (0.0, 0.0, 0.0)

    groups[¶](#bpy.types.LatticePoint.groups "Link to this definition")
    ...
    select[¶](#bpy.types.LatticePoint.select "Link to this definition")
    :   Selection status

        Type:
        :   boolean, default False

    weight\_softbody[¶](#bpy.types.LatticePoint.weight_softbody "Link to this definition")
    :   Softbody goal weight

        Type:
        :   float in [0.01, 100], default 0.0

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.LatticePoint.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.LatticePoint.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Lattice.points`](Lattice.md#bpy.types.Lattice.points "bpy.types.Lattice.points") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.LatticePoint.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.LatticePoint.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* LatticePoint(bpy\_struct)
  + [`LatticePoint`](#bpy.types.LatticePoint)
    - [`LatticePoint.co`](#bpy.types.LatticePoint.co)
    - [`LatticePoint.co_deform`](#bpy.types.LatticePoint.co_deform)
    - [`LatticePoint.groups`](#bpy.types.LatticePoint.groups)
    - [`LatticePoint.select`](#bpy.types.LatticePoint.select)
    - [`LatticePoint.weight_softbody`](#bpy.types.LatticePoint.weight_softbody)
    - [`LatticePoint.bl_rna_get_subclass()`](#bpy.types.LatticePoint.bl_rna_get_subclass)
    - [`LatticePoint.bl_rna_get_subclass_py()`](#bpy.types.LatticePoint.bl_rna_get_subclass_py)
