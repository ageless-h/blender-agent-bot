...
# WorkSpaceTool(bpy\_struct)[¶](#workspacetool-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.WorkSpaceTool(*bpy\_struct*)[¶](#bpy.types.WorkSpaceTool "Link to this definition")
:   brush\_type[¶](#bpy.types.WorkSpaceTool.brush_type "Link to this definition")
    ...
    has\_datablock[¶](#bpy.types.WorkSpaceTool.has_datablock "Link to this definition")
    :   Type:
        :   boolean, default False, (readonly)

    idname[¶](#bpy.types.WorkSpaceTool.idname "Link to this definition")
    :   Type:
        :   string, default “”, (never None)

    idname\_fallback[¶](#bpy.types.WorkSpaceTool.idname_fallback "Link to this definition")
    :   Type:
        :   string, default “”, (never None)

    index[¶](#bpy.types.WorkSpaceTool.index "Link to this definition")
    :   Type:
        :   int in [-inf, inf], default 0, (readonly)

    mode[¶](#bpy.types.WorkSpaceTool.mode "Link to this definition")
    :   Type:
        :   enum in [`'DEFAULT'`], default `'DEFAULT'`, (readonly)

    space\_type[¶](#bpy.types.WorkSpaceTool.space_type "Link to this definition")
    :   Type:
        :   enum in [Space Type Items](../../../appendix/bpy_types_enum_items/space_type_items.md#rna-enum-space-type-items), default `'EMPTY'`, (readonly)

    use\_brushes[¶](#bpy.types.WorkSpaceTool.use_brushes "Link to this definition")
    :   Type:
        :   boolean, default False, (readonly)

    use\_paint\_canvas[¶](#bpy.types.WorkSpaceTool.use_paint_canvas "Link to this definition")
    :   Does this tool use a painting canvas

        Type:
        :   boolean, default False, (readonly)

    widget[¶](#bpy.types.WorkSpaceTool.widget "Link to this definition")
    :   Type:
        :   string, default “”, (readonly, never None)

    setup(*idname*, *\**, *cursor='DEFAULT'*, *keymap=''*, *gizmo\_group=''*, *brush\_type=''*, *data\_block=''*, *operator=''*, *index=0*, *options={}*, *idname\_fallback=''*, *keymap\_fallback=''*)[¶](#bpy.types.WorkSpaceTool.setup "Link to this definition")
    :   Set the tool settings

        Parameters:
        :   * **idname** (*string**,* *(**never None**)*) – Identifier
            * **cursor** (enum in [Window Cursor Items](../../../appendix/bpy_types_enum_items/window_cursor_items.md#rna-enum-window-cursor-items), (optional)) – cursor
            * **keymap** (*string**,* *(**optional**,* *never None**)*) – Key Map
            * **gizmo\_group** (*string**,* *(**optional**,* *never None**)*) – Gizmo Group
            * **brush\_type** (*enum in* *[**]**,* *(**optional**)*) – Brush Type, Limit this tool to a specific type of brush
            * **data\_block** (*string**,* *(**optional**,* *never None**)*) – Data Block
            ...
            * **idname\_fallback** (*string**,* *(**optional**,* *never None**)*) – Fallback Identifier
            * **keymap\_fallback** (*string**,* *(**optional**,* *never None**)*) – Fallback Key Map

    operator\_properties(*operator*)[¶](#bpy.types.WorkSpaceTool.operator_properties "Link to this definition")
    ...
    gizmo\_group\_properties(*group*)[¶](#bpy.types.WorkSpaceTool.gizmo_group_properties "Link to this definition")
    :   gizmo\_group\_properties

        Return type:
        :   [`GizmoGroupProperties`](GizmoGroupProperties.md#bpy.types.GizmoGroupProperties "bpy.types.GizmoGroupProperties"), (never None)

    refresh\_from\_context()[¶](#bpy.types.WorkSpaceTool.refresh_from_context "Link to this definition")
    :   refresh\_from\_context

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.WorkSpaceTool.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.WorkSpaceTool.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`WorkSpace.tools`](WorkSpace.md#bpy.types.WorkSpace.tools "bpy.types.WorkSpace.tools") * [`wmTools.from_space_image_mode`](wmTools.md#bpy.types.wmTools.from_space_image_mode "bpy.types.wmTools.from_space_image_mode") * [`wmTools.from_space_node`](wmTools.md#bpy.types.wmTools.from_space_node "bpy.types.wmTools.from_space_node") | * [`wmTools.from_space_sequencer`](wmTools.md#bpy.types.wmTools.from_space_sequencer "bpy.types.wmTools.from_space_sequencer") * [`wmTools.from_space_view3d_mode`](wmTools.md#bpy.types.wmTools.from_space_view3d_mode "bpy.types.wmTools.from_space_view3d_mode") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.WorkSpaceTool.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.WorkSpaceTool.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* WorkSpaceTool(bpy\_struct)
  + [`WorkSpaceTool`](#bpy.types.WorkSpaceTool)
    - [`WorkSpaceTool.brush_type`](#bpy.types.WorkSpaceTool.brush_type)
    - [`WorkSpaceTool.has_datablock`](#bpy.types.WorkSpaceTool.has_datablock)
    - [`WorkSpaceTool.idname`](#bpy.types.WorkSpaceTool.idname)
    - [`WorkSpaceTool.idname_fallback`](#bpy.types.WorkSpaceTool.idname_fallback)
    - [`WorkSpaceTool.index`](#bpy.types.WorkSpaceTool.index)
    - [`WorkSpaceTool.mode`](#bpy.types.WorkSpaceTool.mode)
    - [`WorkSpaceTool.space_type`](#bpy.types.WorkSpaceTool.space_type)
    - [`WorkSpaceTool.use_brushes`](#bpy.types.WorkSpaceTool.use_brushes)
    - [`WorkSpaceTool.use_paint_canvas`](#bpy.types.WorkSpaceTool.use_paint_canvas)
    - [`WorkSpaceTool.widget`](#bpy.types.WorkSpaceTool.widget)
    - [`WorkSpaceTool.setup()`](#bpy.types.WorkSpaceTool.setup)
    - [`WorkSpaceTool.operator_properties()`](#bpy.types.WorkSpaceTool.operator_properties)
    - [`WorkSpaceTool.gizmo_group_properties()`](#bpy.types.WorkSpaceTool.gizmo_group_properties)
    - [`WorkSpaceTool.refresh_from_context()`](#bpy.types.WorkSpaceTool.refresh_from_context)
    - [`WorkSpaceTool.bl_rna_get_subclass()`](#bpy.types.WorkSpaceTool.bl_rna_get_subclass)
    - [`WorkSpaceTool.bl_rna_get_subclass_py()`](#bpy.types.WorkSpaceTool.bl_rna_get_subclass_py)
