...
# BlendDataSounds(bpy\_struct)[¶](#blenddatasounds-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.BlendDataSounds(*bpy\_struct*)[¶](#bpy.types.BlendDataSounds "Link to this definition")
:   Collection of sounds

    load(*filepath*, *\**, *check\_existing=False*)[¶](#bpy.types.BlendDataSounds.load "Link to this definition")
    ...
    remove(*sound*, *\**, *do\_unlink=True*, *do\_id\_user=True*, *do\_ui\_user=True*)[¶](#bpy.types.BlendDataSounds.remove "Link to this definition")
    :   Remove a sound from the current blendfile

        Parameters:
        :   * **sound** ([`Sound`](Sound.md#bpy.types.Sound "bpy.types.Sound"), (never None)) – Sound to remove
            * **do\_unlink** (*boolean**,* *(**optional**)*) – Unlink all usages of this sound before deleting it
            * **do\_id\_user** (*boolean**,* *(**optional**)*) – Decrement user counter of all data-blocks used by this sound
            * **do\_ui\_user** (*boolean**,* *(**optional**)*) – Make sure interface does not reference this sound

    tag(*value*)[¶](#bpy.types.BlendDataSounds.tag "Link to this definition")
    :   tag

        Parameters:
        :   **value** (*boolean*) – Value

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.BlendDataSounds.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.BlendDataSounds.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`BlendData.sounds`](BlendData.md#bpy.types.BlendData.sounds "bpy.types.BlendData.sounds") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.BlendDataSounds.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.BlendDataSounds.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* BlendDataSounds(bpy\_struct)
  + [`BlendDataSounds`](#bpy.types.BlendDataSounds)
    - [`BlendDataSounds.load()`](#bpy.types.BlendDataSounds.load)
    - [`BlendDataSounds.remove()`](#bpy.types.BlendDataSounds.remove)
    - [`BlendDataSounds.tag()`](#bpy.types.BlendDataSounds.tag)
    - [`BlendDataSounds.bl_rna_get_subclass()`](#bpy.types.BlendDataSounds.bl_rna_get_subclass)
    - [`BlendDataSounds.bl_rna_get_subclass_py()`](#bpy.types.BlendDataSounds.bl_rna_get_subclass_py)
