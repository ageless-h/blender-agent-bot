...
# MovieReconstructedCamera(bpy\_struct)[¶](#moviereconstructedcamera-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.MovieReconstructedCamera(*bpy\_struct*)[¶](#bpy.types.MovieReconstructedCamera "Link to this definition")
:   Match-moving reconstructed camera data from tracker

    average\_error[¶](#bpy.types.MovieReconstructedCamera.average_error "Link to this definition")
    :   Average error of reconstruction

        Type:
        :   float in [-inf, inf], default 0.0, (readonly)

    frame[¶](#bpy.types.MovieReconstructedCamera.frame "Link to this definition")
    :   Frame number marker is keyframed on

        Type:
        :   int in [-inf, inf], default 0, (readonly)

    matrix[¶](#bpy.types.MovieReconstructedCamera.matrix "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.MovieReconstructedCamera.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.MovieReconstructedCamera.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`MovieTrackingReconstructedCameras.find_frame`](MovieTrackingReconstructedCameras.md#bpy.types.MovieTrackingReconstructedCameras.find_frame "bpy.types.MovieTrackingReconstructedCameras.find_frame") | * [`MovieTrackingReconstruction.cameras`](MovieTrackingReconstruction.md#bpy.types.MovieTrackingReconstruction.cameras "bpy.types.MovieTrackingReconstruction.cameras") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.MovieReconstructedCamera.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.MovieReconstructedCamera.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* MovieReconstructedCamera(bpy\_struct)
  + [`MovieReconstructedCamera`](#bpy.types.MovieReconstructedCamera)
    - [`MovieReconstructedCamera.average_error`](#bpy.types.MovieReconstructedCamera.average_error)
    - [`MovieReconstructedCamera.frame`](#bpy.types.MovieReconstructedCamera.frame)
    - [`MovieReconstructedCamera.matrix`](#bpy.types.MovieReconstructedCamera.matrix)
    - [`MovieReconstructedCamera.bl_rna_get_subclass()`](#bpy.types.MovieReconstructedCamera.bl_rna_get_subclass)
    - [`MovieReconstructedCamera.bl_rna_get_subclass_py()`](#bpy.types.MovieReconstructedCamera.bl_rna_get_subclass_py)
