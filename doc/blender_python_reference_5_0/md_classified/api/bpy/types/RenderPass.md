...
# RenderPass(bpy\_struct)[¶](#renderpass-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.RenderPass(*bpy\_struct*)[¶](#bpy.types.RenderPass "Link to this definition")
:   channel\_id[¶](#bpy.types.RenderPass.channel_id "Link to this definition")
    :   Type:
        :   string, default “”, (readonly, never None)

    channels[¶](#bpy.types.RenderPass.channels "Link to this definition")
    :   Type:
        :   int in [-inf, inf], default 0, (readonly)

    fullname[¶](#bpy.types.RenderPass.fullname "Link to this definition")
    :   Type:
        :   string, default “”, (readonly, never None)

    name[¶](#bpy.types.RenderPass.name "Link to this definition")
    :   Type:
        :   string, default “”, (readonly, never None)

    rect[¶](#bpy.types.RenderPass.rect "Link to this definition")
    :   Type:
        :   float in [-inf, inf], default 0.0

    view\_id[¶](#bpy.types.RenderPass.view_id "Link to this definition")
    :   Type:
        :   int in [-inf, inf], default 0, (readonly)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.RenderPass.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.RenderPass.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`RenderEngine.pass_by_index_get`](RenderEngine.md#bpy.types.RenderEngine.pass_by_index_get "bpy.types.RenderEngine.pass_by_index_get") * [`RenderLayer.passes`](RenderLayer.md#bpy.types.RenderLayer.passes "bpy.types.RenderLayer.passes") | * [`RenderPasses.find_by_name`](RenderPasses.md#bpy.types.RenderPasses.find_by_name "bpy.types.RenderPasses.find_by_name") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.RenderPass.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.RenderPass.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* RenderPass(bpy\_struct)
  + [`RenderPass`](#bpy.types.RenderPass)
    - [`RenderPass.channel_id`](#bpy.types.RenderPass.channel_id)
    - [`RenderPass.channels`](#bpy.types.RenderPass.channels)
    - [`RenderPass.fullname`](#bpy.types.RenderPass.fullname)
    - [`RenderPass.name`](#bpy.types.RenderPass.name)
    - [`RenderPass.rect`](#bpy.types.RenderPass.rect)
    - [`RenderPass.view_id`](#bpy.types.RenderPass.view_id)
    - [`RenderPass.bl_rna_get_subclass()`](#bpy.types.RenderPass.bl_rna_get_subclass)
    - [`RenderPass.bl_rna_get_subclass_py()`](#bpy.types.RenderPass.bl_rna_get_subclass_py)
