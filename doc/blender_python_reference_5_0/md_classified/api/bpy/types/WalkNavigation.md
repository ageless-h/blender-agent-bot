...
# WalkNavigation(bpy\_struct)[¶](#walknavigation-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.WalkNavigation(*bpy\_struct*)[¶](#bpy.types.WalkNavigation "Link to this definition")
:   Walk navigation settings

    jump\_height[¶](#bpy.types.WalkNavigation.jump_height "Link to this definition")
    :   Maximum height of a jump

        Type:
        :   float in [0.1, 100], default 0.4

    mouse\_speed[¶](#bpy.types.WalkNavigation.mouse_speed "Link to this definition")
    :   Speed factor for when looking around, high values mean faster mouse movement

        Type:
        :   float in [0.01, 10], default 1.0

    teleport\_time[¶](#bpy.types.WalkNavigation.teleport_time "Link to this definition")
    :   Interval of time warp when teleporting in navigation mode

        Type:
        :   float in [0, 10], default 0.2

    use\_gravity[¶](#bpy.types.WalkNavigation.use_gravity "Link to this definition")
    :   Walk with gravity, or free navigate

        Type:
        :   boolean, default False

    use\_mouse\_reverse[¶](#bpy.types.WalkNavigation.use_mouse_reverse "Link to this definition")
    :   Reverse the vertical movement of the mouse

        Type:
        :   boolean, default False

    view\_height[¶](#bpy.types.WalkNavigation.view_height "Link to this definition")
    :   View distance from the floor when walking

        Type:
        :   float in [0, 1000], default 1.6

    walk\_speed[¶](#bpy.types.WalkNavigation.walk_speed "Link to this definition")
    :   Base speed for walking and flying

        Type:
        :   float in [0.01, 100], default 2.5

    walk\_speed\_factor[¶](#bpy.types.WalkNavigation.walk_speed_factor "Link to this definition")
    :   Multiplication factor when using the fast or slow modifiers

        Type:
        :   float in [0.01, 10], default 5.0

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.WalkNavigation.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.WalkNavigation.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`PreferencesInput.walk_navigation`](PreferencesInput.md#bpy.types.PreferencesInput.walk_navigation "bpy.types.PreferencesInput.walk_navigation") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.WalkNavigation.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.WalkNavigation.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* WalkNavigation(bpy\_struct)
  + [`WalkNavigation`](#bpy.types.WalkNavigation)
    - [`WalkNavigation.jump_height`](#bpy.types.WalkNavigation.jump_height)
    - [`WalkNavigation.mouse_speed`](#bpy.types.WalkNavigation.mouse_speed)
    - [`WalkNavigation.teleport_time`](#bpy.types.WalkNavigation.teleport_time)
    - [`WalkNavigation.use_gravity`](#bpy.types.WalkNavigation.use_gravity)
    - [`WalkNavigation.use_mouse_reverse`](#bpy.types.WalkNavigation.use_mouse_reverse)
    - [`WalkNavigation.view_height`](#bpy.types.WalkNavigation.view_height)
    - [`WalkNavigation.walk_speed`](#bpy.types.WalkNavigation.walk_speed)
    - [`WalkNavigation.walk_speed_factor`](#bpy.types.WalkNavigation.walk_speed_factor)
    - [`WalkNavigation.bl_rna_get_subclass()`](#bpy.types.WalkNavigation.bl_rna_get_subclass)
    - [`WalkNavigation.bl_rna_get_subclass_py()`](#bpy.types.WalkNavigation.bl_rna_get_subclass_py)
