...
# LineStyleThicknessModifier\_DistanceFromObject(LineStyleThicknessModifier)[¶](#linestylethicknessmodifier-distancefromobject-linestylethicknessmodifier "Link to this heading")

base classes — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct"), [`LineStyleModifier`](LineStyleModifier.md#bpy.types.LineStyleModifier "bpy.types.LineStyleModifier"), [`LineStyleThicknessModifier`](LineStyleThicknessModifier.md#bpy.types.LineStyleThicknessModifier "bpy.types.LineStyleThicknessModifier")

*class* bpy.types.LineStyleThicknessModifier\_DistanceFromObject(*LineStyleThicknessModifier*)[¶](#bpy.types.LineStyleThicknessModifier_DistanceFromObject "Link to this definition")
:   Change line thickness based on the distance from an object

    blend[¶](#bpy.types.LineStyleThicknessModifier_DistanceFromObject.blend "Link to this definition")
    :   Specify how the modifier value is blended into the base value

        Type:
        :   enum in [`'MIX'`, `'ADD'`, `'SUBTRACT'`, `'MULTIPLY'`, `'DIVIDE'`, `'DIFFERENCE'`, `'MINIMUM'`, `'MAXIMUM'`], default `'MIX'`

    curve[¶](#bpy.types.LineStyleThicknessModifier_DistanceFromObject.curve "Link to this definition")
    :   Curve used for the curve mapping

        Type:
        :   [`CurveMapping`](CurveMapping.md#bpy.types.CurveMapping "bpy.types.CurveMapping"), (readonly)

    expanded[¶](#bpy.types.LineStyleThicknessModifier_DistanceFromObject.expanded "Link to this definition")
    :   True if the modifier tab is expanded

        Type:
        :   boolean, default False

    influence[¶](#bpy.types.LineStyleThicknessModifier_DistanceFromObject.influence "Link to this definition")
    :   Influence factor by which the modifier changes the property

        Type:
        :   float in [0, 1], default 0.0

    invert[¶](#bpy.types.LineStyleThicknessModifier_DistanceFromObject.invert "Link to this definition")
    :   Invert the fade-out direction of the linear mapping

        Type:
        :   boolean, default False

    mapping[¶](#bpy.types.LineStyleThicknessModifier_DistanceFromObject.mapping "Link to this definition")
    ...
    range\_max[¶](#bpy.types.LineStyleThicknessModifier_DistanceFromObject.range_max "Link to this definition")
    :   Upper bound of the input range the mapping is applied

        Type:
        :   float in [-inf, inf], default 0.0

    range\_min[¶](#bpy.types.LineStyleThicknessModifier_DistanceFromObject.range_min "Link to this definition")
    :   Lower bound of the input range the mapping is applied

        Type:
        :   float in [-inf, inf], default 0.0

    target[¶](#bpy.types.LineStyleThicknessModifier_DistanceFromObject.target "Link to this definition")
    :   Target object from which the distance is measured

        Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object")

    type[¶](#bpy.types.LineStyleThicknessModifier_DistanceFromObject.type "Link to this definition")
    :   Type of the modifier

        Type:
        :   enum in [Linestyle Thickness Modifier Type Items](../../../appendix/bpy_types_enum_items/linestyle_thickness_modifier_type_items.md#rna-enum-linestyle-thickness-modifier-type-items), default `'ALONG_STROKE'`, (readonly)

    use[¶](#bpy.types.LineStyleThicknessModifier_DistanceFromObject.use "Link to this definition")
    :   Enable or disable this modifier during stroke rendering

        Type:
        :   boolean, default False

    value\_max[¶](#bpy.types.LineStyleThicknessModifier_DistanceFromObject.value_max "Link to this definition")
    :   Maximum output value of the mapping

        Type:
        :   float in [-inf, inf], default 0.0

    value\_min[¶](#bpy.types.LineStyleThicknessModifier_DistanceFromObject.value_min "Link to this definition")
    :   Minimum output value of the mapping

        Type:
        :   float in [-inf, inf], default 0.0

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.LineStyleThicknessModifier_DistanceFromObject.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.LineStyleThicknessModifier_DistanceFromObject.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.LineStyleThicknessModifier_DistanceFromObject.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.LineStyleThicknessModifier_DistanceFromObject.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* LineStyleThicknessModifier\_DistanceFromObject(LineStyleThicknessModifier)
  + [`LineStyleThicknessModifier_DistanceFromObject`](#bpy.types.LineStyleThicknessModifier_DistanceFromObject)
    - [`LineStyleThicknessModifier_DistanceFromObject.blend`](#bpy.types.LineStyleThicknessModifier_DistanceFromObject.blend)
    - [`LineStyleThicknessModifier_DistanceFromObject.curve`](#bpy.types.LineStyleThicknessModifier_DistanceFromObject.curve)
    - [`LineStyleThicknessModifier_DistanceFromObject.expanded`](#bpy.types.LineStyleThicknessModifier_DistanceFromObject.expanded)
    - [`LineStyleThicknessModifier_DistanceFromObject.influence`](#bpy.types.LineStyleThicknessModifier_DistanceFromObject.influence)
    - [`LineStyleThicknessModifier_DistanceFromObject.invert`](#bpy.types.LineStyleThicknessModifier_DistanceFromObject.invert)
    - [`LineStyleThicknessModifier_DistanceFromObject.mapping`](#bpy.types.LineStyleThicknessModifier_DistanceFromObject.mapping)
    - [`LineStyleThicknessModifier_DistanceFromObject.range_max`](#bpy.types.LineStyleThicknessModifier_DistanceFromObject.range_max)
    - [`LineStyleThicknessModifier_DistanceFromObject.range_min`](#bpy.types.LineStyleThicknessModifier_DistanceFromObject.range_min)
    - [`LineStyleThicknessModifier_DistanceFromObject.target`](#bpy.types.LineStyleThicknessModifier_DistanceFromObject.target)
    - [`LineStyleThicknessModifier_DistanceFromObject.type`](#bpy.types.LineStyleThicknessModifier_DistanceFromObject.type)
    - [`LineStyleThicknessModifier_DistanceFromObject.use`](#bpy.types.LineStyleThicknessModifier_DistanceFromObject.use)
    - [`LineStyleThicknessModifier_DistanceFromObject.value_max`](#bpy.types.LineStyleThicknessModifier_DistanceFromObject.value_max)
    - [`LineStyleThicknessModifier_DistanceFromObject.value_min`](#bpy.types.LineStyleThicknessModifier_DistanceFromObject.value_min)
    - [`LineStyleThicknessModifier_DistanceFromObject.bl_rna_get_subclass()`](#bpy.types.LineStyleThicknessModifier_DistanceFromObject.bl_rna_get_subclass)
    - [`LineStyleThicknessModifier_DistanceFromObject.bl_rna_get_subclass_py()`](#bpy.types.LineStyleThicknessModifier_DistanceFromObject.bl_rna_get_subclass_py)
