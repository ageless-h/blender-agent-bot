...
# TransformOrientationSlot(bpy\_struct)[¶](#transformorientationslot-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.TransformOrientationSlot(*bpy\_struct*)[¶](#bpy.types.TransformOrientationSlot "Link to this definition")
:   custom\_orientation[¶](#bpy.types.TransformOrientationSlot.custom_orientation "Link to this definition")
    :   Type:
        :   [`TransformOrientation`](TransformOrientation.md#bpy.types.TransformOrientation "bpy.types.TransformOrientation"), (readonly)

    type[¶](#bpy.types.TransformOrientationSlot.type "Link to this definition")
    :   Transformation orientation

        Type:
        :   enum in [Transform Orientation Items](../../../appendix/bpy_types_enum_items/transform_orientation_items.md#rna-enum-transform-orientation-items), default `'GLOBAL'`

    use[¶](#bpy.types.TransformOrientationSlot.use "Link to this definition")
    :   Use scene orientation instead of a custom setting

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.TransformOrientationSlot.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.TransformOrientationSlot.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Scene.transform_orientation_slots`](Scene.md#bpy.types.Scene.transform_orientation_slots "bpy.types.Scene.transform_orientation_slots") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.TransformOrientationSlot.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.TransformOrientationSlot.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* TransformOrientationSlot(bpy\_struct)
  + [`TransformOrientationSlot`](#bpy.types.TransformOrientationSlot)
    - [`TransformOrientationSlot.custom_orientation`](#bpy.types.TransformOrientationSlot.custom_orientation)
    - [`TransformOrientationSlot.type`](#bpy.types.TransformOrientationSlot.type)
    - [`TransformOrientationSlot.use`](#bpy.types.TransformOrientationSlot.use)
    - [`TransformOrientationSlot.bl_rna_get_subclass()`](#bpy.types.TransformOrientationSlot.bl_rna_get_subclass)
    - [`TransformOrientationSlot.bl_rna_get_subclass_py()`](#bpy.types.TransformOrientationSlot.bl_rna_get_subclass_py)
