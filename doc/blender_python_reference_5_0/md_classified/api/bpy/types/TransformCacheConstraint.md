...
# TransformCacheConstraint(Constraint)[¶](#transformcacheconstraint-constraint "Link to this heading")
...
*class* bpy.types.TransformCacheConstraint(*Constraint*)[¶](#bpy.types.TransformCacheConstraint "Link to this definition")
:   Look up transformation from an external file

    cache\_file[¶](#bpy.types.TransformCacheConstraint.cache_file "Link to this definition")
    :   Type:
        :   [`CacheFile`](CacheFile.md#bpy.types.CacheFile "bpy.types.CacheFile")

    object\_path[¶](#bpy.types.TransformCacheConstraint.object_path "Link to this definition")
    :   Path to the object in the Alembic archive used to lookup the transform matrix

        Type:
        :   string, default “”, (never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.TransformCacheConstraint.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.TransformCacheConstraint.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.TransformCacheConstraint.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.TransformCacheConstraint.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* TransformCacheConstraint(Constraint)
  + [`TransformCacheConstraint`](#bpy.types.TransformCacheConstraint)
    - [`TransformCacheConstraint.cache_file`](#bpy.types.TransformCacheConstraint.cache_file)
    - [`TransformCacheConstraint.object_path`](#bpy.types.TransformCacheConstraint.object_path)
    - [`TransformCacheConstraint.bl_rna_get_subclass()`](#bpy.types.TransformCacheConstraint.bl_rna_get_subclass)
    - [`TransformCacheConstraint.bl_rna_get_subclass_py()`](#bpy.types.TransformCacheConstraint.bl_rna_get_subclass_py)
