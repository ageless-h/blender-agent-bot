...
# DATA\_UL\_bone\_collections(UIList)[¶](#data-ul-bone-collections-uilist "Link to this heading")
...
*class* bpy.types.DATA\_UL\_bone\_collections(*UIList*)[¶](#bpy.types.DATA_UL_bone_collections "Link to this definition")
:   draw\_item(*\_context*, *layout*, *armature*, *bcoll*, *\_icon*, *\_active\_data*, *\_active\_propname*, *\_index*)[¶](#bpy.types.DATA_UL_bone_collections.draw_item "Link to this definition")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.DATA_UL_bone_collections.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.DATA_UL_bone_collections.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.DATA_UL_bone_collections.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.DATA_UL_bone_collections.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* DATA\_UL\_bone\_collections(UIList)
  + [`DATA_UL_bone_collections`](#bpy.types.DATA_UL_bone_collections)
    - [`DATA_UL_bone_collections.draw_item()`](#bpy.types.DATA_UL_bone_collections.draw_item)
    - [`DATA_UL_bone_collections.bl_rna_get_subclass()`](#bpy.types.DATA_UL_bone_collections.bl_rna_get_subclass)
    - [`DATA_UL_bone_collections.bl_rna_get_subclass_py()`](#bpy.types.DATA_UL_bone_collections.bl_rna_get_subclass_py)
