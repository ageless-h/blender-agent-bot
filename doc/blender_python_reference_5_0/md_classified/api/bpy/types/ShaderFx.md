...
# ShaderFx(bpy\_struct)[¶](#shaderfx-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

subclasses —
[`ShaderFxBlur`](ShaderFxBlur.md#bpy.types.ShaderFxBlur "bpy.types.ShaderFxBlur"), [`ShaderFxColorize`](ShaderFxColorize.md#bpy.types.ShaderFxColorize "bpy.types.ShaderFxColorize"), [`ShaderFxFlip`](ShaderFxFlip.md#bpy.types.ShaderFxFlip "bpy.types.ShaderFxFlip"), [`ShaderFxGlow`](ShaderFxGlow.md#bpy.types.ShaderFxGlow "bpy.types.ShaderFxGlow"), [`ShaderFxPixel`](ShaderFxPixel.md#bpy.types.ShaderFxPixel "bpy.types.ShaderFxPixel"), [`ShaderFxRim`](ShaderFxRim.md#bpy.types.ShaderFxRim "bpy.types.ShaderFxRim"), [`ShaderFxShadow`](ShaderFxShadow.md#bpy.types.ShaderFxShadow "bpy.types.ShaderFxShadow"), [`ShaderFxSwirl`](ShaderFxSwirl.md#bpy.types.ShaderFxSwirl "bpy.types.ShaderFxSwirl"), [`ShaderFxWave`](ShaderFxWave.md#bpy.types.ShaderFxWave "bpy.types.ShaderFxWave")

*class* bpy.types.ShaderFx(*bpy\_struct*)[¶](#bpy.types.ShaderFx "Link to this definition")
:   Effect affecting the Grease Pencil object

    name[¶](#bpy.types.ShaderFx.name "Link to this definition")
    :   Effect name

        Type:
        :   string, default “”, (never None)

    show\_expanded[¶](#bpy.types.ShaderFx.show_expanded "Link to this definition")
    :   Set effect expansion in the user interface

        Type:
        :   boolean, default False

    show\_in\_editmode[¶](#bpy.types.ShaderFx.show_in_editmode "Link to this definition")
    :   Display effect in Edit mode

        Type:
        :   boolean, default False

    show\_render[¶](#bpy.types.ShaderFx.show_render "Link to this definition")
    :   Use effect during render

        Type:
        :   boolean, default False

    show\_viewport[¶](#bpy.types.ShaderFx.show_viewport "Link to this definition")
    :   Display effect in viewport

        Type:
        :   boolean, default False

    type[¶](#bpy.types.ShaderFx.type "Link to this definition")
    :   Type:
        :   enum in [Object Shaderfx Type Items](../../../appendix/bpy_types_enum_items/object_shaderfx_type_items.md#rna-enum-object-shaderfx-type-items), default `'FX_BLUR'`, (readonly)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ShaderFx.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ShaderFx.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Object.shader_effects`](Object.md#bpy.types.Object.shader_effects "bpy.types.Object.shader_effects") * [`ObjectShaderFx.new`](ObjectShaderFx.md#bpy.types.ObjectShaderFx.new "bpy.types.ObjectShaderFx.new") | * [`ObjectShaderFx.remove`](ObjectShaderFx.md#bpy.types.ObjectShaderFx.remove "bpy.types.ObjectShaderFx.remove") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ShaderFx.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ShaderFx.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ShaderFx(bpy\_struct)
  + [`ShaderFx`](#bpy.types.ShaderFx)
    - [`ShaderFx.name`](#bpy.types.ShaderFx.name)
    - [`ShaderFx.show_expanded`](#bpy.types.ShaderFx.show_expanded)
    - [`ShaderFx.show_in_editmode`](#bpy.types.ShaderFx.show_in_editmode)
    - [`ShaderFx.show_render`](#bpy.types.ShaderFx.show_render)
    - [`ShaderFx.show_viewport`](#bpy.types.ShaderFx.show_viewport)
    - [`ShaderFx.type`](#bpy.types.ShaderFx.type)
    - [`ShaderFx.bl_rna_get_subclass()`](#bpy.types.ShaderFx.bl_rna_get_subclass)
    - [`ShaderFx.bl_rna_get_subclass_py()`](#bpy.types.ShaderFx.bl_rna_get_subclass_py)
