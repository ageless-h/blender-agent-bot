...
# CurveSlice(bpy\_struct)[¶](#curveslice-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.CurveSlice(*bpy\_struct*)[¶](#bpy.types.CurveSlice "Link to this definition")
:   A single curve from a curves data-block

    first\_point\_index[¶](#bpy.types.CurveSlice.first_point_index "Link to this definition")
    :   The index of this curve’s first control point

        Type:
        :   int in [0, inf], default 0, (readonly)

    index[¶](#bpy.types.CurveSlice.index "Link to this definition")
    :   Index of this curve

        Type:
        :   int in [0, inf], default 0, (readonly)

    points[¶](#bpy.types.CurveSlice.points "Link to this definition")
    ...
    points\_length[¶](#bpy.types.CurveSlice.points_length "Link to this definition")
    :   Number of control points in the curve

        Type:
        :   int in [0, inf], default 0, (readonly)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.CurveSlice.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.CurveSlice.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Curves.curves`](Curves.md#bpy.types.Curves.curves "bpy.types.Curves.curves") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CurveSlice.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.CurveSlice.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CurveSlice(bpy\_struct)
  + [`CurveSlice`](#bpy.types.CurveSlice)
    - [`CurveSlice.first_point_index`](#bpy.types.CurveSlice.first_point_index)
    - [`CurveSlice.index`](#bpy.types.CurveSlice.index)
    - [`CurveSlice.points`](#bpy.types.CurveSlice.points)
    - [`CurveSlice.points_length`](#bpy.types.CurveSlice.points_length)
    - [`CurveSlice.bl_rna_get_subclass()`](#bpy.types.CurveSlice.bl_rna_get_subclass)
    - [`CurveSlice.bl_rna_get_subclass_py()`](#bpy.types.CurveSlice.bl_rna_get_subclass_py)
