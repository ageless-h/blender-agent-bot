...
# PointCloud(ID)[¶](#pointcloud-id "Link to this heading")

base classes — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct"), [`ID`](ID.md#bpy.types.ID "bpy.types.ID")

*class* bpy.types.PointCloud(*ID*)[¶](#bpy.types.PointCloud "Link to this definition")
:   Point cloud data-block

    animation\_data[¶](#bpy.types.PointCloud.animation_data "Link to this definition")
    :   Animation data for this data-block

        Type:
        :   [`AnimData`](AnimData.md#bpy.types.AnimData "bpy.types.AnimData"), (readonly)

    attributes[¶](#bpy.types.PointCloud.attributes "Link to this definition")
    :   Geometry attributes

        Type:
        :   [`AttributeGroupPointCloud`](AttributeGroupPointCloud.md#bpy.types.AttributeGroupPointCloud "bpy.types.AttributeGroupPointCloud") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`Attribute`](Attribute.md#bpy.types.Attribute "bpy.types.Attribute"), (readonly)

    color\_attributes[¶](#bpy.types.PointCloud.color_attributes "Link to this definition")
    :   Geometry color attributes

        Type:
        :   [`AttributeGroupPointCloud`](AttributeGroupPointCloud.md#bpy.types.AttributeGroupPointCloud "bpy.types.AttributeGroupPointCloud") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`Attribute`](Attribute.md#bpy.types.Attribute "bpy.types.Attribute"), (readonly)

    materials[¶](#bpy.types.PointCloud.materials "Link to this definition")
    :   Type:
    ...
    points[¶](#bpy.types.PointCloud.points "Link to this definition")
    :   Type:
        :   [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`Point`](Point.md#bpy.types.Point "bpy.types.Point"), (readonly)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.PointCloud.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.PointCloud.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`bpy.context.pointcloud`](../context/index.md#bpy.context.pointcloud "bpy.context.pointcloud") * [`BlendData.pointclouds`](BlendData.md#bpy.types.BlendData.pointclouds "bpy.types.BlendData.pointclouds") | * [`BlendDataPointClouds.new`](BlendDataPointClouds.md#bpy.types.BlendDataPointClouds.new "bpy.types.BlendDataPointClouds.new") * [`BlendDataPointClouds.remove`](BlendDataPointClouds.md#bpy.types.BlendDataPointClouds.remove "bpy.types.BlendDataPointClouds.remove") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.PointCloud.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.PointCloud.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* PointCloud(ID)
  + [`PointCloud`](#bpy.types.PointCloud)
    - [`PointCloud.animation_data`](#bpy.types.PointCloud.animation_data)
    - [`PointCloud.attributes`](#bpy.types.PointCloud.attributes)
    - [`PointCloud.color_attributes`](#bpy.types.PointCloud.color_attributes)
    - [`PointCloud.materials`](#bpy.types.PointCloud.materials)
    - [`PointCloud.points`](#bpy.types.PointCloud.points)
    - [`PointCloud.bl_rna_get_subclass()`](#bpy.types.PointCloud.bl_rna_get_subclass)
    - [`PointCloud.bl_rna_get_subclass_py()`](#bpy.types.PointCloud.bl_rna_get_subclass_py)
