...
# LimitDistanceConstraint(Constraint)[¶](#limitdistanceconstraint-constraint "Link to this heading")
...
*class* bpy.types.LimitDistanceConstraint(*Constraint*)[¶](#bpy.types.LimitDistanceConstraint "Link to this definition")
:   Limit the distance from target object

    distance[¶](#bpy.types.LimitDistanceConstraint.distance "Link to this definition")
    :   Radius of limiting sphere

        Type:
        :   float in [-inf, inf], default 0.0

    head\_tail[¶](#bpy.types.LimitDistanceConstraint.head_tail "Link to this definition")
    :   Target along length of bone: Head is 0, Tail is 1

        Type:
        :   float in [0, 1], default 0.0

    limit\_mode[¶](#bpy.types.LimitDistanceConstraint.limit_mode "Link to this definition")
    ...
    subtarget[¶](#bpy.types.LimitDistanceConstraint.subtarget "Link to this definition")
    :   Armature bone, mesh or lattice vertex group, …

        Type:
        :   string, default “”, (never None)

    target[¶](#bpy.types.LimitDistanceConstraint.target "Link to this definition")
    :   Target object

        Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object")

    use\_bbone\_shape[¶](#bpy.types.LimitDistanceConstraint.use_bbone_shape "Link to this definition")
    :   Follow shape of B-Bone segments when calculating Head/Tail position

        Type:
        :   boolean, default False

    use\_transform\_limit[¶](#bpy.types.LimitDistanceConstraint.use_transform_limit "Link to this definition")
    :   Transforms are affected by this constraint as well

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.LimitDistanceConstraint.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.LimitDistanceConstraint.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.LimitDistanceConstraint.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.LimitDistanceConstraint.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* LimitDistanceConstraint(Constraint)
  + [`LimitDistanceConstraint`](#bpy.types.LimitDistanceConstraint)
    - [`LimitDistanceConstraint.distance`](#bpy.types.LimitDistanceConstraint.distance)
    - [`LimitDistanceConstraint.head_tail`](#bpy.types.LimitDistanceConstraint.head_tail)
    - [`LimitDistanceConstraint.limit_mode`](#bpy.types.LimitDistanceConstraint.limit_mode)
    - [`LimitDistanceConstraint.subtarget`](#bpy.types.LimitDistanceConstraint.subtarget)
    - [`LimitDistanceConstraint.target`](#bpy.types.LimitDistanceConstraint.target)
    - [`LimitDistanceConstraint.use_bbone_shape`](#bpy.types.LimitDistanceConstraint.use_bbone_shape)
    - [`LimitDistanceConstraint.use_transform_limit`](#bpy.types.LimitDistanceConstraint.use_transform_limit)
    - [`LimitDistanceConstraint.bl_rna_get_subclass()`](#bpy.types.LimitDistanceConstraint.bl_rna_get_subclass)
    - [`LimitDistanceConstraint.bl_rna_get_subclass_py()`](#bpy.types.LimitDistanceConstraint.bl_rna_get_subclass_py)
