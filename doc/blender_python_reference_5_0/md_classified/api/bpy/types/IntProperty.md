...
# IntProperty(Property)[¶](#intproperty-property "Link to this heading")
...
*class* bpy.types.IntProperty(*Property*)[¶](#bpy.types.IntProperty "Link to this definition")
:   RNA integer number property definition

    array\_dimensions[¶](#bpy.types.IntProperty.array_dimensions "Link to this definition")
    :   Length of each dimension of the array

        Type:
        :   int array of 3 items in [0, inf], [default](#bpy.types.IntProperty.default "bpy.types.IntProperty.default") (0, 0, 0), (readonly)

    array\_length[¶](#bpy.types.IntProperty.array_length "Link to this definition")
    :   Maximum length of the array, 0 means unlimited

        Type:
        :   int in [0, inf], default 0, (readonly)

    default[¶](#bpy.types.IntProperty.default "Link to this definition")
    :   Default value for this number

        Type:
        :   int in [-inf, inf], default 0, (readonly)

    default\_array[¶](#bpy.types.IntProperty.default_array "Link to this definition")
    :   Default value for this array

        Type:
        :   int array of 3 items in [-inf, inf], [default](#bpy.types.IntProperty.default "bpy.types.IntProperty.default") (0, 0, 0), (readonly)

    hard\_max[¶](#bpy.types.IntProperty.hard_max "Link to this definition")
    :   Maximum value used by buttons

        Type:
        :   int in [-inf, inf], default 0, (readonly)

    hard\_min[¶](#bpy.types.IntProperty.hard_min "Link to this definition")
    :   Minimum value used by buttons

        Type:
        :   int in [-inf, inf], default 0, (readonly)

    is\_array[¶](#bpy.types.IntProperty.is_array "Link to this definition")
    :   Type:
        :   boolean, default False, (readonly)

    soft\_max[¶](#bpy.types.IntProperty.soft_max "Link to this definition")
    :   Maximum value used by buttons

        Type:
        :   int in [-inf, inf], default 0, (readonly)

    soft\_min[¶](#bpy.types.IntProperty.soft_min "Link to this definition")
    :   Minimum value used by buttons

        Type:
        :   int in [-inf, inf], default 0, (readonly)

    step[¶](#bpy.types.IntProperty.step "Link to this definition")
    :   Step size used by number buttons, for floats 1/100th of the step size

        Type:
        :   int in [0, inf], default 0, (readonly)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.IntProperty.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.IntProperty.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.IntProperty.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.IntProperty.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* IntProperty(Property)
  + [`IntProperty`](#bpy.types.IntProperty)
    - [`IntProperty.array_dimensions`](#bpy.types.IntProperty.array_dimensions)
    - [`IntProperty.array_length`](#bpy.types.IntProperty.array_length)
    - [`IntProperty.default`](#bpy.types.IntProperty.default)
    - [`IntProperty.default_array`](#bpy.types.IntProperty.default_array)
    - [`IntProperty.hard_max`](#bpy.types.IntProperty.hard_max)
    - [`IntProperty.hard_min`](#bpy.types.IntProperty.hard_min)
    - [`IntProperty.is_array`](#bpy.types.IntProperty.is_array)
    - [`IntProperty.soft_max`](#bpy.types.IntProperty.soft_max)
    - [`IntProperty.soft_min`](#bpy.types.IntProperty.soft_min)
    - [`IntProperty.step`](#bpy.types.IntProperty.step)
    - [`IntProperty.bl_rna_get_subclass()`](#bpy.types.IntProperty.bl_rna_get_subclass)
    - [`IntProperty.bl_rna_get_subclass_py()`](#bpy.types.IntProperty.bl_rna_get_subclass_py)
