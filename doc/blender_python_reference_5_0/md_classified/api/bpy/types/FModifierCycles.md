...
# FModifierCycles(FModifier)[¶](#fmodifiercycles-fmodifier "Link to this heading")
...
*class* bpy.types.FModifierCycles(*FModifier*)[¶](#bpy.types.FModifierCycles "Link to this definition")
:   Repeat the values of the modified F-Curve

    cycles\_after[¶](#bpy.types.FModifierCycles.cycles_after "Link to this definition")
    :   Maximum number of cycles to allow after last keyframe (0 = infinite)

        Type:
        :   int in [-32768, 32767], default 0

    cycles\_before[¶](#bpy.types.FModifierCycles.cycles_before "Link to this definition")
    :   Maximum number of cycles to allow before first keyframe (0 = infinite)

        Type:
        :   int in [-32768, 32767], default 0

    mode\_after[¶](#bpy.types.FModifierCycles.mode_after "Link to this definition")
    ...
    mode\_before[¶](#bpy.types.FModifierCycles.mode_before "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.FModifierCycles.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.FModifierCycles.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.FModifierCycles.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.FModifierCycles.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* FModifierCycles(FModifier)
  + [`FModifierCycles`](#bpy.types.FModifierCycles)
    - [`FModifierCycles.cycles_after`](#bpy.types.FModifierCycles.cycles_after)
    - [`FModifierCycles.cycles_before`](#bpy.types.FModifierCycles.cycles_before)
    - [`FModifierCycles.mode_after`](#bpy.types.FModifierCycles.mode_after)
    - [`FModifierCycles.mode_before`](#bpy.types.FModifierCycles.mode_before)
    - [`FModifierCycles.bl_rna_get_subclass()`](#bpy.types.FModifierCycles.bl_rna_get_subclass)
    - [`FModifierCycles.bl_rna_get_subclass_py()`](#bpy.types.FModifierCycles.bl_rna_get_subclass_py)
