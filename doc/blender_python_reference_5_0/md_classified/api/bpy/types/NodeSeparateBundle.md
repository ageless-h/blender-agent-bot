...
# NodeSeparateBundle(NodeInternal)[¶](#nodeseparatebundle-nodeinternal "Link to this heading")
...
*class* bpy.types.NodeSeparateBundle(*NodeInternal*)[¶](#bpy.types.NodeSeparateBundle "Link to this definition")
:   Split a bundle into multiple sockets.

    active\_index[¶](#bpy.types.NodeSeparateBundle.active_index "Link to this definition")
    :   Index of the active item

        Type:
        :   int in [0, inf], default 0

    bundle\_items[¶](#bpy.types.NodeSeparateBundle.bundle_items "Link to this definition")
    :   Type:
        :   [`NodeSeparateBundleItems`](NodeSeparateBundleItems.md#bpy.types.NodeSeparateBundleItems "bpy.types.NodeSeparateBundleItems") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`NodeSeparateBundleItem`](NodeSeparateBundleItem.md#bpy.types.NodeSeparateBundleItem "bpy.types.NodeSeparateBundleItem"), (readonly)

    define\_signature[¶](#bpy.types.NodeSeparateBundle.define_signature "Link to this definition")
    :   This node defines a bundle signature that should be used by other nodes

        Type:
        :   boolean, default False

    *classmethod* is\_registered\_node\_type()[¶](#bpy.types.NodeSeparateBundle.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[¶](#bpy.types.NodeSeparateBundle.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[¶](#bpy.types.NodeSeparateBundle.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.NodeSeparateBundle.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.NodeSeparateBundle.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.NodeSeparateBundle.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.NodeSeparateBundle.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* NodeSeparateBundle(NodeInternal)
  + [`NodeSeparateBundle`](#bpy.types.NodeSeparateBundle)
    - [`NodeSeparateBundle.active_index`](#bpy.types.NodeSeparateBundle.active_index)
    - [`NodeSeparateBundle.bundle_items`](#bpy.types.NodeSeparateBundle.bundle_items)
    - [`NodeSeparateBundle.define_signature`](#bpy.types.NodeSeparateBundle.define_signature)
    - [`NodeSeparateBundle.is_registered_node_type()`](#bpy.types.NodeSeparateBundle.is_registered_node_type)
    - [`NodeSeparateBundle.input_template()`](#bpy.types.NodeSeparateBundle.input_template)
    - [`NodeSeparateBundle.output_template()`](#bpy.types.NodeSeparateBundle.output_template)
    - [`NodeSeparateBundle.bl_rna_get_subclass()`](#bpy.types.NodeSeparateBundle.bl_rna_get_subclass)
    - [`NodeSeparateBundle.bl_rna_get_subclass_py()`](#bpy.types.NodeSeparateBundle.bl_rna_get_subclass_py)
