...
# XrUserPaths(bpy\_struct)[¶](#xruserpaths-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.XrUserPaths(*bpy\_struct*)[¶](#bpy.types.XrUserPaths "Link to this definition")
:   Collection of OpenXR user paths

    new(*path*)[¶](#bpy.types.XrUserPaths.new "Link to this definition")
    :   new

        Parameters:
        :   **path** (*string**,* *(**never None**)*) – Path, OpenXR user path

        Returns:
        :   User Path, Added user path

        Return type:
        :   [`XrUserPath`](XrUserPath.md#bpy.types.XrUserPath "bpy.types.XrUserPath")

    remove(*user\_path*)[¶](#bpy.types.XrUserPaths.remove "Link to this definition")
    :   remove

        Parameters:
        :   **user\_path** ([`XrUserPath`](XrUserPath.md#bpy.types.XrUserPath "bpy.types.XrUserPath"), (never None)) – User Path

    find(*path*)[¶](#bpy.types.XrUserPaths.find "Link to this definition")
    :   find
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.XrUserPaths.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.XrUserPaths.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`XrActionMapItem.user_paths`](XrActionMapItem.md#bpy.types.XrActionMapItem.user_paths "bpy.types.XrActionMapItem.user_paths") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.XrUserPaths.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.XrUserPaths.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* XrUserPaths(bpy\_struct)
  + [`XrUserPaths`](#bpy.types.XrUserPaths)
    - [`XrUserPaths.new()`](#bpy.types.XrUserPaths.new)
    - [`XrUserPaths.remove()`](#bpy.types.XrUserPaths.remove)
    - [`XrUserPaths.find()`](#bpy.types.XrUserPaths.find)
    - [`XrUserPaths.bl_rna_get_subclass()`](#bpy.types.XrUserPaths.bl_rna_get_subclass)
    - [`XrUserPaths.bl_rna_get_subclass_py()`](#bpy.types.XrUserPaths.bl_rna_get_subclass_py)
