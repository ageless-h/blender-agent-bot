...
# MovieTrackingCamera(bpy\_struct)[¶](#movietrackingcamera-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.MovieTrackingCamera(*bpy\_struct*)[¶](#bpy.types.MovieTrackingCamera "Link to this definition")
:   Match-moving camera data for tracking

    brown\_k1[¶](#bpy.types.MovieTrackingCamera.brown_k1 "Link to this definition")
    :   First coefficient of fourth order Brown-Conrady radial distortion

        Type:
        :   float in [-inf, inf], default 0.0

    brown\_k2[¶](#bpy.types.MovieTrackingCamera.brown_k2 "Link to this definition")
    :   Second coefficient of fourth order Brown-Conrady radial distortion

        Type:
        :   float in [-inf, inf], default 0.0

    brown\_k3[¶](#bpy.types.MovieTrackingCamera.brown_k3 "Link to this definition")
    :   Third coefficient of fourth order Brown-Conrady radial distortion

        Type:
        :   float in [-inf, inf], default 0.0

    brown\_k4[¶](#bpy.types.MovieTrackingCamera.brown_k4 "Link to this definition")
    :   Fourth coefficient of fourth order Brown-Conrady radial distortion

        Type:
        :   float in [-inf, inf], default 0.0

    brown\_p1[¶](#bpy.types.MovieTrackingCamera.brown_p1 "Link to this definition")
    :   First coefficient of second order Brown-Conrady tangential distortion

        Type:
        :   float in [-inf, inf], default 0.0

    brown\_p2[¶](#bpy.types.MovieTrackingCamera.brown_p2 "Link to this definition")
    :   Second coefficient of second order Brown-Conrady tangential distortion

        Type:
        :   float in [-inf, inf], default 0.0

    distortion\_model[¶](#bpy.types.MovieTrackingCamera.distortion_model "Link to this definition")
    ...
    division\_k1[¶](#bpy.types.MovieTrackingCamera.division_k1 "Link to this definition")
    :   First coefficient of second order division distortion

        Type:
        :   float in [-inf, inf], default 0.0

    division\_k2[¶](#bpy.types.MovieTrackingCamera.division_k2 "Link to this definition")
    :   Second coefficient of second order division distortion

        Type:
        :   float in [-inf, inf], default 0.0

    focal\_length[¶](#bpy.types.MovieTrackingCamera.focal_length "Link to this definition")
    :   Camera’s focal length

        Type:
        :   float in [0.0001, inf], default 0.0

    focal\_length\_pixels[¶](#bpy.types.MovieTrackingCamera.focal_length_pixels "Link to this definition")
    :   Camera’s focal length

        Type:
        :   float in [0, inf], default 0.0

    k1[¶](#bpy.types.MovieTrackingCamera.k1 "Link to this definition")
    :   First coefficient of third order polynomial radial distortion

        Type:
        :   float in [-inf, inf], default 0.0

    k2[¶](#bpy.types.MovieTrackingCamera.k2 "Link to this definition")
    :   Second coefficient of third order polynomial radial distortion

        Type:
        :   float in [-inf, inf], default 0.0

    k3[¶](#bpy.types.MovieTrackingCamera.k3 "Link to this definition")
    :   Third coefficient of third order polynomial radial distortion

        Type:
        :   float in [-inf, inf], default 0.0

    nuke\_k1[¶](#bpy.types.MovieTrackingCamera.nuke_k1 "Link to this definition")
    :   First coefficient of second order Nuke distortion

        Type:
        :   float in [-inf, inf], default 0.0

    nuke\_k2[¶](#bpy.types.MovieTrackingCamera.nuke_k2 "Link to this definition")
    :   Second coefficient of second order Nuke distortion

        Type:
        :   float in [-inf, inf], default 0.0

    pixel\_aspect[¶](#bpy.types.MovieTrackingCamera.pixel_aspect "Link to this definition")
    :   Pixel aspect ratio

        Type:
        :   float in [0.1, inf], default 1.0

    principal\_point[¶](#bpy.types.MovieTrackingCamera.principal_point "Link to this definition")
    :   Optical center of lens

        Type:
        :   float array of 2 items in [-1, 1], default (0.0, 0.0)

    principal\_point\_pixels[¶](#bpy.types.MovieTrackingCamera.principal_point_pixels "Link to this definition")
    :   Optical center of lens in pixels

        Type:
        :   float array of 2 items in [-inf, inf], default (0.0, 0.0)

    sensor\_width[¶](#bpy.types.MovieTrackingCamera.sensor_width "Link to this definition")
    :   Width of CCD sensor in millimeters

        Type:
        :   float in [0, 500], default 0.0

    units[¶](#bpy.types.MovieTrackingCamera.units "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.MovieTrackingCamera.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.MovieTrackingCamera.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`MovieTracking.camera`](MovieTracking.md#bpy.types.MovieTracking.camera "bpy.types.MovieTracking.camera") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.MovieTrackingCamera.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.MovieTrackingCamera.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* MovieTrackingCamera(bpy\_struct)
  + [`MovieTrackingCamera`](#bpy.types.MovieTrackingCamera)
    - [`MovieTrackingCamera.brown_k1`](#bpy.types.MovieTrackingCamera.brown_k1)
    - [`MovieTrackingCamera.brown_k2`](#bpy.types.MovieTrackingCamera.brown_k2)
    - [`MovieTrackingCamera.brown_k3`](#bpy.types.MovieTrackingCamera.brown_k3)
    - [`MovieTrackingCamera.brown_k4`](#bpy.types.MovieTrackingCamera.brown_k4)
    - [`MovieTrackingCamera.brown_p1`](#bpy.types.MovieTrackingCamera.brown_p1)
    - [`MovieTrackingCamera.brown_p2`](#bpy.types.MovieTrackingCamera.brown_p2)
    - [`MovieTrackingCamera.distortion_model`](#bpy.types.MovieTrackingCamera.distortion_model)
    - [`MovieTrackingCamera.division_k1`](#bpy.types.MovieTrackingCamera.division_k1)
    - [`MovieTrackingCamera.division_k2`](#bpy.types.MovieTrackingCamera.division_k2)
    - [`MovieTrackingCamera.focal_length`](#bpy.types.MovieTrackingCamera.focal_length)
    - [`MovieTrackingCamera.focal_length_pixels`](#bpy.types.MovieTrackingCamera.focal_length_pixels)
    - [`MovieTrackingCamera.k1`](#bpy.types.MovieTrackingCamera.k1)
    - [`MovieTrackingCamera.k2`](#bpy.types.MovieTrackingCamera.k2)
    - [`MovieTrackingCamera.k3`](#bpy.types.MovieTrackingCamera.k3)
    - [`MovieTrackingCamera.nuke_k1`](#bpy.types.MovieTrackingCamera.nuke_k1)
    - [`MovieTrackingCamera.nuke_k2`](#bpy.types.MovieTrackingCamera.nuke_k2)
    - [`MovieTrackingCamera.pixel_aspect`](#bpy.types.MovieTrackingCamera.pixel_aspect)
    - [`MovieTrackingCamera.principal_point`](#bpy.types.MovieTrackingCamera.principal_point)
    - [`MovieTrackingCamera.principal_point_pixels`](#bpy.types.MovieTrackingCamera.principal_point_pixels)
    - [`MovieTrackingCamera.sensor_width`](#bpy.types.MovieTrackingCamera.sensor_width)
    - [`MovieTrackingCamera.units`](#bpy.types.MovieTrackingCamera.units)
    - [`MovieTrackingCamera.bl_rna_get_subclass()`](#bpy.types.MovieTrackingCamera.bl_rna_get_subclass)
    - [`MovieTrackingCamera.bl_rna_get_subclass_py()`](#bpy.types.MovieTrackingCamera.bl_rna_get_subclass_py)
