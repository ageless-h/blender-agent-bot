...
# BlendDataTexts(bpy\_struct)[¶](#blenddatatexts-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.BlendDataTexts(*bpy\_struct*)[¶](#bpy.types.BlendDataTexts "Link to this definition")
:   Collection of texts

    new(*name*)[¶](#bpy.types.BlendDataTexts.new "Link to this definition")
    ...
    remove(*text*, *\**, *do\_unlink=True*, *do\_id\_user=True*, *do\_ui\_user=True*)[¶](#bpy.types.BlendDataTexts.remove "Link to this definition")
    :   Remove a text from the current blendfile

        Parameters:
        :   * **text** ([`Text`](Text.md#bpy.types.Text "bpy.types.Text"), (never None)) – Text to remove
            * **do\_unlink** (*boolean**,* *(**optional**)*) – Unlink all usages of this text before deleting it
            * **do\_id\_user** (*boolean**,* *(**optional**)*) – Decrement user counter of all data-blocks used by this text
            * **do\_ui\_user** (*boolean**,* *(**optional**)*) – Make sure interface does not reference this text

    load(*filepath*, *\**, *internal=False*)[¶](#bpy.types.BlendDataTexts.load "Link to this definition")
    ...
    tag(*value*)[¶](#bpy.types.BlendDataTexts.tag "Link to this definition")
    :   tag

        Parameters:
        :   **value** (*boolean*) – Value

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.BlendDataTexts.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.BlendDataTexts.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`BlendData.texts`](BlendData.md#bpy.types.BlendData.texts "bpy.types.BlendData.texts") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.BlendDataTexts.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.BlendDataTexts.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* BlendDataTexts(bpy\_struct)
  + [`BlendDataTexts`](#bpy.types.BlendDataTexts)
    - [`BlendDataTexts.new()`](#bpy.types.BlendDataTexts.new)
    - [`BlendDataTexts.remove()`](#bpy.types.BlendDataTexts.remove)
    - [`BlendDataTexts.load()`](#bpy.types.BlendDataTexts.load)
    - [`BlendDataTexts.tag()`](#bpy.types.BlendDataTexts.tag)
    - [`BlendDataTexts.bl_rna_get_subclass()`](#bpy.types.BlendDataTexts.bl_rna_get_subclass)
    - [`BlendDataTexts.bl_rna_get_subclass_py()`](#bpy.types.BlendDataTexts.bl_rna_get_subclass_py)
