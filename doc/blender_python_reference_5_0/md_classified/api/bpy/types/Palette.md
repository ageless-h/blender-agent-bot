...
# Palette(ID)[¶](#palette-id "Link to this heading")

base classes — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct"), [`ID`](ID.md#bpy.types.ID "bpy.types.ID")

*class* bpy.types.Palette(*ID*)[¶](#bpy.types.Palette "Link to this definition")
:   colors[¶](#bpy.types.Palette.colors "Link to this definition")
    :   Type:
        :   [`PaletteColors`](PaletteColors.md#bpy.types.PaletteColors "bpy.types.PaletteColors") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`PaletteColor`](PaletteColor.md#bpy.types.PaletteColor "bpy.types.PaletteColor"), (readonly)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.Palette.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.Palette.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`BlendData.palettes`](BlendData.md#bpy.types.BlendData.palettes "bpy.types.BlendData.palettes") * [`BlendDataPalettes.new`](BlendDataPalettes.md#bpy.types.BlendDataPalettes.new "bpy.types.BlendDataPalettes.new") | * [`BlendDataPalettes.remove`](BlendDataPalettes.md#bpy.types.BlendDataPalettes.remove "bpy.types.BlendDataPalettes.remove") * [`Paint.palette`](Paint.md#bpy.types.Paint.palette "bpy.types.Paint.palette") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.Palette.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.Palette.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* Palette(ID)
  + [`Palette`](#bpy.types.Palette)
    - [`Palette.colors`](#bpy.types.Palette.colors)
    - [`Palette.bl_rna_get_subclass()`](#bpy.types.Palette.bl_rna_get_subclass)
    - [`Palette.bl_rna_get_subclass_py()`](#bpy.types.Palette.bl_rna_get_subclass_py)
