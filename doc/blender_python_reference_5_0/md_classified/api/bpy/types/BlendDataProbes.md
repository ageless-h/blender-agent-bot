...
# BlendDataProbes(bpy\_struct)[¶](#blenddataprobes-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.BlendDataProbes(*bpy\_struct*)[¶](#bpy.types.BlendDataProbes "Link to this definition")
:   Collection of light probes

    new(*name*, *type*)[¶](#bpy.types.BlendDataProbes.new "Link to this definition")
    :   Add a new light probe to the main database

        Parameters:
        :   * **name** (*string**,* *(**never None**)*) – New name for the data-block
            * **type** (enum in [Lightprobes Type Items](../../../appendix/bpy_types_enum_items/lightprobes_type_items.md#rna-enum-lightprobes-type-items)) – Type, The type of light probe to add

        Returns:
        :   New light probe data-block

        Return type:
        :   [`LightProbe`](LightProbe.md#bpy.types.LightProbe "bpy.types.LightProbe")

    remove(*lightprobe*, *\**, *do\_unlink=True*, *do\_id\_user=True*, *do\_ui\_user=True*)[¶](#bpy.types.BlendDataProbes.remove "Link to this definition")
    :   Remove a light probe from the current blendfile

        Parameters:
        :   * **lightprobe** ([`LightProbe`](LightProbe.md#bpy.types.LightProbe "bpy.types.LightProbe"), (never None)) – Light probe to remove
            * **do\_unlink** (*boolean**,* *(**optional**)*) – Unlink all usages of this light probe before deleting it (WARNING: will also delete objects instancing that light probe data)
            * **do\_id\_user** (*boolean**,* *(**optional**)*) – Decrement user counter of all data-blocks used by this light probe
            * **do\_ui\_user** (*boolean**,* *(**optional**)*) – Make sure interface does not reference this light probe

    tag(*value*)[¶](#bpy.types.BlendDataProbes.tag "Link to this definition")
    :   tag

        Parameters:
        :   **value** (*boolean*) – Value

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.BlendDataProbes.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.BlendDataProbes.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`BlendData.lightprobes`](BlendData.md#bpy.types.BlendData.lightprobes "bpy.types.BlendData.lightprobes") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.BlendDataProbes.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.BlendDataProbes.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* BlendDataProbes(bpy\_struct)
  + [`BlendDataProbes`](#bpy.types.BlendDataProbes)
    - [`BlendDataProbes.new()`](#bpy.types.BlendDataProbes.new)
    - [`BlendDataProbes.remove()`](#bpy.types.BlendDataProbes.remove)
    - [`BlendDataProbes.tag()`](#bpy.types.BlendDataProbes.tag)
    - [`BlendDataProbes.bl_rna_get_subclass()`](#bpy.types.BlendDataProbes.bl_rna_get_subclass)
    - [`BlendDataProbes.bl_rna_get_subclass_py()`](#bpy.types.BlendDataProbes.bl_rna_get_subclass_py)
