...
# SpaceNodeEditorPath(bpy\_struct)[¶](#spacenodeeditorpath-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.SpaceNodeEditorPath(*bpy\_struct*)[¶](#bpy.types.SpaceNodeEditorPath "Link to this definition")
:   Get the node tree path as a string

    to\_string[¶](#bpy.types.SpaceNodeEditorPath.to_string "Link to this definition")
    :   Type:
        :   string, default “”, (readonly, never None)

    clear()[¶](#bpy.types.SpaceNodeEditorPath.clear "Link to this definition")
    :   Reset the node tree path

    start(*node\_tree*)[¶](#bpy.types.SpaceNodeEditorPath.start "Link to this definition")
    :   Set the root node tree

        Parameters:
        :   **node\_tree** ([`NodeTree`](NodeTree.md#bpy.types.NodeTree "bpy.types.NodeTree")) – Node Tree

    append(*node\_tree*, *\**, *node=None*)[¶](#bpy.types.SpaceNodeEditorPath.append "Link to this definition")
    :   Append a node group tree to the path

        Parameters:
        :   * **node\_tree** ([`NodeTree`](NodeTree.md#bpy.types.NodeTree "bpy.types.NodeTree")) – Node Tree, Node tree to append to the node editor path
            * **node** ([`Node`](Node.md#bpy.types.Node "bpy.types.Node"), (optional)) – Node, Group node linking to this node tree

    pop()[¶](#bpy.types.SpaceNodeEditorPath.pop "Link to this definition")
    :   Remove the last node tree from the path

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.SpaceNodeEditorPath.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.SpaceNodeEditorPath.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`SpaceNodeEditor.path`](SpaceNodeEditor.md#bpy.types.SpaceNodeEditor.path "bpy.types.SpaceNodeEditor.path") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.SpaceNodeEditorPath.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.SpaceNodeEditorPath.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* SpaceNodeEditorPath(bpy\_struct)
  + [`SpaceNodeEditorPath`](#bpy.types.SpaceNodeEditorPath)
    - [`SpaceNodeEditorPath.to_string`](#bpy.types.SpaceNodeEditorPath.to_string)
    - [`SpaceNodeEditorPath.clear()`](#bpy.types.SpaceNodeEditorPath.clear)
    - [`SpaceNodeEditorPath.start()`](#bpy.types.SpaceNodeEditorPath.start)
    - [`SpaceNodeEditorPath.append()`](#bpy.types.SpaceNodeEditorPath.append)
    - [`SpaceNodeEditorPath.pop()`](#bpy.types.SpaceNodeEditorPath.pop)
    - [`SpaceNodeEditorPath.bl_rna_get_subclass()`](#bpy.types.SpaceNodeEditorPath.bl_rna_get_subclass)
    - [`SpaceNodeEditorPath.bl_rna_get_subclass_py()`](#bpy.types.SpaceNodeEditorPath.bl_rna_get_subclass_py)
