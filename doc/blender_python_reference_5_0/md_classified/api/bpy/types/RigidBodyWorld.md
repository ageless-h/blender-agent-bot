...
# RigidBodyWorld(bpy\_struct)[¶](#rigidbodyworld-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.RigidBodyWorld(*bpy\_struct*)[¶](#bpy.types.RigidBodyWorld "Link to this definition")
:   Self-contained rigid body simulation environment and settings

    collection[¶](#bpy.types.RigidBodyWorld.collection "Link to this definition")
    ...
    constraints[¶](#bpy.types.RigidBodyWorld.constraints "Link to this definition")
    :   Collection containing rigid body constraint objects

        Type:
        :   [`Collection`](Collection.md#bpy.types.Collection "bpy.types.Collection")

    effector\_weights[¶](#bpy.types.RigidBodyWorld.effector_weights "Link to this definition")
    :   Type:
        :   [`EffectorWeights`](EffectorWeights.md#bpy.types.EffectorWeights "bpy.types.EffectorWeights"), (readonly)

    enabled[¶](#bpy.types.RigidBodyWorld.enabled "Link to this definition")
    :   Simulation will be evaluated

        Type:
        :   boolean, default False

    point\_cache[¶](#bpy.types.RigidBodyWorld.point_cache "Link to this definition")
    :   Type:
        :   [`PointCache`](PointCache.md#bpy.types.PointCache "bpy.types.PointCache"), (readonly, never None)

    solver\_iterations[¶](#bpy.types.RigidBodyWorld.solver_iterations "Link to this definition")
    ...
    substeps\_per\_frame[¶](#bpy.types.RigidBodyWorld.substeps_per_frame "Link to this definition")
    :   Number of simulation steps taken per frame (higher values are more accurate but slower)

        Type:
        :   int in [1, 32767], default 10

    time\_scale[¶](#bpy.types.RigidBodyWorld.time_scale "Link to this definition")
    :   Change the speed of the simulation

        Type:
        :   float in [0, 100], default 1.0

    use\_split\_impulse[¶](#bpy.types.RigidBodyWorld.use_split_impulse "Link to this definition")
    ...
    convex\_sweep\_test(*object*, *start*, *end*)[¶](#bpy.types.RigidBodyWorld.convex_sweep_test "Link to this definition")
    :   Sweep test convex rigidbody against the current rigidbody world

        Parameters:
        :   **object** ([`Object`](Object.md#bpy.types.Object "bpy.types.Object"), (never None)) – Rigidbody object with a convex collision shape

        Returns:
        :   `object_location`, The hit location of this sweep test, [`mathutils.Vector`](../../mathutils/index.md#mathutils.Vector "mathutils.Vector") of 3 items in [-inf, inf]

            `hitpoint`, The hit location of this sweep test, [`mathutils.Vector`](../../mathutils/index.md#mathutils.Vector "mathutils.Vector") of 3 items in [-inf, inf]

            `normal`, The face normal at the sweep test hit location, [`mathutils.Vector`](../../mathutils/index.md#mathutils.Vector "mathutils.Vector") of 3 items in [-inf, inf]

            `has_hit`, If the function has found collision point, value is 1, otherwise 0, int in [-inf, inf]

        Return type:
        :   ([`mathutils.Vector`](../../mathutils/index.md#mathutils.Vector "mathutils.Vector") of 3 items in [-inf, inf], [`mathutils.Vector`](../../mathutils/index.md#mathutils.Vector "mathutils.Vector") of 3 items in [-inf, inf], [`mathutils.Vector`](../../mathutils/index.md#mathutils.Vector "mathutils.Vector") of 3 items in [-inf, inf], int in [-inf, inf])

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.RigidBodyWorld.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.RigidBodyWorld.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Scene.rigidbody_world`](Scene.md#bpy.types.Scene.rigidbody_world "bpy.types.Scene.rigidbody_world") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.RigidBodyWorld.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.RigidBodyWorld.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* RigidBodyWorld(bpy\_struct)
  + [`RigidBodyWorld`](#bpy.types.RigidBodyWorld)
    - [`RigidBodyWorld.collection`](#bpy.types.RigidBodyWorld.collection)
    - [`RigidBodyWorld.constraints`](#bpy.types.RigidBodyWorld.constraints)
    - [`RigidBodyWorld.effector_weights`](#bpy.types.RigidBodyWorld.effector_weights)
    - [`RigidBodyWorld.enabled`](#bpy.types.RigidBodyWorld.enabled)
    - [`RigidBodyWorld.point_cache`](#bpy.types.RigidBodyWorld.point_cache)
    - [`RigidBodyWorld.solver_iterations`](#bpy.types.RigidBodyWorld.solver_iterations)
    - [`RigidBodyWorld.substeps_per_frame`](#bpy.types.RigidBodyWorld.substeps_per_frame)
    - [`RigidBodyWorld.time_scale`](#bpy.types.RigidBodyWorld.time_scale)
    - [`RigidBodyWorld.use_split_impulse`](#bpy.types.RigidBodyWorld.use_split_impulse)
    - [`RigidBodyWorld.convex_sweep_test()`](#bpy.types.RigidBodyWorld.convex_sweep_test)
    - [`RigidBodyWorld.bl_rna_get_subclass()`](#bpy.types.RigidBodyWorld.bl_rna_get_subclass)
    - [`RigidBodyWorld.bl_rna_get_subclass_py()`](#bpy.types.RigidBodyWorld.bl_rna_get_subclass_py)
