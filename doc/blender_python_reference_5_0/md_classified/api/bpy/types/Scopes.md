...
# Scopes(bpy\_struct)[¶](#scopes-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.Scopes(*bpy\_struct*)[¶](#bpy.types.Scopes "Link to this definition")
:   Scopes for statistical view of an image

    accuracy[¶](#bpy.types.Scopes.accuracy "Link to this definition")
    :   Proportion of original image source pixel lines to sample

        Type:
        :   float in [0, 100], default 0.0

    histogram[¶](#bpy.types.Scopes.histogram "Link to this definition")
    :   Histogram for viewing image statistics

        Type:
        :   [`Histogram`](Histogram.md#bpy.types.Histogram "bpy.types.Histogram"), (readonly)

    use\_full\_resolution[¶](#bpy.types.Scopes.use_full_resolution "Link to this definition")
    :   Sample every pixel of the image

        Type:
        :   boolean, default False

    vectorscope\_alpha[¶](#bpy.types.Scopes.vectorscope_alpha "Link to this definition")
    :   Opacity of the points

        Type:
        :   float in [0, 1], default 0.0

    vectorscope\_mode[¶](#bpy.types.Scopes.vectorscope_mode "Link to this definition")
    :   Type:
        :   enum in [`'LUMA'`, `'RGB'`], default `'RGB'`

    waveform\_alpha[¶](#bpy.types.Scopes.waveform_alpha "Link to this definition")
    :   Opacity of the points

        Type:
        :   float in [0, 1], default 0.0

    waveform\_mode[¶](#bpy.types.Scopes.waveform_mode "Link to this definition")
    :   Type:
        :   enum in [`'LUMA'`, `'PARADE'`, `'YCBCR601'`, `'YCBCR709'`, `'YCBCRJPG'`, `'RGB'`], default `'LUMA'`

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.Scopes.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.Scopes.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`SpaceImageEditor.scopes`](SpaceImageEditor.md#bpy.types.SpaceImageEditor.scopes "bpy.types.SpaceImageEditor.scopes") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.Scopes.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.Scopes.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* Scopes(bpy\_struct)
  + [`Scopes`](#bpy.types.Scopes)
    - [`Scopes.accuracy`](#bpy.types.Scopes.accuracy)
    - [`Scopes.histogram`](#bpy.types.Scopes.histogram)
    - [`Scopes.use_full_resolution`](#bpy.types.Scopes.use_full_resolution)
    - [`Scopes.vectorscope_alpha`](#bpy.types.Scopes.vectorscope_alpha)
    - [`Scopes.vectorscope_mode`](#bpy.types.Scopes.vectorscope_mode)
    - [`Scopes.waveform_alpha`](#bpy.types.Scopes.waveform_alpha)
    - [`Scopes.waveform_mode`](#bpy.types.Scopes.waveform_mode)
    - [`Scopes.bl_rna_get_subclass()`](#bpy.types.Scopes.bl_rna_get_subclass)
    - [`Scopes.bl_rna_get_subclass_py()`](#bpy.types.Scopes.bl_rna_get_subclass_py)
