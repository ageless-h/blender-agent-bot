...
# AttributeGroupMesh(bpy\_struct)[¶](#attributegroupmesh-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.AttributeGroupMesh(*bpy\_struct*)[¶](#bpy.types.AttributeGroupMesh "Link to this definition")
:   Group of geometry attributes

    active[¶](#bpy.types.AttributeGroupMesh.active "Link to this definition")
    :   Active attribute

        Type:
        :   [`Attribute`](Attribute.md#bpy.types.Attribute "bpy.types.Attribute")

    active\_color[¶](#bpy.types.AttributeGroupMesh.active_color "Link to this definition")
    :   Active color attribute for display and editing

        Type:
        :   [`Attribute`](Attribute.md#bpy.types.Attribute "bpy.types.Attribute")

    active\_color\_index[¶](#bpy.types.AttributeGroupMesh.active_color_index "Link to this definition")
    :   Active color attribute index

        Type:
        :   int in [-inf, inf], default 0

    active\_color\_name[¶](#bpy.types.AttributeGroupMesh.active_color_name "Link to this definition")
    :   The name of the active color attribute for display and editing

        Type:
        :   string, default “”, (never None)

    active\_index[¶](#bpy.types.AttributeGroupMesh.active_index "Link to this definition")
    :   Active attribute index or -1 when none are active

        Type:
        :   int in [-1, inf], default 0

    default\_color\_name[¶](#bpy.types.AttributeGroupMesh.default_color_name "Link to this definition")
    :   The name of the default color attribute used as a fallback for rendering

        Type:
        :   string, default “”, (never None)

    render\_color\_index[¶](#bpy.types.AttributeGroupMesh.render_color_index "Link to this definition")
    :   The index of the color attribute used as a fallback for rendering

        Type:
        :   int in [-inf, inf], default 0

    new(*name*, *type*, *domain*)[¶](#bpy.types.AttributeGroupMesh.new "Link to this definition")
    :   Add attribute to geometry

        Parameters:
        :   * **name** (*string**,* *(**never None**)*) – Name, Name of geometry attribute
            * **type** (enum in [Attribute Type Items](../../../appendix/bpy_types_enum_items/attribute_type_items.md#rna-enum-attribute-type-items)) – Type, Attribute type
            * **domain** (enum in [Attribute Domain Items](../../../appendix/bpy_types_enum_items/attribute_domain_items.md#rna-enum-attribute-domain-items)) – Domain, Type of element that attribute is stored on
    ...
    remove(*attribute*)[¶](#bpy.types.AttributeGroupMesh.remove "Link to this definition")
    :   Remove attribute from geometry

        Parameters:
        :   **attribute** ([`Attribute`](Attribute.md#bpy.types.Attribute "bpy.types.Attribute"), (never None)) – Geometry Attribute

    domain\_size(*domain*)[¶](#bpy.types.AttributeGroupMesh.domain_size "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.AttributeGroupMesh.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.AttributeGroupMesh.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Mesh.attributes`](Mesh.md#bpy.types.Mesh.attributes "bpy.types.Mesh.attributes") | * [`Mesh.color_attributes`](Mesh.md#bpy.types.Mesh.color_attributes "bpy.types.Mesh.color_attributes") |
...
AttributeGroupGreasePencilDrawing(bpy\_struct)](AttributeGroupGreasePencilDrawing.md)
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.AttributeGroupMesh.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.AttributeGroupMesh.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* AttributeGroupMesh(bpy\_struct)
  + [`AttributeGroupMesh`](#bpy.types.AttributeGroupMesh)
    - [`AttributeGroupMesh.active`](#bpy.types.AttributeGroupMesh.active)
    - [`AttributeGroupMesh.active_color`](#bpy.types.AttributeGroupMesh.active_color)
    - [`AttributeGroupMesh.active_color_index`](#bpy.types.AttributeGroupMesh.active_color_index)
    - [`AttributeGroupMesh.active_color_name`](#bpy.types.AttributeGroupMesh.active_color_name)
    - [`AttributeGroupMesh.active_index`](#bpy.types.AttributeGroupMesh.active_index)
    - [`AttributeGroupMesh.default_color_name`](#bpy.types.AttributeGroupMesh.default_color_name)
    - [`AttributeGroupMesh.render_color_index`](#bpy.types.AttributeGroupMesh.render_color_index)
    - [`AttributeGroupMesh.new()`](#bpy.types.AttributeGroupMesh.new)
    - [`AttributeGroupMesh.remove()`](#bpy.types.AttributeGroupMesh.remove)
    - [`AttributeGroupMesh.domain_size()`](#bpy.types.AttributeGroupMesh.domain_size)
    - [`AttributeGroupMesh.bl_rna_get_subclass()`](#bpy.types.AttributeGroupMesh.bl_rna_get_subclass)
    - [`AttributeGroupMesh.bl_rna_get_subclass_py()`](#bpy.types.AttributeGroupMesh.bl_rna_get_subclass_py)
