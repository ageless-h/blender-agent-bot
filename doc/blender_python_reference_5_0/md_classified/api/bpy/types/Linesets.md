...
# Linesets(bpy\_struct)[¶](#linesets-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.Linesets(*bpy\_struct*)[¶](#bpy.types.Linesets "Link to this definition")
:   Line sets for associating lines and style parameters

    active[¶](#bpy.types.Linesets.active "Link to this definition")
    :   Active line set being displayed

        Type:
        :   [`FreestyleLineSet`](FreestyleLineSet.md#bpy.types.FreestyleLineSet "bpy.types.FreestyleLineSet"), (readonly)

    active\_index[¶](#bpy.types.Linesets.active_index "Link to this definition")
    :   Index of active line set slot

        Type:
        :   int in [0, inf], default 0

    new(*name*)[¶](#bpy.types.Linesets.new "Link to this definition")
    :   Add a line set to scene render layer Freestyle settings
        ...
        Return type:
        :   [`FreestyleLineSet`](FreestyleLineSet.md#bpy.types.FreestyleLineSet "bpy.types.FreestyleLineSet")

    remove(*lineset*)[¶](#bpy.types.Linesets.remove "Link to this definition")
    :   Remove a line set from scene render layer Freestyle settings

        Parameters:
        :   **lineset** ([`FreestyleLineSet`](FreestyleLineSet.md#bpy.types.FreestyleLineSet "bpy.types.FreestyleLineSet"), (never None)) – Line set to remove

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.Linesets.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.Linesets.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`FreestyleSettings.linesets`](FreestyleSettings.md#bpy.types.FreestyleSettings.linesets "bpy.types.FreestyleSettings.linesets") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.Linesets.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.Linesets.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* Linesets(bpy\_struct)
  + [`Linesets`](#bpy.types.Linesets)
    - [`Linesets.active`](#bpy.types.Linesets.active)
    - [`Linesets.active_index`](#bpy.types.Linesets.active_index)
    - [`Linesets.new()`](#bpy.types.Linesets.new)
    - [`Linesets.remove()`](#bpy.types.Linesets.remove)
    - [`Linesets.bl_rna_get_subclass()`](#bpy.types.Linesets.bl_rna_get_subclass)
    - [`Linesets.bl_rna_get_subclass_py()`](#bpy.types.Linesets.bl_rna_get_subclass_py)
