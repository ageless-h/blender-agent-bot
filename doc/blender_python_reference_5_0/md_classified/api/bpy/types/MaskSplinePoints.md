...
# MaskSplinePoints(bpy\_struct)[¶](#masksplinepoints-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.MaskSplinePoints(*bpy\_struct*)[¶](#bpy.types.MaskSplinePoints "Link to this definition")
:   Collection of masking spline points

    add(*count*)[¶](#bpy.types.MaskSplinePoints.add "Link to this definition")
    :   Add a number of point to this spline

        Parameters:
        :   **count** (*int in* *[**0**,* *inf**]*) – Number, Number of points to add to the spline

    remove(*point*)[¶](#bpy.types.MaskSplinePoints.remove "Link to this definition")
    :   Remove a point from a spline

        Parameters:
        :   **point** ([`MaskSplinePoint`](MaskSplinePoint.md#bpy.types.MaskSplinePoint "bpy.types.MaskSplinePoint"), (never None)) – The point to remove

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.MaskSplinePoints.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.MaskSplinePoints.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`MaskSpline.points`](MaskSpline.md#bpy.types.MaskSpline.points "bpy.types.MaskSpline.points") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.MaskSplinePoints.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.MaskSplinePoints.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* MaskSplinePoints(bpy\_struct)
  + [`MaskSplinePoints`](#bpy.types.MaskSplinePoints)
    - [`MaskSplinePoints.add()`](#bpy.types.MaskSplinePoints.add)
    - [`MaskSplinePoints.remove()`](#bpy.types.MaskSplinePoints.remove)
    - [`MaskSplinePoints.bl_rna_get_subclass()`](#bpy.types.MaskSplinePoints.bl_rna_get_subclass)
    - [`MaskSplinePoints.bl_rna_get_subclass_py()`](#bpy.types.MaskSplinePoints.bl_rna_get_subclass_py)
