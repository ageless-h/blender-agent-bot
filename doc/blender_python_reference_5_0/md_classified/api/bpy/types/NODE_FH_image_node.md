...
# NODE\_FH\_image\_node(FileHandler)[¶](#node-fh-image-node-filehandler "Link to this heading")
...
*class* bpy.types.NODE\_FH\_image\_node(*FileHandler*)[¶](#bpy.types.NODE_FH_image_node "Link to this definition")
:   *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.NODE_FH_image_node.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.NODE_FH_image_node.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
NODE\_AST\_compositor(AssetShelf)](NODE_AST_compositor.md)
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.NODE_FH_image_node.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.NODE_FH_image_node.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* NODE\_FH\_image\_node(FileHandler)
  + [`NODE_FH_image_node`](#bpy.types.NODE_FH_image_node)
    - [`NODE_FH_image_node.bl_rna_get_subclass()`](#bpy.types.NODE_FH_image_node.bl_rna_get_subclass)
    - [`NODE_FH_image_node.bl_rna_get_subclass_py()`](#bpy.types.NODE_FH_image_node.bl_rna_get_subclass_py)
