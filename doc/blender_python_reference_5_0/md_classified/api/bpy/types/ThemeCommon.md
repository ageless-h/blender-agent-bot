...
# ThemeCommon(bpy\_struct)[¶](#themecommon-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.ThemeCommon(*bpy\_struct*)[¶](#bpy.types.ThemeCommon "Link to this definition")
:   Theme properties shared by different editors

    anim[¶](#bpy.types.ThemeCommon.anim "Link to this definition")
    :   Type:
        :   [`ThemeCommonAnim`](ThemeCommonAnim.md#bpy.types.ThemeCommonAnim "bpy.types.ThemeCommonAnim"), (readonly, never None)

    curves[¶](#bpy.types.ThemeCommon.curves "Link to this definition")
    :   Type:
        :   [`ThemeCommonCurves`](ThemeCommonCurves.md#bpy.types.ThemeCommonCurves "bpy.types.ThemeCommonCurves"), (readonly, never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ThemeCommon.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ThemeCommon.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Theme.common`](Theme.md#bpy.types.Theme.common "bpy.types.Theme.common") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ThemeCommon.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ThemeCommon.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ThemeCommon(bpy\_struct)
  + [`ThemeCommon`](#bpy.types.ThemeCommon)
    - [`ThemeCommon.anim`](#bpy.types.ThemeCommon.anim)
    - [`ThemeCommon.curves`](#bpy.types.ThemeCommon.curves)
    - [`ThemeCommon.bl_rna_get_subclass()`](#bpy.types.ThemeCommon.bl_rna_get_subclass)
    - [`ThemeCommon.bl_rna_get_subclass_py()`](#bpy.types.ThemeCommon.bl_rna_get_subclass_py)
