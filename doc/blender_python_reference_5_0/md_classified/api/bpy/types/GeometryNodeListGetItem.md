...
# GeometryNodeListGetItem(GeometryNode)[¶](#geometrynodelistgetitem-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeListGetItem(*GeometryNode*)[¶](#bpy.types.GeometryNodeListGetItem "Link to this definition")
:   Retrieve a value from a list

    data\_type[¶](#bpy.types.GeometryNodeListGetItem.data_type "Link to this definition")
    :   Type:
    ...
    *classmethod* is\_registered\_node\_type()[¶](#bpy.types.GeometryNodeListGetItem.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[¶](#bpy.types.GeometryNodeListGetItem.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[¶](#bpy.types.GeometryNodeListGetItem.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.GeometryNodeListGetItem.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.GeometryNodeListGetItem.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
GeometryNodeListLength(GeometryNode)](GeometryNodeListLength.md)
[Previous

GeometryNodeList(GeometryNode)](GeometryNodeList.md)
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeListGetItem.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.GeometryNodeListGetItem.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeListGetItem(GeometryNode)
  + [`GeometryNodeListGetItem`](#bpy.types.GeometryNodeListGetItem)
    - [`GeometryNodeListGetItem.data_type`](#bpy.types.GeometryNodeListGetItem.data_type)
    - [`GeometryNodeListGetItem.is_registered_node_type()`](#bpy.types.GeometryNodeListGetItem.is_registered_node_type)
    - [`GeometryNodeListGetItem.input_template()`](#bpy.types.GeometryNodeListGetItem.input_template)
    - [`GeometryNodeListGetItem.output_template()`](#bpy.types.GeometryNodeListGetItem.output_template)
    - [`GeometryNodeListGetItem.bl_rna_get_subclass()`](#bpy.types.GeometryNodeListGetItem.bl_rna_get_subclass)
    - [`GeometryNodeListGetItem.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeListGetItem.bl_rna_get_subclass_py)
