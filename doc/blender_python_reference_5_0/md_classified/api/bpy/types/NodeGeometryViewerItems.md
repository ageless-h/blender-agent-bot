...
# NodeGeometryViewerItems(bpy\_struct)[¶](#nodegeometryvieweritems-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.NodeGeometryViewerItems(*bpy\_struct*)[¶](#bpy.types.NodeGeometryViewerItems "Link to this definition")
:   Collection of viewer items

    new(*socket\_type*, *name*)[¶](#bpy.types.NodeGeometryViewerItems.new "Link to this definition")
    ...
    remove(*item*)[¶](#bpy.types.NodeGeometryViewerItems.remove "Link to this definition")
    :   Remove an item

        Parameters:
        :   **item** ([`NodeGeometryViewerItem`](NodeGeometryViewerItem.md#bpy.types.NodeGeometryViewerItem "bpy.types.NodeGeometryViewerItem"), (never None)) – Item, The item to remove

    clear()[¶](#bpy.types.NodeGeometryViewerItems.clear "Link to this definition")
    :   Remove all items

    move(*from\_index*, *to\_index*)[¶](#bpy.types.NodeGeometryViewerItems.move "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.NodeGeometryViewerItems.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.NodeGeometryViewerItems.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`GeometryNodeViewer.viewer_items`](GeometryNodeViewer.md#bpy.types.GeometryNodeViewer.viewer_items "bpy.types.GeometryNodeViewer.viewer_items") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.NodeGeometryViewerItems.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.NodeGeometryViewerItems.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* NodeGeometryViewerItems(bpy\_struct)
  + [`NodeGeometryViewerItems`](#bpy.types.NodeGeometryViewerItems)
    - [`NodeGeometryViewerItems.new()`](#bpy.types.NodeGeometryViewerItems.new)
    - [`NodeGeometryViewerItems.remove()`](#bpy.types.NodeGeometryViewerItems.remove)
    - [`NodeGeometryViewerItems.clear()`](#bpy.types.NodeGeometryViewerItems.clear)
    - [`NodeGeometryViewerItems.move()`](#bpy.types.NodeGeometryViewerItems.move)
    - [`NodeGeometryViewerItems.bl_rna_get_subclass()`](#bpy.types.NodeGeometryViewerItems.bl_rna_get_subclass)
    - [`NodeGeometryViewerItems.bl_rna_get_subclass_py()`](#bpy.types.NodeGeometryViewerItems.bl_rna_get_subclass_py)
