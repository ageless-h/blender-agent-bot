...
# MovieTrackingObject(bpy\_struct)[¶](#movietrackingobject-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.MovieTrackingObject(*bpy\_struct*)[¶](#bpy.types.MovieTrackingObject "Link to this definition")
:   Match-moving object tracking and reconstruction data

    is\_camera[¶](#bpy.types.MovieTrackingObject.is_camera "Link to this definition")
    :   Object is used for camera tracking

        Type:
        :   boolean, default False, (readonly)

    keyframe\_a[¶](#bpy.types.MovieTrackingObject.keyframe_a "Link to this definition")
    :   First keyframe used for reconstruction initialization

        Type:
        :   int in [-inf, inf], default 0

    keyframe\_b[¶](#bpy.types.MovieTrackingObject.keyframe_b "Link to this definition")
    :   Second keyframe used for reconstruction initialization

        Type:
        :   int in [-inf, inf], default 0

    name[¶](#bpy.types.MovieTrackingObject.name "Link to this definition")
    :   Unique name of object

        Type:
        :   string, default “”, (never None)

    plane\_tracks[¶](#bpy.types.MovieTrackingObject.plane_tracks "Link to this definition")
    :   Collection of plane tracks in this tracking data object

        Type:
        :   [`MovieTrackingObjectPlaneTracks`](MovieTrackingObjectPlaneTracks.md#bpy.types.MovieTrackingObjectPlaneTracks "bpy.types.MovieTrackingObjectPlaneTracks") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`MovieTrackingPlaneTrack`](MovieTrackingPlaneTrack.md#bpy.types.MovieTrackingPlaneTrack "bpy.types.MovieTrackingPlaneTrack"), (readonly)

    reconstruction[¶](#bpy.types.MovieTrackingObject.reconstruction "Link to this definition")
    :   Type:
    ...
    scale[¶](#bpy.types.MovieTrackingObject.scale "Link to this definition")
    :   Scale of object solution in camera space

        Type:
        :   float in [0.0001, 10000], default 1.0

    tracks[¶](#bpy.types.MovieTrackingObject.tracks "Link to this definition")
    :   Collection of tracks in this tracking data object

        Type:
        :   [`MovieTrackingObjectTracks`](MovieTrackingObjectTracks.md#bpy.types.MovieTrackingObjectTracks "bpy.types.MovieTrackingObjectTracks") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`MovieTrackingTrack`](MovieTrackingTrack.md#bpy.types.MovieTrackingTrack "bpy.types.MovieTrackingTrack"), (readonly)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.MovieTrackingObject.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.MovieTrackingObject.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`MovieTracking.objects`](MovieTracking.md#bpy.types.MovieTracking.objects "bpy.types.MovieTracking.objects") * [`MovieTrackingObjects.active`](MovieTrackingObjects.md#bpy.types.MovieTrackingObjects.active "bpy.types.MovieTrackingObjects.active") | * [`MovieTrackingObjects.new`](MovieTrackingObjects.md#bpy.types.MovieTrackingObjects.new "bpy.types.MovieTrackingObjects.new") * [`MovieTrackingObjects.remove`](MovieTrackingObjects.md#bpy.types.MovieTrackingObjects.remove "bpy.types.MovieTrackingObjects.remove") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.MovieTrackingObject.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.MovieTrackingObject.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* MovieTrackingObject(bpy\_struct)
  + [`MovieTrackingObject`](#bpy.types.MovieTrackingObject)
    - [`MovieTrackingObject.is_camera`](#bpy.types.MovieTrackingObject.is_camera)
    - [`MovieTrackingObject.keyframe_a`](#bpy.types.MovieTrackingObject.keyframe_a)
    - [`MovieTrackingObject.keyframe_b`](#bpy.types.MovieTrackingObject.keyframe_b)
    - [`MovieTrackingObject.name`](#bpy.types.MovieTrackingObject.name)
    - [`MovieTrackingObject.plane_tracks`](#bpy.types.MovieTrackingObject.plane_tracks)
    - [`MovieTrackingObject.reconstruction`](#bpy.types.MovieTrackingObject.reconstruction)
    - [`MovieTrackingObject.scale`](#bpy.types.MovieTrackingObject.scale)
    - [`MovieTrackingObject.tracks`](#bpy.types.MovieTrackingObject.tracks)
    - [`MovieTrackingObject.bl_rna_get_subclass()`](#bpy.types.MovieTrackingObject.bl_rna_get_subclass)
    - [`MovieTrackingObject.bl_rna_get_subclass_py()`](#bpy.types.MovieTrackingObject.bl_rna_get_subclass_py)
