...
# wmOwnerIDs(bpy\_struct)[¶](#wmownerids-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.wmOwnerIDs(*bpy\_struct*)[¶](#bpy.types.wmOwnerIDs "Link to this definition")
:   new(*name*)[¶](#bpy.types.wmOwnerIDs.new "Link to this definition")
    :   Add ui tag

        Parameters:
        :   **name** (*string**,* *(**never None**)*) – New name for the tag

        Return type:
        :   [`wmOwnerID`](wmOwnerID.md#bpy.types.wmOwnerID "bpy.types.wmOwnerID")

    remove(*owner\_id*)[¶](#bpy.types.wmOwnerIDs.remove "Link to this definition")
    :   Remove ui tag

        Parameters:
        :   **owner\_id** ([`wmOwnerID`](wmOwnerID.md#bpy.types.wmOwnerID "bpy.types.wmOwnerID"), (never None)) – Tag to remove

    clear()[¶](#bpy.types.wmOwnerIDs.clear "Link to this definition")
    :   Remove all tags

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.wmOwnerIDs.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.wmOwnerIDs.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`WorkSpace.owner_ids`](WorkSpace.md#bpy.types.WorkSpace.owner_ids "bpy.types.WorkSpace.owner_ids") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.wmOwnerIDs.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.wmOwnerIDs.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* wmOwnerIDs(bpy\_struct)
  + [`wmOwnerIDs`](#bpy.types.wmOwnerIDs)
    - [`wmOwnerIDs.new()`](#bpy.types.wmOwnerIDs.new)
    - [`wmOwnerIDs.remove()`](#bpy.types.wmOwnerIDs.remove)
    - [`wmOwnerIDs.clear()`](#bpy.types.wmOwnerIDs.clear)
    - [`wmOwnerIDs.bl_rna_get_subclass()`](#bpy.types.wmOwnerIDs.bl_rna_get_subclass)
    - [`wmOwnerIDs.bl_rna_get_subclass_py()`](#bpy.types.wmOwnerIDs.bl_rna_get_subclass_py)
