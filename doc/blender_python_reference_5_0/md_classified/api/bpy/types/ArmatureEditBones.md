...
# ArmatureEditBones(bpy\_struct)[¶](#armatureeditbones-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.ArmatureEditBones(*bpy\_struct*)[¶](#bpy.types.ArmatureEditBones "Link to this definition")
:   Collection of armature edit bones

    active[¶](#bpy.types.ArmatureEditBones.active "Link to this definition")
    :   Armatures active edit bone

        Type:
        :   [`EditBone`](EditBone.md#bpy.types.EditBone "bpy.types.EditBone")

    new(*name*)[¶](#bpy.types.ArmatureEditBones.new "Link to this definition")
    :   Add a new bone
    ...
    remove(*bone*)[¶](#bpy.types.ArmatureEditBones.remove "Link to this definition")
    :   Remove an existing bone from the armature

        Parameters:
        :   **bone** ([`EditBone`](EditBone.md#bpy.types.EditBone "bpy.types.EditBone"), (never None)) – EditBone to remove

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ArmatureEditBones.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ArmatureEditBones.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Armature.edit_bones`](Armature.md#bpy.types.Armature.edit_bones "bpy.types.Armature.edit_bones") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ArmatureEditBones.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ArmatureEditBones.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ArmatureEditBones(bpy\_struct)
  + [`ArmatureEditBones`](#bpy.types.ArmatureEditBones)
    - [`ArmatureEditBones.active`](#bpy.types.ArmatureEditBones.active)
    - [`ArmatureEditBones.new()`](#bpy.types.ArmatureEditBones.new)
    - [`ArmatureEditBones.remove()`](#bpy.types.ArmatureEditBones.remove)
    - [`ArmatureEditBones.bl_rna_get_subclass()`](#bpy.types.ArmatureEditBones.bl_rna_get_subclass)
    - [`ArmatureEditBones.bl_rna_get_subclass_py()`](#bpy.types.ArmatureEditBones.bl_rna_get_subclass_py)
