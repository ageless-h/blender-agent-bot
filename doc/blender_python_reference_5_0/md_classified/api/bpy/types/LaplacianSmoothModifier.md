...
# LaplacianSmoothModifier(Modifier)[¶](#laplaciansmoothmodifier-modifier "Link to this heading")
...
*class* bpy.types.LaplacianSmoothModifier(*Modifier*)[¶](#bpy.types.LaplacianSmoothModifier "Link to this definition")
:   Smoothing effect modifier

    invert\_vertex\_group[¶](#bpy.types.LaplacianSmoothModifier.invert_vertex_group "Link to this definition")
    :   Invert vertex group influence

        Type:
        :   boolean, default False

    iterations[¶](#bpy.types.LaplacianSmoothModifier.iterations "Link to this definition")
    :   Type:
        :   int in [0, 32767], default 1

    lambda\_border[¶](#bpy.types.LaplacianSmoothModifier.lambda_border "Link to this definition")
    :   Lambda factor in border

        Type:
        :   float in [-inf, inf], default 0.01

    lambda\_factor[¶](#bpy.types.LaplacianSmoothModifier.lambda_factor "Link to this definition")
    :   Smooth effect factor

        Type:
        :   float in [-inf, inf], default 0.01

    use\_normalized[¶](#bpy.types.LaplacianSmoothModifier.use_normalized "Link to this definition")
    :   Improve and stabilize the enhanced shape

        Type:
        :   boolean, default True

    use\_volume\_preserve[¶](#bpy.types.LaplacianSmoothModifier.use_volume_preserve "Link to this definition")
    :   Apply volume preservation after smooth

        Type:
        :   boolean, default True

    use\_x[¶](#bpy.types.LaplacianSmoothModifier.use_x "Link to this definition")
    :   Smooth object along X axis

        Type:
        :   boolean, default True

    use\_y[¶](#bpy.types.LaplacianSmoothModifier.use_y "Link to this definition")
    :   Smooth object along Y axis

        Type:
        :   boolean, default True

    use\_z[¶](#bpy.types.LaplacianSmoothModifier.use_z "Link to this definition")
    :   Smooth object along Z axis

        Type:
        :   boolean, default True

    vertex\_group[¶](#bpy.types.LaplacianSmoothModifier.vertex_group "Link to this definition")
    :   Name of Vertex Group which determines influence of modifier per point

        Type:
        :   string, default “”, (never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.LaplacianSmoothModifier.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.LaplacianSmoothModifier.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.LaplacianSmoothModifier.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.LaplacianSmoothModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* LaplacianSmoothModifier(Modifier)
  + [`LaplacianSmoothModifier`](#bpy.types.LaplacianSmoothModifier)
    - [`LaplacianSmoothModifier.invert_vertex_group`](#bpy.types.LaplacianSmoothModifier.invert_vertex_group)
    - [`LaplacianSmoothModifier.iterations`](#bpy.types.LaplacianSmoothModifier.iterations)
    - [`LaplacianSmoothModifier.lambda_border`](#bpy.types.LaplacianSmoothModifier.lambda_border)
    - [`LaplacianSmoothModifier.lambda_factor`](#bpy.types.LaplacianSmoothModifier.lambda_factor)
    - [`LaplacianSmoothModifier.use_normalized`](#bpy.types.LaplacianSmoothModifier.use_normalized)
    - [`LaplacianSmoothModifier.use_volume_preserve`](#bpy.types.LaplacianSmoothModifier.use_volume_preserve)
    - [`LaplacianSmoothModifier.use_x`](#bpy.types.LaplacianSmoothModifier.use_x)
    - [`LaplacianSmoothModifier.use_y`](#bpy.types.LaplacianSmoothModifier.use_y)
    - [`LaplacianSmoothModifier.use_z`](#bpy.types.LaplacianSmoothModifier.use_z)
    - [`LaplacianSmoothModifier.vertex_group`](#bpy.types.LaplacianSmoothModifier.vertex_group)
    - [`LaplacianSmoothModifier.bl_rna_get_subclass()`](#bpy.types.LaplacianSmoothModifier.bl_rna_get_subclass)
    - [`LaplacianSmoothModifier.bl_rna_get_subclass_py()`](#bpy.types.LaplacianSmoothModifier.bl_rna_get_subclass_py)
