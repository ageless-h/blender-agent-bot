...
# KeyingSet(bpy\_struct)[¶](#keyingset-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.KeyingSet(*bpy\_struct*)[¶](#bpy.types.KeyingSet "Link to this definition")
:   Settings that should be keyframed together

    bl\_description[¶](#bpy.types.KeyingSet.bl_description "Link to this definition")
    :   A short description of the keying set

        Type:
        :   string, default “”, (never None)

    bl\_idname[¶](#bpy.types.KeyingSet.bl_idname "Link to this definition")
    :   If this is set, the Keying Set gets a custom ID, otherwise it takes the name of the class used to define the Keying Set (for example, if the class name is “BUILTIN\_KSI\_location”, and bl\_idname is not set by the script, then bl\_idname = “BUILTIN\_KSI\_location”)

        Type:
        :   string, default “”, (never None)

    bl\_label[¶](#bpy.types.KeyingSet.bl_label "Link to this definition")
    :   Type:
        :   string, default “”, (never None)

    is\_path\_absolute[¶](#bpy.types.KeyingSet.is_path_absolute "Link to this definition")
    :   Keying Set defines specific paths/settings to be keyframed (i.e. is not reliant on context info)

        Type:
        :   boolean, default False, (readonly)

    paths[¶](#bpy.types.KeyingSet.paths "Link to this definition")
    :   Keying Set Paths to define settings that get keyframed together

        Type:
        :   [`KeyingSetPaths`](KeyingSetPaths.md#bpy.types.KeyingSetPaths "bpy.types.KeyingSetPaths") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`KeyingSetPath`](KeyingSetPath.md#bpy.types.KeyingSetPath "bpy.types.KeyingSetPath"), (readonly)

    type\_info[¶](#bpy.types.KeyingSet.type_info "Link to this definition")
    :   Callback function defines for built-in Keying Sets

        Type:
        :   [`KeyingSetInfo`](KeyingSetInfo.md#bpy.types.KeyingSetInfo "bpy.types.KeyingSetInfo"), (readonly)

    use\_insertkey\_needed[¶](#bpy.types.KeyingSet.use_insertkey_needed "Link to this definition")
    :   Only insert keyframes where they’re needed in the relevant F-Curves

        Type:
        :   boolean, default False

    use\_insertkey\_override\_needed[¶](#bpy.types.KeyingSet.use_insertkey_override_needed "Link to this definition")
    :   Override default setting to only insert keyframes where they’re needed in the relevant F-Curves

        Type:
        :   boolean, default False

    use\_insertkey\_override\_visual[¶](#bpy.types.KeyingSet.use_insertkey_override_visual "Link to this definition")
    :   Override default setting to insert keyframes based on ‘visual transforms’

        Type:
        :   boolean, default False

    use\_insertkey\_visual[¶](#bpy.types.KeyingSet.use_insertkey_visual "Link to this definition")
    :   Insert keyframes based on ‘visual transforms’

        Type:
        :   boolean, default False

    refresh()[¶](#bpy.types.KeyingSet.refresh "Link to this definition")
    :   Refresh Keying Set to ensure that it is valid for the current context (call before each use of one)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.KeyingSet.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.KeyingSet.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`KeyingSetInfo.generate`](KeyingSetInfo.md#bpy.types.KeyingSetInfo.generate "bpy.types.KeyingSetInfo.generate") * [`KeyingSetInfo.iterator`](KeyingSetInfo.md#bpy.types.KeyingSetInfo.iterator "bpy.types.KeyingSetInfo.iterator") * [`KeyingSets.active`](KeyingSets.md#bpy.types.KeyingSets.active "bpy.types.KeyingSets.active") * [`KeyingSets.new`](KeyingSets.md#bpy.types.KeyingSets.new "bpy.types.KeyingSets.new") | * [`KeyingSetsAll.active`](KeyingSetsAll.md#bpy.types.KeyingSetsAll.active "bpy.types.KeyingSetsAll.active") * [`Scene.keying_sets`](Scene.md#bpy.types.Scene.keying_sets "bpy.types.Scene.keying_sets") * [`Scene.keying_sets_all`](Scene.md#bpy.types.Scene.keying_sets_all "bpy.types.Scene.keying_sets_all") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.KeyingSet.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.KeyingSet.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* KeyingSet(bpy\_struct)
  + [`KeyingSet`](#bpy.types.KeyingSet)
    - [`KeyingSet.bl_description`](#bpy.types.KeyingSet.bl_description)
    - [`KeyingSet.bl_idname`](#bpy.types.KeyingSet.bl_idname)
    - [`KeyingSet.bl_label`](#bpy.types.KeyingSet.bl_label)
    - [`KeyingSet.is_path_absolute`](#bpy.types.KeyingSet.is_path_absolute)
    - [`KeyingSet.paths`](#bpy.types.KeyingSet.paths)
    - [`KeyingSet.type_info`](#bpy.types.KeyingSet.type_info)
    - [`KeyingSet.use_insertkey_needed`](#bpy.types.KeyingSet.use_insertkey_needed)
    - [`KeyingSet.use_insertkey_override_needed`](#bpy.types.KeyingSet.use_insertkey_override_needed)
    - [`KeyingSet.use_insertkey_override_visual`](#bpy.types.KeyingSet.use_insertkey_override_visual)
    - [`KeyingSet.use_insertkey_visual`](#bpy.types.KeyingSet.use_insertkey_visual)
    - [`KeyingSet.refresh()`](#bpy.types.KeyingSet.refresh)
    - [`KeyingSet.bl_rna_get_subclass()`](#bpy.types.KeyingSet.bl_rna_get_subclass)
    - [`KeyingSet.bl_rna_get_subclass_py()`](#bpy.types.KeyingSet.bl_rna_get_subclass_py)
