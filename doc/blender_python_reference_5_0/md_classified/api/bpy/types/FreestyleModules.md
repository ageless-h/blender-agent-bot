...
# FreestyleModules(bpy\_struct)[¶](#freestylemodules-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.FreestyleModules(*bpy\_struct*)[¶](#bpy.types.FreestyleModules "Link to this definition")
:   A list of style modules (to be applied from top to bottom)

    new()[¶](#bpy.types.FreestyleModules.new "Link to this definition")
    :   Add a style module to scene render layer Freestyle settings
        ...
        Return type:
        :   [`FreestyleModuleSettings`](FreestyleModuleSettings.md#bpy.types.FreestyleModuleSettings "bpy.types.FreestyleModuleSettings")

    remove(*module*)[¶](#bpy.types.FreestyleModules.remove "Link to this definition")
    :   Remove a style module from scene render layer Freestyle settings

        Parameters:
        :   **module** ([`FreestyleModuleSettings`](FreestyleModuleSettings.md#bpy.types.FreestyleModuleSettings "bpy.types.FreestyleModuleSettings"), (never None)) – Style module to remove

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.FreestyleModules.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.FreestyleModules.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`FreestyleSettings.modules`](FreestyleSettings.md#bpy.types.FreestyleSettings.modules "bpy.types.FreestyleSettings.modules") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.FreestyleModules.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.FreestyleModules.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* FreestyleModules(bpy\_struct)
  + [`FreestyleModules`](#bpy.types.FreestyleModules)
    - [`FreestyleModules.new()`](#bpy.types.FreestyleModules.new)
    - [`FreestyleModules.remove()`](#bpy.types.FreestyleModules.remove)
    - [`FreestyleModules.bl_rna_get_subclass()`](#bpy.types.FreestyleModules.bl_rna_get_subclass)
    - [`FreestyleModules.bl_rna_get_subclass_py()`](#bpy.types.FreestyleModules.bl_rna_get_subclass_py)
