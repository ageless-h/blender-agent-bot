...
# GeometryNodeSDFGridMeanCurvature(GeometryNode)[¶](#geometrynodesdfgridmeancurvature-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeSDFGridMeanCurvature(*GeometryNode*)[¶](#bpy.types.GeometryNodeSDFGridMeanCurvature "Link to this definition")
:   Apply mean curvature flow smoothing to a signed distance field. Evolves the surface based on its mean curvature, naturally smoothing high-curvature regions more than flat areas
    ...
    *classmethod* is\_registered\_node\_type()[¶](#bpy.types.GeometryNodeSDFGridMeanCurvature.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[¶](#bpy.types.GeometryNodeSDFGridMeanCurvature.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[¶](#bpy.types.GeometryNodeSDFGridMeanCurvature.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.GeometryNodeSDFGridMeanCurvature.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.GeometryNodeSDFGridMeanCurvature.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
GeometryNodeSDFGridMedian(GeometryNode)](GeometryNodeSDFGridMedian.md)
[Previous

GeometryNodeSDFGridMean(GeometryNode)](GeometryNodeSDFGridMean.md)
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeSDFGridMeanCurvature.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.GeometryNodeSDFGridMeanCurvature.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeSDFGridMeanCurvature(GeometryNode)
  + [`GeometryNodeSDFGridMeanCurvature`](#bpy.types.GeometryNodeSDFGridMeanCurvature)
    - [`GeometryNodeSDFGridMeanCurvature.is_registered_node_type()`](#bpy.types.GeometryNodeSDFGridMeanCurvature.is_registered_node_type)
    - [`GeometryNodeSDFGridMeanCurvature.input_template()`](#bpy.types.GeometryNodeSDFGridMeanCurvature.input_template)
    - [`GeometryNodeSDFGridMeanCurvature.output_template()`](#bpy.types.GeometryNodeSDFGridMeanCurvature.output_template)
    - [`GeometryNodeSDFGridMeanCurvature.bl_rna_get_subclass()`](#bpy.types.GeometryNodeSDFGridMeanCurvature.bl_rna_get_subclass)
    - [`GeometryNodeSDFGridMeanCurvature.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeSDFGridMeanCurvature.bl_rna_get_subclass_py)
