...
# GeometryNodeFieldToGridItem(bpy\_struct)[¶](#geometrynodefieldtogriditem-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.GeometryNodeFieldToGridItem(*bpy\_struct*)[¶](#bpy.types.GeometryNodeFieldToGridItem "Link to this definition")
:   color[¶](#bpy.types.GeometryNodeFieldToGridItem.color "Link to this definition")
    ...
    data\_type[¶](#bpy.types.GeometryNodeFieldToGridItem.data_type "Link to this definition")
    :   Type:
    ...
    identifier[¶](#bpy.types.GeometryNodeFieldToGridItem.identifier "Link to this definition")
    :   Type:
        :   int in [-inf, inf], default 0, (readonly)

    name[¶](#bpy.types.GeometryNodeFieldToGridItem.name "Link to this definition")
    :   Type:
        :   string, default “”, (never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.GeometryNodeFieldToGridItem.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.GeometryNodeFieldToGridItem.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`GeometryNodeFieldToGrid.grid_items`](GeometryNodeFieldToGrid.md#bpy.types.GeometryNodeFieldToGrid.grid_items "bpy.types.GeometryNodeFieldToGrid.grid_items") * [`GeometryNodeFieldToGridItems.new`](GeometryNodeFieldToGridItems.md#bpy.types.GeometryNodeFieldToGridItems.new "bpy.types.GeometryNodeFieldToGridItems.new") | * [`GeometryNodeFieldToGridItems.remove`](GeometryNodeFieldToGridItems.md#bpy.types.GeometryNodeFieldToGridItems.remove "bpy.types.GeometryNodeFieldToGridItems.remove") |

[Next

GeometryNodeFieldToGridItems(bpy\_struct)](GeometryNodeFieldToGridItems.md)
[Previous

GeometryNodeFieldToGrid(GeometryNode)](GeometryNodeFieldToGrid.md)
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeFieldToGridItem.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.GeometryNodeFieldToGridItem.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeFieldToGridItem(bpy\_struct)
  + [`GeometryNodeFieldToGridItem`](#bpy.types.GeometryNodeFieldToGridItem)
    - [`GeometryNodeFieldToGridItem.color`](#bpy.types.GeometryNodeFieldToGridItem.color)
    - [`GeometryNodeFieldToGridItem.data_type`](#bpy.types.GeometryNodeFieldToGridItem.data_type)
    - [`GeometryNodeFieldToGridItem.identifier`](#bpy.types.GeometryNodeFieldToGridItem.identifier)
    - [`GeometryNodeFieldToGridItem.name`](#bpy.types.GeometryNodeFieldToGridItem.name)
    - [`GeometryNodeFieldToGridItem.bl_rna_get_subclass()`](#bpy.types.GeometryNodeFieldToGridItem.bl_rna_get_subclass)
    - [`GeometryNodeFieldToGridItem.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeFieldToGridItem.bl_rna_get_subclass_py)
