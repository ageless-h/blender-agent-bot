...
# LineStyleThicknessModifier\_Calligraphy(LineStyleThicknessModifier)[¶](#linestylethicknessmodifier-calligraphy-linestylethicknessmodifier "Link to this heading")
...
*class* bpy.types.LineStyleThicknessModifier\_Calligraphy(*LineStyleThicknessModifier*)[¶](#bpy.types.LineStyleThicknessModifier_Calligraphy "Link to this definition")
:   Change line thickness so that stroke looks like made with a calligraphic pen

    blend[¶](#bpy.types.LineStyleThicknessModifier_Calligraphy.blend "Link to this definition")
    :   Specify how the modifier value is blended into the base value

        Type:
        :   enum in [`'MIX'`, `'ADD'`, `'SUBTRACT'`, `'MULTIPLY'`, `'DIVIDE'`, `'DIFFERENCE'`, `'MINIMUM'`, `'MAXIMUM'`], default `'MIX'`

    expanded[¶](#bpy.types.LineStyleThicknessModifier_Calligraphy.expanded "Link to this definition")
    :   True if the modifier tab is expanded

        Type:
        :   boolean, default False

    influence[¶](#bpy.types.LineStyleThicknessModifier_Calligraphy.influence "Link to this definition")
    :   Influence factor by which the modifier changes the property

        Type:
        :   float in [0, 1], default 0.0

    orientation[¶](#bpy.types.LineStyleThicknessModifier_Calligraphy.orientation "Link to this definition")
    :   Angle of the main direction

        Type:
        :   float in [-inf, inf], default 0.0

    thickness\_max[¶](#bpy.types.LineStyleThicknessModifier_Calligraphy.thickness_max "Link to this definition")
    :   Maximum thickness in the main direction

        Type:
        :   float in [0, 10000], default 0.0

    thickness\_min[¶](#bpy.types.LineStyleThicknessModifier_Calligraphy.thickness_min "Link to this definition")
    :   Minimum thickness in the direction perpendicular to the main direction

        Type:
        :   float in [0, 10000], default 0.0

    type[¶](#bpy.types.LineStyleThicknessModifier_Calligraphy.type "Link to this definition")
    ...
    use[¶](#bpy.types.LineStyleThicknessModifier_Calligraphy.use "Link to this definition")
    :   Enable or disable this modifier during stroke rendering

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.LineStyleThicknessModifier_Calligraphy.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.LineStyleThicknessModifier_Calligraphy.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.LineStyleThicknessModifier_Calligraphy.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.LineStyleThicknessModifier_Calligraphy.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* LineStyleThicknessModifier\_Calligraphy(LineStyleThicknessModifier)
  + [`LineStyleThicknessModifier_Calligraphy`](#bpy.types.LineStyleThicknessModifier_Calligraphy)
    - [`LineStyleThicknessModifier_Calligraphy.blend`](#bpy.types.LineStyleThicknessModifier_Calligraphy.blend)
    - [`LineStyleThicknessModifier_Calligraphy.expanded`](#bpy.types.LineStyleThicknessModifier_Calligraphy.expanded)
    - [`LineStyleThicknessModifier_Calligraphy.influence`](#bpy.types.LineStyleThicknessModifier_Calligraphy.influence)
    - [`LineStyleThicknessModifier_Calligraphy.orientation`](#bpy.types.LineStyleThicknessModifier_Calligraphy.orientation)
    - [`LineStyleThicknessModifier_Calligraphy.thickness_max`](#bpy.types.LineStyleThicknessModifier_Calligraphy.thickness_max)
    - [`LineStyleThicknessModifier_Calligraphy.thickness_min`](#bpy.types.LineStyleThicknessModifier_Calligraphy.thickness_min)
    - [`LineStyleThicknessModifier_Calligraphy.type`](#bpy.types.LineStyleThicknessModifier_Calligraphy.type)
    - [`LineStyleThicknessModifier_Calligraphy.use`](#bpy.types.LineStyleThicknessModifier_Calligraphy.use)
    - [`LineStyleThicknessModifier_Calligraphy.bl_rna_get_subclass()`](#bpy.types.LineStyleThicknessModifier_Calligraphy.bl_rna_get_subclass)
    - [`LineStyleThicknessModifier_Calligraphy.bl_rna_get_subclass_py()`](#bpy.types.LineStyleThicknessModifier_Calligraphy.bl_rna_get_subclass_py)
