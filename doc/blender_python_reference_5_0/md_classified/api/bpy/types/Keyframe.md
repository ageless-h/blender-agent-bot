...
# Keyframe(bpy\_struct)[¶](#keyframe-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.Keyframe(*bpy\_struct*)[¶](#bpy.types.Keyframe "Link to this definition")
:   Bézier curve point with two handles defining a Keyframe on an F-Curve

    amplitude[¶](#bpy.types.Keyframe.amplitude "Link to this definition")
    :   Amount to boost elastic bounces for ‘elastic’ easing

        Type:
        :   float in [0, inf], default 0.0

    back[¶](#bpy.types.Keyframe.back "Link to this definition")
    :   Amount of overshoot for ‘back’ easing

        Type:
        :   float in [-inf, inf], default 0.0

    co[¶](#bpy.types.Keyframe.co "Link to this definition")
    :   Coordinates of the control point

        Type:
        :   [`mathutils.Vector`](../../mathutils/index.md#mathutils.Vector "mathutils.Vector") of 2 items in [-inf, inf], default (0.0, 0.0)

    co\_ui[¶](#bpy.types.Keyframe.co_ui "Link to this definition")
    ...
    easing[¶](#bpy.types.Keyframe.easing "Link to this definition")
    :   Which ends of the segment between this and the next keyframe easing interpolation is applied to

        Type:
        :   enum in [Beztriple Interpolation Easing Items](../../../appendix/bpy_types_enum_items/beztriple_interpolation_easing_items.md#rna-enum-beztriple-interpolation-easing-items), default `'AUTO'`

    handle\_left[¶](#bpy.types.Keyframe.handle_left "Link to this definition")
    :   Coordinates of the left handle (before the control point)

        Type:
        :   [`mathutils.Vector`](../../mathutils/index.md#mathutils.Vector "mathutils.Vector") of 2 items in [-inf, inf], default (0.0, 0.0)

    handle\_left\_type[¶](#bpy.types.Keyframe.handle_left_type "Link to this definition")
    :   Handle types

        Type:
        :   enum in [Keyframe Handle Type Items](../../../appendix/bpy_types_enum_items/keyframe_handle_type_items.md#rna-enum-keyframe-handle-type-items), default `'FREE'`

    handle\_right[¶](#bpy.types.Keyframe.handle_right "Link to this definition")
    :   Coordinates of the right handle (after the control point)

        Type:
        :   [`mathutils.Vector`](../../mathutils/index.md#mathutils.Vector "mathutils.Vector") of 2 items in [-inf, inf], default (0.0, 0.0)

    handle\_right\_type[¶](#bpy.types.Keyframe.handle_right_type "Link to this definition")
    :   Handle types

        Type:
        :   enum in [Keyframe Handle Type Items](../../../appendix/bpy_types_enum_items/keyframe_handle_type_items.md#rna-enum-keyframe-handle-type-items), default `'FREE'`

    interpolation[¶](#bpy.types.Keyframe.interpolation "Link to this definition")
    :   Interpolation method to use for segment of the F-Curve from this Keyframe until the next Keyframe

        Type:
        :   enum in [Beztriple Interpolation Mode Items](../../../appendix/bpy_types_enum_items/beztriple_interpolation_mode_items.md#rna-enum-beztriple-interpolation-mode-items), default `'CONSTANT'`

    period[¶](#bpy.types.Keyframe.period "Link to this definition")
    :   Time between bounces for elastic easing

        Type:
        :   float in [-inf, inf], default 0.0

    select\_control\_point[¶](#bpy.types.Keyframe.select_control_point "Link to this definition")
    :   Control point selection status

        Type:
        :   boolean, default False

    select\_left\_handle[¶](#bpy.types.Keyframe.select_left_handle "Link to this definition")
    :   Left handle selection status

        Type:
        :   boolean, default False

    select\_right\_handle[¶](#bpy.types.Keyframe.select_right_handle "Link to this definition")
    :   Right handle selection status

        Type:
        :   boolean, default False

    type[¶](#bpy.types.Keyframe.type "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.Keyframe.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.Keyframe.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`bpy.context.selected_editable_keyframes`](../context/index.md#bpy.context.selected_editable_keyframes "bpy.context.selected_editable_keyframes") * [`FCurve.keyframe_points`](FCurve.md#bpy.types.FCurve.keyframe_points "bpy.types.FCurve.keyframe_points") | * [`FCurveKeyframePoints.insert`](FCurveKeyframePoints.md#bpy.types.FCurveKeyframePoints.insert "bpy.types.FCurveKeyframePoints.insert") * [`FCurveKeyframePoints.remove`](FCurveKeyframePoints.md#bpy.types.FCurveKeyframePoints.remove "bpy.types.FCurveKeyframePoints.remove") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.Keyframe.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.Keyframe.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* Keyframe(bpy\_struct)
  + [`Keyframe`](#bpy.types.Keyframe)
    - [`Keyframe.amplitude`](#bpy.types.Keyframe.amplitude)
    - [`Keyframe.back`](#bpy.types.Keyframe.back)
    - [`Keyframe.co`](#bpy.types.Keyframe.co)
    - [`Keyframe.co_ui`](#bpy.types.Keyframe.co_ui)
    - [`Keyframe.easing`](#bpy.types.Keyframe.easing)
    - [`Keyframe.handle_left`](#bpy.types.Keyframe.handle_left)
    - [`Keyframe.handle_left_type`](#bpy.types.Keyframe.handle_left_type)
    - [`Keyframe.handle_right`](#bpy.types.Keyframe.handle_right)
    - [`Keyframe.handle_right_type`](#bpy.types.Keyframe.handle_right_type)
    - [`Keyframe.interpolation`](#bpy.types.Keyframe.interpolation)
    - [`Keyframe.period`](#bpy.types.Keyframe.period)
    - [`Keyframe.select_control_point`](#bpy.types.Keyframe.select_control_point)
    - [`Keyframe.select_left_handle`](#bpy.types.Keyframe.select_left_handle)
    - [`Keyframe.select_right_handle`](#bpy.types.Keyframe.select_right_handle)
    - [`Keyframe.type`](#bpy.types.Keyframe.type)
    - [`Keyframe.bl_rna_get_subclass()`](#bpy.types.Keyframe.bl_rna_get_subclass)
    - [`Keyframe.bl_rna_get_subclass_py()`](#bpy.types.Keyframe.bl_rna_get_subclass_py)
