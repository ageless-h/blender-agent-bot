...
# ImagePreview(bpy\_struct)[¶](#imagepreview-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.ImagePreview(*bpy\_struct*)[¶](#bpy.types.ImagePreview "Link to this definition")
:   Preview image and icon

    icon\_id[¶](#bpy.types.ImagePreview.icon_id "Link to this definition")
    :   Unique integer identifying this preview as an icon (zero means invalid)

        Type:
        :   int in [-inf, inf], default 0, (readonly)

    icon\_pixels[¶](#bpy.types.ImagePreview.icon_pixels "Link to this definition")
    :   Icon pixels, as bytes (always 32-bit RGBA)

        Type:
        :   int in [-inf, inf], default 0

    icon\_pixels\_float[¶](#bpy.types.ImagePreview.icon_pixels_float "Link to this definition")
    :   Icon pixels components, as floats (RGBA concatenated values)

        Type:
        :   float in [-inf, inf], default 0.0

    icon\_size[¶](#bpy.types.ImagePreview.icon_size "Link to this definition")
    :   Width and height in pixels

        Type:
        :   int array of 2 items in [-inf, inf], default (0, 0)

    image\_pixels[¶](#bpy.types.ImagePreview.image_pixels "Link to this definition")
    :   Image pixels, as bytes (always 32-bit RGBA)

        Type:
        :   int in [-inf, inf], default 0

    image\_pixels\_float[¶](#bpy.types.ImagePreview.image_pixels_float "Link to this definition")
    :   Image pixels components, as floats (RGBA concatenated values)

        Type:
        :   float in [-inf, inf], default 0.0

    image\_size[¶](#bpy.types.ImagePreview.image_size "Link to this definition")
    :   Width and height in pixels

        Type:
        :   int array of 2 items in [-inf, inf], default (0, 0)

    is\_icon\_custom[¶](#bpy.types.ImagePreview.is_icon_custom "Link to this definition")
    :   True if this preview icon has been modified by py script, and is no more auto-generated by Blender

        Type:
        :   boolean, default False

    is\_image\_custom[¶](#bpy.types.ImagePreview.is_image_custom "Link to this definition")
    :   True if this preview image has been modified by py script, and is no more auto-generated by Blender

        Type:
        :   boolean, default False

    reload()[¶](#bpy.types.ImagePreview.reload "Link to this definition")
    :   Reload the preview from its source path

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ImagePreview.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ImagePreview.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`ID.preview`](ID.md#bpy.types.ID.preview "bpy.types.ID.preview") | * [`ID.preview_ensure`](ID.md#bpy.types.ID.preview_ensure "bpy.types.ID.preview_ensure") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ImagePreview.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.ImagePreview.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ImagePreview(bpy\_struct)
  + [`ImagePreview`](#bpy.types.ImagePreview)
    - [`ImagePreview.icon_id`](#bpy.types.ImagePreview.icon_id)
    - [`ImagePreview.icon_pixels`](#bpy.types.ImagePreview.icon_pixels)
    - [`ImagePreview.icon_pixels_float`](#bpy.types.ImagePreview.icon_pixels_float)
    - [`ImagePreview.icon_size`](#bpy.types.ImagePreview.icon_size)
    - [`ImagePreview.image_pixels`](#bpy.types.ImagePreview.image_pixels)
    - [`ImagePreview.image_pixels_float`](#bpy.types.ImagePreview.image_pixels_float)
    - [`ImagePreview.image_size`](#bpy.types.ImagePreview.image_size)
    - [`ImagePreview.is_icon_custom`](#bpy.types.ImagePreview.is_icon_custom)
    - [`ImagePreview.is_image_custom`](#bpy.types.ImagePreview.is_image_custom)
    - [`ImagePreview.reload()`](#bpy.types.ImagePreview.reload)
    - [`ImagePreview.bl_rna_get_subclass()`](#bpy.types.ImagePreview.bl_rna_get_subclass)
    - [`ImagePreview.bl_rna_get_subclass_py()`](#bpy.types.ImagePreview.bl_rna_get_subclass_py)
