...
# AOVs(bpy\_struct)[¶](#aovs-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.AOVs(*bpy\_struct*)[¶](#bpy.types.AOVs "Link to this definition")
:   Collection of AOVs

    add()[¶](#bpy.types.AOVs.add "Link to this definition")
    :   add
        ...
        Return type:
        :   [`AOV`](AOV.md#bpy.types.AOV "bpy.types.AOV")

    remove(*aov*)[¶](#bpy.types.AOVs.remove "Link to this definition")
    :   Remove an AOV

        Parameters:
        :   **aov** ([`AOV`](AOV.md#bpy.types.AOV "bpy.types.AOV"), (never None)) – AOV to remove

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.AOVs.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.AOVs.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`ViewLayer.aovs`](ViewLayer.md#bpy.types.ViewLayer.aovs "bpy.types.ViewLayer.aovs") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.AOVs.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.AOVs.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* AOVs(bpy\_struct)
  + [`AOVs`](#bpy.types.AOVs)
    - [`AOVs.add()`](#bpy.types.AOVs.add)
    - [`AOVs.remove()`](#bpy.types.AOVs.remove)
    - [`AOVs.bl_rna_get_subclass()`](#bpy.types.AOVs.bl_rna_get_subclass)
    - [`AOVs.bl_rna_get_subclass_py()`](#bpy.types.AOVs.bl_rna_get_subclass_py)
