...
# FloatColorAttribute(Attribute)[¶](#floatcolorattribute-attribute "Link to this heading")
...
*class* bpy.types.FloatColorAttribute(*Attribute*)[¶](#bpy.types.FloatColorAttribute "Link to this definition")
:   Geometry attribute that stores RGBA colors as floating-point values using 32-bits per channel

    data[¶](#bpy.types.FloatColorAttribute.data "Link to this definition")
    :   Type:
        :   [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`FloatColorAttributeValue`](FloatColorAttributeValue.md#bpy.types.FloatColorAttributeValue "bpy.types.FloatColorAttributeValue"), (readonly)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.FloatColorAttribute.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.FloatColorAttribute.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.FloatColorAttribute.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.FloatColorAttribute.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* FloatColorAttribute(Attribute)
  + [`FloatColorAttribute`](#bpy.types.FloatColorAttribute)
    - [`FloatColorAttribute.data`](#bpy.types.FloatColorAttribute.data)
    - [`FloatColorAttribute.bl_rna_get_subclass()`](#bpy.types.FloatColorAttribute.bl_rna_get_subclass)
    - [`FloatColorAttribute.bl_rna_get_subclass_py()`](#bpy.types.FloatColorAttribute.bl_rna_get_subclass_py)
