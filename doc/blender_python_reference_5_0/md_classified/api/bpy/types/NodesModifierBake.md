...
# NodesModifierBake(bpy\_struct)[¶](#nodesmodifierbake-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.NodesModifierBake(*bpy\_struct*)[¶](#bpy.types.NodesModifierBake "Link to this definition")
:   bake\_id[¶](#bpy.types.NodesModifierBake.bake_id "Link to this definition")
    :   Identifier for this bake which remains unchanged even when the bake node is renamed, grouped or ungrouped

        Type:
        :   int in [-inf, inf], default 0, (readonly)

    bake\_mode[¶](#bpy.types.NodesModifierBake.bake_mode "Link to this definition")
    :   * `ANIMATION`
    ...
    bake\_target[¶](#bpy.types.NodesModifierBake.bake_target "Link to this definition")
    ...
    data\_blocks[¶](#bpy.types.NodesModifierBake.data_blocks "Link to this definition")
    :   Type:
        :   [`NodesModifierBakeDataBlocks`](NodesModifierBakeDataBlocks.md#bpy.types.NodesModifierBakeDataBlocks "bpy.types.NodesModifierBakeDataBlocks") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`NodesModifierDataBlock`](NodesModifierDataBlock.md#bpy.types.NodesModifierDataBlock "bpy.types.NodesModifierDataBlock"), (readonly)

    directory[¶](#bpy.types.NodesModifierBake.directory "Link to this definition")
    :   Location on disk where the bake data is stored

        Type:
        :   string, default “”, (never None, blend relative `//` prefix supported)

    frame\_end[¶](#bpy.types.NodesModifierBake.frame_end "Link to this definition")
    :   Frame where the baking ends

        Type:
        :   int in [-inf, inf], default 0

    frame\_start[¶](#bpy.types.NodesModifierBake.frame_start "Link to this definition")
    :   Frame where the baking starts

        Type:
        :   int in [-inf, inf], default 0

    node[¶](#bpy.types.NodesModifierBake.node "Link to this definition")
    ...
    use\_custom\_path[¶](#bpy.types.NodesModifierBake.use_custom_path "Link to this definition")
    :   Specify a path where the baked data should be stored manually

        Type:
        :   boolean, default False

    use\_custom\_simulation\_frame\_range[¶](#bpy.types.NodesModifierBake.use_custom_simulation_frame_range "Link to this definition")
    :   Override the simulation frame range from the scene

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.NodesModifierBake.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.NodesModifierBake.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`NodesModifier.bakes`](NodesModifier.md#bpy.types.NodesModifier.bakes "bpy.types.NodesModifier.bakes") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.NodesModifierBake.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.NodesModifierBake.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* NodesModifierBake(bpy\_struct)
  + [`NodesModifierBake`](#bpy.types.NodesModifierBake)
    - [`NodesModifierBake.bake_id`](#bpy.types.NodesModifierBake.bake_id)
    - [`NodesModifierBake.bake_mode`](#bpy.types.NodesModifierBake.bake_mode)
    - [`NodesModifierBake.bake_target`](#bpy.types.NodesModifierBake.bake_target)
    - [`NodesModifierBake.data_blocks`](#bpy.types.NodesModifierBake.data_blocks)
    - [`NodesModifierBake.directory`](#bpy.types.NodesModifierBake.directory)
    - [`NodesModifierBake.frame_end`](#bpy.types.NodesModifierBake.frame_end)
    - [`NodesModifierBake.frame_start`](#bpy.types.NodesModifierBake.frame_start)
    - [`NodesModifierBake.node`](#bpy.types.NodesModifierBake.node)
    - [`NodesModifierBake.use_custom_path`](#bpy.types.NodesModifierBake.use_custom_path)
    - [`NodesModifierBake.use_custom_simulation_frame_range`](#bpy.types.NodesModifierBake.use_custom_simulation_frame_range)
    - [`NodesModifierBake.bl_rna_get_subclass()`](#bpy.types.NodesModifierBake.bl_rna_get_subclass)
    - [`NodesModifierBake.bl_rna_get_subclass_py()`](#bpy.types.NodesModifierBake.bl_rna_get_subclass_py)
