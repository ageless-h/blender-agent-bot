...
# BlendDataAnnotations(bpy\_struct)[¶](#blenddataannotations-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.BlendDataAnnotations(*bpy\_struct*)[¶](#bpy.types.BlendDataAnnotations "Link to this definition")
:   Collection of annotations

    tag(*value*)[¶](#bpy.types.BlendDataAnnotations.tag "Link to this definition")
    :   tag

        Parameters:
        :   **value** (*boolean*) – Value

    new(*name*)[¶](#bpy.types.BlendDataAnnotations.new "Link to this definition")
    ...
    remove(*annotation*, *\**, *do\_unlink=True*, *do\_id\_user=True*, *do\_ui\_user=True*)[¶](#bpy.types.BlendDataAnnotations.remove "Link to this definition")
    :   Remove annotation instance from the current blendfile

        Parameters:
        :   * **annotation** ([`Annotation`](Annotation.md#bpy.types.Annotation "bpy.types.Annotation"), (never None)) – Grease Pencil to remove
            * **do\_unlink** (*boolean**,* *(**optional**)*) – Unlink all usages of this annotation before deleting it
            * **do\_id\_user** (*boolean**,* *(**optional**)*) – Decrement user counter of all data-blocks used by this annotation
            * **do\_ui\_user** (*boolean**,* *(**optional**)*) – Make sure interface does not reference this annotation

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.BlendDataAnnotations.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.BlendDataAnnotations.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`BlendData.annotations`](BlendData.md#bpy.types.BlendData.annotations "bpy.types.BlendData.annotations") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.BlendDataAnnotations.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.BlendDataAnnotations.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* BlendDataAnnotations(bpy\_struct)
  + [`BlendDataAnnotations`](#bpy.types.BlendDataAnnotations)
    - [`BlendDataAnnotations.tag()`](#bpy.types.BlendDataAnnotations.tag)
    - [`BlendDataAnnotations.new()`](#bpy.types.BlendDataAnnotations.new)
    - [`BlendDataAnnotations.remove()`](#bpy.types.BlendDataAnnotations.remove)
    - [`BlendDataAnnotations.bl_rna_get_subclass()`](#bpy.types.BlendDataAnnotations.bl_rna_get_subclass)
    - [`BlendDataAnnotations.bl_rna_get_subclass_py()`](#bpy.types.BlendDataAnnotations.bl_rna_get_subclass_py)
