...
# FloorConstraint(Constraint)[¶](#floorconstraint-constraint "Link to this heading")
...
*class* bpy.types.FloorConstraint(*Constraint*)[¶](#bpy.types.FloorConstraint "Link to this definition")
:   Use the target object for location limitation

    floor\_location[¶](#bpy.types.FloorConstraint.floor_location "Link to this definition")
    ...
    offset[¶](#bpy.types.FloorConstraint.offset "Link to this definition")
    :   Offset of floor from object origin

        Type:
        :   float in [-inf, inf], default 0.0

    subtarget[¶](#bpy.types.FloorConstraint.subtarget "Link to this definition")
    :   Armature bone, mesh or lattice vertex group, …

        Type:
        :   string, default “”, (never None)

    target[¶](#bpy.types.FloorConstraint.target "Link to this definition")
    :   Target object

        Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object")

    use\_rotation[¶](#bpy.types.FloorConstraint.use_rotation "Link to this definition")
    :   Use the target’s rotation to determine floor

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.FloorConstraint.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.FloorConstraint.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.FloorConstraint.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.FloorConstraint.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* FloorConstraint(Constraint)
  + [`FloorConstraint`](#bpy.types.FloorConstraint)
    - [`FloorConstraint.floor_location`](#bpy.types.FloorConstraint.floor_location)
    - [`FloorConstraint.offset`](#bpy.types.FloorConstraint.offset)
    - [`FloorConstraint.subtarget`](#bpy.types.FloorConstraint.subtarget)
    - [`FloorConstraint.target`](#bpy.types.FloorConstraint.target)
    - [`FloorConstraint.use_rotation`](#bpy.types.FloorConstraint.use_rotation)
    - [`FloorConstraint.bl_rna_get_subclass()`](#bpy.types.FloorConstraint.bl_rna_get_subclass)
    - [`FloorConstraint.bl_rna_get_subclass_py()`](#bpy.types.FloorConstraint.bl_rna_get_subclass_py)
