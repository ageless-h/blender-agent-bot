...
# DepsgraphObjectInstance(bpy\_struct)[¶](#depsgraphobjectinstance-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.DepsgraphObjectInstance(*bpy\_struct*)[¶](#bpy.types.DepsgraphObjectInstance "Link to this definition")
:   Extended information about dependency graph object iterator (Warning: All data here is ‘evaluated’ one, not original .blend IDs)
    ...
    instance\_object[¶](#bpy.types.DepsgraphObjectInstance.instance_object "Link to this definition")
    :   Evaluated object which is being instanced by this iterator

        Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object"), (readonly)

    is\_instance[¶](#bpy.types.DepsgraphObjectInstance.is_instance "Link to this definition")
    :   Denotes if the object is generated by another object

        Type:
        :   boolean, default False, (readonly)

    matrix\_world[¶](#bpy.types.DepsgraphObjectInstance.matrix_world "Link to this definition")
    ...
    object[¶](#bpy.types.DepsgraphObjectInstance.object "Link to this definition")
    :   Evaluated object the iterator points to

        Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object"), (readonly)

    orco[¶](#bpy.types.DepsgraphObjectInstance.orco "Link to this definition")
    ...
    parent[¶](#bpy.types.DepsgraphObjectInstance.parent "Link to this definition")
    :   If the object is an instance, the parent object that generated it

        Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object"), (readonly)

    particle\_system[¶](#bpy.types.DepsgraphObjectInstance.particle_system "Link to this definition")
    :   Evaluated particle system that this object was instanced from

        Type:
        :   [`ParticleSystem`](ParticleSystem.md#bpy.types.ParticleSystem "bpy.types.ParticleSystem"), (readonly)

    persistent\_id[¶](#bpy.types.DepsgraphObjectInstance.persistent_id "Link to this definition")
    :   Persistent identifier for inter-frame matching of objects with motion blur

        Type:
        :   int array of 8 items in [-inf, inf], default (0, 0, 0, 0, 0, 0, 0, 0), (readonly)

    random\_id[¶](#bpy.types.DepsgraphObjectInstance.random_id "Link to this definition")
    :   Random id for this instance, typically for randomized shading

        Type:
        :   int in [0, inf], default 0, (readonly)

    show\_particles[¶](#bpy.types.DepsgraphObjectInstance.show_particles "Link to this definition")
    :   Particles part of the object should be visible in the render

        Type:
        :   boolean, default False, (readonly)

    show\_self[¶](#bpy.types.DepsgraphObjectInstance.show_self "Link to this definition")
    :   The object geometry itself should be visible in the render

        Type:
        :   boolean, default False, (readonly)

    uv[¶](#bpy.types.DepsgraphObjectInstance.uv "Link to this definition")
    :   UV coordinates in parent object space

        Type:
        :   float array of 2 items in [-inf, inf], default (0.0, 0.0), (readonly)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.DepsgraphObjectInstance.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.DepsgraphObjectInstance.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Depsgraph.object_instances`](Depsgraph.md#bpy.types.Depsgraph.object_instances "bpy.types.Depsgraph.object_instances") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.DepsgraphObjectInstance.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.DepsgraphObjectInstance.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* DepsgraphObjectInstance(bpy\_struct)
  + [`DepsgraphObjectInstance`](#bpy.types.DepsgraphObjectInstance)
    - [`DepsgraphObjectInstance.instance_object`](#bpy.types.DepsgraphObjectInstance.instance_object)
    - [`DepsgraphObjectInstance.is_instance`](#bpy.types.DepsgraphObjectInstance.is_instance)
    - [`DepsgraphObjectInstance.matrix_world`](#bpy.types.DepsgraphObjectInstance.matrix_world)
    - [`DepsgraphObjectInstance.object`](#bpy.types.DepsgraphObjectInstance.object)
    - [`DepsgraphObjectInstance.orco`](#bpy.types.DepsgraphObjectInstance.orco)
    - [`DepsgraphObjectInstance.parent`](#bpy.types.DepsgraphObjectInstance.parent)
    - [`DepsgraphObjectInstance.particle_system`](#bpy.types.DepsgraphObjectInstance.particle_system)
    - [`DepsgraphObjectInstance.persistent_id`](#bpy.types.DepsgraphObjectInstance.persistent_id)
    - [`DepsgraphObjectInstance.random_id`](#bpy.types.DepsgraphObjectInstance.random_id)
    - [`DepsgraphObjectInstance.show_particles`](#bpy.types.DepsgraphObjectInstance.show_particles)
    - [`DepsgraphObjectInstance.show_self`](#bpy.types.DepsgraphObjectInstance.show_self)
    - [`DepsgraphObjectInstance.uv`](#bpy.types.DepsgraphObjectInstance.uv)
    - [`DepsgraphObjectInstance.bl_rna_get_subclass()`](#bpy.types.DepsgraphObjectInstance.bl_rna_get_subclass)
    - [`DepsgraphObjectInstance.bl_rna_get_subclass_py()`](#bpy.types.DepsgraphObjectInstance.bl_rna_get_subclass_py)
