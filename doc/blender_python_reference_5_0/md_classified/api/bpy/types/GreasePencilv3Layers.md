...
# GreasePencilv3Layers(bpy\_struct)[¶](#greasepencilv3layers-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.GreasePencilv3Layers(*bpy\_struct*)[¶](#bpy.types.GreasePencilv3Layers "Link to this definition")
:   Collection of Grease Pencil layers

    active[¶](#bpy.types.GreasePencilv3Layers.active "Link to this definition")
    :   Active Grease Pencil layer

        Type:
        :   [`GreasePencilLayer`](GreasePencilLayer.md#bpy.types.GreasePencilLayer "bpy.types.GreasePencilLayer")

    new(*name*, *\**, *set\_active=True*, *layer\_group=None*)[¶](#bpy.types.GreasePencilv3Layers.new "Link to this definition")
    :   Add a new Grease Pencil layer

        Parameters:
        :   * **name** (*string**,* *(**never None**)*) – Name, Name of the layer
            * **set\_active** (*boolean**,* *(**optional**)*) – Set Active, Set the newly created layer as the active layer
            * **layer\_group** ([`GreasePencilLayerGroup`](GreasePencilLayerGroup.md#bpy.types.GreasePencilLayerGroup "bpy.types.GreasePencilLayerGroup"), (optional)) – The layer group the new layer will be created in (use None for the main stack)
    ...
    remove(*layer*)[¶](#bpy.types.GreasePencilv3Layers.remove "Link to this definition")
    :   Remove a Grease Pencil layer

        Parameters:
        :   **layer** ([`GreasePencilLayer`](GreasePencilLayer.md#bpy.types.GreasePencilLayer "bpy.types.GreasePencilLayer"), (never None)) – The layer to remove

    move(*layer*, *type*)[¶](#bpy.types.GreasePencilv3Layers.move "Link to this definition")
    :   Move a Grease Pencil layer in the layer group or main stack

        Parameters:
        :   * **layer** ([`GreasePencilLayer`](GreasePencilLayer.md#bpy.types.GreasePencilLayer "bpy.types.GreasePencilLayer"), (never None)) – The layer to move
            * **type** (enum in [`'DOWN'`, `'UP'`]) – Direction of movement

    move\_top(*layer*)[¶](#bpy.types.GreasePencilv3Layers.move_top "Link to this definition")
    :   Move a Grease Pencil layer to the top of the layer group or main stack

        Parameters:
        :   **layer** ([`GreasePencilLayer`](GreasePencilLayer.md#bpy.types.GreasePencilLayer "bpy.types.GreasePencilLayer"), (never None)) – The layer to move

    move\_bottom(*layer*)[¶](#bpy.types.GreasePencilv3Layers.move_bottom "Link to this definition")
    :   Move a Grease Pencil layer to the bottom of the layer group or main stack

        Parameters:
        :   **layer** ([`GreasePencilLayer`](GreasePencilLayer.md#bpy.types.GreasePencilLayer "bpy.types.GreasePencilLayer"), (never None)) – The layer to move

    move\_to\_layer\_group(*layer*, *layer\_group*)[¶](#bpy.types.GreasePencilv3Layers.move_to_layer_group "Link to this definition")
    :   Move a Grease Pencil layer into a layer group

        Parameters:
        :   * **layer** ([`GreasePencilLayer`](GreasePencilLayer.md#bpy.types.GreasePencilLayer "bpy.types.GreasePencilLayer"), (never None)) – The layer to move
            * **layer\_group** ([`GreasePencilLayerGroup`](GreasePencilLayerGroup.md#bpy.types.GreasePencilLayerGroup "bpy.types.GreasePencilLayerGroup")) – The layer group the layer will be moved into (use None for the main stack)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.GreasePencilv3Layers.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.GreasePencilv3Layers.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`GreasePencil.layers`](GreasePencil.md#bpy.types.GreasePencil.layers "bpy.types.GreasePencil.layers") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GreasePencilv3Layers.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.GreasePencilv3Layers.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GreasePencilv3Layers(bpy\_struct)
  + [`GreasePencilv3Layers`](#bpy.types.GreasePencilv3Layers)
    - [`GreasePencilv3Layers.active`](#bpy.types.GreasePencilv3Layers.active)
    - [`GreasePencilv3Layers.new()`](#bpy.types.GreasePencilv3Layers.new)
    - [`GreasePencilv3Layers.remove()`](#bpy.types.GreasePencilv3Layers.remove)
    - [`GreasePencilv3Layers.move()`](#bpy.types.GreasePencilv3Layers.move)
    - [`GreasePencilv3Layers.move_top()`](#bpy.types.GreasePencilv3Layers.move_top)
    - [`GreasePencilv3Layers.move_bottom()`](#bpy.types.GreasePencilv3Layers.move_bottom)
    - [`GreasePencilv3Layers.move_to_layer_group()`](#bpy.types.GreasePencilv3Layers.move_to_layer_group)
    - [`GreasePencilv3Layers.bl_rna_get_subclass()`](#bpy.types.GreasePencilv3Layers.bl_rna_get_subclass)
    - [`GreasePencilv3Layers.bl_rna_get_subclass_py()`](#bpy.types.GreasePencilv3Layers.bl_rna_get_subclass_py)
