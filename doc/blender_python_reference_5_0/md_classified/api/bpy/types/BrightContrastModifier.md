...
# BrightContrastModifier(StripModifier)[¶](#brightcontrastmodifier-stripmodifier "Link to this heading")
...
*class* bpy.types.BrightContrastModifier(*StripModifier*)[¶](#bpy.types.BrightContrastModifier "Link to this definition")
:   Bright/contrast modifier data for sequence strip

    bright[¶](#bpy.types.BrightContrastModifier.bright "Link to this definition")
    :   Adjust the luminosity of the colors

        Type:
        :   float in [-inf, inf], default 0.0

    contrast[¶](#bpy.types.BrightContrastModifier.contrast "Link to this definition")
    :   Adjust the difference in luminosity between pixels

        Type:
        :   float in [-100, 100], default 0.0

    open\_mask\_input\_panel[¶](#bpy.types.BrightContrastModifier.open_mask_input_panel "Link to this definition")
    :   Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.BrightContrastModifier.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.BrightContrastModifier.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.BrightContrastModifier.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.types.BrightContrastModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* BrightContrastModifier(StripModifier)
  + [`BrightContrastModifier`](#bpy.types.BrightContrastModifier)
    - [`BrightContrastModifier.bright`](#bpy.types.BrightContrastModifier.bright)
    - [`BrightContrastModifier.contrast`](#bpy.types.BrightContrastModifier.contrast)
    - [`BrightContrastModifier.open_mask_input_panel`](#bpy.types.BrightContrastModifier.open_mask_input_panel)
    - [`BrightContrastModifier.bl_rna_get_subclass()`](#bpy.types.BrightContrastModifier.bl_rna_get_subclass)
    - [`BrightContrastModifier.bl_rna_get_subclass_py()`](#bpy.types.BrightContrastModifier.bl_rna_get_subclass_py)
