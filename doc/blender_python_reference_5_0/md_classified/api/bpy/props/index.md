...
bpy.props.BoolProperty(*\**, *name=''*, *description=''*, *translation\_context='\*'*, *default=False*, *options={'ANIMATABLE'}*, *override=set()*, *tags=set()*, *subtype='NONE'*, *update=None*, *get=None*, *set=None*, *get\_transform=None*, *set\_transform=None*)[¶](#bpy.props.BoolProperty "Link to this definition")
:   Returns a new boolean property definition.
    ...
    :   * **name** (*str*) – Name used in the user interface.
        ...
        * **options** (*set**[**str**]*) – Enumerator in [Property Flag Items](../../../appendix/bpy_types_enum_items/property_flag_items.md#rna-enum-property-flag-items).
        * **override** (*set**[**str**]*) – Enumerator in [Property Override Flag Items](../../../appendix/bpy_types_enum_items/property_override_flag_items.md#rna-enum-property-override-flag-items).
        * **tags** (*set**[**str**]*) – Enumerator of tags that are defined by parent class.
        * **subtype** (*str*) – Enumerator in [Property Subtype Number Items](../../../appendix/bpy_types_enum_items/property_subtype_number_items.md#rna-enum-property-subtype-number-items).
        * **update** (Callable[[[`bpy.types.bpy_struct`](../types/bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct"), [`bpy.types.Context`](../types/Context.md#bpy.types.Context "bpy.types.Context")], None]) – Function to be called when this value is modified,
          This function must take 2 values (self, context) and return None.
          *Warning* there are no safety checks to avoid infinite recursion.
        * **get** (Callable[[[`bpy.types.bpy_struct`](../types/bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")], bool]) –

          Function to be called when this value is ‘read’, and the default,
        ...
        * **set** (Callable[[[`bpy.types.bpy_struct`](../types/bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct"), bool], None]) –

          Function to be called when this value is ‘written’, and the default,
          system-defined storage is not used for this property.
        ...
        * **get\_transform** (Callable[[[`bpy.types.bpy_struct`](../types/bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct"), bool, bool], bool]) –

          Function to be called when this value is ‘read’,
        ...
        * **set\_transform** (Callable[[[`bpy.types.bpy_struct`](../types/bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct"), bool, bool, bool], bool]) –

          Function to be called when this value is ‘written’,
...
bpy.props.BoolVectorProperty(*\**, *name=''*, *description=''*, *translation\_context='\*'*, *default=(False, False, False)*, *options={'ANIMATABLE'}*, *override=set()*, *tags=set()*, *subtype='NONE'*, *size=3*, *update=None*, *get=None*, *set=None*, *get\_transform=None*, *set\_transform=None*)[¶](#bpy.props.BoolVectorProperty "Link to this definition")
:   Returns a new vector boolean property definition.
    ...
    :   * **name** (*str*) – Name used in the user interface.
        ...
        * **override** (*set**[**str**]*) – Enumerator in [Property Override Flag Items](../../../appendix/bpy_types_enum_items/property_override_flag_items.md#rna-enum-property-override-flag-items).
        * **tags** (*set**[**str**]*) – Enumerator of tags that are defined by parent class.
        * **subtype** (*str*) – Enumerator in [Property Subtype Number Array Items](../../../appendix/bpy_types_enum_items/property_subtype_number_array_items.md#rna-enum-property-subtype-number-array-items).
        * **size** (*int* *|* *Sequence**[**int**]*) – Vector dimensions in [1, 32]. An int sequence can be used to define multi-dimension arrays.
        * **update** (Callable[[[`bpy.types.bpy_struct`](../types/bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct"), [`bpy.types.Context`](../types/Context.md#bpy.types.Context "bpy.types.Context")], None]) – Function to be called when this value is modified,
          This function must take 2 values (self, context) and return None.
          *Warning* there are no safety checks to avoid infinite recursion.
        * **get** (Callable[[[`bpy.types.bpy_struct`](../types/bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")], Sequence[bool]]) –
          ...
          Defining this callback without a matching `set` one will make the property read-only (even if `READ_ONLY` option is not set).
        * **set** (Callable[[[`bpy.types.bpy_struct`](../types/bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct"), tuple[bool, …]], None]) –
          ...
          Defining this callback without a matching `get` one is invalid.
        * **get\_transform** (Callable[[[`bpy.types.bpy_struct`](../types/bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct"), Sequence[bool], bool], Sequence[bool]]) –
          ...
          The callback is responsible to ensure that value limits of the property (min/max, length…) are respected. Otherwise a ValueError exception is raised.
        * **set\_transform** (Callable[[[`bpy.types.bpy_struct`](../types/bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct"), Sequence[bool], Sequence[bool], bool], Sequence[bool]]) –
...
bpy.props.CollectionProperty(*type*, *\**, *name=''*, *description=''*, *translation\_context='\*'*, *options={'ANIMATABLE'}*, *override=set()*, *tags=set()*)[¶](#bpy.props.CollectionProperty "Link to this definition")
:   Returns a new collection property definition.

    Parameters:
    :   * **type** (type[[`bpy.types.PropertyGroup`](../types/PropertyGroup.md#bpy.types.PropertyGroup "bpy.types.PropertyGroup")]) – A subclass of a property group.
        * **name** (*str*) – Name used in the user interface.
        * **description** (*str*) – Text used for the tooltip and api documentation.
        * **translation\_context** (*str*) – Text used as context to disambiguate translations.
        * **options** (*set**[**str**]*) – Enumerator in [Property Flag Items](../../../appendix/bpy_types_enum_items/property_flag_items.md#rna-enum-property-flag-items).
        * **override** (*set**[**str**]*) – Enumerator in [Property Override Flag Collection Items](../../../appendix/bpy_types_enum_items/property_override_flag_collection_items.md#rna-enum-property-override-flag-collection-items).
        * **tags** (*set**[**str**]*) – Enumerator of tags that are defined by parent class.

bpy.props.EnumProperty(*items*, *\**, *name=''*, *description=''*, *translation\_context='\*'*, *default=None*, *options={'ANIMATABLE'}*, *override=set()*, *tags=set()*, *update=None*, *get=None*, *set=None*, *get\_transform=None*, *set\_transform=None*)[¶](#bpy.props.EnumProperty "Link to this definition")
:   Returns a new enumerator property definition.

    Parameters:
    :   * **items** (Iterable[tuple[str, str, str] | tuple[str, str, str, int] | tuple[str, str, str, int, int] | None] | Callable[[[`bpy.types.bpy_struct`](../types/bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct"), [`bpy.types.Context`](../types/Context.md#bpy.types.Context "bpy.types.Context") | None], Iterable[tuple[str, str, str] | tuple[str, str, str, int] | tuple[str, str, str, int, int] | None]]) –
        ...
        * **description** (*str*) – Text used for the tooltip and api documentation.
        * **translation\_context** (*str*) – Text used as context to disambiguate translations.
        * **default** (*str* *|* *int* *|* *set**[**str**]*) – The default value for this enum, a string from the identifiers used in *items*, or integer matching an item number.
        ...
        * **options** (*set**[**str**]*) – Enumerator in [Property Flag Enum Items](../../../appendix/bpy_types_enum_items/property_flag_enum_items.md#rna-enum-property-flag-enum-items).
        * **override** (*set**[**str**]*) – Enumerator in [Property Override Flag Items](../../../appendix/bpy_types_enum_items/property_override_flag_items.md#rna-enum-property-override-flag-items).
        * **tags** (*set**[**str**]*) – Enumerator of tags that are defined by parent class.
        * **update** (Callable[[[`bpy.types.bpy_struct`](../types/bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct"), [`bpy.types.Context`](../types/Context.md#bpy.types.Context "bpy.types.Context")], None]) – Function to be called when this value is modified,
          This function must take 2 values (self, context) and return None.
          *Warning* there are no safety checks to avoid infinite recursion.
        * **get** (Callable[[[`bpy.types.bpy_struct`](../types/bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")], int]) –
          ...
          Defining this callback without a matching `set` one will make the property read-only (even if `READ_ONLY` option is not set).
        * **set** (Callable[[[`bpy.types.bpy_struct`](../types/bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct"), int], None]) –
          ...
          Defining this callback without a matching `get` one is invalid.
        * **get\_transform** (Callable[[[`bpy.types.bpy_struct`](../types/bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct"), int, bool], int]) –
          ...
          The callback is responsible to ensure that value limits of the property (min/max, length…) are respected. Otherwise a ValueError exception is raised.
        * **set\_transform** (Callable[[[`bpy.types.bpy_struct`](../types/bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct"), int, int, bool], int]) –
...
bpy.props.FloatProperty(*\**, *name=''*, *description=''*, *translation\_context='\*'*, *default=0.0*, *min=-3.402823e+38*, *max=3.402823e+38*, *soft\_min=-3.402823e+38*, *soft\_max=3.402823e+38*, *step=3*, *precision=2*, *options={'ANIMATABLE'}*, *override=set()*, *tags=set()*, *subtype='NONE'*, *unit='NONE'*, *update=None*, *get=None*, *set=None*, *get\_transform=None*, *set\_transform=None*)[¶](#bpy.props.FloatProperty "Link to this definition")
:   Returns a new float (single precision) property definition.
    ...
    :   * **name** (*str*) – Name used in the user interface.
        ...
        * **tags** (*set**[**str**]*) – Enumerator of tags that are defined by parent class.
        * **subtype** (*str*) – Enumerator in [Property Subtype Number Items](../../../appendix/bpy_types_enum_items/property_subtype_number_items.md#rna-enum-property-subtype-number-items).
        * **unit** (*str*) – Enumerator in [Property Unit Items](../../../appendix/bpy_types_enum_items/property_unit_items.md#rna-enum-property-unit-items).
        * **update** (Callable[[[`bpy.types.bpy_struct`](../types/bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct"), [`bpy.types.Context`](../types/Context.md#bpy.types.Context "bpy.types.Context")], None]) – Function to be called when this value is modified,
          This function must take 2 values (self, context) and return None.
          *Warning* there are no safety checks to avoid infinite recursion.
        * **get** (Callable[[[`bpy.types.bpy_struct`](../types/bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")], float]) –
          ...
          Defining this callback without a matching `set` one will make the property read-only (even if `READ_ONLY` option is not set).
        * **set** (Callable[[[`bpy.types.bpy_struct`](../types/bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct"), float], None]) –
          ...
          Defining this callback without a matching `get` one is invalid.
        * **get\_transform** (Callable[[[`bpy.types.bpy_struct`](../types/bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct"), float, bool], float]) –
          ...
          The callback is responsible to ensure that value limits of the property (min/max, length…) are respected. Otherwise a ValueError exception is raised.
        * **set\_transform** (Callable[[[`bpy.types.bpy_struct`](../types/bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct"), float, float, bool], float]) –
...
:   Returns a new vector float property definition.
    ...
    :   * **name** (*str*) – Name used in the user interface.
        ...
        * **update** (Callable[[[`bpy.types.bpy_struct`](../types/bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct"), [`bpy.types.Context`](../types/Context.md#bpy.types.Context "bpy.types.Context")], None]) – Function to be called when this value is modified,
          This function must take 2 values (self, context) and return None.
          *Warning* there are no safety checks to avoid infinite recursion.
        * **get** (Callable[[[`bpy.types.bpy_struct`](../types/bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")], Sequence[float]]) –
          ...
          Defining this callback without a matching `set` one will make the property read-only (even if `READ_ONLY` option is not set).
        * **set** (Callable[[[`bpy.types.bpy_struct`](../types/bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct"), tuple[float, …]], None]) –
          ...
          Defining this callback without a matching `get` one is invalid.
        * **get\_transform** (Callable[[[`bpy.types.bpy_struct`](../types/bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct"), Sequence[float], bool], Sequence[float]]) –
          ...
          The callback is responsible to ensure that value limits of the property (min/max, length…) are respected. Otherwise a ValueError exception is raised.
        * **set\_transform** (Callable[[[`bpy.types.bpy_struct`](../types/bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct"), Sequence[float], Sequence[float], bool], Sequence[float]]) –
...
bpy.props.IntProperty(*\**, *name=''*, *description=''*, *translation\_context='\*'*, *default=0*, *min=-2\*\*31*, *max=2\*\*31 - 1*, *soft\_min=-2\*\*31*, *soft\_max=2\*\*31 - 1*, *step=1*, *options={'ANIMATABLE'}*, *override=set()*, *tags=set()*, *subtype='NONE'*, *update=None*, *get=None*, *set=None*, *get\_transform=None*, *set\_transform=None*)[¶](#bpy.props.IntProperty "Link to this definition")
...
bpy.props.IntVectorProperty(*\**, *name=''*, *description=''*, *translation\_context='\*'*, *default=(0, 0, 0)*, *min=-2\*\*31*, *max=2\*\*31 - 1*, *soft\_min=-2\*\*31*, *soft\_max=2\*\*31 - 1*, *step=1*, *options={'ANIMATABLE'}*, *override=set()*, *tags=set()*, *subtype='NONE'*, *size=3*, *update=None*, *get=None*, *set=None*, *get\_transform=None*, *set\_transform=None*)[¶](#bpy.props.IntVectorProperty "Link to this definition")
:   Returns a new vector int property definition.
    ...
    :   * **name** (*str*) – Name used in the user interface.
        ...
        * **update** (Callable[[[`bpy.types.bpy_struct`](../types/bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct"), [`bpy.types.Context`](../types/Context.md#bpy.types.Context "bpy.types.Context")], None]) – Function to be called when this value is modified,
          This function must take 2 values (self, context) and return None.
          *Warning* there are no safety checks to avoid infinite recursion.
        * **get** (Callable[[[`bpy.types.bpy_struct`](../types/bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")], Sequence[int]]) –
          ...
          Defining this callback without a matching `set` one will make the property read-only (even if `READ_ONLY` option is not set).
        * **set** (Callable[[[`bpy.types.bpy_struct`](../types/bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct"), tuple[int, …]], None]) –
          ...
          Defining this callback without a matching `get` one is invalid.
        * **get\_transform** (Callable[[[`bpy.types.bpy_struct`](../types/bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct"), Sequence[int], bool], Sequence[int]]) –
          ...
          The callback is responsible to ensure that value limits of the property (min/max, length…) are respected. Otherwise a ValueError exception is raised.
        * **set\_transform** (Callable[[[`bpy.types.bpy_struct`](../types/bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct"), Sequence[int], Sequence[int], bool], Sequence[int]]) –
...
bpy.props.PointerProperty(*type*, *\**, *name=''*, *description=''*, *translation\_context='\*'*, *options={'ANIMATABLE'}*, *override=set()*, *tags=set()*, *poll=None*, *update=None*)[¶](#bpy.props.PointerProperty "Link to this definition")
:   Returns a new pointer property definition.

    Parameters:
    :   * **type** (type[[`bpy.types.PropertyGroup`](../types/PropertyGroup.md#bpy.types.PropertyGroup "bpy.types.PropertyGroup") | [`bpy.types.ID`](../types/ID.md#bpy.types.ID "bpy.types.ID")]) – A subclass of a property group or ID types.
        * **name** (*str*) – Name used in the user interface.
        * **description** (*str*) – Text used for the tooltip and api documentation.
        * **translation\_context** (*str*) – Text used as context to disambiguate translations.
        * **options** (*set**[**str**]*) – Enumerator in [Property Flag Items](../../../appendix/bpy_types_enum_items/property_flag_items.md#rna-enum-property-flag-items).
        * **override** (*set**[**str**]*) – Enumerator in [Property Override Flag Items](../../../appendix/bpy_types_enum_items/property_override_flag_items.md#rna-enum-property-override-flag-items).
        * **tags** (*set**[**str**]*) – Enumerator of tags that are defined by parent class.
        * **poll** (Callable[[[`bpy.types.bpy_struct`](../types/bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct"), [`bpy.types.ID`](../types/ID.md#bpy.types.ID "bpy.types.ID")], bool]) –

          Function that determines whether an item is valid for this property.
...
Pointer properties do not support storing references to embedded IDs (e.g. [`bpy.types.Scene.collection`](../types/Scene.md#bpy.types.Scene.collection "bpy.types.Scene.collection"), [`bpy.types.Material.node_tree`](../types/Material.md#bpy.types.Material.node_tree "bpy.types.Material.node_tree")).
...
bpy.props.StringProperty(*\**, *name=''*, *description=''*, *translation\_context='\*'*, *default=''*, *maxlen=0*, *options={'ANIMATABLE'}*, *override=set()*, *tags=set()*, *subtype='NONE'*, *update=None*, *get=None*, *set=None*, *get\_transform=None*, *set\_transform=None*, *search=None*, *search\_options={'SUGGESTION'}*)[¶](#bpy.props.StringProperty "Link to this definition")
:   Returns a new string property definition.
    ...
    :   * **name** (*str*) – Name used in the user interface.
        ...
        * **override** (*set**[**str**]*) – Enumerator in [Property Override Flag Items](../../../appendix/bpy_types_enum_items/property_override_flag_items.md#rna-enum-property-override-flag-items).
        * **tags** (*set**[**str**]*) – Enumerator of tags that are defined by parent class.
        * **subtype** (*str*) – Enumerator in [Property Subtype String Items](../../../appendix/bpy_types_enum_items/property_subtype_string_items.md#rna-enum-property-subtype-string-items).
        * **update** (Callable[[[`bpy.types.bpy_struct`](../types/bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct"), [`bpy.types.Context`](../types/Context.md#bpy.types.Context "bpy.types.Context")], None]) – Function to be called when this value is modified,
          This function must take 2 values (self, context) and return None.
          *Warning* there are no safety checks to avoid infinite recursion.
        * **get** (Callable[[[`bpy.types.bpy_struct`](../types/bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")], str]) –
          ...
          Defining this callback without a matching `set` one will make the property read-only (even if `READ_ONLY` option is not set).
        * **set** (Callable[[[`bpy.types.bpy_struct`](../types/bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct"), str], None]) –
          ...
          Defining this callback without a matching `get` one is invalid.
        * **get\_transform** (Callable[[[`bpy.types.bpy_struct`](../types/bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct"), str, bool], str]) –
          ...
          The callback is responsible to ensure that value limits of the property (min/max, length…) are respected. Otherwise a ValueError exception is raised.
        * **set\_transform** (Callable[[[`bpy.types.bpy_struct`](../types/bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct"), str, str, bool], str]) –
          ...
          The callback is responsible to ensure that value limits (min/max, length…) are respected. Otherwise a ValueError exception is raised.
        * **search** (Callable[[[`bpy.types.bpy_struct`](../types/bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct"), [`bpy.types.Context`](../types/Context.md#bpy.types.Context "bpy.types.Context"), str], Iterable[str | tuple[str, str]]]) –
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.props.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.props.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)
