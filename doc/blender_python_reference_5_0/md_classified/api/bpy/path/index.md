...
:   Returns the absolute path relative to the current blend file
    ...
    Parameters:
    :   * **start** (*str* *|* *bytes*) – Relative to this path,
...
:   Creates a display string from name to be used menus and the user interface.
    ...
    :   * **name** (*str*) – The name to be used for displaying the user interface.
        * **has\_ext** (*bool*) – Remove file extension from name.
        * **title\_case** (*bool*) – Convert lowercase names to title case.
...
:   Return the path with the extension added if it is not already set.
    ...
    :   * **filepath** (*str*) – The file path.
        * **ext** (*str*) – The extension to check for, can be a compound extension. Should
          start with a dot, such as `.blend` or `.tar.gz`.
        * **case\_sensitive** (*bool*) – Check for matching case when comparing extensions.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.path.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.path.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)
