...
bpy.ops.scene.drop\_scene\_asset(*\**, *session\_uid=0*)[¶](#bpy.ops.scene.drop_scene_asset "Link to this definition")
...
:   Add the data paths to the Freestyle Edge Mark property of selected edges to the active keying set
    ...
    File:
    :   [startup/bl\_operators/freestyle.py:139](https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/freestyle.py#L139)
...
:   Add the data paths to the Freestyle Face Mark property of selected polygons to the active keying set
    ...
    File:
    :   [startup/bl\_operators/freestyle.py:170](https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/freestyle.py#L170)
...
:   Fill the Range Min/Max entries by the min/max distance between selected mesh objects and the source object (either a user-specified object or the active camera)
    ...
    File:
    :   [startup/bl\_operators/freestyle.py:45](https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/freestyle.py#L45)
...
:   Open a style module file
    ...
    File:
    :   [startup/bl\_operators/freestyle.py:215](https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/freestyle.py#L215)
...
:   Refresh list of actions
    ...
    File:
    :   [addons\_core/io\_scene\_gltf2/blender/com/gltf2\_blender\_ui.py:606](https://projects.blender.org/blender/blender/src/branch/main/scripts/addons_core/io_scene_gltf2/blender/com/gltf2_blender_ui.py#L606)
...
bpy.ops.scene.new\_sequencer\_scene(*\**, *type='NEW'*)[¶](#bpy.ops.scene.new_sequencer_scene "Link to this definition")
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.ops.scene.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.ops.scene.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* Scene Operators
  + [`delete()`](#bpy.ops.scene.delete)
  + [`drop_scene_asset()`](#bpy.ops.scene.drop_scene_asset)
  ...
  + [`new_sequencer_scene()`](#bpy.ops.scene.new_sequencer_scene)
