...
# Pointcloud Operators[¶](#module-bpy.ops.pointcloud "Link to this heading")

bpy.ops.pointcloud.attribute\_set(*\**, *value\_float=0.0*, *value\_float\_vector\_2d=(0.0, 0.0)*, *value\_float\_vector\_3d=(0.0, 0.0, 0.0)*, *value\_int=0*, *value\_int\_vector\_2d=(0, 0)*, *value\_color=(1.0, 1.0, 1.0, 1.0)*, *value\_bool=False*)[¶](#bpy.ops.pointcloud.attribute_set "Link to this definition")
...
bpy.ops.pointcloud.delete()[¶](#bpy.ops.pointcloud.delete "Link to this definition")
:   Remove selected points

bpy.ops.pointcloud.duplicate()[¶](#bpy.ops.pointcloud.duplicate "Link to this definition")
:   Copy selected points

bpy.ops.pointcloud.duplicate\_move(*\**, *POINTCLOUD\_OT\_duplicate=None*, *TRANSFORM\_OT\_translate=None*)[¶](#bpy.ops.pointcloud.duplicate_move "Link to this definition")
:   Make copies of selected elements and move them

    Parameters:
    :   * **POINTCLOUD\_OT\_duplicate** (`POINTCLOUD_OT_duplicate`, (optional)) – Duplicate, Copy selected points
        * **TRANSFORM\_OT\_translate** (`TRANSFORM_OT_translate`, (optional)) – Move, Move selected items

bpy.ops.pointcloud.select\_all(*\**, *action='TOGGLE'*)[¶](#bpy.ops.pointcloud.select_all "Link to this definition")
...
bpy.ops.pointcloud.select\_random(*\**, *seed=0*, *probability=0.5*)[¶](#bpy.ops.pointcloud.select_random "Link to this definition")
...
bpy.ops.pointcloud.separate()[¶](#bpy.ops.pointcloud.separate "Link to this definition")
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.ops.pointcloud.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.ops.pointcloud.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* Pointcloud Operators
  + [`attribute_set()`](#bpy.ops.pointcloud.attribute_set)
  + [`delete()`](#bpy.ops.pointcloud.delete)
  + [`duplicate()`](#bpy.ops.pointcloud.duplicate)
  + [`duplicate_move()`](#bpy.ops.pointcloud.duplicate_move)
  + [`select_all()`](#bpy.ops.pointcloud.select_all)
  + [`select_random()`](#bpy.ops.pointcloud.select_random)
  + [`separate()`](#bpy.ops.pointcloud.separate)