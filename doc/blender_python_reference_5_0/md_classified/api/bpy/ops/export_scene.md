...
:   Write a FBX file
    ...
    :   * **filepath** (*string**,* *(**optional**,* *never None**)*) – File Path, Filepath used for exporting the file
        ...
        * **apply\_scale\_options** (enum in [`'FBX_SCALE_NONE'`, `'FBX_SCALE_UNITS'`, `'FBX_SCALE_CUSTOM'`, `'FBX_SCALE_ALL'`], (optional)) –
        ...
        * **mesh\_smooth\_type** (enum in [`'OFF'`, `'FACE'`, `'EDGE'`, `'SMOOTH_GROUP'`], (optional)) –
        ...
        * **batch\_mode** (enum in [`'OFF'`, `'SCENE'`, `'COLLECTION'`, `'SCENE_COLLECTION'`, `'ACTIVE_SCENE_COLLECTION'`], (optional)) –
...
:   Export scene as glTF 2.0 file
    ...
    :   * **filepath** (*string**,* *(**optional**,* *never None**)*) – File Path, Filepath used for exporting the file
        ...
        * **export\_gltfpack\_kn** (*boolean**,* *(**optional**)*) – Keep Named Nodes, Restrict some optimization to keep named nodes and meshes attached to named nodes so that named nodes can be transformed externally
        ...
        * **export\_materials** (enum in [`'EXPORT'`, `'PLACEHOLDER'`, `'VIEWPORT'`, `'NONE'`], (optional)) –
        ...
        * **export\_vertex\_color** (enum in [`'MATERIAL'`, `'ACTIVE'`, `'NAME'`, `'NONE'`], (optional)) –
        ...
        * **export\_vertex\_color\_name** (*string**,* *(**optional**,* *never None**)*) – Vertex Color Name, Name of vertex color to export
        ...
        * **export\_sampling\_interpolation\_fallback** (enum in [`'LINEAR'`, `'STEP'`], (optional)) –
        ...
        * **export\_animation\_mode** (enum in [`'ACTIONS'`, `'ACTIVE_ACTIONS'`, `'BROADCAST'`, `'NLA_TRACKS'`, `'SCENE'`], (optional)) –
        ...
        * **export\_merge\_animation** (enum in [`'NLA_TRACK'`, `'ACTION'`, `'NONE'`], (optional)) –
        ...
        * **export\_extra\_animations** (*boolean**,* *(**optional**)*) – Prepare Extra Animations, Export additional animations.This feature is not standard and needs an external extension to be included in the glTF file
        * **export\_loglevel** (*int in* *[**-inf**,* *inf**]**,* *(**optional**)*) – Log Level, Log Level
        * **filter\_glob** (*string**,* *(**optional**,* *never None**)*) – filter\_glob

    File:
    :   [addons\_core/io\_scene\_gltf2/\_\_init\_\_.py:1084](https://projects.blender.org/blender/blender/src/branch/main/scripts/addons_core/io_scene_gltf2/__init__.py#L1084)
