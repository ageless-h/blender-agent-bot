...
bpy.ops.file.external\_operation(*\**, *operation='OPEN'*)[¶](#bpy.ops.file.external_operation "Link to this definition")
...
bpy.ops.file.select(*\**, *wait\_to\_deselect\_others=False*, *use\_select\_on\_click=False*, *mouse\_x=0*, *mouse\_y=0*, *extend=False*, *fill=False*, *open=True*, *deselect\_all=False*, *only\_activate\_if\_selected=False*, *pass\_through=False*)[¶](#bpy.ops.file.select "Link to this definition")
