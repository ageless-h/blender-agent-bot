...
# Collection Operators[¶](#module-bpy.ops.collection "Link to this heading")

bpy.ops.collection.create(*\**, *name=''*)[¶](#bpy.ops.collection.create "Link to this definition")
:   Create an object collection from selected objects

    Parameters:
    :   **name** (*string**,* *(**optional**,* *never None**)*) – Name, Name of the new collection

bpy.ops.collection.export\_all()[¶](#bpy.ops.collection.export_all "Link to this definition")
:   Invoke all configured exporters on this collection

bpy.ops.collection.exporter\_add(*\**, *name=''*)[¶](#bpy.ops.collection.exporter_add "Link to this definition")
:   Add exporter to the exporter list

    Parameters:
    :   **name** (*string**,* *(**optional**,* *never None**)*) – Name, FileHandler idname

bpy.ops.collection.exporter\_export(*\**, *index=0*)[¶](#bpy.ops.collection.exporter_export "Link to this definition")
:   Invoke the export operation

    Parameters:
    :   **index** (*int in* *[**0**,* *inf**]**,* *(**optional**)*) – Index, Exporter index

bpy.ops.collection.exporter\_move(*\**, *direction='UP'*)[¶](#bpy.ops.collection.exporter_move "Link to this definition")
...
bpy.ops.collection.exporter\_remove(*\**, *index=0*)[¶](#bpy.ops.collection.exporter_remove "Link to this definition")
:   Remove exporter from the exporter list

    Parameters:
    :   **index** (*int in* *[**0**,* *inf**]**,* *(**optional**)*) – Index, Exporter index

bpy.ops.collection.objects\_add\_active(*\**, *collection=''*)[¶](#bpy.ops.collection.objects_add_active "Link to this definition")
...
bpy.ops.collection.objects\_remove(*\**, *collection=''*)[¶](#bpy.ops.collection.objects_remove "Link to this definition")
...
bpy.ops.collection.objects\_remove\_active(*\**, *collection=''*)[¶](#bpy.ops.collection.objects_remove_active "Link to this definition")
:   Remove the object from an object collection that contains the active object

    Parameters:
    :   **collection** (*enum in* *[**]**,* *(**optional**)*) – Collection, The collection to remove other selected objects from

bpy.ops.collection.objects\_remove\_all()[¶](#bpy.ops.collection.objects_remove_all "Link to this definition")
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.ops.collection.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.ops.collection.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* Collection Operators
  + [`create()`](#bpy.ops.collection.create)
  + [`export_all()`](#bpy.ops.collection.export_all)
  + [`exporter_add()`](#bpy.ops.collection.exporter_add)
  + [`exporter_export()`](#bpy.ops.collection.exporter_export)
  + [`exporter_move()`](#bpy.ops.collection.exporter_move)
  + [`exporter_remove()`](#bpy.ops.collection.exporter_remove)
  + [`objects_add_active()`](#bpy.ops.collection.objects_add_active)
  + [`objects_remove()`](#bpy.ops.collection.objects_remove)
  + [`objects_remove_active()`](#bpy.ops.collection.objects_remove_active)
  + [`objects_remove_all()`](#bpy.ops.collection.objects_remove_all)