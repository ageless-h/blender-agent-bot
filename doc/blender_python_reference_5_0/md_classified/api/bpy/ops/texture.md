...
# Texture Operators[¶](#module-bpy.ops.texture "Link to this heading")

bpy.ops.texture.new()[¶](#bpy.ops.texture.new "Link to this definition")
:   Add a new texture

bpy.ops.texture.slot\_copy()[¶](#bpy.ops.texture.slot_copy "Link to this definition")
:   Copy the material texture settings and nodes

bpy.ops.texture.slot\_move(*\**, *type='UP'*)[¶](#bpy.ops.texture.slot_move "Link to this definition")
:   Move texture slots up and down

    Parameters:
    :   **type** (enum in [`'UP'`, `'DOWN'`], (optional)) – Type

bpy.ops.texture.slot\_paste()[¶](#bpy.ops.texture.slot_paste "Link to this definition")
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.ops.texture.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.ops.texture.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* Texture Operators
  + [`new()`](#bpy.ops.texture.new)
  + [`slot_copy()`](#bpy.ops.texture.slot_copy)
  + [`slot_move()`](#bpy.ops.texture.slot_move)
  + [`slot_paste()`](#bpy.ops.texture.slot_paste)