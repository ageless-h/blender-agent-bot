...
:   Bake all selected objects location/scale/rotation animation to an action
    ...
    :   * **frame\_start** (*int in* *[**0**,* *300000**]**,* *(**optional**)*) – Start Frame, Start frame for baking
        ...
        * **clear\_constraints** (*boolean**,* *(**optional**)*) – Clear Constraints, Remove all constraints from keyed object/bones. To get a correct bake with this setting Visual Keying should be enabled
    ...
    File:
    :   [startup/bl\_operators/anim.py:274](https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/anim.py#L274)
...
bpy.ops.nla.click\_select(*\**, *wait\_to\_deselect\_others=False*, *use\_select\_on\_click=False*, *mouse\_x=0*, *mouse\_y=0*, *extend=False*, *deselect\_all=False*)[¶](#bpy.ops.nla.click_select "Link to this definition")
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.ops.nla.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.ops.nla.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)
