...
bpy.ops.marker.select(*\**, *wait\_to\_deselect\_others=False*, *use\_select\_on\_click=False*, *mouse\_x=0*, *mouse\_y=0*, *extend=False*, *camera=False*)[¶](#bpy.ops.marker.select "Link to this definition")
