...
# Boid Operators[¶](#module-bpy.ops.boid "Link to this heading")

bpy.ops.boid.rule\_add(*\**, *type='GOAL'*)[¶](#bpy.ops.boid.rule_add "Link to this definition")
:   Add a boid rule to the current boid state

    Parameters:
    :   **type** (enum in [Boidrule Type Items](../../../appendix/bpy_types_enum_items/boidrule_type_items.md#rna-enum-boidrule-type-items), (optional)) – Type

bpy.ops.boid.rule\_del()[¶](#bpy.ops.boid.rule_del "Link to this definition")
:   Delete current boid rule

bpy.ops.boid.rule\_move\_down()[¶](#bpy.ops.boid.rule_move_down "Link to this definition")
:   Move boid rule down in the list

bpy.ops.boid.rule\_move\_up()[¶](#bpy.ops.boid.rule_move_up "Link to this definition")
:   Move boid rule up in the list

bpy.ops.boid.state\_add()[¶](#bpy.ops.boid.state_add "Link to this definition")
:   Add a boid state to the particle system

bpy.ops.boid.state\_del()[¶](#bpy.ops.boid.state_del "Link to this definition")
:   Delete current boid state

bpy.ops.boid.state\_move\_down()[¶](#bpy.ops.boid.state_move_down "Link to this definition")
:   Move boid state down in the list

bpy.ops.boid.state\_move\_up()[¶](#bpy.ops.boid.state_move_up "Link to this definition")
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.ops.boid.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.ops.boid.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* Boid Operators
  + [`rule_add()`](#bpy.ops.boid.rule_add)
  + [`rule_del()`](#bpy.ops.boid.rule_del)
  + [`rule_move_down()`](#bpy.ops.boid.rule_move_down)
  + [`rule_move_up()`](#bpy.ops.boid.rule_move_up)
  + [`state_add()`](#bpy.ops.boid.state_add)
  + [`state_del()`](#bpy.ops.boid.state_del)
  + [`state_move_down()`](#bpy.ops.boid.state_move_down)
  + [`state_move_up()`](#bpy.ops.boid.state_move_up)