...
# Text Editor Operators[¶](#module-bpy.ops.text_editor "Link to this heading")

bpy.ops.text\_editor.preset\_add(*\**, *name=''*, *remove\_name=False*, *remove\_active=False*)[¶](#bpy.ops.text_editor.preset_add "Link to this definition")
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.ops.text_editor.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.ops.text_editor.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* Text Editor Operators
  + [`preset_add()`](#bpy.ops.text_editor.preset_add)