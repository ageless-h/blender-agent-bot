...
# Workspace Operators[¶](#module-bpy.ops.workspace "Link to this heading")

bpy.ops.workspace.add()[¶](#bpy.ops.workspace.add "Link to this definition")
:   Add a new workspace by duplicating the current one or appending one from the user configuration

bpy.ops.workspace.append\_activate(*\**, *idname=''*, *filepath=''*)[¶](#bpy.ops.workspace.append_activate "Link to this definition")
...
bpy.ops.workspace.delete()[¶](#bpy.ops.workspace.delete "Link to this definition")
:   Delete the active workspace

bpy.ops.workspace.delete\_all\_others()[¶](#bpy.ops.workspace.delete_all_others "Link to this definition")
:   Delete all workspaces except this one

bpy.ops.workspace.duplicate()[¶](#bpy.ops.workspace.duplicate "Link to this definition")
:   Add a new workspace

bpy.ops.workspace.reorder\_to\_back()[¶](#bpy.ops.workspace.reorder_to_back "Link to this definition")
:   Reorder workspace to be last in the list

bpy.ops.workspace.reorder\_to\_front()[¶](#bpy.ops.workspace.reorder_to_front "Link to this definition")
:   Reorder workspace to be first in the list

bpy.ops.workspace.scene\_pin\_toggle()[¶](#bpy.ops.workspace.scene_pin_toggle "Link to this definition")
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.ops.workspace.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.ops.workspace.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* Workspace Operators
  + [`add()`](#bpy.ops.workspace.add)
  + [`append_activate()`](#bpy.ops.workspace.append_activate)
  + [`delete()`](#bpy.ops.workspace.delete)
  + [`delete_all_others()`](#bpy.ops.workspace.delete_all_others)
  + [`duplicate()`](#bpy.ops.workspace.duplicate)
  + [`reorder_to_back()`](#bpy.ops.workspace.reorder_to_back)
  + [`reorder_to_front()`](#bpy.ops.workspace.reorder_to_front)
  + [`scene_pin_toggle()`](#bpy.ops.workspace.scene_pin_toggle)