...
# Paintcurve Operators[¶](#module-bpy.ops.paintcurve "Link to this heading")

bpy.ops.paintcurve.add\_point(*\**, *location=(0, 0)*)[¶](#bpy.ops.paintcurve.add_point "Link to this definition")
:   Add New Paint Curve Point

    Parameters:
    :   **location** (*int array* *of* *2 items in* *[**0**,* *32767**]**,* *(**optional**)*) – Location, Location of vertex in area space

bpy.ops.paintcurve.add\_point\_slide(*\**, *PAINTCURVE\_OT\_add\_point=None*, *PAINTCURVE\_OT\_slide=None*)[¶](#bpy.ops.paintcurve.add_point_slide "Link to this definition")
:   Add new curve point and slide it

    Parameters:
    :   * **PAINTCURVE\_OT\_add\_point** (`PAINTCURVE_OT_add_point`, (optional)) – Add New Paint Curve Point, Add New Paint Curve Point
        * **PAINTCURVE\_OT\_slide** (`PAINTCURVE_OT_slide`, (optional)) – Slide Paint Curve Point, Select and slide paint curve point

bpy.ops.paintcurve.cursor()[¶](#bpy.ops.paintcurve.cursor "Link to this definition")
:   Place cursor

bpy.ops.paintcurve.delete\_point()[¶](#bpy.ops.paintcurve.delete_point "Link to this definition")
:   Remove Paint Curve Point

bpy.ops.paintcurve.draw()[¶](#bpy.ops.paintcurve.draw "Link to this definition")
:   Draw curve

bpy.ops.paintcurve.new()[¶](#bpy.ops.paintcurve.new "Link to this definition")
:   Add new paint curve

bpy.ops.paintcurve.select(*\**, *location=(0, 0)*, *toggle=False*, *extend=False*)[¶](#bpy.ops.paintcurve.select "Link to this definition")
...
bpy.ops.paintcurve.slide(*\**, *align=False*, *select=True*)[¶](#bpy.ops.paintcurve.slide "Link to this definition")
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.ops.paintcurve.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.ops.paintcurve.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* Paintcurve Operators
  + [`add_point()`](#bpy.ops.paintcurve.add_point)
  + [`add_point_slide()`](#bpy.ops.paintcurve.add_point_slide)
  + [`cursor()`](#bpy.ops.paintcurve.cursor)
  + [`delete_point()`](#bpy.ops.paintcurve.delete_point)
  + [`draw()`](#bpy.ops.paintcurve.draw)
  + [`new()`](#bpy.ops.paintcurve.new)
  + [`select()`](#bpy.ops.paintcurve.select)
  + [`slide()`](#bpy.ops.paintcurve.slide)