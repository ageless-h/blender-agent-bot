...
:   Constant value bpy.utils.units.categories(NONE=’NONE’, LENGTH=’LENGTH’, AREA=’AREA’, VOLUME=’VOLUME’, MASS=’MASS’, ROTATION=’ROTATION’, TIME=’TIME’, TIME\_ABSOLUTE=’TIME\_ABSOLUTE’, VELOCITY=’VELOCITY’, ACCELERATION=’ACCELERATION’, CAMERA=’CAMERA’, POWER=’POWER’, TEMPERATURE=’TEMPERATURE’, WAVELENGTH=’WAVELENGTH’, COLOR\_TEMPERATURE=’COLOR\_TEMPERATURE’, FREQUENCY=’FREQUENCY’)
...
:   Convert a given input float value into a string with units.
    ...
    Parameters:
    :   * **unit\_system** (*str*) – The unit system, from [`bpy.utils.units.systems`](#bpy.utils.units.systems "bpy.utils.units.systems").
        * **unit\_category** (*str*) – The category of data we are converting (length, area, rotation, etc.),
        ...
        * **compatible\_unit** (*bool*) – Whether to use keyboard-friendly units (1m2) or nicer UTF8 ones (1m²).
...
:   Convert a given input string into a float value.
    ...
    :   * **unit\_system** (*str*) – The unit system, from [`bpy.utils.units.systems`](#bpy.utils.units.systems "bpy.utils.units.systems").
        * **unit\_category** (*str*) – The category of data we are converting (length, area, rotation, etc.),
          from [`bpy.utils.units.categories`](#bpy.utils.units.categories "bpy.utils.units.categories").
        * **str\_input** (*str*) – The string to convert to a float value.
        * **str\_ref\_unit** (*str* *|* *None*) – A reference string from which to extract a default unit, if none is found in `str_input`.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.utils.units.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy.utils.units.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)
