...
# File Paths & String Encoding[¶](#file-paths-string-encoding "Link to this heading")

## Relative File Paths[¶](#relative-file-paths "Link to this heading")
...
When the data block may be from an external blend-file pass the library argument from the [`bpy.types.ID`](../../api/bpy/types/ID.md#bpy.types.ID "bpy.types.ID").
...
## Unicode Problems[¶](#unicode-problems "Link to this heading")
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60info_gotchas_file_paths_and_encoding.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Finfo_gotchas_file_paths_and_encoding.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)
