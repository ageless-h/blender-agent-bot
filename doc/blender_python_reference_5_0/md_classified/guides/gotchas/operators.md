...
# Using Operators[¶](#using-operators "Link to this heading")
...
## Why does an operator’s poll fail?[¶](#why-does-an-operator-s-poll-fail "Link to this heading")
...
feel free to add calls to [`bpy.types.Operator.poll_message_set`](../../api/bpy/types/Operator.md#bpy.types.Operator.poll_message_set "bpy.types.Operator.poll_message_set") (`CTX_wm_operator_poll_msg_set` in C)
...
In some cases using [`bpy.types.Context.temp_override`](../../api/bpy/types/Context.md#bpy.types.Context.temp_override "bpy.types.Context.temp_override") to enable temporary logging or using the
`context` category when [logging](https://docs.blender.org/manual/en/dev/advanced/command_line/arguments.html#command-line-args-logging-options "(in Blender 5.1 Manual v5.1)") can help.

## The operator still doesn’t work![¶](#the-operator-still-doesn-t-work "Link to this heading")
...
* [`bpy.ops.texture.slot_move`](../../api/bpy/ops/texture.md#bpy.ops.texture.slot_move "bpy.ops.texture.slot_move")
* [`bpy.ops.constraint.limitdistance_reset`](../../api/bpy/ops/constraint.md#bpy.ops.constraint.limitdistance_reset "bpy.ops.constraint.limitdistance_reset")
* [`bpy.ops.object.modifier_copy`](../../api/bpy/ops/object.md#bpy.ops.object.modifier_copy "bpy.ops.object.modifier_copy")
* [`bpy.ops.buttons.file_browse`](../../api/bpy/ops/buttons.md#bpy.ops.buttons.file_browse "bpy.ops.buttons.file_browse")
...
Modes and Mesh Access](meshes.md)
[Previous

Internal Data & Their Python Objects](internal_data_and_python_objects.md)
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60info_gotchas_operators.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Finfo_gotchas_operators.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* Using Operators
  + [Why does an operator’s poll fail?](#why-does-an-operator-s-poll-fail)
  + [The operator still doesn’t work!](#the-operator-still-doesn-t-work)