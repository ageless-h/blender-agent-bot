...
# Troubleshooting Errors & Crashes[¶](#troubleshooting-errors-crashes "Link to this heading")

## Help! My script crashes Blender[¶](#help-my-script-crashes-blender "Link to this heading")
...
* See last subsection about [Unfortunate Corner Cases](#unfortunate-corner-cases) for some known breaking exceptions.

Note

To find the line of your script that crashes you can use the `faulthandler` module.
See the [Faulthandler docs](https://docs.python.org/dev/library/faulthandler.html).
...
### Undo/Redo[¶](#undo-redo "Link to this heading")

For safety, you should assume that undo and redo always invalidates all [`bpy.types.ID`](../../api/bpy/types/ID.md#bpy.types.ID "bpy.types.ID")
...
This is especially true when modifying Blender data [in operators](../../api/bpy/types/Operator.md#operator-modifying-blender-data-undo).

#### Undo & Library Data[¶](#undo-library-data "Link to this heading")
...
### Abusing RNA property callbacks[¶](#abusing-rna-property-callbacks "Link to this heading")
...
### Edit-Mode / Memory Access[¶](#edit-mode-memory-access "Link to this heading")
...
### Array Re-Allocation[¶](#array-re-allocation "Link to this heading")
...
### Removing Data[¶](#removing-data "Link to this heading")
...
### Unfortunate Corner Cases[¶](#unfortunate-corner-cases "Link to this heading")
...
#### Collection Objects[¶](#collection-objects "Link to this heading")
...
#### Data-Blocks Renaming During Iteration[¶](#data-blocks-renaming-during-iteration "Link to this heading")
...
## sys.exit[¶](#sys-exit "Link to this heading")
...
* Troubleshooting Errors & Crashes
  + [Help! My script crashes Blender](#help-my-script-crashes-blender)
    - [Undo/Redo](#undo-redo)
      * [Modifying Blender Data & Undo](#modifying-blender-data-undo)
      * [Undo & Library Data](#undo-library-data)
    - [Abusing RNA property callbacks](#abusing-rna-property-callbacks)
    - [Edit-Mode / Memory Access](#edit-mode-memory-access)
    ...
    - [Unfortunate Corner Cases](#unfortunate-corner-cases)
      ...
      * [Data-Blocks Renaming During Iteration](#data-blocks-renaming-during-iteration)
  + [sys.exit](#sys-exit)