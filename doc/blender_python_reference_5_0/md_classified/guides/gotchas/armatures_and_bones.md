...
# Bones & Armatures[¶](#bones-armatures "Link to this heading")

## Edit Bones, Pose Bones, Bone… Bones[¶](#edit-bones-pose-bones-bone-bones "Link to this heading")
...
### Edit Bones[¶](#edit-bones "Link to this heading")
...
Example using [`bpy.types.EditBone`](../../api/bpy/types/EditBone.md#bpy.types.EditBone "bpy.types.EditBone") in armature Edit-Mode
...
### Bones (Object-Mode)[¶](#bones-object-mode "Link to this heading")
...
Example using [`bpy.types.Bone`](../../api/bpy/types/Bone.md#bpy.types.Bone "bpy.types.Bone") in Object or Pose-Mode
...
### Pose Bones[¶](#pose-bones "Link to this heading")
...
Examples using [`bpy.types.PoseBone`](../../api/bpy/types/PoseBone.md#bpy.types.PoseBone "bpy.types.PoseBone") in Object or Pose-Mode:
...
stored in the [`bpy.types.Object`](../../api/bpy/types/Object.md#bpy.types.Object "bpy.types.Object") rather than the [`bpy.types.Armature`](../../api/bpy/types/Armature.md#bpy.types.Armature "bpy.types.Armature"),
yet the real bones are accessible from the pose bones via [`bpy.types.PoseBone.bone`](../../api/bpy/types/PoseBone.md#bpy.types.PoseBone.bone "bpy.types.PoseBone.bone").

## Armature Mode Switching[¶](#armature-mode-switching "Link to this heading")
...
File Paths & String Encoding](file_paths_and_encoding.md)
[Previous
...
* Bones & Armatures
  + [Edit Bones, Pose Bones, Bone… Bones](#edit-bones-pose-bones-bone-bones)
    - [Edit Bones](#edit-bones)
    - [Bones (Object-Mode)](#bones-object-mode)
    - [Pose Bones](#pose-bones)
  + [Armature Mode Switching](#armature-mode-switching)