...
# Types with Custom Property Support[¶](#types-with-custom-property-support "Link to this heading")
...
[Custom Properties](quickstart.md#info-quickstart-custom-properties).

* [`bpy.types.Bone`](../api/bpy/types/Bone.md#bpy.types.Bone "bpy.types.Bone")
* [`bpy.types.BoneCollection`](../api/bpy/types/BoneCollection.md#bpy.types.BoneCollection "bpy.types.BoneCollection")
* [`bpy.types.EditBone`](../api/bpy/types/EditBone.md#bpy.types.EditBone "bpy.types.EditBone")
* [`bpy.types.GizmoGroupProperties`](../api/bpy/types/GizmoGroupProperties.md#bpy.types.GizmoGroupProperties "bpy.types.GizmoGroupProperties")
* [`bpy.types.GizmoProperties`](../api/bpy/types/GizmoProperties.md#bpy.types.GizmoProperties "bpy.types.GizmoProperties")
* [`bpy.types.ID`](../api/bpy/types/ID.md#bpy.types.ID "bpy.types.ID")
* [`bpy.types.KeyConfigPreferences`](../api/bpy/types/KeyConfigPreferences.md#bpy.types.KeyConfigPreferences "bpy.types.KeyConfigPreferences")
* [`bpy.types.Node`](../api/bpy/types/Node.md#bpy.types.Node "bpy.types.Node")
* [`bpy.types.NodeSocket`](../api/bpy/types/NodeSocket.md#bpy.types.NodeSocket "bpy.types.NodeSocket")
* [`bpy.types.NodeTreeInterfaceSocket`](../api/bpy/types/NodeTreeInterfaceSocket.md#bpy.types.NodeTreeInterfaceSocket "bpy.types.NodeTreeInterfaceSocket")
* [`bpy.types.NodesModifier`](../api/bpy/types/NodesModifier.md#bpy.types.NodesModifier "bpy.types.NodesModifier")
* [`bpy.types.OperatorProperties`](../api/bpy/types/OperatorProperties.md#bpy.types.OperatorProperties "bpy.types.OperatorProperties")
* [`bpy.types.PoseBone`](../api/bpy/types/PoseBone.md#bpy.types.PoseBone "bpy.types.PoseBone")
* [`bpy.types.PropertyGroup`](../api/bpy/types/PropertyGroup.md#bpy.types.PropertyGroup "bpy.types.PropertyGroup")
* [`bpy.types.Strip`](../api/bpy/types/Strip.md#bpy.types.Strip "bpy.types.Strip")
* [`bpy.types.TimelineMarker`](../api/bpy/types/TimelineMarker.md#bpy.types.TimelineMarker "bpy.types.TimelineMarker")
* [`bpy.types.View3DShading`](../api/bpy/types/View3DShading.md#bpy.types.View3DShading "bpy.types.View3DShading")
* [`bpy.types.ViewLayer`](../api/bpy/types/ViewLayer.md#bpy.types.ViewLayer "bpy.types.ViewLayer")
...
File Path Foreach Flag Items](../appendix/bpy_types_enum_items/file_path_foreach_flag_items.md)
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy_types_custom_properties.rst%60%0D%0ABlender+Version%3A+%605.0%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F5.0%2Fbpy_types_custom_properties.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)