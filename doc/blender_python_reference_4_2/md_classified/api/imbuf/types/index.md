...
*class* imbuf.types.ImBuf[#](#imbuf.types.ImBuf "Link to this definition")
:   copy()[#](#imbuf.types.ImBuf.copy "Link to this definition")
    :   Returns:
        :   A copy of the image.
    ...
    crop(*min*, *max*)[#](#imbuf.types.ImBuf.crop "Link to this definition")
    :   Crop the image.
    ...
    free()[#](#imbuf.types.ImBuf.free "Link to this definition")
    :   Clear image data immediately (causing an error on re-use).

    resize(*size*, *method='FAST'*)[#](#imbuf.types.ImBuf.resize "Link to this definition")
    :   Resize the image.
    ...
    channels[#](#imbuf.types.ImBuf.channels "Link to this definition")
    :   Number of bit-planes.

        Type:
        :   int

    filepath[#](#imbuf.types.ImBuf.filepath "Link to this definition")
    :   filepath associated with this image.

        Type:
        :   string

    planes[#](#imbuf.types.ImBuf.planes "Link to this definition")
    :   Number of bits associated with this image.

        Type:
        :   int

    ppm[#](#imbuf.types.ImBuf.ppm "Link to this definition")
    :   pixels per meter.

        Type:
        :   pair of floats

    size[#](#imbuf.types.ImBuf.size "Link to this definition")
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60imbuf.types.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fimbuf.types.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* Image Buffer Types (imbuf.types)
  + [`ImBuf`](#imbuf.types.ImBuf)
    - [`ImBuf.copy()`](#imbuf.types.ImBuf.copy)
    - [`ImBuf.crop()`](#imbuf.types.ImBuf.crop)
    - [`ImBuf.free()`](#imbuf.types.ImBuf.free)
    - [`ImBuf.resize()`](#imbuf.types.ImBuf.resize)
    - [`ImBuf.channels`](#imbuf.types.ImBuf.channels)
    - [`ImBuf.filepath`](#imbuf.types.ImBuf.filepath)
    - [`ImBuf.planes`](#imbuf.types.ImBuf.planes)
    - [`ImBuf.ppm`](#imbuf.types.ImBuf.ppm)
    - [`ImBuf.size`](#imbuf.types.ImBuf.size)