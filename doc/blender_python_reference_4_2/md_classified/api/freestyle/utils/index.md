...
freestyle.utils.pairwise(*iterable*, *types={<class 'Stroke'>*, *<class 'StrokeVertexIterator'>}*)[#](#freestyle.utils.pairwise "Link to this definition")
...
*class* freestyle.utils.BoundingBox[#](#freestyle.utils.BoundingBox "Link to this definition")
:   Object representing a bounding box consisting out of 2 2D vectors

    inside(*other*)[#](#freestyle.utils.BoundingBox.inside "Link to this definition")
    :   True if self inside other, False otherwise

*class* freestyle.utils.StrokeCollector[#](#freestyle.utils.StrokeCollector "Link to this definition")
:   Collects and Stores stroke objects

    shade(*stroke*)[#](#freestyle.utils.StrokeCollector.shade "Link to this definition")
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60freestyle.utils.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Ffreestyle.utils.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)
...
* Freestyle Utilities (freestyle.utils)
  ...
  + [`BoundingBox`](#freestyle.utils.BoundingBox)
    - [`BoundingBox.inside()`](#freestyle.utils.BoundingBox.inside)
  + [`StrokeCollector`](#freestyle.utils.StrokeCollector)
    - [`StrokeCollector.shade()`](#freestyle.utils.StrokeCollector.shade)