...
:   Draw a circle.
    ...
    :   * **position** (*2D Vector*) – Position where the circle will be drawn.
        * **color** (*tuple containing RGBA values*) – Color of the circle. To use transparency GL\_BLEND has to be enabled.
        * **radius** (*float*) – Radius of the circle.
        * **segments** (*int* *or* *None*) – How many segments will be used to draw the circle.
...
gpu\_extras.presets.draw\_texture\_2d(*texture*, *position*, *width*, *height*)[#](#gpu_extras.presets.draw_texture_2d "Link to this definition")
:   Draw a 2d texture.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60gpu_extras.presets.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fgpu_extras.presets.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)
