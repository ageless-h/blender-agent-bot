...
# Message Bus (bpy.msgbus)[#](#module-bpy.msgbus "Link to this heading")
...
## Example Use[#](#example-use "Link to this heading")
...
bpy.msgbus.clear\_by\_owner(*owner*)[#](#bpy.msgbus.clear_by_owner "Link to this definition")
:   Clear all subscribers using this owner.

bpy.msgbus.publish\_rna(*key*)[#](#bpy.msgbus.publish_rna "Link to this definition")
:   Parameters:
    :   **key** (*Multiple*) –
        ...
        Arguments include
        - [`bpy.types.Property`](../types/Property.md#bpy.types.Property "bpy.types.Property") instance.
        - [`bpy.types.Struct`](../types/Struct.md#bpy.types.Struct "bpy.types.Struct") type.
        - ([`bpy.types.Struct`](../types/Struct.md#bpy.types.Struct "bpy.types.Struct"), str) type and property name.
...
bpy.msgbus.subscribe\_rna(*key*, *owner*, *args*, *notify*, *options=set()*)[#](#bpy.msgbus.subscribe_rna "Link to this definition")
:   Register a message bus subscription. It will be cleared when another blend file is
    loaded, or can be cleared explicitly via [`bpy.msgbus.clear_by_owner()`](#bpy.msgbus.clear_by_owner "bpy.msgbus.clear_by_owner").
...
see [`bpy.app.handlers.load_post`](../app/handlers.md#bpy.app.handlers.load_post "bpy.app.handlers.load_post").
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.msgbus.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.msgbus.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)
...
* Message Bus (bpy.msgbus)
  ...
  + [Example Use](#example-use)
    ...
    - [`publish_rna()`](#bpy.msgbus.publish_rna)
