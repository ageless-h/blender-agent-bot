...
# GeometryNodeRaycast(GeometryNode)[#](#geometrynoderaycast-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeRaycast(*GeometryNode*)[#](#bpy.types.GeometryNodeRaycast "Link to this definition")
:   Cast rays from the context geometry onto a target geometry, and retrieve information from each hit point

    data\_type[#](#bpy.types.GeometryNodeRaycast.data_type "Link to this definition")
    ...
    mapping[#](#bpy.types.GeometryNodeRaycast.mapping "Link to this definition")
    :   Mapping from the target geometry to hit points
        ...
        * `NEAREST`
        ...
        Type:
        :   enum in [‘INTERPOLATED’, ‘NEAREST’], default ‘INTERPOLATED’

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.GeometryNodeRaycast.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.GeometryNodeRaycast.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.GeometryNodeRaycast.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.GeometryNodeRaycast.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.GeometryNodeRaycast.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeRaycast.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.GeometryNodeRaycast.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeRaycast(GeometryNode)
  + [`GeometryNodeRaycast`](#bpy.types.GeometryNodeRaycast)
    - [`GeometryNodeRaycast.data_type`](#bpy.types.GeometryNodeRaycast.data_type)
    - [`GeometryNodeRaycast.mapping`](#bpy.types.GeometryNodeRaycast.mapping)
    - [`GeometryNodeRaycast.is_registered_node_type()`](#bpy.types.GeometryNodeRaycast.is_registered_node_type)
    - [`GeometryNodeRaycast.input_template()`](#bpy.types.GeometryNodeRaycast.input_template)
    - [`GeometryNodeRaycast.output_template()`](#bpy.types.GeometryNodeRaycast.output_template)
    - [`GeometryNodeRaycast.bl_rna_get_subclass()`](#bpy.types.GeometryNodeRaycast.bl_rna_get_subclass)
    - [`GeometryNodeRaycast.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeRaycast.bl_rna_get_subclass_py)
