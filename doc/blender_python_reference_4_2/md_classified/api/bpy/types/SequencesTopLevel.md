...
# SequencesTopLevel(bpy\_struct)[#](#sequencestoplevel-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.SequencesTopLevel(*bpy\_struct*)[#](#bpy.types.SequencesTopLevel "Link to this definition")
:   Collection of Sequences

    new\_clip(*name*, *clip*, *channel*, *frame\_start*)[#](#bpy.types.SequencesTopLevel.new_clip "Link to this definition")
    :   Add a new movie clip sequence
        ...
        :   * **name** (*string**,* *(**never None**)*) – Name for the new sequence
            ...
            * **channel** (*int in* *[**1**,* *128**]*) – Channel, The channel for the new sequence
            * **frame\_start** (*int in* *[**-1048574**,* *1048574**]*) – The start frame for the new sequence
    ...
    new\_mask(*name*, *mask*, *channel*, *frame\_start*)[#](#bpy.types.SequencesTopLevel.new_mask "Link to this definition")
    ...
    new\_scene(*name*, *scene*, *channel*, *frame\_start*)[#](#bpy.types.SequencesTopLevel.new_scene "Link to this definition")
    ...
    new\_image(*name*, *filepath*, *channel*, *frame\_start*, *fit\_method='ORIGINAL'*)[#](#bpy.types.SequencesTopLevel.new_image "Link to this definition")
    :   Add a new image sequence
        ...
        :   * **name** (*string**,* *(**never None**)*) – Name for the new sequence
            ...
            * **channel** (*int in* *[**1**,* *128**]*) – Channel, The channel for the new sequence
            * **frame\_start** (*int in* *[**-1048574**,* *1048574**]*) – The start frame for the new sequence
            * **fit\_method** (*enum in* *[**'FIT'**,* *'FILL'**,* *'STRETCH'**,* *'ORIGINAL'**]**,* *(**optional**,* *optional argument**)*) –
    ...
    new\_movie(*name*, *filepath*, *channel*, *frame\_start*, *fit\_method='ORIGINAL'*)[#](#bpy.types.SequencesTopLevel.new_movie "Link to this definition")
    ...
    new\_sound(*name*, *filepath*, *channel*, *frame\_start*)[#](#bpy.types.SequencesTopLevel.new_sound "Link to this definition")
    ...
    new\_meta(*name*, *channel*, *frame\_start*)[#](#bpy.types.SequencesTopLevel.new_meta "Link to this definition")
    ...
    new\_effect(*name*, *type*, *channel*, *frame\_start*, *frame\_end=0*, *seq1=None*, *seq2=None*)[#](#bpy.types.SequencesTopLevel.new_effect "Link to this definition")
    :   Add a new effect sequence

        Parameters:
        :   * **name** (*string**,* *(**never None**)*) – Name for the new sequence
            * **type** (*enum in* *[**'CROSS'**,* *'ADD'**,* *'SUBTRACT'**,* *'ALPHA\_OVER'**,* *'ALPHA\_UNDER'**,* *'GAMMA\_CROSS'**,* *'MULTIPLY'**,* *'OVER\_DROP'**,* *'WIPE'**,* *'GLOW'**,* *'TRANSFORM'**,* *'COLOR'**,* *'SPEED'**,* *'MULTICAM'**,* *'ADJUSTMENT'**,* *'GAUSSIAN\_BLUR'**,* *'TEXT'**,* *'COLORMIX'**]*) – Type, type for the new sequence
            * **channel** (*int in* *[**1**,* *128**]*) – Channel, The channel for the new sequence
            * **frame\_start** (*int in* *[**-inf**,* *inf**]*) – The start frame for the new sequence
            * **frame\_end** (*int in* *[**-inf**,* *inf**]**,* *(**optional**)*) – The end frame for the new sequence
            * **seq1** ([`Sequence`](Sequence.md#bpy.types.Sequence "bpy.types.Sequence"), (optional)) – Sequence 1 for effect
            * **seq2** ([`Sequence`](Sequence.md#bpy.types.Sequence "bpy.types.Sequence"), (optional)) – Sequence 2 for effect
    ...
    remove(*sequence*)[#](#bpy.types.SequencesTopLevel.remove "Link to this definition")
    :   Remove a Sequence

        Parameters:
        :   **sequence** ([`Sequence`](Sequence.md#bpy.types.Sequence "bpy.types.Sequence"), (never None)) – Sequence to remove

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.SequencesTopLevel.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.SequencesTopLevel.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`SequenceEditor.sequences`](SequenceEditor.md#bpy.types.SequenceEditor.sequences "bpy.types.SequenceEditor.sequences") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.SequencesTopLevel.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.SequencesTopLevel.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* SequencesTopLevel(bpy\_struct)
  + [`SequencesTopLevel`](#bpy.types.SequencesTopLevel)
    - [`SequencesTopLevel.new_clip()`](#bpy.types.SequencesTopLevel.new_clip)
    - [`SequencesTopLevel.new_mask()`](#bpy.types.SequencesTopLevel.new_mask)
    - [`SequencesTopLevel.new_scene()`](#bpy.types.SequencesTopLevel.new_scene)
    - [`SequencesTopLevel.new_image()`](#bpy.types.SequencesTopLevel.new_image)
    - [`SequencesTopLevel.new_movie()`](#bpy.types.SequencesTopLevel.new_movie)
    - [`SequencesTopLevel.new_sound()`](#bpy.types.SequencesTopLevel.new_sound)
    - [`SequencesTopLevel.new_meta()`](#bpy.types.SequencesTopLevel.new_meta)
    - [`SequencesTopLevel.new_effect()`](#bpy.types.SequencesTopLevel.new_effect)
    - [`SequencesTopLevel.remove()`](#bpy.types.SequencesTopLevel.remove)
    - [`SequencesTopLevel.bl_rna_get_subclass()`](#bpy.types.SequencesTopLevel.bl_rna_get_subclass)
    - [`SequencesTopLevel.bl_rna_get_subclass_py()`](#bpy.types.SequencesTopLevel.bl_rna_get_subclass_py)
