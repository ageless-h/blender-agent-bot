...
# CompositorNodeTexture(CompositorNode)[#](#compositornodetexture-compositornode "Link to this heading")
...
*class* bpy.types.CompositorNodeTexture(*CompositorNode*)[#](#bpy.types.CompositorNodeTexture "Link to this definition")
:   Generate texture pattern from texture datablock

    node\_output[#](#bpy.types.CompositorNodeTexture.node_output "Link to this definition")
    :   For node-based textures, which output node to use

        Type:
        :   int in [-32768, 32767], default 0

    texture[#](#bpy.types.CompositorNodeTexture.texture "Link to this definition")
    :   Type:
        :   [`Texture`](Texture.md#bpy.types.Texture "bpy.types.Texture")

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.CompositorNodeTexture.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.CompositorNodeTexture.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.CompositorNodeTexture.output_template "Link to this definition")
    ...
    update()[#](#bpy.types.CompositorNodeTexture.update "Link to this definition")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.CompositorNodeTexture.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.CompositorNodeTexture.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CompositorNodeTexture.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.CompositorNodeTexture.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CompositorNodeTexture(CompositorNode)
  + [`CompositorNodeTexture`](#bpy.types.CompositorNodeTexture)
    - [`CompositorNodeTexture.node_output`](#bpy.types.CompositorNodeTexture.node_output)
    - [`CompositorNodeTexture.texture`](#bpy.types.CompositorNodeTexture.texture)
    - [`CompositorNodeTexture.is_registered_node_type()`](#bpy.types.CompositorNodeTexture.is_registered_node_type)
    - [`CompositorNodeTexture.input_template()`](#bpy.types.CompositorNodeTexture.input_template)
    - [`CompositorNodeTexture.output_template()`](#bpy.types.CompositorNodeTexture.output_template)
    - [`CompositorNodeTexture.update()`](#bpy.types.CompositorNodeTexture.update)
    - [`CompositorNodeTexture.bl_rna_get_subclass()`](#bpy.types.CompositorNodeTexture.bl_rna_get_subclass)
    - [`CompositorNodeTexture.bl_rna_get_subclass_py()`](#bpy.types.CompositorNodeTexture.bl_rna_get_subclass_py)
