...
# CompositorNodeInvert(CompositorNode)[#](#compositornodeinvert-compositornode "Link to this heading")
...
*class* bpy.types.CompositorNodeInvert(*CompositorNode*)[#](#bpy.types.CompositorNodeInvert "Link to this definition")
:   Invert colors, producing a negative

    invert\_alpha[#](#bpy.types.CompositorNodeInvert.invert_alpha "Link to this definition")
    :   Type:
        :   boolean, default False

    invert\_rgb[#](#bpy.types.CompositorNodeInvert.invert_rgb "Link to this definition")
    :   Type:
        :   boolean, default False

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.CompositorNodeInvert.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.CompositorNodeInvert.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.CompositorNodeInvert.output_template "Link to this definition")
    ...
    update()[#](#bpy.types.CompositorNodeInvert.update "Link to this definition")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.CompositorNodeInvert.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.CompositorNodeInvert.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CompositorNodeInvert.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.CompositorNodeInvert.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CompositorNodeInvert(CompositorNode)
  + [`CompositorNodeInvert`](#bpy.types.CompositorNodeInvert)
    - [`CompositorNodeInvert.invert_alpha`](#bpy.types.CompositorNodeInvert.invert_alpha)
    - [`CompositorNodeInvert.invert_rgb`](#bpy.types.CompositorNodeInvert.invert_rgb)
    - [`CompositorNodeInvert.is_registered_node_type()`](#bpy.types.CompositorNodeInvert.is_registered_node_type)
    - [`CompositorNodeInvert.input_template()`](#bpy.types.CompositorNodeInvert.input_template)
    - [`CompositorNodeInvert.output_template()`](#bpy.types.CompositorNodeInvert.output_template)
    - [`CompositorNodeInvert.update()`](#bpy.types.CompositorNodeInvert.update)
    - [`CompositorNodeInvert.bl_rna_get_subclass()`](#bpy.types.CompositorNodeInvert.bl_rna_get_subclass)
    - [`CompositorNodeInvert.bl_rna_get_subclass_py()`](#bpy.types.CompositorNodeInvert.bl_rna_get_subclass_py)
