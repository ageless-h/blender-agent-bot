...
# ShaderNodeGroup(ShaderNode)[#](#shadernodegroup-shadernode "Link to this heading")
...
*class* bpy.types.ShaderNodeGroup(*ShaderNode*)[#](#bpy.types.ShaderNodeGroup "Link to this definition")
:   node\_tree[#](#bpy.types.ShaderNodeGroup.node_tree "Link to this definition")
    :   Type:
        :   [`NodeTree`](NodeTree.md#bpy.types.NodeTree "bpy.types.NodeTree")

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.ShaderNodeGroup.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.ShaderNodeGroup.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.ShaderNodeGroup.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.ShaderNodeGroup.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.ShaderNodeGroup.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ShaderNodeGroup.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.ShaderNodeGroup.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ShaderNodeGroup(ShaderNode)
  + [`ShaderNodeGroup`](#bpy.types.ShaderNodeGroup)
    - [`ShaderNodeGroup.node_tree`](#bpy.types.ShaderNodeGroup.node_tree)
    - [`ShaderNodeGroup.is_registered_node_type()`](#bpy.types.ShaderNodeGroup.is_registered_node_type)
    - [`ShaderNodeGroup.input_template()`](#bpy.types.ShaderNodeGroup.input_template)
    - [`ShaderNodeGroup.output_template()`](#bpy.types.ShaderNodeGroup.output_template)
    - [`ShaderNodeGroup.bl_rna_get_subclass()`](#bpy.types.ShaderNodeGroup.bl_rna_get_subclass)
    - [`ShaderNodeGroup.bl_rna_get_subclass_py()`](#bpy.types.ShaderNodeGroup.bl_rna_get_subclass_py)
