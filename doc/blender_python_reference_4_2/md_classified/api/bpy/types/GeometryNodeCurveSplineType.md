...
# GeometryNodeCurveSplineType(GeometryNode)[#](#geometrynodecurvesplinetype-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeCurveSplineType(*GeometryNode*)[#](#bpy.types.GeometryNodeCurveSplineType "Link to this definition")
:   Change the type of curves

    spline\_type[#](#bpy.types.GeometryNodeCurveSplineType.spline_type "Link to this definition")
    :   The curve type to change the selected curves to

        Type:
        :   enum in [Curves Type Items](../../../appendix/bpy_types_enum_items/curves_type_items.md#rna-enum-curves-type-items), default ‘POLY’

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.GeometryNodeCurveSplineType.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.GeometryNodeCurveSplineType.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.GeometryNodeCurveSplineType.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.GeometryNodeCurveSplineType.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.GeometryNodeCurveSplineType.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeCurveSplineType.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.GeometryNodeCurveSplineType.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeCurveSplineType(GeometryNode)
  + [`GeometryNodeCurveSplineType`](#bpy.types.GeometryNodeCurveSplineType)
    - [`GeometryNodeCurveSplineType.spline_type`](#bpy.types.GeometryNodeCurveSplineType.spline_type)
    - [`GeometryNodeCurveSplineType.is_registered_node_type()`](#bpy.types.GeometryNodeCurveSplineType.is_registered_node_type)
    - [`GeometryNodeCurveSplineType.input_template()`](#bpy.types.GeometryNodeCurveSplineType.input_template)
    - [`GeometryNodeCurveSplineType.output_template()`](#bpy.types.GeometryNodeCurveSplineType.output_template)
    - [`GeometryNodeCurveSplineType.bl_rna_get_subclass()`](#bpy.types.GeometryNodeCurveSplineType.bl_rna_get_subclass)
    - [`GeometryNodeCurveSplineType.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeCurveSplineType.bl_rna_get_subclass_py)
