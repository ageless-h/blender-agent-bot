...
# GPencilEditCurve(bpy\_struct)[#](#gpencileditcurve-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.GPencilEditCurve(*bpy\_struct*)[#](#bpy.types.GPencilEditCurve "Link to this definition")
:   Edition Curve

    curve\_points[#](#bpy.types.GPencilEditCurve.curve_points "Link to this definition")
    :   Curve data points

        Type:
        :   [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`GPencilEditCurvePoint`](GPencilEditCurvePoint.md#bpy.types.GPencilEditCurvePoint "bpy.types.GPencilEditCurvePoint"), (readonly)

    select[#](#bpy.types.GPencilEditCurve.select "Link to this definition")
    :   Curve is selected for viewport editing

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.GPencilEditCurve.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.GPencilEditCurve.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`GPencilStroke.edit_curve`](GPencilStroke.md#bpy.types.GPencilStroke.edit_curve "bpy.types.GPencilStroke.edit_curve") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GPencilEditCurve.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.GPencilEditCurve.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GPencilEditCurve(bpy\_struct)
  + [`GPencilEditCurve`](#bpy.types.GPencilEditCurve)
    - [`GPencilEditCurve.curve_points`](#bpy.types.GPencilEditCurve.curve_points)
    - [`GPencilEditCurve.select`](#bpy.types.GPencilEditCurve.select)
    - [`GPencilEditCurve.bl_rna_get_subclass()`](#bpy.types.GPencilEditCurve.bl_rna_get_subclass)
    - [`GPencilEditCurve.bl_rna_get_subclass_py()`](#bpy.types.GPencilEditCurve.bl_rna_get_subclass_py)
