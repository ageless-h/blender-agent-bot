...
# ShaderNodeBsdfAnisotropic(ShaderNode)[#](#shadernodebsdfanisotropic-shadernode "Link to this heading")
...
*class* bpy.types.ShaderNodeBsdfAnisotropic(*ShaderNode*)[#](#bpy.types.ShaderNodeBsdfAnisotropic "Link to this definition")
:   Reflection with microfacet distribution, used for materials such as metal or mirrors

    distribution[#](#bpy.types.ShaderNodeBsdfAnisotropic.distribution "Link to this definition")
    :   Light scattering distribution on rough surface
        ...
        * `MULTI_GGX`
        ...
        Type:
        :   enum in [‘BECKMANN’, ‘GGX’, ‘ASHIKHMIN\_SHIRLEY’, ‘MULTI\_GGX’], default ‘BECKMANN’

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.ShaderNodeBsdfAnisotropic.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.ShaderNodeBsdfAnisotropic.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.ShaderNodeBsdfAnisotropic.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.ShaderNodeBsdfAnisotropic.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.ShaderNodeBsdfAnisotropic.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ShaderNodeBsdfAnisotropic.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.ShaderNodeBsdfAnisotropic.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ShaderNodeBsdfAnisotropic(ShaderNode)
  + [`ShaderNodeBsdfAnisotropic`](#bpy.types.ShaderNodeBsdfAnisotropic)
    - [`ShaderNodeBsdfAnisotropic.distribution`](#bpy.types.ShaderNodeBsdfAnisotropic.distribution)
    - [`ShaderNodeBsdfAnisotropic.is_registered_node_type()`](#bpy.types.ShaderNodeBsdfAnisotropic.is_registered_node_type)
    - [`ShaderNodeBsdfAnisotropic.input_template()`](#bpy.types.ShaderNodeBsdfAnisotropic.input_template)
    - [`ShaderNodeBsdfAnisotropic.output_template()`](#bpy.types.ShaderNodeBsdfAnisotropic.output_template)
    - [`ShaderNodeBsdfAnisotropic.bl_rna_get_subclass()`](#bpy.types.ShaderNodeBsdfAnisotropic.bl_rna_get_subclass)
    - [`ShaderNodeBsdfAnisotropic.bl_rna_get_subclass_py()`](#bpy.types.ShaderNodeBsdfAnisotropic.bl_rna_get_subclass_py)
