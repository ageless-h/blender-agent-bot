...
# GeometryNodeViewportTransform(GeometryNode)[#](#geometrynodeviewporttransform-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeViewportTransform(*GeometryNode*)[#](#bpy.types.GeometryNodeViewportTransform "Link to this definition")
:   Retrieve the view direction and location of the 3D viewport

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.GeometryNodeViewportTransform.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.GeometryNodeViewportTransform.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.GeometryNodeViewportTransform.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.GeometryNodeViewportTransform.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.GeometryNodeViewportTransform.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeViewportTransform.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.GeometryNodeViewportTransform.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeViewportTransform(GeometryNode)
  + [`GeometryNodeViewportTransform`](#bpy.types.GeometryNodeViewportTransform)
    - [`GeometryNodeViewportTransform.is_registered_node_type()`](#bpy.types.GeometryNodeViewportTransform.is_registered_node_type)
    - [`GeometryNodeViewportTransform.input_template()`](#bpy.types.GeometryNodeViewportTransform.input_template)
    - [`GeometryNodeViewportTransform.output_template()`](#bpy.types.GeometryNodeViewportTransform.output_template)
    - [`GeometryNodeViewportTransform.bl_rna_get_subclass()`](#bpy.types.GeometryNodeViewportTransform.bl_rna_get_subclass)
    - [`GeometryNodeViewportTransform.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeViewportTransform.bl_rna_get_subclass_py)
