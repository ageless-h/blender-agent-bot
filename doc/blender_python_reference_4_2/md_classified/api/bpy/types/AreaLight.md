...
:   Directional area Light
    ...
    contact\_shadow\_bias[#](#bpy.types.AreaLight.contact_shadow_bias "Link to this definition")
    :   Bias to avoid self shadowing

        Type:
        :   float in [0.001, 9999], default 0.03

    contact\_shadow\_distance[#](#bpy.types.AreaLight.contact_shadow_distance "Link to this definition")
    :   World space distance in which to search for screen space occluder

        Type:
        :   float in [0, 9999], default 0.2

    contact\_shadow\_thickness[#](#bpy.types.AreaLight.contact_shadow_thickness "Link to this definition")
    ...
    shadow\_buffer\_bias[#](#bpy.types.AreaLight.shadow_buffer_bias "Link to this definition")
    ...
    shadow\_color[#](#bpy.types.AreaLight.shadow_color "Link to this definition")
    ...
    use\_contact\_shadow[#](#bpy.types.AreaLight.use_contact_shadow "Link to this definition")
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.AreaLight.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.AreaLight.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* AreaLight(Light)
  + [`AreaLight`](#bpy.types.AreaLight)
    - [`AreaLight.contact_shadow_bias`](#bpy.types.AreaLight.contact_shadow_bias)
    - [`AreaLight.contact_shadow_distance`](#bpy.types.AreaLight.contact_shadow_distance)
    - [`AreaLight.contact_shadow_thickness`](#bpy.types.AreaLight.contact_shadow_thickness)
    - [`AreaLight.energy`](#bpy.types.AreaLight.energy)
    - [`AreaLight.shadow_buffer_bias`](#bpy.types.AreaLight.shadow_buffer_bias)
    - [`AreaLight.shadow_buffer_clip_start`](#bpy.types.AreaLight.shadow_buffer_clip_start)
    - [`AreaLight.shadow_color`](#bpy.types.AreaLight.shadow_color)
    ...
    - [`AreaLight.use_contact_shadow`](#bpy.types.AreaLight.use_contact_shadow)
