...
# GpencilModifier(bpy\_struct)[#](#gpencilmodifier-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

subclasses —
[`ArmatureGpencilModifier`](ArmatureGpencilModifier.md#bpy.types.ArmatureGpencilModifier "bpy.types.ArmatureGpencilModifier"), [`ArrayGpencilModifier`](ArrayGpencilModifier.md#bpy.types.ArrayGpencilModifier "bpy.types.ArrayGpencilModifier"), [`BuildGpencilModifier`](BuildGpencilModifier.md#bpy.types.BuildGpencilModifier "bpy.types.BuildGpencilModifier"), [`ColorGpencilModifier`](ColorGpencilModifier.md#bpy.types.ColorGpencilModifier "bpy.types.ColorGpencilModifier"), [`DashGpencilModifierData`](DashGpencilModifierData.md#bpy.types.DashGpencilModifierData "bpy.types.DashGpencilModifierData"), [`EnvelopeGpencilModifier`](EnvelopeGpencilModifier.md#bpy.types.EnvelopeGpencilModifier "bpy.types.EnvelopeGpencilModifier"), [`HookGpencilModifier`](HookGpencilModifier.md#bpy.types.HookGpencilModifier "bpy.types.HookGpencilModifier"), [`LatticeGpencilModifier`](LatticeGpencilModifier.md#bpy.types.LatticeGpencilModifier "bpy.types.LatticeGpencilModifier"), [`LengthGpencilModifier`](LengthGpencilModifier.md#bpy.types.LengthGpencilModifier "bpy.types.LengthGpencilModifier"), [`LineartGpencilModifier`](LineartGpencilModifier.md#bpy.types.LineartGpencilModifier "bpy.types.LineartGpencilModifier"), [`MirrorGpencilModifier`](MirrorGpencilModifier.md#bpy.types.MirrorGpencilModifier "bpy.types.MirrorGpencilModifier"), [`MultiplyGpencilModifier`](MultiplyGpencilModifier.md#bpy.types.MultiplyGpencilModifier "bpy.types.MultiplyGpencilModifier"), [`NoiseGpencilModifier`](NoiseGpencilModifier.md#bpy.types.NoiseGpencilModifier "bpy.types.NoiseGpencilModifier"), [`OffsetGpencilModifier`](OffsetGpencilModifier.md#bpy.types.OffsetGpencilModifier "bpy.types.OffsetGpencilModifier"), [`OpacityGpencilModifier`](OpacityGpencilModifier.md#bpy.types.OpacityGpencilModifier "bpy.types.OpacityGpencilModifier"), [`OutlineGpencilModifier`](OutlineGpencilModifier.md#bpy.types.OutlineGpencilModifier "bpy.types.OutlineGpencilModifier"), [`ShrinkwrapGpencilModifier`](ShrinkwrapGpencilModifier.md#bpy.types.ShrinkwrapGpencilModifier "bpy.types.ShrinkwrapGpencilModifier"), [`SimplifyGpencilModifier`](SimplifyGpencilModifier.md#bpy.types.SimplifyGpencilModifier "bpy.types.SimplifyGpencilModifier"), [`SmoothGpencilModifier`](SmoothGpencilModifier.md#bpy.types.SmoothGpencilModifier "bpy.types.SmoothGpencilModifier"), [`SubdivGpencilModifier`](SubdivGpencilModifier.md#bpy.types.SubdivGpencilModifier "bpy.types.SubdivGpencilModifier"), [`TextureGpencilModifier`](TextureGpencilModifier.md#bpy.types.TextureGpencilModifier "bpy.types.TextureGpencilModifier"), [`ThickGpencilModifier`](ThickGpencilModifier.md#bpy.types.ThickGpencilModifier "bpy.types.ThickGpencilModifier"), [`TimeGpencilModifier`](TimeGpencilModifier.md#bpy.types.TimeGpencilModifier "bpy.types.TimeGpencilModifier"), [`TintGpencilModifier`](TintGpencilModifier.md#bpy.types.TintGpencilModifier "bpy.types.TintGpencilModifier"), [`WeightAngleGpencilModifier`](WeightAngleGpencilModifier.md#bpy.types.WeightAngleGpencilModifier "bpy.types.WeightAngleGpencilModifier"), [`WeightProxGpencilModifier`](WeightProxGpencilModifier.md#bpy.types.WeightProxGpencilModifier "bpy.types.WeightProxGpencilModifier")

*class* bpy.types.GpencilModifier(*bpy\_struct*)[#](#bpy.types.GpencilModifier "Link to this definition")
:   Modifier affecting the Grease Pencil object

    is\_override\_data[#](#bpy.types.GpencilModifier.is_override_data "Link to this definition")
    ...
    name[#](#bpy.types.GpencilModifier.name "Link to this definition")
    :   Modifier name

        Type:
        :   string, default “”, (never None)

    show\_expanded[#](#bpy.types.GpencilModifier.show_expanded "Link to this definition")
    :   Set modifier expanded in the user interface

        Type:
        :   boolean, default False

    show\_in\_editmode[#](#bpy.types.GpencilModifier.show_in_editmode "Link to this definition")
    :   Display modifier in Edit mode

        Type:
        :   boolean, default False

    show\_render[#](#bpy.types.GpencilModifier.show_render "Link to this definition")
    :   Use modifier during render

        Type:
        :   boolean, default False

    show\_viewport[#](#bpy.types.GpencilModifier.show_viewport "Link to this definition")
    :   Display modifier in viewport

        Type:
        :   boolean, default False

    type[#](#bpy.types.GpencilModifier.type "Link to this definition")
    :   Type:
        :   enum in [Object Greasepencil Modifier Type Items](../../../appendix/bpy_types_enum_items/object_greasepencil_modifier_type_items.md#rna-enum-object-greasepencil-modifier-type-items), default ‘GP\_TEXTURE’, (readonly)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.GpencilModifier.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.GpencilModifier.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
        ...
        Return type:
        :   [type](#bpy.types.GpencilModifier.type "bpy.types.GpencilModifier.type")
...
|  |  |
| --- | --- |
| * [`Object.grease_pencil_modifiers`](Object.md#bpy.types.Object.grease_pencil_modifiers "bpy.types.Object.grease_pencil_modifiers") * [`ObjectGpencilModifiers.new`](ObjectGpencilModifiers.md#bpy.types.ObjectGpencilModifiers.new "bpy.types.ObjectGpencilModifiers.new") | * [`ObjectGpencilModifiers.remove`](ObjectGpencilModifiers.md#bpy.types.ObjectGpencilModifiers.remove "bpy.types.ObjectGpencilModifiers.remove") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GpencilModifier.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.GpencilModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GpencilModifier(bpy\_struct)
  + [`GpencilModifier`](#bpy.types.GpencilModifier)
    - [`GpencilModifier.is_override_data`](#bpy.types.GpencilModifier.is_override_data)
    - [`GpencilModifier.name`](#bpy.types.GpencilModifier.name)
    - [`GpencilModifier.show_expanded`](#bpy.types.GpencilModifier.show_expanded)
    - [`GpencilModifier.show_in_editmode`](#bpy.types.GpencilModifier.show_in_editmode)
    - [`GpencilModifier.show_render`](#bpy.types.GpencilModifier.show_render)
    - [`GpencilModifier.show_viewport`](#bpy.types.GpencilModifier.show_viewport)
    - [`GpencilModifier.type`](#bpy.types.GpencilModifier.type)
    - [`GpencilModifier.bl_rna_get_subclass()`](#bpy.types.GpencilModifier.bl_rna_get_subclass)
    - [`GpencilModifier.bl_rna_get_subclass_py()`](#bpy.types.GpencilModifier.bl_rna_get_subclass_py)
