...
# ShaderNodeVectorRotate(ShaderNode)[#](#shadernodevectorrotate-shadernode "Link to this heading")
...
*class* bpy.types.ShaderNodeVectorRotate(*ShaderNode*)[#](#bpy.types.ShaderNodeVectorRotate "Link to this definition")
:   Rotate a vector around a pivot point (center)

    invert[#](#bpy.types.ShaderNodeVectorRotate.invert "Link to this definition")
    :   Invert the rotation angle

        Type:
        :   boolean, default False

    rotation\_type[#](#bpy.types.ShaderNodeVectorRotate.rotation_type "Link to this definition")
    :   Type of angle input
        ...
        * `EULER_XYZ`
        ...
        Type:
        :   enum in [‘AXIS\_ANGLE’, ‘X\_AXIS’, ‘Y\_AXIS’, ‘Z\_AXIS’, ‘EULER\_XYZ’], default ‘AXIS\_ANGLE’

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.ShaderNodeVectorRotate.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.ShaderNodeVectorRotate.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.ShaderNodeVectorRotate.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.ShaderNodeVectorRotate.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.ShaderNodeVectorRotate.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ShaderNodeVectorRotate.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.ShaderNodeVectorRotate.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ShaderNodeVectorRotate(ShaderNode)
  + [`ShaderNodeVectorRotate`](#bpy.types.ShaderNodeVectorRotate)
    - [`ShaderNodeVectorRotate.invert`](#bpy.types.ShaderNodeVectorRotate.invert)
    - [`ShaderNodeVectorRotate.rotation_type`](#bpy.types.ShaderNodeVectorRotate.rotation_type)
    - [`ShaderNodeVectorRotate.is_registered_node_type()`](#bpy.types.ShaderNodeVectorRotate.is_registered_node_type)
    - [`ShaderNodeVectorRotate.input_template()`](#bpy.types.ShaderNodeVectorRotate.input_template)
    - [`ShaderNodeVectorRotate.output_template()`](#bpy.types.ShaderNodeVectorRotate.output_template)
    - [`ShaderNodeVectorRotate.bl_rna_get_subclass()`](#bpy.types.ShaderNodeVectorRotate.bl_rna_get_subclass)
    - [`ShaderNodeVectorRotate.bl_rna_get_subclass_py()`](#bpy.types.ShaderNodeVectorRotate.bl_rna_get_subclass_py)
