...
# FunctionNodeFloatToInt(FunctionNode)[#](#functionnodefloattoint-functionnode "Link to this heading")
...
*class* bpy.types.FunctionNodeFloatToInt(*FunctionNode*)[#](#bpy.types.FunctionNodeFloatToInt "Link to this definition")
:   rounding\_mode[#](#bpy.types.FunctionNodeFloatToInt.rounding_mode "Link to this definition")
    :   Method used to convert the float to an integer

        Type:
        :   enum in [Node Float To Int Items](../../../appendix/bpy_types_enum_items/node_float_to_int_items.md#rna-enum-node-float-to-int-items), default ‘ROUND’

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.FunctionNodeFloatToInt.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.FunctionNodeFloatToInt.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.FunctionNodeFloatToInt.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.FunctionNodeFloatToInt.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.FunctionNodeFloatToInt.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.FunctionNodeFloatToInt.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.FunctionNodeFloatToInt.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* FunctionNodeFloatToInt(FunctionNode)
  + [`FunctionNodeFloatToInt`](#bpy.types.FunctionNodeFloatToInt)
    - [`FunctionNodeFloatToInt.rounding_mode`](#bpy.types.FunctionNodeFloatToInt.rounding_mode)
    - [`FunctionNodeFloatToInt.is_registered_node_type()`](#bpy.types.FunctionNodeFloatToInt.is_registered_node_type)
    - [`FunctionNodeFloatToInt.input_template()`](#bpy.types.FunctionNodeFloatToInt.input_template)
    - [`FunctionNodeFloatToInt.output_template()`](#bpy.types.FunctionNodeFloatToInt.output_template)
    - [`FunctionNodeFloatToInt.bl_rna_get_subclass()`](#bpy.types.FunctionNodeFloatToInt.bl_rna_get_subclass)
    - [`FunctionNodeFloatToInt.bl_rna_get_subclass_py()`](#bpy.types.FunctionNodeFloatToInt.bl_rna_get_subclass_py)
