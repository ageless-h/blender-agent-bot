...
# SoundSequence(Sequence)[#](#soundsequence-sequence "Link to this heading")
...
*class* bpy.types.SoundSequence(*Sequence*)[#](#bpy.types.SoundSequence "Link to this definition")
:   Sequence strip defining a sound to be played over a period of time

    animation\_offset\_end[#](#bpy.types.SoundSequence.animation_offset_end "Link to this definition")
    :   Animation end offset (trim end)

        Type:
        :   int in [0, inf], default 0

    animation\_offset\_start[#](#bpy.types.SoundSequence.animation_offset_start "Link to this definition")
    :   Animation start offset (trim start)

        Type:
        :   int in [0, inf], default 0

    pan[#](#bpy.types.SoundSequence.pan "Link to this definition")
    :   Playback panning of the sound (only for Mono sources)

        Type:
        :   float in [-inf, inf], default 0.0

    show\_waveform[#](#bpy.types.SoundSequence.show_waveform "Link to this definition")
    :   Display the audio waveform inside the strip

        Type:
        :   boolean, default False

    sound[#](#bpy.types.SoundSequence.sound "Link to this definition")
    :   Sound data-block used by this sequence

        Type:
        :   [`Sound`](Sound.md#bpy.types.Sound "bpy.types.Sound")

    volume[#](#bpy.types.SoundSequence.volume "Link to this definition")
    :   Playback volume of the sound

        Type:
        :   float in [0, 100], default 0.0

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.SoundSequence.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.SoundSequence.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.SoundSequence.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.SoundSequence.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* SoundSequence(Sequence)
  + [`SoundSequence`](#bpy.types.SoundSequence)
    - [`SoundSequence.animation_offset_end`](#bpy.types.SoundSequence.animation_offset_end)
    - [`SoundSequence.animation_offset_start`](#bpy.types.SoundSequence.animation_offset_start)
    - [`SoundSequence.pan`](#bpy.types.SoundSequence.pan)
    - [`SoundSequence.show_waveform`](#bpy.types.SoundSequence.show_waveform)
    - [`SoundSequence.sound`](#bpy.types.SoundSequence.sound)
    - [`SoundSequence.volume`](#bpy.types.SoundSequence.volume)
    - [`SoundSequence.bl_rna_get_subclass()`](#bpy.types.SoundSequence.bl_rna_get_subclass)
    - [`SoundSequence.bl_rna_get_subclass_py()`](#bpy.types.SoundSequence.bl_rna_get_subclass_py)
