...
# GeometryNodePointsToVolume(GeometryNode)[#](#geometrynodepointstovolume-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodePointsToVolume(*GeometryNode*)[#](#bpy.types.GeometryNodePointsToVolume "Link to this definition")
:   Generate a fog volume sphere around every point

    resolution\_mode[#](#bpy.types.GeometryNodePointsToVolume.resolution_mode "Link to this definition")
    :   How the voxel size is specified
        ...
        * `VOXEL_SIZE`
        ...
        Type:
        :   enum in [‘VOXEL\_AMOUNT’, ‘VOXEL\_SIZE’], default ‘VOXEL\_AMOUNT’

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.GeometryNodePointsToVolume.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.GeometryNodePointsToVolume.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.GeometryNodePointsToVolume.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.GeometryNodePointsToVolume.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.GeometryNodePointsToVolume.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodePointsToVolume.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.GeometryNodePointsToVolume.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodePointsToVolume(GeometryNode)
  + [`GeometryNodePointsToVolume`](#bpy.types.GeometryNodePointsToVolume)
    - [`GeometryNodePointsToVolume.resolution_mode`](#bpy.types.GeometryNodePointsToVolume.resolution_mode)
    - [`GeometryNodePointsToVolume.is_registered_node_type()`](#bpy.types.GeometryNodePointsToVolume.is_registered_node_type)
    - [`GeometryNodePointsToVolume.input_template()`](#bpy.types.GeometryNodePointsToVolume.input_template)
    - [`GeometryNodePointsToVolume.output_template()`](#bpy.types.GeometryNodePointsToVolume.output_template)
    - [`GeometryNodePointsToVolume.bl_rna_get_subclass()`](#bpy.types.GeometryNodePointsToVolume.bl_rna_get_subclass)
    - [`GeometryNodePointsToVolume.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodePointsToVolume.bl_rna_get_subclass_py)
