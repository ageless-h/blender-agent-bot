...
# CompositorNodeCrop(CompositorNode)[#](#compositornodecrop-compositornode "Link to this heading")
...
*class* bpy.types.CompositorNodeCrop(*CompositorNode*)[#](#bpy.types.CompositorNodeCrop "Link to this definition")
:   Crops image to a smaller region, either making the cropped area transparent or resizing the image

    max\_x[#](#bpy.types.CompositorNodeCrop.max_x "Link to this definition")
    :   Type:
        :   int in [0, 10000], default 0

    max\_y[#](#bpy.types.CompositorNodeCrop.max_y "Link to this definition")
    :   Type:
        :   int in [0, 10000], default 0

    min\_x[#](#bpy.types.CompositorNodeCrop.min_x "Link to this definition")
    :   Type:
        :   int in [0, 10000], default 0

    min\_y[#](#bpy.types.CompositorNodeCrop.min_y "Link to this definition")
    :   Type:
        :   int in [0, 10000], default 0

    rel\_max\_x[#](#bpy.types.CompositorNodeCrop.rel_max_x "Link to this definition")
    :   Type:
        :   float in [0, 1], default 0.0

    rel\_max\_y[#](#bpy.types.CompositorNodeCrop.rel_max_y "Link to this definition")
    :   Type:
        :   float in [0, 1], default 0.0

    rel\_min\_x[#](#bpy.types.CompositorNodeCrop.rel_min_x "Link to this definition")
    :   Type:
        :   float in [0, 1], default 0.0

    rel\_min\_y[#](#bpy.types.CompositorNodeCrop.rel_min_y "Link to this definition")
    :   Type:
        :   float in [0, 1], default 0.0

    relative[#](#bpy.types.CompositorNodeCrop.relative "Link to this definition")
    :   Use relative values to crop image

        Type:
        :   boolean, default False

    use\_crop\_size[#](#bpy.types.CompositorNodeCrop.use_crop_size "Link to this definition")
    :   Whether to crop the size of the input image

        Type:
        :   boolean, default False

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.CompositorNodeCrop.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.CompositorNodeCrop.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.CompositorNodeCrop.output_template "Link to this definition")
    ...
    update()[#](#bpy.types.CompositorNodeCrop.update "Link to this definition")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.CompositorNodeCrop.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.CompositorNodeCrop.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CompositorNodeCrop.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.CompositorNodeCrop.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CompositorNodeCrop(CompositorNode)
  + [`CompositorNodeCrop`](#bpy.types.CompositorNodeCrop)
    - [`CompositorNodeCrop.max_x`](#bpy.types.CompositorNodeCrop.max_x)
    - [`CompositorNodeCrop.max_y`](#bpy.types.CompositorNodeCrop.max_y)
    - [`CompositorNodeCrop.min_x`](#bpy.types.CompositorNodeCrop.min_x)
    - [`CompositorNodeCrop.min_y`](#bpy.types.CompositorNodeCrop.min_y)
    - [`CompositorNodeCrop.rel_max_x`](#bpy.types.CompositorNodeCrop.rel_max_x)
    - [`CompositorNodeCrop.rel_max_y`](#bpy.types.CompositorNodeCrop.rel_max_y)
    - [`CompositorNodeCrop.rel_min_x`](#bpy.types.CompositorNodeCrop.rel_min_x)
    - [`CompositorNodeCrop.rel_min_y`](#bpy.types.CompositorNodeCrop.rel_min_y)
    - [`CompositorNodeCrop.relative`](#bpy.types.CompositorNodeCrop.relative)
    - [`CompositorNodeCrop.use_crop_size`](#bpy.types.CompositorNodeCrop.use_crop_size)
    - [`CompositorNodeCrop.is_registered_node_type()`](#bpy.types.CompositorNodeCrop.is_registered_node_type)
    - [`CompositorNodeCrop.input_template()`](#bpy.types.CompositorNodeCrop.input_template)
    - [`CompositorNodeCrop.output_template()`](#bpy.types.CompositorNodeCrop.output_template)
    - [`CompositorNodeCrop.update()`](#bpy.types.CompositorNodeCrop.update)
    - [`CompositorNodeCrop.bl_rna_get_subclass()`](#bpy.types.CompositorNodeCrop.bl_rna_get_subclass)
    - [`CompositorNodeCrop.bl_rna_get_subclass_py()`](#bpy.types.CompositorNodeCrop.bl_rna_get_subclass_py)
