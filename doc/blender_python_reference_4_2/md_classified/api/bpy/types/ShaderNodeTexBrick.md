...
# ShaderNodeTexBrick(ShaderNode)[#](#shadernodetexbrick-shadernode "Link to this heading")
...
*class* bpy.types.ShaderNodeTexBrick(*ShaderNode*)[#](#bpy.types.ShaderNodeTexBrick "Link to this definition")
:   Generate a procedural texture producing bricks

    color\_mapping[#](#bpy.types.ShaderNodeTexBrick.color_mapping "Link to this definition")
    :   Color mapping settings

        Type:
        :   [`ColorMapping`](ColorMapping.md#bpy.types.ColorMapping "bpy.types.ColorMapping"), (readonly, never None)

    offset[#](#bpy.types.ShaderNodeTexBrick.offset "Link to this definition")
    :   Type:
        :   float in [0, 1], default 0.5

    offset\_frequency[#](#bpy.types.ShaderNodeTexBrick.offset_frequency "Link to this definition")
    :   Type:
        :   int in [1, 99], default 2

    squash[#](#bpy.types.ShaderNodeTexBrick.squash "Link to this definition")
    :   Type:
        :   float in [0, 99], default 1.0

    squash\_frequency[#](#bpy.types.ShaderNodeTexBrick.squash_frequency "Link to this definition")
    :   Type:
        :   int in [1, 99], default 2

    texture\_mapping[#](#bpy.types.ShaderNodeTexBrick.texture_mapping "Link to this definition")
    :   Texture coordinate mapping settings

        Type:
        :   [`TexMapping`](TexMapping.md#bpy.types.TexMapping "bpy.types.TexMapping"), (readonly, never None)

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.ShaderNodeTexBrick.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.ShaderNodeTexBrick.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.ShaderNodeTexBrick.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.ShaderNodeTexBrick.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.ShaderNodeTexBrick.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ShaderNodeTexBrick.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.ShaderNodeTexBrick.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ShaderNodeTexBrick(ShaderNode)
  + [`ShaderNodeTexBrick`](#bpy.types.ShaderNodeTexBrick)
    - [`ShaderNodeTexBrick.color_mapping`](#bpy.types.ShaderNodeTexBrick.color_mapping)
    - [`ShaderNodeTexBrick.offset`](#bpy.types.ShaderNodeTexBrick.offset)
    - [`ShaderNodeTexBrick.offset_frequency`](#bpy.types.ShaderNodeTexBrick.offset_frequency)
    - [`ShaderNodeTexBrick.squash`](#bpy.types.ShaderNodeTexBrick.squash)
    - [`ShaderNodeTexBrick.squash_frequency`](#bpy.types.ShaderNodeTexBrick.squash_frequency)
    - [`ShaderNodeTexBrick.texture_mapping`](#bpy.types.ShaderNodeTexBrick.texture_mapping)
    - [`ShaderNodeTexBrick.is_registered_node_type()`](#bpy.types.ShaderNodeTexBrick.is_registered_node_type)
    - [`ShaderNodeTexBrick.input_template()`](#bpy.types.ShaderNodeTexBrick.input_template)
    - [`ShaderNodeTexBrick.output_template()`](#bpy.types.ShaderNodeTexBrick.output_template)
    - [`ShaderNodeTexBrick.bl_rna_get_subclass()`](#bpy.types.ShaderNodeTexBrick.bl_rna_get_subclass)
    - [`ShaderNodeTexBrick.bl_rna_get_subclass_py()`](#bpy.types.ShaderNodeTexBrick.bl_rna_get_subclass_py)
