...
# CompositorNodeComposite(CompositorNode)[#](#compositornodecomposite-compositornode "Link to this heading")
...
*class* bpy.types.CompositorNodeComposite(*CompositorNode*)[#](#bpy.types.CompositorNodeComposite "Link to this definition")
:   Final render output

    use\_alpha[#](#bpy.types.CompositorNodeComposite.use_alpha "Link to this definition")
    :   Colors are treated alpha premultiplied, or colors output straight (alpha gets set to 1)

        Type:
        :   boolean, default False

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.CompositorNodeComposite.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.CompositorNodeComposite.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.CompositorNodeComposite.output_template "Link to this definition")
    ...
    update()[#](#bpy.types.CompositorNodeComposite.update "Link to this definition")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.CompositorNodeComposite.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.CompositorNodeComposite.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CompositorNodeComposite.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.CompositorNodeComposite.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CompositorNodeComposite(CompositorNode)
  + [`CompositorNodeComposite`](#bpy.types.CompositorNodeComposite)
    - [`CompositorNodeComposite.use_alpha`](#bpy.types.CompositorNodeComposite.use_alpha)
    - [`CompositorNodeComposite.is_registered_node_type()`](#bpy.types.CompositorNodeComposite.is_registered_node_type)
    - [`CompositorNodeComposite.input_template()`](#bpy.types.CompositorNodeComposite.input_template)
    - [`CompositorNodeComposite.output_template()`](#bpy.types.CompositorNodeComposite.output_template)
    - [`CompositorNodeComposite.update()`](#bpy.types.CompositorNodeComposite.update)
    - [`CompositorNodeComposite.bl_rna_get_subclass()`](#bpy.types.CompositorNodeComposite.bl_rna_get_subclass)
    - [`CompositorNodeComposite.bl_rna_get_subclass_py()`](#bpy.types.CompositorNodeComposite.bl_rna_get_subclass_py)
