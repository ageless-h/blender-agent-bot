...
|  |  |
| --- | --- |
| * [`bpy.context.edit_mask`](../context/index.md#bpy.context.edit_mask "bpy.context.edit_mask") * [`BlendData.masks`](BlendData.md#bpy.types.BlendData.masks "bpy.types.BlendData.masks") * [`BlendDataMasks.new`](BlendDataMasks.md#bpy.types.BlendDataMasks.new "bpy.types.BlendDataMasks.new") * [`BlendDataMasks.remove`](BlendDataMasks.md#bpy.types.BlendDataMasks.remove "bpy.types.BlendDataMasks.remove") * [`CompositorNodeMask.mask`](CompositorNodeMask.md#bpy.types.CompositorNodeMask.mask "bpy.types.CompositorNodeMask.mask") * [`MaskSequence.mask`](MaskSequence.md#bpy.types.MaskSequence.mask "bpy.types.MaskSequence.mask") | * [`SequenceModifier.input_mask_id`](SequenceModifier.md#bpy.types.SequenceModifier.input_mask_id "bpy.types.SequenceModifier.input_mask_id") * [`SequencesMeta.new_mask`](SequencesMeta.md#bpy.types.SequencesMeta.new_mask "bpy.types.SequencesMeta.new_mask") * [`SequencesTopLevel.new_mask`](SequencesTopLevel.md#bpy.types.SequencesTopLevel.new_mask "bpy.types.SequencesTopLevel.new_mask") * [`SpaceClipEditor.mask`](SpaceClipEditor.md#bpy.types.SpaceClipEditor.mask "bpy.types.SpaceClipEditor.mask") * [`SpaceImageEditor.mask`](SpaceImageEditor.md#bpy.types.SpaceImageEditor.mask "bpy.types.SpaceImageEditor.mask") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.Mask.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.Mask.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)
