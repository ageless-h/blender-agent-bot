...
# CompositorNodeValToRGB(CompositorNode)[#](#compositornodevaltorgb-compositornode "Link to this heading")
...
*class* bpy.types.CompositorNodeValToRGB(*CompositorNode*)[#](#bpy.types.CompositorNodeValToRGB "Link to this definition")
:   Map values to colors with the use of a gradient

    color\_ramp[#](#bpy.types.CompositorNodeValToRGB.color_ramp "Link to this definition")
    :   Type:
        :   [`ColorRamp`](ColorRamp.md#bpy.types.ColorRamp "bpy.types.ColorRamp"), (readonly)

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.CompositorNodeValToRGB.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.CompositorNodeValToRGB.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.CompositorNodeValToRGB.output_template "Link to this definition")
    ...
    update()[#](#bpy.types.CompositorNodeValToRGB.update "Link to this definition")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.CompositorNodeValToRGB.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.CompositorNodeValToRGB.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CompositorNodeValToRGB.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.CompositorNodeValToRGB.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CompositorNodeValToRGB(CompositorNode)
  + [`CompositorNodeValToRGB`](#bpy.types.CompositorNodeValToRGB)
    - [`CompositorNodeValToRGB.color_ramp`](#bpy.types.CompositorNodeValToRGB.color_ramp)
    - [`CompositorNodeValToRGB.is_registered_node_type()`](#bpy.types.CompositorNodeValToRGB.is_registered_node_type)
    - [`CompositorNodeValToRGB.input_template()`](#bpy.types.CompositorNodeValToRGB.input_template)
    - [`CompositorNodeValToRGB.output_template()`](#bpy.types.CompositorNodeValToRGB.output_template)
    - [`CompositorNodeValToRGB.update()`](#bpy.types.CompositorNodeValToRGB.update)
    - [`CompositorNodeValToRGB.bl_rna_get_subclass()`](#bpy.types.CompositorNodeValToRGB.bl_rna_get_subclass)
    - [`CompositorNodeValToRGB.bl_rna_get_subclass_py()`](#bpy.types.CompositorNodeValToRGB.bl_rna_get_subclass_py)
