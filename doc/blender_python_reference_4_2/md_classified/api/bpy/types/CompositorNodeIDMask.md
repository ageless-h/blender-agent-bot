...
# CompositorNodeIDMask(CompositorNode)[#](#compositornodeidmask-compositornode "Link to this heading")
...
*class* bpy.types.CompositorNodeIDMask(*CompositorNode*)[#](#bpy.types.CompositorNodeIDMask "Link to this definition")
:   Create a matte from an object or material index pass

    index[#](#bpy.types.CompositorNodeIDMask.index "Link to this definition")
    :   Pass index number to convert to alpha

        Type:
        :   int in [0, 32767], default 0

    use\_antialiasing[#](#bpy.types.CompositorNodeIDMask.use_antialiasing "Link to this definition")
    :   Apply an anti-aliasing filter to the mask

        Type:
        :   boolean, default False

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.CompositorNodeIDMask.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.CompositorNodeIDMask.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.CompositorNodeIDMask.output_template "Link to this definition")
    ...
    update()[#](#bpy.types.CompositorNodeIDMask.update "Link to this definition")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.CompositorNodeIDMask.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.CompositorNodeIDMask.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CompositorNodeIDMask.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.CompositorNodeIDMask.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CompositorNodeIDMask(CompositorNode)
  + [`CompositorNodeIDMask`](#bpy.types.CompositorNodeIDMask)
    - [`CompositorNodeIDMask.index`](#bpy.types.CompositorNodeIDMask.index)
    - [`CompositorNodeIDMask.use_antialiasing`](#bpy.types.CompositorNodeIDMask.use_antialiasing)
    - [`CompositorNodeIDMask.is_registered_node_type()`](#bpy.types.CompositorNodeIDMask.is_registered_node_type)
    - [`CompositorNodeIDMask.input_template()`](#bpy.types.CompositorNodeIDMask.input_template)
    - [`CompositorNodeIDMask.output_template()`](#bpy.types.CompositorNodeIDMask.output_template)
    - [`CompositorNodeIDMask.update()`](#bpy.types.CompositorNodeIDMask.update)
    - [`CompositorNodeIDMask.bl_rna_get_subclass()`](#bpy.types.CompositorNodeIDMask.bl_rna_get_subclass)
    - [`CompositorNodeIDMask.bl_rna_get_subclass_py()`](#bpy.types.CompositorNodeIDMask.bl_rna_get_subclass_py)
