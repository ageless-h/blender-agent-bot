...
:   Collection of grease pencil layers
    ...
    active[#](#bpy.types.GreasePencilLayers.active "Link to this definition")
    ...
    move(*layer*, *type*)[#](#bpy.types.GreasePencilLayers.move "Link to this definition")
    :   Move a grease pencil layer in the layer stack

        Parameters:
        :   * **layer** ([`GPencilLayer`](GPencilLayer.md#bpy.types.GPencilLayer "bpy.types.GPencilLayer"), (never None)) – The layer to move
            * **type** (*enum in* *[**'UP'**,* *'DOWN'**]*) – Direction of movement
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GreasePencilLayers.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.GreasePencilLayers.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GreasePencilLayers(bpy\_struct)
  + [`GreasePencilLayers`](#bpy.types.GreasePencilLayers)
    - [`GreasePencilLayers.active`](#bpy.types.GreasePencilLayers.active)
    ...
    - [`GreasePencilLayers.move()`](#bpy.types.GreasePencilLayers.move)
