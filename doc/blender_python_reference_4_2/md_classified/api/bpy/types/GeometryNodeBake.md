...
# GeometryNodeBake(GeometryNode)[#](#geometrynodebake-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeBake(*GeometryNode*)[#](#bpy.types.GeometryNodeBake "Link to this definition")
:   Cache the incoming data so that it can be used without recomputation

    active\_index[#](#bpy.types.GeometryNodeBake.active_index "Link to this definition")
    :   Index of the active item

        Type:
        :   int in [0, inf], default 0

    active\_item[#](#bpy.types.GeometryNodeBake.active_item "Link to this definition")
    :   Index of the active item

        Type:
        :   [`RepeatItem`](RepeatItem.md#bpy.types.RepeatItem "bpy.types.RepeatItem")

    bake\_items[#](#bpy.types.GeometryNodeBake.bake_items "Link to this definition")
    :   Type:
        :   [`NodeGeometryBakeItems`](NodeGeometryBakeItems.md#bpy.types.NodeGeometryBakeItems "bpy.types.NodeGeometryBakeItems") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`NodeGeometryBakeItem`](NodeGeometryBakeItem.md#bpy.types.NodeGeometryBakeItem "bpy.types.NodeGeometryBakeItem"), (readonly)

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.GeometryNodeBake.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.GeometryNodeBake.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.GeometryNodeBake.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.GeometryNodeBake.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.GeometryNodeBake.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeBake.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.GeometryNodeBake.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeBake(GeometryNode)
  + [`GeometryNodeBake`](#bpy.types.GeometryNodeBake)
    - [`GeometryNodeBake.active_index`](#bpy.types.GeometryNodeBake.active_index)
    - [`GeometryNodeBake.active_item`](#bpy.types.GeometryNodeBake.active_item)
    - [`GeometryNodeBake.bake_items`](#bpy.types.GeometryNodeBake.bake_items)
    - [`GeometryNodeBake.is_registered_node_type()`](#bpy.types.GeometryNodeBake.is_registered_node_type)
    - [`GeometryNodeBake.input_template()`](#bpy.types.GeometryNodeBake.input_template)
    - [`GeometryNodeBake.output_template()`](#bpy.types.GeometryNodeBake.output_template)
    - [`GeometryNodeBake.bl_rna_get_subclass()`](#bpy.types.GeometryNodeBake.bl_rna_get_subclass)
    - [`GeometryNodeBake.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeBake.bl_rna_get_subclass_py)
