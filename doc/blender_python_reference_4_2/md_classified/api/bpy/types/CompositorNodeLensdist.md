...
# CompositorNodeLensdist(CompositorNode)[#](#compositornodelensdist-compositornode "Link to this heading")
...
*class* bpy.types.CompositorNodeLensdist(*CompositorNode*)[#](#bpy.types.CompositorNodeLensdist "Link to this definition")
:   Simulate distortion and dispersion from camera lenses

    use\_fit[#](#bpy.types.CompositorNodeLensdist.use_fit "Link to this definition")
    :   For positive distortion factor only: scale image such that black areas are not visible

        Type:
        :   boolean, default False

    use\_jitter[#](#bpy.types.CompositorNodeLensdist.use_jitter "Link to this definition")
    :   Enable/disable jittering (faster, but also noisier)

        Type:
        :   boolean, default False

    use\_projector[#](#bpy.types.CompositorNodeLensdist.use_projector "Link to this definition")
    :   Enable/disable projector mode (the effect is applied in horizontal direction only)

        Type:
        :   boolean, default False

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.CompositorNodeLensdist.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.CompositorNodeLensdist.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.CompositorNodeLensdist.output_template "Link to this definition")
    ...
    update()[#](#bpy.types.CompositorNodeLensdist.update "Link to this definition")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.CompositorNodeLensdist.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.CompositorNodeLensdist.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CompositorNodeLensdist.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.CompositorNodeLensdist.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CompositorNodeLensdist(CompositorNode)
  + [`CompositorNodeLensdist`](#bpy.types.CompositorNodeLensdist)
    - [`CompositorNodeLensdist.use_fit`](#bpy.types.CompositorNodeLensdist.use_fit)
    - [`CompositorNodeLensdist.use_jitter`](#bpy.types.CompositorNodeLensdist.use_jitter)
    - [`CompositorNodeLensdist.use_projector`](#bpy.types.CompositorNodeLensdist.use_projector)
    - [`CompositorNodeLensdist.is_registered_node_type()`](#bpy.types.CompositorNodeLensdist.is_registered_node_type)
    - [`CompositorNodeLensdist.input_template()`](#bpy.types.CompositorNodeLensdist.input_template)
    - [`CompositorNodeLensdist.output_template()`](#bpy.types.CompositorNodeLensdist.output_template)
    - [`CompositorNodeLensdist.update()`](#bpy.types.CompositorNodeLensdist.update)
    - [`CompositorNodeLensdist.bl_rna_get_subclass()`](#bpy.types.CompositorNodeLensdist.bl_rna_get_subclass)
    - [`CompositorNodeLensdist.bl_rna_get_subclass_py()`](#bpy.types.CompositorNodeLensdist.bl_rna_get_subclass_py)
