...
# ShaderNodeMixRGB(ShaderNode)[#](#shadernodemixrgb-shadernode "Link to this heading")
...
*class* bpy.types.ShaderNodeMixRGB(*ShaderNode*)[#](#bpy.types.ShaderNodeMixRGB "Link to this definition")
:   Mix two input colors

    blend\_type[#](#bpy.types.ShaderNodeMixRGB.blend_type "Link to this definition")
    :   Type:
        :   enum in [Ramp Blend Items](../../../appendix/bpy_types_enum_items/ramp_blend_items.md#rna-enum-ramp-blend-items), default ‘MIX’

    use\_alpha[#](#bpy.types.ShaderNodeMixRGB.use_alpha "Link to this definition")
    :   Include alpha of second input in this operation

        Type:
        :   boolean, default False

    use\_clamp[#](#bpy.types.ShaderNodeMixRGB.use_clamp "Link to this definition")
    :   Clamp result of the node to 0.0 to 1.0 range

        Type:
        :   boolean, default False

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.ShaderNodeMixRGB.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.ShaderNodeMixRGB.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.ShaderNodeMixRGB.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.ShaderNodeMixRGB.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.ShaderNodeMixRGB.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ShaderNodeMixRGB.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.ShaderNodeMixRGB.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ShaderNodeMixRGB(ShaderNode)
  + [`ShaderNodeMixRGB`](#bpy.types.ShaderNodeMixRGB)
    - [`ShaderNodeMixRGB.blend_type`](#bpy.types.ShaderNodeMixRGB.blend_type)
    - [`ShaderNodeMixRGB.use_alpha`](#bpy.types.ShaderNodeMixRGB.use_alpha)
    - [`ShaderNodeMixRGB.use_clamp`](#bpy.types.ShaderNodeMixRGB.use_clamp)
    - [`ShaderNodeMixRGB.is_registered_node_type()`](#bpy.types.ShaderNodeMixRGB.is_registered_node_type)
    - [`ShaderNodeMixRGB.input_template()`](#bpy.types.ShaderNodeMixRGB.input_template)
    - [`ShaderNodeMixRGB.output_template()`](#bpy.types.ShaderNodeMixRGB.output_template)
    - [`ShaderNodeMixRGB.bl_rna_get_subclass()`](#bpy.types.ShaderNodeMixRGB.bl_rna_get_subclass)
    - [`ShaderNodeMixRGB.bl_rna_get_subclass_py()`](#bpy.types.ShaderNodeMixRGB.bl_rna_get_subclass_py)
