...
subclasses —
[`VIEW3D_AST_pose_library`](VIEW3D_AST_pose_library.md#bpy.types.VIEW3D_AST_pose_library "bpy.types.VIEW3D_AST_pose_library"), [`VIEW3D_AST_sculpt_brushes`](VIEW3D_AST_sculpt_brushes.md#bpy.types.VIEW3D_AST_sculpt_brushes "bpy.types.VIEW3D_AST_sculpt_brushes")
...
:   Regions for quick access to assets
    ...
    :   Options for this asset shelf type
        ...
        * `STORE_ENABLED_CATALOGS_IN_PREFERENCES`
        ...
        Type:
        :   enum set in {‘NO\_ASSET\_DRAG’, ‘DEFAULT\_VISIBLE’, ‘STORE\_ENABLED\_CATALOGS\_IN\_PREFERENCES’}, default {‘NO\_ASSET\_DRAG’}
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.AssetShelf.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.AssetShelf.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)
