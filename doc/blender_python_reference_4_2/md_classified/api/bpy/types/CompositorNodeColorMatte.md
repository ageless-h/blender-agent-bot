...
# CompositorNodeColorMatte(CompositorNode)[#](#compositornodecolormatte-compositornode "Link to this heading")
...
*class* bpy.types.CompositorNodeColorMatte(*CompositorNode*)[#](#bpy.types.CompositorNodeColorMatte "Link to this definition")
:   Create matte using a given color, for green or blue screen footage

    color\_hue[#](#bpy.types.CompositorNodeColorMatte.color_hue "Link to this definition")
    :   Hue tolerance for colors to be considered a keying color

        Type:
        :   float in [0, 1], default 0.0

    color\_saturation[#](#bpy.types.CompositorNodeColorMatte.color_saturation "Link to this definition")
    :   Saturation tolerance for the color

        Type:
        :   float in [0, 1], default 0.0

    color\_value[#](#bpy.types.CompositorNodeColorMatte.color_value "Link to this definition")
    :   Value tolerance for the color

        Type:
        :   float in [0, 1], default 0.0

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.CompositorNodeColorMatte.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.CompositorNodeColorMatte.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.CompositorNodeColorMatte.output_template "Link to this definition")
    ...
    update()[#](#bpy.types.CompositorNodeColorMatte.update "Link to this definition")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.CompositorNodeColorMatte.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.CompositorNodeColorMatte.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CompositorNodeColorMatte.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.CompositorNodeColorMatte.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CompositorNodeColorMatte(CompositorNode)
  + [`CompositorNodeColorMatte`](#bpy.types.CompositorNodeColorMatte)
    - [`CompositorNodeColorMatte.color_hue`](#bpy.types.CompositorNodeColorMatte.color_hue)
    - [`CompositorNodeColorMatte.color_saturation`](#bpy.types.CompositorNodeColorMatte.color_saturation)
    - [`CompositorNodeColorMatte.color_value`](#bpy.types.CompositorNodeColorMatte.color_value)
    - [`CompositorNodeColorMatte.is_registered_node_type()`](#bpy.types.CompositorNodeColorMatte.is_registered_node_type)
    - [`CompositorNodeColorMatte.input_template()`](#bpy.types.CompositorNodeColorMatte.input_template)
    - [`CompositorNodeColorMatte.output_template()`](#bpy.types.CompositorNodeColorMatte.output_template)
    - [`CompositorNodeColorMatte.update()`](#bpy.types.CompositorNodeColorMatte.update)
    - [`CompositorNodeColorMatte.bl_rna_get_subclass()`](#bpy.types.CompositorNodeColorMatte.bl_rna_get_subclass)
    - [`CompositorNodeColorMatte.bl_rna_get_subclass_py()`](#bpy.types.CompositorNodeColorMatte.bl_rna_get_subclass_py)
