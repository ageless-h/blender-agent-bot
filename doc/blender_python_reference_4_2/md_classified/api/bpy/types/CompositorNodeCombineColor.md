...
# CompositorNodeCombineColor(CompositorNode)[#](#compositornodecombinecolor-compositornode "Link to this heading")
...
*class* bpy.types.CompositorNodeCombineColor(*CompositorNode*)[#](#bpy.types.CompositorNodeCombineColor "Link to this definition")
:   Combine an image from its composite color channels

    mode[#](#bpy.types.CompositorNodeCombineColor.mode "Link to this definition")
    ...
    ycc\_mode[#](#bpy.types.CompositorNodeCombineColor.ycc_mode "Link to this definition")
    :   Color space used for YCbCrA processing

        Type:
        :   enum in [‘ITUBT601’, ‘ITUBT709’, ‘JFIF’], default ‘ITUBT601’

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.CompositorNodeCombineColor.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.CompositorNodeCombineColor.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.CompositorNodeCombineColor.output_template "Link to this definition")
    ...
    update()[#](#bpy.types.CompositorNodeCombineColor.update "Link to this definition")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.CompositorNodeCombineColor.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.CompositorNodeCombineColor.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CompositorNodeCombineColor.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.CompositorNodeCombineColor.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CompositorNodeCombineColor(CompositorNode)
  + [`CompositorNodeCombineColor`](#bpy.types.CompositorNodeCombineColor)
    - [`CompositorNodeCombineColor.mode`](#bpy.types.CompositorNodeCombineColor.mode)
    - [`CompositorNodeCombineColor.ycc_mode`](#bpy.types.CompositorNodeCombineColor.ycc_mode)
    - [`CompositorNodeCombineColor.is_registered_node_type()`](#bpy.types.CompositorNodeCombineColor.is_registered_node_type)
    - [`CompositorNodeCombineColor.input_template()`](#bpy.types.CompositorNodeCombineColor.input_template)
    - [`CompositorNodeCombineColor.output_template()`](#bpy.types.CompositorNodeCombineColor.output_template)
    - [`CompositorNodeCombineColor.update()`](#bpy.types.CompositorNodeCombineColor.update)
    - [`CompositorNodeCombineColor.bl_rna_get_subclass()`](#bpy.types.CompositorNodeCombineColor.bl_rna_get_subclass)
    - [`CompositorNodeCombineColor.bl_rna_get_subclass_py()`](#bpy.types.CompositorNodeCombineColor.bl_rna_get_subclass_py)
