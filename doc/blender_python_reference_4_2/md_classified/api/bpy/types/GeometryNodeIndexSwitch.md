...
# GeometryNodeIndexSwitch(GeometryNode)[#](#geometrynodeindexswitch-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeIndexSwitch(*GeometryNode*)[#](#bpy.types.GeometryNodeIndexSwitch "Link to this definition")
:   Choose between an arbitrary number of values with an index

    data\_type[#](#bpy.types.GeometryNodeIndexSwitch.data_type "Link to this definition")
    :   Type:
    ...
    index\_switch\_items[#](#bpy.types.GeometryNodeIndexSwitch.index_switch_items "Link to this definition")
    :   Type:
        :   [`NodeIndexSwitchItems`](NodeIndexSwitchItems.md#bpy.types.NodeIndexSwitchItems "bpy.types.NodeIndexSwitchItems") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`IndexSwitchItem`](IndexSwitchItem.md#bpy.types.IndexSwitchItem "bpy.types.IndexSwitchItem"), (readonly)

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.GeometryNodeIndexSwitch.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.GeometryNodeIndexSwitch.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.GeometryNodeIndexSwitch.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.GeometryNodeIndexSwitch.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.GeometryNodeIndexSwitch.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeIndexSwitch.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.GeometryNodeIndexSwitch.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeIndexSwitch(GeometryNode)
  + [`GeometryNodeIndexSwitch`](#bpy.types.GeometryNodeIndexSwitch)
    - [`GeometryNodeIndexSwitch.data_type`](#bpy.types.GeometryNodeIndexSwitch.data_type)
    - [`GeometryNodeIndexSwitch.index_switch_items`](#bpy.types.GeometryNodeIndexSwitch.index_switch_items)
    - [`GeometryNodeIndexSwitch.is_registered_node_type()`](#bpy.types.GeometryNodeIndexSwitch.is_registered_node_type)
    - [`GeometryNodeIndexSwitch.input_template()`](#bpy.types.GeometryNodeIndexSwitch.input_template)
    - [`GeometryNodeIndexSwitch.output_template()`](#bpy.types.GeometryNodeIndexSwitch.output_template)
    - [`GeometryNodeIndexSwitch.bl_rna_get_subclass()`](#bpy.types.GeometryNodeIndexSwitch.bl_rna_get_subclass)
    - [`GeometryNodeIndexSwitch.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeIndexSwitch.bl_rna_get_subclass_py)
