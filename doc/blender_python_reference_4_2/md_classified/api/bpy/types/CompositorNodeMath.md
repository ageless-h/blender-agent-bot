...
# CompositorNodeMath(CompositorNode)[#](#compositornodemath-compositornode "Link to this heading")
...
*class* bpy.types.CompositorNodeMath(*CompositorNode*)[#](#bpy.types.CompositorNodeMath "Link to this definition")
:   Perform math operations

    operation[#](#bpy.types.CompositorNodeMath.operation "Link to this definition")
    :   Type:
        :   enum in [Node Math Items](../../../appendix/bpy_types_enum_items/node_math_items.md#rna-enum-node-math-items), default ‘ADD’

    use\_clamp[#](#bpy.types.CompositorNodeMath.use_clamp "Link to this definition")
    :   Clamp result of the node to 0.0 to 1.0 range

        Type:
        :   boolean, default False

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.CompositorNodeMath.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.CompositorNodeMath.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.CompositorNodeMath.output_template "Link to this definition")
    ...
    update()[#](#bpy.types.CompositorNodeMath.update "Link to this definition")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.CompositorNodeMath.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.CompositorNodeMath.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CompositorNodeMath.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.CompositorNodeMath.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CompositorNodeMath(CompositorNode)
  + [`CompositorNodeMath`](#bpy.types.CompositorNodeMath)
    - [`CompositorNodeMath.operation`](#bpy.types.CompositorNodeMath.operation)
    - [`CompositorNodeMath.use_clamp`](#bpy.types.CompositorNodeMath.use_clamp)
    - [`CompositorNodeMath.is_registered_node_type()`](#bpy.types.CompositorNodeMath.is_registered_node_type)
    - [`CompositorNodeMath.input_template()`](#bpy.types.CompositorNodeMath.input_template)
    - [`CompositorNodeMath.output_template()`](#bpy.types.CompositorNodeMath.output_template)
    - [`CompositorNodeMath.update()`](#bpy.types.CompositorNodeMath.update)
    - [`CompositorNodeMath.bl_rna_get_subclass()`](#bpy.types.CompositorNodeMath.bl_rna_get_subclass)
    - [`CompositorNodeMath.bl_rna_get_subclass_py()`](#bpy.types.CompositorNodeMath.bl_rna_get_subclass_py)
