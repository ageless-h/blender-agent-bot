...
# CompositorNodeGlare(CompositorNode)[#](#compositornodeglare-compositornode "Link to this heading")
...
*class* bpy.types.CompositorNodeGlare(*CompositorNode*)[#](#bpy.types.CompositorNodeGlare "Link to this definition")
:   Add lens flares, fog and glows around bright parts of the image

    angle\_offset[#](#bpy.types.CompositorNodeGlare.angle_offset "Link to this definition")
    :   Streak angle offset

        Type:
        :   float in [0, 3.14159], default 0.0

    color\_modulation[#](#bpy.types.CompositorNodeGlare.color_modulation "Link to this definition")
    :   Amount of Color Modulation, modulates colors of streaks and ghosts for a spectral dispersion effect

        Type:
        :   float in [0, 1], default 0.0

    fade[#](#bpy.types.CompositorNodeGlare.fade "Link to this definition")
    :   Streak fade-out factor

        Type:
        :   float in [0.75, 1], default 0.0

    glare\_type[#](#bpy.types.CompositorNodeGlare.glare_type "Link to this definition")
    :   Type:
        :   enum in [‘BLOOM’, ‘GHOSTS’, ‘STREAKS’, ‘FOG\_GLOW’, ‘SIMPLE\_STAR’], default ‘SIMPLE\_STAR’

    iterations[#](#bpy.types.CompositorNodeGlare.iterations "Link to this definition")
    :   Type:
        :   int in [2, 5], default 0

    mix[#](#bpy.types.CompositorNodeGlare.mix "Link to this definition")
    :   -1 is original image only, 0 is exact 50/50 mix, 1 is processed image only

        Type:
        :   float in [-1, 1], default 0.0

    quality[#](#bpy.types.CompositorNodeGlare.quality "Link to this definition")
    ...
    size[#](#bpy.types.CompositorNodeGlare.size "Link to this definition")
    :   Glow/glare size (not actual size; relative to initial size of bright area of pixels)

        Type:
        :   int in [1, 9], default 0

    streaks[#](#bpy.types.CompositorNodeGlare.streaks "Link to this definition")
    :   Total number of streaks

        Type:
        :   int in [1, 16], default 0

    threshold[#](#bpy.types.CompositorNodeGlare.threshold "Link to this definition")
    :   The glare filter will only be applied to pixels brighter than this value

        Type:
        :   float in [0, 1000], default 0.0

    use\_rotate\_45[#](#bpy.types.CompositorNodeGlare.use_rotate_45 "Link to this definition")
    :   Simple star filter: add 45 degree rotation offset

        Type:
        :   boolean, default False

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.CompositorNodeGlare.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.CompositorNodeGlare.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.CompositorNodeGlare.output_template "Link to this definition")
    ...
    update()[#](#bpy.types.CompositorNodeGlare.update "Link to this definition")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.CompositorNodeGlare.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.CompositorNodeGlare.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CompositorNodeGlare.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.CompositorNodeGlare.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CompositorNodeGlare(CompositorNode)
  + [`CompositorNodeGlare`](#bpy.types.CompositorNodeGlare)
    - [`CompositorNodeGlare.angle_offset`](#bpy.types.CompositorNodeGlare.angle_offset)
    - [`CompositorNodeGlare.color_modulation`](#bpy.types.CompositorNodeGlare.color_modulation)
    - [`CompositorNodeGlare.fade`](#bpy.types.CompositorNodeGlare.fade)
    - [`CompositorNodeGlare.glare_type`](#bpy.types.CompositorNodeGlare.glare_type)
    - [`CompositorNodeGlare.iterations`](#bpy.types.CompositorNodeGlare.iterations)
    - [`CompositorNodeGlare.mix`](#bpy.types.CompositorNodeGlare.mix)
    - [`CompositorNodeGlare.quality`](#bpy.types.CompositorNodeGlare.quality)
    - [`CompositorNodeGlare.size`](#bpy.types.CompositorNodeGlare.size)
    - [`CompositorNodeGlare.streaks`](#bpy.types.CompositorNodeGlare.streaks)
    - [`CompositorNodeGlare.threshold`](#bpy.types.CompositorNodeGlare.threshold)
    - [`CompositorNodeGlare.use_rotate_45`](#bpy.types.CompositorNodeGlare.use_rotate_45)
    - [`CompositorNodeGlare.is_registered_node_type()`](#bpy.types.CompositorNodeGlare.is_registered_node_type)
    - [`CompositorNodeGlare.input_template()`](#bpy.types.CompositorNodeGlare.input_template)
    - [`CompositorNodeGlare.output_template()`](#bpy.types.CompositorNodeGlare.output_template)
    - [`CompositorNodeGlare.update()`](#bpy.types.CompositorNodeGlare.update)
    - [`CompositorNodeGlare.bl_rna_get_subclass()`](#bpy.types.CompositorNodeGlare.bl_rna_get_subclass)
    - [`CompositorNodeGlare.bl_rna_get_subclass_py()`](#bpy.types.CompositorNodeGlare.bl_rna_get_subclass_py)
