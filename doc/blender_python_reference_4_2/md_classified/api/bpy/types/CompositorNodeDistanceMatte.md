...
# CompositorNodeDistanceMatte(CompositorNode)[#](#compositornodedistancematte-compositornode "Link to this heading")
...
*class* bpy.types.CompositorNodeDistanceMatte(*CompositorNode*)[#](#bpy.types.CompositorNodeDistanceMatte "Link to this definition")
:   Create matte based on 3D distance between colors

    channel[#](#bpy.types.CompositorNodeDistanceMatte.channel "Link to this definition")
    :   * `RGB`
          RGB – RGB color space.
        * `YCC`
    ...
    falloff[#](#bpy.types.CompositorNodeDistanceMatte.falloff "Link to this definition")
    :   Color distances below this additional threshold are partially keyed

        Type:
        :   float in [0, 1], default 0.0

    tolerance[#](#bpy.types.CompositorNodeDistanceMatte.tolerance "Link to this definition")
    :   Color distances below this threshold are keyed

        Type:
        :   float in [0, 1], default 0.0

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.CompositorNodeDistanceMatte.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.CompositorNodeDistanceMatte.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.CompositorNodeDistanceMatte.output_template "Link to this definition")
    ...
    update()[#](#bpy.types.CompositorNodeDistanceMatte.update "Link to this definition")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.CompositorNodeDistanceMatte.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.CompositorNodeDistanceMatte.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CompositorNodeDistanceMatte.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.CompositorNodeDistanceMatte.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CompositorNodeDistanceMatte(CompositorNode)
  + [`CompositorNodeDistanceMatte`](#bpy.types.CompositorNodeDistanceMatte)
    - [`CompositorNodeDistanceMatte.channel`](#bpy.types.CompositorNodeDistanceMatte.channel)
    - [`CompositorNodeDistanceMatte.falloff`](#bpy.types.CompositorNodeDistanceMatte.falloff)
    - [`CompositorNodeDistanceMatte.tolerance`](#bpy.types.CompositorNodeDistanceMatte.tolerance)
    - [`CompositorNodeDistanceMatte.is_registered_node_type()`](#bpy.types.CompositorNodeDistanceMatte.is_registered_node_type)
    - [`CompositorNodeDistanceMatte.input_template()`](#bpy.types.CompositorNodeDistanceMatte.input_template)
    - [`CompositorNodeDistanceMatte.output_template()`](#bpy.types.CompositorNodeDistanceMatte.output_template)
    - [`CompositorNodeDistanceMatte.update()`](#bpy.types.CompositorNodeDistanceMatte.update)
    - [`CompositorNodeDistanceMatte.bl_rna_get_subclass()`](#bpy.types.CompositorNodeDistanceMatte.bl_rna_get_subclass)
    - [`CompositorNodeDistanceMatte.bl_rna_get_subclass_py()`](#bpy.types.CompositorNodeDistanceMatte.bl_rna_get_subclass_py)
