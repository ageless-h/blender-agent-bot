...
# NodeInternal(Node)[#](#nodeinternal-node "Link to this heading")

base classes — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct"), [`Node`](Node.md#bpy.types.Node "bpy.types.Node")

subclasses —
[`CompositorNode`](CompositorNode.md#bpy.types.CompositorNode "bpy.types.CompositorNode"), [`FunctionNode`](FunctionNode.md#bpy.types.FunctionNode "bpy.types.FunctionNode"), [`GeometryNode`](GeometryNode.md#bpy.types.GeometryNode "bpy.types.GeometryNode"), [`NodeFrame`](NodeFrame.md#bpy.types.NodeFrame "bpy.types.NodeFrame"), [`NodeGroup`](NodeGroup.md#bpy.types.NodeGroup "bpy.types.NodeGroup"), [`NodeGroupInput`](NodeGroupInput.md#bpy.types.NodeGroupInput "bpy.types.NodeGroupInput"), [`NodeGroupOutput`](NodeGroupOutput.md#bpy.types.NodeGroupOutput "bpy.types.NodeGroupOutput"), [`NodeReroute`](NodeReroute.md#bpy.types.NodeReroute "bpy.types.NodeReroute"), [`ShaderNode`](ShaderNode.md#bpy.types.ShaderNode "bpy.types.ShaderNode"), [`TextureNode`](TextureNode.md#bpy.types.TextureNode "bpy.types.TextureNode")

*class* bpy.types.NodeInternal(*Node*)[#](#bpy.types.NodeInternal "Link to this definition")
:   *classmethod* poll(*node\_tree*)[#](#bpy.types.NodeInternal.poll "Link to this definition")
    ...
    poll\_instance(*node\_tree*)[#](#bpy.types.NodeInternal.poll_instance "Link to this definition")
    ...
    update()[#](#bpy.types.NodeInternal.update "Link to this definition")
    :   Update on node graph topology changes (adding or removing nodes and links)

    draw\_buttons(*context*, *layout*)[#](#bpy.types.NodeInternal.draw_buttons "Link to this definition")
    :   Draw node buttons

        Parameters:
        :   **layout** ([`UILayout`](UILayout.md#bpy.types.UILayout "bpy.types.UILayout"), (never None)) – Layout, Layout in the UI

    draw\_buttons\_ext(*context*, *layout*)[#](#bpy.types.NodeInternal.draw_buttons_ext "Link to this definition")
    :   Draw node buttons in the sidebar

        Parameters:
        :   **layout** ([`UILayout`](UILayout.md#bpy.types.UILayout "bpy.types.UILayout"), (never None)) – Layout, Layout in the UI

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.NodeInternal.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.NodeInternal.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.NodeInternal.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.NodeInternal.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* NodeInternal(Node)
  + [`NodeInternal`](#bpy.types.NodeInternal)
    - [`NodeInternal.poll()`](#bpy.types.NodeInternal.poll)
    - [`NodeInternal.poll_instance()`](#bpy.types.NodeInternal.poll_instance)
    - [`NodeInternal.update()`](#bpy.types.NodeInternal.update)
    - [`NodeInternal.draw_buttons()`](#bpy.types.NodeInternal.draw_buttons)
    - [`NodeInternal.draw_buttons_ext()`](#bpy.types.NodeInternal.draw_buttons_ext)
    - [`NodeInternal.bl_rna_get_subclass()`](#bpy.types.NodeInternal.bl_rna_get_subclass)
    - [`NodeInternal.bl_rna_get_subclass_py()`](#bpy.types.NodeInternal.bl_rna_get_subclass_py)
