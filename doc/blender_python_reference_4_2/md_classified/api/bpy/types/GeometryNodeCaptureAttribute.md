...
# GeometryNodeCaptureAttribute(GeometryNode)[#](#geometrynodecaptureattribute-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeCaptureAttribute(*GeometryNode*)[#](#bpy.types.GeometryNodeCaptureAttribute "Link to this definition")
:   Store the result of a field on a geometry and output the data as a node socket. Allows remembering or interpolating data as the geometry changes, such as positions before deformation
    ...
    active\_index[#](#bpy.types.GeometryNodeCaptureAttribute.active_index "Link to this definition")
    :   Index of the active item

        Type:
        :   int in [0, inf], default 0

    active\_item[#](#bpy.types.GeometryNodeCaptureAttribute.active_item "Link to this definition")
    :   Index of the active item

        Type:
        :   [`RepeatItem`](RepeatItem.md#bpy.types.RepeatItem "bpy.types.RepeatItem")

    capture\_items[#](#bpy.types.GeometryNodeCaptureAttribute.capture_items "Link to this definition")
    :   Type:
        :   [`NodeGeometryCaptureAttributeItems`](NodeGeometryCaptureAttributeItems.md#bpy.types.NodeGeometryCaptureAttributeItems "bpy.types.NodeGeometryCaptureAttributeItems") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`NodeGeometryCaptureAttributeItem`](NodeGeometryCaptureAttributeItem.md#bpy.types.NodeGeometryCaptureAttributeItem "bpy.types.NodeGeometryCaptureAttributeItem"), (readonly)

    domain[#](#bpy.types.GeometryNodeCaptureAttribute.domain "Link to this definition")
    ...
    *classmethod* is\_registered\_node\_type()[#](#bpy.types.GeometryNodeCaptureAttribute.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.GeometryNodeCaptureAttribute.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.GeometryNodeCaptureAttribute.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.GeometryNodeCaptureAttribute.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.GeometryNodeCaptureAttribute.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeCaptureAttribute.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.GeometryNodeCaptureAttribute.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeCaptureAttribute(GeometryNode)
  + [`GeometryNodeCaptureAttribute`](#bpy.types.GeometryNodeCaptureAttribute)
    - [`GeometryNodeCaptureAttribute.active_index`](#bpy.types.GeometryNodeCaptureAttribute.active_index)
    - [`GeometryNodeCaptureAttribute.active_item`](#bpy.types.GeometryNodeCaptureAttribute.active_item)
    - [`GeometryNodeCaptureAttribute.capture_items`](#bpy.types.GeometryNodeCaptureAttribute.capture_items)
    - [`GeometryNodeCaptureAttribute.domain`](#bpy.types.GeometryNodeCaptureAttribute.domain)
    - [`GeometryNodeCaptureAttribute.is_registered_node_type()`](#bpy.types.GeometryNodeCaptureAttribute.is_registered_node_type)
    - [`GeometryNodeCaptureAttribute.input_template()`](#bpy.types.GeometryNodeCaptureAttribute.input_template)
    - [`GeometryNodeCaptureAttribute.output_template()`](#bpy.types.GeometryNodeCaptureAttribute.output_template)
    - [`GeometryNodeCaptureAttribute.bl_rna_get_subclass()`](#bpy.types.GeometryNodeCaptureAttribute.bl_rna_get_subclass)
    - [`GeometryNodeCaptureAttribute.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeCaptureAttribute.bl_rna_get_subclass_py)
