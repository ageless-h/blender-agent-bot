...
# CompositorNodeDefocus(CompositorNode)[#](#compositornodedefocus-compositornode "Link to this heading")
...
*class* bpy.types.CompositorNodeDefocus(*CompositorNode*)[#](#bpy.types.CompositorNodeDefocus "Link to this definition")
:   Apply depth of field in 2D, using a Z depth map or mask

    angle[#](#bpy.types.CompositorNodeDefocus.angle "Link to this definition")
    :   Bokeh shape rotation offset

        Type:
        :   float in [0, 1.5708], default 0.0

    blur\_max[#](#bpy.types.CompositorNodeDefocus.blur_max "Link to this definition")
    :   Blur limit, maximum CoC radius

        Type:
        :   float in [0, 10000], default 0.0

    bokeh[#](#bpy.types.CompositorNodeDefocus.bokeh "Link to this definition")
    :   * `OCTAGON`
          Octagonal – 8 sides.
        * `HEPTAGON`
          Heptagonal – 7 sides.
    ...
    *classmethod* is\_registered\_node\_type()[#](#bpy.types.CompositorNodeDefocus.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.CompositorNodeDefocus.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.CompositorNodeDefocus.output_template "Link to this definition")
    ...
    update()[#](#bpy.types.CompositorNodeDefocus.update "Link to this definition")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.CompositorNodeDefocus.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.CompositorNodeDefocus.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CompositorNodeDefocus.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.CompositorNodeDefocus.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CompositorNodeDefocus(CompositorNode)
  + [`CompositorNodeDefocus`](#bpy.types.CompositorNodeDefocus)
    - [`CompositorNodeDefocus.angle`](#bpy.types.CompositorNodeDefocus.angle)
    - [`CompositorNodeDefocus.blur_max`](#bpy.types.CompositorNodeDefocus.blur_max)
    - [`CompositorNodeDefocus.bokeh`](#bpy.types.CompositorNodeDefocus.bokeh)
    - [`CompositorNodeDefocus.f_stop`](#bpy.types.CompositorNodeDefocus.f_stop)
    - [`CompositorNodeDefocus.scene`](#bpy.types.CompositorNodeDefocus.scene)
    - [`CompositorNodeDefocus.threshold`](#bpy.types.CompositorNodeDefocus.threshold)
    - [`CompositorNodeDefocus.use_gamma_correction`](#bpy.types.CompositorNodeDefocus.use_gamma_correction)
    - [`CompositorNodeDefocus.use_preview`](#bpy.types.CompositorNodeDefocus.use_preview)
    - [`CompositorNodeDefocus.use_zbuffer`](#bpy.types.CompositorNodeDefocus.use_zbuffer)
    - [`CompositorNodeDefocus.z_scale`](#bpy.types.CompositorNodeDefocus.z_scale)
    - [`CompositorNodeDefocus.is_registered_node_type()`](#bpy.types.CompositorNodeDefocus.is_registered_node_type)
    - [`CompositorNodeDefocus.input_template()`](#bpy.types.CompositorNodeDefocus.input_template)
    - [`CompositorNodeDefocus.output_template()`](#bpy.types.CompositorNodeDefocus.output_template)
    - [`CompositorNodeDefocus.update()`](#bpy.types.CompositorNodeDefocus.update)
    - [`CompositorNodeDefocus.bl_rna_get_subclass()`](#bpy.types.CompositorNodeDefocus.bl_rna_get_subclass)
    - [`CompositorNodeDefocus.bl_rna_get_subclass_py()`](#bpy.types.CompositorNodeDefocus.bl_rna_get_subclass_py)
