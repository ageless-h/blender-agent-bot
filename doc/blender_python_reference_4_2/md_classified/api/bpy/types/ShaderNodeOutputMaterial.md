...
# ShaderNodeOutputMaterial(ShaderNode)[#](#shadernodeoutputmaterial-shadernode "Link to this heading")
...
*class* bpy.types.ShaderNodeOutputMaterial(*ShaderNode*)[#](#bpy.types.ShaderNodeOutputMaterial "Link to this definition")
:   Output surface material information for use in rendering

    is\_active\_output[#](#bpy.types.ShaderNodeOutputMaterial.is_active_output "Link to this definition")
    :   True if this node is used as the active output

        Type:
        :   boolean, default False

    target[#](#bpy.types.ShaderNodeOutputMaterial.target "Link to this definition")
    ...
    *classmethod* is\_registered\_node\_type()[#](#bpy.types.ShaderNodeOutputMaterial.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.ShaderNodeOutputMaterial.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.ShaderNodeOutputMaterial.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.ShaderNodeOutputMaterial.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.ShaderNodeOutputMaterial.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ShaderNodeOutputMaterial.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.ShaderNodeOutputMaterial.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ShaderNodeOutputMaterial(ShaderNode)
  + [`ShaderNodeOutputMaterial`](#bpy.types.ShaderNodeOutputMaterial)
    - [`ShaderNodeOutputMaterial.is_active_output`](#bpy.types.ShaderNodeOutputMaterial.is_active_output)
    - [`ShaderNodeOutputMaterial.target`](#bpy.types.ShaderNodeOutputMaterial.target)
    - [`ShaderNodeOutputMaterial.is_registered_node_type()`](#bpy.types.ShaderNodeOutputMaterial.is_registered_node_type)
    - [`ShaderNodeOutputMaterial.input_template()`](#bpy.types.ShaderNodeOutputMaterial.input_template)
    - [`ShaderNodeOutputMaterial.output_template()`](#bpy.types.ShaderNodeOutputMaterial.output_template)
    - [`ShaderNodeOutputMaterial.bl_rna_get_subclass()`](#bpy.types.ShaderNodeOutputMaterial.bl_rna_get_subclass)
    - [`ShaderNodeOutputMaterial.bl_rna_get_subclass_py()`](#bpy.types.ShaderNodeOutputMaterial.bl_rna_get_subclass_py)
