...
# ShaderNodeAmbientOcclusion(ShaderNode)[#](#shadernodeambientocclusion-shadernode "Link to this heading")
...
*class* bpy.types.ShaderNodeAmbientOcclusion(*ShaderNode*)[#](#bpy.types.ShaderNodeAmbientOcclusion "Link to this definition")
:   Compute how much the hemisphere above the shading point is occluded, for example to add weathering effects to corners.
    ...
    inside[#](#bpy.types.ShaderNodeAmbientOcclusion.inside "Link to this definition")
    :   Trace rays towards the inside of the object

        Type:
        :   boolean, default False

    only\_local[#](#bpy.types.ShaderNodeAmbientOcclusion.only_local "Link to this definition")
    :   Only consider the object itself when computing AO

        Type:
        :   boolean, default False

    samples[#](#bpy.types.ShaderNodeAmbientOcclusion.samples "Link to this definition")
    :   Number of rays to trace per shader evaluation

        Type:
        :   int in [1, 128], default 0

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.ShaderNodeAmbientOcclusion.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.ShaderNodeAmbientOcclusion.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.ShaderNodeAmbientOcclusion.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.ShaderNodeAmbientOcclusion.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.ShaderNodeAmbientOcclusion.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ShaderNodeAmbientOcclusion.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.ShaderNodeAmbientOcclusion.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ShaderNodeAmbientOcclusion(ShaderNode)
  + [`ShaderNodeAmbientOcclusion`](#bpy.types.ShaderNodeAmbientOcclusion)
    - [`ShaderNodeAmbientOcclusion.inside`](#bpy.types.ShaderNodeAmbientOcclusion.inside)
    - [`ShaderNodeAmbientOcclusion.only_local`](#bpy.types.ShaderNodeAmbientOcclusion.only_local)
    - [`ShaderNodeAmbientOcclusion.samples`](#bpy.types.ShaderNodeAmbientOcclusion.samples)
    - [`ShaderNodeAmbientOcclusion.is_registered_node_type()`](#bpy.types.ShaderNodeAmbientOcclusion.is_registered_node_type)
    - [`ShaderNodeAmbientOcclusion.input_template()`](#bpy.types.ShaderNodeAmbientOcclusion.input_template)
    - [`ShaderNodeAmbientOcclusion.output_template()`](#bpy.types.ShaderNodeAmbientOcclusion.output_template)
    - [`ShaderNodeAmbientOcclusion.bl_rna_get_subclass()`](#bpy.types.ShaderNodeAmbientOcclusion.bl_rna_get_subclass)
    - [`ShaderNodeAmbientOcclusion.bl_rna_get_subclass_py()`](#bpy.types.ShaderNodeAmbientOcclusion.bl_rna_get_subclass_py)
