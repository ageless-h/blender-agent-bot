...
# GeometryNodeStringToCurves(GeometryNode)[#](#geometrynodestringtocurves-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeStringToCurves(*GeometryNode*)[#](#bpy.types.GeometryNodeStringToCurves "Link to this definition")
:   Generate a paragraph of text with a specific font, using a curve instance to store each character

    align\_x[#](#bpy.types.GeometryNodeStringToCurves.align_x "Link to this definition")
    ...
    align\_y[#](#bpy.types.GeometryNodeStringToCurves.align_y "Link to this definition")
    :   Text vertical alignment from the object center
        ...
        * `BOTTOM`
        ...
        Type:
        :   enum in [‘TOP’, ‘TOP\_BASELINE’, ‘MIDDLE’, ‘BOTTOM\_BASELINE’, ‘BOTTOM’], default ‘TOP\_BASELINE’

    font[#](#bpy.types.GeometryNodeStringToCurves.font "Link to this definition")
    :   Font of the text. Falls back to the UI font by default

        Type:
        :   [`VectorFont`](VectorFont.md#bpy.types.VectorFont "bpy.types.VectorFont")

    overflow[#](#bpy.types.GeometryNodeStringToCurves.overflow "Link to this definition")
    :   Handle the text behavior when it doesn’t fit in the text boxes
        ...
        * `TRUNCATE`
        ...
        Type:
        :   enum in [‘OVERFLOW’, ‘SCALE\_TO\_FIT’, ‘TRUNCATE’], default ‘OVERFLOW’

    pivot\_mode[#](#bpy.types.GeometryNodeStringToCurves.pivot_mode "Link to this definition")
    :   Pivot point position relative to character
        ...
        * `BOTTOM_RIGHT`
        ...
        Type:
        :   enum in [‘MIDPOINT’, ‘TOP\_LEFT’, ‘TOP\_CENTER’, ‘TOP\_RIGHT’, ‘BOTTOM\_LEFT’, ‘BOTTOM\_CENTER’, ‘BOTTOM\_RIGHT’], default ‘BOTTOM\_LEFT’

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.GeometryNodeStringToCurves.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.GeometryNodeStringToCurves.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.GeometryNodeStringToCurves.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.GeometryNodeStringToCurves.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.GeometryNodeStringToCurves.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeStringToCurves.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.GeometryNodeStringToCurves.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeStringToCurves(GeometryNode)
  + [`GeometryNodeStringToCurves`](#bpy.types.GeometryNodeStringToCurves)
    - [`GeometryNodeStringToCurves.align_x`](#bpy.types.GeometryNodeStringToCurves.align_x)
    - [`GeometryNodeStringToCurves.align_y`](#bpy.types.GeometryNodeStringToCurves.align_y)
    - [`GeometryNodeStringToCurves.font`](#bpy.types.GeometryNodeStringToCurves.font)
    - [`GeometryNodeStringToCurves.overflow`](#bpy.types.GeometryNodeStringToCurves.overflow)
    - [`GeometryNodeStringToCurves.pivot_mode`](#bpy.types.GeometryNodeStringToCurves.pivot_mode)
    - [`GeometryNodeStringToCurves.is_registered_node_type()`](#bpy.types.GeometryNodeStringToCurves.is_registered_node_type)
    - [`GeometryNodeStringToCurves.input_template()`](#bpy.types.GeometryNodeStringToCurves.input_template)
    - [`GeometryNodeStringToCurves.output_template()`](#bpy.types.GeometryNodeStringToCurves.output_template)
    - [`GeometryNodeStringToCurves.bl_rna_get_subclass()`](#bpy.types.GeometryNodeStringToCurves.bl_rna_get_subclass)
    - [`GeometryNodeStringToCurves.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeStringToCurves.bl_rna_get_subclass_py)
