...
# GeometryNodeMeshCone(GeometryNode)[#](#geometrynodemeshcone-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeMeshCone(*GeometryNode*)[#](#bpy.types.GeometryNodeMeshCone "Link to this definition")
:   Generate a cone mesh

    fill\_type[#](#bpy.types.GeometryNodeMeshCone.fill_type "Link to this definition")
    :   Type:
        :   enum in [Node Geometry Mesh Circle Fill Type Items](../../../appendix/bpy_types_enum_items/node_geometry_mesh_circle_fill_type_items.md#rna-enum-node-geometry-mesh-circle-fill-type-items), default ‘NGON’

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.GeometryNodeMeshCone.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.GeometryNodeMeshCone.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.GeometryNodeMeshCone.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.GeometryNodeMeshCone.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.GeometryNodeMeshCone.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeMeshCone.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.GeometryNodeMeshCone.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeMeshCone(GeometryNode)
  + [`GeometryNodeMeshCone`](#bpy.types.GeometryNodeMeshCone)
    - [`GeometryNodeMeshCone.fill_type`](#bpy.types.GeometryNodeMeshCone.fill_type)
    - [`GeometryNodeMeshCone.is_registered_node_type()`](#bpy.types.GeometryNodeMeshCone.is_registered_node_type)
    - [`GeometryNodeMeshCone.input_template()`](#bpy.types.GeometryNodeMeshCone.input_template)
    - [`GeometryNodeMeshCone.output_template()`](#bpy.types.GeometryNodeMeshCone.output_template)
    - [`GeometryNodeMeshCone.bl_rna_get_subclass()`](#bpy.types.GeometryNodeMeshCone.bl_rna_get_subclass)
    - [`GeometryNodeMeshCone.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeMeshCone.bl_rna_get_subclass_py)
