...
# CompositorNodeViewer(CompositorNode)[#](#compositornodeviewer-compositornode "Link to this heading")
...
*class* bpy.types.CompositorNodeViewer(*CompositorNode*)[#](#bpy.types.CompositorNodeViewer "Link to this definition")
:   Visualize data from inside a node graph, in the image editor or as a backdrop

    use\_alpha[#](#bpy.types.CompositorNodeViewer.use_alpha "Link to this definition")
    :   Colors are treated alpha premultiplied, or colors output straight (alpha gets set to 1)

        Type:
        :   boolean, default False

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.CompositorNodeViewer.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.CompositorNodeViewer.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.CompositorNodeViewer.output_template "Link to this definition")
    ...
    update()[#](#bpy.types.CompositorNodeViewer.update "Link to this definition")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.CompositorNodeViewer.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.CompositorNodeViewer.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CompositorNodeViewer.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.CompositorNodeViewer.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CompositorNodeViewer(CompositorNode)
  + [`CompositorNodeViewer`](#bpy.types.CompositorNodeViewer)
    - [`CompositorNodeViewer.use_alpha`](#bpy.types.CompositorNodeViewer.use_alpha)
    - [`CompositorNodeViewer.is_registered_node_type()`](#bpy.types.CompositorNodeViewer.is_registered_node_type)
    - [`CompositorNodeViewer.input_template()`](#bpy.types.CompositorNodeViewer.input_template)
    - [`CompositorNodeViewer.output_template()`](#bpy.types.CompositorNodeViewer.output_template)
    - [`CompositorNodeViewer.update()`](#bpy.types.CompositorNodeViewer.update)
    - [`CompositorNodeViewer.bl_rna_get_subclass()`](#bpy.types.CompositorNodeViewer.bl_rna_get_subclass)
    - [`CompositorNodeViewer.bl_rna_get_subclass_py()`](#bpy.types.CompositorNodeViewer.bl_rna_get_subclass_py)
