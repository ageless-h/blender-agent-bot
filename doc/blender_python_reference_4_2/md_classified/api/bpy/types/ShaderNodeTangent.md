...
# ShaderNodeTangent(ShaderNode)[#](#shadernodetangent-shadernode "Link to this heading")
...
*class* bpy.types.ShaderNodeTangent(*ShaderNode*)[#](#bpy.types.ShaderNodeTangent "Link to this definition")
:   Generate a tangent direction for the Anisotropic BSDF

    axis[#](#bpy.types.ShaderNodeTangent.axis "Link to this definition")
    ...
    direction\_type[#](#bpy.types.ShaderNodeTangent.direction_type "Link to this definition")
    :   Method to use for the tangent
        ...
        * `UV_MAP`
        ...
        Type:
        :   enum in [‘RADIAL’, ‘UV\_MAP’], default ‘RADIAL’

    uv\_map[#](#bpy.types.ShaderNodeTangent.uv_map "Link to this definition")
    :   UV Map for tangent generated from UV

        Type:
        :   string, default “”, (never None)

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.ShaderNodeTangent.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.ShaderNodeTangent.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.ShaderNodeTangent.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.ShaderNodeTangent.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.ShaderNodeTangent.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ShaderNodeTangent.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.ShaderNodeTangent.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ShaderNodeTangent(ShaderNode)
  + [`ShaderNodeTangent`](#bpy.types.ShaderNodeTangent)
    - [`ShaderNodeTangent.axis`](#bpy.types.ShaderNodeTangent.axis)
    - [`ShaderNodeTangent.direction_type`](#bpy.types.ShaderNodeTangent.direction_type)
    - [`ShaderNodeTangent.uv_map`](#bpy.types.ShaderNodeTangent.uv_map)
    - [`ShaderNodeTangent.is_registered_node_type()`](#bpy.types.ShaderNodeTangent.is_registered_node_type)
    - [`ShaderNodeTangent.input_template()`](#bpy.types.ShaderNodeTangent.input_template)
    - [`ShaderNodeTangent.output_template()`](#bpy.types.ShaderNodeTangent.output_template)
    - [`ShaderNodeTangent.bl_rna_get_subclass()`](#bpy.types.ShaderNodeTangent.bl_rna_get_subclass)
    - [`ShaderNodeTangent.bl_rna_get_subclass_py()`](#bpy.types.ShaderNodeTangent.bl_rna_get_subclass_py)
