...
# ObjectGpencilModifiers(bpy\_struct)[#](#objectgpencilmodifiers-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.ObjectGpencilModifiers(*bpy\_struct*)[#](#bpy.types.ObjectGpencilModifiers "Link to this definition")
:   Collection of object grease pencil modifiers

    new(*name*, *type*)[#](#bpy.types.ObjectGpencilModifiers.new "Link to this definition")
    :   Add a new greasepencil\_modifier

        Parameters:
        :   * **name** (*string**,* *(**never None**)*) – New name for the greasepencil\_modifier
            * **type** (enum in [Object Greasepencil Modifier Type Items](../../../appendix/bpy_types_enum_items/object_greasepencil_modifier_type_items.md#rna-enum-object-greasepencil-modifier-type-items)) – Modifier type to add

        Returns:
        :   Newly created modifier

        Return type:
        :   [`GpencilModifier`](GpencilModifier.md#bpy.types.GpencilModifier "bpy.types.GpencilModifier")

    remove(*greasepencil\_modifier*)[#](#bpy.types.ObjectGpencilModifiers.remove "Link to this definition")
    :   Remove an existing greasepencil\_modifier from the object

        Parameters:
        :   **greasepencil\_modifier** ([`GpencilModifier`](GpencilModifier.md#bpy.types.GpencilModifier "bpy.types.GpencilModifier"), (never None)) – Modifier to remove

    clear()[#](#bpy.types.ObjectGpencilModifiers.clear "Link to this definition")
    :   Remove all grease pencil modifiers from the object

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.ObjectGpencilModifiers.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.ObjectGpencilModifiers.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Object.grease_pencil_modifiers`](Object.md#bpy.types.Object.grease_pencil_modifiers "bpy.types.Object.grease_pencil_modifiers") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ObjectGpencilModifiers.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.ObjectGpencilModifiers.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ObjectGpencilModifiers(bpy\_struct)
  + [`ObjectGpencilModifiers`](#bpy.types.ObjectGpencilModifiers)
    - [`ObjectGpencilModifiers.new()`](#bpy.types.ObjectGpencilModifiers.new)
    - [`ObjectGpencilModifiers.remove()`](#bpy.types.ObjectGpencilModifiers.remove)
    - [`ObjectGpencilModifiers.clear()`](#bpy.types.ObjectGpencilModifiers.clear)
    - [`ObjectGpencilModifiers.bl_rna_get_subclass()`](#bpy.types.ObjectGpencilModifiers.bl_rna_get_subclass)
    - [`ObjectGpencilModifiers.bl_rna_get_subclass_py()`](#bpy.types.ObjectGpencilModifiers.bl_rna_get_subclass_py)
