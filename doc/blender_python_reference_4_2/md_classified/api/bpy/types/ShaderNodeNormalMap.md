...
# ShaderNodeNormalMap(ShaderNode)[#](#shadernodenormalmap-shadernode "Link to this heading")
...
*class* bpy.types.ShaderNodeNormalMap(*ShaderNode*)[#](#bpy.types.ShaderNodeNormalMap "Link to this definition")
:   Generate a perturbed normal from an RGB normal map image. Typically used for faking highly detailed surfaces

    space[#](#bpy.types.ShaderNodeNormalMap.space "Link to this definition")
    :   Space of the input normal
        ...
        * `BLENDER_WORLD`
        ...
        Type:
        :   enum in [‘TANGENT’, ‘OBJECT’, ‘WORLD’, ‘BLENDER\_OBJECT’, ‘BLENDER\_WORLD’], default ‘TANGENT’

    uv\_map[#](#bpy.types.ShaderNodeNormalMap.uv_map "Link to this definition")
    :   UV Map for tangent space maps

        Type:
        :   string, default “”, (never None)

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.ShaderNodeNormalMap.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.ShaderNodeNormalMap.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.ShaderNodeNormalMap.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.ShaderNodeNormalMap.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.ShaderNodeNormalMap.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ShaderNodeNormalMap.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.ShaderNodeNormalMap.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ShaderNodeNormalMap(ShaderNode)
  + [`ShaderNodeNormalMap`](#bpy.types.ShaderNodeNormalMap)
    - [`ShaderNodeNormalMap.space`](#bpy.types.ShaderNodeNormalMap.space)
    - [`ShaderNodeNormalMap.uv_map`](#bpy.types.ShaderNodeNormalMap.uv_map)
    - [`ShaderNodeNormalMap.is_registered_node_type()`](#bpy.types.ShaderNodeNormalMap.is_registered_node_type)
    - [`ShaderNodeNormalMap.input_template()`](#bpy.types.ShaderNodeNormalMap.input_template)
    - [`ShaderNodeNormalMap.output_template()`](#bpy.types.ShaderNodeNormalMap.output_template)
    - [`ShaderNodeNormalMap.bl_rna_get_subclass()`](#bpy.types.ShaderNodeNormalMap.bl_rna_get_subclass)
    - [`ShaderNodeNormalMap.bl_rna_get_subclass_py()`](#bpy.types.ShaderNodeNormalMap.bl_rna_get_subclass_py)
