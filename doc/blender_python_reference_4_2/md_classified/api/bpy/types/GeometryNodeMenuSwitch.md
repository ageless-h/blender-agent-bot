...
# GeometryNodeMenuSwitch(GeometryNode)[#](#geometrynodemenuswitch-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeMenuSwitch(*GeometryNode*)[#](#bpy.types.GeometryNodeMenuSwitch "Link to this definition")
:   Select from multiple inputs by name

    active\_index[#](#bpy.types.GeometryNodeMenuSwitch.active_index "Link to this definition")
    :   Index of the active item

        Type:
        :   int in [0, inf], default 0

    active\_item[#](#bpy.types.GeometryNodeMenuSwitch.active_item "Link to this definition")
    :   Active item

        Type:
        :   [`NodeEnumItem`](NodeEnumItem.md#bpy.types.NodeEnumItem "bpy.types.NodeEnumItem")

    data\_type[#](#bpy.types.GeometryNodeMenuSwitch.data_type "Link to this definition")
    :   Type:
        :   enum in [Node Socket Data Type Items](../../../appendix/bpy_types_enum_items/node_socket_data_type_items.md#rna-enum-node-socket-data-type-items), default ‘GEOMETRY’

    enum\_definition[#](#bpy.types.GeometryNodeMenuSwitch.enum_definition "Link to this definition")
    ...
    enum\_items[#](#bpy.types.GeometryNodeMenuSwitch.enum_items "Link to this definition")
    :   Type:
        :   [`NodeMenuSwitchItems`](NodeMenuSwitchItems.md#bpy.types.NodeMenuSwitchItems "bpy.types.NodeMenuSwitchItems") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`NodeEnumItem`](NodeEnumItem.md#bpy.types.NodeEnumItem "bpy.types.NodeEnumItem"), (readonly)

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.GeometryNodeMenuSwitch.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.GeometryNodeMenuSwitch.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.GeometryNodeMenuSwitch.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.GeometryNodeMenuSwitch.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.GeometryNodeMenuSwitch.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeMenuSwitch.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.GeometryNodeMenuSwitch.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeMenuSwitch(GeometryNode)
  + [`GeometryNodeMenuSwitch`](#bpy.types.GeometryNodeMenuSwitch)
    - [`GeometryNodeMenuSwitch.active_index`](#bpy.types.GeometryNodeMenuSwitch.active_index)
    - [`GeometryNodeMenuSwitch.active_item`](#bpy.types.GeometryNodeMenuSwitch.active_item)
    - [`GeometryNodeMenuSwitch.data_type`](#bpy.types.GeometryNodeMenuSwitch.data_type)
    - [`GeometryNodeMenuSwitch.enum_definition`](#bpy.types.GeometryNodeMenuSwitch.enum_definition)
    - [`GeometryNodeMenuSwitch.enum_items`](#bpy.types.GeometryNodeMenuSwitch.enum_items)
    - [`GeometryNodeMenuSwitch.is_registered_node_type()`](#bpy.types.GeometryNodeMenuSwitch.is_registered_node_type)
    - [`GeometryNodeMenuSwitch.input_template()`](#bpy.types.GeometryNodeMenuSwitch.input_template)
    - [`GeometryNodeMenuSwitch.output_template()`](#bpy.types.GeometryNodeMenuSwitch.output_template)
    - [`GeometryNodeMenuSwitch.bl_rna_get_subclass()`](#bpy.types.GeometryNodeMenuSwitch.bl_rna_get_subclass)
    - [`GeometryNodeMenuSwitch.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeMenuSwitch.bl_rna_get_subclass_py)
