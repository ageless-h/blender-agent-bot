...
# CompositorNodeTrackPos(CompositorNode)[#](#compositornodetrackpos-compositornode "Link to this heading")
...
*class* bpy.types.CompositorNodeTrackPos(*CompositorNode*)[#](#bpy.types.CompositorNodeTrackPos "Link to this definition")
:   Provide information about motion tracking points, such as x and y values

    clip[#](#bpy.types.CompositorNodeTrackPos.clip "Link to this definition")
    :   Type:
        :   [`MovieClip`](MovieClip.md#bpy.types.MovieClip "bpy.types.MovieClip")

    frame\_relative[#](#bpy.types.CompositorNodeTrackPos.frame_relative "Link to this definition")
    :   Frame to be used for relative position

        Type:
        :   int in [-32768, 32767], default 0

    position[#](#bpy.types.CompositorNodeTrackPos.position "Link to this definition")
    :   Which marker position to use for output
        ...
        * `ABSOLUTE_FRAME`
        ...
        Type:
        :   enum in [‘ABSOLUTE’, ‘RELATIVE\_START’, ‘RELATIVE\_FRAME’, ‘ABSOLUTE\_FRAME’], default ‘ABSOLUTE’

    track\_name[#](#bpy.types.CompositorNodeTrackPos.track_name "Link to this definition")
    :   Type:
        :   string, default “”, (never None)

    tracking\_object[#](#bpy.types.CompositorNodeTrackPos.tracking_object "Link to this definition")
    :   Type:
        :   string, default “”, (never None)

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.CompositorNodeTrackPos.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.CompositorNodeTrackPos.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.CompositorNodeTrackPos.output_template "Link to this definition")
    ...
    update()[#](#bpy.types.CompositorNodeTrackPos.update "Link to this definition")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.CompositorNodeTrackPos.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.CompositorNodeTrackPos.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CompositorNodeTrackPos.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.CompositorNodeTrackPos.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CompositorNodeTrackPos(CompositorNode)
  + [`CompositorNodeTrackPos`](#bpy.types.CompositorNodeTrackPos)
    - [`CompositorNodeTrackPos.clip`](#bpy.types.CompositorNodeTrackPos.clip)
    - [`CompositorNodeTrackPos.frame_relative`](#bpy.types.CompositorNodeTrackPos.frame_relative)
    - [`CompositorNodeTrackPos.position`](#bpy.types.CompositorNodeTrackPos.position)
    - [`CompositorNodeTrackPos.track_name`](#bpy.types.CompositorNodeTrackPos.track_name)
    - [`CompositorNodeTrackPos.tracking_object`](#bpy.types.CompositorNodeTrackPos.tracking_object)
    - [`CompositorNodeTrackPos.is_registered_node_type()`](#bpy.types.CompositorNodeTrackPos.is_registered_node_type)
    - [`CompositorNodeTrackPos.input_template()`](#bpy.types.CompositorNodeTrackPos.input_template)
    - [`CompositorNodeTrackPos.output_template()`](#bpy.types.CompositorNodeTrackPos.output_template)
    - [`CompositorNodeTrackPos.update()`](#bpy.types.CompositorNodeTrackPos.update)
    - [`CompositorNodeTrackPos.bl_rna_get_subclass()`](#bpy.types.CompositorNodeTrackPos.bl_rna_get_subclass)
    - [`CompositorNodeTrackPos.bl_rna_get_subclass_py()`](#bpy.types.CompositorNodeTrackPos.bl_rna_get_subclass_py)
