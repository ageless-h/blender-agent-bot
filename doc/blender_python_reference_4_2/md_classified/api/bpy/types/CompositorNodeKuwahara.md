...
# CompositorNodeKuwahara(CompositorNode)[#](#compositornodekuwahara-compositornode "Link to this heading")
...
*class* bpy.types.CompositorNodeKuwahara(*CompositorNode*)[#](#bpy.types.CompositorNodeKuwahara "Link to this definition")
:   Apply smoothing filter that preserves edges, for stylized and painterly effects

    eccentricity[#](#bpy.types.CompositorNodeKuwahara.eccentricity "Link to this definition")
    ...
    sharpness[#](#bpy.types.CompositorNodeKuwahara.sharpness "Link to this definition")
    :   Controls the sharpness of the filter. 0 means completely smooth while 1 means completely sharp

        Type:
        :   float in [0, 1], default 0.0

    uniformity[#](#bpy.types.CompositorNodeKuwahara.uniformity "Link to this definition")
    ...
    use\_high\_precision[#](#bpy.types.CompositorNodeKuwahara.use_high_precision "Link to this definition")
    :   Uses a more precise but slower method. Use if the output contains undesirable noise

        Type:
        :   boolean, default False

    variation[#](#bpy.types.CompositorNodeKuwahara.variation "Link to this definition")
    :   Variation of Kuwahara filter to use

        * `CLASSIC`
          Classic – Fast but less accurate variation.
        * `ANISOTROPIC`
          Anisotropic – Accurate but slower variation.

        Type:
        :   enum in [‘CLASSIC’, ‘ANISOTROPIC’], default ‘CLASSIC’

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.CompositorNodeKuwahara.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.CompositorNodeKuwahara.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.CompositorNodeKuwahara.output_template "Link to this definition")
    ...
    update()[#](#bpy.types.CompositorNodeKuwahara.update "Link to this definition")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.CompositorNodeKuwahara.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.CompositorNodeKuwahara.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CompositorNodeKuwahara.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.CompositorNodeKuwahara.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CompositorNodeKuwahara(CompositorNode)
  + [`CompositorNodeKuwahara`](#bpy.types.CompositorNodeKuwahara)
    - [`CompositorNodeKuwahara.eccentricity`](#bpy.types.CompositorNodeKuwahara.eccentricity)
    - [`CompositorNodeKuwahara.sharpness`](#bpy.types.CompositorNodeKuwahara.sharpness)
    - [`CompositorNodeKuwahara.uniformity`](#bpy.types.CompositorNodeKuwahara.uniformity)
    - [`CompositorNodeKuwahara.use_high_precision`](#bpy.types.CompositorNodeKuwahara.use_high_precision)
    - [`CompositorNodeKuwahara.variation`](#bpy.types.CompositorNodeKuwahara.variation)
    - [`CompositorNodeKuwahara.is_registered_node_type()`](#bpy.types.CompositorNodeKuwahara.is_registered_node_type)
    - [`CompositorNodeKuwahara.input_template()`](#bpy.types.CompositorNodeKuwahara.input_template)
    - [`CompositorNodeKuwahara.output_template()`](#bpy.types.CompositorNodeKuwahara.output_template)
    - [`CompositorNodeKuwahara.update()`](#bpy.types.CompositorNodeKuwahara.update)
    - [`CompositorNodeKuwahara.bl_rna_get_subclass()`](#bpy.types.CompositorNodeKuwahara.bl_rna_get_subclass)
    - [`CompositorNodeKuwahara.bl_rna_get_subclass_py()`](#bpy.types.CompositorNodeKuwahara.bl_rna_get_subclass_py)
