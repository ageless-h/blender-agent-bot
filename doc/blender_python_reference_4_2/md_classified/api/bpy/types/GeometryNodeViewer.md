...
# GeometryNodeViewer(GeometryNode)[#](#geometrynodeviewer-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeViewer(*GeometryNode*)[#](#bpy.types.GeometryNodeViewer "Link to this definition")
:   Display the input data in the Spreadsheet Editor

    data\_type[#](#bpy.types.GeometryNodeViewer.data_type "Link to this definition")
    :   Type:
    ...
    domain[#](#bpy.types.GeometryNodeViewer.domain "Link to this definition")
    :   Domain to evaluate the field on

        Type:
        :   enum in [Attribute Domain With Auto Items](../../../appendix/bpy_types_enum_items/attribute_domain_with_auto_items.md#rna-enum-attribute-domain-with-auto-items), default ‘POINT’

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.GeometryNodeViewer.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.GeometryNodeViewer.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.GeometryNodeViewer.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.GeometryNodeViewer.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.GeometryNodeViewer.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeViewer.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.GeometryNodeViewer.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeViewer(GeometryNode)
  + [`GeometryNodeViewer`](#bpy.types.GeometryNodeViewer)
    - [`GeometryNodeViewer.data_type`](#bpy.types.GeometryNodeViewer.data_type)
    - [`GeometryNodeViewer.domain`](#bpy.types.GeometryNodeViewer.domain)
    - [`GeometryNodeViewer.is_registered_node_type()`](#bpy.types.GeometryNodeViewer.is_registered_node_type)
    - [`GeometryNodeViewer.input_template()`](#bpy.types.GeometryNodeViewer.input_template)
    - [`GeometryNodeViewer.output_template()`](#bpy.types.GeometryNodeViewer.output_template)
    - [`GeometryNodeViewer.bl_rna_get_subclass()`](#bpy.types.GeometryNodeViewer.bl_rna_get_subclass)
    - [`GeometryNodeViewer.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeViewer.bl_rna_get_subclass_py)
