...
:   Collection of keymap items
    ...
    new(*idname*, *type*, *value*, *any=False*, *shift=0*, *ctrl=0*, *alt=0*, *oskey=0*, *key\_modifier='NONE'*, *direction='ANY'*, *repeat=False*, *head=False*)[#](#bpy.types.KeyMapItems.new "Link to this definition")
    :   new
    ...
    new\_modal(*propvalue*, *type*, *value*, *any=False*, *shift=0*, *ctrl=0*, *alt=0*, *oskey=0*, *key\_modifier='NONE'*, *direction='ANY'*, *repeat=False*)[#](#bpy.types.KeyMapItems.new_modal "Link to this definition")
    :   new\_modal
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.KeyMapItems.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.KeyMapItems.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)
