...
# FunctionNodeBooleanMath(FunctionNode)[#](#functionnodebooleanmath-functionnode "Link to this heading")
...
*class* bpy.types.FunctionNodeBooleanMath(*FunctionNode*)[#](#bpy.types.FunctionNodeBooleanMath "Link to this definition")
:   operation[#](#bpy.types.FunctionNodeBooleanMath.operation "Link to this definition")
    :   Type:
        :   enum in [Node Boolean Math Items](../../../appendix/bpy_types_enum_items/node_boolean_math_items.md#rna-enum-node-boolean-math-items), default ‘AND’

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.FunctionNodeBooleanMath.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.FunctionNodeBooleanMath.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.FunctionNodeBooleanMath.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.FunctionNodeBooleanMath.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.FunctionNodeBooleanMath.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.FunctionNodeBooleanMath.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.FunctionNodeBooleanMath.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* FunctionNodeBooleanMath(FunctionNode)
  + [`FunctionNodeBooleanMath`](#bpy.types.FunctionNodeBooleanMath)
    - [`FunctionNodeBooleanMath.operation`](#bpy.types.FunctionNodeBooleanMath.operation)
    - [`FunctionNodeBooleanMath.is_registered_node_type()`](#bpy.types.FunctionNodeBooleanMath.is_registered_node_type)
    - [`FunctionNodeBooleanMath.input_template()`](#bpy.types.FunctionNodeBooleanMath.input_template)
    - [`FunctionNodeBooleanMath.output_template()`](#bpy.types.FunctionNodeBooleanMath.output_template)
    - [`FunctionNodeBooleanMath.bl_rna_get_subclass()`](#bpy.types.FunctionNodeBooleanMath.bl_rna_get_subclass)
    - [`FunctionNodeBooleanMath.bl_rna_get_subclass_py()`](#bpy.types.FunctionNodeBooleanMath.bl_rna_get_subclass_py)
