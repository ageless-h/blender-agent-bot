...
# GeometryNodeRepeatOutput(GeometryNode)[#](#geometrynoderepeatoutput-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeRepeatOutput(*GeometryNode*)[#](#bpy.types.GeometryNodeRepeatOutput "Link to this definition")
:   active\_index[#](#bpy.types.GeometryNodeRepeatOutput.active_index "Link to this definition")
    :   Index of the active item

        Type:
        :   int in [0, inf], default 0

    active\_item[#](#bpy.types.GeometryNodeRepeatOutput.active_item "Link to this definition")
    :   Index of the active item

        Type:
        :   [`RepeatItem`](RepeatItem.md#bpy.types.RepeatItem "bpy.types.RepeatItem")

    inspection\_index[#](#bpy.types.GeometryNodeRepeatOutput.inspection_index "Link to this definition")
    :   Iteration index that is used by inspection features like the viewer node or socket inspection

        Type:
        :   int in [-inf, inf], default 0

    repeat\_items[#](#bpy.types.GeometryNodeRepeatOutput.repeat_items "Link to this definition")
    :   Type:
        :   [`NodeGeometryRepeatOutputItems`](NodeGeometryRepeatOutputItems.md#bpy.types.NodeGeometryRepeatOutputItems "bpy.types.NodeGeometryRepeatOutputItems") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`RepeatItem`](RepeatItem.md#bpy.types.RepeatItem "bpy.types.RepeatItem"), (readonly)

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.GeometryNodeRepeatOutput.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.GeometryNodeRepeatOutput.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.GeometryNodeRepeatOutput.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.GeometryNodeRepeatOutput.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.GeometryNodeRepeatOutput.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeRepeatOutput.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.GeometryNodeRepeatOutput.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeRepeatOutput(GeometryNode)
  + [`GeometryNodeRepeatOutput`](#bpy.types.GeometryNodeRepeatOutput)
    - [`GeometryNodeRepeatOutput.active_index`](#bpy.types.GeometryNodeRepeatOutput.active_index)
    - [`GeometryNodeRepeatOutput.active_item`](#bpy.types.GeometryNodeRepeatOutput.active_item)
    - [`GeometryNodeRepeatOutput.inspection_index`](#bpy.types.GeometryNodeRepeatOutput.inspection_index)
    - [`GeometryNodeRepeatOutput.repeat_items`](#bpy.types.GeometryNodeRepeatOutput.repeat_items)
    - [`GeometryNodeRepeatOutput.is_registered_node_type()`](#bpy.types.GeometryNodeRepeatOutput.is_registered_node_type)
    - [`GeometryNodeRepeatOutput.input_template()`](#bpy.types.GeometryNodeRepeatOutput.input_template)
    - [`GeometryNodeRepeatOutput.output_template()`](#bpy.types.GeometryNodeRepeatOutput.output_template)
    - [`GeometryNodeRepeatOutput.bl_rna_get_subclass()`](#bpy.types.GeometryNodeRepeatOutput.bl_rna_get_subclass)
    - [`GeometryNodeRepeatOutput.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeRepeatOutput.bl_rna_get_subclass_py)
