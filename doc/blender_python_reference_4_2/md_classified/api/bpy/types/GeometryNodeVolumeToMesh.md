...
# GeometryNodeVolumeToMesh(GeometryNode)[#](#geometrynodevolumetomesh-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeVolumeToMesh(*GeometryNode*)[#](#bpy.types.GeometryNodeVolumeToMesh "Link to this definition")
:   Generate a mesh on the “surface” of a volume

    resolution\_mode[#](#bpy.types.GeometryNodeVolumeToMesh.resolution_mode "Link to this definition")
    :   How the voxel size is specified
        ...
        * `VOXEL_SIZE`
        ...
        Type:
        :   enum in [‘GRID’, ‘VOXEL\_AMOUNT’, ‘VOXEL\_SIZE’], default ‘GRID’

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.GeometryNodeVolumeToMesh.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.GeometryNodeVolumeToMesh.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.GeometryNodeVolumeToMesh.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.GeometryNodeVolumeToMesh.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.GeometryNodeVolumeToMesh.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeVolumeToMesh.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.GeometryNodeVolumeToMesh.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeVolumeToMesh(GeometryNode)
  + [`GeometryNodeVolumeToMesh`](#bpy.types.GeometryNodeVolumeToMesh)
    - [`GeometryNodeVolumeToMesh.resolution_mode`](#bpy.types.GeometryNodeVolumeToMesh.resolution_mode)
    - [`GeometryNodeVolumeToMesh.is_registered_node_type()`](#bpy.types.GeometryNodeVolumeToMesh.is_registered_node_type)
    - [`GeometryNodeVolumeToMesh.input_template()`](#bpy.types.GeometryNodeVolumeToMesh.input_template)
    - [`GeometryNodeVolumeToMesh.output_template()`](#bpy.types.GeometryNodeVolumeToMesh.output_template)
    - [`GeometryNodeVolumeToMesh.bl_rna_get_subclass()`](#bpy.types.GeometryNodeVolumeToMesh.bl_rna_get_subclass)
    - [`GeometryNodeVolumeToMesh.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeVolumeToMesh.bl_rna_get_subclass_py)
