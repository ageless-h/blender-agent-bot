...
# CompositorNodeConvertColorSpace(CompositorNode)[#](#compositornodeconvertcolorspace-compositornode "Link to this heading")
...
*class* bpy.types.CompositorNodeConvertColorSpace(*CompositorNode*)[#](#bpy.types.CompositorNodeConvertColorSpace "Link to this definition")
:   Convert between color spaces

    from\_color\_space[#](#bpy.types.CompositorNodeConvertColorSpace.from_color_space "Link to this definition")
    :   Color space of the input image

        Type:
        :   enum in [Color Space Convert Default Items](../../../appendix/bpy_types_enum_items/color_space_convert_default_items.md#rna-enum-color-space-convert-default-items), default ‘NONE’

    to\_color\_space[#](#bpy.types.CompositorNodeConvertColorSpace.to_color_space "Link to this definition")
    :   Color space of the output image

        Type:
        :   enum in [Color Space Convert Default Items](../../../appendix/bpy_types_enum_items/color_space_convert_default_items.md#rna-enum-color-space-convert-default-items), default ‘NONE’

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.CompositorNodeConvertColorSpace.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.CompositorNodeConvertColorSpace.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.CompositorNodeConvertColorSpace.output_template "Link to this definition")
    ...
    update()[#](#bpy.types.CompositorNodeConvertColorSpace.update "Link to this definition")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.CompositorNodeConvertColorSpace.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.CompositorNodeConvertColorSpace.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CompositorNodeConvertColorSpace.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.CompositorNodeConvertColorSpace.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CompositorNodeConvertColorSpace(CompositorNode)
  + [`CompositorNodeConvertColorSpace`](#bpy.types.CompositorNodeConvertColorSpace)
    - [`CompositorNodeConvertColorSpace.from_color_space`](#bpy.types.CompositorNodeConvertColorSpace.from_color_space)
    - [`CompositorNodeConvertColorSpace.to_color_space`](#bpy.types.CompositorNodeConvertColorSpace.to_color_space)
    - [`CompositorNodeConvertColorSpace.is_registered_node_type()`](#bpy.types.CompositorNodeConvertColorSpace.is_registered_node_type)
    - [`CompositorNodeConvertColorSpace.input_template()`](#bpy.types.CompositorNodeConvertColorSpace.input_template)
    - [`CompositorNodeConvertColorSpace.output_template()`](#bpy.types.CompositorNodeConvertColorSpace.output_template)
    - [`CompositorNodeConvertColorSpace.update()`](#bpy.types.CompositorNodeConvertColorSpace.update)
    - [`CompositorNodeConvertColorSpace.bl_rna_get_subclass()`](#bpy.types.CompositorNodeConvertColorSpace.bl_rna_get_subclass)
    - [`CompositorNodeConvertColorSpace.bl_rna_get_subclass_py()`](#bpy.types.CompositorNodeConvertColorSpace.bl_rna_get_subclass_py)
