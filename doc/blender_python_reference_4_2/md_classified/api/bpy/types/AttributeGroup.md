...
# AttributeGroup(bpy\_struct)[#](#attributegroup-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.AttributeGroup(*bpy\_struct*)[#](#bpy.types.AttributeGroup "Link to this definition")
:   Group of geometry attributes

    active[#](#bpy.types.AttributeGroup.active "Link to this definition")
    :   Active attribute

        Type:
        :   [`Attribute`](Attribute.md#bpy.types.Attribute "bpy.types.Attribute")

    active\_color[#](#bpy.types.AttributeGroup.active_color "Link to this definition")
    :   Active color attribute for display and editing

        Type:
        :   [`Attribute`](Attribute.md#bpy.types.Attribute "bpy.types.Attribute")

    active\_color\_index[#](#bpy.types.AttributeGroup.active_color_index "Link to this definition")
    :   Active color attribute index

        Type:
        :   int in [-inf, inf], default 0

    active\_color\_name[#](#bpy.types.AttributeGroup.active_color_name "Link to this definition")
    :   The name of the active color attribute for display and editing

        Type:
        :   string, default “”, (never None)

    active\_index[#](#bpy.types.AttributeGroup.active_index "Link to this definition")
    :   Active attribute index or -1 when none are active

        Type:
        :   int in [-1, inf], default 0

    default\_color\_name[#](#bpy.types.AttributeGroup.default_color_name "Link to this definition")
    :   The name of the default color attribute used as a fallback for rendering

        Type:
        :   string, default “”, (never None)

    render\_color\_index[#](#bpy.types.AttributeGroup.render_color_index "Link to this definition")
    :   The index of the color attribute used as a fallback for rendering

        Type:
        :   int in [-inf, inf], default 0

    new(*name*, *type*, *domain*)[#](#bpy.types.AttributeGroup.new "Link to this definition")
    ...
    remove(*attribute*)[#](#bpy.types.AttributeGroup.remove "Link to this definition")
    :   Remove attribute from geometry

        Parameters:
        :   **attribute** ([`Attribute`](Attribute.md#bpy.types.Attribute "bpy.types.Attribute"), (never None)) – Geometry Attribute

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.AttributeGroup.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.AttributeGroup.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Curves.attributes`](Curves.md#bpy.types.Curves.attributes "bpy.types.Curves.attributes") * [`Curves.color_attributes`](Curves.md#bpy.types.Curves.color_attributes "bpy.types.Curves.color_attributes") * [`Mesh.attributes`](Mesh.md#bpy.types.Mesh.attributes "bpy.types.Mesh.attributes") | * [`Mesh.color_attributes`](Mesh.md#bpy.types.Mesh.color_attributes "bpy.types.Mesh.color_attributes") * [`PointCloud.attributes`](PointCloud.md#bpy.types.PointCloud.attributes "bpy.types.PointCloud.attributes") * [`PointCloud.color_attributes`](PointCloud.md#bpy.types.PointCloud.color_attributes "bpy.types.PointCloud.color_attributes") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.AttributeGroup.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.AttributeGroup.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* AttributeGroup(bpy\_struct)
  + [`AttributeGroup`](#bpy.types.AttributeGroup)
    - [`AttributeGroup.active`](#bpy.types.AttributeGroup.active)
    - [`AttributeGroup.active_color`](#bpy.types.AttributeGroup.active_color)
    - [`AttributeGroup.active_color_index`](#bpy.types.AttributeGroup.active_color_index)
    - [`AttributeGroup.active_color_name`](#bpy.types.AttributeGroup.active_color_name)
    - [`AttributeGroup.active_index`](#bpy.types.AttributeGroup.active_index)
    - [`AttributeGroup.default_color_name`](#bpy.types.AttributeGroup.default_color_name)
    - [`AttributeGroup.render_color_index`](#bpy.types.AttributeGroup.render_color_index)
    - [`AttributeGroup.new()`](#bpy.types.AttributeGroup.new)
    - [`AttributeGroup.remove()`](#bpy.types.AttributeGroup.remove)
    - [`AttributeGroup.bl_rna_get_subclass()`](#bpy.types.AttributeGroup.bl_rna_get_subclass)
    - [`AttributeGroup.bl_rna_get_subclass_py()`](#bpy.types.AttributeGroup.bl_rna_get_subclass_py)
