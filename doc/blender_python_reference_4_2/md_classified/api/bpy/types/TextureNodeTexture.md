...
# TextureNodeTexture(TextureNode)[#](#texturenodetexture-texturenode "Link to this heading")
...
*class* bpy.types.TextureNodeTexture(*TextureNode*)[#](#bpy.types.TextureNodeTexture "Link to this definition")
:   node\_output[#](#bpy.types.TextureNodeTexture.node_output "Link to this definition")
    :   For node-based textures, which output node to use

        Type:
        :   int in [-32768, 32767], default 0

    texture[#](#bpy.types.TextureNodeTexture.texture "Link to this definition")
    :   Type:
        :   [`Texture`](Texture.md#bpy.types.Texture "bpy.types.Texture")

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.TextureNodeTexture.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.TextureNodeTexture.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.TextureNodeTexture.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.TextureNodeTexture.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.TextureNodeTexture.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.TextureNodeTexture.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.TextureNodeTexture.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* TextureNodeTexture(TextureNode)
  + [`TextureNodeTexture`](#bpy.types.TextureNodeTexture)
    - [`TextureNodeTexture.node_output`](#bpy.types.TextureNodeTexture.node_output)
    - [`TextureNodeTexture.texture`](#bpy.types.TextureNodeTexture.texture)
    - [`TextureNodeTexture.is_registered_node_type()`](#bpy.types.TextureNodeTexture.is_registered_node_type)
    - [`TextureNodeTexture.input_template()`](#bpy.types.TextureNodeTexture.input_template)
    - [`TextureNodeTexture.output_template()`](#bpy.types.TextureNodeTexture.output_template)
    - [`TextureNodeTexture.bl_rna_get_subclass()`](#bpy.types.TextureNodeTexture.bl_rna_get_subclass)
    - [`TextureNodeTexture.bl_rna_get_subclass_py()`](#bpy.types.TextureNodeTexture.bl_rna_get_subclass_py)
