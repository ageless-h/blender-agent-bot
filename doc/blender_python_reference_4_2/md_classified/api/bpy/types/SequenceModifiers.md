...
# SequenceModifiers(bpy\_struct)[#](#sequencemodifiers-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.SequenceModifiers(*bpy\_struct*)[#](#bpy.types.SequenceModifiers "Link to this definition")
:   Collection of strip modifiers

    new(*name*, *type*)[#](#bpy.types.SequenceModifiers.new "Link to this definition")
    :   Add a new modifier

        Parameters:
        :   * **name** (*string**,* *(**never None**)*) – New name for the modifier
            * **type** (enum in [Sequence Modifier Type Items](../../../appendix/bpy_types_enum_items/sequence_modifier_type_items.md#rna-enum-sequence-modifier-type-items)) – Modifier type to add

        Returns:
        :   Newly created modifier

        Return type:
        :   [`SequenceModifier`](SequenceModifier.md#bpy.types.SequenceModifier "bpy.types.SequenceModifier")

    remove(*modifier*)[#](#bpy.types.SequenceModifiers.remove "Link to this definition")
    :   Remove an existing modifier from the sequence

        Parameters:
        :   **modifier** ([`SequenceModifier`](SequenceModifier.md#bpy.types.SequenceModifier "bpy.types.SequenceModifier"), (never None)) – Modifier to remove

    clear()[#](#bpy.types.SequenceModifiers.clear "Link to this definition")
    :   Remove all modifiers from the sequence

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.SequenceModifiers.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.SequenceModifiers.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Sequence.modifiers`](Sequence.md#bpy.types.Sequence.modifiers "bpy.types.Sequence.modifiers") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.SequenceModifiers.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.SequenceModifiers.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* SequenceModifiers(bpy\_struct)
  + [`SequenceModifiers`](#bpy.types.SequenceModifiers)
    - [`SequenceModifiers.new()`](#bpy.types.SequenceModifiers.new)
    - [`SequenceModifiers.remove()`](#bpy.types.SequenceModifiers.remove)
    - [`SequenceModifiers.clear()`](#bpy.types.SequenceModifiers.clear)
    - [`SequenceModifiers.bl_rna_get_subclass()`](#bpy.types.SequenceModifiers.bl_rna_get_subclass)
    - [`SequenceModifiers.bl_rna_get_subclass_py()`](#bpy.types.SequenceModifiers.bl_rna_get_subclass_py)
