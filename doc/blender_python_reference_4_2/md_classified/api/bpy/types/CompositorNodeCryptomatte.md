...
# CompositorNodeCryptomatte(CompositorNode)[#](#compositornodecryptomatte-compositornode "Link to this heading")
...
*class* bpy.types.CompositorNodeCryptomatte(*CompositorNode*)[#](#bpy.types.CompositorNodeCryptomatte "Link to this definition")
:   Deprecated. Use Cryptomatte Node instead

    add[#](#bpy.types.CompositorNodeCryptomatte.add "Link to this definition")
    ...
    matte\_id[#](#bpy.types.CompositorNodeCryptomatte.matte_id "Link to this definition")
    :   List of object and material crypto IDs to include in matte

        Type:
        :   string, default “”, (never None)

    remove[#](#bpy.types.CompositorNodeCryptomatte.remove "Link to this definition")
    :   Remove object or material from matte, by picking a color from the Pick output

        Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [-inf, inf], default (1.0, 1.0, 1.0)

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.CompositorNodeCryptomatte.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.CompositorNodeCryptomatte.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.CompositorNodeCryptomatte.output_template "Link to this definition")
    ...
    update()[#](#bpy.types.CompositorNodeCryptomatte.update "Link to this definition")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.CompositorNodeCryptomatte.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.CompositorNodeCryptomatte.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CompositorNodeCryptomatte.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.CompositorNodeCryptomatte.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CompositorNodeCryptomatte(CompositorNode)
  + [`CompositorNodeCryptomatte`](#bpy.types.CompositorNodeCryptomatte)
    - [`CompositorNodeCryptomatte.add`](#bpy.types.CompositorNodeCryptomatte.add)
    - [`CompositorNodeCryptomatte.matte_id`](#bpy.types.CompositorNodeCryptomatte.matte_id)
    - [`CompositorNodeCryptomatte.remove`](#bpy.types.CompositorNodeCryptomatte.remove)
    - [`CompositorNodeCryptomatte.is_registered_node_type()`](#bpy.types.CompositorNodeCryptomatte.is_registered_node_type)
    - [`CompositorNodeCryptomatte.input_template()`](#bpy.types.CompositorNodeCryptomatte.input_template)
    - [`CompositorNodeCryptomatte.output_template()`](#bpy.types.CompositorNodeCryptomatte.output_template)
    - [`CompositorNodeCryptomatte.update()`](#bpy.types.CompositorNodeCryptomatte.update)
    - [`CompositorNodeCryptomatte.bl_rna_get_subclass()`](#bpy.types.CompositorNodeCryptomatte.bl_rna_get_subclass)
    - [`CompositorNodeCryptomatte.bl_rna_get_subclass_py()`](#bpy.types.CompositorNodeCryptomatte.bl_rna_get_subclass_py)
