...
# CompositorNodeTranslate(CompositorNode)[#](#compositornodetranslate-compositornode "Link to this heading")
...
*class* bpy.types.CompositorNodeTranslate(*CompositorNode*)[#](#bpy.types.CompositorNodeTranslate "Link to this definition")
:   Offset an image

    interpolation[#](#bpy.types.CompositorNodeTranslate.interpolation "Link to this definition")
    :   * `Nearest`
    ...
    use\_relative[#](#bpy.types.CompositorNodeTranslate.use_relative "Link to this definition")
    :   Use relative (fraction of input image size) values to define translation

        Type:
        :   boolean, default False

    wrap\_axis[#](#bpy.types.CompositorNodeTranslate.wrap_axis "Link to this definition")
    ...
    *classmethod* is\_registered\_node\_type()[#](#bpy.types.CompositorNodeTranslate.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.CompositorNodeTranslate.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.CompositorNodeTranslate.output_template "Link to this definition")
    ...
    update()[#](#bpy.types.CompositorNodeTranslate.update "Link to this definition")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.CompositorNodeTranslate.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.CompositorNodeTranslate.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CompositorNodeTranslate.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.CompositorNodeTranslate.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CompositorNodeTranslate(CompositorNode)
  + [`CompositorNodeTranslate`](#bpy.types.CompositorNodeTranslate)
    - [`CompositorNodeTranslate.interpolation`](#bpy.types.CompositorNodeTranslate.interpolation)
    - [`CompositorNodeTranslate.use_relative`](#bpy.types.CompositorNodeTranslate.use_relative)
    - [`CompositorNodeTranslate.wrap_axis`](#bpy.types.CompositorNodeTranslate.wrap_axis)
    - [`CompositorNodeTranslate.is_registered_node_type()`](#bpy.types.CompositorNodeTranslate.is_registered_node_type)
    - [`CompositorNodeTranslate.input_template()`](#bpy.types.CompositorNodeTranslate.input_template)
    - [`CompositorNodeTranslate.output_template()`](#bpy.types.CompositorNodeTranslate.output_template)
    - [`CompositorNodeTranslate.update()`](#bpy.types.CompositorNodeTranslate.update)
    - [`CompositorNodeTranslate.bl_rna_get_subclass()`](#bpy.types.CompositorNodeTranslate.bl_rna_get_subclass)
    - [`CompositorNodeTranslate.bl_rna_get_subclass_py()`](#bpy.types.CompositorNodeTranslate.bl_rna_get_subclass_py)
