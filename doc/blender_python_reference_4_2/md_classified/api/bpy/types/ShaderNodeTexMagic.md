...
# ShaderNodeTexMagic(ShaderNode)[#](#shadernodetexmagic-shadernode "Link to this heading")
...
*class* bpy.types.ShaderNodeTexMagic(*ShaderNode*)[#](#bpy.types.ShaderNodeTexMagic "Link to this definition")
:   Generate a psychedelic color texture

    color\_mapping[#](#bpy.types.ShaderNodeTexMagic.color_mapping "Link to this definition")
    :   Color mapping settings

        Type:
        :   [`ColorMapping`](ColorMapping.md#bpy.types.ColorMapping "bpy.types.ColorMapping"), (readonly, never None)

    texture\_mapping[#](#bpy.types.ShaderNodeTexMagic.texture_mapping "Link to this definition")
    :   Texture coordinate mapping settings

        Type:
        :   [`TexMapping`](TexMapping.md#bpy.types.TexMapping "bpy.types.TexMapping"), (readonly, never None)

    turbulence\_depth[#](#bpy.types.ShaderNodeTexMagic.turbulence_depth "Link to this definition")
    :   Level of detail in the added turbulent noise

        Type:
        :   int in [0, 10], default 0

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.ShaderNodeTexMagic.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.ShaderNodeTexMagic.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.ShaderNodeTexMagic.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.ShaderNodeTexMagic.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.ShaderNodeTexMagic.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ShaderNodeTexMagic.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.ShaderNodeTexMagic.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ShaderNodeTexMagic(ShaderNode)
  + [`ShaderNodeTexMagic`](#bpy.types.ShaderNodeTexMagic)
    - [`ShaderNodeTexMagic.color_mapping`](#bpy.types.ShaderNodeTexMagic.color_mapping)
    - [`ShaderNodeTexMagic.texture_mapping`](#bpy.types.ShaderNodeTexMagic.texture_mapping)
    - [`ShaderNodeTexMagic.turbulence_depth`](#bpy.types.ShaderNodeTexMagic.turbulence_depth)
    - [`ShaderNodeTexMagic.is_registered_node_type()`](#bpy.types.ShaderNodeTexMagic.is_registered_node_type)
    - [`ShaderNodeTexMagic.input_template()`](#bpy.types.ShaderNodeTexMagic.input_template)
    - [`ShaderNodeTexMagic.output_template()`](#bpy.types.ShaderNodeTexMagic.output_template)
    - [`ShaderNodeTexMagic.bl_rna_get_subclass()`](#bpy.types.ShaderNodeTexMagic.bl_rna_get_subclass)
    - [`ShaderNodeTexMagic.bl_rna_get_subclass_py()`](#bpy.types.ShaderNodeTexMagic.bl_rna_get_subclass_py)
