...
# CompositorNodePlaneTrackDeform(CompositorNode)[#](#compositornodeplanetrackdeform-compositornode "Link to this heading")
...
*class* bpy.types.CompositorNodePlaneTrackDeform(*CompositorNode*)[#](#bpy.types.CompositorNodePlaneTrackDeform "Link to this definition")
:   Replace flat planes in footage by another image, dectected by plane tracks from motion tracking

    clip[#](#bpy.types.CompositorNodePlaneTrackDeform.clip "Link to this definition")
    :   Type:
        :   [`MovieClip`](MovieClip.md#bpy.types.MovieClip "bpy.types.MovieClip")

    motion\_blur\_samples[#](#bpy.types.CompositorNodePlaneTrackDeform.motion_blur_samples "Link to this definition")
    :   Number of motion blur samples

        Type:
        :   int in [1, 64], default 0

    motion\_blur\_shutter[#](#bpy.types.CompositorNodePlaneTrackDeform.motion_blur_shutter "Link to this definition")
    :   Exposure for motion blur as a factor of FPS

        Type:
        :   float in [0, 1], default 0.0

    plane\_track\_name[#](#bpy.types.CompositorNodePlaneTrackDeform.plane_track_name "Link to this definition")
    :   Type:
        :   string, default “”, (never None)

    tracking\_object[#](#bpy.types.CompositorNodePlaneTrackDeform.tracking_object "Link to this definition")
    :   Type:
        :   string, default “”, (never None)

    use\_motion\_blur[#](#bpy.types.CompositorNodePlaneTrackDeform.use_motion_blur "Link to this definition")
    :   Use multi-sampled motion blur of the mask

        Type:
        :   boolean, default False

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.CompositorNodePlaneTrackDeform.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.CompositorNodePlaneTrackDeform.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.CompositorNodePlaneTrackDeform.output_template "Link to this definition")
    ...
    update()[#](#bpy.types.CompositorNodePlaneTrackDeform.update "Link to this definition")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.CompositorNodePlaneTrackDeform.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.CompositorNodePlaneTrackDeform.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CompositorNodePlaneTrackDeform.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.CompositorNodePlaneTrackDeform.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CompositorNodePlaneTrackDeform(CompositorNode)
  + [`CompositorNodePlaneTrackDeform`](#bpy.types.CompositorNodePlaneTrackDeform)
    - [`CompositorNodePlaneTrackDeform.clip`](#bpy.types.CompositorNodePlaneTrackDeform.clip)
    - [`CompositorNodePlaneTrackDeform.motion_blur_samples`](#bpy.types.CompositorNodePlaneTrackDeform.motion_blur_samples)
    - [`CompositorNodePlaneTrackDeform.motion_blur_shutter`](#bpy.types.CompositorNodePlaneTrackDeform.motion_blur_shutter)
    - [`CompositorNodePlaneTrackDeform.plane_track_name`](#bpy.types.CompositorNodePlaneTrackDeform.plane_track_name)
    - [`CompositorNodePlaneTrackDeform.tracking_object`](#bpy.types.CompositorNodePlaneTrackDeform.tracking_object)
    - [`CompositorNodePlaneTrackDeform.use_motion_blur`](#bpy.types.CompositorNodePlaneTrackDeform.use_motion_blur)
    - [`CompositorNodePlaneTrackDeform.is_registered_node_type()`](#bpy.types.CompositorNodePlaneTrackDeform.is_registered_node_type)
    - [`CompositorNodePlaneTrackDeform.input_template()`](#bpy.types.CompositorNodePlaneTrackDeform.input_template)
    - [`CompositorNodePlaneTrackDeform.output_template()`](#bpy.types.CompositorNodePlaneTrackDeform.output_template)
    - [`CompositorNodePlaneTrackDeform.update()`](#bpy.types.CompositorNodePlaneTrackDeform.update)
    - [`CompositorNodePlaneTrackDeform.bl_rna_get_subclass()`](#bpy.types.CompositorNodePlaneTrackDeform.bl_rna_get_subclass)
    - [`CompositorNodePlaneTrackDeform.bl_rna_get_subclass_py()`](#bpy.types.CompositorNodePlaneTrackDeform.bl_rna_get_subclass_py)
