...
# ShaderNodeTexNoise(ShaderNode)[#](#shadernodetexnoise-shadernode "Link to this heading")
...
*class* bpy.types.ShaderNodeTexNoise(*ShaderNode*)[#](#bpy.types.ShaderNodeTexNoise "Link to this definition")
:   Generate fractal Perlin noise

    color\_mapping[#](#bpy.types.ShaderNodeTexNoise.color_mapping "Link to this definition")
    :   Color mapping settings

        Type:
        :   [`ColorMapping`](ColorMapping.md#bpy.types.ColorMapping "bpy.types.ColorMapping"), (readonly, never None)

    noise\_dimensions[#](#bpy.types.ShaderNodeTexNoise.noise_dimensions "Link to this definition")
    ...
    noise\_type[#](#bpy.types.ShaderNodeTexNoise.noise_type "Link to this definition")
    ...
    normalize[#](#bpy.types.ShaderNodeTexNoise.normalize "Link to this definition")
    :   Normalize outputs to 0.0 to 1.0 range

        Type:
        :   boolean, default False

    texture\_mapping[#](#bpy.types.ShaderNodeTexNoise.texture_mapping "Link to this definition")
    :   Texture coordinate mapping settings

        Type:
        :   [`TexMapping`](TexMapping.md#bpy.types.TexMapping "bpy.types.TexMapping"), (readonly, never None)

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.ShaderNodeTexNoise.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.ShaderNodeTexNoise.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.ShaderNodeTexNoise.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.ShaderNodeTexNoise.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.ShaderNodeTexNoise.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ShaderNodeTexNoise.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.ShaderNodeTexNoise.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ShaderNodeTexNoise(ShaderNode)
  + [`ShaderNodeTexNoise`](#bpy.types.ShaderNodeTexNoise)
    - [`ShaderNodeTexNoise.color_mapping`](#bpy.types.ShaderNodeTexNoise.color_mapping)
    - [`ShaderNodeTexNoise.noise_dimensions`](#bpy.types.ShaderNodeTexNoise.noise_dimensions)
    - [`ShaderNodeTexNoise.noise_type`](#bpy.types.ShaderNodeTexNoise.noise_type)
    - [`ShaderNodeTexNoise.normalize`](#bpy.types.ShaderNodeTexNoise.normalize)
    - [`ShaderNodeTexNoise.texture_mapping`](#bpy.types.ShaderNodeTexNoise.texture_mapping)
    - [`ShaderNodeTexNoise.is_registered_node_type()`](#bpy.types.ShaderNodeTexNoise.is_registered_node_type)
    - [`ShaderNodeTexNoise.input_template()`](#bpy.types.ShaderNodeTexNoise.input_template)
    - [`ShaderNodeTexNoise.output_template()`](#bpy.types.ShaderNodeTexNoise.output_template)
    - [`ShaderNodeTexNoise.bl_rna_get_subclass()`](#bpy.types.ShaderNodeTexNoise.bl_rna_get_subclass)
    - [`ShaderNodeTexNoise.bl_rna_get_subclass_py()`](#bpy.types.ShaderNodeTexNoise.bl_rna_get_subclass_py)
