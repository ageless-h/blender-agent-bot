...
# GPENCIL\_UL\_vgroups(UIList)[#](#gpencil-ul-vgroups-uilist "Link to this heading")
...
*class* bpy.types.GPENCIL\_UL\_vgroups(*UIList*)[#](#bpy.types.GPENCIL_UL_vgroups "Link to this definition")
:   draw\_item(*\_context*, *layout*, *\_data*, *item*, *icon*, *\_active\_data*, *\_active\_propname*, *\_index*)[#](#bpy.types.GPENCIL_UL_vgroups.draw_item "Link to this definition")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.GPENCIL_UL_vgroups.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.GPENCIL_UL_vgroups.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GPENCIL_UL_vgroups.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.GPENCIL_UL_vgroups.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GPENCIL\_UL\_vgroups(UIList)
  + [`GPENCIL_UL_vgroups`](#bpy.types.GPENCIL_UL_vgroups)
    - [`GPENCIL_UL_vgroups.draw_item()`](#bpy.types.GPENCIL_UL_vgroups.draw_item)
    - [`GPENCIL_UL_vgroups.bl_rna_get_subclass()`](#bpy.types.GPENCIL_UL_vgroups.bl_rna_get_subclass)
    - [`GPENCIL_UL_vgroups.bl_rna_get_subclass_py()`](#bpy.types.GPENCIL_UL_vgroups.bl_rna_get_subclass_py)
