...
# ShaderNodeMapRange(ShaderNode)[#](#shadernodemaprange-shadernode "Link to this heading")
...
*class* bpy.types.ShaderNodeMapRange(*ShaderNode*)[#](#bpy.types.ShaderNodeMapRange "Link to this definition")
:   Remap a value from a range to a target range

    clamp[#](#bpy.types.ShaderNodeMapRange.clamp "Link to this definition")
    :   Clamp the result to the target range [To Min, To Max]

        Type:
        :   boolean, default False

    data\_type[#](#bpy.types.ShaderNodeMapRange.data_type "Link to this definition")
    :   * `FLOAT`
        ...
        * `FLOAT_VECTOR`
        ...
        Type:
        :   enum in [‘FLOAT’, ‘FLOAT\_VECTOR’], default ‘FLOAT’

    interpolation\_type[#](#bpy.types.ShaderNodeMapRange.interpolation_type "Link to this definition")
    :   Type:
        :   enum in [Node Map Range Items](../../../appendix/bpy_types_enum_items/node_map_range_items.md#rna-enum-node-map-range-items), default ‘LINEAR’

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.ShaderNodeMapRange.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.ShaderNodeMapRange.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.ShaderNodeMapRange.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.ShaderNodeMapRange.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.ShaderNodeMapRange.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ShaderNodeMapRange.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.ShaderNodeMapRange.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ShaderNodeMapRange(ShaderNode)
  + [`ShaderNodeMapRange`](#bpy.types.ShaderNodeMapRange)
    - [`ShaderNodeMapRange.clamp`](#bpy.types.ShaderNodeMapRange.clamp)
    - [`ShaderNodeMapRange.data_type`](#bpy.types.ShaderNodeMapRange.data_type)
    - [`ShaderNodeMapRange.interpolation_type`](#bpy.types.ShaderNodeMapRange.interpolation_type)
    - [`ShaderNodeMapRange.is_registered_node_type()`](#bpy.types.ShaderNodeMapRange.is_registered_node_type)
    - [`ShaderNodeMapRange.input_template()`](#bpy.types.ShaderNodeMapRange.input_template)
    - [`ShaderNodeMapRange.output_template()`](#bpy.types.ShaderNodeMapRange.output_template)
    - [`ShaderNodeMapRange.bl_rna_get_subclass()`](#bpy.types.ShaderNodeMapRange.bl_rna_get_subclass)
    - [`ShaderNodeMapRange.bl_rna_get_subclass_py()`](#bpy.types.ShaderNodeMapRange.bl_rna_get_subclass_py)
