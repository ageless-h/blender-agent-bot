...
# ShaderNodeVectorTransform(ShaderNode)[#](#shadernodevectortransform-shadernode "Link to this heading")
...
*class* bpy.types.ShaderNodeVectorTransform(*ShaderNode*)[#](#bpy.types.ShaderNodeVectorTransform "Link to this definition")
:   Convert a vector, point, or normal between world, camera, and object coordinate space

    convert\_from[#](#bpy.types.ShaderNodeVectorTransform.convert_from "Link to this definition")
    :   Space to convert from

        Type:
        :   enum in [‘WORLD’, ‘OBJECT’, ‘CAMERA’], default ‘WORLD’

    convert\_to[#](#bpy.types.ShaderNodeVectorTransform.convert_to "Link to this definition")
    :   Space to convert to

        Type:
        :   enum in [‘WORLD’, ‘OBJECT’, ‘CAMERA’], default ‘WORLD’

    vector\_type[#](#bpy.types.ShaderNodeVectorTransform.vector_type "Link to this definition")
    :   * `POINT`
    ...
    *classmethod* is\_registered\_node\_type()[#](#bpy.types.ShaderNodeVectorTransform.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.ShaderNodeVectorTransform.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.ShaderNodeVectorTransform.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.ShaderNodeVectorTransform.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.ShaderNodeVectorTransform.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ShaderNodeVectorTransform.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.ShaderNodeVectorTransform.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ShaderNodeVectorTransform(ShaderNode)
  + [`ShaderNodeVectorTransform`](#bpy.types.ShaderNodeVectorTransform)
    - [`ShaderNodeVectorTransform.convert_from`](#bpy.types.ShaderNodeVectorTransform.convert_from)
    - [`ShaderNodeVectorTransform.convert_to`](#bpy.types.ShaderNodeVectorTransform.convert_to)
    - [`ShaderNodeVectorTransform.vector_type`](#bpy.types.ShaderNodeVectorTransform.vector_type)
    - [`ShaderNodeVectorTransform.is_registered_node_type()`](#bpy.types.ShaderNodeVectorTransform.is_registered_node_type)
    - [`ShaderNodeVectorTransform.input_template()`](#bpy.types.ShaderNodeVectorTransform.input_template)
    - [`ShaderNodeVectorTransform.output_template()`](#bpy.types.ShaderNodeVectorTransform.output_template)
    - [`ShaderNodeVectorTransform.bl_rna_get_subclass()`](#bpy.types.ShaderNodeVectorTransform.bl_rna_get_subclass)
    - [`ShaderNodeVectorTransform.bl_rna_get_subclass_py()`](#bpy.types.ShaderNodeVectorTransform.bl_rna_get_subclass_py)
