...
# GeometryNodeCurveHandleTypeSelection(GeometryNode)[#](#geometrynodecurvehandletypeselection-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeCurveHandleTypeSelection(*GeometryNode*)[#](#bpy.types.GeometryNodeCurveHandleTypeSelection "Link to this definition")
:   Provide a selection based on the handle types of Bézier control points

    handle\_type[#](#bpy.types.GeometryNodeCurveHandleTypeSelection.handle_type "Link to this definition")
    :   * `FREE`
        ...
        * `ALIGN`
        ...
        Type:
        :   enum in [‘FREE’, ‘AUTO’, ‘VECTOR’, ‘ALIGN’], default ‘FREE’

    mode[#](#bpy.types.GeometryNodeCurveHandleTypeSelection.mode "Link to this definition")
    :   Whether to check the type of left and right handles

        Type:
        :   enum set in [Node Geometry Curve Handle Side Items](../../../appendix/bpy_types_enum_items/node_geometry_curve_handle_side_items.md#rna-enum-node-geometry-curve-handle-side-items), default {‘LEFT’}

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.GeometryNodeCurveHandleTypeSelection.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.GeometryNodeCurveHandleTypeSelection.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.GeometryNodeCurveHandleTypeSelection.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.GeometryNodeCurveHandleTypeSelection.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.GeometryNodeCurveHandleTypeSelection.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeCurveHandleTypeSelection.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.GeometryNodeCurveHandleTypeSelection.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeCurveHandleTypeSelection(GeometryNode)
  + [`GeometryNodeCurveHandleTypeSelection`](#bpy.types.GeometryNodeCurveHandleTypeSelection)
    - [`GeometryNodeCurveHandleTypeSelection.handle_type`](#bpy.types.GeometryNodeCurveHandleTypeSelection.handle_type)
    - [`GeometryNodeCurveHandleTypeSelection.mode`](#bpy.types.GeometryNodeCurveHandleTypeSelection.mode)
    - [`GeometryNodeCurveHandleTypeSelection.is_registered_node_type()`](#bpy.types.GeometryNodeCurveHandleTypeSelection.is_registered_node_type)
    - [`GeometryNodeCurveHandleTypeSelection.input_template()`](#bpy.types.GeometryNodeCurveHandleTypeSelection.input_template)
    - [`GeometryNodeCurveHandleTypeSelection.output_template()`](#bpy.types.GeometryNodeCurveHandleTypeSelection.output_template)
    - [`GeometryNodeCurveHandleTypeSelection.bl_rna_get_subclass()`](#bpy.types.GeometryNodeCurveHandleTypeSelection.bl_rna_get_subclass)
    - [`GeometryNodeCurveHandleTypeSelection.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeCurveHandleTypeSelection.bl_rna_get_subclass_py)
