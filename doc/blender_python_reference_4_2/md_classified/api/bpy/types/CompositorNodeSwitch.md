...
# CompositorNodeSwitch(CompositorNode)[#](#compositornodeswitch-compositornode "Link to this heading")
...
*class* bpy.types.CompositorNodeSwitch(*CompositorNode*)[#](#bpy.types.CompositorNodeSwitch "Link to this definition")
:   Switch between two images using a checkbox

    check[#](#bpy.types.CompositorNodeSwitch.check "Link to this definition")
    :   Off: first socket, On: second socket

        Type:
        :   boolean, default False

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.CompositorNodeSwitch.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.CompositorNodeSwitch.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.CompositorNodeSwitch.output_template "Link to this definition")
    ...
    update()[#](#bpy.types.CompositorNodeSwitch.update "Link to this definition")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.CompositorNodeSwitch.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.CompositorNodeSwitch.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CompositorNodeSwitch.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.CompositorNodeSwitch.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CompositorNodeSwitch(CompositorNode)
  + [`CompositorNodeSwitch`](#bpy.types.CompositorNodeSwitch)
    - [`CompositorNodeSwitch.check`](#bpy.types.CompositorNodeSwitch.check)
    - [`CompositorNodeSwitch.is_registered_node_type()`](#bpy.types.CompositorNodeSwitch.is_registered_node_type)
    - [`CompositorNodeSwitch.input_template()`](#bpy.types.CompositorNodeSwitch.input_template)
    - [`CompositorNodeSwitch.output_template()`](#bpy.types.CompositorNodeSwitch.output_template)
    - [`CompositorNodeSwitch.update()`](#bpy.types.CompositorNodeSwitch.update)
    - [`CompositorNodeSwitch.bl_rna_get_subclass()`](#bpy.types.CompositorNodeSwitch.bl_rna_get_subclass)
    - [`CompositorNodeSwitch.bl_rna_get_subclass_py()`](#bpy.types.CompositorNodeSwitch.bl_rna_get_subclass_py)
