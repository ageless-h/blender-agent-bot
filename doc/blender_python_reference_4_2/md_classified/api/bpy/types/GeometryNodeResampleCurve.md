...
# GeometryNodeResampleCurve(GeometryNode)[#](#geometrynoderesamplecurve-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeResampleCurve(*GeometryNode*)[#](#bpy.types.GeometryNodeResampleCurve "Link to this definition")
:   Generate a poly spline for each input spline

    mode[#](#bpy.types.GeometryNodeResampleCurve.mode "Link to this definition")
    :   How to specify the amount of samples

        * `EVALUATED`
          Evaluated – Output the input spline’s evaluated points, based on the resolution attribute for NURBS and Bézier splines. Poly splines are unchanged.
        * `COUNT`
        ...
        * `LENGTH`
        ...
        Type:
        :   enum in [‘EVALUATED’, ‘COUNT’, ‘LENGTH’], default ‘COUNT’

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.GeometryNodeResampleCurve.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.GeometryNodeResampleCurve.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.GeometryNodeResampleCurve.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.GeometryNodeResampleCurve.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.GeometryNodeResampleCurve.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeResampleCurve.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.GeometryNodeResampleCurve.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeResampleCurve(GeometryNode)
  + [`GeometryNodeResampleCurve`](#bpy.types.GeometryNodeResampleCurve)
    - [`GeometryNodeResampleCurve.mode`](#bpy.types.GeometryNodeResampleCurve.mode)
    - [`GeometryNodeResampleCurve.is_registered_node_type()`](#bpy.types.GeometryNodeResampleCurve.is_registered_node_type)
    - [`GeometryNodeResampleCurve.input_template()`](#bpy.types.GeometryNodeResampleCurve.input_template)
    - [`GeometryNodeResampleCurve.output_template()`](#bpy.types.GeometryNodeResampleCurve.output_template)
    - [`GeometryNodeResampleCurve.bl_rna_get_subclass()`](#bpy.types.GeometryNodeResampleCurve.bl_rna_get_subclass)
    - [`GeometryNodeResampleCurve.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeResampleCurve.bl_rna_get_subclass_py)
