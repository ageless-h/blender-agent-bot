...
# ShaderNodeTexVoronoi(ShaderNode)[#](#shadernodetexvoronoi-shadernode "Link to this heading")
...
*class* bpy.types.ShaderNodeTexVoronoi(*ShaderNode*)[#](#bpy.types.ShaderNodeTexVoronoi "Link to this definition")
:   Generate Worley noise based on the distance to random points. Typically used to generate textures such as stones, water, or biological cells
    ...
    color\_mapping[#](#bpy.types.ShaderNodeTexVoronoi.color_mapping "Link to this definition")
    :   Color mapping settings

        Type:
        :   [`ColorMapping`](ColorMapping.md#bpy.types.ColorMapping "bpy.types.ColorMapping"), (readonly, never None)

    distance[#](#bpy.types.ShaderNodeTexVoronoi.distance "Link to this definition")
    ...
    feature[#](#bpy.types.ShaderNodeTexVoronoi.feature "Link to this definition")
    :   The Voronoi feature that the node will compute
        ...
        * `N_SPHERE_RADIUS`
        ...
        Type:
        :   enum in [‘F1’, ‘F2’, ‘SMOOTH\_F1’, ‘DISTANCE\_TO\_EDGE’, ‘N\_SPHERE\_RADIUS’], default ‘F1’

    normalize[#](#bpy.types.ShaderNodeTexVoronoi.normalize "Link to this definition")
    :   Normalize output Distance to 0.0 to 1.0 range

        Type:
        :   boolean, default False

    texture\_mapping[#](#bpy.types.ShaderNodeTexVoronoi.texture_mapping "Link to this definition")
    :   Texture coordinate mapping settings

        Type:
        :   [`TexMapping`](TexMapping.md#bpy.types.TexMapping "bpy.types.TexMapping"), (readonly, never None)

    voronoi\_dimensions[#](#bpy.types.ShaderNodeTexVoronoi.voronoi_dimensions "Link to this definition")
    ...
    *classmethod* is\_registered\_node\_type()[#](#bpy.types.ShaderNodeTexVoronoi.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.ShaderNodeTexVoronoi.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.ShaderNodeTexVoronoi.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.ShaderNodeTexVoronoi.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.ShaderNodeTexVoronoi.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ShaderNodeTexVoronoi.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.ShaderNodeTexVoronoi.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ShaderNodeTexVoronoi(ShaderNode)
  + [`ShaderNodeTexVoronoi`](#bpy.types.ShaderNodeTexVoronoi)
    - [`ShaderNodeTexVoronoi.color_mapping`](#bpy.types.ShaderNodeTexVoronoi.color_mapping)
    - [`ShaderNodeTexVoronoi.distance`](#bpy.types.ShaderNodeTexVoronoi.distance)
    - [`ShaderNodeTexVoronoi.feature`](#bpy.types.ShaderNodeTexVoronoi.feature)
    - [`ShaderNodeTexVoronoi.normalize`](#bpy.types.ShaderNodeTexVoronoi.normalize)
    - [`ShaderNodeTexVoronoi.texture_mapping`](#bpy.types.ShaderNodeTexVoronoi.texture_mapping)
    - [`ShaderNodeTexVoronoi.voronoi_dimensions`](#bpy.types.ShaderNodeTexVoronoi.voronoi_dimensions)
    - [`ShaderNodeTexVoronoi.is_registered_node_type()`](#bpy.types.ShaderNodeTexVoronoi.is_registered_node_type)
    - [`ShaderNodeTexVoronoi.input_template()`](#bpy.types.ShaderNodeTexVoronoi.input_template)
    - [`ShaderNodeTexVoronoi.output_template()`](#bpy.types.ShaderNodeTexVoronoi.output_template)
    - [`ShaderNodeTexVoronoi.bl_rna_get_subclass()`](#bpy.types.ShaderNodeTexVoronoi.bl_rna_get_subclass)
    - [`ShaderNodeTexVoronoi.bl_rna_get_subclass_py()`](#bpy.types.ShaderNodeTexVoronoi.bl_rna_get_subclass_py)
