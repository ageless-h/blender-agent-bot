...
# CompositorNodeImage(CompositorNode)[#](#compositornodeimage-compositornode "Link to this heading")
...
*class* bpy.types.CompositorNodeImage(*CompositorNode*)[#](#bpy.types.CompositorNodeImage "Link to this definition")
:   Input image or movie file

    frame\_duration[#](#bpy.types.CompositorNodeImage.frame_duration "Link to this definition")
    :   Number of images of a movie to use

        Type:
        :   int in [0, 1048574], default 0

    frame\_offset[#](#bpy.types.CompositorNodeImage.frame_offset "Link to this definition")
    :   Offset the number of the frame to use in the animation

        Type:
        :   int in [-1048574, 1048574], default 0

    frame\_start[#](#bpy.types.CompositorNodeImage.frame_start "Link to this definition")
    :   Global starting frame of the movie/sequence, assuming first picture has a #1

        Type:
        :   int in [-1048574, 1048574], default 0

    has\_layers[#](#bpy.types.CompositorNodeImage.has_layers "Link to this definition")
    :   True if this image has any named layer

        Type:
        :   boolean, default False, (readonly)

    has\_views[#](#bpy.types.CompositorNodeImage.has_views "Link to this definition")
    :   True if this image has multiple views

        Type:
        :   boolean, default False, (readonly)

    image[#](#bpy.types.CompositorNodeImage.image "Link to this definition")
    :   Type:
        :   [`Image`](Image.md#bpy.types.Image "bpy.types.Image")

    layer[#](#bpy.types.CompositorNodeImage.layer "Link to this definition")
    :   Type:
        :   enum in [‘PLACEHOLDER’], default ‘PLACEHOLDER’

    use\_auto\_refresh[#](#bpy.types.CompositorNodeImage.use_auto_refresh "Link to this definition")
    :   Always refresh image on frame changes

        Type:
        :   boolean, default False

    use\_cyclic[#](#bpy.types.CompositorNodeImage.use_cyclic "Link to this definition")
    :   Cycle the images in the movie

        Type:
        :   boolean, default False

    use\_straight\_alpha\_output[#](#bpy.types.CompositorNodeImage.use_straight_alpha_output "Link to this definition")
    :   Put node output buffer to straight alpha instead of premultiplied

        Type:
        :   boolean, default False

    view[#](#bpy.types.CompositorNodeImage.view "Link to this definition")
    :   Type:
        :   enum in [‘ALL’], default ‘ALL’

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.CompositorNodeImage.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.CompositorNodeImage.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.CompositorNodeImage.output_template "Link to this definition")
    ...
    update()[#](#bpy.types.CompositorNodeImage.update "Link to this definition")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.CompositorNodeImage.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.CompositorNodeImage.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CompositorNodeImage.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.CompositorNodeImage.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CompositorNodeImage(CompositorNode)
  + [`CompositorNodeImage`](#bpy.types.CompositorNodeImage)
    - [`CompositorNodeImage.frame_duration`](#bpy.types.CompositorNodeImage.frame_duration)
    - [`CompositorNodeImage.frame_offset`](#bpy.types.CompositorNodeImage.frame_offset)
    - [`CompositorNodeImage.frame_start`](#bpy.types.CompositorNodeImage.frame_start)
    - [`CompositorNodeImage.has_layers`](#bpy.types.CompositorNodeImage.has_layers)
    - [`CompositorNodeImage.has_views`](#bpy.types.CompositorNodeImage.has_views)
    - [`CompositorNodeImage.image`](#bpy.types.CompositorNodeImage.image)
    - [`CompositorNodeImage.layer`](#bpy.types.CompositorNodeImage.layer)
    - [`CompositorNodeImage.use_auto_refresh`](#bpy.types.CompositorNodeImage.use_auto_refresh)
    - [`CompositorNodeImage.use_cyclic`](#bpy.types.CompositorNodeImage.use_cyclic)
    - [`CompositorNodeImage.use_straight_alpha_output`](#bpy.types.CompositorNodeImage.use_straight_alpha_output)
    - [`CompositorNodeImage.view`](#bpy.types.CompositorNodeImage.view)
    - [`CompositorNodeImage.is_registered_node_type()`](#bpy.types.CompositorNodeImage.is_registered_node_type)
    - [`CompositorNodeImage.input_template()`](#bpy.types.CompositorNodeImage.input_template)
    - [`CompositorNodeImage.output_template()`](#bpy.types.CompositorNodeImage.output_template)
    - [`CompositorNodeImage.update()`](#bpy.types.CompositorNodeImage.update)
    - [`CompositorNodeImage.bl_rna_get_subclass()`](#bpy.types.CompositorNodeImage.bl_rna_get_subclass)
    - [`CompositorNodeImage.bl_rna_get_subclass_py()`](#bpy.types.CompositorNodeImage.bl_rna_get_subclass_py)
