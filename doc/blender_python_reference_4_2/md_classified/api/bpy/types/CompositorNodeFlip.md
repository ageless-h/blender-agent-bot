...
# CompositorNodeFlip(CompositorNode)[#](#compositornodeflip-compositornode "Link to this heading")
...
*class* bpy.types.CompositorNodeFlip(*CompositorNode*)[#](#bpy.types.CompositorNodeFlip "Link to this definition")
:   Flip an image along a defined axis

    axis[#](#bpy.types.CompositorNodeFlip.axis "Link to this definition")
    :   Type:
        :   enum in [‘X’, ‘Y’, ‘XY’], default ‘X’

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.CompositorNodeFlip.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.CompositorNodeFlip.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.CompositorNodeFlip.output_template "Link to this definition")
    ...
    update()[#](#bpy.types.CompositorNodeFlip.update "Link to this definition")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.CompositorNodeFlip.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.CompositorNodeFlip.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CompositorNodeFlip.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.CompositorNodeFlip.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CompositorNodeFlip(CompositorNode)
  + [`CompositorNodeFlip`](#bpy.types.CompositorNodeFlip)
    - [`CompositorNodeFlip.axis`](#bpy.types.CompositorNodeFlip.axis)
    - [`CompositorNodeFlip.is_registered_node_type()`](#bpy.types.CompositorNodeFlip.is_registered_node_type)
    - [`CompositorNodeFlip.input_template()`](#bpy.types.CompositorNodeFlip.input_template)
    - [`CompositorNodeFlip.output_template()`](#bpy.types.CompositorNodeFlip.output_template)
    - [`CompositorNodeFlip.update()`](#bpy.types.CompositorNodeFlip.update)
    - [`CompositorNodeFlip.bl_rna_get_subclass()`](#bpy.types.CompositorNodeFlip.bl_rna_get_subclass)
    - [`CompositorNodeFlip.bl_rna_get_subclass_py()`](#bpy.types.CompositorNodeFlip.bl_rna_get_subclass_py)
