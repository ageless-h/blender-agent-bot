...
# GpencilVertexGroupElement(bpy\_struct)[#](#gpencilvertexgroupelement-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.GpencilVertexGroupElement(*bpy\_struct*)[#](#bpy.types.GpencilVertexGroupElement "Link to this definition")
:   Weight value of a vertex in a vertex group

    group[#](#bpy.types.GpencilVertexGroupElement.group "Link to this definition")
    :   Type:
        :   int in [0, inf], default 0, (readonly)

    weight[#](#bpy.types.GpencilVertexGroupElement.weight "Link to this definition")
    :   Vertex Weight

        Type:
        :   float in [0, 1], default 0.0

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.GpencilVertexGroupElement.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.GpencilVertexGroupElement.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GpencilVertexGroupElement.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.GpencilVertexGroupElement.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GpencilVertexGroupElement(bpy\_struct)
  + [`GpencilVertexGroupElement`](#bpy.types.GpencilVertexGroupElement)
    - [`GpencilVertexGroupElement.group`](#bpy.types.GpencilVertexGroupElement.group)
    - [`GpencilVertexGroupElement.weight`](#bpy.types.GpencilVertexGroupElement.weight)
    - [`GpencilVertexGroupElement.bl_rna_get_subclass()`](#bpy.types.GpencilVertexGroupElement.bl_rna_get_subclass)
    - [`GpencilVertexGroupElement.bl_rna_get_subclass_py()`](#bpy.types.GpencilVertexGroupElement.bl_rna_get_subclass_py)
