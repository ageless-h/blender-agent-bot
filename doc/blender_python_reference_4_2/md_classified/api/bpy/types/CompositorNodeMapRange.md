...
# CompositorNodeMapRange(CompositorNode)[#](#compositornodemaprange-compositornode "Link to this heading")
...
*class* bpy.types.CompositorNodeMapRange(*CompositorNode*)[#](#bpy.types.CompositorNodeMapRange "Link to this definition")
:   Map an input value range into a destination range

    use\_clamp[#](#bpy.types.CompositorNodeMapRange.use_clamp "Link to this definition")
    :   Clamp the result of the node to the target range

        Type:
        :   boolean, default False

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.CompositorNodeMapRange.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.CompositorNodeMapRange.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.CompositorNodeMapRange.output_template "Link to this definition")
    ...
    update()[#](#bpy.types.CompositorNodeMapRange.update "Link to this definition")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.CompositorNodeMapRange.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.CompositorNodeMapRange.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CompositorNodeMapRange.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.CompositorNodeMapRange.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CompositorNodeMapRange(CompositorNode)
  + [`CompositorNodeMapRange`](#bpy.types.CompositorNodeMapRange)
    - [`CompositorNodeMapRange.use_clamp`](#bpy.types.CompositorNodeMapRange.use_clamp)
    - [`CompositorNodeMapRange.is_registered_node_type()`](#bpy.types.CompositorNodeMapRange.is_registered_node_type)
    - [`CompositorNodeMapRange.input_template()`](#bpy.types.CompositorNodeMapRange.input_template)
    - [`CompositorNodeMapRange.output_template()`](#bpy.types.CompositorNodeMapRange.output_template)
    - [`CompositorNodeMapRange.update()`](#bpy.types.CompositorNodeMapRange.update)
    - [`CompositorNodeMapRange.bl_rna_get_subclass()`](#bpy.types.CompositorNodeMapRange.bl_rna_get_subclass)
    - [`CompositorNodeMapRange.bl_rna_get_subclass_py()`](#bpy.types.CompositorNodeMapRange.bl_rna_get_subclass_py)
