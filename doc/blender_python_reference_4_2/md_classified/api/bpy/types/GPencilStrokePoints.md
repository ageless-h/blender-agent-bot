...
# GPencilStrokePoints(bpy\_struct)[#](#gpencilstrokepoints-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.GPencilStrokePoints(*bpy\_struct*)[#](#bpy.types.GPencilStrokePoints "Link to this definition")
:   Collection of grease pencil stroke points

    add(*count*, *pressure=1.0*, *strength=1.0*)[#](#bpy.types.GPencilStrokePoints.add "Link to this definition")
    :   Add a new grease pencil stroke point

        Parameters:
        :   * **count** (*int in* *[**0**,* *inf**]*) – Number, Number of points to add to the stroke
            * **pressure** (*float in* *[**0**,* *inf**]**,* *(**optional**)*) – Pressure, Pressure for newly created points
            * **strength** (*float in* *[**0**,* *1**]**,* *(**optional**)*) – Strength, Color intensity (alpha factor) for newly created points

    pop(*index=-1*)[#](#bpy.types.GPencilStrokePoints.pop "Link to this definition")
    :   Remove a grease pencil stroke point

        Parameters:
        :   **index** (*int in* *[**-inf**,* *inf**]**,* *(**optional**)*) – Index, point index

    update()[#](#bpy.types.GPencilStrokePoints.update "Link to this definition")
    :   Recalculate internal triangulation data

    weight\_get(*vertex\_group\_index=0*, *point\_index=0*)[#](#bpy.types.GPencilStrokePoints.weight_get "Link to this definition")
    :   Get vertex group point weight

        Parameters:
        :   * **vertex\_group\_index** (*int in* *[**0**,* *inf**]**,* *(**optional**)*) – Vertex Group Index, Index of Vertex Group in the array of groups
            * **point\_index** (*int in* *[**0**,* *inf**]**,* *(**optional**)*) – Point Index, Index of the Point in the array
    ...
    weight\_set(*vertex\_group\_index=0*, *point\_index=0*, *weight=0.0*)[#](#bpy.types.GPencilStrokePoints.weight_set "Link to this definition")
    :   Set vertex group point weight

        Parameters:
        :   * **vertex\_group\_index** (*int in* *[**0**,* *inf**]**,* *(**optional**)*) – Vertex Group Index, Index of Vertex Group in the array of groups
            * **point\_index** (*int in* *[**0**,* *inf**]**,* *(**optional**)*) – Point Index, Index of the Point in the array
            * **weight** (*float in* *[**-inf**,* *inf**]**,* *(**optional**)*) – Weight, Point Weight

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.GPencilStrokePoints.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.GPencilStrokePoints.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`GPencilStroke.points`](GPencilStroke.md#bpy.types.GPencilStroke.points "bpy.types.GPencilStroke.points") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GPencilStrokePoints.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.GPencilStrokePoints.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GPencilStrokePoints(bpy\_struct)
  + [`GPencilStrokePoints`](#bpy.types.GPencilStrokePoints)
    - [`GPencilStrokePoints.add()`](#bpy.types.GPencilStrokePoints.add)
    - [`GPencilStrokePoints.pop()`](#bpy.types.GPencilStrokePoints.pop)
    - [`GPencilStrokePoints.update()`](#bpy.types.GPencilStrokePoints.update)
    - [`GPencilStrokePoints.weight_get()`](#bpy.types.GPencilStrokePoints.weight_get)
    - [`GPencilStrokePoints.weight_set()`](#bpy.types.GPencilStrokePoints.weight_set)
    - [`GPencilStrokePoints.bl_rna_get_subclass()`](#bpy.types.GPencilStrokePoints.bl_rna_get_subclass)
    - [`GPencilStrokePoints.bl_rna_get_subclass_py()`](#bpy.types.GPencilStrokePoints.bl_rna_get_subclass_py)
