...
# ThickGpencilModifier(GpencilModifier)[#](#thickgpencilmodifier-gpencilmodifier "Link to this heading")
...
*class* bpy.types.ThickGpencilModifier(*GpencilModifier*)[#](#bpy.types.ThickGpencilModifier "Link to this definition")
:   Subdivide and Smooth Stroke modifier

    curve[#](#bpy.types.ThickGpencilModifier.curve "Link to this definition")
    :   Custom curve to apply effect

        Type:
        :   [`CurveMapping`](CurveMapping.md#bpy.types.CurveMapping "bpy.types.CurveMapping"), (readonly)

    invert\_layer\_pass[#](#bpy.types.ThickGpencilModifier.invert_layer_pass "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    invert\_layers[#](#bpy.types.ThickGpencilModifier.invert_layers "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    invert\_material\_pass[#](#bpy.types.ThickGpencilModifier.invert_material_pass "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    invert\_materials[#](#bpy.types.ThickGpencilModifier.invert_materials "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    invert\_vertex[#](#bpy.types.ThickGpencilModifier.invert_vertex "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    layer[#](#bpy.types.ThickGpencilModifier.layer "Link to this definition")
    :   Layer name

        Type:
        :   string, default “”, (never None)

    layer\_pass[#](#bpy.types.ThickGpencilModifier.layer_pass "Link to this definition")
    :   Layer pass index

        Type:
        :   int in [0, 100], default 0

    material[#](#bpy.types.ThickGpencilModifier.material "Link to this definition")
    :   Material used for filtering effect

        Type:
        :   [`Material`](Material.md#bpy.types.Material "bpy.types.Material")

    pass\_index[#](#bpy.types.ThickGpencilModifier.pass_index "Link to this definition")
    :   Pass index

        Type:
        :   int in [0, 100], default 0

    thickness[#](#bpy.types.ThickGpencilModifier.thickness "Link to this definition")
    :   Absolute thickness to apply everywhere

        Type:
        :   int in [-100, 500], default 30

    thickness\_factor[#](#bpy.types.ThickGpencilModifier.thickness_factor "Link to this definition")
    :   Factor to multiply the thickness with

        Type:
        :   float in [0, inf], default 1.0

    use\_custom\_curve[#](#bpy.types.ThickGpencilModifier.use_custom_curve "Link to this definition")
    :   Use a custom curve to define thickness change along the strokes

        Type:
        :   boolean, default False

    use\_normalized\_thickness[#](#bpy.types.ThickGpencilModifier.use_normalized_thickness "Link to this definition")
    :   Replace the stroke thickness

        Type:
        :   boolean, default False

    use\_weight\_factor[#](#bpy.types.ThickGpencilModifier.use_weight_factor "Link to this definition")
    :   Use weight to modulate effect

        Type:
        :   boolean, default False

    vertex\_group[#](#bpy.types.ThickGpencilModifier.vertex_group "Link to this definition")
    :   Vertex group name for modulating the deform

        Type:
        :   string, default “”, (never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.ThickGpencilModifier.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.ThickGpencilModifier.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ThickGpencilModifier.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.ThickGpencilModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ThickGpencilModifier(GpencilModifier)
  + [`ThickGpencilModifier`](#bpy.types.ThickGpencilModifier)
    - [`ThickGpencilModifier.curve`](#bpy.types.ThickGpencilModifier.curve)
    - [`ThickGpencilModifier.invert_layer_pass`](#bpy.types.ThickGpencilModifier.invert_layer_pass)
    - [`ThickGpencilModifier.invert_layers`](#bpy.types.ThickGpencilModifier.invert_layers)
    - [`ThickGpencilModifier.invert_material_pass`](#bpy.types.ThickGpencilModifier.invert_material_pass)
    - [`ThickGpencilModifier.invert_materials`](#bpy.types.ThickGpencilModifier.invert_materials)
    - [`ThickGpencilModifier.invert_vertex`](#bpy.types.ThickGpencilModifier.invert_vertex)
    - [`ThickGpencilModifier.layer`](#bpy.types.ThickGpencilModifier.layer)
    - [`ThickGpencilModifier.layer_pass`](#bpy.types.ThickGpencilModifier.layer_pass)
    - [`ThickGpencilModifier.material`](#bpy.types.ThickGpencilModifier.material)
    - [`ThickGpencilModifier.pass_index`](#bpy.types.ThickGpencilModifier.pass_index)
    - [`ThickGpencilModifier.thickness`](#bpy.types.ThickGpencilModifier.thickness)
    - [`ThickGpencilModifier.thickness_factor`](#bpy.types.ThickGpencilModifier.thickness_factor)
    - [`ThickGpencilModifier.use_custom_curve`](#bpy.types.ThickGpencilModifier.use_custom_curve)
    - [`ThickGpencilModifier.use_normalized_thickness`](#bpy.types.ThickGpencilModifier.use_normalized_thickness)
    - [`ThickGpencilModifier.use_weight_factor`](#bpy.types.ThickGpencilModifier.use_weight_factor)
    - [`ThickGpencilModifier.vertex_group`](#bpy.types.ThickGpencilModifier.vertex_group)
    - [`ThickGpencilModifier.bl_rna_get_subclass()`](#bpy.types.ThickGpencilModifier.bl_rna_get_subclass)
    - [`ThickGpencilModifier.bl_rna_get_subclass_py()`](#bpy.types.ThickGpencilModifier.bl_rna_get_subclass_py)
