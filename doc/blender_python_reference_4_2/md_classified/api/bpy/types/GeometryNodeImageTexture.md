...
# GeometryNodeImageTexture(GeometryNode)[#](#geometrynodeimagetexture-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeImageTexture(*GeometryNode*)[#](#bpy.types.GeometryNodeImageTexture "Link to this definition")
:   Sample values from an image texture

    extension[#](#bpy.types.GeometryNodeImageTexture.extension "Link to this definition")
    ...
    interpolation[#](#bpy.types.GeometryNodeImageTexture.interpolation "Link to this definition")
    :   Method for smoothing values between pixels
        ...
        * `Cubic`
        ...
        Type:
        :   enum in [‘Linear’, ‘Closest’, ‘Cubic’], default ‘Linear’

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.GeometryNodeImageTexture.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.GeometryNodeImageTexture.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.GeometryNodeImageTexture.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.GeometryNodeImageTexture.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.GeometryNodeImageTexture.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeImageTexture.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.GeometryNodeImageTexture.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeImageTexture(GeometryNode)
  + [`GeometryNodeImageTexture`](#bpy.types.GeometryNodeImageTexture)
    - [`GeometryNodeImageTexture.extension`](#bpy.types.GeometryNodeImageTexture.extension)
    - [`GeometryNodeImageTexture.interpolation`](#bpy.types.GeometryNodeImageTexture.interpolation)
    - [`GeometryNodeImageTexture.is_registered_node_type()`](#bpy.types.GeometryNodeImageTexture.is_registered_node_type)
    - [`GeometryNodeImageTexture.input_template()`](#bpy.types.GeometryNodeImageTexture.input_template)
    - [`GeometryNodeImageTexture.output_template()`](#bpy.types.GeometryNodeImageTexture.output_template)
    - [`GeometryNodeImageTexture.bl_rna_get_subclass()`](#bpy.types.GeometryNodeImageTexture.bl_rna_get_subclass)
    - [`GeometryNodeImageTexture.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeImageTexture.bl_rna_get_subclass_py)
