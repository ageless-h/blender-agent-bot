...
# DashGpencilModifierData(GpencilModifier)[#](#dashgpencilmodifierdata-gpencilmodifier "Link to this heading")
...
*class* bpy.types.DashGpencilModifierData(*GpencilModifier*)[#](#bpy.types.DashGpencilModifierData "Link to this definition")
:   Create dot-dash effect for strokes

    dash\_offset[#](#bpy.types.DashGpencilModifierData.dash_offset "Link to this definition")
    :   Offset into each stroke before the beginning of the dashed segment generation

        Type:
        :   int in [-inf, inf], default 0

    invert\_layer\_pass[#](#bpy.types.DashGpencilModifierData.invert_layer_pass "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    invert\_layers[#](#bpy.types.DashGpencilModifierData.invert_layers "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    invert\_material\_pass[#](#bpy.types.DashGpencilModifierData.invert_material_pass "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    invert\_materials[#](#bpy.types.DashGpencilModifierData.invert_materials "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    layer[#](#bpy.types.DashGpencilModifierData.layer "Link to this definition")
    :   Layer name

        Type:
        :   string, default “”, (never None)

    layer\_pass[#](#bpy.types.DashGpencilModifierData.layer_pass "Link to this definition")
    :   Layer pass index

        Type:
        :   int in [0, 100], default 0

    material[#](#bpy.types.DashGpencilModifierData.material "Link to this definition")
    :   Material used for filtering effect

        Type:
        :   [`Material`](Material.md#bpy.types.Material "bpy.types.Material")

    pass\_index[#](#bpy.types.DashGpencilModifierData.pass_index "Link to this definition")
    :   Pass index

        Type:
        :   int in [0, 100], default 0

    segment\_active\_index[#](#bpy.types.DashGpencilModifierData.segment_active_index "Link to this definition")
    :   Active index in the segment list

        Type:
        :   int in [0, inf], default 0

    segments[#](#bpy.types.DashGpencilModifierData.segments "Link to this definition")
    :   Type:
        :   [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`DashGpencilModifierSegment`](DashGpencilModifierSegment.md#bpy.types.DashGpencilModifierSegment "bpy.types.DashGpencilModifierSegment"), (readonly)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.DashGpencilModifierData.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.DashGpencilModifierData.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.DashGpencilModifierData.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.DashGpencilModifierData.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* DashGpencilModifierData(GpencilModifier)
  + [`DashGpencilModifierData`](#bpy.types.DashGpencilModifierData)
    - [`DashGpencilModifierData.dash_offset`](#bpy.types.DashGpencilModifierData.dash_offset)
    - [`DashGpencilModifierData.invert_layer_pass`](#bpy.types.DashGpencilModifierData.invert_layer_pass)
    - [`DashGpencilModifierData.invert_layers`](#bpy.types.DashGpencilModifierData.invert_layers)
    - [`DashGpencilModifierData.invert_material_pass`](#bpy.types.DashGpencilModifierData.invert_material_pass)
    - [`DashGpencilModifierData.invert_materials`](#bpy.types.DashGpencilModifierData.invert_materials)
    - [`DashGpencilModifierData.layer`](#bpy.types.DashGpencilModifierData.layer)
    - [`DashGpencilModifierData.layer_pass`](#bpy.types.DashGpencilModifierData.layer_pass)
    - [`DashGpencilModifierData.material`](#bpy.types.DashGpencilModifierData.material)
    - [`DashGpencilModifierData.pass_index`](#bpy.types.DashGpencilModifierData.pass_index)
    - [`DashGpencilModifierData.segment_active_index`](#bpy.types.DashGpencilModifierData.segment_active_index)
    - [`DashGpencilModifierData.segments`](#bpy.types.DashGpencilModifierData.segments)
    - [`DashGpencilModifierData.bl_rna_get_subclass()`](#bpy.types.DashGpencilModifierData.bl_rna_get_subclass)
    - [`DashGpencilModifierData.bl_rna_get_subclass_py()`](#bpy.types.DashGpencilModifierData.bl_rna_get_subclass_py)
