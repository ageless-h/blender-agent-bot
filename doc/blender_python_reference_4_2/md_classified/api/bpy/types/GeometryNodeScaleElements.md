...
# GeometryNodeScaleElements(GeometryNode)[#](#geometrynodescaleelements-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeScaleElements(*GeometryNode*)[#](#bpy.types.GeometryNodeScaleElements "Link to this definition")
:   Scale groups of connected edges and faces

    domain[#](#bpy.types.GeometryNodeScaleElements.domain "Link to this definition")
    :   Element type to transform
        ...
        * `EDGE`
        ...
        Type:
        :   enum in [‘FACE’, ‘EDGE’], default ‘FACE’

    scale\_mode[#](#bpy.types.GeometryNodeScaleElements.scale_mode "Link to this definition")
    :   * `UNIFORM`
        ...
        * `SINGLE_AXIS`
        ...
        Type:
        :   enum in [‘UNIFORM’, ‘SINGLE\_AXIS’], default ‘UNIFORM’

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.GeometryNodeScaleElements.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.GeometryNodeScaleElements.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.GeometryNodeScaleElements.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.GeometryNodeScaleElements.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.GeometryNodeScaleElements.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeScaleElements.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.GeometryNodeScaleElements.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeScaleElements(GeometryNode)
  + [`GeometryNodeScaleElements`](#bpy.types.GeometryNodeScaleElements)
    - [`GeometryNodeScaleElements.domain`](#bpy.types.GeometryNodeScaleElements.domain)
    - [`GeometryNodeScaleElements.scale_mode`](#bpy.types.GeometryNodeScaleElements.scale_mode)
    - [`GeometryNodeScaleElements.is_registered_node_type()`](#bpy.types.GeometryNodeScaleElements.is_registered_node_type)
    - [`GeometryNodeScaleElements.input_template()`](#bpy.types.GeometryNodeScaleElements.input_template)
    - [`GeometryNodeScaleElements.output_template()`](#bpy.types.GeometryNodeScaleElements.output_template)
    - [`GeometryNodeScaleElements.bl_rna_get_subclass()`](#bpy.types.GeometryNodeScaleElements.bl_rna_get_subclass)
    - [`GeometryNodeScaleElements.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeScaleElements.bl_rna_get_subclass_py)
