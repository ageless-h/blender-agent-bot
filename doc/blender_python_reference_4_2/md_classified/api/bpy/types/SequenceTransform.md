...
# SequenceTransform(bpy\_struct)[#](#sequencetransform-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.SequenceTransform(*bpy\_struct*)[#](#bpy.types.SequenceTransform "Link to this definition")
:   Transform parameters for a sequence strip

    filter[#](#bpy.types.SequenceTransform.filter "Link to this definition")
    :   Type of filter to use for image transformation
        ...
        * `BOX`
        ...
        Type:
        :   enum in [‘AUTO’, ‘NEAREST’, ‘BILINEAR’, ‘CUBIC\_MITCHELL’, ‘CUBIC\_BSPLINE’, ‘BOX’], default ‘AUTO’

    offset\_x[#](#bpy.types.SequenceTransform.offset_x "Link to this definition")
    :   Move along X axis

        Type:
        :   float in [-inf, inf], default 0.0

    offset\_y[#](#bpy.types.SequenceTransform.offset_y "Link to this definition")
    :   Move along Y axis

        Type:
        :   float in [-inf, inf], default 0.0

    origin[#](#bpy.types.SequenceTransform.origin "Link to this definition")
    :   Origin of image for transformation

        Type:
        :   float array of 2 items in [-inf, inf], default (0.0, 0.0)

    rotation[#](#bpy.types.SequenceTransform.rotation "Link to this definition")
    :   Rotate around image center

        Type:
        :   float in [-inf, inf], default 0.0

    scale\_x[#](#bpy.types.SequenceTransform.scale_x "Link to this definition")
    :   Scale along X axis

        Type:
        :   float in [0, inf], default 1.0

    scale\_y[#](#bpy.types.SequenceTransform.scale_y "Link to this definition")
    :   Scale along Y axis

        Type:
        :   float in [0, inf], default 1.0

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.SequenceTransform.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.SequenceTransform.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`EffectSequence.transform`](EffectSequence.md#bpy.types.EffectSequence.transform "bpy.types.EffectSequence.transform") * [`ImageSequence.transform`](ImageSequence.md#bpy.types.ImageSequence.transform "bpy.types.ImageSequence.transform") * [`MaskSequence.transform`](MaskSequence.md#bpy.types.MaskSequence.transform "bpy.types.MaskSequence.transform") * [`MetaSequence.transform`](MetaSequence.md#bpy.types.MetaSequence.transform "bpy.types.MetaSequence.transform") | * [`MovieClipSequence.transform`](MovieClipSequence.md#bpy.types.MovieClipSequence.transform "bpy.types.MovieClipSequence.transform") * [`MovieSequence.transform`](MovieSequence.md#bpy.types.MovieSequence.transform "bpy.types.MovieSequence.transform") * [`SceneSequence.transform`](SceneSequence.md#bpy.types.SceneSequence.transform "bpy.types.SceneSequence.transform") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.SequenceTransform.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.SequenceTransform.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* SequenceTransform(bpy\_struct)
  + [`SequenceTransform`](#bpy.types.SequenceTransform)
    - [`SequenceTransform.filter`](#bpy.types.SequenceTransform.filter)
    - [`SequenceTransform.offset_x`](#bpy.types.SequenceTransform.offset_x)
    - [`SequenceTransform.offset_y`](#bpy.types.SequenceTransform.offset_y)
    - [`SequenceTransform.origin`](#bpy.types.SequenceTransform.origin)
    - [`SequenceTransform.rotation`](#bpy.types.SequenceTransform.rotation)
    - [`SequenceTransform.scale_x`](#bpy.types.SequenceTransform.scale_x)
    - [`SequenceTransform.scale_y`](#bpy.types.SequenceTransform.scale_y)
    - [`SequenceTransform.bl_rna_get_subclass()`](#bpy.types.SequenceTransform.bl_rna_get_subclass)
    - [`SequenceTransform.bl_rna_get_subclass_py()`](#bpy.types.SequenceTransform.bl_rna_get_subclass_py)
