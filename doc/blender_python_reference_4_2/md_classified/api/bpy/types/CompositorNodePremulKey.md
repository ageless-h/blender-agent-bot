...
# CompositorNodePremulKey(CompositorNode)[#](#compositornodepremulkey-compositornode "Link to this heading")
...
*class* bpy.types.CompositorNodePremulKey(*CompositorNode*)[#](#bpy.types.CompositorNodePremulKey "Link to this definition")
:   Convert to and from premultiplied (associated) alpha

    mapping[#](#bpy.types.CompositorNodePremulKey.mapping "Link to this definition")
    :   Conversion between premultiplied alpha and key alpha
        ...
        * `PREMUL_TO_STRAIGHT`
        ...
        Type:
        :   enum in [‘STRAIGHT\_TO\_PREMUL’, ‘PREMUL\_TO\_STRAIGHT’], default ‘STRAIGHT\_TO\_PREMUL’

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.CompositorNodePremulKey.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.CompositorNodePremulKey.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.CompositorNodePremulKey.output_template "Link to this definition")
    ...
    update()[#](#bpy.types.CompositorNodePremulKey.update "Link to this definition")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.CompositorNodePremulKey.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.CompositorNodePremulKey.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CompositorNodePremulKey.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.CompositorNodePremulKey.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CompositorNodePremulKey(CompositorNode)
  + [`CompositorNodePremulKey`](#bpy.types.CompositorNodePremulKey)
    - [`CompositorNodePremulKey.mapping`](#bpy.types.CompositorNodePremulKey.mapping)
    - [`CompositorNodePremulKey.is_registered_node_type()`](#bpy.types.CompositorNodePremulKey.is_registered_node_type)
    - [`CompositorNodePremulKey.input_template()`](#bpy.types.CompositorNodePremulKey.input_template)
    - [`CompositorNodePremulKey.output_template()`](#bpy.types.CompositorNodePremulKey.output_template)
    - [`CompositorNodePremulKey.update()`](#bpy.types.CompositorNodePremulKey.update)
    - [`CompositorNodePremulKey.bl_rna_get_subclass()`](#bpy.types.CompositorNodePremulKey.bl_rna_get_subclass)
    - [`CompositorNodePremulKey.bl_rna_get_subclass_py()`](#bpy.types.CompositorNodePremulKey.bl_rna_get_subclass_py)
