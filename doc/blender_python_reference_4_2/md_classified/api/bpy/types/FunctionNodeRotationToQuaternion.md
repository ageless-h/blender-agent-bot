...
# FunctionNodeRotationToQuaternion(FunctionNode)[#](#functionnoderotationtoquaternion-functionnode "Link to this heading")
...
*class* bpy.types.FunctionNodeRotationToQuaternion(*FunctionNode*)[#](#bpy.types.FunctionNodeRotationToQuaternion "Link to this definition")
:   *classmethod* is\_registered\_node\_type()[#](#bpy.types.FunctionNodeRotationToQuaternion.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.FunctionNodeRotationToQuaternion.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.FunctionNodeRotationToQuaternion.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.FunctionNodeRotationToQuaternion.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.FunctionNodeRotationToQuaternion.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.FunctionNodeRotationToQuaternion.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.FunctionNodeRotationToQuaternion.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* FunctionNodeRotationToQuaternion(FunctionNode)
  + [`FunctionNodeRotationToQuaternion`](#bpy.types.FunctionNodeRotationToQuaternion)
    - [`FunctionNodeRotationToQuaternion.is_registered_node_type()`](#bpy.types.FunctionNodeRotationToQuaternion.is_registered_node_type)
    - [`FunctionNodeRotationToQuaternion.input_template()`](#bpy.types.FunctionNodeRotationToQuaternion.input_template)
    - [`FunctionNodeRotationToQuaternion.output_template()`](#bpy.types.FunctionNodeRotationToQuaternion.output_template)
    - [`FunctionNodeRotationToQuaternion.bl_rna_get_subclass()`](#bpy.types.FunctionNodeRotationToQuaternion.bl_rna_get_subclass)
    - [`FunctionNodeRotationToQuaternion.bl_rna_get_subclass_py()`](#bpy.types.FunctionNodeRotationToQuaternion.bl_rna_get_subclass_py)
