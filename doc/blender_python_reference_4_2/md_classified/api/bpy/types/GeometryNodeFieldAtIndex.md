...
# GeometryNodeFieldAtIndex(GeometryNode)[#](#geometrynodefieldatindex-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeFieldAtIndex(*GeometryNode*)[#](#bpy.types.GeometryNodeFieldAtIndex "Link to this definition")
:   Retrieve data of other elements in the context’s geometry

    data\_type[#](#bpy.types.GeometryNodeFieldAtIndex.data_type "Link to this definition")
    :   Type:
    ...
    domain[#](#bpy.types.GeometryNodeFieldAtIndex.domain "Link to this definition")
    ...
    *classmethod* is\_registered\_node\_type()[#](#bpy.types.GeometryNodeFieldAtIndex.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.GeometryNodeFieldAtIndex.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.GeometryNodeFieldAtIndex.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.GeometryNodeFieldAtIndex.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.GeometryNodeFieldAtIndex.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeFieldAtIndex.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.GeometryNodeFieldAtIndex.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeFieldAtIndex(GeometryNode)
  + [`GeometryNodeFieldAtIndex`](#bpy.types.GeometryNodeFieldAtIndex)
    - [`GeometryNodeFieldAtIndex.data_type`](#bpy.types.GeometryNodeFieldAtIndex.data_type)
    - [`GeometryNodeFieldAtIndex.domain`](#bpy.types.GeometryNodeFieldAtIndex.domain)
    - [`GeometryNodeFieldAtIndex.is_registered_node_type()`](#bpy.types.GeometryNodeFieldAtIndex.is_registered_node_type)
    - [`GeometryNodeFieldAtIndex.input_template()`](#bpy.types.GeometryNodeFieldAtIndex.input_template)
    - [`GeometryNodeFieldAtIndex.output_template()`](#bpy.types.GeometryNodeFieldAtIndex.output_template)
    - [`GeometryNodeFieldAtIndex.bl_rna_get_subclass()`](#bpy.types.GeometryNodeFieldAtIndex.bl_rna_get_subclass)
    - [`GeometryNodeFieldAtIndex.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeFieldAtIndex.bl_rna_get_subclass_py)
