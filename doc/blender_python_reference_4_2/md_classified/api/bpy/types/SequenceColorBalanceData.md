...
# SequenceColorBalanceData(bpy\_struct)[#](#sequencecolorbalancedata-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

subclasses —
[`SequenceColorBalance`](SequenceColorBalance.md#bpy.types.SequenceColorBalance "bpy.types.SequenceColorBalance")

*class* bpy.types.SequenceColorBalanceData(*bpy\_struct*)[#](#bpy.types.SequenceColorBalanceData "Link to this definition")
:   Color balance parameters for a sequence strip and its modifiers

    correction\_method[#](#bpy.types.SequenceColorBalanceData.correction_method "Link to this definition")
    :   * `LIFT_GAMMA_GAIN`
          Lift/Gamma/Gain.
        * `OFFSET_POWER_SLOPE`
    ...
    gain[#](#bpy.types.SequenceColorBalanceData.gain "Link to this definition")
    ...
    gamma[#](#bpy.types.SequenceColorBalanceData.gamma "Link to this definition")
    :   Color balance gamma (midtones)

        Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, inf], default (1.0, 1.0, 1.0)

    invert\_gain[#](#bpy.types.SequenceColorBalanceData.invert_gain "Link to this definition")
    :   Invert the gain color

        Type:
        :   boolean, default False

    invert\_gamma[#](#bpy.types.SequenceColorBalanceData.invert_gamma "Link to this definition")
    :   Invert the gamma color

        Type:
        :   boolean, default False

    invert\_lift[#](#bpy.types.SequenceColorBalanceData.invert_lift "Link to this definition")
    :   Invert the lift color

        Type:
        :   boolean, default False

    invert\_offset[#](#bpy.types.SequenceColorBalanceData.invert_offset "Link to this definition")
    :   Invert the offset color

        Type:
        :   boolean, default False

    invert\_power[#](#bpy.types.SequenceColorBalanceData.invert_power "Link to this definition")
    :   Invert the power color

        Type:
        :   boolean, default False

    invert\_slope[#](#bpy.types.SequenceColorBalanceData.invert_slope "Link to this definition")
    :   Invert the slope color

        Type:
        :   boolean, default False

    lift[#](#bpy.types.SequenceColorBalanceData.lift "Link to this definition")
    :   Color balance lift (shadows)

        Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, inf], default (1.0, 1.0, 1.0)

    offset[#](#bpy.types.SequenceColorBalanceData.offset "Link to this definition")
    :   Correction for entire tonal range

        Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, inf], default (1.0, 1.0, 1.0)

    power[#](#bpy.types.SequenceColorBalanceData.power "Link to this definition")
    :   Correction for midtones

        Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, inf], default (1.0, 1.0, 1.0)

    slope[#](#bpy.types.SequenceColorBalanceData.slope "Link to this definition")
    :   Correction for highlights

        Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, inf], default (1.0, 1.0, 1.0)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.SequenceColorBalanceData.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.SequenceColorBalanceData.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.SequenceColorBalanceData.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.SequenceColorBalanceData.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* SequenceColorBalanceData(bpy\_struct)
  + [`SequenceColorBalanceData`](#bpy.types.SequenceColorBalanceData)
    - [`SequenceColorBalanceData.correction_method`](#bpy.types.SequenceColorBalanceData.correction_method)
    - [`SequenceColorBalanceData.gain`](#bpy.types.SequenceColorBalanceData.gain)
    - [`SequenceColorBalanceData.gamma`](#bpy.types.SequenceColorBalanceData.gamma)
    - [`SequenceColorBalanceData.invert_gain`](#bpy.types.SequenceColorBalanceData.invert_gain)
    - [`SequenceColorBalanceData.invert_gamma`](#bpy.types.SequenceColorBalanceData.invert_gamma)
    - [`SequenceColorBalanceData.invert_lift`](#bpy.types.SequenceColorBalanceData.invert_lift)
    - [`SequenceColorBalanceData.invert_offset`](#bpy.types.SequenceColorBalanceData.invert_offset)
    - [`SequenceColorBalanceData.invert_power`](#bpy.types.SequenceColorBalanceData.invert_power)
    - [`SequenceColorBalanceData.invert_slope`](#bpy.types.SequenceColorBalanceData.invert_slope)
    - [`SequenceColorBalanceData.lift`](#bpy.types.SequenceColorBalanceData.lift)
    - [`SequenceColorBalanceData.offset`](#bpy.types.SequenceColorBalanceData.offset)
    - [`SequenceColorBalanceData.power`](#bpy.types.SequenceColorBalanceData.power)
    - [`SequenceColorBalanceData.slope`](#bpy.types.SequenceColorBalanceData.slope)
    - [`SequenceColorBalanceData.bl_rna_get_subclass()`](#bpy.types.SequenceColorBalanceData.bl_rna_get_subclass)
    - [`SequenceColorBalanceData.bl_rna_get_subclass_py()`](#bpy.types.SequenceColorBalanceData.bl_rna_get_subclass_py)
