...
:   Collection of libraries
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.BlendDataLibraries.bl_rna_get_subclass_py "Link to this definition")
    ...
    :   Returns a context manager which exposes 2 library objects on entering.
        ...
        Parameters:
        :   * **filepath** (*string* *or* *bytes*) – The path to a blend file.
    ...
    :   Write data-blocks into a blend file.
        ...
        Parameters:
        :   * **filepath** (*string* *or* *bytes*) – The path to write the blend-file.
            * **datablocks** (*set*) – set of data-blocks ([`bpy.types.ID`](ID.md#bpy.types.ID "bpy.types.ID") instances).
            * **path\_remap** (*string*) –
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.BlendDataLibraries.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.BlendDataLibraries.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)
