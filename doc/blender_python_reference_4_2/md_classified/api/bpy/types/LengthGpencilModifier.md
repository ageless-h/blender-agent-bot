...
# LengthGpencilModifier(GpencilModifier)[#](#lengthgpencilmodifier-gpencilmodifier "Link to this heading")
...
*class* bpy.types.LengthGpencilModifier(*GpencilModifier*)[#](#bpy.types.LengthGpencilModifier "Link to this definition")
:   Stretch or shrink strokes

    end\_factor[#](#bpy.types.LengthGpencilModifier.end_factor "Link to this definition")
    :   Added length to the end of each stroke relative to its length

        Type:
        :   float in [-inf, inf], default 0.1

    end\_length[#](#bpy.types.LengthGpencilModifier.end_length "Link to this definition")
    :   Absolute added length to the end of each stroke

        Type:
        :   float in [-inf, inf], default 0.1

    invert\_curvature[#](#bpy.types.LengthGpencilModifier.invert_curvature "Link to this definition")
    :   Invert the curvature of the stroke’s extension

        Type:
        :   boolean, default False

    invert\_layer\_pass[#](#bpy.types.LengthGpencilModifier.invert_layer_pass "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    invert\_layers[#](#bpy.types.LengthGpencilModifier.invert_layers "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    invert\_material\_pass[#](#bpy.types.LengthGpencilModifier.invert_material_pass "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    invert\_materials[#](#bpy.types.LengthGpencilModifier.invert_materials "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    layer[#](#bpy.types.LengthGpencilModifier.layer "Link to this definition")
    :   Layer name

        Type:
        :   string, default “”, (never None)

    layer\_pass[#](#bpy.types.LengthGpencilModifier.layer_pass "Link to this definition")
    :   Layer pass index

        Type:
        :   int in [0, 100], default 0

    material[#](#bpy.types.LengthGpencilModifier.material "Link to this definition")
    :   Material used for filtering effect

        Type:
        :   [`Material`](Material.md#bpy.types.Material "bpy.types.Material")

    max\_angle[#](#bpy.types.LengthGpencilModifier.max_angle "Link to this definition")
    ...
    mode[#](#bpy.types.LengthGpencilModifier.mode "Link to this definition")
    ...
    overshoot\_factor[#](#bpy.types.LengthGpencilModifier.overshoot_factor "Link to this definition")
    :   Defines what portion of the stroke is used for the calculation of the extension

        Type:
        :   float in [0, 1], default 0.1

    pass\_index[#](#bpy.types.LengthGpencilModifier.pass_index "Link to this definition")
    :   Pass index

        Type:
        :   int in [0, 100], default 0

    point\_density[#](#bpy.types.LengthGpencilModifier.point_density "Link to this definition")
    :   Multiplied by Start/End for the total added point count

        Type:
        :   float in [0.1, 1000], default 30.0

    random\_end\_factor[#](#bpy.types.LengthGpencilModifier.random_end_factor "Link to this definition")
    :   Size of random length added to the end of each stroke

        Type:
        :   float in [-inf, inf], default 0.0

    random\_offset[#](#bpy.types.LengthGpencilModifier.random_offset "Link to this definition")
    :   Smoothly offset each stroke’s random value

        Type:
        :   float in [-inf, inf], default 0.0

    random\_start\_factor[#](#bpy.types.LengthGpencilModifier.random_start_factor "Link to this definition")
    :   Size of random length added to the start of each stroke

        Type:
        :   float in [-inf, inf], default 0.0

    seed[#](#bpy.types.LengthGpencilModifier.seed "Link to this definition")
    :   Random seed

        Type:
        :   int in [0, inf], default 0

    segment\_influence[#](#bpy.types.LengthGpencilModifier.segment_influence "Link to this definition")
    ...
    start\_factor[#](#bpy.types.LengthGpencilModifier.start_factor "Link to this definition")
    :   Added length to the start of each stroke relative to its length

        Type:
        :   float in [-inf, inf], default 0.1

    start\_length[#](#bpy.types.LengthGpencilModifier.start_length "Link to this definition")
    :   Absolute added length to the start of each stroke

        Type:
        :   float in [-inf, inf], default 0.1

    step[#](#bpy.types.LengthGpencilModifier.step "Link to this definition")
    :   Number of frames between randomization steps

        Type:
        :   int in [1, 100], default 4

    use\_curvature[#](#bpy.types.LengthGpencilModifier.use_curvature "Link to this definition")
    :   Follow the curvature of the stroke

        Type:
        :   boolean, default True

    use\_random[#](#bpy.types.LengthGpencilModifier.use_random "Link to this definition")
    :   Use random values over time

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.LengthGpencilModifier.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.LengthGpencilModifier.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.LengthGpencilModifier.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.LengthGpencilModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* LengthGpencilModifier(GpencilModifier)
  + [`LengthGpencilModifier`](#bpy.types.LengthGpencilModifier)
    - [`LengthGpencilModifier.end_factor`](#bpy.types.LengthGpencilModifier.end_factor)
    - [`LengthGpencilModifier.end_length`](#bpy.types.LengthGpencilModifier.end_length)
    - [`LengthGpencilModifier.invert_curvature`](#bpy.types.LengthGpencilModifier.invert_curvature)
    - [`LengthGpencilModifier.invert_layer_pass`](#bpy.types.LengthGpencilModifier.invert_layer_pass)
    - [`LengthGpencilModifier.invert_layers`](#bpy.types.LengthGpencilModifier.invert_layers)
    - [`LengthGpencilModifier.invert_material_pass`](#bpy.types.LengthGpencilModifier.invert_material_pass)
    - [`LengthGpencilModifier.invert_materials`](#bpy.types.LengthGpencilModifier.invert_materials)
    - [`LengthGpencilModifier.layer`](#bpy.types.LengthGpencilModifier.layer)
    - [`LengthGpencilModifier.layer_pass`](#bpy.types.LengthGpencilModifier.layer_pass)
    - [`LengthGpencilModifier.material`](#bpy.types.LengthGpencilModifier.material)
    - [`LengthGpencilModifier.max_angle`](#bpy.types.LengthGpencilModifier.max_angle)
    - [`LengthGpencilModifier.mode`](#bpy.types.LengthGpencilModifier.mode)
    - [`LengthGpencilModifier.overshoot_factor`](#bpy.types.LengthGpencilModifier.overshoot_factor)
    - [`LengthGpencilModifier.pass_index`](#bpy.types.LengthGpencilModifier.pass_index)
    - [`LengthGpencilModifier.point_density`](#bpy.types.LengthGpencilModifier.point_density)
    - [`LengthGpencilModifier.random_end_factor`](#bpy.types.LengthGpencilModifier.random_end_factor)
    - [`LengthGpencilModifier.random_offset`](#bpy.types.LengthGpencilModifier.random_offset)
    - [`LengthGpencilModifier.random_start_factor`](#bpy.types.LengthGpencilModifier.random_start_factor)
    - [`LengthGpencilModifier.seed`](#bpy.types.LengthGpencilModifier.seed)
    - [`LengthGpencilModifier.segment_influence`](#bpy.types.LengthGpencilModifier.segment_influence)
    - [`LengthGpencilModifier.start_factor`](#bpy.types.LengthGpencilModifier.start_factor)
    - [`LengthGpencilModifier.start_length`](#bpy.types.LengthGpencilModifier.start_length)
    - [`LengthGpencilModifier.step`](#bpy.types.LengthGpencilModifier.step)
    - [`LengthGpencilModifier.use_curvature`](#bpy.types.LengthGpencilModifier.use_curvature)
    - [`LengthGpencilModifier.use_random`](#bpy.types.LengthGpencilModifier.use_random)
    - [`LengthGpencilModifier.bl_rna_get_subclass()`](#bpy.types.LengthGpencilModifier.bl_rna_get_subclass)
    - [`LengthGpencilModifier.bl_rna_get_subclass_py()`](#bpy.types.LengthGpencilModifier.bl_rna_get_subclass_py)
