...
# CompositorNodeVecBlur(CompositorNode)[#](#compositornodevecblur-compositornode "Link to this heading")
...
*class* bpy.types.CompositorNodeVecBlur(*CompositorNode*)[#](#bpy.types.CompositorNodeVecBlur "Link to this definition")
:   Uses the vector speed render pass to blur the image pixels in 2D

    factor[#](#bpy.types.CompositorNodeVecBlur.factor "Link to this definition")
    :   Scaling factor for motion vectors (actually, ‘shutter speed’, in frames)

        Type:
        :   float in [0, 20], default 0.0

    samples[#](#bpy.types.CompositorNodeVecBlur.samples "Link to this definition")
    :   Type:
        :   int in [1, 256], default 0

    speed\_max[#](#bpy.types.CompositorNodeVecBlur.speed_max "Link to this definition")
    :   Maximum speed, or zero for none

        Type:
        :   int in [0, 1024], default 0

    speed\_min[#](#bpy.types.CompositorNodeVecBlur.speed_min "Link to this definition")
    :   Minimum speed for a pixel to be blurred (used to separate background from foreground)

        Type:
        :   int in [0, 1024], default 0

    use\_curved[#](#bpy.types.CompositorNodeVecBlur.use_curved "Link to this definition")
    :   Interpolate between frames in a Bézier curve, rather than linearly

        Type:
        :   boolean, default False

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.CompositorNodeVecBlur.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.CompositorNodeVecBlur.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.CompositorNodeVecBlur.output_template "Link to this definition")
    ...
    update()[#](#bpy.types.CompositorNodeVecBlur.update "Link to this definition")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.CompositorNodeVecBlur.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.CompositorNodeVecBlur.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CompositorNodeVecBlur.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.CompositorNodeVecBlur.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CompositorNodeVecBlur(CompositorNode)
  + [`CompositorNodeVecBlur`](#bpy.types.CompositorNodeVecBlur)
    - [`CompositorNodeVecBlur.factor`](#bpy.types.CompositorNodeVecBlur.factor)
    - [`CompositorNodeVecBlur.samples`](#bpy.types.CompositorNodeVecBlur.samples)
    - [`CompositorNodeVecBlur.speed_max`](#bpy.types.CompositorNodeVecBlur.speed_max)
    - [`CompositorNodeVecBlur.speed_min`](#bpy.types.CompositorNodeVecBlur.speed_min)
    - [`CompositorNodeVecBlur.use_curved`](#bpy.types.CompositorNodeVecBlur.use_curved)
    - [`CompositorNodeVecBlur.is_registered_node_type()`](#bpy.types.CompositorNodeVecBlur.is_registered_node_type)
    - [`CompositorNodeVecBlur.input_template()`](#bpy.types.CompositorNodeVecBlur.input_template)
    - [`CompositorNodeVecBlur.output_template()`](#bpy.types.CompositorNodeVecBlur.output_template)
    - [`CompositorNodeVecBlur.update()`](#bpy.types.CompositorNodeVecBlur.update)
    - [`CompositorNodeVecBlur.bl_rna_get_subclass()`](#bpy.types.CompositorNodeVecBlur.bl_rna_get_subclass)
    - [`CompositorNodeVecBlur.bl_rna_get_subclass_py()`](#bpy.types.CompositorNodeVecBlur.bl_rna_get_subclass_py)
