...
# GeometryNodeSampleNearestSurface(GeometryNode)[#](#geometrynodesamplenearestsurface-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeSampleNearestSurface(*GeometryNode*)[#](#bpy.types.GeometryNodeSampleNearestSurface "Link to this definition")
:   Calculate the interpolated value of a mesh attribute on the closest point of its surface

    data\_type[#](#bpy.types.GeometryNodeSampleNearestSurface.data_type "Link to this definition")
    :   Type:
    ...
    *classmethod* is\_registered\_node\_type()[#](#bpy.types.GeometryNodeSampleNearestSurface.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.GeometryNodeSampleNearestSurface.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.GeometryNodeSampleNearestSurface.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.GeometryNodeSampleNearestSurface.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.GeometryNodeSampleNearestSurface.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeSampleNearestSurface.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.GeometryNodeSampleNearestSurface.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeSampleNearestSurface(GeometryNode)
  + [`GeometryNodeSampleNearestSurface`](#bpy.types.GeometryNodeSampleNearestSurface)
    - [`GeometryNodeSampleNearestSurface.data_type`](#bpy.types.GeometryNodeSampleNearestSurface.data_type)
    - [`GeometryNodeSampleNearestSurface.is_registered_node_type()`](#bpy.types.GeometryNodeSampleNearestSurface.is_registered_node_type)
    - [`GeometryNodeSampleNearestSurface.input_template()`](#bpy.types.GeometryNodeSampleNearestSurface.input_template)
    - [`GeometryNodeSampleNearestSurface.output_template()`](#bpy.types.GeometryNodeSampleNearestSurface.output_template)
    - [`GeometryNodeSampleNearestSurface.bl_rna_get_subclass()`](#bpy.types.GeometryNodeSampleNearestSurface.bl_rna_get_subclass)
    - [`GeometryNodeSampleNearestSurface.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeSampleNearestSurface.bl_rna_get_subclass_py)
