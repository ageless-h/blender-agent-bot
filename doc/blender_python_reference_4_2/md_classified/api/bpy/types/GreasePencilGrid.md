...
# GreasePencilGrid(bpy\_struct)[#](#greasepencilgrid-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.GreasePencilGrid(*bpy\_struct*)[#](#bpy.types.GreasePencilGrid "Link to this definition")
:   Settings for grid and canvas in 3D viewport

    color[#](#bpy.types.GreasePencilGrid.color "Link to this definition")
    :   Color for grid lines

        Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.5, 0.5, 0.5)

    lines[#](#bpy.types.GreasePencilGrid.lines "Link to this definition")
    :   Number of subdivisions in each side of symmetry line

        Type:
        :   int in [0, 32767], default 4

    offset[#](#bpy.types.GreasePencilGrid.offset "Link to this definition")
    ...
    scale[#](#bpy.types.GreasePencilGrid.scale "Link to this definition")
    :   Grid scale

        Type:
        :   [`mathutils.Vector`](../../mathutils/index.md#mathutils.Vector "mathutils.Vector") of 2 items in [0.01, inf], default (1.0, 1.0)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.GreasePencilGrid.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.GreasePencilGrid.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`GreasePencil.grid`](GreasePencil.md#bpy.types.GreasePencil.grid "bpy.types.GreasePencil.grid") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GreasePencilGrid.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.GreasePencilGrid.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GreasePencilGrid(bpy\_struct)
  + [`GreasePencilGrid`](#bpy.types.GreasePencilGrid)
    - [`GreasePencilGrid.color`](#bpy.types.GreasePencilGrid.color)
    - [`GreasePencilGrid.lines`](#bpy.types.GreasePencilGrid.lines)
    - [`GreasePencilGrid.offset`](#bpy.types.GreasePencilGrid.offset)
    - [`GreasePencilGrid.scale`](#bpy.types.GreasePencilGrid.scale)
    - [`GreasePencilGrid.bl_rna_get_subclass()`](#bpy.types.GreasePencilGrid.bl_rna_get_subclass)
    - [`GreasePencilGrid.bl_rna_get_subclass_py()`](#bpy.types.GreasePencilGrid.bl_rna_get_subclass_py)
