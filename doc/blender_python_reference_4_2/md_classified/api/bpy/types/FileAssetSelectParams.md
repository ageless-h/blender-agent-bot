...
:   Settings for the file selection in Asset Browser mode
    ...
    :   * `ALL`
          All – Show assets from all of the listed asset libraries.
        * `LOCAL`
    ...
    :   Determine how the asset will be imported
        ...
        * `APPEND_REUSE`
        ...
        Type:
        :   enum in [‘FOLLOW\_PREFS’, ‘LINK’, ‘APPEND’, ‘APPEND\_REUSE’], default ‘LINK’
