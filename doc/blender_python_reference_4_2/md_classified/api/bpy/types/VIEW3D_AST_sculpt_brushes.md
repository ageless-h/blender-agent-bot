...
# VIEW3D\_AST\_sculpt\_brushes(AssetShelf)[#](#view3d-ast-sculpt-brushes-assetshelf "Link to this heading")
...
*class* bpy.types.VIEW3D\_AST\_sculpt\_brushes(*AssetShelf*)[#](#bpy.types.VIEW3D_AST_sculpt_brushes "Link to this definition")
:   *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.VIEW3D_AST_sculpt_brushes.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.VIEW3D_AST_sculpt_brushes.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.VIEW3D_AST_sculpt_brushes.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.VIEW3D_AST_sculpt_brushes.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* VIEW3D\_AST\_sculpt\_brushes(AssetShelf)
  + [`VIEW3D_AST_sculpt_brushes`](#bpy.types.VIEW3D_AST_sculpt_brushes)
    - [`VIEW3D_AST_sculpt_brushes.bl_rna_get_subclass()`](#bpy.types.VIEW3D_AST_sculpt_brushes.bl_rna_get_subclass)
    - [`VIEW3D_AST_sculpt_brushes.bl_rna_get_subclass_py()`](#bpy.types.VIEW3D_AST_sculpt_brushes.bl_rna_get_subclass_py)
