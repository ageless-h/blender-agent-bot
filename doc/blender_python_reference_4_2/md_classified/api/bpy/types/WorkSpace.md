...
:   Workspace data-block, defining the working environment for the user
    ...
    active\_pose\_asset\_index[#](#bpy.types.WorkSpace.active_pose_asset_index "Link to this definition")
...
* WorkSpace(ID)
  + [`WorkSpace`](#bpy.types.WorkSpace)
    ...
    - [`WorkSpace.active_pose_asset_index`](#bpy.types.WorkSpace.active_pose_asset_index)
