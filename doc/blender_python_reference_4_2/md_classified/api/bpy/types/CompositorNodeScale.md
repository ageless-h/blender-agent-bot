...
# CompositorNodeScale(CompositorNode)[#](#compositornodescale-compositornode "Link to this heading")
...
*class* bpy.types.CompositorNodeScale(*CompositorNode*)[#](#bpy.types.CompositorNodeScale "Link to this definition")
:   Change the size of the image

    frame\_method[#](#bpy.types.CompositorNodeScale.frame_method "Link to this definition")
    :   How the image fits in the camera frame

        Type:
        :   enum in [‘STRETCH’, ‘FIT’, ‘CROP’], default ‘STRETCH’

    offset\_x[#](#bpy.types.CompositorNodeScale.offset_x "Link to this definition")
    :   Offset image horizontally (factor of image size)

        Type:
        :   float in [-inf, inf], default 0.0

    offset\_y[#](#bpy.types.CompositorNodeScale.offset_y "Link to this definition")
    :   Offset image vertically (factor of image size)

        Type:
        :   float in [-inf, inf], default 0.0

    space[#](#bpy.types.CompositorNodeScale.space "Link to this definition")
    :   Coordinate space to scale relative to

        Type:
        :   enum in [‘RELATIVE’, ‘ABSOLUTE’, ‘SCENE\_SIZE’, ‘RENDER\_SIZE’], default ‘RELATIVE’

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.CompositorNodeScale.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.CompositorNodeScale.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.CompositorNodeScale.output_template "Link to this definition")
    ...
    update()[#](#bpy.types.CompositorNodeScale.update "Link to this definition")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.CompositorNodeScale.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.CompositorNodeScale.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CompositorNodeScale.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.CompositorNodeScale.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CompositorNodeScale(CompositorNode)
  + [`CompositorNodeScale`](#bpy.types.CompositorNodeScale)
    - [`CompositorNodeScale.frame_method`](#bpy.types.CompositorNodeScale.frame_method)
    - [`CompositorNodeScale.offset_x`](#bpy.types.CompositorNodeScale.offset_x)
    - [`CompositorNodeScale.offset_y`](#bpy.types.CompositorNodeScale.offset_y)
    - [`CompositorNodeScale.space`](#bpy.types.CompositorNodeScale.space)
    - [`CompositorNodeScale.is_registered_node_type()`](#bpy.types.CompositorNodeScale.is_registered_node_type)
    - [`CompositorNodeScale.input_template()`](#bpy.types.CompositorNodeScale.input_template)
    - [`CompositorNodeScale.output_template()`](#bpy.types.CompositorNodeScale.output_template)
    - [`CompositorNodeScale.update()`](#bpy.types.CompositorNodeScale.update)
    - [`CompositorNodeScale.bl_rna_get_subclass()`](#bpy.types.CompositorNodeScale.bl_rna_get_subclass)
    - [`CompositorNodeScale.bl_rna_get_subclass_py()`](#bpy.types.CompositorNodeScale.bl_rna_get_subclass_py)
