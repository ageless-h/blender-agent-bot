...
# GeometryNodeSetSplineCyclic(GeometryNode)[#](#geometrynodesetsplinecyclic-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeSetSplineCyclic(*GeometryNode*)[#](#bpy.types.GeometryNodeSetSplineCyclic "Link to this definition")
:   Control whether each spline loops back on itself by changing the “cyclic” attribute

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.GeometryNodeSetSplineCyclic.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.GeometryNodeSetSplineCyclic.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.GeometryNodeSetSplineCyclic.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.GeometryNodeSetSplineCyclic.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.GeometryNodeSetSplineCyclic.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeSetSplineCyclic.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.GeometryNodeSetSplineCyclic.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeSetSplineCyclic(GeometryNode)
  + [`GeometryNodeSetSplineCyclic`](#bpy.types.GeometryNodeSetSplineCyclic)
    - [`GeometryNodeSetSplineCyclic.is_registered_node_type()`](#bpy.types.GeometryNodeSetSplineCyclic.is_registered_node_type)
    - [`GeometryNodeSetSplineCyclic.input_template()`](#bpy.types.GeometryNodeSetSplineCyclic.input_template)
    - [`GeometryNodeSetSplineCyclic.output_template()`](#bpy.types.GeometryNodeSetSplineCyclic.output_template)
    - [`GeometryNodeSetSplineCyclic.bl_rna_get_subclass()`](#bpy.types.GeometryNodeSetSplineCyclic.bl_rna_get_subclass)
    - [`GeometryNodeSetSplineCyclic.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeSetSplineCyclic.bl_rna_get_subclass_py)
