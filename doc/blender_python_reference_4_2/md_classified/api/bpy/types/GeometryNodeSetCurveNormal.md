...
# GeometryNodeSetCurveNormal(GeometryNode)[#](#geometrynodesetcurvenormal-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeSetCurveNormal(*GeometryNode*)[#](#bpy.types.GeometryNodeSetCurveNormal "Link to this definition")
:   Set the evaluation mode for curve normals

    mode[#](#bpy.types.GeometryNodeSetCurveNormal.mode "Link to this definition")
    :   Mode for curve normal evaluation

        Type:
        :   enum in [Curve Normal Mode Items](../../../appendix/bpy_types_enum_items/curve_normal_mode_items.md#rna-enum-curve-normal-mode-items), default ‘MINIMUM\_TWIST’

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.GeometryNodeSetCurveNormal.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.GeometryNodeSetCurveNormal.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.GeometryNodeSetCurveNormal.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.GeometryNodeSetCurveNormal.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.GeometryNodeSetCurveNormal.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeSetCurveNormal.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.GeometryNodeSetCurveNormal.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeSetCurveNormal(GeometryNode)
  + [`GeometryNodeSetCurveNormal`](#bpy.types.GeometryNodeSetCurveNormal)
    - [`GeometryNodeSetCurveNormal.mode`](#bpy.types.GeometryNodeSetCurveNormal.mode)
    - [`GeometryNodeSetCurveNormal.is_registered_node_type()`](#bpy.types.GeometryNodeSetCurveNormal.is_registered_node_type)
    - [`GeometryNodeSetCurveNormal.input_template()`](#bpy.types.GeometryNodeSetCurveNormal.input_template)
    - [`GeometryNodeSetCurveNormal.output_template()`](#bpy.types.GeometryNodeSetCurveNormal.output_template)
    - [`GeometryNodeSetCurveNormal.bl_rna_get_subclass()`](#bpy.types.GeometryNodeSetCurveNormal.bl_rna_get_subclass)
    - [`GeometryNodeSetCurveNormal.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeSetCurveNormal.bl_rna_get_subclass_py)
