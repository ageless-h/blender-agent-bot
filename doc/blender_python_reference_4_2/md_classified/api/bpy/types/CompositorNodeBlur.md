...
# CompositorNodeBlur(CompositorNode)[#](#compositornodeblur-compositornode "Link to this heading")
...
*class* bpy.types.CompositorNodeBlur(*CompositorNode*)[#](#bpy.types.CompositorNodeBlur "Link to this definition")
:   Blur an image, using several blur modes

    aspect\_correction[#](#bpy.types.CompositorNodeBlur.aspect_correction "Link to this definition")
    :   Type of aspect correction to use

        Type:
        :   enum in [‘NONE’, ‘Y’, ‘X’], default ‘NONE’

    factor[#](#bpy.types.CompositorNodeBlur.factor "Link to this definition")
    :   Type:
        :   float in [0, 2], default 0.0

    factor\_x[#](#bpy.types.CompositorNodeBlur.factor_x "Link to this definition")
    :   Type:
        :   float in [0, 100], default 0.0

    factor\_y[#](#bpy.types.CompositorNodeBlur.factor_y "Link to this definition")
    :   Type:
        :   float in [0, 100], default 0.0

    filter\_type[#](#bpy.types.CompositorNodeBlur.filter_type "Link to this definition")
    :   Type:
        :   enum in [‘FLAT’, ‘TENT’, ‘QUAD’, ‘CUBIC’, ‘GAUSS’, ‘FAST\_GAUSS’, ‘CATROM’, ‘MITCH’], default ‘FLAT’

    size\_x[#](#bpy.types.CompositorNodeBlur.size_x "Link to this definition")
    :   Type:
        :   int in [0, 2048], default 0

    size\_y[#](#bpy.types.CompositorNodeBlur.size_y "Link to this definition")
    :   Type:
        :   int in [0, 2048], default 0

    use\_bokeh[#](#bpy.types.CompositorNodeBlur.use_bokeh "Link to this definition")
    :   Use circular filter (slower)

        Type:
        :   boolean, default False

    use\_extended\_bounds[#](#bpy.types.CompositorNodeBlur.use_extended_bounds "Link to this definition")
    :   Extend bounds of the input image to fully fit blurred image

        Type:
        :   boolean, default False

    use\_gamma\_correction[#](#bpy.types.CompositorNodeBlur.use_gamma_correction "Link to this definition")
    :   Apply filter on gamma corrected values

        Type:
        :   boolean, default False

    use\_relative[#](#bpy.types.CompositorNodeBlur.use_relative "Link to this definition")
    :   Use relative (percent) values to define blur radius

        Type:
        :   boolean, default False

    use\_variable\_size[#](#bpy.types.CompositorNodeBlur.use_variable_size "Link to this definition")
    :   Support variable blur per pixel when using an image for size input

        Type:
        :   boolean, default False

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.CompositorNodeBlur.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.CompositorNodeBlur.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.CompositorNodeBlur.output_template "Link to this definition")
    ...
    update()[#](#bpy.types.CompositorNodeBlur.update "Link to this definition")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.CompositorNodeBlur.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.CompositorNodeBlur.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CompositorNodeBlur.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.CompositorNodeBlur.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CompositorNodeBlur(CompositorNode)
  + [`CompositorNodeBlur`](#bpy.types.CompositorNodeBlur)
    - [`CompositorNodeBlur.aspect_correction`](#bpy.types.CompositorNodeBlur.aspect_correction)
    - [`CompositorNodeBlur.factor`](#bpy.types.CompositorNodeBlur.factor)
    - [`CompositorNodeBlur.factor_x`](#bpy.types.CompositorNodeBlur.factor_x)
    - [`CompositorNodeBlur.factor_y`](#bpy.types.CompositorNodeBlur.factor_y)
    - [`CompositorNodeBlur.filter_type`](#bpy.types.CompositorNodeBlur.filter_type)
    - [`CompositorNodeBlur.size_x`](#bpy.types.CompositorNodeBlur.size_x)
    - [`CompositorNodeBlur.size_y`](#bpy.types.CompositorNodeBlur.size_y)
    - [`CompositorNodeBlur.use_bokeh`](#bpy.types.CompositorNodeBlur.use_bokeh)
    - [`CompositorNodeBlur.use_extended_bounds`](#bpy.types.CompositorNodeBlur.use_extended_bounds)
    - [`CompositorNodeBlur.use_gamma_correction`](#bpy.types.CompositorNodeBlur.use_gamma_correction)
    - [`CompositorNodeBlur.use_relative`](#bpy.types.CompositorNodeBlur.use_relative)
    - [`CompositorNodeBlur.use_variable_size`](#bpy.types.CompositorNodeBlur.use_variable_size)
    - [`CompositorNodeBlur.is_registered_node_type()`](#bpy.types.CompositorNodeBlur.is_registered_node_type)
    - [`CompositorNodeBlur.input_template()`](#bpy.types.CompositorNodeBlur.input_template)
    - [`CompositorNodeBlur.output_template()`](#bpy.types.CompositorNodeBlur.output_template)
    - [`CompositorNodeBlur.update()`](#bpy.types.CompositorNodeBlur.update)
    - [`CompositorNodeBlur.bl_rna_get_subclass()`](#bpy.types.CompositorNodeBlur.bl_rna_get_subclass)
    - [`CompositorNodeBlur.bl_rna_get_subclass_py()`](#bpy.types.CompositorNodeBlur.bl_rna_get_subclass_py)
