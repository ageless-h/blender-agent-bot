...
# NodeFrame(NodeInternal)[#](#nodeframe-nodeinternal "Link to this heading")
...
*class* bpy.types.NodeFrame(*NodeInternal*)[#](#bpy.types.NodeFrame "Link to this definition")
:   Collect related nodes together in a common area. Useful for organization when the re-usability of a node group is not required
    ...
    label\_size[#](#bpy.types.NodeFrame.label_size "Link to this definition")
    :   Font size to use for displaying the label

        Type:
        :   int in [8, 64], default 0

    shrink[#](#bpy.types.NodeFrame.shrink "Link to this definition")
    :   Shrink the frame to minimal bounding box

        Type:
        :   boolean, default False

    text[#](#bpy.types.NodeFrame.text "Link to this definition")
    :   Type:
        :   [`Text`](Text.md#bpy.types.Text "bpy.types.Text")

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.NodeFrame.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.NodeFrame.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.NodeFrame.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.NodeFrame.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.NodeFrame.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.NodeFrame.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.NodeFrame.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* NodeFrame(NodeInternal)
  + [`NodeFrame`](#bpy.types.NodeFrame)
    - [`NodeFrame.label_size`](#bpy.types.NodeFrame.label_size)
    - [`NodeFrame.shrink`](#bpy.types.NodeFrame.shrink)
    - [`NodeFrame.text`](#bpy.types.NodeFrame.text)
    - [`NodeFrame.is_registered_node_type()`](#bpy.types.NodeFrame.is_registered_node_type)
    - [`NodeFrame.input_template()`](#bpy.types.NodeFrame.input_template)
    - [`NodeFrame.output_template()`](#bpy.types.NodeFrame.output_template)
    - [`NodeFrame.bl_rna_get_subclass()`](#bpy.types.NodeFrame.bl_rna_get_subclass)
    - [`NodeFrame.bl_rna_get_subclass_py()`](#bpy.types.NodeFrame.bl_rna_get_subclass_py)
