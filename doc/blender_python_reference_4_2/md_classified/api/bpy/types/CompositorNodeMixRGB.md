...
# CompositorNodeMixRGB(CompositorNode)[#](#compositornodemixrgb-compositornode "Link to this heading")
...
*class* bpy.types.CompositorNodeMixRGB(*CompositorNode*)[#](#bpy.types.CompositorNodeMixRGB "Link to this definition")
:   Blend two images together using various blending modes

    blend\_type[#](#bpy.types.CompositorNodeMixRGB.blend_type "Link to this definition")
    :   Type:
        :   enum in [Ramp Blend Items](../../../appendix/bpy_types_enum_items/ramp_blend_items.md#rna-enum-ramp-blend-items), default ‘MIX’

    use\_alpha[#](#bpy.types.CompositorNodeMixRGB.use_alpha "Link to this definition")
    :   Include alpha of second input in this operation

        Type:
        :   boolean, default False

    use\_clamp[#](#bpy.types.CompositorNodeMixRGB.use_clamp "Link to this definition")
    :   Clamp result of the node to 0.0 to 1.0 range

        Type:
        :   boolean, default False

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.CompositorNodeMixRGB.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.CompositorNodeMixRGB.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.CompositorNodeMixRGB.output_template "Link to this definition")
    ...
    update()[#](#bpy.types.CompositorNodeMixRGB.update "Link to this definition")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.CompositorNodeMixRGB.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.CompositorNodeMixRGB.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CompositorNodeMixRGB.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.CompositorNodeMixRGB.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CompositorNodeMixRGB(CompositorNode)
  + [`CompositorNodeMixRGB`](#bpy.types.CompositorNodeMixRGB)
    - [`CompositorNodeMixRGB.blend_type`](#bpy.types.CompositorNodeMixRGB.blend_type)
    - [`CompositorNodeMixRGB.use_alpha`](#bpy.types.CompositorNodeMixRGB.use_alpha)
    - [`CompositorNodeMixRGB.use_clamp`](#bpy.types.CompositorNodeMixRGB.use_clamp)
    - [`CompositorNodeMixRGB.is_registered_node_type()`](#bpy.types.CompositorNodeMixRGB.is_registered_node_type)
    - [`CompositorNodeMixRGB.input_template()`](#bpy.types.CompositorNodeMixRGB.input_template)
    - [`CompositorNodeMixRGB.output_template()`](#bpy.types.CompositorNodeMixRGB.output_template)
    - [`CompositorNodeMixRGB.update()`](#bpy.types.CompositorNodeMixRGB.update)
    - [`CompositorNodeMixRGB.bl_rna_get_subclass()`](#bpy.types.CompositorNodeMixRGB.bl_rna_get_subclass)
    - [`CompositorNodeMixRGB.bl_rna_get_subclass_py()`](#bpy.types.CompositorNodeMixRGB.bl_rna_get_subclass_py)
