...
# CompositorNodeInpaint(CompositorNode)[#](#compositornodeinpaint-compositornode "Link to this heading")
...
*class* bpy.types.CompositorNodeInpaint(*CompositorNode*)[#](#bpy.types.CompositorNodeInpaint "Link to this definition")
:   Extend borders of an image into transparent or masked regions

    distance[#](#bpy.types.CompositorNodeInpaint.distance "Link to this definition")
    :   Distance to inpaint (number of iterations)

        Type:
        :   int in [0, 10000], default 0

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.CompositorNodeInpaint.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.CompositorNodeInpaint.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.CompositorNodeInpaint.output_template "Link to this definition")
    ...
    update()[#](#bpy.types.CompositorNodeInpaint.update "Link to this definition")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.CompositorNodeInpaint.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.CompositorNodeInpaint.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CompositorNodeInpaint.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.CompositorNodeInpaint.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CompositorNodeInpaint(CompositorNode)
  + [`CompositorNodeInpaint`](#bpy.types.CompositorNodeInpaint)
    - [`CompositorNodeInpaint.distance`](#bpy.types.CompositorNodeInpaint.distance)
    - [`CompositorNodeInpaint.is_registered_node_type()`](#bpy.types.CompositorNodeInpaint.is_registered_node_type)
    - [`CompositorNodeInpaint.input_template()`](#bpy.types.CompositorNodeInpaint.input_template)
    - [`CompositorNodeInpaint.output_template()`](#bpy.types.CompositorNodeInpaint.output_template)
    - [`CompositorNodeInpaint.update()`](#bpy.types.CompositorNodeInpaint.update)
    - [`CompositorNodeInpaint.bl_rna_get_subclass()`](#bpy.types.CompositorNodeInpaint.bl_rna_get_subclass)
    - [`CompositorNodeInpaint.bl_rna_get_subclass_py()`](#bpy.types.CompositorNodeInpaint.bl_rna_get_subclass_py)
