...
# TextureNodeMath(TextureNode)[#](#texturenodemath-texturenode "Link to this heading")
...
*class* bpy.types.TextureNodeMath(*TextureNode*)[#](#bpy.types.TextureNodeMath "Link to this definition")
:   operation[#](#bpy.types.TextureNodeMath.operation "Link to this definition")
    :   Type:
        :   enum in [Node Math Items](../../../appendix/bpy_types_enum_items/node_math_items.md#rna-enum-node-math-items), default ‘ADD’

    use\_clamp[#](#bpy.types.TextureNodeMath.use_clamp "Link to this definition")
    :   Clamp result of the node to 0.0 to 1.0 range

        Type:
        :   boolean, default False

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.TextureNodeMath.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.TextureNodeMath.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.TextureNodeMath.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.TextureNodeMath.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.TextureNodeMath.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.TextureNodeMath.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.TextureNodeMath.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* TextureNodeMath(TextureNode)
  + [`TextureNodeMath`](#bpy.types.TextureNodeMath)
    - [`TextureNodeMath.operation`](#bpy.types.TextureNodeMath.operation)
    - [`TextureNodeMath.use_clamp`](#bpy.types.TextureNodeMath.use_clamp)
    - [`TextureNodeMath.is_registered_node_type()`](#bpy.types.TextureNodeMath.is_registered_node_type)
    - [`TextureNodeMath.input_template()`](#bpy.types.TextureNodeMath.input_template)
    - [`TextureNodeMath.output_template()`](#bpy.types.TextureNodeMath.output_template)
    - [`TextureNodeMath.bl_rna_get_subclass()`](#bpy.types.TextureNodeMath.bl_rna_get_subclass)
    - [`TextureNodeMath.bl_rna_get_subclass_py()`](#bpy.types.TextureNodeMath.bl_rna_get_subclass_py)
