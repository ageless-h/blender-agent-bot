...
# PythonConstraint(Constraint)[#](#pythonconstraint-constraint "Link to this heading")
...
*class* bpy.types.PythonConstraint(*Constraint*)[#](#bpy.types.PythonConstraint "Link to this definition")
:   Use Python script for constraint evaluation

    has\_script\_error[#](#bpy.types.PythonConstraint.has_script_error "Link to this definition")
    :   The linked Python script has thrown an error

        Type:
        :   boolean, default False, (readonly)

    target\_count[#](#bpy.types.PythonConstraint.target_count "Link to this definition")
    :   Usually only 1 to 3 are needed

        Type:
        :   int in [-inf, inf], default 0

    targets[#](#bpy.types.PythonConstraint.targets "Link to this definition")
    :   Target Objects

        Type:
        :   [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`ConstraintTarget`](ConstraintTarget.md#bpy.types.ConstraintTarget "bpy.types.ConstraintTarget"), (readonly)

    text[#](#bpy.types.PythonConstraint.text "Link to this definition")
    :   The text object that contains the Python script

        Type:
        :   [`Text`](Text.md#bpy.types.Text "bpy.types.Text")

    use\_targets[#](#bpy.types.PythonConstraint.use_targets "Link to this definition")
    :   Use the targets indicated in the constraint panel

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.PythonConstraint.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.PythonConstraint.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.PythonConstraint.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.PythonConstraint.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* PythonConstraint(Constraint)
  + [`PythonConstraint`](#bpy.types.PythonConstraint)
    - [`PythonConstraint.has_script_error`](#bpy.types.PythonConstraint.has_script_error)
    - [`PythonConstraint.target_count`](#bpy.types.PythonConstraint.target_count)
    - [`PythonConstraint.targets`](#bpy.types.PythonConstraint.targets)
    - [`PythonConstraint.text`](#bpy.types.PythonConstraint.text)
    - [`PythonConstraint.use_targets`](#bpy.types.PythonConstraint.use_targets)
    - [`PythonConstraint.bl_rna_get_subclass()`](#bpy.types.PythonConstraint.bl_rna_get_subclass)
    - [`PythonConstraint.bl_rna_get_subclass_py()`](#bpy.types.PythonConstraint.bl_rna_get_subclass_py)
