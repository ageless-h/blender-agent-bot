...
# GeometryNodeMeshBoolean(GeometryNode)[#](#geometrynodemeshboolean-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeMeshBoolean(*GeometryNode*)[#](#bpy.types.GeometryNodeMeshBoolean "Link to this definition")
:   Cut, subtract, or join multiple mesh inputs

    operation[#](#bpy.types.GeometryNodeMeshBoolean.operation "Link to this definition")
    :   * `INTERSECT`
        ...
        * `DIFFERENCE`
        ...
        Type:
        :   enum in [‘INTERSECT’, ‘UNION’, ‘DIFFERENCE’], default ‘INTERSECT’

    solver[#](#bpy.types.GeometryNodeMeshBoolean.solver "Link to this definition")
    :   * `EXACT`
          Exact – Exact solver for the best results.
        * `FLOAT`
          Float – Simple solver for the best performance, without support for overlapping geometry.

        Type:
        :   enum in [‘EXACT’, ‘FLOAT’], default ‘FLOAT’

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.GeometryNodeMeshBoolean.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.GeometryNodeMeshBoolean.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.GeometryNodeMeshBoolean.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.GeometryNodeMeshBoolean.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.GeometryNodeMeshBoolean.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeMeshBoolean.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.GeometryNodeMeshBoolean.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeMeshBoolean(GeometryNode)
  + [`GeometryNodeMeshBoolean`](#bpy.types.GeometryNodeMeshBoolean)
    - [`GeometryNodeMeshBoolean.operation`](#bpy.types.GeometryNodeMeshBoolean.operation)
    - [`GeometryNodeMeshBoolean.solver`](#bpy.types.GeometryNodeMeshBoolean.solver)
    - [`GeometryNodeMeshBoolean.is_registered_node_type()`](#bpy.types.GeometryNodeMeshBoolean.is_registered_node_type)
    - [`GeometryNodeMeshBoolean.input_template()`](#bpy.types.GeometryNodeMeshBoolean.input_template)
    - [`GeometryNodeMeshBoolean.output_template()`](#bpy.types.GeometryNodeMeshBoolean.output_template)
    - [`GeometryNodeMeshBoolean.bl_rna_get_subclass()`](#bpy.types.GeometryNodeMeshBoolean.bl_rna_get_subclass)
    - [`GeometryNodeMeshBoolean.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeMeshBoolean.bl_rna_get_subclass_py)
