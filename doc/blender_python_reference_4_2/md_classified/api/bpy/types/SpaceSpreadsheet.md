...
:   Spreadsheet space data
    ...
    columns[#](#bpy.types.SpaceSpreadsheet.columns "Link to this definition")
    :   Persistent data associated with spreadsheet columns

        Type:
        :   [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`SpreadsheetColumn`](SpreadsheetColumn.md#bpy.types.SpreadsheetColumn "bpy.types.SpreadsheetColumn"), (readonly)

    display\_viewer\_path\_collapsed[#](#bpy.types.SpaceSpreadsheet.display_viewer_path_collapsed "Link to this definition")
    :   Type:
    ...
    :   * `EVALUATED`
        ...
        * `VIEWER_NODE`
        ...
        Type:
        :   enum in [‘EVALUATED’, ‘ORIGINAL’, ‘VIEWER\_NODE’], default ‘EVALUATED’
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.SpaceSpreadsheet.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.SpaceSpreadsheet.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)
...
* SpaceSpreadsheet(Space)
  + [`SpaceSpreadsheet`](#bpy.types.SpaceSpreadsheet)
    ...
    - [`SpaceSpreadsheet.columns`](#bpy.types.SpaceSpreadsheet.columns)
    - [`SpaceSpreadsheet.display_viewer_path_collapsed`](#bpy.types.SpaceSpreadsheet.display_viewer_path_collapsed)
