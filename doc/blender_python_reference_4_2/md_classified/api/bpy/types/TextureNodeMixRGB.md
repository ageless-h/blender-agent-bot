...
# TextureNodeMixRGB(TextureNode)[#](#texturenodemixrgb-texturenode "Link to this heading")

base classes — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct"), [`Node`](Node.md#bpy.types.Node "bpy.types.Node"), [`NodeInternal`](NodeInternal.md#bpy.types.NodeInternal "bpy.types.NodeInternal"), [`TextureNode`](TextureNode.md#bpy.types.TextureNode "bpy.types.TextureNode")

*class* bpy.types.TextureNodeMixRGB(*TextureNode*)[#](#bpy.types.TextureNodeMixRGB "Link to this definition")
:   blend\_type[#](#bpy.types.TextureNodeMixRGB.blend_type "Link to this definition")
    :   Type:
        :   enum in [Ramp Blend Items](../../../appendix/bpy_types_enum_items/ramp_blend_items.md#rna-enum-ramp-blend-items), default ‘MIX’

    use\_alpha[#](#bpy.types.TextureNodeMixRGB.use_alpha "Link to this definition")
    :   Include alpha of second input in this operation

        Type:
        :   boolean, default False

    use\_clamp[#](#bpy.types.TextureNodeMixRGB.use_clamp "Link to this definition")
    :   Clamp result of the node to 0.0 to 1.0 range

        Type:
        :   boolean, default False

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.TextureNodeMixRGB.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.TextureNodeMixRGB.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.TextureNodeMixRGB.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.TextureNodeMixRGB.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.TextureNodeMixRGB.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.TextureNodeMixRGB.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.TextureNodeMixRGB.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* TextureNodeMixRGB(TextureNode)
  + [`TextureNodeMixRGB`](#bpy.types.TextureNodeMixRGB)
    - [`TextureNodeMixRGB.blend_type`](#bpy.types.TextureNodeMixRGB.blend_type)
    - [`TextureNodeMixRGB.use_alpha`](#bpy.types.TextureNodeMixRGB.use_alpha)
    - [`TextureNodeMixRGB.use_clamp`](#bpy.types.TextureNodeMixRGB.use_clamp)
    - [`TextureNodeMixRGB.is_registered_node_type()`](#bpy.types.TextureNodeMixRGB.is_registered_node_type)
    - [`TextureNodeMixRGB.input_template()`](#bpy.types.TextureNodeMixRGB.input_template)
    - [`TextureNodeMixRGB.output_template()`](#bpy.types.TextureNodeMixRGB.output_template)
    - [`TextureNodeMixRGB.bl_rna_get_subclass()`](#bpy.types.TextureNodeMixRGB.bl_rna_get_subclass)
    - [`TextureNodeMixRGB.bl_rna_get_subclass_py()`](#bpy.types.TextureNodeMixRGB.bl_rna_get_subclass_py)
