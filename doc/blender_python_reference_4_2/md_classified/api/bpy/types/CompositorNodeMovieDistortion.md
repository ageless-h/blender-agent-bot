...
# CompositorNodeMovieDistortion(CompositorNode)[#](#compositornodemoviedistortion-compositornode "Link to this heading")
...
*class* bpy.types.CompositorNodeMovieDistortion(*CompositorNode*)[#](#bpy.types.CompositorNodeMovieDistortion "Link to this definition")
:   Remove lens distortion from footage, using motion tracking camera lens settings

    clip[#](#bpy.types.CompositorNodeMovieDistortion.clip "Link to this definition")
    :   Type:
        :   [`MovieClip`](MovieClip.md#bpy.types.MovieClip "bpy.types.MovieClip")

    distortion\_type[#](#bpy.types.CompositorNodeMovieDistortion.distortion_type "Link to this definition")
    :   Distortion to use to filter image

        Type:
        :   enum in [‘UNDISTORT’, ‘DISTORT’], default ‘UNDISTORT’

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.CompositorNodeMovieDistortion.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.CompositorNodeMovieDistortion.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.CompositorNodeMovieDistortion.output_template "Link to this definition")
    ...
    update()[#](#bpy.types.CompositorNodeMovieDistortion.update "Link to this definition")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.CompositorNodeMovieDistortion.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.CompositorNodeMovieDistortion.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CompositorNodeMovieDistortion.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.CompositorNodeMovieDistortion.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CompositorNodeMovieDistortion(CompositorNode)
  + [`CompositorNodeMovieDistortion`](#bpy.types.CompositorNodeMovieDistortion)
    - [`CompositorNodeMovieDistortion.clip`](#bpy.types.CompositorNodeMovieDistortion.clip)
    - [`CompositorNodeMovieDistortion.distortion_type`](#bpy.types.CompositorNodeMovieDistortion.distortion_type)
    - [`CompositorNodeMovieDistortion.is_registered_node_type()`](#bpy.types.CompositorNodeMovieDistortion.is_registered_node_type)
    - [`CompositorNodeMovieDistortion.input_template()`](#bpy.types.CompositorNodeMovieDistortion.input_template)
    - [`CompositorNodeMovieDistortion.output_template()`](#bpy.types.CompositorNodeMovieDistortion.output_template)
    - [`CompositorNodeMovieDistortion.update()`](#bpy.types.CompositorNodeMovieDistortion.update)
    - [`CompositorNodeMovieDistortion.bl_rna_get_subclass()`](#bpy.types.CompositorNodeMovieDistortion.bl_rna_get_subclass)
    - [`CompositorNodeMovieDistortion.bl_rna_get_subclass_py()`](#bpy.types.CompositorNodeMovieDistortion.bl_rna_get_subclass_py)
