...
# TimeGpencilModifierSegment(bpy\_struct)[#](#timegpencilmodifiersegment-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.TimeGpencilModifierSegment(*bpy\_struct*)[#](#bpy.types.TimeGpencilModifierSegment "Link to this definition")
:   Configuration for a single dash segment

    name[#](#bpy.types.TimeGpencilModifierSegment.name "Link to this definition")
    :   Name of the dash segment

        Type:
        :   string, default “”, (never None)

    seg\_end[#](#bpy.types.TimeGpencilModifierSegment.seg_end "Link to this definition")
    :   Last frame of the segment

        Type:
        :   int in [0, 32767], default 2

    seg\_mode[#](#bpy.types.TimeGpencilModifierSegment.seg_mode "Link to this definition")
    :   * `NORMAL`
    ...
    seg\_repeat[#](#bpy.types.TimeGpencilModifierSegment.seg_repeat "Link to this definition")
    :   Number of cycle repeats

        Type:
        :   int in [1, 32767], default 1

    seg\_start[#](#bpy.types.TimeGpencilModifierSegment.seg_start "Link to this definition")
    :   First frame of the segment

        Type:
        :   int in [0, 32767], default 1

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.TimeGpencilModifierSegment.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.TimeGpencilModifierSegment.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`TimeGpencilModifier.segments`](TimeGpencilModifier.md#bpy.types.TimeGpencilModifier.segments "bpy.types.TimeGpencilModifier.segments") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.TimeGpencilModifierSegment.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.TimeGpencilModifierSegment.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* TimeGpencilModifierSegment(bpy\_struct)
  + [`TimeGpencilModifierSegment`](#bpy.types.TimeGpencilModifierSegment)
    - [`TimeGpencilModifierSegment.name`](#bpy.types.TimeGpencilModifierSegment.name)
    - [`TimeGpencilModifierSegment.seg_end`](#bpy.types.TimeGpencilModifierSegment.seg_end)
    - [`TimeGpencilModifierSegment.seg_mode`](#bpy.types.TimeGpencilModifierSegment.seg_mode)
    - [`TimeGpencilModifierSegment.seg_repeat`](#bpy.types.TimeGpencilModifierSegment.seg_repeat)
    - [`TimeGpencilModifierSegment.seg_start`](#bpy.types.TimeGpencilModifierSegment.seg_start)
    - [`TimeGpencilModifierSegment.bl_rna_get_subclass()`](#bpy.types.TimeGpencilModifierSegment.bl_rna_get_subclass)
    - [`TimeGpencilModifierSegment.bl_rna_get_subclass_py()`](#bpy.types.TimeGpencilModifierSegment.bl_rna_get_subclass_py)
