...
# FunctionNodeRotateEuler(FunctionNode)[#](#functionnoderotateeuler-functionnode "Link to this heading")
...
*class* bpy.types.FunctionNodeRotateEuler(*FunctionNode*)[#](#bpy.types.FunctionNodeRotateEuler "Link to this definition")
:   rotation\_type[#](#bpy.types.FunctionNodeRotateEuler.rotation_type "Link to this definition")
    :   Method used to describe the rotation
        ...
        * `EULER`
        ...
        Type:
        :   enum in [‘AXIS\_ANGLE’, ‘EULER’], default ‘EULER’

    space[#](#bpy.types.FunctionNodeRotateEuler.space "Link to this definition")
    :   Base orientation for rotation
        ...
        * `LOCAL`
        ...
        Type:
        :   enum in [‘OBJECT’, ‘LOCAL’], default ‘OBJECT’

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.FunctionNodeRotateEuler.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.FunctionNodeRotateEuler.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.FunctionNodeRotateEuler.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.FunctionNodeRotateEuler.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.FunctionNodeRotateEuler.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.FunctionNodeRotateEuler.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.FunctionNodeRotateEuler.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* FunctionNodeRotateEuler(FunctionNode)
  + [`FunctionNodeRotateEuler`](#bpy.types.FunctionNodeRotateEuler)
    - [`FunctionNodeRotateEuler.rotation_type`](#bpy.types.FunctionNodeRotateEuler.rotation_type)
    - [`FunctionNodeRotateEuler.space`](#bpy.types.FunctionNodeRotateEuler.space)
    - [`FunctionNodeRotateEuler.is_registered_node_type()`](#bpy.types.FunctionNodeRotateEuler.is_registered_node_type)
    - [`FunctionNodeRotateEuler.input_template()`](#bpy.types.FunctionNodeRotateEuler.input_template)
    - [`FunctionNodeRotateEuler.output_template()`](#bpy.types.FunctionNodeRotateEuler.output_template)
    - [`FunctionNodeRotateEuler.bl_rna_get_subclass()`](#bpy.types.FunctionNodeRotateEuler.bl_rna_get_subclass)
    - [`FunctionNodeRotateEuler.bl_rna_get_subclass_py()`](#bpy.types.FunctionNodeRotateEuler.bl_rna_get_subclass_py)
