...
# CompositorNodeBoxMask(CompositorNode)[#](#compositornodeboxmask-compositornode "Link to this heading")
...
*class* bpy.types.CompositorNodeBoxMask(*CompositorNode*)[#](#bpy.types.CompositorNodeBoxMask "Link to this definition")
:   Create rectangular mask suitable for use as a simple matte

    mask\_height[#](#bpy.types.CompositorNodeBoxMask.mask_height "Link to this definition")
    :   Height of the box

        Type:
        :   float in [0, 2], default 0.2

    mask\_type[#](#bpy.types.CompositorNodeBoxMask.mask_type "Link to this definition")
    :   Type:
        :   enum in [‘ADD’, ‘SUBTRACT’, ‘MULTIPLY’, ‘NOT’], default ‘ADD’

    mask\_width[#](#bpy.types.CompositorNodeBoxMask.mask_width "Link to this definition")
    :   Width of the box

        Type:
        :   float in [0, 2], default 0.3

    rotation[#](#bpy.types.CompositorNodeBoxMask.rotation "Link to this definition")
    :   Rotation angle of the box

        Type:
        :   float in [-31.4159, 31.4159], default 0.0

    x[#](#bpy.types.CompositorNodeBoxMask.x "Link to this definition")
    :   X position of the middle of the box

        Type:
        :   float in [-1, 2], default 0.5

    y[#](#bpy.types.CompositorNodeBoxMask.y "Link to this definition")
    :   Y position of the middle of the box

        Type:
        :   float in [-1, 2], default 0.5

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.CompositorNodeBoxMask.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.CompositorNodeBoxMask.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.CompositorNodeBoxMask.output_template "Link to this definition")
    ...
    update()[#](#bpy.types.CompositorNodeBoxMask.update "Link to this definition")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.CompositorNodeBoxMask.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.CompositorNodeBoxMask.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CompositorNodeBoxMask.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.CompositorNodeBoxMask.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CompositorNodeBoxMask(CompositorNode)
  + [`CompositorNodeBoxMask`](#bpy.types.CompositorNodeBoxMask)
    - [`CompositorNodeBoxMask.mask_height`](#bpy.types.CompositorNodeBoxMask.mask_height)
    - [`CompositorNodeBoxMask.mask_type`](#bpy.types.CompositorNodeBoxMask.mask_type)
    - [`CompositorNodeBoxMask.mask_width`](#bpy.types.CompositorNodeBoxMask.mask_width)
    - [`CompositorNodeBoxMask.rotation`](#bpy.types.CompositorNodeBoxMask.rotation)
    - [`CompositorNodeBoxMask.x`](#bpy.types.CompositorNodeBoxMask.x)
    - [`CompositorNodeBoxMask.y`](#bpy.types.CompositorNodeBoxMask.y)
    - [`CompositorNodeBoxMask.is_registered_node_type()`](#bpy.types.CompositorNodeBoxMask.is_registered_node_type)
    - [`CompositorNodeBoxMask.input_template()`](#bpy.types.CompositorNodeBoxMask.input_template)
    - [`CompositorNodeBoxMask.output_template()`](#bpy.types.CompositorNodeBoxMask.output_template)
    - [`CompositorNodeBoxMask.update()`](#bpy.types.CompositorNodeBoxMask.update)
    - [`CompositorNodeBoxMask.bl_rna_get_subclass()`](#bpy.types.CompositorNodeBoxMask.bl_rna_get_subclass)
    - [`CompositorNodeBoxMask.bl_rna_get_subclass_py()`](#bpy.types.CompositorNodeBoxMask.bl_rna_get_subclass_py)
