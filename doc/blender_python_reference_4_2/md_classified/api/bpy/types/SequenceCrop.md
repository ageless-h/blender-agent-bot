...
# SequenceCrop(bpy\_struct)[#](#sequencecrop-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.SequenceCrop(*bpy\_struct*)[#](#bpy.types.SequenceCrop "Link to this definition")
:   Cropping parameters for a sequence strip

    max\_x[#](#bpy.types.SequenceCrop.max_x "Link to this definition")
    :   Number of pixels to crop from the right side

        Type:
        :   int in [-inf, inf], default 0

    max\_y[#](#bpy.types.SequenceCrop.max_y "Link to this definition")
    :   Number of pixels to crop from the top

        Type:
        :   int in [-inf, inf], default 0

    min\_x[#](#bpy.types.SequenceCrop.min_x "Link to this definition")
    :   Number of pixels to crop from the left side

        Type:
        :   int in [-inf, inf], default 0

    min\_y[#](#bpy.types.SequenceCrop.min_y "Link to this definition")
    :   Number of pixels to crop from the bottom

        Type:
        :   int in [-inf, inf], default 0

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.SequenceCrop.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.SequenceCrop.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`EffectSequence.crop`](EffectSequence.md#bpy.types.EffectSequence.crop "bpy.types.EffectSequence.crop") * [`ImageSequence.crop`](ImageSequence.md#bpy.types.ImageSequence.crop "bpy.types.ImageSequence.crop") * [`MaskSequence.crop`](MaskSequence.md#bpy.types.MaskSequence.crop "bpy.types.MaskSequence.crop") * [`MetaSequence.crop`](MetaSequence.md#bpy.types.MetaSequence.crop "bpy.types.MetaSequence.crop") | * [`MovieClipSequence.crop`](MovieClipSequence.md#bpy.types.MovieClipSequence.crop "bpy.types.MovieClipSequence.crop") * [`MovieSequence.crop`](MovieSequence.md#bpy.types.MovieSequence.crop "bpy.types.MovieSequence.crop") * [`SceneSequence.crop`](SceneSequence.md#bpy.types.SceneSequence.crop "bpy.types.SceneSequence.crop") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.SequenceCrop.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.SequenceCrop.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* SequenceCrop(bpy\_struct)
  + [`SequenceCrop`](#bpy.types.SequenceCrop)
    - [`SequenceCrop.max_x`](#bpy.types.SequenceCrop.max_x)
    - [`SequenceCrop.max_y`](#bpy.types.SequenceCrop.max_y)
    - [`SequenceCrop.min_x`](#bpy.types.SequenceCrop.min_x)
    - [`SequenceCrop.min_y`](#bpy.types.SequenceCrop.min_y)
    - [`SequenceCrop.bl_rna_get_subclass()`](#bpy.types.SequenceCrop.bl_rna_get_subclass)
    - [`SequenceCrop.bl_rna_get_subclass_py()`](#bpy.types.SequenceCrop.bl_rna_get_subclass_py)
