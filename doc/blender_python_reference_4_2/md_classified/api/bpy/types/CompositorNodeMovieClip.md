...
# CompositorNodeMovieClip(CompositorNode)[#](#compositornodemovieclip-compositornode "Link to this heading")
...
*class* bpy.types.CompositorNodeMovieClip(*CompositorNode*)[#](#bpy.types.CompositorNodeMovieClip "Link to this definition")
:   Input image or movie from a movie clip datablock, typically used for motion tracking

    clip[#](#bpy.types.CompositorNodeMovieClip.clip "Link to this definition")
    :   Type:
        :   [`MovieClip`](MovieClip.md#bpy.types.MovieClip "bpy.types.MovieClip")

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.CompositorNodeMovieClip.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.CompositorNodeMovieClip.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.CompositorNodeMovieClip.output_template "Link to this definition")
    ...
    update()[#](#bpy.types.CompositorNodeMovieClip.update "Link to this definition")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.CompositorNodeMovieClip.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.CompositorNodeMovieClip.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CompositorNodeMovieClip.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.CompositorNodeMovieClip.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CompositorNodeMovieClip(CompositorNode)
  + [`CompositorNodeMovieClip`](#bpy.types.CompositorNodeMovieClip)
    - [`CompositorNodeMovieClip.clip`](#bpy.types.CompositorNodeMovieClip.clip)
    - [`CompositorNodeMovieClip.is_registered_node_type()`](#bpy.types.CompositorNodeMovieClip.is_registered_node_type)
    - [`CompositorNodeMovieClip.input_template()`](#bpy.types.CompositorNodeMovieClip.input_template)
    - [`CompositorNodeMovieClip.output_template()`](#bpy.types.CompositorNodeMovieClip.output_template)
    - [`CompositorNodeMovieClip.update()`](#bpy.types.CompositorNodeMovieClip.update)
    - [`CompositorNodeMovieClip.bl_rna_get_subclass()`](#bpy.types.CompositorNodeMovieClip.bl_rna_get_subclass)
    - [`CompositorNodeMovieClip.bl_rna_get_subclass_py()`](#bpy.types.CompositorNodeMovieClip.bl_rna_get_subclass_py)
