...
# FModifierPython(FModifier)[#](#fmodifierpython-fmodifier "Link to this heading")
...
*class* bpy.types.FModifierPython(*FModifier*)[#](#bpy.types.FModifierPython "Link to this definition")
:   Perform user-defined operation on the modified F-Curve

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.FModifierPython.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.FModifierPython.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.FModifierPython.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.FModifierPython.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* FModifierPython(FModifier)
  + [`FModifierPython`](#bpy.types.FModifierPython)
    - [`FModifierPython.bl_rna_get_subclass()`](#bpy.types.FModifierPython.bl_rna_get_subclass)
    - [`FModifierPython.bl_rna_get_subclass_py()`](#bpy.types.FModifierPython.bl_rna_get_subclass_py)
