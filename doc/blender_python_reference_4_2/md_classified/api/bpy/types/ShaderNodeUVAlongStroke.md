...
# ShaderNodeUVAlongStroke(ShaderNode)[#](#shadernodeuvalongstroke-shadernode "Link to this heading")
...
*class* bpy.types.ShaderNodeUVAlongStroke(*ShaderNode*)[#](#bpy.types.ShaderNodeUVAlongStroke "Link to this definition")
:   use\_tips[#](#bpy.types.ShaderNodeUVAlongStroke.use_tips "Link to this definition")
    :   Lower half of the texture is for tips of the stroke

        Type:
        :   boolean, default False

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.ShaderNodeUVAlongStroke.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.ShaderNodeUVAlongStroke.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.ShaderNodeUVAlongStroke.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.ShaderNodeUVAlongStroke.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.ShaderNodeUVAlongStroke.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ShaderNodeUVAlongStroke.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.ShaderNodeUVAlongStroke.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ShaderNodeUVAlongStroke(ShaderNode)
  + [`ShaderNodeUVAlongStroke`](#bpy.types.ShaderNodeUVAlongStroke)
    - [`ShaderNodeUVAlongStroke.use_tips`](#bpy.types.ShaderNodeUVAlongStroke.use_tips)
    - [`ShaderNodeUVAlongStroke.is_registered_node_type()`](#bpy.types.ShaderNodeUVAlongStroke.is_registered_node_type)
    - [`ShaderNodeUVAlongStroke.input_template()`](#bpy.types.ShaderNodeUVAlongStroke.input_template)
    - [`ShaderNodeUVAlongStroke.output_template()`](#bpy.types.ShaderNodeUVAlongStroke.output_template)
    - [`ShaderNodeUVAlongStroke.bl_rna_get_subclass()`](#bpy.types.ShaderNodeUVAlongStroke.bl_rna_get_subclass)
    - [`ShaderNodeUVAlongStroke.bl_rna_get_subclass_py()`](#bpy.types.ShaderNodeUVAlongStroke.bl_rna_get_subclass_py)
