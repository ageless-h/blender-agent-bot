...
# DashGpencilModifierSegment(bpy\_struct)[#](#dashgpencilmodifiersegment-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.DashGpencilModifierSegment(*bpy\_struct*)[#](#bpy.types.DashGpencilModifierSegment "Link to this definition")
:   Configuration for a single dash segment

    dash[#](#bpy.types.DashGpencilModifierSegment.dash "Link to this definition")
    :   The number of consecutive points from the original stroke to include in this segment

        Type:
        :   int in [1, 32767], default 2

    gap[#](#bpy.types.DashGpencilModifierSegment.gap "Link to this definition")
    :   The number of points skipped after this segment

        Type:
        :   int in [0, 32767], default 1

    material\_index[#](#bpy.types.DashGpencilModifierSegment.material_index "Link to this definition")
    :   Use this index on generated segment. -1 means using the existing material

        Type:
        :   int in [-1, 32767], default -1

    name[#](#bpy.types.DashGpencilModifierSegment.name "Link to this definition")
    :   Name of the dash segment

        Type:
        :   string, default “”, (never None)

    opacity[#](#bpy.types.DashGpencilModifierSegment.opacity "Link to this definition")
    :   The factor to apply to the original point’s opacity for the new points

        Type:
        :   float in [0, 1], default 1.0

    radius[#](#bpy.types.DashGpencilModifierSegment.radius "Link to this definition")
    :   The factor to apply to the original point’s radius for the new points

        Type:
        :   float in [0, 1], default 1.0

    use\_cyclic[#](#bpy.types.DashGpencilModifierSegment.use_cyclic "Link to this definition")
    :   Enable cyclic on individual stroke dashes

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.DashGpencilModifierSegment.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.DashGpencilModifierSegment.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`DashGpencilModifierData.segments`](DashGpencilModifierData.md#bpy.types.DashGpencilModifierData.segments "bpy.types.DashGpencilModifierData.segments") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.DashGpencilModifierSegment.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.DashGpencilModifierSegment.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* DashGpencilModifierSegment(bpy\_struct)
  + [`DashGpencilModifierSegment`](#bpy.types.DashGpencilModifierSegment)
    - [`DashGpencilModifierSegment.dash`](#bpy.types.DashGpencilModifierSegment.dash)
    - [`DashGpencilModifierSegment.gap`](#bpy.types.DashGpencilModifierSegment.gap)
    - [`DashGpencilModifierSegment.material_index`](#bpy.types.DashGpencilModifierSegment.material_index)
    - [`DashGpencilModifierSegment.name`](#bpy.types.DashGpencilModifierSegment.name)
    - [`DashGpencilModifierSegment.opacity`](#bpy.types.DashGpencilModifierSegment.opacity)
    - [`DashGpencilModifierSegment.radius`](#bpy.types.DashGpencilModifierSegment.radius)
    - [`DashGpencilModifierSegment.use_cyclic`](#bpy.types.DashGpencilModifierSegment.use_cyclic)
    - [`DashGpencilModifierSegment.bl_rna_get_subclass()`](#bpy.types.DashGpencilModifierSegment.bl_rna_get_subclass)
    - [`DashGpencilModifierSegment.bl_rna_get_subclass_py()`](#bpy.types.DashGpencilModifierSegment.bl_rna_get_subclass_py)
