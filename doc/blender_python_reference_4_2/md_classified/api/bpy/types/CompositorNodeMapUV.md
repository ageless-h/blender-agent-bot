...
# CompositorNodeMapUV(CompositorNode)[#](#compositornodemapuv-compositornode "Link to this heading")
...
*class* bpy.types.CompositorNodeMapUV(*CompositorNode*)[#](#bpy.types.CompositorNodeMapUV "Link to this definition")
:   Map a texture using UV coordinates, to apply a texture to objects in compositing

    alpha[#](#bpy.types.CompositorNodeMapUV.alpha "Link to this definition")
    :   Type:
        :   int in [0, 100], default 0

    filter\_type[#](#bpy.types.CompositorNodeMapUV.filter_type "Link to this definition")
    :   Type:
        :   enum in [‘NEAREST’, ‘ANISOTROPIC’], default ‘NEAREST’

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.CompositorNodeMapUV.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.CompositorNodeMapUV.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.CompositorNodeMapUV.output_template "Link to this definition")
    ...
    update()[#](#bpy.types.CompositorNodeMapUV.update "Link to this definition")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.CompositorNodeMapUV.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.CompositorNodeMapUV.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CompositorNodeMapUV.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.CompositorNodeMapUV.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CompositorNodeMapUV(CompositorNode)
  + [`CompositorNodeMapUV`](#bpy.types.CompositorNodeMapUV)
    - [`CompositorNodeMapUV.alpha`](#bpy.types.CompositorNodeMapUV.alpha)
    - [`CompositorNodeMapUV.filter_type`](#bpy.types.CompositorNodeMapUV.filter_type)
    - [`CompositorNodeMapUV.is_registered_node_type()`](#bpy.types.CompositorNodeMapUV.is_registered_node_type)
    - [`CompositorNodeMapUV.input_template()`](#bpy.types.CompositorNodeMapUV.input_template)
    - [`CompositorNodeMapUV.output_template()`](#bpy.types.CompositorNodeMapUV.output_template)
    - [`CompositorNodeMapUV.update()`](#bpy.types.CompositorNodeMapUV.update)
    - [`CompositorNodeMapUV.bl_rna_get_subclass()`](#bpy.types.CompositorNodeMapUV.bl_rna_get_subclass)
    - [`CompositorNodeMapUV.bl_rna_get_subclass_py()`](#bpy.types.CompositorNodeMapUV.bl_rna_get_subclass_py)
