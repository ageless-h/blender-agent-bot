...
# ShaderNodeTexEnvironment(ShaderNode)[#](#shadernodetexenvironment-shadernode "Link to this heading")
...
*class* bpy.types.ShaderNodeTexEnvironment(*ShaderNode*)[#](#bpy.types.ShaderNodeTexEnvironment "Link to this definition")
:   Sample an image file as an environment texture. Typically used to light the scene with the background node

    color\_mapping[#](#bpy.types.ShaderNodeTexEnvironment.color_mapping "Link to this definition")
    :   Color mapping settings

        Type:
        :   [`ColorMapping`](ColorMapping.md#bpy.types.ColorMapping "bpy.types.ColorMapping"), (readonly, never None)

    image[#](#bpy.types.ShaderNodeTexEnvironment.image "Link to this definition")
    :   Type:
        :   [`Image`](Image.md#bpy.types.Image "bpy.types.Image")

    image\_user[#](#bpy.types.ShaderNodeTexEnvironment.image_user "Link to this definition")
    :   Parameters defining which layer, pass and frame of the image is displayed

        Type:
        :   [`ImageUser`](ImageUser.md#bpy.types.ImageUser "bpy.types.ImageUser"), (readonly, never None)

    interpolation[#](#bpy.types.ShaderNodeTexEnvironment.interpolation "Link to this definition")
    ...
    projection[#](#bpy.types.ShaderNodeTexEnvironment.projection "Link to this definition")
    :   Projection of the input image
        ...
        * `MIRROR_BALL`
        ...
        Type:
        :   enum in [‘EQUIRECTANGULAR’, ‘MIRROR\_BALL’], default ‘EQUIRECTANGULAR’

    texture\_mapping[#](#bpy.types.ShaderNodeTexEnvironment.texture_mapping "Link to this definition")
    :   Texture coordinate mapping settings

        Type:
        :   [`TexMapping`](TexMapping.md#bpy.types.TexMapping "bpy.types.TexMapping"), (readonly, never None)

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.ShaderNodeTexEnvironment.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.ShaderNodeTexEnvironment.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.ShaderNodeTexEnvironment.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.ShaderNodeTexEnvironment.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.ShaderNodeTexEnvironment.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ShaderNodeTexEnvironment.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.ShaderNodeTexEnvironment.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ShaderNodeTexEnvironment(ShaderNode)
  + [`ShaderNodeTexEnvironment`](#bpy.types.ShaderNodeTexEnvironment)
    - [`ShaderNodeTexEnvironment.color_mapping`](#bpy.types.ShaderNodeTexEnvironment.color_mapping)
    - [`ShaderNodeTexEnvironment.image`](#bpy.types.ShaderNodeTexEnvironment.image)
    - [`ShaderNodeTexEnvironment.image_user`](#bpy.types.ShaderNodeTexEnvironment.image_user)
    - [`ShaderNodeTexEnvironment.interpolation`](#bpy.types.ShaderNodeTexEnvironment.interpolation)
    - [`ShaderNodeTexEnvironment.projection`](#bpy.types.ShaderNodeTexEnvironment.projection)
    - [`ShaderNodeTexEnvironment.texture_mapping`](#bpy.types.ShaderNodeTexEnvironment.texture_mapping)
    - [`ShaderNodeTexEnvironment.is_registered_node_type()`](#bpy.types.ShaderNodeTexEnvironment.is_registered_node_type)
    - [`ShaderNodeTexEnvironment.input_template()`](#bpy.types.ShaderNodeTexEnvironment.input_template)
    - [`ShaderNodeTexEnvironment.output_template()`](#bpy.types.ShaderNodeTexEnvironment.output_template)
    - [`ShaderNodeTexEnvironment.bl_rna_get_subclass()`](#bpy.types.ShaderNodeTexEnvironment.bl_rna_get_subclass)
    - [`ShaderNodeTexEnvironment.bl_rna_get_subclass_py()`](#bpy.types.ShaderNodeTexEnvironment.bl_rna_get_subclass_py)
