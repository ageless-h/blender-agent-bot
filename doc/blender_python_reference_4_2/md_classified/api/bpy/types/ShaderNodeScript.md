...
# ShaderNodeScript(ShaderNode)[#](#shadernodescript-shadernode "Link to this heading")
...
*class* bpy.types.ShaderNodeScript(*ShaderNode*)[#](#bpy.types.ShaderNodeScript "Link to this definition")
:   Generate an OSL shader from a file or text data-block.
    Note: OSL shaders are not supported on all GPU backends

    bytecode[#](#bpy.types.ShaderNodeScript.bytecode "Link to this definition")
    :   Compile bytecode for shader script node

        Type:
        :   string, default “”, (never None)

    bytecode\_hash[#](#bpy.types.ShaderNodeScript.bytecode_hash "Link to this definition")
    :   Hash of compile bytecode, for quick equality checking

        Type:
        :   string, default “”, (never None)

    filepath[#](#bpy.types.ShaderNodeScript.filepath "Link to this definition")
    :   Shader script path

        Type:
        :   string, default “”, (never None)

    mode[#](#bpy.types.ShaderNodeScript.mode "Link to this definition")
    :   * `INTERNAL`
    ...
    script[#](#bpy.types.ShaderNodeScript.script "Link to this definition")
    :   Internal shader script to define the shader

        Type:
        :   [`Text`](Text.md#bpy.types.Text "bpy.types.Text")

    use\_auto\_update[#](#bpy.types.ShaderNodeScript.use_auto_update "Link to this definition")
    :   Automatically update the shader when the .osl file changes (external scripts only)

        Type:
        :   boolean, default False

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.ShaderNodeScript.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.ShaderNodeScript.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.ShaderNodeScript.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.ShaderNodeScript.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.ShaderNodeScript.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ShaderNodeScript.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.ShaderNodeScript.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ShaderNodeScript(ShaderNode)
  + [`ShaderNodeScript`](#bpy.types.ShaderNodeScript)
    - [`ShaderNodeScript.bytecode`](#bpy.types.ShaderNodeScript.bytecode)
    - [`ShaderNodeScript.bytecode_hash`](#bpy.types.ShaderNodeScript.bytecode_hash)
    - [`ShaderNodeScript.filepath`](#bpy.types.ShaderNodeScript.filepath)
    - [`ShaderNodeScript.mode`](#bpy.types.ShaderNodeScript.mode)
    - [`ShaderNodeScript.script`](#bpy.types.ShaderNodeScript.script)
    - [`ShaderNodeScript.use_auto_update`](#bpy.types.ShaderNodeScript.use_auto_update)
    - [`ShaderNodeScript.is_registered_node_type()`](#bpy.types.ShaderNodeScript.is_registered_node_type)
    - [`ShaderNodeScript.input_template()`](#bpy.types.ShaderNodeScript.input_template)
    - [`ShaderNodeScript.output_template()`](#bpy.types.ShaderNodeScript.output_template)
    - [`ShaderNodeScript.bl_rna_get_subclass()`](#bpy.types.ShaderNodeScript.bl_rna_get_subclass)
    - [`ShaderNodeScript.bl_rna_get_subclass_py()`](#bpy.types.ShaderNodeScript.bl_rna_get_subclass_py)
