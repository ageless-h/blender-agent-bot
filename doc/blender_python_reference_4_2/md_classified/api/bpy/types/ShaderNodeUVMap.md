...
# ShaderNodeUVMap(ShaderNode)[#](#shadernodeuvmap-shadernode "Link to this heading")
...
*class* bpy.types.ShaderNodeUVMap(*ShaderNode*)[#](#bpy.types.ShaderNodeUVMap "Link to this definition")
:   Retrieve a UV map from the geometry, or the default fallback if none is specified

    from\_instancer[#](#bpy.types.ShaderNodeUVMap.from_instancer "Link to this definition")
    :   Use the parent of the instance object if possible

        Type:
        :   boolean, default False

    uv\_map[#](#bpy.types.ShaderNodeUVMap.uv_map "Link to this definition")
    :   UV coordinates to be used for mapping

        Type:
        :   string, default “”, (never None)

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.ShaderNodeUVMap.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.ShaderNodeUVMap.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.ShaderNodeUVMap.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.ShaderNodeUVMap.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.ShaderNodeUVMap.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ShaderNodeUVMap.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.ShaderNodeUVMap.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ShaderNodeUVMap(ShaderNode)
  + [`ShaderNodeUVMap`](#bpy.types.ShaderNodeUVMap)
    - [`ShaderNodeUVMap.from_instancer`](#bpy.types.ShaderNodeUVMap.from_instancer)
    - [`ShaderNodeUVMap.uv_map`](#bpy.types.ShaderNodeUVMap.uv_map)
    - [`ShaderNodeUVMap.is_registered_node_type()`](#bpy.types.ShaderNodeUVMap.is_registered_node_type)
    - [`ShaderNodeUVMap.input_template()`](#bpy.types.ShaderNodeUVMap.input_template)
    - [`ShaderNodeUVMap.output_template()`](#bpy.types.ShaderNodeUVMap.output_template)
    - [`ShaderNodeUVMap.bl_rna_get_subclass()`](#bpy.types.ShaderNodeUVMap.bl_rna_get_subclass)
    - [`ShaderNodeUVMap.bl_rna_get_subclass_py()`](#bpy.types.ShaderNodeUVMap.bl_rna_get_subclass_py)
