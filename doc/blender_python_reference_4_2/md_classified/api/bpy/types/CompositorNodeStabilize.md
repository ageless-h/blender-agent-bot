...
# CompositorNodeStabilize(CompositorNode)[#](#compositornodestabilize-compositornode "Link to this heading")
...
*class* bpy.types.CompositorNodeStabilize(*CompositorNode*)[#](#bpy.types.CompositorNodeStabilize "Link to this definition")
:   Stabilize footage using 2D stabilization motion tracking settings

    clip[#](#bpy.types.CompositorNodeStabilize.clip "Link to this definition")
    :   Type:
        :   [`MovieClip`](MovieClip.md#bpy.types.MovieClip "bpy.types.MovieClip")

    filter\_type[#](#bpy.types.CompositorNodeStabilize.filter_type "Link to this definition")
    :   Method to use to filter stabilization

        Type:
        :   enum in [‘NEAREST’, ‘BILINEAR’, ‘BICUBIC’], default ‘NEAREST’

    invert[#](#bpy.types.CompositorNodeStabilize.invert "Link to this definition")
    :   Invert stabilization to re-introduce motion to the frame

        Type:
        :   boolean, default False

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.CompositorNodeStabilize.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.CompositorNodeStabilize.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.CompositorNodeStabilize.output_template "Link to this definition")
    ...
    update()[#](#bpy.types.CompositorNodeStabilize.update "Link to this definition")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.CompositorNodeStabilize.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.CompositorNodeStabilize.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CompositorNodeStabilize.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.CompositorNodeStabilize.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CompositorNodeStabilize(CompositorNode)
  + [`CompositorNodeStabilize`](#bpy.types.CompositorNodeStabilize)
    - [`CompositorNodeStabilize.clip`](#bpy.types.CompositorNodeStabilize.clip)
    - [`CompositorNodeStabilize.filter_type`](#bpy.types.CompositorNodeStabilize.filter_type)
    - [`CompositorNodeStabilize.invert`](#bpy.types.CompositorNodeStabilize.invert)
    - [`CompositorNodeStabilize.is_registered_node_type()`](#bpy.types.CompositorNodeStabilize.is_registered_node_type)
    - [`CompositorNodeStabilize.input_template()`](#bpy.types.CompositorNodeStabilize.input_template)
    - [`CompositorNodeStabilize.output_template()`](#bpy.types.CompositorNodeStabilize.output_template)
    - [`CompositorNodeStabilize.update()`](#bpy.types.CompositorNodeStabilize.update)
    - [`CompositorNodeStabilize.bl_rna_get_subclass()`](#bpy.types.CompositorNodeStabilize.bl_rna_get_subclass)
    - [`CompositorNodeStabilize.bl_rna_get_subclass_py()`](#bpy.types.CompositorNodeStabilize.bl_rna_get_subclass_py)
