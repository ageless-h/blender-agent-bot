...
# ShaderNodeFresnel(ShaderNode)[#](#shadernodefresnel-shadernode "Link to this heading")
...
*class* bpy.types.ShaderNodeFresnel(*ShaderNode*)[#](#bpy.types.ShaderNodeFresnel "Link to this definition")
:   Produce a blending factor depending on the angle between the surface normal and the view direction using Fresnel equations.
    ...
    *classmethod* is\_registered\_node\_type()[#](#bpy.types.ShaderNodeFresnel.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.ShaderNodeFresnel.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.ShaderNodeFresnel.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.ShaderNodeFresnel.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.ShaderNodeFresnel.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ShaderNodeFresnel.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.ShaderNodeFresnel.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ShaderNodeFresnel(ShaderNode)
  + [`ShaderNodeFresnel`](#bpy.types.ShaderNodeFresnel)
    - [`ShaderNodeFresnel.is_registered_node_type()`](#bpy.types.ShaderNodeFresnel.is_registered_node_type)
    - [`ShaderNodeFresnel.input_template()`](#bpy.types.ShaderNodeFresnel.input_template)
    - [`ShaderNodeFresnel.output_template()`](#bpy.types.ShaderNodeFresnel.output_template)
    - [`ShaderNodeFresnel.bl_rna_get_subclass()`](#bpy.types.ShaderNodeFresnel.bl_rna_get_subclass)
    - [`ShaderNodeFresnel.bl_rna_get_subclass_py()`](#bpy.types.ShaderNodeFresnel.bl_rna_get_subclass_py)
