...
# CompositorNodeDenoise(CompositorNode)[#](#compositornodedenoise-compositornode "Link to this heading")
...
*class* bpy.types.CompositorNodeDenoise(*CompositorNode*)[#](#bpy.types.CompositorNodeDenoise "Link to this definition")
:   Denoise renders from Cycles and other ray tracing renderers

    prefilter[#](#bpy.types.CompositorNodeDenoise.prefilter "Link to this definition")
    :   Denoising prefilter
    ...
    use\_hdr[#](#bpy.types.CompositorNodeDenoise.use_hdr "Link to this definition")
    :   Process HDR images

        Type:
        :   boolean, default True

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.CompositorNodeDenoise.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.CompositorNodeDenoise.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.CompositorNodeDenoise.output_template "Link to this definition")
    ...
    update()[#](#bpy.types.CompositorNodeDenoise.update "Link to this definition")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.CompositorNodeDenoise.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.CompositorNodeDenoise.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CompositorNodeDenoise.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.CompositorNodeDenoise.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CompositorNodeDenoise(CompositorNode)
  + [`CompositorNodeDenoise`](#bpy.types.CompositorNodeDenoise)
    - [`CompositorNodeDenoise.prefilter`](#bpy.types.CompositorNodeDenoise.prefilter)
    - [`CompositorNodeDenoise.use_hdr`](#bpy.types.CompositorNodeDenoise.use_hdr)
    - [`CompositorNodeDenoise.is_registered_node_type()`](#bpy.types.CompositorNodeDenoise.is_registered_node_type)
    - [`CompositorNodeDenoise.input_template()`](#bpy.types.CompositorNodeDenoise.input_template)
    - [`CompositorNodeDenoise.output_template()`](#bpy.types.CompositorNodeDenoise.output_template)
    - [`CompositorNodeDenoise.update()`](#bpy.types.CompositorNodeDenoise.update)
    - [`CompositorNodeDenoise.bl_rna_get_subclass()`](#bpy.types.CompositorNodeDenoise.bl_rna_get_subclass)
    - [`CompositorNodeDenoise.bl_rna_get_subclass_py()`](#bpy.types.CompositorNodeDenoise.bl_rna_get_subclass_py)
