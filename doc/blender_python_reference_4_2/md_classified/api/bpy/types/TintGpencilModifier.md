...
# TintGpencilModifier(GpencilModifier)[#](#tintgpencilmodifier-gpencilmodifier "Link to this heading")
...
*class* bpy.types.TintGpencilModifier(*GpencilModifier*)[#](#bpy.types.TintGpencilModifier "Link to this definition")
:   Tint modifier

    color[#](#bpy.types.TintGpencilModifier.color "Link to this definition")
    ...
    colors[#](#bpy.types.TintGpencilModifier.colors "Link to this definition")
    :   Color ramp used to define tinting colors

        Type:
        :   [`ColorRamp`](ColorRamp.md#bpy.types.ColorRamp "bpy.types.ColorRamp"), (readonly)

    curve[#](#bpy.types.TintGpencilModifier.curve "Link to this definition")
    :   Custom curve to apply effect

        Type:
        :   [`CurveMapping`](CurveMapping.md#bpy.types.CurveMapping "bpy.types.CurveMapping"), (readonly)

    factor[#](#bpy.types.TintGpencilModifier.factor "Link to this definition")
    :   Factor for tinting

        Type:
        :   float in [0, 2], default 0.5

    invert\_layer\_pass[#](#bpy.types.TintGpencilModifier.invert_layer_pass "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    invert\_layers[#](#bpy.types.TintGpencilModifier.invert_layers "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    invert\_material\_pass[#](#bpy.types.TintGpencilModifier.invert_material_pass "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    invert\_materials[#](#bpy.types.TintGpencilModifier.invert_materials "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    invert\_vertex[#](#bpy.types.TintGpencilModifier.invert_vertex "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    layer[#](#bpy.types.TintGpencilModifier.layer "Link to this definition")
    :   Layer name

        Type:
        :   string, default “”, (never None)

    layer\_pass[#](#bpy.types.TintGpencilModifier.layer_pass "Link to this definition")
    :   Layer pass index

        Type:
        :   int in [0, 100], default 0

    material[#](#bpy.types.TintGpencilModifier.material "Link to this definition")
    :   Material used for filtering effect

        Type:
        :   [`Material`](Material.md#bpy.types.Material "bpy.types.Material")

    object[#](#bpy.types.TintGpencilModifier.object "Link to this definition")
    :   Parent object to define the center of the effect

        Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object")

    pass\_index[#](#bpy.types.TintGpencilModifier.pass_index "Link to this definition")
    :   Pass index

        Type:
        :   int in [0, 100], default 0

    radius[#](#bpy.types.TintGpencilModifier.radius "Link to this definition")
    :   Defines the maximum distance of the effect

        Type:
        :   float in [1e-06, inf], default 1.0

    tint\_type[#](#bpy.types.TintGpencilModifier.tint_type "Link to this definition")
    :   Select type of tinting algorithm

        Type:
        :   enum in [‘UNIFORM’, ‘GRADIENT’], default ‘UNIFORM’

    use\_custom\_curve[#](#bpy.types.TintGpencilModifier.use_custom_curve "Link to this definition")
    :   Use a custom curve to define vertex color effect along the strokes

        Type:
        :   boolean, default False

    use\_weight\_factor[#](#bpy.types.TintGpencilModifier.use_weight_factor "Link to this definition")
    :   Use weight to modulate effect

        Type:
        :   boolean, default False

    vertex\_group[#](#bpy.types.TintGpencilModifier.vertex_group "Link to this definition")
    :   Vertex group name for modulating the deform

        Type:
        :   string, default “”, (never None)

    vertex\_mode[#](#bpy.types.TintGpencilModifier.vertex_mode "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.TintGpencilModifier.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.TintGpencilModifier.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.TintGpencilModifier.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.TintGpencilModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* TintGpencilModifier(GpencilModifier)
  + [`TintGpencilModifier`](#bpy.types.TintGpencilModifier)
    - [`TintGpencilModifier.color`](#bpy.types.TintGpencilModifier.color)
    - [`TintGpencilModifier.colors`](#bpy.types.TintGpencilModifier.colors)
    - [`TintGpencilModifier.curve`](#bpy.types.TintGpencilModifier.curve)
    - [`TintGpencilModifier.factor`](#bpy.types.TintGpencilModifier.factor)
    - [`TintGpencilModifier.invert_layer_pass`](#bpy.types.TintGpencilModifier.invert_layer_pass)
    - [`TintGpencilModifier.invert_layers`](#bpy.types.TintGpencilModifier.invert_layers)
    - [`TintGpencilModifier.invert_material_pass`](#bpy.types.TintGpencilModifier.invert_material_pass)
    - [`TintGpencilModifier.invert_materials`](#bpy.types.TintGpencilModifier.invert_materials)
    - [`TintGpencilModifier.invert_vertex`](#bpy.types.TintGpencilModifier.invert_vertex)
    - [`TintGpencilModifier.layer`](#bpy.types.TintGpencilModifier.layer)
    - [`TintGpencilModifier.layer_pass`](#bpy.types.TintGpencilModifier.layer_pass)
    - [`TintGpencilModifier.material`](#bpy.types.TintGpencilModifier.material)
    - [`TintGpencilModifier.object`](#bpy.types.TintGpencilModifier.object)
    - [`TintGpencilModifier.pass_index`](#bpy.types.TintGpencilModifier.pass_index)
    - [`TintGpencilModifier.radius`](#bpy.types.TintGpencilModifier.radius)
    - [`TintGpencilModifier.tint_type`](#bpy.types.TintGpencilModifier.tint_type)
    - [`TintGpencilModifier.use_custom_curve`](#bpy.types.TintGpencilModifier.use_custom_curve)
    - [`TintGpencilModifier.use_weight_factor`](#bpy.types.TintGpencilModifier.use_weight_factor)
    - [`TintGpencilModifier.vertex_group`](#bpy.types.TintGpencilModifier.vertex_group)
    - [`TintGpencilModifier.vertex_mode`](#bpy.types.TintGpencilModifier.vertex_mode)
    - [`TintGpencilModifier.bl_rna_get_subclass()`](#bpy.types.TintGpencilModifier.bl_rna_get_subclass)
    - [`TintGpencilModifier.bl_rna_get_subclass_py()`](#bpy.types.TintGpencilModifier.bl_rna_get_subclass_py)
