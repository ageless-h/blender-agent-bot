...
# GeometryNodeSplineLength(GeometryNode)[#](#geometrynodesplinelength-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeSplineLength(*GeometryNode*)[#](#bpy.types.GeometryNodeSplineLength "Link to this definition")
:   Retrieve the total length of each spline, as a distance or as a number of points

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.GeometryNodeSplineLength.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.GeometryNodeSplineLength.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.GeometryNodeSplineLength.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.GeometryNodeSplineLength.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.GeometryNodeSplineLength.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeSplineLength.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.GeometryNodeSplineLength.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeSplineLength(GeometryNode)
  + [`GeometryNodeSplineLength`](#bpy.types.GeometryNodeSplineLength)
    - [`GeometryNodeSplineLength.is_registered_node_type()`](#bpy.types.GeometryNodeSplineLength.is_registered_node_type)
    - [`GeometryNodeSplineLength.input_template()`](#bpy.types.GeometryNodeSplineLength.input_template)
    - [`GeometryNodeSplineLength.output_template()`](#bpy.types.GeometryNodeSplineLength.output_template)
    - [`GeometryNodeSplineLength.bl_rna_get_subclass()`](#bpy.types.GeometryNodeSplineLength.bl_rna_get_subclass)
    - [`GeometryNodeSplineLength.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeSplineLength.bl_rna_get_subclass_py)
