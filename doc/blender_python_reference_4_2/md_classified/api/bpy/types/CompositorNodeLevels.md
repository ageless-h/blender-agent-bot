...
# CompositorNodeLevels(CompositorNode)[#](#compositornodelevels-compositornode "Link to this heading")
...
*class* bpy.types.CompositorNodeLevels(*CompositorNode*)[#](#bpy.types.CompositorNodeLevels "Link to this definition")
:   Compute average and standard deviation of pixel values

    channel[#](#bpy.types.CompositorNodeLevels.channel "Link to this definition")
    :   * `COMBINED_RGB`
        ...
        * `LUMINANCE`
        ...
        Type:
        :   enum in [‘COMBINED\_RGB’, ‘RED’, ‘GREEN’, ‘BLUE’, ‘LUMINANCE’], default ‘COMBINED\_RGB’

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.CompositorNodeLevels.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.CompositorNodeLevels.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.CompositorNodeLevels.output_template "Link to this definition")
    ...
    update()[#](#bpy.types.CompositorNodeLevels.update "Link to this definition")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.CompositorNodeLevels.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.CompositorNodeLevels.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CompositorNodeLevels.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.CompositorNodeLevels.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CompositorNodeLevels(CompositorNode)
  + [`CompositorNodeLevels`](#bpy.types.CompositorNodeLevels)
    - [`CompositorNodeLevels.channel`](#bpy.types.CompositorNodeLevels.channel)
    - [`CompositorNodeLevels.is_registered_node_type()`](#bpy.types.CompositorNodeLevels.is_registered_node_type)
    - [`CompositorNodeLevels.input_template()`](#bpy.types.CompositorNodeLevels.input_template)
    - [`CompositorNodeLevels.output_template()`](#bpy.types.CompositorNodeLevels.output_template)
    - [`CompositorNodeLevels.update()`](#bpy.types.CompositorNodeLevels.update)
    - [`CompositorNodeLevels.bl_rna_get_subclass()`](#bpy.types.CompositorNodeLevels.bl_rna_get_subclass)
    - [`CompositorNodeLevels.bl_rna_get_subclass_py()`](#bpy.types.CompositorNodeLevels.bl_rna_get_subclass_py)
