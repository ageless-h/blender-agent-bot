...
# TextureGpencilModifier(GpencilModifier)[#](#texturegpencilmodifier-gpencilmodifier "Link to this heading")
...
*class* bpy.types.TextureGpencilModifier(*GpencilModifier*)[#](#bpy.types.TextureGpencilModifier "Link to this definition")
:   Transform stroke texture coordinates Modifier

    alignment\_rotation[#](#bpy.types.TextureGpencilModifier.alignment_rotation "Link to this definition")
    :   Additional rotation applied to dots and square strokes

        Type:
        :   float in [-1.5708, 1.5708], default 0.0

    fill\_offset[#](#bpy.types.TextureGpencilModifier.fill_offset "Link to this definition")
    ...
    fill\_rotation[#](#bpy.types.TextureGpencilModifier.fill_rotation "Link to this definition")
    :   Additional rotation of the fill UV

        Type:
        :   float in [-inf, inf], default 0.0

    fill\_scale[#](#bpy.types.TextureGpencilModifier.fill_scale "Link to this definition")
    :   Additional scale of the fill UV

        Type:
        :   float in [0.01, 100], default 1.0

    fit\_method[#](#bpy.types.TextureGpencilModifier.fit_method "Link to this definition")
    :   * `CONSTANT_LENGTH`
    ...
    invert\_layer\_pass[#](#bpy.types.TextureGpencilModifier.invert_layer_pass "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    invert\_layers[#](#bpy.types.TextureGpencilModifier.invert_layers "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    invert\_material\_pass[#](#bpy.types.TextureGpencilModifier.invert_material_pass "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    invert\_materials[#](#bpy.types.TextureGpencilModifier.invert_materials "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    invert\_vertex[#](#bpy.types.TextureGpencilModifier.invert_vertex "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    layer[#](#bpy.types.TextureGpencilModifier.layer "Link to this definition")
    :   Layer name

        Type:
        :   string, default “”, (never None)

    layer\_pass[#](#bpy.types.TextureGpencilModifier.layer_pass "Link to this definition")
    :   Layer pass index

        Type:
        :   int in [0, 100], default 0

    material[#](#bpy.types.TextureGpencilModifier.material "Link to this definition")
    :   Material used for filtering effect

        Type:
        :   [`Material`](Material.md#bpy.types.Material "bpy.types.Material")

    mode[#](#bpy.types.TextureGpencilModifier.mode "Link to this definition")
    :   * `STROKE`
    ...
    pass\_index[#](#bpy.types.TextureGpencilModifier.pass_index "Link to this definition")
    :   Pass index

        Type:
        :   int in [0, 100], default 0

    uv\_offset[#](#bpy.types.TextureGpencilModifier.uv_offset "Link to this definition")
    :   Offset value to add to stroke UVs

        Type:
        :   float in [-inf, inf], default 0.0

    uv\_scale[#](#bpy.types.TextureGpencilModifier.uv_scale "Link to this definition")
    :   Factor to scale the UVs

        Type:
        :   float in [0, inf], default 1.0

    vertex\_group[#](#bpy.types.TextureGpencilModifier.vertex_group "Link to this definition")
    :   Vertex group name for modulating the deform

        Type:
        :   string, default “”, (never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.TextureGpencilModifier.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.TextureGpencilModifier.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.TextureGpencilModifier.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.TextureGpencilModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* TextureGpencilModifier(GpencilModifier)
  + [`TextureGpencilModifier`](#bpy.types.TextureGpencilModifier)
    - [`TextureGpencilModifier.alignment_rotation`](#bpy.types.TextureGpencilModifier.alignment_rotation)
    - [`TextureGpencilModifier.fill_offset`](#bpy.types.TextureGpencilModifier.fill_offset)
    - [`TextureGpencilModifier.fill_rotation`](#bpy.types.TextureGpencilModifier.fill_rotation)
    - [`TextureGpencilModifier.fill_scale`](#bpy.types.TextureGpencilModifier.fill_scale)
    - [`TextureGpencilModifier.fit_method`](#bpy.types.TextureGpencilModifier.fit_method)
    - [`TextureGpencilModifier.invert_layer_pass`](#bpy.types.TextureGpencilModifier.invert_layer_pass)
    - [`TextureGpencilModifier.invert_layers`](#bpy.types.TextureGpencilModifier.invert_layers)
    - [`TextureGpencilModifier.invert_material_pass`](#bpy.types.TextureGpencilModifier.invert_material_pass)
    - [`TextureGpencilModifier.invert_materials`](#bpy.types.TextureGpencilModifier.invert_materials)
    - [`TextureGpencilModifier.invert_vertex`](#bpy.types.TextureGpencilModifier.invert_vertex)
    - [`TextureGpencilModifier.layer`](#bpy.types.TextureGpencilModifier.layer)
    - [`TextureGpencilModifier.layer_pass`](#bpy.types.TextureGpencilModifier.layer_pass)
    - [`TextureGpencilModifier.material`](#bpy.types.TextureGpencilModifier.material)
    - [`TextureGpencilModifier.mode`](#bpy.types.TextureGpencilModifier.mode)
    - [`TextureGpencilModifier.pass_index`](#bpy.types.TextureGpencilModifier.pass_index)
    - [`TextureGpencilModifier.uv_offset`](#bpy.types.TextureGpencilModifier.uv_offset)
    - [`TextureGpencilModifier.uv_scale`](#bpy.types.TextureGpencilModifier.uv_scale)
    - [`TextureGpencilModifier.vertex_group`](#bpy.types.TextureGpencilModifier.vertex_group)
    - [`TextureGpencilModifier.bl_rna_get_subclass()`](#bpy.types.TextureGpencilModifier.bl_rna_get_subclass)
    - [`TextureGpencilModifier.bl_rna_get_subclass_py()`](#bpy.types.TextureGpencilModifier.bl_rna_get_subclass_py)
