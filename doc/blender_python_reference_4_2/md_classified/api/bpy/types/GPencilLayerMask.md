...
# GPencilLayerMask(bpy\_struct)[#](#gpencillayermask-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.GPencilLayerMask(*bpy\_struct*)[#](#bpy.types.GPencilLayerMask "Link to this definition")
:   List of Mask Layers

    hide[#](#bpy.types.GPencilLayerMask.hide "Link to this definition")
    :   Set mask Visibility

        Type:
        :   boolean, default False

    invert[#](#bpy.types.GPencilLayerMask.invert "Link to this definition")
    :   Invert mask

        Type:
        :   boolean, default False

    name[#](#bpy.types.GPencilLayerMask.name "Link to this definition")
    :   Mask layer name

        Type:
        :   string, default “”, (never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.GPencilLayerMask.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.GPencilLayerMask.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`GPencilLayer.mask_layers`](GPencilLayer.md#bpy.types.GPencilLayer.mask_layers "bpy.types.GPencilLayer.mask_layers") | * [`GreasePencilMaskLayers.remove`](GreasePencilMaskLayers.md#bpy.types.GreasePencilMaskLayers.remove "bpy.types.GreasePencilMaskLayers.remove") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GPencilLayerMask.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.GPencilLayerMask.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GPencilLayerMask(bpy\_struct)
  + [`GPencilLayerMask`](#bpy.types.GPencilLayerMask)
    - [`GPencilLayerMask.hide`](#bpy.types.GPencilLayerMask.hide)
    - [`GPencilLayerMask.invert`](#bpy.types.GPencilLayerMask.invert)
    - [`GPencilLayerMask.name`](#bpy.types.GPencilLayerMask.name)
    - [`GPencilLayerMask.bl_rna_get_subclass()`](#bpy.types.GPencilLayerMask.bl_rna_get_subclass)
    - [`GPencilLayerMask.bl_rna_get_subclass_py()`](#bpy.types.GPencilLayerMask.bl_rna_get_subclass_py)
