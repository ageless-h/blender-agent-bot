...
# CompositorNodeMapValue(CompositorNode)[#](#compositornodemapvalue-compositornode "Link to this heading")
...
*class* bpy.types.CompositorNodeMapValue(*CompositorNode*)[#](#bpy.types.CompositorNodeMapValue "Link to this definition")
:   Scale, offset and clamp values

    max[#](#bpy.types.CompositorNodeMapValue.max "Link to this definition")
    :   Type:
        :   float array of 1 items in [-1000, 1000], default (0.0)

    min[#](#bpy.types.CompositorNodeMapValue.min "Link to this definition")
    :   Type:
        :   float array of 1 items in [-1000, 1000], default (0.0)

    offset[#](#bpy.types.CompositorNodeMapValue.offset "Link to this definition")
    :   Type:
        :   float array of 1 items in [-1000, 1000], default (0.0)

    size[#](#bpy.types.CompositorNodeMapValue.size "Link to this definition")
    :   Type:
        :   float array of 1 items in [-1000, 1000], default (0.0)

    use\_max[#](#bpy.types.CompositorNodeMapValue.use_max "Link to this definition")
    :   Type:
        :   boolean, default False

    use\_min[#](#bpy.types.CompositorNodeMapValue.use_min "Link to this definition")
    :   Type:
        :   boolean, default False

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.CompositorNodeMapValue.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.CompositorNodeMapValue.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.CompositorNodeMapValue.output_template "Link to this definition")
    ...
    update()[#](#bpy.types.CompositorNodeMapValue.update "Link to this definition")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.CompositorNodeMapValue.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.CompositorNodeMapValue.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CompositorNodeMapValue.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.CompositorNodeMapValue.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CompositorNodeMapValue(CompositorNode)
  + [`CompositorNodeMapValue`](#bpy.types.CompositorNodeMapValue)
    - [`CompositorNodeMapValue.max`](#bpy.types.CompositorNodeMapValue.max)
    - [`CompositorNodeMapValue.min`](#bpy.types.CompositorNodeMapValue.min)
    - [`CompositorNodeMapValue.offset`](#bpy.types.CompositorNodeMapValue.offset)
    - [`CompositorNodeMapValue.size`](#bpy.types.CompositorNodeMapValue.size)
    - [`CompositorNodeMapValue.use_max`](#bpy.types.CompositorNodeMapValue.use_max)
    - [`CompositorNodeMapValue.use_min`](#bpy.types.CompositorNodeMapValue.use_min)
    - [`CompositorNodeMapValue.is_registered_node_type()`](#bpy.types.CompositorNodeMapValue.is_registered_node_type)
    - [`CompositorNodeMapValue.input_template()`](#bpy.types.CompositorNodeMapValue.input_template)
    - [`CompositorNodeMapValue.output_template()`](#bpy.types.CompositorNodeMapValue.output_template)
    - [`CompositorNodeMapValue.update()`](#bpy.types.CompositorNodeMapValue.update)
    - [`CompositorNodeMapValue.bl_rna_get_subclass()`](#bpy.types.CompositorNodeMapValue.bl_rna_get_subclass)
    - [`CompositorNodeMapValue.bl_rna_get_subclass_py()`](#bpy.types.CompositorNodeMapValue.bl_rna_get_subclass_py)
