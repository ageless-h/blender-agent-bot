...
# GPencilStrokePoint(bpy\_struct)[#](#gpencilstrokepoint-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.GPencilStrokePoint(*bpy\_struct*)[#](#bpy.types.GPencilStrokePoint "Link to this definition")
:   Data point for freehand stroke curve

    co[#](#bpy.types.GPencilStrokePoint.co "Link to this definition")
    :   Type:
        :   [`mathutils.Vector`](../../mathutils/index.md#mathutils.Vector "mathutils.Vector") of 3 items in [-inf, inf], default (0.0, 0.0, 0.0)

    pressure[#](#bpy.types.GPencilStrokePoint.pressure "Link to this definition")
    :   Pressure of tablet at point when drawing it

        Type:
        :   float in [0, inf], default 0.0

    select[#](#bpy.types.GPencilStrokePoint.select "Link to this definition")
    :   Point is selected for viewport editing

        Type:
        :   boolean, default False

    strength[#](#bpy.types.GPencilStrokePoint.strength "Link to this definition")
    :   Color intensity (alpha factor)

        Type:
        :   float in [0, 1], default 0.0

    time[#](#bpy.types.GPencilStrokePoint.time "Link to this definition")
    :   Time relative to stroke start

        Type:
        :   float in [-inf, inf], default 0.0, (readonly)

    uv\_factor[#](#bpy.types.GPencilStrokePoint.uv_factor "Link to this definition")
    :   Internal UV factor

        Type:
        :   float in [0, 1], default 0.0

    uv\_fill[#](#bpy.types.GPencilStrokePoint.uv_fill "Link to this definition")
    ...
    uv\_rotation[#](#bpy.types.GPencilStrokePoint.uv_rotation "Link to this definition")
    :   Internal UV factor for dot mode

        Type:
        :   float in [-1.5708, 1.5708], default 0.0

    vertex\_color[#](#bpy.types.GPencilStrokePoint.vertex_color "Link to this definition")
    :   Color used to mix with point color to get final color

        Type:
        :   float array of 4 items in [0, 1], default (0.0, 0.0, 0.0, 0.0)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.GPencilStrokePoint.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.GPencilStrokePoint.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GPencilStrokePoint.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.GPencilStrokePoint.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GPencilStrokePoint(bpy\_struct)
  + [`GPencilStrokePoint`](#bpy.types.GPencilStrokePoint)
    - [`GPencilStrokePoint.co`](#bpy.types.GPencilStrokePoint.co)
    - [`GPencilStrokePoint.pressure`](#bpy.types.GPencilStrokePoint.pressure)
    - [`GPencilStrokePoint.select`](#bpy.types.GPencilStrokePoint.select)
    - [`GPencilStrokePoint.strength`](#bpy.types.GPencilStrokePoint.strength)
    - [`GPencilStrokePoint.time`](#bpy.types.GPencilStrokePoint.time)
    - [`GPencilStrokePoint.uv_factor`](#bpy.types.GPencilStrokePoint.uv_factor)
    - [`GPencilStrokePoint.uv_fill`](#bpy.types.GPencilStrokePoint.uv_fill)
    - [`GPencilStrokePoint.uv_rotation`](#bpy.types.GPencilStrokePoint.uv_rotation)
    - [`GPencilStrokePoint.vertex_color`](#bpy.types.GPencilStrokePoint.vertex_color)
    - [`GPencilStrokePoint.bl_rna_get_subclass()`](#bpy.types.GPencilStrokePoint.bl_rna_get_subclass)
    - [`GPencilStrokePoint.bl_rna_get_subclass_py()`](#bpy.types.GPencilStrokePoint.bl_rna_get_subclass_py)
