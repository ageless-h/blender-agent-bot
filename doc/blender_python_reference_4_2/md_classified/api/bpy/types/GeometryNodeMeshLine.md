...
# GeometryNodeMeshLine(GeometryNode)[#](#geometrynodemeshline-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeMeshLine(*GeometryNode*)[#](#bpy.types.GeometryNodeMeshLine "Link to this definition")
:   Generate vertices in a line and connect them with edges

    count\_mode[#](#bpy.types.GeometryNodeMeshLine.count_mode "Link to this definition")
    :   * `TOTAL`
        ...
        * `RESOLUTION`
        ...
        Type:
        :   enum in [‘TOTAL’, ‘RESOLUTION’], default ‘TOTAL’

    mode[#](#bpy.types.GeometryNodeMeshLine.mode "Link to this definition")
    :   * `OFFSET`
        ...
        * `END_POINTS`
        ...
        Type:
        :   enum in [‘OFFSET’, ‘END\_POINTS’], default ‘OFFSET’

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.GeometryNodeMeshLine.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.GeometryNodeMeshLine.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.GeometryNodeMeshLine.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.GeometryNodeMeshLine.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.GeometryNodeMeshLine.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeMeshLine.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.GeometryNodeMeshLine.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeMeshLine(GeometryNode)
  + [`GeometryNodeMeshLine`](#bpy.types.GeometryNodeMeshLine)
    - [`GeometryNodeMeshLine.count_mode`](#bpy.types.GeometryNodeMeshLine.count_mode)
    - [`GeometryNodeMeshLine.mode`](#bpy.types.GeometryNodeMeshLine.mode)
    - [`GeometryNodeMeshLine.is_registered_node_type()`](#bpy.types.GeometryNodeMeshLine.is_registered_node_type)
    - [`GeometryNodeMeshLine.input_template()`](#bpy.types.GeometryNodeMeshLine.input_template)
    - [`GeometryNodeMeshLine.output_template()`](#bpy.types.GeometryNodeMeshLine.output_template)
    - [`GeometryNodeMeshLine.bl_rna_get_subclass()`](#bpy.types.GeometryNodeMeshLine.bl_rna_get_subclass)
    - [`GeometryNodeMeshLine.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeMeshLine.bl_rna_get_subclass_py)
