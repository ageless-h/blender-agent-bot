...
# CompositorNodeTransform(CompositorNode)[#](#compositornodetransform-compositornode "Link to this heading")
...
*class* bpy.types.CompositorNodeTransform(*CompositorNode*)[#](#bpy.types.CompositorNodeTransform "Link to this definition")
:   Scale, translate and rotate an image

    filter\_type[#](#bpy.types.CompositorNodeTransform.filter_type "Link to this definition")
    :   Method to use to filter transform

        Type:
        :   enum in [‘NEAREST’, ‘BILINEAR’, ‘BICUBIC’], default ‘NEAREST’

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.CompositorNodeTransform.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.CompositorNodeTransform.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.CompositorNodeTransform.output_template "Link to this definition")
    ...
    update()[#](#bpy.types.CompositorNodeTransform.update "Link to this definition")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.CompositorNodeTransform.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.CompositorNodeTransform.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CompositorNodeTransform.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.CompositorNodeTransform.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CompositorNodeTransform(CompositorNode)
  + [`CompositorNodeTransform`](#bpy.types.CompositorNodeTransform)
    - [`CompositorNodeTransform.filter_type`](#bpy.types.CompositorNodeTransform.filter_type)
    - [`CompositorNodeTransform.is_registered_node_type()`](#bpy.types.CompositorNodeTransform.is_registered_node_type)
    - [`CompositorNodeTransform.input_template()`](#bpy.types.CompositorNodeTransform.input_template)
    - [`CompositorNodeTransform.output_template()`](#bpy.types.CompositorNodeTransform.output_template)
    - [`CompositorNodeTransform.update()`](#bpy.types.CompositorNodeTransform.update)
    - [`CompositorNodeTransform.bl_rna_get_subclass()`](#bpy.types.CompositorNodeTransform.bl_rna_get_subclass)
    - [`CompositorNodeTransform.bl_rna_get_subclass_py()`](#bpy.types.CompositorNodeTransform.bl_rna_get_subclass_py)
