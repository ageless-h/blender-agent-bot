...
# CompositorNodeDespeckle(CompositorNode)[#](#compositornodedespeckle-compositornode "Link to this heading")
...
*class* bpy.types.CompositorNodeDespeckle(*CompositorNode*)[#](#bpy.types.CompositorNodeDespeckle "Link to this definition")
:   Smooth areas of an image in which noise is noticeable, while leaving complex areas untouched

    threshold[#](#bpy.types.CompositorNodeDespeckle.threshold "Link to this definition")
    :   Threshold for detecting pixels to despeckle

        Type:
        :   float in [0, 1], default 0.0

    threshold\_neighbor[#](#bpy.types.CompositorNodeDespeckle.threshold_neighbor "Link to this definition")
    :   Threshold for the number of neighbor pixels that must match

        Type:
        :   float in [0, 1], default 0.0

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.CompositorNodeDespeckle.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.CompositorNodeDespeckle.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.CompositorNodeDespeckle.output_template "Link to this definition")
    ...
    update()[#](#bpy.types.CompositorNodeDespeckle.update "Link to this definition")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.CompositorNodeDespeckle.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.CompositorNodeDespeckle.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CompositorNodeDespeckle.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.CompositorNodeDespeckle.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CompositorNodeDespeckle(CompositorNode)
  + [`CompositorNodeDespeckle`](#bpy.types.CompositorNodeDespeckle)
    - [`CompositorNodeDespeckle.threshold`](#bpy.types.CompositorNodeDespeckle.threshold)
    - [`CompositorNodeDespeckle.threshold_neighbor`](#bpy.types.CompositorNodeDespeckle.threshold_neighbor)
    - [`CompositorNodeDespeckle.is_registered_node_type()`](#bpy.types.CompositorNodeDespeckle.is_registered_node_type)
    - [`CompositorNodeDespeckle.input_template()`](#bpy.types.CompositorNodeDespeckle.input_template)
    - [`CompositorNodeDespeckle.output_template()`](#bpy.types.CompositorNodeDespeckle.output_template)
    - [`CompositorNodeDespeckle.update()`](#bpy.types.CompositorNodeDespeckle.update)
    - [`CompositorNodeDespeckle.bl_rna_get_subclass()`](#bpy.types.CompositorNodeDespeckle.bl_rna_get_subclass)
    - [`CompositorNodeDespeckle.bl_rna_get_subclass_py()`](#bpy.types.CompositorNodeDespeckle.bl_rna_get_subclass_py)
