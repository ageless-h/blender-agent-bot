...
:   Offset keyframes
    ...
    layer\_filter[#](#bpy.types.GreasePencilTimeModifier.layer_filter "Link to this definition")
    :   Layer name
...
* GreasePencilTimeModifier(Modifier)
  + [`GreasePencilTimeModifier`](#bpy.types.GreasePencilTimeModifier)
    ...
    - [`GreasePencilTimeModifier.layer_filter`](#bpy.types.GreasePencilTimeModifier.layer_filter)
