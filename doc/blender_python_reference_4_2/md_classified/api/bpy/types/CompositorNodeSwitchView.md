...
# CompositorNodeSwitchView(CompositorNode)[#](#compositornodeswitchview-compositornode "Link to this heading")
...
*class* bpy.types.CompositorNodeSwitchView(*CompositorNode*)[#](#bpy.types.CompositorNodeSwitchView "Link to this definition")
:   Combine the views (left and right) into a single stereo 3D output

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.CompositorNodeSwitchView.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.CompositorNodeSwitchView.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.CompositorNodeSwitchView.output_template "Link to this definition")
    ...
    update()[#](#bpy.types.CompositorNodeSwitchView.update "Link to this definition")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.CompositorNodeSwitchView.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.CompositorNodeSwitchView.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CompositorNodeSwitchView.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.CompositorNodeSwitchView.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CompositorNodeSwitchView(CompositorNode)
  + [`CompositorNodeSwitchView`](#bpy.types.CompositorNodeSwitchView)
    - [`CompositorNodeSwitchView.is_registered_node_type()`](#bpy.types.CompositorNodeSwitchView.is_registered_node_type)
    - [`CompositorNodeSwitchView.input_template()`](#bpy.types.CompositorNodeSwitchView.input_template)
    - [`CompositorNodeSwitchView.output_template()`](#bpy.types.CompositorNodeSwitchView.output_template)
    - [`CompositorNodeSwitchView.update()`](#bpy.types.CompositorNodeSwitchView.update)
    - [`CompositorNodeSwitchView.bl_rna_get_subclass()`](#bpy.types.CompositorNodeSwitchView.bl_rna_get_subclass)
    - [`CompositorNodeSwitchView.bl_rna_get_subclass_py()`](#bpy.types.CompositorNodeSwitchView.bl_rna_get_subclass_py)
