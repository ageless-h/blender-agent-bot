...
:   Repeat the values of the modified F-Curve
    ...
    :   Cycling mode to use after last keyframe
        ...
        * `MIRROR`
        ...
        Type:
        :   enum in [‘NONE’, ‘REPEAT’, ‘REPEAT\_OFFSET’, ‘MIRROR’], default ‘NONE’
