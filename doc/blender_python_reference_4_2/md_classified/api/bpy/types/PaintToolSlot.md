...
# PaintToolSlot(bpy\_struct)[#](#painttoolslot-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.PaintToolSlot(*bpy\_struct*)[#](#bpy.types.PaintToolSlot "Link to this definition")
:   brush[#](#bpy.types.PaintToolSlot.brush "Link to this definition")
    :   Type:
        :   [`Brush`](Brush.md#bpy.types.Brush "bpy.types.Brush")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.PaintToolSlot.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.PaintToolSlot.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Paint.tool_slots`](Paint.md#bpy.types.Paint.tool_slots "bpy.types.Paint.tool_slots") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.PaintToolSlot.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.PaintToolSlot.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* PaintToolSlot(bpy\_struct)
  + [`PaintToolSlot`](#bpy.types.PaintToolSlot)
    - [`PaintToolSlot.brush`](#bpy.types.PaintToolSlot.brush)
    - [`PaintToolSlot.bl_rna_get_subclass()`](#bpy.types.PaintToolSlot.bl_rna_get_subclass)
    - [`PaintToolSlot.bl_rna_get_subclass_py()`](#bpy.types.PaintToolSlot.bl_rna_get_subclass_py)
