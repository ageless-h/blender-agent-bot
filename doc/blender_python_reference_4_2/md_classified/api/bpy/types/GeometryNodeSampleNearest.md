...
# GeometryNodeSampleNearest(GeometryNode)[#](#geometrynodesamplenearest-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeSampleNearest(*GeometryNode*)[#](#bpy.types.GeometryNodeSampleNearest "Link to this definition")
:   Find the element of a geometry closest to a position. Similar to the “Index of Nearest” node

    domain[#](#bpy.types.GeometryNodeSampleNearest.domain "Link to this definition")
    :   Type:
        :   enum in [Attribute Domain Only Mesh Items](../../../appendix/bpy_types_enum_items/attribute_domain_only_mesh_items.md#rna-enum-attribute-domain-only-mesh-items), default ‘POINT’

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.GeometryNodeSampleNearest.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.GeometryNodeSampleNearest.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.GeometryNodeSampleNearest.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.GeometryNodeSampleNearest.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.GeometryNodeSampleNearest.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeSampleNearest.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.GeometryNodeSampleNearest.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeSampleNearest(GeometryNode)
  + [`GeometryNodeSampleNearest`](#bpy.types.GeometryNodeSampleNearest)
    - [`GeometryNodeSampleNearest.domain`](#bpy.types.GeometryNodeSampleNearest.domain)
    - [`GeometryNodeSampleNearest.is_registered_node_type()`](#bpy.types.GeometryNodeSampleNearest.is_registered_node_type)
    - [`GeometryNodeSampleNearest.input_template()`](#bpy.types.GeometryNodeSampleNearest.input_template)
    - [`GeometryNodeSampleNearest.output_template()`](#bpy.types.GeometryNodeSampleNearest.output_template)
    - [`GeometryNodeSampleNearest.bl_rna_get_subclass()`](#bpy.types.GeometryNodeSampleNearest.bl_rna_get_subclass)
    - [`GeometryNodeSampleNearest.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeSampleNearest.bl_rna_get_subclass_py)
