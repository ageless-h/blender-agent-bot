...
# GeometryNodeSampleCurve(GeometryNode)[#](#geometrynodesamplecurve-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeSampleCurve(*GeometryNode*)[#](#bpy.types.GeometryNodeSampleCurve "Link to this definition")
:   Retrieve data from a point on a curve at a certain distance from its start

    data\_type[#](#bpy.types.GeometryNodeSampleCurve.data_type "Link to this definition")
    :   Type:
    ...
    mode[#](#bpy.types.GeometryNodeSampleCurve.mode "Link to this definition")
    :   Method for sampling input
        ...
        * `LENGTH`
        ...
        Type:
        :   enum in [‘FACTOR’, ‘LENGTH’], default ‘FACTOR’

    use\_all\_curves[#](#bpy.types.GeometryNodeSampleCurve.use_all_curves "Link to this definition")
    :   Sample lengths based on the total length of all curves, rather than using a length inside each selected curve

        Type:
        :   boolean, default False

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.GeometryNodeSampleCurve.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.GeometryNodeSampleCurve.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.GeometryNodeSampleCurve.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.GeometryNodeSampleCurve.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.GeometryNodeSampleCurve.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeSampleCurve.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.GeometryNodeSampleCurve.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeSampleCurve(GeometryNode)
  + [`GeometryNodeSampleCurve`](#bpy.types.GeometryNodeSampleCurve)
    - [`GeometryNodeSampleCurve.data_type`](#bpy.types.GeometryNodeSampleCurve.data_type)
    - [`GeometryNodeSampleCurve.mode`](#bpy.types.GeometryNodeSampleCurve.mode)
    - [`GeometryNodeSampleCurve.use_all_curves`](#bpy.types.GeometryNodeSampleCurve.use_all_curves)
    - [`GeometryNodeSampleCurve.is_registered_node_type()`](#bpy.types.GeometryNodeSampleCurve.is_registered_node_type)
    - [`GeometryNodeSampleCurve.input_template()`](#bpy.types.GeometryNodeSampleCurve.input_template)
    - [`GeometryNodeSampleCurve.output_template()`](#bpy.types.GeometryNodeSampleCurve.output_template)
    - [`GeometryNodeSampleCurve.bl_rna_get_subclass()`](#bpy.types.GeometryNodeSampleCurve.bl_rna_get_subclass)
    - [`GeometryNodeSampleCurve.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeSampleCurve.bl_rna_get_subclass_py)
