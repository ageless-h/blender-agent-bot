...
# ShaderNodeTexImage(ShaderNode)[#](#shadernodeteximage-shadernode "Link to this heading")
...
*class* bpy.types.ShaderNodeTexImage(*ShaderNode*)[#](#bpy.types.ShaderNodeTexImage "Link to this definition")
:   Sample an image file as a texture

    color\_mapping[#](#bpy.types.ShaderNodeTexImage.color_mapping "Link to this definition")
    :   Color mapping settings

        Type:
        :   [`ColorMapping`](ColorMapping.md#bpy.types.ColorMapping "bpy.types.ColorMapping"), (readonly, never None)

    extension[#](#bpy.types.ShaderNodeTexImage.extension "Link to this definition")
    ...
    image[#](#bpy.types.ShaderNodeTexImage.image "Link to this definition")
    :   Type:
        :   [`Image`](Image.md#bpy.types.Image "bpy.types.Image")

    image\_user[#](#bpy.types.ShaderNodeTexImage.image_user "Link to this definition")
    :   Parameters defining which layer, pass and frame of the image is displayed

        Type:
        :   [`ImageUser`](ImageUser.md#bpy.types.ImageUser "bpy.types.ImageUser"), (readonly, never None)

    interpolation[#](#bpy.types.ShaderNodeTexImage.interpolation "Link to this definition")
    ...
    projection[#](#bpy.types.ShaderNodeTexImage.projection "Link to this definition")
    ...
    projection\_blend[#](#bpy.types.ShaderNodeTexImage.projection_blend "Link to this definition")
    :   For box projection, amount of blend to use between sides

        Type:
        :   float in [0, 1], default 0.0

    texture\_mapping[#](#bpy.types.ShaderNodeTexImage.texture_mapping "Link to this definition")
    :   Texture coordinate mapping settings

        Type:
        :   [`TexMapping`](TexMapping.md#bpy.types.TexMapping "bpy.types.TexMapping"), (readonly, never None)

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.ShaderNodeTexImage.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.ShaderNodeTexImage.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.ShaderNodeTexImage.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.ShaderNodeTexImage.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.ShaderNodeTexImage.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ShaderNodeTexImage.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.ShaderNodeTexImage.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ShaderNodeTexImage(ShaderNode)
  + [`ShaderNodeTexImage`](#bpy.types.ShaderNodeTexImage)
    - [`ShaderNodeTexImage.color_mapping`](#bpy.types.ShaderNodeTexImage.color_mapping)
    - [`ShaderNodeTexImage.extension`](#bpy.types.ShaderNodeTexImage.extension)
    - [`ShaderNodeTexImage.image`](#bpy.types.ShaderNodeTexImage.image)
    - [`ShaderNodeTexImage.image_user`](#bpy.types.ShaderNodeTexImage.image_user)
    - [`ShaderNodeTexImage.interpolation`](#bpy.types.ShaderNodeTexImage.interpolation)
    - [`ShaderNodeTexImage.projection`](#bpy.types.ShaderNodeTexImage.projection)
    - [`ShaderNodeTexImage.projection_blend`](#bpy.types.ShaderNodeTexImage.projection_blend)
    - [`ShaderNodeTexImage.texture_mapping`](#bpy.types.ShaderNodeTexImage.texture_mapping)
    - [`ShaderNodeTexImage.is_registered_node_type()`](#bpy.types.ShaderNodeTexImage.is_registered_node_type)
    - [`ShaderNodeTexImage.input_template()`](#bpy.types.ShaderNodeTexImage.input_template)
    - [`ShaderNodeTexImage.output_template()`](#bpy.types.ShaderNodeTexImage.output_template)
    - [`ShaderNodeTexImage.bl_rna_get_subclass()`](#bpy.types.ShaderNodeTexImage.bl_rna_get_subclass)
    - [`ShaderNodeTexImage.bl_rna_get_subclass_py()`](#bpy.types.ShaderNodeTexImage.bl_rna_get_subclass_py)
