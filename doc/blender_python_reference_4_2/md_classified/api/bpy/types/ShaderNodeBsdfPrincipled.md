...
# ShaderNodeBsdfPrincipled(ShaderNode)[#](#shadernodebsdfprincipled-shadernode "Link to this heading")
...
*class* bpy.types.ShaderNodeBsdfPrincipled(*ShaderNode*)[#](#bpy.types.ShaderNodeBsdfPrincipled "Link to this definition")
:   Physically-based, easy-to-use shader for rendering surface materials, based on the OpenPBR model

    distribution[#](#bpy.types.ShaderNodeBsdfPrincipled.distribution "Link to this definition")
    :   Light scattering distribution on rough surface
        ...
        * `MULTI_GGX`
        ...
        Type:
        :   enum in [‘GGX’, ‘MULTI\_GGX’], default ‘GGX’

    subsurface\_method[#](#bpy.types.ShaderNodeBsdfPrincipled.subsurface_method "Link to this definition")
    :   Method for rendering subsurface scattering
        ...
        * `RANDOM_WALK_SKIN`
        ...
        Type:
        :   enum in [‘BURLEY’, ‘RANDOM\_WALK’, ‘RANDOM\_WALK\_SKIN’], default ‘BURLEY’

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.ShaderNodeBsdfPrincipled.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.ShaderNodeBsdfPrincipled.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.ShaderNodeBsdfPrincipled.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.ShaderNodeBsdfPrincipled.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.ShaderNodeBsdfPrincipled.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ShaderNodeBsdfPrincipled.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.ShaderNodeBsdfPrincipled.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ShaderNodeBsdfPrincipled(ShaderNode)
  + [`ShaderNodeBsdfPrincipled`](#bpy.types.ShaderNodeBsdfPrincipled)
    - [`ShaderNodeBsdfPrincipled.distribution`](#bpy.types.ShaderNodeBsdfPrincipled.distribution)
    - [`ShaderNodeBsdfPrincipled.subsurface_method`](#bpy.types.ShaderNodeBsdfPrincipled.subsurface_method)
    - [`ShaderNodeBsdfPrincipled.is_registered_node_type()`](#bpy.types.ShaderNodeBsdfPrincipled.is_registered_node_type)
    - [`ShaderNodeBsdfPrincipled.input_template()`](#bpy.types.ShaderNodeBsdfPrincipled.input_template)
    - [`ShaderNodeBsdfPrincipled.output_template()`](#bpy.types.ShaderNodeBsdfPrincipled.output_template)
    - [`ShaderNodeBsdfPrincipled.bl_rna_get_subclass()`](#bpy.types.ShaderNodeBsdfPrincipled.bl_rna_get_subclass)
    - [`ShaderNodeBsdfPrincipled.bl_rna_get_subclass_py()`](#bpy.types.ShaderNodeBsdfPrincipled.bl_rna_get_subclass_py)
