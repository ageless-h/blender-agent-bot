...
# ShaderNodeEeveeSpecular(ShaderNode)[#](#shadernodeeeveespecular-shadernode "Link to this heading")
...
*class* bpy.types.ShaderNodeEeveeSpecular(*ShaderNode*)[#](#bpy.types.ShaderNodeEeveeSpecular "Link to this definition")
:   Similar to the Principled BSDF node but uses the specular workflow instead of metallic, which functions by specifying the facing (along normal) reflection color. Energy is not conserved, so the result may not be physically accurate
    ...
    *classmethod* is\_registered\_node\_type()[#](#bpy.types.ShaderNodeEeveeSpecular.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.ShaderNodeEeveeSpecular.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.ShaderNodeEeveeSpecular.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.ShaderNodeEeveeSpecular.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.ShaderNodeEeveeSpecular.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ShaderNodeEeveeSpecular.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.ShaderNodeEeveeSpecular.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ShaderNodeEeveeSpecular(ShaderNode)
  + [`ShaderNodeEeveeSpecular`](#bpy.types.ShaderNodeEeveeSpecular)
    - [`ShaderNodeEeveeSpecular.is_registered_node_type()`](#bpy.types.ShaderNodeEeveeSpecular.is_registered_node_type)
    - [`ShaderNodeEeveeSpecular.input_template()`](#bpy.types.ShaderNodeEeveeSpecular.input_template)
    - [`ShaderNodeEeveeSpecular.output_template()`](#bpy.types.ShaderNodeEeveeSpecular.output_template)
    - [`ShaderNodeEeveeSpecular.bl_rna_get_subclass()`](#bpy.types.ShaderNodeEeveeSpecular.bl_rna_get_subclass)
    - [`ShaderNodeEeveeSpecular.bl_rna_get_subclass_py()`](#bpy.types.ShaderNodeEeveeSpecular.bl_rna_get_subclass_py)
