...
# ShaderNodeTexCoord(ShaderNode)[#](#shadernodetexcoord-shadernode "Link to this heading")
...
*class* bpy.types.ShaderNodeTexCoord(*ShaderNode*)[#](#bpy.types.ShaderNodeTexCoord "Link to this definition")
:   Retrieve multiple types of texture coordinates.
    Typically used as inputs for texture nodes

    from\_instancer[#](#bpy.types.ShaderNodeTexCoord.from_instancer "Link to this definition")
    :   Use the parent of the instance object if possible

        Type:
        :   boolean, default False

    object[#](#bpy.types.ShaderNodeTexCoord.object "Link to this definition")
    :   Use coordinates from this object (for object texture coordinates output)

        Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object")

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.ShaderNodeTexCoord.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.ShaderNodeTexCoord.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.ShaderNodeTexCoord.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.ShaderNodeTexCoord.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.ShaderNodeTexCoord.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ShaderNodeTexCoord.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.ShaderNodeTexCoord.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ShaderNodeTexCoord(ShaderNode)
  + [`ShaderNodeTexCoord`](#bpy.types.ShaderNodeTexCoord)
    - [`ShaderNodeTexCoord.from_instancer`](#bpy.types.ShaderNodeTexCoord.from_instancer)
    - [`ShaderNodeTexCoord.object`](#bpy.types.ShaderNodeTexCoord.object)
    - [`ShaderNodeTexCoord.is_registered_node_type()`](#bpy.types.ShaderNodeTexCoord.is_registered_node_type)
    - [`ShaderNodeTexCoord.input_template()`](#bpy.types.ShaderNodeTexCoord.input_template)
    - [`ShaderNodeTexCoord.output_template()`](#bpy.types.ShaderNodeTexCoord.output_template)
    - [`ShaderNodeTexCoord.bl_rna_get_subclass()`](#bpy.types.ShaderNodeTexCoord.bl_rna_get_subclass)
    - [`ShaderNodeTexCoord.bl_rna_get_subclass_py()`](#bpy.types.ShaderNodeTexCoord.bl_rna_get_subclass_py)
