...
# ShrinkwrapConstraint(Constraint)[#](#shrinkwrapconstraint-constraint "Link to this heading")
...
*class* bpy.types.ShrinkwrapConstraint(*Constraint*)[#](#bpy.types.ShrinkwrapConstraint "Link to this definition")
:   Create constraint-based shrinkwrap relationship

    cull\_face[#](#bpy.types.ShrinkwrapConstraint.cull_face "Link to this definition")
    ...
    distance[#](#bpy.types.ShrinkwrapConstraint.distance "Link to this definition")
    :   Distance to Target

        Type:
        :   float in [0, inf], default 0.0

    project\_axis[#](#bpy.types.ShrinkwrapConstraint.project_axis "Link to this definition")
    :   Axis constrain to

        Type:
        :   enum in [Object Axis Items](../../../appendix/bpy_types_enum_items/object_axis_items.md#rna-enum-object-axis-items), default ‘POS\_X’

    project\_axis\_space[#](#bpy.types.ShrinkwrapConstraint.project_axis_space "Link to this definition")
    ...
    project\_limit[#](#bpy.types.ShrinkwrapConstraint.project_limit "Link to this definition")
    :   Limit the distance used for projection (zero disables)

        Type:
        :   float in [0, inf], default 0.0

    shrinkwrap\_type[#](#bpy.types.ShrinkwrapConstraint.shrinkwrap_type "Link to this definition")
    :   Select type of shrinkwrap algorithm for target position
        ...
        * `TARGET_PROJECT`
        ...
        Type:
        :   enum in [‘NEAREST\_SURFACE’, ‘PROJECT’, ‘NEAREST\_VERTEX’, ‘TARGET\_PROJECT’], default ‘NEAREST\_SURFACE’

    target[#](#bpy.types.ShrinkwrapConstraint.target "Link to this definition")
    :   Target Mesh object

        Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object")

    track\_axis[#](#bpy.types.ShrinkwrapConstraint.track_axis "Link to this definition")
    :   Axis that is aligned to the normal

        Type:
        :   enum in [‘TRACK\_X’, ‘TRACK\_Y’, ‘TRACK\_Z’, ‘TRACK\_NEGATIVE\_X’, ‘TRACK\_NEGATIVE\_Y’, ‘TRACK\_NEGATIVE\_Z’], default ‘TRACK\_X’

    use\_invert\_cull[#](#bpy.types.ShrinkwrapConstraint.use_invert_cull "Link to this definition")
    :   When projecting in the opposite direction invert the face cull mode

        Type:
        :   boolean, default False

    use\_project\_opposite[#](#bpy.types.ShrinkwrapConstraint.use_project_opposite "Link to this definition")
    :   Project in both specified and opposite directions

        Type:
        :   boolean, default False

    use\_track\_normal[#](#bpy.types.ShrinkwrapConstraint.use_track_normal "Link to this definition")
    :   Align the specified axis to the surface normal

        Type:
        :   boolean, default False

    wrap\_mode[#](#bpy.types.ShrinkwrapConstraint.wrap_mode "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.ShrinkwrapConstraint.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.ShrinkwrapConstraint.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ShrinkwrapConstraint.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.ShrinkwrapConstraint.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ShrinkwrapConstraint(Constraint)
  + [`ShrinkwrapConstraint`](#bpy.types.ShrinkwrapConstraint)
    - [`ShrinkwrapConstraint.cull_face`](#bpy.types.ShrinkwrapConstraint.cull_face)
    - [`ShrinkwrapConstraint.distance`](#bpy.types.ShrinkwrapConstraint.distance)
    - [`ShrinkwrapConstraint.project_axis`](#bpy.types.ShrinkwrapConstraint.project_axis)
    - [`ShrinkwrapConstraint.project_axis_space`](#bpy.types.ShrinkwrapConstraint.project_axis_space)
    - [`ShrinkwrapConstraint.project_limit`](#bpy.types.ShrinkwrapConstraint.project_limit)
    - [`ShrinkwrapConstraint.shrinkwrap_type`](#bpy.types.ShrinkwrapConstraint.shrinkwrap_type)
    - [`ShrinkwrapConstraint.target`](#bpy.types.ShrinkwrapConstraint.target)
    - [`ShrinkwrapConstraint.track_axis`](#bpy.types.ShrinkwrapConstraint.track_axis)
    - [`ShrinkwrapConstraint.use_invert_cull`](#bpy.types.ShrinkwrapConstraint.use_invert_cull)
    - [`ShrinkwrapConstraint.use_project_opposite`](#bpy.types.ShrinkwrapConstraint.use_project_opposite)
    - [`ShrinkwrapConstraint.use_track_normal`](#bpy.types.ShrinkwrapConstraint.use_track_normal)
    - [`ShrinkwrapConstraint.wrap_mode`](#bpy.types.ShrinkwrapConstraint.wrap_mode)
    - [`ShrinkwrapConstraint.bl_rna_get_subclass()`](#bpy.types.ShrinkwrapConstraint.bl_rna_get_subclass)
    - [`ShrinkwrapConstraint.bl_rna_get_subclass_py()`](#bpy.types.ShrinkwrapConstraint.bl_rna_get_subclass_py)
