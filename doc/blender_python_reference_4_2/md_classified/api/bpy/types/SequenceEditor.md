...
:   Sequence editing data for a Scene data-block
    ...
    :   Sequencer’s active strip
        ...
        Type:
        :   [`Sequence`](Sequence.md#bpy.types.Sequence "bpy.types.Sequence")
    ...
    :   Meta strip stack, last is currently edited meta strip
        ...
        Type:
        :   [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`Sequence`](Sequence.md#bpy.types.Sequence "bpy.types.Sequence"), (readonly)
    ...
    :   How to store proxies for this project
        ...
        * `PROJECT`
        ...
        Type:
        :   enum in [‘PER\_STRIP’, ‘PROJECT’], default ‘PER\_STRIP’

    selected\_retiming\_keys[#](#bpy.types.SequenceEditor.selected_retiming_keys "Link to this definition")
    :   Type:
        :   boolean, default False, (readonly)

    sequences[#](#bpy.types.SequenceEditor.sequences "Link to this definition")
    :   Top-level strips only

        Type:
        :   [`SequencesTopLevel`](SequencesTopLevel.md#bpy.types.SequencesTopLevel "bpy.types.SequencesTopLevel") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`Sequence`](Sequence.md#bpy.types.Sequence "bpy.types.Sequence"), (readonly)

    sequences\_all[#](#bpy.types.SequenceEditor.sequences_all "Link to this definition")
    ...
    use\_cache\_composite[#](#bpy.types.SequenceEditor.use_cache_composite "Link to this definition")
    ...
    use\_cache\_preprocessed[#](#bpy.types.SequenceEditor.use_cache_preprocessed "Link to this definition")
    ...
    :   Display sequences stack
        ...
        Parameters:
        :   **meta\_sequence** ([`Sequence`](Sequence.md#bpy.types.Sequence "bpy.types.Sequence")) – Meta Sequence, Meta to display its stack
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.SequenceEditor.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.SequenceEditor.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)
...
* SequenceEditor(bpy\_struct)
  + [`SequenceEditor`](#bpy.types.SequenceEditor)
    ...
    - [`SequenceEditor.sequences`](#bpy.types.SequenceEditor.sequences)
    - [`SequenceEditor.sequences_all`](#bpy.types.SequenceEditor.sequences_all)
    ...
    - [`SequenceEditor.use_cache_composite`](#bpy.types.SequenceEditor.use_cache_composite)
    - [`SequenceEditor.use_cache_final`](#bpy.types.SequenceEditor.use_cache_final)
    - [`SequenceEditor.use_cache_preprocessed`](#bpy.types.SequenceEditor.use_cache_preprocessed)
