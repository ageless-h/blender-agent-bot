...
# ShaderNodeOutputLineStyle(ShaderNode)[#](#shadernodeoutputlinestyle-shadernode "Link to this heading")
...
*class* bpy.types.ShaderNodeOutputLineStyle(*ShaderNode*)[#](#bpy.types.ShaderNodeOutputLineStyle "Link to this definition")
:   blend\_type[#](#bpy.types.ShaderNodeOutputLineStyle.blend_type "Link to this definition")
    :   Type:
        :   enum in [Ramp Blend Items](../../../appendix/bpy_types_enum_items/ramp_blend_items.md#rna-enum-ramp-blend-items), default ‘MIX’

    is\_active\_output[#](#bpy.types.ShaderNodeOutputLineStyle.is_active_output "Link to this definition")
    :   True if this node is used as the active output

        Type:
        :   boolean, default False

    target[#](#bpy.types.ShaderNodeOutputLineStyle.target "Link to this definition")
    :   Which renderer and viewport shading types to use the shaders for
        ...
        * `CYCLES`
        ...
        Type:
        :   enum in [‘ALL’, ‘EEVEE’, ‘CYCLES’], default ‘ALL’

    use\_alpha[#](#bpy.types.ShaderNodeOutputLineStyle.use_alpha "Link to this definition")
    :   Include alpha of second input in this operation

        Type:
        :   boolean, default False

    use\_clamp[#](#bpy.types.ShaderNodeOutputLineStyle.use_clamp "Link to this definition")
    :   Clamp result of the node to 0.0 to 1.0 range

        Type:
        :   boolean, default False

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.ShaderNodeOutputLineStyle.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.ShaderNodeOutputLineStyle.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.ShaderNodeOutputLineStyle.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.ShaderNodeOutputLineStyle.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.ShaderNodeOutputLineStyle.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ShaderNodeOutputLineStyle.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.ShaderNodeOutputLineStyle.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ShaderNodeOutputLineStyle(ShaderNode)
  + [`ShaderNodeOutputLineStyle`](#bpy.types.ShaderNodeOutputLineStyle)
    - [`ShaderNodeOutputLineStyle.blend_type`](#bpy.types.ShaderNodeOutputLineStyle.blend_type)
    - [`ShaderNodeOutputLineStyle.is_active_output`](#bpy.types.ShaderNodeOutputLineStyle.is_active_output)
    - [`ShaderNodeOutputLineStyle.target`](#bpy.types.ShaderNodeOutputLineStyle.target)
    - [`ShaderNodeOutputLineStyle.use_alpha`](#bpy.types.ShaderNodeOutputLineStyle.use_alpha)
    - [`ShaderNodeOutputLineStyle.use_clamp`](#bpy.types.ShaderNodeOutputLineStyle.use_clamp)
    - [`ShaderNodeOutputLineStyle.is_registered_node_type()`](#bpy.types.ShaderNodeOutputLineStyle.is_registered_node_type)
    - [`ShaderNodeOutputLineStyle.input_template()`](#bpy.types.ShaderNodeOutputLineStyle.input_template)
    - [`ShaderNodeOutputLineStyle.output_template()`](#bpy.types.ShaderNodeOutputLineStyle.output_template)
    - [`ShaderNodeOutputLineStyle.bl_rna_get_subclass()`](#bpy.types.ShaderNodeOutputLineStyle.bl_rna_get_subclass)
    - [`ShaderNodeOutputLineStyle.bl_rna_get_subclass_py()`](#bpy.types.ShaderNodeOutputLineStyle.bl_rna_get_subclass_py)
