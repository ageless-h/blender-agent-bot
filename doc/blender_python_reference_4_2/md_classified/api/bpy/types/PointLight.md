...
# PointLight(Light)[#](#pointlight-light "Link to this heading")
...
*class* bpy.types.PointLight(*Light*)[#](#bpy.types.PointLight "Link to this definition")
:   Omnidirectional point Light

    contact\_shadow\_bias[#](#bpy.types.PointLight.contact_shadow_bias "Link to this definition")
    :   Bias to avoid self shadowing

        Type:
        :   float in [0.001, 9999], default 0.03

    contact\_shadow\_distance[#](#bpy.types.PointLight.contact_shadow_distance "Link to this definition")
    :   World space distance in which to search for screen space occluder

        Type:
        :   float in [0, 9999], default 0.2

    contact\_shadow\_thickness[#](#bpy.types.PointLight.contact_shadow_thickness "Link to this definition")
    :   Pixel thickness used to detect occlusion

        Type:
        :   float in [0, 9999], default 0.2

    energy[#](#bpy.types.PointLight.energy "Link to this definition")
    :   Light energy emitted over the entire area of the light in all directions

        Type:
        :   float in [-inf, inf], default 10.0

    shadow\_buffer\_bias[#](#bpy.types.PointLight.shadow_buffer_bias "Link to this definition")
    :   Bias for reducing self shadowing

        Type:
        :   float in [0, inf], default 1.0

    shadow\_buffer\_clip\_start[#](#bpy.types.PointLight.shadow_buffer_clip_start "Link to this definition")
    :   Shadow map clip start, below which objects will not generate shadows

        Type:
        :   float in [1e-06, inf], default 0.05

    shadow\_color[#](#bpy.types.PointLight.shadow_color "Link to this definition")
    ...
    shadow\_filter\_radius[#](#bpy.types.PointLight.shadow_filter_radius "Link to this definition")
    :   Blur shadow aliasing using Percentage Closer Filtering

        Type:
        :   float in [0, inf], default 1.0

    shadow\_jitter\_overblur[#](#bpy.types.PointLight.shadow_jitter_overblur "Link to this definition")
    :   Apply shadow tracing to each jittered sample to reduce under-sampling artifacts

        Type:
        :   float in [0, 100], default 10.0

    shadow\_maximum\_resolution[#](#bpy.types.PointLight.shadow_maximum_resolution "Link to this definition")
    ...
    shadow\_soft\_size[#](#bpy.types.PointLight.shadow_soft_size "Link to this definition")
    :   Light size for ray shadow sampling (Raytraced shadows)

        Type:
        :   float in [0, inf], default 0.0

    use\_absolute\_resolution[#](#bpy.types.PointLight.use_absolute_resolution "Link to this definition")
    :   Limit the resolution at 1 unit from the light origin instead of relative to the shadowed pixel

        Type:
        :   boolean, default False

    use\_contact\_shadow[#](#bpy.types.PointLight.use_contact_shadow "Link to this definition")
    ...
    use\_shadow\_jitter[#](#bpy.types.PointLight.use_shadow_jitter "Link to this definition")
    ...
    use\_soft\_falloff[#](#bpy.types.PointLight.use_soft_falloff "Link to this definition")
    :   Apply falloff to avoid sharp edges when the light geometry intersects with other objects

        Type:
        :   boolean, default True

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.PointLight.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.PointLight.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.PointLight.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.PointLight.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* PointLight(Light)
  + [`PointLight`](#bpy.types.PointLight)
    - [`PointLight.contact_shadow_bias`](#bpy.types.PointLight.contact_shadow_bias)
    - [`PointLight.contact_shadow_distance`](#bpy.types.PointLight.contact_shadow_distance)
    - [`PointLight.contact_shadow_thickness`](#bpy.types.PointLight.contact_shadow_thickness)
    - [`PointLight.energy`](#bpy.types.PointLight.energy)
    - [`PointLight.shadow_buffer_bias`](#bpy.types.PointLight.shadow_buffer_bias)
    - [`PointLight.shadow_buffer_clip_start`](#bpy.types.PointLight.shadow_buffer_clip_start)
    - [`PointLight.shadow_color`](#bpy.types.PointLight.shadow_color)
    - [`PointLight.shadow_filter_radius`](#bpy.types.PointLight.shadow_filter_radius)
    - [`PointLight.shadow_jitter_overblur`](#bpy.types.PointLight.shadow_jitter_overblur)
    - [`PointLight.shadow_maximum_resolution`](#bpy.types.PointLight.shadow_maximum_resolution)
    - [`PointLight.shadow_soft_size`](#bpy.types.PointLight.shadow_soft_size)
    - [`PointLight.use_absolute_resolution`](#bpy.types.PointLight.use_absolute_resolution)
    - [`PointLight.use_contact_shadow`](#bpy.types.PointLight.use_contact_shadow)
    - [`PointLight.use_shadow_jitter`](#bpy.types.PointLight.use_shadow_jitter)
    - [`PointLight.use_soft_falloff`](#bpy.types.PointLight.use_soft_falloff)
    - [`PointLight.bl_rna_get_subclass()`](#bpy.types.PointLight.bl_rna_get_subclass)
    - [`PointLight.bl_rna_get_subclass_py()`](#bpy.types.PointLight.bl_rna_get_subclass_py)
