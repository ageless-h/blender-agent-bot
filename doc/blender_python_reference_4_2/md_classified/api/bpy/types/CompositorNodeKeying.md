...
# CompositorNodeKeying(CompositorNode)[#](#compositornodekeying-compositornode "Link to this heading")
...
*class* bpy.types.CompositorNodeKeying(*CompositorNode*)[#](#bpy.types.CompositorNodeKeying "Link to this definition")
:   Perform both chroma keying (to remove the backdrop) and despill (to correct color cast from the backdrop)

    blur\_post[#](#bpy.types.CompositorNodeKeying.blur_post "Link to this definition")
    :   Matte blur size which applies after clipping and dilate/eroding

        Type:
        :   int in [0, 2048], default 0

    blur\_pre[#](#bpy.types.CompositorNodeKeying.blur_pre "Link to this definition")
    :   Chroma pre-blur size which applies before running keyer

        Type:
        :   int in [0, 2048], default 0

    clip\_black[#](#bpy.types.CompositorNodeKeying.clip_black "Link to this definition")
    :   Value of non-scaled matte pixel which considers as fully background pixel

        Type:
        :   float in [0, 1], default 0.0

    clip\_white[#](#bpy.types.CompositorNodeKeying.clip_white "Link to this definition")
    :   Value of non-scaled matte pixel which considers as fully foreground pixel

        Type:
        :   float in [0, 1], default 0.0

    despill\_balance[#](#bpy.types.CompositorNodeKeying.despill_balance "Link to this definition")
    :   Balance between non-key colors used to detect amount of key color to be removed

        Type:
        :   float in [0, 1], default 0.0

    despill\_factor[#](#bpy.types.CompositorNodeKeying.despill_factor "Link to this definition")
    :   Factor of despilling screen color from image

        Type:
        :   float in [0, 1], default 0.0

    dilate\_distance[#](#bpy.types.CompositorNodeKeying.dilate_distance "Link to this definition")
    :   Distance to grow/shrink the matte

        Type:
        :   int in [-100, 100], default 0

    edge\_kernel\_radius[#](#bpy.types.CompositorNodeKeying.edge_kernel_radius "Link to this definition")
    :   Radius of kernel used to detect whether pixel belongs to edge

        Type:
        :   int in [0, 100], default 0

    edge\_kernel\_tolerance[#](#bpy.types.CompositorNodeKeying.edge_kernel_tolerance "Link to this definition")
    :   Tolerance to pixels inside kernel which are treating as belonging to the same plane

        Type:
        :   float in [0, 1], default 0.0

    feather\_distance[#](#bpy.types.CompositorNodeKeying.feather_distance "Link to this definition")
    :   Distance to grow/shrink the feather

        Type:
        :   int in [-100, 100], default 0

    feather\_falloff[#](#bpy.types.CompositorNodeKeying.feather_falloff "Link to this definition")
    :   Falloff type of the feather

        Type:
        :   enum in [Proportional Falloff Curve Only Items](../../../appendix/bpy_types_enum_items/proportional_falloff_curve_only_items.md#rna-enum-proportional-falloff-curve-only-items), default ‘SMOOTH’

    screen\_balance[#](#bpy.types.CompositorNodeKeying.screen_balance "Link to this definition")
    :   Balance between two non-primary channels primary channel is comparing against

        Type:
        :   float in [0, 1], default 0.0

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.CompositorNodeKeying.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.CompositorNodeKeying.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.CompositorNodeKeying.output_template "Link to this definition")
    ...
    update()[#](#bpy.types.CompositorNodeKeying.update "Link to this definition")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.CompositorNodeKeying.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.CompositorNodeKeying.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CompositorNodeKeying.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.CompositorNodeKeying.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CompositorNodeKeying(CompositorNode)
  + [`CompositorNodeKeying`](#bpy.types.CompositorNodeKeying)
    - [`CompositorNodeKeying.blur_post`](#bpy.types.CompositorNodeKeying.blur_post)
    - [`CompositorNodeKeying.blur_pre`](#bpy.types.CompositorNodeKeying.blur_pre)
    - [`CompositorNodeKeying.clip_black`](#bpy.types.CompositorNodeKeying.clip_black)
    - [`CompositorNodeKeying.clip_white`](#bpy.types.CompositorNodeKeying.clip_white)
    - [`CompositorNodeKeying.despill_balance`](#bpy.types.CompositorNodeKeying.despill_balance)
    - [`CompositorNodeKeying.despill_factor`](#bpy.types.CompositorNodeKeying.despill_factor)
    - [`CompositorNodeKeying.dilate_distance`](#bpy.types.CompositorNodeKeying.dilate_distance)
    - [`CompositorNodeKeying.edge_kernel_radius`](#bpy.types.CompositorNodeKeying.edge_kernel_radius)
    - [`CompositorNodeKeying.edge_kernel_tolerance`](#bpy.types.CompositorNodeKeying.edge_kernel_tolerance)
    - [`CompositorNodeKeying.feather_distance`](#bpy.types.CompositorNodeKeying.feather_distance)
    - [`CompositorNodeKeying.feather_falloff`](#bpy.types.CompositorNodeKeying.feather_falloff)
    - [`CompositorNodeKeying.screen_balance`](#bpy.types.CompositorNodeKeying.screen_balance)
    - [`CompositorNodeKeying.is_registered_node_type()`](#bpy.types.CompositorNodeKeying.is_registered_node_type)
    - [`CompositorNodeKeying.input_template()`](#bpy.types.CompositorNodeKeying.input_template)
    - [`CompositorNodeKeying.output_template()`](#bpy.types.CompositorNodeKeying.output_template)
    - [`CompositorNodeKeying.update()`](#bpy.types.CompositorNodeKeying.update)
    - [`CompositorNodeKeying.bl_rna_get_subclass()`](#bpy.types.CompositorNodeKeying.bl_rna_get_subclass)
    - [`CompositorNodeKeying.bl_rna_get_subclass_py()`](#bpy.types.CompositorNodeKeying.bl_rna_get_subclass_py)
