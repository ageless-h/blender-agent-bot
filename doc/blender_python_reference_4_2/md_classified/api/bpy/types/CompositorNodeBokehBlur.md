...
# CompositorNodeBokehBlur(CompositorNode)[#](#compositornodebokehblur-compositornode "Link to this heading")
...
*class* bpy.types.CompositorNodeBokehBlur(*CompositorNode*)[#](#bpy.types.CompositorNodeBokehBlur "Link to this definition")
:   Generate a bokeh type blur similar to Defocus. Unlike defocus an in-focus region is defined in the compositor

    blur\_max[#](#bpy.types.CompositorNodeBokehBlur.blur_max "Link to this definition")
    :   Blur limit, maximum CoC radius

        Type:
        :   float in [0, 10000], default 0.0

    use\_extended\_bounds[#](#bpy.types.CompositorNodeBokehBlur.use_extended_bounds "Link to this definition")
    :   Extend bounds of the input image to fully fit blurred image

        Type:
        :   boolean, default False

    use\_variable\_size[#](#bpy.types.CompositorNodeBokehBlur.use_variable_size "Link to this definition")
    :   Support variable blur per pixel when using an image for size input

        Type:
        :   boolean, default False

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.CompositorNodeBokehBlur.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.CompositorNodeBokehBlur.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.CompositorNodeBokehBlur.output_template "Link to this definition")
    ...
    update()[#](#bpy.types.CompositorNodeBokehBlur.update "Link to this definition")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.CompositorNodeBokehBlur.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.CompositorNodeBokehBlur.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CompositorNodeBokehBlur.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.CompositorNodeBokehBlur.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CompositorNodeBokehBlur(CompositorNode)
  + [`CompositorNodeBokehBlur`](#bpy.types.CompositorNodeBokehBlur)
    - [`CompositorNodeBokehBlur.blur_max`](#bpy.types.CompositorNodeBokehBlur.blur_max)
    - [`CompositorNodeBokehBlur.use_extended_bounds`](#bpy.types.CompositorNodeBokehBlur.use_extended_bounds)
    - [`CompositorNodeBokehBlur.use_variable_size`](#bpy.types.CompositorNodeBokehBlur.use_variable_size)
    - [`CompositorNodeBokehBlur.is_registered_node_type()`](#bpy.types.CompositorNodeBokehBlur.is_registered_node_type)
    - [`CompositorNodeBokehBlur.input_template()`](#bpy.types.CompositorNodeBokehBlur.input_template)
    - [`CompositorNodeBokehBlur.output_template()`](#bpy.types.CompositorNodeBokehBlur.output_template)
    - [`CompositorNodeBokehBlur.update()`](#bpy.types.CompositorNodeBokehBlur.update)
    - [`CompositorNodeBokehBlur.bl_rna_get_subclass()`](#bpy.types.CompositorNodeBokehBlur.bl_rna_get_subclass)
    - [`CompositorNodeBokehBlur.bl_rna_get_subclass_py()`](#bpy.types.CompositorNodeBokehBlur.bl_rna_get_subclass_py)
