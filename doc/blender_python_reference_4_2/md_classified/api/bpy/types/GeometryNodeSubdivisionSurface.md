...
# GeometryNodeSubdivisionSurface(GeometryNode)[#](#geometrynodesubdivisionsurface-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeSubdivisionSurface(*GeometryNode*)[#](#bpy.types.GeometryNodeSubdivisionSurface "Link to this definition")
:   Divide mesh faces to form a smooth surface, using the Catmull-Clark subdivision method

    boundary\_smooth[#](#bpy.types.GeometryNodeSubdivisionSurface.boundary_smooth "Link to this definition")
    ...
    uv\_smooth[#](#bpy.types.GeometryNodeSubdivisionSurface.uv_smooth "Link to this definition")
    ...
    *classmethod* is\_registered\_node\_type()[#](#bpy.types.GeometryNodeSubdivisionSurface.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.GeometryNodeSubdivisionSurface.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.GeometryNodeSubdivisionSurface.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.GeometryNodeSubdivisionSurface.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.GeometryNodeSubdivisionSurface.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeSubdivisionSurface.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.GeometryNodeSubdivisionSurface.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeSubdivisionSurface(GeometryNode)
  + [`GeometryNodeSubdivisionSurface`](#bpy.types.GeometryNodeSubdivisionSurface)
    - [`GeometryNodeSubdivisionSurface.boundary_smooth`](#bpy.types.GeometryNodeSubdivisionSurface.boundary_smooth)
    - [`GeometryNodeSubdivisionSurface.uv_smooth`](#bpy.types.GeometryNodeSubdivisionSurface.uv_smooth)
    - [`GeometryNodeSubdivisionSurface.is_registered_node_type()`](#bpy.types.GeometryNodeSubdivisionSurface.is_registered_node_type)
    - [`GeometryNodeSubdivisionSurface.input_template()`](#bpy.types.GeometryNodeSubdivisionSurface.input_template)
    - [`GeometryNodeSubdivisionSurface.output_template()`](#bpy.types.GeometryNodeSubdivisionSurface.output_template)
    - [`GeometryNodeSubdivisionSurface.bl_rna_get_subclass()`](#bpy.types.GeometryNodeSubdivisionSurface.bl_rna_get_subclass)
    - [`GeometryNodeSubdivisionSurface.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeSubdivisionSurface.bl_rna_get_subclass_py)
