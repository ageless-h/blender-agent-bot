...
# ShaderNodeOutputAOV(ShaderNode)[#](#shadernodeoutputaov-shadernode "Link to this heading")
...
*class* bpy.types.ShaderNodeOutputAOV(*ShaderNode*)[#](#bpy.types.ShaderNodeOutputAOV "Link to this definition")
:   Arbitrary Output Variables.
    Provide custom render passes for arbitrary shader node outputs

    aov\_name[#](#bpy.types.ShaderNodeOutputAOV.aov_name "Link to this definition")
    :   Name of the AOV that this output writes to

        Type:
        :   string, default “”, (never None)

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.ShaderNodeOutputAOV.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.ShaderNodeOutputAOV.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.ShaderNodeOutputAOV.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.ShaderNodeOutputAOV.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.ShaderNodeOutputAOV.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ShaderNodeOutputAOV.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.ShaderNodeOutputAOV.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ShaderNodeOutputAOV(ShaderNode)
  + [`ShaderNodeOutputAOV`](#bpy.types.ShaderNodeOutputAOV)
    - [`ShaderNodeOutputAOV.aov_name`](#bpy.types.ShaderNodeOutputAOV.aov_name)
    - [`ShaderNodeOutputAOV.is_registered_node_type()`](#bpy.types.ShaderNodeOutputAOV.is_registered_node_type)
    - [`ShaderNodeOutputAOV.input_template()`](#bpy.types.ShaderNodeOutputAOV.input_template)
    - [`ShaderNodeOutputAOV.output_template()`](#bpy.types.ShaderNodeOutputAOV.output_template)
    - [`ShaderNodeOutputAOV.bl_rna_get_subclass()`](#bpy.types.ShaderNodeOutputAOV.bl_rna_get_subclass)
    - [`ShaderNodeOutputAOV.bl_rna_get_subclass_py()`](#bpy.types.ShaderNodeOutputAOV.bl_rna_get_subclass_py)
