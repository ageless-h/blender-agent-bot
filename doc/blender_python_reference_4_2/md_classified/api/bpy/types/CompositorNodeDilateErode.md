...
# CompositorNodeDilateErode(CompositorNode)[#](#compositornodedilateerode-compositornode "Link to this heading")
...
*class* bpy.types.CompositorNodeDilateErode(*CompositorNode*)[#](#bpy.types.CompositorNodeDilateErode "Link to this definition")
:   Expand and shrink masks

    distance[#](#bpy.types.CompositorNodeDilateErode.distance "Link to this definition")
    :   Distance to grow/shrink (number of iterations)

        Type:
        :   int in [-5000, 5000], default 0

    edge[#](#bpy.types.CompositorNodeDilateErode.edge "Link to this definition")
    :   Edge to inset

        Type:
        :   float in [-100, 100], default 0.0

    falloff[#](#bpy.types.CompositorNodeDilateErode.falloff "Link to this definition")
    ...
    mode[#](#bpy.types.CompositorNodeDilateErode.mode "Link to this definition")
    :   Growing/shrinking mode

        Type:
        :   enum in [‘STEP’, ‘THRESHOLD’, ‘DISTANCE’, ‘FEATHER’], default ‘STEP’

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.CompositorNodeDilateErode.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.CompositorNodeDilateErode.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.CompositorNodeDilateErode.output_template "Link to this definition")
    ...
    update()[#](#bpy.types.CompositorNodeDilateErode.update "Link to this definition")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.CompositorNodeDilateErode.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.CompositorNodeDilateErode.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CompositorNodeDilateErode.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.CompositorNodeDilateErode.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CompositorNodeDilateErode(CompositorNode)
  + [`CompositorNodeDilateErode`](#bpy.types.CompositorNodeDilateErode)
    - [`CompositorNodeDilateErode.distance`](#bpy.types.CompositorNodeDilateErode.distance)
    - [`CompositorNodeDilateErode.edge`](#bpy.types.CompositorNodeDilateErode.edge)
    - [`CompositorNodeDilateErode.falloff`](#bpy.types.CompositorNodeDilateErode.falloff)
    - [`CompositorNodeDilateErode.mode`](#bpy.types.CompositorNodeDilateErode.mode)
    - [`CompositorNodeDilateErode.is_registered_node_type()`](#bpy.types.CompositorNodeDilateErode.is_registered_node_type)
    - [`CompositorNodeDilateErode.input_template()`](#bpy.types.CompositorNodeDilateErode.input_template)
    - [`CompositorNodeDilateErode.output_template()`](#bpy.types.CompositorNodeDilateErode.output_template)
    - [`CompositorNodeDilateErode.update()`](#bpy.types.CompositorNodeDilateErode.update)
    - [`CompositorNodeDilateErode.bl_rna_get_subclass()`](#bpy.types.CompositorNodeDilateErode.bl_rna_get_subclass)
    - [`CompositorNodeDilateErode.bl_rna_get_subclass_py()`](#bpy.types.CompositorNodeDilateErode.bl_rna_get_subclass_py)
