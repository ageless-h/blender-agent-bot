...
# CompositorNodeTonemap(CompositorNode)[#](#compositornodetonemap-compositornode "Link to this heading")
...
*class* bpy.types.CompositorNodeTonemap(*CompositorNode*)[#](#bpy.types.CompositorNodeTonemap "Link to this definition")
:   Map one set of colors to another in order to approximate the appearance of high dynamic range

    adaptation[#](#bpy.types.CompositorNodeTonemap.adaptation "Link to this definition")
    :   If 0, global; if 1, based on pixel intensity

        Type:
        :   float in [0, 1], default 0.0

    contrast[#](#bpy.types.CompositorNodeTonemap.contrast "Link to this definition")
    :   Set to 0 to use estimate from input image

        Type:
        :   float in [0, 1], default 0.0

    correction[#](#bpy.types.CompositorNodeTonemap.correction "Link to this definition")
    :   If 0, same for all channels; if 1, each independent

        Type:
        :   float in [0, 1], default 0.0

    gamma[#](#bpy.types.CompositorNodeTonemap.gamma "Link to this definition")
    :   If not used, set to 1

        Type:
        :   float in [0.001, 3], default 0.0

    intensity[#](#bpy.types.CompositorNodeTonemap.intensity "Link to this definition")
    :   If less than zero, darkens image; otherwise, makes it brighter

        Type:
        :   float in [-8, 8], default 0.0

    key[#](#bpy.types.CompositorNodeTonemap.key "Link to this definition")
    :   The value the average luminance is mapped to

        Type:
        :   float in [0, 1], default 0.0

    offset[#](#bpy.types.CompositorNodeTonemap.offset "Link to this definition")
    :   Normally always 1, but can be used as an extra control to alter the brightness curve

        Type:
        :   float in [0.001, 10], default 0.0

    tonemap\_type[#](#bpy.types.CompositorNodeTonemap.tonemap_type "Link to this definition")
    :   * `RD_PHOTORECEPTOR`
          R/D Photoreceptor – More advanced algorithm based on eye physiology, by Reinhard and Devlin.
        * `RH_SIMPLE`
          Rh Simple – Simpler photographic algorithm by Reinhard.

        Type:
        :   enum in [‘RD\_PHOTORECEPTOR’, ‘RH\_SIMPLE’], default ‘RH\_SIMPLE’

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.CompositorNodeTonemap.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.CompositorNodeTonemap.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.CompositorNodeTonemap.output_template "Link to this definition")
    ...
    update()[#](#bpy.types.CompositorNodeTonemap.update "Link to this definition")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.CompositorNodeTonemap.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.CompositorNodeTonemap.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CompositorNodeTonemap.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.CompositorNodeTonemap.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CompositorNodeTonemap(CompositorNode)
  + [`CompositorNodeTonemap`](#bpy.types.CompositorNodeTonemap)
    - [`CompositorNodeTonemap.adaptation`](#bpy.types.CompositorNodeTonemap.adaptation)
    - [`CompositorNodeTonemap.contrast`](#bpy.types.CompositorNodeTonemap.contrast)
    - [`CompositorNodeTonemap.correction`](#bpy.types.CompositorNodeTonemap.correction)
    - [`CompositorNodeTonemap.gamma`](#bpy.types.CompositorNodeTonemap.gamma)
    - [`CompositorNodeTonemap.intensity`](#bpy.types.CompositorNodeTonemap.intensity)
    - [`CompositorNodeTonemap.key`](#bpy.types.CompositorNodeTonemap.key)
    - [`CompositorNodeTonemap.offset`](#bpy.types.CompositorNodeTonemap.offset)
    - [`CompositorNodeTonemap.tonemap_type`](#bpy.types.CompositorNodeTonemap.tonemap_type)
    - [`CompositorNodeTonemap.is_registered_node_type()`](#bpy.types.CompositorNodeTonemap.is_registered_node_type)
    - [`CompositorNodeTonemap.input_template()`](#bpy.types.CompositorNodeTonemap.input_template)
    - [`CompositorNodeTonemap.output_template()`](#bpy.types.CompositorNodeTonemap.output_template)
    - [`CompositorNodeTonemap.update()`](#bpy.types.CompositorNodeTonemap.update)
    - [`CompositorNodeTonemap.bl_rna_get_subclass()`](#bpy.types.CompositorNodeTonemap.bl_rna_get_subclass)
    - [`CompositorNodeTonemap.bl_rna_get_subclass_py()`](#bpy.types.CompositorNodeTonemap.bl_rna_get_subclass_py)
