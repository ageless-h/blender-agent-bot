...
# SubdivGpencilModifier(GpencilModifier)[#](#subdivgpencilmodifier-gpencilmodifier "Link to this heading")
...
*class* bpy.types.SubdivGpencilModifier(*GpencilModifier*)[#](#bpy.types.SubdivGpencilModifier "Link to this definition")
:   Subdivide Stroke modifier

    invert\_layer\_pass[#](#bpy.types.SubdivGpencilModifier.invert_layer_pass "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    invert\_layers[#](#bpy.types.SubdivGpencilModifier.invert_layers "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    invert\_material\_pass[#](#bpy.types.SubdivGpencilModifier.invert_material_pass "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    invert\_materials[#](#bpy.types.SubdivGpencilModifier.invert_materials "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    layer[#](#bpy.types.SubdivGpencilModifier.layer "Link to this definition")
    :   Layer name

        Type:
        :   string, default “”, (never None)

    layer\_pass[#](#bpy.types.SubdivGpencilModifier.layer_pass "Link to this definition")
    :   Layer pass index

        Type:
        :   int in [0, 100], default 0

    level[#](#bpy.types.SubdivGpencilModifier.level "Link to this definition")
    :   Number of subdivisions

        Type:
        :   int in [0, 16], default 1

    material[#](#bpy.types.SubdivGpencilModifier.material "Link to this definition")
    :   Material used for filtering effect

        Type:
        :   [`Material`](Material.md#bpy.types.Material "bpy.types.Material")

    pass\_index[#](#bpy.types.SubdivGpencilModifier.pass_index "Link to this definition")
    :   Pass index

        Type:
        :   int in [0, 100], default 0

    subdivision\_type[#](#bpy.types.SubdivGpencilModifier.subdivision_type "Link to this definition")
    :   Select type of subdivision algorithm

        Type:
        :   enum in [‘CATMULL\_CLARK’, ‘SIMPLE’], default ‘CATMULL\_CLARK’

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.SubdivGpencilModifier.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.SubdivGpencilModifier.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.SubdivGpencilModifier.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.SubdivGpencilModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* SubdivGpencilModifier(GpencilModifier)
  + [`SubdivGpencilModifier`](#bpy.types.SubdivGpencilModifier)
    - [`SubdivGpencilModifier.invert_layer_pass`](#bpy.types.SubdivGpencilModifier.invert_layer_pass)
    - [`SubdivGpencilModifier.invert_layers`](#bpy.types.SubdivGpencilModifier.invert_layers)
    - [`SubdivGpencilModifier.invert_material_pass`](#bpy.types.SubdivGpencilModifier.invert_material_pass)
    - [`SubdivGpencilModifier.invert_materials`](#bpy.types.SubdivGpencilModifier.invert_materials)
    - [`SubdivGpencilModifier.layer`](#bpy.types.SubdivGpencilModifier.layer)
    - [`SubdivGpencilModifier.layer_pass`](#bpy.types.SubdivGpencilModifier.layer_pass)
    - [`SubdivGpencilModifier.level`](#bpy.types.SubdivGpencilModifier.level)
    - [`SubdivGpencilModifier.material`](#bpy.types.SubdivGpencilModifier.material)
    - [`SubdivGpencilModifier.pass_index`](#bpy.types.SubdivGpencilModifier.pass_index)
    - [`SubdivGpencilModifier.subdivision_type`](#bpy.types.SubdivGpencilModifier.subdivision_type)
    - [`SubdivGpencilModifier.bl_rna_get_subclass()`](#bpy.types.SubdivGpencilModifier.bl_rna_get_subclass)
    - [`SubdivGpencilModifier.bl_rna_get_subclass_py()`](#bpy.types.SubdivGpencilModifier.bl_rna_get_subclass_py)
