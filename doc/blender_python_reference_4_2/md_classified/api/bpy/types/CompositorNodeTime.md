...
# CompositorNodeTime(CompositorNode)[#](#compositornodetime-compositornode "Link to this heading")
...
*class* bpy.types.CompositorNodeTime(*CompositorNode*)[#](#bpy.types.CompositorNodeTime "Link to this definition")
:   Generate a factor value (from 0.0 to 1.0) between scene start and end time, using a curve mapping

    curve[#](#bpy.types.CompositorNodeTime.curve "Link to this definition")
    :   Type:
        :   [`CurveMapping`](CurveMapping.md#bpy.types.CurveMapping "bpy.types.CurveMapping"), (readonly)

    frame\_end[#](#bpy.types.CompositorNodeTime.frame_end "Link to this definition")
    :   Type:
        :   int in [-32768, 32767], default 0

    frame\_start[#](#bpy.types.CompositorNodeTime.frame_start "Link to this definition")
    :   Type:
        :   int in [-32768, 32767], default 0

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.CompositorNodeTime.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.CompositorNodeTime.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.CompositorNodeTime.output_template "Link to this definition")
    ...
    update()[#](#bpy.types.CompositorNodeTime.update "Link to this definition")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.CompositorNodeTime.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.CompositorNodeTime.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CompositorNodeTime.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.CompositorNodeTime.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CompositorNodeTime(CompositorNode)
  + [`CompositorNodeTime`](#bpy.types.CompositorNodeTime)
    - [`CompositorNodeTime.curve`](#bpy.types.CompositorNodeTime.curve)
    - [`CompositorNodeTime.frame_end`](#bpy.types.CompositorNodeTime.frame_end)
    - [`CompositorNodeTime.frame_start`](#bpy.types.CompositorNodeTime.frame_start)
    - [`CompositorNodeTime.is_registered_node_type()`](#bpy.types.CompositorNodeTime.is_registered_node_type)
    - [`CompositorNodeTime.input_template()`](#bpy.types.CompositorNodeTime.input_template)
    - [`CompositorNodeTime.output_template()`](#bpy.types.CompositorNodeTime.output_template)
    - [`CompositorNodeTime.update()`](#bpy.types.CompositorNodeTime.update)
    - [`CompositorNodeTime.bl_rna_get_subclass()`](#bpy.types.CompositorNodeTime.bl_rna_get_subclass)
    - [`CompositorNodeTime.bl_rna_get_subclass_py()`](#bpy.types.CompositorNodeTime.bl_rna_get_subclass_py)
