...
|  |  |
| --- | --- |
| * [`KeyConfigurations.find_item_from_operator`](KeyConfigurations.md#bpy.types.KeyConfigurations.find_item_from_operator "bpy.types.KeyConfigurations.find_item_from_operator") * [`KeyMap.keymap_items`](KeyMap.md#bpy.types.KeyMap.keymap_items "bpy.types.KeyMap.keymap_items") * [`KeyMap.restore_item_to_default`](KeyMap.md#bpy.types.KeyMap.restore_item_to_default "bpy.types.KeyMap.restore_item_to_default") * [`KeyMapItem.compare`](#bpy.types.KeyMapItem.compare "bpy.types.KeyMapItem.compare") * [`KeyMapItems.find_from_operator`](KeyMapItems.md#bpy.types.KeyMapItems.find_from_operator "bpy.types.KeyMapItems.find_from_operator") * [`KeyMapItems.from_id`](KeyMapItems.md#bpy.types.KeyMapItems.from_id "bpy.types.KeyMapItems.from_id") * [`KeyMapItems.match_event`](KeyMapItems.md#bpy.types.KeyMapItems.match_event "bpy.types.KeyMapItems.match_event") | * [`KeyMapItems.new`](KeyMapItems.md#bpy.types.KeyMapItems.new "bpy.types.KeyMapItems.new") * [`KeyMapItems.new_from_item`](KeyMapItems.md#bpy.types.KeyMapItems.new_from_item "bpy.types.KeyMapItems.new_from_item") * [`KeyMapItems.new_from_item`](KeyMapItems.md#bpy.types.KeyMapItems.new_from_item "bpy.types.KeyMapItems.new_from_item") * [`KeyMapItems.new_modal`](KeyMapItems.md#bpy.types.KeyMapItems.new_modal "bpy.types.KeyMapItems.new_modal") * [`KeyMapItems.remove`](KeyMapItems.md#bpy.types.KeyMapItems.remove "bpy.types.KeyMapItems.remove") * [`UILayout.template_event_from_keymap_item`](UILayout.md#bpy.types.UILayout.template_event_from_keymap_item "bpy.types.UILayout.template_event_from_keymap_item") * [`UILayout.template_keymap_item_properties`](UILayout.md#bpy.types.UILayout.template_keymap_item_properties "bpy.types.UILayout.template_keymap_item_properties") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.KeyMapItem.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.KeyMapItem.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)
