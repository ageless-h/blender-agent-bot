...
# CompositorNodeChannelMatte(CompositorNode)[#](#compositornodechannelmatte-compositornode "Link to this heading")
...
*class* bpy.types.CompositorNodeChannelMatte(*CompositorNode*)[#](#bpy.types.CompositorNodeChannelMatte "Link to this definition")
:   Create matte based on differences in color channels

    color\_space[#](#bpy.types.CompositorNodeChannelMatte.color_space "Link to this definition")
    :   * `RGB`
          RGB – RGB color space.
        * `HSV`
          HSV – HSV color space.
    ...
    limit\_channel[#](#bpy.types.CompositorNodeChannelMatte.limit_channel "Link to this definition")
    ...
    limit\_max[#](#bpy.types.CompositorNodeChannelMatte.limit_max "Link to this definition")
    :   Values higher than this setting are 100% opaque

        Type:
        :   float in [-inf, inf], default 0.0

    limit\_method[#](#bpy.types.CompositorNodeChannelMatte.limit_method "Link to this definition")
    ...
    limit\_min[#](#bpy.types.CompositorNodeChannelMatte.limit_min "Link to this definition")
    :   Values lower than this setting are 100% keyed

        Type:
        :   float in [-inf, inf], default 0.0

    matte\_channel[#](#bpy.types.CompositorNodeChannelMatte.matte_channel "Link to this definition")
    ...
    *classmethod* is\_registered\_node\_type()[#](#bpy.types.CompositorNodeChannelMatte.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.CompositorNodeChannelMatte.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.CompositorNodeChannelMatte.output_template "Link to this definition")
    ...
    update()[#](#bpy.types.CompositorNodeChannelMatte.update "Link to this definition")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.CompositorNodeChannelMatte.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.CompositorNodeChannelMatte.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CompositorNodeChannelMatte.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.CompositorNodeChannelMatte.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CompositorNodeChannelMatte(CompositorNode)
  + [`CompositorNodeChannelMatte`](#bpy.types.CompositorNodeChannelMatte)
    - [`CompositorNodeChannelMatte.color_space`](#bpy.types.CompositorNodeChannelMatte.color_space)
    - [`CompositorNodeChannelMatte.limit_channel`](#bpy.types.CompositorNodeChannelMatte.limit_channel)
    - [`CompositorNodeChannelMatte.limit_max`](#bpy.types.CompositorNodeChannelMatte.limit_max)
    - [`CompositorNodeChannelMatte.limit_method`](#bpy.types.CompositorNodeChannelMatte.limit_method)
    - [`CompositorNodeChannelMatte.limit_min`](#bpy.types.CompositorNodeChannelMatte.limit_min)
    - [`CompositorNodeChannelMatte.matte_channel`](#bpy.types.CompositorNodeChannelMatte.matte_channel)
    - [`CompositorNodeChannelMatte.is_registered_node_type()`](#bpy.types.CompositorNodeChannelMatte.is_registered_node_type)
    - [`CompositorNodeChannelMatte.input_template()`](#bpy.types.CompositorNodeChannelMatte.input_template)
    - [`CompositorNodeChannelMatte.output_template()`](#bpy.types.CompositorNodeChannelMatte.output_template)
    - [`CompositorNodeChannelMatte.update()`](#bpy.types.CompositorNodeChannelMatte.update)
    - [`CompositorNodeChannelMatte.bl_rna_get_subclass()`](#bpy.types.CompositorNodeChannelMatte.bl_rna_get_subclass)
    - [`CompositorNodeChannelMatte.bl_rna_get_subclass_py()`](#bpy.types.CompositorNodeChannelMatte.bl_rna_get_subclass_py)
