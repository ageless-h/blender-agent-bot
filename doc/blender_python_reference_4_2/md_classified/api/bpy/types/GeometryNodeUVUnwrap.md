...
# GeometryNodeUVUnwrap(GeometryNode)[#](#geometrynodeuvunwrap-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeUVUnwrap(*GeometryNode*)[#](#bpy.types.GeometryNodeUVUnwrap "Link to this definition")
:   Generate a UV map based on seam edges

    method[#](#bpy.types.GeometryNodeUVUnwrap.method "Link to this definition")
    :   * `ANGLE_BASED`
          Angle Based – This method gives a good 2D representation of a mesh.
        * `CONFORMAL`
          Conformal – Uses LSCM (Least Squares Conformal Mapping). This usually gives a less accurate UV mapping than Angle Based, but works better for simpler objects.

        Type:
        :   enum in [‘ANGLE\_BASED’, ‘CONFORMAL’], default ‘ANGLE\_BASED’

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.GeometryNodeUVUnwrap.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.GeometryNodeUVUnwrap.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.GeometryNodeUVUnwrap.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.GeometryNodeUVUnwrap.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.GeometryNodeUVUnwrap.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeUVUnwrap.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.GeometryNodeUVUnwrap.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeUVUnwrap(GeometryNode)
  + [`GeometryNodeUVUnwrap`](#bpy.types.GeometryNodeUVUnwrap)
    - [`GeometryNodeUVUnwrap.method`](#bpy.types.GeometryNodeUVUnwrap.method)
    - [`GeometryNodeUVUnwrap.is_registered_node_type()`](#bpy.types.GeometryNodeUVUnwrap.is_registered_node_type)
    - [`GeometryNodeUVUnwrap.input_template()`](#bpy.types.GeometryNodeUVUnwrap.input_template)
    - [`GeometryNodeUVUnwrap.output_template()`](#bpy.types.GeometryNodeUVUnwrap.output_template)
    - [`GeometryNodeUVUnwrap.bl_rna_get_subclass()`](#bpy.types.GeometryNodeUVUnwrap.bl_rna_get_subclass)
    - [`GeometryNodeUVUnwrap.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeUVUnwrap.bl_rna_get_subclass_py)
