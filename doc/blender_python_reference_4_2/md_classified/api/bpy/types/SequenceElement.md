...
# SequenceElement(bpy\_struct)[#](#sequenceelement-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.SequenceElement(*bpy\_struct*)[#](#bpy.types.SequenceElement "Link to this definition")
:   Sequence strip data for a single frame

    filename[#](#bpy.types.SequenceElement.filename "Link to this definition")
    :   Name of the source file

        Type:
        :   string, default “”, (never None)

    orig\_fps[#](#bpy.types.SequenceElement.orig_fps "Link to this definition")
    :   Original frames per second

        Type:
        :   float in [-inf, inf], default 0.0, (readonly)

    orig\_height[#](#bpy.types.SequenceElement.orig_height "Link to this definition")
    :   Original image height

        Type:
        :   int in [-inf, inf], default 0, (readonly)

    orig\_width[#](#bpy.types.SequenceElement.orig_width "Link to this definition")
    :   Original image width

        Type:
        :   int in [-inf, inf], default 0, (readonly)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.SequenceElement.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.SequenceElement.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`ImageSequence.elements`](ImageSequence.md#bpy.types.ImageSequence.elements "bpy.types.ImageSequence.elements") * [`MovieSequence.elements`](MovieSequence.md#bpy.types.MovieSequence.elements "bpy.types.MovieSequence.elements") | * [`Sequence.strip_elem_from_frame`](Sequence.md#bpy.types.Sequence.strip_elem_from_frame "bpy.types.Sequence.strip_elem_from_frame") * [`SequenceElements.append`](SequenceElements.md#bpy.types.SequenceElements.append "bpy.types.SequenceElements.append") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.SequenceElement.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.SequenceElement.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* SequenceElement(bpy\_struct)
  + [`SequenceElement`](#bpy.types.SequenceElement)
    - [`SequenceElement.filename`](#bpy.types.SequenceElement.filename)
    - [`SequenceElement.orig_fps`](#bpy.types.SequenceElement.orig_fps)
    - [`SequenceElement.orig_height`](#bpy.types.SequenceElement.orig_height)
    - [`SequenceElement.orig_width`](#bpy.types.SequenceElement.orig_width)
    - [`SequenceElement.bl_rna_get_subclass()`](#bpy.types.SequenceElement.bl_rna_get_subclass)
    - [`SequenceElement.bl_rna_get_subclass_py()`](#bpy.types.SequenceElement.bl_rna_get_subclass_py)
