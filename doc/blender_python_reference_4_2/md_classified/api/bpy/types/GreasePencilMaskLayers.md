...
# GreasePencilMaskLayers(bpy\_struct)[#](#greasepencilmasklayers-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.GreasePencilMaskLayers(*bpy\_struct*)[#](#bpy.types.GreasePencilMaskLayers "Link to this definition")
:   Collection of grease pencil masking layers

    active\_mask\_index[#](#bpy.types.GreasePencilMaskLayers.active_mask_index "Link to this definition")
    :   Active index in layer mask array

        Type:
        :   int in [0, inf], default 0

    add(*layer*)[#](#bpy.types.GreasePencilMaskLayers.add "Link to this definition")
    :   Add a layer to mask list

        Parameters:
        :   **layer** ([`GPencilLayer`](GPencilLayer.md#bpy.types.GPencilLayer "bpy.types.GPencilLayer"), (never None)) – Layer to add as mask

    remove(*mask*)[#](#bpy.types.GreasePencilMaskLayers.remove "Link to this definition")
    :   Remove a layer from mask list

        Parameters:
        :   **mask** ([`GPencilLayerMask`](GPencilLayerMask.md#bpy.types.GPencilLayerMask "bpy.types.GPencilLayerMask"), (never None)) – Mask to remove

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.GreasePencilMaskLayers.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.GreasePencilMaskLayers.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`GPencilLayer.mask_layers`](GPencilLayer.md#bpy.types.GPencilLayer.mask_layers "bpy.types.GPencilLayer.mask_layers") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GreasePencilMaskLayers.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.GreasePencilMaskLayers.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GreasePencilMaskLayers(bpy\_struct)
  + [`GreasePencilMaskLayers`](#bpy.types.GreasePencilMaskLayers)
    - [`GreasePencilMaskLayers.active_mask_index`](#bpy.types.GreasePencilMaskLayers.active_mask_index)
    - [`GreasePencilMaskLayers.add()`](#bpy.types.GreasePencilMaskLayers.add)
    - [`GreasePencilMaskLayers.remove()`](#bpy.types.GreasePencilMaskLayers.remove)
    - [`GreasePencilMaskLayers.bl_rna_get_subclass()`](#bpy.types.GreasePencilMaskLayers.bl_rna_get_subclass)
    - [`GreasePencilMaskLayers.bl_rna_get_subclass_py()`](#bpy.types.GreasePencilMaskLayers.bl_rna_get_subclass_py)
