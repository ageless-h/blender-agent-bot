...
# CompositorNodeBilateralblur(CompositorNode)[#](#compositornodebilateralblur-compositornode "Link to this heading")
...
*class* bpy.types.CompositorNodeBilateralblur(*CompositorNode*)[#](#bpy.types.CompositorNodeBilateralblur "Link to this definition")
:   Adaptively blur image, while retaining sharp edges

    iterations[#](#bpy.types.CompositorNodeBilateralblur.iterations "Link to this definition")
    :   Type:
        :   int in [1, 128], default 0

    sigma\_color[#](#bpy.types.CompositorNodeBilateralblur.sigma_color "Link to this definition")
    :   Type:
        :   float in [0.01, 3], default 0.0

    sigma\_space[#](#bpy.types.CompositorNodeBilateralblur.sigma_space "Link to this definition")
    :   Type:
        :   float in [0.01, 30], default 0.0

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.CompositorNodeBilateralblur.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.CompositorNodeBilateralblur.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.CompositorNodeBilateralblur.output_template "Link to this definition")
    ...
    update()[#](#bpy.types.CompositorNodeBilateralblur.update "Link to this definition")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.CompositorNodeBilateralblur.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.CompositorNodeBilateralblur.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CompositorNodeBilateralblur.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.CompositorNodeBilateralblur.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CompositorNodeBilateralblur(CompositorNode)
  + [`CompositorNodeBilateralblur`](#bpy.types.CompositorNodeBilateralblur)
    - [`CompositorNodeBilateralblur.iterations`](#bpy.types.CompositorNodeBilateralblur.iterations)
    - [`CompositorNodeBilateralblur.sigma_color`](#bpy.types.CompositorNodeBilateralblur.sigma_color)
    - [`CompositorNodeBilateralblur.sigma_space`](#bpy.types.CompositorNodeBilateralblur.sigma_space)
    - [`CompositorNodeBilateralblur.is_registered_node_type()`](#bpy.types.CompositorNodeBilateralblur.is_registered_node_type)
    - [`CompositorNodeBilateralblur.input_template()`](#bpy.types.CompositorNodeBilateralblur.input_template)
    - [`CompositorNodeBilateralblur.output_template()`](#bpy.types.CompositorNodeBilateralblur.output_template)
    - [`CompositorNodeBilateralblur.update()`](#bpy.types.CompositorNodeBilateralblur.update)
    - [`CompositorNodeBilateralblur.bl_rna_get_subclass()`](#bpy.types.CompositorNodeBilateralblur.bl_rna_get_subclass)
    - [`CompositorNodeBilateralblur.bl_rna_get_subclass_py()`](#bpy.types.CompositorNodeBilateralblur.bl_rna_get_subclass_py)
