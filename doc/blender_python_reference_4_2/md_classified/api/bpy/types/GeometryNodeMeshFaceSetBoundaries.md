...
# GeometryNodeMeshFaceSetBoundaries(GeometryNode)[#](#geometrynodemeshfacesetboundaries-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeMeshFaceSetBoundaries(*GeometryNode*)[#](#bpy.types.GeometryNodeMeshFaceSetBoundaries "Link to this definition")
:   Find edges on the boundaries between groups of faces with the same ID value

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.GeometryNodeMeshFaceSetBoundaries.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.GeometryNodeMeshFaceSetBoundaries.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.GeometryNodeMeshFaceSetBoundaries.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.GeometryNodeMeshFaceSetBoundaries.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.GeometryNodeMeshFaceSetBoundaries.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeMeshFaceSetBoundaries.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.GeometryNodeMeshFaceSetBoundaries.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeMeshFaceSetBoundaries(GeometryNode)
  + [`GeometryNodeMeshFaceSetBoundaries`](#bpy.types.GeometryNodeMeshFaceSetBoundaries)
    - [`GeometryNodeMeshFaceSetBoundaries.is_registered_node_type()`](#bpy.types.GeometryNodeMeshFaceSetBoundaries.is_registered_node_type)
    - [`GeometryNodeMeshFaceSetBoundaries.input_template()`](#bpy.types.GeometryNodeMeshFaceSetBoundaries.input_template)
    - [`GeometryNodeMeshFaceSetBoundaries.output_template()`](#bpy.types.GeometryNodeMeshFaceSetBoundaries.output_template)
    - [`GeometryNodeMeshFaceSetBoundaries.bl_rna_get_subclass()`](#bpy.types.GeometryNodeMeshFaceSetBoundaries.bl_rna_get_subclass)
    - [`GeometryNodeMeshFaceSetBoundaries.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeMeshFaceSetBoundaries.bl_rna_get_subclass_py)
