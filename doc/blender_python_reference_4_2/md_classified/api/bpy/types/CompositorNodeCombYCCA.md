...
# CompositorNodeCombYCCA(CompositorNode)[#](#compositornodecombycca-compositornode "Link to this heading")
...
*class* bpy.types.CompositorNodeCombYCCA(*CompositorNode*)[#](#bpy.types.CompositorNodeCombYCCA "Link to this definition")
:   Deprecated

    mode[#](#bpy.types.CompositorNodeCombYCCA.mode "Link to this definition")
    :   Type:
        :   enum in [‘ITUBT601’, ‘ITUBT709’, ‘JFIF’], default ‘ITUBT601’

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.CompositorNodeCombYCCA.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.CompositorNodeCombYCCA.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.CompositorNodeCombYCCA.output_template "Link to this definition")
    ...
    update()[#](#bpy.types.CompositorNodeCombYCCA.update "Link to this definition")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.CompositorNodeCombYCCA.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.CompositorNodeCombYCCA.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CompositorNodeCombYCCA.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.CompositorNodeCombYCCA.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CompositorNodeCombYCCA(CompositorNode)
  + [`CompositorNodeCombYCCA`](#bpy.types.CompositorNodeCombYCCA)
    - [`CompositorNodeCombYCCA.mode`](#bpy.types.CompositorNodeCombYCCA.mode)
    - [`CompositorNodeCombYCCA.is_registered_node_type()`](#bpy.types.CompositorNodeCombYCCA.is_registered_node_type)
    - [`CompositorNodeCombYCCA.input_template()`](#bpy.types.CompositorNodeCombYCCA.input_template)
    - [`CompositorNodeCombYCCA.output_template()`](#bpy.types.CompositorNodeCombYCCA.output_template)
    - [`CompositorNodeCombYCCA.update()`](#bpy.types.CompositorNodeCombYCCA.update)
    - [`CompositorNodeCombYCCA.bl_rna_get_subclass()`](#bpy.types.CompositorNodeCombYCCA.bl_rna_get_subclass)
    - [`CompositorNodeCombYCCA.bl_rna_get_subclass_py()`](#bpy.types.CompositorNodeCombYCCA.bl_rna_get_subclass_py)
