...
# GeometryNodeCurveOfPoint(GeometryNode)[#](#geometrynodecurveofpoint-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeCurveOfPoint(*GeometryNode*)[#](#bpy.types.GeometryNodeCurveOfPoint "Link to this definition")
:   Retrieve the curve a control point is part of

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.GeometryNodeCurveOfPoint.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.GeometryNodeCurveOfPoint.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.GeometryNodeCurveOfPoint.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.GeometryNodeCurveOfPoint.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.GeometryNodeCurveOfPoint.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeCurveOfPoint.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.GeometryNodeCurveOfPoint.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeCurveOfPoint(GeometryNode)
  + [`GeometryNodeCurveOfPoint`](#bpy.types.GeometryNodeCurveOfPoint)
    - [`GeometryNodeCurveOfPoint.is_registered_node_type()`](#bpy.types.GeometryNodeCurveOfPoint.is_registered_node_type)
    - [`GeometryNodeCurveOfPoint.input_template()`](#bpy.types.GeometryNodeCurveOfPoint.input_template)
    - [`GeometryNodeCurveOfPoint.output_template()`](#bpy.types.GeometryNodeCurveOfPoint.output_template)
    - [`GeometryNodeCurveOfPoint.bl_rna_get_subclass()`](#bpy.types.GeometryNodeCurveOfPoint.bl_rna_get_subclass)
    - [`GeometryNodeCurveOfPoint.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeCurveOfPoint.bl_rna_get_subclass_py)
