...
# ColorGpencilModifier(GpencilModifier)[#](#colorgpencilmodifier-gpencilmodifier "Link to this heading")
...
*class* bpy.types.ColorGpencilModifier(*GpencilModifier*)[#](#bpy.types.ColorGpencilModifier "Link to this definition")
:   Change Hue/Saturation modifier

    curve[#](#bpy.types.ColorGpencilModifier.curve "Link to this definition")
    :   Custom curve to apply effect

        Type:
        :   [`CurveMapping`](CurveMapping.md#bpy.types.CurveMapping "bpy.types.CurveMapping"), (readonly)

    hue[#](#bpy.types.ColorGpencilModifier.hue "Link to this definition")
    :   Color Hue

        Type:
        :   float in [0, 1], default 0.5

    invert\_layer\_pass[#](#bpy.types.ColorGpencilModifier.invert_layer_pass "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    invert\_layers[#](#bpy.types.ColorGpencilModifier.invert_layers "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    invert\_material\_pass[#](#bpy.types.ColorGpencilModifier.invert_material_pass "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    invert\_materials[#](#bpy.types.ColorGpencilModifier.invert_materials "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    layer[#](#bpy.types.ColorGpencilModifier.layer "Link to this definition")
    :   Layer name

        Type:
        :   string, default “”, (never None)

    layer\_pass[#](#bpy.types.ColorGpencilModifier.layer_pass "Link to this definition")
    :   Layer pass index

        Type:
        :   int in [0, 100], default 0

    material[#](#bpy.types.ColorGpencilModifier.material "Link to this definition")
    :   Material used for filtering effect

        Type:
        :   [`Material`](Material.md#bpy.types.Material "bpy.types.Material")

    modify\_color[#](#bpy.types.ColorGpencilModifier.modify_color "Link to this definition")
    ...
    pass\_index[#](#bpy.types.ColorGpencilModifier.pass_index "Link to this definition")
    :   Pass index

        Type:
        :   int in [0, 100], default 0

    saturation[#](#bpy.types.ColorGpencilModifier.saturation "Link to this definition")
    :   Color Saturation

        Type:
        :   float in [0, inf], default 0.5

    use\_custom\_curve[#](#bpy.types.ColorGpencilModifier.use_custom_curve "Link to this definition")
    :   Use a custom curve to define color effect along the strokes

        Type:
        :   boolean, default False

    value[#](#bpy.types.ColorGpencilModifier.value "Link to this definition")
    :   Color Value

        Type:
        :   float in [0, inf], default 0.5

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.ColorGpencilModifier.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.ColorGpencilModifier.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ColorGpencilModifier.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.ColorGpencilModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ColorGpencilModifier(GpencilModifier)
  + [`ColorGpencilModifier`](#bpy.types.ColorGpencilModifier)
    - [`ColorGpencilModifier.curve`](#bpy.types.ColorGpencilModifier.curve)
    - [`ColorGpencilModifier.hue`](#bpy.types.ColorGpencilModifier.hue)
    - [`ColorGpencilModifier.invert_layer_pass`](#bpy.types.ColorGpencilModifier.invert_layer_pass)
    - [`ColorGpencilModifier.invert_layers`](#bpy.types.ColorGpencilModifier.invert_layers)
    - [`ColorGpencilModifier.invert_material_pass`](#bpy.types.ColorGpencilModifier.invert_material_pass)
    - [`ColorGpencilModifier.invert_materials`](#bpy.types.ColorGpencilModifier.invert_materials)
    - [`ColorGpencilModifier.layer`](#bpy.types.ColorGpencilModifier.layer)
    - [`ColorGpencilModifier.layer_pass`](#bpy.types.ColorGpencilModifier.layer_pass)
    - [`ColorGpencilModifier.material`](#bpy.types.ColorGpencilModifier.material)
    - [`ColorGpencilModifier.modify_color`](#bpy.types.ColorGpencilModifier.modify_color)
    - [`ColorGpencilModifier.pass_index`](#bpy.types.ColorGpencilModifier.pass_index)
    - [`ColorGpencilModifier.saturation`](#bpy.types.ColorGpencilModifier.saturation)
    - [`ColorGpencilModifier.use_custom_curve`](#bpy.types.ColorGpencilModifier.use_custom_curve)
    - [`ColorGpencilModifier.value`](#bpy.types.ColorGpencilModifier.value)
    - [`ColorGpencilModifier.bl_rna_get_subclass()`](#bpy.types.ColorGpencilModifier.bl_rna_get_subclass)
    - [`ColorGpencilModifier.bl_rna_get_subclass_py()`](#bpy.types.ColorGpencilModifier.bl_rna_get_subclass_py)
