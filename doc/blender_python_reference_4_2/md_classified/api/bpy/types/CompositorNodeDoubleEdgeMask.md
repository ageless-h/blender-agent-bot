...
# CompositorNodeDoubleEdgeMask(CompositorNode)[#](#compositornodedoubleedgemask-compositornode "Link to this heading")
...
*class* bpy.types.CompositorNodeDoubleEdgeMask(*CompositorNode*)[#](#bpy.types.CompositorNodeDoubleEdgeMask "Link to this definition")
:   Create a gradient between two masks

    edge\_mode[#](#bpy.types.CompositorNodeDoubleEdgeMask.edge_mode "Link to this definition")
    :   * `BLEED_OUT`
        ...
        * `KEEP_IN`
        ...
        Type:
        :   enum in [‘BLEED\_OUT’, ‘KEEP\_IN’], default ‘BLEED\_OUT’

    inner\_mode[#](#bpy.types.CompositorNodeDoubleEdgeMask.inner_mode "Link to this definition")
    :   * `ALL`
        ...
        * `ADJACENT_ONLY`
        ...
        Type:
        :   enum in [‘ALL’, ‘ADJACENT\_ONLY’], default ‘ALL’

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.CompositorNodeDoubleEdgeMask.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.CompositorNodeDoubleEdgeMask.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.CompositorNodeDoubleEdgeMask.output_template "Link to this definition")
    ...
    update()[#](#bpy.types.CompositorNodeDoubleEdgeMask.update "Link to this definition")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.CompositorNodeDoubleEdgeMask.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.CompositorNodeDoubleEdgeMask.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CompositorNodeDoubleEdgeMask.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.CompositorNodeDoubleEdgeMask.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CompositorNodeDoubleEdgeMask(CompositorNode)
  + [`CompositorNodeDoubleEdgeMask`](#bpy.types.CompositorNodeDoubleEdgeMask)
    - [`CompositorNodeDoubleEdgeMask.edge_mode`](#bpy.types.CompositorNodeDoubleEdgeMask.edge_mode)
    - [`CompositorNodeDoubleEdgeMask.inner_mode`](#bpy.types.CompositorNodeDoubleEdgeMask.inner_mode)
    - [`CompositorNodeDoubleEdgeMask.is_registered_node_type()`](#bpy.types.CompositorNodeDoubleEdgeMask.is_registered_node_type)
    - [`CompositorNodeDoubleEdgeMask.input_template()`](#bpy.types.CompositorNodeDoubleEdgeMask.input_template)
    - [`CompositorNodeDoubleEdgeMask.output_template()`](#bpy.types.CompositorNodeDoubleEdgeMask.output_template)
    - [`CompositorNodeDoubleEdgeMask.update()`](#bpy.types.CompositorNodeDoubleEdgeMask.update)
    - [`CompositorNodeDoubleEdgeMask.bl_rna_get_subclass()`](#bpy.types.CompositorNodeDoubleEdgeMask.bl_rna_get_subclass)
    - [`CompositorNodeDoubleEdgeMask.bl_rna_get_subclass_py()`](#bpy.types.CompositorNodeDoubleEdgeMask.bl_rna_get_subclass_py)
