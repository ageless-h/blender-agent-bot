...
:   Map an action to the transform axes of a bone
    ...
    :   Specify how existing transformations and the action channels are combined
        ...
        * `AFTER_SPLIT`
        ...
        Type:
        :   enum in [‘BEFORE\_FULL’, ‘BEFORE’, ‘BEFORE\_SPLIT’, ‘AFTER\_FULL’, ‘AFTER’, ‘AFTER\_SPLIT’], default ‘AFTER\_FULL’
    ...
    :   Transformation channel from the target that is used to key the Action
        ...
        Type:
        :   enum in [‘LOCATION\_X’, ‘LOCATION\_Y’, ‘LOCATION\_Z’, ‘ROTATION\_X’, ‘ROTATION\_Y’, ‘ROTATION\_Z’, ‘SCALE\_X’, ‘SCALE\_Y’, ‘SCALE\_Z’], default ‘ROTATION\_X’
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ActionConstraint.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.ActionConstraint.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)
