...
# CompositorNodeSplit(CompositorNode)[#](#compositornodesplit-compositornode "Link to this heading")
...
*class* bpy.types.CompositorNodeSplit(*CompositorNode*)[#](#bpy.types.CompositorNodeSplit "Link to this definition")
:   Combine two images for side-by-side display. Typically used in combination with a Viewer node

    axis[#](#bpy.types.CompositorNodeSplit.axis "Link to this definition")
    :   Type:
        :   enum in [Axis Xy Items](../../../appendix/bpy_types_enum_items/axis_xy_items.md#rna-enum-axis-xy-items), default ‘X’

    factor[#](#bpy.types.CompositorNodeSplit.factor "Link to this definition")
    :   Type:
        :   int in [0, 100], default 0

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.CompositorNodeSplit.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.CompositorNodeSplit.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.CompositorNodeSplit.output_template "Link to this definition")
    ...
    update()[#](#bpy.types.CompositorNodeSplit.update "Link to this definition")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.CompositorNodeSplit.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.CompositorNodeSplit.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CompositorNodeSplit.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.CompositorNodeSplit.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CompositorNodeSplit(CompositorNode)
  + [`CompositorNodeSplit`](#bpy.types.CompositorNodeSplit)
    - [`CompositorNodeSplit.axis`](#bpy.types.CompositorNodeSplit.axis)
    - [`CompositorNodeSplit.factor`](#bpy.types.CompositorNodeSplit.factor)
    - [`CompositorNodeSplit.is_registered_node_type()`](#bpy.types.CompositorNodeSplit.is_registered_node_type)
    - [`CompositorNodeSplit.input_template()`](#bpy.types.CompositorNodeSplit.input_template)
    - [`CompositorNodeSplit.output_template()`](#bpy.types.CompositorNodeSplit.output_template)
    - [`CompositorNodeSplit.update()`](#bpy.types.CompositorNodeSplit.update)
    - [`CompositorNodeSplit.bl_rna_get_subclass()`](#bpy.types.CompositorNodeSplit.bl_rna_get_subclass)
    - [`CompositorNodeSplit.bl_rna_get_subclass_py()`](#bpy.types.CompositorNodeSplit.bl_rna_get_subclass_py)
