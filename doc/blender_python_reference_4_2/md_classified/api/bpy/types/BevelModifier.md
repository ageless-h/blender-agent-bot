...
:   Bevel modifier to make edges and vertices more rounded
    ...
    :   Whether to set face strength, and which faces to set it on
        ...
        * `FSTR_ALL`
        ...
        Type:
        :   enum in [‘FSTR\_NONE’, ‘FSTR\_NEW’, ‘FSTR\_AFFECTED’, ‘FSTR\_ALL’], default ‘FSTR\_NONE’
    ...
    :   Pattern to use for inside of miters
        ...
        * `MITER_ARC`
        ...
        Type:
        :   enum in [‘MITER\_SHARP’, ‘MITER\_ARC’], default ‘MITER\_SHARP’
    ...
    :   Pattern to use for outside of miters
        ...
        * `MITER_ARC`
        ...
        Type:
        :   enum in [‘MITER\_SHARP’, ‘MITER\_PATCH’, ‘MITER\_ARC’], default ‘MITER\_SHARP’
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.BevelModifier.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.BevelModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)
