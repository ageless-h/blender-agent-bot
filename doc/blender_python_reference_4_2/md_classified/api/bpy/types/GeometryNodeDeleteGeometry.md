...
# GeometryNodeDeleteGeometry(GeometryNode)[#](#geometrynodedeletegeometry-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeDeleteGeometry(*GeometryNode*)[#](#bpy.types.GeometryNodeDeleteGeometry "Link to this definition")
:   Remove selected elements of a geometry

    domain[#](#bpy.types.GeometryNodeDeleteGeometry.domain "Link to this definition")
    :   Which domain to delete in

        Type:
        :   enum in [Attribute Domain Without Corner Items](../../../appendix/bpy_types_enum_items/attribute_domain_without_corner_items.md#rna-enum-attribute-domain-without-corner-items), default ‘POINT’

    mode[#](#bpy.types.GeometryNodeDeleteGeometry.mode "Link to this definition")
    :   Which parts of the mesh component to delete

        Type:
        :   enum in [‘ALL’, ‘EDGE\_FACE’, ‘ONLY\_FACE’], default ‘ALL’

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.GeometryNodeDeleteGeometry.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.GeometryNodeDeleteGeometry.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.GeometryNodeDeleteGeometry.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.GeometryNodeDeleteGeometry.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.GeometryNodeDeleteGeometry.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeDeleteGeometry.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.GeometryNodeDeleteGeometry.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeDeleteGeometry(GeometryNode)
  + [`GeometryNodeDeleteGeometry`](#bpy.types.GeometryNodeDeleteGeometry)
    - [`GeometryNodeDeleteGeometry.domain`](#bpy.types.GeometryNodeDeleteGeometry.domain)
    - [`GeometryNodeDeleteGeometry.mode`](#bpy.types.GeometryNodeDeleteGeometry.mode)
    - [`GeometryNodeDeleteGeometry.is_registered_node_type()`](#bpy.types.GeometryNodeDeleteGeometry.is_registered_node_type)
    - [`GeometryNodeDeleteGeometry.input_template()`](#bpy.types.GeometryNodeDeleteGeometry.input_template)
    - [`GeometryNodeDeleteGeometry.output_template()`](#bpy.types.GeometryNodeDeleteGeometry.output_template)
    - [`GeometryNodeDeleteGeometry.bl_rna_get_subclass()`](#bpy.types.GeometryNodeDeleteGeometry.bl_rna_get_subclass)
    - [`GeometryNodeDeleteGeometry.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeDeleteGeometry.bl_rna_get_subclass_py)
