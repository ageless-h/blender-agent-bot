...
:   Subdivide Stroke modifier
    ...
    layer\_filter[#](#bpy.types.GreasePencilSubdivModifier.layer_filter "Link to this definition")
    :   Layer name
    ...
    :   Select type of subdivision algorithm
        ...
        Type:
        :   enum in [‘CATMULL\_CLARK’, ‘SIMPLE’], default ‘CATMULL\_CLARK’
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GreasePencilSubdivModifier.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.GreasePencilSubdivModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)
...
* GreasePencilSubdivModifier(Modifier)
  + [`GreasePencilSubdivModifier`](#bpy.types.GreasePencilSubdivModifier)
    ...
    - [`GreasePencilSubdivModifier.layer_filter`](#bpy.types.GreasePencilSubdivModifier.layer_filter)
