...
# GPencilStrokes(bpy\_struct)[#](#gpencilstrokes-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.GPencilStrokes(*bpy\_struct*)[#](#bpy.types.GPencilStrokes "Link to this definition")
:   Collection of grease pencil stroke

    new()[#](#bpy.types.GPencilStrokes.new "Link to this definition")
    :   Add a new grease pencil stroke
        ...
        Return type:
        :   [`GPencilStroke`](GPencilStroke.md#bpy.types.GPencilStroke "bpy.types.GPencilStroke")

    remove(*stroke*)[#](#bpy.types.GPencilStrokes.remove "Link to this definition")
    :   Remove a grease pencil stroke

        Parameters:
        :   **stroke** ([`GPencilStroke`](GPencilStroke.md#bpy.types.GPencilStroke "bpy.types.GPencilStroke"), (never None)) – Stroke, The stroke to remove

    close(*stroke*)[#](#bpy.types.GPencilStrokes.close "Link to this definition")
    :   Close a grease pencil stroke adding geometry

        Parameters:
        :   **stroke** ([`GPencilStroke`](GPencilStroke.md#bpy.types.GPencilStroke "bpy.types.GPencilStroke"), (never None)) – Stroke, The stroke to close

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.GPencilStrokes.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.GPencilStrokes.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GPencilStrokes.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.GPencilStrokes.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GPencilStrokes(bpy\_struct)
  + [`GPencilStrokes`](#bpy.types.GPencilStrokes)
    - [`GPencilStrokes.new()`](#bpy.types.GPencilStrokes.new)
    - [`GPencilStrokes.remove()`](#bpy.types.GPencilStrokes.remove)
    - [`GPencilStrokes.close()`](#bpy.types.GPencilStrokes.close)
    - [`GPencilStrokes.bl_rna_get_subclass()`](#bpy.types.GPencilStrokes.bl_rna_get_subclass)
    - [`GPencilStrokes.bl_rna_get_subclass_py()`](#bpy.types.GPencilStrokes.bl_rna_get_subclass_py)
