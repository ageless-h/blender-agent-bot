...
# GeometryNodeConvexHull(GeometryNode)[#](#geometrynodeconvexhull-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeConvexHull(*GeometryNode*)[#](#bpy.types.GeometryNodeConvexHull "Link to this definition")
:   Create a mesh that encloses all points in the input geometry with the smallest number of points

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.GeometryNodeConvexHull.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.GeometryNodeConvexHull.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.GeometryNodeConvexHull.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.GeometryNodeConvexHull.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.GeometryNodeConvexHull.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeConvexHull.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.GeometryNodeConvexHull.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeConvexHull(GeometryNode)
  + [`GeometryNodeConvexHull`](#bpy.types.GeometryNodeConvexHull)
    - [`GeometryNodeConvexHull.is_registered_node_type()`](#bpy.types.GeometryNodeConvexHull.is_registered_node_type)
    - [`GeometryNodeConvexHull.input_template()`](#bpy.types.GeometryNodeConvexHull.input_template)
    - [`GeometryNodeConvexHull.output_template()`](#bpy.types.GeometryNodeConvexHull.output_template)
    - [`GeometryNodeConvexHull.bl_rna_get_subclass()`](#bpy.types.GeometryNodeConvexHull.bl_rna_get_subclass)
    - [`GeometryNodeConvexHull.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeConvexHull.bl_rna_get_subclass_py)
