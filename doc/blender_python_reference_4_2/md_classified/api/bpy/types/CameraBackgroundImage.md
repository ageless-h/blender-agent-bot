...
:   Image and settings for display in the 3D View background
    ...
    :   Data source used for background
        ...
        Type:
        :   enum in [‘IMAGE’, ‘MOVIE\_CLIP’], default ‘IMAGE’
