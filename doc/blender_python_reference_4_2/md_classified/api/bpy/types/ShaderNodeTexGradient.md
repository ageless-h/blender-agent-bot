...
# ShaderNodeTexGradient(ShaderNode)[#](#shadernodetexgradient-shadernode "Link to this heading")
...
*class* bpy.types.ShaderNodeTexGradient(*ShaderNode*)[#](#bpy.types.ShaderNodeTexGradient "Link to this definition")
:   Generate interpolated color and intensity values based on the input vector

    color\_mapping[#](#bpy.types.ShaderNodeTexGradient.color_mapping "Link to this definition")
    :   Color mapping settings

        Type:
        :   [`ColorMapping`](ColorMapping.md#bpy.types.ColorMapping "bpy.types.ColorMapping"), (readonly, never None)

    gradient\_type[#](#bpy.types.ShaderNodeTexGradient.gradient_type "Link to this definition")
    :   Style of the color blending
        ...
        * `RADIAL`
        ...
        Type:
        :   enum in [‘LINEAR’, ‘QUADRATIC’, ‘EASING’, ‘DIAGONAL’, ‘SPHERICAL’, ‘QUADRATIC\_SPHERE’, ‘RADIAL’], default ‘LINEAR’

    texture\_mapping[#](#bpy.types.ShaderNodeTexGradient.texture_mapping "Link to this definition")
    :   Texture coordinate mapping settings

        Type:
        :   [`TexMapping`](TexMapping.md#bpy.types.TexMapping "bpy.types.TexMapping"), (readonly, never None)

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.ShaderNodeTexGradient.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.ShaderNodeTexGradient.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.ShaderNodeTexGradient.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.ShaderNodeTexGradient.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.ShaderNodeTexGradient.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ShaderNodeTexGradient.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.ShaderNodeTexGradient.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ShaderNodeTexGradient(ShaderNode)
  + [`ShaderNodeTexGradient`](#bpy.types.ShaderNodeTexGradient)
    - [`ShaderNodeTexGradient.color_mapping`](#bpy.types.ShaderNodeTexGradient.color_mapping)
    - [`ShaderNodeTexGradient.gradient_type`](#bpy.types.ShaderNodeTexGradient.gradient_type)
    - [`ShaderNodeTexGradient.texture_mapping`](#bpy.types.ShaderNodeTexGradient.texture_mapping)
    - [`ShaderNodeTexGradient.is_registered_node_type()`](#bpy.types.ShaderNodeTexGradient.is_registered_node_type)
    - [`ShaderNodeTexGradient.input_template()`](#bpy.types.ShaderNodeTexGradient.input_template)
    - [`ShaderNodeTexGradient.output_template()`](#bpy.types.ShaderNodeTexGradient.output_template)
    - [`ShaderNodeTexGradient.bl_rna_get_subclass()`](#bpy.types.ShaderNodeTexGradient.bl_rna_get_subclass)
    - [`ShaderNodeTexGradient.bl_rna_get_subclass_py()`](#bpy.types.ShaderNodeTexGradient.bl_rna_get_subclass_py)
