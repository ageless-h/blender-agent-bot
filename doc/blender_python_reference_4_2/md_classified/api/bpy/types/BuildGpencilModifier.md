...
# BuildGpencilModifier(GpencilModifier)[#](#buildgpencilmodifier-gpencilmodifier "Link to this heading")
...
*class* bpy.types.BuildGpencilModifier(*GpencilModifier*)[#](#bpy.types.BuildGpencilModifier "Link to this definition")
:   Animate strokes appearing and disappearing

    concurrent\_time\_alignment[#](#bpy.types.BuildGpencilModifier.concurrent_time_alignment "Link to this definition")
    ...
    fade\_factor[#](#bpy.types.BuildGpencilModifier.fade_factor "Link to this definition")
    :   Defines how much of the stroke is fading in/out

        Type:
        :   float in [0, 1], default 0.0

    fade\_opacity\_strength[#](#bpy.types.BuildGpencilModifier.fade_opacity_strength "Link to this definition")
    :   How much strength fading applies on top of stroke opacity

        Type:
        :   float in [0, 1], default 0.0

    fade\_thickness\_strength[#](#bpy.types.BuildGpencilModifier.fade_thickness_strength "Link to this definition")
    :   How much strength fading applies on top of stroke thickness

        Type:
        :   float in [0, 1], default 0.0

    frame\_end[#](#bpy.types.BuildGpencilModifier.frame_end "Link to this definition")
    :   End Frame (when Restrict Frame Range is enabled)

        Type:
        :   float in [-1.04857e+06, 1.04857e+06], default 125.0

    frame\_start[#](#bpy.types.BuildGpencilModifier.frame_start "Link to this definition")
    :   Start Frame (when Restrict Frame Range is enabled)

        Type:
        :   float in [-1.04857e+06, 1.04857e+06], default 1.0

    invert\_layer\_pass[#](#bpy.types.BuildGpencilModifier.invert_layer_pass "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    invert\_layers[#](#bpy.types.BuildGpencilModifier.invert_layers "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    layer[#](#bpy.types.BuildGpencilModifier.layer "Link to this definition")
    :   Layer name

        Type:
        :   string, default “”, (never None)

    layer\_pass[#](#bpy.types.BuildGpencilModifier.layer_pass "Link to this definition")
    :   Layer pass index

        Type:
        :   int in [0, 100], default 0

    length[#](#bpy.types.BuildGpencilModifier.length "Link to this definition")
    ...
    mode[#](#bpy.types.BuildGpencilModifier.mode "Link to this definition")
    ...
    object[#](#bpy.types.BuildGpencilModifier.object "Link to this definition")
    :   Object used as build starting position

        Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object")

    percentage\_factor[#](#bpy.types.BuildGpencilModifier.percentage_factor "Link to this definition")
    :   Defines how much of the stroke is visible

        Type:
        :   float in [0, 1], default 0.0

    speed\_factor[#](#bpy.types.BuildGpencilModifier.speed_factor "Link to this definition")
    :   Multiply recorded drawing speed by a factor

        Type:
        :   float in [0, 100], default 1.2

    speed\_maxgap[#](#bpy.types.BuildGpencilModifier.speed_maxgap "Link to this definition")
    :   The maximum gap between strokes in seconds

        Type:
        :   float in [0, 100], default 0.5

    start\_delay[#](#bpy.types.BuildGpencilModifier.start_delay "Link to this definition")
    :   Number of frames after each GP keyframe before the modifier has any effect

        Type:
        :   float in [0, 1.04857e+06], default 0.0

    target\_vertex\_group[#](#bpy.types.BuildGpencilModifier.target_vertex_group "Link to this definition")
    :   Output Vertex group

        Type:
        :   string, default “”, (never None)

    time\_mode[#](#bpy.types.BuildGpencilModifier.time_mode "Link to this definition")
    ...
    transition[#](#bpy.types.BuildGpencilModifier.transition "Link to this definition")
    ...
    use\_fading[#](#bpy.types.BuildGpencilModifier.use_fading "Link to this definition")
    :   Fade out strokes instead of directly cutting off

        Type:
        :   boolean, default False

    use\_percentage[#](#bpy.types.BuildGpencilModifier.use_percentage "Link to this definition")
    :   Use a percentage factor to determine the visible points

        Type:
        :   boolean, default False

    use\_restrict\_frame\_range[#](#bpy.types.BuildGpencilModifier.use_restrict_frame_range "Link to this definition")
    :   Only modify strokes during the specified frame range

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.BuildGpencilModifier.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.BuildGpencilModifier.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.BuildGpencilModifier.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.BuildGpencilModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* BuildGpencilModifier(GpencilModifier)
  + [`BuildGpencilModifier`](#bpy.types.BuildGpencilModifier)
    - [`BuildGpencilModifier.concurrent_time_alignment`](#bpy.types.BuildGpencilModifier.concurrent_time_alignment)
    - [`BuildGpencilModifier.fade_factor`](#bpy.types.BuildGpencilModifier.fade_factor)
    - [`BuildGpencilModifier.fade_opacity_strength`](#bpy.types.BuildGpencilModifier.fade_opacity_strength)
    - [`BuildGpencilModifier.fade_thickness_strength`](#bpy.types.BuildGpencilModifier.fade_thickness_strength)
    - [`BuildGpencilModifier.frame_end`](#bpy.types.BuildGpencilModifier.frame_end)
    - [`BuildGpencilModifier.frame_start`](#bpy.types.BuildGpencilModifier.frame_start)
    - [`BuildGpencilModifier.invert_layer_pass`](#bpy.types.BuildGpencilModifier.invert_layer_pass)
    - [`BuildGpencilModifier.invert_layers`](#bpy.types.BuildGpencilModifier.invert_layers)
    - [`BuildGpencilModifier.layer`](#bpy.types.BuildGpencilModifier.layer)
    - [`BuildGpencilModifier.layer_pass`](#bpy.types.BuildGpencilModifier.layer_pass)
    - [`BuildGpencilModifier.length`](#bpy.types.BuildGpencilModifier.length)
    - [`BuildGpencilModifier.mode`](#bpy.types.BuildGpencilModifier.mode)
    - [`BuildGpencilModifier.object`](#bpy.types.BuildGpencilModifier.object)
    - [`BuildGpencilModifier.percentage_factor`](#bpy.types.BuildGpencilModifier.percentage_factor)
    - [`BuildGpencilModifier.speed_factor`](#bpy.types.BuildGpencilModifier.speed_factor)
    - [`BuildGpencilModifier.speed_maxgap`](#bpy.types.BuildGpencilModifier.speed_maxgap)
    - [`BuildGpencilModifier.start_delay`](#bpy.types.BuildGpencilModifier.start_delay)
    - [`BuildGpencilModifier.target_vertex_group`](#bpy.types.BuildGpencilModifier.target_vertex_group)
    - [`BuildGpencilModifier.time_mode`](#bpy.types.BuildGpencilModifier.time_mode)
    - [`BuildGpencilModifier.transition`](#bpy.types.BuildGpencilModifier.transition)
    - [`BuildGpencilModifier.use_fading`](#bpy.types.BuildGpencilModifier.use_fading)
    - [`BuildGpencilModifier.use_percentage`](#bpy.types.BuildGpencilModifier.use_percentage)
    - [`BuildGpencilModifier.use_restrict_frame_range`](#bpy.types.BuildGpencilModifier.use_restrict_frame_range)
    - [`BuildGpencilModifier.bl_rna_get_subclass()`](#bpy.types.BuildGpencilModifier.bl_rna_get_subclass)
    - [`BuildGpencilModifier.bl_rna_get_subclass_py()`](#bpy.types.BuildGpencilModifier.bl_rna_get_subclass_py)
