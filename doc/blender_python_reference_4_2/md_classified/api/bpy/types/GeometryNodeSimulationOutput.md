...
# GeometryNodeSimulationOutput(GeometryNode)[#](#geometrynodesimulationoutput-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeSimulationOutput(*GeometryNode*)[#](#bpy.types.GeometryNodeSimulationOutput "Link to this definition")
:   Output data from the simulation zone

    active\_index[#](#bpy.types.GeometryNodeSimulationOutput.active_index "Link to this definition")
    :   Index of the active item

        Type:
        :   int in [0, inf], default 0

    active\_item[#](#bpy.types.GeometryNodeSimulationOutput.active_item "Link to this definition")
    :   Index of the active item

        Type:
        :   [`SimulationStateItem`](SimulationStateItem.md#bpy.types.SimulationStateItem "bpy.types.SimulationStateItem")

    state\_items[#](#bpy.types.GeometryNodeSimulationOutput.state_items "Link to this definition")
    :   Type:
        :   [`NodeGeometrySimulationOutputItems`](NodeGeometrySimulationOutputItems.md#bpy.types.NodeGeometrySimulationOutputItems "bpy.types.NodeGeometrySimulationOutputItems") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`SimulationStateItem`](SimulationStateItem.md#bpy.types.SimulationStateItem "bpy.types.SimulationStateItem"), (readonly)

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.GeometryNodeSimulationOutput.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.GeometryNodeSimulationOutput.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.GeometryNodeSimulationOutput.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.GeometryNodeSimulationOutput.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.GeometryNodeSimulationOutput.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeSimulationOutput.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.GeometryNodeSimulationOutput.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeSimulationOutput(GeometryNode)
  + [`GeometryNodeSimulationOutput`](#bpy.types.GeometryNodeSimulationOutput)
    - [`GeometryNodeSimulationOutput.active_index`](#bpy.types.GeometryNodeSimulationOutput.active_index)
    - [`GeometryNodeSimulationOutput.active_item`](#bpy.types.GeometryNodeSimulationOutput.active_item)
    - [`GeometryNodeSimulationOutput.state_items`](#bpy.types.GeometryNodeSimulationOutput.state_items)
    - [`GeometryNodeSimulationOutput.is_registered_node_type()`](#bpy.types.GeometryNodeSimulationOutput.is_registered_node_type)
    - [`GeometryNodeSimulationOutput.input_template()`](#bpy.types.GeometryNodeSimulationOutput.input_template)
    - [`GeometryNodeSimulationOutput.output_template()`](#bpy.types.GeometryNodeSimulationOutput.output_template)
    - [`GeometryNodeSimulationOutput.bl_rna_get_subclass()`](#bpy.types.GeometryNodeSimulationOutput.bl_rna_get_subclass)
    - [`GeometryNodeSimulationOutput.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeSimulationOutput.bl_rna_get_subclass_py)
