...
# CompositorNodeLumaMatte(CompositorNode)[#](#compositornodelumamatte-compositornode "Link to this heading")
...
*class* bpy.types.CompositorNodeLumaMatte(*CompositorNode*)[#](#bpy.types.CompositorNodeLumaMatte "Link to this definition")
:   Create a matte based on luminance (brightness) difference

    limit\_max[#](#bpy.types.CompositorNodeLumaMatte.limit_max "Link to this definition")
    :   Values higher than this setting are 100% opaque

        Type:
        :   float in [-inf, inf], default 0.0

    limit\_min[#](#bpy.types.CompositorNodeLumaMatte.limit_min "Link to this definition")
    :   Values lower than this setting are 100% keyed

        Type:
        :   float in [-inf, inf], default 0.0

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.CompositorNodeLumaMatte.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.CompositorNodeLumaMatte.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.CompositorNodeLumaMatte.output_template "Link to this definition")
    ...
    update()[#](#bpy.types.CompositorNodeLumaMatte.update "Link to this definition")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.CompositorNodeLumaMatte.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.CompositorNodeLumaMatte.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CompositorNodeLumaMatte.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.CompositorNodeLumaMatte.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CompositorNodeLumaMatte(CompositorNode)
  + [`CompositorNodeLumaMatte`](#bpy.types.CompositorNodeLumaMatte)
    - [`CompositorNodeLumaMatte.limit_max`](#bpy.types.CompositorNodeLumaMatte.limit_max)
    - [`CompositorNodeLumaMatte.limit_min`](#bpy.types.CompositorNodeLumaMatte.limit_min)
    - [`CompositorNodeLumaMatte.is_registered_node_type()`](#bpy.types.CompositorNodeLumaMatte.is_registered_node_type)
    - [`CompositorNodeLumaMatte.input_template()`](#bpy.types.CompositorNodeLumaMatte.input_template)
    - [`CompositorNodeLumaMatte.output_template()`](#bpy.types.CompositorNodeLumaMatte.output_template)
    - [`CompositorNodeLumaMatte.update()`](#bpy.types.CompositorNodeLumaMatte.update)
    - [`CompositorNodeLumaMatte.bl_rna_get_subclass()`](#bpy.types.CompositorNodeLumaMatte.bl_rna_get_subclass)
    - [`CompositorNodeLumaMatte.bl_rna_get_subclass_py()`](#bpy.types.CompositorNodeLumaMatte.bl_rna_get_subclass_py)
