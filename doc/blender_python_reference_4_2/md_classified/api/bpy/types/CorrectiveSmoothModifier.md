...
:   Correct distortion caused by deformation
    ...
    :   Method used for smoothing
        ...
        * `LENGTH_WEIGHTED`
        ...
        Type:
        :   enum in [‘SIMPLE’, ‘LENGTH\_WEIGHTED’], default ‘SIMPLE’
