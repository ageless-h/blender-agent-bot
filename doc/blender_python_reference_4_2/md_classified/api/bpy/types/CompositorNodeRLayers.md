...
# CompositorNodeRLayers(CompositorNode)[#](#compositornoderlayers-compositornode "Link to this heading")
...
*class* bpy.types.CompositorNodeRLayers(*CompositorNode*)[#](#bpy.types.CompositorNodeRLayers "Link to this definition")
:   Input render passes from a scene render

    layer[#](#bpy.types.CompositorNodeRLayers.layer "Link to this definition")
    :   Type:
        :   enum in [‘PLACEHOLDER’], default ‘PLACEHOLDER’

    scene[#](#bpy.types.CompositorNodeRLayers.scene "Link to this definition")
    :   Type:
        :   [`Scene`](Scene.md#bpy.types.Scene "bpy.types.Scene")

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.CompositorNodeRLayers.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.CompositorNodeRLayers.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.CompositorNodeRLayers.output_template "Link to this definition")
    ...
    update()[#](#bpy.types.CompositorNodeRLayers.update "Link to this definition")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.CompositorNodeRLayers.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.CompositorNodeRLayers.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CompositorNodeRLayers.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.CompositorNodeRLayers.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CompositorNodeRLayers(CompositorNode)
  + [`CompositorNodeRLayers`](#bpy.types.CompositorNodeRLayers)
    - [`CompositorNodeRLayers.layer`](#bpy.types.CompositorNodeRLayers.layer)
    - [`CompositorNodeRLayers.scene`](#bpy.types.CompositorNodeRLayers.scene)
    - [`CompositorNodeRLayers.is_registered_node_type()`](#bpy.types.CompositorNodeRLayers.is_registered_node_type)
    - [`CompositorNodeRLayers.input_template()`](#bpy.types.CompositorNodeRLayers.input_template)
    - [`CompositorNodeRLayers.output_template()`](#bpy.types.CompositorNodeRLayers.output_template)
    - [`CompositorNodeRLayers.update()`](#bpy.types.CompositorNodeRLayers.update)
    - [`CompositorNodeRLayers.bl_rna_get_subclass()`](#bpy.types.CompositorNodeRLayers.bl_rna_get_subclass)
    - [`CompositorNodeRLayers.bl_rna_get_subclass_py()`](#bpy.types.CompositorNodeRLayers.bl_rna_get_subclass_py)
