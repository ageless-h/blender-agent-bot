...
# NodeCustomGroup(Node)[#](#nodecustomgroup-node "Link to this heading")
...
*class* bpy.types.NodeCustomGroup(*Node*)[#](#bpy.types.NodeCustomGroup "Link to this definition")
:   Base node type for custom registered node group types

    node\_tree[#](#bpy.types.NodeCustomGroup.node_tree "Link to this definition")
    :   Type:
        :   [`NodeTree`](NodeTree.md#bpy.types.NodeTree "bpy.types.NodeTree")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.NodeCustomGroup.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.NodeCustomGroup.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.NodeCustomGroup.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.NodeCustomGroup.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* NodeCustomGroup(Node)
  + [`NodeCustomGroup`](#bpy.types.NodeCustomGroup)
    - [`NodeCustomGroup.node_tree`](#bpy.types.NodeCustomGroup.node_tree)
    - [`NodeCustomGroup.bl_rna_get_subclass()`](#bpy.types.NodeCustomGroup.bl_rna_get_subclass)
    - [`NodeCustomGroup.bl_rna_get_subclass_py()`](#bpy.types.NodeCustomGroup.bl_rna_get_subclass_py)
