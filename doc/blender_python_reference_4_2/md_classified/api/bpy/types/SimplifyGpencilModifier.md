...
# SimplifyGpencilModifier(GpencilModifier)[#](#simplifygpencilmodifier-gpencilmodifier "Link to this heading")
...
*class* bpy.types.SimplifyGpencilModifier(*GpencilModifier*)[#](#bpy.types.SimplifyGpencilModifier "Link to this definition")
:   Simplify Stroke modifier

    distance[#](#bpy.types.SimplifyGpencilModifier.distance "Link to this definition")
    :   Distance between points

        Type:
        :   float in [0, inf], default 0.1

    factor[#](#bpy.types.SimplifyGpencilModifier.factor "Link to this definition")
    :   Factor of Simplify

        Type:
        :   float in [0, 100], default 0.0

    invert\_layer\_pass[#](#bpy.types.SimplifyGpencilModifier.invert_layer_pass "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    invert\_layers[#](#bpy.types.SimplifyGpencilModifier.invert_layers "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    invert\_material\_pass[#](#bpy.types.SimplifyGpencilModifier.invert_material_pass "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    invert\_materials[#](#bpy.types.SimplifyGpencilModifier.invert_materials "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    layer[#](#bpy.types.SimplifyGpencilModifier.layer "Link to this definition")
    :   Layer name

        Type:
        :   string, default “”, (never None)

    layer\_pass[#](#bpy.types.SimplifyGpencilModifier.layer_pass "Link to this definition")
    :   Layer pass index

        Type:
        :   int in [0, 100], default 0

    length[#](#bpy.types.SimplifyGpencilModifier.length "Link to this definition")
    :   Length of each segment

        Type:
        :   float in [0, inf], default 0.1

    material[#](#bpy.types.SimplifyGpencilModifier.material "Link to this definition")
    :   Material used for filtering effect

        Type:
        :   [`Material`](Material.md#bpy.types.Material "bpy.types.Material")

    mode[#](#bpy.types.SimplifyGpencilModifier.mode "Link to this definition")
    ...
    pass\_index[#](#bpy.types.SimplifyGpencilModifier.pass_index "Link to this definition")
    :   Pass index

        Type:
        :   int in [0, 100], default 0

    sharp\_threshold[#](#bpy.types.SimplifyGpencilModifier.sharp_threshold "Link to this definition")
    :   Preserve corners that have sharper angle than this threshold

        Type:
        :   float in [0, 3.14159], default 0.0

    step[#](#bpy.types.SimplifyGpencilModifier.step "Link to this definition")
    :   Number of times to apply simplify

        Type:
        :   int in [1, 50], default 1

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.SimplifyGpencilModifier.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.SimplifyGpencilModifier.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.SimplifyGpencilModifier.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.SimplifyGpencilModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* SimplifyGpencilModifier(GpencilModifier)
  + [`SimplifyGpencilModifier`](#bpy.types.SimplifyGpencilModifier)
    - [`SimplifyGpencilModifier.distance`](#bpy.types.SimplifyGpencilModifier.distance)
    - [`SimplifyGpencilModifier.factor`](#bpy.types.SimplifyGpencilModifier.factor)
    - [`SimplifyGpencilModifier.invert_layer_pass`](#bpy.types.SimplifyGpencilModifier.invert_layer_pass)
    - [`SimplifyGpencilModifier.invert_layers`](#bpy.types.SimplifyGpencilModifier.invert_layers)
    - [`SimplifyGpencilModifier.invert_material_pass`](#bpy.types.SimplifyGpencilModifier.invert_material_pass)
    - [`SimplifyGpencilModifier.invert_materials`](#bpy.types.SimplifyGpencilModifier.invert_materials)
    - [`SimplifyGpencilModifier.layer`](#bpy.types.SimplifyGpencilModifier.layer)
    - [`SimplifyGpencilModifier.layer_pass`](#bpy.types.SimplifyGpencilModifier.layer_pass)
    - [`SimplifyGpencilModifier.length`](#bpy.types.SimplifyGpencilModifier.length)
    - [`SimplifyGpencilModifier.material`](#bpy.types.SimplifyGpencilModifier.material)
    - [`SimplifyGpencilModifier.mode`](#bpy.types.SimplifyGpencilModifier.mode)
    - [`SimplifyGpencilModifier.pass_index`](#bpy.types.SimplifyGpencilModifier.pass_index)
    - [`SimplifyGpencilModifier.sharp_threshold`](#bpy.types.SimplifyGpencilModifier.sharp_threshold)
    - [`SimplifyGpencilModifier.step`](#bpy.types.SimplifyGpencilModifier.step)
    - [`SimplifyGpencilModifier.bl_rna_get_subclass()`](#bpy.types.SimplifyGpencilModifier.bl_rna_get_subclass)
    - [`SimplifyGpencilModifier.bl_rna_get_subclass_py()`](#bpy.types.SimplifyGpencilModifier.bl_rna_get_subclass_py)
