...
# GeometryNodeTransform(GeometryNode)[#](#geometrynodetransform-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeTransform(*GeometryNode*)[#](#bpy.types.GeometryNodeTransform "Link to this definition")
:   Translate, rotate or scale the geometry

    mode[#](#bpy.types.GeometryNodeTransform.mode "Link to this definition")
    :   How the transformation is specified

        * `COMPONENTS`
          Components – Provide separate location, rotation and scale.
        * `MATRIX`
          Matrix – Use a transformation matrix.

        Type:
        :   enum in [‘COMPONENTS’, ‘MATRIX’], default ‘COMPONENTS’

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.GeometryNodeTransform.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.GeometryNodeTransform.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.GeometryNodeTransform.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.GeometryNodeTransform.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.GeometryNodeTransform.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeTransform.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.GeometryNodeTransform.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeTransform(GeometryNode)
  + [`GeometryNodeTransform`](#bpy.types.GeometryNodeTransform)
    - [`GeometryNodeTransform.mode`](#bpy.types.GeometryNodeTransform.mode)
    - [`GeometryNodeTransform.is_registered_node_type()`](#bpy.types.GeometryNodeTransform.is_registered_node_type)
    - [`GeometryNodeTransform.input_template()`](#bpy.types.GeometryNodeTransform.input_template)
    - [`GeometryNodeTransform.output_template()`](#bpy.types.GeometryNodeTransform.output_template)
    - [`GeometryNodeTransform.bl_rna_get_subclass()`](#bpy.types.GeometryNodeTransform.bl_rna_get_subclass)
    - [`GeometryNodeTransform.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeTransform.bl_rna_get_subclass_py)
