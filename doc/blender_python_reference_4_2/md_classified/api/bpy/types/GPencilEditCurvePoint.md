...
# GPencilEditCurvePoint(bpy\_struct)[#](#gpencileditcurvepoint-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.GPencilEditCurvePoint(*bpy\_struct*)[#](#bpy.types.GPencilEditCurvePoint "Link to this definition")
:   Bézier curve point with two handles

    co[#](#bpy.types.GPencilEditCurvePoint.co "Link to this definition")
    :   Coordinates of the control point

        Type:
        :   [`mathutils.Vector`](../../mathutils/index.md#mathutils.Vector "mathutils.Vector") of 3 items in [-inf, inf], default (0.0, 0.0, 0.0)

    handle\_left[#](#bpy.types.GPencilEditCurvePoint.handle_left "Link to this definition")
    :   Coordinates of the first handle

        Type:
        :   [`mathutils.Vector`](../../mathutils/index.md#mathutils.Vector "mathutils.Vector") of 3 items in [-inf, inf], default (0.0, 0.0, 0.0)

    handle\_right[#](#bpy.types.GPencilEditCurvePoint.handle_right "Link to this definition")
    :   Coordinates of the second handle

        Type:
        :   [`mathutils.Vector`](../../mathutils/index.md#mathutils.Vector "mathutils.Vector") of 3 items in [-inf, inf], default (0.0, 0.0, 0.0)

    hide[#](#bpy.types.GPencilEditCurvePoint.hide "Link to this definition")
    :   Visibility status

        Type:
        :   boolean, default False

    point\_index[#](#bpy.types.GPencilEditCurvePoint.point_index "Link to this definition")
    :   Index of the corresponding grease pencil stroke point

        Type:
        :   int in [0, inf], default 0, (readonly)

    pressure[#](#bpy.types.GPencilEditCurvePoint.pressure "Link to this definition")
    :   Pressure of the grease pencil stroke point

        Type:
        :   float in [0, inf], default 0.0

    select\_control\_point[#](#bpy.types.GPencilEditCurvePoint.select_control_point "Link to this definition")
    :   Control point selection status

        Type:
        :   boolean, default False

    select\_left\_handle[#](#bpy.types.GPencilEditCurvePoint.select_left_handle "Link to this definition")
    :   Handle 1 selection status

        Type:
        :   boolean, default False

    select\_right\_handle[#](#bpy.types.GPencilEditCurvePoint.select_right_handle "Link to this definition")
    :   Handle 2 selection status

        Type:
        :   boolean, default False

    strength[#](#bpy.types.GPencilEditCurvePoint.strength "Link to this definition")
    :   Color intensity (alpha factor) of the grease pencil stroke point

        Type:
        :   float in [0, 1], default 0.0

    uv\_factor[#](#bpy.types.GPencilEditCurvePoint.uv_factor "Link to this definition")
    :   Internal UV factor

        Type:
        :   float in [0, 1], default 0.0

    uv\_rotation[#](#bpy.types.GPencilEditCurvePoint.uv_rotation "Link to this definition")
    :   Internal UV factor for dot mode

        Type:
        :   float in [-1.5708, 1.5708], default 0.0

    vertex\_color[#](#bpy.types.GPencilEditCurvePoint.vertex_color "Link to this definition")
    :   Vertex color of the grease pencil stroke point

        Type:
        :   float array of 4 items in [0, 1], default (0.0, 0.0, 0.0, 0.0)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.GPencilEditCurvePoint.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.GPencilEditCurvePoint.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`GPencilEditCurve.curve_points`](GPencilEditCurve.md#bpy.types.GPencilEditCurve.curve_points "bpy.types.GPencilEditCurve.curve_points") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GPencilEditCurvePoint.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.GPencilEditCurvePoint.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GPencilEditCurvePoint(bpy\_struct)
  + [`GPencilEditCurvePoint`](#bpy.types.GPencilEditCurvePoint)
    - [`GPencilEditCurvePoint.co`](#bpy.types.GPencilEditCurvePoint.co)
    - [`GPencilEditCurvePoint.handle_left`](#bpy.types.GPencilEditCurvePoint.handle_left)
    - [`GPencilEditCurvePoint.handle_right`](#bpy.types.GPencilEditCurvePoint.handle_right)
    - [`GPencilEditCurvePoint.hide`](#bpy.types.GPencilEditCurvePoint.hide)
    - [`GPencilEditCurvePoint.point_index`](#bpy.types.GPencilEditCurvePoint.point_index)
    - [`GPencilEditCurvePoint.pressure`](#bpy.types.GPencilEditCurvePoint.pressure)
    - [`GPencilEditCurvePoint.select_control_point`](#bpy.types.GPencilEditCurvePoint.select_control_point)
    - [`GPencilEditCurvePoint.select_left_handle`](#bpy.types.GPencilEditCurvePoint.select_left_handle)
    - [`GPencilEditCurvePoint.select_right_handle`](#bpy.types.GPencilEditCurvePoint.select_right_handle)
    - [`GPencilEditCurvePoint.strength`](#bpy.types.GPencilEditCurvePoint.strength)
    - [`GPencilEditCurvePoint.uv_factor`](#bpy.types.GPencilEditCurvePoint.uv_factor)
    - [`GPencilEditCurvePoint.uv_rotation`](#bpy.types.GPencilEditCurvePoint.uv_rotation)
    - [`GPencilEditCurvePoint.vertex_color`](#bpy.types.GPencilEditCurvePoint.vertex_color)
    - [`GPencilEditCurvePoint.bl_rna_get_subclass()`](#bpy.types.GPencilEditCurvePoint.bl_rna_get_subclass)
    - [`GPencilEditCurvePoint.bl_rna_get_subclass_py()`](#bpy.types.GPencilEditCurvePoint.bl_rna_get_subclass_py)
