...
# TextureNodeBricks(TextureNode)[#](#texturenodebricks-texturenode "Link to this heading")
...
*class* bpy.types.TextureNodeBricks(*TextureNode*)[#](#bpy.types.TextureNodeBricks "Link to this definition")
:   offset[#](#bpy.types.TextureNodeBricks.offset "Link to this definition")
    :   Type:
        :   float in [0, 1], default 0.0

    offset\_frequency[#](#bpy.types.TextureNodeBricks.offset_frequency "Link to this definition")
    :   Offset every N rows

        Type:
        :   int in [2, 99], default 0

    squash[#](#bpy.types.TextureNodeBricks.squash "Link to this definition")
    :   Type:
        :   float in [0, 99], default 0.0

    squash\_frequency[#](#bpy.types.TextureNodeBricks.squash_frequency "Link to this definition")
    :   Squash every N rows

        Type:
        :   int in [2, 99], default 0

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.TextureNodeBricks.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.TextureNodeBricks.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.TextureNodeBricks.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.TextureNodeBricks.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.TextureNodeBricks.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.TextureNodeBricks.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.TextureNodeBricks.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* TextureNodeBricks(TextureNode)
  + [`TextureNodeBricks`](#bpy.types.TextureNodeBricks)
    - [`TextureNodeBricks.offset`](#bpy.types.TextureNodeBricks.offset)
    - [`TextureNodeBricks.offset_frequency`](#bpy.types.TextureNodeBricks.offset_frequency)
    - [`TextureNodeBricks.squash`](#bpy.types.TextureNodeBricks.squash)
    - [`TextureNodeBricks.squash_frequency`](#bpy.types.TextureNodeBricks.squash_frequency)
    - [`TextureNodeBricks.is_registered_node_type()`](#bpy.types.TextureNodeBricks.is_registered_node_type)
    - [`TextureNodeBricks.input_template()`](#bpy.types.TextureNodeBricks.input_template)
    - [`TextureNodeBricks.output_template()`](#bpy.types.TextureNodeBricks.output_template)
    - [`TextureNodeBricks.bl_rna_get_subclass()`](#bpy.types.TextureNodeBricks.bl_rna_get_subclass)
    - [`TextureNodeBricks.bl_rna_get_subclass_py()`](#bpy.types.TextureNodeBricks.bl_rna_get_subclass_py)
