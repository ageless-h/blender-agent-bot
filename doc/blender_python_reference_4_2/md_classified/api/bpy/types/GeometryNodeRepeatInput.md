...
# GeometryNodeRepeatInput(GeometryNode)[#](#geometrynoderepeatinput-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeRepeatInput(*GeometryNode*)[#](#bpy.types.GeometryNodeRepeatInput "Link to this definition")
:   paired\_output[#](#bpy.types.GeometryNodeRepeatInput.paired_output "Link to this definition")
    :   Zone output node that this input node is paired with

        Type:
        :   [`Node`](Node.md#bpy.types.Node "bpy.types.Node"), (readonly)

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.GeometryNodeRepeatInput.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.GeometryNodeRepeatInput.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.GeometryNodeRepeatInput.output_template "Link to this definition")
    ...
    pair\_with\_output(*output\_node*)[#](#bpy.types.GeometryNodeRepeatInput.pair_with_output "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.GeometryNodeRepeatInput.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.GeometryNodeRepeatInput.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeRepeatInput.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.GeometryNodeRepeatInput.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeRepeatInput(GeometryNode)
  + [`GeometryNodeRepeatInput`](#bpy.types.GeometryNodeRepeatInput)
    - [`GeometryNodeRepeatInput.paired_output`](#bpy.types.GeometryNodeRepeatInput.paired_output)
    - [`GeometryNodeRepeatInput.is_registered_node_type()`](#bpy.types.GeometryNodeRepeatInput.is_registered_node_type)
    - [`GeometryNodeRepeatInput.input_template()`](#bpy.types.GeometryNodeRepeatInput.input_template)
    - [`GeometryNodeRepeatInput.output_template()`](#bpy.types.GeometryNodeRepeatInput.output_template)
    - [`GeometryNodeRepeatInput.pair_with_output()`](#bpy.types.GeometryNodeRepeatInput.pair_with_output)
    - [`GeometryNodeRepeatInput.bl_rna_get_subclass()`](#bpy.types.GeometryNodeRepeatInput.bl_rna_get_subclass)
    - [`GeometryNodeRepeatInput.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeRepeatInput.bl_rna_get_subclass_py)
