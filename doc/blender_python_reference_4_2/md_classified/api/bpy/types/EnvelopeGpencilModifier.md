...
# EnvelopeGpencilModifier(GpencilModifier)[#](#envelopegpencilmodifier-gpencilmodifier "Link to this heading")
...
*class* bpy.types.EnvelopeGpencilModifier(*GpencilModifier*)[#](#bpy.types.EnvelopeGpencilModifier "Link to this definition")
:   Envelope stroke effect modifier

    invert\_layer\_pass[#](#bpy.types.EnvelopeGpencilModifier.invert_layer_pass "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    invert\_layers[#](#bpy.types.EnvelopeGpencilModifier.invert_layers "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    invert\_material\_pass[#](#bpy.types.EnvelopeGpencilModifier.invert_material_pass "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    invert\_materials[#](#bpy.types.EnvelopeGpencilModifier.invert_materials "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    invert\_vertex[#](#bpy.types.EnvelopeGpencilModifier.invert_vertex "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    layer[#](#bpy.types.EnvelopeGpencilModifier.layer "Link to this definition")
    :   Layer name

        Type:
        :   string, default “”, (never None)

    layer\_pass[#](#bpy.types.EnvelopeGpencilModifier.layer_pass "Link to this definition")
    :   Layer pass index

        Type:
        :   int in [0, 100], default 0

    mat\_nr[#](#bpy.types.EnvelopeGpencilModifier.mat_nr "Link to this definition")
    :   The material to use for the new strokes

        Type:
        :   int in [-1, 32767], default -1

    material[#](#bpy.types.EnvelopeGpencilModifier.material "Link to this definition")
    :   Material used for filtering effect

        Type:
        :   [`Material`](Material.md#bpy.types.Material "bpy.types.Material")

    mode[#](#bpy.types.EnvelopeGpencilModifier.mode "Link to this definition")
    ...
    pass\_index[#](#bpy.types.EnvelopeGpencilModifier.pass_index "Link to this definition")
    :   Pass index

        Type:
        :   int in [0, 100], default 0

    skip[#](#bpy.types.EnvelopeGpencilModifier.skip "Link to this definition")
    :   The number of generated segments to skip to reduce complexity

        Type:
        :   int in [0, inf], default 0

    spread[#](#bpy.types.EnvelopeGpencilModifier.spread "Link to this definition")
    :   The number of points to skip to create straight segments

        Type:
        :   int in [1, inf], default 10

    strength[#](#bpy.types.EnvelopeGpencilModifier.strength "Link to this definition")
    :   Multiplier for the strength of the new strokes

        Type:
        :   float in [0, inf], default 1.0

    thickness[#](#bpy.types.EnvelopeGpencilModifier.thickness "Link to this definition")
    :   Multiplier for the thickness of the new strokes

        Type:
        :   float in [0, inf], default 1.0

    vertex\_group[#](#bpy.types.EnvelopeGpencilModifier.vertex_group "Link to this definition")
    :   Vertex group name for modulating the deform

        Type:
        :   string, default “”, (never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.EnvelopeGpencilModifier.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.EnvelopeGpencilModifier.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.EnvelopeGpencilModifier.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.EnvelopeGpencilModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* EnvelopeGpencilModifier(GpencilModifier)
  + [`EnvelopeGpencilModifier`](#bpy.types.EnvelopeGpencilModifier)
    - [`EnvelopeGpencilModifier.invert_layer_pass`](#bpy.types.EnvelopeGpencilModifier.invert_layer_pass)
    - [`EnvelopeGpencilModifier.invert_layers`](#bpy.types.EnvelopeGpencilModifier.invert_layers)
    - [`EnvelopeGpencilModifier.invert_material_pass`](#bpy.types.EnvelopeGpencilModifier.invert_material_pass)
    - [`EnvelopeGpencilModifier.invert_materials`](#bpy.types.EnvelopeGpencilModifier.invert_materials)
    - [`EnvelopeGpencilModifier.invert_vertex`](#bpy.types.EnvelopeGpencilModifier.invert_vertex)
    - [`EnvelopeGpencilModifier.layer`](#bpy.types.EnvelopeGpencilModifier.layer)
    - [`EnvelopeGpencilModifier.layer_pass`](#bpy.types.EnvelopeGpencilModifier.layer_pass)
    - [`EnvelopeGpencilModifier.mat_nr`](#bpy.types.EnvelopeGpencilModifier.mat_nr)
    - [`EnvelopeGpencilModifier.material`](#bpy.types.EnvelopeGpencilModifier.material)
    - [`EnvelopeGpencilModifier.mode`](#bpy.types.EnvelopeGpencilModifier.mode)
    - [`EnvelopeGpencilModifier.pass_index`](#bpy.types.EnvelopeGpencilModifier.pass_index)
    - [`EnvelopeGpencilModifier.skip`](#bpy.types.EnvelopeGpencilModifier.skip)
    - [`EnvelopeGpencilModifier.spread`](#bpy.types.EnvelopeGpencilModifier.spread)
    - [`EnvelopeGpencilModifier.strength`](#bpy.types.EnvelopeGpencilModifier.strength)
    - [`EnvelopeGpencilModifier.thickness`](#bpy.types.EnvelopeGpencilModifier.thickness)
    - [`EnvelopeGpencilModifier.vertex_group`](#bpy.types.EnvelopeGpencilModifier.vertex_group)
    - [`EnvelopeGpencilModifier.bl_rna_get_subclass()`](#bpy.types.EnvelopeGpencilModifier.bl_rna_get_subclass)
    - [`EnvelopeGpencilModifier.bl_rna_get_subclass_py()`](#bpy.types.EnvelopeGpencilModifier.bl_rna_get_subclass_py)
