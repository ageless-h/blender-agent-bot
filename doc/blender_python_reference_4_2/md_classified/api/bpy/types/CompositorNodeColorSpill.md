...
# CompositorNodeColorSpill(CompositorNode)[#](#compositornodecolorspill-compositornode "Link to this heading")
...
*class* bpy.types.CompositorNodeColorSpill(*CompositorNode*)[#](#bpy.types.CompositorNodeColorSpill "Link to this definition")
:   Remove colors from a blue or green screen, by reducing one RGB channel compared to the others

    channel[#](#bpy.types.CompositorNodeColorSpill.channel "Link to this definition")
    :   * `R`
    ...
    limit\_channel[#](#bpy.types.CompositorNodeColorSpill.limit_channel "Link to this definition")
    :   * `R`
          R – Limit by red.
        * `G`
          G – Limit by green.
    ...
    limit\_method[#](#bpy.types.CompositorNodeColorSpill.limit_method "Link to this definition")
    :   * `SIMPLE`
    ...
    ratio[#](#bpy.types.CompositorNodeColorSpill.ratio "Link to this definition")
    :   Scale limit by value

        Type:
        :   float in [0.5, 1.5], default 0.0

    unspill\_blue[#](#bpy.types.CompositorNodeColorSpill.unspill_blue "Link to this definition")
    :   Blue spillmap scale

        Type:
        :   float in [0, 1.5], default 0.0

    unspill\_green[#](#bpy.types.CompositorNodeColorSpill.unspill_green "Link to this definition")
    :   Green spillmap scale

        Type:
        :   float in [0, 1.5], default 0.0

    unspill\_red[#](#bpy.types.CompositorNodeColorSpill.unspill_red "Link to this definition")
    :   Red spillmap scale

        Type:
        :   float in [0, 1.5], default 0.0

    use\_unspill[#](#bpy.types.CompositorNodeColorSpill.use_unspill "Link to this definition")
    :   Compensate all channels (differently) by hand

        Type:
        :   boolean, default False

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.CompositorNodeColorSpill.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.CompositorNodeColorSpill.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.CompositorNodeColorSpill.output_template "Link to this definition")
    ...
    update()[#](#bpy.types.CompositorNodeColorSpill.update "Link to this definition")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.CompositorNodeColorSpill.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.CompositorNodeColorSpill.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CompositorNodeColorSpill.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.CompositorNodeColorSpill.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CompositorNodeColorSpill(CompositorNode)
  + [`CompositorNodeColorSpill`](#bpy.types.CompositorNodeColorSpill)
    - [`CompositorNodeColorSpill.channel`](#bpy.types.CompositorNodeColorSpill.channel)
    - [`CompositorNodeColorSpill.limit_channel`](#bpy.types.CompositorNodeColorSpill.limit_channel)
    - [`CompositorNodeColorSpill.limit_method`](#bpy.types.CompositorNodeColorSpill.limit_method)
    - [`CompositorNodeColorSpill.ratio`](#bpy.types.CompositorNodeColorSpill.ratio)
    - [`CompositorNodeColorSpill.unspill_blue`](#bpy.types.CompositorNodeColorSpill.unspill_blue)
    - [`CompositorNodeColorSpill.unspill_green`](#bpy.types.CompositorNodeColorSpill.unspill_green)
    - [`CompositorNodeColorSpill.unspill_red`](#bpy.types.CompositorNodeColorSpill.unspill_red)
    - [`CompositorNodeColorSpill.use_unspill`](#bpy.types.CompositorNodeColorSpill.use_unspill)
    - [`CompositorNodeColorSpill.is_registered_node_type()`](#bpy.types.CompositorNodeColorSpill.is_registered_node_type)
    - [`CompositorNodeColorSpill.input_template()`](#bpy.types.CompositorNodeColorSpill.input_template)
    - [`CompositorNodeColorSpill.output_template()`](#bpy.types.CompositorNodeColorSpill.output_template)
    - [`CompositorNodeColorSpill.update()`](#bpy.types.CompositorNodeColorSpill.update)
    - [`CompositorNodeColorSpill.bl_rna_get_subclass()`](#bpy.types.CompositorNodeColorSpill.bl_rna_get_subclass)
    - [`CompositorNodeColorSpill.bl_rna_get_subclass_py()`](#bpy.types.CompositorNodeColorSpill.bl_rna_get_subclass_py)
