...
# GeometryNodeMeshToPoints(GeometryNode)[#](#geometrynodemeshtopoints-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeMeshToPoints(*GeometryNode*)[#](#bpy.types.GeometryNodeMeshToPoints "Link to this definition")
:   Generate a point cloud from a mesh’s vertices

    mode[#](#bpy.types.GeometryNodeMeshToPoints.mode "Link to this definition")
    :   * `VERTICES`
        ...
        * `CORNERS`
        ...
        Type:
        :   enum in [‘VERTICES’, ‘EDGES’, ‘FACES’, ‘CORNERS’], default ‘VERTICES’

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.GeometryNodeMeshToPoints.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.GeometryNodeMeshToPoints.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.GeometryNodeMeshToPoints.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.GeometryNodeMeshToPoints.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.GeometryNodeMeshToPoints.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeMeshToPoints.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.GeometryNodeMeshToPoints.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeMeshToPoints(GeometryNode)
  + [`GeometryNodeMeshToPoints`](#bpy.types.GeometryNodeMeshToPoints)
    - [`GeometryNodeMeshToPoints.mode`](#bpy.types.GeometryNodeMeshToPoints.mode)
    - [`GeometryNodeMeshToPoints.is_registered_node_type()`](#bpy.types.GeometryNodeMeshToPoints.is_registered_node_type)
    - [`GeometryNodeMeshToPoints.input_template()`](#bpy.types.GeometryNodeMeshToPoints.input_template)
    - [`GeometryNodeMeshToPoints.output_template()`](#bpy.types.GeometryNodeMeshToPoints.output_template)
    - [`GeometryNodeMeshToPoints.bl_rna_get_subclass()`](#bpy.types.GeometryNodeMeshToPoints.bl_rna_get_subclass)
    - [`GeometryNodeMeshToPoints.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeMeshToPoints.bl_rna_get_subclass_py)
