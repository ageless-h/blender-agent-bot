...
# GeometryNodeAttributeStatistic(GeometryNode)[#](#geometrynodeattributestatistic-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeAttributeStatistic(*GeometryNode*)[#](#bpy.types.GeometryNodeAttributeStatistic "Link to this definition")
:   Calculate statistics about a data set from a field evaluated on a geometry

    data\_type[#](#bpy.types.GeometryNodeAttributeStatistic.data_type "Link to this definition")
    ...
    domain[#](#bpy.types.GeometryNodeAttributeStatistic.domain "Link to this definition")
    ...
    *classmethod* is\_registered\_node\_type()[#](#bpy.types.GeometryNodeAttributeStatistic.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.GeometryNodeAttributeStatistic.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.GeometryNodeAttributeStatistic.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.GeometryNodeAttributeStatistic.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.GeometryNodeAttributeStatistic.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeAttributeStatistic.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.GeometryNodeAttributeStatistic.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeAttributeStatistic(GeometryNode)
  + [`GeometryNodeAttributeStatistic`](#bpy.types.GeometryNodeAttributeStatistic)
    - [`GeometryNodeAttributeStatistic.data_type`](#bpy.types.GeometryNodeAttributeStatistic.data_type)
    - [`GeometryNodeAttributeStatistic.domain`](#bpy.types.GeometryNodeAttributeStatistic.domain)
    - [`GeometryNodeAttributeStatistic.is_registered_node_type()`](#bpy.types.GeometryNodeAttributeStatistic.is_registered_node_type)
    - [`GeometryNodeAttributeStatistic.input_template()`](#bpy.types.GeometryNodeAttributeStatistic.input_template)
    - [`GeometryNodeAttributeStatistic.output_template()`](#bpy.types.GeometryNodeAttributeStatistic.output_template)
    - [`GeometryNodeAttributeStatistic.bl_rna_get_subclass()`](#bpy.types.GeometryNodeAttributeStatistic.bl_rna_get_subclass)
    - [`GeometryNodeAttributeStatistic.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeAttributeStatistic.bl_rna_get_subclass_py)
