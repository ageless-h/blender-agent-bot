...
# CompositorNodeDBlur(CompositorNode)[#](#compositornodedblur-compositornode "Link to this heading")
...
*class* bpy.types.CompositorNodeDBlur(*CompositorNode*)[#](#bpy.types.CompositorNodeDBlur "Link to this definition")
:   Blur an image along a direction

    angle[#](#bpy.types.CompositorNodeDBlur.angle "Link to this definition")
    :   Type:
        :   float in [0, 6.28319], default 0.0

    center\_x[#](#bpy.types.CompositorNodeDBlur.center_x "Link to this definition")
    :   Type:
        :   float in [0, 1], default 0.0

    center\_y[#](#bpy.types.CompositorNodeDBlur.center_y "Link to this definition")
    :   Type:
        :   float in [0, 1], default 0.0

    distance[#](#bpy.types.CompositorNodeDBlur.distance "Link to this definition")
    :   Type:
        :   float in [-1, 1], default 0.0

    iterations[#](#bpy.types.CompositorNodeDBlur.iterations "Link to this definition")
    :   Type:
        :   int in [1, 32], default 0

    spin[#](#bpy.types.CompositorNodeDBlur.spin "Link to this definition")
    :   Type:
        :   float in [-6.28319, 6.28319], default 0.0

    zoom[#](#bpy.types.CompositorNodeDBlur.zoom "Link to this definition")
    :   Type:
        :   float in [0, 100], default 0.0

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.CompositorNodeDBlur.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.CompositorNodeDBlur.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.CompositorNodeDBlur.output_template "Link to this definition")
    ...
    update()[#](#bpy.types.CompositorNodeDBlur.update "Link to this definition")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.CompositorNodeDBlur.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.CompositorNodeDBlur.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CompositorNodeDBlur.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.CompositorNodeDBlur.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CompositorNodeDBlur(CompositorNode)
  + [`CompositorNodeDBlur`](#bpy.types.CompositorNodeDBlur)
    - [`CompositorNodeDBlur.angle`](#bpy.types.CompositorNodeDBlur.angle)
    - [`CompositorNodeDBlur.center_x`](#bpy.types.CompositorNodeDBlur.center_x)
    - [`CompositorNodeDBlur.center_y`](#bpy.types.CompositorNodeDBlur.center_y)
    - [`CompositorNodeDBlur.distance`](#bpy.types.CompositorNodeDBlur.distance)
    - [`CompositorNodeDBlur.iterations`](#bpy.types.CompositorNodeDBlur.iterations)
    - [`CompositorNodeDBlur.spin`](#bpy.types.CompositorNodeDBlur.spin)
    - [`CompositorNodeDBlur.zoom`](#bpy.types.CompositorNodeDBlur.zoom)
    - [`CompositorNodeDBlur.is_registered_node_type()`](#bpy.types.CompositorNodeDBlur.is_registered_node_type)
    - [`CompositorNodeDBlur.input_template()`](#bpy.types.CompositorNodeDBlur.input_template)
    - [`CompositorNodeDBlur.output_template()`](#bpy.types.CompositorNodeDBlur.output_template)
    - [`CompositorNodeDBlur.update()`](#bpy.types.CompositorNodeDBlur.update)
    - [`CompositorNodeDBlur.bl_rna_get_subclass()`](#bpy.types.CompositorNodeDBlur.bl_rna_get_subclass)
    - [`CompositorNodeDBlur.bl_rna_get_subclass_py()`](#bpy.types.CompositorNodeDBlur.bl_rna_get_subclass_py)
