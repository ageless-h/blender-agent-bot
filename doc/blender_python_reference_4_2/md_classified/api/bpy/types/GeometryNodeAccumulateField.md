...
# GeometryNodeAccumulateField(GeometryNode)[#](#geometrynodeaccumulatefield-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeAccumulateField(*GeometryNode*)[#](#bpy.types.GeometryNodeAccumulateField "Link to this definition")
:   Add the values of an evaluated field together and output the running total for each element

    data\_type[#](#bpy.types.GeometryNodeAccumulateField.data_type "Link to this definition")
    :   Type of data that is accumulated
        ...
        * `TRANSFORM`
        ...
        Type:
        :   enum in [‘FLOAT’, ‘INT’, ‘FLOAT\_VECTOR’, ‘TRANSFORM’], default ‘FLOAT’

    domain[#](#bpy.types.GeometryNodeAccumulateField.domain "Link to this definition")
    :   Type:
    ...
    *classmethod* is\_registered\_node\_type()[#](#bpy.types.GeometryNodeAccumulateField.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.GeometryNodeAccumulateField.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.GeometryNodeAccumulateField.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.GeometryNodeAccumulateField.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.GeometryNodeAccumulateField.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeAccumulateField.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.GeometryNodeAccumulateField.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeAccumulateField(GeometryNode)
  + [`GeometryNodeAccumulateField`](#bpy.types.GeometryNodeAccumulateField)
    - [`GeometryNodeAccumulateField.data_type`](#bpy.types.GeometryNodeAccumulateField.data_type)
    - [`GeometryNodeAccumulateField.domain`](#bpy.types.GeometryNodeAccumulateField.domain)
    - [`GeometryNodeAccumulateField.is_registered_node_type()`](#bpy.types.GeometryNodeAccumulateField.is_registered_node_type)
    - [`GeometryNodeAccumulateField.input_template()`](#bpy.types.GeometryNodeAccumulateField.input_template)
    - [`GeometryNodeAccumulateField.output_template()`](#bpy.types.GeometryNodeAccumulateField.output_template)
    - [`GeometryNodeAccumulateField.bl_rna_get_subclass()`](#bpy.types.GeometryNodeAccumulateField.bl_rna_get_subclass)
    - [`GeometryNodeAccumulateField.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeAccumulateField.bl_rna_get_subclass_py)
