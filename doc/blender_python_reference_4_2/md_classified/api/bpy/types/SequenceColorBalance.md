...
# SequenceColorBalance(SequenceColorBalanceData)[#](#sequencecolorbalance-sequencecolorbalancedata "Link to this heading")

base classes — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct"), [`SequenceColorBalanceData`](SequenceColorBalanceData.md#bpy.types.SequenceColorBalanceData "bpy.types.SequenceColorBalanceData")

*class* bpy.types.SequenceColorBalance(*SequenceColorBalanceData*)[#](#bpy.types.SequenceColorBalance "Link to this definition")
:   Color balance parameters for a sequence strip

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.SequenceColorBalance.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.SequenceColorBalance.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`bpy_struct.id_data`](bpy_struct.md#bpy.types.bpy_struct.id_data "bpy.types.bpy_struct.id_data") * [`SequenceColorBalanceData.correction_method`](SequenceColorBalanceData.md#bpy.types.SequenceColorBalanceData.correction_method "bpy.types.SequenceColorBalanceData.correction_method") * [`SequenceColorBalanceData.lift`](SequenceColorBalanceData.md#bpy.types.SequenceColorBalanceData.lift "bpy.types.SequenceColorBalanceData.lift") * [`SequenceColorBalanceData.gamma`](SequenceColorBalanceData.md#bpy.types.SequenceColorBalanceData.gamma "bpy.types.SequenceColorBalanceData.gamma") * [`SequenceColorBalanceData.gain`](SequenceColorBalanceData.md#bpy.types.SequenceColorBalanceData.gain "bpy.types.SequenceColorBalanceData.gain") * [`SequenceColorBalanceData.slope`](SequenceColorBalanceData.md#bpy.types.SequenceColorBalanceData.slope "bpy.types.SequenceColorBalanceData.slope") * [`SequenceColorBalanceData.offset`](SequenceColorBalanceData.md#bpy.types.SequenceColorBalanceData.offset "bpy.types.SequenceColorBalanceData.offset") | * [`SequenceColorBalanceData.power`](SequenceColorBalanceData.md#bpy.types.SequenceColorBalanceData.power "bpy.types.SequenceColorBalanceData.power") * [`SequenceColorBalanceData.invert_lift`](SequenceColorBalanceData.md#bpy.types.SequenceColorBalanceData.invert_lift "bpy.types.SequenceColorBalanceData.invert_lift") * [`SequenceColorBalanceData.invert_gamma`](SequenceColorBalanceData.md#bpy.types.SequenceColorBalanceData.invert_gamma "bpy.types.SequenceColorBalanceData.invert_gamma") * [`SequenceColorBalanceData.invert_gain`](SequenceColorBalanceData.md#bpy.types.SequenceColorBalanceData.invert_gain "bpy.types.SequenceColorBalanceData.invert_gain") * [`SequenceColorBalanceData.invert_slope`](SequenceColorBalanceData.md#bpy.types.SequenceColorBalanceData.invert_slope "bpy.types.SequenceColorBalanceData.invert_slope") * [`SequenceColorBalanceData.invert_offset`](SequenceColorBalanceData.md#bpy.types.SequenceColorBalanceData.invert_offset "bpy.types.SequenceColorBalanceData.invert_offset") * [`SequenceColorBalanceData.invert_power`](SequenceColorBalanceData.md#bpy.types.SequenceColorBalanceData.invert_power "bpy.types.SequenceColorBalanceData.invert_power") |

## Inherited Functions[#](#inherited-functions "Link to this heading")

|  |  |
| --- | --- |
| * [`bpy_struct.as_pointer`](bpy_struct.md#bpy.types.bpy_struct.as_pointer "bpy.types.bpy_struct.as_pointer") * [`bpy_struct.driver_add`](bpy_struct.md#bpy.types.bpy_struct.driver_add "bpy.types.bpy_struct.driver_add") * [`bpy_struct.driver_remove`](bpy_struct.md#bpy.types.bpy_struct.driver_remove "bpy.types.bpy_struct.driver_remove") * [`bpy_struct.get`](bpy_struct.md#bpy.types.bpy_struct.get "bpy.types.bpy_struct.get") * [`bpy_struct.id_properties_clear`](bpy_struct.md#bpy.types.bpy_struct.id_properties_clear "bpy.types.bpy_struct.id_properties_clear") * [`bpy_struct.id_properties_ensure`](bpy_struct.md#bpy.types.bpy_struct.id_properties_ensure "bpy.types.bpy_struct.id_properties_ensure") * [`bpy_struct.id_properties_ui`](bpy_struct.md#bpy.types.bpy_struct.id_properties_ui "bpy.types.bpy_struct.id_properties_ui") * [`bpy_struct.is_property_hidden`](bpy_struct.md#bpy.types.bpy_struct.is_property_hidden "bpy.types.bpy_struct.is_property_hidden") * [`bpy_struct.is_property_overridable_library`](bpy_struct.md#bpy.types.bpy_struct.is_property_overridable_library "bpy.types.bpy_struct.is_property_overridable_library") * [`bpy_struct.is_property_readonly`](bpy_struct.md#bpy.types.bpy_struct.is_property_readonly "bpy.types.bpy_struct.is_property_readonly") * [`bpy_struct.is_property_set`](bpy_struct.md#bpy.types.bpy_struct.is_property_set "bpy.types.bpy_struct.is_property_set") * [`bpy_struct.items`](bpy_struct.md#bpy.types.bpy_struct.items "bpy.types.bpy_struct.items") | * [`bpy_struct.keyframe_delete`](bpy_struct.md#bpy.types.bpy_struct.keyframe_delete "bpy.types.bpy_struct.keyframe_delete") * [`bpy_struct.keyframe_insert`](bpy_struct.md#bpy.types.bpy_struct.keyframe_insert "bpy.types.bpy_struct.keyframe_insert") * [`bpy_struct.keys`](bpy_struct.md#bpy.types.bpy_struct.keys "bpy.types.bpy_struct.keys") * [`bpy_struct.path_from_id`](bpy_struct.md#bpy.types.bpy_struct.path_from_id "bpy.types.bpy_struct.path_from_id") * [`bpy_struct.path_resolve`](bpy_struct.md#bpy.types.bpy_struct.path_resolve "bpy.types.bpy_struct.path_resolve") * [`bpy_struct.pop`](bpy_struct.md#bpy.types.bpy_struct.pop "bpy.types.bpy_struct.pop") * [`bpy_struct.property_overridable_library_set`](bpy_struct.md#bpy.types.bpy_struct.property_overridable_library_set "bpy.types.bpy_struct.property_overridable_library_set") * [`bpy_struct.property_unset`](bpy_struct.md#bpy.types.bpy_struct.property_unset "bpy.types.bpy_struct.property_unset") * [`bpy_struct.type_recast`](bpy_struct.md#bpy.types.bpy_struct.type_recast "bpy.types.bpy_struct.type_recast") * [`bpy_struct.values`](bpy_struct.md#bpy.types.bpy_struct.values "bpy.types.bpy_struct.values") * [`SequenceColorBalanceData.bl_rna_get_subclass`](SequenceColorBalanceData.md#bpy.types.SequenceColorBalanceData.bl_rna_get_subclass "bpy.types.SequenceColorBalanceData.bl_rna_get_subclass") * [`SequenceColorBalanceData.bl_rna_get_subclass_py`](SequenceColorBalanceData.md#bpy.types.SequenceColorBalanceData.bl_rna_get_subclass_py "bpy.types.SequenceColorBalanceData.bl_rna_get_subclass_py") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.SequenceColorBalance.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.SequenceColorBalance.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* SequenceColorBalance(SequenceColorBalanceData)
  + [`SequenceColorBalance`](#bpy.types.SequenceColorBalance)
    - [`SequenceColorBalance.bl_rna_get_subclass()`](#bpy.types.SequenceColorBalance.bl_rna_get_subclass)
    - [`SequenceColorBalance.bl_rna_get_subclass_py()`](#bpy.types.SequenceColorBalance.bl_rna_get_subclass_py)
