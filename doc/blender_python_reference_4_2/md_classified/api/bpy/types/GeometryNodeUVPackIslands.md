...
# GeometryNodeUVPackIslands(GeometryNode)[#](#geometrynodeuvpackislands-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeUVPackIslands(*GeometryNode*)[#](#bpy.types.GeometryNodeUVPackIslands "Link to this definition")
:   Scale islands of a UV map and move them so they fill the UV space as much as possible

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.GeometryNodeUVPackIslands.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.GeometryNodeUVPackIslands.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.GeometryNodeUVPackIslands.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.GeometryNodeUVPackIslands.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.GeometryNodeUVPackIslands.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeUVPackIslands.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.GeometryNodeUVPackIslands.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeUVPackIslands(GeometryNode)
  + [`GeometryNodeUVPackIslands`](#bpy.types.GeometryNodeUVPackIslands)
    - [`GeometryNodeUVPackIslands.is_registered_node_type()`](#bpy.types.GeometryNodeUVPackIslands.is_registered_node_type)
    - [`GeometryNodeUVPackIslands.input_template()`](#bpy.types.GeometryNodeUVPackIslands.input_template)
    - [`GeometryNodeUVPackIslands.output_template()`](#bpy.types.GeometryNodeUVPackIslands.output_template)
    - [`GeometryNodeUVPackIslands.bl_rna_get_subclass()`](#bpy.types.GeometryNodeUVPackIslands.bl_rna_get_subclass)
    - [`GeometryNodeUVPackIslands.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeUVPackIslands.bl_rna_get_subclass_py)
