...
# GPencilTriangle(bpy\_struct)[#](#gpenciltriangle-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.GPencilTriangle(*bpy\_struct*)[#](#bpy.types.GPencilTriangle "Link to this definition")
:   Triangulation data for Grease Pencil fills

    v1[#](#bpy.types.GPencilTriangle.v1 "Link to this definition")
    :   First triangle vertex index

        Type:
        :   int in [-inf, inf], default 0, (readonly)

    v2[#](#bpy.types.GPencilTriangle.v2 "Link to this definition")
    :   Second triangle vertex index

        Type:
        :   int in [-inf, inf], default 0, (readonly)

    v3[#](#bpy.types.GPencilTriangle.v3 "Link to this definition")
    :   Third triangle vertex index

        Type:
        :   int in [-inf, inf], default 0, (readonly)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.GPencilTriangle.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.GPencilTriangle.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`GPencilStroke.triangles`](GPencilStroke.md#bpy.types.GPencilStroke.triangles "bpy.types.GPencilStroke.triangles") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GPencilTriangle.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.GPencilTriangle.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GPencilTriangle(bpy\_struct)
  + [`GPencilTriangle`](#bpy.types.GPencilTriangle)
    - [`GPencilTriangle.v1`](#bpy.types.GPencilTriangle.v1)
    - [`GPencilTriangle.v2`](#bpy.types.GPencilTriangle.v2)
    - [`GPencilTriangle.v3`](#bpy.types.GPencilTriangle.v3)
    - [`GPencilTriangle.bl_rna_get_subclass()`](#bpy.types.GPencilTriangle.bl_rna_get_subclass)
    - [`GPencilTriangle.bl_rna_get_subclass_py()`](#bpy.types.GPencilTriangle.bl_rna_get_subclass_py)
