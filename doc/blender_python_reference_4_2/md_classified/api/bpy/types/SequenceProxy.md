...
# SequenceProxy(bpy\_struct)[#](#sequenceproxy-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.SequenceProxy(*bpy\_struct*)[#](#bpy.types.SequenceProxy "Link to this definition")
:   Proxy parameters for a sequence strip

    build\_100[#](#bpy.types.SequenceProxy.build_100 "Link to this definition")
    :   Build 100% proxy resolution

        Type:
        :   boolean, default False

    build\_25[#](#bpy.types.SequenceProxy.build_25 "Link to this definition")
    :   Build 25% proxy resolution

        Type:
        :   boolean, default False

    build\_50[#](#bpy.types.SequenceProxy.build_50 "Link to this definition")
    :   Build 50% proxy resolution

        Type:
        :   boolean, default False

    build\_75[#](#bpy.types.SequenceProxy.build_75 "Link to this definition")
    :   Build 75% proxy resolution

        Type:
        :   boolean, default False

    build\_record\_run[#](#bpy.types.SequenceProxy.build_record_run "Link to this definition")
    :   Build record run time code index

        Type:
        :   boolean, default False

    directory[#](#bpy.types.SequenceProxy.directory "Link to this definition")
    :   Location to store the proxy files

        Type:
        :   string, default “”, (never None)

    filepath[#](#bpy.types.SequenceProxy.filepath "Link to this definition")
    :   Location of custom proxy file

        Type:
        :   string, default “”, (never None)

    quality[#](#bpy.types.SequenceProxy.quality "Link to this definition")
    :   Quality of proxies to build

        Type:
        :   int in [0, 32767], default 0

    timecode[#](#bpy.types.SequenceProxy.timecode "Link to this definition")
    :   Method for reading the inputs timecode
        ...
        * `RECORD_RUN_NO_GAPS`
        ...
        Type:
        :   enum in [‘NONE’, ‘RECORD\_RUN’, ‘RECORD\_RUN\_NO\_GAPS’], default ‘NONE’

    use\_overwrite[#](#bpy.types.SequenceProxy.use_overwrite "Link to this definition")
    :   Overwrite existing proxy files when building

        Type:
        :   boolean, default False

    use\_proxy\_custom\_directory[#](#bpy.types.SequenceProxy.use_proxy_custom_directory "Link to this definition")
    :   Use a custom directory to store data

        Type:
        :   boolean, default False

    use\_proxy\_custom\_file[#](#bpy.types.SequenceProxy.use_proxy_custom_file "Link to this definition")
    :   Use a custom file to read proxy data from

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.SequenceProxy.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.SequenceProxy.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`EffectSequence.proxy`](EffectSequence.md#bpy.types.EffectSequence.proxy "bpy.types.EffectSequence.proxy") * [`ImageSequence.proxy`](ImageSequence.md#bpy.types.ImageSequence.proxy "bpy.types.ImageSequence.proxy") * [`MetaSequence.proxy`](MetaSequence.md#bpy.types.MetaSequence.proxy "bpy.types.MetaSequence.proxy") | * [`MovieSequence.proxy`](MovieSequence.md#bpy.types.MovieSequence.proxy "bpy.types.MovieSequence.proxy") * [`SceneSequence.proxy`](SceneSequence.md#bpy.types.SceneSequence.proxy "bpy.types.SceneSequence.proxy") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.SequenceProxy.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.SequenceProxy.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* SequenceProxy(bpy\_struct)
  + [`SequenceProxy`](#bpy.types.SequenceProxy)
    - [`SequenceProxy.build_100`](#bpy.types.SequenceProxy.build_100)
    - [`SequenceProxy.build_25`](#bpy.types.SequenceProxy.build_25)
    - [`SequenceProxy.build_50`](#bpy.types.SequenceProxy.build_50)
    - [`SequenceProxy.build_75`](#bpy.types.SequenceProxy.build_75)
    - [`SequenceProxy.build_record_run`](#bpy.types.SequenceProxy.build_record_run)
    - [`SequenceProxy.directory`](#bpy.types.SequenceProxy.directory)
    - [`SequenceProxy.filepath`](#bpy.types.SequenceProxy.filepath)
    - [`SequenceProxy.quality`](#bpy.types.SequenceProxy.quality)
    - [`SequenceProxy.timecode`](#bpy.types.SequenceProxy.timecode)
    - [`SequenceProxy.use_overwrite`](#bpy.types.SequenceProxy.use_overwrite)
    - [`SequenceProxy.use_proxy_custom_directory`](#bpy.types.SequenceProxy.use_proxy_custom_directory)
    - [`SequenceProxy.use_proxy_custom_file`](#bpy.types.SequenceProxy.use_proxy_custom_file)
    - [`SequenceProxy.bl_rna_get_subclass()`](#bpy.types.SequenceProxy.bl_rna_get_subclass)
    - [`SequenceProxy.bl_rna_get_subclass_py()`](#bpy.types.SequenceProxy.bl_rna_get_subclass_py)
