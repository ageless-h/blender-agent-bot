...
# GeometryNodeMergeByDistance(GeometryNode)[#](#geometrynodemergebydistance-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeMergeByDistance(*GeometryNode*)[#](#bpy.types.GeometryNodeMergeByDistance "Link to this definition")
:   Merge vertices or points within a given distance

    mode[#](#bpy.types.GeometryNodeMergeByDistance.mode "Link to this definition")
    :   * `ALL`
          All – Merge all close selected points, whether or not they are connected.
        * `CONNECTED`
          Connected – Only merge mesh vertices along existing edges. This method can be much faster.

        Type:
        :   enum in [‘ALL’, ‘CONNECTED’], default ‘ALL’

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.GeometryNodeMergeByDistance.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.GeometryNodeMergeByDistance.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.GeometryNodeMergeByDistance.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.GeometryNodeMergeByDistance.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.GeometryNodeMergeByDistance.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeMergeByDistance.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.GeometryNodeMergeByDistance.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeMergeByDistance(GeometryNode)
  + [`GeometryNodeMergeByDistance`](#bpy.types.GeometryNodeMergeByDistance)
    - [`GeometryNodeMergeByDistance.mode`](#bpy.types.GeometryNodeMergeByDistance.mode)
    - [`GeometryNodeMergeByDistance.is_registered_node_type()`](#bpy.types.GeometryNodeMergeByDistance.is_registered_node_type)
    - [`GeometryNodeMergeByDistance.input_template()`](#bpy.types.GeometryNodeMergeByDistance.input_template)
    - [`GeometryNodeMergeByDistance.output_template()`](#bpy.types.GeometryNodeMergeByDistance.output_template)
    - [`GeometryNodeMergeByDistance.bl_rna_get_subclass()`](#bpy.types.GeometryNodeMergeByDistance.bl_rna_get_subclass)
    - [`GeometryNodeMergeByDistance.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeMergeByDistance.bl_rna_get_subclass_py)
