...
# NodeGroupOutput(NodeInternal)[#](#nodegroupoutput-nodeinternal "Link to this heading")
...
*class* bpy.types.NodeGroupOutput(*NodeInternal*)[#](#bpy.types.NodeGroupOutput "Link to this definition")
:   Output data from inside of a node group

    is\_active\_output[#](#bpy.types.NodeGroupOutput.is_active_output "Link to this definition")
    :   True if this node is used as the active group output

        Type:
        :   boolean, default False

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.NodeGroupOutput.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.NodeGroupOutput.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.NodeGroupOutput.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.NodeGroupOutput.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.NodeGroupOutput.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.NodeGroupOutput.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.NodeGroupOutput.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* NodeGroupOutput(NodeInternal)
  + [`NodeGroupOutput`](#bpy.types.NodeGroupOutput)
    - [`NodeGroupOutput.is_active_output`](#bpy.types.NodeGroupOutput.is_active_output)
    - [`NodeGroupOutput.is_registered_node_type()`](#bpy.types.NodeGroupOutput.is_registered_node_type)
    - [`NodeGroupOutput.input_template()`](#bpy.types.NodeGroupOutput.input_template)
    - [`NodeGroupOutput.output_template()`](#bpy.types.NodeGroupOutput.output_template)
    - [`NodeGroupOutput.bl_rna_get_subclass()`](#bpy.types.NodeGroupOutput.bl_rna_get_subclass)
    - [`NodeGroupOutput.bl_rna_get_subclass_py()`](#bpy.types.NodeGroupOutput.bl_rna_get_subclass_py)
