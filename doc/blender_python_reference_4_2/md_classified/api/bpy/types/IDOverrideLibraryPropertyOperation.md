...
:   Description of an override operation over an overridden property
    ...
    :   Status flags
        ...
        * `IDPOINTER_ITEM_USE_ID`
        ...
        Type:
        :   enum set in {‘MANDATORY’, ‘LOCKED’, ‘IDPOINTER\_MATCH\_REFERENCE’, ‘IDPOINTER\_ITEM\_USE\_ID’}, default {‘MANDATORY’}, (readonly)
    ...
    :   What override operation is performed
        ...
        * `INSERT_BEFORE`
        ...
        Type:
        :   enum in [‘NOOP’, ‘REPLACE’, ‘DIFF\_ADD’, ‘DIFF\_SUB’, ‘FACT\_MULTIPLY’, ‘INSERT\_AFTER’, ‘INSERT\_BEFORE’], default ‘REPLACE’, (readonly)
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.IDOverrideLibraryPropertyOperation.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.IDOverrideLibraryPropertyOperation.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)
