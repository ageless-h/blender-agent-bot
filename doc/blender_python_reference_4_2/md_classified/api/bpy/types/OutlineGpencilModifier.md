...
# OutlineGpencilModifier(GpencilModifier)[#](#outlinegpencilmodifier-gpencilmodifier "Link to this heading")
...
*class* bpy.types.OutlineGpencilModifier(*GpencilModifier*)[#](#bpy.types.OutlineGpencilModifier "Link to this definition")
:   Outline of Strokes modifier from camera view

    invert\_layer\_pass[#](#bpy.types.OutlineGpencilModifier.invert_layer_pass "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    invert\_layers[#](#bpy.types.OutlineGpencilModifier.invert_layers "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    invert\_material\_pass[#](#bpy.types.OutlineGpencilModifier.invert_material_pass "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    invert\_materials[#](#bpy.types.OutlineGpencilModifier.invert_materials "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    layer[#](#bpy.types.OutlineGpencilModifier.layer "Link to this definition")
    :   Layer name

        Type:
        :   string, default “”, (never None)

    layer\_pass[#](#bpy.types.OutlineGpencilModifier.layer_pass "Link to this definition")
    :   Layer pass index

        Type:
        :   int in [0, 100], default 0

    material[#](#bpy.types.OutlineGpencilModifier.material "Link to this definition")
    :   Material used for filtering effect

        Type:
        :   [`Material`](Material.md#bpy.types.Material "bpy.types.Material")

    object[#](#bpy.types.OutlineGpencilModifier.object "Link to this definition")
    :   Target object to define stroke start

        Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object")

    outline\_material[#](#bpy.types.OutlineGpencilModifier.outline_material "Link to this definition")
    :   Material used for outline strokes

        Type:
        :   [`Material`](Material.md#bpy.types.Material "bpy.types.Material")

    pass\_index[#](#bpy.types.OutlineGpencilModifier.pass_index "Link to this definition")
    :   Pass index

        Type:
        :   int in [0, 100], default 0

    sample\_length[#](#bpy.types.OutlineGpencilModifier.sample_length "Link to this definition")
    :   Type:
        :   float in [-inf, inf], default 0.0

    subdivision[#](#bpy.types.OutlineGpencilModifier.subdivision "Link to this definition")
    :   Number of subdivisions

        Type:
        :   int in [0, 10], default 3

    thickness[#](#bpy.types.OutlineGpencilModifier.thickness "Link to this definition")
    :   Thickness of the perimeter stroke

        Type:
        :   int in [1, 1000], default 1

    use\_keep\_shape[#](#bpy.types.OutlineGpencilModifier.use_keep_shape "Link to this definition")
    :   Try to keep global shape

        Type:
        :   boolean, default True

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.OutlineGpencilModifier.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.OutlineGpencilModifier.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.OutlineGpencilModifier.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.OutlineGpencilModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* OutlineGpencilModifier(GpencilModifier)
  + [`OutlineGpencilModifier`](#bpy.types.OutlineGpencilModifier)
    - [`OutlineGpencilModifier.invert_layer_pass`](#bpy.types.OutlineGpencilModifier.invert_layer_pass)
    - [`OutlineGpencilModifier.invert_layers`](#bpy.types.OutlineGpencilModifier.invert_layers)
    - [`OutlineGpencilModifier.invert_material_pass`](#bpy.types.OutlineGpencilModifier.invert_material_pass)
    - [`OutlineGpencilModifier.invert_materials`](#bpy.types.OutlineGpencilModifier.invert_materials)
    - [`OutlineGpencilModifier.layer`](#bpy.types.OutlineGpencilModifier.layer)
    - [`OutlineGpencilModifier.layer_pass`](#bpy.types.OutlineGpencilModifier.layer_pass)
    - [`OutlineGpencilModifier.material`](#bpy.types.OutlineGpencilModifier.material)
    - [`OutlineGpencilModifier.object`](#bpy.types.OutlineGpencilModifier.object)
    - [`OutlineGpencilModifier.outline_material`](#bpy.types.OutlineGpencilModifier.outline_material)
    - [`OutlineGpencilModifier.pass_index`](#bpy.types.OutlineGpencilModifier.pass_index)
    - [`OutlineGpencilModifier.sample_length`](#bpy.types.OutlineGpencilModifier.sample_length)
    - [`OutlineGpencilModifier.subdivision`](#bpy.types.OutlineGpencilModifier.subdivision)
    - [`OutlineGpencilModifier.thickness`](#bpy.types.OutlineGpencilModifier.thickness)
    - [`OutlineGpencilModifier.use_keep_shape`](#bpy.types.OutlineGpencilModifier.use_keep_shape)
    - [`OutlineGpencilModifier.bl_rna_get_subclass()`](#bpy.types.OutlineGpencilModifier.bl_rna_get_subclass)
    - [`OutlineGpencilModifier.bl_rna_get_subclass_py()`](#bpy.types.OutlineGpencilModifier.bl_rna_get_subclass_py)
