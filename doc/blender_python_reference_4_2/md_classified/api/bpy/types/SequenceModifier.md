...
# SequenceModifier(bpy\_struct)[#](#sequencemodifier-bpy-struct "Link to this heading")
...
*class* bpy.types.SequenceModifier(*bpy\_struct*)[#](#bpy.types.SequenceModifier "Link to this definition")
:   Modifier for sequence strip

    input\_mask\_id[#](#bpy.types.SequenceModifier.input_mask_id "Link to this definition")
    :   Mask ID used as mask input for the modifier

        Type:
        :   [`Mask`](Mask.md#bpy.types.Mask "bpy.types.Mask")

    input\_mask\_strip[#](#bpy.types.SequenceModifier.input_mask_strip "Link to this definition")
    :   Strip used as mask input for the modifier

        Type:
        :   [`Sequence`](Sequence.md#bpy.types.Sequence "bpy.types.Sequence")

    input\_mask\_type[#](#bpy.types.SequenceModifier.input_mask_type "Link to this definition")
    ...
    mask\_time[#](#bpy.types.SequenceModifier.mask_time "Link to this definition")
    ...
    mute[#](#bpy.types.SequenceModifier.mute "Link to this definition")
    :   Mute this modifier

        Type:
        :   boolean, default False

    name[#](#bpy.types.SequenceModifier.name "Link to this definition")
    :   Type:
        :   string, default “”, (never None)

    show\_expanded[#](#bpy.types.SequenceModifier.show_expanded "Link to this definition")
    :   Mute expanded settings for the modifier

        Type:
        :   boolean, default False

    type[#](#bpy.types.SequenceModifier.type "Link to this definition")
    :   Type:
        :   enum in [Sequence Modifier Type Items](../../../appendix/bpy_types_enum_items/sequence_modifier_type_items.md#rna-enum-sequence-modifier-type-items), default ‘BRIGHT\_CONTRAST’, (readonly)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.SequenceModifier.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.SequenceModifier.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
        ...
        Return type:
        :   [type](#bpy.types.SequenceModifier.type "bpy.types.SequenceModifier.type")
...
|  |  |
| --- | --- |
| * [`Sequence.modifiers`](Sequence.md#bpy.types.Sequence.modifiers "bpy.types.Sequence.modifiers") * [`SequenceModifiers.new`](SequenceModifiers.md#bpy.types.SequenceModifiers.new "bpy.types.SequenceModifiers.new") | * [`SequenceModifiers.remove`](SequenceModifiers.md#bpy.types.SequenceModifiers.remove "bpy.types.SequenceModifiers.remove") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.SequenceModifier.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.SequenceModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* SequenceModifier(bpy\_struct)
  + [`SequenceModifier`](#bpy.types.SequenceModifier)
    - [`SequenceModifier.input_mask_id`](#bpy.types.SequenceModifier.input_mask_id)
    - [`SequenceModifier.input_mask_strip`](#bpy.types.SequenceModifier.input_mask_strip)
    - [`SequenceModifier.input_mask_type`](#bpy.types.SequenceModifier.input_mask_type)
    - [`SequenceModifier.mask_time`](#bpy.types.SequenceModifier.mask_time)
    - [`SequenceModifier.mute`](#bpy.types.SequenceModifier.mute)
    - [`SequenceModifier.name`](#bpy.types.SequenceModifier.name)
    - [`SequenceModifier.show_expanded`](#bpy.types.SequenceModifier.show_expanded)
    - [`SequenceModifier.type`](#bpy.types.SequenceModifier.type)
    - [`SequenceModifier.bl_rna_get_subclass()`](#bpy.types.SequenceModifier.bl_rna_get_subclass)
    - [`SequenceModifier.bl_rna_get_subclass_py()`](#bpy.types.SequenceModifier.bl_rna_get_subclass_py)
