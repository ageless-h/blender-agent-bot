...
# GeometryNodeDistributePointsOnFaces(GeometryNode)[#](#geometrynodedistributepointsonfaces-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeDistributePointsOnFaces(*GeometryNode*)[#](#bpy.types.GeometryNodeDistributePointsOnFaces "Link to this definition")
:   Generate points spread out on the surface of a mesh

    distribute\_method[#](#bpy.types.GeometryNodeDistributePointsOnFaces.distribute_method "Link to this definition")
    :   Method to use for scattering points
        ...
        * `POISSON`
        ...
        Type:
        :   enum in [‘RANDOM’, ‘POISSON’], default ‘RANDOM’

    use\_legacy\_normal[#](#bpy.types.GeometryNodeDistributePointsOnFaces.use_legacy_normal "Link to this definition")
    ...
    *classmethod* is\_registered\_node\_type()[#](#bpy.types.GeometryNodeDistributePointsOnFaces.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.GeometryNodeDistributePointsOnFaces.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.GeometryNodeDistributePointsOnFaces.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.GeometryNodeDistributePointsOnFaces.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.GeometryNodeDistributePointsOnFaces.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeDistributePointsOnFaces.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.GeometryNodeDistributePointsOnFaces.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeDistributePointsOnFaces(GeometryNode)
  + [`GeometryNodeDistributePointsOnFaces`](#bpy.types.GeometryNodeDistributePointsOnFaces)
    - [`GeometryNodeDistributePointsOnFaces.distribute_method`](#bpy.types.GeometryNodeDistributePointsOnFaces.distribute_method)
    - [`GeometryNodeDistributePointsOnFaces.use_legacy_normal`](#bpy.types.GeometryNodeDistributePointsOnFaces.use_legacy_normal)
    - [`GeometryNodeDistributePointsOnFaces.is_registered_node_type()`](#bpy.types.GeometryNodeDistributePointsOnFaces.is_registered_node_type)
    - [`GeometryNodeDistributePointsOnFaces.input_template()`](#bpy.types.GeometryNodeDistributePointsOnFaces.input_template)
    - [`GeometryNodeDistributePointsOnFaces.output_template()`](#bpy.types.GeometryNodeDistributePointsOnFaces.output_template)
    - [`GeometryNodeDistributePointsOnFaces.bl_rna_get_subclass()`](#bpy.types.GeometryNodeDistributePointsOnFaces.bl_rna_get_subclass)
    - [`GeometryNodeDistributePointsOnFaces.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeDistributePointsOnFaces.bl_rna_get_subclass_py)
