...
# MultiplyGpencilModifier(GpencilModifier)[#](#multiplygpencilmodifier-gpencilmodifier "Link to this heading")
...
*class* bpy.types.MultiplyGpencilModifier(*GpencilModifier*)[#](#bpy.types.MultiplyGpencilModifier "Link to this definition")
:   Generate multiple strokes from one stroke

    distance[#](#bpy.types.MultiplyGpencilModifier.distance "Link to this definition")
    :   Distance of duplications

        Type:
        :   float in [-inf, inf], default 0.1

    duplicates[#](#bpy.types.MultiplyGpencilModifier.duplicates "Link to this definition")
    :   How many copies of strokes be displayed

        Type:
        :   int in [0, 999], default 3

    fading\_center[#](#bpy.types.MultiplyGpencilModifier.fading_center "Link to this definition")
    :   Fade center

        Type:
        :   float in [0, 1], default 0.5

    fading\_opacity[#](#bpy.types.MultiplyGpencilModifier.fading_opacity "Link to this definition")
    :   Fade influence of stroke’s opacity

        Type:
        :   float in [0, 1], default 0.5

    fading\_thickness[#](#bpy.types.MultiplyGpencilModifier.fading_thickness "Link to this definition")
    :   Fade influence of stroke’s thickness

        Type:
        :   float in [0, 1], default 0.5

    invert\_layer\_pass[#](#bpy.types.MultiplyGpencilModifier.invert_layer_pass "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    invert\_layers[#](#bpy.types.MultiplyGpencilModifier.invert_layers "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    invert\_material\_pass[#](#bpy.types.MultiplyGpencilModifier.invert_material_pass "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    invert\_materials[#](#bpy.types.MultiplyGpencilModifier.invert_materials "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    layer[#](#bpy.types.MultiplyGpencilModifier.layer "Link to this definition")
    :   Layer name

        Type:
        :   string, default “”, (never None)

    layer\_pass[#](#bpy.types.MultiplyGpencilModifier.layer_pass "Link to this definition")
    :   Layer pass index

        Type:
        :   int in [0, 100], default 0

    material[#](#bpy.types.MultiplyGpencilModifier.material "Link to this definition")
    :   Material used for filtering effect

        Type:
        :   [`Material`](Material.md#bpy.types.Material "bpy.types.Material")

    offset[#](#bpy.types.MultiplyGpencilModifier.offset "Link to this definition")
    :   Offset of duplicates. -1 to 1: inner to outer

        Type:
        :   float in [-inf, inf], default 0.0

    pass\_index[#](#bpy.types.MultiplyGpencilModifier.pass_index "Link to this definition")
    :   Pass index

        Type:
        :   int in [0, 100], default 0

    use\_fade[#](#bpy.types.MultiplyGpencilModifier.use_fade "Link to this definition")
    :   Fade the stroke thickness for each generated stroke

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.MultiplyGpencilModifier.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.MultiplyGpencilModifier.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.MultiplyGpencilModifier.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.MultiplyGpencilModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* MultiplyGpencilModifier(GpencilModifier)
  + [`MultiplyGpencilModifier`](#bpy.types.MultiplyGpencilModifier)
    - [`MultiplyGpencilModifier.distance`](#bpy.types.MultiplyGpencilModifier.distance)
    - [`MultiplyGpencilModifier.duplicates`](#bpy.types.MultiplyGpencilModifier.duplicates)
    - [`MultiplyGpencilModifier.fading_center`](#bpy.types.MultiplyGpencilModifier.fading_center)
    - [`MultiplyGpencilModifier.fading_opacity`](#bpy.types.MultiplyGpencilModifier.fading_opacity)
    - [`MultiplyGpencilModifier.fading_thickness`](#bpy.types.MultiplyGpencilModifier.fading_thickness)
    - [`MultiplyGpencilModifier.invert_layer_pass`](#bpy.types.MultiplyGpencilModifier.invert_layer_pass)
    - [`MultiplyGpencilModifier.invert_layers`](#bpy.types.MultiplyGpencilModifier.invert_layers)
    - [`MultiplyGpencilModifier.invert_material_pass`](#bpy.types.MultiplyGpencilModifier.invert_material_pass)
    - [`MultiplyGpencilModifier.invert_materials`](#bpy.types.MultiplyGpencilModifier.invert_materials)
    - [`MultiplyGpencilModifier.layer`](#bpy.types.MultiplyGpencilModifier.layer)
    - [`MultiplyGpencilModifier.layer_pass`](#bpy.types.MultiplyGpencilModifier.layer_pass)
    - [`MultiplyGpencilModifier.material`](#bpy.types.MultiplyGpencilModifier.material)
    - [`MultiplyGpencilModifier.offset`](#bpy.types.MultiplyGpencilModifier.offset)
    - [`MultiplyGpencilModifier.pass_index`](#bpy.types.MultiplyGpencilModifier.pass_index)
    - [`MultiplyGpencilModifier.use_fade`](#bpy.types.MultiplyGpencilModifier.use_fade)
    - [`MultiplyGpencilModifier.bl_rna_get_subclass()`](#bpy.types.MultiplyGpencilModifier.bl_rna_get_subclass)
    - [`MultiplyGpencilModifier.bl_rna_get_subclass_py()`](#bpy.types.MultiplyGpencilModifier.bl_rna_get_subclass_py)
