...
:   Collection of Object data-blocks
    ...
    :   Color tag for a collection
        ...
        Type:
        :   enum in [Collection Color Items](../../../appendix/bpy_types_enum_items/collection_color_items.md#rna-enum-collection-color-items), default ‘COLOR\_01’
    ...
    :   How to use this collection in Line Art calculation
        ...
        * `FORCE_INTERSECTION`
        ...
        Type:
        :   enum in [‘INCLUDE’, ‘OCCLUSION\_ONLY’, ‘EXCLUDE’, ‘INTERSECTION\_ONLY’, ‘NO\_INTERSECTION’, ‘FORCE\_INTERSECTION’], default ‘INCLUDE’
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.Collection.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.Collection.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)
