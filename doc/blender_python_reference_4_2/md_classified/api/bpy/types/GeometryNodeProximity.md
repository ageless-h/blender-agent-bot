...
# GeometryNodeProximity(GeometryNode)[#](#geometrynodeproximity-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeProximity(*GeometryNode*)[#](#bpy.types.GeometryNodeProximity "Link to this definition")
:   Compute the closest location on the target geometry

    target\_element[#](#bpy.types.GeometryNodeProximity.target_element "Link to this definition")
    :   Element of the target geometry to calculate the distance from
        ...
        * `FACES`
        ...
        Type:
        :   enum in [‘POINTS’, ‘EDGES’, ‘FACES’], default ‘FACES’

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.GeometryNodeProximity.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.GeometryNodeProximity.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.GeometryNodeProximity.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.GeometryNodeProximity.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.GeometryNodeProximity.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeProximity.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.GeometryNodeProximity.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeProximity(GeometryNode)
  + [`GeometryNodeProximity`](#bpy.types.GeometryNodeProximity)
    - [`GeometryNodeProximity.target_element`](#bpy.types.GeometryNodeProximity.target_element)
    - [`GeometryNodeProximity.is_registered_node_type()`](#bpy.types.GeometryNodeProximity.is_registered_node_type)
    - [`GeometryNodeProximity.input_template()`](#bpy.types.GeometryNodeProximity.input_template)
    - [`GeometryNodeProximity.output_template()`](#bpy.types.GeometryNodeProximity.output_template)
    - [`GeometryNodeProximity.bl_rna_get_subclass()`](#bpy.types.GeometryNodeProximity.bl_rna_get_subclass)
    - [`GeometryNodeProximity.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeProximity.bl_rna_get_subclass_py)
