...
# CompositorNodeFilter(CompositorNode)[#](#compositornodefilter-compositornode "Link to this heading")
...
*class* bpy.types.CompositorNodeFilter(*CompositorNode*)[#](#bpy.types.CompositorNodeFilter "Link to this definition")
:   Apply common image enhancement filters

    filter\_type[#](#bpy.types.CompositorNodeFilter.filter_type "Link to this definition")
    :   Type:
        :   enum in [Node Filter Items](../../../appendix/bpy_types_enum_items/node_filter_items.md#rna-enum-node-filter-items), default ‘SOFTEN’

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.CompositorNodeFilter.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.CompositorNodeFilter.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.CompositorNodeFilter.output_template "Link to this definition")
    ...
    update()[#](#bpy.types.CompositorNodeFilter.update "Link to this definition")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.CompositorNodeFilter.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.CompositorNodeFilter.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CompositorNodeFilter.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.CompositorNodeFilter.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CompositorNodeFilter(CompositorNode)
  + [`CompositorNodeFilter`](#bpy.types.CompositorNodeFilter)
    - [`CompositorNodeFilter.filter_type`](#bpy.types.CompositorNodeFilter.filter_type)
    - [`CompositorNodeFilter.is_registered_node_type()`](#bpy.types.CompositorNodeFilter.is_registered_node_type)
    - [`CompositorNodeFilter.input_template()`](#bpy.types.CompositorNodeFilter.input_template)
    - [`CompositorNodeFilter.output_template()`](#bpy.types.CompositorNodeFilter.output_template)
    - [`CompositorNodeFilter.update()`](#bpy.types.CompositorNodeFilter.update)
    - [`CompositorNodeFilter.bl_rna_get_subclass()`](#bpy.types.CompositorNodeFilter.bl_rna_get_subclass)
    - [`CompositorNodeFilter.bl_rna_get_subclass_py()`](#bpy.types.CompositorNodeFilter.bl_rna_get_subclass_py)
