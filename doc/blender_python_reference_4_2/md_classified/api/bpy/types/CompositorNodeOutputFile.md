...
# CompositorNodeOutputFile(CompositorNode)[#](#compositornodeoutputfile-compositornode "Link to this heading")
...
*class* bpy.types.CompositorNodeOutputFile(*CompositorNode*)[#](#bpy.types.CompositorNodeOutputFile "Link to this definition")
:   Write image file to disk

    active\_input\_index[#](#bpy.types.CompositorNodeOutputFile.active_input_index "Link to this definition")
    :   Active input index in details view list

        Type:
        :   int in [-inf, inf], default 0

    base\_path[#](#bpy.types.CompositorNodeOutputFile.base_path "Link to this definition")
    :   Base output path for the image

        Type:
        :   string, default “”, (never None)

    file\_slots[#](#bpy.types.CompositorNodeOutputFile.file_slots "Link to this definition")
    :   Type:
        :   [`CompositorNodeOutputFileFileSlots`](CompositorNodeOutputFileFileSlots.md#bpy.types.CompositorNodeOutputFileFileSlots "bpy.types.CompositorNodeOutputFileFileSlots") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`NodeOutputFileSlotFile`](NodeOutputFileSlotFile.md#bpy.types.NodeOutputFileSlotFile "bpy.types.NodeOutputFileSlotFile"), (readonly)

    format[#](#bpy.types.CompositorNodeOutputFile.format "Link to this definition")
    :   Type:
        :   [`ImageFormatSettings`](ImageFormatSettings.md#bpy.types.ImageFormatSettings "bpy.types.ImageFormatSettings"), (readonly)

    layer\_slots[#](#bpy.types.CompositorNodeOutputFile.layer_slots "Link to this definition")
    :   Type:
        :   [`CompositorNodeOutputFileLayerSlots`](CompositorNodeOutputFileLayerSlots.md#bpy.types.CompositorNodeOutputFileLayerSlots "bpy.types.CompositorNodeOutputFileLayerSlots") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`NodeOutputFileSlotLayer`](NodeOutputFileSlotLayer.md#bpy.types.NodeOutputFileSlotLayer "bpy.types.NodeOutputFileSlotLayer"), (readonly)

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.CompositorNodeOutputFile.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.CompositorNodeOutputFile.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.CompositorNodeOutputFile.output_template "Link to this definition")
    ...
    update()[#](#bpy.types.CompositorNodeOutputFile.update "Link to this definition")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.CompositorNodeOutputFile.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.CompositorNodeOutputFile.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CompositorNodeOutputFile.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.CompositorNodeOutputFile.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CompositorNodeOutputFile(CompositorNode)
  + [`CompositorNodeOutputFile`](#bpy.types.CompositorNodeOutputFile)
    - [`CompositorNodeOutputFile.active_input_index`](#bpy.types.CompositorNodeOutputFile.active_input_index)
    - [`CompositorNodeOutputFile.base_path`](#bpy.types.CompositorNodeOutputFile.base_path)
    - [`CompositorNodeOutputFile.file_slots`](#bpy.types.CompositorNodeOutputFile.file_slots)
    - [`CompositorNodeOutputFile.format`](#bpy.types.CompositorNodeOutputFile.format)
    - [`CompositorNodeOutputFile.layer_slots`](#bpy.types.CompositorNodeOutputFile.layer_slots)
    - [`CompositorNodeOutputFile.is_registered_node_type()`](#bpy.types.CompositorNodeOutputFile.is_registered_node_type)
    - [`CompositorNodeOutputFile.input_template()`](#bpy.types.CompositorNodeOutputFile.input_template)
    - [`CompositorNodeOutputFile.output_template()`](#bpy.types.CompositorNodeOutputFile.output_template)
    - [`CompositorNodeOutputFile.update()`](#bpy.types.CompositorNodeOutputFile.update)
    - [`CompositorNodeOutputFile.bl_rna_get_subclass()`](#bpy.types.CompositorNodeOutputFile.bl_rna_get_subclass)
    - [`CompositorNodeOutputFile.bl_rna_get_subclass_py()`](#bpy.types.CompositorNodeOutputFile.bl_rna_get_subclass_py)
