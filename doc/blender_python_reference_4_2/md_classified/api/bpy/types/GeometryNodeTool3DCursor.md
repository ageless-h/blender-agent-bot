...
# GeometryNodeTool3DCursor(GeometryNode)[#](#geometrynodetool3dcursor-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeTool3DCursor(*GeometryNode*)[#](#bpy.types.GeometryNodeTool3DCursor "Link to this definition")
:   The scene’s 3D cursor location and rotation

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.GeometryNodeTool3DCursor.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.GeometryNodeTool3DCursor.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.GeometryNodeTool3DCursor.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.GeometryNodeTool3DCursor.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.GeometryNodeTool3DCursor.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeTool3DCursor.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.GeometryNodeTool3DCursor.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeTool3DCursor(GeometryNode)
  + [`GeometryNodeTool3DCursor`](#bpy.types.GeometryNodeTool3DCursor)
    - [`GeometryNodeTool3DCursor.is_registered_node_type()`](#bpy.types.GeometryNodeTool3DCursor.is_registered_node_type)
    - [`GeometryNodeTool3DCursor.input_template()`](#bpy.types.GeometryNodeTool3DCursor.input_template)
    - [`GeometryNodeTool3DCursor.output_template()`](#bpy.types.GeometryNodeTool3DCursor.output_template)
    - [`GeometryNodeTool3DCursor.bl_rna_get_subclass()`](#bpy.types.GeometryNodeTool3DCursor.bl_rna_get_subclass)
    - [`GeometryNodeTool3DCursor.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeTool3DCursor.bl_rna_get_subclass_py)
