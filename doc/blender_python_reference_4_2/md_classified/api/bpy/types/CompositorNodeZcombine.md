...
# CompositorNodeZcombine(CompositorNode)[#](#compositornodezcombine-compositornode "Link to this heading")
...
*class* bpy.types.CompositorNodeZcombine(*CompositorNode*)[#](#bpy.types.CompositorNodeZcombine "Link to this definition")
:   Combine two images using depth maps

    use\_alpha[#](#bpy.types.CompositorNodeZcombine.use_alpha "Link to this definition")
    :   Take alpha channel into account when doing the Z operation

        Type:
        :   boolean, default False

    use\_antialias\_z[#](#bpy.types.CompositorNodeZcombine.use_antialias_z "Link to this definition")
    :   Anti-alias the z-buffer to try to avoid artifacts, mostly useful for Blender renders

        Type:
        :   boolean, default False

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.CompositorNodeZcombine.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.CompositorNodeZcombine.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.CompositorNodeZcombine.output_template "Link to this definition")
    ...
    update()[#](#bpy.types.CompositorNodeZcombine.update "Link to this definition")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.CompositorNodeZcombine.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.CompositorNodeZcombine.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CompositorNodeZcombine.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.CompositorNodeZcombine.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CompositorNodeZcombine(CompositorNode)
  + [`CompositorNodeZcombine`](#bpy.types.CompositorNodeZcombine)
    - [`CompositorNodeZcombine.use_alpha`](#bpy.types.CompositorNodeZcombine.use_alpha)
    - [`CompositorNodeZcombine.use_antialias_z`](#bpy.types.CompositorNodeZcombine.use_antialias_z)
    - [`CompositorNodeZcombine.is_registered_node_type()`](#bpy.types.CompositorNodeZcombine.is_registered_node_type)
    - [`CompositorNodeZcombine.input_template()`](#bpy.types.CompositorNodeZcombine.input_template)
    - [`CompositorNodeZcombine.output_template()`](#bpy.types.CompositorNodeZcombine.output_template)
    - [`CompositorNodeZcombine.update()`](#bpy.types.CompositorNodeZcombine.update)
    - [`CompositorNodeZcombine.bl_rna_get_subclass()`](#bpy.types.CompositorNodeZcombine.bl_rna_get_subclass)
    - [`CompositorNodeZcombine.bl_rna_get_subclass_py()`](#bpy.types.CompositorNodeZcombine.bl_rna_get_subclass_py)
