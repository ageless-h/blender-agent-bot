...
|  |  |
| --- | --- |
| * [`AttributeGroup.active`](AttributeGroup.md#bpy.types.AttributeGroup.active "bpy.types.AttributeGroup.active") * [`AttributeGroup.active_color`](AttributeGroup.md#bpy.types.AttributeGroup.active_color "bpy.types.AttributeGroup.active_color") * [`AttributeGroup.new`](AttributeGroup.md#bpy.types.AttributeGroup.new "bpy.types.AttributeGroup.new") * [`AttributeGroup.remove`](AttributeGroup.md#bpy.types.AttributeGroup.remove "bpy.types.AttributeGroup.remove") * [`Curves.attributes`](Curves.md#bpy.types.Curves.attributes "bpy.types.Curves.attributes") | * [`Curves.color_attributes`](Curves.md#bpy.types.Curves.color_attributes "bpy.types.Curves.color_attributes") * [`Mesh.attributes`](Mesh.md#bpy.types.Mesh.attributes "bpy.types.Mesh.attributes") * [`Mesh.color_attributes`](Mesh.md#bpy.types.Mesh.color_attributes "bpy.types.Mesh.color_attributes") * [`PointCloud.attributes`](PointCloud.md#bpy.types.PointCloud.attributes "bpy.types.PointCloud.attributes") * [`PointCloud.color_attributes`](PointCloud.md#bpy.types.PointCloud.color_attributes "bpy.types.PointCloud.color_attributes") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.Attribute.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.Attribute.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)
