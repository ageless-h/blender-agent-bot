...
# GeometryNodeToolSetSelection(GeometryNode)[#](#geometrynodetoolsetselection-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeToolSetSelection(*GeometryNode*)[#](#bpy.types.GeometryNodeToolSetSelection "Link to this definition")
:   Set selection of the edited geometry, for tool execution

    domain[#](#bpy.types.GeometryNodeToolSetSelection.domain "Link to this definition")
    :   Type:
        :   enum in [Attribute Domain Point Edge Face Curve Items](../../../appendix/bpy_types_enum_items/attribute_domain_point_edge_face_curve_items.md#rna-enum-attribute-domain-point-edge-face-curve-items), default ‘POINT’

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.GeometryNodeToolSetSelection.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.GeometryNodeToolSetSelection.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.GeometryNodeToolSetSelection.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.GeometryNodeToolSetSelection.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.GeometryNodeToolSetSelection.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeToolSetSelection.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.GeometryNodeToolSetSelection.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeToolSetSelection(GeometryNode)
  + [`GeometryNodeToolSetSelection`](#bpy.types.GeometryNodeToolSetSelection)
    - [`GeometryNodeToolSetSelection.domain`](#bpy.types.GeometryNodeToolSetSelection.domain)
    - [`GeometryNodeToolSetSelection.is_registered_node_type()`](#bpy.types.GeometryNodeToolSetSelection.is_registered_node_type)
    - [`GeometryNodeToolSetSelection.input_template()`](#bpy.types.GeometryNodeToolSetSelection.input_template)
    - [`GeometryNodeToolSetSelection.output_template()`](#bpy.types.GeometryNodeToolSetSelection.output_template)
    - [`GeometryNodeToolSetSelection.bl_rna_get_subclass()`](#bpy.types.GeometryNodeToolSetSelection.bl_rna_get_subclass)
    - [`GeometryNodeToolSetSelection.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeToolSetSelection.bl_rna_get_subclass_py)
