...
# TextureNodeGroup(TextureNode)[#](#texturenodegroup-texturenode "Link to this heading")
...
*class* bpy.types.TextureNodeGroup(*TextureNode*)[#](#bpy.types.TextureNodeGroup "Link to this definition")
:   node\_tree[#](#bpy.types.TextureNodeGroup.node_tree "Link to this definition")
    :   Type:
        :   [`NodeTree`](NodeTree.md#bpy.types.NodeTree "bpy.types.NodeTree")

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.TextureNodeGroup.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.TextureNodeGroup.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.TextureNodeGroup.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.TextureNodeGroup.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.TextureNodeGroup.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.TextureNodeGroup.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.TextureNodeGroup.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* TextureNodeGroup(TextureNode)
  + [`TextureNodeGroup`](#bpy.types.TextureNodeGroup)
    - [`TextureNodeGroup.node_tree`](#bpy.types.TextureNodeGroup.node_tree)
    - [`TextureNodeGroup.is_registered_node_type()`](#bpy.types.TextureNodeGroup.is_registered_node_type)
    - [`TextureNodeGroup.input_template()`](#bpy.types.TextureNodeGroup.input_template)
    - [`TextureNodeGroup.output_template()`](#bpy.types.TextureNodeGroup.output_template)
    - [`TextureNodeGroup.bl_rna_get_subclass()`](#bpy.types.TextureNodeGroup.bl_rna_get_subclass)
    - [`TextureNodeGroup.bl_rna_get_subclass_py()`](#bpy.types.TextureNodeGroup.bl_rna_get_subclass_py)
