...
:   Settings for stereo output
    ...
    :   Type:
        :   enum in [Stereo3D Anaglyph Type Items](../../../appendix/bpy_types_enum_items/stereo3d_anaglyph_type_items.md#rna-enum-stereo3d-anaglyph-type-items), default ‘RED\_CYAN’
    ...
    :   Type:
        :   enum in [Stereo3D Interlace Type Items](../../../appendix/bpy_types_enum_items/stereo3d_interlace_type_items.md#rna-enum-stereo3d-interlace-type-items), default ‘ROW\_INTERLEAVED’
...
|  |  |
| --- | --- |
| * [`Image.stereo_3d_format`](Image.md#bpy.types.Image.stereo_3d_format "bpy.types.Image.stereo_3d_format") * [`ImageSequence.stereo_3d_format`](ImageSequence.md#bpy.types.ImageSequence.stereo_3d_format "bpy.types.ImageSequence.stereo_3d_format") * [`MovieSequence.stereo_3d_format`](MovieSequence.md#bpy.types.MovieSequence.stereo_3d_format "bpy.types.MovieSequence.stereo_3d_format") | * [`ImageFormatSettings.stereo_3d_format`](ImageFormatSettings.md#bpy.types.ImageFormatSettings.stereo_3d_format "bpy.types.ImageFormatSettings.stereo_3d_format") * [`UILayout.template_image_stereo_3d`](UILayout.md#bpy.types.UILayout.template_image_stereo_3d "bpy.types.UILayout.template_image_stereo_3d") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.Stereo3dFormat.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.Stereo3dFormat.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)
