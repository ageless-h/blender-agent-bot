...
# AssetHandle(PropertyGroup)[#](#assethandle-propertygroup "Link to this heading")
...
*class* bpy.types.AssetHandle(*PropertyGroup*)[#](#bpy.types.AssetHandle "Link to this definition")
:   Reference to some asset

    file\_data[#](#bpy.types.AssetHandle.file_data "Link to this definition")
    :   TEMPORARY, DO NOT USE - File data used to refer to the asset

        Type:
        :   [`FileSelectEntry`](FileSelectEntry.md#bpy.types.FileSelectEntry "bpy.types.FileSelectEntry")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.AssetHandle.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.AssetHandle.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`WindowManager.pose_assets`](WindowManager.md#bpy.types.WindowManager.pose_assets "bpy.types.WindowManager.pose_assets") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.AssetHandle.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.AssetHandle.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* AssetHandle(PropertyGroup)
  + [`AssetHandle`](#bpy.types.AssetHandle)
    - [`AssetHandle.file_data`](#bpy.types.AssetHandle.file_data)
    - [`AssetHandle.bl_rna_get_subclass()`](#bpy.types.AssetHandle.bl_rna_get_subclass)
    - [`AssetHandle.bl_rna_get_subclass_py()`](#bpy.types.AssetHandle.bl_rna_get_subclass_py)
