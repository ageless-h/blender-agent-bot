...
# CompositorNodeAntiAliasing(CompositorNode)[#](#compositornodeantialiasing-compositornode "Link to this heading")
...
*class* bpy.types.CompositorNodeAntiAliasing(*CompositorNode*)[#](#bpy.types.CompositorNodeAntiAliasing "Link to this definition")
:   Smooth away jagged edges

    contrast\_limit[#](#bpy.types.CompositorNodeAntiAliasing.contrast_limit "Link to this definition")
    ...
    corner\_rounding[#](#bpy.types.CompositorNodeAntiAliasing.corner_rounding "Link to this definition")
    :   How much sharp corners will be rounded

        Type:
        :   float in [0, 1], default 0.0

    threshold[#](#bpy.types.CompositorNodeAntiAliasing.threshold "Link to this definition")
    :   Threshold to detect edges (smaller threshold makes more sensitive detection)

        Type:
        :   float in [0, 1], default 0.0

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.CompositorNodeAntiAliasing.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.CompositorNodeAntiAliasing.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.CompositorNodeAntiAliasing.output_template "Link to this definition")
    ...
    update()[#](#bpy.types.CompositorNodeAntiAliasing.update "Link to this definition")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.CompositorNodeAntiAliasing.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.CompositorNodeAntiAliasing.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CompositorNodeAntiAliasing.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.CompositorNodeAntiAliasing.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CompositorNodeAntiAliasing(CompositorNode)
  + [`CompositorNodeAntiAliasing`](#bpy.types.CompositorNodeAntiAliasing)
    - [`CompositorNodeAntiAliasing.contrast_limit`](#bpy.types.CompositorNodeAntiAliasing.contrast_limit)
    - [`CompositorNodeAntiAliasing.corner_rounding`](#bpy.types.CompositorNodeAntiAliasing.corner_rounding)
    - [`CompositorNodeAntiAliasing.threshold`](#bpy.types.CompositorNodeAntiAliasing.threshold)
    - [`CompositorNodeAntiAliasing.is_registered_node_type()`](#bpy.types.CompositorNodeAntiAliasing.is_registered_node_type)
    - [`CompositorNodeAntiAliasing.input_template()`](#bpy.types.CompositorNodeAntiAliasing.input_template)
    - [`CompositorNodeAntiAliasing.output_template()`](#bpy.types.CompositorNodeAntiAliasing.output_template)
    - [`CompositorNodeAntiAliasing.update()`](#bpy.types.CompositorNodeAntiAliasing.update)
    - [`CompositorNodeAntiAliasing.bl_rna_get_subclass()`](#bpy.types.CompositorNodeAntiAliasing.bl_rna_get_subclass)
    - [`CompositorNodeAntiAliasing.bl_rna_get_subclass_py()`](#bpy.types.CompositorNodeAntiAliasing.bl_rna_get_subclass_py)
