...
# GeometryNodeTriangulate(GeometryNode)[#](#geometrynodetriangulate-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeTriangulate(*GeometryNode*)[#](#bpy.types.GeometryNodeTriangulate "Link to this definition")
:   Convert all faces in a mesh to triangular faces

    ngon\_method[#](#bpy.types.GeometryNodeTriangulate.ngon_method "Link to this definition")
    :   Method for splitting the n-gons into triangles
        ...
        * `CLIP`
        ...
        Type:
        :   enum in [‘BEAUTY’, ‘CLIP’], default ‘BEAUTY’

    quad\_method[#](#bpy.types.GeometryNodeTriangulate.quad_method "Link to this definition")
    :   Method for splitting the quads into triangles
        ...
        * `LONGEST_DIAGONAL`
        ...
        Type:
        :   enum in [‘BEAUTY’, ‘FIXED’, ‘FIXED\_ALTERNATE’, ‘SHORTEST\_DIAGONAL’, ‘LONGEST\_DIAGONAL’], default ‘BEAUTY’

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.GeometryNodeTriangulate.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.GeometryNodeTriangulate.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.GeometryNodeTriangulate.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.GeometryNodeTriangulate.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.GeometryNodeTriangulate.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeTriangulate.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.GeometryNodeTriangulate.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeTriangulate(GeometryNode)
  + [`GeometryNodeTriangulate`](#bpy.types.GeometryNodeTriangulate)
    - [`GeometryNodeTriangulate.ngon_method`](#bpy.types.GeometryNodeTriangulate.ngon_method)
    - [`GeometryNodeTriangulate.quad_method`](#bpy.types.GeometryNodeTriangulate.quad_method)
    - [`GeometryNodeTriangulate.is_registered_node_type()`](#bpy.types.GeometryNodeTriangulate.is_registered_node_type)
    - [`GeometryNodeTriangulate.input_template()`](#bpy.types.GeometryNodeTriangulate.input_template)
    - [`GeometryNodeTriangulate.output_template()`](#bpy.types.GeometryNodeTriangulate.output_template)
    - [`GeometryNodeTriangulate.bl_rna_get_subclass()`](#bpy.types.GeometryNodeTriangulate.bl_rna_get_subclass)
    - [`GeometryNodeTriangulate.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeTriangulate.bl_rna_get_subclass_py)
