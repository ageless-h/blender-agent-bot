...
# CompositorNodePixelate(CompositorNode)[#](#compositornodepixelate-compositornode "Link to this heading")
...
*class* bpy.types.CompositorNodePixelate(*CompositorNode*)[#](#bpy.types.CompositorNodePixelate "Link to this definition")
:   Reduce detail in an image by making individual pixels more prominent, for a blocky or mosaic-like appearance

    pixel\_size[#](#bpy.types.CompositorNodePixelate.pixel_size "Link to this definition")
    :   Pixel size of the output image

        Type:
        :   int in [1, 2048], default 1

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.CompositorNodePixelate.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.CompositorNodePixelate.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.CompositorNodePixelate.output_template "Link to this definition")
    ...
    update()[#](#bpy.types.CompositorNodePixelate.update "Link to this definition")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.CompositorNodePixelate.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.CompositorNodePixelate.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CompositorNodePixelate.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.CompositorNodePixelate.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CompositorNodePixelate(CompositorNode)
  + [`CompositorNodePixelate`](#bpy.types.CompositorNodePixelate)
    - [`CompositorNodePixelate.pixel_size`](#bpy.types.CompositorNodePixelate.pixel_size)
    - [`CompositorNodePixelate.is_registered_node_type()`](#bpy.types.CompositorNodePixelate.is_registered_node_type)
    - [`CompositorNodePixelate.input_template()`](#bpy.types.CompositorNodePixelate.input_template)
    - [`CompositorNodePixelate.output_template()`](#bpy.types.CompositorNodePixelate.output_template)
    - [`CompositorNodePixelate.update()`](#bpy.types.CompositorNodePixelate.update)
    - [`CompositorNodePixelate.bl_rna_get_subclass()`](#bpy.types.CompositorNodePixelate.bl_rna_get_subclass)
    - [`CompositorNodePixelate.bl_rna_get_subclass_py()`](#bpy.types.CompositorNodePixelate.bl_rna_get_subclass_py)
