...
# GeometryNodeDuplicateElements(GeometryNode)[#](#geometrynodeduplicateelements-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeDuplicateElements(*GeometryNode*)[#](#bpy.types.GeometryNodeDuplicateElements "Link to this definition")
:   Generate an arbitrary number copies of each selected input element

    domain[#](#bpy.types.GeometryNodeDuplicateElements.domain "Link to this definition")
    :   Which domain to duplicate

        Type:
        :   enum in [‘POINT’, ‘EDGE’, ‘FACE’, ‘SPLINE’, ‘INSTANCE’], default ‘POINT’

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.GeometryNodeDuplicateElements.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.GeometryNodeDuplicateElements.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.GeometryNodeDuplicateElements.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.GeometryNodeDuplicateElements.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.GeometryNodeDuplicateElements.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeDuplicateElements.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.GeometryNodeDuplicateElements.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeDuplicateElements(GeometryNode)
  + [`GeometryNodeDuplicateElements`](#bpy.types.GeometryNodeDuplicateElements)
    - [`GeometryNodeDuplicateElements.domain`](#bpy.types.GeometryNodeDuplicateElements.domain)
    - [`GeometryNodeDuplicateElements.is_registered_node_type()`](#bpy.types.GeometryNodeDuplicateElements.is_registered_node_type)
    - [`GeometryNodeDuplicateElements.input_template()`](#bpy.types.GeometryNodeDuplicateElements.input_template)
    - [`GeometryNodeDuplicateElements.output_template()`](#bpy.types.GeometryNodeDuplicateElements.output_template)
    - [`GeometryNodeDuplicateElements.bl_rna_get_subclass()`](#bpy.types.GeometryNodeDuplicateElements.bl_rna_get_subclass)
    - [`GeometryNodeDuplicateElements.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeDuplicateElements.bl_rna_get_subclass_py)
