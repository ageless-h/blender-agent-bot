...
# ShaderNodeTexChecker(ShaderNode)[#](#shadernodetexchecker-shadernode "Link to this heading")
...
*class* bpy.types.ShaderNodeTexChecker(*ShaderNode*)[#](#bpy.types.ShaderNodeTexChecker "Link to this definition")
:   Generate a checkerboard texture

    color\_mapping[#](#bpy.types.ShaderNodeTexChecker.color_mapping "Link to this definition")
    :   Color mapping settings

        Type:
        :   [`ColorMapping`](ColorMapping.md#bpy.types.ColorMapping "bpy.types.ColorMapping"), (readonly, never None)

    texture\_mapping[#](#bpy.types.ShaderNodeTexChecker.texture_mapping "Link to this definition")
    :   Texture coordinate mapping settings

        Type:
        :   [`TexMapping`](TexMapping.md#bpy.types.TexMapping "bpy.types.TexMapping"), (readonly, never None)

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.ShaderNodeTexChecker.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.ShaderNodeTexChecker.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.ShaderNodeTexChecker.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.ShaderNodeTexChecker.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.ShaderNodeTexChecker.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ShaderNodeTexChecker.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.ShaderNodeTexChecker.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ShaderNodeTexChecker(ShaderNode)
  + [`ShaderNodeTexChecker`](#bpy.types.ShaderNodeTexChecker)
    - [`ShaderNodeTexChecker.color_mapping`](#bpy.types.ShaderNodeTexChecker.color_mapping)
    - [`ShaderNodeTexChecker.texture_mapping`](#bpy.types.ShaderNodeTexChecker.texture_mapping)
    - [`ShaderNodeTexChecker.is_registered_node_type()`](#bpy.types.ShaderNodeTexChecker.is_registered_node_type)
    - [`ShaderNodeTexChecker.input_template()`](#bpy.types.ShaderNodeTexChecker.input_template)
    - [`ShaderNodeTexChecker.output_template()`](#bpy.types.ShaderNodeTexChecker.output_template)
    - [`ShaderNodeTexChecker.bl_rna_get_subclass()`](#bpy.types.ShaderNodeTexChecker.bl_rna_get_subclass)
    - [`ShaderNodeTexChecker.bl_rna_get_subclass_py()`](#bpy.types.ShaderNodeTexChecker.bl_rna_get_subclass_py)
