...
# CompositorNodeMask(CompositorNode)[#](#compositornodemask-compositornode "Link to this heading")
...
*class* bpy.types.CompositorNodeMask(*CompositorNode*)[#](#bpy.types.CompositorNodeMask "Link to this definition")
:   Input mask from a mask datablock, created in the image editor

    mask[#](#bpy.types.CompositorNodeMask.mask "Link to this definition")
    :   Type:
        :   [`Mask`](Mask.md#bpy.types.Mask "bpy.types.Mask")

    motion\_blur\_samples[#](#bpy.types.CompositorNodeMask.motion_blur_samples "Link to this definition")
    :   Number of motion blur samples

        Type:
        :   int in [1, 64], default 0

    motion\_blur\_shutter[#](#bpy.types.CompositorNodeMask.motion_blur_shutter "Link to this definition")
    :   Exposure for motion blur as a factor of FPS

        Type:
        :   float in [0, 1], default 0.0

    size\_source[#](#bpy.types.CompositorNodeMask.size_source "Link to this definition")
    :   Where to get the mask size from for aspect/size information
        ...
        * `FIXED_SCENE`
        ...
        Type:
        :   enum in [‘SCENE’, ‘FIXED’, ‘FIXED\_SCENE’], default ‘SCENE’

    size\_x[#](#bpy.types.CompositorNodeMask.size_x "Link to this definition")
    :   Type:
        :   int in [1, 10000], default 0

    size\_y[#](#bpy.types.CompositorNodeMask.size_y "Link to this definition")
    :   Type:
        :   int in [1, 10000], default 0

    use\_feather[#](#bpy.types.CompositorNodeMask.use_feather "Link to this definition")
    :   Use feather information from the mask

        Type:
        :   boolean, default False

    use\_motion\_blur[#](#bpy.types.CompositorNodeMask.use_motion_blur "Link to this definition")
    :   Use multi-sampled motion blur of the mask

        Type:
        :   boolean, default False

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.CompositorNodeMask.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.CompositorNodeMask.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.CompositorNodeMask.output_template "Link to this definition")
    ...
    update()[#](#bpy.types.CompositorNodeMask.update "Link to this definition")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.CompositorNodeMask.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.CompositorNodeMask.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CompositorNodeMask.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.CompositorNodeMask.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CompositorNodeMask(CompositorNode)
  + [`CompositorNodeMask`](#bpy.types.CompositorNodeMask)
    - [`CompositorNodeMask.mask`](#bpy.types.CompositorNodeMask.mask)
    - [`CompositorNodeMask.motion_blur_samples`](#bpy.types.CompositorNodeMask.motion_blur_samples)
    - [`CompositorNodeMask.motion_blur_shutter`](#bpy.types.CompositorNodeMask.motion_blur_shutter)
    - [`CompositorNodeMask.size_source`](#bpy.types.CompositorNodeMask.size_source)
    - [`CompositorNodeMask.size_x`](#bpy.types.CompositorNodeMask.size_x)
    - [`CompositorNodeMask.size_y`](#bpy.types.CompositorNodeMask.size_y)
    - [`CompositorNodeMask.use_feather`](#bpy.types.CompositorNodeMask.use_feather)
    - [`CompositorNodeMask.use_motion_blur`](#bpy.types.CompositorNodeMask.use_motion_blur)
    - [`CompositorNodeMask.is_registered_node_type()`](#bpy.types.CompositorNodeMask.is_registered_node_type)
    - [`CompositorNodeMask.input_template()`](#bpy.types.CompositorNodeMask.input_template)
    - [`CompositorNodeMask.output_template()`](#bpy.types.CompositorNodeMask.output_template)
    - [`CompositorNodeMask.update()`](#bpy.types.CompositorNodeMask.update)
    - [`CompositorNodeMask.bl_rna_get_subclass()`](#bpy.types.CompositorNodeMask.bl_rna_get_subclass)
    - [`CompositorNodeMask.bl_rna_get_subclass_py()`](#bpy.types.CompositorNodeMask.bl_rna_get_subclass_py)
