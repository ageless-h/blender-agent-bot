...
# GeometryNodeSetShadeSmooth(GeometryNode)[#](#geometrynodesetshadesmooth-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeSetShadeSmooth(*GeometryNode*)[#](#bpy.types.GeometryNodeSetShadeSmooth "Link to this definition")
:   Control the smoothness of mesh normals around each face by changing the “shade smooth” attribute

    domain[#](#bpy.types.GeometryNodeSetShadeSmooth.domain "Link to this definition")
    :   Type:
        :   enum in [Attribute Domain Edge Face Items](../../../appendix/bpy_types_enum_items/attribute_domain_edge_face_items.md#rna-enum-attribute-domain-edge-face-items), default ‘EDGE’

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.GeometryNodeSetShadeSmooth.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.GeometryNodeSetShadeSmooth.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.GeometryNodeSetShadeSmooth.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.GeometryNodeSetShadeSmooth.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.GeometryNodeSetShadeSmooth.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeSetShadeSmooth.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.GeometryNodeSetShadeSmooth.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeSetShadeSmooth(GeometryNode)
  + [`GeometryNodeSetShadeSmooth`](#bpy.types.GeometryNodeSetShadeSmooth)
    - [`GeometryNodeSetShadeSmooth.domain`](#bpy.types.GeometryNodeSetShadeSmooth.domain)
    - [`GeometryNodeSetShadeSmooth.is_registered_node_type()`](#bpy.types.GeometryNodeSetShadeSmooth.is_registered_node_type)
    - [`GeometryNodeSetShadeSmooth.input_template()`](#bpy.types.GeometryNodeSetShadeSmooth.input_template)
    - [`GeometryNodeSetShadeSmooth.output_template()`](#bpy.types.GeometryNodeSetShadeSmooth.output_template)
    - [`GeometryNodeSetShadeSmooth.bl_rna_get_subclass()`](#bpy.types.GeometryNodeSetShadeSmooth.bl_rna_get_subclass)
    - [`GeometryNodeSetShadeSmooth.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeSetShadeSmooth.bl_rna_get_subclass_py)
