...
# ShaderNodeWireframe(ShaderNode)[#](#shadernodewireframe-shadernode "Link to this heading")
...
*class* bpy.types.ShaderNodeWireframe(*ShaderNode*)[#](#bpy.types.ShaderNodeWireframe "Link to this definition")
:   Retrieve the edges of an object as it appears to Cycles.
    ...
    use\_pixel\_size[#](#bpy.types.ShaderNodeWireframe.use_pixel_size "Link to this definition")
    :   Use screen pixel size instead of world units

        Type:
        :   boolean, default False

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.ShaderNodeWireframe.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.ShaderNodeWireframe.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.ShaderNodeWireframe.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.ShaderNodeWireframe.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.ShaderNodeWireframe.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ShaderNodeWireframe.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.ShaderNodeWireframe.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ShaderNodeWireframe(ShaderNode)
  + [`ShaderNodeWireframe`](#bpy.types.ShaderNodeWireframe)
    - [`ShaderNodeWireframe.use_pixel_size`](#bpy.types.ShaderNodeWireframe.use_pixel_size)
    - [`ShaderNodeWireframe.is_registered_node_type()`](#bpy.types.ShaderNodeWireframe.is_registered_node_type)
    - [`ShaderNodeWireframe.input_template()`](#bpy.types.ShaderNodeWireframe.input_template)
    - [`ShaderNodeWireframe.output_template()`](#bpy.types.ShaderNodeWireframe.output_template)
    - [`ShaderNodeWireframe.bl_rna_get_subclass()`](#bpy.types.ShaderNodeWireframe.bl_rna_get_subclass)
    - [`ShaderNodeWireframe.bl_rna_get_subclass_py()`](#bpy.types.ShaderNodeWireframe.bl_rna_get_subclass_py)
