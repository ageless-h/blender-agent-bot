...
# ShaderNodeTexSky(ShaderNode)[#](#shadernodetexsky-shadernode "Link to this heading")

base classes — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct"), [`Node`](Node.md#bpy.types.Node "bpy.types.Node"), [`NodeInternal`](NodeInternal.md#bpy.types.NodeInternal "bpy.types.NodeInternal"), [`ShaderNode`](ShaderNode.md#bpy.types.ShaderNode "bpy.types.ShaderNode")

*class* bpy.types.ShaderNodeTexSky(*ShaderNode*)[#](#bpy.types.ShaderNodeTexSky "Link to this definition")
:   Generate a procedural sky texture

    air\_density[#](#bpy.types.ShaderNodeTexSky.air_density "Link to this definition")
    :   Density of air molecules

        Type:
        :   float in [0, 10], default 1.0

    altitude[#](#bpy.types.ShaderNodeTexSky.altitude "Link to this definition")
    :   Height from sea level

        Type:
        :   float in [0, 60000], default 0.0

    color\_mapping[#](#bpy.types.ShaderNodeTexSky.color_mapping "Link to this definition")
    :   Color mapping settings

        Type:
        :   [`ColorMapping`](ColorMapping.md#bpy.types.ColorMapping "bpy.types.ColorMapping"), (readonly, never None)

    dust\_density[#](#bpy.types.ShaderNodeTexSky.dust_density "Link to this definition")
    :   Density of dust molecules and water droplets

        Type:
        :   float in [0, 10], default 1.0

    ground\_albedo[#](#bpy.types.ShaderNodeTexSky.ground_albedo "Link to this definition")
    :   Ground color that is subtly reflected in the sky

        Type:
        :   float in [0, 1], default 0.0

    ozone\_density[#](#bpy.types.ShaderNodeTexSky.ozone_density "Link to this definition")
    :   Density of ozone layer

        Type:
        :   float in [0, 10], default 1.0

    sky\_type[#](#bpy.types.ShaderNodeTexSky.sky_type "Link to this definition")
    :   Which sky model should be used
        ...
        * `NISHITA`
        ...
        Type:
        :   enum in [‘PREETHAM’, ‘HOSEK\_WILKIE’, ‘NISHITA’], default ‘PREETHAM’

    sun\_direction[#](#bpy.types.ShaderNodeTexSky.sun_direction "Link to this definition")
    :   Direction from where the sun is shining

        Type:
        :   [`mathutils.Vector`](../../mathutils/index.md#mathutils.Vector "mathutils.Vector") of 3 items in [-inf, inf], default (0.0, 0.0, 1.0)

    sun\_disc[#](#bpy.types.ShaderNodeTexSky.sun_disc "Link to this definition")
    :   Include the sun itself in the output

        Type:
        :   boolean, default True

    sun\_elevation[#](#bpy.types.ShaderNodeTexSky.sun_elevation "Link to this definition")
    :   Sun angle from horizon

        Type:
        :   float in [-inf, inf], default 1.5708

    sun\_intensity[#](#bpy.types.ShaderNodeTexSky.sun_intensity "Link to this definition")
    :   Strength of sun

        Type:
        :   float in [0, 1000], default 1.0

    sun\_rotation[#](#bpy.types.ShaderNodeTexSky.sun_rotation "Link to this definition")
    :   Rotation of sun around zenith

        Type:
        :   float in [-inf, inf], default 0.0

    sun\_size[#](#bpy.types.ShaderNodeTexSky.sun_size "Link to this definition")
    :   Size of sun disc

        Type:
        :   float in [0, 1.5708], default 0.00951204

    texture\_mapping[#](#bpy.types.ShaderNodeTexSky.texture_mapping "Link to this definition")
    :   Texture coordinate mapping settings

        Type:
        :   [`TexMapping`](TexMapping.md#bpy.types.TexMapping "bpy.types.TexMapping"), (readonly, never None)

    turbidity[#](#bpy.types.ShaderNodeTexSky.turbidity "Link to this definition")
    :   Atmospheric turbidity

        Type:
        :   float in [1, 10], default 0.0

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.ShaderNodeTexSky.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.ShaderNodeTexSky.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.ShaderNodeTexSky.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.ShaderNodeTexSky.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.ShaderNodeTexSky.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ShaderNodeTexSky.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.ShaderNodeTexSky.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ShaderNodeTexSky(ShaderNode)
  + [`ShaderNodeTexSky`](#bpy.types.ShaderNodeTexSky)
    - [`ShaderNodeTexSky.air_density`](#bpy.types.ShaderNodeTexSky.air_density)
    - [`ShaderNodeTexSky.altitude`](#bpy.types.ShaderNodeTexSky.altitude)
    - [`ShaderNodeTexSky.color_mapping`](#bpy.types.ShaderNodeTexSky.color_mapping)
    - [`ShaderNodeTexSky.dust_density`](#bpy.types.ShaderNodeTexSky.dust_density)
    - [`ShaderNodeTexSky.ground_albedo`](#bpy.types.ShaderNodeTexSky.ground_albedo)
    - [`ShaderNodeTexSky.ozone_density`](#bpy.types.ShaderNodeTexSky.ozone_density)
    - [`ShaderNodeTexSky.sky_type`](#bpy.types.ShaderNodeTexSky.sky_type)
    - [`ShaderNodeTexSky.sun_direction`](#bpy.types.ShaderNodeTexSky.sun_direction)
    - [`ShaderNodeTexSky.sun_disc`](#bpy.types.ShaderNodeTexSky.sun_disc)
    - [`ShaderNodeTexSky.sun_elevation`](#bpy.types.ShaderNodeTexSky.sun_elevation)
    - [`ShaderNodeTexSky.sun_intensity`](#bpy.types.ShaderNodeTexSky.sun_intensity)
    - [`ShaderNodeTexSky.sun_rotation`](#bpy.types.ShaderNodeTexSky.sun_rotation)
    - [`ShaderNodeTexSky.sun_size`](#bpy.types.ShaderNodeTexSky.sun_size)
    - [`ShaderNodeTexSky.texture_mapping`](#bpy.types.ShaderNodeTexSky.texture_mapping)
    - [`ShaderNodeTexSky.turbidity`](#bpy.types.ShaderNodeTexSky.turbidity)
    - [`ShaderNodeTexSky.is_registered_node_type()`](#bpy.types.ShaderNodeTexSky.is_registered_node_type)
    - [`ShaderNodeTexSky.input_template()`](#bpy.types.ShaderNodeTexSky.input_template)
    - [`ShaderNodeTexSky.output_template()`](#bpy.types.ShaderNodeTexSky.output_template)
    - [`ShaderNodeTexSky.bl_rna_get_subclass()`](#bpy.types.ShaderNodeTexSky.bl_rna_get_subclass)
    - [`ShaderNodeTexSky.bl_rna_get_subclass_py()`](#bpy.types.ShaderNodeTexSky.bl_rna_get_subclass_py)
