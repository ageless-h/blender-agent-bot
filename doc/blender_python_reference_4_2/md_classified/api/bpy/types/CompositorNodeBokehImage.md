...
# CompositorNodeBokehImage(CompositorNode)[#](#compositornodebokehimage-compositornode "Link to this heading")
...
*class* bpy.types.CompositorNodeBokehImage(*CompositorNode*)[#](#bpy.types.CompositorNodeBokehImage "Link to this definition")
:   Generate image with bokeh shape for use with the Bokeh Blur filter node

    angle[#](#bpy.types.CompositorNodeBokehImage.angle "Link to this definition")
    :   Angle of the bokeh

        Type:
        :   float in [-12.5664, 12.5664], default 0.0

    catadioptric[#](#bpy.types.CompositorNodeBokehImage.catadioptric "Link to this definition")
    :   Level of catadioptric of the bokeh

        Type:
        :   float in [-0, 1], default 0.0

    flaps[#](#bpy.types.CompositorNodeBokehImage.flaps "Link to this definition")
    :   Number of flaps

        Type:
        :   int in [3, 24], default 5

    rounding[#](#bpy.types.CompositorNodeBokehImage.rounding "Link to this definition")
    :   Level of rounding of the bokeh

        Type:
        :   float in [-0, 1], default 0.0

    shift[#](#bpy.types.CompositorNodeBokehImage.shift "Link to this definition")
    :   Shift of the lens components

        Type:
        :   float in [-1, 1], default 0.0

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.CompositorNodeBokehImage.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.CompositorNodeBokehImage.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.CompositorNodeBokehImage.output_template "Link to this definition")
    ...
    update()[#](#bpy.types.CompositorNodeBokehImage.update "Link to this definition")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.CompositorNodeBokehImage.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.CompositorNodeBokehImage.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CompositorNodeBokehImage.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.CompositorNodeBokehImage.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CompositorNodeBokehImage(CompositorNode)
  + [`CompositorNodeBokehImage`](#bpy.types.CompositorNodeBokehImage)
    - [`CompositorNodeBokehImage.angle`](#bpy.types.CompositorNodeBokehImage.angle)
    - [`CompositorNodeBokehImage.catadioptric`](#bpy.types.CompositorNodeBokehImage.catadioptric)
    - [`CompositorNodeBokehImage.flaps`](#bpy.types.CompositorNodeBokehImage.flaps)
    - [`CompositorNodeBokehImage.rounding`](#bpy.types.CompositorNodeBokehImage.rounding)
    - [`CompositorNodeBokehImage.shift`](#bpy.types.CompositorNodeBokehImage.shift)
    - [`CompositorNodeBokehImage.is_registered_node_type()`](#bpy.types.CompositorNodeBokehImage.is_registered_node_type)
    - [`CompositorNodeBokehImage.input_template()`](#bpy.types.CompositorNodeBokehImage.input_template)
    - [`CompositorNodeBokehImage.output_template()`](#bpy.types.CompositorNodeBokehImage.output_template)
    - [`CompositorNodeBokehImage.update()`](#bpy.types.CompositorNodeBokehImage.update)
    - [`CompositorNodeBokehImage.bl_rna_get_subclass()`](#bpy.types.CompositorNodeBokehImage.bl_rna_get_subclass)
    - [`CompositorNodeBokehImage.bl_rna_get_subclass_py()`](#bpy.types.CompositorNodeBokehImage.bl_rna_get_subclass_py)
