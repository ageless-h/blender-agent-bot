...
# TextureNode(NodeInternal)[#](#texturenode-nodeinternal "Link to this heading")
...
subclasses —
[`TextureNodeAt`](TextureNodeAt.md#bpy.types.TextureNodeAt "bpy.types.TextureNodeAt"), [`TextureNodeBricks`](TextureNodeBricks.md#bpy.types.TextureNodeBricks "bpy.types.TextureNodeBricks"), [`TextureNodeChecker`](TextureNodeChecker.md#bpy.types.TextureNodeChecker "bpy.types.TextureNodeChecker"), [`TextureNodeCombineColor`](TextureNodeCombineColor.md#bpy.types.TextureNodeCombineColor "bpy.types.TextureNodeCombineColor"), [`TextureNodeCompose`](TextureNodeCompose.md#bpy.types.TextureNodeCompose "bpy.types.TextureNodeCompose"), [`TextureNodeCoordinates`](TextureNodeCoordinates.md#bpy.types.TextureNodeCoordinates "bpy.types.TextureNodeCoordinates"), [`TextureNodeCurveRGB`](TextureNodeCurveRGB.md#bpy.types.TextureNodeCurveRGB "bpy.types.TextureNodeCurveRGB"), [`TextureNodeCurveTime`](TextureNodeCurveTime.md#bpy.types.TextureNodeCurveTime "bpy.types.TextureNodeCurveTime"), [`TextureNodeDecompose`](TextureNodeDecompose.md#bpy.types.TextureNodeDecompose "bpy.types.TextureNodeDecompose"), [`TextureNodeDistance`](TextureNodeDistance.md#bpy.types.TextureNodeDistance "bpy.types.TextureNodeDistance"), [`TextureNodeGroup`](TextureNodeGroup.md#bpy.types.TextureNodeGroup "bpy.types.TextureNodeGroup"), [`TextureNodeHueSaturation`](TextureNodeHueSaturation.md#bpy.types.TextureNodeHueSaturation "bpy.types.TextureNodeHueSaturation"), [`TextureNodeImage`](TextureNodeImage.md#bpy.types.TextureNodeImage "bpy.types.TextureNodeImage"), [`TextureNodeInvert`](TextureNodeInvert.md#bpy.types.TextureNodeInvert "bpy.types.TextureNodeInvert"), [`TextureNodeMath`](TextureNodeMath.md#bpy.types.TextureNodeMath "bpy.types.TextureNodeMath"), [`TextureNodeMixRGB`](TextureNodeMixRGB.md#bpy.types.TextureNodeMixRGB "bpy.types.TextureNodeMixRGB"), [`TextureNodeOutput`](TextureNodeOutput.md#bpy.types.TextureNodeOutput "bpy.types.TextureNodeOutput"), [`TextureNodeRGBToBW`](TextureNodeRGBToBW.md#bpy.types.TextureNodeRGBToBW "bpy.types.TextureNodeRGBToBW"), [`TextureNodeRotate`](TextureNodeRotate.md#bpy.types.TextureNodeRotate "bpy.types.TextureNodeRotate"), [`TextureNodeScale`](TextureNodeScale.md#bpy.types.TextureNodeScale "bpy.types.TextureNodeScale"), [`TextureNodeSeparateColor`](TextureNodeSeparateColor.md#bpy.types.TextureNodeSeparateColor "bpy.types.TextureNodeSeparateColor"), [`TextureNodeTexBlend`](TextureNodeTexBlend.md#bpy.types.TextureNodeTexBlend "bpy.types.TextureNodeTexBlend"), [`TextureNodeTexClouds`](TextureNodeTexClouds.md#bpy.types.TextureNodeTexClouds "bpy.types.TextureNodeTexClouds"), [`TextureNodeTexDistNoise`](TextureNodeTexDistNoise.md#bpy.types.TextureNodeTexDistNoise "bpy.types.TextureNodeTexDistNoise"), [`TextureNodeTexMagic`](TextureNodeTexMagic.md#bpy.types.TextureNodeTexMagic "bpy.types.TextureNodeTexMagic"), [`TextureNodeTexMarble`](TextureNodeTexMarble.md#bpy.types.TextureNodeTexMarble "bpy.types.TextureNodeTexMarble"), [`TextureNodeTexMusgrave`](TextureNodeTexMusgrave.md#bpy.types.TextureNodeTexMusgrave "bpy.types.TextureNodeTexMusgrave"), [`TextureNodeTexNoise`](TextureNodeTexNoise.md#bpy.types.TextureNodeTexNoise "bpy.types.TextureNodeTexNoise"), [`TextureNodeTexStucci`](TextureNodeTexStucci.md#bpy.types.TextureNodeTexStucci "bpy.types.TextureNodeTexStucci"), [`TextureNodeTexVoronoi`](TextureNodeTexVoronoi.md#bpy.types.TextureNodeTexVoronoi "bpy.types.TextureNodeTexVoronoi"), [`TextureNodeTexWood`](TextureNodeTexWood.md#bpy.types.TextureNodeTexWood "bpy.types.TextureNodeTexWood"), [`TextureNodeTexture`](TextureNodeTexture.md#bpy.types.TextureNodeTexture "bpy.types.TextureNodeTexture"), [`TextureNodeTranslate`](TextureNodeTranslate.md#bpy.types.TextureNodeTranslate "bpy.types.TextureNodeTranslate"), [`TextureNodeValToNor`](TextureNodeValToNor.md#bpy.types.TextureNodeValToNor "bpy.types.TextureNodeValToNor"), [`TextureNodeValToRGB`](TextureNodeValToRGB.md#bpy.types.TextureNodeValToRGB "bpy.types.TextureNodeValToRGB"), [`TextureNodeViewer`](TextureNodeViewer.md#bpy.types.TextureNodeViewer "bpy.types.TextureNodeViewer")

*class* bpy.types.TextureNode(*NodeInternal*)[#](#bpy.types.TextureNode "Link to this definition")
:   *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.TextureNode.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.TextureNode.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.TextureNode.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.TextureNode.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* TextureNode(NodeInternal)
  + [`TextureNode`](#bpy.types.TextureNode)
    - [`TextureNode.bl_rna_get_subclass()`](#bpy.types.TextureNode.bl_rna_get_subclass)
    - [`TextureNode.bl_rna_get_subclass_py()`](#bpy.types.TextureNode.bl_rna_get_subclass_py)
