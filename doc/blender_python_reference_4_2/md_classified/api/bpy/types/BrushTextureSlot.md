...
:   Texture slot for textures in a Brush data-block
    ...
    :   Type:
        :   enum in [‘VIEW\_PLANE’, ‘AREA\_PLANE’, ‘TILED’, ‘3D’, ‘RANDOM’, ‘STENCIL’], default ‘VIEW\_PLANE’

    mask\_map\_mode[#](#bpy.types.BrushTextureSlot.mask_map_mode "Link to this definition")
    :   Type:
        :   enum in [‘VIEW\_PLANE’, ‘TILED’, ‘RANDOM’, ‘STENCIL’], default ‘VIEW\_PLANE’
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.BrushTextureSlot.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.BrushTextureSlot.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)
