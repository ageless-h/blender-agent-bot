...
# ShaderNodeSeparateXYZ(ShaderNode)[#](#shadernodeseparatexyz-shadernode "Link to this heading")
...
*class* bpy.types.ShaderNodeSeparateXYZ(*ShaderNode*)[#](#bpy.types.ShaderNodeSeparateXYZ "Link to this definition")
:   Split a vector into its X, Y, and Z components

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.ShaderNodeSeparateXYZ.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.ShaderNodeSeparateXYZ.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.ShaderNodeSeparateXYZ.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.ShaderNodeSeparateXYZ.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.ShaderNodeSeparateXYZ.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ShaderNodeSeparateXYZ.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.ShaderNodeSeparateXYZ.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ShaderNodeSeparateXYZ(ShaderNode)
  + [`ShaderNodeSeparateXYZ`](#bpy.types.ShaderNodeSeparateXYZ)
    - [`ShaderNodeSeparateXYZ.is_registered_node_type()`](#bpy.types.ShaderNodeSeparateXYZ.is_registered_node_type)
    - [`ShaderNodeSeparateXYZ.input_template()`](#bpy.types.ShaderNodeSeparateXYZ.input_template)
    - [`ShaderNodeSeparateXYZ.output_template()`](#bpy.types.ShaderNodeSeparateXYZ.output_template)
    - [`ShaderNodeSeparateXYZ.bl_rna_get_subclass()`](#bpy.types.ShaderNodeSeparateXYZ.bl_rna_get_subclass)
    - [`ShaderNodeSeparateXYZ.bl_rna_get_subclass_py()`](#bpy.types.ShaderNodeSeparateXYZ.bl_rna_get_subclass_py)
