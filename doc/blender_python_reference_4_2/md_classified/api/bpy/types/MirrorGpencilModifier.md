...
# MirrorGpencilModifier(GpencilModifier)[#](#mirrorgpencilmodifier-gpencilmodifier "Link to this heading")
...
*class* bpy.types.MirrorGpencilModifier(*GpencilModifier*)[#](#bpy.types.MirrorGpencilModifier "Link to this definition")
:   Create mirroring strokes

    invert\_layer\_pass[#](#bpy.types.MirrorGpencilModifier.invert_layer_pass "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    invert\_layers[#](#bpy.types.MirrorGpencilModifier.invert_layers "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    invert\_material\_pass[#](#bpy.types.MirrorGpencilModifier.invert_material_pass "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    invert\_materials[#](#bpy.types.MirrorGpencilModifier.invert_materials "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    layer[#](#bpy.types.MirrorGpencilModifier.layer "Link to this definition")
    :   Layer name

        Type:
        :   string, default “”, (never None)

    layer\_pass[#](#bpy.types.MirrorGpencilModifier.layer_pass "Link to this definition")
    :   Layer pass index

        Type:
        :   int in [0, 100], default 0

    material[#](#bpy.types.MirrorGpencilModifier.material "Link to this definition")
    :   Material used for filtering effect

        Type:
        :   [`Material`](Material.md#bpy.types.Material "bpy.types.Material")

    object[#](#bpy.types.MirrorGpencilModifier.object "Link to this definition")
    :   Object used as center

        Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object")

    pass\_index[#](#bpy.types.MirrorGpencilModifier.pass_index "Link to this definition")
    :   Pass index

        Type:
        :   int in [0, 100], default 0

    use\_axis\_x[#](#bpy.types.MirrorGpencilModifier.use_axis_x "Link to this definition")
    :   Mirror the X axis

        Type:
        :   boolean, default True

    use\_axis\_y[#](#bpy.types.MirrorGpencilModifier.use_axis_y "Link to this definition")
    :   Mirror the Y axis

        Type:
        :   boolean, default False

    use\_axis\_z[#](#bpy.types.MirrorGpencilModifier.use_axis_z "Link to this definition")
    :   Mirror the Z axis

        Type:
        :   boolean, default False

    use\_clip[#](#bpy.types.MirrorGpencilModifier.use_clip "Link to this definition")
    :   Prevent points from going through the mirror during transform

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.MirrorGpencilModifier.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.MirrorGpencilModifier.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.MirrorGpencilModifier.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.MirrorGpencilModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* MirrorGpencilModifier(GpencilModifier)
  + [`MirrorGpencilModifier`](#bpy.types.MirrorGpencilModifier)
    - [`MirrorGpencilModifier.invert_layer_pass`](#bpy.types.MirrorGpencilModifier.invert_layer_pass)
    - [`MirrorGpencilModifier.invert_layers`](#bpy.types.MirrorGpencilModifier.invert_layers)
    - [`MirrorGpencilModifier.invert_material_pass`](#bpy.types.MirrorGpencilModifier.invert_material_pass)
    - [`MirrorGpencilModifier.invert_materials`](#bpy.types.MirrorGpencilModifier.invert_materials)
    - [`MirrorGpencilModifier.layer`](#bpy.types.MirrorGpencilModifier.layer)
    - [`MirrorGpencilModifier.layer_pass`](#bpy.types.MirrorGpencilModifier.layer_pass)
    - [`MirrorGpencilModifier.material`](#bpy.types.MirrorGpencilModifier.material)
    - [`MirrorGpencilModifier.object`](#bpy.types.MirrorGpencilModifier.object)
    - [`MirrorGpencilModifier.pass_index`](#bpy.types.MirrorGpencilModifier.pass_index)
    - [`MirrorGpencilModifier.use_axis_x`](#bpy.types.MirrorGpencilModifier.use_axis_x)
    - [`MirrorGpencilModifier.use_axis_y`](#bpy.types.MirrorGpencilModifier.use_axis_y)
    - [`MirrorGpencilModifier.use_axis_z`](#bpy.types.MirrorGpencilModifier.use_axis_z)
    - [`MirrorGpencilModifier.use_clip`](#bpy.types.MirrorGpencilModifier.use_clip)
    - [`MirrorGpencilModifier.bl_rna_get_subclass()`](#bpy.types.MirrorGpencilModifier.bl_rna_get_subclass)
    - [`MirrorGpencilModifier.bl_rna_get_subclass_py()`](#bpy.types.MirrorGpencilModifier.bl_rna_get_subclass_py)
