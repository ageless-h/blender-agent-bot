...
# FunctionNodeCompare(FunctionNode)[#](#functionnodecompare-functionnode "Link to this heading")

base classes — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct"), [`Node`](Node.md#bpy.types.Node "bpy.types.Node"), [`NodeInternal`](NodeInternal.md#bpy.types.NodeInternal "bpy.types.NodeInternal"), [`FunctionNode`](FunctionNode.md#bpy.types.FunctionNode "bpy.types.FunctionNode")

*class* bpy.types.FunctionNodeCompare(*FunctionNode*)[#](#bpy.types.FunctionNodeCompare "Link to this definition")
:   data\_type[#](#bpy.types.FunctionNodeCompare.data_type "Link to this definition")
    :   Type:
        :   enum in [Node Socket Data Type Items](../../../appendix/bpy_types_enum_items/node_socket_data_type_items.md#rna-enum-node-socket-data-type-items), default ‘FLOAT’

    mode[#](#bpy.types.FunctionNodeCompare.mode "Link to this definition")
    :   * `ELEMENT`
        ...
        * `DIRECTION`
        ...
        Type:
        :   enum in [‘ELEMENT’, ‘LENGTH’, ‘AVERAGE’, ‘DOT\_PRODUCT’, ‘DIRECTION’], default ‘ELEMENT’

    operation[#](#bpy.types.FunctionNodeCompare.operation "Link to this definition")
    :   Type:
        :   enum in [Node Compare Operation Items](../../../appendix/bpy_types_enum_items/node_compare_operation_items.md#rna-enum-node-compare-operation-items), default ‘EQUAL’

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.FunctionNodeCompare.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.FunctionNodeCompare.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.FunctionNodeCompare.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.FunctionNodeCompare.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.FunctionNodeCompare.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.FunctionNodeCompare.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.FunctionNodeCompare.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* FunctionNodeCompare(FunctionNode)
  + [`FunctionNodeCompare`](#bpy.types.FunctionNodeCompare)
    - [`FunctionNodeCompare.data_type`](#bpy.types.FunctionNodeCompare.data_type)
    - [`FunctionNodeCompare.mode`](#bpy.types.FunctionNodeCompare.mode)
    - [`FunctionNodeCompare.operation`](#bpy.types.FunctionNodeCompare.operation)
    - [`FunctionNodeCompare.is_registered_node_type()`](#bpy.types.FunctionNodeCompare.is_registered_node_type)
    - [`FunctionNodeCompare.input_template()`](#bpy.types.FunctionNodeCompare.input_template)
    - [`FunctionNodeCompare.output_template()`](#bpy.types.FunctionNodeCompare.output_template)
    - [`FunctionNodeCompare.bl_rna_get_subclass()`](#bpy.types.FunctionNodeCompare.bl_rna_get_subclass)
    - [`FunctionNodeCompare.bl_rna_get_subclass_py()`](#bpy.types.FunctionNodeCompare.bl_rna_get_subclass_py)
