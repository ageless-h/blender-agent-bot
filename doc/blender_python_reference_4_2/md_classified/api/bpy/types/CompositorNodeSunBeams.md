...
# CompositorNodeSunBeams(CompositorNode)[#](#compositornodesunbeams-compositornode "Link to this heading")
...
*class* bpy.types.CompositorNodeSunBeams(*CompositorNode*)[#](#bpy.types.CompositorNodeSunBeams "Link to this definition")
:   Create sun beams based on image brightness

    ray\_length[#](#bpy.types.CompositorNodeSunBeams.ray_length "Link to this definition")
    :   Length of rays as a factor of the image size

        Type:
        :   float in [0, 100], default 0.0

    source[#](#bpy.types.CompositorNodeSunBeams.source "Link to this definition")
    :   Source point of rays as a factor of the image width and height

        Type:
        :   float array of 2 items in [-100, 100], default (0.0, 0.0)

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.CompositorNodeSunBeams.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.CompositorNodeSunBeams.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.CompositorNodeSunBeams.output_template "Link to this definition")
    ...
    update()[#](#bpy.types.CompositorNodeSunBeams.update "Link to this definition")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.CompositorNodeSunBeams.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.CompositorNodeSunBeams.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CompositorNodeSunBeams.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.CompositorNodeSunBeams.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CompositorNodeSunBeams(CompositorNode)
  + [`CompositorNodeSunBeams`](#bpy.types.CompositorNodeSunBeams)
    - [`CompositorNodeSunBeams.ray_length`](#bpy.types.CompositorNodeSunBeams.ray_length)
    - [`CompositorNodeSunBeams.source`](#bpy.types.CompositorNodeSunBeams.source)
    - [`CompositorNodeSunBeams.is_registered_node_type()`](#bpy.types.CompositorNodeSunBeams.is_registered_node_type)
    - [`CompositorNodeSunBeams.input_template()`](#bpy.types.CompositorNodeSunBeams.input_template)
    - [`CompositorNodeSunBeams.output_template()`](#bpy.types.CompositorNodeSunBeams.output_template)
    - [`CompositorNodeSunBeams.update()`](#bpy.types.CompositorNodeSunBeams.update)
    - [`CompositorNodeSunBeams.bl_rna_get_subclass()`](#bpy.types.CompositorNodeSunBeams.bl_rna_get_subclass)
    - [`CompositorNodeSunBeams.bl_rna_get_subclass_py()`](#bpy.types.CompositorNodeSunBeams.bl_rna_get_subclass_py)
