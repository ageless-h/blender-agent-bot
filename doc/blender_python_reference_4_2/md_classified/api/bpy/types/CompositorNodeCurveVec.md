...
# CompositorNodeCurveVec(CompositorNode)[#](#compositornodecurvevec-compositornode "Link to this heading")
...
*class* bpy.types.CompositorNodeCurveVec(*CompositorNode*)[#](#bpy.types.CompositorNodeCurveVec "Link to this definition")
:   Map input vector components with curves

    mapping[#](#bpy.types.CompositorNodeCurveVec.mapping "Link to this definition")
    :   Type:
        :   [`CurveMapping`](CurveMapping.md#bpy.types.CurveMapping "bpy.types.CurveMapping"), (readonly)

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.CompositorNodeCurveVec.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.CompositorNodeCurveVec.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.CompositorNodeCurveVec.output_template "Link to this definition")
    ...
    update()[#](#bpy.types.CompositorNodeCurveVec.update "Link to this definition")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.CompositorNodeCurveVec.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.CompositorNodeCurveVec.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CompositorNodeCurveVec.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.CompositorNodeCurveVec.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CompositorNodeCurveVec(CompositorNode)
  + [`CompositorNodeCurveVec`](#bpy.types.CompositorNodeCurveVec)
    - [`CompositorNodeCurveVec.mapping`](#bpy.types.CompositorNodeCurveVec.mapping)
    - [`CompositorNodeCurveVec.is_registered_node_type()`](#bpy.types.CompositorNodeCurveVec.is_registered_node_type)
    - [`CompositorNodeCurveVec.input_template()`](#bpy.types.CompositorNodeCurveVec.input_template)
    - [`CompositorNodeCurveVec.output_template()`](#bpy.types.CompositorNodeCurveVec.output_template)
    - [`CompositorNodeCurveVec.update()`](#bpy.types.CompositorNodeCurveVec.update)
    - [`CompositorNodeCurveVec.bl_rna_get_subclass()`](#bpy.types.CompositorNodeCurveVec.bl_rna_get_subclass)
    - [`CompositorNodeCurveVec.bl_rna_get_subclass_py()`](#bpy.types.CompositorNodeCurveVec.bl_rna_get_subclass_py)
