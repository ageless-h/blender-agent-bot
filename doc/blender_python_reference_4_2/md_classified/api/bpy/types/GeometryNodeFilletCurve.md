...
# GeometryNodeFilletCurve(GeometryNode)[#](#geometrynodefilletcurve-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeFilletCurve(*GeometryNode*)[#](#bpy.types.GeometryNodeFilletCurve "Link to this definition")
:   Round corners by generating circular arcs on each control point

    mode[#](#bpy.types.GeometryNodeFilletCurve.mode "Link to this definition")
    :   How to choose number of vertices on fillet

        * `BEZIER`
          Bézier – Align Bézier handles to create circular arcs at each control point.
        * `POLY`
          Poly – Add control points along a circular arc (handle type is vector if Bézier Spline).

        Type:
        :   enum in [‘BEZIER’, ‘POLY’], default ‘BEZIER’

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.GeometryNodeFilletCurve.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.GeometryNodeFilletCurve.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.GeometryNodeFilletCurve.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.GeometryNodeFilletCurve.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.GeometryNodeFilletCurve.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeFilletCurve.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.GeometryNodeFilletCurve.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeFilletCurve(GeometryNode)
  + [`GeometryNodeFilletCurve`](#bpy.types.GeometryNodeFilletCurve)
    - [`GeometryNodeFilletCurve.mode`](#bpy.types.GeometryNodeFilletCurve.mode)
    - [`GeometryNodeFilletCurve.is_registered_node_type()`](#bpy.types.GeometryNodeFilletCurve.is_registered_node_type)
    - [`GeometryNodeFilletCurve.input_template()`](#bpy.types.GeometryNodeFilletCurve.input_template)
    - [`GeometryNodeFilletCurve.output_template()`](#bpy.types.GeometryNodeFilletCurve.output_template)
    - [`GeometryNodeFilletCurve.bl_rna_get_subclass()`](#bpy.types.GeometryNodeFilletCurve.bl_rna_get_subclass)
    - [`GeometryNodeFilletCurve.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeFilletCurve.bl_rna_get_subclass_py)
