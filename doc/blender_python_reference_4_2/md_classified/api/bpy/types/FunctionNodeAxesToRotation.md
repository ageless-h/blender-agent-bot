...
# FunctionNodeAxesToRotation(FunctionNode)[#](#functionnodeaxestorotation-functionnode "Link to this heading")
...
*class* bpy.types.FunctionNodeAxesToRotation(*FunctionNode*)[#](#bpy.types.FunctionNodeAxesToRotation "Link to this definition")
:   Create a rotation from a primary and (ideally orthogonal) secondary axis

    primary\_axis[#](#bpy.types.FunctionNodeAxesToRotation.primary_axis "Link to this definition")
    :   Axis that is aligned exactly to the provided primary direction

        Type:
        :   enum in [‘X’, ‘Y’, ‘Z’], default ‘X’

    secondary\_axis[#](#bpy.types.FunctionNodeAxesToRotation.secondary_axis "Link to this definition")
    :   Axis that is aligned as well as possible given the alignment of the primary axis

        Type:
        :   enum in [‘X’, ‘Y’, ‘Z’], default ‘X’

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.FunctionNodeAxesToRotation.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.FunctionNodeAxesToRotation.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.FunctionNodeAxesToRotation.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.FunctionNodeAxesToRotation.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.FunctionNodeAxesToRotation.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.FunctionNodeAxesToRotation.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.FunctionNodeAxesToRotation.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* FunctionNodeAxesToRotation(FunctionNode)
  + [`FunctionNodeAxesToRotation`](#bpy.types.FunctionNodeAxesToRotation)
    - [`FunctionNodeAxesToRotation.primary_axis`](#bpy.types.FunctionNodeAxesToRotation.primary_axis)
    - [`FunctionNodeAxesToRotation.secondary_axis`](#bpy.types.FunctionNodeAxesToRotation.secondary_axis)
    - [`FunctionNodeAxesToRotation.is_registered_node_type()`](#bpy.types.FunctionNodeAxesToRotation.is_registered_node_type)
    - [`FunctionNodeAxesToRotation.input_template()`](#bpy.types.FunctionNodeAxesToRotation.input_template)
    - [`FunctionNodeAxesToRotation.output_template()`](#bpy.types.FunctionNodeAxesToRotation.output_template)
    - [`FunctionNodeAxesToRotation.bl_rna_get_subclass()`](#bpy.types.FunctionNodeAxesToRotation.bl_rna_get_subclass)
    - [`FunctionNodeAxesToRotation.bl_rna_get_subclass_py()`](#bpy.types.FunctionNodeAxesToRotation.bl_rna_get_subclass_py)
