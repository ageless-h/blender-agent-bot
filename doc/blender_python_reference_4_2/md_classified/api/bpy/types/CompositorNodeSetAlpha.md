...
# CompositorNodeSetAlpha(CompositorNode)[#](#compositornodesetalpha-compositornode "Link to this heading")
...
*class* bpy.types.CompositorNodeSetAlpha(*CompositorNode*)[#](#bpy.types.CompositorNodeSetAlpha "Link to this definition")
:   Add an alpha channel to an image

    mode[#](#bpy.types.CompositorNodeSetAlpha.mode "Link to this definition")
    :   * `APPLY`
          Apply Mask – Multiply the input image’s RGBA channels by the alpha input value.
        * `REPLACE_ALPHA`
          Replace Alpha – Replace the input image’s alpha channel by the alpha input value.

        Type:
        :   enum in [‘APPLY’, ‘REPLACE\_ALPHA’], default ‘APPLY’

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.CompositorNodeSetAlpha.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.CompositorNodeSetAlpha.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.CompositorNodeSetAlpha.output_template "Link to this definition")
    ...
    update()[#](#bpy.types.CompositorNodeSetAlpha.update "Link to this definition")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.CompositorNodeSetAlpha.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.CompositorNodeSetAlpha.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CompositorNodeSetAlpha.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.CompositorNodeSetAlpha.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CompositorNodeSetAlpha(CompositorNode)
  + [`CompositorNodeSetAlpha`](#bpy.types.CompositorNodeSetAlpha)
    - [`CompositorNodeSetAlpha.mode`](#bpy.types.CompositorNodeSetAlpha.mode)
    - [`CompositorNodeSetAlpha.is_registered_node_type()`](#bpy.types.CompositorNodeSetAlpha.is_registered_node_type)
    - [`CompositorNodeSetAlpha.input_template()`](#bpy.types.CompositorNodeSetAlpha.input_template)
    - [`CompositorNodeSetAlpha.output_template()`](#bpy.types.CompositorNodeSetAlpha.output_template)
    - [`CompositorNodeSetAlpha.update()`](#bpy.types.CompositorNodeSetAlpha.update)
    - [`CompositorNodeSetAlpha.bl_rna_get_subclass()`](#bpy.types.CompositorNodeSetAlpha.bl_rna_get_subclass)
    - [`CompositorNodeSetAlpha.bl_rna_get_subclass_py()`](#bpy.types.CompositorNodeSetAlpha.bl_rna_get_subclass_py)
