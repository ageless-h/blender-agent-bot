...
# WeightAngleGpencilModifier(GpencilModifier)[#](#weightanglegpencilmodifier-gpencilmodifier "Link to this heading")
...
*class* bpy.types.WeightAngleGpencilModifier(*GpencilModifier*)[#](#bpy.types.WeightAngleGpencilModifier "Link to this definition")
:   Calculate Vertex Weight dynamically

    angle[#](#bpy.types.WeightAngleGpencilModifier.angle "Link to this definition")
    :   Angle

        Type:
        :   float in [0, 3.14159], default 0.0

    axis[#](#bpy.types.WeightAngleGpencilModifier.axis "Link to this definition")
    :   Type:
        :   enum in [‘X’, ‘Y’, ‘Z’], default ‘Y’

    invert\_layer\_pass[#](#bpy.types.WeightAngleGpencilModifier.invert_layer_pass "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    invert\_layers[#](#bpy.types.WeightAngleGpencilModifier.invert_layers "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    invert\_material\_pass[#](#bpy.types.WeightAngleGpencilModifier.invert_material_pass "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    invert\_materials[#](#bpy.types.WeightAngleGpencilModifier.invert_materials "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    invert\_vertex[#](#bpy.types.WeightAngleGpencilModifier.invert_vertex "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    layer[#](#bpy.types.WeightAngleGpencilModifier.layer "Link to this definition")
    :   Layer name

        Type:
        :   string, default “”, (never None)

    layer\_pass[#](#bpy.types.WeightAngleGpencilModifier.layer_pass "Link to this definition")
    :   Layer pass index

        Type:
        :   int in [0, 100], default 0

    material[#](#bpy.types.WeightAngleGpencilModifier.material "Link to this definition")
    :   Material used for filtering effect

        Type:
        :   [`Material`](Material.md#bpy.types.Material "bpy.types.Material")

    minimum\_weight[#](#bpy.types.WeightAngleGpencilModifier.minimum_weight "Link to this definition")
    :   Minimum value for vertex weight

        Type:
        :   float in [0, 1], default 0.0

    pass\_index[#](#bpy.types.WeightAngleGpencilModifier.pass_index "Link to this definition")
    :   Pass index

        Type:
        :   int in [0, 100], default 0

    space[#](#bpy.types.WeightAngleGpencilModifier.space "Link to this definition")
    :   Coordinates space

        Type:
        :   enum in [‘LOCAL’, ‘WORLD’], default ‘LOCAL’

    target\_vertex\_group[#](#bpy.types.WeightAngleGpencilModifier.target_vertex_group "Link to this definition")
    :   Output Vertex group

        Type:
        :   string, default “”, (never None)

    use\_invert\_output[#](#bpy.types.WeightAngleGpencilModifier.use_invert_output "Link to this definition")
    :   Invert output weight values

        Type:
        :   boolean, default False

    use\_multiply[#](#bpy.types.WeightAngleGpencilModifier.use_multiply "Link to this definition")
    :   Multiply the calculated weights with the existing values in the vertex group

        Type:
        :   boolean, default False

    vertex\_group[#](#bpy.types.WeightAngleGpencilModifier.vertex_group "Link to this definition")
    :   Vertex group name for modulating the deform

        Type:
        :   string, default “”, (never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.WeightAngleGpencilModifier.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.WeightAngleGpencilModifier.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.WeightAngleGpencilModifier.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.WeightAngleGpencilModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* WeightAngleGpencilModifier(GpencilModifier)
  + [`WeightAngleGpencilModifier`](#bpy.types.WeightAngleGpencilModifier)
    - [`WeightAngleGpencilModifier.angle`](#bpy.types.WeightAngleGpencilModifier.angle)
    - [`WeightAngleGpencilModifier.axis`](#bpy.types.WeightAngleGpencilModifier.axis)
    - [`WeightAngleGpencilModifier.invert_layer_pass`](#bpy.types.WeightAngleGpencilModifier.invert_layer_pass)
    - [`WeightAngleGpencilModifier.invert_layers`](#bpy.types.WeightAngleGpencilModifier.invert_layers)
    - [`WeightAngleGpencilModifier.invert_material_pass`](#bpy.types.WeightAngleGpencilModifier.invert_material_pass)
    - [`WeightAngleGpencilModifier.invert_materials`](#bpy.types.WeightAngleGpencilModifier.invert_materials)
    - [`WeightAngleGpencilModifier.invert_vertex`](#bpy.types.WeightAngleGpencilModifier.invert_vertex)
    - [`WeightAngleGpencilModifier.layer`](#bpy.types.WeightAngleGpencilModifier.layer)
    - [`WeightAngleGpencilModifier.layer_pass`](#bpy.types.WeightAngleGpencilModifier.layer_pass)
    - [`WeightAngleGpencilModifier.material`](#bpy.types.WeightAngleGpencilModifier.material)
    - [`WeightAngleGpencilModifier.minimum_weight`](#bpy.types.WeightAngleGpencilModifier.minimum_weight)
    - [`WeightAngleGpencilModifier.pass_index`](#bpy.types.WeightAngleGpencilModifier.pass_index)
    - [`WeightAngleGpencilModifier.space`](#bpy.types.WeightAngleGpencilModifier.space)
    - [`WeightAngleGpencilModifier.target_vertex_group`](#bpy.types.WeightAngleGpencilModifier.target_vertex_group)
    - [`WeightAngleGpencilModifier.use_invert_output`](#bpy.types.WeightAngleGpencilModifier.use_invert_output)
    - [`WeightAngleGpencilModifier.use_multiply`](#bpy.types.WeightAngleGpencilModifier.use_multiply)
    - [`WeightAngleGpencilModifier.vertex_group`](#bpy.types.WeightAngleGpencilModifier.vertex_group)
    - [`WeightAngleGpencilModifier.bl_rna_get_subclass()`](#bpy.types.WeightAngleGpencilModifier.bl_rna_get_subclass)
    - [`WeightAngleGpencilModifier.bl_rna_get_subclass_py()`](#bpy.types.WeightAngleGpencilModifier.bl_rna_get_subclass_py)
