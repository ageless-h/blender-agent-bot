...
# TextureNodeImage(TextureNode)[#](#texturenodeimage-texturenode "Link to this heading")
...
*class* bpy.types.TextureNodeImage(*TextureNode*)[#](#bpy.types.TextureNodeImage "Link to this definition")
:   image[#](#bpy.types.TextureNodeImage.image "Link to this definition")
    :   Type:
        :   [`Image`](Image.md#bpy.types.Image "bpy.types.Image")

    image\_user[#](#bpy.types.TextureNodeImage.image_user "Link to this definition")
    ...
    *classmethod* is\_registered\_node\_type()[#](#bpy.types.TextureNodeImage.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.TextureNodeImage.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.TextureNodeImage.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.TextureNodeImage.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.TextureNodeImage.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.TextureNodeImage.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.TextureNodeImage.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* TextureNodeImage(TextureNode)
  + [`TextureNodeImage`](#bpy.types.TextureNodeImage)
    - [`TextureNodeImage.image`](#bpy.types.TextureNodeImage.image)
    - [`TextureNodeImage.image_user`](#bpy.types.TextureNodeImage.image_user)
    - [`TextureNodeImage.is_registered_node_type()`](#bpy.types.TextureNodeImage.is_registered_node_type)
    - [`TextureNodeImage.input_template()`](#bpy.types.TextureNodeImage.input_template)
    - [`TextureNodeImage.output_template()`](#bpy.types.TextureNodeImage.output_template)
    - [`TextureNodeImage.bl_rna_get_subclass()`](#bpy.types.TextureNodeImage.bl_rna_get_subclass)
    - [`TextureNodeImage.bl_rna_get_subclass_py()`](#bpy.types.TextureNodeImage.bl_rna_get_subclass_py)
