...
# GeometryNodeStoreNamedAttribute(GeometryNode)[#](#geometrynodestorenamedattribute-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeStoreNamedAttribute(*GeometryNode*)[#](#bpy.types.GeometryNodeStoreNamedAttribute "Link to this definition")
:   Store the result of a field on a geometry as an attribute with the specified name

    data\_type[#](#bpy.types.GeometryNodeStoreNamedAttribute.data_type "Link to this definition")
    :   Type of data stored in attribute

        Type:
        :   enum in [Attribute Type Items](../../../appendix/bpy_types_enum_items/attribute_type_items.md#rna-enum-attribute-type-items), default ‘FLOAT’

    domain[#](#bpy.types.GeometryNodeStoreNamedAttribute.domain "Link to this definition")
    ...
    *classmethod* is\_registered\_node\_type()[#](#bpy.types.GeometryNodeStoreNamedAttribute.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.GeometryNodeStoreNamedAttribute.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.GeometryNodeStoreNamedAttribute.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.GeometryNodeStoreNamedAttribute.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.GeometryNodeStoreNamedAttribute.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeStoreNamedAttribute.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.GeometryNodeStoreNamedAttribute.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeStoreNamedAttribute(GeometryNode)
  + [`GeometryNodeStoreNamedAttribute`](#bpy.types.GeometryNodeStoreNamedAttribute)
    - [`GeometryNodeStoreNamedAttribute.data_type`](#bpy.types.GeometryNodeStoreNamedAttribute.data_type)
    - [`GeometryNodeStoreNamedAttribute.domain`](#bpy.types.GeometryNodeStoreNamedAttribute.domain)
    - [`GeometryNodeStoreNamedAttribute.is_registered_node_type()`](#bpy.types.GeometryNodeStoreNamedAttribute.is_registered_node_type)
    - [`GeometryNodeStoreNamedAttribute.input_template()`](#bpy.types.GeometryNodeStoreNamedAttribute.input_template)
    - [`GeometryNodeStoreNamedAttribute.output_template()`](#bpy.types.GeometryNodeStoreNamedAttribute.output_template)
    - [`GeometryNodeStoreNamedAttribute.bl_rna_get_subclass()`](#bpy.types.GeometryNodeStoreNamedAttribute.bl_rna_get_subclass)
    - [`GeometryNodeStoreNamedAttribute.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeStoreNamedAttribute.bl_rna_get_subclass_py)
