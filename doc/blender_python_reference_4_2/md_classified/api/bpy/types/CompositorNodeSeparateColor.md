...
# CompositorNodeSeparateColor(CompositorNode)[#](#compositornodeseparatecolor-compositornode "Link to this heading")
...
*class* bpy.types.CompositorNodeSeparateColor(*CompositorNode*)[#](#bpy.types.CompositorNodeSeparateColor "Link to this definition")
:   Split an image into its composite color channels

    mode[#](#bpy.types.CompositorNodeSeparateColor.mode "Link to this definition")
    :   Mode of color processing

        * `RGB`
          RGB – Use RGB color processing.
        * `HSV`
          HSV – Use HSV color processing.
        * `HSL`
          HSL – Use HSL color processing.
        * `YCC`
          YCbCr – Use YCbCr color processing.
        * `YUV`
          YUV – Use YUV color processing.

        Type:
        :   enum in [‘RGB’, ‘HSV’, ‘HSL’, ‘YCC’, ‘YUV’], default ‘RGB’

    ycc\_mode[#](#bpy.types.CompositorNodeSeparateColor.ycc_mode "Link to this definition")
    :   Color space used for YCbCrA processing

        Type:
        :   enum in [‘ITUBT601’, ‘ITUBT709’, ‘JFIF’], default ‘ITUBT601’

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.CompositorNodeSeparateColor.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.CompositorNodeSeparateColor.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.CompositorNodeSeparateColor.output_template "Link to this definition")
    ...
    update()[#](#bpy.types.CompositorNodeSeparateColor.update "Link to this definition")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.CompositorNodeSeparateColor.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.CompositorNodeSeparateColor.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CompositorNodeSeparateColor.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.CompositorNodeSeparateColor.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CompositorNodeSeparateColor(CompositorNode)
  + [`CompositorNodeSeparateColor`](#bpy.types.CompositorNodeSeparateColor)
    - [`CompositorNodeSeparateColor.mode`](#bpy.types.CompositorNodeSeparateColor.mode)
    - [`CompositorNodeSeparateColor.ycc_mode`](#bpy.types.CompositorNodeSeparateColor.ycc_mode)
    - [`CompositorNodeSeparateColor.is_registered_node_type()`](#bpy.types.CompositorNodeSeparateColor.is_registered_node_type)
    - [`CompositorNodeSeparateColor.input_template()`](#bpy.types.CompositorNodeSeparateColor.input_template)
    - [`CompositorNodeSeparateColor.output_template()`](#bpy.types.CompositorNodeSeparateColor.output_template)
    - [`CompositorNodeSeparateColor.update()`](#bpy.types.CompositorNodeSeparateColor.update)
    - [`CompositorNodeSeparateColor.bl_rna_get_subclass()`](#bpy.types.CompositorNodeSeparateColor.bl_rna_get_subclass)
    - [`CompositorNodeSeparateColor.bl_rna_get_subclass_py()`](#bpy.types.CompositorNodeSeparateColor.bl_rna_get_subclass_py)
