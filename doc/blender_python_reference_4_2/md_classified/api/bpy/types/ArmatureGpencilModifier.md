...
# ArmatureGpencilModifier(GpencilModifier)[#](#armaturegpencilmodifier-gpencilmodifier "Link to this heading")
...
*class* bpy.types.ArmatureGpencilModifier(*GpencilModifier*)[#](#bpy.types.ArmatureGpencilModifier "Link to this definition")
:   Change stroke using armature to deform modifier

    invert\_vertex\_group[#](#bpy.types.ArmatureGpencilModifier.invert_vertex_group "Link to this definition")
    :   Invert vertex group influence

        Type:
        :   boolean, default False

    object[#](#bpy.types.ArmatureGpencilModifier.object "Link to this definition")
    :   Armature object to deform with

        Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object")

    use\_bone\_envelopes[#](#bpy.types.ArmatureGpencilModifier.use_bone_envelopes "Link to this definition")
    :   Bind Bone envelopes to armature modifier

        Type:
        :   boolean, default False

    use\_deform\_preserve\_volume[#](#bpy.types.ArmatureGpencilModifier.use_deform_preserve_volume "Link to this definition")
    :   Deform rotation interpolation with quaternions

        Type:
        :   boolean, default False

    use\_vertex\_groups[#](#bpy.types.ArmatureGpencilModifier.use_vertex_groups "Link to this definition")
    :   Bind vertex groups to armature modifier

        Type:
        :   boolean, default True

    vertex\_group[#](#bpy.types.ArmatureGpencilModifier.vertex_group "Link to this definition")
    :   Name of Vertex Group which determines influence of modifier per point

        Type:
        :   string, default “”, (never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.ArmatureGpencilModifier.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.ArmatureGpencilModifier.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ArmatureGpencilModifier.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.ArmatureGpencilModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ArmatureGpencilModifier(GpencilModifier)
  + [`ArmatureGpencilModifier`](#bpy.types.ArmatureGpencilModifier)
    - [`ArmatureGpencilModifier.invert_vertex_group`](#bpy.types.ArmatureGpencilModifier.invert_vertex_group)
    - [`ArmatureGpencilModifier.object`](#bpy.types.ArmatureGpencilModifier.object)
    - [`ArmatureGpencilModifier.use_bone_envelopes`](#bpy.types.ArmatureGpencilModifier.use_bone_envelopes)
    - [`ArmatureGpencilModifier.use_deform_preserve_volume`](#bpy.types.ArmatureGpencilModifier.use_deform_preserve_volume)
    - [`ArmatureGpencilModifier.use_vertex_groups`](#bpy.types.ArmatureGpencilModifier.use_vertex_groups)
    - [`ArmatureGpencilModifier.vertex_group`](#bpy.types.ArmatureGpencilModifier.vertex_group)
    - [`ArmatureGpencilModifier.bl_rna_get_subclass()`](#bpy.types.ArmatureGpencilModifier.bl_rna_get_subclass)
    - [`ArmatureGpencilModifier.bl_rna_get_subclass_py()`](#bpy.types.ArmatureGpencilModifier.bl_rna_get_subclass_py)
