...
# ShaderNodeBsdfHairPrincipled(ShaderNode)[#](#shadernodebsdfhairprincipled-shadernode "Link to this heading")
...
*class* bpy.types.ShaderNodeBsdfHairPrincipled(*ShaderNode*)[#](#bpy.types.ShaderNodeBsdfHairPrincipled "Link to this definition")
:   Physically-based, easy-to-use shader for rendering hair and fur

    model[#](#bpy.types.ShaderNodeBsdfHairPrincipled.model "Link to this definition")
    :   Select from Chiang or Huang model
        ...
        * `HUANG`
        ...
        Type:
        :   enum in [‘CHIANG’, ‘HUANG’], default ‘HUANG’

    parametrization[#](#bpy.types.ShaderNodeBsdfHairPrincipled.parametrization "Link to this definition")
    :   Select the shader’s color parametrization

        * `ABSORPTION`
          Absorption Coefficient – Directly set the absorption coefficient “sigma\_a” (this is not the most intuitive way to color hair).
        * `MELANIN`
        ...
        * `COLOR`
        ...
        Type:
        :   enum in [‘ABSORPTION’, ‘MELANIN’, ‘COLOR’], default ‘COLOR’

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.ShaderNodeBsdfHairPrincipled.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.ShaderNodeBsdfHairPrincipled.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.ShaderNodeBsdfHairPrincipled.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.ShaderNodeBsdfHairPrincipled.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.ShaderNodeBsdfHairPrincipled.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ShaderNodeBsdfHairPrincipled.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.ShaderNodeBsdfHairPrincipled.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ShaderNodeBsdfHairPrincipled(ShaderNode)
  + [`ShaderNodeBsdfHairPrincipled`](#bpy.types.ShaderNodeBsdfHairPrincipled)
    - [`ShaderNodeBsdfHairPrincipled.model`](#bpy.types.ShaderNodeBsdfHairPrincipled.model)
    - [`ShaderNodeBsdfHairPrincipled.parametrization`](#bpy.types.ShaderNodeBsdfHairPrincipled.parametrization)
    - [`ShaderNodeBsdfHairPrincipled.is_registered_node_type()`](#bpy.types.ShaderNodeBsdfHairPrincipled.is_registered_node_type)
    - [`ShaderNodeBsdfHairPrincipled.input_template()`](#bpy.types.ShaderNodeBsdfHairPrincipled.input_template)
    - [`ShaderNodeBsdfHairPrincipled.output_template()`](#bpy.types.ShaderNodeBsdfHairPrincipled.output_template)
    - [`ShaderNodeBsdfHairPrincipled.bl_rna_get_subclass()`](#bpy.types.ShaderNodeBsdfHairPrincipled.bl_rna_get_subclass)
    - [`ShaderNodeBsdfHairPrincipled.bl_rna_get_subclass_py()`](#bpy.types.ShaderNodeBsdfHairPrincipled.bl_rna_get_subclass_py)
