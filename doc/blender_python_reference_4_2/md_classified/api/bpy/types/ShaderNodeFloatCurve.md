...
# ShaderNodeFloatCurve(ShaderNode)[#](#shadernodefloatcurve-shadernode "Link to this heading")
...
*class* bpy.types.ShaderNodeFloatCurve(*ShaderNode*)[#](#bpy.types.ShaderNodeFloatCurve "Link to this definition")
:   Map an input float to a curve and outputs a float value

    mapping[#](#bpy.types.ShaderNodeFloatCurve.mapping "Link to this definition")
    :   Type:
        :   [`CurveMapping`](CurveMapping.md#bpy.types.CurveMapping "bpy.types.CurveMapping"), (readonly)

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.ShaderNodeFloatCurve.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.ShaderNodeFloatCurve.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.ShaderNodeFloatCurve.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.ShaderNodeFloatCurve.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.ShaderNodeFloatCurve.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ShaderNodeFloatCurve.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.ShaderNodeFloatCurve.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ShaderNodeFloatCurve(ShaderNode)
  + [`ShaderNodeFloatCurve`](#bpy.types.ShaderNodeFloatCurve)
    - [`ShaderNodeFloatCurve.mapping`](#bpy.types.ShaderNodeFloatCurve.mapping)
    - [`ShaderNodeFloatCurve.is_registered_node_type()`](#bpy.types.ShaderNodeFloatCurve.is_registered_node_type)
    - [`ShaderNodeFloatCurve.input_template()`](#bpy.types.ShaderNodeFloatCurve.input_template)
    - [`ShaderNodeFloatCurve.output_template()`](#bpy.types.ShaderNodeFloatCurve.output_template)
    - [`ShaderNodeFloatCurve.bl_rna_get_subclass()`](#bpy.types.ShaderNodeFloatCurve.bl_rna_get_subclass)
    - [`ShaderNodeFloatCurve.bl_rna_get_subclass_py()`](#bpy.types.ShaderNodeFloatCurve.bl_rna_get_subclass_py)
