...
# ShaderNodeTexIES(ShaderNode)[#](#shadernodetexies-shadernode "Link to this heading")
...
*class* bpy.types.ShaderNodeTexIES(*ShaderNode*)[#](#bpy.types.ShaderNodeTexIES "Link to this definition")
:   Match real world lights with IES files, which store the directional intensity distribution of light sources

    filepath[#](#bpy.types.ShaderNodeTexIES.filepath "Link to this definition")
    :   IES light path

        Type:
        :   string, default “”, (never None)

    ies[#](#bpy.types.ShaderNodeTexIES.ies "Link to this definition")
    :   Internal IES file

        Type:
        :   [`Text`](Text.md#bpy.types.Text "bpy.types.Text")

    mode[#](#bpy.types.ShaderNodeTexIES.mode "Link to this definition")
    ...
    *classmethod* is\_registered\_node\_type()[#](#bpy.types.ShaderNodeTexIES.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.ShaderNodeTexIES.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.ShaderNodeTexIES.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.ShaderNodeTexIES.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.ShaderNodeTexIES.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ShaderNodeTexIES.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.ShaderNodeTexIES.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ShaderNodeTexIES(ShaderNode)
  + [`ShaderNodeTexIES`](#bpy.types.ShaderNodeTexIES)
    - [`ShaderNodeTexIES.filepath`](#bpy.types.ShaderNodeTexIES.filepath)
    - [`ShaderNodeTexIES.ies`](#bpy.types.ShaderNodeTexIES.ies)
    - [`ShaderNodeTexIES.mode`](#bpy.types.ShaderNodeTexIES.mode)
    - [`ShaderNodeTexIES.is_registered_node_type()`](#bpy.types.ShaderNodeTexIES.is_registered_node_type)
    - [`ShaderNodeTexIES.input_template()`](#bpy.types.ShaderNodeTexIES.input_template)
    - [`ShaderNodeTexIES.output_template()`](#bpy.types.ShaderNodeTexIES.output_template)
    - [`ShaderNodeTexIES.bl_rna_get_subclass()`](#bpy.types.ShaderNodeTexIES.bl_rna_get_subclass)
    - [`ShaderNodeTexIES.bl_rna_get_subclass_py()`](#bpy.types.ShaderNodeTexIES.bl_rna_get_subclass_py)
