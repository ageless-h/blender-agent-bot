...
# CompositorNodeDiffMatte(CompositorNode)[#](#compositornodediffmatte-compositornode "Link to this heading")
...
*class* bpy.types.CompositorNodeDiffMatte(*CompositorNode*)[#](#bpy.types.CompositorNodeDiffMatte "Link to this definition")
:   Produce a matte that isolates foreground content by comparing it with a reference background image

    falloff[#](#bpy.types.CompositorNodeDiffMatte.falloff "Link to this definition")
    :   Color distances below this additional threshold are partially keyed

        Type:
        :   float in [0, 1], default 0.0

    tolerance[#](#bpy.types.CompositorNodeDiffMatte.tolerance "Link to this definition")
    :   Color distances below this threshold are keyed

        Type:
        :   float in [0, 1], default 0.0

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.CompositorNodeDiffMatte.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.CompositorNodeDiffMatte.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.CompositorNodeDiffMatte.output_template "Link to this definition")
    ...
    update()[#](#bpy.types.CompositorNodeDiffMatte.update "Link to this definition")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.CompositorNodeDiffMatte.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.CompositorNodeDiffMatte.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CompositorNodeDiffMatte.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.CompositorNodeDiffMatte.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CompositorNodeDiffMatte(CompositorNode)
  + [`CompositorNodeDiffMatte`](#bpy.types.CompositorNodeDiffMatte)
    - [`CompositorNodeDiffMatte.falloff`](#bpy.types.CompositorNodeDiffMatte.falloff)
    - [`CompositorNodeDiffMatte.tolerance`](#bpy.types.CompositorNodeDiffMatte.tolerance)
    - [`CompositorNodeDiffMatte.is_registered_node_type()`](#bpy.types.CompositorNodeDiffMatte.is_registered_node_type)
    - [`CompositorNodeDiffMatte.input_template()`](#bpy.types.CompositorNodeDiffMatte.input_template)
    - [`CompositorNodeDiffMatte.output_template()`](#bpy.types.CompositorNodeDiffMatte.output_template)
    - [`CompositorNodeDiffMatte.update()`](#bpy.types.CompositorNodeDiffMatte.update)
    - [`CompositorNodeDiffMatte.bl_rna_get_subclass()`](#bpy.types.CompositorNodeDiffMatte.bl_rna_get_subclass)
    - [`CompositorNodeDiffMatte.bl_rna_get_subclass_py()`](#bpy.types.CompositorNodeDiffMatte.bl_rna_get_subclass_py)
