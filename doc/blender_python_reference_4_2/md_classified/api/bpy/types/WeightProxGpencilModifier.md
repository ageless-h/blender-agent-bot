...
# WeightProxGpencilModifier(GpencilModifier)[#](#weightproxgpencilmodifier-gpencilmodifier "Link to this heading")
...
*class* bpy.types.WeightProxGpencilModifier(*GpencilModifier*)[#](#bpy.types.WeightProxGpencilModifier "Link to this definition")
:   Calculate Vertex Weight dynamically

    distance\_end[#](#bpy.types.WeightProxGpencilModifier.distance_end "Link to this definition")
    :   Distance mapping to 1.0 weight

        Type:
        :   float in [0, inf], default 20.0

    distance\_start[#](#bpy.types.WeightProxGpencilModifier.distance_start "Link to this definition")
    :   Distance mapping to 0.0 weight

        Type:
        :   float in [0, inf], default 0.0

    invert\_layer\_pass[#](#bpy.types.WeightProxGpencilModifier.invert_layer_pass "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    invert\_layers[#](#bpy.types.WeightProxGpencilModifier.invert_layers "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    invert\_material\_pass[#](#bpy.types.WeightProxGpencilModifier.invert_material_pass "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    invert\_materials[#](#bpy.types.WeightProxGpencilModifier.invert_materials "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    invert\_vertex[#](#bpy.types.WeightProxGpencilModifier.invert_vertex "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    layer[#](#bpy.types.WeightProxGpencilModifier.layer "Link to this definition")
    :   Layer name

        Type:
        :   string, default “”, (never None)

    layer\_pass[#](#bpy.types.WeightProxGpencilModifier.layer_pass "Link to this definition")
    :   Layer pass index

        Type:
        :   int in [0, 100], default 0

    material[#](#bpy.types.WeightProxGpencilModifier.material "Link to this definition")
    :   Material used for filtering effect

        Type:
        :   [`Material`](Material.md#bpy.types.Material "bpy.types.Material")

    minimum\_weight[#](#bpy.types.WeightProxGpencilModifier.minimum_weight "Link to this definition")
    :   Minimum value for vertex weight

        Type:
        :   float in [0, 1], default 0.0

    object[#](#bpy.types.WeightProxGpencilModifier.object "Link to this definition")
    :   Object used as distance reference

        Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object")

    pass\_index[#](#bpy.types.WeightProxGpencilModifier.pass_index "Link to this definition")
    :   Pass index

        Type:
        :   int in [0, 100], default 0

    target\_vertex\_group[#](#bpy.types.WeightProxGpencilModifier.target_vertex_group "Link to this definition")
    :   Output Vertex group

        Type:
        :   string, default “”, (never None)

    use\_invert\_output[#](#bpy.types.WeightProxGpencilModifier.use_invert_output "Link to this definition")
    :   Invert output weight values

        Type:
        :   boolean, default False

    use\_multiply[#](#bpy.types.WeightProxGpencilModifier.use_multiply "Link to this definition")
    :   Multiply the calculated weights with the existing values in the vertex group

        Type:
        :   boolean, default False

    vertex\_group[#](#bpy.types.WeightProxGpencilModifier.vertex_group "Link to this definition")
    :   Vertex group name for modulating the deform

        Type:
        :   string, default “”, (never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.WeightProxGpencilModifier.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.WeightProxGpencilModifier.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.WeightProxGpencilModifier.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.WeightProxGpencilModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* WeightProxGpencilModifier(GpencilModifier)
  + [`WeightProxGpencilModifier`](#bpy.types.WeightProxGpencilModifier)
    - [`WeightProxGpencilModifier.distance_end`](#bpy.types.WeightProxGpencilModifier.distance_end)
    - [`WeightProxGpencilModifier.distance_start`](#bpy.types.WeightProxGpencilModifier.distance_start)
    - [`WeightProxGpencilModifier.invert_layer_pass`](#bpy.types.WeightProxGpencilModifier.invert_layer_pass)
    - [`WeightProxGpencilModifier.invert_layers`](#bpy.types.WeightProxGpencilModifier.invert_layers)
    - [`WeightProxGpencilModifier.invert_material_pass`](#bpy.types.WeightProxGpencilModifier.invert_material_pass)
    - [`WeightProxGpencilModifier.invert_materials`](#bpy.types.WeightProxGpencilModifier.invert_materials)
    - [`WeightProxGpencilModifier.invert_vertex`](#bpy.types.WeightProxGpencilModifier.invert_vertex)
    - [`WeightProxGpencilModifier.layer`](#bpy.types.WeightProxGpencilModifier.layer)
    - [`WeightProxGpencilModifier.layer_pass`](#bpy.types.WeightProxGpencilModifier.layer_pass)
    - [`WeightProxGpencilModifier.material`](#bpy.types.WeightProxGpencilModifier.material)
    - [`WeightProxGpencilModifier.minimum_weight`](#bpy.types.WeightProxGpencilModifier.minimum_weight)
    - [`WeightProxGpencilModifier.object`](#bpy.types.WeightProxGpencilModifier.object)
    - [`WeightProxGpencilModifier.pass_index`](#bpy.types.WeightProxGpencilModifier.pass_index)
    - [`WeightProxGpencilModifier.target_vertex_group`](#bpy.types.WeightProxGpencilModifier.target_vertex_group)
    - [`WeightProxGpencilModifier.use_invert_output`](#bpy.types.WeightProxGpencilModifier.use_invert_output)
    - [`WeightProxGpencilModifier.use_multiply`](#bpy.types.WeightProxGpencilModifier.use_multiply)
    - [`WeightProxGpencilModifier.vertex_group`](#bpy.types.WeightProxGpencilModifier.vertex_group)
    - [`WeightProxGpencilModifier.bl_rna_get_subclass()`](#bpy.types.WeightProxGpencilModifier.bl_rna_get_subclass)
    - [`WeightProxGpencilModifier.bl_rna_get_subclass_py()`](#bpy.types.WeightProxGpencilModifier.bl_rna_get_subclass_py)
