...
subclasses —
[`ActionConstraint`](ActionConstraint.md#bpy.types.ActionConstraint "bpy.types.ActionConstraint"), [`ArmatureConstraint`](ArmatureConstraint.md#bpy.types.ArmatureConstraint "bpy.types.ArmatureConstraint"), [`CameraSolverConstraint`](CameraSolverConstraint.md#bpy.types.CameraSolverConstraint "bpy.types.CameraSolverConstraint"), [`ChildOfConstraint`](ChildOfConstraint.md#bpy.types.ChildOfConstraint "bpy.types.ChildOfConstraint"), [`ClampToConstraint`](ClampToConstraint.md#bpy.types.ClampToConstraint "bpy.types.ClampToConstraint"), [`CopyLocationConstraint`](CopyLocationConstraint.md#bpy.types.CopyLocationConstraint "bpy.types.CopyLocationConstraint"), [`CopyRotationConstraint`](CopyRotationConstraint.md#bpy.types.CopyRotationConstraint "bpy.types.CopyRotationConstraint"), [`CopyScaleConstraint`](CopyScaleConstraint.md#bpy.types.CopyScaleConstraint "bpy.types.CopyScaleConstraint"), [`CopyTransformsConstraint`](CopyTransformsConstraint.md#bpy.types.CopyTransformsConstraint "bpy.types.CopyTransformsConstraint"), [`DampedTrackConstraint`](DampedTrackConstraint.md#bpy.types.DampedTrackConstraint "bpy.types.DampedTrackConstraint"), [`FloorConstraint`](FloorConstraint.md#bpy.types.FloorConstraint "bpy.types.FloorConstraint"), [`FollowPathConstraint`](FollowPathConstraint.md#bpy.types.FollowPathConstraint "bpy.types.FollowPathConstraint"), [`FollowTrackConstraint`](FollowTrackConstraint.md#bpy.types.FollowTrackConstraint "bpy.types.FollowTrackConstraint"), [`KinematicConstraint`](KinematicConstraint.md#bpy.types.KinematicConstraint "bpy.types.KinematicConstraint"), [`LimitDistanceConstraint`](LimitDistanceConstraint.md#bpy.types.LimitDistanceConstraint "bpy.types.LimitDistanceConstraint"), [`LimitLocationConstraint`](LimitLocationConstraint.md#bpy.types.LimitLocationConstraint "bpy.types.LimitLocationConstraint"), [`LimitRotationConstraint`](LimitRotationConstraint.md#bpy.types.LimitRotationConstraint "bpy.types.LimitRotationConstraint"), [`LimitScaleConstraint`](LimitScaleConstraint.md#bpy.types.LimitScaleConstraint "bpy.types.LimitScaleConstraint"), [`LockedTrackConstraint`](LockedTrackConstraint.md#bpy.types.LockedTrackConstraint "bpy.types.LockedTrackConstraint"), [`MaintainVolumeConstraint`](MaintainVolumeConstraint.md#bpy.types.MaintainVolumeConstraint "bpy.types.MaintainVolumeConstraint"), [`ObjectSolverConstraint`](ObjectSolverConstraint.md#bpy.types.ObjectSolverConstraint "bpy.types.ObjectSolverConstraint"), [`PivotConstraint`](PivotConstraint.md#bpy.types.PivotConstraint "bpy.types.PivotConstraint"), [`PythonConstraint`](PythonConstraint.md#bpy.types.PythonConstraint "bpy.types.PythonConstraint"), [`ShrinkwrapConstraint`](ShrinkwrapConstraint.md#bpy.types.ShrinkwrapConstraint "bpy.types.ShrinkwrapConstraint"), [`SplineIKConstraint`](SplineIKConstraint.md#bpy.types.SplineIKConstraint "bpy.types.SplineIKConstraint"), [`StretchToConstraint`](StretchToConstraint.md#bpy.types.StretchToConstraint "bpy.types.StretchToConstraint"), [`TrackToConstraint`](TrackToConstraint.md#bpy.types.TrackToConstraint "bpy.types.TrackToConstraint"), [`TransformCacheConstraint`](TransformCacheConstraint.md#bpy.types.TransformCacheConstraint "bpy.types.TransformCacheConstraint"), [`TransformConstraint`](TransformConstraint.md#bpy.types.TransformConstraint "bpy.types.TransformConstraint")
...
:   Constraint modifying the transformation of objects and bones
    ...
    :   Space that owner is evaluated in
        ...
        * `LOCAL`
        ...
        Type:
        :   enum in [‘WORLD’, ‘CUSTOM’, ‘POSE’, ‘LOCAL\_WITH\_PARENT’, ‘LOCAL’], default ‘WORLD’
    ...
    :   Space that target is evaluated in
        ...
        * `LOCAL_OWNER_ORIENT`
        ...
        Type:
        :   enum in [‘WORLD’, ‘CUSTOM’, ‘POSE’, ‘LOCAL\_WITH\_PARENT’, ‘LOCAL’, ‘LOCAL\_OWNER\_ORIENT’], default ‘WORLD’

    type[#](#bpy.types.Constraint.type "Link to this definition")
    :   Type:
        :   enum in [Constraint Type Items](../../../appendix/bpy_types_enum_items/constraint_type_items.md#rna-enum-constraint-type-items), default ‘CAMERA\_SOLVER’, (readonly)
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.Constraint.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.Constraint.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)
