...
# ShaderNodeTexWave(ShaderNode)[#](#shadernodetexwave-shadernode "Link to this heading")
...
*class* bpy.types.ShaderNodeTexWave(*ShaderNode*)[#](#bpy.types.ShaderNodeTexWave "Link to this definition")
:   Generate procedural bands or rings with noise

    bands\_direction[#](#bpy.types.ShaderNodeTexWave.bands_direction "Link to this definition")
    :   * `X`
    ...
    color\_mapping[#](#bpy.types.ShaderNodeTexWave.color_mapping "Link to this definition")
    :   Color mapping settings

        Type:
        :   [`ColorMapping`](ColorMapping.md#bpy.types.ColorMapping "bpy.types.ColorMapping"), (readonly, never None)

    rings\_direction[#](#bpy.types.ShaderNodeTexWave.rings_direction "Link to this definition")
    :   * `X`
    ...
    texture\_mapping[#](#bpy.types.ShaderNodeTexWave.texture_mapping "Link to this definition")
    :   Texture coordinate mapping settings

        Type:
        :   [`TexMapping`](TexMapping.md#bpy.types.TexMapping "bpy.types.TexMapping"), (readonly, never None)

    wave\_profile[#](#bpy.types.ShaderNodeTexWave.wave_profile "Link to this definition")
    :   * `SIN`
    ...
    wave\_type[#](#bpy.types.ShaderNodeTexWave.wave_type "Link to this definition")
    :   * `BANDS`
    ...
    *classmethod* is\_registered\_node\_type()[#](#bpy.types.ShaderNodeTexWave.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.ShaderNodeTexWave.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.ShaderNodeTexWave.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.ShaderNodeTexWave.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.ShaderNodeTexWave.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ShaderNodeTexWave.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.ShaderNodeTexWave.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ShaderNodeTexWave(ShaderNode)
  + [`ShaderNodeTexWave`](#bpy.types.ShaderNodeTexWave)
    - [`ShaderNodeTexWave.bands_direction`](#bpy.types.ShaderNodeTexWave.bands_direction)
    - [`ShaderNodeTexWave.color_mapping`](#bpy.types.ShaderNodeTexWave.color_mapping)
    - [`ShaderNodeTexWave.rings_direction`](#bpy.types.ShaderNodeTexWave.rings_direction)
    - [`ShaderNodeTexWave.texture_mapping`](#bpy.types.ShaderNodeTexWave.texture_mapping)
    - [`ShaderNodeTexWave.wave_profile`](#bpy.types.ShaderNodeTexWave.wave_profile)
    - [`ShaderNodeTexWave.wave_type`](#bpy.types.ShaderNodeTexWave.wave_type)
    - [`ShaderNodeTexWave.is_registered_node_type()`](#bpy.types.ShaderNodeTexWave.is_registered_node_type)
    - [`ShaderNodeTexWave.input_template()`](#bpy.types.ShaderNodeTexWave.input_template)
    - [`ShaderNodeTexWave.output_template()`](#bpy.types.ShaderNodeTexWave.output_template)
    - [`ShaderNodeTexWave.bl_rna_get_subclass()`](#bpy.types.ShaderNodeTexWave.bl_rna_get_subclass)
    - [`ShaderNodeTexWave.bl_rna_get_subclass_py()`](#bpy.types.ShaderNodeTexWave.bl_rna_get_subclass_py)
