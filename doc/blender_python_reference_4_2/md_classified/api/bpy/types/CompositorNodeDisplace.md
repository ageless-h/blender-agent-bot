...
# CompositorNodeDisplace(CompositorNode)[#](#compositornodedisplace-compositornode "Link to this heading")
...
*class* bpy.types.CompositorNodeDisplace(*CompositorNode*)[#](#bpy.types.CompositorNodeDisplace "Link to this definition")
:   Displace pixel position using an offset vector

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.CompositorNodeDisplace.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.CompositorNodeDisplace.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.CompositorNodeDisplace.output_template "Link to this definition")
    ...
    update()[#](#bpy.types.CompositorNodeDisplace.update "Link to this definition")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.CompositorNodeDisplace.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.CompositorNodeDisplace.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CompositorNodeDisplace.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.CompositorNodeDisplace.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CompositorNodeDisplace(CompositorNode)
  + [`CompositorNodeDisplace`](#bpy.types.CompositorNodeDisplace)
    - [`CompositorNodeDisplace.is_registered_node_type()`](#bpy.types.CompositorNodeDisplace.is_registered_node_type)
    - [`CompositorNodeDisplace.input_template()`](#bpy.types.CompositorNodeDisplace.input_template)
    - [`CompositorNodeDisplace.output_template()`](#bpy.types.CompositorNodeDisplace.output_template)
    - [`CompositorNodeDisplace.update()`](#bpy.types.CompositorNodeDisplace.update)
    - [`CompositorNodeDisplace.bl_rna_get_subclass()`](#bpy.types.CompositorNodeDisplace.bl_rna_get_subclass)
    - [`CompositorNodeDisplace.bl_rna_get_subclass_py()`](#bpy.types.CompositorNodeDisplace.bl_rna_get_subclass_py)
