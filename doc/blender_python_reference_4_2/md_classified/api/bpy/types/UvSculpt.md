...
# UvSculpt(Paint)[#](#uvsculpt-paint "Link to this heading")
...
*class* bpy.types.UvSculpt(*Paint*)[#](#bpy.types.UvSculpt "Link to this definition")
:   curve\_preset[#](#bpy.types.UvSculpt.curve_preset "Link to this definition")
    :   Type:
    ...
    size[#](#bpy.types.UvSculpt.size "Link to this definition")
    :   Type:
        :   int in [1, 5000], default 0

    strength[#](#bpy.types.UvSculpt.strength "Link to this definition")
    :   Type:
        :   float in [0, 1], default 0.0

    strength\_curve[#](#bpy.types.UvSculpt.strength_curve "Link to this definition")
    :   Type:
        :   [`CurveMapping`](CurveMapping.md#bpy.types.CurveMapping "bpy.types.CurveMapping"), (readonly)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.UvSculpt.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.UvSculpt.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`ToolSettings.uv_sculpt`](ToolSettings.md#bpy.types.ToolSettings.uv_sculpt "bpy.types.ToolSettings.uv_sculpt") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.UvSculpt.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.UvSculpt.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* UvSculpt(Paint)
  + [`UvSculpt`](#bpy.types.UvSculpt)
    - [`UvSculpt.curve_preset`](#bpy.types.UvSculpt.curve_preset)
    - [`UvSculpt.size`](#bpy.types.UvSculpt.size)
    - [`UvSculpt.strength`](#bpy.types.UvSculpt.strength)
    - [`UvSculpt.strength_curve`](#bpy.types.UvSculpt.strength_curve)
    - [`UvSculpt.bl_rna_get_subclass()`](#bpy.types.UvSculpt.bl_rna_get_subclass)
    - [`UvSculpt.bl_rna_get_subclass_py()`](#bpy.types.UvSculpt.bl_rna_get_subclass_py)
