...
:   Settings for input devices
    ...
    ndof\_pan\_yz\_swap\_axis[#](#bpy.types.PreferencesInput.ndof_pan_yz_swap_axis "Link to this definition")
    ...
    ndof\_show\_guide[#](#bpy.types.PreferencesInput.ndof_show_guide "Link to this definition")
    :   Display the center and axis during rotation

        Type:
        :   boolean, default False

    ndof\_view\_navigate\_method[#](#bpy.types.PreferencesInput.ndof_view_navigate_method "Link to this definition")
    ...
    ndof\_view\_rotate\_method[#](#bpy.types.PreferencesInput.ndof_view_rotate_method "Link to this definition")
    ...
    ndof\_zoom\_invert[#](#bpy.types.PreferencesInput.ndof_zoom_invert "Link to this definition")
    ...
    :   Select the tablet API to use for pressure sensitivity (may require restarting Blender for changes to take effect)
        ...
        * `WINTAB`
        ...
        Type:
        :   enum in [‘AUTOMATIC’, ‘WINDOWS\_INK’, ‘WINTAB’], default ‘AUTOMATIC’
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.PreferencesInput.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.PreferencesInput.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)
...
* PreferencesInput(bpy\_struct)
  + [`PreferencesInput`](#bpy.types.PreferencesInput)
    ...
    - [`PreferencesInput.ndof_pan_yz_swap_axis`](#bpy.types.PreferencesInput.ndof_pan_yz_swap_axis)
    ...
    - [`PreferencesInput.ndof_show_guide`](#bpy.types.PreferencesInput.ndof_show_guide)
    - [`PreferencesInput.ndof_view_navigate_method`](#bpy.types.PreferencesInput.ndof_view_navigate_method)
    - [`PreferencesInput.ndof_view_rotate_method`](#bpy.types.PreferencesInput.ndof_view_rotate_method)
    - [`PreferencesInput.ndof_zoom_invert`](#bpy.types.PreferencesInput.ndof_zoom_invert)
