...
# GeometryNodeSimulationInput(GeometryNode)[#](#geometrynodesimulationinput-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeSimulationInput(*GeometryNode*)[#](#bpy.types.GeometryNodeSimulationInput "Link to this definition")
:   Input data for the simulation zone

    paired\_output[#](#bpy.types.GeometryNodeSimulationInput.paired_output "Link to this definition")
    :   Zone output node that this input node is paired with

        Type:
        :   [`Node`](Node.md#bpy.types.Node "bpy.types.Node"), (readonly)

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.GeometryNodeSimulationInput.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.GeometryNodeSimulationInput.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.GeometryNodeSimulationInput.output_template "Link to this definition")
    ...
    pair\_with\_output(*output\_node*)[#](#bpy.types.GeometryNodeSimulationInput.pair_with_output "Link to this definition")
    :   Pair a zone input node with an output node.

        Parameters:
        :   **output\_node** ([`GeometryNode`](GeometryNode.md#bpy.types.GeometryNode "bpy.types.GeometryNode")) – Output Node, Zone output node to pair with
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.GeometryNodeSimulationInput.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.GeometryNodeSimulationInput.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeSimulationInput.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.GeometryNodeSimulationInput.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeSimulationInput(GeometryNode)
  + [`GeometryNodeSimulationInput`](#bpy.types.GeometryNodeSimulationInput)
    - [`GeometryNodeSimulationInput.paired_output`](#bpy.types.GeometryNodeSimulationInput.paired_output)
    - [`GeometryNodeSimulationInput.is_registered_node_type()`](#bpy.types.GeometryNodeSimulationInput.is_registered_node_type)
    - [`GeometryNodeSimulationInput.input_template()`](#bpy.types.GeometryNodeSimulationInput.input_template)
    - [`GeometryNodeSimulationInput.output_template()`](#bpy.types.GeometryNodeSimulationInput.output_template)
    - [`GeometryNodeSimulationInput.pair_with_output()`](#bpy.types.GeometryNodeSimulationInput.pair_with_output)
    - [`GeometryNodeSimulationInput.bl_rna_get_subclass()`](#bpy.types.GeometryNodeSimulationInput.bl_rna_get_subclass)
    - [`GeometryNodeSimulationInput.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeSimulationInput.bl_rna_get_subclass_py)
