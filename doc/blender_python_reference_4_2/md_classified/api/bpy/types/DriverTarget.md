...
:   Source of input values for driver variables
    ...
    :   Type of a context-dependent data-block to access property from
        ...
        * `ACTIVE_VIEW_LAYER`
        ...
        Type:
        :   enum in [‘ACTIVE\_SCENE’, ‘ACTIVE\_VIEW\_LAYER’], default ‘ACTIVE\_SCENE’
    ...
    :   Space in which transforms are used
        ...
        * `LOCAL_SPACE`
        ...
        Type:
        :   enum in [‘WORLD\_SPACE’, ‘TRANSFORM\_SPACE’, ‘LOCAL\_SPACE’], default ‘WORLD\_SPACE’

    transform\_type[#](#bpy.types.DriverTarget.transform_type "Link to this definition")
    :   Driver variable type

        Type:
        :   enum in [‘LOC\_X’, ‘LOC\_Y’, ‘LOC\_Z’, ‘ROT\_X’, ‘ROT\_Y’, ‘ROT\_Z’, ‘ROT\_W’, ‘SCALE\_X’, ‘SCALE\_Y’, ‘SCALE\_Z’, ‘SCALE\_AVG’], default ‘LOC\_X’
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.DriverTarget.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.DriverTarget.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)
