...
# CompositorNodeAlphaOver(CompositorNode)[#](#compositornodealphaover-compositornode "Link to this heading")
...
*class* bpy.types.CompositorNodeAlphaOver(*CompositorNode*)[#](#bpy.types.CompositorNodeAlphaOver "Link to this definition")
:   Overlay a foreground image onto a background image

    premul[#](#bpy.types.CompositorNodeAlphaOver.premul "Link to this definition")
    :   Mix Factor

        Type:
        :   float in [0, 1], default 0.0

    use\_premultiply[#](#bpy.types.CompositorNodeAlphaOver.use_premultiply "Link to this definition")
    :   Type:
        :   boolean, default False

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.CompositorNodeAlphaOver.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.CompositorNodeAlphaOver.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.CompositorNodeAlphaOver.output_template "Link to this definition")
    ...
    update()[#](#bpy.types.CompositorNodeAlphaOver.update "Link to this definition")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.CompositorNodeAlphaOver.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.CompositorNodeAlphaOver.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CompositorNodeAlphaOver.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.CompositorNodeAlphaOver.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CompositorNodeAlphaOver(CompositorNode)
  + [`CompositorNodeAlphaOver`](#bpy.types.CompositorNodeAlphaOver)
    - [`CompositorNodeAlphaOver.premul`](#bpy.types.CompositorNodeAlphaOver.premul)
    - [`CompositorNodeAlphaOver.use_premultiply`](#bpy.types.CompositorNodeAlphaOver.use_premultiply)
    - [`CompositorNodeAlphaOver.is_registered_node_type()`](#bpy.types.CompositorNodeAlphaOver.is_registered_node_type)
    - [`CompositorNodeAlphaOver.input_template()`](#bpy.types.CompositorNodeAlphaOver.input_template)
    - [`CompositorNodeAlphaOver.output_template()`](#bpy.types.CompositorNodeAlphaOver.output_template)
    - [`CompositorNodeAlphaOver.update()`](#bpy.types.CompositorNodeAlphaOver.update)
    - [`CompositorNodeAlphaOver.bl_rna_get_subclass()`](#bpy.types.CompositorNodeAlphaOver.bl_rna_get_subclass)
    - [`CompositorNodeAlphaOver.bl_rna_get_subclass_py()`](#bpy.types.CompositorNodeAlphaOver.bl_rna_get_subclass_py)
