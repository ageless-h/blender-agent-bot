...
# CompositorNodeEllipseMask(CompositorNode)[#](#compositornodeellipsemask-compositornode "Link to this heading")
...
*class* bpy.types.CompositorNodeEllipseMask(*CompositorNode*)[#](#bpy.types.CompositorNodeEllipseMask "Link to this definition")
:   Create elliptical mask suitable for use as a simple matte or vignette mask

    mask\_height[#](#bpy.types.CompositorNodeEllipseMask.mask_height "Link to this definition")
    :   Height of the ellipse

        Type:
        :   float in [0, 2], default 0.2

    mask\_type[#](#bpy.types.CompositorNodeEllipseMask.mask_type "Link to this definition")
    :   Type:
        :   enum in [‘ADD’, ‘SUBTRACT’, ‘MULTIPLY’, ‘NOT’], default ‘ADD’

    mask\_width[#](#bpy.types.CompositorNodeEllipseMask.mask_width "Link to this definition")
    :   Width of the ellipse

        Type:
        :   float in [0, 2], default 0.3

    rotation[#](#bpy.types.CompositorNodeEllipseMask.rotation "Link to this definition")
    :   Rotation angle of the ellipse

        Type:
        :   float in [-31.4159, 31.4159], default 0.0

    x[#](#bpy.types.CompositorNodeEllipseMask.x "Link to this definition")
    :   X position of the middle of the ellipse

        Type:
        :   float in [-1, 2], default 0.5

    y[#](#bpy.types.CompositorNodeEllipseMask.y "Link to this definition")
    :   Y position of the middle of the ellipse

        Type:
        :   float in [-1, 2], default 0.5

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.CompositorNodeEllipseMask.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.CompositorNodeEllipseMask.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.CompositorNodeEllipseMask.output_template "Link to this definition")
    ...
    update()[#](#bpy.types.CompositorNodeEllipseMask.update "Link to this definition")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.CompositorNodeEllipseMask.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.CompositorNodeEllipseMask.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CompositorNodeEllipseMask.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.CompositorNodeEllipseMask.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CompositorNodeEllipseMask(CompositorNode)
  + [`CompositorNodeEllipseMask`](#bpy.types.CompositorNodeEllipseMask)
    - [`CompositorNodeEllipseMask.mask_height`](#bpy.types.CompositorNodeEllipseMask.mask_height)
    - [`CompositorNodeEllipseMask.mask_type`](#bpy.types.CompositorNodeEllipseMask.mask_type)
    - [`CompositorNodeEllipseMask.mask_width`](#bpy.types.CompositorNodeEllipseMask.mask_width)
    - [`CompositorNodeEllipseMask.rotation`](#bpy.types.CompositorNodeEllipseMask.rotation)
    - [`CompositorNodeEllipseMask.x`](#bpy.types.CompositorNodeEllipseMask.x)
    - [`CompositorNodeEllipseMask.y`](#bpy.types.CompositorNodeEllipseMask.y)
    - [`CompositorNodeEllipseMask.is_registered_node_type()`](#bpy.types.CompositorNodeEllipseMask.is_registered_node_type)
    - [`CompositorNodeEllipseMask.input_template()`](#bpy.types.CompositorNodeEllipseMask.input_template)
    - [`CompositorNodeEllipseMask.output_template()`](#bpy.types.CompositorNodeEllipseMask.output_template)
    - [`CompositorNodeEllipseMask.update()`](#bpy.types.CompositorNodeEllipseMask.update)
    - [`CompositorNodeEllipseMask.bl_rna_get_subclass()`](#bpy.types.CompositorNodeEllipseMask.bl_rna_get_subclass)
    - [`CompositorNodeEllipseMask.bl_rna_get_subclass_py()`](#bpy.types.CompositorNodeEllipseMask.bl_rna_get_subclass_py)
