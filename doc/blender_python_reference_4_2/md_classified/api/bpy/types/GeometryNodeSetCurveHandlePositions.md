...
# GeometryNodeSetCurveHandlePositions(GeometryNode)[#](#geometrynodesetcurvehandlepositions-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeSetCurveHandlePositions(*GeometryNode*)[#](#bpy.types.GeometryNodeSetCurveHandlePositions "Link to this definition")
:   Set the positions for the handles of Bézier curves

    mode[#](#bpy.types.GeometryNodeSetCurveHandlePositions.mode "Link to this definition")
    :   Whether to update left and right handles

        Type:
        :   enum in [Node Geometry Curve Handle Side Items](../../../appendix/bpy_types_enum_items/node_geometry_curve_handle_side_items.md#rna-enum-node-geometry-curve-handle-side-items), default ‘LEFT’

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.GeometryNodeSetCurveHandlePositions.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.GeometryNodeSetCurveHandlePositions.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.GeometryNodeSetCurveHandlePositions.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.GeometryNodeSetCurveHandlePositions.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.GeometryNodeSetCurveHandlePositions.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeSetCurveHandlePositions.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.GeometryNodeSetCurveHandlePositions.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeSetCurveHandlePositions(GeometryNode)
  + [`GeometryNodeSetCurveHandlePositions`](#bpy.types.GeometryNodeSetCurveHandlePositions)
    - [`GeometryNodeSetCurveHandlePositions.mode`](#bpy.types.GeometryNodeSetCurveHandlePositions.mode)
    - [`GeometryNodeSetCurveHandlePositions.is_registered_node_type()`](#bpy.types.GeometryNodeSetCurveHandlePositions.is_registered_node_type)
    - [`GeometryNodeSetCurveHandlePositions.input_template()`](#bpy.types.GeometryNodeSetCurveHandlePositions.input_template)
    - [`GeometryNodeSetCurveHandlePositions.output_template()`](#bpy.types.GeometryNodeSetCurveHandlePositions.output_template)
    - [`GeometryNodeSetCurveHandlePositions.bl_rna_get_subclass()`](#bpy.types.GeometryNodeSetCurveHandlePositions.bl_rna_get_subclass)
    - [`GeometryNodeSetCurveHandlePositions.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeSetCurveHandlePositions.bl_rna_get_subclass_py)
