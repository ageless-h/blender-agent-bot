...
:   Lock motion to the target path
    ...
    :   Axis that points forward along the path
        ...
        Type:
        :   enum in [‘FORWARD\_X’, ‘FORWARD\_Y’, ‘FORWARD\_Z’, ‘TRACK\_NEGATIVE\_X’, ‘TRACK\_NEGATIVE\_Y’, ‘TRACK\_NEGATIVE\_Z’], default ‘FORWARD\_X’
    ...
    :   Axis that points upward
        ...
        Type:
        :   enum in [‘UP\_X’, ‘UP\_Y’, ‘UP\_Z’], default ‘UP\_X’
