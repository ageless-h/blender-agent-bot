...
# OpacityGpencilModifier(GpencilModifier)[#](#opacitygpencilmodifier-gpencilmodifier "Link to this heading")
...
*class* bpy.types.OpacityGpencilModifier(*GpencilModifier*)[#](#bpy.types.OpacityGpencilModifier "Link to this definition")
:   Opacity of Strokes modifier

    curve[#](#bpy.types.OpacityGpencilModifier.curve "Link to this definition")
    :   Custom curve to apply effect

        Type:
        :   [`CurveMapping`](CurveMapping.md#bpy.types.CurveMapping "bpy.types.CurveMapping"), (readonly)

    factor[#](#bpy.types.OpacityGpencilModifier.factor "Link to this definition")
    :   Factor of Opacity

        Type:
        :   float in [-inf, inf], default 1.0

    hardness[#](#bpy.types.OpacityGpencilModifier.hardness "Link to this definition")
    :   Factor of stroke hardness

        Type:
        :   float in [0, inf], default 1.0

    invert\_layer\_pass[#](#bpy.types.OpacityGpencilModifier.invert_layer_pass "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    invert\_layers[#](#bpy.types.OpacityGpencilModifier.invert_layers "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    invert\_material\_pass[#](#bpy.types.OpacityGpencilModifier.invert_material_pass "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    invert\_materials[#](#bpy.types.OpacityGpencilModifier.invert_materials "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    invert\_vertex[#](#bpy.types.OpacityGpencilModifier.invert_vertex "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    layer[#](#bpy.types.OpacityGpencilModifier.layer "Link to this definition")
    :   Layer name

        Type:
        :   string, default “”, (never None)

    layer\_pass[#](#bpy.types.OpacityGpencilModifier.layer_pass "Link to this definition")
    :   Layer pass index

        Type:
        :   int in [0, 100], default 0

    material[#](#bpy.types.OpacityGpencilModifier.material "Link to this definition")
    :   Material used for filtering effect

        Type:
        :   [`Material`](Material.md#bpy.types.Material "bpy.types.Material")

    modify\_color[#](#bpy.types.OpacityGpencilModifier.modify_color "Link to this definition")
    ...
    pass\_index[#](#bpy.types.OpacityGpencilModifier.pass_index "Link to this definition")
    :   Pass index

        Type:
        :   int in [0, 100], default 0

    use\_custom\_curve[#](#bpy.types.OpacityGpencilModifier.use_custom_curve "Link to this definition")
    :   Use a custom curve to define opacity effect along the strokes

        Type:
        :   boolean, default False

    use\_normalized\_opacity[#](#bpy.types.OpacityGpencilModifier.use_normalized_opacity "Link to this definition")
    :   Replace the stroke opacity

        Type:
        :   boolean, default False

    use\_weight\_factor[#](#bpy.types.OpacityGpencilModifier.use_weight_factor "Link to this definition")
    :   Use weight to modulate effect

        Type:
        :   boolean, default False

    vertex\_group[#](#bpy.types.OpacityGpencilModifier.vertex_group "Link to this definition")
    :   Vertex group name for modulating the deform

        Type:
        :   string, default “”, (never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.OpacityGpencilModifier.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.OpacityGpencilModifier.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.OpacityGpencilModifier.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.OpacityGpencilModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* OpacityGpencilModifier(GpencilModifier)
  + [`OpacityGpencilModifier`](#bpy.types.OpacityGpencilModifier)
    - [`OpacityGpencilModifier.curve`](#bpy.types.OpacityGpencilModifier.curve)
    - [`OpacityGpencilModifier.factor`](#bpy.types.OpacityGpencilModifier.factor)
    - [`OpacityGpencilModifier.hardness`](#bpy.types.OpacityGpencilModifier.hardness)
    - [`OpacityGpencilModifier.invert_layer_pass`](#bpy.types.OpacityGpencilModifier.invert_layer_pass)
    - [`OpacityGpencilModifier.invert_layers`](#bpy.types.OpacityGpencilModifier.invert_layers)
    - [`OpacityGpencilModifier.invert_material_pass`](#bpy.types.OpacityGpencilModifier.invert_material_pass)
    - [`OpacityGpencilModifier.invert_materials`](#bpy.types.OpacityGpencilModifier.invert_materials)
    - [`OpacityGpencilModifier.invert_vertex`](#bpy.types.OpacityGpencilModifier.invert_vertex)
    - [`OpacityGpencilModifier.layer`](#bpy.types.OpacityGpencilModifier.layer)
    - [`OpacityGpencilModifier.layer_pass`](#bpy.types.OpacityGpencilModifier.layer_pass)
    - [`OpacityGpencilModifier.material`](#bpy.types.OpacityGpencilModifier.material)
    - [`OpacityGpencilModifier.modify_color`](#bpy.types.OpacityGpencilModifier.modify_color)
    - [`OpacityGpencilModifier.pass_index`](#bpy.types.OpacityGpencilModifier.pass_index)
    - [`OpacityGpencilModifier.use_custom_curve`](#bpy.types.OpacityGpencilModifier.use_custom_curve)
    - [`OpacityGpencilModifier.use_normalized_opacity`](#bpy.types.OpacityGpencilModifier.use_normalized_opacity)
    - [`OpacityGpencilModifier.use_weight_factor`](#bpy.types.OpacityGpencilModifier.use_weight_factor)
    - [`OpacityGpencilModifier.vertex_group`](#bpy.types.OpacityGpencilModifier.vertex_group)
    - [`OpacityGpencilModifier.bl_rna_get_subclass()`](#bpy.types.OpacityGpencilModifier.bl_rna_get_subclass)
    - [`OpacityGpencilModifier.bl_rna_get_subclass_py()`](#bpy.types.OpacityGpencilModifier.bl_rna_get_subclass_py)
