...
# SmoothGpencilModifier(GpencilModifier)[#](#smoothgpencilmodifier-gpencilmodifier "Link to this heading")
...
*class* bpy.types.SmoothGpencilModifier(*GpencilModifier*)[#](#bpy.types.SmoothGpencilModifier "Link to this definition")
:   Smooth effect modifier

    curve[#](#bpy.types.SmoothGpencilModifier.curve "Link to this definition")
    :   Custom curve to apply effect

        Type:
        :   [`CurveMapping`](CurveMapping.md#bpy.types.CurveMapping "bpy.types.CurveMapping"), (readonly)

    factor[#](#bpy.types.SmoothGpencilModifier.factor "Link to this definition")
    :   Amount of smooth to apply

        Type:
        :   float in [0, 1], default 1.0

    invert\_layer\_pass[#](#bpy.types.SmoothGpencilModifier.invert_layer_pass "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    invert\_layers[#](#bpy.types.SmoothGpencilModifier.invert_layers "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    invert\_material\_pass[#](#bpy.types.SmoothGpencilModifier.invert_material_pass "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    invert\_materials[#](#bpy.types.SmoothGpencilModifier.invert_materials "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    invert\_vertex[#](#bpy.types.SmoothGpencilModifier.invert_vertex "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    layer[#](#bpy.types.SmoothGpencilModifier.layer "Link to this definition")
    :   Layer name

        Type:
        :   string, default “”, (never None)

    layer\_pass[#](#bpy.types.SmoothGpencilModifier.layer_pass "Link to this definition")
    :   Layer pass index

        Type:
        :   int in [0, 100], default 0

    material[#](#bpy.types.SmoothGpencilModifier.material "Link to this definition")
    :   Material used for filtering effect

        Type:
        :   [`Material`](Material.md#bpy.types.Material "bpy.types.Material")

    pass\_index[#](#bpy.types.SmoothGpencilModifier.pass_index "Link to this definition")
    :   Pass index

        Type:
        :   int in [0, 100], default 0

    step[#](#bpy.types.SmoothGpencilModifier.step "Link to this definition")
    :   Number of times to apply smooth (high numbers can reduce fps)

        Type:
        :   int in [1, 1000], default 1

    use\_custom\_curve[#](#bpy.types.SmoothGpencilModifier.use_custom_curve "Link to this definition")
    :   Use a custom curve to define smooth effect along the strokes

        Type:
        :   boolean, default False

    use\_edit\_position[#](#bpy.types.SmoothGpencilModifier.use_edit_position "Link to this definition")
    :   The modifier affects the position of the point

        Type:
        :   boolean, default True

    use\_edit\_strength[#](#bpy.types.SmoothGpencilModifier.use_edit_strength "Link to this definition")
    :   The modifier affects the color strength of the point

        Type:
        :   boolean, default False

    use\_edit\_thickness[#](#bpy.types.SmoothGpencilModifier.use_edit_thickness "Link to this definition")
    :   The modifier affects the thickness of the point

        Type:
        :   boolean, default False

    use\_edit\_uv[#](#bpy.types.SmoothGpencilModifier.use_edit_uv "Link to this definition")
    :   The modifier affects the UV rotation factor of the point

        Type:
        :   boolean, default False

    use\_keep\_shape[#](#bpy.types.SmoothGpencilModifier.use_keep_shape "Link to this definition")
    :   Smooth the details, but keep the overall shape

        Type:
        :   boolean, default False

    vertex\_group[#](#bpy.types.SmoothGpencilModifier.vertex_group "Link to this definition")
    :   Vertex group name for modulating the deform

        Type:
        :   string, default “”, (never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.SmoothGpencilModifier.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.SmoothGpencilModifier.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.SmoothGpencilModifier.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.SmoothGpencilModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* SmoothGpencilModifier(GpencilModifier)
  + [`SmoothGpencilModifier`](#bpy.types.SmoothGpencilModifier)
    - [`SmoothGpencilModifier.curve`](#bpy.types.SmoothGpencilModifier.curve)
    - [`SmoothGpencilModifier.factor`](#bpy.types.SmoothGpencilModifier.factor)
    - [`SmoothGpencilModifier.invert_layer_pass`](#bpy.types.SmoothGpencilModifier.invert_layer_pass)
    - [`SmoothGpencilModifier.invert_layers`](#bpy.types.SmoothGpencilModifier.invert_layers)
    - [`SmoothGpencilModifier.invert_material_pass`](#bpy.types.SmoothGpencilModifier.invert_material_pass)
    - [`SmoothGpencilModifier.invert_materials`](#bpy.types.SmoothGpencilModifier.invert_materials)
    - [`SmoothGpencilModifier.invert_vertex`](#bpy.types.SmoothGpencilModifier.invert_vertex)
    - [`SmoothGpencilModifier.layer`](#bpy.types.SmoothGpencilModifier.layer)
    - [`SmoothGpencilModifier.layer_pass`](#bpy.types.SmoothGpencilModifier.layer_pass)
    - [`SmoothGpencilModifier.material`](#bpy.types.SmoothGpencilModifier.material)
    - [`SmoothGpencilModifier.pass_index`](#bpy.types.SmoothGpencilModifier.pass_index)
    - [`SmoothGpencilModifier.step`](#bpy.types.SmoothGpencilModifier.step)
    - [`SmoothGpencilModifier.use_custom_curve`](#bpy.types.SmoothGpencilModifier.use_custom_curve)
    - [`SmoothGpencilModifier.use_edit_position`](#bpy.types.SmoothGpencilModifier.use_edit_position)
    - [`SmoothGpencilModifier.use_edit_strength`](#bpy.types.SmoothGpencilModifier.use_edit_strength)
    - [`SmoothGpencilModifier.use_edit_thickness`](#bpy.types.SmoothGpencilModifier.use_edit_thickness)
    - [`SmoothGpencilModifier.use_edit_uv`](#bpy.types.SmoothGpencilModifier.use_edit_uv)
    - [`SmoothGpencilModifier.use_keep_shape`](#bpy.types.SmoothGpencilModifier.use_keep_shape)
    - [`SmoothGpencilModifier.vertex_group`](#bpy.types.SmoothGpencilModifier.vertex_group)
    - [`SmoothGpencilModifier.bl_rna_get_subclass()`](#bpy.types.SmoothGpencilModifier.bl_rna_get_subclass)
    - [`SmoothGpencilModifier.bl_rna_get_subclass_py()`](#bpy.types.SmoothGpencilModifier.bl_rna_get_subclass_py)
