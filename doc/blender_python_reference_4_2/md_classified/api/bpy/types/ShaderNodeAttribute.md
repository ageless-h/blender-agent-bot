...
# ShaderNodeAttribute(ShaderNode)[#](#shadernodeattribute-shadernode "Link to this heading")
...
*class* bpy.types.ShaderNodeAttribute(*ShaderNode*)[#](#bpy.types.ShaderNodeAttribute "Link to this definition")
:   Retrieve attributes attached to objects or geometry

    attribute\_name[#](#bpy.types.ShaderNodeAttribute.attribute_name "Link to this definition")
    :   Type:
        :   string, default “”, (never None)

    attribute\_type[#](#bpy.types.ShaderNodeAttribute.attribute_type "Link to this definition")
    :   General type of the attribute
        ...
        * `VIEW_LAYER`
        ...
        Type:
        :   enum in [‘GEOMETRY’, ‘OBJECT’, ‘INSTANCER’, ‘VIEW\_LAYER’], default ‘GEOMETRY’

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.ShaderNodeAttribute.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.ShaderNodeAttribute.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.ShaderNodeAttribute.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.ShaderNodeAttribute.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.ShaderNodeAttribute.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ShaderNodeAttribute.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.ShaderNodeAttribute.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ShaderNodeAttribute(ShaderNode)
  + [`ShaderNodeAttribute`](#bpy.types.ShaderNodeAttribute)
    - [`ShaderNodeAttribute.attribute_name`](#bpy.types.ShaderNodeAttribute.attribute_name)
    - [`ShaderNodeAttribute.attribute_type`](#bpy.types.ShaderNodeAttribute.attribute_type)
    - [`ShaderNodeAttribute.is_registered_node_type()`](#bpy.types.ShaderNodeAttribute.is_registered_node_type)
    - [`ShaderNodeAttribute.input_template()`](#bpy.types.ShaderNodeAttribute.input_template)
    - [`ShaderNodeAttribute.output_template()`](#bpy.types.ShaderNodeAttribute.output_template)
    - [`ShaderNodeAttribute.bl_rna_get_subclass()`](#bpy.types.ShaderNodeAttribute.bl_rna_get_subclass)
    - [`ShaderNodeAttribute.bl_rna_get_subclass_py()`](#bpy.types.ShaderNodeAttribute.bl_rna_get_subclass_py)
