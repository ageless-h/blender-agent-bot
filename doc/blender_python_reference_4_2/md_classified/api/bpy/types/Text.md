...
:   Text data-block referencing an external or packed text file
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.Text.bl_rna_get_subclass_py "Link to this definition")
    ...
    :   Parameters:
        :   **range** (*Two pairs* *of* *ints*) – The region of text to be returned, defaulting to the selection when no range is passed.
...
|  |  |
| --- | --- |
| * [`bpy.context.edit_text`](../context/index.md#bpy.context.edit_text "bpy.context.edit_text") * [`BlendData.texts`](BlendData.md#bpy.types.BlendData.texts "bpy.types.BlendData.texts") * [`BlendDataTexts.load`](BlendDataTexts.md#bpy.types.BlendDataTexts.load "bpy.types.BlendDataTexts.load") * [`BlendDataTexts.new`](BlendDataTexts.md#bpy.types.BlendDataTexts.new "bpy.types.BlendDataTexts.new") * [`BlendDataTexts.remove`](BlendDataTexts.md#bpy.types.BlendDataTexts.remove "bpy.types.BlendDataTexts.remove") * [`FreestyleModuleSettings.script`](FreestyleModuleSettings.md#bpy.types.FreestyleModuleSettings.script "bpy.types.FreestyleModuleSettings.script") | * [`NodeFrame.text`](NodeFrame.md#bpy.types.NodeFrame.text "bpy.types.NodeFrame.text") * [`PythonConstraint.text`](PythonConstraint.md#bpy.types.PythonConstraint.text "bpy.types.PythonConstraint.text") * [`ShaderNodeScript.script`](ShaderNodeScript.md#bpy.types.ShaderNodeScript.script "bpy.types.ShaderNodeScript.script") * [`ShaderNodeTexIES.ies`](ShaderNodeTexIES.md#bpy.types.ShaderNodeTexIES.ies "bpy.types.ShaderNodeTexIES.ies") * [`SpaceTextEditor.text`](SpaceTextEditor.md#bpy.types.SpaceTextEditor.text "bpy.types.SpaceTextEditor.text") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.Text.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.Text.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)
