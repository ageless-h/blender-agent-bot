...
# GeometryNodeSampleIndex(GeometryNode)[#](#geometrynodesampleindex-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeSampleIndex(*GeometryNode*)[#](#bpy.types.GeometryNodeSampleIndex "Link to this definition")
:   Retrieve values from specific geometry elements

    clamp[#](#bpy.types.GeometryNodeSampleIndex.clamp "Link to this definition")
    :   Clamp the indices to the size of the attribute domain instead of outputting a default value for invalid indices

        Type:
        :   boolean, default False

    data\_type[#](#bpy.types.GeometryNodeSampleIndex.data_type "Link to this definition")
    :   Type:
    ...
    domain[#](#bpy.types.GeometryNodeSampleIndex.domain "Link to this definition")
    :   Type:
    ...
    *classmethod* is\_registered\_node\_type()[#](#bpy.types.GeometryNodeSampleIndex.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.GeometryNodeSampleIndex.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.GeometryNodeSampleIndex.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.GeometryNodeSampleIndex.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.GeometryNodeSampleIndex.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeSampleIndex.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.GeometryNodeSampleIndex.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeSampleIndex(GeometryNode)
  + [`GeometryNodeSampleIndex`](#bpy.types.GeometryNodeSampleIndex)
    - [`GeometryNodeSampleIndex.clamp`](#bpy.types.GeometryNodeSampleIndex.clamp)
    - [`GeometryNodeSampleIndex.data_type`](#bpy.types.GeometryNodeSampleIndex.data_type)
    - [`GeometryNodeSampleIndex.domain`](#bpy.types.GeometryNodeSampleIndex.domain)
    - [`GeometryNodeSampleIndex.is_registered_node_type()`](#bpy.types.GeometryNodeSampleIndex.is_registered_node_type)
    - [`GeometryNodeSampleIndex.input_template()`](#bpy.types.GeometryNodeSampleIndex.input_template)
    - [`GeometryNodeSampleIndex.output_template()`](#bpy.types.GeometryNodeSampleIndex.output_template)
    - [`GeometryNodeSampleIndex.bl_rna_get_subclass()`](#bpy.types.GeometryNodeSampleIndex.bl_rna_get_subclass)
    - [`GeometryNodeSampleIndex.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeSampleIndex.bl_rna_get_subclass_py)
