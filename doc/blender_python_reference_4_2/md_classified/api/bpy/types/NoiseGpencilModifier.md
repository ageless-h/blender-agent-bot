...
# NoiseGpencilModifier(GpencilModifier)[#](#noisegpencilmodifier-gpencilmodifier "Link to this heading")
...
*class* bpy.types.NoiseGpencilModifier(*GpencilModifier*)[#](#bpy.types.NoiseGpencilModifier "Link to this definition")
:   Noise effect modifier

    curve[#](#bpy.types.NoiseGpencilModifier.curve "Link to this definition")
    :   Custom curve to apply effect

        Type:
        :   [`CurveMapping`](CurveMapping.md#bpy.types.CurveMapping "bpy.types.CurveMapping"), (readonly)

    factor[#](#bpy.types.NoiseGpencilModifier.factor "Link to this definition")
    :   Amount of noise to apply

        Type:
        :   float in [0, inf], default 0.5

    factor\_strength[#](#bpy.types.NoiseGpencilModifier.factor_strength "Link to this definition")
    :   Amount of noise to apply to opacity

        Type:
        :   float in [0, inf], default 0.0

    factor\_thickness[#](#bpy.types.NoiseGpencilModifier.factor_thickness "Link to this definition")
    :   Amount of noise to apply to thickness

        Type:
        :   float in [0, inf], default 0.0

    factor\_uvs[#](#bpy.types.NoiseGpencilModifier.factor_uvs "Link to this definition")
    :   Amount of noise to apply to UV rotation

        Type:
        :   float in [0, inf], default 0.0

    invert\_layer\_pass[#](#bpy.types.NoiseGpencilModifier.invert_layer_pass "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    invert\_layers[#](#bpy.types.NoiseGpencilModifier.invert_layers "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    invert\_material\_pass[#](#bpy.types.NoiseGpencilModifier.invert_material_pass "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    invert\_materials[#](#bpy.types.NoiseGpencilModifier.invert_materials "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    invert\_vertex[#](#bpy.types.NoiseGpencilModifier.invert_vertex "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    layer[#](#bpy.types.NoiseGpencilModifier.layer "Link to this definition")
    :   Layer name

        Type:
        :   string, default “”, (never None)

    layer\_pass[#](#bpy.types.NoiseGpencilModifier.layer_pass "Link to this definition")
    :   Layer pass index

        Type:
        :   int in [0, 100], default 0

    material[#](#bpy.types.NoiseGpencilModifier.material "Link to this definition")
    :   Material used for filtering effect

        Type:
        :   [`Material`](Material.md#bpy.types.Material "bpy.types.Material")

    noise\_offset[#](#bpy.types.NoiseGpencilModifier.noise_offset "Link to this definition")
    :   Offset the noise along the strokes

        Type:
        :   float in [0, inf], default 0.0

    noise\_scale[#](#bpy.types.NoiseGpencilModifier.noise_scale "Link to this definition")
    :   Scale the noise frequency

        Type:
        :   float in [0, 1], default 0.0

    pass\_index[#](#bpy.types.NoiseGpencilModifier.pass_index "Link to this definition")
    :   Pass index

        Type:
        :   int in [0, 100], default 0

    random\_mode[#](#bpy.types.NoiseGpencilModifier.random_mode "Link to this definition")
    ...
    seed[#](#bpy.types.NoiseGpencilModifier.seed "Link to this definition")
    :   Random seed

        Type:
        :   int in [0, inf], default 1

    step[#](#bpy.types.NoiseGpencilModifier.step "Link to this definition")
    :   Number of frames between randomization steps

        Type:
        :   int in [1, 100], default 4

    use\_custom\_curve[#](#bpy.types.NoiseGpencilModifier.use_custom_curve "Link to this definition")
    :   Use a custom curve to define noise effect along the strokes

        Type:
        :   boolean, default False

    use\_random[#](#bpy.types.NoiseGpencilModifier.use_random "Link to this definition")
    :   Use random values over time

        Type:
        :   boolean, default True

    vertex\_group[#](#bpy.types.NoiseGpencilModifier.vertex_group "Link to this definition")
    :   Vertex group name for modulating the deform

        Type:
        :   string, default “”, (never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.NoiseGpencilModifier.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.NoiseGpencilModifier.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.NoiseGpencilModifier.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.NoiseGpencilModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* NoiseGpencilModifier(GpencilModifier)
  + [`NoiseGpencilModifier`](#bpy.types.NoiseGpencilModifier)
    - [`NoiseGpencilModifier.curve`](#bpy.types.NoiseGpencilModifier.curve)
    - [`NoiseGpencilModifier.factor`](#bpy.types.NoiseGpencilModifier.factor)
    - [`NoiseGpencilModifier.factor_strength`](#bpy.types.NoiseGpencilModifier.factor_strength)
    - [`NoiseGpencilModifier.factor_thickness`](#bpy.types.NoiseGpencilModifier.factor_thickness)
    - [`NoiseGpencilModifier.factor_uvs`](#bpy.types.NoiseGpencilModifier.factor_uvs)
    - [`NoiseGpencilModifier.invert_layer_pass`](#bpy.types.NoiseGpencilModifier.invert_layer_pass)
    - [`NoiseGpencilModifier.invert_layers`](#bpy.types.NoiseGpencilModifier.invert_layers)
    - [`NoiseGpencilModifier.invert_material_pass`](#bpy.types.NoiseGpencilModifier.invert_material_pass)
    - [`NoiseGpencilModifier.invert_materials`](#bpy.types.NoiseGpencilModifier.invert_materials)
    - [`NoiseGpencilModifier.invert_vertex`](#bpy.types.NoiseGpencilModifier.invert_vertex)
    - [`NoiseGpencilModifier.layer`](#bpy.types.NoiseGpencilModifier.layer)
    - [`NoiseGpencilModifier.layer_pass`](#bpy.types.NoiseGpencilModifier.layer_pass)
    - [`NoiseGpencilModifier.material`](#bpy.types.NoiseGpencilModifier.material)
    - [`NoiseGpencilModifier.noise_offset`](#bpy.types.NoiseGpencilModifier.noise_offset)
    - [`NoiseGpencilModifier.noise_scale`](#bpy.types.NoiseGpencilModifier.noise_scale)
    - [`NoiseGpencilModifier.pass_index`](#bpy.types.NoiseGpencilModifier.pass_index)
    - [`NoiseGpencilModifier.random_mode`](#bpy.types.NoiseGpencilModifier.random_mode)
    - [`NoiseGpencilModifier.seed`](#bpy.types.NoiseGpencilModifier.seed)
    - [`NoiseGpencilModifier.step`](#bpy.types.NoiseGpencilModifier.step)
    - [`NoiseGpencilModifier.use_custom_curve`](#bpy.types.NoiseGpencilModifier.use_custom_curve)
    - [`NoiseGpencilModifier.use_random`](#bpy.types.NoiseGpencilModifier.use_random)
    - [`NoiseGpencilModifier.vertex_group`](#bpy.types.NoiseGpencilModifier.vertex_group)
    - [`NoiseGpencilModifier.bl_rna_get_subclass()`](#bpy.types.NoiseGpencilModifier.bl_rna_get_subclass)
    - [`NoiseGpencilModifier.bl_rna_get_subclass_py()`](#bpy.types.NoiseGpencilModifier.bl_rna_get_subclass_py)
