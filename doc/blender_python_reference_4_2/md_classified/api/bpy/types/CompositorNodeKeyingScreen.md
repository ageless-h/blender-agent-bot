...
# CompositorNodeKeyingScreen(CompositorNode)[#](#compositornodekeyingscreen-compositornode "Link to this heading")
...
*class* bpy.types.CompositorNodeKeyingScreen(*CompositorNode*)[#](#bpy.types.CompositorNodeKeyingScreen "Link to this definition")
:   Create plates for use as a color reference for keying nodes

    clip[#](#bpy.types.CompositorNodeKeyingScreen.clip "Link to this definition")
    :   Type:
        :   [`MovieClip`](MovieClip.md#bpy.types.MovieClip "bpy.types.MovieClip")

    smoothness[#](#bpy.types.CompositorNodeKeyingScreen.smoothness "Link to this definition")
    :   Type:
        :   float in [0, 1], default 0.0

    tracking\_object[#](#bpy.types.CompositorNodeKeyingScreen.tracking_object "Link to this definition")
    :   Type:
        :   string, default “”, (never None)

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.CompositorNodeKeyingScreen.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.CompositorNodeKeyingScreen.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.CompositorNodeKeyingScreen.output_template "Link to this definition")
    ...
    update()[#](#bpy.types.CompositorNodeKeyingScreen.update "Link to this definition")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.CompositorNodeKeyingScreen.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.CompositorNodeKeyingScreen.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CompositorNodeKeyingScreen.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.CompositorNodeKeyingScreen.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CompositorNodeKeyingScreen(CompositorNode)
  + [`CompositorNodeKeyingScreen`](#bpy.types.CompositorNodeKeyingScreen)
    - [`CompositorNodeKeyingScreen.clip`](#bpy.types.CompositorNodeKeyingScreen.clip)
    - [`CompositorNodeKeyingScreen.smoothness`](#bpy.types.CompositorNodeKeyingScreen.smoothness)
    - [`CompositorNodeKeyingScreen.tracking_object`](#bpy.types.CompositorNodeKeyingScreen.tracking_object)
    - [`CompositorNodeKeyingScreen.is_registered_node_type()`](#bpy.types.CompositorNodeKeyingScreen.is_registered_node_type)
    - [`CompositorNodeKeyingScreen.input_template()`](#bpy.types.CompositorNodeKeyingScreen.input_template)
    - [`CompositorNodeKeyingScreen.output_template()`](#bpy.types.CompositorNodeKeyingScreen.output_template)
    - [`CompositorNodeKeyingScreen.update()`](#bpy.types.CompositorNodeKeyingScreen.update)
    - [`CompositorNodeKeyingScreen.bl_rna_get_subclass()`](#bpy.types.CompositorNodeKeyingScreen.bl_rna_get_subclass)
    - [`CompositorNodeKeyingScreen.bl_rna_get_subclass_py()`](#bpy.types.CompositorNodeKeyingScreen.bl_rna_get_subclass_py)
