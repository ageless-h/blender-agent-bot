...
:   Collection of related sketches on a particular frame
    ...
    is\_edited[#](#bpy.types.GPencilFrame.is_edited "Link to this definition")
    :   Frame is being edited (painted on)

        Type:
        :   boolean, default False

    keyframe\_type[#](#bpy.types.GPencilFrame.keyframe_type "Link to this definition")
    :   Type of keyframe
        ...
        * `GENERATED`
        ...
        Type:
        :   enum in [‘KEYFRAME’, ‘BREAKDOWN’, ‘MOVING\_HOLD’, ‘EXTREME’, ‘JITTER’, ‘GENERATED’], default ‘KEYFRAME’
    ...
    :   Freehand curves defining the sketch on this frame
        ...
        Type:
        :   [`GPencilStrokes`](GPencilStrokes.md#bpy.types.GPencilStrokes "bpy.types.GPencilStrokes") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`GPencilStroke`](GPencilStroke.md#bpy.types.GPencilStroke "bpy.types.GPencilStroke"), (readonly)

    clear()[#](#bpy.types.GPencilFrame.clear "Link to this definition")
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GPencilFrame.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.GPencilFrame.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)
...
* GPencilFrame(bpy\_struct)
  + [`GPencilFrame`](#bpy.types.GPencilFrame)
    ...
    - [`GPencilFrame.is_edited`](#bpy.types.GPencilFrame.is_edited)
    - [`GPencilFrame.keyframe_type`](#bpy.types.GPencilFrame.keyframe_type)
    - [`GPencilFrame.select`](#bpy.types.GPencilFrame.select)
    - [`GPencilFrame.strokes`](#bpy.types.GPencilFrame.strokes)
    - [`GPencilFrame.clear()`](#bpy.types.GPencilFrame.clear)
