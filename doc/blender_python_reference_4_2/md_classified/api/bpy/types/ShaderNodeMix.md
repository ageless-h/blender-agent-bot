...
# ShaderNodeMix(ShaderNode)[#](#shadernodemix-shadernode "Link to this heading")
...
*class* bpy.types.ShaderNodeMix(*ShaderNode*)[#](#bpy.types.ShaderNodeMix "Link to this definition")
:   Mix values by a factor

    blend\_type[#](#bpy.types.ShaderNodeMix.blend_type "Link to this definition")
    :   Type:
        :   enum in [Ramp Blend Items](../../../appendix/bpy_types_enum_items/ramp_blend_items.md#rna-enum-ramp-blend-items), default ‘MIX’

    clamp\_factor[#](#bpy.types.ShaderNodeMix.clamp_factor "Link to this definition")
    :   Clamp the factor to [0,1] range

        Type:
        :   boolean, default False

    clamp\_result[#](#bpy.types.ShaderNodeMix.clamp_result "Link to this definition")
    :   Clamp the result to [0,1] range

        Type:
        :   boolean, default False

    data\_type[#](#bpy.types.ShaderNodeMix.data_type "Link to this definition")
    :   Type:
        :   enum in [‘FLOAT’, ‘VECTOR’, ‘RGBA’, ‘ROTATION’], default ‘FLOAT’

    factor\_mode[#](#bpy.types.ShaderNodeMix.factor_mode "Link to this definition")
    :   * `UNIFORM`
        ...
        * `NON_UNIFORM`
        ...
        Type:
        :   enum in [‘UNIFORM’, ‘NON\_UNIFORM’], default ‘UNIFORM’

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.ShaderNodeMix.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.ShaderNodeMix.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.ShaderNodeMix.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.ShaderNodeMix.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.ShaderNodeMix.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ShaderNodeMix.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.ShaderNodeMix.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ShaderNodeMix(ShaderNode)
  + [`ShaderNodeMix`](#bpy.types.ShaderNodeMix)
    - [`ShaderNodeMix.blend_type`](#bpy.types.ShaderNodeMix.blend_type)
    - [`ShaderNodeMix.clamp_factor`](#bpy.types.ShaderNodeMix.clamp_factor)
    - [`ShaderNodeMix.clamp_result`](#bpy.types.ShaderNodeMix.clamp_result)
    - [`ShaderNodeMix.data_type`](#bpy.types.ShaderNodeMix.data_type)
    - [`ShaderNodeMix.factor_mode`](#bpy.types.ShaderNodeMix.factor_mode)
    - [`ShaderNodeMix.is_registered_node_type()`](#bpy.types.ShaderNodeMix.is_registered_node_type)
    - [`ShaderNodeMix.input_template()`](#bpy.types.ShaderNodeMix.input_template)
    - [`ShaderNodeMix.output_template()`](#bpy.types.ShaderNodeMix.output_template)
    - [`ShaderNodeMix.bl_rna_get_subclass()`](#bpy.types.ShaderNodeMix.bl_rna_get_subclass)
    - [`ShaderNodeMix.bl_rna_get_subclass_py()`](#bpy.types.ShaderNodeMix.bl_rna_get_subclass_py)
