...
# CompositorNodeChromaMatte(CompositorNode)[#](#compositornodechromamatte-compositornode "Link to this heading")
...
*class* bpy.types.CompositorNodeChromaMatte(*CompositorNode*)[#](#bpy.types.CompositorNodeChromaMatte "Link to this definition")
:   Create matte based on chroma values

    gain[#](#bpy.types.CompositorNodeChromaMatte.gain "Link to this definition")
    :   Alpha falloff

        Type:
        :   float in [0, 1], default 0.0

    lift[#](#bpy.types.CompositorNodeChromaMatte.lift "Link to this definition")
    :   Alpha lift

        Type:
        :   float in [0, 1], default 0.0

    shadow\_adjust[#](#bpy.types.CompositorNodeChromaMatte.shadow_adjust "Link to this definition")
    :   Adjusts the brightness of any shadows captured

        Type:
        :   float in [0, 1], default 0.0

    threshold[#](#bpy.types.CompositorNodeChromaMatte.threshold "Link to this definition")
    :   Tolerance below which colors will be considered as exact matches

        Type:
        :   float in [0, 0.523599], default 0.0

    tolerance[#](#bpy.types.CompositorNodeChromaMatte.tolerance "Link to this definition")
    :   Tolerance for a color to be considered a keying color

        Type:
        :   float in [0.0174533, 1.39626], default 0.0

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.CompositorNodeChromaMatte.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.CompositorNodeChromaMatte.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.CompositorNodeChromaMatte.output_template "Link to this definition")
    ...
    update()[#](#bpy.types.CompositorNodeChromaMatte.update "Link to this definition")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.CompositorNodeChromaMatte.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.CompositorNodeChromaMatte.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CompositorNodeChromaMatte.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.CompositorNodeChromaMatte.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CompositorNodeChromaMatte(CompositorNode)
  + [`CompositorNodeChromaMatte`](#bpy.types.CompositorNodeChromaMatte)
    - [`CompositorNodeChromaMatte.gain`](#bpy.types.CompositorNodeChromaMatte.gain)
    - [`CompositorNodeChromaMatte.lift`](#bpy.types.CompositorNodeChromaMatte.lift)
    - [`CompositorNodeChromaMatte.shadow_adjust`](#bpy.types.CompositorNodeChromaMatte.shadow_adjust)
    - [`CompositorNodeChromaMatte.threshold`](#bpy.types.CompositorNodeChromaMatte.threshold)
    - [`CompositorNodeChromaMatte.tolerance`](#bpy.types.CompositorNodeChromaMatte.tolerance)
    - [`CompositorNodeChromaMatte.is_registered_node_type()`](#bpy.types.CompositorNodeChromaMatte.is_registered_node_type)
    - [`CompositorNodeChromaMatte.input_template()`](#bpy.types.CompositorNodeChromaMatte.input_template)
    - [`CompositorNodeChromaMatte.output_template()`](#bpy.types.CompositorNodeChromaMatte.output_template)
    - [`CompositorNodeChromaMatte.update()`](#bpy.types.CompositorNodeChromaMatte.update)
    - [`CompositorNodeChromaMatte.bl_rna_get_subclass()`](#bpy.types.CompositorNodeChromaMatte.bl_rna_get_subclass)
    - [`CompositorNodeChromaMatte.bl_rna_get_subclass_py()`](#bpy.types.CompositorNodeChromaMatte.bl_rna_get_subclass_py)
