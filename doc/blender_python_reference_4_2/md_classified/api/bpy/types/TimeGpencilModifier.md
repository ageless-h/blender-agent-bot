...
# TimeGpencilModifier(GpencilModifier)[#](#timegpencilmodifier-gpencilmodifier "Link to this heading")
...
*class* bpy.types.TimeGpencilModifier(*GpencilModifier*)[#](#bpy.types.TimeGpencilModifier "Link to this definition")
:   Time offset modifier

    frame\_end[#](#bpy.types.TimeGpencilModifier.frame_end "Link to this definition")
    :   Final frame of the range

        Type:
        :   int in [0, 1048574], default 250

    frame\_scale[#](#bpy.types.TimeGpencilModifier.frame_scale "Link to this definition")
    :   Evaluation time in seconds

        Type:
        :   float in [0.001, 100], default 1.0

    frame\_start[#](#bpy.types.TimeGpencilModifier.frame_start "Link to this definition")
    :   First frame of the range

        Type:
        :   int in [0, 1048574], default 1

    invert\_layer\_pass[#](#bpy.types.TimeGpencilModifier.invert_layer_pass "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    invert\_layers[#](#bpy.types.TimeGpencilModifier.invert_layers "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    layer[#](#bpy.types.TimeGpencilModifier.layer "Link to this definition")
    :   Layer name

        Type:
        :   string, default “”, (never None)

    layer\_pass[#](#bpy.types.TimeGpencilModifier.layer_pass "Link to this definition")
    :   Layer pass index

        Type:
        :   int in [0, 100], default 0

    mode[#](#bpy.types.TimeGpencilModifier.mode "Link to this definition")
    :   * `NORMAL`
    ...
    offset[#](#bpy.types.TimeGpencilModifier.offset "Link to this definition")
    :   Number of frames to offset original keyframe number or frame to fix

        Type:
        :   int in [-32768, 32767], default 1

    segment\_active\_index[#](#bpy.types.TimeGpencilModifier.segment_active_index "Link to this definition")
    :   Active index in the segment list

        Type:
        :   int in [0, inf], default 0

    segments[#](#bpy.types.TimeGpencilModifier.segments "Link to this definition")
    :   Type:
        :   [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`TimeGpencilModifierSegment`](TimeGpencilModifierSegment.md#bpy.types.TimeGpencilModifierSegment "bpy.types.TimeGpencilModifierSegment"), (readonly)

    use\_custom\_frame\_range[#](#bpy.types.TimeGpencilModifier.use_custom_frame_range "Link to this definition")
    :   Define a custom range of frames to use in modifier

        Type:
        :   boolean, default False

    use\_keep\_loop[#](#bpy.types.TimeGpencilModifier.use_keep_loop "Link to this definition")
    :   Retiming end frames and move to start of animation to keep loop

        Type:
        :   boolean, default True

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.TimeGpencilModifier.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.TimeGpencilModifier.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.TimeGpencilModifier.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.TimeGpencilModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* TimeGpencilModifier(GpencilModifier)
  + [`TimeGpencilModifier`](#bpy.types.TimeGpencilModifier)
    - [`TimeGpencilModifier.frame_end`](#bpy.types.TimeGpencilModifier.frame_end)
    - [`TimeGpencilModifier.frame_scale`](#bpy.types.TimeGpencilModifier.frame_scale)
    - [`TimeGpencilModifier.frame_start`](#bpy.types.TimeGpencilModifier.frame_start)
    - [`TimeGpencilModifier.invert_layer_pass`](#bpy.types.TimeGpencilModifier.invert_layer_pass)
    - [`TimeGpencilModifier.invert_layers`](#bpy.types.TimeGpencilModifier.invert_layers)
    - [`TimeGpencilModifier.layer`](#bpy.types.TimeGpencilModifier.layer)
    - [`TimeGpencilModifier.layer_pass`](#bpy.types.TimeGpencilModifier.layer_pass)
    - [`TimeGpencilModifier.mode`](#bpy.types.TimeGpencilModifier.mode)
    - [`TimeGpencilModifier.offset`](#bpy.types.TimeGpencilModifier.offset)
    - [`TimeGpencilModifier.segment_active_index`](#bpy.types.TimeGpencilModifier.segment_active_index)
    - [`TimeGpencilModifier.segments`](#bpy.types.TimeGpencilModifier.segments)
    - [`TimeGpencilModifier.use_custom_frame_range`](#bpy.types.TimeGpencilModifier.use_custom_frame_range)
    - [`TimeGpencilModifier.use_keep_loop`](#bpy.types.TimeGpencilModifier.use_keep_loop)
    - [`TimeGpencilModifier.bl_rna_get_subclass()`](#bpy.types.TimeGpencilModifier.bl_rna_get_subclass)
    - [`TimeGpencilModifier.bl_rna_get_subclass_py()`](#bpy.types.TimeGpencilModifier.bl_rna_get_subclass_py)
