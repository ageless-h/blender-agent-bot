...
# LatticeGpencilModifier(GpencilModifier)[#](#latticegpencilmodifier-gpencilmodifier "Link to this heading")
...
*class* bpy.types.LatticeGpencilModifier(*GpencilModifier*)[#](#bpy.types.LatticeGpencilModifier "Link to this definition")
:   Deform strokes using a lattice object

    invert\_layer\_pass[#](#bpy.types.LatticeGpencilModifier.invert_layer_pass "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    invert\_layers[#](#bpy.types.LatticeGpencilModifier.invert_layers "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    invert\_material\_pass[#](#bpy.types.LatticeGpencilModifier.invert_material_pass "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    invert\_materials[#](#bpy.types.LatticeGpencilModifier.invert_materials "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    invert\_vertex[#](#bpy.types.LatticeGpencilModifier.invert_vertex "Link to this definition")
    :   Inverse filter

        Type:
        :   boolean, default False

    layer[#](#bpy.types.LatticeGpencilModifier.layer "Link to this definition")
    :   Layer name

        Type:
        :   string, default “”, (never None)

    layer\_pass[#](#bpy.types.LatticeGpencilModifier.layer_pass "Link to this definition")
    :   Layer pass index

        Type:
        :   int in [0, 100], default 0

    material[#](#bpy.types.LatticeGpencilModifier.material "Link to this definition")
    :   Material used for filtering effect

        Type:
        :   [`Material`](Material.md#bpy.types.Material "bpy.types.Material")

    object[#](#bpy.types.LatticeGpencilModifier.object "Link to this definition")
    :   Lattice object to deform with

        Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object")

    pass\_index[#](#bpy.types.LatticeGpencilModifier.pass_index "Link to this definition")
    :   Pass index

        Type:
        :   int in [0, 100], default 0

    strength[#](#bpy.types.LatticeGpencilModifier.strength "Link to this definition")
    :   Strength of modifier effect

        Type:
        :   float in [-inf, inf], default 1.0

    vertex\_group[#](#bpy.types.LatticeGpencilModifier.vertex_group "Link to this definition")
    :   Vertex group name for modulating the deform

        Type:
        :   string, default “”, (never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.LatticeGpencilModifier.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.LatticeGpencilModifier.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.LatticeGpencilModifier.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.LatticeGpencilModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* LatticeGpencilModifier(GpencilModifier)
  + [`LatticeGpencilModifier`](#bpy.types.LatticeGpencilModifier)
    - [`LatticeGpencilModifier.invert_layer_pass`](#bpy.types.LatticeGpencilModifier.invert_layer_pass)
    - [`LatticeGpencilModifier.invert_layers`](#bpy.types.LatticeGpencilModifier.invert_layers)
    - [`LatticeGpencilModifier.invert_material_pass`](#bpy.types.LatticeGpencilModifier.invert_material_pass)
    - [`LatticeGpencilModifier.invert_materials`](#bpy.types.LatticeGpencilModifier.invert_materials)
    - [`LatticeGpencilModifier.invert_vertex`](#bpy.types.LatticeGpencilModifier.invert_vertex)
    - [`LatticeGpencilModifier.layer`](#bpy.types.LatticeGpencilModifier.layer)
    - [`LatticeGpencilModifier.layer_pass`](#bpy.types.LatticeGpencilModifier.layer_pass)
    - [`LatticeGpencilModifier.material`](#bpy.types.LatticeGpencilModifier.material)
    - [`LatticeGpencilModifier.object`](#bpy.types.LatticeGpencilModifier.object)
    - [`LatticeGpencilModifier.pass_index`](#bpy.types.LatticeGpencilModifier.pass_index)
    - [`LatticeGpencilModifier.strength`](#bpy.types.LatticeGpencilModifier.strength)
    - [`LatticeGpencilModifier.vertex_group`](#bpy.types.LatticeGpencilModifier.vertex_group)
    - [`LatticeGpencilModifier.bl_rna_get_subclass()`](#bpy.types.LatticeGpencilModifier.bl_rna_get_subclass)
    - [`LatticeGpencilModifier.bl_rna_get_subclass_py()`](#bpy.types.LatticeGpencilModifier.bl_rna_get_subclass_py)
