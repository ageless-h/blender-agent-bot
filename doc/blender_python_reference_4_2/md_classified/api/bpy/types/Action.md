...
:   A collection of F-Curves for animation
    ...
    fcurves[#](#bpy.types.Action.fcurves "Link to this definition")
    :   The individual F-Curves that make up the action

        Type:
        :   [`ActionFCurves`](ActionFCurves.md#bpy.types.ActionFCurves "bpy.types.ActionFCurves") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`FCurve`](FCurve.md#bpy.types.FCurve "bpy.types.FCurve"), (readonly)
    ...
    groups[#](#bpy.types.Action.groups "Link to this definition")
    :   Convenient groupings of F-Curves

        Type:
        :   [`ActionGroups`](ActionGroups.md#bpy.types.ActionGroups "bpy.types.ActionGroups") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`ActionGroup`](ActionGroup.md#bpy.types.ActionGroup "bpy.types.ActionGroup"), (readonly)

    id\_root[#](#bpy.types.Action.id_root "Link to this definition")
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.Action.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.Action.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)
...
* Action(ID)
  + [`Action`](#bpy.types.Action)
    ...
    - [`Action.fcurves`](#bpy.types.Action.fcurves)
    ...
    - [`Action.groups`](#bpy.types.Action.groups)
    - [`Action.id_root`](#bpy.types.Action.id_root)
