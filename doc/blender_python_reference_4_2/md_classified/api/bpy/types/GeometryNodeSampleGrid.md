...
# GeometryNodeSampleGrid(GeometryNode)[#](#geometrynodesamplegrid-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeSampleGrid(*GeometryNode*)[#](#bpy.types.GeometryNodeSampleGrid "Link to this definition")
:   data\_type[#](#bpy.types.GeometryNodeSampleGrid.data_type "Link to this definition")
    ...
    interpolation\_mode[#](#bpy.types.GeometryNodeSampleGrid.interpolation_mode "Link to this definition")
    :   How to interpolate the values between neighboring voxels

        Type:
        :   enum in [‘NEAREST’, ‘TRILINEAR’, ‘TRIQUADRATIC’], default ‘TRILINEAR’

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.GeometryNodeSampleGrid.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.GeometryNodeSampleGrid.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.GeometryNodeSampleGrid.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.GeometryNodeSampleGrid.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.GeometryNodeSampleGrid.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeSampleGrid.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.GeometryNodeSampleGrid.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeSampleGrid(GeometryNode)
  + [`GeometryNodeSampleGrid`](#bpy.types.GeometryNodeSampleGrid)
    - [`GeometryNodeSampleGrid.data_type`](#bpy.types.GeometryNodeSampleGrid.data_type)
    - [`GeometryNodeSampleGrid.interpolation_mode`](#bpy.types.GeometryNodeSampleGrid.interpolation_mode)
    - [`GeometryNodeSampleGrid.is_registered_node_type()`](#bpy.types.GeometryNodeSampleGrid.is_registered_node_type)
    - [`GeometryNodeSampleGrid.input_template()`](#bpy.types.GeometryNodeSampleGrid.input_template)
    - [`GeometryNodeSampleGrid.output_template()`](#bpy.types.GeometryNodeSampleGrid.output_template)
    - [`GeometryNodeSampleGrid.bl_rna_get_subclass()`](#bpy.types.GeometryNodeSampleGrid.bl_rna_get_subclass)
    - [`GeometryNodeSampleGrid.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeSampleGrid.bl_rna_get_subclass_py)
