...
# FunctionNodeSeparateColor(FunctionNode)[#](#functionnodeseparatecolor-functionnode "Link to this heading")
...
*class* bpy.types.FunctionNodeSeparateColor(*FunctionNode*)[#](#bpy.types.FunctionNodeSeparateColor "Link to this definition")
:   mode[#](#bpy.types.FunctionNodeSeparateColor.mode "Link to this definition")
    :   Mode of color processing

        Type:
        :   enum in [Node Combsep Color Items](../../../appendix/bpy_types_enum_items/node_combsep_color_items.md#rna-enum-node-combsep-color-items), default ‘RGB’

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.FunctionNodeSeparateColor.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.FunctionNodeSeparateColor.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.FunctionNodeSeparateColor.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.FunctionNodeSeparateColor.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.FunctionNodeSeparateColor.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.FunctionNodeSeparateColor.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.FunctionNodeSeparateColor.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* FunctionNodeSeparateColor(FunctionNode)
  + [`FunctionNodeSeparateColor`](#bpy.types.FunctionNodeSeparateColor)
    - [`FunctionNodeSeparateColor.mode`](#bpy.types.FunctionNodeSeparateColor.mode)
    - [`FunctionNodeSeparateColor.is_registered_node_type()`](#bpy.types.FunctionNodeSeparateColor.is_registered_node_type)
    - [`FunctionNodeSeparateColor.input_template()`](#bpy.types.FunctionNodeSeparateColor.input_template)
    - [`FunctionNodeSeparateColor.output_template()`](#bpy.types.FunctionNodeSeparateColor.output_template)
    - [`FunctionNodeSeparateColor.bl_rna_get_subclass()`](#bpy.types.FunctionNodeSeparateColor.bl_rna_get_subclass)
    - [`FunctionNodeSeparateColor.bl_rna_get_subclass_py()`](#bpy.types.FunctionNodeSeparateColor.bl_rna_get_subclass_py)
