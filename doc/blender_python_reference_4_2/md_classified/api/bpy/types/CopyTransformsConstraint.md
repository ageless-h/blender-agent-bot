...
:   Copy all the transforms of the target
    ...
    :   Specify how the copied and existing transformations are combined
        ...
        * `AFTER_SPLIT`
        ...
        Type:
        :   enum in [‘REPLACE’, ‘BEFORE\_FULL’, ‘BEFORE’, ‘BEFORE\_SPLIT’, ‘AFTER\_FULL’, ‘AFTER’, ‘AFTER\_SPLIT’], default ‘REPLACE’
