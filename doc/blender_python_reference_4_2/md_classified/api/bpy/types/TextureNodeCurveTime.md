...
# TextureNodeCurveTime(TextureNode)[#](#texturenodecurvetime-texturenode "Link to this heading")
...
*class* bpy.types.TextureNodeCurveTime(*TextureNode*)[#](#bpy.types.TextureNodeCurveTime "Link to this definition")
:   curve[#](#bpy.types.TextureNodeCurveTime.curve "Link to this definition")
    :   Type:
        :   [`CurveMapping`](CurveMapping.md#bpy.types.CurveMapping "bpy.types.CurveMapping"), (readonly)

    frame\_end[#](#bpy.types.TextureNodeCurveTime.frame_end "Link to this definition")
    :   Type:
        :   int in [-32768, 32767], default 0

    frame\_start[#](#bpy.types.TextureNodeCurveTime.frame_start "Link to this definition")
    :   Type:
        :   int in [-32768, 32767], default 0

    *classmethod* is\_registered\_node\_type()[#](#bpy.types.TextureNodeCurveTime.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[#](#bpy.types.TextureNodeCurveTime.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[#](#bpy.types.TextureNodeCurveTime.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*)[#](#bpy.types.TextureNodeCurveTime.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*)[#](#bpy.types.TextureNodeCurveTime.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*string*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.TextureNodeCurveTime.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.types.TextureNodeCurveTime.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* TextureNodeCurveTime(TextureNode)
  + [`TextureNodeCurveTime`](#bpy.types.TextureNodeCurveTime)
    - [`TextureNodeCurveTime.curve`](#bpy.types.TextureNodeCurveTime.curve)
    - [`TextureNodeCurveTime.frame_end`](#bpy.types.TextureNodeCurveTime.frame_end)
    - [`TextureNodeCurveTime.frame_start`](#bpy.types.TextureNodeCurveTime.frame_start)
    - [`TextureNodeCurveTime.is_registered_node_type()`](#bpy.types.TextureNodeCurveTime.is_registered_node_type)
    - [`TextureNodeCurveTime.input_template()`](#bpy.types.TextureNodeCurveTime.input_template)
    - [`TextureNodeCurveTime.output_template()`](#bpy.types.TextureNodeCurveTime.output_template)
    - [`TextureNodeCurveTime.bl_rna_get_subclass()`](#bpy.types.TextureNodeCurveTime.bl_rna_get_subclass)
    - [`TextureNodeCurveTime.bl_rna_get_subclass_py()`](#bpy.types.TextureNodeCurveTime.bl_rna_get_subclass_py)
