...
# bpy.utils submodule (bpy.utils.units)[#](#module-bpy.utils.units "Link to this heading")

This module contains some data/methods regarding units handling.

bpy.utils.units.categories[#](#bpy.utils.units.categories "Link to this definition")
:   Constant value bpy.utils.units.categories(NONE=’NONE’, LENGTH=’LENGTH’, AREA=’AREA’, VOLUME=’VOLUME’, MASS=’MASS’, ROTATION=’ROTATION’, TIME=’TIME’, TIME\_ABSOLUTE=’TIME\_ABSOLUTE’, VELOCITY=’VELOCITY’, ACCELERATION=’ACCELERATION’, CAMERA=’CAMERA’, POWER=’POWER’, TEMPERATURE=’TEMPERATURE’, WAVELENGTH=’WAVELENGTH’)

bpy.utils.units.systems[#](#bpy.utils.units.systems "Link to this definition")
:   Constant value bpy.utils.units.systems(NONE=’NONE’, METRIC=’METRIC’, IMPERIAL=’IMPERIAL’)

bpy.utils.units.to\_string(*unit\_system*, *unit\_category*, *value*, *precision=3*, *split\_unit=False*, *compatible\_unit=False*)[#](#bpy.utils.units.to_string "Link to this definition")
:   Convert a given input float value into a string with units.

    Parameters:
    :   * **unit\_system** (*string*) – The unit system, from [`bpy.utils.units.systems`](#bpy.utils.units.systems "bpy.utils.units.systems").
        * **unit\_category** (*string*) – The category of data we are converting (length, area, rotation, etc.),
          from [`bpy.utils.units.categories`](#bpy.utils.units.categories "bpy.utils.units.categories").
        * **value** (*float*) – The value to convert to a string.
        * **precision** (*int*) – Number of digits after the comma.
        * **split\_unit** (*bool*) – Whether to use several units if needed (1m1cm), or always only one (1.01m).
        * **compatible\_unit** (*bool*) – Whether to use keyboard-friendly units (1m2) or nicer utf-8 ones (1m²).
...
bpy.utils.units.to\_value(*unit\_system*, *unit\_category*, *str\_input*, *str\_ref\_unit=None*)[#](#bpy.utils.units.to_value "Link to this definition")
:   Convert a given input string into a float value.
    ...
    :   * **unit\_system** (*string*) – The unit system, from [`bpy.utils.units.systems`](#bpy.utils.units.systems "bpy.utils.units.systems").
        * **unit\_category** (*string*) – The category of data we are converting (length, area, rotation, etc.),
          from [`bpy.utils.units.categories`](#bpy.utils.units.categories "bpy.utils.units.categories").
        * **str\_input** (*string*) – The string to convert to a float value.
        * **str\_ref\_unit** (*string* *or* *None*) – A reference string from which to extract a default unit, if none is found in `str_input`.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.utils.units.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.utils.units.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* bpy.utils submodule (bpy.utils.units)
  + [`categories`](#bpy.utils.units.categories)
  + [`systems`](#bpy.utils.units.systems)
  + [`to_string()`](#bpy.utils.units.to_string)
  + [`to_value()`](#bpy.utils.units.to_value)