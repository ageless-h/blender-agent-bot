...
# Cachefile Operators[#](#module-bpy.ops.cachefile "Link to this heading")

bpy.ops.cachefile.layer\_add(*filepath=''*, *hide\_props\_region=True*, *check\_existing=False*, *filter\_blender=False*, *filter\_backup=False*, *filter\_image=False*, *filter\_movie=False*, *filter\_python=False*, *filter\_font=False*, *filter\_sound=False*, *filter\_text=False*, *filter\_archive=False*, *filter\_btx=False*, *filter\_collada=False*, *filter\_alembic=True*, *filter\_usd=True*, *filter\_obj=False*, *filter\_volume=False*, *filter\_folder=True*, *filter\_blenlib=False*, *filemode=8*, *relative\_path=True*, *display\_type='DEFAULT'*, *sort\_method=''*)[#](#bpy.ops.cachefile.layer_add "Link to this definition")
...
bpy.ops.cachefile.layer\_move(*direction='UP'*)[#](#bpy.ops.cachefile.layer_move "Link to this definition")
...
bpy.ops.cachefile.layer\_remove()[#](#bpy.ops.cachefile.layer_remove "Link to this definition")
:   Remove an override layer from the archive

bpy.ops.cachefile.open(*filepath=''*, *hide\_props\_region=True*, *check\_existing=False*, *filter\_blender=False*, *filter\_backup=False*, *filter\_image=False*, *filter\_movie=False*, *filter\_python=False*, *filter\_font=False*, *filter\_sound=False*, *filter\_text=False*, *filter\_archive=False*, *filter\_btx=False*, *filter\_collada=False*, *filter\_alembic=True*, *filter\_usd=True*, *filter\_obj=False*, *filter\_volume=False*, *filter\_folder=True*, *filter\_blenlib=False*, *filemode=8*, *relative\_path=True*, *display\_type='DEFAULT'*, *sort\_method=''*)[#](#bpy.ops.cachefile.open "Link to this definition")
:   Load a cache file
...
bpy.ops.cachefile.reload()[#](#bpy.ops.cachefile.reload "Link to this definition")
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.ops.cachefile.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.ops.cachefile.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* Cachefile Operators
  + [`layer_add()`](#bpy.ops.cachefile.layer_add)
  + [`layer_move()`](#bpy.ops.cachefile.layer_move)
  + [`layer_remove()`](#bpy.ops.cachefile.layer_remove)
  + [`open()`](#bpy.ops.cachefile.open)
  + [`reload()`](#bpy.ops.cachefile.reload)