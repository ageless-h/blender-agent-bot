...
# Surface Operators[#](#module-bpy.ops.surface "Link to this heading")

bpy.ops.surface.primitive\_nurbs\_surface\_circle\_add(*radius=1.0*, *enter\_editmode=False*, *align='WORLD'*, *location=(0.0, 0.0, 0.0)*, *rotation=(0.0, 0.0, 0.0)*, *scale=(0.0, 0.0, 0.0)*)[#](#bpy.ops.surface.primitive_nurbs_surface_circle_add "Link to this definition")
...
bpy.ops.surface.primitive\_nurbs\_surface\_curve\_add(*radius=1.0*, *enter\_editmode=False*, *align='WORLD'*, *location=(0.0, 0.0, 0.0)*, *rotation=(0.0, 0.0, 0.0)*, *scale=(0.0, 0.0, 0.0)*)[#](#bpy.ops.surface.primitive_nurbs_surface_curve_add "Link to this definition")
...
bpy.ops.surface.primitive\_nurbs\_surface\_cylinder\_add(*radius=1.0*, *enter\_editmode=False*, *align='WORLD'*, *location=(0.0, 0.0, 0.0)*, *rotation=(0.0, 0.0, 0.0)*, *scale=(0.0, 0.0, 0.0)*)[#](#bpy.ops.surface.primitive_nurbs_surface_cylinder_add "Link to this definition")
...
bpy.ops.surface.primitive\_nurbs\_surface\_sphere\_add(*radius=1.0*, *enter\_editmode=False*, *align='WORLD'*, *location=(0.0, 0.0, 0.0)*, *rotation=(0.0, 0.0, 0.0)*, *scale=(0.0, 0.0, 0.0)*)[#](#bpy.ops.surface.primitive_nurbs_surface_sphere_add "Link to this definition")
...
bpy.ops.surface.primitive\_nurbs\_surface\_surface\_add(*radius=1.0*, *enter\_editmode=False*, *align='WORLD'*, *location=(0.0, 0.0, 0.0)*, *rotation=(0.0, 0.0, 0.0)*, *scale=(0.0, 0.0, 0.0)*)[#](#bpy.ops.surface.primitive_nurbs_surface_surface_add "Link to this definition")
...
bpy.ops.surface.primitive\_nurbs\_surface\_torus\_add(*radius=1.0*, *enter\_editmode=False*, *align='WORLD'*, *location=(0.0, 0.0, 0.0)*, *rotation=(0.0, 0.0, 0.0)*, *scale=(0.0, 0.0, 0.0)*)[#](#bpy.ops.surface.primitive_nurbs_surface_torus_add "Link to this definition")
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.ops.surface.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.ops.surface.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* Surface Operators
  + [`primitive_nurbs_surface_circle_add()`](#bpy.ops.surface.primitive_nurbs_surface_circle_add)
  + [`primitive_nurbs_surface_curve_add()`](#bpy.ops.surface.primitive_nurbs_surface_curve_add)
  + [`primitive_nurbs_surface_cylinder_add()`](#bpy.ops.surface.primitive_nurbs_surface_cylinder_add)
  + [`primitive_nurbs_surface_sphere_add()`](#bpy.ops.surface.primitive_nurbs_surface_sphere_add)
  + [`primitive_nurbs_surface_surface_add()`](#bpy.ops.surface.primitive_nurbs_surface_surface_add)
  + [`primitive_nurbs_surface_torus_add()`](#bpy.ops.surface.primitive_nurbs_surface_torus_add)