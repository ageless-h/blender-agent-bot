...
# Mball Operators[#](#module-bpy.ops.mball "Link to this heading")

bpy.ops.mball.delete\_metaelems(*confirm=True*)[#](#bpy.ops.mball.delete_metaelems "Link to this definition")
:   Delete selected metaball element(s)

    Parameters:
    :   **confirm** (*boolean**,* *(**optional**)*) – Confirm, Prompt for confirmation

bpy.ops.mball.duplicate\_metaelems()[#](#bpy.ops.mball.duplicate_metaelems "Link to this definition")
:   Duplicate selected metaball element(s)

bpy.ops.mball.duplicate\_move(*MBALL\_OT\_duplicate\_metaelems=None*, *TRANSFORM\_OT\_translate=None*)[#](#bpy.ops.mball.duplicate_move "Link to this definition")
:   Make copies of the selected metaball elements and move them

    Parameters:
    :   * **MBALL\_OT\_duplicate\_metaelems** (`MBALL_OT_duplicate_metaelems`, (optional)) – Duplicate Metaball Elements, Duplicate selected metaball element(s)
        * **TRANSFORM\_OT\_translate** (`TRANSFORM_OT_translate`, (optional)) – Move, Move selected items

bpy.ops.mball.hide\_metaelems(*unselected=False*)[#](#bpy.ops.mball.hide_metaelems "Link to this definition")
:   Hide (un)selected metaball element(s)

    Parameters:
    :   **unselected** (*boolean**,* *(**optional**)*) – Unselected, Hide unselected rather than selected

bpy.ops.mball.reveal\_metaelems(*select=True*)[#](#bpy.ops.mball.reveal_metaelems "Link to this definition")
:   Reveal all hidden metaball elements

    Parameters:
    :   **select** (*boolean**,* *(**optional**)*) – Select

bpy.ops.mball.select\_all(*action='TOGGLE'*)[#](#bpy.ops.mball.select_all "Link to this definition")
...
bpy.ops.mball.select\_random\_metaelems(*ratio=0.5*, *seed=0*, *action='SELECT'*)[#](#bpy.ops.mball.select_random_metaelems "Link to this definition")
...
bpy.ops.mball.select\_similar(*type='TYPE'*, *threshold=0.1*)[#](#bpy.ops.mball.select_similar "Link to this definition")
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.ops.mball.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.ops.mball.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* Mball Operators
  + [`delete_metaelems()`](#bpy.ops.mball.delete_metaelems)
  + [`duplicate_metaelems()`](#bpy.ops.mball.duplicate_metaelems)
  + [`duplicate_move()`](#bpy.ops.mball.duplicate_move)
  + [`hide_metaelems()`](#bpy.ops.mball.hide_metaelems)
  + [`reveal_metaelems()`](#bpy.ops.mball.reveal_metaelems)
  + [`select_all()`](#bpy.ops.mball.select_all)
  + [`select_random_metaelems()`](#bpy.ops.mball.select_random_metaelems)
  + [`select_similar()`](#bpy.ops.mball.select_similar)