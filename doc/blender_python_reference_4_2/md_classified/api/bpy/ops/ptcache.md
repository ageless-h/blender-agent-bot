...
# Ptcache Operators[#](#module-bpy.ops.ptcache "Link to this heading")

bpy.ops.ptcache.add()[#](#bpy.ops.ptcache.add "Link to this definition")
:   Add new cache

bpy.ops.ptcache.bake(*bake=False*)[#](#bpy.ops.ptcache.bake "Link to this definition")
:   Bake physics

    Parameters:
    :   **bake** (*boolean**,* *(**optional**)*) – Bake

bpy.ops.ptcache.bake\_all(*bake=True*)[#](#bpy.ops.ptcache.bake_all "Link to this definition")
:   Bake all physics

    Parameters:
    :   **bake** (*boolean**,* *(**optional**)*) – Bake

bpy.ops.ptcache.bake\_from\_cache()[#](#bpy.ops.ptcache.bake_from_cache "Link to this definition")
:   Bake from cache

bpy.ops.ptcache.free\_bake()[#](#bpy.ops.ptcache.free_bake "Link to this definition")
:   Delete physics bake

bpy.ops.ptcache.free\_bake\_all()[#](#bpy.ops.ptcache.free_bake_all "Link to this definition")
:   Delete all baked caches of all objects in the current scene

bpy.ops.ptcache.remove()[#](#bpy.ops.ptcache.remove "Link to this definition")
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.ops.ptcache.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.ops.ptcache.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* Ptcache Operators
  + [`add()`](#bpy.ops.ptcache.add)
  + [`bake()`](#bpy.ops.ptcache.bake)
  + [`bake_all()`](#bpy.ops.ptcache.bake_all)
  + [`bake_from_cache()`](#bpy.ops.ptcache.bake_from_cache)
  + [`free_bake()`](#bpy.ops.ptcache.free_bake)
  + [`free_bake_all()`](#bpy.ops.ptcache.free_bake_all)
  + [`remove()`](#bpy.ops.ptcache.remove)