...
# Marker Operators[#](#module-bpy.ops.marker "Link to this heading")

bpy.ops.marker.add()[#](#bpy.ops.marker.add "Link to this definition")
:   Add a new time marker

bpy.ops.marker.camera\_bind()[#](#bpy.ops.marker.camera_bind "Link to this definition")
:   Bind the selected camera to a marker on the current frame

bpy.ops.marker.delete(*confirm=True*)[#](#bpy.ops.marker.delete "Link to this definition")
:   Delete selected time marker(s)

    Parameters:
    :   **confirm** (*boolean**,* *(**optional**)*) – Confirm, Prompt for confirmation

bpy.ops.marker.duplicate(*frames=0*)[#](#bpy.ops.marker.duplicate "Link to this definition")
:   Duplicate selected time marker(s)

    Parameters:
    :   **frames** (*int in* *[**-inf**,* *inf**]**,* *(**optional**)*) – Frames

bpy.ops.marker.make\_links\_scene(*scene=''*)[#](#bpy.ops.marker.make_links_scene "Link to this definition")
:   Copy selected markers to another scene

    Parameters:
    :   **scene** (*enum in* *[**]**,* *(**optional**)*) – Scene

bpy.ops.marker.move(*frames=0*, *tweak=False*)[#](#bpy.ops.marker.move "Link to this definition")
...
bpy.ops.marker.rename(*name='RenamedMarker'*)[#](#bpy.ops.marker.rename "Link to this definition")
:   Rename first selected time marker

    Parameters:
    :   **name** (*string**,* *(**optional**,* *never None**)*) – Name, New name for marker

bpy.ops.marker.select(*wait\_to\_deselect\_others=False*, *mouse\_x=0*, *mouse\_y=0*, *extend=False*, *camera=False*)[#](#bpy.ops.marker.select "Link to this definition")
...
bpy.ops.marker.select\_all(*action='TOGGLE'*)[#](#bpy.ops.marker.select_all "Link to this definition")
...
bpy.ops.marker.select\_box(*xmin=0*, *xmax=0*, *ymin=0*, *ymax=0*, *wait\_for\_input=True*, *mode='SET'*, *tweak=False*)[#](#bpy.ops.marker.select_box "Link to this definition")
...
bpy.ops.marker.select\_leftright(*mode='LEFT'*, *extend=False*)[#](#bpy.ops.marker.select_leftright "Link to this definition")
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.ops.marker.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.ops.marker.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* Marker Operators
  + [`add()`](#bpy.ops.marker.add)
  + [`camera_bind()`](#bpy.ops.marker.camera_bind)
  + [`delete()`](#bpy.ops.marker.delete)
  + [`duplicate()`](#bpy.ops.marker.duplicate)
  + [`make_links_scene()`](#bpy.ops.marker.make_links_scene)
  + [`move()`](#bpy.ops.marker.move)
  + [`rename()`](#bpy.ops.marker.rename)
  + [`select()`](#bpy.ops.marker.select)
  + [`select_all()`](#bpy.ops.marker.select_all)
  + [`select_box()`](#bpy.ops.marker.select_box)
  + [`select_leftright()`](#bpy.ops.marker.select_leftright)