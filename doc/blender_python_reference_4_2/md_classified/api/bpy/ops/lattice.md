...
# Lattice Operators[#](#module-bpy.ops.lattice "Link to this heading")

bpy.ops.lattice.flip(*axis='U'*)[#](#bpy.ops.lattice.flip "Link to this definition")
:   Mirror all control points without inverting the lattice deform

    Parameters:
    :   **axis** (*enum in* *[**'U'**,* *'V'**,* *'W'**]**,* *(**optional**)*) – Flip Axis, Coordinates along this axis get flipped

bpy.ops.lattice.make\_regular()[#](#bpy.ops.lattice.make_regular "Link to this definition")
:   Set UVW control points a uniform distance apart

bpy.ops.lattice.select\_all(*action='TOGGLE'*)[#](#bpy.ops.lattice.select_all "Link to this definition")
...
bpy.ops.lattice.select\_less()[#](#bpy.ops.lattice.select_less "Link to this definition")
:   Deselect vertices at the boundary of each selection region

bpy.ops.lattice.select\_mirror(*axis={'X'}*, *extend=False*)[#](#bpy.ops.lattice.select_mirror "Link to this definition")
...
bpy.ops.lattice.select\_more()[#](#bpy.ops.lattice.select_more "Link to this definition")
:   Select vertex directly linked to already selected ones

bpy.ops.lattice.select\_random(*ratio=0.5*, *seed=0*, *action='SELECT'*)[#](#bpy.ops.lattice.select_random "Link to this definition")
...
bpy.ops.lattice.select\_ungrouped(*extend=False*)[#](#bpy.ops.lattice.select_ungrouped "Link to this definition")
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.ops.lattice.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.ops.lattice.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* Lattice Operators
  + [`flip()`](#bpy.ops.lattice.flip)
  + [`make_regular()`](#bpy.ops.lattice.make_regular)
  + [`select_all()`](#bpy.ops.lattice.select_all)
  + [`select_less()`](#bpy.ops.lattice.select_less)
  + [`select_mirror()`](#bpy.ops.lattice.select_mirror)
  + [`select_more()`](#bpy.ops.lattice.select_more)
  + [`select_random()`](#bpy.ops.lattice.select_random)
  + [`select_ungrouped()`](#bpy.ops.lattice.select_ungrouped)