...
bpy.ops.import\_curve.svg(*filepath=''*, *filter\_glob='\*.svg'*)[#](#bpy.ops.import_curve.svg "Link to this definition")
:   Load a SVG file
    ...
    File:
    :   [addons\_core/io\_curve\_svg/\_\_init\_\_.py:40](https://projects.blender.org/blender/blender-addons/addons_core/io_curve_svg/__init__.py#L40)
