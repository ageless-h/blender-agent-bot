...
# Palette Operators[#](#module-bpy.ops.palette "Link to this heading")

bpy.ops.palette.color\_add()[#](#bpy.ops.palette.color_add "Link to this definition")
:   Add new color to active palette

bpy.ops.palette.color\_delete()[#](#bpy.ops.palette.color_delete "Link to this definition")
:   Remove active color from palette

bpy.ops.palette.color\_move(*type='UP'*)[#](#bpy.ops.palette.color_move "Link to this definition")
:   Move the active Color up/down in the list

    Parameters:
    :   **type** (*enum in* *[**'UP'**,* *'DOWN'**]**,* *(**optional**)*) – Type

bpy.ops.palette.extract\_from\_image(*threshold=1*)[#](#bpy.ops.palette.extract_from_image "Link to this definition")
:   Extract all colors used in Image and create a Palette

    Parameters:
    :   **threshold** (*int in* *[**-inf**,* *inf**]**,* *(**optional**)*) – Threshold

bpy.ops.palette.join(*palette=''*)[#](#bpy.ops.palette.join "Link to this definition")
:   Join Palette Swatches

    Parameters:
    :   **palette** (*string**,* *(**optional**,* *never None**)*) – Palette, Name of the Palette

bpy.ops.palette.new()[#](#bpy.ops.palette.new "Link to this definition")
:   Add new palette

bpy.ops.palette.sort(*type='HSV'*)[#](#bpy.ops.palette.sort "Link to this definition")
:   Sort Palette Colors
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.ops.palette.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.ops.palette.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* Palette Operators
  + [`color_add()`](#bpy.ops.palette.color_add)
  + [`color_delete()`](#bpy.ops.palette.color_delete)
  + [`color_move()`](#bpy.ops.palette.color_move)
  + [`extract_from_image()`](#bpy.ops.palette.extract_from_image)
  + [`join()`](#bpy.ops.palette.join)
  + [`new()`](#bpy.ops.palette.new)
  + [`sort()`](#bpy.ops.palette.sort)