...
:   Set this pose Action as active Action on the active Object
    ...
    File:
    :   [addons\_core/pose\_library/operators.py:198](https://projects.blender.org/blender/blender-addons/addons_core/pose_library/operators.py#L198)
...
:   Open the blend file that contains the active asset
    ...
    File:
    :   [startup/bl\_operators/assets.py:97](https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/assets.py#L97)
