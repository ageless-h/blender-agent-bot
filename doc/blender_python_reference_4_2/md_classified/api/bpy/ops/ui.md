...
bpy.ops.ui.drop\_color(*color=(0.0, 0.0, 0.0)*, *gamma=False*)[#](#bpy.ops.ui.drop_color "Link to this definition")
:   Drop colors to buttons

    Parameters:
    :   * **color** ([`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, inf], (optional)) – Color, Source color
...
bpy.ops.ui.eyedropper\_color()[#](#bpy.ops.ui.eyedropper_color "Link to this definition")
...
:   Pick a property to use as a driver target
    ...
    Parameters:
    :   **mapping\_type** (*enum in* *[**'SINGLE\_MANY'**,* *'DIRECT'**,* *'MATCH'**,* *'NONE\_ALL'**,* *'NONE\_SINGLE'**]**,* *(**optional**)*) –
...
bpy.ops.ui.eyedropper\_gpencil\_color(*mode='MATERIAL'*)[#](#bpy.ops.ui.eyedropper_gpencil_color "Link to this definition")
...
bpy.ops.ui.override\_type\_set\_button(*all=True*, *type='REPLACE'*)[#](#bpy.ops.ui.override_type_set_button "Link to this definition")
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.ops.ui.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.ops.ui.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)
...
* Ui Operators
  ...
  + [`eyedropper_gpencil_color()`](#bpy.ops.ui.eyedropper_gpencil_color)
  ...
  + [`override_type_set_button()`](#bpy.ops.ui.override_type_set_button)
