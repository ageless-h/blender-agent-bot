...
# Application Icons (bpy.app.icons)[#](#module-bpy.app.icons "Link to this heading")

bpy.app.icons.new\_triangles(*range*, *coords*, *colors*)[#](#bpy.app.icons.new_triangles "Link to this definition")
...
bpy.app.icons.new\_triangles\_from\_file(*filepath*)[#](#bpy.app.icons.new_triangles_from_file "Link to this definition")
:   Create a new icon from triangle geometry.

    Parameters:
    :   **filepath** (*string* *or* *bytes.*) – File path.
...
bpy.app.icons.release(*icon\_id*)[#](#bpy.app.icons.release "Link to this definition")
:   Release the icon.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.app.icons.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.app.icons.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* Application Icons (bpy.app.icons)
  + [`new_triangles()`](#bpy.app.icons.new_triangles)
  + [`new_triangles_from_file()`](#bpy.app.icons.new_triangles_from_file)
