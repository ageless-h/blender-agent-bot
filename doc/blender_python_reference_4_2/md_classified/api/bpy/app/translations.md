...
:   Try to translate the given msgid (with optional msgctxt).
    ...
    :   * **msgid** (*string*) – The string to translate.
        * **msgctxt** (*string* *or* *None*) – The translation context (defaults to BLT\_I18NCONTEXT\_DEFAULT).
...
:   Extract the given msgid to translation files. This is a no-op function that will only mark the string to extract, but not perform the actual translation.
    ...
    Parameters:
    :   * **msgid** (*string*) – The string to extract.
        * **msgctxt** (*string* *or* *None*) – The translation context (defaults to BLT\_I18NCONTEXT\_DEFAULT).
...
:   Registers an addon’s UI translations.
    ...
    Parameters:
    :   * **module\_name** (*string*) – The name identifying the addon.
        * **translations\_dict** (*dict*) – A dictionary built like that:
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.app.translations.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy.app.translations.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)
