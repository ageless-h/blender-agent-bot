...
:   Function to ensure an operator has valid axis conversion settings, intended
    ...
    :   * **operator** ([`bpy.types.Operator`](../../bpy/types/Operator.md#bpy.types.Operator "bpy.types.Operator")) – the operator to access axis attributes from.
        * **forward\_attr** (*string*) – attribute storing the forward axis
        * **up\_attr** (*string*) – attribute storing the up axis
...
:   This function takes a sequence of objects, returning their instances.
    ...
    :   * **depsgraph** ([`bpy.types.Depsgraph`](../../bpy/types/Depsgraph.md#bpy.types.Depsgraph "bpy.types.Depsgraph")) – The evaluated depsgraph.
        * **objects** (sequence of [`bpy.types.Object`](../../bpy/types/Object.md#bpy.types.Object "bpy.types.Object")) – A sequencer of objects.

    Returns:
    :   A dictionary where each key is an object from objects,
        values are lists of ([`bpy.types.Object`](../../bpy/types/Object.md#bpy.types.Object "bpy.types.Object"), [`mathutils.Matrix`](../../mathutils/index.md#mathutils.Matrix "mathutils.Matrix")) tuples representing instances.
...
:   Return a filepath relative to a destination directory, for use with
    ...
    :   * **filepath** (*string*) – the file path to return,
        ...
        * **base\_src** (*string*) – the directory the *filepath* is relative too
          (normally the blend file).
        * **base\_dst** (*string*) – the directory the *filepath* will be referenced from
          (normally the export path).
        * **mode** (*string*) – the method used get the path in
          [‘AUTO’, ‘ABSOLUTE’, ‘RELATIVE’, ‘MATCH’, ‘STRIP’, ‘COPY’]
        * **copy\_subdir** (*string*) – the subdirectory of *base\_dst* to use when mode=’COPY’.
        * **copy\_set** (*set*) – collect from/to pairs when mode=’COPY’,
          pass to *path\_reference\_copy* when exporting is done.
        * **library** ([`bpy.types.Library`](../../bpy/types/Library.md#bpy.types.Library "bpy.types.Library") or None) – The library this path is relative to.
...
:   Execute copying files of path\_reference
    ...
    Parameters:
    :   * **copy\_set** (*set*) – set of (from, to) pairs to copy.
...
:   Helper function for storing unique names which may have special characters
    ...
    Parameters:
    :   * **key** (any hashable object associated with the *name*.) – unique item this name belongs to, name\_dict[key] will be reused
          when available.
          This can be the object, mesh, material, etc instance itself.
        * **name** (*string*) – The name used to create a unique value in *name\_dict*.
...
*class* bpy\_extras.io\_utils.ExportHelper[#](#bpy_extras.io_utils.ExportHelper "Link to this definition")
:   check(*\_context*)[#](#bpy_extras.io_utils.ExportHelper.check "Link to this definition")

    invoke(*context*, *\_event*)[#](#bpy_extras.io_utils.ExportHelper.invoke "Link to this definition")

*class* bpy\_extras.io\_utils.ImportHelper[#](#bpy_extras.io_utils.ImportHelper "Link to this definition")
:   check(*\_context*)[#](#bpy_extras.io_utils.ImportHelper.check "Link to this definition")

    invoke(*context*, *\_event*)[#](#bpy_extras.io_utils.ImportHelper.invoke "Link to this definition")

    invoke\_popup(*context*, *confirm\_text=''*)[#](#bpy_extras.io_utils.ImportHelper.invoke_popup "Link to this definition")
...
* bpy\_extras submodule (bpy\_extras.io\_utils)
  ...
  + [`ExportHelper`](#bpy_extras.io_utils.ExportHelper)
    - [`ExportHelper.check()`](#bpy_extras.io_utils.ExportHelper.check)
    - [`ExportHelper.invoke()`](#bpy_extras.io_utils.ExportHelper.invoke)
  + [`ImportHelper`](#bpy_extras.io_utils.ImportHelper)
    - [`ImportHelper.check()`](#bpy_extras.io_utils.ImportHelper.check)
    - [`ImportHelper.invoke()`](#bpy_extras.io_utils.ImportHelper.invoke)
    - [`ImportHelper.invoke_popup()`](#bpy_extras.io_utils.ImportHelper.invoke_popup)