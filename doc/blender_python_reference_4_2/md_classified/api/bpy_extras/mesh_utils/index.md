...
:   Returns:
    :   dict of edge keys with their value set to the number of
...
:   Takes a poly-line of indices (ngon) and returns a list of face
    ...
    Parameters:
    :   * **from\_data** (list or [`bpy.types.Mesh`](../../bpy/types/Mesh.md#bpy.types.Mesh "bpy.types.Mesh")) – either a mesh, or a list/tuple of vectors.
...
:   Generates a list of random points over mesh loop triangles.
    ...
    Parameters:
    :   * **num\_points** – the number of random points to generate on each triangle.
        * **loop\_triangles** ([`bpy.types.MeshLoopTriangle`](../../bpy/types/MeshLoopTriangle.md#bpy.types.MeshLoopTriangle "bpy.types.MeshLoopTriangle"), sequence) – list of the triangles to generate points on.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy_extras.mesh_utils.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy_extras.mesh_utils.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)
