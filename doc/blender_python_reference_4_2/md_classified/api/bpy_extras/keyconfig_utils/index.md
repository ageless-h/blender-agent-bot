...
* [Extra Utilities (bpy\_extras)](../../../meta/index.md)[x]
  ...
  + bpy\_extras submodule (bpy\_extras.keyconfig\_utils)
...
# bpy\_extras submodule (bpy\_extras.keyconfig\_utils)[#](#module-bpy_extras.keyconfig_utils "Link to this heading")

bpy\_extras.keyconfig\_utils.addon\_keymap\_register(*keymap\_data*)[#](#bpy_extras.keyconfig_utils.addon_keymap_register "Link to this definition")
:   Register a set of keymaps for addons using a list of keymaps.

    See ‘blender\_defaults.py’ for examples of the format this takes.

bpy\_extras.keyconfig\_utils.addon\_keymap\_unregister(*keymap\_data*)[#](#bpy_extras.keyconfig_utils.addon_keymap_unregister "Link to this definition")
:   Unregister a set of keymaps for addons.

bpy\_extras.keyconfig\_utils.keyconfig\_test(*kc*)[#](#bpy_extras.keyconfig_utils.keyconfig_test "Link to this definition")
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy_extras.keyconfig_utils.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy_extras.keyconfig_utils.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* bpy\_extras submodule (bpy\_extras.keyconfig\_utils)
  + [`addon_keymap_register()`](#bpy_extras.keyconfig_utils.addon_keymap_register)
  + [`addon_keymap_unregister()`](#bpy_extras.keyconfig_utils.addon_keymap_unregister)
  + [`keyconfig_test()`](#bpy_extras.keyconfig_utils.keyconfig_test)