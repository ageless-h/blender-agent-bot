...
bpy\_extras.anim\_utils.bake\_action(*obj*, *\**, *action*, *frames*, *bake\_options: bpy\_extras.anim\_utils.BakeOptions*)[#](#bpy_extras.anim_utils.bake_action "Link to this definition")
:   Parameters:
    :   * **obj** ([`bpy.types.Object`](../../bpy/types/Object.md#bpy.types.Object "bpy.types.Object")) – Object to bake.
        * **action** ([`bpy.types.Action`](../../bpy/types/Action.md#bpy.types.Action "bpy.types.Action") or None) – An action to bake the data into, or None for a new action
          to be created.
...
bpy\_extras.anim\_utils.bake\_action\_objects(*object\_action\_pairs*, *\**, *frames*, *bake\_options: bpy\_extras.anim\_utils.BakeOptions*)[#](#bpy_extras.anim_utils.bake_action_objects "Link to this definition")
:   A version of [`bake_action_objects_iter()`](#bpy_extras.anim_utils.bake_action_objects_iter "bpy_extras.anim_utils.bake_action_objects_iter") that takes frames and returns the output.
    ...
    Returns:
    :   A sequence of Action or None types (aligned with object\_action\_pairs)

    Return type:
    :   sequence of [`bpy.types.Action`](../../bpy/types/Action.md#bpy.types.Action "bpy.types.Action")

bpy\_extras.anim\_utils.bake\_action\_iter(*obj*, *\**, *action*, *bake\_options: bpy\_extras.anim\_utils.BakeOptions*)[#](#bpy_extras.anim_utils.bake_action_iter "Link to this definition")
:   An coroutine that bakes action for a single object.
    ...
    :   * **obj** ([`bpy.types.Object`](../../bpy/types/Object.md#bpy.types.Object "bpy.types.Object")) – Object to bake.
        * **action** ([`bpy.types.Action`](../../bpy/types/Action.md#bpy.types.Action "bpy.types.Action") or None) – An action to bake the data into, or None for a new action
          to be created.
        * **bake\_options** – Boolean options of what to include into the action bake.
...
bpy\_extras.anim\_utils.bake\_action\_objects\_iter(*object\_action\_pairs*, *bake\_options: bpy\_extras.anim\_utils.BakeOptions*)[#](#bpy_extras.anim_utils.bake_action_objects_iter "Link to this definition")
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy_extras.anim_utils.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Fbpy_extras.anim_utils.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)
