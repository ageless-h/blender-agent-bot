...
## Before Starting[#](#before-starting "Link to this heading")
...
* Enable [Developer Extra](https://docs.blender.org/manual/en/dev/editors/preferences/interface.html#bpy-types-preferencesview-show-developer-ui "(in Blender 5.2 LTS Manual v5.2)")
  and [Python Tooltips](https://docs.blender.org/manual/en/dev/editors/preferences/interface.html#bpy-types-preferencesview-show-tooltips-python "(in Blender 5.2 LTS Manual v5.2)").
* The [Python Console](https://docs.blender.org/manual/en/dev/editors/python_console.html#bpy-types-spaceconsole "(in Blender 5.2 LTS Manual v5.2)")
...
* To examine further scripts distributed with Blender, see:
  ...
  [directory layout docs](https://docs.blender.org/manual/en/dev/advanced/blender_directory_layout.html#blender-directory-layout "(in Blender 5.2 LTS Manual v5.2)").

### Running Scripts[#](#running-scripts "Link to this heading")
...
#### Accessing Data-Blocks[#](#accessing-data-blocks "Link to this heading")
...
Accessing data from the currently loaded blend-file is done with the module [`bpy.data`](../api/bpy/data/index.md#module-bpy.data "bpy.data").
...
#### Accessing Collections[#](#accessing-collections "Link to this heading")
...
#### Accessing Attributes[#](#accessing-attributes "Link to this heading")
...
#### Data Creation/Removal[#](#data-creation-removal "Link to this heading")
...
(accessed through [`bpy.data`](../api/bpy/data/index.md#module-bpy.data "bpy.data")), because this data is managed by Blender (save, load, undo, append, etc).

Data is added and removed via methods on the collections in [`bpy.data`](../api/bpy/data/index.md#module-bpy.data "bpy.data"), e.g:
...
(data that can be linked in and accessed from [`bpy.data`](../api/bpy/data/index.md#module-bpy.data "bpy.data")).
...
See [`bpy.context`](../api/bpy/context/index.md#module-bpy.context "bpy.context") API reference.

### Operators (Tools)[#](#operators-tools "Link to this heading")
...
through the [`bpy.ops`](../api/bpy/ops/index.md#module-bpy.ops "bpy.ops") module.
...
The [Operator Cheat Sheet](https://docs.blender.org/manual/en/dev/advanced/operators.html#bpy-ops-wm-operator-cheat-sheet "(in Blender 5.2 LTS Manual v5.2)")
gives a list of all operators and their default values in Python syntax, along with the generated docs.
This is a good way to get an overview of all Blender’s operators.

#### Operator Poll()[#](#operator-poll "Link to this heading")
...
## Integration[#](#integration "Link to this heading")
...
### Example Operator[#](#example-operator "Link to this heading")
...
5. Move your cursor into the 3D Viewport,
   open the [Operator Search menu](https://docs.blender.org/manual/en/dev/interface/operators.html#bpy-ops-wm-search-menu "(in Blender 5.2 LTS Manual v5.2)"),
   and type “Simple”.
6. Click on the “Simple Operator” item found in search.

See also

The class members with the `bl_` prefix are documented in the API reference [`bpy.types.Operator`](../api/bpy/types/Operator.md#bpy.types.Operator "bpy.types.Operator").

Note

The output from the `main` function is sent to the terminal;
in order to see this, be sure to [use the terminal](tips_and_tricks.md#use-the-terminal).

### Example Panel[#](#example-panel "Link to this heading")
...
[`bpy.types.Panel`](../api/bpy/types/Panel.md#bpy.types.Panel "bpy.types.Panel")
...
### Native Types[#](#native-types "Link to this heading")
...
### Internal Types[#](#internal-types "Link to this heading")

[`bpy.types.bpy_struct`](../api/bpy/types/bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct") is used for Blender data-blocks and collections.
...
### Mathutils Types[#](#mathutils-types "Link to this heading")

Accessible from [`mathutils`](../api/mathutils/index.md#module-mathutils "mathutils") are vectors, quaternions, Euler angles, matrix and color types.
Some attributes such as [`bpy.types.Object.location`](../api/bpy/types/Object.md#bpy.types.Object.location "bpy.types.Object.location"),
[`bpy.types.PoseBone.rotation_euler`](../api/bpy/types/PoseBone.md#bpy.types.PoseBone.rotation_euler "bpy.types.PoseBone.rotation_euler") and `bpy.types.Scene.cursor_location`
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60info_quickstart.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Finfo_quickstart.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)
...
* Quickstart
  ...
  + [Types](#types)
    ...
    - [Mathutils Types](#mathutils-types)
  + [Animation](#animation)