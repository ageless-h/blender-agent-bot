...
# Blender 4.2 Python API Documentation[#](#blender-4-2-python-api-documentation "Link to this heading")

Welcome to the Python API documentation for [Blender](https://www.blender.org), the free and open source 3D creation suite.

This site can be used offline: [Download the full documentation (zipped HTML files)](blender_python_reference_4_2.zip)

## Documentation[#](#documentation "Link to this heading")

* [Quickstart](../guides/quickstart.md): New to Blender or scripting and want to get your feet wet?
* [API Overview](../guides/overview.md): A more complete explanation of Python integration.
* [API Reference Usage](../guides/api_reference.md): Examples of how to use the API reference docs.
* [Best Practice](../guides/best_practice.md): Conventions to follow for writing good scripts.
* [Tips and Tricks](../guides/tips_and_tricks.md): Hints to help you while writing scripts for Blender.
* [Gotchas](../guides/gotchas/index.md): Some of the problems you may encounter when writing scripts.
* [Advanced](../guides/advanced/index.md): Topics which may not be required for typical usage.
* [Change Log](../guides/change_log.md): List of changes since last Blender release
...
* [Index](../indices/genindex/index.md)
* [Module Index](../indices/py-modindex.md)
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60index.rst%60%0D%0ABlender+Version%3A+%604.2%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.2%2Findex.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* Blender 4.2 Python API Documentation
