...
# API Overview[¶](#api-overview "Link to this heading")
...
## Python in Blender[¶](#python-in-blender "Link to this heading")
...
Python modules, such as `bpy` and [`mathutils`](../api/mathutils/index.md#module-mathutils "mathutils"), to the embedded interpreter so they can
...
## The Default Environment[¶](#the-default-environment "Link to this heading")
...
See the [directory layout docs](https://docs.blender.org/manual/en/dev/advanced/blender_directory_layout.html#blender-directory-layout "(in Blender 5.2 LTS Manual v5.2)").

## Script Loading[¶](#script-loading "Link to this heading")
...
## Integration through Classes[¶](#integration-through-classes "Link to this heading")
...
* [`bpy.types.Menu`](../api/bpy/types/Menu.md#bpy.types.Menu "bpy.types.Menu")
* [`bpy.types.Operator`](../api/bpy/types/Operator.md#bpy.types.Operator "bpy.types.Operator")
* [`bpy.types.PropertyGroup`](../api/bpy/types/PropertyGroup.md#bpy.types.PropertyGroup "bpy.types.PropertyGroup")
* [`bpy.types.KeyingSet`](../api/bpy/types/KeyingSet.md#bpy.types.KeyingSet "bpy.types.KeyingSet")
* [`bpy.types.RenderEngine`](../api/bpy/types/RenderEngine.md#bpy.types.RenderEngine "bpy.types.RenderEngine")
...
First note that it defines a subclass as a member of [`bpy.types`](../api/bpy/types/index.md#module-bpy.types "bpy.types"),
...
Lastly the register function is called, this takes the class and loads it into Blender. See [Class Registration](#class-registration).
...
### Construction & Destruction[¶](#construction-destruction "Link to this heading")
...
[dedicated section](gotchas/internal_data_and_python_objects.md#blender-py-objects-life-time)), a panel for example will
have a new instance for every redraw.
Some other types, like [`bpy.types.Operator`](../api/bpy/types/Operator.md#bpy.types.Operator "bpy.types.Operator"), have an even more complex internal handling,
...
[`bpy.types.RenderEngine`](../api/bpy/types/RenderEngine.md#bpy.types.RenderEngine "bpy.types.RenderEngine"). When doing so, the parent matching function must always be called,
...
> MemoryError: couldn’t create bpy\_struct object\_

With Operators, it might be something like that:

> RuntimeError: could not create instance of <OPERATOR\_OT\_identifier> to call callback function execute
...
Due to internal
[CPython implementation details](https://discuss.python.org/t/cpython-usage-of-tp-finalize/64100),
C++-defined Blender types do not define or use a `__del__()` (aka `tp_finalize()`) destructor
currently.
As this function
[does not exist if not explicitly defined](https://stackoverflow.com/questions/36722390/python-3-super-del),
...
## Registration[¶](#registration "Link to this heading")

### Module Registration[¶](#module-registration "Link to this heading")
...
### Class Registration[¶](#class-registration "Link to this heading")
...
Once this class is loaded you can access it from [`bpy.types`](../api/bpy/types/index.md#module-bpy.types "bpy.types"),
...
In this case use: [`bpy.types.Struct.bl_rna_get_subclass_py()`](../api/bpy/types/Struct.md#bpy.types.Struct.bl_rna_get_subclass_py "bpy.types.Struct.bl_rna_get_subclass_py").
...
#### Inter-Class Dependencies[¶](#inter-class-dependencies "Link to this heading")
...
#### Manipulating Classes[¶](#manipulating-classes "Link to this heading")
...
#### Dynamic Class Definition (Advanced)[¶](#dynamic-class-definition-advanced "Link to this heading")
...
* API Overview
  ...
  + [Script Loading](#script-loading)
    - [Add-ons](#add-ons)
  + [Integration through Classes](#integration-through-classes)
    - [Construction & Destruction](#construction-destruction)
  + [Registration](#registration)
    - [Module Registration](#module-registration)
    - [Class Registration](#class-registration)
      * [Inter-Class Dependencies](#inter-class-dependencies)
      * [Manipulating Classes](#manipulating-classes)
      * [Dynamic Class Definition (Advanced)](#dynamic-class-definition-advanced)