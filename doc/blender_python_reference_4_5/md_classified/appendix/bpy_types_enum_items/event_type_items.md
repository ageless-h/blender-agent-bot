...
# Event Type Items[¶](#event-type-items "Link to this heading")
...
NDOF\_BUTTON\_ROLL\_CW:
:   NDOF Roll CW.

    NdofRCW.

NDOF\_BUTTON\_ROLL\_CCW:
:   NDOF Roll CCW.

    NdofRCCW.

NDOF\_BUTTON\_SPIN\_CW:
:   NDOF Spin CW.

    NdofSCW.

NDOF\_BUTTON\_SPIN\_CCW:
:   NDOF Spin CCW.

    NdofSCCW.

NDOF\_BUTTON\_TILT\_CW:
:   NDOF Tilt CW.

    NdofTCW.

NDOF\_BUTTON\_TILT\_CCW:
:   NDOF Tilt CCW.

    NdofTCCW.

NDOF\_BUTTON\_ROTATE:
:   NDOF Rotate.

    NdofRot.

NDOF\_BUTTON\_PANZOOM:
:   NDOF Pan/Zoom.

    NdofPanZoom.

NDOF\_BUTTON\_DOMINANT:
:   NDOF Dominant.
...
NDOF\_BUTTON\_SAVE\_V1:
:   NDOF Save View 1.

    NdofSaveView1.

NDOF\_BUTTON\_SAVE\_V2:
:   NDOF Save View 2.

    NdofSaveView2.

NDOF\_BUTTON\_SAVE\_V3:
:   NDOF Save View 3.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy_types_enum_items/event_type_items.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy_types_enum_items/event_type_items.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)