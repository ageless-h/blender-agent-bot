...
# Operator Context Items[¶](#operator-context-items "Link to this heading")
...
INVOKE\_REGION\_CHANNELS:
:   Invoke Region Channels.

INVOKE\_REGION\_PREVIEW:
...
EXEC\_REGION\_CHANNELS:
:   Exec Region Channels.

EXEC\_REGION\_PREVIEW:
:   Exec Region Preview.
