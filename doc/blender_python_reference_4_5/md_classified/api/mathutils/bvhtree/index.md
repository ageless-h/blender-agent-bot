...
*class* mathutils.bvhtree.BVHTree[¶](#mathutils.bvhtree.mathutils.bvhtree.BVHTree "Link to this definition")
:   *classmethod* FromBMesh(*bmesh*, *epsilon=0.0*)[¶](#mathutils.bvhtree.mathutils.bvhtree.BVHTree.FromBMesh "Link to this definition")
    ...
    *classmethod* FromObject(*object*, *depsgraph*, *deform=True*, *render=False*, *cage=False*, *epsilon=0.0*)[¶](#mathutils.bvhtree.mathutils.bvhtree.BVHTree.FromObject "Link to this definition")
    ...
    *classmethod* FromPolygons(*vertices*, *polygons*, *all\_triangles=False*, *epsilon=0.0*)[¶](#mathutils.bvhtree.mathutils.bvhtree.BVHTree.FromPolygons "Link to this definition")
    ...
    find\_nearest(*origin*, *distance=1.84467e+19*)[¶](#mathutils.bvhtree.mathutils.bvhtree.BVHTree.find_nearest "Link to this definition")
    ...
    find\_nearest\_range(*origin*, *distance=1.84467e+19*)[¶](#mathutils.bvhtree.mathutils.bvhtree.BVHTree.find_nearest_range "Link to this definition")
    ...
    overlap(*other\_tree*)[¶](#mathutils.bvhtree.mathutils.bvhtree.BVHTree.overlap "Link to this definition")
    ...
    ray\_cast(*origin*, *direction*, *distance=sys.float\_info.max*)[¶](#mathutils.bvhtree.mathutils.bvhtree.BVHTree.ray_cast "Link to this definition")
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60mathutils.bvhtree.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fmathutils.bvhtree.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* BVHTree Utilities (mathutils.bvhtree)
  + [`mathutils.bvhtree.BVHTree`](#mathutils.bvhtree.mathutils.bvhtree.BVHTree)
    - [`mathutils.bvhtree.BVHTree.FromBMesh()`](#mathutils.bvhtree.mathutils.bvhtree.BVHTree.FromBMesh)
    - [`mathutils.bvhtree.BVHTree.FromObject()`](#mathutils.bvhtree.mathutils.bvhtree.BVHTree.FromObject)
    - [`mathutils.bvhtree.BVHTree.FromPolygons()`](#mathutils.bvhtree.mathutils.bvhtree.BVHTree.FromPolygons)
    - [`mathutils.bvhtree.BVHTree.find_nearest()`](#mathutils.bvhtree.mathutils.bvhtree.BVHTree.find_nearest)
    - [`mathutils.bvhtree.BVHTree.find_nearest_range()`](#mathutils.bvhtree.mathutils.bvhtree.BVHTree.find_nearest_range)
    - [`mathutils.bvhtree.BVHTree.overlap()`](#mathutils.bvhtree.mathutils.bvhtree.BVHTree.overlap)
    - [`mathutils.bvhtree.BVHTree.ray_cast()`](#mathutils.bvhtree.mathutils.bvhtree.BVHTree.ray_cast)