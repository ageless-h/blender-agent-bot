...
:   Reusable container for drawable geometry.
    ...
    draw(*shader=None*)[¶](#gpu.types.GPUBatch.draw "Link to this definition")
    :   Run the drawing shader with the parameters assigned to the batch.

        Parameters:
        :   **shader** – Shader that performs the drawing operations.
    ...
    :   Add another vertex buffer to the Batch.
        ...
        Current a batch can have at most GPU\_BATCH\_VBO\_MAX\_LEN vertex buffers.
...
:   Constructor is deprecated and will be removed in Blender 5.0, use [`gpu.shader.create_from_info()`](../shader/index.md#gpu.shader.create_from_info "gpu.shader.create_from_info") instead.
...
:   Stores and describes types and variables that are used in shader sources.
    ...
    depth\_write(*value*)[¶](#gpu.types.GPUShaderCreateInfo.depth_write "Link to this definition")
    :   Specify a depth write behavior when modifying gl\_FragDepth.
        ...
        Parameters:
        :   **value** – Depth write value. It can be ‘UNCHANGED’ (default), ‘ANY’, ‘GREATER’ or ‘LESS’.
    ...
    :   Specify an image resource used for arbitrary load and store operations.
        ...
        :   * **slot** (*int*) – The image resource index.
            ...
            * **qualifiers** (*set**[**str**]*) – Set containing values that describe how the image resource is to be read or written. Possible values are:
              - `NO_RESTRICT`
              - `READ`
              - `WRITE`
...
* GPU Types (gpu.types)
  ...
  + [`GPUShaderCreateInfo`](#gpu.types.GPUShaderCreateInfo)
    ...
    - [`GPUShaderCreateInfo.depth_write()`](#gpu.types.GPUShaderCreateInfo.depth_write)
