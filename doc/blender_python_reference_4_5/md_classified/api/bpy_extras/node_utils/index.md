...
* [Extra Utilities (bpy\_extras)](../../../meta/index.md)[x]
  ...
  + bpy\_extras submodule (bpy\_extras.node\_utils)
...
# bpy\_extras submodule (bpy\_extras.node\_utils)[¶](#module-bpy_extras.node_utils "Link to this heading")

bpy\_extras.node\_utils.connect\_sockets(*input*, *output*)[¶](#bpy_extras.node_utils.connect_sockets "Link to this definition")
:   Connect sockets in a node tree.
    ...
    It replaces node\_tree.links.new(input, output)

bpy\_extras.node\_utils.find\_base\_socket\_type(*socket*)[¶](#bpy_extras.node_utils.find_base_socket_type "Link to this definition")
...
bpy\_extras.node\_utils.find\_node\_input(*node*, *name*)[¶](#bpy_extras.node_utils.find_node_input "Link to this definition")
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy_extras.node_utils.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy_extras.node_utils.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* bpy\_extras submodule (bpy\_extras.node\_utils)
  + [`connect_sockets()`](#bpy_extras.node_utils.connect_sockets)
  + [`find_base_socket_type()`](#bpy_extras.node_utils.find_base_socket_type)
  + [`find_node_input()`](#bpy_extras.node_utils.find_node_input)