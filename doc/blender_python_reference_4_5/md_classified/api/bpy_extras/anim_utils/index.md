...
* [Extra Utilities (bpy\_extras)](../../../meta/index.md)[x]
  ...
  + bpy\_extras submodule (bpy\_extras.anim\_utils)
...
# bpy\_extras submodule (bpy\_extras.anim\_utils)[¶](#module-bpy_extras.anim_utils "Link to this heading")

bpy\_extras.anim\_utils.bake\_action(*obj*, *\**, *action*, *frames*, *bake\_options*)[¶](#bpy_extras.anim_utils.bake_action "Link to this definition")
:   Parameters:
    :   * **obj** ([`bpy.types.Object`](../../bpy/types/Object.md#bpy.types.Object "bpy.types.Object")) – Object to bake.
        * **action** ([`bpy.types.Action`](../../bpy/types/Action.md#bpy.types.Action "bpy.types.Action") | None) – An action to bake the data into, or None for a new action
          to be created.
        * **frames** (*int*) – Frames to bake.
        * **bake\_options** (`anim_utils.BakeOptions`) – Options for baking.

    Returns:
    :   Action or None.

    Return type:
    :   [`bpy.types.Action`](../../bpy/types/Action.md#bpy.types.Action "bpy.types.Action") | None

bpy\_extras.anim\_utils.bake\_action\_objects(*object\_action\_pairs*, *\**, *frames*, *bake\_options*)[¶](#bpy_extras.anim_utils.bake_action_objects "Link to this definition")
:   A version of [`bake_action_objects_iter()`](#bpy_extras.anim_utils.bake_action_objects_iter "bpy_extras.anim_utils.bake_action_objects_iter") that takes frames and returns the output.
    ...
    Return type:
    :   Sequence[[`bpy.types.Action`](../../bpy/types/Action.md#bpy.types.Action "bpy.types.Action")]

bpy\_extras.anim\_utils.bake\_action\_iter(*obj*, *\**, *action*, *bake\_options*)[¶](#bpy_extras.anim_utils.bake_action_iter "Link to this definition")
:   An coroutine that bakes action for a single object.
    ...
    :   * **obj** ([`bpy.types.Object`](../../bpy/types/Object.md#bpy.types.Object "bpy.types.Object")) – Object to bake.
        * **action** ([`bpy.types.Action`](../../bpy/types/Action.md#bpy.types.Action "bpy.types.Action") | None) – An action to bake the data into, or None for a new action
          to be created.
        * **bake\_options** (`anim_utils.BakeOptions`) – Boolean options of what to include into the action bake.
...
bpy\_extras.anim\_utils.bake\_action\_objects\_iter(*object\_action\_pairs*, *bake\_options*)[¶](#bpy_extras.anim_utils.bake_action_objects_iter "Link to this definition")
:   An coroutine that bakes actions for multiple objects.

    Parameters:
    :   * **object\_action\_pairs** (Sequence of ([`bpy.types.Object`](../../bpy/types/Object.md#bpy.types.Object "bpy.types.Object"), [`bpy.types.Action`](../../bpy/types/Action.md#bpy.types.Action "bpy.types.Action"))) – Sequence of object action tuples,
          action is the destination for the baked data. When None a new action will be created.
        * **bake\_options** (`anim_utils.BakeOptions`) – Options for baking.

*class* bpy\_extras.anim\_utils.BakeOptions[¶](#bpy_extras.anim_utils.bpy_extras.anim_utils.BakeOptions "Link to this definition")
:   BakeOptions(only\_selected: bool, do\_pose: bool, do\_object: bool, do\_visual\_keying: bool, do\_constraint\_clear: bool, do\_parents\_clear: bool, do\_clean: bool, do\_location: bool, do\_rotation: bool, do\_scale: bool, do\_bbone: bool, do\_custom\_props: bool)
...
Extra Utilities (bpy\_extras)](../../../meta/index.md)
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy_extras.anim_utils.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy_extras.anim_utils.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* bpy\_extras submodule (bpy\_extras.anim\_utils)
  + [`bake_action()`](#bpy_extras.anim_utils.bake_action)
  + [`bake_action_objects()`](#bpy_extras.anim_utils.bake_action_objects)
  + [`bake_action_iter()`](#bpy_extras.anim_utils.bake_action_iter)
  + [`bake_action_objects_iter()`](#bpy_extras.anim_utils.bake_action_objects_iter)
  + [`bpy_extras.anim_utils.BakeOptions`](#bpy_extras.anim_utils.bpy_extras.anim_utils.BakeOptions)