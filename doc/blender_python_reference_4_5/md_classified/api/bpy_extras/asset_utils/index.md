...
* [Extra Utilities (bpy\_extras)](../../../meta/index.md)[x]
  ...
  + bpy\_extras submodule (bpy\_extras.asset\_utils)
...
# bpy\_extras submodule (bpy\_extras.asset\_utils)[¶](#module-bpy_extras.asset_utils "Link to this heading")

Helpers for asset management tasks.

*class* bpy\_extras.asset\_utils.AssetBrowserPanel[¶](#bpy_extras.asset_utils.bpy_extras.asset_utils.AssetBrowserPanel "Link to this definition")

*class* bpy\_extras.asset\_utils.AssetMetaDataPanel[¶](#bpy_extras.asset_utils.bpy_extras.asset_utils.AssetMetaDataPanel "Link to this definition")

*class* bpy\_extras.asset\_utils.SpaceAssetInfo[¶](#bpy_extras.asset_utils.bpy_extras.asset_utils.SpaceAssetInfo "Link to this definition")
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy_extras.asset_utils.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy_extras.asset_utils.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* bpy\_extras submodule (bpy\_extras.asset\_utils)
  + [`bpy_extras.asset_utils.AssetBrowserPanel`](#bpy_extras.asset_utils.bpy_extras.asset_utils.AssetBrowserPanel)
  + [`bpy_extras.asset_utils.AssetMetaDataPanel`](#bpy_extras.asset_utils.bpy_extras.asset_utils.AssetMetaDataPanel)
  + [`bpy_extras.asset_utils.SpaceAssetInfo`](#bpy_extras.asset_utils.bpy_extras.asset_utils.SpaceAssetInfo)