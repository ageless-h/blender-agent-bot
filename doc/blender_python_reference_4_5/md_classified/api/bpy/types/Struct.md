...
# Struct(bpy\_struct)[¶](#struct-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.Struct(*bpy\_struct*)[¶](#bpy.types.Struct "Link to this definition")
:   RNA structure definition

    base[¶](#bpy.types.Struct.base "Link to this definition")
    :   Struct definition this is derived from

        Type:
        :   [`Struct`](#bpy.types.Struct "bpy.types.Struct"), (readonly)

    description[¶](#bpy.types.Struct.description "Link to this definition")
    :   Description of the Struct’s purpose

        Type:
        :   string, default “”, (readonly, never None)

    functions[¶](#bpy.types.Struct.functions "Link to this definition")
    :   Type:
        :   [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`Function`](Function.md#bpy.types.Function "bpy.types.Function"), (readonly)

    identifier[¶](#bpy.types.Struct.identifier "Link to this definition")
    :   Unique name used in the code and scripting

        Type:
        :   string, default “”, (readonly, never None)

    name[¶](#bpy.types.Struct.name "Link to this definition")
    :   Human readable name

        Type:
        :   string, default “”, (readonly, never None)

    name\_property[¶](#bpy.types.Struct.name_property "Link to this definition")
    :   Property that gives the name of the struct

        Type:
        :   [`StringProperty`](StringProperty.md#bpy.types.StringProperty "bpy.types.StringProperty"), (readonly)

    nested[¶](#bpy.types.Struct.nested "Link to this definition")
    :   Struct in which this struct is always nested, and to which it logically belongs

        Type:
        :   [`Struct`](#bpy.types.Struct "bpy.types.Struct"), (readonly)

    properties[¶](#bpy.types.Struct.properties "Link to this definition")
    :   Properties in the struct

        Type:
        :   [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`Property`](Property.md#bpy.types.Property "bpy.types.Property"), (readonly)

    property\_tags[¶](#bpy.types.Struct.property_tags "Link to this definition")
    ...
    translation\_context[¶](#bpy.types.Struct.translation_context "Link to this definition")
    :   Translation context of the struct’s name

        Type:
        :   string, default “”, (readonly, never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.Struct.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
        ...
        Return type:
        :   [`bpy.types.Struct`](#bpy.types.Struct "bpy.types.Struct") subclass

    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.Struct.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`BlenderRNA.structs`](BlenderRNA.md#bpy.types.BlenderRNA.structs "bpy.types.BlenderRNA.structs") * [`CollectionProperty.fixed_type`](CollectionProperty.md#bpy.types.CollectionProperty.fixed_type "bpy.types.CollectionProperty.fixed_type") * [`PointerProperty.fixed_type`](PointerProperty.md#bpy.types.PointerProperty.fixed_type "bpy.types.PointerProperty.fixed_type") | * [`Property.srna`](Property.md#bpy.types.Property.srna "bpy.types.Property.srna") * [`Struct.base`](#bpy.types.Struct.base "bpy.types.Struct.base") * [`Struct.nested`](#bpy.types.Struct.nested "bpy.types.Struct.nested") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.Struct.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.Struct.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* Struct(bpy\_struct)
  + [`Struct`](#bpy.types.Struct)
    - [`Struct.base`](#bpy.types.Struct.base)
    - [`Struct.description`](#bpy.types.Struct.description)
    - [`Struct.functions`](#bpy.types.Struct.functions)
    - [`Struct.identifier`](#bpy.types.Struct.identifier)
    - [`Struct.name`](#bpy.types.Struct.name)
    - [`Struct.name_property`](#bpy.types.Struct.name_property)
    - [`Struct.nested`](#bpy.types.Struct.nested)
    - [`Struct.properties`](#bpy.types.Struct.properties)
    - [`Struct.property_tags`](#bpy.types.Struct.property_tags)
    - [`Struct.translation_context`](#bpy.types.Struct.translation_context)
    - [`Struct.bl_rna_get_subclass()`](#bpy.types.Struct.bl_rna_get_subclass)
    - [`Struct.bl_rna_get_subclass_py()`](#bpy.types.Struct.bl_rna_get_subclass_py)
