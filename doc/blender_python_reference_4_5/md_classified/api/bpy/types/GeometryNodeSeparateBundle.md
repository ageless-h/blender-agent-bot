...
# GeometryNodeSeparateBundle(GeometryNode)[¶](#geometrynodeseparatebundle-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeSeparateBundle(*GeometryNode*)[¶](#bpy.types.GeometryNodeSeparateBundle "Link to this definition")
:   Split a bundle into multiple sockets.

    active\_index[¶](#bpy.types.GeometryNodeSeparateBundle.active_index "Link to this definition")
    :   Index of the active item

        Type:
        :   int in [0, inf], default 0

    bundle\_items[¶](#bpy.types.GeometryNodeSeparateBundle.bundle_items "Link to this definition")
    :   Type:
        :   [`NodeGeometrySeparateBundleItems`](NodeGeometrySeparateBundleItems.md#bpy.types.NodeGeometrySeparateBundleItems "bpy.types.NodeGeometrySeparateBundleItems") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`NodeGeometrySeparateBundleItem`](NodeGeometrySeparateBundleItem.md#bpy.types.NodeGeometrySeparateBundleItem "bpy.types.NodeGeometrySeparateBundleItem"), (readonly)

    *classmethod* is\_registered\_node\_type()[¶](#bpy.types.GeometryNodeSeparateBundle.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[¶](#bpy.types.GeometryNodeSeparateBundle.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[¶](#bpy.types.GeometryNodeSeparateBundle.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.GeometryNodeSeparateBundle.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.GeometryNodeSeparateBundle.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeSeparateBundle.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.GeometryNodeSeparateBundle.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeSeparateBundle(GeometryNode)
  + [`GeometryNodeSeparateBundle`](#bpy.types.GeometryNodeSeparateBundle)
    - [`GeometryNodeSeparateBundle.active_index`](#bpy.types.GeometryNodeSeparateBundle.active_index)
    - [`GeometryNodeSeparateBundle.bundle_items`](#bpy.types.GeometryNodeSeparateBundle.bundle_items)
    - [`GeometryNodeSeparateBundle.is_registered_node_type()`](#bpy.types.GeometryNodeSeparateBundle.is_registered_node_type)
    - [`GeometryNodeSeparateBundle.input_template()`](#bpy.types.GeometryNodeSeparateBundle.input_template)
    - [`GeometryNodeSeparateBundle.output_template()`](#bpy.types.GeometryNodeSeparateBundle.output_template)
    - [`GeometryNodeSeparateBundle.bl_rna_get_subclass()`](#bpy.types.GeometryNodeSeparateBundle.bl_rna_get_subclass)
    - [`GeometryNodeSeparateBundle.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeSeparateBundle.bl_rna_get_subclass_py)
