...
# MeshEdge(bpy\_struct)[¶](#meshedge-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.MeshEdge(*bpy\_struct*)[¶](#bpy.types.MeshEdge "Link to this definition")
:   Edge in a Mesh data-block

    hide[¶](#bpy.types.MeshEdge.hide "Link to this definition")
    :   Type:
        :   boolean, default False

    index[¶](#bpy.types.MeshEdge.index "Link to this definition")
    :   Index of this edge

        Type:
        :   int in [0, inf], default 0, (readonly)

    is\_loose[¶](#bpy.types.MeshEdge.is_loose "Link to this definition")
    :   Edge is not connected to any faces

        Type:
        :   boolean, default False, (readonly)

    select[¶](#bpy.types.MeshEdge.select "Link to this definition")
    :   Type:
        :   boolean, default False

    use\_edge\_sharp[¶](#bpy.types.MeshEdge.use_edge_sharp "Link to this definition")
    :   Sharp edge for shading

        Type:
        :   boolean, default False

    use\_freestyle\_mark[¶](#bpy.types.MeshEdge.use_freestyle_mark "Link to this definition")
    :   Edge mark for Freestyle line rendering

        Type:
        :   boolean, default False

    use\_seam[¶](#bpy.types.MeshEdge.use_seam "Link to this definition")
    :   Seam edge for UV unwrapping

        Type:
        :   boolean, default False

    vertices[¶](#bpy.types.MeshEdge.vertices "Link to this definition")
    :   Vertex indices

        Type:
        :   int array of 2 items in [0, inf], default (0, 0)

    key[¶](#bpy.types.MeshEdge.key "Link to this definition")
    :   (readonly)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.MeshEdge.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.MeshEdge.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Mesh.edges`](Mesh.md#bpy.types.Mesh.edges "bpy.types.Mesh.edges") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.MeshEdge.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.MeshEdge.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* MeshEdge(bpy\_struct)
  + [`MeshEdge`](#bpy.types.MeshEdge)
    - [`MeshEdge.hide`](#bpy.types.MeshEdge.hide)
    - [`MeshEdge.index`](#bpy.types.MeshEdge.index)
    - [`MeshEdge.is_loose`](#bpy.types.MeshEdge.is_loose)
    - [`MeshEdge.select`](#bpy.types.MeshEdge.select)
    - [`MeshEdge.use_edge_sharp`](#bpy.types.MeshEdge.use_edge_sharp)
    - [`MeshEdge.use_freestyle_mark`](#bpy.types.MeshEdge.use_freestyle_mark)
    - [`MeshEdge.use_seam`](#bpy.types.MeshEdge.use_seam)
    - [`MeshEdge.vertices`](#bpy.types.MeshEdge.vertices)
    - [`MeshEdge.key`](#bpy.types.MeshEdge.key)
    - [`MeshEdge.bl_rna_get_subclass()`](#bpy.types.MeshEdge.bl_rna_get_subclass)
    - [`MeshEdge.bl_rna_get_subclass_py()`](#bpy.types.MeshEdge.bl_rna_get_subclass_py)
