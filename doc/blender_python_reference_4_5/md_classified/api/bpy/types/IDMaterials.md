...
|  |  |
| --- | --- |
| * [`Curve.materials`](Curve.md#bpy.types.Curve.materials "bpy.types.Curve.materials") * [`Curves.materials`](Curves.md#bpy.types.Curves.materials "bpy.types.Curves.materials") * [`GreasePencilv3.materials`](GreasePencilv3.md#bpy.types.GreasePencilv3.materials "bpy.types.GreasePencilv3.materials") * [`Mesh.materials`](Mesh.md#bpy.types.Mesh.materials "bpy.types.Mesh.materials") | * [`MetaBall.materials`](MetaBall.md#bpy.types.MetaBall.materials "bpy.types.MetaBall.materials") * [`PointCloud.materials`](PointCloud.md#bpy.types.PointCloud.materials "bpy.types.PointCloud.materials") * [`Volume.materials`](Volume.md#bpy.types.Volume.materials "bpy.types.Volume.materials") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.IDMaterials.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.IDMaterials.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)
