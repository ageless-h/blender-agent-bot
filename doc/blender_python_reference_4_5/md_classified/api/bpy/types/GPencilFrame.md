...
# GPencilFrame(bpy\_struct)[¶](#gpencilframe-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.GPencilFrame(*bpy\_struct*)[¶](#bpy.types.GPencilFrame "Link to this definition")
:   Collection of related sketches on a particular frame

    frame\_number[¶](#bpy.types.GPencilFrame.frame_number "Link to this definition")
    :   The frame on which this sketch appears

        Type:
        :   int in [-1048574, 1048574], default 0

    select[¶](#bpy.types.GPencilFrame.select "Link to this definition")
    :   Frame is selected for editing in the Dope Sheet

        Type:
        :   boolean, default False

    strokes[¶](#bpy.types.GPencilFrame.strokes "Link to this definition")
    :   Freehand curves defining the sketch on this frame

        Type:
        :   [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`GPencilStroke`](GPencilStroke.md#bpy.types.GPencilStroke "bpy.types.GPencilStroke"), (readonly)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.GPencilFrame.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.GPencilFrame.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`GPencilFrames.copy`](GPencilFrames.md#bpy.types.GPencilFrames.copy "bpy.types.GPencilFrames.copy") * [`GPencilFrames.copy`](GPencilFrames.md#bpy.types.GPencilFrames.copy "bpy.types.GPencilFrames.copy") * [`GPencilFrames.new`](GPencilFrames.md#bpy.types.GPencilFrames.new "bpy.types.GPencilFrames.new") | * [`GPencilFrames.remove`](GPencilFrames.md#bpy.types.GPencilFrames.remove "bpy.types.GPencilFrames.remove") * [`GPencilLayer.active_frame`](GPencilLayer.md#bpy.types.GPencilLayer.active_frame "bpy.types.GPencilLayer.active_frame") * [`GPencilLayer.frames`](GPencilLayer.md#bpy.types.GPencilLayer.frames "bpy.types.GPencilLayer.frames") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GPencilFrame.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.GPencilFrame.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GPencilFrame(bpy\_struct)
  + [`GPencilFrame`](#bpy.types.GPencilFrame)
    - [`GPencilFrame.frame_number`](#bpy.types.GPencilFrame.frame_number)
    - [`GPencilFrame.select`](#bpy.types.GPencilFrame.select)
    - [`GPencilFrame.strokes`](#bpy.types.GPencilFrame.strokes)
    - [`GPencilFrame.bl_rna_get_subclass()`](#bpy.types.GPencilFrame.bl_rna_get_subclass)
    - [`GPencilFrame.bl_rna_get_subclass_py()`](#bpy.types.GPencilFrame.bl_rna_get_subclass_py)
