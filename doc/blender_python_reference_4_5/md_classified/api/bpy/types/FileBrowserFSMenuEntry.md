...
# FileBrowserFSMenuEntry(bpy\_struct)[¶](#filebrowserfsmenuentry-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.FileBrowserFSMenuEntry(*bpy\_struct*)[¶](#bpy.types.FileBrowserFSMenuEntry "Link to this definition")
:   File Select Parameters

    icon[¶](#bpy.types.FileBrowserFSMenuEntry.icon "Link to this definition")
    :   Type:
        :   int in [-inf, inf], default 0

    is\_valid[¶](#bpy.types.FileBrowserFSMenuEntry.is_valid "Link to this definition")
    :   Whether this path is currently reachable

        Type:
        :   boolean, default False, (readonly)

    name[¶](#bpy.types.FileBrowserFSMenuEntry.name "Link to this definition")
    :   Type:
        :   string, default “”, (never None)

    path[¶](#bpy.types.FileBrowserFSMenuEntry.path "Link to this definition")
    :   Type:
        :   string, default “”, (never None)

    use\_save[¶](#bpy.types.FileBrowserFSMenuEntry.use_save "Link to this definition")
    :   Whether this path is saved in bookmarks, or generated from OS

        Type:
        :   boolean, default False, (readonly)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.FileBrowserFSMenuEntry.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.FileBrowserFSMenuEntry.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`SpaceFileBrowser.bookmarks`](SpaceFileBrowser.md#bpy.types.SpaceFileBrowser.bookmarks "bpy.types.SpaceFileBrowser.bookmarks") * [`SpaceFileBrowser.recent_folders`](SpaceFileBrowser.md#bpy.types.SpaceFileBrowser.recent_folders "bpy.types.SpaceFileBrowser.recent_folders") | * [`SpaceFileBrowser.system_bookmarks`](SpaceFileBrowser.md#bpy.types.SpaceFileBrowser.system_bookmarks "bpy.types.SpaceFileBrowser.system_bookmarks") * [`SpaceFileBrowser.system_folders`](SpaceFileBrowser.md#bpy.types.SpaceFileBrowser.system_folders "bpy.types.SpaceFileBrowser.system_folders") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.FileBrowserFSMenuEntry.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.FileBrowserFSMenuEntry.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* FileBrowserFSMenuEntry(bpy\_struct)
  + [`FileBrowserFSMenuEntry`](#bpy.types.FileBrowserFSMenuEntry)
    - [`FileBrowserFSMenuEntry.icon`](#bpy.types.FileBrowserFSMenuEntry.icon)
    - [`FileBrowserFSMenuEntry.is_valid`](#bpy.types.FileBrowserFSMenuEntry.is_valid)
    - [`FileBrowserFSMenuEntry.name`](#bpy.types.FileBrowserFSMenuEntry.name)
    - [`FileBrowserFSMenuEntry.path`](#bpy.types.FileBrowserFSMenuEntry.path)
    - [`FileBrowserFSMenuEntry.use_save`](#bpy.types.FileBrowserFSMenuEntry.use_save)
    - [`FileBrowserFSMenuEntry.bl_rna_get_subclass()`](#bpy.types.FileBrowserFSMenuEntry.bl_rna_get_subclass)
    - [`FileBrowserFSMenuEntry.bl_rna_get_subclass_py()`](#bpy.types.FileBrowserFSMenuEntry.bl_rna_get_subclass_py)
