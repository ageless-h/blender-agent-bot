...
# ThemeNLAEditor(bpy\_struct)[¶](#themenlaeditor-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.ThemeNLAEditor(*bpy\_struct*)[¶](#bpy.types.ThemeNLAEditor "Link to this definition")
:   Theme settings for the NLA Editor

    active\_action[¶](#bpy.types.ThemeNLAEditor.active_action "Link to this definition")
    :   Animation data-block has active action

        Type:
        :   float array of 4 items in [0, 1], default (0.0, 0.0, 0.0, 0.0)

    active\_action\_unset[¶](#bpy.types.ThemeNLAEditor.active_action_unset "Link to this definition")
    :   Animation data-block doesn’t have active action

        Type:
        :   float array of 4 items in [0, 1], default (0.0, 0.0, 0.0, 0.0)

    dopesheet\_channel[¶](#bpy.types.ThemeNLAEditor.dopesheet_channel "Link to this definition")
    ...
    dopesheet\_subchannel[¶](#bpy.types.ThemeNLAEditor.dopesheet_subchannel "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    frame\_current[¶](#bpy.types.ThemeNLAEditor.frame_current "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    grid[¶](#bpy.types.ThemeNLAEditor.grid "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    keyframe\_border[¶](#bpy.types.ThemeNLAEditor.keyframe_border "Link to this definition")
    :   Color of keyframe border

        Type:
        :   float array of 4 items in [0, 1], default (0.0, 0.0, 0.0, 0.0)

    keyframe\_border\_selected[¶](#bpy.types.ThemeNLAEditor.keyframe_border_selected "Link to this definition")
    :   Color of selected keyframe border

        Type:
        :   float array of 4 items in [0, 1], default (0.0, 0.0, 0.0, 0.0)

    meta\_strips[¶](#bpy.types.ThemeNLAEditor.meta_strips "Link to this definition")
    :   Unselected Meta Strip (for grouping related strips)

        Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    meta\_strips\_selected[¶](#bpy.types.ThemeNLAEditor.meta_strips_selected "Link to this definition")
    :   Selected Meta Strip (for grouping related strips)

        Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    nla\_track[¶](#bpy.types.ThemeNLAEditor.nla_track "Link to this definition")
    :   Nonlinear Animation Track

        Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    preview\_range[¶](#bpy.types.ThemeNLAEditor.preview_range "Link to this definition")
    :   Color of preview range overlay

        Type:
        :   float array of 4 items in [0, 1], default (0.0, 0.0, 0.0, 0.0)

    sound\_strips[¶](#bpy.types.ThemeNLAEditor.sound_strips "Link to this definition")
    :   Unselected Sound Strip (for timing speaker sounds)

        Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    sound\_strips\_selected[¶](#bpy.types.ThemeNLAEditor.sound_strips_selected "Link to this definition")
    :   Selected Sound Strip (for timing speaker sounds)

        Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    space[¶](#bpy.types.ThemeNLAEditor.space "Link to this definition")
    :   Settings for space

        Type:
        :   [`ThemeSpaceGeneric`](ThemeSpaceGeneric.md#bpy.types.ThemeSpaceGeneric "bpy.types.ThemeSpaceGeneric"), (readonly, never None)

    space\_list[¶](#bpy.types.ThemeNLAEditor.space_list "Link to this definition")
    ...
    strips[¶](#bpy.types.ThemeNLAEditor.strips "Link to this definition")
    :   Unselected Action-Clip Strip

        Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    strips\_selected[¶](#bpy.types.ThemeNLAEditor.strips_selected "Link to this definition")
    :   Selected Action-Clip Strip

        Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    time\_marker\_line[¶](#bpy.types.ThemeNLAEditor.time_marker_line "Link to this definition")
    :   Type:
        :   float array of 4 items in [0, 1], default (0.0, 0.0, 0.0, 0.0)

    time\_marker\_line\_selected[¶](#bpy.types.ThemeNLAEditor.time_marker_line_selected "Link to this definition")
    :   Type:
        :   float array of 4 items in [0, 1], default (0.0, 0.0, 0.0, 0.0)

    time\_scrub\_background[¶](#bpy.types.ThemeNLAEditor.time_scrub_background "Link to this definition")
    :   Type:
        :   float array of 4 items in [0, 1], default (0.0, 0.0, 0.0, 0.0)

    transition\_strips[¶](#bpy.types.ThemeNLAEditor.transition_strips "Link to this definition")
    :   Unselected Transition Strip

        Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    transition\_strips\_selected[¶](#bpy.types.ThemeNLAEditor.transition_strips_selected "Link to this definition")
    :   Selected Transition Strip

        Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    tweak[¶](#bpy.types.ThemeNLAEditor.tweak "Link to this definition")
    :   Color for strip/action being “tweaked” or edited

        Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    tweak\_duplicate[¶](#bpy.types.ThemeNLAEditor.tweak_duplicate "Link to this definition")
    :   Warning/error indicator color for strips referencing the strip being tweaked

        Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    view\_sliders[¶](#bpy.types.ThemeNLAEditor.view_sliders "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ThemeNLAEditor.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ThemeNLAEditor.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Theme.nla_editor`](Theme.md#bpy.types.Theme.nla_editor "bpy.types.Theme.nla_editor") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ThemeNLAEditor.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.ThemeNLAEditor.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ThemeNLAEditor(bpy\_struct)
  + [`ThemeNLAEditor`](#bpy.types.ThemeNLAEditor)
    - [`ThemeNLAEditor.active_action`](#bpy.types.ThemeNLAEditor.active_action)
    - [`ThemeNLAEditor.active_action_unset`](#bpy.types.ThemeNLAEditor.active_action_unset)
    - [`ThemeNLAEditor.dopesheet_channel`](#bpy.types.ThemeNLAEditor.dopesheet_channel)
    - [`ThemeNLAEditor.dopesheet_subchannel`](#bpy.types.ThemeNLAEditor.dopesheet_subchannel)
    - [`ThemeNLAEditor.frame_current`](#bpy.types.ThemeNLAEditor.frame_current)
    - [`ThemeNLAEditor.grid`](#bpy.types.ThemeNLAEditor.grid)
    - [`ThemeNLAEditor.keyframe_border`](#bpy.types.ThemeNLAEditor.keyframe_border)
    - [`ThemeNLAEditor.keyframe_border_selected`](#bpy.types.ThemeNLAEditor.keyframe_border_selected)
    - [`ThemeNLAEditor.meta_strips`](#bpy.types.ThemeNLAEditor.meta_strips)
    - [`ThemeNLAEditor.meta_strips_selected`](#bpy.types.ThemeNLAEditor.meta_strips_selected)
    - [`ThemeNLAEditor.nla_track`](#bpy.types.ThemeNLAEditor.nla_track)
    - [`ThemeNLAEditor.preview_range`](#bpy.types.ThemeNLAEditor.preview_range)
    - [`ThemeNLAEditor.sound_strips`](#bpy.types.ThemeNLAEditor.sound_strips)
    - [`ThemeNLAEditor.sound_strips_selected`](#bpy.types.ThemeNLAEditor.sound_strips_selected)
    - [`ThemeNLAEditor.space`](#bpy.types.ThemeNLAEditor.space)
    - [`ThemeNLAEditor.space_list`](#bpy.types.ThemeNLAEditor.space_list)
    - [`ThemeNLAEditor.strips`](#bpy.types.ThemeNLAEditor.strips)
    - [`ThemeNLAEditor.strips_selected`](#bpy.types.ThemeNLAEditor.strips_selected)
    - [`ThemeNLAEditor.time_marker_line`](#bpy.types.ThemeNLAEditor.time_marker_line)
    - [`ThemeNLAEditor.time_marker_line_selected`](#bpy.types.ThemeNLAEditor.time_marker_line_selected)
    - [`ThemeNLAEditor.time_scrub_background`](#bpy.types.ThemeNLAEditor.time_scrub_background)
    - [`ThemeNLAEditor.transition_strips`](#bpy.types.ThemeNLAEditor.transition_strips)
    - [`ThemeNLAEditor.transition_strips_selected`](#bpy.types.ThemeNLAEditor.transition_strips_selected)
    - [`ThemeNLAEditor.tweak`](#bpy.types.ThemeNLAEditor.tweak)
    - [`ThemeNLAEditor.tweak_duplicate`](#bpy.types.ThemeNLAEditor.tweak_duplicate)
    - [`ThemeNLAEditor.view_sliders`](#bpy.types.ThemeNLAEditor.view_sliders)
    - [`ThemeNLAEditor.bl_rna_get_subclass()`](#bpy.types.ThemeNLAEditor.bl_rna_get_subclass)
    - [`ThemeNLAEditor.bl_rna_get_subclass_py()`](#bpy.types.ThemeNLAEditor.bl_rna_get_subclass_py)
