...
# GreasePencilLayers(bpy\_struct)[¶](#greasepencillayers-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.GreasePencilLayers(*bpy\_struct*)[¶](#bpy.types.GreasePencilLayers "Link to this definition")
:   Collection of annotation layers

    active\_index[¶](#bpy.types.GreasePencilLayers.active_index "Link to this definition")
    :   Index of active annotation layer

        Type:
        :   int in [0, inf], default 0

    active\_note[¶](#bpy.types.GreasePencilLayers.active_note "Link to this definition")
    :   Note/Layer to add annotation strokes to

        Type:
        :   enum in [`'DEFAULT'`], default `'DEFAULT'`

    new(*name*, *\**, *set\_active=True*)[¶](#bpy.types.GreasePencilLayers.new "Link to this definition")
    :   Add a new annotation layer

        Parameters:
        :   * **name** (*string**,* *(**never None**)*) – Name, Name of the layer
            * **set\_active** (*boolean**,* *(**optional**)*) – Set Active, Set the newly created layer to the active layer

        Returns:
        :   The newly created layer

        Return type:
        :   [`GPencilLayer`](GPencilLayer.md#bpy.types.GPencilLayer "bpy.types.GPencilLayer")

    remove(*layer*)[¶](#bpy.types.GreasePencilLayers.remove "Link to this definition")
    :   Remove a annotation layer

        Parameters:
        :   **layer** ([`GPencilLayer`](GPencilLayer.md#bpy.types.GPencilLayer "bpy.types.GPencilLayer"), (never None)) – The layer to remove

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.GreasePencilLayers.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.GreasePencilLayers.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GreasePencilLayers.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.GreasePencilLayers.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GreasePencilLayers(bpy\_struct)
  + [`GreasePencilLayers`](#bpy.types.GreasePencilLayers)
    - [`GreasePencilLayers.active_index`](#bpy.types.GreasePencilLayers.active_index)
    - [`GreasePencilLayers.active_note`](#bpy.types.GreasePencilLayers.active_note)
    - [`GreasePencilLayers.new()`](#bpy.types.GreasePencilLayers.new)
    - [`GreasePencilLayers.remove()`](#bpy.types.GreasePencilLayers.remove)
    - [`GreasePencilLayers.bl_rna_get_subclass()`](#bpy.types.GreasePencilLayers.bl_rna_get_subclass)
    - [`GreasePencilLayers.bl_rna_get_subclass_py()`](#bpy.types.GreasePencilLayers.bl_rna_get_subclass_py)
