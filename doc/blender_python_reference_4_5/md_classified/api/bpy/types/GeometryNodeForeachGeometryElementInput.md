...
# GeometryNodeForeachGeometryElementInput(GeometryNode)[¶](#geometrynodeforeachgeometryelementinput-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeForeachGeometryElementInput(*GeometryNode*)[¶](#bpy.types.GeometryNodeForeachGeometryElementInput "Link to this definition")
:   paired\_output[¶](#bpy.types.GeometryNodeForeachGeometryElementInput.paired_output "Link to this definition")
    :   Zone output node that this input node is paired with

        Type:
        :   [`Node`](Node.md#bpy.types.Node "bpy.types.Node"), (readonly)

    *classmethod* is\_registered\_node\_type()[¶](#bpy.types.GeometryNodeForeachGeometryElementInput.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[¶](#bpy.types.GeometryNodeForeachGeometryElementInput.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[¶](#bpy.types.GeometryNodeForeachGeometryElementInput.output_template "Link to this definition")
    ...
    pair\_with\_output(*output\_node*)[¶](#bpy.types.GeometryNodeForeachGeometryElementInput.pair_with_output "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.GeometryNodeForeachGeometryElementInput.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.GeometryNodeForeachGeometryElementInput.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
GeometryNodeForeachGeometryElementOutput(GeometryNode)](GeometryNodeForeachGeometryElementOutput.md)
[Previous
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeForeachGeometryElementInput.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.GeometryNodeForeachGeometryElementInput.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeForeachGeometryElementInput(GeometryNode)
  + [`GeometryNodeForeachGeometryElementInput`](#bpy.types.GeometryNodeForeachGeometryElementInput)
    - [`GeometryNodeForeachGeometryElementInput.paired_output`](#bpy.types.GeometryNodeForeachGeometryElementInput.paired_output)
    - [`GeometryNodeForeachGeometryElementInput.is_registered_node_type()`](#bpy.types.GeometryNodeForeachGeometryElementInput.is_registered_node_type)
    - [`GeometryNodeForeachGeometryElementInput.input_template()`](#bpy.types.GeometryNodeForeachGeometryElementInput.input_template)
    - [`GeometryNodeForeachGeometryElementInput.output_template()`](#bpy.types.GeometryNodeForeachGeometryElementInput.output_template)
    - [`GeometryNodeForeachGeometryElementInput.pair_with_output()`](#bpy.types.GeometryNodeForeachGeometryElementInput.pair_with_output)
    - [`GeometryNodeForeachGeometryElementInput.bl_rna_get_subclass()`](#bpy.types.GeometryNodeForeachGeometryElementInput.bl_rna_get_subclass)
    - [`GeometryNodeForeachGeometryElementInput.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeForeachGeometryElementInput.bl_rna_get_subclass_py)
