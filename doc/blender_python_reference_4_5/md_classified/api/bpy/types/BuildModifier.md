...
# BuildModifier(Modifier)[¶](#buildmodifier-modifier "Link to this heading")
...
*class* bpy.types.BuildModifier(*Modifier*)[¶](#bpy.types.BuildModifier "Link to this definition")
:   Build effect modifier

    frame\_duration[¶](#bpy.types.BuildModifier.frame_duration "Link to this definition")
    :   Total time the build effect requires

        Type:
        :   float in [1, 1.04857e+06], default 100.0

    frame\_start[¶](#bpy.types.BuildModifier.frame_start "Link to this definition")
    :   Start frame of the effect

        Type:
        :   float in [-1.04857e+06, 1.04857e+06], default 1.0

    seed[¶](#bpy.types.BuildModifier.seed "Link to this definition")
    :   Seed for random if used

        Type:
        :   int in [1, 1048574], default 0

    use\_random\_order[¶](#bpy.types.BuildModifier.use_random_order "Link to this definition")
    :   Randomize the faces or edges during build

        Type:
        :   boolean, default False

    use\_reverse[¶](#bpy.types.BuildModifier.use_reverse "Link to this definition")
    :   Deconstruct the mesh instead of building it

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.BuildModifier.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.BuildModifier.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.BuildModifier.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.BuildModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* BuildModifier(Modifier)
  + [`BuildModifier`](#bpy.types.BuildModifier)
    - [`BuildModifier.frame_duration`](#bpy.types.BuildModifier.frame_duration)
    - [`BuildModifier.frame_start`](#bpy.types.BuildModifier.frame_start)
    - [`BuildModifier.seed`](#bpy.types.BuildModifier.seed)
    - [`BuildModifier.use_random_order`](#bpy.types.BuildModifier.use_random_order)
    - [`BuildModifier.use_reverse`](#bpy.types.BuildModifier.use_reverse)
    - [`BuildModifier.bl_rna_get_subclass()`](#bpy.types.BuildModifier.bl_rna_get_subclass)
    - [`BuildModifier.bl_rna_get_subclass_py()`](#bpy.types.BuildModifier.bl_rna_get_subclass_py)
