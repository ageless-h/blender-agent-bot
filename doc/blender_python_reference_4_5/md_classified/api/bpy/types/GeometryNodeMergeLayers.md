...
# GeometryNodeMergeLayers(GeometryNode)[¶](#geometrynodemergelayers-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeMergeLayers(*GeometryNode*)[¶](#bpy.types.GeometryNodeMergeLayers "Link to this definition")
:   Join groups of Grease Pencil layers into one

    mode[¶](#bpy.types.GeometryNodeMergeLayers.mode "Link to this definition")
    :   Determines how to choose which layers are merged
        ...
        * `MERGE_BY_ID`
        ...
        Type:
        :   enum in [`'MERGE_BY_NAME'`, `'MERGE_BY_ID'`], default `'MERGE_BY_NAME'`

    *classmethod* is\_registered\_node\_type()[¶](#bpy.types.GeometryNodeMergeLayers.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[¶](#bpy.types.GeometryNodeMergeLayers.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[¶](#bpy.types.GeometryNodeMergeLayers.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.GeometryNodeMergeLayers.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.GeometryNodeMergeLayers.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeMergeLayers.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.GeometryNodeMergeLayers.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeMergeLayers(GeometryNode)
  + [`GeometryNodeMergeLayers`](#bpy.types.GeometryNodeMergeLayers)
    - [`GeometryNodeMergeLayers.mode`](#bpy.types.GeometryNodeMergeLayers.mode)
    - [`GeometryNodeMergeLayers.is_registered_node_type()`](#bpy.types.GeometryNodeMergeLayers.is_registered_node_type)
    - [`GeometryNodeMergeLayers.input_template()`](#bpy.types.GeometryNodeMergeLayers.input_template)
    - [`GeometryNodeMergeLayers.output_template()`](#bpy.types.GeometryNodeMergeLayers.output_template)
    - [`GeometryNodeMergeLayers.bl_rna_get_subclass()`](#bpy.types.GeometryNodeMergeLayers.bl_rna_get_subclass)
    - [`GeometryNodeMergeLayers.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeMergeLayers.bl_rna_get_subclass_py)
