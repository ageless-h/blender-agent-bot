...
# IO\_FH\_fbx(FileHandler)[¶](#io-fh-fbx-filehandler "Link to this heading")
...
*class* bpy.types.IO\_FH\_fbx(*FileHandler*)[¶](#bpy.types.IO_FH_fbx "Link to this definition")
:   *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.IO_FH_fbx.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.IO_FH_fbx.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.IO_FH_fbx.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.IO_FH_fbx.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* IO\_FH\_fbx(FileHandler)
  + [`IO_FH_fbx`](#bpy.types.IO_FH_fbx)
    - [`IO_FH_fbx.bl_rna_get_subclass()`](#bpy.types.IO_FH_fbx.bl_rna_get_subclass)
    - [`IO_FH_fbx.bl_rna_get_subclass_py()`](#bpy.types.IO_FH_fbx.bl_rna_get_subclass_py)
