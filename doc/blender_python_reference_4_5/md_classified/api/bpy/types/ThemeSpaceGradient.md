...
# ThemeSpaceGradient(bpy\_struct)[¶](#themespacegradient-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.ThemeSpaceGradient(*bpy\_struct*)[¶](#bpy.types.ThemeSpaceGradient "Link to this definition")
:   button[¶](#bpy.types.ThemeSpaceGradient.button "Link to this definition")
    :   Type:
        :   float array of 4 items in [0, 1], default (0.0, 0.0, 0.0, 0.0)

    button\_text[¶](#bpy.types.ThemeSpaceGradient.button_text "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    button\_text\_hi[¶](#bpy.types.ThemeSpaceGradient.button_text_hi "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    button\_title[¶](#bpy.types.ThemeSpaceGradient.button_title "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    execution\_buts[¶](#bpy.types.ThemeSpaceGradient.execution_buts "Link to this definition")
    :   Type:
        :   float array of 4 items in [0, 1], default (0.0, 0.0, 0.0, 0.0)

    gradients[¶](#bpy.types.ThemeSpaceGradient.gradients "Link to this definition")
    :   Type:
        :   [`ThemeGradientColors`](ThemeGradientColors.md#bpy.types.ThemeGradientColors "bpy.types.ThemeGradientColors"), (readonly, never None)

    header[¶](#bpy.types.ThemeSpaceGradient.header "Link to this definition")
    :   Type:
        :   float array of 4 items in [0, 1], default (0.0, 0.0, 0.0, 0.0)

    header\_text[¶](#bpy.types.ThemeSpaceGradient.header_text "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    header\_text\_hi[¶](#bpy.types.ThemeSpaceGradient.header_text_hi "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    navigation\_bar[¶](#bpy.types.ThemeSpaceGradient.navigation_bar "Link to this definition")
    :   Type:
        :   float array of 4 items in [0, 1], default (0.0, 0.0, 0.0, 0.0)

    panelcolors[¶](#bpy.types.ThemeSpaceGradient.panelcolors "Link to this definition")
    :   Type:
        :   [`ThemePanelColors`](ThemePanelColors.md#bpy.types.ThemePanelColors "bpy.types.ThemePanelColors"), (readonly, never None)

    tab\_active[¶](#bpy.types.ThemeSpaceGradient.tab_active "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    tab\_back[¶](#bpy.types.ThemeSpaceGradient.tab_back "Link to this definition")
    :   Type:
        :   float array of 4 items in [0, 1], default (0.0, 0.0, 0.0, 0.0)

    tab\_inactive[¶](#bpy.types.ThemeSpaceGradient.tab_inactive "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    tab\_outline[¶](#bpy.types.ThemeSpaceGradient.tab_outline "Link to this definition")
    :   Type:
        :   float array of 4 items in [0, 1], default (0.0, 0.0, 0.0, 0.0)

    text[¶](#bpy.types.ThemeSpaceGradient.text "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    text\_hi[¶](#bpy.types.ThemeSpaceGradient.text_hi "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    title[¶](#bpy.types.ThemeSpaceGradient.title "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ThemeSpaceGradient.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ThemeSpaceGradient.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`ThemeView3D.space`](ThemeView3D.md#bpy.types.ThemeView3D.space "bpy.types.ThemeView3D.space") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ThemeSpaceGradient.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.ThemeSpaceGradient.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ThemeSpaceGradient(bpy\_struct)
  + [`ThemeSpaceGradient`](#bpy.types.ThemeSpaceGradient)
    - [`ThemeSpaceGradient.button`](#bpy.types.ThemeSpaceGradient.button)
    - [`ThemeSpaceGradient.button_text`](#bpy.types.ThemeSpaceGradient.button_text)
    - [`ThemeSpaceGradient.button_text_hi`](#bpy.types.ThemeSpaceGradient.button_text_hi)
    - [`ThemeSpaceGradient.button_title`](#bpy.types.ThemeSpaceGradient.button_title)
    - [`ThemeSpaceGradient.execution_buts`](#bpy.types.ThemeSpaceGradient.execution_buts)
    - [`ThemeSpaceGradient.gradients`](#bpy.types.ThemeSpaceGradient.gradients)
    - [`ThemeSpaceGradient.header`](#bpy.types.ThemeSpaceGradient.header)
    - [`ThemeSpaceGradient.header_text`](#bpy.types.ThemeSpaceGradient.header_text)
    - [`ThemeSpaceGradient.header_text_hi`](#bpy.types.ThemeSpaceGradient.header_text_hi)
    - [`ThemeSpaceGradient.navigation_bar`](#bpy.types.ThemeSpaceGradient.navigation_bar)
    - [`ThemeSpaceGradient.panelcolors`](#bpy.types.ThemeSpaceGradient.panelcolors)
    - [`ThemeSpaceGradient.tab_active`](#bpy.types.ThemeSpaceGradient.tab_active)
    - [`ThemeSpaceGradient.tab_back`](#bpy.types.ThemeSpaceGradient.tab_back)
    - [`ThemeSpaceGradient.tab_inactive`](#bpy.types.ThemeSpaceGradient.tab_inactive)
    - [`ThemeSpaceGradient.tab_outline`](#bpy.types.ThemeSpaceGradient.tab_outline)
    - [`ThemeSpaceGradient.text`](#bpy.types.ThemeSpaceGradient.text)
    - [`ThemeSpaceGradient.text_hi`](#bpy.types.ThemeSpaceGradient.text_hi)
    - [`ThemeSpaceGradient.title`](#bpy.types.ThemeSpaceGradient.title)
    - [`ThemeSpaceGradient.bl_rna_get_subclass()`](#bpy.types.ThemeSpaceGradient.bl_rna_get_subclass)
    - [`ThemeSpaceGradient.bl_rna_get_subclass_py()`](#bpy.types.ThemeSpaceGradient.bl_rna_get_subclass_py)
