...
:   Visualize data from inside a node graph, in the image editor or as a backdrop
    ...
    ui\_shortcut[¶](#bpy.types.CompositorNodeViewer.ui_shortcut "Link to this definition")
    :   Type:
