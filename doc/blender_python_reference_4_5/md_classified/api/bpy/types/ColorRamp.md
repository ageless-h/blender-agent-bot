...
# ColorRamp(bpy\_struct)[¶](#colorramp-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.ColorRamp(*bpy\_struct*)[¶](#bpy.types.ColorRamp "Link to this definition")
:   Color ramp mapping a scalar value to a color

    color\_mode[¶](#bpy.types.ColorRamp.color_mode "Link to this definition")
    :   Set color mode to use for interpolation

        Type:
        :   enum in [`'RGB'`, `'HSV'`, `'HSL'`], default `'RGB'`

    elements[¶](#bpy.types.ColorRamp.elements "Link to this definition")
    :   Type:
        :   [`ColorRampElements`](ColorRampElements.md#bpy.types.ColorRampElements "bpy.types.ColorRampElements") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`ColorRampElement`](ColorRampElement.md#bpy.types.ColorRampElement "bpy.types.ColorRampElement"), (readonly)

    hue\_interpolation[¶](#bpy.types.ColorRamp.hue_interpolation "Link to this definition")
    :   Set color interpolation

        Type:
        :   enum in [`'NEAR'`, `'FAR'`, `'CW'`, `'CCW'`], default `'NEAR'`

    interpolation[¶](#bpy.types.ColorRamp.interpolation "Link to this definition")
    :   Set interpolation between color stops

        Type:
        :   enum in [`'EASE'`, `'CARDINAL'`, `'LINEAR'`, `'B_SPLINE'`, `'CONSTANT'`], default `'LINEAR'`

    evaluate(*position*)[¶](#bpy.types.ColorRamp.evaluate "Link to this definition")
    :   Evaluate Color Ramp
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ColorRamp.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ColorRamp.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Brush.gradient`](Brush.md#bpy.types.Brush.gradient "bpy.types.Brush.gradient") * [`ColorMapping.color_ramp`](ColorMapping.md#bpy.types.ColorMapping.color_ramp "bpy.types.ColorMapping.color_ramp") * [`CompositorNodeValToRGB.color_ramp`](CompositorNodeValToRGB.md#bpy.types.CompositorNodeValToRGB.color_ramp "bpy.types.CompositorNodeValToRGB.color_ramp") * [`DynamicPaintBrushSettings.paint_ramp`](DynamicPaintBrushSettings.md#bpy.types.DynamicPaintBrushSettings.paint_ramp "bpy.types.DynamicPaintBrushSettings.paint_ramp") * [`DynamicPaintBrushSettings.velocity_ramp`](DynamicPaintBrushSettings.md#bpy.types.DynamicPaintBrushSettings.velocity_ramp "bpy.types.DynamicPaintBrushSettings.velocity_ramp") * [`FluidDomainSettings.color_ramp`](FluidDomainSettings.md#bpy.types.FluidDomainSettings.color_ramp "bpy.types.FluidDomainSettings.color_ramp") * [`GreasePencilTintModifier.color_ramp`](GreasePencilTintModifier.md#bpy.types.GreasePencilTintModifier.color_ramp "bpy.types.GreasePencilTintModifier.color_ramp") * [`LineStyleColorModifier_AlongStroke.color_ramp`](LineStyleColorModifier_AlongStroke.md#bpy.types.LineStyleColorModifier_AlongStroke.color_ramp "bpy.types.LineStyleColorModifier_AlongStroke.color_ramp") * [`LineStyleColorModifier_CreaseAngle.color_ramp`](LineStyleColorModifier_CreaseAngle.md#bpy.types.LineStyleColorModifier_CreaseAngle.color_ramp "bpy.types.LineStyleColorModifier_CreaseAngle.color_ramp") * [`LineStyleColorModifier_Curvature_3D.color_ramp`](LineStyleColorModifier_Curvature_3D.md#bpy.types.LineStyleColorModifier_Curvature_3D.color_ramp "bpy.types.LineStyleColorModifier_Curvature_3D.color_ramp") | * [`LineStyleColorModifier_DistanceFromCamera.color_ramp`](LineStyleColorModifier_DistanceFromCamera.md#bpy.types.LineStyleColorModifier_DistanceFromCamera.color_ramp "bpy.types.LineStyleColorModifier_DistanceFromCamera.color_ramp") * [`LineStyleColorModifier_DistanceFromObject.color_ramp`](LineStyleColorModifier_DistanceFromObject.md#bpy.types.LineStyleColorModifier_DistanceFromObject.color_ramp "bpy.types.LineStyleColorModifier_DistanceFromObject.color_ramp") * [`LineStyleColorModifier_Material.color_ramp`](LineStyleColorModifier_Material.md#bpy.types.LineStyleColorModifier_Material.color_ramp "bpy.types.LineStyleColorModifier_Material.color_ramp") * [`LineStyleColorModifier_Noise.color_ramp`](LineStyleColorModifier_Noise.md#bpy.types.LineStyleColorModifier_Noise.color_ramp "bpy.types.LineStyleColorModifier_Noise.color_ramp") * [`LineStyleColorModifier_Tangent.color_ramp`](LineStyleColorModifier_Tangent.md#bpy.types.LineStyleColorModifier_Tangent.color_ramp "bpy.types.LineStyleColorModifier_Tangent.color_ramp") * [`PreferencesView.weight_color_range`](PreferencesView.md#bpy.types.PreferencesView.weight_color_range "bpy.types.PreferencesView.weight_color_range") * [`ShaderNodeValToRGB.color_ramp`](ShaderNodeValToRGB.md#bpy.types.ShaderNodeValToRGB.color_ramp "bpy.types.ShaderNodeValToRGB.color_ramp") * [`Texture.color_ramp`](Texture.md#bpy.types.Texture.color_ramp "bpy.types.Texture.color_ramp") * [`TextureNodeValToRGB.color_ramp`](TextureNodeValToRGB.md#bpy.types.TextureNodeValToRGB.color_ramp "bpy.types.TextureNodeValToRGB.color_ramp") |
...
ColorMixStrip(EffectStrip)](ColorMixStrip.md)
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ColorRamp.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.ColorRamp.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ColorRamp(bpy\_struct)
  + [`ColorRamp`](#bpy.types.ColorRamp)
    - [`ColorRamp.color_mode`](#bpy.types.ColorRamp.color_mode)
    - [`ColorRamp.elements`](#bpy.types.ColorRamp.elements)
    - [`ColorRamp.hue_interpolation`](#bpy.types.ColorRamp.hue_interpolation)
    - [`ColorRamp.interpolation`](#bpy.types.ColorRamp.interpolation)
    - [`ColorRamp.evaluate()`](#bpy.types.ColorRamp.evaluate)
    - [`ColorRamp.bl_rna_get_subclass()`](#bpy.types.ColorRamp.bl_rna_get_subclass)
    - [`ColorRamp.bl_rna_get_subclass_py()`](#bpy.types.ColorRamp.bl_rna_get_subclass_py)
