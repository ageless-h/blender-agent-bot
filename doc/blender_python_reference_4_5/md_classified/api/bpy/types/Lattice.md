...
# Lattice(ID)[¶](#lattice-id "Link to this heading")

base classes — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct"), [`ID`](ID.md#bpy.types.ID "bpy.types.ID")

*class* bpy.types.Lattice(*ID*)[¶](#bpy.types.Lattice "Link to this definition")
:   Lattice data-block defining a grid for deforming other objects

    animation\_data[¶](#bpy.types.Lattice.animation_data "Link to this definition")
    :   Animation data for this data-block

        Type:
        :   [`AnimData`](AnimData.md#bpy.types.AnimData "bpy.types.AnimData"), (readonly)

    interpolation\_type\_u[¶](#bpy.types.Lattice.interpolation_type_u "Link to this definition")
    :   Type:
        :   enum in [`'KEY_LINEAR'`, `'KEY_CARDINAL'`, `'KEY_CATMULL_ROM'`, `'KEY_BSPLINE'`], default `'KEY_BSPLINE'`

    interpolation\_type\_v[¶](#bpy.types.Lattice.interpolation_type_v "Link to this definition")
    :   Type:
        :   enum in [`'KEY_LINEAR'`, `'KEY_CARDINAL'`, `'KEY_CATMULL_ROM'`, `'KEY_BSPLINE'`], default `'KEY_BSPLINE'`

    interpolation\_type\_w[¶](#bpy.types.Lattice.interpolation_type_w "Link to this definition")
    :   Type:
        :   enum in [`'KEY_LINEAR'`, `'KEY_CARDINAL'`, `'KEY_CATMULL_ROM'`, `'KEY_BSPLINE'`], default `'KEY_BSPLINE'`

    is\_editmode[¶](#bpy.types.Lattice.is_editmode "Link to this definition")
    :   True when used in editmode

        Type:
        :   boolean, default False, (readonly)

    points[¶](#bpy.types.Lattice.points "Link to this definition")
    :   Points of the lattice

        Type:
        :   [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`LatticePoint`](LatticePoint.md#bpy.types.LatticePoint "bpy.types.LatticePoint"), (readonly)

    points\_u[¶](#bpy.types.Lattice.points_u "Link to this definition")
    :   Points in U direction (cannot be changed when there are shape keys)

        Type:
        :   int in [1, 64], default 0

    points\_v[¶](#bpy.types.Lattice.points_v "Link to this definition")
    :   Points in V direction (cannot be changed when there are shape keys)

        Type:
        :   int in [1, 64], default 0

    points\_w[¶](#bpy.types.Lattice.points_w "Link to this definition")
    :   Points in W direction (cannot be changed when there are shape keys)

        Type:
        :   int in [1, 64], default 0

    shape\_keys[¶](#bpy.types.Lattice.shape_keys "Link to this definition")
    :   Type:
        :   [`Key`](Key.md#bpy.types.Key "bpy.types.Key"), (readonly)

    use\_outside[¶](#bpy.types.Lattice.use_outside "Link to this definition")
    :   Only display and take into account the outer vertices

        Type:
        :   boolean, default False

    vertex\_group[¶](#bpy.types.Lattice.vertex_group "Link to this definition")
    :   Vertex group to apply the influence of the lattice

        Type:
        :   string, default “”, (never None)

    transform(*matrix*, *\**, *shape\_keys=False*)[¶](#bpy.types.Lattice.transform "Link to this definition")
    ...
    update\_gpu\_tag()[¶](#bpy.types.Lattice.update_gpu_tag "Link to this definition")
    :   update\_gpu\_tag

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.Lattice.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.Lattice.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`bpy.context.lattice`](../context/index.md#bpy.context.lattice "bpy.context.lattice") * [`BlendData.lattices`](BlendData.md#bpy.types.BlendData.lattices "bpy.types.BlendData.lattices") | * [`BlendDataLattices.new`](BlendDataLattices.md#bpy.types.BlendDataLattices.new "bpy.types.BlendDataLattices.new") * [`BlendDataLattices.remove`](BlendDataLattices.md#bpy.types.BlendDataLattices.remove "bpy.types.BlendDataLattices.remove") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.Lattice.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.Lattice.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* Lattice(ID)
  + [`Lattice`](#bpy.types.Lattice)
    - [`Lattice.animation_data`](#bpy.types.Lattice.animation_data)
    - [`Lattice.interpolation_type_u`](#bpy.types.Lattice.interpolation_type_u)
    - [`Lattice.interpolation_type_v`](#bpy.types.Lattice.interpolation_type_v)
    - [`Lattice.interpolation_type_w`](#bpy.types.Lattice.interpolation_type_w)
    - [`Lattice.is_editmode`](#bpy.types.Lattice.is_editmode)
    - [`Lattice.points`](#bpy.types.Lattice.points)
    - [`Lattice.points_u`](#bpy.types.Lattice.points_u)
    - [`Lattice.points_v`](#bpy.types.Lattice.points_v)
    - [`Lattice.points_w`](#bpy.types.Lattice.points_w)
    - [`Lattice.shape_keys`](#bpy.types.Lattice.shape_keys)
    - [`Lattice.use_outside`](#bpy.types.Lattice.use_outside)
    - [`Lattice.vertex_group`](#bpy.types.Lattice.vertex_group)
    - [`Lattice.transform()`](#bpy.types.Lattice.transform)
    - [`Lattice.update_gpu_tag()`](#bpy.types.Lattice.update_gpu_tag)
    - [`Lattice.bl_rna_get_subclass()`](#bpy.types.Lattice.bl_rna_get_subclass)
    - [`Lattice.bl_rna_get_subclass_py()`](#bpy.types.Lattice.bl_rna_get_subclass_py)
