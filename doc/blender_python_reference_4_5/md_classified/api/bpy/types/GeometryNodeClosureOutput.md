...
# GeometryNodeClosureOutput(GeometryNode)[¶](#geometrynodeclosureoutput-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeClosureOutput(*GeometryNode*)[¶](#bpy.types.GeometryNodeClosureOutput "Link to this definition")
:   active\_input\_index[¶](#bpy.types.GeometryNodeClosureOutput.active_input_index "Link to this definition")
    :   Index of the active item

        Type:
        :   int in [0, inf], default 0

    active\_output\_index[¶](#bpy.types.GeometryNodeClosureOutput.active_output_index "Link to this definition")
    :   Index of the active item

        Type:
        :   int in [0, inf], default 0

    input\_items[¶](#bpy.types.GeometryNodeClosureOutput.input_items "Link to this definition")
    :   Type:
        :   [`NodeGeometryClosureInputItems`](NodeGeometryClosureInputItems.md#bpy.types.NodeGeometryClosureInputItems "bpy.types.NodeGeometryClosureInputItems") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`NodeGeometryClosureInputItem`](NodeGeometryClosureInputItem.md#bpy.types.NodeGeometryClosureInputItem "bpy.types.NodeGeometryClosureInputItem"), (readonly)

    output\_items[¶](#bpy.types.GeometryNodeClosureOutput.output_items "Link to this definition")
    :   Type:
        :   [`NodeGeometryClosureOutputItems`](NodeGeometryClosureOutputItems.md#bpy.types.NodeGeometryClosureOutputItems "bpy.types.NodeGeometryClosureOutputItems") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`NodeGeometryClosureOutputItem`](NodeGeometryClosureOutputItem.md#bpy.types.NodeGeometryClosureOutputItem "bpy.types.NodeGeometryClosureOutputItem"), (readonly)

    *classmethod* is\_registered\_node\_type()[¶](#bpy.types.GeometryNodeClosureOutput.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[¶](#bpy.types.GeometryNodeClosureOutput.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[¶](#bpy.types.GeometryNodeClosureOutput.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.GeometryNodeClosureOutput.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.GeometryNodeClosureOutput.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
GeometryNodeClosureInput(GeometryNode)](GeometryNodeClosureInput.md)
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeClosureOutput.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.GeometryNodeClosureOutput.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeClosureOutput(GeometryNode)
  + [`GeometryNodeClosureOutput`](#bpy.types.GeometryNodeClosureOutput)
    - [`GeometryNodeClosureOutput.active_input_index`](#bpy.types.GeometryNodeClosureOutput.active_input_index)
    - [`GeometryNodeClosureOutput.active_output_index`](#bpy.types.GeometryNodeClosureOutput.active_output_index)
    - [`GeometryNodeClosureOutput.input_items`](#bpy.types.GeometryNodeClosureOutput.input_items)
    - [`GeometryNodeClosureOutput.output_items`](#bpy.types.GeometryNodeClosureOutput.output_items)
    - [`GeometryNodeClosureOutput.is_registered_node_type()`](#bpy.types.GeometryNodeClosureOutput.is_registered_node_type)
    - [`GeometryNodeClosureOutput.input_template()`](#bpy.types.GeometryNodeClosureOutput.input_template)
    - [`GeometryNodeClosureOutput.output_template()`](#bpy.types.GeometryNodeClosureOutput.output_template)
    - [`GeometryNodeClosureOutput.bl_rna_get_subclass()`](#bpy.types.GeometryNodeClosureOutput.bl_rna_get_subclass)
    - [`GeometryNodeClosureOutput.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeClosureOutput.bl_rna_get_subclass_py)
