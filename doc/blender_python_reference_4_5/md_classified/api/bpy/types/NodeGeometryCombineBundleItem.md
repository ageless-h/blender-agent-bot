...
# NodeGeometryCombineBundleItem(bpy\_struct)[¶](#nodegeometrycombinebundleitem-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.NodeGeometryCombineBundleItem(*bpy\_struct*)[¶](#bpy.types.NodeGeometryCombineBundleItem "Link to this definition")
:   color[¶](#bpy.types.NodeGeometryCombineBundleItem.color "Link to this definition")
    ...
    name[¶](#bpy.types.NodeGeometryCombineBundleItem.name "Link to this definition")
    :   Type:
        :   string, default “”, (never None)

    socket\_type[¶](#bpy.types.NodeGeometryCombineBundleItem.socket_type "Link to this definition")
    :   Type:
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.NodeGeometryCombineBundleItem.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.NodeGeometryCombineBundleItem.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`GeometryNodeCombineBundle.bundle_items`](GeometryNodeCombineBundle.md#bpy.types.GeometryNodeCombineBundle.bundle_items "bpy.types.GeometryNodeCombineBundle.bundle_items") * [`NodeGeometryCombineBundleItems.new`](NodeGeometryCombineBundleItems.md#bpy.types.NodeGeometryCombineBundleItems.new "bpy.types.NodeGeometryCombineBundleItems.new") | * [`NodeGeometryCombineBundleItems.remove`](NodeGeometryCombineBundleItems.md#bpy.types.NodeGeometryCombineBundleItems.remove "bpy.types.NodeGeometryCombineBundleItems.remove") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.NodeGeometryCombineBundleItem.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.NodeGeometryCombineBundleItem.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* NodeGeometryCombineBundleItem(bpy\_struct)
  + [`NodeGeometryCombineBundleItem`](#bpy.types.NodeGeometryCombineBundleItem)
    - [`NodeGeometryCombineBundleItem.color`](#bpy.types.NodeGeometryCombineBundleItem.color)
    - [`NodeGeometryCombineBundleItem.name`](#bpy.types.NodeGeometryCombineBundleItem.name)
    - [`NodeGeometryCombineBundleItem.socket_type`](#bpy.types.NodeGeometryCombineBundleItem.socket_type)
    - [`NodeGeometryCombineBundleItem.bl_rna_get_subclass()`](#bpy.types.NodeGeometryCombineBundleItem.bl_rna_get_subclass)
    - [`NodeGeometryCombineBundleItem.bl_rna_get_subclass_py()`](#bpy.types.NodeGeometryCombineBundleItem.bl_rna_get_subclass_py)
