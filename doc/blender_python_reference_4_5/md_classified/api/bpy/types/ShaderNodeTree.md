...
# ShaderNodeTree(NodeTree)[¶](#shadernodetree-nodetree "Link to this heading")
...
*class* bpy.types.ShaderNodeTree(*NodeTree*)[¶](#bpy.types.ShaderNodeTree "Link to this definition")
:   Node tree consisting of linked nodes used for materials (and other shading data-blocks)

    get\_output\_node(*target*)[¶](#bpy.types.ShaderNodeTree.get_output_node "Link to this definition")
    :   Return active shader output node for the specified target
        ...
        Return type:
        :   [`ShaderNode`](ShaderNode.md#bpy.types.ShaderNode "bpy.types.ShaderNode")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ShaderNodeTree.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ShaderNodeTree.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ShaderNodeTree.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.ShaderNodeTree.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ShaderNodeTree(NodeTree)
  + [`ShaderNodeTree`](#bpy.types.ShaderNodeTree)
    - [`ShaderNodeTree.get_output_node()`](#bpy.types.ShaderNodeTree.get_output_node)
    - [`ShaderNodeTree.bl_rna_get_subclass()`](#bpy.types.ShaderNodeTree.bl_rna_get_subclass)
    - [`ShaderNodeTree.bl_rna_get_subclass_py()`](#bpy.types.ShaderNodeTree.bl_rna_get_subclass_py)
