...
# Region(bpy\_struct)[¶](#region-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.Region(*bpy\_struct*)[¶](#bpy.types.Region "Link to this definition")
:   Region in a subdivided screen area

    active\_panel\_category[¶](#bpy.types.Region.active_panel_category "Link to this definition")
    :   The current active panel category, may be Null if the region does not support this feature (NOTE: these categories are generated at runtime, so list may be empty at initialization, before any drawing took place)
        ...
        * `UNSUPPORTED`
          Not Supported – This region does not support panel categories.

        Type:
        :   enum in [`'UNSUPPORTED'`], default `'UNSUPPORTED'`

    alignment[¶](#bpy.types.Region.alignment "Link to this definition")
    ...
    data[¶](#bpy.types.Region.data "Link to this definition")
    :   Region specific data (the type depends on the region type)

        Type:
        :   [`AnyType`](AnyType.md#bpy.types.AnyType "bpy.types.AnyType"), (readonly)

    height[¶](#bpy.types.Region.height "Link to this definition")
    :   Region height

        Type:
        :   int in [0, 32767], default 0, (readonly)

    type[¶](#bpy.types.Region.type "Link to this definition")
    :   Type of this region
    ...
    view2d[¶](#bpy.types.Region.view2d "Link to this definition")
    :   2D view of the region

        Type:
        :   [`View2D`](View2D.md#bpy.types.View2D "bpy.types.View2D"), (readonly, never None)

    width[¶](#bpy.types.Region.width "Link to this definition")
    :   Region width

        Type:
        :   int in [0, 32767], default 0, (readonly)

    x[¶](#bpy.types.Region.x "Link to this definition")
    :   The window relative vertical location of the region

        Type:
        :   int in [-inf, inf], default 0, (readonly)

    y[¶](#bpy.types.Region.y "Link to this definition")
    :   The window relative horizontal location of the region

        Type:
        :   int in [-inf, inf], default 0, (readonly)

    tag\_redraw()[¶](#bpy.types.Region.tag_redraw "Link to this definition")
    :   tag\_redraw

    tag\_refresh\_ui()[¶](#bpy.types.Region.tag_refresh_ui "Link to this definition")
    :   tag\_refresh\_ui

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.Region.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.Region.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Area.regions`](Area.md#bpy.types.Area.regions "bpy.types.Area.regions") * [`Context.region`](Context.md#bpy.types.Context.region "bpy.types.Context.region") | * [`Context.region_popup`](Context.md#bpy.types.Context.region_popup "bpy.types.Context.region_popup") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.Region.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.Region.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* Region(bpy\_struct)
  + [`Region`](#bpy.types.Region)
    - [`Region.active_panel_category`](#bpy.types.Region.active_panel_category)
    - [`Region.alignment`](#bpy.types.Region.alignment)
    - [`Region.data`](#bpy.types.Region.data)
    - [`Region.height`](#bpy.types.Region.height)
    - [`Region.type`](#bpy.types.Region.type)
    - [`Region.view2d`](#bpy.types.Region.view2d)
    - [`Region.width`](#bpy.types.Region.width)
    - [`Region.x`](#bpy.types.Region.x)
    - [`Region.y`](#bpy.types.Region.y)
    - [`Region.tag_redraw()`](#bpy.types.Region.tag_redraw)
    - [`Region.tag_refresh_ui()`](#bpy.types.Region.tag_refresh_ui)
    - [`Region.bl_rna_get_subclass()`](#bpy.types.Region.bl_rna_get_subclass)
    - [`Region.bl_rna_get_subclass_py()`](#bpy.types.Region.bl_rna_get_subclass_py)
