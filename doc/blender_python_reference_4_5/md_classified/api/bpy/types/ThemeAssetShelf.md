...
# ThemeAssetShelf(bpy\_struct)[¶](#themeassetshelf-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.ThemeAssetShelf(*bpy\_struct*)[¶](#bpy.types.ThemeAssetShelf "Link to this definition")
:   Theme settings for asset shelves

    back[¶](#bpy.types.ThemeAssetShelf.back "Link to this definition")
    :   Type:
        :   float array of 4 items in [0, 1], default (0.0, 0.0, 0.0, 0.0)

    header\_back[¶](#bpy.types.ThemeAssetShelf.header_back "Link to this definition")
    :   Type:
        :   float array of 4 items in [0, 1], default (0.0, 0.0, 0.0, 0.0)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ThemeAssetShelf.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ThemeAssetShelf.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`ThemeImageEditor.asset_shelf`](ThemeImageEditor.md#bpy.types.ThemeImageEditor.asset_shelf "bpy.types.ThemeImageEditor.asset_shelf") | * [`ThemeView3D.asset_shelf`](ThemeView3D.md#bpy.types.ThemeView3D.asset_shelf "bpy.types.ThemeView3D.asset_shelf") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ThemeAssetShelf.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.ThemeAssetShelf.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ThemeAssetShelf(bpy\_struct)
  + [`ThemeAssetShelf`](#bpy.types.ThemeAssetShelf)
    - [`ThemeAssetShelf.back`](#bpy.types.ThemeAssetShelf.back)
    - [`ThemeAssetShelf.header_back`](#bpy.types.ThemeAssetShelf.header_back)
    - [`ThemeAssetShelf.bl_rna_get_subclass()`](#bpy.types.ThemeAssetShelf.bl_rna_get_subclass)
    - [`ThemeAssetShelf.bl_rna_get_subclass_py()`](#bpy.types.ThemeAssetShelf.bl_rna_get_subclass_py)
