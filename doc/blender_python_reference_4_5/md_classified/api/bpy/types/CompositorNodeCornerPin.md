...
:   Plane warp transformation using explicit corner values
    ...
    interpolation[¶](#bpy.types.CompositorNodeCornerPin.interpolation "Link to this definition")
    :   Interpolation method
        ...
        * `ANISOTROPIC`
        ...
        Type:
        :   enum in [`'NEAREST'`, `'BILINEAR'`, `'BICUBIC'`, `'ANISOTROPIC'`], default `'ANISOTROPIC'`
