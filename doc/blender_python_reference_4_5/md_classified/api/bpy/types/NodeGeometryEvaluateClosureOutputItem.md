...
# NodeGeometryEvaluateClosureOutputItem(bpy\_struct)[¶](#nodegeometryevaluateclosureoutputitem-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.NodeGeometryEvaluateClosureOutputItem(*bpy\_struct*)[¶](#bpy.types.NodeGeometryEvaluateClosureOutputItem "Link to this definition")
:   color[¶](#bpy.types.NodeGeometryEvaluateClosureOutputItem.color "Link to this definition")
    ...
    name[¶](#bpy.types.NodeGeometryEvaluateClosureOutputItem.name "Link to this definition")
    :   Type:
        :   string, default “”, (never None)

    socket\_type[¶](#bpy.types.NodeGeometryEvaluateClosureOutputItem.socket_type "Link to this definition")
    :   Type:
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.NodeGeometryEvaluateClosureOutputItem.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.NodeGeometryEvaluateClosureOutputItem.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`GeometryNodeEvaluateClosure.output_items`](GeometryNodeEvaluateClosure.md#bpy.types.GeometryNodeEvaluateClosure.output_items "bpy.types.GeometryNodeEvaluateClosure.output_items") * [`NodeGeometryEvaluateClosureOutputItems.new`](NodeGeometryEvaluateClosureOutputItems.md#bpy.types.NodeGeometryEvaluateClosureOutputItems.new "bpy.types.NodeGeometryEvaluateClosureOutputItems.new") | * [`NodeGeometryEvaluateClosureOutputItems.remove`](NodeGeometryEvaluateClosureOutputItems.md#bpy.types.NodeGeometryEvaluateClosureOutputItems.remove "bpy.types.NodeGeometryEvaluateClosureOutputItems.remove") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.NodeGeometryEvaluateClosureOutputItem.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.NodeGeometryEvaluateClosureOutputItem.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* NodeGeometryEvaluateClosureOutputItem(bpy\_struct)
  + [`NodeGeometryEvaluateClosureOutputItem`](#bpy.types.NodeGeometryEvaluateClosureOutputItem)
    - [`NodeGeometryEvaluateClosureOutputItem.color`](#bpy.types.NodeGeometryEvaluateClosureOutputItem.color)
    - [`NodeGeometryEvaluateClosureOutputItem.name`](#bpy.types.NodeGeometryEvaluateClosureOutputItem.name)
    - [`NodeGeometryEvaluateClosureOutputItem.socket_type`](#bpy.types.NodeGeometryEvaluateClosureOutputItem.socket_type)
    - [`NodeGeometryEvaluateClosureOutputItem.bl_rna_get_subclass()`](#bpy.types.NodeGeometryEvaluateClosureOutputItem.bl_rna_get_subclass)
    - [`NodeGeometryEvaluateClosureOutputItem.bl_rna_get_subclass_py()`](#bpy.types.NodeGeometryEvaluateClosureOutputItem.bl_rna_get_subclass_py)
