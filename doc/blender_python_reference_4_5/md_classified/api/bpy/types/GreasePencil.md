...
:   Freehand annotation sketchbook
    ...
    :   Type:
        :   [`GreasePencilLayers`](GreasePencilLayers.md#bpy.types.GreasePencilLayers "bpy.types.GreasePencilLayers") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`GPencilLayer`](GPencilLayer.md#bpy.types.GPencilLayer "bpy.types.GPencilLayer"), (readonly)
...
|  |  |
| --- | --- |
| * [`bpy.context.annotation_data`](../context/index.md#bpy.context.annotation_data "bpy.context.annotation_data") * [`bpy.context.gpencil`](../context/index.md#bpy.context.gpencil "bpy.context.gpencil") * [`BlendData.grease_pencils`](BlendData.md#bpy.types.BlendData.grease_pencils "bpy.types.BlendData.grease_pencils") * [`BlendDataGreasePencils.new`](BlendDataGreasePencils.md#bpy.types.BlendDataGreasePencils.new "bpy.types.BlendDataGreasePencils.new") * [`BlendDataGreasePencils.remove`](BlendDataGreasePencils.md#bpy.types.BlendDataGreasePencils.remove "bpy.types.BlendDataGreasePencils.remove") * [`MovieClip.grease_pencil`](MovieClip.md#bpy.types.MovieClip.grease_pencil "bpy.types.MovieClip.grease_pencil") | * [`MovieTrackingTrack.grease_pencil`](MovieTrackingTrack.md#bpy.types.MovieTrackingTrack.grease_pencil "bpy.types.MovieTrackingTrack.grease_pencil") * [`NodeTree.grease_pencil`](NodeTree.md#bpy.types.NodeTree.grease_pencil "bpy.types.NodeTree.grease_pencil") * [`Scene.grease_pencil`](Scene.md#bpy.types.Scene.grease_pencil "bpy.types.Scene.grease_pencil") * [`SpaceImageEditor.grease_pencil`](SpaceImageEditor.md#bpy.types.SpaceImageEditor.grease_pencil "bpy.types.SpaceImageEditor.grease_pencil") * [`SpaceSequenceEditor.grease_pencil`](SpaceSequenceEditor.md#bpy.types.SpaceSequenceEditor.grease_pencil "bpy.types.SpaceSequenceEditor.grease_pencil") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GreasePencil.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.GreasePencil.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)
