...
# GeometryNodeEvaluateClosure(GeometryNode)[¶](#geometrynodeevaluateclosure-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeEvaluateClosure(*GeometryNode*)[¶](#bpy.types.GeometryNodeEvaluateClosure "Link to this definition")
:   active\_input\_index[¶](#bpy.types.GeometryNodeEvaluateClosure.active_input_index "Link to this definition")
    :   Index of the active item

        Type:
        :   int in [0, inf], default 0

    active\_output\_index[¶](#bpy.types.GeometryNodeEvaluateClosure.active_output_index "Link to this definition")
    :   Index of the active item

        Type:
        :   int in [0, inf], default 0

    input\_items[¶](#bpy.types.GeometryNodeEvaluateClosure.input_items "Link to this definition")
    :   Type:
        :   [`NodeGeometryEvaluateClosureInputItems`](NodeGeometryEvaluateClosureInputItems.md#bpy.types.NodeGeometryEvaluateClosureInputItems "bpy.types.NodeGeometryEvaluateClosureInputItems") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`NodeGeometryEvaluateClosureInputItem`](NodeGeometryEvaluateClosureInputItem.md#bpy.types.NodeGeometryEvaluateClosureInputItem "bpy.types.NodeGeometryEvaluateClosureInputItem"), (readonly)

    output\_items[¶](#bpy.types.GeometryNodeEvaluateClosure.output_items "Link to this definition")
    :   Type:
        :   [`NodeGeometryEvaluateClosureOutputItems`](NodeGeometryEvaluateClosureOutputItems.md#bpy.types.NodeGeometryEvaluateClosureOutputItems "bpy.types.NodeGeometryEvaluateClosureOutputItems") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`NodeGeometryEvaluateClosureOutputItem`](NodeGeometryEvaluateClosureOutputItem.md#bpy.types.NodeGeometryEvaluateClosureOutputItem "bpy.types.NodeGeometryEvaluateClosureOutputItem"), (readonly)

    *classmethod* is\_registered\_node\_type()[¶](#bpy.types.GeometryNodeEvaluateClosure.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[¶](#bpy.types.GeometryNodeEvaluateClosure.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[¶](#bpy.types.GeometryNodeEvaluateClosure.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.GeometryNodeEvaluateClosure.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.GeometryNodeEvaluateClosure.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeEvaluateClosure.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.GeometryNodeEvaluateClosure.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeEvaluateClosure(GeometryNode)
  + [`GeometryNodeEvaluateClosure`](#bpy.types.GeometryNodeEvaluateClosure)
    - [`GeometryNodeEvaluateClosure.active_input_index`](#bpy.types.GeometryNodeEvaluateClosure.active_input_index)
    - [`GeometryNodeEvaluateClosure.active_output_index`](#bpy.types.GeometryNodeEvaluateClosure.active_output_index)
    - [`GeometryNodeEvaluateClosure.input_items`](#bpy.types.GeometryNodeEvaluateClosure.input_items)
    - [`GeometryNodeEvaluateClosure.output_items`](#bpy.types.GeometryNodeEvaluateClosure.output_items)
    - [`GeometryNodeEvaluateClosure.is_registered_node_type()`](#bpy.types.GeometryNodeEvaluateClosure.is_registered_node_type)
    - [`GeometryNodeEvaluateClosure.input_template()`](#bpy.types.GeometryNodeEvaluateClosure.input_template)
    - [`GeometryNodeEvaluateClosure.output_template()`](#bpy.types.GeometryNodeEvaluateClosure.output_template)
    - [`GeometryNodeEvaluateClosure.bl_rna_get_subclass()`](#bpy.types.GeometryNodeEvaluateClosure.bl_rna_get_subclass)
    - [`GeometryNodeEvaluateClosure.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeEvaluateClosure.bl_rna_get_subclass_py)
