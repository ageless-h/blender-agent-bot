...
# ActionConstraint(Constraint)[¶](#actionconstraint-constraint "Link to this heading")
...
*class* bpy.types.ActionConstraint(*Constraint*)[¶](#bpy.types.ActionConstraint "Link to this definition")
:   Map an action to the transform axes of a bone

    action[¶](#bpy.types.ActionConstraint.action "Link to this definition")
    :   The constraining action

        Type:
        :   [`Action`](Action.md#bpy.types.Action "bpy.types.Action")

    action\_slot[¶](#bpy.types.ActionConstraint.action_slot "Link to this definition")
    ...
    action\_slot\_handle[¶](#bpy.types.ActionConstraint.action_slot_handle "Link to this definition")
    :   A number that identifies which sub-set of the Action is considered to be for this Action Constraint

        Type:
        :   int in [-inf, inf], default 0

    action\_suitable\_slots[¶](#bpy.types.ActionConstraint.action_suitable_slots "Link to this definition")
    ...
    eval\_time[¶](#bpy.types.ActionConstraint.eval_time "Link to this definition")
    :   Interpolates between Action Start and End frames

        Type:
        :   float in [0, 1], default 0.0

    frame\_end[¶](#bpy.types.ActionConstraint.frame_end "Link to this definition")
    :   Last frame of the Action to use

        Type:
        :   int in [-1048574, 1048574], default 0

    frame\_start[¶](#bpy.types.ActionConstraint.frame_start "Link to this definition")
    :   First frame of the Action to use

        Type:
        :   int in [-1048574, 1048574], default 0

    last\_slot\_identifier[¶](#bpy.types.ActionConstraint.last_slot_identifier "Link to this definition")
    ...
    max[¶](#bpy.types.ActionConstraint.max "Link to this definition")
    :   Maximum value for target channel range

        Type:
        :   float in [-1000, 1000], default 0.0

    min[¶](#bpy.types.ActionConstraint.min "Link to this definition")
    :   Minimum value for target channel range

        Type:
        :   float in [-1000, 1000], default 0.0

    mix\_mode[¶](#bpy.types.ActionConstraint.mix_mode "Link to this definition")
    ...
    subtarget[¶](#bpy.types.ActionConstraint.subtarget "Link to this definition")
    :   Armature bone, mesh or lattice vertex group, …

        Type:
        :   string, default “”, (never None)

    target[¶](#bpy.types.ActionConstraint.target "Link to this definition")
    :   Target object

        Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object")

    transform\_channel[¶](#bpy.types.ActionConstraint.transform_channel "Link to this definition")
    ...
    use\_bone\_object\_action[¶](#bpy.types.ActionConstraint.use_bone_object_action "Link to this definition")
    ...
    use\_eval\_time[¶](#bpy.types.ActionConstraint.use_eval_time "Link to this definition")
    :   Interpolate between Action Start and End frames, with the Evaluation Time slider instead of the Target object/bone

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ActionConstraint.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ActionConstraint.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
ActionChannelbags(bpy\_struct)](ActionChannelbags.md)
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ActionConstraint.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.ActionConstraint.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ActionConstraint(Constraint)
  + [`ActionConstraint`](#bpy.types.ActionConstraint)
    - [`ActionConstraint.action`](#bpy.types.ActionConstraint.action)
    - [`ActionConstraint.action_slot`](#bpy.types.ActionConstraint.action_slot)
    - [`ActionConstraint.action_slot_handle`](#bpy.types.ActionConstraint.action_slot_handle)
    - [`ActionConstraint.action_suitable_slots`](#bpy.types.ActionConstraint.action_suitable_slots)
    - [`ActionConstraint.eval_time`](#bpy.types.ActionConstraint.eval_time)
    - [`ActionConstraint.frame_end`](#bpy.types.ActionConstraint.frame_end)
    - [`ActionConstraint.frame_start`](#bpy.types.ActionConstraint.frame_start)
    - [`ActionConstraint.last_slot_identifier`](#bpy.types.ActionConstraint.last_slot_identifier)
    - [`ActionConstraint.max`](#bpy.types.ActionConstraint.max)
    - [`ActionConstraint.min`](#bpy.types.ActionConstraint.min)
    - [`ActionConstraint.mix_mode`](#bpy.types.ActionConstraint.mix_mode)
    - [`ActionConstraint.subtarget`](#bpy.types.ActionConstraint.subtarget)
    - [`ActionConstraint.target`](#bpy.types.ActionConstraint.target)
    - [`ActionConstraint.transform_channel`](#bpy.types.ActionConstraint.transform_channel)
    - [`ActionConstraint.use_bone_object_action`](#bpy.types.ActionConstraint.use_bone_object_action)
    - [`ActionConstraint.use_eval_time`](#bpy.types.ActionConstraint.use_eval_time)
    - [`ActionConstraint.bl_rna_get_subclass()`](#bpy.types.ActionConstraint.bl_rna_get_subclass)
    - [`ActionConstraint.bl_rna_get_subclass_py()`](#bpy.types.ActionConstraint.bl_rna_get_subclass_py)
