...
# MeshPolygon(bpy\_struct)[¶](#meshpolygon-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.MeshPolygon(*bpy\_struct*)[¶](#bpy.types.MeshPolygon "Link to this definition")
:   Polygon in a Mesh data-block

    area[¶](#bpy.types.MeshPolygon.area "Link to this definition")
    :   Read only area of this face

        Type:
        :   float in [0, inf], default 0.0, (readonly)

    center[¶](#bpy.types.MeshPolygon.center "Link to this definition")
    :   Center of this face

        Type:
        :   [`mathutils.Vector`](../../mathutils/index.md#mathutils.Vector "mathutils.Vector") of 3 items in [-inf, inf], default (0.0, 0.0, 0.0), (readonly)

    hide[¶](#bpy.types.MeshPolygon.hide "Link to this definition")
    :   Type:
        :   boolean, default False

    index[¶](#bpy.types.MeshPolygon.index "Link to this definition")
    :   Index of this face

        Type:
        :   int in [0, inf], default 0, (readonly)

    loop\_start[¶](#bpy.types.MeshPolygon.loop_start "Link to this definition")
    :   Index of the first loop of this face

        Type:
        :   int in [0, inf], default 0

    loop\_total[¶](#bpy.types.MeshPolygon.loop_total "Link to this definition")
    :   Number of loops used by this face

        Type:
        :   int in [0, inf], default 0, (readonly)

    material\_index[¶](#bpy.types.MeshPolygon.material_index "Link to this definition")
    :   Material slot index of this face

        Type:
        :   int in [0, inf], default 0

    normal[¶](#bpy.types.MeshPolygon.normal "Link to this definition")
    :   Local space unit length normal vector for this face

        Type:
        :   [`mathutils.Vector`](../../mathutils/index.md#mathutils.Vector "mathutils.Vector") of 3 items in [-1, 1], default (0.0, 0.0, 0.0), (readonly)

    select[¶](#bpy.types.MeshPolygon.select "Link to this definition")
    :   Type:
        :   boolean, default False

    use\_freestyle\_mark[¶](#bpy.types.MeshPolygon.use_freestyle_mark "Link to this definition")
    :   Face mark for Freestyle line rendering

        Type:
        :   boolean, default False

    use\_smooth[¶](#bpy.types.MeshPolygon.use_smooth "Link to this definition")
    :   Type:
        :   boolean, default False

    vertices[¶](#bpy.types.MeshPolygon.vertices "Link to this definition")
    :   Vertex indices

        Type:
        :   int array of 3 items in [0, inf], default (0, 0, 0)

    edge\_keys[¶](#bpy.types.MeshPolygon.edge_keys "Link to this definition")
    :   (readonly)

    loop\_indices[¶](#bpy.types.MeshPolygon.loop_indices "Link to this definition")
    :   (readonly)

    flip()[¶](#bpy.types.MeshPolygon.flip "Link to this definition")
    :   Invert winding of this face (flip its normal)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.MeshPolygon.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.MeshPolygon.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Mesh.polygons`](Mesh.md#bpy.types.Mesh.polygons "bpy.types.Mesh.polygons") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.MeshPolygon.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.MeshPolygon.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* MeshPolygon(bpy\_struct)
  + [`MeshPolygon`](#bpy.types.MeshPolygon)
    - [`MeshPolygon.area`](#bpy.types.MeshPolygon.area)
    - [`MeshPolygon.center`](#bpy.types.MeshPolygon.center)
    - [`MeshPolygon.hide`](#bpy.types.MeshPolygon.hide)
    - [`MeshPolygon.index`](#bpy.types.MeshPolygon.index)
    - [`MeshPolygon.loop_start`](#bpy.types.MeshPolygon.loop_start)
    - [`MeshPolygon.loop_total`](#bpy.types.MeshPolygon.loop_total)
    - [`MeshPolygon.material_index`](#bpy.types.MeshPolygon.material_index)
    - [`MeshPolygon.normal`](#bpy.types.MeshPolygon.normal)
    - [`MeshPolygon.select`](#bpy.types.MeshPolygon.select)
    - [`MeshPolygon.use_freestyle_mark`](#bpy.types.MeshPolygon.use_freestyle_mark)
    - [`MeshPolygon.use_smooth`](#bpy.types.MeshPolygon.use_smooth)
    - [`MeshPolygon.vertices`](#bpy.types.MeshPolygon.vertices)
    - [`MeshPolygon.edge_keys`](#bpy.types.MeshPolygon.edge_keys)
    - [`MeshPolygon.loop_indices`](#bpy.types.MeshPolygon.loop_indices)
    - [`MeshPolygon.flip()`](#bpy.types.MeshPolygon.flip)
    - [`MeshPolygon.bl_rna_get_subclass()`](#bpy.types.MeshPolygon.bl_rna_get_subclass)
    - [`MeshPolygon.bl_rna_get_subclass_py()`](#bpy.types.MeshPolygon.bl_rna_get_subclass_py)
