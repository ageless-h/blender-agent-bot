...
# BooleanModifier(Modifier)[¶](#booleanmodifier-modifier "Link to this heading")
...
*class* bpy.types.BooleanModifier(*Modifier*)[¶](#bpy.types.BooleanModifier "Link to this definition")
:   Boolean operations modifier

    collection[¶](#bpy.types.BooleanModifier.collection "Link to this definition")
    ...
    debug\_options[¶](#bpy.types.BooleanModifier.debug_options "Link to this definition")
    :   Debugging options, only when started with ‘-d’

        Type:
        :   enum set in {`'SEPARATE'`, `'NO_DISSOLVE'`, `'NO_CONNECT_REGIONS'`}, default set()

    double\_threshold[¶](#bpy.types.BooleanModifier.double_threshold "Link to this definition")
    :   Threshold for checking overlapping geometry

        Type:
        :   float in [0, 1], default 1e-06

    material\_mode[¶](#bpy.types.BooleanModifier.material_mode "Link to this definition")
    :   Method for setting materials on the new faces

        * `INDEX`
          Index Based – Set the material on new faces based on the order of the material slot lists. If a material doesn’t exist on the modifier object, the face will use the same material slot or the first if the object doesn’t have enough slots..
        * `TRANSFER`
    ...
    object[¶](#bpy.types.BooleanModifier.object "Link to this definition")
    :   Mesh object to use for Boolean operation

        Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object")

    operand\_type[¶](#bpy.types.BooleanModifier.operand_type "Link to this definition")
    :   * `OBJECT`
    ...
    operation[¶](#bpy.types.BooleanModifier.operation "Link to this definition")
    :   * `INTERSECT`
    ...
    solver[¶](#bpy.types.BooleanModifier.solver "Link to this definition")
    ...
    use\_hole\_tolerant[¶](#bpy.types.BooleanModifier.use_hole_tolerant "Link to this definition")
    :   Better results when there are holes (slower)

        Type:
        :   boolean, default False

    use\_self[¶](#bpy.types.BooleanModifier.use_self "Link to this definition")
    :   Allow self-intersection in operands

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.BooleanModifier.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.BooleanModifier.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.BooleanModifier.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.BooleanModifier.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* BooleanModifier(Modifier)
  + [`BooleanModifier`](#bpy.types.BooleanModifier)
    - [`BooleanModifier.collection`](#bpy.types.BooleanModifier.collection)
    - [`BooleanModifier.debug_options`](#bpy.types.BooleanModifier.debug_options)
    - [`BooleanModifier.double_threshold`](#bpy.types.BooleanModifier.double_threshold)
    - [`BooleanModifier.material_mode`](#bpy.types.BooleanModifier.material_mode)
    - [`BooleanModifier.object`](#bpy.types.BooleanModifier.object)
    - [`BooleanModifier.operand_type`](#bpy.types.BooleanModifier.operand_type)
    - [`BooleanModifier.operation`](#bpy.types.BooleanModifier.operation)
    - [`BooleanModifier.solver`](#bpy.types.BooleanModifier.solver)
    - [`BooleanModifier.use_hole_tolerant`](#bpy.types.BooleanModifier.use_hole_tolerant)
    - [`BooleanModifier.use_self`](#bpy.types.BooleanModifier.use_self)
    - [`BooleanModifier.bl_rna_get_subclass()`](#bpy.types.BooleanModifier.bl_rna_get_subclass)
    - [`BooleanModifier.bl_rna_get_subclass_py()`](#bpy.types.BooleanModifier.bl_rna_get_subclass_py)
