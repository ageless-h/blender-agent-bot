...
# GreasePencilv3(ID)[¶](#greasepencilv3-id "Link to this heading")

base classes — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct"), [`ID`](ID.md#bpy.types.ID "bpy.types.ID")

*class* bpy.types.GreasePencilv3(*ID*)[¶](#bpy.types.GreasePencilv3 "Link to this definition")
:   Grease Pencil data-block

    after\_color[¶](#bpy.types.GreasePencilv3.after_color "Link to this definition")
    ...
    animation\_data[¶](#bpy.types.GreasePencilv3.animation_data "Link to this definition")
    :   Animation data for this data-block

        Type:
        :   [`AnimData`](AnimData.md#bpy.types.AnimData "bpy.types.AnimData"), (readonly)

    attributes[¶](#bpy.types.GreasePencilv3.attributes "Link to this definition")
    :   Geometry attributes
    ...
    before\_color[¶](#bpy.types.GreasePencilv3.before_color "Link to this definition")
    ...
    color\_attributes[¶](#bpy.types.GreasePencilv3.color_attributes "Link to this definition")
    :   Geometry color attributes

        Type:
        :   [`AttributeGroupGreasePencil`](AttributeGroupGreasePencil.md#bpy.types.AttributeGroupGreasePencil "bpy.types.AttributeGroupGreasePencil") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`Attribute`](Attribute.md#bpy.types.Attribute "bpy.types.Attribute"), (readonly)

    ghost\_after\_range[¶](#bpy.types.GreasePencilv3.ghost_after_range "Link to this definition")
    :   Maximum number of frames to show after current frame (0 = don’t show any frames after current)

        Type:
        :   int in [0, 120], default 1

    ghost\_before\_range[¶](#bpy.types.GreasePencilv3.ghost_before_range "Link to this definition")
    :   Maximum number of frames to show before current frame (0 = don’t show any frames before current)

        Type:
        :   int in [0, 120], default 1

    layer\_groups[¶](#bpy.types.GreasePencilv3.layer_groups "Link to this definition")
    ...
    layers[¶](#bpy.types.GreasePencilv3.layers "Link to this definition")
    ...
    materials[¶](#bpy.types.GreasePencilv3.materials "Link to this definition")
    :   Type:
    ...
    onion\_factor[¶](#bpy.types.GreasePencilv3.onion_factor "Link to this definition")
    :   Change fade opacity of displayed onion frames

        Type:
        :   float in [0, 1], default 0.5

    onion\_keyframe\_type[¶](#bpy.types.GreasePencilv3.onion_keyframe_type "Link to this definition")
    ...
    onion\_mode[¶](#bpy.types.GreasePencilv3.onion_mode "Link to this definition")
    ...
    stroke\_depth\_order[¶](#bpy.types.GreasePencilv3.stroke_depth_order "Link to this definition")
    ...
    use\_autolock\_layers[¶](#bpy.types.GreasePencilv3.use_autolock_layers "Link to this definition")
    :   Automatically lock all layers except the active one to avoid accidental changes

        Type:
        :   boolean, default False

    use\_ghost\_custom\_colors[¶](#bpy.types.GreasePencilv3.use_ghost_custom_colors "Link to this definition")
    :   Use custom colors for ghost frames

        Type:
        :   boolean, default False

    use\_onion\_fade[¶](#bpy.types.GreasePencilv3.use_onion_fade "Link to this definition")
    :   Display onion keyframes with a fade in color transparency

        Type:
        :   boolean, default False

    use\_onion\_loop[¶](#bpy.types.GreasePencilv3.use_onion_loop "Link to this definition")
    :   Display onion keyframes for looping animations

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.GreasePencilv3.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.GreasePencilv3.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`bpy.context.grease_pencil`](../context/index.md#bpy.context.grease_pencil "bpy.context.grease_pencil") * [`BlendData.grease_pencils_v3`](BlendData.md#bpy.types.BlendData.grease_pencils_v3 "bpy.types.BlendData.grease_pencils_v3") | * [`BlendDataGreasePencilsV3.new`](BlendDataGreasePencilsV3.md#bpy.types.BlendDataGreasePencilsV3.new "bpy.types.BlendDataGreasePencilsV3.new") * [`BlendDataGreasePencilsV3.remove`](BlendDataGreasePencilsV3.md#bpy.types.BlendDataGreasePencilsV3.remove "bpy.types.BlendDataGreasePencilsV3.remove") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GreasePencilv3.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.GreasePencilv3.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GreasePencilv3(ID)
  + [`GreasePencilv3`](#bpy.types.GreasePencilv3)
    - [`GreasePencilv3.after_color`](#bpy.types.GreasePencilv3.after_color)
    - [`GreasePencilv3.animation_data`](#bpy.types.GreasePencilv3.animation_data)
    - [`GreasePencilv3.attributes`](#bpy.types.GreasePencilv3.attributes)
    - [`GreasePencilv3.before_color`](#bpy.types.GreasePencilv3.before_color)
    - [`GreasePencilv3.color_attributes`](#bpy.types.GreasePencilv3.color_attributes)
    - [`GreasePencilv3.ghost_after_range`](#bpy.types.GreasePencilv3.ghost_after_range)
    - [`GreasePencilv3.ghost_before_range`](#bpy.types.GreasePencilv3.ghost_before_range)
    - [`GreasePencilv3.layer_groups`](#bpy.types.GreasePencilv3.layer_groups)
    - [`GreasePencilv3.layers`](#bpy.types.GreasePencilv3.layers)
    - [`GreasePencilv3.materials`](#bpy.types.GreasePencilv3.materials)
    - [`GreasePencilv3.onion_factor`](#bpy.types.GreasePencilv3.onion_factor)
    - [`GreasePencilv3.onion_keyframe_type`](#bpy.types.GreasePencilv3.onion_keyframe_type)
    - [`GreasePencilv3.onion_mode`](#bpy.types.GreasePencilv3.onion_mode)
    - [`GreasePencilv3.stroke_depth_order`](#bpy.types.GreasePencilv3.stroke_depth_order)
    - [`GreasePencilv3.use_autolock_layers`](#bpy.types.GreasePencilv3.use_autolock_layers)
    - [`GreasePencilv3.use_ghost_custom_colors`](#bpy.types.GreasePencilv3.use_ghost_custom_colors)
    - [`GreasePencilv3.use_onion_fade`](#bpy.types.GreasePencilv3.use_onion_fade)
    - [`GreasePencilv3.use_onion_loop`](#bpy.types.GreasePencilv3.use_onion_loop)
    - [`GreasePencilv3.bl_rna_get_subclass()`](#bpy.types.GreasePencilv3.bl_rna_get_subclass)
    - [`GreasePencilv3.bl_rna_get_subclass_py()`](#bpy.types.GreasePencilv3.bl_rna_get_subclass_py)
