...
:   Generate a poly spline for each input spline
    ...
    keep\_last\_segment[¶](#bpy.types.GeometryNodeResampleCurve.keep_last_segment "Link to this definition")
