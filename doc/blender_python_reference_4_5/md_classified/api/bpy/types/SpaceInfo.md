...
# SpaceInfo(Space)[¶](#spaceinfo-space "Link to this heading")
...
*class* bpy.types.SpaceInfo(*Space*)[¶](#bpy.types.SpaceInfo "Link to this definition")
:   Info space data

    show\_report\_debug[¶](#bpy.types.SpaceInfo.show_report_debug "Link to this definition")
    :   Display debug reporting info

        Type:
        :   boolean, default False

    show\_report\_error[¶](#bpy.types.SpaceInfo.show_report_error "Link to this definition")
    :   Display error text

        Type:
        :   boolean, default False

    show\_report\_info[¶](#bpy.types.SpaceInfo.show_report_info "Link to this definition")
    :   Display general information

        Type:
        :   boolean, default False

    show\_report\_operator[¶](#bpy.types.SpaceInfo.show_report_operator "Link to this definition")
    :   Display the operator log

        Type:
        :   boolean, default False

    show\_report\_warning[¶](#bpy.types.SpaceInfo.show_report_warning "Link to this definition")
    :   Display warnings

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.SpaceInfo.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.SpaceInfo.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
    ...
    *classmethod* draw\_handler\_add(*callback*, *args*, *region\_type*, *draw\_type*)[¶](#bpy.types.SpaceInfo.draw_handler_add "Link to this definition")
    ...
    *classmethod* draw\_handler\_remove(*handler*, *region\_type*)[¶](#bpy.types.SpaceInfo.draw_handler_remove "Link to this definition")
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.SpaceInfo.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.SpaceInfo.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* SpaceInfo(Space)
  + [`SpaceInfo`](#bpy.types.SpaceInfo)
    - [`SpaceInfo.show_report_debug`](#bpy.types.SpaceInfo.show_report_debug)
    - [`SpaceInfo.show_report_error`](#bpy.types.SpaceInfo.show_report_error)
    - [`SpaceInfo.show_report_info`](#bpy.types.SpaceInfo.show_report_info)
    - [`SpaceInfo.show_report_operator`](#bpy.types.SpaceInfo.show_report_operator)
    - [`SpaceInfo.show_report_warning`](#bpy.types.SpaceInfo.show_report_warning)
    - [`SpaceInfo.bl_rna_get_subclass()`](#bpy.types.SpaceInfo.bl_rna_get_subclass)
    - [`SpaceInfo.bl_rna_get_subclass_py()`](#bpy.types.SpaceInfo.bl_rna_get_subclass_py)
    - [`SpaceInfo.draw_handler_add()`](#bpy.types.SpaceInfo.draw_handler_add)
    - [`SpaceInfo.draw_handler_remove()`](#bpy.types.SpaceInfo.draw_handler_remove)
