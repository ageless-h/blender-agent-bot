...
# ActionFCurves(bpy\_struct)[¶](#actionfcurves-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.ActionFCurves(*bpy\_struct*)[¶](#bpy.types.ActionFCurves "Link to this definition")
:   Collection of action F-Curves. Note that this is a legacy API that is unaware of action slots, and will only consider the F-Curves for this action’s first slot
    ...
    new(*data\_path*, *\**, *index=0*, *action\_group=''*)[¶](#bpy.types.ActionFCurves.new "Link to this definition")
    :   Add an F-Curve for the first slot of this action, creating the necessary layer, strip, and slot if necessary
        ...
        :   * **data\_path** (*string**,* *(**never None**)*) – Data Path, F-Curve data path to use
            ...
            * **action\_group** (*string**,* *(**optional**,* *never None**)*) – Action Group, Acton group to add this F-Curve into
    ...
    find(*data\_path*, *\**, *index=0*)[¶](#bpy.types.ActionFCurves.find "Link to this definition")
    ...
    remove(*fcurve*)[¶](#bpy.types.ActionFCurves.remove "Link to this definition")
    ...
    clear()[¶](#bpy.types.ActionFCurves.clear "Link to this definition")
    :   Remove all F-Curves from the action’s first slot

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ActionFCurves.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ActionFCurves.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Action.fcurves`](Action.md#bpy.types.Action.fcurves "bpy.types.Action.fcurves") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ActionFCurves.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.ActionFCurves.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ActionFCurves(bpy\_struct)
  + [`ActionFCurves`](#bpy.types.ActionFCurves)
    - [`ActionFCurves.new()`](#bpy.types.ActionFCurves.new)
    - [`ActionFCurves.find()`](#bpy.types.ActionFCurves.find)
    - [`ActionFCurves.remove()`](#bpy.types.ActionFCurves.remove)
    - [`ActionFCurves.clear()`](#bpy.types.ActionFCurves.clear)
    - [`ActionFCurves.bl_rna_get_subclass()`](#bpy.types.ActionFCurves.bl_rna_get_subclass)
    - [`ActionFCurves.bl_rna_get_subclass_py()`](#bpy.types.ActionFCurves.bl_rna_get_subclass_py)
