...
# NodeGeometryEvaluateClosureInputItems(bpy\_struct)[¶](#nodegeometryevaluateclosureinputitems-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.NodeGeometryEvaluateClosureInputItems(*bpy\_struct*)[¶](#bpy.types.NodeGeometryEvaluateClosureInputItems "Link to this definition")
:   new(*socket\_type*, *name*)[¶](#bpy.types.NodeGeometryEvaluateClosureInputItems.new "Link to this definition")
    :   Add an item at the end
        ...
        Return type:
        :   [`NodeGeometryEvaluateClosureInputItem`](NodeGeometryEvaluateClosureInputItem.md#bpy.types.NodeGeometryEvaluateClosureInputItem "bpy.types.NodeGeometryEvaluateClosureInputItem")

    remove(*item*)[¶](#bpy.types.NodeGeometryEvaluateClosureInputItems.remove "Link to this definition")
    :   Remove an item

        Parameters:
        :   **item** ([`NodeGeometryEvaluateClosureInputItem`](NodeGeometryEvaluateClosureInputItem.md#bpy.types.NodeGeometryEvaluateClosureInputItem "bpy.types.NodeGeometryEvaluateClosureInputItem"), (never None)) – Item, The item to remove

    clear()[¶](#bpy.types.NodeGeometryEvaluateClosureInputItems.clear "Link to this definition")
    :   Remove all items

    move(*from\_index*, *to\_index*)[¶](#bpy.types.NodeGeometryEvaluateClosureInputItems.move "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.NodeGeometryEvaluateClosureInputItems.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.NodeGeometryEvaluateClosureInputItems.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`GeometryNodeEvaluateClosure.input_items`](GeometryNodeEvaluateClosure.md#bpy.types.GeometryNodeEvaluateClosure.input_items "bpy.types.GeometryNodeEvaluateClosure.input_items") |  |

[Next

NodeGeometryEvaluateClosureOutputItem(bpy\_struct)](NodeGeometryEvaluateClosureOutputItem.md)
[Previous

NodeGeometryEvaluateClosureInputItem(bpy\_struct)](NodeGeometryEvaluateClosureInputItem.md)
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.NodeGeometryEvaluateClosureInputItems.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.NodeGeometryEvaluateClosureInputItems.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* NodeGeometryEvaluateClosureInputItems(bpy\_struct)
  + [`NodeGeometryEvaluateClosureInputItems`](#bpy.types.NodeGeometryEvaluateClosureInputItems)
    - [`NodeGeometryEvaluateClosureInputItems.new()`](#bpy.types.NodeGeometryEvaluateClosureInputItems.new)
    - [`NodeGeometryEvaluateClosureInputItems.remove()`](#bpy.types.NodeGeometryEvaluateClosureInputItems.remove)
    - [`NodeGeometryEvaluateClosureInputItems.clear()`](#bpy.types.NodeGeometryEvaluateClosureInputItems.clear)
    - [`NodeGeometryEvaluateClosureInputItems.move()`](#bpy.types.NodeGeometryEvaluateClosureInputItems.move)
    - [`NodeGeometryEvaluateClosureInputItems.bl_rna_get_subclass()`](#bpy.types.NodeGeometryEvaluateClosureInputItems.bl_rna_get_subclass)
    - [`NodeGeometryEvaluateClosureInputItems.bl_rna_get_subclass_py()`](#bpy.types.NodeGeometryEvaluateClosureInputItems.bl_rna_get_subclass_py)
