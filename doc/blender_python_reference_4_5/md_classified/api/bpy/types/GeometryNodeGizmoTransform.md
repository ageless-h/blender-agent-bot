...
# GeometryNodeGizmoTransform(GeometryNode)[¶](#geometrynodegizmotransform-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeGizmoTransform(*GeometryNode*)[¶](#bpy.types.GeometryNodeGizmoTransform "Link to this definition")
:   Show a transform gizmo in the viewport

    use\_rotation\_x[¶](#bpy.types.GeometryNodeGizmoTransform.use_rotation_x "Link to this definition")
    :   Type:
        :   boolean, default False

    use\_rotation\_y[¶](#bpy.types.GeometryNodeGizmoTransform.use_rotation_y "Link to this definition")
    :   Type:
        :   boolean, default False

    use\_rotation\_z[¶](#bpy.types.GeometryNodeGizmoTransform.use_rotation_z "Link to this definition")
    :   Type:
        :   boolean, default False

    use\_scale\_x[¶](#bpy.types.GeometryNodeGizmoTransform.use_scale_x "Link to this definition")
    :   Type:
        :   boolean, default False

    use\_scale\_y[¶](#bpy.types.GeometryNodeGizmoTransform.use_scale_y "Link to this definition")
    :   Type:
        :   boolean, default False

    use\_scale\_z[¶](#bpy.types.GeometryNodeGizmoTransform.use_scale_z "Link to this definition")
    :   Type:
        :   boolean, default False

    use\_translation\_x[¶](#bpy.types.GeometryNodeGizmoTransform.use_translation_x "Link to this definition")
    :   Type:
        :   boolean, default False

    use\_translation\_y[¶](#bpy.types.GeometryNodeGizmoTransform.use_translation_y "Link to this definition")
    :   Type:
        :   boolean, default False

    use\_translation\_z[¶](#bpy.types.GeometryNodeGizmoTransform.use_translation_z "Link to this definition")
    :   Type:
        :   boolean, default False

    *classmethod* is\_registered\_node\_type()[¶](#bpy.types.GeometryNodeGizmoTransform.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[¶](#bpy.types.GeometryNodeGizmoTransform.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[¶](#bpy.types.GeometryNodeGizmoTransform.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.GeometryNodeGizmoTransform.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.GeometryNodeGizmoTransform.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
GeometryNodeGreasePencilToCurves(GeometryNode)](GeometryNodeGreasePencilToCurves.md)
[Previous

GeometryNodeGizmoLinear(GeometryNode)](GeometryNodeGizmoLinear.md)
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeGizmoTransform.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.GeometryNodeGizmoTransform.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeGizmoTransform(GeometryNode)
  + [`GeometryNodeGizmoTransform`](#bpy.types.GeometryNodeGizmoTransform)
    - [`GeometryNodeGizmoTransform.use_rotation_x`](#bpy.types.GeometryNodeGizmoTransform.use_rotation_x)
    - [`GeometryNodeGizmoTransform.use_rotation_y`](#bpy.types.GeometryNodeGizmoTransform.use_rotation_y)
    - [`GeometryNodeGizmoTransform.use_rotation_z`](#bpy.types.GeometryNodeGizmoTransform.use_rotation_z)
    - [`GeometryNodeGizmoTransform.use_scale_x`](#bpy.types.GeometryNodeGizmoTransform.use_scale_x)
    - [`GeometryNodeGizmoTransform.use_scale_y`](#bpy.types.GeometryNodeGizmoTransform.use_scale_y)
    - [`GeometryNodeGizmoTransform.use_scale_z`](#bpy.types.GeometryNodeGizmoTransform.use_scale_z)
    - [`GeometryNodeGizmoTransform.use_translation_x`](#bpy.types.GeometryNodeGizmoTransform.use_translation_x)
    - [`GeometryNodeGizmoTransform.use_translation_y`](#bpy.types.GeometryNodeGizmoTransform.use_translation_y)
    - [`GeometryNodeGizmoTransform.use_translation_z`](#bpy.types.GeometryNodeGizmoTransform.use_translation_z)
    - [`GeometryNodeGizmoTransform.is_registered_node_type()`](#bpy.types.GeometryNodeGizmoTransform.is_registered_node_type)
    - [`GeometryNodeGizmoTransform.input_template()`](#bpy.types.GeometryNodeGizmoTransform.input_template)
    - [`GeometryNodeGizmoTransform.output_template()`](#bpy.types.GeometryNodeGizmoTransform.output_template)
    - [`GeometryNodeGizmoTransform.bl_rna_get_subclass()`](#bpy.types.GeometryNodeGizmoTransform.bl_rna_get_subclass)
    - [`GeometryNodeGizmoTransform.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeGizmoTransform.bl_rna_get_subclass_py)
