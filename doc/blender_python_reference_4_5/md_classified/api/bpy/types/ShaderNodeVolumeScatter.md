...
:   Scatter light as it passes through the volume, often used to add fog to a scene
    ...
    phase[¶](#bpy.types.ShaderNodeVolumeScatter.phase "Link to this definition")
