...
# NodeGeometrySeparateBundleItems(bpy\_struct)[¶](#nodegeometryseparatebundleitems-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.NodeGeometrySeparateBundleItems(*bpy\_struct*)[¶](#bpy.types.NodeGeometrySeparateBundleItems "Link to this definition")
:   Collection of separate bundle items

    new(*socket\_type*, *name*)[¶](#bpy.types.NodeGeometrySeparateBundleItems.new "Link to this definition")
    :   Add an item at the end
        ...
        Return type:
        :   [`NodeGeometrySeparateBundleItem`](NodeGeometrySeparateBundleItem.md#bpy.types.NodeGeometrySeparateBundleItem "bpy.types.NodeGeometrySeparateBundleItem")

    remove(*item*)[¶](#bpy.types.NodeGeometrySeparateBundleItems.remove "Link to this definition")
    :   Remove an item

        Parameters:
        :   **item** ([`NodeGeometrySeparateBundleItem`](NodeGeometrySeparateBundleItem.md#bpy.types.NodeGeometrySeparateBundleItem "bpy.types.NodeGeometrySeparateBundleItem"), (never None)) – Item, The item to remove

    clear()[¶](#bpy.types.NodeGeometrySeparateBundleItems.clear "Link to this definition")
    :   Remove all items

    move(*from\_index*, *to\_index*)[¶](#bpy.types.NodeGeometrySeparateBundleItems.move "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.NodeGeometrySeparateBundleItems.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.NodeGeometrySeparateBundleItems.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`GeometryNodeSeparateBundle.bundle_items`](GeometryNodeSeparateBundle.md#bpy.types.GeometryNodeSeparateBundle.bundle_items "bpy.types.GeometryNodeSeparateBundle.bundle_items") |  |
...
NodeGeometrySeparateBundleItem(bpy\_struct)](NodeGeometrySeparateBundleItem.md)
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.NodeGeometrySeparateBundleItems.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.NodeGeometrySeparateBundleItems.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* NodeGeometrySeparateBundleItems(bpy\_struct)
  + [`NodeGeometrySeparateBundleItems`](#bpy.types.NodeGeometrySeparateBundleItems)
    - [`NodeGeometrySeparateBundleItems.new()`](#bpy.types.NodeGeometrySeparateBundleItems.new)
    - [`NodeGeometrySeparateBundleItems.remove()`](#bpy.types.NodeGeometrySeparateBundleItems.remove)
    - [`NodeGeometrySeparateBundleItems.clear()`](#bpy.types.NodeGeometrySeparateBundleItems.clear)
    - [`NodeGeometrySeparateBundleItems.move()`](#bpy.types.NodeGeometrySeparateBundleItems.move)
    - [`NodeGeometrySeparateBundleItems.bl_rna_get_subclass()`](#bpy.types.NodeGeometrySeparateBundleItems.bl_rna_get_subclass)
    - [`NodeGeometrySeparateBundleItems.bl_rna_get_subclass_py()`](#bpy.types.NodeGeometrySeparateBundleItems.bl_rna_get_subclass_py)
