...
# BlendDataGreasePencils(bpy\_struct)[¶](#blenddatagreasepencils-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.BlendDataGreasePencils(*bpy\_struct*)[¶](#bpy.types.BlendDataGreasePencils "Link to this definition")
:   Collection of annotations

    tag(*value*)[¶](#bpy.types.BlendDataGreasePencils.tag "Link to this definition")
    :   tag

        Parameters:
        :   **value** (*boolean*) – Value

    new(*name*)[¶](#bpy.types.BlendDataGreasePencils.new "Link to this definition")
    ...
    remove(*grease\_pencil*, *\**, *do\_unlink=True*, *do\_id\_user=True*, *do\_ui\_user=True*)[¶](#bpy.types.BlendDataGreasePencils.remove "Link to this definition")
    :   Remove annotation instance from the current blendfile
        ...
        :   * **grease\_pencil** ([`GreasePencil`](GreasePencil.md#bpy.types.GreasePencil "bpy.types.GreasePencil"), (never None)) – Grease Pencil to remove
            ...
            * **do\_id\_user** (*boolean**,* *(**optional**)*) – Decrement user counter of all datablocks used by this annotation
            * **do\_ui\_user** (*boolean**,* *(**optional**)*) – Make sure interface does not reference this annotation

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.BlendDataGreasePencils.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.BlendDataGreasePencils.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.BlendDataGreasePencils.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.BlendDataGreasePencils.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* BlendDataGreasePencils(bpy\_struct)
  + [`BlendDataGreasePencils`](#bpy.types.BlendDataGreasePencils)
    - [`BlendDataGreasePencils.tag()`](#bpy.types.BlendDataGreasePencils.tag)
    - [`BlendDataGreasePencils.new()`](#bpy.types.BlendDataGreasePencils.new)
    - [`BlendDataGreasePencils.remove()`](#bpy.types.BlendDataGreasePencils.remove)
    - [`BlendDataGreasePencils.bl_rna_get_subclass()`](#bpy.types.BlendDataGreasePencils.bl_rna_get_subclass)
    - [`BlendDataGreasePencils.bl_rna_get_subclass_py()`](#bpy.types.BlendDataGreasePencils.bl_rna_get_subclass_py)
