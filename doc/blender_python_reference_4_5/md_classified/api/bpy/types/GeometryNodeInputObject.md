...
# GeometryNodeInputObject(GeometryNode)[¶](#geometrynodeinputobject-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeInputObject(*GeometryNode*)[¶](#bpy.types.GeometryNodeInputObject "Link to this definition")
:   Output a single object

    object[¶](#bpy.types.GeometryNodeInputObject.object "Link to this definition")
    :   Type:
        :   [`Object`](Object.md#bpy.types.Object "bpy.types.Object")

    *classmethod* is\_registered\_node\_type()[¶](#bpy.types.GeometryNodeInputObject.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[¶](#bpy.types.GeometryNodeInputObject.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[¶](#bpy.types.GeometryNodeInputObject.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.GeometryNodeInputObject.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.GeometryNodeInputObject.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeInputObject.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.GeometryNodeInputObject.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeInputObject(GeometryNode)
  + [`GeometryNodeInputObject`](#bpy.types.GeometryNodeInputObject)
    - [`GeometryNodeInputObject.object`](#bpy.types.GeometryNodeInputObject.object)
    - [`GeometryNodeInputObject.is_registered_node_type()`](#bpy.types.GeometryNodeInputObject.is_registered_node_type)
    - [`GeometryNodeInputObject.input_template()`](#bpy.types.GeometryNodeInputObject.input_template)
    - [`GeometryNodeInputObject.output_template()`](#bpy.types.GeometryNodeInputObject.output_template)
    - [`GeometryNodeInputObject.bl_rna_get_subclass()`](#bpy.types.GeometryNodeInputObject.bl_rna_get_subclass)
    - [`GeometryNodeInputObject.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeInputObject.bl_rna_get_subclass_py)
