...
# BlendImportContext(bpy\_struct)[¶](#blendimportcontext-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.BlendImportContext(*bpy\_struct*)[¶](#bpy.types.BlendImportContext "Link to this definition")
:   Contextual data for a blendfile library/linked-data related operation. Currently only exposed as read-only data for the pre/post blendimport handlers
    ...
    import\_items[¶](#bpy.types.BlendImportContext.import_items "Link to this definition")
    :   Type:
        :   [`BlendImportContextItems`](BlendImportContextItems.md#bpy.types.BlendImportContextItems "bpy.types.BlendImportContextItems") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`BlendImportContextItem`](BlendImportContextItem.md#bpy.types.BlendImportContextItem "bpy.types.BlendImportContextItem"), (readonly)

    options[¶](#bpy.types.BlendImportContext.options "Link to this definition")
    ...
    process\_stage[¶](#bpy.types.BlendImportContext.process_stage "Link to this definition")
    :   Current stage of the import process
        ...
        * `DONE`
          All data has been imported and is available in the list of ``import\_items``.

        Type:
        :   enum in [`'INIT'`, `'DONE'`], default `'INIT'`, (readonly)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.BlendImportContext.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.BlendImportContext.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
BlendImportContextItem(bpy\_struct)](BlendImportContextItem.md)
[Previous
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.BlendImportContext.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.BlendImportContext.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* BlendImportContext(bpy\_struct)
  + [`BlendImportContext`](#bpy.types.BlendImportContext)
    - [`BlendImportContext.import_items`](#bpy.types.BlendImportContext.import_items)
    - [`BlendImportContext.options`](#bpy.types.BlendImportContext.options)
    - [`BlendImportContext.process_stage`](#bpy.types.BlendImportContext.process_stage)
    - [`BlendImportContext.bl_rna_get_subclass()`](#bpy.types.BlendImportContext.bl_rna_get_subclass)
    - [`BlendImportContext.bl_rna_get_subclass_py()`](#bpy.types.BlendImportContext.bl_rna_get_subclass_py)
