...
# ActionGroup(bpy\_struct)[¶](#actiongroup-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.ActionGroup(*bpy\_struct*)[¶](#bpy.types.ActionGroup "Link to this definition")
:   Groups of F-Curves

    channels[¶](#bpy.types.ActionGroup.channels "Link to this definition")
    :   F-Curves in this group

        Type:
        :   [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`FCurve`](FCurve.md#bpy.types.FCurve "bpy.types.FCurve"), (readonly)

    color\_set[¶](#bpy.types.ActionGroup.color_set "Link to this definition")
    :   Custom color set to use

        Type:
        :   enum in [Color Sets Items](../../../appendix/bpy_types_enum_items/color_sets_items.md#rna-enum-color-sets-items), default `'DEFAULT'`

    colors[¶](#bpy.types.ActionGroup.colors "Link to this definition")
    :   Copy of the colors associated with the group’s color set

        Type:
        :   [`ThemeBoneColorSet`](ThemeBoneColorSet.md#bpy.types.ThemeBoneColorSet "bpy.types.ThemeBoneColorSet"), (readonly, never None)

    is\_custom\_color\_set[¶](#bpy.types.ActionGroup.is_custom_color_set "Link to this definition")
    :   Color set is user-defined instead of a fixed theme color set

        Type:
        :   boolean, default False, (readonly)

    lock[¶](#bpy.types.ActionGroup.lock "Link to this definition")
    :   Action group is locked

        Type:
        :   boolean, default False

    mute[¶](#bpy.types.ActionGroup.mute "Link to this definition")
    :   Action group is muted

        Type:
        :   boolean, default False

    name[¶](#bpy.types.ActionGroup.name "Link to this definition")
    :   Type:
        :   string, default “”, (never None)

    select[¶](#bpy.types.ActionGroup.select "Link to this definition")
    :   Action group is selected

        Type:
        :   boolean, default False

    show\_expanded[¶](#bpy.types.ActionGroup.show_expanded "Link to this definition")
    :   Action group is expanded except in graph editor

        Type:
        :   boolean, default False

    show\_expanded\_graph[¶](#bpy.types.ActionGroup.show_expanded_graph "Link to this definition")
    :   Action group is expanded in graph editor

        Type:
        :   boolean, default False

    use\_pin[¶](#bpy.types.ActionGroup.use_pin "Link to this definition")
    :   Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ActionGroup.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ActionGroup.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Action.groups`](Action.md#bpy.types.Action.groups "bpy.types.Action.groups") * [`ActionChannelbag.groups`](ActionChannelbag.md#bpy.types.ActionChannelbag.groups "bpy.types.ActionChannelbag.groups") * [`ActionChannelbagGroups.new`](ActionChannelbagGroups.md#bpy.types.ActionChannelbagGroups.new "bpy.types.ActionChannelbagGroups.new") * [`ActionChannelbagGroups.remove`](ActionChannelbagGroups.md#bpy.types.ActionChannelbagGroups.remove "bpy.types.ActionChannelbagGroups.remove") | * [`ActionGroups.new`](ActionGroups.md#bpy.types.ActionGroups.new "bpy.types.ActionGroups.new") * [`ActionGroups.remove`](ActionGroups.md#bpy.types.ActionGroups.remove "bpy.types.ActionGroups.remove") * [`FCurve.group`](FCurve.md#bpy.types.FCurve.group "bpy.types.FCurve.group") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ActionGroup.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.ActionGroup.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ActionGroup(bpy\_struct)
  + [`ActionGroup`](#bpy.types.ActionGroup)
    - [`ActionGroup.channels`](#bpy.types.ActionGroup.channels)
    - [`ActionGroup.color_set`](#bpy.types.ActionGroup.color_set)
    - [`ActionGroup.colors`](#bpy.types.ActionGroup.colors)
    - [`ActionGroup.is_custom_color_set`](#bpy.types.ActionGroup.is_custom_color_set)
    - [`ActionGroup.lock`](#bpy.types.ActionGroup.lock)
    - [`ActionGroup.mute`](#bpy.types.ActionGroup.mute)
    - [`ActionGroup.name`](#bpy.types.ActionGroup.name)
    - [`ActionGroup.select`](#bpy.types.ActionGroup.select)
    - [`ActionGroup.show_expanded`](#bpy.types.ActionGroup.show_expanded)
    - [`ActionGroup.show_expanded_graph`](#bpy.types.ActionGroup.show_expanded_graph)
    - [`ActionGroup.use_pin`](#bpy.types.ActionGroup.use_pin)
    - [`ActionGroup.bl_rna_get_subclass()`](#bpy.types.ActionGroup.bl_rna_get_subclass)
    - [`ActionGroup.bl_rna_get_subclass_py()`](#bpy.types.ActionGroup.bl_rna_get_subclass_py)
