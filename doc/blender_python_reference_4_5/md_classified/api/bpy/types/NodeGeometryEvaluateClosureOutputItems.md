...
# NodeGeometryEvaluateClosureOutputItems(bpy\_struct)[¶](#nodegeometryevaluateclosureoutputitems-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.NodeGeometryEvaluateClosureOutputItems(*bpy\_struct*)[¶](#bpy.types.NodeGeometryEvaluateClosureOutputItems "Link to this definition")
:   new(*socket\_type*, *name*)[¶](#bpy.types.NodeGeometryEvaluateClosureOutputItems.new "Link to this definition")
    :   Add an item at the end
        ...
        Return type:
        :   [`NodeGeometryEvaluateClosureOutputItem`](NodeGeometryEvaluateClosureOutputItem.md#bpy.types.NodeGeometryEvaluateClosureOutputItem "bpy.types.NodeGeometryEvaluateClosureOutputItem")

    remove(*item*)[¶](#bpy.types.NodeGeometryEvaluateClosureOutputItems.remove "Link to this definition")
    :   Remove an item

        Parameters:
        :   **item** ([`NodeGeometryEvaluateClosureOutputItem`](NodeGeometryEvaluateClosureOutputItem.md#bpy.types.NodeGeometryEvaluateClosureOutputItem "bpy.types.NodeGeometryEvaluateClosureOutputItem"), (never None)) – Item, The item to remove

    clear()[¶](#bpy.types.NodeGeometryEvaluateClosureOutputItems.clear "Link to this definition")
    :   Remove all items

    move(*from\_index*, *to\_index*)[¶](#bpy.types.NodeGeometryEvaluateClosureOutputItems.move "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.NodeGeometryEvaluateClosureOutputItems.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.NodeGeometryEvaluateClosureOutputItems.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`GeometryNodeEvaluateClosure.output_items`](GeometryNodeEvaluateClosure.md#bpy.types.GeometryNodeEvaluateClosure.output_items "bpy.types.GeometryNodeEvaluateClosure.output_items") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.NodeGeometryEvaluateClosureOutputItems.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.NodeGeometryEvaluateClosureOutputItems.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* NodeGeometryEvaluateClosureOutputItems(bpy\_struct)
  + [`NodeGeometryEvaluateClosureOutputItems`](#bpy.types.NodeGeometryEvaluateClosureOutputItems)
    - [`NodeGeometryEvaluateClosureOutputItems.new()`](#bpy.types.NodeGeometryEvaluateClosureOutputItems.new)
    - [`NodeGeometryEvaluateClosureOutputItems.remove()`](#bpy.types.NodeGeometryEvaluateClosureOutputItems.remove)
    - [`NodeGeometryEvaluateClosureOutputItems.clear()`](#bpy.types.NodeGeometryEvaluateClosureOutputItems.clear)
    - [`NodeGeometryEvaluateClosureOutputItems.move()`](#bpy.types.NodeGeometryEvaluateClosureOutputItems.move)
    - [`NodeGeometryEvaluateClosureOutputItems.bl_rna_get_subclass()`](#bpy.types.NodeGeometryEvaluateClosureOutputItems.bl_rna_get_subclass)
    - [`NodeGeometryEvaluateClosureOutputItems.bl_rna_get_subclass_py()`](#bpy.types.NodeGeometryEvaluateClosureOutputItems.bl_rna_get_subclass_py)
