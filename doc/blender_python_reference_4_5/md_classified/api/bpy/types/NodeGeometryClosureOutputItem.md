...
# NodeGeometryClosureOutputItem(bpy\_struct)[¶](#nodegeometryclosureoutputitem-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.NodeGeometryClosureOutputItem(*bpy\_struct*)[¶](#bpy.types.NodeGeometryClosureOutputItem "Link to this definition")
:   color[¶](#bpy.types.NodeGeometryClosureOutputItem.color "Link to this definition")
    ...
    name[¶](#bpy.types.NodeGeometryClosureOutputItem.name "Link to this definition")
    :   Type:
        :   string, default “”, (never None)

    socket\_type[¶](#bpy.types.NodeGeometryClosureOutputItem.socket_type "Link to this definition")
    :   Type:
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.NodeGeometryClosureOutputItem.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.NodeGeometryClosureOutputItem.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`GeometryNodeClosureOutput.output_items`](GeometryNodeClosureOutput.md#bpy.types.GeometryNodeClosureOutput.output_items "bpy.types.GeometryNodeClosureOutput.output_items") * [`NodeGeometryClosureOutputItems.new`](NodeGeometryClosureOutputItems.md#bpy.types.NodeGeometryClosureOutputItems.new "bpy.types.NodeGeometryClosureOutputItems.new") | * [`NodeGeometryClosureOutputItems.remove`](NodeGeometryClosureOutputItems.md#bpy.types.NodeGeometryClosureOutputItems.remove "bpy.types.NodeGeometryClosureOutputItems.remove") |

[Next

NodeGeometryClosureOutputItems(bpy\_struct)](NodeGeometryClosureOutputItems.md)
[Previous

NodeGeometryClosureInputItems(bpy\_struct)](NodeGeometryClosureInputItems.md)
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.NodeGeometryClosureOutputItem.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.NodeGeometryClosureOutputItem.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* NodeGeometryClosureOutputItem(bpy\_struct)
  + [`NodeGeometryClosureOutputItem`](#bpy.types.NodeGeometryClosureOutputItem)
    - [`NodeGeometryClosureOutputItem.color`](#bpy.types.NodeGeometryClosureOutputItem.color)
    - [`NodeGeometryClosureOutputItem.name`](#bpy.types.NodeGeometryClosureOutputItem.name)
    - [`NodeGeometryClosureOutputItem.socket_type`](#bpy.types.NodeGeometryClosureOutputItem.socket_type)
    - [`NodeGeometryClosureOutputItem.bl_rna_get_subclass()`](#bpy.types.NodeGeometryClosureOutputItem.bl_rna_get_subclass)
    - [`NodeGeometryClosureOutputItem.bl_rna_get_subclass_py()`](#bpy.types.NodeGeometryClosureOutputItem.bl_rna_get_subclass_py)
