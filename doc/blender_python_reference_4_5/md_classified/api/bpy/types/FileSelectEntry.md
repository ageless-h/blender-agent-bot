...
# FileSelectEntry(bpy\_struct)[¶](#fileselectentry-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.FileSelectEntry(*bpy\_struct*)[¶](#bpy.types.FileSelectEntry "Link to this definition")
:   A file viewable in the File Browser

    asset\_data[¶](#bpy.types.FileSelectEntry.asset_data "Link to this definition")
    ...
    name[¶](#bpy.types.FileSelectEntry.name "Link to this definition")
    :   Type:
        :   string, default “”, (readonly, never None)

    preview\_icon\_id[¶](#bpy.types.FileSelectEntry.preview_icon_id "Link to this definition")
    :   Unique integer identifying the preview of this file as an icon (zero means invalid)

        Type:
        :   int in [-inf, inf], default 0, (readonly)

    relative\_path[¶](#bpy.types.FileSelectEntry.relative_path "Link to this definition")
    :   Path relative to the directory currently displayed in the File Browser (includes the file name)

        Type:
        :   string, default “”, (readonly, never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.FileSelectEntry.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.FileSelectEntry.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`bpy.context.active_file`](../context/index.md#bpy.context.active_file "bpy.context.active_file") * [`bpy.context.selected_files`](../context/index.md#bpy.context.selected_files "bpy.context.selected_files") | * [`AssetHandle.file_data`](AssetHandle.md#bpy.types.AssetHandle.file_data "bpy.types.AssetHandle.file_data") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.FileSelectEntry.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.FileSelectEntry.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* FileSelectEntry(bpy\_struct)
  + [`FileSelectEntry`](#bpy.types.FileSelectEntry)
    - [`FileSelectEntry.asset_data`](#bpy.types.FileSelectEntry.asset_data)
    - [`FileSelectEntry.name`](#bpy.types.FileSelectEntry.name)
    - [`FileSelectEntry.preview_icon_id`](#bpy.types.FileSelectEntry.preview_icon_id)
    - [`FileSelectEntry.relative_path`](#bpy.types.FileSelectEntry.relative_path)
    - [`FileSelectEntry.bl_rna_get_subclass()`](#bpy.types.FileSelectEntry.bl_rna_get_subclass)
    - [`FileSelectEntry.bl_rna_get_subclass_py()`](#bpy.types.FileSelectEntry.bl_rna_get_subclass_py)
