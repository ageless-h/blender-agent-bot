...
:   Decimation modifier
    ...
    :   Limit merging geometry
        ...
        Type:
        :   enum set in [Mesh Delimit Mode Items](../../../appendix/bpy_types_enum_items/mesh_delimit_mode_items.md#rna-enum-mesh-delimit-mode-items), default {`'NORMAL'`}
