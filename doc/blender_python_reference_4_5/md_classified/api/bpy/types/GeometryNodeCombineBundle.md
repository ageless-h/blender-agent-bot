...
# GeometryNodeCombineBundle(GeometryNode)[¶](#geometrynodecombinebundle-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeCombineBundle(*GeometryNode*)[¶](#bpy.types.GeometryNodeCombineBundle "Link to this definition")
:   Combine multiple socket values into one.

    active\_index[¶](#bpy.types.GeometryNodeCombineBundle.active_index "Link to this definition")
    :   Index of the active item

        Type:
        :   int in [0, inf], default 0

    bundle\_items[¶](#bpy.types.GeometryNodeCombineBundle.bundle_items "Link to this definition")
    :   Type:
        :   [`NodeGeometryCombineBundleItems`](NodeGeometryCombineBundleItems.md#bpy.types.NodeGeometryCombineBundleItems "bpy.types.NodeGeometryCombineBundleItems") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`NodeGeometryCombineBundleItem`](NodeGeometryCombineBundleItem.md#bpy.types.NodeGeometryCombineBundleItem "bpy.types.NodeGeometryCombineBundleItem"), (readonly)

    *classmethod* is\_registered\_node\_type()[¶](#bpy.types.GeometryNodeCombineBundle.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[¶](#bpy.types.GeometryNodeCombineBundle.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[¶](#bpy.types.GeometryNodeCombineBundle.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.GeometryNodeCombineBundle.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.GeometryNodeCombineBundle.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeCombineBundle.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.GeometryNodeCombineBundle.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeCombineBundle(GeometryNode)
  + [`GeometryNodeCombineBundle`](#bpy.types.GeometryNodeCombineBundle)
    - [`GeometryNodeCombineBundle.active_index`](#bpy.types.GeometryNodeCombineBundle.active_index)
    - [`GeometryNodeCombineBundle.bundle_items`](#bpy.types.GeometryNodeCombineBundle.bundle_items)
    - [`GeometryNodeCombineBundle.is_registered_node_type()`](#bpy.types.GeometryNodeCombineBundle.is_registered_node_type)
    - [`GeometryNodeCombineBundle.input_template()`](#bpy.types.GeometryNodeCombineBundle.input_template)
    - [`GeometryNodeCombineBundle.output_template()`](#bpy.types.GeometryNodeCombineBundle.output_template)
    - [`GeometryNodeCombineBundle.bl_rna_get_subclass()`](#bpy.types.GeometryNodeCombineBundle.bl_rna_get_subclass)
    - [`GeometryNodeCombineBundle.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeCombineBundle.bl_rna_get_subclass_py)
