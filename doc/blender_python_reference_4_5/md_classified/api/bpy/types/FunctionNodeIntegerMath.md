...
# FunctionNodeIntegerMath(FunctionNode)[¶](#functionnodeintegermath-functionnode "Link to this heading")
...
*class* bpy.types.FunctionNodeIntegerMath(*FunctionNode*)[¶](#bpy.types.FunctionNodeIntegerMath "Link to this definition")
:   operation[¶](#bpy.types.FunctionNodeIntegerMath.operation "Link to this definition")
    :   Type:
        :   enum in [Node Integer Math Items](../../../appendix/bpy_types_enum_items/node_integer_math_items.md#rna-enum-node-integer-math-items), default `'ADD'`

    *classmethod* is\_registered\_node\_type()[¶](#bpy.types.FunctionNodeIntegerMath.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[¶](#bpy.types.FunctionNodeIntegerMath.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[¶](#bpy.types.FunctionNodeIntegerMath.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.FunctionNodeIntegerMath.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.FunctionNodeIntegerMath.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.FunctionNodeIntegerMath.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.FunctionNodeIntegerMath.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* FunctionNodeIntegerMath(FunctionNode)
  + [`FunctionNodeIntegerMath`](#bpy.types.FunctionNodeIntegerMath)
    - [`FunctionNodeIntegerMath.operation`](#bpy.types.FunctionNodeIntegerMath.operation)
    - [`FunctionNodeIntegerMath.is_registered_node_type()`](#bpy.types.FunctionNodeIntegerMath.is_registered_node_type)
    - [`FunctionNodeIntegerMath.input_template()`](#bpy.types.FunctionNodeIntegerMath.input_template)
    - [`FunctionNodeIntegerMath.output_template()`](#bpy.types.FunctionNodeIntegerMath.output_template)
    - [`FunctionNodeIntegerMath.bl_rna_get_subclass()`](#bpy.types.FunctionNodeIntegerMath.bl_rna_get_subclass)
    - [`FunctionNodeIntegerMath.bl_rna_get_subclass_py()`](#bpy.types.FunctionNodeIntegerMath.bl_rna_get_subclass_py)
