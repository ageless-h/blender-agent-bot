...
:   Collection of Grease Pencils
    ...
    :   Add a new Grease Pencil datablock to the main database
        ...
        Return type:
        :   [`GreasePencilv3`](GreasePencilv3.md#bpy.types.GreasePencilv3 "bpy.types.GreasePencilv3")
    ...
    :   Remove a Grease Pencil instance from the current blendfile
        ...
        Parameters:
        :   * **grease\_pencil** ([`GreasePencilv3`](GreasePencilv3.md#bpy.types.GreasePencilv3 "bpy.types.GreasePencilv3"), (never None)) – Grease Pencil to remove
            * **do\_unlink** (*boolean**,* *(**optional**)*) – Unlink all usages of this Grease Pencil before deleting it
            * **do\_id\_user** (*boolean**,* *(**optional**)*) – Decrement user counter of all datablocks used by this Grease Pencil
...
|  |  |
| --- | --- |
| * [`BlendData.grease_pencils_v3`](BlendData.md#bpy.types.BlendData.grease_pencils_v3 "bpy.types.BlendData.grease_pencils_v3") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.BlendDataGreasePencilsV3.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.BlendDataGreasePencilsV3.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)
