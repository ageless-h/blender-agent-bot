...
# GPencilStroke(bpy\_struct)[¶](#gpencilstroke-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.GPencilStroke(*bpy\_struct*)[¶](#bpy.types.GPencilStroke "Link to this definition")
:   Freehand curve defining part of a sketch

    points[¶](#bpy.types.GPencilStroke.points "Link to this definition")
    :   Stroke data points

        Type:
        :   [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`GPencilStrokePoint`](GPencilStrokePoint.md#bpy.types.GPencilStrokePoint "bpy.types.GPencilStrokePoint"), (readonly)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.GPencilStroke.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.GPencilStroke.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`GPencilFrame.strokes`](GPencilFrame.md#bpy.types.GPencilFrame.strokes "bpy.types.GPencilFrame.strokes") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GPencilStroke.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.GPencilStroke.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GPencilStroke(bpy\_struct)
  + [`GPencilStroke`](#bpy.types.GPencilStroke)
    - [`GPencilStroke.points`](#bpy.types.GPencilStroke.points)
    - [`GPencilStroke.bl_rna_get_subclass()`](#bpy.types.GPencilStroke.bl_rna_get_subclass)
    - [`GPencilStroke.bl_rna_get_subclass_py()`](#bpy.types.GPencilStroke.bl_rna_get_subclass_py)
