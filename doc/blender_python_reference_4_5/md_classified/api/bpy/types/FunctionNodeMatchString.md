...
# FunctionNodeMatchString(FunctionNode)[¶](#functionnodematchstring-functionnode "Link to this heading")
...
*class* bpy.types.FunctionNodeMatchString(*FunctionNode*)[¶](#bpy.types.FunctionNodeMatchString "Link to this definition")
:   operation[¶](#bpy.types.FunctionNodeMatchString.operation "Link to this definition")
    :   * `STARTS_WITH`
          Starts With – True when the first input starts with the second.
        * `ENDS_WITH`
          Ends With – True when the first input ends with the second.
        * `CONTAINS`
          Contains – True when the first input contains the second as a substring.

        Type:
        :   enum in [`'STARTS_WITH'`, `'ENDS_WITH'`, `'CONTAINS'`], default `'STARTS_WITH'`

    *classmethod* is\_registered\_node\_type()[¶](#bpy.types.FunctionNodeMatchString.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[¶](#bpy.types.FunctionNodeMatchString.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[¶](#bpy.types.FunctionNodeMatchString.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.FunctionNodeMatchString.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.FunctionNodeMatchString.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
FunctionNodeMatrixDeterminant(FunctionNode)](FunctionNodeMatrixDeterminant.md)
[Previous
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.FunctionNodeMatchString.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.FunctionNodeMatchString.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* FunctionNodeMatchString(FunctionNode)
  + [`FunctionNodeMatchString`](#bpy.types.FunctionNodeMatchString)
    - [`FunctionNodeMatchString.operation`](#bpy.types.FunctionNodeMatchString.operation)
    - [`FunctionNodeMatchString.is_registered_node_type()`](#bpy.types.FunctionNodeMatchString.is_registered_node_type)
    - [`FunctionNodeMatchString.input_template()`](#bpy.types.FunctionNodeMatchString.input_template)
    - [`FunctionNodeMatchString.output_template()`](#bpy.types.FunctionNodeMatchString.output_template)
    - [`FunctionNodeMatchString.bl_rna_get_subclass()`](#bpy.types.FunctionNodeMatchString.bl_rna_get_subclass)
    - [`FunctionNodeMatchString.bl_rna_get_subclass_py()`](#bpy.types.FunctionNodeMatchString.bl_rna_get_subclass_py)
