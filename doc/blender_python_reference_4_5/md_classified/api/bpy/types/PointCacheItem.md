...
# PointCacheItem(bpy\_struct)[¶](#pointcacheitem-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.PointCacheItem(*bpy\_struct*)[¶](#bpy.types.PointCacheItem "Link to this definition")
:   Point cache for physics simulations

    compression[¶](#bpy.types.PointCacheItem.compression "Link to this definition")
    ...
    filepath[¶](#bpy.types.PointCacheItem.filepath "Link to this definition")
    :   Cache file path

        Type:
        :   string, default “”, (never None, blend relative `//` prefix supported)

    frame\_end[¶](#bpy.types.PointCacheItem.frame_end "Link to this definition")
    :   Frame on which the simulation stops

        Type:
        :   int in [1, 1048574], default 0

    frame\_start[¶](#bpy.types.PointCacheItem.frame_start "Link to this definition")
    :   Frame on which the simulation starts

        Type:
        :   int in [-1048574, 1048574], default 0

    frame\_step[¶](#bpy.types.PointCacheItem.frame_step "Link to this definition")
    :   Number of frames between cached frames

        Type:
        :   int in [1, 20], default 0

    index[¶](#bpy.types.PointCacheItem.index "Link to this definition")
    :   Index number of cache files

        Type:
        :   int in [-1, 100], default 0

    info[¶](#bpy.types.PointCacheItem.info "Link to this definition")
    :   Info on current cache status

        Type:
        :   string, default “”, (readonly, never None)

    is\_baked[¶](#bpy.types.PointCacheItem.is_baked "Link to this definition")
    :   The cache is baked

        Type:
        :   boolean, default False, (readonly)

    is\_baking[¶](#bpy.types.PointCacheItem.is_baking "Link to this definition")
    :   The cache is being baked

        Type:
        :   boolean, default False, (readonly)

    is\_frame\_skip[¶](#bpy.types.PointCacheItem.is_frame_skip "Link to this definition")
    :   Some frames were skipped while baking/saving that cache

        Type:
        :   boolean, default False, (readonly)

    is\_outdated[¶](#bpy.types.PointCacheItem.is_outdated "Link to this definition")
    :   Type:
        :   boolean, default False, (readonly)

    name[¶](#bpy.types.PointCacheItem.name "Link to this definition")
    :   Cache name

        Type:
        :   string, default “”, (never None)

    use\_disk\_cache[¶](#bpy.types.PointCacheItem.use_disk_cache "Link to this definition")
    :   Save cache files to disk (.blend file must be saved first)

        Type:
        :   boolean, default False

    use\_external[¶](#bpy.types.PointCacheItem.use_external "Link to this definition")
    :   Read cache from an external location

        Type:
        :   boolean, default False

    use\_library\_path[¶](#bpy.types.PointCacheItem.use_library_path "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.PointCacheItem.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.PointCacheItem.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`PointCache.point_caches`](PointCache.md#bpy.types.PointCache.point_caches "bpy.types.PointCache.point_caches") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.PointCacheItem.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.PointCacheItem.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* PointCacheItem(bpy\_struct)
  + [`PointCacheItem`](#bpy.types.PointCacheItem)
    - [`PointCacheItem.compression`](#bpy.types.PointCacheItem.compression)
    - [`PointCacheItem.filepath`](#bpy.types.PointCacheItem.filepath)
    - [`PointCacheItem.frame_end`](#bpy.types.PointCacheItem.frame_end)
    - [`PointCacheItem.frame_start`](#bpy.types.PointCacheItem.frame_start)
    - [`PointCacheItem.frame_step`](#bpy.types.PointCacheItem.frame_step)
    - [`PointCacheItem.index`](#bpy.types.PointCacheItem.index)
    - [`PointCacheItem.info`](#bpy.types.PointCacheItem.info)
    - [`PointCacheItem.is_baked`](#bpy.types.PointCacheItem.is_baked)
    - [`PointCacheItem.is_baking`](#bpy.types.PointCacheItem.is_baking)
    - [`PointCacheItem.is_frame_skip`](#bpy.types.PointCacheItem.is_frame_skip)
    - [`PointCacheItem.is_outdated`](#bpy.types.PointCacheItem.is_outdated)
    - [`PointCacheItem.name`](#bpy.types.PointCacheItem.name)
    - [`PointCacheItem.use_disk_cache`](#bpy.types.PointCacheItem.use_disk_cache)
    - [`PointCacheItem.use_external`](#bpy.types.PointCacheItem.use_external)
    - [`PointCacheItem.use_library_path`](#bpy.types.PointCacheItem.use_library_path)
    - [`PointCacheItem.bl_rna_get_subclass()`](#bpy.types.PointCacheItem.bl_rna_get_subclass)
    - [`PointCacheItem.bl_rna_get_subclass_py()`](#bpy.types.PointCacheItem.bl_rna_get_subclass_py)
