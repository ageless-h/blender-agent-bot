...
# ThemePanelColors(bpy\_struct)[¶](#themepanelcolors-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.ThemePanelColors(*bpy\_struct*)[¶](#bpy.types.ThemePanelColors "Link to this definition")
:   Theme settings for panel colors

    back[¶](#bpy.types.ThemePanelColors.back "Link to this definition")
    :   Type:
        :   float array of 4 items in [0, 1], default (0.0, 0.0, 0.0, 0.0)

    header[¶](#bpy.types.ThemePanelColors.header "Link to this definition")
    :   Type:
        :   float array of 4 items in [0, 1], default (0.0, 0.0, 0.0, 0.0)

    sub\_back[¶](#bpy.types.ThemePanelColors.sub_back "Link to this definition")
    :   Type:
        :   float array of 4 items in [0, 1], default (0.0, 0.0, 0.0, 0.0)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ThemePanelColors.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ThemePanelColors.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`ThemeSpaceGeneric.panelcolors`](ThemeSpaceGeneric.md#bpy.types.ThemeSpaceGeneric.panelcolors "bpy.types.ThemeSpaceGeneric.panelcolors") | * [`ThemeSpaceGradient.panelcolors`](ThemeSpaceGradient.md#bpy.types.ThemeSpaceGradient.panelcolors "bpy.types.ThemeSpaceGradient.panelcolors") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ThemePanelColors.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.ThemePanelColors.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ThemePanelColors(bpy\_struct)
  + [`ThemePanelColors`](#bpy.types.ThemePanelColors)
    - [`ThemePanelColors.back`](#bpy.types.ThemePanelColors.back)
    - [`ThemePanelColors.header`](#bpy.types.ThemePanelColors.header)
    - [`ThemePanelColors.sub_back`](#bpy.types.ThemePanelColors.sub_back)
    - [`ThemePanelColors.bl_rna_get_subclass()`](#bpy.types.ThemePanelColors.bl_rna_get_subclass)
    - [`ThemePanelColors.bl_rna_get_subclass_py()`](#bpy.types.ThemePanelColors.bl_rna_get_subclass_py)
