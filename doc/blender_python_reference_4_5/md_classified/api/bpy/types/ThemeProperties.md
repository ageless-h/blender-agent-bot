...
# ThemeProperties(bpy\_struct)[¶](#themeproperties-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.ThemeProperties(*bpy\_struct*)[¶](#bpy.types.ThemeProperties "Link to this definition")
:   Theme settings for the Properties

    active\_modifier[¶](#bpy.types.ThemeProperties.active_modifier "Link to this definition")
    :   Type:
        :   float array of 4 items in [0, 1], default (0.0, 0.0, 0.0, 0.0)

    match[¶](#bpy.types.ThemeProperties.match "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    space[¶](#bpy.types.ThemeProperties.space "Link to this definition")
    :   Settings for space

        Type:
        :   [`ThemeSpaceGeneric`](ThemeSpaceGeneric.md#bpy.types.ThemeSpaceGeneric "bpy.types.ThemeSpaceGeneric"), (readonly, never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ThemeProperties.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ThemeProperties.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Theme.properties`](Theme.md#bpy.types.Theme.properties "bpy.types.Theme.properties") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ThemeProperties.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.ThemeProperties.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ThemeProperties(bpy\_struct)
  + [`ThemeProperties`](#bpy.types.ThemeProperties)
    - [`ThemeProperties.active_modifier`](#bpy.types.ThemeProperties.active_modifier)
    - [`ThemeProperties.match`](#bpy.types.ThemeProperties.match)
    - [`ThemeProperties.space`](#bpy.types.ThemeProperties.space)
    - [`ThemeProperties.bl_rna_get_subclass()`](#bpy.types.ThemeProperties.bl_rna_get_subclass)
    - [`ThemeProperties.bl_rna_get_subclass_py()`](#bpy.types.ThemeProperties.bl_rna_get_subclass_py)
