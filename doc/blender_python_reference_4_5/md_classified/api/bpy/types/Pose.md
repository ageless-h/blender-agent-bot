...
# Pose(bpy\_struct)[¶](#pose-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.Pose(*bpy\_struct*)[¶](#bpy.types.Pose "Link to this definition")
:   A collection of pose channels, including settings for animating bones

    animation\_visualization[¶](#bpy.types.Pose.animation_visualization "Link to this definition")
    :   Animation data for this data-block

        Type:
        :   [`AnimViz`](AnimViz.md#bpy.types.AnimViz "bpy.types.AnimViz"), (readonly, never None)

    bones[¶](#bpy.types.Pose.bones "Link to this definition")
    :   Individual pose bones for the armature

        Type:
        :   [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`PoseBone`](PoseBone.md#bpy.types.PoseBone "bpy.types.PoseBone"), (readonly)

    ik\_param[¶](#bpy.types.Pose.ik_param "Link to this definition")
    :   Parameters for IK solver

        Type:
        :   [`IKParam`](IKParam.md#bpy.types.IKParam "bpy.types.IKParam"), (readonly)

    ik\_solver[¶](#bpy.types.Pose.ik_solver "Link to this definition")
    ...
    use\_auto\_ik[¶](#bpy.types.Pose.use_auto_ik "Link to this definition")
    :   Add temporary IK constraints while grabbing bones in Pose Mode

        Type:
        :   boolean, default False

    use\_mirror\_relative[¶](#bpy.types.Pose.use_mirror_relative "Link to this definition")
    :   Apply relative transformations in X-mirror mode (not supported with Auto IK)

        Type:
        :   boolean, default False

    use\_mirror\_x[¶](#bpy.types.Pose.use_mirror_x "Link to this definition")
    :   Apply changes to matching bone on opposite side of X-Axis

        Type:
        :   boolean, default False

    *classmethod* apply\_pose\_from\_action(*action*, *\**, *evaluation\_time=0.0*)[¶](#bpy.types.Pose.apply_pose_from_action "Link to this definition")
    :   Apply the given action to this pose by evaluating it at a specific time. Only updates the pose of selected bones, or all bones if none are selected.
        ...
        Parameters:
        :   * **action** ([`Action`](Action.md#bpy.types.Action "bpy.types.Action")) – Action, The Action containing the pose
            * **evaluation\_time** (*float in* *[**-inf**,* *inf**]**,* *(**optional**)*) – Evaluation Time, Time at which the given action is evaluated to obtain the pose

    *classmethod* blend\_pose\_from\_action(*action*, *\**, *blend\_factor=1.0*, *evaluation\_time=0.0*)[¶](#bpy.types.Pose.blend_pose_from_action "Link to this definition")
    :   Blend the given action into this pose by evaluating it at a specific time. Only updates the pose of selected bones, or all bones if none are selected.
        ...
        Parameters:
        :   * **action** ([`Action`](Action.md#bpy.types.Action "bpy.types.Action")) – Action, The Action containing the pose
            * **blend\_factor** (*float in* *[**0**,* *1**]**,* *(**optional**)*) – Blend Factor, How much the given Action affects the final pose
            * **evaluation\_time** (*float in* *[**-inf**,* *inf**]**,* *(**optional**)*) – Evaluation Time, Time at which the given action is evaluated to obtain the pose

    *classmethod* backup\_create(*action*)[¶](#bpy.types.Pose.backup_create "Link to this definition")
    :   Create a backup of the current pose. Only those bones that are animated in the Action are backed up. The object owns the backup, and each object can have only one backup at a time. When you no longer need it, it must be freed use backup\_clear().

        Parameters:
        :   **action** ([`Action`](Action.md#bpy.types.Action "bpy.types.Action")) – Action, An Action with animation data for the bones. Only the animated bones will be included in the backup.

    *classmethod* backup\_restore()[¶](#bpy.types.Pose.backup_restore "Link to this definition")
    :   Restore the previously made pose backup. This can be called multiple times. See Pose.backup\_create() for more info.
    ...
    *classmethod* backup\_clear()[¶](#bpy.types.Pose.backup_clear "Link to this definition")
    :   Free a previously made pose backup. See Pose.backup\_create() for more info.

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.Pose.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.Pose.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Object.pose`](Object.md#bpy.types.Object.pose "bpy.types.Object.pose") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.Pose.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.Pose.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* Pose(bpy\_struct)
  + [`Pose`](#bpy.types.Pose)
    - [`Pose.animation_visualization`](#bpy.types.Pose.animation_visualization)
    - [`Pose.bones`](#bpy.types.Pose.bones)
    - [`Pose.ik_param`](#bpy.types.Pose.ik_param)
    - [`Pose.ik_solver`](#bpy.types.Pose.ik_solver)
    - [`Pose.use_auto_ik`](#bpy.types.Pose.use_auto_ik)
    - [`Pose.use_mirror_relative`](#bpy.types.Pose.use_mirror_relative)
    - [`Pose.use_mirror_x`](#bpy.types.Pose.use_mirror_x)
    - [`Pose.apply_pose_from_action()`](#bpy.types.Pose.apply_pose_from_action)
    - [`Pose.blend_pose_from_action()`](#bpy.types.Pose.blend_pose_from_action)
    - [`Pose.backup_create()`](#bpy.types.Pose.backup_create)
    - [`Pose.backup_restore()`](#bpy.types.Pose.backup_restore)
    - [`Pose.backup_clear()`](#bpy.types.Pose.backup_clear)
    - [`Pose.bl_rna_get_subclass()`](#bpy.types.Pose.bl_rna_get_subclass)
    - [`Pose.bl_rna_get_subclass_py()`](#bpy.types.Pose.bl_rna_get_subclass_py)
