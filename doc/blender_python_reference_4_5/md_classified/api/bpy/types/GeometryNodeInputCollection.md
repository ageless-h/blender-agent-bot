...
# GeometryNodeInputCollection(GeometryNode)[¶](#geometrynodeinputcollection-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeInputCollection(*GeometryNode*)[¶](#bpy.types.GeometryNodeInputCollection "Link to this definition")
:   Output a single collection

    collection[¶](#bpy.types.GeometryNodeInputCollection.collection "Link to this definition")
    :   Type:
        :   [`Collection`](Collection.md#bpy.types.Collection "bpy.types.Collection")

    *classmethod* is\_registered\_node\_type()[¶](#bpy.types.GeometryNodeInputCollection.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[¶](#bpy.types.GeometryNodeInputCollection.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[¶](#bpy.types.GeometryNodeInputCollection.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.GeometryNodeInputCollection.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.GeometryNodeInputCollection.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeInputCollection.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.GeometryNodeInputCollection.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeInputCollection(GeometryNode)
  + [`GeometryNodeInputCollection`](#bpy.types.GeometryNodeInputCollection)
    - [`GeometryNodeInputCollection.collection`](#bpy.types.GeometryNodeInputCollection.collection)
    - [`GeometryNodeInputCollection.is_registered_node_type()`](#bpy.types.GeometryNodeInputCollection.is_registered_node_type)
    - [`GeometryNodeInputCollection.input_template()`](#bpy.types.GeometryNodeInputCollection.input_template)
    - [`GeometryNodeInputCollection.output_template()`](#bpy.types.GeometryNodeInputCollection.output_template)
    - [`GeometryNodeInputCollection.bl_rna_get_subclass()`](#bpy.types.GeometryNodeInputCollection.bl_rna_get_subclass)
    - [`GeometryNodeInputCollection.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeInputCollection.bl_rna_get_subclass_py)
