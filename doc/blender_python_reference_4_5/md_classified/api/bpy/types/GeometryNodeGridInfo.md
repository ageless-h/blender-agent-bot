...
# GeometryNodeGridInfo(GeometryNode)[¶](#geometrynodegridinfo-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeGridInfo(*GeometryNode*)[¶](#bpy.types.GeometryNodeGridInfo "Link to this definition")
:   Retrieve information about a volume grid

    data\_type[¶](#bpy.types.GeometryNodeGridInfo.data_type "Link to this definition")
    :   Type of grid data
    ...
    *classmethod* is\_registered\_node\_type()[¶](#bpy.types.GeometryNodeGridInfo.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[¶](#bpy.types.GeometryNodeGridInfo.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[¶](#bpy.types.GeometryNodeGridInfo.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.GeometryNodeGridInfo.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.GeometryNodeGridInfo.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeGridInfo.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.GeometryNodeGridInfo.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeGridInfo(GeometryNode)
  + [`GeometryNodeGridInfo`](#bpy.types.GeometryNodeGridInfo)
    - [`GeometryNodeGridInfo.data_type`](#bpy.types.GeometryNodeGridInfo.data_type)
    - [`GeometryNodeGridInfo.is_registered_node_type()`](#bpy.types.GeometryNodeGridInfo.is_registered_node_type)
    - [`GeometryNodeGridInfo.input_template()`](#bpy.types.GeometryNodeGridInfo.input_template)
    - [`GeometryNodeGridInfo.output_template()`](#bpy.types.GeometryNodeGridInfo.output_template)
    - [`GeometryNodeGridInfo.bl_rna_get_subclass()`](#bpy.types.GeometryNodeGridInfo.bl_rna_get_subclass)
    - [`GeometryNodeGridInfo.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeGridInfo.bl_rna_get_subclass_py)
