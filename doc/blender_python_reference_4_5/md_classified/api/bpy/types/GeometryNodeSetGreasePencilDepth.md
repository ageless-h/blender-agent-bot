...
# GeometryNodeSetGreasePencilDepth(GeometryNode)[¶](#geometrynodesetgreasepencildepth-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeSetGreasePencilDepth(*GeometryNode*)[¶](#bpy.types.GeometryNodeSetGreasePencilDepth "Link to this definition")
:   Set the Grease Pencil depth order to use

    depth\_order[¶](#bpy.types.GeometryNodeSetGreasePencilDepth.depth_order "Link to this definition")
    :   Type:
    ...
    *classmethod* is\_registered\_node\_type()[¶](#bpy.types.GeometryNodeSetGreasePencilDepth.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[¶](#bpy.types.GeometryNodeSetGreasePencilDepth.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[¶](#bpy.types.GeometryNodeSetGreasePencilDepth.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.GeometryNodeSetGreasePencilDepth.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.GeometryNodeSetGreasePencilDepth.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
GeometryNodeSetGreasePencilSoftness(GeometryNode)](GeometryNodeSetGreasePencilSoftness.md)
[Previous

GeometryNodeSetGreasePencilColor(GeometryNode)](GeometryNodeSetGreasePencilColor.md)
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeSetGreasePencilDepth.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.GeometryNodeSetGreasePencilDepth.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeSetGreasePencilDepth(GeometryNode)
  + [`GeometryNodeSetGreasePencilDepth`](#bpy.types.GeometryNodeSetGreasePencilDepth)
    - [`GeometryNodeSetGreasePencilDepth.depth_order`](#bpy.types.GeometryNodeSetGreasePencilDepth.depth_order)
    - [`GeometryNodeSetGreasePencilDepth.is_registered_node_type()`](#bpy.types.GeometryNodeSetGreasePencilDepth.is_registered_node_type)
    - [`GeometryNodeSetGreasePencilDepth.input_template()`](#bpy.types.GeometryNodeSetGreasePencilDepth.input_template)
    - [`GeometryNodeSetGreasePencilDepth.output_template()`](#bpy.types.GeometryNodeSetGreasePencilDepth.output_template)
    - [`GeometryNodeSetGreasePencilDepth.bl_rna_get_subclass()`](#bpy.types.GeometryNodeSetGreasePencilDepth.bl_rna_get_subclass)
    - [`GeometryNodeSetGreasePencilDepth.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeSetGreasePencilDepth.bl_rna_get_subclass_py)
