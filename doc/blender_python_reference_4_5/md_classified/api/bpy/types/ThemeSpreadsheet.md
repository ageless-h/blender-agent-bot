...
# ThemeSpreadsheet(bpy\_struct)[¶](#themespreadsheet-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.ThemeSpreadsheet(*bpy\_struct*)[¶](#bpy.types.ThemeSpreadsheet "Link to this definition")
:   Theme settings for the Spreadsheet

    row\_alternate[¶](#bpy.types.ThemeSpreadsheet.row_alternate "Link to this definition")
    :   Overlay color on every other row

        Type:
        :   float array of 4 items in [0, 1], default (0.0, 0.0, 0.0, 0.0)

    space[¶](#bpy.types.ThemeSpreadsheet.space "Link to this definition")
    :   Settings for space

        Type:
        :   [`ThemeSpaceGeneric`](ThemeSpaceGeneric.md#bpy.types.ThemeSpaceGeneric "bpy.types.ThemeSpaceGeneric"), (readonly, never None)

    space\_list[¶](#bpy.types.ThemeSpreadsheet.space_list "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ThemeSpreadsheet.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ThemeSpreadsheet.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Theme.spreadsheet`](Theme.md#bpy.types.Theme.spreadsheet "bpy.types.Theme.spreadsheet") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ThemeSpreadsheet.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.ThemeSpreadsheet.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ThemeSpreadsheet(bpy\_struct)
  + [`ThemeSpreadsheet`](#bpy.types.ThemeSpreadsheet)
    - [`ThemeSpreadsheet.row_alternate`](#bpy.types.ThemeSpreadsheet.row_alternate)
    - [`ThemeSpreadsheet.space`](#bpy.types.ThemeSpreadsheet.space)
    - [`ThemeSpreadsheet.space_list`](#bpy.types.ThemeSpreadsheet.space_list)
    - [`ThemeSpreadsheet.bl_rna_get_subclass()`](#bpy.types.ThemeSpreadsheet.bl_rna_get_subclass)
    - [`ThemeSpreadsheet.bl_rna_get_subclass_py()`](#bpy.types.ThemeSpreadsheet.bl_rna_get_subclass_py)
