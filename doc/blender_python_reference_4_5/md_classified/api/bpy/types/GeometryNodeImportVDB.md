...
# GeometryNodeImportVDB(GeometryNode)[¶](#geometrynodeimportvdb-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeImportVDB(*GeometryNode*)[¶](#bpy.types.GeometryNodeImportVDB "Link to this definition")
:   Import volume data from a .vdb file

    *classmethod* is\_registered\_node\_type()[¶](#bpy.types.GeometryNodeImportVDB.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[¶](#bpy.types.GeometryNodeImportVDB.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[¶](#bpy.types.GeometryNodeImportVDB.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.GeometryNodeImportVDB.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.GeometryNodeImportVDB.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
GeometryNodeImportText(GeometryNode)](GeometryNodeImportText.md)
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeImportVDB.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.GeometryNodeImportVDB.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeImportVDB(GeometryNode)
  + [`GeometryNodeImportVDB`](#bpy.types.GeometryNodeImportVDB)
    - [`GeometryNodeImportVDB.is_registered_node_type()`](#bpy.types.GeometryNodeImportVDB.is_registered_node_type)
    - [`GeometryNodeImportVDB.input_template()`](#bpy.types.GeometryNodeImportVDB.input_template)
    - [`GeometryNodeImportVDB.output_template()`](#bpy.types.GeometryNodeImportVDB.output_template)
    - [`GeometryNodeImportVDB.bl_rna_get_subclass()`](#bpy.types.GeometryNodeImportVDB.bl_rna_get_subclass)
    - [`GeometryNodeImportVDB.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeImportVDB.bl_rna_get_subclass_py)
