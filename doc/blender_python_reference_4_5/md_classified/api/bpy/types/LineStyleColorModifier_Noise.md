...
# LineStyleColorModifier\_Noise(LineStyleColorModifier)[¶](#linestylecolormodifier-noise-linestylecolormodifier "Link to this heading")
...
*class* bpy.types.LineStyleColorModifier\_Noise(*LineStyleColorModifier*)[¶](#bpy.types.LineStyleColorModifier_Noise "Link to this definition")
:   Change line color based on random noise

    amplitude[¶](#bpy.types.LineStyleColorModifier_Noise.amplitude "Link to this definition")
    :   Amplitude of the noise

        Type:
        :   float in [-inf, inf], default 0.0

    blend[¶](#bpy.types.LineStyleColorModifier_Noise.blend "Link to this definition")
    ...
    color\_ramp[¶](#bpy.types.LineStyleColorModifier_Noise.color_ramp "Link to this definition")
    :   Color ramp used to change line color

        Type:
        :   [`ColorRamp`](ColorRamp.md#bpy.types.ColorRamp "bpy.types.ColorRamp"), (readonly)

    expanded[¶](#bpy.types.LineStyleColorModifier_Noise.expanded "Link to this definition")
    :   True if the modifier tab is expanded

        Type:
        :   boolean, default False

    influence[¶](#bpy.types.LineStyleColorModifier_Noise.influence "Link to this definition")
    :   Influence factor by which the modifier changes the property

        Type:
        :   float in [0, 1], default 0.0

    period[¶](#bpy.types.LineStyleColorModifier_Noise.period "Link to this definition")
    :   Period of the noise

        Type:
        :   float in [-inf, inf], default 0.0

    seed[¶](#bpy.types.LineStyleColorModifier_Noise.seed "Link to this definition")
    :   Seed for the noise generation

        Type:
        :   int in [1, 32767], default 0

    type[¶](#bpy.types.LineStyleColorModifier_Noise.type "Link to this definition")
    ...
    use[¶](#bpy.types.LineStyleColorModifier_Noise.use "Link to this definition")
    :   Enable or disable this modifier during stroke rendering

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.LineStyleColorModifier_Noise.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.LineStyleColorModifier_Noise.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.LineStyleColorModifier_Noise.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.LineStyleColorModifier_Noise.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* LineStyleColorModifier\_Noise(LineStyleColorModifier)
  + [`LineStyleColorModifier_Noise`](#bpy.types.LineStyleColorModifier_Noise)
    - [`LineStyleColorModifier_Noise.amplitude`](#bpy.types.LineStyleColorModifier_Noise.amplitude)
    - [`LineStyleColorModifier_Noise.blend`](#bpy.types.LineStyleColorModifier_Noise.blend)
    - [`LineStyleColorModifier_Noise.color_ramp`](#bpy.types.LineStyleColorModifier_Noise.color_ramp)
    - [`LineStyleColorModifier_Noise.expanded`](#bpy.types.LineStyleColorModifier_Noise.expanded)
    - [`LineStyleColorModifier_Noise.influence`](#bpy.types.LineStyleColorModifier_Noise.influence)
    - [`LineStyleColorModifier_Noise.period`](#bpy.types.LineStyleColorModifier_Noise.period)
    - [`LineStyleColorModifier_Noise.seed`](#bpy.types.LineStyleColorModifier_Noise.seed)
    - [`LineStyleColorModifier_Noise.type`](#bpy.types.LineStyleColorModifier_Noise.type)
    - [`LineStyleColorModifier_Noise.use`](#bpy.types.LineStyleColorModifier_Noise.use)
    - [`LineStyleColorModifier_Noise.bl_rna_get_subclass()`](#bpy.types.LineStyleColorModifier_Noise.bl_rna_get_subclass)
    - [`LineStyleColorModifier_Noise.bl_rna_get_subclass_py()`](#bpy.types.LineStyleColorModifier_Noise.bl_rna_get_subclass_py)
