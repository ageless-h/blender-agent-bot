...
# NodeGeometryClosureOutputItems(bpy\_struct)[¶](#nodegeometryclosureoutputitems-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.NodeGeometryClosureOutputItems(*bpy\_struct*)[¶](#bpy.types.NodeGeometryClosureOutputItems "Link to this definition")
:   new(*socket\_type*, *name*)[¶](#bpy.types.NodeGeometryClosureOutputItems.new "Link to this definition")
    :   Add an item at the end
        ...
        Return type:
        :   [`NodeGeometryClosureOutputItem`](NodeGeometryClosureOutputItem.md#bpy.types.NodeGeometryClosureOutputItem "bpy.types.NodeGeometryClosureOutputItem")

    remove(*item*)[¶](#bpy.types.NodeGeometryClosureOutputItems.remove "Link to this definition")
    :   Remove an item

        Parameters:
        :   **item** ([`NodeGeometryClosureOutputItem`](NodeGeometryClosureOutputItem.md#bpy.types.NodeGeometryClosureOutputItem "bpy.types.NodeGeometryClosureOutputItem"), (never None)) – Item, The item to remove

    clear()[¶](#bpy.types.NodeGeometryClosureOutputItems.clear "Link to this definition")
    :   Remove all items

    move(*from\_index*, *to\_index*)[¶](#bpy.types.NodeGeometryClosureOutputItems.move "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.NodeGeometryClosureOutputItems.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.NodeGeometryClosureOutputItems.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`GeometryNodeClosureOutput.output_items`](GeometryNodeClosureOutput.md#bpy.types.GeometryNodeClosureOutput.output_items "bpy.types.GeometryNodeClosureOutput.output_items") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.NodeGeometryClosureOutputItems.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.NodeGeometryClosureOutputItems.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* NodeGeometryClosureOutputItems(bpy\_struct)
  + [`NodeGeometryClosureOutputItems`](#bpy.types.NodeGeometryClosureOutputItems)
    - [`NodeGeometryClosureOutputItems.new()`](#bpy.types.NodeGeometryClosureOutputItems.new)
    - [`NodeGeometryClosureOutputItems.remove()`](#bpy.types.NodeGeometryClosureOutputItems.remove)
    - [`NodeGeometryClosureOutputItems.clear()`](#bpy.types.NodeGeometryClosureOutputItems.clear)
    - [`NodeGeometryClosureOutputItems.move()`](#bpy.types.NodeGeometryClosureOutputItems.move)
    - [`NodeGeometryClosureOutputItems.bl_rna_get_subclass()`](#bpy.types.NodeGeometryClosureOutputItems.bl_rna_get_subclass)
    - [`NodeGeometryClosureOutputItems.bl_rna_get_subclass_py()`](#bpy.types.NodeGeometryClosureOutputItems.bl_rna_get_subclass_py)
