...
# GeometryNodeSetMeshNormal(GeometryNode)[¶](#geometrynodesetmeshnormal-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeSetMeshNormal(*GeometryNode*)[¶](#bpy.types.GeometryNodeSetMeshNormal "Link to this definition")
:   Store a normal vector for each mesh element

    domain[¶](#bpy.types.GeometryNodeSetMeshNormal.domain "Link to this definition")
    :   Attribute domain to store free custom normals

        Type:
        :   enum in [Attribute Domain Only Mesh No Edge Items](../../../appendix/bpy_types_enum_items/attribute_domain_only_mesh_no_edge_items.md#rna-enum-attribute-domain-only-mesh-no-edge-items), default `'POINT'`

    mode[¶](#bpy.types.GeometryNodeSetMeshNormal.mode "Link to this definition")
    ...
    *classmethod* is\_registered\_node\_type()[¶](#bpy.types.GeometryNodeSetMeshNormal.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[¶](#bpy.types.GeometryNodeSetMeshNormal.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[¶](#bpy.types.GeometryNodeSetMeshNormal.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.GeometryNodeSetMeshNormal.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.GeometryNodeSetMeshNormal.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeSetMeshNormal.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.GeometryNodeSetMeshNormal.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeSetMeshNormal(GeometryNode)
  + [`GeometryNodeSetMeshNormal`](#bpy.types.GeometryNodeSetMeshNormal)
    - [`GeometryNodeSetMeshNormal.domain`](#bpy.types.GeometryNodeSetMeshNormal.domain)
    - [`GeometryNodeSetMeshNormal.mode`](#bpy.types.GeometryNodeSetMeshNormal.mode)
    - [`GeometryNodeSetMeshNormal.is_registered_node_type()`](#bpy.types.GeometryNodeSetMeshNormal.is_registered_node_type)
    - [`GeometryNodeSetMeshNormal.input_template()`](#bpy.types.GeometryNodeSetMeshNormal.input_template)
    - [`GeometryNodeSetMeshNormal.output_template()`](#bpy.types.GeometryNodeSetMeshNormal.output_template)
    - [`GeometryNodeSetMeshNormal.bl_rna_get_subclass()`](#bpy.types.GeometryNodeSetMeshNormal.bl_rna_get_subclass)
    - [`GeometryNodeSetMeshNormal.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeSetMeshNormal.bl_rna_get_subclass_py)
