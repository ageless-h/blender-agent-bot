...
# NodeGeometryCombineBundleItems(bpy\_struct)[¶](#nodegeometrycombinebundleitems-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.NodeGeometryCombineBundleItems(*bpy\_struct*)[¶](#bpy.types.NodeGeometryCombineBundleItems "Link to this definition")
:   Collection of combine bundle items

    new(*socket\_type*, *name*)[¶](#bpy.types.NodeGeometryCombineBundleItems.new "Link to this definition")
    :   Add an item at the end
        ...
        Return type:
        :   [`NodeGeometryCombineBundleItem`](NodeGeometryCombineBundleItem.md#bpy.types.NodeGeometryCombineBundleItem "bpy.types.NodeGeometryCombineBundleItem")

    remove(*item*)[¶](#bpy.types.NodeGeometryCombineBundleItems.remove "Link to this definition")
    :   Remove an item

        Parameters:
        :   **item** ([`NodeGeometryCombineBundleItem`](NodeGeometryCombineBundleItem.md#bpy.types.NodeGeometryCombineBundleItem "bpy.types.NodeGeometryCombineBundleItem"), (never None)) – Item, The item to remove

    clear()[¶](#bpy.types.NodeGeometryCombineBundleItems.clear "Link to this definition")
    :   Remove all items

    move(*from\_index*, *to\_index*)[¶](#bpy.types.NodeGeometryCombineBundleItems.move "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.NodeGeometryCombineBundleItems.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.NodeGeometryCombineBundleItems.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`GeometryNodeCombineBundle.bundle_items`](GeometryNodeCombineBundle.md#bpy.types.GeometryNodeCombineBundle.bundle_items "bpy.types.GeometryNodeCombineBundle.bundle_items") |  |
...
NodeGeometryCombineBundleItem(bpy\_struct)](NodeGeometryCombineBundleItem.md)
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.NodeGeometryCombineBundleItems.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.NodeGeometryCombineBundleItems.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* NodeGeometryCombineBundleItems(bpy\_struct)
  + [`NodeGeometryCombineBundleItems`](#bpy.types.NodeGeometryCombineBundleItems)
    - [`NodeGeometryCombineBundleItems.new()`](#bpy.types.NodeGeometryCombineBundleItems.new)
    - [`NodeGeometryCombineBundleItems.remove()`](#bpy.types.NodeGeometryCombineBundleItems.remove)
    - [`NodeGeometryCombineBundleItems.clear()`](#bpy.types.NodeGeometryCombineBundleItems.clear)
    - [`NodeGeometryCombineBundleItems.move()`](#bpy.types.NodeGeometryCombineBundleItems.move)
    - [`NodeGeometryCombineBundleItems.bl_rna_get_subclass()`](#bpy.types.NodeGeometryCombineBundleItems.bl_rna_get_subclass)
    - [`NodeGeometryCombineBundleItems.bl_rna_get_subclass_py()`](#bpy.types.NodeGeometryCombineBundleItems.bl_rna_get_subclass_py)
