...
# BoolAttributeValue(bpy\_struct)[¶](#boolattributevalue-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.BoolAttributeValue(*bpy\_struct*)[¶](#bpy.types.BoolAttributeValue "Link to this definition")
:   Bool value in geometry attribute

    value[¶](#bpy.types.BoolAttributeValue.value "Link to this definition")
    :   Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.BoolAttributeValue.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.BoolAttributeValue.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`BoolAttribute.data`](BoolAttribute.md#bpy.types.BoolAttribute.data "bpy.types.BoolAttribute.data") * [`MeshUVLoopLayer.edge_selection`](MeshUVLoopLayer.md#bpy.types.MeshUVLoopLayer.edge_selection "bpy.types.MeshUVLoopLayer.edge_selection") | * [`MeshUVLoopLayer.pin`](MeshUVLoopLayer.md#bpy.types.MeshUVLoopLayer.pin "bpy.types.MeshUVLoopLayer.pin") * [`MeshUVLoopLayer.vertex_selection`](MeshUVLoopLayer.md#bpy.types.MeshUVLoopLayer.vertex_selection "bpy.types.MeshUVLoopLayer.vertex_selection") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.BoolAttributeValue.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.BoolAttributeValue.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* BoolAttributeValue(bpy\_struct)
  + [`BoolAttributeValue`](#bpy.types.BoolAttributeValue)
    - [`BoolAttributeValue.value`](#bpy.types.BoolAttributeValue.value)
    - [`BoolAttributeValue.bl_rna_get_subclass()`](#bpy.types.BoolAttributeValue.bl_rna_get_subclass)
    - [`BoolAttributeValue.bl_rna_get_subclass_py()`](#bpy.types.BoolAttributeValue.bl_rna_get_subclass_py)
