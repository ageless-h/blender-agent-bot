...
:   Stabilize footage using 2D stabilization motion tracking settings
    ...
    :   Invert stabilization to re-introduce motion to the frame. (Deprecated: Use Invert input instead.)
