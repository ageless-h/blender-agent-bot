...
# CompositorNodeRelativeToPixel(CompositorNode)[¶](#compositornoderelativetopixel-compositornode "Link to this heading")
...
*class* bpy.types.CompositorNodeRelativeToPixel(*CompositorNode*)[¶](#bpy.types.CompositorNodeRelativeToPixel "Link to this definition")
:   Converts values that are relative to the image size to be in terms of pixels

    data\_type[¶](#bpy.types.CompositorNodeRelativeToPixel.data_type "Link to this definition")
    :   The type of data
    ...
    reference\_dimension[¶](#bpy.types.CompositorNodeRelativeToPixel.reference_dimension "Link to this definition")
    ...
    *classmethod* is\_registered\_node\_type()[¶](#bpy.types.CompositorNodeRelativeToPixel.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[¶](#bpy.types.CompositorNodeRelativeToPixel.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[¶](#bpy.types.CompositorNodeRelativeToPixel.output_template "Link to this definition")
    ...
    update()[¶](#bpy.types.CompositorNodeRelativeToPixel.update "Link to this definition")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.CompositorNodeRelativeToPixel.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.CompositorNodeRelativeToPixel.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CompositorNodeRelativeToPixel.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.CompositorNodeRelativeToPixel.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CompositorNodeRelativeToPixel(CompositorNode)
  + [`CompositorNodeRelativeToPixel`](#bpy.types.CompositorNodeRelativeToPixel)
    - [`CompositorNodeRelativeToPixel.data_type`](#bpy.types.CompositorNodeRelativeToPixel.data_type)
    - [`CompositorNodeRelativeToPixel.reference_dimension`](#bpy.types.CompositorNodeRelativeToPixel.reference_dimension)
    - [`CompositorNodeRelativeToPixel.is_registered_node_type()`](#bpy.types.CompositorNodeRelativeToPixel.is_registered_node_type)
    - [`CompositorNodeRelativeToPixel.input_template()`](#bpy.types.CompositorNodeRelativeToPixel.input_template)
    - [`CompositorNodeRelativeToPixel.output_template()`](#bpy.types.CompositorNodeRelativeToPixel.output_template)
    - [`CompositorNodeRelativeToPixel.update()`](#bpy.types.CompositorNodeRelativeToPixel.update)
    - [`CompositorNodeRelativeToPixel.bl_rna_get_subclass()`](#bpy.types.CompositorNodeRelativeToPixel.bl_rna_get_subclass)
    - [`CompositorNodeRelativeToPixel.bl_rna_get_subclass_py()`](#bpy.types.CompositorNodeRelativeToPixel.bl_rna_get_subclass_py)
