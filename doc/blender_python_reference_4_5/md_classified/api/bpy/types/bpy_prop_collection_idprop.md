...
# bpy\_prop\_collection\_idprop[¶](#bpy-prop-collection-idprop "Link to this heading")

base classes — [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection")

*class* bpy.types.bpy\_prop\_collection\_idprop[¶](#bpy.types.bpy_prop_collection_idprop "Link to this definition")
:   built-in class used for user defined collections.

    Note

    Note that [`bpy.types.bpy_prop_collection_idprop`](#bpy.types.bpy_prop_collection_idprop "bpy.types.bpy_prop_collection_idprop") is not actually available from within Blender,
    it only exists for the purpose of documentation.

    add()[¶](#bpy.types.bpy_prop_collection_idprop.add "Link to this definition")
    ...
    clear()[¶](#bpy.types.bpy_prop_collection_idprop.clear "Link to this definition")
    :   This is a function to remove all items from a collection.

    move(*src\_index*, *dst\_index*)[¶](#bpy.types.bpy_prop_collection_idprop.move "Link to this definition")
    :   This is a function to move an item in a collection.

        Parameters:
        :   * **src\_index** (*int*) – Source item index.
            * **dst\_index** (*int*) – Destination item index.

    remove(*index*)[¶](#bpy.types.bpy_prop_collection_idprop.remove "Link to this definition")
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.bpy_prop_collection_idprop.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.bpy_prop_collection_idprop.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* bpy\_prop\_collection\_idprop
  + [`bpy_prop_collection_idprop`](#bpy.types.bpy_prop_collection_idprop)
    - [`bpy_prop_collection_idprop.add()`](#bpy.types.bpy_prop_collection_idprop.add)
    - [`bpy_prop_collection_idprop.clear()`](#bpy.types.bpy_prop_collection_idprop.clear)
    - [`bpy_prop_collection_idprop.move()`](#bpy.types.bpy_prop_collection_idprop.move)
    - [`bpy_prop_collection_idprop.remove()`](#bpy.types.bpy_prop_collection_idprop.remove)