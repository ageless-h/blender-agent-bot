...
# GeometryNodeFieldVariance(GeometryNode)[¶](#geometrynodefieldvariance-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeFieldVariance(*GeometryNode*)[¶](#bpy.types.GeometryNodeFieldVariance "Link to this definition")
:   Calculate the standard deviation and variance of a given field

    data\_type[¶](#bpy.types.GeometryNodeFieldVariance.data_type "Link to this definition")
    :   Type of data the outputs are calculated from
        ...
        * `FLOAT_VECTOR`
        ...
        Type:
        :   enum in [`'FLOAT'`, `'FLOAT_VECTOR'`], default `'FLOAT'`

    domain[¶](#bpy.types.GeometryNodeFieldVariance.domain "Link to this definition")
    :   Type:
    ...
    *classmethod* is\_registered\_node\_type()[¶](#bpy.types.GeometryNodeFieldVariance.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[¶](#bpy.types.GeometryNodeFieldVariance.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[¶](#bpy.types.GeometryNodeFieldVariance.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.GeometryNodeFieldVariance.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.GeometryNodeFieldVariance.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeFieldVariance.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.GeometryNodeFieldVariance.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeFieldVariance(GeometryNode)
  + [`GeometryNodeFieldVariance`](#bpy.types.GeometryNodeFieldVariance)
    - [`GeometryNodeFieldVariance.data_type`](#bpy.types.GeometryNodeFieldVariance.data_type)
    - [`GeometryNodeFieldVariance.domain`](#bpy.types.GeometryNodeFieldVariance.domain)
    - [`GeometryNodeFieldVariance.is_registered_node_type()`](#bpy.types.GeometryNodeFieldVariance.is_registered_node_type)
    - [`GeometryNodeFieldVariance.input_template()`](#bpy.types.GeometryNodeFieldVariance.input_template)
    - [`GeometryNodeFieldVariance.output_template()`](#bpy.types.GeometryNodeFieldVariance.output_template)
    - [`GeometryNodeFieldVariance.bl_rna_get_subclass()`](#bpy.types.GeometryNodeFieldVariance.bl_rna_get_subclass)
    - [`GeometryNodeFieldVariance.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeFieldVariance.bl_rna_get_subclass_py)
