...
# StripsMeta(bpy\_struct)[¶](#stripsmeta-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.StripsMeta(*bpy\_struct*)[¶](#bpy.types.StripsMeta "Link to this definition")
:   Collection of Strips

    new\_clip(*name*, *clip*, *channel*, *frame\_start*)[¶](#bpy.types.StripsMeta.new_clip "Link to this definition")
    ...
    new\_mask(*name*, *mask*, *channel*, *frame\_start*)[¶](#bpy.types.StripsMeta.new_mask "Link to this definition")
    ...
    new\_scene(*name*, *scene*, *channel*, *frame\_start*)[¶](#bpy.types.StripsMeta.new_scene "Link to this definition")
    ...
    new\_image(*name*, *filepath*, *channel*, *frame\_start*, *\**, *fit\_method='ORIGINAL'*)[¶](#bpy.types.StripsMeta.new_image "Link to this definition")
    ...
    new\_movie(*name*, *filepath*, *channel*, *frame\_start*, *\**, *fit\_method='ORIGINAL'*)[¶](#bpy.types.StripsMeta.new_movie "Link to this definition")
    ...
    new\_sound(*name*, *filepath*, *channel*, *frame\_start*)[¶](#bpy.types.StripsMeta.new_sound "Link to this definition")
    ...
    new\_meta(*name*, *channel*, *frame\_start*)[¶](#bpy.types.StripsMeta.new_meta "Link to this definition")
    ...
    new\_effect(*name*, *type*, *channel*, *frame\_start*, *\**, *frame\_end=0*, *input1=None*, *input2=None*)[¶](#bpy.types.StripsMeta.new_effect "Link to this definition")
    ...
    remove(*sequence*)[¶](#bpy.types.StripsMeta.remove "Link to this definition")
    :   Remove a Strip

        Parameters:
        :   **sequence** ([`Strip`](Strip.md#bpy.types.Strip "bpy.types.Strip"), (never None)) – Strip to remove

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.StripsMeta.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.StripsMeta.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`MetaStrip.sequences`](MetaStrip.md#bpy.types.MetaStrip.sequences "bpy.types.MetaStrip.sequences") | * [`MetaStrip.strips`](MetaStrip.md#bpy.types.MetaStrip.strips "bpy.types.MetaStrip.strips") |

[Next

StripsTopLevel(bpy\_struct)](StripsTopLevel.md)
[Previous

StripTransform(bpy\_struct)](StripTransform.md)
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.StripsMeta.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.StripsMeta.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* StripsMeta(bpy\_struct)
  + [`StripsMeta`](#bpy.types.StripsMeta)
    - [`StripsMeta.new_clip()`](#bpy.types.StripsMeta.new_clip)
    - [`StripsMeta.new_mask()`](#bpy.types.StripsMeta.new_mask)
    - [`StripsMeta.new_scene()`](#bpy.types.StripsMeta.new_scene)
    - [`StripsMeta.new_image()`](#bpy.types.StripsMeta.new_image)
    - [`StripsMeta.new_movie()`](#bpy.types.StripsMeta.new_movie)
    - [`StripsMeta.new_sound()`](#bpy.types.StripsMeta.new_sound)
    - [`StripsMeta.new_meta()`](#bpy.types.StripsMeta.new_meta)
    - [`StripsMeta.new_effect()`](#bpy.types.StripsMeta.new_effect)
    - [`StripsMeta.remove()`](#bpy.types.StripsMeta.remove)
    - [`StripsMeta.bl_rna_get_subclass()`](#bpy.types.StripsMeta.bl_rna_get_subclass)
    - [`StripsMeta.bl_rna_get_subclass_py()`](#bpy.types.StripsMeta.bl_rna_get_subclass_py)
