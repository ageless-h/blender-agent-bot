...
# KeyingSetPath(bpy\_struct)[¶](#keyingsetpath-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.KeyingSetPath(*bpy\_struct*)[¶](#bpy.types.KeyingSetPath "Link to this definition")
:   Path to a setting for use in a Keying Set

    array\_index[¶](#bpy.types.KeyingSetPath.array_index "Link to this definition")
    :   Index to the specific setting if applicable

        Type:
        :   int in [-inf, inf], default 0

    data\_path[¶](#bpy.types.KeyingSetPath.data_path "Link to this definition")
    :   Path to property setting

        Type:
        :   string, default “”, (never None)

    group[¶](#bpy.types.KeyingSetPath.group "Link to this definition")
    :   Name of Action Group to assign setting(s) for this path to

        Type:
        :   string, default “”, (never None)

    group\_method[¶](#bpy.types.KeyingSetPath.group_method "Link to this definition")
    :   Method used to define which Group-name to use

        Type:
        :   enum in [Keyingset Path Grouping Items](../../../appendix/bpy_types_enum_items/keyingset_path_grouping_items.md#rna-enum-keyingset-path-grouping-items), default `'NAMED'`

    id[¶](#bpy.types.KeyingSetPath.id "Link to this definition")
    ...
    id\_type[¶](#bpy.types.KeyingSetPath.id_type "Link to this definition")
    :   Type of ID-block that can be used

        Type:
        :   enum in [Id Type Items](../../../appendix/bpy_types_enum_items/id_type_items.md#rna-enum-id-type-items), default `'OBJECT'`

    use\_entire\_array[¶](#bpy.types.KeyingSetPath.use_entire_array "Link to this definition")
    :   When an ‘array/vector’ type is chosen (Location, Rotation, Color, etc.), entire array is to be used

        Type:
        :   boolean, default False

    use\_insertkey\_needed[¶](#bpy.types.KeyingSetPath.use_insertkey_needed "Link to this definition")
    :   Only insert keyframes where they’re needed in the relevant F-Curves

        Type:
        :   boolean, default False

    use\_insertkey\_override\_needed[¶](#bpy.types.KeyingSetPath.use_insertkey_override_needed "Link to this definition")
    :   Override default setting to only insert keyframes where they’re needed in the relevant F-Curves

        Type:
        :   boolean, default False

    use\_insertkey\_override\_visual[¶](#bpy.types.KeyingSetPath.use_insertkey_override_visual "Link to this definition")
    :   Override default setting to insert keyframes based on ‘visual transforms’

        Type:
        :   boolean, default False

    use\_insertkey\_visual[¶](#bpy.types.KeyingSetPath.use_insertkey_visual "Link to this definition")
    :   Insert keyframes based on ‘visual transforms’

        Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.KeyingSetPath.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.KeyingSetPath.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`KeyingSet.paths`](KeyingSet.md#bpy.types.KeyingSet.paths "bpy.types.KeyingSet.paths") * [`KeyingSetPaths.active`](KeyingSetPaths.md#bpy.types.KeyingSetPaths.active "bpy.types.KeyingSetPaths.active") | * [`KeyingSetPaths.add`](KeyingSetPaths.md#bpy.types.KeyingSetPaths.add "bpy.types.KeyingSetPaths.add") * [`KeyingSetPaths.remove`](KeyingSetPaths.md#bpy.types.KeyingSetPaths.remove "bpy.types.KeyingSetPaths.remove") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.KeyingSetPath.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.KeyingSetPath.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* KeyingSetPath(bpy\_struct)
  + [`KeyingSetPath`](#bpy.types.KeyingSetPath)
    - [`KeyingSetPath.array_index`](#bpy.types.KeyingSetPath.array_index)
    - [`KeyingSetPath.data_path`](#bpy.types.KeyingSetPath.data_path)
    - [`KeyingSetPath.group`](#bpy.types.KeyingSetPath.group)
    - [`KeyingSetPath.group_method`](#bpy.types.KeyingSetPath.group_method)
    - [`KeyingSetPath.id`](#bpy.types.KeyingSetPath.id)
    - [`KeyingSetPath.id_type`](#bpy.types.KeyingSetPath.id_type)
    - [`KeyingSetPath.use_entire_array`](#bpy.types.KeyingSetPath.use_entire_array)
    - [`KeyingSetPath.use_insertkey_needed`](#bpy.types.KeyingSetPath.use_insertkey_needed)
    - [`KeyingSetPath.use_insertkey_override_needed`](#bpy.types.KeyingSetPath.use_insertkey_override_needed)
    - [`KeyingSetPath.use_insertkey_override_visual`](#bpy.types.KeyingSetPath.use_insertkey_override_visual)
    - [`KeyingSetPath.use_insertkey_visual`](#bpy.types.KeyingSetPath.use_insertkey_visual)
    - [`KeyingSetPath.bl_rna_get_subclass()`](#bpy.types.KeyingSetPath.bl_rna_get_subclass)
    - [`KeyingSetPath.bl_rna_get_subclass_py()`](#bpy.types.KeyingSetPath.bl_rna_get_subclass_py)
