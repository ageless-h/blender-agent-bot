...
# GeometryNodeWarning(GeometryNode)[¶](#geometrynodewarning-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeWarning(*GeometryNode*)[¶](#bpy.types.GeometryNodeWarning "Link to this definition")
:   Create custom warnings in node groups

    warning\_type[¶](#bpy.types.GeometryNodeWarning.warning_type "Link to this definition")
    :   Type:
        :   enum in [Node Warning Type Items](../../../appendix/bpy_types_enum_items/node_warning_type_items.md#rna-enum-node-warning-type-items), default `'ERROR'`

    *classmethod* is\_registered\_node\_type()[¶](#bpy.types.GeometryNodeWarning.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[¶](#bpy.types.GeometryNodeWarning.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[¶](#bpy.types.GeometryNodeWarning.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.GeometryNodeWarning.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.GeometryNodeWarning.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeWarning.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.GeometryNodeWarning.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeWarning(GeometryNode)
  + [`GeometryNodeWarning`](#bpy.types.GeometryNodeWarning)
    - [`GeometryNodeWarning.warning_type`](#bpy.types.GeometryNodeWarning.warning_type)
    - [`GeometryNodeWarning.is_registered_node_type()`](#bpy.types.GeometryNodeWarning.is_registered_node_type)
    - [`GeometryNodeWarning.input_template()`](#bpy.types.GeometryNodeWarning.input_template)
    - [`GeometryNodeWarning.output_template()`](#bpy.types.GeometryNodeWarning.output_template)
    - [`GeometryNodeWarning.bl_rna_get_subclass()`](#bpy.types.GeometryNodeWarning.bl_rna_get_subclass)
    - [`GeometryNodeWarning.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeWarning.bl_rna_get_subclass_py)
