...
# NodeGeometrySeparateBundleItem(bpy\_struct)[¶](#nodegeometryseparatebundleitem-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.NodeGeometrySeparateBundleItem(*bpy\_struct*)[¶](#bpy.types.NodeGeometrySeparateBundleItem "Link to this definition")
:   color[¶](#bpy.types.NodeGeometrySeparateBundleItem.color "Link to this definition")
    ...
    name[¶](#bpy.types.NodeGeometrySeparateBundleItem.name "Link to this definition")
    :   Type:
        :   string, default “”, (never None)

    socket\_type[¶](#bpy.types.NodeGeometrySeparateBundleItem.socket_type "Link to this definition")
    :   Type:
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.NodeGeometrySeparateBundleItem.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.NodeGeometrySeparateBundleItem.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`GeometryNodeSeparateBundle.bundle_items`](GeometryNodeSeparateBundle.md#bpy.types.GeometryNodeSeparateBundle.bundle_items "bpy.types.GeometryNodeSeparateBundle.bundle_items") * [`NodeGeometrySeparateBundleItems.new`](NodeGeometrySeparateBundleItems.md#bpy.types.NodeGeometrySeparateBundleItems.new "bpy.types.NodeGeometrySeparateBundleItems.new") | * [`NodeGeometrySeparateBundleItems.remove`](NodeGeometrySeparateBundleItems.md#bpy.types.NodeGeometrySeparateBundleItems.remove "bpy.types.NodeGeometrySeparateBundleItems.remove") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.NodeGeometrySeparateBundleItem.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.NodeGeometrySeparateBundleItem.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* NodeGeometrySeparateBundleItem(bpy\_struct)
  + [`NodeGeometrySeparateBundleItem`](#bpy.types.NodeGeometrySeparateBundleItem)
    - [`NodeGeometrySeparateBundleItem.color`](#bpy.types.NodeGeometrySeparateBundleItem.color)
    - [`NodeGeometrySeparateBundleItem.name`](#bpy.types.NodeGeometrySeparateBundleItem.name)
    - [`NodeGeometrySeparateBundleItem.socket_type`](#bpy.types.NodeGeometrySeparateBundleItem.socket_type)
    - [`NodeGeometrySeparateBundleItem.bl_rna_get_subclass()`](#bpy.types.NodeGeometrySeparateBundleItem.bl_rna_get_subclass)
    - [`NodeGeometrySeparateBundleItem.bl_rna_get_subclass_py()`](#bpy.types.NodeGeometrySeparateBundleItem.bl_rna_get_subclass_py)
