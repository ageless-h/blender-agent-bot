...
# ShaderNodeBsdfMetallic(ShaderNode)[¶](#shadernodebsdfmetallic-shadernode "Link to this heading")
...
*class* bpy.types.ShaderNodeBsdfMetallic(*ShaderNode*)[¶](#bpy.types.ShaderNodeBsdfMetallic "Link to this definition")
:   Metallic reflection with microfacet distribution, and metallic fresnel

    distribution[¶](#bpy.types.ShaderNodeBsdfMetallic.distribution "Link to this definition")
    :   Light scattering distribution on rough surface
        ...
        * `MULTI_GGX`
        ...
        Type:
        :   enum in [`'BECKMANN'`, `'GGX'`, `'MULTI_GGX'`], default `'BECKMANN'`

    fresnel\_type[¶](#bpy.types.ShaderNodeBsdfMetallic.fresnel_type "Link to this definition")
    :   Fresnel method used to tint the metal
        ...
        * `F82`
        ...
        Type:
        :   enum in [`'PHYSICAL_CONDUCTOR'`, `'F82'`], default `'PHYSICAL_CONDUCTOR'`

    *classmethod* is\_registered\_node\_type()[¶](#bpy.types.ShaderNodeBsdfMetallic.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[¶](#bpy.types.ShaderNodeBsdfMetallic.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[¶](#bpy.types.ShaderNodeBsdfMetallic.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ShaderNodeBsdfMetallic.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ShaderNodeBsdfMetallic.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ShaderNodeBsdfMetallic.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.ShaderNodeBsdfMetallic.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ShaderNodeBsdfMetallic(ShaderNode)
  + [`ShaderNodeBsdfMetallic`](#bpy.types.ShaderNodeBsdfMetallic)
    - [`ShaderNodeBsdfMetallic.distribution`](#bpy.types.ShaderNodeBsdfMetallic.distribution)
    - [`ShaderNodeBsdfMetallic.fresnel_type`](#bpy.types.ShaderNodeBsdfMetallic.fresnel_type)
    - [`ShaderNodeBsdfMetallic.is_registered_node_type()`](#bpy.types.ShaderNodeBsdfMetallic.is_registered_node_type)
    - [`ShaderNodeBsdfMetallic.input_template()`](#bpy.types.ShaderNodeBsdfMetallic.input_template)
    - [`ShaderNodeBsdfMetallic.output_template()`](#bpy.types.ShaderNodeBsdfMetallic.output_template)
    - [`ShaderNodeBsdfMetallic.bl_rna_get_subclass()`](#bpy.types.ShaderNodeBsdfMetallic.bl_rna_get_subclass)
    - [`ShaderNodeBsdfMetallic.bl_rna_get_subclass_py()`](#bpy.types.ShaderNodeBsdfMetallic.bl_rna_get_subclass_py)
