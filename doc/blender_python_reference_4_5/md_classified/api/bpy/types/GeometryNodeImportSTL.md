...
# GeometryNodeImportSTL(GeometryNode)[¶](#geometrynodeimportstl-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeImportSTL(*GeometryNode*)[¶](#bpy.types.GeometryNodeImportSTL "Link to this definition")
:   Import a mesh from an STL file

    *classmethod* is\_registered\_node\_type()[¶](#bpy.types.GeometryNodeImportSTL.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[¶](#bpy.types.GeometryNodeImportSTL.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[¶](#bpy.types.GeometryNodeImportSTL.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.GeometryNodeImportSTL.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.GeometryNodeImportSTL.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
GeometryNodeImportPLY(GeometryNode)](GeometryNodeImportPLY.md)
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeImportSTL.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.GeometryNodeImportSTL.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeImportSTL(GeometryNode)
  + [`GeometryNodeImportSTL`](#bpy.types.GeometryNodeImportSTL)
    - [`GeometryNodeImportSTL.is_registered_node_type()`](#bpy.types.GeometryNodeImportSTL.is_registered_node_type)
    - [`GeometryNodeImportSTL.input_template()`](#bpy.types.GeometryNodeImportSTL.input_template)
    - [`GeometryNodeImportSTL.output_template()`](#bpy.types.GeometryNodeImportSTL.output_template)
    - [`GeometryNodeImportSTL.bl_rna_get_subclass()`](#bpy.types.GeometryNodeImportSTL.bl_rna_get_subclass)
    - [`GeometryNodeImportSTL.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeImportSTL.bl_rna_get_subclass_py)
