...
:   active\_index[¶](#bpy.types.CacheFile.active_index "Link to this definition")
    ...
    prefetch\_cache\_size[¶](#bpy.types.CacheFile.prefetch_cache_size "Link to this definition")
    ...
    use\_prefetch[¶](#bpy.types.CacheFile.use_prefetch "Link to this definition")
    :   When enabled, the Cycles Procedural will preload animation data for faster updates

        Type:
        :   boolean, default False

    use\_render\_procedural[¶](#bpy.types.CacheFile.use_render_procedural "Link to this definition")
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CacheFile.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.CacheFile.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)
...
* CacheFile(ID)
  + [`CacheFile`](#bpy.types.CacheFile)
    ...
    - [`CacheFile.prefetch_cache_size`](#bpy.types.CacheFile.prefetch_cache_size)
    - [`CacheFile.scale`](#bpy.types.CacheFile.scale)
    - [`CacheFile.up_axis`](#bpy.types.CacheFile.up_axis)
    - [`CacheFile.use_prefetch`](#bpy.types.CacheFile.use_prefetch)
    - [`CacheFile.use_render_procedural`](#bpy.types.CacheFile.use_render_procedural)
