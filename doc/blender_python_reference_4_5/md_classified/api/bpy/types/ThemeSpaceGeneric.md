...
# ThemeSpaceGeneric(bpy\_struct)[¶](#themespacegeneric-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.ThemeSpaceGeneric(*bpy\_struct*)[¶](#bpy.types.ThemeSpaceGeneric "Link to this definition")
:   back[¶](#bpy.types.ThemeSpaceGeneric.back "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    button[¶](#bpy.types.ThemeSpaceGeneric.button "Link to this definition")
    :   Type:
        :   float array of 4 items in [0, 1], default (0.0, 0.0, 0.0, 0.0)

    button\_text[¶](#bpy.types.ThemeSpaceGeneric.button_text "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    button\_text\_hi[¶](#bpy.types.ThemeSpaceGeneric.button_text_hi "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    button\_title[¶](#bpy.types.ThemeSpaceGeneric.button_title "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    execution\_buts[¶](#bpy.types.ThemeSpaceGeneric.execution_buts "Link to this definition")
    :   Type:
        :   float array of 4 items in [0, 1], default (0.0, 0.0, 0.0, 0.0)

    header[¶](#bpy.types.ThemeSpaceGeneric.header "Link to this definition")
    :   Type:
        :   float array of 4 items in [0, 1], default (0.0, 0.0, 0.0, 0.0)

    header\_text[¶](#bpy.types.ThemeSpaceGeneric.header_text "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    header\_text\_hi[¶](#bpy.types.ThemeSpaceGeneric.header_text_hi "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    navigation\_bar[¶](#bpy.types.ThemeSpaceGeneric.navigation_bar "Link to this definition")
    :   Type:
        :   float array of 4 items in [0, 1], default (0.0, 0.0, 0.0, 0.0)

    panelcolors[¶](#bpy.types.ThemeSpaceGeneric.panelcolors "Link to this definition")
    :   Type:
        :   [`ThemePanelColors`](ThemePanelColors.md#bpy.types.ThemePanelColors "bpy.types.ThemePanelColors"), (readonly, never None)

    tab\_active[¶](#bpy.types.ThemeSpaceGeneric.tab_active "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    tab\_back[¶](#bpy.types.ThemeSpaceGeneric.tab_back "Link to this definition")
    :   Type:
        :   float array of 4 items in [0, 1], default (0.0, 0.0, 0.0, 0.0)

    tab\_inactive[¶](#bpy.types.ThemeSpaceGeneric.tab_inactive "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    tab\_outline[¶](#bpy.types.ThemeSpaceGeneric.tab_outline "Link to this definition")
    :   Type:
        :   float array of 4 items in [0, 1], default (0.0, 0.0, 0.0, 0.0)

    text[¶](#bpy.types.ThemeSpaceGeneric.text "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    text\_hi[¶](#bpy.types.ThemeSpaceGeneric.text_hi "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    title[¶](#bpy.types.ThemeSpaceGeneric.title "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ThemeSpaceGeneric.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ThemeSpaceGeneric.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`ThemeClipEditor.space`](ThemeClipEditor.md#bpy.types.ThemeClipEditor.space "bpy.types.ThemeClipEditor.space") * [`ThemeConsole.space`](ThemeConsole.md#bpy.types.ThemeConsole.space "bpy.types.ThemeConsole.space") * [`ThemeDopeSheet.space`](ThemeDopeSheet.md#bpy.types.ThemeDopeSheet.space "bpy.types.ThemeDopeSheet.space") * [`ThemeFileBrowser.space`](ThemeFileBrowser.md#bpy.types.ThemeFileBrowser.space "bpy.types.ThemeFileBrowser.space") * [`ThemeGraphEditor.space`](ThemeGraphEditor.md#bpy.types.ThemeGraphEditor.space "bpy.types.ThemeGraphEditor.space") * [`ThemeImageEditor.space`](ThemeImageEditor.md#bpy.types.ThemeImageEditor.space "bpy.types.ThemeImageEditor.space") * [`ThemeInfo.space`](ThemeInfo.md#bpy.types.ThemeInfo.space "bpy.types.ThemeInfo.space") * [`ThemeNLAEditor.space`](ThemeNLAEditor.md#bpy.types.ThemeNLAEditor.space "bpy.types.ThemeNLAEditor.space") * [`ThemeNodeEditor.space`](ThemeNodeEditor.md#bpy.types.ThemeNodeEditor.space "bpy.types.ThemeNodeEditor.space") | * [`ThemeOutliner.space`](ThemeOutliner.md#bpy.types.ThemeOutliner.space "bpy.types.ThemeOutliner.space") * [`ThemePreferences.space`](ThemePreferences.md#bpy.types.ThemePreferences.space "bpy.types.ThemePreferences.space") * [`ThemeProperties.space`](ThemeProperties.md#bpy.types.ThemeProperties.space "bpy.types.ThemeProperties.space") * [`ThemeSequenceEditor.space`](ThemeSequenceEditor.md#bpy.types.ThemeSequenceEditor.space "bpy.types.ThemeSequenceEditor.space") * [`ThemeSpreadsheet.space`](ThemeSpreadsheet.md#bpy.types.ThemeSpreadsheet.space "bpy.types.ThemeSpreadsheet.space") * [`ThemeStatusBar.space`](ThemeStatusBar.md#bpy.types.ThemeStatusBar.space "bpy.types.ThemeStatusBar.space") * [`ThemeTextEditor.space`](ThemeTextEditor.md#bpy.types.ThemeTextEditor.space "bpy.types.ThemeTextEditor.space") * [`ThemeTopBar.space`](ThemeTopBar.md#bpy.types.ThemeTopBar.space "bpy.types.ThemeTopBar.space") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ThemeSpaceGeneric.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.ThemeSpaceGeneric.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ThemeSpaceGeneric(bpy\_struct)
  + [`ThemeSpaceGeneric`](#bpy.types.ThemeSpaceGeneric)
    - [`ThemeSpaceGeneric.back`](#bpy.types.ThemeSpaceGeneric.back)
    - [`ThemeSpaceGeneric.button`](#bpy.types.ThemeSpaceGeneric.button)
    - [`ThemeSpaceGeneric.button_text`](#bpy.types.ThemeSpaceGeneric.button_text)
    - [`ThemeSpaceGeneric.button_text_hi`](#bpy.types.ThemeSpaceGeneric.button_text_hi)
    - [`ThemeSpaceGeneric.button_title`](#bpy.types.ThemeSpaceGeneric.button_title)
    - [`ThemeSpaceGeneric.execution_buts`](#bpy.types.ThemeSpaceGeneric.execution_buts)
    - [`ThemeSpaceGeneric.header`](#bpy.types.ThemeSpaceGeneric.header)
    - [`ThemeSpaceGeneric.header_text`](#bpy.types.ThemeSpaceGeneric.header_text)
    - [`ThemeSpaceGeneric.header_text_hi`](#bpy.types.ThemeSpaceGeneric.header_text_hi)
    - [`ThemeSpaceGeneric.navigation_bar`](#bpy.types.ThemeSpaceGeneric.navigation_bar)
    - [`ThemeSpaceGeneric.panelcolors`](#bpy.types.ThemeSpaceGeneric.panelcolors)
    - [`ThemeSpaceGeneric.tab_active`](#bpy.types.ThemeSpaceGeneric.tab_active)
    - [`ThemeSpaceGeneric.tab_back`](#bpy.types.ThemeSpaceGeneric.tab_back)
    - [`ThemeSpaceGeneric.tab_inactive`](#bpy.types.ThemeSpaceGeneric.tab_inactive)
    - [`ThemeSpaceGeneric.tab_outline`](#bpy.types.ThemeSpaceGeneric.tab_outline)
    - [`ThemeSpaceGeneric.text`](#bpy.types.ThemeSpaceGeneric.text)
    - [`ThemeSpaceGeneric.text_hi`](#bpy.types.ThemeSpaceGeneric.text_hi)
    - [`ThemeSpaceGeneric.title`](#bpy.types.ThemeSpaceGeneric.title)
    - [`ThemeSpaceGeneric.bl_rna_get_subclass()`](#bpy.types.ThemeSpaceGeneric.bl_rna_get_subclass)
    - [`ThemeSpaceGeneric.bl_rna_get_subclass_py()`](#bpy.types.ThemeSpaceGeneric.bl_rna_get_subclass_py)
