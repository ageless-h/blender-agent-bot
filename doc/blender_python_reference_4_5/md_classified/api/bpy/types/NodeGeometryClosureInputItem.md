...
# NodeGeometryClosureInputItem(bpy\_struct)[¶](#nodegeometryclosureinputitem-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.NodeGeometryClosureInputItem(*bpy\_struct*)[¶](#bpy.types.NodeGeometryClosureInputItem "Link to this definition")
:   color[¶](#bpy.types.NodeGeometryClosureInputItem.color "Link to this definition")
    ...
    name[¶](#bpy.types.NodeGeometryClosureInputItem.name "Link to this definition")
    :   Type:
        :   string, default “”, (never None)

    socket\_type[¶](#bpy.types.NodeGeometryClosureInputItem.socket_type "Link to this definition")
    :   Type:
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.NodeGeometryClosureInputItem.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.NodeGeometryClosureInputItem.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`GeometryNodeClosureOutput.input_items`](GeometryNodeClosureOutput.md#bpy.types.GeometryNodeClosureOutput.input_items "bpy.types.GeometryNodeClosureOutput.input_items") * [`NodeGeometryClosureInputItems.new`](NodeGeometryClosureInputItems.md#bpy.types.NodeGeometryClosureInputItems.new "bpy.types.NodeGeometryClosureInputItems.new") | * [`NodeGeometryClosureInputItems.remove`](NodeGeometryClosureInputItems.md#bpy.types.NodeGeometryClosureInputItems.remove "bpy.types.NodeGeometryClosureInputItems.remove") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.NodeGeometryClosureInputItem.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.NodeGeometryClosureInputItem.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* NodeGeometryClosureInputItem(bpy\_struct)
  + [`NodeGeometryClosureInputItem`](#bpy.types.NodeGeometryClosureInputItem)
    - [`NodeGeometryClosureInputItem.color`](#bpy.types.NodeGeometryClosureInputItem.color)
    - [`NodeGeometryClosureInputItem.name`](#bpy.types.NodeGeometryClosureInputItem.name)
    - [`NodeGeometryClosureInputItem.socket_type`](#bpy.types.NodeGeometryClosureInputItem.socket_type)
    - [`NodeGeometryClosureInputItem.bl_rna_get_subclass()`](#bpy.types.NodeGeometryClosureInputItem.bl_rna_get_subclass)
    - [`NodeGeometryClosureInputItem.bl_rna_get_subclass_py()`](#bpy.types.NodeGeometryClosureInputItem.bl_rna_get_subclass_py)
