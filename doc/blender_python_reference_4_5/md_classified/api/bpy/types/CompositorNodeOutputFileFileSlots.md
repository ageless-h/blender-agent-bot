...
# CompositorNodeOutputFileFileSlots(bpy\_struct)[¶](#compositornodeoutputfilefileslots-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.CompositorNodeOutputFileFileSlots(*bpy\_struct*)[¶](#bpy.types.CompositorNodeOutputFileFileSlots "Link to this definition")
:   Collection of File Output node slots

    new(*name*)[¶](#bpy.types.CompositorNodeOutputFileFileSlots.new "Link to this definition")
    ...
    remove(*socket*)[¶](#bpy.types.CompositorNodeOutputFileFileSlots.remove "Link to this definition")
    ...
    clear()[¶](#bpy.types.CompositorNodeOutputFileFileSlots.clear "Link to this definition")
    :   Remove all file slots from this node

    move(*from\_index*, *to\_index*)[¶](#bpy.types.CompositorNodeOutputFileFileSlots.move "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.CompositorNodeOutputFileFileSlots.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.CompositorNodeOutputFileFileSlots.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`CompositorNodeOutputFile.file_slots`](CompositorNodeOutputFile.md#bpy.types.CompositorNodeOutputFile.file_slots "bpy.types.CompositorNodeOutputFile.file_slots") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CompositorNodeOutputFileFileSlots.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.CompositorNodeOutputFileFileSlots.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CompositorNodeOutputFileFileSlots(bpy\_struct)
  + [`CompositorNodeOutputFileFileSlots`](#bpy.types.CompositorNodeOutputFileFileSlots)
    - [`CompositorNodeOutputFileFileSlots.new()`](#bpy.types.CompositorNodeOutputFileFileSlots.new)
    - [`CompositorNodeOutputFileFileSlots.remove()`](#bpy.types.CompositorNodeOutputFileFileSlots.remove)
    - [`CompositorNodeOutputFileFileSlots.clear()`](#bpy.types.CompositorNodeOutputFileFileSlots.clear)
    - [`CompositorNodeOutputFileFileSlots.move()`](#bpy.types.CompositorNodeOutputFileFileSlots.move)
    - [`CompositorNodeOutputFileFileSlots.bl_rna_get_subclass()`](#bpy.types.CompositorNodeOutputFileFileSlots.bl_rna_get_subclass)
    - [`CompositorNodeOutputFileFileSlots.bl_rna_get_subclass_py()`](#bpy.types.CompositorNodeOutputFileFileSlots.bl_rna_get_subclass_py)
