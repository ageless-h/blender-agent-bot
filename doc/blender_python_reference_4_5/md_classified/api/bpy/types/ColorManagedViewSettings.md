...
:   Color management settings used for displaying images on the display
    ...
    use\_hdr\_view[¶](#bpy.types.ColorManagedViewSettings.use_hdr_view "Link to this definition")
...
* ColorManagedViewSettings(bpy\_struct)
  + [`ColorManagedViewSettings`](#bpy.types.ColorManagedViewSettings)
    ...
    - [`ColorManagedViewSettings.use_hdr_view`](#bpy.types.ColorManagedViewSettings.use_hdr_view)
