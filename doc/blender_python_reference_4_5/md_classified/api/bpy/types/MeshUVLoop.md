...
# MeshUVLoop(bpy\_struct)[¶](#meshuvloop-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.MeshUVLoop(*bpy\_struct*)[¶](#bpy.types.MeshUVLoop "Link to this definition")
:   (Deprecated) Layer of UV coordinates in a Mesh data-block

    pin\_uv[¶](#bpy.types.MeshUVLoop.pin_uv "Link to this definition")
    :   Type:
        :   boolean, default False

    select[¶](#bpy.types.MeshUVLoop.select "Link to this definition")
    :   Type:
        :   boolean, default False

    select\_edge[¶](#bpy.types.MeshUVLoop.select_edge "Link to this definition")
    :   Type:
        :   boolean, default False

    uv[¶](#bpy.types.MeshUVLoop.uv "Link to this definition")
    :   Type:
        :   [`mathutils.Vector`](../../mathutils/index.md#mathutils.Vector "mathutils.Vector") of 2 items in [-inf, inf], default (0.0, 0.0)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.MeshUVLoop.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.MeshUVLoop.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`MeshUVLoopLayer.data`](MeshUVLoopLayer.md#bpy.types.MeshUVLoopLayer.data "bpy.types.MeshUVLoopLayer.data") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.MeshUVLoop.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.MeshUVLoop.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* MeshUVLoop(bpy\_struct)
  + [`MeshUVLoop`](#bpy.types.MeshUVLoop)
    - [`MeshUVLoop.pin_uv`](#bpy.types.MeshUVLoop.pin_uv)
    - [`MeshUVLoop.select`](#bpy.types.MeshUVLoop.select)
    - [`MeshUVLoop.select_edge`](#bpy.types.MeshUVLoop.select_edge)
    - [`MeshUVLoop.uv`](#bpy.types.MeshUVLoop.uv)
    - [`MeshUVLoop.bl_rna_get_subclass()`](#bpy.types.MeshUVLoop.bl_rna_get_subclass)
    - [`MeshUVLoop.bl_rna_get_subclass_py()`](#bpy.types.MeshUVLoop.bl_rna_get_subclass_py)
