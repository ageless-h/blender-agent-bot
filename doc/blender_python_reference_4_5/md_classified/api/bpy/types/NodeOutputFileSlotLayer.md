...
# NodeOutputFileSlotLayer(bpy\_struct)[¶](#nodeoutputfileslotlayer-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.NodeOutputFileSlotLayer(*bpy\_struct*)[¶](#bpy.types.NodeOutputFileSlotLayer "Link to this definition")
:   Multilayer slot of the file output node

    name[¶](#bpy.types.NodeOutputFileSlotLayer.name "Link to this definition")
    :   OpenEXR layer name used for this slot

        Type:
        :   string, default “”, (never None)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.NodeOutputFileSlotLayer.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.NodeOutputFileSlotLayer.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.NodeOutputFileSlotLayer.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.NodeOutputFileSlotLayer.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* NodeOutputFileSlotLayer(bpy\_struct)
  + [`NodeOutputFileSlotLayer`](#bpy.types.NodeOutputFileSlotLayer)
    - [`NodeOutputFileSlotLayer.name`](#bpy.types.NodeOutputFileSlotLayer.name)
    - [`NodeOutputFileSlotLayer.bl_rna_get_subclass()`](#bpy.types.NodeOutputFileSlotLayer.bl_rna_get_subclass)
    - [`NodeOutputFileSlotLayer.bl_rna_get_subclass_py()`](#bpy.types.NodeOutputFileSlotLayer.bl_rna_get_subclass_py)
