...
# StripsTopLevel(bpy\_struct)[¶](#stripstoplevel-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.StripsTopLevel(*bpy\_struct*)[¶](#bpy.types.StripsTopLevel "Link to this definition")
:   Collection of Strips

    new\_clip(*name*, *clip*, *channel*, *frame\_start*)[¶](#bpy.types.StripsTopLevel.new_clip "Link to this definition")
    :   Add a new movie clip strip

        Parameters:
        :   * **name** (*string**,* *(**never None**)*) – Name for the new strip
            * **clip** ([`MovieClip`](MovieClip.md#bpy.types.MovieClip "bpy.types.MovieClip"), (never None)) – Movie clip to add
            * **channel** (*int in* *[**1**,* *128**]*) – Channel, The channel for the new strip
            * **frame\_start** (*int in* *[**-1048574**,* *1048574**]*) – The start frame for the new strip
    ...
    new\_mask(*name*, *mask*, *channel*, *frame\_start*)[¶](#bpy.types.StripsTopLevel.new_mask "Link to this definition")
    :   Add a new mask strip

        Parameters:
        :   * **name** (*string**,* *(**never None**)*) – Name for the new strip
            * **mask** ([`Mask`](Mask.md#bpy.types.Mask "bpy.types.Mask"), (never None)) – Mask to add
            * **channel** (*int in* *[**1**,* *128**]*) – Channel, The channel for the new strip
            * **frame\_start** (*int in* *[**-1048574**,* *1048574**]*) – The start frame for the new strip
    ...
    new\_scene(*name*, *scene*, *channel*, *frame\_start*)[¶](#bpy.types.StripsTopLevel.new_scene "Link to this definition")
    :   Add a new scene strip

        Parameters:
        :   * **name** (*string**,* *(**never None**)*) – Name for the new strip
            * **scene** ([`Scene`](Scene.md#bpy.types.Scene "bpy.types.Scene"), (never None)) – Scene to add
            * **channel** (*int in* *[**1**,* *128**]*) – Channel, The channel for the new strip
            * **frame\_start** (*int in* *[**-1048574**,* *1048574**]*) – The start frame for the new strip
    ...
    new\_image(*name*, *filepath*, *channel*, *frame\_start*, *\**, *fit\_method='ORIGINAL'*)[¶](#bpy.types.StripsTopLevel.new_image "Link to this definition")
    ...
    new\_movie(*name*, *filepath*, *channel*, *frame\_start*, *\**, *fit\_method='ORIGINAL'*)[¶](#bpy.types.StripsTopLevel.new_movie "Link to this definition")
    ...
    new\_sound(*name*, *filepath*, *channel*, *frame\_start*)[¶](#bpy.types.StripsTopLevel.new_sound "Link to this definition")
    ...
    new\_meta(*name*, *channel*, *frame\_start*)[¶](#bpy.types.StripsTopLevel.new_meta "Link to this definition")
    ...
    new\_effect(*name*, *type*, *channel*, *frame\_start*, *\**, *frame\_end=0*, *input1=None*, *input2=None*)[¶](#bpy.types.StripsTopLevel.new_effect "Link to this definition")
    :   Add a new effect strip

        Parameters:
        :   * **name** (*string**,* *(**never None**)*) – Name for the new strip
            * **type** (enum in [`'CROSS'`, `'ADD'`, `'SUBTRACT'`, `'ALPHA_OVER'`, `'ALPHA_UNDER'`, `'GAMMA_CROSS'`, `'MULTIPLY'`, `'WIPE'`, `'GLOW'`, `'TRANSFORM'`, `'COLOR'`, `'SPEED'`, `'MULTICAM'`, `'ADJUSTMENT'`, `'GAUSSIAN_BLUR'`, `'TEXT'`, `'COLORMIX'`]) –
            ...
            * **channel** (*int in* *[**1**,* *128**]*) – Channel, The channel for the new strip
            * **frame\_start** (*int in* *[**-inf**,* *inf**]*) – The start frame for the new strip
            * **frame\_end** (*int in* *[**-inf**,* *inf**]**,* *(**optional**)*) – The end frame for the new strip
            * **input1** ([`Strip`](Strip.md#bpy.types.Strip "bpy.types.Strip"), (optional)) – First input strip for effect
            * **input2** ([`Strip`](Strip.md#bpy.types.Strip "bpy.types.Strip"), (optional)) – Second input strip for effect
    ...
    remove(*sequence*)[¶](#bpy.types.StripsTopLevel.remove "Link to this definition")
    :   Remove a Strip

        Parameters:
        :   **sequence** ([`Strip`](Strip.md#bpy.types.Strip "bpy.types.Strip"), (never None)) – Strip to remove

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.StripsTopLevel.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.StripsTopLevel.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`SequenceEditor.sequences`](SequenceEditor.md#bpy.types.SequenceEditor.sequences "bpy.types.SequenceEditor.sequences") | * [`SequenceEditor.strips`](SequenceEditor.md#bpy.types.SequenceEditor.strips "bpy.types.SequenceEditor.strips") |
...
StripsMeta(bpy\_struct)](StripsMeta.md)
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.StripsTopLevel.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.StripsTopLevel.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* StripsTopLevel(bpy\_struct)
  + [`StripsTopLevel`](#bpy.types.StripsTopLevel)
    - [`StripsTopLevel.new_clip()`](#bpy.types.StripsTopLevel.new_clip)
    - [`StripsTopLevel.new_mask()`](#bpy.types.StripsTopLevel.new_mask)
    - [`StripsTopLevel.new_scene()`](#bpy.types.StripsTopLevel.new_scene)
    - [`StripsTopLevel.new_image()`](#bpy.types.StripsTopLevel.new_image)
    - [`StripsTopLevel.new_movie()`](#bpy.types.StripsTopLevel.new_movie)
    - [`StripsTopLevel.new_sound()`](#bpy.types.StripsTopLevel.new_sound)
    - [`StripsTopLevel.new_meta()`](#bpy.types.StripsTopLevel.new_meta)
    - [`StripsTopLevel.new_effect()`](#bpy.types.StripsTopLevel.new_effect)
    - [`StripsTopLevel.remove()`](#bpy.types.StripsTopLevel.remove)
    - [`StripsTopLevel.bl_rna_get_subclass()`](#bpy.types.StripsTopLevel.bl_rna_get_subclass)
    - [`StripsTopLevel.bl_rna_get_subclass_py()`](#bpy.types.StripsTopLevel.bl_rna_get_subclass_py)
