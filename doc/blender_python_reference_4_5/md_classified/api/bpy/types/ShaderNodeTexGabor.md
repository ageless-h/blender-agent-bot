...
# ShaderNodeTexGabor(ShaderNode)[¶](#shadernodetexgabor-shadernode "Link to this heading")
...
*class* bpy.types.ShaderNodeTexGabor(*ShaderNode*)[¶](#bpy.types.ShaderNodeTexGabor "Link to this definition")
:   Generate Gabor noise

    color\_mapping[¶](#bpy.types.ShaderNodeTexGabor.color_mapping "Link to this definition")
    :   Color mapping settings

        Type:
        :   [`ColorMapping`](ColorMapping.md#bpy.types.ColorMapping "bpy.types.ColorMapping"), (readonly, never None)

    gabor\_type[¶](#bpy.types.ShaderNodeTexGabor.gabor_type "Link to this definition")
    :   The type of Gabor noise to evaluate
    ...
    texture\_mapping[¶](#bpy.types.ShaderNodeTexGabor.texture_mapping "Link to this definition")
    :   Texture coordinate mapping settings

        Type:
        :   [`TexMapping`](TexMapping.md#bpy.types.TexMapping "bpy.types.TexMapping"), (readonly, never None)

    *classmethod* is\_registered\_node\_type()[¶](#bpy.types.ShaderNodeTexGabor.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[¶](#bpy.types.ShaderNodeTexGabor.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[¶](#bpy.types.ShaderNodeTexGabor.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ShaderNodeTexGabor.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ShaderNodeTexGabor.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ShaderNodeTexGabor.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.ShaderNodeTexGabor.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ShaderNodeTexGabor(ShaderNode)
  + [`ShaderNodeTexGabor`](#bpy.types.ShaderNodeTexGabor)
    - [`ShaderNodeTexGabor.color_mapping`](#bpy.types.ShaderNodeTexGabor.color_mapping)
    - [`ShaderNodeTexGabor.gabor_type`](#bpy.types.ShaderNodeTexGabor.gabor_type)
    - [`ShaderNodeTexGabor.texture_mapping`](#bpy.types.ShaderNodeTexGabor.texture_mapping)
    - [`ShaderNodeTexGabor.is_registered_node_type()`](#bpy.types.ShaderNodeTexGabor.is_registered_node_type)
    - [`ShaderNodeTexGabor.input_template()`](#bpy.types.ShaderNodeTexGabor.input_template)
    - [`ShaderNodeTexGabor.output_template()`](#bpy.types.ShaderNodeTexGabor.output_template)
    - [`ShaderNodeTexGabor.bl_rna_get_subclass()`](#bpy.types.ShaderNodeTexGabor.bl_rna_get_subclass)
    - [`ShaderNodeTexGabor.bl_rna_get_subclass_py()`](#bpy.types.ShaderNodeTexGabor.bl_rna_get_subclass_py)
