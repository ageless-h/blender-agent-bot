...
# GPencilFrames(bpy\_struct)[¶](#gpencilframes-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.GPencilFrames(*bpy\_struct*)[¶](#bpy.types.GPencilFrames "Link to this definition")
:   Collection of annotation frames

    new(*frame\_number*, *\**, *active=False*)[¶](#bpy.types.GPencilFrames.new "Link to this definition")
    :   Add a new annotation frame
        ...
        Return type:
        :   [`GPencilFrame`](GPencilFrame.md#bpy.types.GPencilFrame "bpy.types.GPencilFrame")

    remove(*frame*)[¶](#bpy.types.GPencilFrames.remove "Link to this definition")
    :   Remove an annotation frame

        Parameters:
        :   **frame** ([`GPencilFrame`](GPencilFrame.md#bpy.types.GPencilFrame "bpy.types.GPencilFrame"), (never None)) – Frame, The frame to remove

    copy(*source*)[¶](#bpy.types.GPencilFrames.copy "Link to this definition")
    :   Copy an annotation frame

        Parameters:
        :   **source** ([`GPencilFrame`](GPencilFrame.md#bpy.types.GPencilFrame "bpy.types.GPencilFrame"), (never None)) – Source, The source frame
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.GPencilFrames.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.GPencilFrames.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`GPencilLayer.frames`](GPencilLayer.md#bpy.types.GPencilLayer.frames "bpy.types.GPencilLayer.frames") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GPencilFrames.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.GPencilFrames.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GPencilFrames(bpy\_struct)
  + [`GPencilFrames`](#bpy.types.GPencilFrames)
    - [`GPencilFrames.new()`](#bpy.types.GPencilFrames.new)
    - [`GPencilFrames.remove()`](#bpy.types.GPencilFrames.remove)
    - [`GPencilFrames.copy()`](#bpy.types.GPencilFrames.copy)
    - [`GPencilFrames.bl_rna_get_subclass()`](#bpy.types.GPencilFrames.bl_rna_get_subclass)
    - [`GPencilFrames.bl_rna_get_subclass_py()`](#bpy.types.GPencilFrames.bl_rna_get_subclass_py)
