...
# GeometryNodeFieldMinAndMax(GeometryNode)[¶](#geometrynodefieldminandmax-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeFieldMinAndMax(*GeometryNode*)[¶](#bpy.types.GeometryNodeFieldMinAndMax "Link to this definition")
:   Calculate the minimum and maximum of a given field

    data\_type[¶](#bpy.types.GeometryNodeFieldMinAndMax.data_type "Link to this definition")
    :   Type of data the outputs are calculated from
        ...
        * `FLOAT_VECTOR`
        ...
        Type:
        :   enum in [`'FLOAT'`, `'INT'`, `'FLOAT_VECTOR'`], default `'FLOAT'`

    domain[¶](#bpy.types.GeometryNodeFieldMinAndMax.domain "Link to this definition")
    :   Type:
    ...
    *classmethod* is\_registered\_node\_type()[¶](#bpy.types.GeometryNodeFieldMinAndMax.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[¶](#bpy.types.GeometryNodeFieldMinAndMax.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[¶](#bpy.types.GeometryNodeFieldMinAndMax.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.GeometryNodeFieldMinAndMax.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.GeometryNodeFieldMinAndMax.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeFieldMinAndMax.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.GeometryNodeFieldMinAndMax.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeFieldMinAndMax(GeometryNode)
  + [`GeometryNodeFieldMinAndMax`](#bpy.types.GeometryNodeFieldMinAndMax)
    - [`GeometryNodeFieldMinAndMax.data_type`](#bpy.types.GeometryNodeFieldMinAndMax.data_type)
    - [`GeometryNodeFieldMinAndMax.domain`](#bpy.types.GeometryNodeFieldMinAndMax.domain)
    - [`GeometryNodeFieldMinAndMax.is_registered_node_type()`](#bpy.types.GeometryNodeFieldMinAndMax.is_registered_node_type)
    - [`GeometryNodeFieldMinAndMax.input_template()`](#bpy.types.GeometryNodeFieldMinAndMax.input_template)
    - [`GeometryNodeFieldMinAndMax.output_template()`](#bpy.types.GeometryNodeFieldMinAndMax.output_template)
    - [`GeometryNodeFieldMinAndMax.bl_rna_get_subclass()`](#bpy.types.GeometryNodeFieldMinAndMax.bl_rna_get_subclass)
    - [`GeometryNodeFieldMinAndMax.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeFieldMinAndMax.bl_rna_get_subclass_py)
