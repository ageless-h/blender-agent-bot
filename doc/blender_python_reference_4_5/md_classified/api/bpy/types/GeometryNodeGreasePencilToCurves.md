...
# GeometryNodeGreasePencilToCurves(GeometryNode)[¶](#geometrynodegreasepenciltocurves-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeGreasePencilToCurves(*GeometryNode*)[¶](#bpy.types.GeometryNodeGreasePencilToCurves "Link to this definition")
:   Convert Grease Pencil layers into curve instances

    *classmethod* is\_registered\_node\_type()[¶](#bpy.types.GeometryNodeGreasePencilToCurves.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[¶](#bpy.types.GeometryNodeGreasePencilToCurves.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[¶](#bpy.types.GeometryNodeGreasePencilToCurves.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.GeometryNodeGreasePencilToCurves.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.GeometryNodeGreasePencilToCurves.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
GeometryNodeGridInfo(GeometryNode)](GeometryNodeGridInfo.md)
[Previous
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeGreasePencilToCurves.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.GeometryNodeGreasePencilToCurves.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeGreasePencilToCurves(GeometryNode)
  + [`GeometryNodeGreasePencilToCurves`](#bpy.types.GeometryNodeGreasePencilToCurves)
    - [`GeometryNodeGreasePencilToCurves.is_registered_node_type()`](#bpy.types.GeometryNodeGreasePencilToCurves.is_registered_node_type)
    - [`GeometryNodeGreasePencilToCurves.input_template()`](#bpy.types.GeometryNodeGreasePencilToCurves.input_template)
    - [`GeometryNodeGreasePencilToCurves.output_template()`](#bpy.types.GeometryNodeGreasePencilToCurves.output_template)
    - [`GeometryNodeGreasePencilToCurves.bl_rna_get_subclass()`](#bpy.types.GeometryNodeGreasePencilToCurves.bl_rna_get_subclass)
    - [`GeometryNodeGreasePencilToCurves.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeGreasePencilToCurves.bl_rna_get_subclass_py)
