...
# FunctionNodeFormatString(FunctionNode)[¶](#functionnodeformatstring-functionnode "Link to this heading")
...
*class* bpy.types.FunctionNodeFormatString(*FunctionNode*)[¶](#bpy.types.FunctionNodeFormatString "Link to this definition")
:   Insert values into a string using a Python and path template compatible formatting syntax

    active\_index[¶](#bpy.types.FunctionNodeFormatString.active_index "Link to this definition")
    :   Index of the active item

        Type:
        :   int in [0, inf], default 0

    format\_items[¶](#bpy.types.FunctionNodeFormatString.format_items "Link to this definition")
    :   Type:
        :   [`NodeFunctionFormatStringItems`](NodeFunctionFormatStringItems.md#bpy.types.NodeFunctionFormatStringItems "bpy.types.NodeFunctionFormatStringItems") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`NodeFunctionFormatStringItem`](NodeFunctionFormatStringItem.md#bpy.types.NodeFunctionFormatStringItem "bpy.types.NodeFunctionFormatStringItem"), (readonly)

    *classmethod* is\_registered\_node\_type()[¶](#bpy.types.FunctionNodeFormatString.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[¶](#bpy.types.FunctionNodeFormatString.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[¶](#bpy.types.FunctionNodeFormatString.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.FunctionNodeFormatString.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.FunctionNodeFormatString.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
FunctionNodeHashValue(FunctionNode)](FunctionNodeHashValue.md)
[Previous
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.FunctionNodeFormatString.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.FunctionNodeFormatString.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* FunctionNodeFormatString(FunctionNode)
  + [`FunctionNodeFormatString`](#bpy.types.FunctionNodeFormatString)
    - [`FunctionNodeFormatString.active_index`](#bpy.types.FunctionNodeFormatString.active_index)
    - [`FunctionNodeFormatString.format_items`](#bpy.types.FunctionNodeFormatString.format_items)
    - [`FunctionNodeFormatString.is_registered_node_type()`](#bpy.types.FunctionNodeFormatString.is_registered_node_type)
    - [`FunctionNodeFormatString.input_template()`](#bpy.types.FunctionNodeFormatString.input_template)
    - [`FunctionNodeFormatString.output_template()`](#bpy.types.FunctionNodeFormatString.output_template)
    - [`FunctionNodeFormatString.bl_rna_get_subclass()`](#bpy.types.FunctionNodeFormatString.bl_rna_get_subclass)
    - [`FunctionNodeFormatString.bl_rna_get_subclass_py()`](#bpy.types.FunctionNodeFormatString.bl_rna_get_subclass_py)
