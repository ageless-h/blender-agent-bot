...
# GeometryNodeGizmoLinear(GeometryNode)[¶](#geometrynodegizmolinear-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeGizmoLinear(*GeometryNode*)[¶](#bpy.types.GeometryNodeGizmoLinear "Link to this definition")
:   Show a linear gizmo in the viewport for a value

    color\_id[¶](#bpy.types.GeometryNodeGizmoLinear.color_id "Link to this definition")
    :   Type:
        :   enum in [Geometry Nodes Gizmo Color Items](../../../appendix/bpy_types_enum_items/geometry_nodes_gizmo_color_items.md#rna-enum-geometry-nodes-gizmo-color-items), default `'PRIMARY'`

    draw\_style[¶](#bpy.types.GeometryNodeGizmoLinear.draw_style "Link to this definition")
    :   Type:
        :   enum in [Geometry Nodes Linear Gizmo Draw Style Items](../../../appendix/bpy_types_enum_items/geometry_nodes_linear_gizmo_draw_style_items.md#rna-enum-geometry-nodes-linear-gizmo-draw-style-items), default `'ARROW'`

    *classmethod* is\_registered\_node\_type()[¶](#bpy.types.GeometryNodeGizmoLinear.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[¶](#bpy.types.GeometryNodeGizmoLinear.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[¶](#bpy.types.GeometryNodeGizmoLinear.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.GeometryNodeGizmoLinear.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.GeometryNodeGizmoLinear.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
GeometryNodeGizmoTransform(GeometryNode)](GeometryNodeGizmoTransform.md)
[Previous

GeometryNodeGizmoDial(GeometryNode)](GeometryNodeGizmoDial.md)
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeGizmoLinear.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.GeometryNodeGizmoLinear.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeGizmoLinear(GeometryNode)
  + [`GeometryNodeGizmoLinear`](#bpy.types.GeometryNodeGizmoLinear)
    - [`GeometryNodeGizmoLinear.color_id`](#bpy.types.GeometryNodeGizmoLinear.color_id)
    - [`GeometryNodeGizmoLinear.draw_style`](#bpy.types.GeometryNodeGizmoLinear.draw_style)
    - [`GeometryNodeGizmoLinear.is_registered_node_type()`](#bpy.types.GeometryNodeGizmoLinear.is_registered_node_type)
    - [`GeometryNodeGizmoLinear.input_template()`](#bpy.types.GeometryNodeGizmoLinear.input_template)
    - [`GeometryNodeGizmoLinear.output_template()`](#bpy.types.GeometryNodeGizmoLinear.output_template)
    - [`GeometryNodeGizmoLinear.bl_rna_get_subclass()`](#bpy.types.GeometryNodeGizmoLinear.bl_rna_get_subclass)
    - [`GeometryNodeGizmoLinear.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeGizmoLinear.bl_rna_get_subclass_py)
