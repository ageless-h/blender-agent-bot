...
# GeometryNodeSetGreasePencilColor(GeometryNode)[¶](#geometrynodesetgreasepencilcolor-geometrynode "Link to this heading")
...
*class* bpy.types.GeometryNodeSetGreasePencilColor(*GeometryNode*)[¶](#bpy.types.GeometryNodeSetGreasePencilColor "Link to this definition")
:   Set color and opacity attributes on Grease Pencil geometry

    mode[¶](#bpy.types.GeometryNodeSetGreasePencilColor.mode "Link to this definition")
    :   * `STROKE`
        ...
        * `FILL`
        ...
        Type:
        :   enum in [`'STROKE'`, `'FILL'`], default `'STROKE'`

    *classmethod* is\_registered\_node\_type()[¶](#bpy.types.GeometryNodeSetGreasePencilColor.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[¶](#bpy.types.GeometryNodeSetGreasePencilColor.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[¶](#bpy.types.GeometryNodeSetGreasePencilColor.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.GeometryNodeSetGreasePencilColor.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.GeometryNodeSetGreasePencilColor.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
GeometryNodeSetGreasePencilDepth(GeometryNode)](GeometryNodeSetGreasePencilDepth.md)
[Previous

GeometryNodeSetGeometryName(GeometryNode)](GeometryNodeSetGeometryName.md)
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeSetGreasePencilColor.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.GeometryNodeSetGreasePencilColor.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GeometryNodeSetGreasePencilColor(GeometryNode)
  + [`GeometryNodeSetGreasePencilColor`](#bpy.types.GeometryNodeSetGreasePencilColor)
    - [`GeometryNodeSetGreasePencilColor.mode`](#bpy.types.GeometryNodeSetGreasePencilColor.mode)
    - [`GeometryNodeSetGreasePencilColor.is_registered_node_type()`](#bpy.types.GeometryNodeSetGreasePencilColor.is_registered_node_type)
    - [`GeometryNodeSetGreasePencilColor.input_template()`](#bpy.types.GeometryNodeSetGreasePencilColor.input_template)
    - [`GeometryNodeSetGreasePencilColor.output_template()`](#bpy.types.GeometryNodeSetGreasePencilColor.output_template)
    - [`GeometryNodeSetGreasePencilColor.bl_rna_get_subclass()`](#bpy.types.GeometryNodeSetGreasePencilColor.bl_rna_get_subclass)
    - [`GeometryNodeSetGreasePencilColor.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeSetGreasePencilColor.bl_rna_get_subclass_py)
