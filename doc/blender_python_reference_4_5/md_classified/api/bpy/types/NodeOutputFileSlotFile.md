...
# NodeOutputFileSlotFile(bpy\_struct)[¶](#nodeoutputfileslotfile-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.NodeOutputFileSlotFile(*bpy\_struct*)[¶](#bpy.types.NodeOutputFileSlotFile "Link to this definition")
:   Single layer file slot of the file output node

    format[¶](#bpy.types.NodeOutputFileSlotFile.format "Link to this definition")
    :   Type:
        :   [`ImageFormatSettings`](ImageFormatSettings.md#bpy.types.ImageFormatSettings "bpy.types.ImageFormatSettings"), (readonly)

    path[¶](#bpy.types.NodeOutputFileSlotFile.path "Link to this definition")
    :   Subpath used for this slot

        Type:
        :   string, default “”, (never None, Supports [template expressions](https://docs.blender.org/manual/en/4.5/files/file_paths.html#path-templates))

    save\_as\_render[¶](#bpy.types.NodeOutputFileSlotFile.save_as_render "Link to this definition")
    :   Apply render part of display transform when saving byte image

        Type:
        :   boolean, default False

    use\_node\_format[¶](#bpy.types.NodeOutputFileSlotFile.use_node_format "Link to this definition")
    :   Type:
        :   boolean, default False

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.NodeOutputFileSlotFile.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.NodeOutputFileSlotFile.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.NodeOutputFileSlotFile.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.NodeOutputFileSlotFile.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* NodeOutputFileSlotFile(bpy\_struct)
  + [`NodeOutputFileSlotFile`](#bpy.types.NodeOutputFileSlotFile)
    - [`NodeOutputFileSlotFile.format`](#bpy.types.NodeOutputFileSlotFile.format)
    - [`NodeOutputFileSlotFile.path`](#bpy.types.NodeOutputFileSlotFile.path)
    - [`NodeOutputFileSlotFile.save_as_render`](#bpy.types.NodeOutputFileSlotFile.save_as_render)
    - [`NodeOutputFileSlotFile.use_node_format`](#bpy.types.NodeOutputFileSlotFile.use_node_format)
    - [`NodeOutputFileSlotFile.bl_rna_get_subclass()`](#bpy.types.NodeOutputFileSlotFile.bl_rna_get_subclass)
    - [`NodeOutputFileSlotFile.bl_rna_get_subclass_py()`](#bpy.types.NodeOutputFileSlotFile.bl_rna_get_subclass_py)
