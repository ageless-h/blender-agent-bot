...
# GeometryNodeForeachGeometryElementOutput(GeometryNode)[¶](#geometrynodeforeachgeometryelementoutput-geometrynode "Link to this heading")

base classes — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct"), [`Node`](Node.md#bpy.types.Node "bpy.types.Node"), [`NodeInternal`](NodeInternal.md#bpy.types.NodeInternal "bpy.types.NodeInternal"), [`GeometryNode`](GeometryNode.md#bpy.types.GeometryNode "bpy.types.GeometryNode")

*class* bpy.types.GeometryNodeForeachGeometryElementOutput(*GeometryNode*)[¶](#bpy.types.GeometryNodeForeachGeometryElementOutput "Link to this definition")
:   active\_generation\_index[¶](#bpy.types.GeometryNodeForeachGeometryElementOutput.active_generation_index "Link to this definition")
    :   Index of the active item

        Type:
        :   int in [0, inf], default 0

    active\_input\_index[¶](#bpy.types.GeometryNodeForeachGeometryElementOutput.active_input_index "Link to this definition")
    :   Index of the active item

        Type:
        :   int in [0, inf], default 0

    active\_main\_index[¶](#bpy.types.GeometryNodeForeachGeometryElementOutput.active_main_index "Link to this definition")
    :   Index of the active item

        Type:
        :   int in [0, inf], default 0

    domain[¶](#bpy.types.GeometryNodeForeachGeometryElementOutput.domain "Link to this definition")
    ...
    generation\_items[¶](#bpy.types.GeometryNodeForeachGeometryElementOutput.generation_items "Link to this definition")
    :   Type:
        :   [`NodeGeometryForeachGeometryElementGenerationItems`](NodeGeometryForeachGeometryElementGenerationItems.md#bpy.types.NodeGeometryForeachGeometryElementGenerationItems "bpy.types.NodeGeometryForeachGeometryElementGenerationItems") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`ForeachGeometryElementGenerationItem`](ForeachGeometryElementGenerationItem.md#bpy.types.ForeachGeometryElementGenerationItem "bpy.types.ForeachGeometryElementGenerationItem"), (readonly)

    input\_items[¶](#bpy.types.GeometryNodeForeachGeometryElementOutput.input_items "Link to this definition")
    :   Type:
        :   [`NodeGeometryForeachGeometryElementInputItems`](NodeGeometryForeachGeometryElementInputItems.md#bpy.types.NodeGeometryForeachGeometryElementInputItems "bpy.types.NodeGeometryForeachGeometryElementInputItems") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`ForeachGeometryElementInputItem`](ForeachGeometryElementInputItem.md#bpy.types.ForeachGeometryElementInputItem "bpy.types.ForeachGeometryElementInputItem"), (readonly)

    inspection\_index[¶](#bpy.types.GeometryNodeForeachGeometryElementOutput.inspection_index "Link to this definition")
    :   Iteration index that is used by inspection features like the viewer node or socket inspection

        Type:
        :   int in [-inf, inf], default 0

    main\_items[¶](#bpy.types.GeometryNodeForeachGeometryElementOutput.main_items "Link to this definition")
    :   Type:
        :   [`NodeGeometryForeachGeometryElementMainItems`](NodeGeometryForeachGeometryElementMainItems.md#bpy.types.NodeGeometryForeachGeometryElementMainItems "bpy.types.NodeGeometryForeachGeometryElementMainItems") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`ForeachGeometryElementMainItem`](ForeachGeometryElementMainItem.md#bpy.types.ForeachGeometryElementMainItem "bpy.types.ForeachGeometryElementMainItem"), (readonly)

    *classmethod* is\_registered\_node\_type()[¶](#bpy.types.GeometryNodeForeachGeometryElementOutput.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[¶](#bpy.types.GeometryNodeForeachGeometryElementOutput.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[¶](#bpy.types.GeometryNodeForeachGeometryElementOutput.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.GeometryNodeForeachGeometryElementOutput.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.GeometryNodeForeachGeometryElementOutput.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
GeometryNodeForeachGeometryElementInput(GeometryNode)](GeometryNodeForeachGeometryElementInput.md)
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GeometryNodeForeachGeometryElementOutput.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.GeometryNodeForeachGeometryElementOutput.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)
...
* GeometryNodeForeachGeometryElementOutput(GeometryNode)
  + [`GeometryNodeForeachGeometryElementOutput`](#bpy.types.GeometryNodeForeachGeometryElementOutput)
    - [`GeometryNodeForeachGeometryElementOutput.active_generation_index`](#bpy.types.GeometryNodeForeachGeometryElementOutput.active_generation_index)
    - [`GeometryNodeForeachGeometryElementOutput.active_input_index`](#bpy.types.GeometryNodeForeachGeometryElementOutput.active_input_index)
    - [`GeometryNodeForeachGeometryElementOutput.active_main_index`](#bpy.types.GeometryNodeForeachGeometryElementOutput.active_main_index)
    - [`GeometryNodeForeachGeometryElementOutput.domain`](#bpy.types.GeometryNodeForeachGeometryElementOutput.domain)
    - [`GeometryNodeForeachGeometryElementOutput.generation_items`](#bpy.types.GeometryNodeForeachGeometryElementOutput.generation_items)
    - [`GeometryNodeForeachGeometryElementOutput.input_items`](#bpy.types.GeometryNodeForeachGeometryElementOutput.input_items)
    - [`GeometryNodeForeachGeometryElementOutput.inspection_index`](#bpy.types.GeometryNodeForeachGeometryElementOutput.inspection_index)
    - [`GeometryNodeForeachGeometryElementOutput.main_items`](#bpy.types.GeometryNodeForeachGeometryElementOutput.main_items)
    - [`GeometryNodeForeachGeometryElementOutput.is_registered_node_type()`](#bpy.types.GeometryNodeForeachGeometryElementOutput.is_registered_node_type)
    - [`GeometryNodeForeachGeometryElementOutput.input_template()`](#bpy.types.GeometryNodeForeachGeometryElementOutput.input_template)
    - [`GeometryNodeForeachGeometryElementOutput.output_template()`](#bpy.types.GeometryNodeForeachGeometryElementOutput.output_template)
    - [`GeometryNodeForeachGeometryElementOutput.bl_rna_get_subclass()`](#bpy.types.GeometryNodeForeachGeometryElementOutput.bl_rna_get_subclass)
    - [`GeometryNodeForeachGeometryElementOutput.bl_rna_get_subclass_py()`](#bpy.types.GeometryNodeForeachGeometryElementOutput.bl_rna_get_subclass_py)
