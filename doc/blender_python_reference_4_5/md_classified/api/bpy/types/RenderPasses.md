...
# RenderPasses(bpy\_struct)[¶](#renderpasses-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.RenderPasses(*bpy\_struct*)[¶](#bpy.types.RenderPasses "Link to this definition")
:   Collection of render passes

    find\_by\_type(*pass\_type*, *view*)[¶](#bpy.types.RenderPasses.find_by_type "Link to this definition")
    :   Get the render pass for a given type and view

        Parameters:
        :   * **pass\_type** (enum in [Render Pass Type Items](../../../appendix/bpy_types_enum_items/render_pass_type_items.md#rna-enum-render-pass-type-items)) – Pass
            * **view** (*string**,* *(**never None**)*) – View, Render view to get pass from
    ...
    find\_by\_name(*name*, *view*)[¶](#bpy.types.RenderPasses.find_by_name "Link to this definition")
    :   Get the render pass for a given name and view

        Parameters:
        :   * **name** (*string**,* *(**never None**)*) – Pass
            * **view** (*string**,* *(**never None**)*) – View, Render view to get pass from
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.RenderPasses.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.RenderPasses.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`RenderLayer.passes`](RenderLayer.md#bpy.types.RenderLayer.passes "bpy.types.RenderLayer.passes") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.RenderPasses.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.RenderPasses.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* RenderPasses(bpy\_struct)
  + [`RenderPasses`](#bpy.types.RenderPasses)
    - [`RenderPasses.find_by_type()`](#bpy.types.RenderPasses.find_by_type)
    - [`RenderPasses.find_by_name()`](#bpy.types.RenderPasses.find_by_name)
    - [`RenderPasses.bl_rna_get_subclass()`](#bpy.types.RenderPasses.bl_rna_get_subclass)
    - [`RenderPasses.bl_rna_get_subclass_py()`](#bpy.types.RenderPasses.bl_rna_get_subclass_py)
