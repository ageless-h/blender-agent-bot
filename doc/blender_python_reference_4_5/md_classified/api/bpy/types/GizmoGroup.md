...
# GizmoGroup(bpy\_struct)[¶](#gizmogroup-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.GizmoGroup(*bpy\_struct*)[¶](#bpy.types.GizmoGroup "Link to this definition")
:   Storage of an operator being executed, or registered after execution

    bl\_idname[¶](#bpy.types.GizmoGroup.bl_idname "Link to this definition")
    :   Type:
        :   string, default “”, (never None)

    bl\_label[¶](#bpy.types.GizmoGroup.bl_label "Link to this definition")
    :   Type:
        :   string, default “”, (never None)

    bl\_options[¶](#bpy.types.GizmoGroup.bl_options "Link to this definition")
    :   Options for this operator type
        ...
        * `VR_REDRAWS`
        ...
        Type:
        :   enum set in {`'3D'`, `'SCALE'`, `'DEPTH_3D'`, `'SELECT'`, `'PERSISTENT'`, `'SHOW_MODAL_ALL'`, `'EXCLUDE_MODAL'`, `'TOOL_INIT'`, `'TOOL_FALLBACK_KEYMAP'`, `'VR_REDRAWS'`}, default {`'3D'`}

    bl\_owner\_id[¶](#bpy.types.GizmoGroup.bl_owner_id "Link to this definition")
    :   Type:
        :   string, default “”, (never None)

    bl\_region\_type[¶](#bpy.types.GizmoGroup.bl_region_type "Link to this definition")
    ...
    bl\_space\_type[¶](#bpy.types.GizmoGroup.bl_space_type "Link to this definition")
    ...
    gizmos[¶](#bpy.types.GizmoGroup.gizmos "Link to this definition")
    :   List of gizmos in the Gizmo Map

        Type:
        :   [`Gizmos`](Gizmos.md#bpy.types.Gizmos "bpy.types.Gizmos") [`bpy_prop_collection`](bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`Gizmo`](Gizmo.md#bpy.types.Gizmo "bpy.types.Gizmo"), (readonly)

    name[¶](#bpy.types.GizmoGroup.name "Link to this definition")
    :   Type:
        :   string, default “”, (readonly, never None)

    *classmethod* poll(*context*)[¶](#bpy.types.GizmoGroup.poll "Link to this definition")
    :   Test if the gizmo group can be called or not

        Return type:
        :   boolean

    *classmethod* setup\_keymap(*keyconfig*)[¶](#bpy.types.GizmoGroup.setup_keymap "Link to this definition")
    :   Initialize keymaps for this gizmo group, use fallback keymap when not present

        Return type:
        :   [`KeyMap`](KeyMap.md#bpy.types.KeyMap "bpy.types.KeyMap"), (never None)

    setup(*context*)[¶](#bpy.types.GizmoGroup.setup "Link to this definition")
    :   Create gizmos function for the gizmo group

    refresh(*context*)[¶](#bpy.types.GizmoGroup.refresh "Link to this definition")
    :   Refresh data (called on common state changes such as selection)

    draw\_prepare(*context*)[¶](#bpy.types.GizmoGroup.draw_prepare "Link to this definition")
    :   Run before each redraw

    invoke\_prepare(*context*, *gizmo*)[¶](#bpy.types.GizmoGroup.invoke_prepare "Link to this definition")
    :   Run before invoke

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.GizmoGroup.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.GizmoGroup.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`Context.gizmo_group`](Context.md#bpy.types.Context.gizmo_group "bpy.types.Context.gizmo_group") | * [`Gizmo.group`](Gizmo.md#bpy.types.Gizmo.group "bpy.types.Gizmo.group") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.GizmoGroup.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.GizmoGroup.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* GizmoGroup(bpy\_struct)
  + [`GizmoGroup`](#bpy.types.GizmoGroup)
    - [`GizmoGroup.bl_idname`](#bpy.types.GizmoGroup.bl_idname)
    - [`GizmoGroup.bl_label`](#bpy.types.GizmoGroup.bl_label)
    - [`GizmoGroup.bl_options`](#bpy.types.GizmoGroup.bl_options)
    - [`GizmoGroup.bl_owner_id`](#bpy.types.GizmoGroup.bl_owner_id)
    - [`GizmoGroup.bl_region_type`](#bpy.types.GizmoGroup.bl_region_type)
    - [`GizmoGroup.bl_space_type`](#bpy.types.GizmoGroup.bl_space_type)
    - [`GizmoGroup.gizmos`](#bpy.types.GizmoGroup.gizmos)
    - [`GizmoGroup.name`](#bpy.types.GizmoGroup.name)
    - [`GizmoGroup.poll()`](#bpy.types.GizmoGroup.poll)
    - [`GizmoGroup.setup_keymap()`](#bpy.types.GizmoGroup.setup_keymap)
    - [`GizmoGroup.setup()`](#bpy.types.GizmoGroup.setup)
    - [`GizmoGroup.refresh()`](#bpy.types.GizmoGroup.refresh)
    - [`GizmoGroup.draw_prepare()`](#bpy.types.GizmoGroup.draw_prepare)
    - [`GizmoGroup.invoke_prepare()`](#bpy.types.GizmoGroup.invoke_prepare)
    - [`GizmoGroup.bl_rna_get_subclass()`](#bpy.types.GizmoGroup.bl_rna_get_subclass)
    - [`GizmoGroup.bl_rna_get_subclass_py()`](#bpy.types.GizmoGroup.bl_rna_get_subclass_py)
