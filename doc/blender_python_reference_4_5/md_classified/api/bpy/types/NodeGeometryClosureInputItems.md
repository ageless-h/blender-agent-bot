...
# NodeGeometryClosureInputItems(bpy\_struct)[¶](#nodegeometryclosureinputitems-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.NodeGeometryClosureInputItems(*bpy\_struct*)[¶](#bpy.types.NodeGeometryClosureInputItems "Link to this definition")
:   new(*socket\_type*, *name*)[¶](#bpy.types.NodeGeometryClosureInputItems.new "Link to this definition")
    :   Add an item at the end
        ...
        Return type:
        :   [`NodeGeometryClosureInputItem`](NodeGeometryClosureInputItem.md#bpy.types.NodeGeometryClosureInputItem "bpy.types.NodeGeometryClosureInputItem")

    remove(*item*)[¶](#bpy.types.NodeGeometryClosureInputItems.remove "Link to this definition")
    :   Remove an item

        Parameters:
        :   **item** ([`NodeGeometryClosureInputItem`](NodeGeometryClosureInputItem.md#bpy.types.NodeGeometryClosureInputItem "bpy.types.NodeGeometryClosureInputItem"), (never None)) – Item, The item to remove

    clear()[¶](#bpy.types.NodeGeometryClosureInputItems.clear "Link to this definition")
    :   Remove all items

    move(*from\_index*, *to\_index*)[¶](#bpy.types.NodeGeometryClosureInputItems.move "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.NodeGeometryClosureInputItems.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.NodeGeometryClosureInputItems.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`GeometryNodeClosureOutput.input_items`](GeometryNodeClosureOutput.md#bpy.types.GeometryNodeClosureOutput.input_items "bpy.types.GeometryNodeClosureOutput.input_items") |  |

[Next

NodeGeometryClosureOutputItem(bpy\_struct)](NodeGeometryClosureOutputItem.md)
[Previous
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.NodeGeometryClosureInputItems.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.NodeGeometryClosureInputItems.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* NodeGeometryClosureInputItems(bpy\_struct)
  + [`NodeGeometryClosureInputItems`](#bpy.types.NodeGeometryClosureInputItems)
    - [`NodeGeometryClosureInputItems.new()`](#bpy.types.NodeGeometryClosureInputItems.new)
    - [`NodeGeometryClosureInputItems.remove()`](#bpy.types.NodeGeometryClosureInputItems.remove)
    - [`NodeGeometryClosureInputItems.clear()`](#bpy.types.NodeGeometryClosureInputItems.clear)
    - [`NodeGeometryClosureInputItems.move()`](#bpy.types.NodeGeometryClosureInputItems.move)
    - [`NodeGeometryClosureInputItems.bl_rna_get_subclass()`](#bpy.types.NodeGeometryClosureInputItems.bl_rna_get_subclass)
    - [`NodeGeometryClosureInputItems.bl_rna_get_subclass_py()`](#bpy.types.NodeGeometryClosureInputItems.bl_rna_get_subclass_py)
