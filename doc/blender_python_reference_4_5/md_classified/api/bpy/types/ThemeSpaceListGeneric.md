...
# ThemeSpaceListGeneric(bpy\_struct)[¶](#themespacelistgeneric-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.ThemeSpaceListGeneric(*bpy\_struct*)[¶](#bpy.types.ThemeSpaceListGeneric "Link to this definition")
:   list[¶](#bpy.types.ThemeSpaceListGeneric.list "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    list\_text[¶](#bpy.types.ThemeSpaceListGeneric.list_text "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    list\_text\_hi[¶](#bpy.types.ThemeSpaceListGeneric.list_text_hi "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    list\_title[¶](#bpy.types.ThemeSpaceListGeneric.list_title "Link to this definition")
    :   Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.0, 0.0, 0.0)

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.ThemeSpaceListGeneric.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.ThemeSpaceListGeneric.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`ThemeClipEditor.space_list`](ThemeClipEditor.md#bpy.types.ThemeClipEditor.space_list "bpy.types.ThemeClipEditor.space_list") * [`ThemeDopeSheet.space_list`](ThemeDopeSheet.md#bpy.types.ThemeDopeSheet.space_list "bpy.types.ThemeDopeSheet.space_list") * [`ThemeGraphEditor.space_list`](ThemeGraphEditor.md#bpy.types.ThemeGraphEditor.space_list "bpy.types.ThemeGraphEditor.space_list") * [`ThemeNLAEditor.space_list`](ThemeNLAEditor.md#bpy.types.ThemeNLAEditor.space_list "bpy.types.ThemeNLAEditor.space_list") | * [`ThemeNodeEditor.space_list`](ThemeNodeEditor.md#bpy.types.ThemeNodeEditor.space_list "bpy.types.ThemeNodeEditor.space_list") * [`ThemeSequenceEditor.space_list`](ThemeSequenceEditor.md#bpy.types.ThemeSequenceEditor.space_list "bpy.types.ThemeSequenceEditor.space_list") * [`ThemeSpreadsheet.space_list`](ThemeSpreadsheet.md#bpy.types.ThemeSpreadsheet.space_list "bpy.types.ThemeSpreadsheet.space_list") |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.ThemeSpaceListGeneric.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.ThemeSpaceListGeneric.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* ThemeSpaceListGeneric(bpy\_struct)
  + [`ThemeSpaceListGeneric`](#bpy.types.ThemeSpaceListGeneric)
    - [`ThemeSpaceListGeneric.list`](#bpy.types.ThemeSpaceListGeneric.list)
    - [`ThemeSpaceListGeneric.list_text`](#bpy.types.ThemeSpaceListGeneric.list_text)
    - [`ThemeSpaceListGeneric.list_text_hi`](#bpy.types.ThemeSpaceListGeneric.list_text_hi)
    - [`ThemeSpaceListGeneric.list_title`](#bpy.types.ThemeSpaceListGeneric.list_title)
    - [`ThemeSpaceListGeneric.bl_rna_get_subclass()`](#bpy.types.ThemeSpaceListGeneric.bl_rna_get_subclass)
    - [`ThemeSpaceListGeneric.bl_rna_get_subclass_py()`](#bpy.types.ThemeSpaceListGeneric.bl_rna_get_subclass_py)
