...
:   Collection of actions
    ...
    :   Remove an action from the current blendfile
        ...
        :   * **action** ([`Action`](Action.md#bpy.types.Action "bpy.types.Action"), (never None)) – Action to remove
            ...
            * **do\_id\_user** (*boolean**,* *(**optional**)*) – Decrement user counter of all datablocks used by this action
