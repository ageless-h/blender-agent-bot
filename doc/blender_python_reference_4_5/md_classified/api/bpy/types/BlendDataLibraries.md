...
:   Collection of libraries
    ...
    :   Remove a library from the current blendfile
        ...
        :   * **library** ([`Library`](Library.md#bpy.types.Library "bpy.types.Library"), (never None)) – Library to remove
            ...
            * **do\_id\_user** (*boolean**,* *(**optional**)*) – Decrement user counter of all datablocks used by this library
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.BlendDataLibraries.bl_rna_get_subclass_py "Link to this definition")
    ...
    load(*filepath*, *link=False*, *relative=False*, *assets\_only=False*, *create\_liboverrides=False*, *reuse\_liboverrides=False*, *create\_liboverrides\_runtime=False*)[¶](#bpy.types.BlendDataLibraries.load "Link to this definition")
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.BlendDataLibraries.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.BlendDataLibraries.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)
