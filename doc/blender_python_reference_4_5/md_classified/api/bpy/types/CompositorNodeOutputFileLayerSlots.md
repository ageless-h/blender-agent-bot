...
# CompositorNodeOutputFileLayerSlots(bpy\_struct)[¶](#compositornodeoutputfilelayerslots-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.CompositorNodeOutputFileLayerSlots(*bpy\_struct*)[¶](#bpy.types.CompositorNodeOutputFileLayerSlots "Link to this definition")
:   Collection of File Output node slots

    new(*name*)[¶](#bpy.types.CompositorNodeOutputFileLayerSlots.new "Link to this definition")
    :   Add a file slot to this node
        ...
        Return type:
        :   [`NodeSocket`](NodeSocket.md#bpy.types.NodeSocket "bpy.types.NodeSocket")

    remove(*socket*)[¶](#bpy.types.CompositorNodeOutputFileLayerSlots.remove "Link to this definition")
    :   Remove a file slot from this node

        Parameters:
        :   **socket** ([`NodeSocket`](NodeSocket.md#bpy.types.NodeSocket "bpy.types.NodeSocket")) – The socket to remove

    clear()[¶](#bpy.types.CompositorNodeOutputFileLayerSlots.clear "Link to this definition")
    :   Remove all file slots from this node

    move(*from\_index*, *to\_index*)[¶](#bpy.types.CompositorNodeOutputFileLayerSlots.move "Link to this definition")
    :   Move a file slot to another position

        Parameters:
        :   * **from\_index** (*int in* *[**0**,* *inf**]*) – From Index, Index of the socket to move
            * **to\_index** (*int in* *[**0**,* *inf**]*) – To Index, Target index for the socket

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.CompositorNodeOutputFileLayerSlots.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.CompositorNodeOutputFileLayerSlots.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`CompositorNodeOutputFile.layer_slots`](CompositorNodeOutputFile.md#bpy.types.CompositorNodeOutputFile.layer_slots "bpy.types.CompositorNodeOutputFile.layer_slots") |  |
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CompositorNodeOutputFileLayerSlots.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.CompositorNodeOutputFileLayerSlots.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CompositorNodeOutputFileLayerSlots(bpy\_struct)
  + [`CompositorNodeOutputFileLayerSlots`](#bpy.types.CompositorNodeOutputFileLayerSlots)
    - [`CompositorNodeOutputFileLayerSlots.new()`](#bpy.types.CompositorNodeOutputFileLayerSlots.new)
    - [`CompositorNodeOutputFileLayerSlots.remove()`](#bpy.types.CompositorNodeOutputFileLayerSlots.remove)
    - [`CompositorNodeOutputFileLayerSlots.clear()`](#bpy.types.CompositorNodeOutputFileLayerSlots.clear)
    - [`CompositorNodeOutputFileLayerSlots.move()`](#bpy.types.CompositorNodeOutputFileLayerSlots.move)
    - [`CompositorNodeOutputFileLayerSlots.bl_rna_get_subclass()`](#bpy.types.CompositorNodeOutputFileLayerSlots.bl_rna_get_subclass)
    - [`CompositorNodeOutputFileLayerSlots.bl_rna_get_subclass_py()`](#bpy.types.CompositorNodeOutputFileLayerSlots.bl_rna_get_subclass_py)
