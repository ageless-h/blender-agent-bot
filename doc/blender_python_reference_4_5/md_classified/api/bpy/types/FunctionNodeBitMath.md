...
# FunctionNodeBitMath(FunctionNode)[¶](#functionnodebitmath-functionnode "Link to this heading")
...
*class* bpy.types.FunctionNodeBitMath(*FunctionNode*)[¶](#bpy.types.FunctionNodeBitMath "Link to this definition")
:   Perform bitwise operations on 32-bit integers

    operation[¶](#bpy.types.FunctionNodeBitMath.operation "Link to this definition")
    :   * `AND`
    ...
    *classmethod* is\_registered\_node\_type()[¶](#bpy.types.FunctionNodeBitMath.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[¶](#bpy.types.FunctionNodeBitMath.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[¶](#bpy.types.FunctionNodeBitMath.output_template "Link to this definition")
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.FunctionNodeBitMath.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.FunctionNodeBitMath.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.FunctionNodeBitMath.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.FunctionNodeBitMath.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* FunctionNodeBitMath(FunctionNode)
  + [`FunctionNodeBitMath`](#bpy.types.FunctionNodeBitMath)
    - [`FunctionNodeBitMath.operation`](#bpy.types.FunctionNodeBitMath.operation)
    - [`FunctionNodeBitMath.is_registered_node_type()`](#bpy.types.FunctionNodeBitMath.is_registered_node_type)
    - [`FunctionNodeBitMath.input_template()`](#bpy.types.FunctionNodeBitMath.input_template)
    - [`FunctionNodeBitMath.output_template()`](#bpy.types.FunctionNodeBitMath.output_template)
    - [`FunctionNodeBitMath.bl_rna_get_subclass()`](#bpy.types.FunctionNodeBitMath.bl_rna_get_subclass)
    - [`FunctionNodeBitMath.bl_rna_get_subclass_py()`](#bpy.types.FunctionNodeBitMath.bl_rna_get_subclass_py)
