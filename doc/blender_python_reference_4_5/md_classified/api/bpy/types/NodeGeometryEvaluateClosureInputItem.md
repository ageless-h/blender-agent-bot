...
# NodeGeometryEvaluateClosureInputItem(bpy\_struct)[¶](#nodegeometryevaluateclosureinputitem-bpy-struct "Link to this heading")

base class — [`bpy_struct`](bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct")

*class* bpy.types.NodeGeometryEvaluateClosureInputItem(*bpy\_struct*)[¶](#bpy.types.NodeGeometryEvaluateClosureInputItem "Link to this definition")
:   color[¶](#bpy.types.NodeGeometryEvaluateClosureInputItem.color "Link to this definition")
    ...
    name[¶](#bpy.types.NodeGeometryEvaluateClosureInputItem.name "Link to this definition")
    :   Type:
        :   string, default “”, (never None)

    socket\_type[¶](#bpy.types.NodeGeometryEvaluateClosureInputItem.socket_type "Link to this definition")
    :   Type:
    ...
    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.NodeGeometryEvaluateClosureInputItem.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.NodeGeometryEvaluateClosureInputItem.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
|  |  |
| --- | --- |
| * [`GeometryNodeEvaluateClosure.input_items`](GeometryNodeEvaluateClosure.md#bpy.types.GeometryNodeEvaluateClosure.input_items "bpy.types.GeometryNodeEvaluateClosure.input_items") * [`NodeGeometryEvaluateClosureInputItems.new`](NodeGeometryEvaluateClosureInputItems.md#bpy.types.NodeGeometryEvaluateClosureInputItems.new "bpy.types.NodeGeometryEvaluateClosureInputItems.new") | * [`NodeGeometryEvaluateClosureInputItems.remove`](NodeGeometryEvaluateClosureInputItems.md#bpy.types.NodeGeometryEvaluateClosureInputItems.remove "bpy.types.NodeGeometryEvaluateClosureInputItems.remove") |

[Next

NodeGeometryEvaluateClosureInputItems(bpy\_struct)](NodeGeometryEvaluateClosureInputItems.md)
[Previous

NodeGeometryCombineBundleItems(bpy\_struct)](NodeGeometryCombineBundleItems.md)
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.NodeGeometryEvaluateClosureInputItem.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.NodeGeometryEvaluateClosureInputItem.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* NodeGeometryEvaluateClosureInputItem(bpy\_struct)
  + [`NodeGeometryEvaluateClosureInputItem`](#bpy.types.NodeGeometryEvaluateClosureInputItem)
    - [`NodeGeometryEvaluateClosureInputItem.color`](#bpy.types.NodeGeometryEvaluateClosureInputItem.color)
    - [`NodeGeometryEvaluateClosureInputItem.name`](#bpy.types.NodeGeometryEvaluateClosureInputItem.name)
    - [`NodeGeometryEvaluateClosureInputItem.socket_type`](#bpy.types.NodeGeometryEvaluateClosureInputItem.socket_type)
    - [`NodeGeometryEvaluateClosureInputItem.bl_rna_get_subclass()`](#bpy.types.NodeGeometryEvaluateClosureInputItem.bl_rna_get_subclass)
    - [`NodeGeometryEvaluateClosureInputItem.bl_rna_get_subclass_py()`](#bpy.types.NodeGeometryEvaluateClosureInputItem.bl_rna_get_subclass_py)
