...
# CompositorNodeColorBalance(CompositorNode)[¶](#compositornodecolorbalance-compositornode "Link to this heading")
...
*class* bpy.types.CompositorNodeColorBalance(*CompositorNode*)[¶](#bpy.types.CompositorNodeColorBalance "Link to this definition")
:   Adjust color and values

    correction\_method[¶](#bpy.types.CompositorNodeColorBalance.correction_method "Link to this definition")
    :   * `LIFT_GAMMA_GAIN`
          Lift/Gamma/Gain.
        * `OFFSET_POWER_SLOPE`
          Offset/Power/Slope (ASC-CDL) – ASC-CDL standard color correction.
        * `WHITEPOINT`
          White Point – Chromatic adaption from a different white point.

        Type:
        :   enum in [`'LIFT_GAMMA_GAIN'`, `'OFFSET_POWER_SLOPE'`, `'WHITEPOINT'`], default `'LIFT_GAMMA_GAIN'`

    gain[¶](#bpy.types.CompositorNodeColorBalance.gain "Link to this definition")
    ...
    gamma[¶](#bpy.types.CompositorNodeColorBalance.gamma "Link to this definition")
    :   Correction for midtones. (Deprecated: Use Gamma input instead.)

        Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, inf], default (1.0, 1.0, 1.0)

    input\_temperature[¶](#bpy.types.CompositorNodeColorBalance.input_temperature "Link to this definition")
    ...
    input\_tint[¶](#bpy.types.CompositorNodeColorBalance.input_tint "Link to this definition")
    ...
    input\_whitepoint[¶](#bpy.types.CompositorNodeColorBalance.input_whitepoint "Link to this definition")
    ...
    lift[¶](#bpy.types.CompositorNodeColorBalance.lift "Link to this definition")
    :   Correction for shadows. (Deprecated: Use Lift input instead.)

        Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, inf], default (1.0, 1.0, 1.0)

    offset[¶](#bpy.types.CompositorNodeColorBalance.offset "Link to this definition")
    :   Correction for entire tonal range. (Deprecated: Use Offset input instead.)

        Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, inf], default (0.0, 0.0, 0.0)

    offset\_basis[¶](#bpy.types.CompositorNodeColorBalance.offset_basis "Link to this definition")
    :   Support negative color by using this as the RGB basis. (Deprecated: Use Offset Basis input instead.)

        Type:
        :   float in [-inf, inf], default 0.0

    output\_temperature[¶](#bpy.types.CompositorNodeColorBalance.output_temperature "Link to this definition")
    :   Color temperature of the output’s white point. (Deprecated: Use Output Temperature input instead.)

        Type:
        :   float in [1800, 100000], default 6500.0

    output\_tint[¶](#bpy.types.CompositorNodeColorBalance.output_tint "Link to this definition")
    :   Color tint of the output’s white point (the default of 10 matches daylight). (Deprecated: Use Output Tint input instead.)

        Type:
        :   float in [-500, 500], default 10.0

    output\_whitepoint[¶](#bpy.types.CompositorNodeColorBalance.output_whitepoint "Link to this definition")
    :   The color which gets white gets mapped to (automatically converted to/from temperature and tint)

        Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, inf], default (0.0, 0.0, 0.0)

    power[¶](#bpy.types.CompositorNodeColorBalance.power "Link to this definition")
    :   Correction for midtones. (Deprecated: Use Power input instead.)

        Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, inf], default (1.0, 1.0, 1.0)

    slope[¶](#bpy.types.CompositorNodeColorBalance.slope "Link to this definition")
    :   Correction for highlights. (Deprecated: Use Slope input instead.)

        Type:
        :   [`mathutils.Color`](../../mathutils/index.md#mathutils.Color "mathutils.Color") of 3 items in [0, inf], default (1.0, 1.0, 1.0)

    *classmethod* is\_registered\_node\_type()[¶](#bpy.types.CompositorNodeColorBalance.is_registered_node_type "Link to this definition")
    ...
    *classmethod* input\_template(*index*)[¶](#bpy.types.CompositorNodeColorBalance.input_template "Link to this definition")
    ...
    *classmethod* output\_template(*index*)[¶](#bpy.types.CompositorNodeColorBalance.output_template "Link to this definition")
    ...
    update()[¶](#bpy.types.CompositorNodeColorBalance.update "Link to this definition")

    *classmethod* bl\_rna\_get\_subclass(*id*, *default=None*, */*)[¶](#bpy.types.CompositorNodeColorBalance.bl_rna_get_subclass "Link to this definition")
    :   Parameters:
    ...
    *classmethod* bl\_rna\_get\_subclass\_py(*id*, *default=None*, */*)[¶](#bpy.types.CompositorNodeColorBalance.bl_rna_get_subclass_py "Link to this definition")
    :   Parameters:
        :   **id** (*str*) – The RNA type identifier.
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.types.CompositorNodeColorBalance.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.types.CompositorNodeColorBalance.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* CompositorNodeColorBalance(CompositorNode)
  + [`CompositorNodeColorBalance`](#bpy.types.CompositorNodeColorBalance)
    - [`CompositorNodeColorBalance.correction_method`](#bpy.types.CompositorNodeColorBalance.correction_method)
    - [`CompositorNodeColorBalance.gain`](#bpy.types.CompositorNodeColorBalance.gain)
    - [`CompositorNodeColorBalance.gamma`](#bpy.types.CompositorNodeColorBalance.gamma)
    - [`CompositorNodeColorBalance.input_temperature`](#bpy.types.CompositorNodeColorBalance.input_temperature)
    - [`CompositorNodeColorBalance.input_tint`](#bpy.types.CompositorNodeColorBalance.input_tint)
    - [`CompositorNodeColorBalance.input_whitepoint`](#bpy.types.CompositorNodeColorBalance.input_whitepoint)
    - [`CompositorNodeColorBalance.lift`](#bpy.types.CompositorNodeColorBalance.lift)
    - [`CompositorNodeColorBalance.offset`](#bpy.types.CompositorNodeColorBalance.offset)
    - [`CompositorNodeColorBalance.offset_basis`](#bpy.types.CompositorNodeColorBalance.offset_basis)
    - [`CompositorNodeColorBalance.output_temperature`](#bpy.types.CompositorNodeColorBalance.output_temperature)
    - [`CompositorNodeColorBalance.output_tint`](#bpy.types.CompositorNodeColorBalance.output_tint)
    - [`CompositorNodeColorBalance.output_whitepoint`](#bpy.types.CompositorNodeColorBalance.output_whitepoint)
    - [`CompositorNodeColorBalance.power`](#bpy.types.CompositorNodeColorBalance.power)
    - [`CompositorNodeColorBalance.slope`](#bpy.types.CompositorNodeColorBalance.slope)
    - [`CompositorNodeColorBalance.is_registered_node_type()`](#bpy.types.CompositorNodeColorBalance.is_registered_node_type)
    - [`CompositorNodeColorBalance.input_template()`](#bpy.types.CompositorNodeColorBalance.input_template)
    - [`CompositorNodeColorBalance.output_template()`](#bpy.types.CompositorNodeColorBalance.output_template)
    - [`CompositorNodeColorBalance.update()`](#bpy.types.CompositorNodeColorBalance.update)
    - [`CompositorNodeColorBalance.bl_rna_get_subclass()`](#bpy.types.CompositorNodeColorBalance.bl_rna_get_subclass)
    - [`CompositorNodeColorBalance.bl_rna_get_subclass_py()`](#bpy.types.CompositorNodeColorBalance.bl_rna_get_subclass_py)
