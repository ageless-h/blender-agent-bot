...
bpy.ops.import\_curve.svg(*\**, *filepath=''*, *filter\_glob='\*.svg'*, *files=None*)[¶](#bpy.ops.import_curve.svg "Link to this definition")
:   Load a SVG file
    ...
    File:
    :   [addons\_core/io\_curve\_svg/\_\_init\_\_.py:50](https://projects.blender.org/blender/blender/src/branch/main/scripts/addons_core/io_curve_svg/__init__.py#L50)
