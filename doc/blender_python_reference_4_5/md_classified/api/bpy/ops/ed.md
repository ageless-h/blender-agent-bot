...
# Ed Operators[¶](#module-bpy.ops.ed "Link to this heading")

bpy.ops.ed.flush\_edits()[¶](#bpy.ops.ed.flush_edits "Link to this definition")
:   Flush edit data from active editing modes

bpy.ops.ed.lib\_id\_fake\_user\_toggle()[¶](#bpy.ops.ed.lib_id_fake_user_toggle "Link to this definition")
:   Save this data-block even if it has no users

bpy.ops.ed.lib\_id\_generate\_preview()[¶](#bpy.ops.ed.lib_id_generate_preview "Link to this definition")
:   Create an automatic preview for the selected data-block

bpy.ops.ed.lib\_id\_generate\_preview\_from\_object()[¶](#bpy.ops.ed.lib_id_generate_preview_from_object "Link to this definition")
:   Create a preview for this asset by rendering the active object

bpy.ops.ed.lib\_id\_load\_custom\_preview(*\**, *filepath=''*, *hide\_props\_region=True*, *check\_existing=False*, *filter\_blender=False*, *filter\_backup=False*, *filter\_image=True*, *filter\_movie=False*, *filter\_python=False*, *filter\_font=False*, *filter\_sound=False*, *filter\_text=False*, *filter\_archive=False*, *filter\_btx=False*, *filter\_collada=False*, *filter\_alembic=False*, *filter\_usd=False*, *filter\_obj=False*, *filter\_volume=False*, *filter\_folder=True*, *filter\_blenlib=False*, *filemode=9*, *show\_multiview=False*, *use\_multiview=False*, *display\_type='DEFAULT'*, *sort\_method=''*)[¶](#bpy.ops.ed.lib_id_load_custom_preview "Link to this definition")
...
bpy.ops.ed.lib\_id\_override\_editable\_toggle()[¶](#bpy.ops.ed.lib_id_override_editable_toggle "Link to this definition")
:   Set if this library override data-block can be edited

bpy.ops.ed.lib\_id\_remove\_preview()[¶](#bpy.ops.ed.lib_id_remove_preview "Link to this definition")
:   Remove the preview of this data-block

bpy.ops.ed.lib\_id\_unlink()[¶](#bpy.ops.ed.lib_id_unlink "Link to this definition")
:   Remove a usage of a data-block, clearing the assignment

bpy.ops.ed.redo()[¶](#bpy.ops.ed.redo "Link to this definition")
:   Redo previous action

bpy.ops.ed.undo()[¶](#bpy.ops.ed.undo "Link to this definition")
:   Undo previous action

bpy.ops.ed.undo\_history(*\**, *item=0*)[¶](#bpy.ops.ed.undo_history "Link to this definition")
:   Redo specific action in history

    Parameters:
    :   **item** (*int in* *[**0**,* *inf**]**,* *(**optional**)*) – Item

bpy.ops.ed.undo\_push(*\**, *message='Add an undo step \*function may be moved\*'*)[¶](#bpy.ops.ed.undo_push "Link to this definition")
:   Add an undo state (internal use only)

    Parameters:
    :   **message** (*string**,* *(**optional**,* *never None**)*) – Undo Message

bpy.ops.ed.undo\_redo()[¶](#bpy.ops.ed.undo_redo "Link to this definition")
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.ops.ed.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.ops.ed.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* Ed Operators
  + [`flush_edits()`](#bpy.ops.ed.flush_edits)
  + [`lib_id_fake_user_toggle()`](#bpy.ops.ed.lib_id_fake_user_toggle)
  + [`lib_id_generate_preview()`](#bpy.ops.ed.lib_id_generate_preview)
  + [`lib_id_generate_preview_from_object()`](#bpy.ops.ed.lib_id_generate_preview_from_object)
  + [`lib_id_load_custom_preview()`](#bpy.ops.ed.lib_id_load_custom_preview)
  + [`lib_id_override_editable_toggle()`](#bpy.ops.ed.lib_id_override_editable_toggle)
  + [`lib_id_remove_preview()`](#bpy.ops.ed.lib_id_remove_preview)
  + [`lib_id_unlink()`](#bpy.ops.ed.lib_id_unlink)
  + [`redo()`](#bpy.ops.ed.redo)
  + [`undo()`](#bpy.ops.ed.undo)
  + [`undo_history()`](#bpy.ops.ed.undo_history)
  + [`undo_push()`](#bpy.ops.ed.undo_push)
  + [`undo_redo()`](#bpy.ops.ed.undo_redo)