...
# Buttons Operators[¶](#module-bpy.ops.buttons "Link to this heading")

bpy.ops.buttons.clear\_filter()[¶](#bpy.ops.buttons.clear_filter "Link to this definition")
:   Clear the search filter

bpy.ops.buttons.context\_menu()[¶](#bpy.ops.buttons.context_menu "Link to this definition")
:   Display properties editor context\_menu

bpy.ops.buttons.directory\_browse(*\**, *directory=''*, *hide\_props\_region=True*, *check\_existing=False*, *filter\_blender=False*, *filter\_backup=False*, *filter\_image=False*, *filter\_movie=False*, *filter\_python=False*, *filter\_font=False*, *filter\_sound=False*, *filter\_text=False*, *filter\_archive=False*, *filter\_btx=False*, *filter\_collada=False*, *filter\_alembic=False*, *filter\_usd=False*, *filter\_obj=False*, *filter\_volume=False*, *filter\_folder=False*, *filter\_blenlib=False*, *filemode=9*, *relative\_path=True*, *display\_type='DEFAULT'*, *sort\_method=''*)[¶](#bpy.ops.buttons.directory_browse "Link to this definition")
...
bpy.ops.buttons.file\_browse(*\**, *filepath=''*, *hide\_props\_region=True*, *check\_existing=False*, *filter\_blender=False*, *filter\_backup=False*, *filter\_image=False*, *filter\_movie=False*, *filter\_python=False*, *filter\_font=False*, *filter\_sound=False*, *filter\_text=False*, *filter\_archive=False*, *filter\_btx=False*, *filter\_collada=False*, *filter\_alembic=False*, *filter\_usd=False*, *filter\_obj=False*, *filter\_volume=False*, *filter\_folder=False*, *filter\_blenlib=False*, *filemode=9*, *relative\_path=True*, *display\_type='DEFAULT'*, *sort\_method=''*, *filter\_glob=''*)[¶](#bpy.ops.buttons.file_browse "Link to this definition")
    ...
    :   * **filepath** (*string**,* *(**optional**,* *never None**)*) – File Path, Path to file
        ...
        * **display\_type** (enum in [`'DEFAULT'`, `'LIST_VERTICAL'`, `'LIST_HORIZONTAL'`, `'THUMBNAIL'`], (optional)) –
          ...
          + `THUMBNAIL`
            Thumbnails – Display files as thumbnails.
        * **sort\_method** (*enum in* *[**]**,* *(**optional**)*) – File sorting mode
        * **filter\_glob** (*string**,* *(**optional**,* *never None**)*) – Glob Filter, Custom filter

bpy.ops.buttons.start\_filter()[¶](#bpy.ops.buttons.start_filter "Link to this definition")
:   Start entering filter text

bpy.ops.buttons.toggle\_pin()[¶](#bpy.ops.buttons.toggle_pin "Link to this definition")
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.ops.buttons.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.ops.buttons.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* Buttons Operators
  + [`clear_filter()`](#bpy.ops.buttons.clear_filter)
  + [`context_menu()`](#bpy.ops.buttons.context_menu)
  + [`directory_browse()`](#bpy.ops.buttons.directory_browse)
  + [`file_browse()`](#bpy.ops.buttons.file_browse)
  + [`start_filter()`](#bpy.ops.buttons.start_filter)
  + [`toggle_pin()`](#bpy.ops.buttons.toggle_pin)