...
:   Create a pose asset for each pose marker in this legacy pose library data-block
    ...
    File:
    :   [addons\_core/pose\_library/operators.py:342](https://projects.blender.org/blender/blender/src/branch/main/scripts/addons_core/pose_library/operators.py#L342)
...
:   Create a pose asset for each pose marker in the current action
    ...
    File:
    :   [addons\_core/pose\_library/operators.py:308](https://projects.blender.org/blender/blender/src/branch/main/scripts/addons_core/pose_library/operators.py#L308)
...
bpy.ops.poselib.create\_pose\_asset(*\**, *pose\_name=''*, *asset\_library\_reference=''*, *catalog\_path=''*, *activate\_new\_action=False*)[¶](#bpy.ops.poselib.create_pose_asset "Link to this definition")
:   Create a new asset from the selected bones in the scene
    ...
    :   * **pose\_name** (*string**,* *(**optional**,* *never None**)*) – Pose Name, Name for the new pose asset
        ...
        * **activate\_new\_action** (*boolean**,* *(**optional**)*) – Activate New Action, This property is deprecated and will be removed in the future
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.ops.poselib.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.ops.poselib.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)
