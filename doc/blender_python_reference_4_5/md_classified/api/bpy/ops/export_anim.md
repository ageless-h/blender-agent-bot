...
# Export Anim Operators[¶](#module-bpy.ops.export_anim "Link to this heading")

bpy.ops.export\_anim.bvh(*\**, *filepath=''*, *check\_existing=True*, *filter\_glob='\*.bvh'*, *global\_scale=1.0*, *frame\_start=0*, *frame\_end=0*, *rotate\_mode='NATIVE'*, *root\_transform\_only=False*)[¶](#bpy.ops.export_anim.bvh "Link to this definition")
:   Save a BVH motion capture file from an armature
    ...
    :   * **filepath** (*string**,* *(**optional**,* *never None**)*) – File Path, Filepath used for exporting the file
        ...
        * **frame\_start** (*int in* *[**-inf**,* *inf**]**,* *(**optional**)*) – Start Frame, Starting frame to export
        * **frame\_end** (*int in* *[**-inf**,* *inf**]**,* *(**optional**)*) – End Frame, End frame to export
        * **rotate\_mode** (enum in [`'NATIVE'`, `'XYZ'`, `'XZY'`, `'YXZ'`, `'YZX'`, `'ZXY'`, `'ZYX'`], (optional)) –
        ...
        * **root\_transform\_only** (*boolean**,* *(**optional**)*) – Root Translation Only, Only write out translation channels for the root bone

    File:
    :   [addons\_core/io\_anim\_bvh/\_\_init\_\_.py:279](https://projects.blender.org/blender/blender/src/branch/main/scripts/addons_core/io_anim_bvh/__init__.py#L279)
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.ops.export_anim.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.ops.export_anim.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* Export Anim Operators
  + [`bvh()`](#bpy.ops.export_anim.bvh)