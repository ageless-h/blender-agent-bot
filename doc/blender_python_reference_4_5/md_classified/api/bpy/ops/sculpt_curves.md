...
# Sculpt Curves Operators[¶](#module-bpy.ops.sculpt_curves "Link to this heading")

bpy.ops.sculpt\_curves.brush\_stroke(*\**, *stroke=None*, *mode='NORMAL'*, *pen\_flip=False*)[¶](#bpy.ops.sculpt_curves.brush_stroke "Link to this definition")
...
bpy.ops.sculpt\_curves.min\_distance\_edit()[¶](#bpy.ops.sculpt_curves.min_distance_edit "Link to this definition")
:   Change the minimum distance used by the density brush

bpy.ops.sculpt\_curves.select\_grow(*\**, *distance=0.1*)[¶](#bpy.ops.sculpt_curves.select_grow "Link to this definition")
...
bpy.ops.sculpt\_curves.select\_random(*\**, *seed=0*, *partial=False*, *probability=0.5*, *min=0.0*, *constant\_per\_curve=True*)[¶](#bpy.ops.sculpt_curves.select_random "Link to this definition")
:   Randomizes existing selection or create new random selection
    ...
    :   * **seed** (*int in* *[**-inf**,* *inf**]**,* *(**optional**)*) – Seed, Source of randomness
        ...
        * **constant\_per\_curve** (*boolean**,* *(**optional**)*) – Constant per Curve, The generated random number is the same for every control point of a curve
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.ops.sculpt_curves.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.ops.sculpt_curves.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* Sculpt Curves Operators
  + [`brush_stroke()`](#bpy.ops.sculpt_curves.brush_stroke)
  + [`min_distance_edit()`](#bpy.ops.sculpt_curves.min_distance_edit)
  + [`select_grow()`](#bpy.ops.sculpt_curves.select_grow)
  + [`select_random()`](#bpy.ops.sculpt_curves.select_random)