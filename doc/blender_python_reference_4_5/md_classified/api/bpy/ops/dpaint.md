...
# Dpaint Operators[¶](#module-bpy.ops.dpaint "Link to this heading")

bpy.ops.dpaint.bake()[¶](#bpy.ops.dpaint.bake "Link to this definition")
:   Bake dynamic paint image sequence surface

bpy.ops.dpaint.output\_toggle(*\**, *output='A'*)[¶](#bpy.ops.dpaint.output_toggle "Link to this definition")
:   Add or remove Dynamic Paint output data layer

    Parameters:
    :   **output** (enum in [`'A'`, `'B'`], (optional)) – Output Toggle

bpy.ops.dpaint.surface\_slot\_add()[¶](#bpy.ops.dpaint.surface_slot_add "Link to this definition")
:   Add a new Dynamic Paint surface slot

bpy.ops.dpaint.surface\_slot\_remove()[¶](#bpy.ops.dpaint.surface_slot_remove "Link to this definition")
:   Remove the selected surface slot

bpy.ops.dpaint.type\_toggle(*\**, *type='CANVAS'*)[¶](#bpy.ops.dpaint.type_toggle "Link to this definition")
:   Toggle whether given type is active or not

    Parameters:
    :   **type** (enum in [Prop Dynamicpaint Type Items](../../../appendix/bpy_types_enum_items/prop_dynamicpaint_type_items.md#rna-enum-prop-dynamicpaint-type-items), (optional)) – Type
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.ops.dpaint.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.ops.dpaint.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* Dpaint Operators
  + [`bake()`](#bpy.ops.dpaint.bake)
  + [`output_toggle()`](#bpy.ops.dpaint.output_toggle)
  + [`surface_slot_add()`](#bpy.ops.dpaint.surface_slot_add)
  + [`surface_slot_remove()`](#bpy.ops.dpaint.surface_slot_remove)
  + [`type_toggle()`](#bpy.ops.dpaint.type_toggle)