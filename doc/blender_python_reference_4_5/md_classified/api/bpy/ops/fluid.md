...
# Fluid Operators[¶](#module-bpy.ops.fluid "Link to this heading")

bpy.ops.fluid.bake\_all()[¶](#bpy.ops.fluid.bake_all "Link to this definition")
:   Bake Entire Fluid Simulation

bpy.ops.fluid.bake\_data()[¶](#bpy.ops.fluid.bake_data "Link to this definition")
:   Bake Fluid Data

bpy.ops.fluid.bake\_guides()[¶](#bpy.ops.fluid.bake_guides "Link to this definition")
:   Bake Fluid Guiding

bpy.ops.fluid.bake\_mesh()[¶](#bpy.ops.fluid.bake_mesh "Link to this definition")
:   Bake Fluid Mesh

bpy.ops.fluid.bake\_noise()[¶](#bpy.ops.fluid.bake_noise "Link to this definition")
:   Bake Fluid Noise

bpy.ops.fluid.bake\_particles()[¶](#bpy.ops.fluid.bake_particles "Link to this definition")
:   Bake Fluid Particles

bpy.ops.fluid.free\_all()[¶](#bpy.ops.fluid.free_all "Link to this definition")
:   Free Entire Fluid Simulation

bpy.ops.fluid.free\_data()[¶](#bpy.ops.fluid.free_data "Link to this definition")
:   Free Fluid Data

bpy.ops.fluid.free\_guides()[¶](#bpy.ops.fluid.free_guides "Link to this definition")
:   Free Fluid Guiding

bpy.ops.fluid.free\_mesh()[¶](#bpy.ops.fluid.free_mesh "Link to this definition")
:   Free Fluid Mesh

bpy.ops.fluid.free\_noise()[¶](#bpy.ops.fluid.free_noise "Link to this definition")
:   Free Fluid Noise

bpy.ops.fluid.free\_particles()[¶](#bpy.ops.fluid.free_particles "Link to this definition")
:   Free Fluid Particles

bpy.ops.fluid.pause\_bake()[¶](#bpy.ops.fluid.pause_bake "Link to this definition")
:   Pause Bake

bpy.ops.fluid.preset\_add(*\**, *name=''*, *remove\_name=False*, *remove\_active=False*)[¶](#bpy.ops.fluid.preset_add "Link to this definition")
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.ops.fluid.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.ops.fluid.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)
...
* Fluid Operators
  ...
  + [`bake_noise()`](#bpy.ops.fluid.bake_noise)
  ...
  + [`free_noise()`](#bpy.ops.fluid.free_noise)
  + [`free_particles()`](#bpy.ops.fluid.free_particles)
  + [`pause_bake()`](#bpy.ops.fluid.pause_bake)
  + [`preset_add()`](#bpy.ops.fluid.preset_add)