...
# Info Operators[¶](#module-bpy.ops.info "Link to this heading")

bpy.ops.info.report\_copy()[¶](#bpy.ops.info.report_copy "Link to this definition")
:   Copy selected reports to clipboard

bpy.ops.info.report\_delete()[¶](#bpy.ops.info.report_delete "Link to this definition")
:   Delete selected reports

bpy.ops.info.report\_replay()[¶](#bpy.ops.info.report_replay "Link to this definition")
:   Replay selected reports

bpy.ops.info.reports\_display\_update()[¶](#bpy.ops.info.reports_display_update "Link to this definition")
:   Update the display of reports in Blender UI (internal use)

bpy.ops.info.select\_all(*\**, *action='SELECT'*)[¶](#bpy.ops.info.select_all "Link to this definition")
...
bpy.ops.info.select\_box(*\**, *xmin=0*, *xmax=0*, *ymin=0*, *ymax=0*, *wait\_for\_input=True*, *mode='SET'*)[¶](#bpy.ops.info.select_box "Link to this definition")
...
bpy.ops.info.select\_pick(*\**, *report\_index=0*, *extend=False*)[¶](#bpy.ops.info.select_pick "Link to this definition")
:   Select reports by index

    Parameters:
    :   * **report\_index** (*int in* *[**0**,* *inf**]**,* *(**optional**)*) – Report, Index of the report
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.ops.info.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.ops.info.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* Info Operators
  + [`report_copy()`](#bpy.ops.info.report_copy)
  + [`report_delete()`](#bpy.ops.info.report_delete)
  + [`report_replay()`](#bpy.ops.info.report_replay)
  + [`reports_display_update()`](#bpy.ops.info.reports_display_update)
  + [`select_all()`](#bpy.ops.info.select_all)
  + [`select_box()`](#bpy.ops.info.select_box)
  + [`select_pick()`](#bpy.ops.info.select_pick)