...
# Spreadsheet Operators[¶](#module-bpy.ops.spreadsheet "Link to this heading")

bpy.ops.spreadsheet.add\_row\_filter\_rule()[¶](#bpy.ops.spreadsheet.add_row_filter_rule "Link to this definition")
:   Add a filter to remove rows from the displayed data

bpy.ops.spreadsheet.change\_spreadsheet\_data\_source(*\**, *component\_type=0*, *attribute\_domain\_type=0*)[¶](#bpy.ops.spreadsheet.change_spreadsheet_data_source "Link to this definition")
:   Change visible data source in the spreadsheet

    Parameters:
    :   * **component\_type** (*int in* *[**0**,* *32767**]**,* *(**optional**)*) – Component Type
        * **attribute\_domain\_type** (*int in* *[**0**,* *32767**]**,* *(**optional**)*) – Attribute Domain Type

bpy.ops.spreadsheet.fit\_column()[¶](#bpy.ops.spreadsheet.fit_column "Link to this definition")
:   Resize a spreadsheet column to the width of the data

bpy.ops.spreadsheet.remove\_row\_filter\_rule(*\**, *index=0*)[¶](#bpy.ops.spreadsheet.remove_row_filter_rule "Link to this definition")
:   Remove a row filter from the rules

    Parameters:
    :   **index** (*int in* *[**0**,* *inf**]**,* *(**optional**)*) – Index

bpy.ops.spreadsheet.reorder\_columns()[¶](#bpy.ops.spreadsheet.reorder_columns "Link to this definition")
:   Change the order of columns

bpy.ops.spreadsheet.resize\_column()[¶](#bpy.ops.spreadsheet.resize_column "Link to this definition")
:   Resize a spreadsheet column

bpy.ops.spreadsheet.toggle\_pin()[¶](#bpy.ops.spreadsheet.toggle_pin "Link to this definition")
:   Turn on or off pinning

    File:
    :   [startup/bl\_operators/spreadsheet.py:21](https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/spreadsheet.py#L21)
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.ops.spreadsheet.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.ops.spreadsheet.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)

On this page

* Spreadsheet Operators
  + [`add_row_filter_rule()`](#bpy.ops.spreadsheet.add_row_filter_rule)
  + [`change_spreadsheet_data_source()`](#bpy.ops.spreadsheet.change_spreadsheet_data_source)
  + [`fit_column()`](#bpy.ops.spreadsheet.fit_column)
  + [`remove_row_filter_rule()`](#bpy.ops.spreadsheet.remove_row_filter_rule)
  + [`reorder_columns()`](#bpy.ops.spreadsheet.reorder_columns)
  + [`resize_column()`](#bpy.ops.spreadsheet.resize_column)
  + [`toggle_pin()`](#bpy.ops.spreadsheet.toggle_pin)