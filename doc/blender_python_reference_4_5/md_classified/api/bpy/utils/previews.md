...
*class* bpy.utils.previews.ImagePreviewCollection[¶](#bpy.utils.previews.bpy.utils.previews.ImagePreviewCollection "Link to this definition")
:   Dictionary-like class of previews.
    ...
    * values will be [`bpy.types.ImagePreview`](../types/ImagePreview.md#bpy.types.ImagePreview "bpy.types.ImagePreview")
    ...
    clear()[¶](#bpy.utils.previews.bpy.utils.previews.ImagePreviewCollection.clear "Link to this definition")
    :   Clear all previews.

    close()[¶](#bpy.utils.previews.bpy.utils.previews.ImagePreviewCollection.close "Link to this definition")
    :   Close the collection and clear all previews.

    load(*name*, *filepath*, *filetype*, *force\_reload=False*)[¶](#bpy.utils.previews.bpy.utils.previews.ImagePreviewCollection.load "Link to this definition")
    ...
    new(*name*)[¶](#bpy.utils.previews.bpy.utils.previews.ImagePreviewCollection.new "Link to this definition")
...
* [Report issue
  on this page](https://projects.blender.org/blender/blender/issues/new?template=.gitea/issue_template/api_docs.yaml&field:body=%2A%2APage+Information%2A%2A%0D%0AFile%3A+%60bpy.utils.previews.rst%60%0D%0ABlender+Version%3A+%604.5%60%0D%0A%5BPermanent+Link%5D%28https%3A%2F%2Fdocs.blender.org%2Fapi%2F4.5%2Fbpy.utils.previews.html%29%0D%0A%0D%0A%2A%2AShort+description+of+error%2A%2A%0D%0A%5BPlease+fill+out+a+short+description+of+the+error+here%5D%0D%0A)
...
* bpy.utils submodule (bpy.utils.previews)
  + [Custom Icon Example](#custom-icon-example)
    ...
    - [`bpy.utils.previews.ImagePreviewCollection`](#bpy.utils.previews.bpy.utils.previews.ImagePreviewCollection)
      * [`bpy.utils.previews.ImagePreviewCollection.clear()`](#bpy.utils.previews.bpy.utils.previews.ImagePreviewCollection.clear)
      * [`bpy.utils.previews.ImagePreviewCollection.close()`](#bpy.utils.previews.bpy.utils.previews.ImagePreviewCollection.close)
      * [`bpy.utils.previews.ImagePreviewCollection.load()`](#bpy.utils.previews.bpy.utils.previews.ImagePreviewCollection.load)
      * [`bpy.utils.previews.ImagePreviewCollection.new()`](#bpy.utils.previews.bpy.utils.previews.ImagePreviewCollection.new)